...
class TemperatureProcessor:
    ...
    def __call__(
        ...
        if RUST_AVAILABLE and hasattr(rust_core, "apply_temperature_rust"):
            return rust_core.apply_temperature_rust(logits, self.temperature)
...
class TopKProcessor:
    ...
    def __call__(
        ...
        if RUST_AVAILABLE and hasattr(rust_core, "apply_top_k_rust"):
            return rust_core.apply_top_k_rust(logits, self.top_k)
