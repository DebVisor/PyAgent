...
@Data
public class Idea179212Config {
    private String name = "idea_179212";
...
public class Idea179212Service {
    private static final int IDEA_ID = 179212;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea179212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea179212Service() {
        this(new Idea179212Config());
    }

    public Idea179212Service(Idea179212Config config) {
        this.config = config != null ? config : new Idea179212Config();
