...
@Data
public class Idea179308Config {
    private String name = "idea_179308";
 ...
 */
@Slf4j
public class Idea179308Service {
    private static final int IDEA_ID = 179308;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea179308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea179308Service() {
        this(new Idea179308Config());
    }

    public Idea179308Service(Idea179308Config config) {
        this.config = config != null ? config : new Idea179308Config();
