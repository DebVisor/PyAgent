...
@Data
public class Idea172395Config {
    private String name = "idea_172395";
 ...
 */
@Slf4j
public class Idea172395Service {
    private static final int IDEA_ID = 172395;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea172395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea172395Service() {
        this(new Idea172395Config());
    }

    public Idea172395Service(Idea172395Config config) {
        this.config = config != null ? config : new Idea172395Config();
