...
@Data
public class Idea172209Config {
    private String name = "idea_172209";
 ...
 */
@Slf4j
public class Idea172209Service {
    private static final int IDEA_ID = 172209;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea172209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea172209Service() {
        this(new Idea172209Config());
    }

    public Idea172209Service(Idea172209Config config) {
        this.config = config != null ? config : new Idea172209Config();
