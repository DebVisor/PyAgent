...
@Data
public class Idea178479Config {
    private String name = "idea_178479";
 ...
 */
@Slf4j
public class Idea178479Service {
    private static final int IDEA_ID = 178479;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178479Service() {
        this(new Idea178479Config());
    }

    public Idea178479Service(Idea178479Config config) {
        this.config = config != null ? config : new Idea178479Config();
