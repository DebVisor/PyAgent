...
@Data
public class Idea178239Config {
    private String name = "idea_178239";
 ...
 */
@Slf4j
public class Idea178239Service {
    private static final int IDEA_ID = 178239;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178239Service() {
        this(new Idea178239Config());
    }

    public Idea178239Service(Idea178239Config config) {
        this.config = config != null ? config : new Idea178239Config();
