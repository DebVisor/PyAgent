...
@Data
public class Idea178546Config {
    private String name = "idea_178546";
 ...
 */
@Slf4j
public class Idea178546Service {
    private static final int IDEA_ID = 178546;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178546Service() {
        this(new Idea178546Config());
    }

    public Idea178546Service(Idea178546Config config) {
        this.config = config != null ? config : new Idea178546Config();
