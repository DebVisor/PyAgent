...
@Data
public class Idea178326Config {
    private String name = "idea_178326";
 ...
 */
@Slf4j
public class Idea178326Service {
    private static final int IDEA_ID = 178326;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178326Service() {
        this(new Idea178326Config());
    }

    public Idea178326Service(Idea178326Config config) {
        this.config = config != null ? config : new Idea178326Config();
