...
@Data
public class Idea178550Config {
    private String name = "idea_178550";
 ...
 */
@Slf4j
public class Idea178550Service {
    private static final int IDEA_ID = 178550;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178550Service() {
        this(new Idea178550Config());
    }

    public Idea178550Service(Idea178550Config config) {
        this.config = config != null ? config : new Idea178550Config();
