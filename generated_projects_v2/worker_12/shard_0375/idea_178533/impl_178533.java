...
@Data
public class Idea178533Config {
    private String name = "idea_178533";
 ...
 */
@Slf4j
public class Idea178533Service {
    private static final int IDEA_ID = 178533;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178533Service() {
        this(new Idea178533Config());
    }

    public Idea178533Service(Idea178533Config config) {
        this.config = config != null ? config : new Idea178533Config();
