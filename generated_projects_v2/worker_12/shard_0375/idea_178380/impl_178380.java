...
@Data
public class Idea178380Config {
    private String name = "idea_178380";
 ...
 */
@Slf4j
public class Idea178380Service {
    private static final int IDEA_ID = 178380;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178380Service() {
        this(new Idea178380Config());
    }

    public Idea178380Service(Idea178380Config config) {
        this.config = config != null ? config : new Idea178380Config();
