...
@Data
public class Idea178373Config {
    private String name = "idea_178373";
 ...
 */
@Slf4j
public class Idea178373Service {
    private static final int IDEA_ID = 178373;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178373Service() {
        this(new Idea178373Config());
    }

    public Idea178373Service(Idea178373Config config) {
        this.config = config != null ? config : new Idea178373Config();
