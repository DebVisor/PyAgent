...
@Data
public class Idea178590Config {
    private String name = "idea_178590";
 ...
 */
@Slf4j
public class Idea178590Service {
    private static final int IDEA_ID = 178590;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178590Service() {
        this(new Idea178590Config());
    }

    public Idea178590Service(Idea178590Config config) {
        this.config = config != null ? config : new Idea178590Config();
