...
@Data
public class Idea178181Config {
    private String name = "idea_178181";
 ...
 */
@Slf4j
public class Idea178181Service {
    private static final int IDEA_ID = 178181;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178181Service() {
        this(new Idea178181Config());
    }

    public Idea178181Service(Idea178181Config config) {
        this.config = config != null ? config : new Idea178181Config();
