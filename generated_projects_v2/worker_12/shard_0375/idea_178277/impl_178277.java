...
@Data
public class Idea178277Config {
    private String name = "idea_178277";
 ...
 */
@Slf4j
public class Idea178277Service {
    private static final int IDEA_ID = 178277;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178277Service() {
        this(new Idea178277Config());
    }

    public Idea178277Service(Idea178277Config config) {
        this.config = config != null ? config : new Idea178277Config();
