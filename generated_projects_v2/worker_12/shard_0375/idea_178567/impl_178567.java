...
@Data
public class Idea178567Config {
    private String name = "idea_178567";
 ...
 */
@Slf4j
public class Idea178567Service {
    private static final int IDEA_ID = 178567;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178567Service() {
        this(new Idea178567Config());
    }

    public Idea178567Service(Idea178567Config config) {
        this.config = config != null ? config : new Idea178567Config();
