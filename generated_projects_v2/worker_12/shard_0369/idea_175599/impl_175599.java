...
@Data
public class Idea175599Config {
    private String name = "idea_175599";
 ...
 */
@Slf4j
public class Idea175599Service {
    private static final int IDEA_ID = 175599;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175599Service() {
        this(new Idea175599Config());
    }

    public Idea175599Service(Idea175599Config config) {
        this.config = config != null ? config : new Idea175599Config();
