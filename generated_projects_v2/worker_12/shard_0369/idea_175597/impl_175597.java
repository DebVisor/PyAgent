...
@Data
public class Idea175597Config {
    private String name = "idea_175597";
 ...
 */
@Slf4j
public class Idea175597Service {
    private static final int IDEA_ID = 175597;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175597Service() {
        this(new Idea175597Config());
    }

    public Idea175597Service(Idea175597Config config) {
        this.config = config != null ? config : new Idea175597Config();
