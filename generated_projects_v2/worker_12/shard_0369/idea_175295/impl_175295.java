...
@Data
public class Idea175295Config {
    private String name = "idea_175295";
 ...
 */
@Slf4j
public class Idea175295Service {
    private static final int IDEA_ID = 175295;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175295Service() {
        this(new Idea175295Config());
    }

    public Idea175295Service(Idea175295Config config) {
        this.config = config != null ? config : new Idea175295Config();
