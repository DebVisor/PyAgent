...
@Data
public class Idea175506Config {
    private String name = "idea_175506";
 ...
 */
@Slf4j
public class Idea175506Service {
    private static final int IDEA_ID = 175506;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175506Service() {
        this(new Idea175506Config());
    }

    public Idea175506Service(Idea175506Config config) {
        this.config = config != null ? config : new Idea175506Config();
