...
@Data
public class Idea175479Config {
    private String name = "idea_175479";
 ...
 */
@Slf4j
public class Idea175479Service {
    private static final int IDEA_ID = 175479;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175479Service() {
        this(new Idea175479Config());
    }

    public Idea175479Service(Idea175479Config config) {
        this.config = config != null ? config : new Idea175479Config();
