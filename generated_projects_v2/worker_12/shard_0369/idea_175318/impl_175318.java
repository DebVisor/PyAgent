...
@Data
public class Idea175318Config {
    private String name = "idea_175318";
 ...
 */
@Slf4j
public class Idea175318Service {
    private static final int IDEA_ID = 175318;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175318Service() {
        this(new Idea175318Config());
    }

    public Idea175318Service(Idea175318Config config) {
        this.config = config != null ? config : new Idea175318Config();
