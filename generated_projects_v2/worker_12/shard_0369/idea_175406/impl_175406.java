...
@Data
public class Idea175406Config {
    private String name = "idea_175406";
 ...
 */
@Slf4j
public class Idea175406Service {
    private static final int IDEA_ID = 175406;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175406Service() {
        this(new Idea175406Config());
    }

    public Idea175406Service(Idea175406Config config) {
        this.config = config != null ? config : new Idea175406Config();
