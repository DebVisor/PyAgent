...
@Data
public class Idea175625Config {
    private String name = "idea_175625";
 ...
 */
@Slf4j
public class Idea175625Service {
    private static final int IDEA_ID = 175625;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175625Service() {
        this(new Idea175625Config());
    }

    public Idea175625Service(Idea175625Config config) {
        this.config = config != null ? config : new Idea175625Config();
