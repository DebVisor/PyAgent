...
@Data
public class Idea175408Config {
    private String name = "idea_175408";
 ...
 */
@Slf4j
public class Idea175408Service {
    private static final int IDEA_ID = 175408;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175408Service() {
        this(new Idea175408Config());
    }

    public Idea175408Service(Idea175408Config config) {
        this.config = config != null ? config : new Idea175408Config();
