...
@Data
public class Idea175293Config {
    private String name = "idea_175293";
 ...
 */
@Slf4j
public class Idea175293Service {
    private static final int IDEA_ID = 175293;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175293Service() {
        this(new Idea175293Config());
    }

    public Idea175293Service(Idea175293Config config) {
        this.config = config != null ? config : new Idea175293Config();
