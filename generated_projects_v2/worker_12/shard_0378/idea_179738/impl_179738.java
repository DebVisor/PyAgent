...
@Data
public class Idea179738Config {
    private String name = "idea_179738";
 ...
 */
@Slf4j
public class Idea179738Service {
    private static final int IDEA_ID = 179738;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea179738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea179738Service() {
        this(new Idea179738Config());
    }

    public Idea179738Service(Idea179738Config config) {
        this.config = config != null ? config : new Idea179738Config();
