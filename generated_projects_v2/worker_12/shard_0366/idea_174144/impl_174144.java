...
@Data
public class Idea174144Config {
    private String name = "idea_174144";
 ...
 */
@Slf4j
public class Idea174144Service {
    private static final int IDEA_ID = 174144;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174144Service() {
        this(new Idea174144Config());
    }

    public Idea174144Service(Idea174144Config config) {
        this.config = config != null ? config : new Idea174144Config();
