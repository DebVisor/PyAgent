...
@Data
public class Idea174180Config {
    private String name = "idea_174180";
 ...
 */
@Slf4j
public class Idea174180Service {
    private static final int IDEA_ID = 174180;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174180Service() {
        this(new Idea174180Config());
    }

    public Idea174180Service(Idea174180Config config) {
        this.config = config != null ? config : new Idea174180Config();
