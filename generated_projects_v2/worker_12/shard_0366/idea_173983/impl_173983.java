...
@Data
public class Idea173983Config {
    private String name = "idea_173983";
 ...
 */
@Slf4j
public class Idea173983Service {
    private static final int IDEA_ID = 173983;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea173983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea173983Service() {
        this(new Idea173983Config());
    }

    public Idea173983Service(Idea173983Config config) {
        this.config = config != null ? config : new Idea173983Config();
