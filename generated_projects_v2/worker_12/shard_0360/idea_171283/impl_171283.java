...
@Data
public class Idea171283Config {
    private String name = "idea_171283";
 ...
 */
@Slf4j
public class Idea171283Service {
    private static final int IDEA_ID = 171283;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171283Service() {
        this(new Idea171283Config());
    }

    public Idea171283Service(Idea171283Config config) {
        this.config = config != null ? config : new Idea171283Config();
