...
@Data
public class Idea171281Config {
    private String name = "idea_171281";
 ...
 */
@Slf4j
public class Idea171281Service {
    private static final int IDEA_ID = 171281;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171281Service() {
        this(new Idea171281Config());
    }

    public Idea171281Service(Idea171281Config config) {
        this.config = config != null ? config : new Idea171281Config();
