...
@Data
public class Idea171220Config {
    private String name = "idea_171220";
 ...
 */
@Slf4j
public class Idea171220Service {
    private static final int IDEA_ID = 171220;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171220Service() {
        this(new Idea171220Config());
    }

    public Idea171220Service(Idea171220Config config) {
        this.config = config != null ? config : new Idea171220Config();
