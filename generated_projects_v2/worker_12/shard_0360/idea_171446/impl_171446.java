...
@Data
public class Idea171446Config {
    private String name = "idea_171446";
 ...
 */
@Slf4j
public class Idea171446Service {
    private static final int IDEA_ID = 171446;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171446Service() {
        this(new Idea171446Config());
    }

    public Idea171446Service(Idea171446Config config) {
        this.config = config != null ? config : new Idea171446Config();
