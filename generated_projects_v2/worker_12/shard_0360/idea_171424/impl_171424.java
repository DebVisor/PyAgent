...
@Data
public class Idea171424Config {
    private String name = "idea_171424";
 ...
 */
@Slf4j
public class Idea171424Service {
    private static final int IDEA_ID = 171424;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171424Service() {
        this(new Idea171424Config());
    }

    public Idea171424Service(Idea171424Config config) {
        this.config = config != null ? config : new Idea171424Config();
