...
@Data
public class Idea171433Config {
    private String name = "idea_171433";
 ...
 */
@Slf4j
public class Idea171433Service {
    private static final int IDEA_ID = 171433;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171433Service() {
        this(new Idea171433Config());
    }

    public Idea171433Service(Idea171433Config config) {
        this.config = config != null ? config : new Idea171433Config();
