...
@Data
public class Idea171000Config {
    private String name = "idea_171000";
 ...
 */
@Slf4j
public class Idea171000Service {
    private static final int IDEA_ID = 171000;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171000Service() {
        this(new Idea171000Config());
    }

    public Idea171000Service(Idea171000Config config) {
        this.config = config != null ? config : new Idea171000Config();
