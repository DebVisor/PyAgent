...
@Data
public class Idea171421Config {
    private String name = "idea_171421";
 ...
 */
@Slf4j
public class Idea171421Service {
    private static final int IDEA_ID = 171421;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171421Service() {
        this(new Idea171421Config());
    }

    public Idea171421Service(Idea171421Config config) {
        this.config = config != null ? config : new Idea171421Config();
