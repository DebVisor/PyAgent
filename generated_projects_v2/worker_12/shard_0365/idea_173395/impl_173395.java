...
@Data
public class Idea173395Config {
    private String name = "idea_173395";
 ...
 */
@Slf4j
public class Idea173395Service {
    private static final int IDEA_ID = 173395;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea173395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea173395Service() {
        this(new Idea173395Config());
    }

    public Idea173395Service(Idea173395Config config) {
        this.config = config != null ? config : new Idea173395Config();
