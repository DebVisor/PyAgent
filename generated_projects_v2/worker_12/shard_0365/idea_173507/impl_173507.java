...
@Data
public class Idea173507Config {
    private String name = "idea_173507";
 ...
 */
@Slf4j
public class Idea173507Service {
    private static final int IDEA_ID = 173507;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea173507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea173507Service() {
        this(new Idea173507Config());
    }

    public Idea173507Service(Idea173507Config config) {
        this.config = config != null ? config : new Idea173507Config();
