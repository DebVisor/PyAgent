...
@Data
public class Idea173720Config {
    private String name = "idea_173720";
 ...
 */
@Slf4j
public class Idea173720Service {
    private static final int IDEA_ID = 173720;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea173720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea173720Service() {
        this(new Idea173720Config());
    }

    public Idea173720Service(Idea173720Config config) {
        this.config = config != null ? config : new Idea173720Config();
