...
@Data
public class Idea173655Config {
    private String name = "idea_173655";
 ...
 */
@Slf4j
public class Idea173655Service {
    private static final int IDEA_ID = 173655;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea173655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea173655Service() {
        this(new Idea173655Config());
    }

    public Idea173655Service(Idea173655Config config) {
        this.config = config != null ? config : new Idea173655Config();
