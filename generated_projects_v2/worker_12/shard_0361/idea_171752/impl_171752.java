...
@Data
public class Idea171752Config {
    private String name = "idea_171752";
 ...
 */
@Slf4j
public class Idea171752Service {
    private static final int IDEA_ID = 171752;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171752Service() {
        this(new Idea171752Config());
    }

    public Idea171752Service(Idea171752Config config) {
        this.config = config != null ? config : new Idea171752Config();
