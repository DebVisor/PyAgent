...
@Data
public class Idea171651Config {
    private String name = "idea_171651";
 ...
 */
@Slf4j
public class Idea171651Service {
    private static final int IDEA_ID = 171651;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171651Service() {
        this(new Idea171651Config());
    }

    public Idea171651Service(Idea171651Config config) {
        this.config = config != null ? config : new Idea171651Config();
