...
@Data
public class Idea171490Config {
    private String name = "idea_171490";
 ...
 */
@Slf4j
public class Idea171490Service {
    private static final int IDEA_ID = 171490;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171490Service() {
        this(new Idea171490Config());
    }

    public Idea171490Service(Idea171490Config config) {
        this.config = config != null ? config : new Idea171490Config();
