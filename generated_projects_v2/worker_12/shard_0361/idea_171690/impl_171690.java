...
@Data
public class Idea171690Config {
    private String name = "idea_171690";
 ...
 */
@Slf4j
public class Idea171690Service {
    private static final int IDEA_ID = 171690;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171690Service() {
        this(new Idea171690Config());
    }

    public Idea171690Service(Idea171690Config config) {
        this.config = config != null ? config : new Idea171690Config();
