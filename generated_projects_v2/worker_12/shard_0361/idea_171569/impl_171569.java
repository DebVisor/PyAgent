...
@Data
public class Idea171569Config {
    private String name = "idea_171569";
 ...
 */
@Slf4j
public class Idea171569Service {
    private static final int IDEA_ID = 171569;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171569Service() {
        this(new Idea171569Config());
    }

    public Idea171569Service(Idea171569Config config) {
        this.config = config != null ? config : new Idea171569Config();
