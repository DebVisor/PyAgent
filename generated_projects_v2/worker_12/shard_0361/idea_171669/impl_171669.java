...
@Data
public class Idea171669Config {
    private String name = "idea_171669";
 ...
 */
@Slf4j
public class Idea171669Service {
    private static final int IDEA_ID = 171669;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171669Service() {
        this(new Idea171669Config());
    }

    public Idea171669Service(Idea171669Config config) {
        this.config = config != null ? config : new Idea171669Config();
