...
@Data
public class Idea171514Config {
    private String name = "idea_171514";
 ...
 */
@Slf4j
public class Idea171514Service {
    private static final int IDEA_ID = 171514;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171514Service() {
        this(new Idea171514Config());
    }

    public Idea171514Service(Idea171514Config config) {
        this.config = config != null ? config : new Idea171514Config();
