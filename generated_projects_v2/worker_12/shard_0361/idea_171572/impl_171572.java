...
@Data
public class Idea171572Config {
    private String name = "idea_171572";
 ...
 */
@Slf4j
public class Idea171572Service {
    private static final int IDEA_ID = 171572;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea171572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea171572Service() {
        this(new Idea171572Config());
    }

    public Idea171572Service(Idea171572Config config) {
        this.config = config != null ? config : new Idea171572Config();
