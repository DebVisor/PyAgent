...
@Data
public class Idea177878Config {
    private String name = "idea_177878";
 ...
 */
@Slf4j
public class Idea177878Service {
    private static final int IDEA_ID = 177878;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177878Service() {
        this(new Idea177878Config());
    }

    public Idea177878Service(Idea177878Config config) {
        this.config = config != null ? config : new Idea177878Config();
