...
@Data
public class Idea178094Config {
    private String name = "idea_178094";
 ...
 */
@Slf4j
public class Idea178094Service {
    private static final int IDEA_ID = 178094;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178094Service() {
        this(new Idea178094Config());
    }

    public Idea178094Service(Idea178094Config config) {
        this.config = config != null ? config : new Idea178094Config();
