...
@Data
public class Idea177766Config {
    private String name = "idea_177766";
 ...
 */
@Slf4j
public class Idea177766Service {
    private static final int IDEA_ID = 177766;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177766Service() {
        this(new Idea177766Config());
    }

    public Idea177766Service(Idea177766Config config) {
        this.config = config != null ? config : new Idea177766Config();
