...
@Data
public class Idea177996Config {
    private String name = "idea_177996";
 ...
 */
@Slf4j
public class Idea177996Service {
    private static final int IDEA_ID = 177996;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177996Service() {
        this(new Idea177996Config());
    }

    public Idea177996Service(Idea177996Config config) {
        this.config = config != null ? config : new Idea177996Config();
