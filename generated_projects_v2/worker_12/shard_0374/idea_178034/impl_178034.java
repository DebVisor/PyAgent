...
@Data
public class Idea178034Config {
    private String name = "idea_178034";
 ...
 */
@Slf4j
public class Idea178034Service {
    private static final int IDEA_ID = 178034;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178034Service() {
        this(new Idea178034Config());
    }

    public Idea178034Service(Idea178034Config config) {
        this.config = config != null ? config : new Idea178034Config();
