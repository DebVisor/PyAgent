...
@Data
public class Idea174893Config {
    private String name = "idea_174893";
 ...
 */
@Slf4j
public class Idea174893Service {
    private static final int IDEA_ID = 174893;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174893Service() {
        this(new Idea174893Config());
    }

    public Idea174893Service(Idea174893Config config) {
        this.config = config != null ? config : new Idea174893Config();
