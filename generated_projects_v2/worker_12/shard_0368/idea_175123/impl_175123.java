...
@Data
public class Idea175123Config {
    private String name = "idea_175123";
 ...
 */
@Slf4j
public class Idea175123Service {
    private static final int IDEA_ID = 175123;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175123Service() {
        this(new Idea175123Config());
    }

    public Idea175123Service(Idea175123Config config) {
        this.config = config != null ? config : new Idea175123Config();
