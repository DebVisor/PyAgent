...
@Data
public class Idea175207Config {
    private String name = "idea_175207";
 ...
 */
@Slf4j
public class Idea175207Service {
    private static final int IDEA_ID = 175207;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175207Service() {
        this(new Idea175207Config());
    }

    public Idea175207Service(Idea175207Config config) {
        this.config = config != null ? config : new Idea175207Config();
