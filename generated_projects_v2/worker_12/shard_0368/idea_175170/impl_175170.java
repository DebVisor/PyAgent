...
@Data
public class Idea175170Config {
    private String name = "idea_175170";
 ...
 */
@Slf4j
public class Idea175170Service {
    private static final int IDEA_ID = 175170;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175170Service() {
        this(new Idea175170Config());
    }

    public Idea175170Service(Idea175170Config config) {
        this.config = config != null ? config : new Idea175170Config();
