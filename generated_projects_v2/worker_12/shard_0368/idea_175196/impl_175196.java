...
@Data
public class Idea175196Config {
    private String name = "idea_175196";
 ...
 */
@Slf4j
public class Idea175196Service {
    private static final int IDEA_ID = 175196;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175196Service() {
        this(new Idea175196Config());
    }

    public Idea175196Service(Idea175196Config config) {
        this.config = config != null ? config : new Idea175196Config();
