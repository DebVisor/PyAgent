...
@Data
public class Idea176999Config {
    private String name = "idea_176999";
 ...
 */
@Slf4j
public class Idea176999Service {
    private static final int IDEA_ID = 176999;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea176999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea176999Service() {
        this(new Idea176999Config());
    }

    public Idea176999Service(Idea176999Config config) {
        this.config = config != null ? config : new Idea176999Config();
