...
@Data
public class Idea177094Config {
    private String name = "idea_177094";
 ...
 */
@Slf4j
public class Idea177094Service {
    private static final int IDEA_ID = 177094;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177094Service() {
        this(new Idea177094Config());
    }

    public Idea177094Service(Idea177094Config config) {
        this.config = config != null ? config : new Idea177094Config();
