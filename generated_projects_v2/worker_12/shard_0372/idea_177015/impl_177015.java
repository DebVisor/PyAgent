...
@Data
public class Idea177015Config {
    private String name = "idea_177015";
 ...
 */
@Slf4j
public class Idea177015Service {
    private static final int IDEA_ID = 177015;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177015Service() {
        this(new Idea177015Config());
    }

    public Idea177015Service(Idea177015Config config) {
        this.config = config != null ? config : new Idea177015Config();
