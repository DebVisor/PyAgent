...
@Data
public class Idea177130Config {
    private String name = "idea_177130";
 ...
 */
@Slf4j
public class Idea177130Service {
    private static final int IDEA_ID = 177130;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177130Service() {
        this(new Idea177130Config());
    }

    public Idea177130Service(Idea177130Config config) {
        this.config = config != null ? config : new Idea177130Config();
