...
@Data
public class Idea177058Config {
    private String name = "idea_177058";
 ...
 */
@Slf4j
public class Idea177058Service {
    private static final int IDEA_ID = 177058;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177058Service() {
        this(new Idea177058Config());
    }

    public Idea177058Service(Idea177058Config config) {
        this.config = config != null ? config : new Idea177058Config();
