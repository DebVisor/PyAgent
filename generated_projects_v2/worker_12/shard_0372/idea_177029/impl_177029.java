...
@Data
public class Idea177029Config {
    private String name = "idea_177029";
 ...
 */
@Slf4j
public class Idea177029Service {
    private static final int IDEA_ID = 177029;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177029Service() {
        this(new Idea177029Config());
    }

    public Idea177029Service(Idea177029Config config) {
        this.config = config != null ? config : new Idea177029Config();
