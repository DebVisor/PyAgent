...
@Data
public class Idea176910Config {
    private String name = "idea_176910";
 ...
 */
@Slf4j
public class Idea176910Service {
    private static final int IDEA_ID = 176910;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea176910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea176910Service() {
        this(new Idea176910Config());
    }

    public Idea176910Service(Idea176910Config config) {
        this.config = config != null ? config : new Idea176910Config();
