...
@Data
public class Idea176970Config {
    private String name = "idea_176970";
 ...
 */
@Slf4j
public class Idea176970Service {
    private static final int IDEA_ID = 176970;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea176970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea176970Service() {
        this(new Idea176970Config());
    }

    public Idea176970Service(Idea176970Config config) {
        this.config = config != null ? config : new Idea176970Config();
