...
@Data
public class Idea176939Config {
    private String name = "idea_176939";
 ...
 */
@Slf4j
public class Idea176939Service {
    private static final int IDEA_ID = 176939;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea176939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea176939Service() {
        this(new Idea176939Config());
    }

    public Idea176939Service(Idea176939Config config) {
        this.config = config != null ? config : new Idea176939Config();
