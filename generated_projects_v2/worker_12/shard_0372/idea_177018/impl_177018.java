...
@Data
public class Idea177018Config {
    private String name = "idea_177018";
 ...
 */
@Slf4j
public class Idea177018Service {
    private static final int IDEA_ID = 177018;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177018Service() {
        this(new Idea177018Config());
    }

    public Idea177018Service(Idea177018Config config) {
        this.config = config != null ? config : new Idea177018Config();
