...
@Data
public class Idea177071Config {
    private String name = "idea_177071";
 ...
 */
@Slf4j
public class Idea177071Service {
    private static final int IDEA_ID = 177071;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177071Service() {
        this(new Idea177071Config());
    }

    public Idea177071Service(Idea177071Config config) {
        this.config = config != null ? config : new Idea177071Config();
