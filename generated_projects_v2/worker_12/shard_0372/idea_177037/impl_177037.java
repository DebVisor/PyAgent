...
@Data
public class Idea177037Config {
    private String name = "idea_177037";
 ...
 */
@Slf4j
public class Idea177037Service {
    private static final int IDEA_ID = 177037;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177037Service() {
        this(new Idea177037Config());
    }

    public Idea177037Service(Idea177037Config config) {
        this.config = config != null ? config : new Idea177037Config();
