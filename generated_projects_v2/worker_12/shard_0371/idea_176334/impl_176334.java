...
@Data
public class Idea176334Config {
    private String name = "idea_176334";
 ...
 */
@Slf4j
public class Idea176334Service {
    private static final int IDEA_ID = 176334;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea176334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea176334Service() {
        this(new Idea176334Config());
    }

    public Idea176334Service(Idea176334Config config) {
        this.config = config != null ? config : new Idea176334Config();
