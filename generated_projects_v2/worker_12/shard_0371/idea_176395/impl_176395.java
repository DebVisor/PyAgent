...
@Data
public class Idea176395Config {
    private String name = "idea_176395";
 ...
 */
@Slf4j
public class Idea176395Service {
    private static final int IDEA_ID = 176395;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea176395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea176395Service() {
        this(new Idea176395Config());
    }

    public Idea176395Service(Idea176395Config config) {
        this.config = config != null ? config : new Idea176395Config();
