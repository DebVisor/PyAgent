...
@Data
public class Idea174472Config {
    private String name = "idea_174472";
 ...
 */
@Slf4j
public class Idea174472Service {
    private static final int IDEA_ID = 174472;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174472Service() {
        this(new Idea174472Config());
    }

    public Idea174472Service(Idea174472Config config) {
        this.config = config != null ? config : new Idea174472Config();
