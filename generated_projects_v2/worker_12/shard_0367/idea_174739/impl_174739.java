...
@Data
public class Idea174739Config {
    private String name = "idea_174739";
 ...
 */
@Slf4j
public class Idea174739Service {
    private static final int IDEA_ID = 174739;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174739Service() {
        this(new Idea174739Config());
    }

    public Idea174739Service(Idea174739Config config) {
        this.config = config != null ? config : new Idea174739Config();
