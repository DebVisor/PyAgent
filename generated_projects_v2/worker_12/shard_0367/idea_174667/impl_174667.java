...
@Data
public class Idea174667Config {
    private String name = "idea_174667";
 ...
 */
@Slf4j
public class Idea174667Service {
    private static final int IDEA_ID = 174667;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174667Service() {
        this(new Idea174667Config());
    }

    public Idea174667Service(Idea174667Config config) {
        this.config = config != null ? config : new Idea174667Config();
