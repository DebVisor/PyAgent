...
@Data
public class Idea174604Config {
    private String name = "idea_174604";
 ...
 */
@Slf4j
public class Idea174604Service {
    private static final int IDEA_ID = 174604;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174604Service() {
        this(new Idea174604Config());
    }

    public Idea174604Service(Idea174604Config config) {
        this.config = config != null ? config : new Idea174604Config();
