...
@Data
public class Idea174755Config {
    private String name = "idea_174755";
 ...
 */
@Slf4j
public class Idea174755Service {
    private static final int IDEA_ID = 174755;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174755Service() {
        this(new Idea174755Config());
    }

    public Idea174755Service(Idea174755Config config) {
        this.config = config != null ? config : new Idea174755Config();
