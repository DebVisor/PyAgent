...
@Data
public class Idea174443Config {
    private String name = "idea_174443";
 ...
 */
@Slf4j
public class Idea174443Service {
    private static final int IDEA_ID = 174443;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174443Service() {
        this(new Idea174443Config());
    }

    public Idea174443Service(Idea174443Config config) {
        this.config = config != null ? config : new Idea174443Config();
