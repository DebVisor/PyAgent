...
@Data
public class Idea174648Config {
    private String name = "idea_174648";
 ...
 */
@Slf4j
public class Idea174648Service {
    private static final int IDEA_ID = 174648;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174648Service() {
        this(new Idea174648Config());
    }

    public Idea174648Service(Idea174648Config config) {
        this.config = config != null ? config : new Idea174648Config();
