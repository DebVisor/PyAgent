...
@Data
public class Idea174638Config {
    private String name = "idea_174638";
 ...
 */
@Slf4j
public class Idea174638Service {
    private static final int IDEA_ID = 174638;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174638Service() {
        this(new Idea174638Config());
    }

    public Idea174638Service(Idea174638Config config) {
        this.config = config != null ? config : new Idea174638Config();
