...
@Data
public class Idea174377Config {
    private String name = "idea_174377";
 ...
 */
@Slf4j
public class Idea174377Service {
    private static final int IDEA_ID = 174377;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174377Service() {
        this(new Idea174377Config());
    }

    public Idea174377Service(Idea174377Config config) {
        this.config = config != null ? config : new Idea174377Config();
