...
@Data
public class Idea174728Config {
    private String name = "idea_174728";
 ...
 */
@Slf4j
public class Idea174728Service {
    private static final int IDEA_ID = 174728;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174728Service() {
        this(new Idea174728Config());
    }

    public Idea174728Service(Idea174728Config config) {
        this.config = config != null ? config : new Idea174728Config();
