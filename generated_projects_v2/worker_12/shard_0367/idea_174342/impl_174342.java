...
@Data
public class Idea174342Config {
    private String name = "idea_174342";
 ...
 */
@Slf4j
public class Idea174342Service {
    private static final int IDEA_ID = 174342;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea174342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea174342Service() {
        this(new Idea174342Config());
    }

    public Idea174342Service(Idea174342Config config) {
        this.config = config != null ? config : new Idea174342Config();
