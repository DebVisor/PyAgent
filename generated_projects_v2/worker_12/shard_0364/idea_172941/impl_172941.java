...
@Data
public class Idea172941Config {
    private String name = "idea_172941";
 ...
 */
@Slf4j
public class Idea172941Service {
    private static final int IDEA_ID = 172941;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea172941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea172941Service() {
        this(new Idea172941Config());
    }

    public Idea172941Service(Idea172941Config config) {
        this.config = config != null ? config : new Idea172941Config();
