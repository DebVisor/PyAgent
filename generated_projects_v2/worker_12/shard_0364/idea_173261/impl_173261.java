...
@Data
public class Idea173261Config {
    private String name = "idea_173261";
 ...
 */
@Slf4j
public class Idea173261Service {
    private static final int IDEA_ID = 173261;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea173261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea173261Service() {
        this(new Idea173261Config());
    }

    public Idea173261Service(Idea173261Config config) {
        this.config = config != null ? config : new Idea173261Config();
