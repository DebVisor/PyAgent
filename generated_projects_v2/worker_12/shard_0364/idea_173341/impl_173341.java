...
@Data
public class Idea173341Config {
    private String name = "idea_173341";
 ...
 */
@Slf4j
public class Idea173341Service {
    private static final int IDEA_ID = 173341;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea173341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea173341Service() {
        this(new Idea173341Config());
    }

    public Idea173341Service(Idea173341Config config) {
        this.config = config != null ? config : new Idea173341Config();
