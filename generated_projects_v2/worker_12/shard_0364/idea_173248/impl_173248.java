...
@Data
public class Idea173248Config {
    private String name = "idea_173248";
 ...
 */
@Slf4j
public class Idea173248Service {
    private static final int IDEA_ID = 173248;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea173248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea173248Service() {
        this(new Idea173248Config());
    }

    public Idea173248Service(Idea173248Config config) {
        this.config = config != null ? config : new Idea173248Config();
