...
@Data
public class Idea173176Config {
    private String name = "idea_173176";
 ...
 */
@Slf4j
public class Idea173176Service {
    private static final int IDEA_ID = 173176;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea173176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea173176Service() {
        this(new Idea173176Config());
    }

    public Idea173176Service(Idea173176Config config) {
        this.config = config != null ? config : new Idea173176Config();
