...
@Data
public class Idea172766Config {
    private String name = "idea_172766";
 ...
 */
@Slf4j
public class Idea172766Service {
    private static final int IDEA_ID = 172766;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea172766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea172766Service() {
        this(new Idea172766Config());
    }

    public Idea172766Service(Idea172766Config config) {
        this.config = config != null ? config : new Idea172766Config();
