...
@Data
public class Idea172438Config {
    private String name = "idea_172438";
 ...
 */
@Slf4j
public class Idea172438Service {
    private static final int IDEA_ID = 172438;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea172438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea172438Service() {
        this(new Idea172438Config());
    }

    public Idea172438Service(Idea172438Config config) {
        this.config = config != null ? config : new Idea172438Config();
