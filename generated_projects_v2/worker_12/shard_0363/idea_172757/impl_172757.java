...
@Data
public class Idea172757Config {
    private String name = "idea_172757";
 ...
 */
@Slf4j
public class Idea172757Service {
    private static final int IDEA_ID = 172757;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea172757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea172757Service() {
        this(new Idea172757Config());
    }

    public Idea172757Service(Idea172757Config config) {
        this.config = config != null ? config : new Idea172757Config();
