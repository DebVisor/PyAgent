...
@Data
public class Idea172499Config {
    private String name = "idea_172499";
 ...
 */
@Slf4j
public class Idea172499Service {
    private static final int IDEA_ID = 172499;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea172499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea172499Service() {
        this(new Idea172499Config());
    }

    public Idea172499Service(Idea172499Config config) {
        this.config = config != null ? config : new Idea172499Config();
