...
@Data
public class Idea172727Config {
    private String name = "idea_172727";
 ...
 */
@Slf4j
public class Idea172727Service {
    private static final int IDEA_ID = 172727;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea172727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea172727Service() {
        this(new Idea172727Config());
    }

    public Idea172727Service(Idea172727Config config) {
        this.config = config != null ? config : new Idea172727Config();
