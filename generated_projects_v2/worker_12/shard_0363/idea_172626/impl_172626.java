...
@Data
public class Idea172626Config {
    private String name = "idea_172626";
 ...
 */
@Slf4j
public class Idea172626Service {
    private static final int IDEA_ID = 172626;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea172626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea172626Service() {
        this(new Idea172626Config());
    }

    public Idea172626Service(Idea172626Config config) {
        this.config = config != null ? config : new Idea172626Config();
