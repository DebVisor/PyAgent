...
@Data
public class Idea172725Config {
    private String name = "idea_172725";
 ...
 */
@Slf4j
public class Idea172725Service {
    private static final int IDEA_ID = 172725;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea172725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea172725Service() {
        this(new Idea172725Config());
    }

    public Idea172725Service(Idea172725Config config) {
        this.config = config != null ? config : new Idea172725Config();
