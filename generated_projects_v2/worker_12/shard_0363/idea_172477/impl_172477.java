...
@Data
public class Idea172477Config {
    private String name = "idea_172477";
 ...
 */
@Slf4j
public class Idea172477Service {
    private static final int IDEA_ID = 172477;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea172477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea172477Service() {
        this(new Idea172477Config());
    }

    public Idea172477Service(Idea172477Config config) {
        this.config = config != null ? config : new Idea172477Config();
