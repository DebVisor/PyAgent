...
@Data
public class Idea177560Config {
    private String name = "idea_177560";
 ...
 */
@Slf4j
public class Idea177560Service {
    private static final int IDEA_ID = 177560;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177560Service() {
        this(new Idea177560Config());
    }

    public Idea177560Service(Idea177560Config config) {
        this.config = config != null ? config : new Idea177560Config();
