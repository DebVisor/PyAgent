...
@Data
public class Idea177207Config {
    private String name = "idea_177207";
 ...
 */
@Slf4j
public class Idea177207Service {
    private static final int IDEA_ID = 177207;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177207Service() {
        this(new Idea177207Config());
    }

    public Idea177207Service(Idea177207Config config) {
        this.config = config != null ? config : new Idea177207Config();
