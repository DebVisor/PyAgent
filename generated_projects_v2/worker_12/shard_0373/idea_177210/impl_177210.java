...
@Data
public class Idea177210Config {
    private String name = "idea_177210";
 ...
 */
@Slf4j
public class Idea177210Service {
    private static final int IDEA_ID = 177210;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177210Service() {
        this(new Idea177210Config());
    }

    public Idea177210Service(Idea177210Config config) {
        this.config = config != null ? config : new Idea177210Config();
