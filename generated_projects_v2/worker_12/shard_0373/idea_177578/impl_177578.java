...
@Data
public class Idea177578Config {
    private String name = "idea_177578";
 ...
 */
@Slf4j
public class Idea177578Service {
    private static final int IDEA_ID = 177578;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177578Service() {
        this(new Idea177578Config());
    }

    public Idea177578Service(Idea177578Config config) {
        this.config = config != null ? config : new Idea177578Config();
