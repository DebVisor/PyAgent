...
@Data
public class Idea177487Config {
    private String name = "idea_177487";
 ...
 */
@Slf4j
public class Idea177487Service {
    private static final int IDEA_ID = 177487;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea177487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea177487Service() {
        this(new Idea177487Config());
    }

    public Idea177487Service(Idea177487Config config) {
        this.config = config != null ? config : new Idea177487Config();
