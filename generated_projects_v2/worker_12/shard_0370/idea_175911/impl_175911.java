...
@Data
public class Idea175911Config {
    private String name = "idea_175911";
 ...
 */
@Slf4j
public class Idea175911Service {
    private static final int IDEA_ID = 175911;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175911Service() {
        this(new Idea175911Config());
    }

    public Idea175911Service(Idea175911Config config) {
        this.config = config != null ? config : new Idea175911Config();
