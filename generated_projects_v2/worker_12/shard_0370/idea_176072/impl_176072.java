...
@Data
public class Idea176072Config {
    private String name = "idea_176072";
 ...
 */
@Slf4j
public class Idea176072Service {
    private static final int IDEA_ID = 176072;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea176072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea176072Service() {
        this(new Idea176072Config());
    }

    public Idea176072Service(Idea176072Config config) {
        this.config = config != null ? config : new Idea176072Config();
