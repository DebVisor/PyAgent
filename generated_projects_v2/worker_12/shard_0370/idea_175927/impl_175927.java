...
@Data
public class Idea175927Config {
    private String name = "idea_175927";
 ...
 */
@Slf4j
public class Idea175927Service {
    private static final int IDEA_ID = 175927;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea175927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea175927Service() {
        this(new Idea175927Config());
    }

    public Idea175927Service(Idea175927Config config) {
        this.config = config != null ? config : new Idea175927Config();
