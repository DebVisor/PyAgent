...
@Data
public class Idea178783Config {
    private String name = "idea_178783";
 ...
 */
@Slf4j
public class Idea178783Service {
    private static final int IDEA_ID = 178783;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178783Service() {
        this(new Idea178783Config());
    }

    public Idea178783Service(Idea178783Config config) {
        this.config = config != null ? config : new Idea178783Config();
