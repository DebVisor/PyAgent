...
@Data
public class Idea178900Config {
    private String name = "idea_178900";
 ...
 */
@Slf4j
public class Idea178900Service {
    private static final int IDEA_ID = 178900;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178900Service() {
        this(new Idea178900Config());
    }

    public Idea178900Service(Idea178900Config config) {
        this.config = config != null ? config : new Idea178900Config();
