...
@Data
public class Idea178652Config {
    private String name = "idea_178652";
 ...
 */
@Slf4j
public class Idea178652Service {
    private static final int IDEA_ID = 178652;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178652Service() {
        this(new Idea178652Config());
    }

    public Idea178652Service(Idea178652Config config) {
        this.config = config != null ? config : new Idea178652Config();
