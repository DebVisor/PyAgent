...
@Data
public class Idea178833Config {
    private String name = "idea_178833";
 ...
 */
@Slf4j
public class Idea178833Service {
    private static final int IDEA_ID = 178833;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178833Service() {
        this(new Idea178833Config());
    }

    public Idea178833Service(Idea178833Config config) {
        this.config = config != null ? config : new Idea178833Config();
