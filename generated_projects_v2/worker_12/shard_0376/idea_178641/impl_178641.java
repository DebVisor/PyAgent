...
@Data
public class Idea178641Config {
    private String name = "idea_178641";
 ...
 */
@Slf4j
public class Idea178641Service {
    private static final int IDEA_ID = 178641;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea178641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea178641Service() {
        this(new Idea178641Config());
    }

    public Idea178641Service(Idea178641Config config) {
        this.config = config != null ? config : new Idea178641Config();
