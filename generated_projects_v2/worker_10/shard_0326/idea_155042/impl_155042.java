...
@Data
public class Idea155042Config {
    private String name = "idea_155042";
 ...
 */
@Slf4j
public class Idea155042Service {
    private static final int IDEA_ID = 155042;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea155042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea155042Service() {
        this(new Idea155042Config());
    }

    public Idea155042Service(Idea155042Config config) {
        this.config = config != null ? config : new Idea155042Config();
