...
@Data
public class Idea155305Config {
    private String name = "idea_155305";
 ...
 */
@Slf4j
public class Idea155305Service {
    private static final int IDEA_ID = 155305;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea155305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea155305Service() {
        this(new Idea155305Config());
    }

    public Idea155305Service(Idea155305Config config) {
        this.config = config != null ? config : new Idea155305Config();
