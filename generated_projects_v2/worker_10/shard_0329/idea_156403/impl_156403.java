...
@Data
public class Idea156403Config {
    private String name = "idea_156403";
 ...
 */
@Slf4j
public class Idea156403Service {
    private static final int IDEA_ID = 156403;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea156403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea156403Service() {
        this(new Idea156403Config());
    }

    public Idea156403Service(Idea156403Config config) {
        this.config = config != null ? config : new Idea156403Config();
