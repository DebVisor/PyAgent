...
@Data
public class Idea156513Config {
    private String name = "idea_156513";
 ...
 */
@Slf4j
public class Idea156513Service {
    private static final int IDEA_ID = 156513;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea156513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea156513Service() {
        this(new Idea156513Config());
    }

    public Idea156513Service(Idea156513Config config) {
        this.config = config != null ? config : new Idea156513Config();
