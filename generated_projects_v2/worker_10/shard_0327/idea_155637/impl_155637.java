...
@Data
public class Idea155637Config {
    private String name = "idea_155637";
 ...
 */
@Slf4j
public class Idea155637Service {
    private static final int IDEA_ID = 155637;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea155637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea155637Service() {
        this(new Idea155637Config());
    }

    public Idea155637Service(Idea155637Config config) {
        this.config = config != null ? config : new Idea155637Config();
