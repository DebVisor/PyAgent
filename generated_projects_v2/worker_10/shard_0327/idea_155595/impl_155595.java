...
@Data
public class Idea155595Config {
    private String name = "idea_155595";
 ...
 */
@Slf4j
public class Idea155595Service {
    private static final int IDEA_ID = 155595;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea155595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea155595Service() {
        this(new Idea155595Config());
    }

    public Idea155595Service(Idea155595Config config) {
        this.config = config != null ? config : new Idea155595Config();
