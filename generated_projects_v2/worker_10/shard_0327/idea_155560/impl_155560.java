...
@Data
public class Idea155560Config {
    private String name = "idea_155560";
 ...
 */
@Slf4j
public class Idea155560Service {
    private static final int IDEA_ID = 155560;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea155560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea155560Service() {
        this(new Idea155560Config());
    }

    public Idea155560Service(Idea155560Config config) {
        this.config = config != null ? config : new Idea155560Config();
