...
@Data
public class Idea155444Config {
    private String name = "idea_155444";
 ...
 */
@Slf4j
public class Idea155444Service {
    private static final int IDEA_ID = 155444;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea155444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea155444Service() {
        this(new Idea155444Config());
    }

    public Idea155444Service(Idea155444Config config) {
        this.config = config != null ? config : new Idea155444Config();
