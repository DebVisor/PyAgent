...
@Data
public class Idea155504Config {
    private String name = "idea_155504";
 ...
 */
@Slf4j
public class Idea155504Service {
    private static final int IDEA_ID = 155504;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea155504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea155504Service() {
        this(new Idea155504Config());
    }

    public Idea155504Service(Idea155504Config config) {
        this.config = config != null ? config : new Idea155504Config();
