...
@Data
public class Idea155716Config {
    private String name = "idea_155716";
 ...
 */
@Slf4j
public class Idea155716Service {
    private static final int IDEA_ID = 155716;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea155716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea155716Service() {
        this(new Idea155716Config());
    }

    public Idea155716Service(Idea155716Config config) {
        this.config = config != null ? config : new Idea155716Config();
