...
@Data
public class Idea155921Config {
    private String name = "idea_155921";
 ...
 */
@Slf4j
public class Idea155921Service {
    private static final int IDEA_ID = 155921;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea155921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea155921Service() {
        this(new Idea155921Config());
    }

    public Idea155921Service(Idea155921Config config) {
        this.config = config != null ? config : new Idea155921Config();
