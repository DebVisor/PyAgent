...
@Data
public class Idea156222Config {
    private String name = "idea_156222";
 ...
 */
@Slf4j
public class Idea156222Service {
    private static final int IDEA_ID = 156222;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea156222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea156222Service() {
        this(new Idea156222Config());
    }

    public Idea156222Service(Idea156222Config config) {
        this.config = config != null ? config : new Idea156222Config();
