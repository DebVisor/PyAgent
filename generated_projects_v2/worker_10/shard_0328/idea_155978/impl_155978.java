...
@Data
public class Idea155978Config {
    private String name = "idea_155978";
 ...
 */
@Slf4j
public class Idea155978Service {
    private static final int IDEA_ID = 155978;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea155978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea155978Service() {
        this(new Idea155978Config());
    }

    public Idea155978Service(Idea155978Config config) {
        this.config = config != null ? config : new Idea155978Config();
