...
@Data
public class Idea156099Config {
    private String name = "idea_156099";
 ...
 */
@Slf4j
public class Idea156099Service {
    private static final int IDEA_ID = 156099;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea156099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea156099Service() {
        this(new Idea156099Config());
    }

    public Idea156099Service(Idea156099Config config) {
        this.config = config != null ? config : new Idea156099Config();
