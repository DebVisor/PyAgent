...
@Data
public class Idea156983Config {
    private String name = "idea_156983";
 ...
 */
@Slf4j
public class Idea156983Service {
    private static final int IDEA_ID = 156983;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea156983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea156983Service() {
        this(new Idea156983Config());
    }

    public Idea156983Service(Idea156983Config config) {
        this.config = config != null ? config : new Idea156983Config();
