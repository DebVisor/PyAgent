...
@Data
public class Idea157038Config {
    private String name = "idea_157038";
 ...
 */
@Slf4j
public class Idea157038Service {
    private static final int IDEA_ID = 157038;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea157038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea157038Service() {
        this(new Idea157038Config());
    }

    public Idea157038Service(Idea157038Config config) {
        this.config = config != null ? config : new Idea157038Config();
