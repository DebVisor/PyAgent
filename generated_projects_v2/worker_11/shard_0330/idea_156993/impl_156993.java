...
@Data
public class Idea156993Config {
    private String name = "idea_156993";
 ...
 */
@Slf4j
public class Idea156993Service {
    private static final int IDEA_ID = 156993;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea156993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea156993Service() {
        this(new Idea156993Config());
    }

    public Idea156993Service(Idea156993Config config) {
        this.config = config != null ? config : new Idea156993Config();
