...
@Data
public class Idea161068Config {
    private String name = "idea_161068";
 ...
 */
@Slf4j
public class Idea161068Service {
    private static final int IDEA_ID = 161068;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161068Service() {
        this(new Idea161068Config());
    }

    public Idea161068Service(Idea161068Config config) {
        this.config = config != null ? config : new Idea161068Config();
