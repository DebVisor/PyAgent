...
@Data
public class Idea161178Config {
    private String name = "idea_161178";
 ...
 */
@Slf4j
public class Idea161178Service {
    private static final int IDEA_ID = 161178;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161178Service() {
        this(new Idea161178Config());
    }

    public Idea161178Service(Idea161178Config config) {
        this.config = config != null ? config : new Idea161178Config();
