...
@Data
public class Idea161108Config {
    private String name = "idea_161108";
 ...
 */
@Slf4j
public class Idea161108Service {
    private static final int IDEA_ID = 161108;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161108Service() {
        this(new Idea161108Config());
    }

    public Idea161108Service(Idea161108Config config) {
        this.config = config != null ? config : new Idea161108Config();
