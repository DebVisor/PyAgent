...
@Data
public class Idea161373Config {
    private String name = "idea_161373";
 ...
 */
@Slf4j
public class Idea161373Service {
    private static final int IDEA_ID = 161373;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161373Service() {
        this(new Idea161373Config());
    }

    public Idea161373Service(Idea161373Config config) {
        this.config = config != null ? config : new Idea161373Config();
