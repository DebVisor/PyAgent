...
@Data
public class Idea170198Config {
    private String name = "idea_170198";
 ...
 */
@Slf4j
public class Idea170198Service {
    private static final int IDEA_ID = 170198;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea170198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea170198Service() {
        this(new Idea170198Config());
    }

    public Idea170198Service(Idea170198Config config) {
        this.config = config != null ? config : new Idea170198Config();
