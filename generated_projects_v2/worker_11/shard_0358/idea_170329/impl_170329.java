...
@Data
public class Idea170329Config {
    private String name = "idea_170329";
 ...
 */
@Slf4j
public class Idea170329Service {
    private static final int IDEA_ID = 170329;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea170329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea170329Service() {
        this(new Idea170329Config());
    }

    public Idea170329Service(Idea170329Config config) {
        this.config = config != null ? config : new Idea170329Config();
