...
@Data
public class Idea170301Config {
    private String name = "idea_170301";
 ...
 */
@Slf4j
public class Idea170301Service {
    private static final int IDEA_ID = 170301;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea170301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea170301Service() {
        this(new Idea170301Config());
    }

    public Idea170301Service(Idea170301Config config) {
        this.config = config != null ? config : new Idea170301Config();
