...
@Data
public class Idea170353Config {
    private String name = "idea_170353";
 ...
 */
@Slf4j
public class Idea170353Service {
    private static final int IDEA_ID = 170353;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea170353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea170353Service() {
        this(new Idea170353Config());
    }

    public Idea170353Service(Idea170353Config config) {
        this.config = config != null ? config : new Idea170353Config();
