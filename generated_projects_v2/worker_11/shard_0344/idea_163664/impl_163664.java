...
@Data
public class Idea163664Config {
    private String name = "idea_163664";
 ...
 */
@Slf4j
public class Idea163664Service {
    private static final int IDEA_ID = 163664;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea163664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea163664Service() {
        this(new Idea163664Config());
    }

    public Idea163664Service(Idea163664Config config) {
        this.config = config != null ? config : new Idea163664Config();
