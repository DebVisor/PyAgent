...
@Data
public class Idea163708Config {
    private String name = "idea_163708";
 ...
 */
@Slf4j
public class Idea163708Service {
    private static final int IDEA_ID = 163708;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea163708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea163708Service() {
        this(new Idea163708Config());
    }

    public Idea163708Service(Idea163708Config config) {
        this.config = config != null ? config : new Idea163708Config();
