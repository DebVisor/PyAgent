...
@Data
public class Idea163704Config {
    private String name = "idea_163704";
 ...
 */
@Slf4j
public class Idea163704Service {
    private static final int IDEA_ID = 163704;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea163704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea163704Service() {
        this(new Idea163704Config());
    }

    public Idea163704Service(Idea163704Config config) {
        this.config = config != null ? config : new Idea163704Config();
