...
@Data
public class Idea163778Config {
    private String name = "idea_163778";
 ...
 */
@Slf4j
public class Idea163778Service {
    private static final int IDEA_ID = 163778;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea163778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea163778Service() {
        this(new Idea163778Config());
    }

    public Idea163778Service(Idea163778Config config) {
        this.config = config != null ? config : new Idea163778Config();
