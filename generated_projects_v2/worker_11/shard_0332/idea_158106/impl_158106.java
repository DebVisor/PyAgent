...
@Data
public class Idea158106Config {
    private String name = "idea_158106";
 ...
 */
@Slf4j
public class Idea158106Service {
    private static final int IDEA_ID = 158106;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158106Service() {
        this(new Idea158106Config());
    }

    public Idea158106Service(Idea158106Config config) {
        this.config = config != null ? config : new Idea158106Config();
