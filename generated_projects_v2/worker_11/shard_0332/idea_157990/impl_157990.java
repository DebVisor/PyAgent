...
@Data
public class Idea157990Config {
    private String name = "idea_157990";
 ...
 */
@Slf4j
public class Idea157990Service {
    private static final int IDEA_ID = 157990;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea157990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea157990Service() {
        this(new Idea157990Config());
    }

    public Idea157990Service(Idea157990Config config) {
        this.config = config != null ? config : new Idea157990Config();
