...
@Data
public class Idea161650Config {
    private String name = "idea_161650";
 ...
 */
@Slf4j
public class Idea161650Service {
    private static final int IDEA_ID = 161650;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161650Service() {
        this(new Idea161650Config());
    }

    public Idea161650Service(Idea161650Config config) {
        this.config = config != null ? config : new Idea161650Config();
