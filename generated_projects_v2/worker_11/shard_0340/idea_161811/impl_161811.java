...
@Data
public class Idea161811Config {
    private String name = "idea_161811";
 ...
 */
@Slf4j
public class Idea161811Service {
    private static final int IDEA_ID = 161811;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161811Service() {
        this(new Idea161811Config());
    }

    public Idea161811Service(Idea161811Config config) {
        this.config = config != null ? config : new Idea161811Config();
