...
@Data
public class Idea161760Config {
    private String name = "idea_161760";
 ...
 */
@Slf4j
public class Idea161760Service {
    private static final int IDEA_ID = 161760;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161760Service() {
        this(new Idea161760Config());
    }

    public Idea161760Service(Idea161760Config config) {
        this.config = config != null ? config : new Idea161760Config();
