...
@Data
public class Idea161958Config {
    private String name = "idea_161958";
 ...
 */
@Slf4j
public class Idea161958Service {
    private static final int IDEA_ID = 161958;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161958Service() {
        this(new Idea161958Config());
    }

    public Idea161958Service(Idea161958Config config) {
        this.config = config != null ? config : new Idea161958Config();
