...
@Data
public class Idea161714Config {
    private String name = "idea_161714";
 ...
 */
@Slf4j
public class Idea161714Service {
    private static final int IDEA_ID = 161714;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161714Service() {
        this(new Idea161714Config());
    }

    public Idea161714Service(Idea161714Config config) {
        this.config = config != null ? config : new Idea161714Config();
