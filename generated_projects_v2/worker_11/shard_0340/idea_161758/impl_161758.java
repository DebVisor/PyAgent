...
@Data
public class Idea161758Config {
    private String name = "idea_161758";
 ...
 */
@Slf4j
public class Idea161758Service {
    private static final int IDEA_ID = 161758;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161758Service() {
        this(new Idea161758Config());
    }

    public Idea161758Service(Idea161758Config config) {
        this.config = config != null ? config : new Idea161758Config();
