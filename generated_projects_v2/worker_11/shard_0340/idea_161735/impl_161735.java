...
@Data
public class Idea161735Config {
    private String name = "idea_161735";
 ...
 */
@Slf4j
public class Idea161735Service {
    private static final int IDEA_ID = 161735;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161735Service() {
        this(new Idea161735Config());
    }

    public Idea161735Service(Idea161735Config config) {
        this.config = config != null ? config : new Idea161735Config();
