...
@Data
public class Idea161769Config {
    private String name = "idea_161769";
 ...
 */
@Slf4j
public class Idea161769Service {
    private static final int IDEA_ID = 161769;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161769Service() {
        this(new Idea161769Config());
    }

    public Idea161769Service(Idea161769Config config) {
        this.config = config != null ? config : new Idea161769Config();
