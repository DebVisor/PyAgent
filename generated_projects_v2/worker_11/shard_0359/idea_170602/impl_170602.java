...
@Data
public class Idea170602Config {
    private String name = "idea_170602";
 ...
 */
@Slf4j
public class Idea170602Service {
    private static final int IDEA_ID = 170602;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea170602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea170602Service() {
        this(new Idea170602Config());
    }

    public Idea170602Service(Idea170602Config config) {
        this.config = config != null ? config : new Idea170602Config();
