...
@Data
public class Idea170734Config {
    private String name = "idea_170734";
 ...
 */
@Slf4j
public class Idea170734Service {
    private static final int IDEA_ID = 170734;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea170734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea170734Service() {
        this(new Idea170734Config());
    }

    public Idea170734Service(Idea170734Config config) {
        this.config = config != null ? config : new Idea170734Config();
