...
@Data
public class Idea170988Config {
    private String name = "idea_170988";
 ...
 */
@Slf4j
public class Idea170988Service {
    private static final int IDEA_ID = 170988;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea170988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea170988Service() {
        this(new Idea170988Config());
    }

    public Idea170988Service(Idea170988Config config) {
        this.config = config != null ? config : new Idea170988Config();
