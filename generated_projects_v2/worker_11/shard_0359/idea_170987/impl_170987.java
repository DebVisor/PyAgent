...
@Data
public class Idea170987Config {
    private String name = "idea_170987";
 ...
 */
@Slf4j
public class Idea170987Service {
    private static final int IDEA_ID = 170987;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea170987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea170987Service() {
        this(new Idea170987Config());
    }

    public Idea170987Service(Idea170987Config config) {
        this.config = config != null ? config : new Idea170987Config();
