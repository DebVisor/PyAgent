...
@Data
public class Idea162897Config {
    private String name = "idea_162897";
 ...
 */
@Slf4j
public class Idea162897Service {
    private static final int IDEA_ID = 162897;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea162897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea162897Service() {
        this(new Idea162897Config());
    }

    public Idea162897Service(Idea162897Config config) {
        this.config = config != null ? config : new Idea162897Config();
