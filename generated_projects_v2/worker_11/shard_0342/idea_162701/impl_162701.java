...
@Data
public class Idea162701Config {
    private String name = "idea_162701";
 ...
 */
@Slf4j
public class Idea162701Service {
    private static final int IDEA_ID = 162701;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea162701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea162701Service() {
        this(new Idea162701Config());
    }

    public Idea162701Service(Idea162701Config config) {
        this.config = config != null ? config : new Idea162701Config();
