...
@Data
public class Idea165716Config {
    private String name = "idea_165716";
 ...
 */
@Slf4j
public class Idea165716Service {
    private static final int IDEA_ID = 165716;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea165716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea165716Service() {
        this(new Idea165716Config());
    }

    public Idea165716Service(Idea165716Config config) {
        this.config = config != null ? config : new Idea165716Config();
