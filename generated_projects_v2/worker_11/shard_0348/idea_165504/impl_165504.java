...
@Data
public class Idea165504Config {
    private String name = "idea_165504";
 ...
 */
@Slf4j
public class Idea165504Service {
    private static final int IDEA_ID = 165504;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea165504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea165504Service() {
        this(new Idea165504Config());
    }

    public Idea165504Service(Idea165504Config config) {
        this.config = config != null ? config : new Idea165504Config();
