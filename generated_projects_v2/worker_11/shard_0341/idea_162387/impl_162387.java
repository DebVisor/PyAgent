...
@Data
public class Idea162387Config {
    private String name = "idea_162387";
 ...
 */
@Slf4j
public class Idea162387Service {
    private static final int IDEA_ID = 162387;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea162387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea162387Service() {
        this(new Idea162387Config());
    }

    public Idea162387Service(Idea162387Config config) {
        this.config = config != null ? config : new Idea162387Config();
