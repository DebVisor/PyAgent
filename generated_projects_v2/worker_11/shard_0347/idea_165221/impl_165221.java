...
@Data
public class Idea165221Config {
    private String name = "idea_165221";
 ...
 */
@Slf4j
public class Idea165221Service {
    private static final int IDEA_ID = 165221;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea165221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea165221Service() {
        this(new Idea165221Config());
    }

    public Idea165221Service(Idea165221Config config) {
        this.config = config != null ? config : new Idea165221Config();
