...
@Data
public class Idea164837Config {
    private String name = "idea_164837";
 ...
 */
@Slf4j
public class Idea164837Service {
    private static final int IDEA_ID = 164837;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea164837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea164837Service() {
        this(new Idea164837Config());
    }

    public Idea164837Service(Idea164837Config config) {
        this.config = config != null ? config : new Idea164837Config();
