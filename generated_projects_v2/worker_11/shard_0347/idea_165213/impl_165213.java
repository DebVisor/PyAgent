...
@Data
public class Idea165213Config {
    private String name = "idea_165213";
 ...
 */
@Slf4j
public class Idea165213Service {
    private static final int IDEA_ID = 165213;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea165213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea165213Service() {
        this(new Idea165213Config());
    }

    public Idea165213Service(Idea165213Config config) {
        this.config = config != null ? config : new Idea165213Config();
