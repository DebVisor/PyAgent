...
@Data
public class Idea158301Config {
    private String name = "idea_158301";
 ...
 */
@Slf4j
public class Idea158301Service {
    private static final int IDEA_ID = 158301;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158301Service() {
        this(new Idea158301Config());
    }

    public Idea158301Service(Idea158301Config config) {
        this.config = config != null ? config : new Idea158301Config();
