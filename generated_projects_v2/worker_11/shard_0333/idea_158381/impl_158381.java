...
@Data
public class Idea158381Config {
    private String name = "idea_158381";
 ...
 */
@Slf4j
public class Idea158381Service {
    private static final int IDEA_ID = 158381;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158381Service() {
        this(new Idea158381Config());
    }

    public Idea158381Service(Idea158381Config config) {
        this.config = config != null ? config : new Idea158381Config();
