...
@Data
public class Idea158180Config {
    private String name = "idea_158180";
 ...
 */
@Slf4j
public class Idea158180Service {
    private static final int IDEA_ID = 158180;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158180Service() {
        this(new Idea158180Config());
    }

    public Idea158180Service(Idea158180Config config) {
        this.config = config != null ? config : new Idea158180Config();
