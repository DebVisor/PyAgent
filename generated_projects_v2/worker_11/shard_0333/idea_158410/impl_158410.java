...
@Data
public class Idea158410Config {
    private String name = "idea_158410";
 ...
 */
@Slf4j
public class Idea158410Service {
    private static final int IDEA_ID = 158410;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158410Service() {
        this(new Idea158410Config());
    }

    public Idea158410Service(Idea158410Config config) {
        this.config = config != null ? config : new Idea158410Config();
