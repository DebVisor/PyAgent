...
@Data
public class Idea158526Config {
    private String name = "idea_158526";
 ...
 */
@Slf4j
public class Idea158526Service {
    private static final int IDEA_ID = 158526;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158526Service() {
        this(new Idea158526Config());
    }

    public Idea158526Service(Idea158526Config config) {
        this.config = config != null ? config : new Idea158526Config();
