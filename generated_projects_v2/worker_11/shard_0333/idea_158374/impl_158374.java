...
@Data
public class Idea158374Config {
    private String name = "idea_158374";
 ...
 */
@Slf4j
public class Idea158374Service {
    private static final int IDEA_ID = 158374;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158374Service() {
        this(new Idea158374Config());
    }

    public Idea158374Service(Idea158374Config config) {
        this.config = config != null ? config : new Idea158374Config();
