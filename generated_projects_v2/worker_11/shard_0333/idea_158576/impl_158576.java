...
@Data
public class Idea158576Config {
    private String name = "idea_158576";
 ...
 */
@Slf4j
public class Idea158576Service {
    private static final int IDEA_ID = 158576;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158576Service() {
        this(new Idea158576Config());
    }

    public Idea158576Service(Idea158576Config config) {
        this.config = config != null ? config : new Idea158576Config();
