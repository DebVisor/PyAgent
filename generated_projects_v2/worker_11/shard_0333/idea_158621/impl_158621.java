...
@Data
public class Idea158621Config {
    private String name = "idea_158621";
 ...
 */
@Slf4j
public class Idea158621Service {
    private static final int IDEA_ID = 158621;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158621Service() {
        this(new Idea158621Config());
    }

    public Idea158621Service(Idea158621Config config) {
        this.config = config != null ? config : new Idea158621Config();
