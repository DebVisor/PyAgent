...
@Data
public class Idea158638Config {
    private String name = "idea_158638";
 ...
 */
@Slf4j
public class Idea158638Service {
    private static final int IDEA_ID = 158638;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158638Service() {
        this(new Idea158638Config());
    }

    public Idea158638Service(Idea158638Config config) {
        this.config = config != null ? config : new Idea158638Config();
