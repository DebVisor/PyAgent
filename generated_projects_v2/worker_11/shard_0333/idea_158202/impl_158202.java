...
@Data
public class Idea158202Config {
    private String name = "idea_158202";
 ...
 */
@Slf4j
public class Idea158202Service {
    private static final int IDEA_ID = 158202;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158202Service() {
        this(new Idea158202Config());
    }

    public Idea158202Service(Idea158202Config config) {
        this.config = config != null ? config : new Idea158202Config();
