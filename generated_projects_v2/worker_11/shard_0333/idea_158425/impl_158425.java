...
@Data
public class Idea158425Config {
    private String name = "idea_158425";
 ...
 */
@Slf4j
public class Idea158425Service {
    private static final int IDEA_ID = 158425;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158425Service() {
        this(new Idea158425Config());
    }

    public Idea158425Service(Idea158425Config config) {
        this.config = config != null ? config : new Idea158425Config();
