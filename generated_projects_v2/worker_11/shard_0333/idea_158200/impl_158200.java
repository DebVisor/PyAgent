...
@Data
public class Idea158200Config {
    private String name = "idea_158200";
 ...
 */
@Slf4j
public class Idea158200Service {
    private static final int IDEA_ID = 158200;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158200Service() {
        this(new Idea158200Config());
    }

    public Idea158200Service(Idea158200Config config) {
        this.config = config != null ? config : new Idea158200Config();
