...
@Data
public class Idea157446Config {
    private String name = "idea_157446";
 ...
 */
@Slf4j
public class Idea157446Service {
    private static final int IDEA_ID = 157446;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea157446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea157446Service() {
        this(new Idea157446Config());
    }

    public Idea157446Service(Idea157446Config config) {
        this.config = config != null ? config : new Idea157446Config();
