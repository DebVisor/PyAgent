...
@Data
public class Idea169784Config {
    private String name = "idea_169784";
 ...
 */
@Slf4j
public class Idea169784Service {
    private static final int IDEA_ID = 169784;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea169784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea169784Service() {
        this(new Idea169784Config());
    }

    public Idea169784Service(Idea169784Config config) {
        this.config = config != null ? config : new Idea169784Config();
