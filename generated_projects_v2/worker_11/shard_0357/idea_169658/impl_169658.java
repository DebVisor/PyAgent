...
@Data
public class Idea169658Config {
    private String name = "idea_169658";
 ...
 */
@Slf4j
public class Idea169658Service {
    private static final int IDEA_ID = 169658;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea169658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea169658Service() {
        this(new Idea169658Config());
    }

    public Idea169658Service(Idea169658Config config) {
        this.config = config != null ? config : new Idea169658Config();
