...
@Data
public class Idea169951Config {
    private String name = "idea_169951";
 ...
 */
@Slf4j
public class Idea169951Service {
    private static final int IDEA_ID = 169951;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea169951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea169951Service() {
        this(new Idea169951Config());
    }

    public Idea169951Service(Idea169951Config config) {
        this.config = config != null ? config : new Idea169951Config();
