...
@Data
public class Idea169581Config {
    private String name = "idea_169581";
 ...
 */
@Slf4j
public class Idea169581Service {
    private static final int IDEA_ID = 169581;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea169581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea169581Service() {
        this(new Idea169581Config());
    }

    public Idea169581Service(Idea169581Config config) {
        this.config = config != null ? config : new Idea169581Config();
