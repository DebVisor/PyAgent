...
@Data
public class Idea169966Config {
    private String name = "idea_169966";
 ...
 */
@Slf4j
public class Idea169966Service {
    private static final int IDEA_ID = 169966;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea169966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea169966Service() {
        this(new Idea169966Config());
    }

    public Idea169966Service(Idea169966Config config) {
        this.config = config != null ? config : new Idea169966Config();
