...
@Data
public class Idea169593Config {
    private String name = "idea_169593";
 ...
 */
@Slf4j
public class Idea169593Service {
    private static final int IDEA_ID = 169593;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea169593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea169593Service() {
        this(new Idea169593Config());
    }

    public Idea169593Service(Idea169593Config config) {
        this.config = config != null ? config : new Idea169593Config();
