...
@Data
public class Idea169860Config {
    private String name = "idea_169860";
 ...
 */
@Slf4j
public class Idea169860Service {
    private static final int IDEA_ID = 169860;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea169860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea169860Service() {
        this(new Idea169860Config());
    }

    public Idea169860Service(Idea169860Config config) {
        this.config = config != null ? config : new Idea169860Config();
