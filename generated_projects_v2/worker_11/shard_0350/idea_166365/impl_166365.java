...
@Data
public class Idea166365Config {
    private String name = "idea_166365";
 ...
 */
@Slf4j
public class Idea166365Service {
    private static final int IDEA_ID = 166365;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166365Service() {
        this(new Idea166365Config());
    }

    public Idea166365Service(Idea166365Config config) {
        this.config = config != null ? config : new Idea166365Config();
