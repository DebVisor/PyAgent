...
@Data
public class Idea166385Config {
    private String name = "idea_166385";
 ...
 */
@Slf4j
public class Idea166385Service {
    private static final int IDEA_ID = 166385;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166385Service() {
        this(new Idea166385Config());
    }

    public Idea166385Service(Idea166385Config config) {
        this.config = config != null ? config : new Idea166385Config();
