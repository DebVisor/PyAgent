...
@Data
public class Idea166304Config {
    private String name = "idea_166304";
 ...
 */
@Slf4j
public class Idea166304Service {
    private static final int IDEA_ID = 166304;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166304Service() {
        this(new Idea166304Config());
    }

    public Idea166304Service(Idea166304Config config) {
        this.config = config != null ? config : new Idea166304Config();
