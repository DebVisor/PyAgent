...
@Data
public class Idea164473Config {
    private String name = "idea_164473";
 ...
 */
@Slf4j
public class Idea164473Service {
    private static final int IDEA_ID = 164473;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea164473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea164473Service() {
        this(new Idea164473Config());
    }

    public Idea164473Service(Idea164473Config config) {
        this.config = config != null ? config : new Idea164473Config();
