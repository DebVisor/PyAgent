...
@Data
public class Idea164408Config {
    private String name = "idea_164408";
 ...
 */
@Slf4j
public class Idea164408Service {
    private static final int IDEA_ID = 164408;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea164408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea164408Service() {
        this(new Idea164408Config());
    }

    public Idea164408Service(Idea164408Config config) {
        this.config = config != null ? config : new Idea164408Config();
