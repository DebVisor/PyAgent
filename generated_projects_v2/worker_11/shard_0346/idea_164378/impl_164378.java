...
@Data
public class Idea164378Config {
    private String name = "idea_164378";
 ...
 */
@Slf4j
public class Idea164378Service {
    private static final int IDEA_ID = 164378;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea164378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea164378Service() {
        this(new Idea164378Config());
    }

    public Idea164378Service(Idea164378Config config) {
        this.config = config != null ? config : new Idea164378Config();
