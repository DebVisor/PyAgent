...
@Data
public class Idea169403Config {
    private String name = "idea_169403";
 ...
 */
@Slf4j
public class Idea169403Service {
    private static final int IDEA_ID = 169403;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea169403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea169403Service() {
        this(new Idea169403Config());
    }

    public Idea169403Service(Idea169403Config config) {
        this.config = config != null ? config : new Idea169403Config();
