...
@Data
public class Idea169208Config {
    private String name = "idea_169208";
 ...
 */
@Slf4j
public class Idea169208Service {
    private static final int IDEA_ID = 169208;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea169208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea169208Service() {
        this(new Idea169208Config());
    }

    public Idea169208Service(Idea169208Config config) {
        this.config = config != null ? config : new Idea169208Config();
