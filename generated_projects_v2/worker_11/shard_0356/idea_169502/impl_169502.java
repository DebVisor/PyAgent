...
@Data
public class Idea169502Config {
    private String name = "idea_169502";
 ...
 */
@Slf4j
public class Idea169502Service {
    private static final int IDEA_ID = 169502;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea169502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea169502Service() {
        this(new Idea169502Config());
    }

    public Idea169502Service(Idea169502Config config) {
        this.config = config != null ? config : new Idea169502Config();
