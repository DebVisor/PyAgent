...
@Data
public class Idea169565Config {
    private String name = "idea_169565";
 ...
 */
@Slf4j
public class Idea169565Service {
    private static final int IDEA_ID = 169565;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea169565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea169565Service() {
        this(new Idea169565Config());
    }

    public Idea169565Service(Idea169565Config config) {
        this.config = config != null ? config : new Idea169565Config();
