...
@Data
public class Idea166938Config {
    private String name = "idea_166938";
 ...
 */
@Slf4j
public class Idea166938Service {
    private static final int IDEA_ID = 166938;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166938Service() {
        this(new Idea166938Config());
    }

    public Idea166938Service(Idea166938Config config) {
        this.config = config != null ? config : new Idea166938Config();
