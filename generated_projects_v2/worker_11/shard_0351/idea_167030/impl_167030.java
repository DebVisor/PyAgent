...
@Data
public class Idea167030Config {
    private String name = "idea_167030";
 ...
 */
@Slf4j
public class Idea167030Service {
    private static final int IDEA_ID = 167030;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167030Service() {
        this(new Idea167030Config());
    }

    public Idea167030Service(Idea167030Config config) {
        this.config = config != null ? config : new Idea167030Config();
