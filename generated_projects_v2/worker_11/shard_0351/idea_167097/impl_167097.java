...
@Data
public class Idea167097Config {
    private String name = "idea_167097";
 ...
 */
@Slf4j
public class Idea167097Service {
    private static final int IDEA_ID = 167097;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167097Service() {
        this(new Idea167097Config());
    }

    public Idea167097Service(Idea167097Config config) {
        this.config = config != null ? config : new Idea167097Config();
