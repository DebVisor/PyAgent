...
@Data
public class Idea166772Config {
    private String name = "idea_166772";
 ...
 */
@Slf4j
public class Idea166772Service {
    private static final int IDEA_ID = 166772;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166772Service() {
        this(new Idea166772Config());
    }

    public Idea166772Service(Idea166772Config config) {
        this.config = config != null ? config : new Idea166772Config();
