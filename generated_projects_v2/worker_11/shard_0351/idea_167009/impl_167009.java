...
@Data
public class Idea167009Config {
    private String name = "idea_167009";
 ...
 */
@Slf4j
public class Idea167009Service {
    private static final int IDEA_ID = 167009;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167009Service() {
        this(new Idea167009Config());
    }

    public Idea167009Service(Idea167009Config config) {
        this.config = config != null ? config : new Idea167009Config();
