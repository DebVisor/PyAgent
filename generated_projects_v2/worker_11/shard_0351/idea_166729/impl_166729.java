...
@Data
public class Idea166729Config {
    private String name = "idea_166729";
 ...
 */
@Slf4j
public class Idea166729Service {
    private static final int IDEA_ID = 166729;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166729Service() {
        this(new Idea166729Config());
    }

    public Idea166729Service(Idea166729Config config) {
        this.config = config != null ? config : new Idea166729Config();
