...
@Data
public class Idea166962Config {
    private String name = "idea_166962";
 ...
 */
@Slf4j
public class Idea166962Service {
    private static final int IDEA_ID = 166962;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166962Service() {
        this(new Idea166962Config());
    }

    public Idea166962Service(Idea166962Config config) {
        this.config = config != null ? config : new Idea166962Config();
