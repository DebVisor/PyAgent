...
@Data
public class Idea167018Config {
    private String name = "idea_167018";
 ...
 */
@Slf4j
public class Idea167018Service {
    private static final int IDEA_ID = 167018;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167018Service() {
        this(new Idea167018Config());
    }

    public Idea167018Service(Idea167018Config config) {
        this.config = config != null ? config : new Idea167018Config();
