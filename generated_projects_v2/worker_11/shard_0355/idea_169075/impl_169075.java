...
@Data
public class Idea169075Config {
    private String name = "idea_169075";
 ...
 */
@Slf4j
public class Idea169075Service {
    private static final int IDEA_ID = 169075;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea169075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea169075Service() {
        this(new Idea169075Config());
    }

    public Idea169075Service(Idea169075Config config) {
        this.config = config != null ? config : new Idea169075Config();
