...
@Data
public class Idea168693Config {
    private String name = "idea_168693";
 ...
 */
@Slf4j
public class Idea168693Service {
    private static final int IDEA_ID = 168693;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168693Service() {
        this(new Idea168693Config());
    }

    public Idea168693Service(Idea168693Config config) {
        this.config = config != null ? config : new Idea168693Config();
