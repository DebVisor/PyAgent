...
@Data
public class Idea168627Config {
    private String name = "idea_168627";
 ...
 */
@Slf4j
public class Idea168627Service {
    private static final int IDEA_ID = 168627;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168627Service() {
        this(new Idea168627Config());
    }

    public Idea168627Service(Idea168627Config config) {
        this.config = config != null ? config : new Idea168627Config();
