...
@Data
public class Idea168903Config {
    private String name = "idea_168903";
 ...
 */
@Slf4j
public class Idea168903Service {
    private static final int IDEA_ID = 168903;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168903Service() {
        this(new Idea168903Config());
    }

    public Idea168903Service(Idea168903Config config) {
        this.config = config != null ? config : new Idea168903Config();
