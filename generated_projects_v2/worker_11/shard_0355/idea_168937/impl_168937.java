...
@Data
public class Idea168937Config {
    private String name = "idea_168937";
 ...
 */
@Slf4j
public class Idea168937Service {
    private static final int IDEA_ID = 168937;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168937Service() {
        this(new Idea168937Config());
    }

    public Idea168937Service(Idea168937Config config) {
        this.config = config != null ? config : new Idea168937Config();
