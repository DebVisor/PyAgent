...
@Data
public class Idea168949Config {
    private String name = "idea_168949";
 ...
 */
@Slf4j
public class Idea168949Service {
    private static final int IDEA_ID = 168949;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168949Service() {
        this(new Idea168949Config());
    }

    public Idea168949Service(Idea168949Config config) {
        this.config = config != null ? config : new Idea168949Config();
