...
@Data
public class Idea168900Config {
    private String name = "idea_168900";
 ...
 */
@Slf4j
public class Idea168900Service {
    private static final int IDEA_ID = 168900;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168900Service() {
        this(new Idea168900Config());
    }

    public Idea168900Service(Idea168900Config config) {
        this.config = config != null ? config : new Idea168900Config();
