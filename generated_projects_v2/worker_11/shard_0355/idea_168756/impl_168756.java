...
@Data
public class Idea168756Config {
    private String name = "idea_168756";
 ...
 */
@Slf4j
public class Idea168756Service {
    private static final int IDEA_ID = 168756;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168756Service() {
        this(new Idea168756Config());
    }

    public Idea168756Service(Idea168756Config config) {
        this.config = config != null ? config : new Idea168756Config();
