...
@Data
public class Idea168224Config {
    private String name = "idea_168224";
 ...
 */
@Slf4j
public class Idea168224Service {
    private static final int IDEA_ID = 168224;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168224Service() {
        this(new Idea168224Config());
    }

    public Idea168224Service(Idea168224Config config) {
        this.config = config != null ? config : new Idea168224Config();
