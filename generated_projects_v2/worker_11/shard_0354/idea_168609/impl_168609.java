...
@Data
public class Idea168609Config {
    private String name = "idea_168609";
 ...
 */
@Slf4j
public class Idea168609Service {
    private static final int IDEA_ID = 168609;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168609Service() {
        this(new Idea168609Config());
    }

    public Idea168609Service(Idea168609Config config) {
        this.config = config != null ? config : new Idea168609Config();
