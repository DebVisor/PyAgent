...
@Data
public class Idea168402Config {
    private String name = "idea_168402";
 ...
 */
@Slf4j
public class Idea168402Service {
    private static final int IDEA_ID = 168402;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168402Service() {
        this(new Idea168402Config());
    }

    public Idea168402Service(Idea168402Config config) {
        this.config = config != null ? config : new Idea168402Config();
