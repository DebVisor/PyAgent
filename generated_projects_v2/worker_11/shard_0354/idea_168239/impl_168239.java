...
@Data
public class Idea168239Config {
    private String name = "idea_168239";
 ...
 */
@Slf4j
public class Idea168239Service {
    private static final int IDEA_ID = 168239;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168239Service() {
        this(new Idea168239Config());
    }

    public Idea168239Service(Idea168239Config config) {
        this.config = config != null ? config : new Idea168239Config();
