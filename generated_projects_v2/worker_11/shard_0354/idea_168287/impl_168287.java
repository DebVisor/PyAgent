...
@Data
public class Idea168287Config {
    private String name = "idea_168287";
 ...
 */
@Slf4j
public class Idea168287Service {
    private static final int IDEA_ID = 168287;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168287Service() {
        this(new Idea168287Config());
    }

    public Idea168287Service(Idea168287Config config) {
        this.config = config != null ? config : new Idea168287Config();
