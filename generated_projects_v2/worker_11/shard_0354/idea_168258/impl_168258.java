...
@Data
public class Idea168258Config {
    private String name = "idea_168258";
 ...
 */
@Slf4j
public class Idea168258Service {
    private static final int IDEA_ID = 168258;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168258Service() {
        this(new Idea168258Config());
    }

    public Idea168258Service(Idea168258Config config) {
        this.config = config != null ? config : new Idea168258Config();
