...
@Data
public class Idea168256Config {
    private String name = "idea_168256";
 ...
 */
@Slf4j
public class Idea168256Service {
    private static final int IDEA_ID = 168256;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168256Service() {
        this(new Idea168256Config());
    }

    public Idea168256Service(Idea168256Config config) {
        this.config = config != null ? config : new Idea168256Config();
