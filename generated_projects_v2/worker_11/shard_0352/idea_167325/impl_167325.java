...
@Data
public class Idea167325Config {
    private String name = "idea_167325";
 ...
 */
@Slf4j
public class Idea167325Service {
    private static final int IDEA_ID = 167325;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167325Service() {
        this(new Idea167325Config());
    }

    public Idea167325Service(Idea167325Config config) {
        this.config = config != null ? config : new Idea167325Config();
