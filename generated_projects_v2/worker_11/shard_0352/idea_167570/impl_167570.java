...
@Data
public class Idea167570Config {
    private String name = "idea_167570";
 ...
 */
@Slf4j
public class Idea167570Service {
    private static final int IDEA_ID = 167570;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167570Service() {
        this(new Idea167570Config());
    }

    public Idea167570Service(Idea167570Config config) {
        this.config = config != null ? config : new Idea167570Config();
