...
@Data
public class Idea167623Config {
    private String name = "idea_167623";
 ...
 */
@Slf4j
public class Idea167623Service {
    private static final int IDEA_ID = 167623;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167623Service() {
        this(new Idea167623Config());
    }

    public Idea167623Service(Idea167623Config config) {
        this.config = config != null ? config : new Idea167623Config();
