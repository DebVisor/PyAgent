...
@Data
public class Idea160612Config {
    private String name = "idea_160612";
 ...
 */
@Slf4j
public class Idea160612Service {
    private static final int IDEA_ID = 160612;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea160612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea160612Service() {
        this(new Idea160612Config());
    }

    public Idea160612Service(Idea160612Config config) {
        this.config = config != null ? config : new Idea160612Config();
