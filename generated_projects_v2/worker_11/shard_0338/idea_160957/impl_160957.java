...
@Data
public class Idea160957Config {
    private String name = "idea_160957";
 ...
 */
@Slf4j
public class Idea160957Service {
    private static final int IDEA_ID = 160957;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea160957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea160957Service() {
        this(new Idea160957Config());
    }

    public Idea160957Service(Idea160957Config config) {
        this.config = config != null ? config : new Idea160957Config();
