...
@Data
public class Idea161012Config {
    private String name = "idea_161012";
 ...
 */
@Slf4j
public class Idea161012Service {
    private static final int IDEA_ID = 161012;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea161012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea161012Service() {
        this(new Idea161012Config());
    }

    public Idea161012Service(Idea161012Config config) {
        this.config = config != null ? config : new Idea161012Config();
