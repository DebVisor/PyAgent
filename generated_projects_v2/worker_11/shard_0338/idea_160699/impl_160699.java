...
@Data
public class Idea160699Config {
    private String name = "idea_160699";
 ...
 */
@Slf4j
public class Idea160699Service {
    private static final int IDEA_ID = 160699;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea160699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea160699Service() {
        this(new Idea160699Config());
    }

    public Idea160699Service(Idea160699Config config) {
        this.config = config != null ? config : new Idea160699Config();
