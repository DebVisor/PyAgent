...
@Data
public class Idea160705Config {
    private String name = "idea_160705";
 ...
 */
@Slf4j
public class Idea160705Service {
    private static final int IDEA_ID = 160705;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea160705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea160705Service() {
        this(new Idea160705Config());
    }

    public Idea160705Service(Idea160705Config config) {
        this.config = config != null ? config : new Idea160705Config();
