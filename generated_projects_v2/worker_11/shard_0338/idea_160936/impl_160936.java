...
@Data
public class Idea160936Config {
    private String name = "idea_160936";
 ...
 */
@Slf4j
public class Idea160936Service {
    private static final int IDEA_ID = 160936;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea160936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea160936Service() {
        this(new Idea160936Config());
    }

    public Idea160936Service(Idea160936Config config) {
        this.config = config != null ? config : new Idea160936Config();
