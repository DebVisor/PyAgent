...
@Data
public class Idea163353Config {
    private String name = "idea_163353";
 ...
 */
@Slf4j
public class Idea163353Service {
    private static final int IDEA_ID = 163353;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea163353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea163353Service() {
        this(new Idea163353Config());
    }

    public Idea163353Service(Idea163353Config config) {
        this.config = config != null ? config : new Idea163353Config();
