...
@Data
public class Idea162987Config {
    private String name = "idea_162987";
 ...
 */
@Slf4j
public class Idea162987Service {
    private static final int IDEA_ID = 162987;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea162987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea162987Service() {
        this(new Idea162987Config());
    }

    public Idea162987Service(Idea162987Config config) {
        this.config = config != null ? config : new Idea162987Config();
