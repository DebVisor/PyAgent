...
@Data
public class Idea163322Config {
    private String name = "idea_163322";
 ...
 */
@Slf4j
public class Idea163322Service {
    private static final int IDEA_ID = 163322;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea163322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea163322Service() {
        this(new Idea163322Config());
    }

    public Idea163322Service(Idea163322Config config) {
        this.config = config != null ? config : new Idea163322Config();
