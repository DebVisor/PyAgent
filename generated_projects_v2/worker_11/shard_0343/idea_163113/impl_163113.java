...
@Data
public class Idea163113Config {
    private String name = "idea_163113";
 ...
 */
@Slf4j
public class Idea163113Service {
    private static final int IDEA_ID = 163113;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea163113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea163113Service() {
        this(new Idea163113Config());
    }

    public Idea163113Service(Idea163113Config config) {
        this.config = config != null ? config : new Idea163113Config();
