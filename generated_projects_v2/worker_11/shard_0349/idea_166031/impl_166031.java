...
@Data
public class Idea166031Config {
    private String name = "idea_166031";
 ...
 */
@Slf4j
public class Idea166031Service {
    private static final int IDEA_ID = 166031;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166031Service() {
        this(new Idea166031Config());
    }

    public Idea166031Service(Idea166031Config config) {
        this.config = config != null ? config : new Idea166031Config();
