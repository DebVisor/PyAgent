...
@Data
public class Idea166223Config {
    private String name = "idea_166223";
 ...
 */
@Slf4j
public class Idea166223Service {
    private static final int IDEA_ID = 166223;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166223Service() {
        this(new Idea166223Config());
    }

    public Idea166223Service(Idea166223Config config) {
        this.config = config != null ? config : new Idea166223Config();
