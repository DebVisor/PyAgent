...
@Data
public class Idea166061Config {
    private String name = "idea_166061";
 ...
 */
@Slf4j
public class Idea166061Service {
    private static final int IDEA_ID = 166061;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166061Service() {
        this(new Idea166061Config());
    }

    public Idea166061Service(Idea166061Config config) {
        this.config = config != null ? config : new Idea166061Config();
