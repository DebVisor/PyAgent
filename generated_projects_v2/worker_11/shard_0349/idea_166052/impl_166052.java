...
@Data
public class Idea166052Config {
    private String name = "idea_166052";
 ...
 */
@Slf4j
public class Idea166052Service {
    private static final int IDEA_ID = 166052;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166052Service() {
        this(new Idea166052Config());
    }

    public Idea166052Service(Idea166052Config config) {
        this.config = config != null ? config : new Idea166052Config();
