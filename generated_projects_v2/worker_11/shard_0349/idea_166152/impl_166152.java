...
@Data
public class Idea166152Config {
    private String name = "idea_166152";
 ...
 */
@Slf4j
public class Idea166152Service {
    private static final int IDEA_ID = 166152;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166152Service() {
        this(new Idea166152Config());
    }

    public Idea166152Service(Idea166152Config config) {
        this.config = config != null ? config : new Idea166152Config();
