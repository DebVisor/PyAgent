...
@Data
public class Idea166154Config {
    private String name = "idea_166154";
 ...
 */
@Slf4j
public class Idea166154Service {
    private static final int IDEA_ID = 166154;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea166154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea166154Service() {
        this(new Idea166154Config());
    }

    public Idea166154Service(Idea166154Config config) {
        this.config = config != null ? config : new Idea166154Config();
