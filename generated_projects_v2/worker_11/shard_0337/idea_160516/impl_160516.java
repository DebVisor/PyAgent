...
@Data
public class Idea160516Config {
    private String name = "idea_160516";
 ...
 */
@Slf4j
public class Idea160516Service {
    private static final int IDEA_ID = 160516;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea160516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea160516Service() {
        this(new Idea160516Config());
    }

    public Idea160516Service(Idea160516Config config) {
        this.config = config != null ? config : new Idea160516Config();
