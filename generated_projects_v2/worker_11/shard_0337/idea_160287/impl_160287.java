...
@Data
public class Idea160287Config {
    private String name = "idea_160287";
 ...
 */
@Slf4j
public class Idea160287Service {
    private static final int IDEA_ID = 160287;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea160287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea160287Service() {
        this(new Idea160287Config());
    }

    public Idea160287Service(Idea160287Config config) {
        this.config = config != null ? config : new Idea160287Config();
