...
@Data
public class Idea160234Config {
    private String name = "idea_160234";
 ...
 */
@Slf4j
public class Idea160234Service {
    private static final int IDEA_ID = 160234;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea160234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea160234Service() {
        this(new Idea160234Config());
    }

    public Idea160234Service(Idea160234Config config) {
        this.config = config != null ? config : new Idea160234Config();
