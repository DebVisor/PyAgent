...
@Data
public class Idea160537Config {
    private String name = "idea_160537";
 ...
 */
@Slf4j
public class Idea160537Service {
    private static final int IDEA_ID = 160537;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea160537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea160537Service() {
        this(new Idea160537Config());
    }

    public Idea160537Service(Idea160537Config config) {
        this.config = config != null ? config : new Idea160537Config();
