...
@Data
public class Idea164017Config {
    private String name = "idea_164017";
 ...
 */
@Slf4j
public class Idea164017Service {
    private static final int IDEA_ID = 164017;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea164017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea164017Service() {
        this(new Idea164017Config());
    }

    public Idea164017Service(Idea164017Config config) {
        this.config = config != null ? config : new Idea164017Config();
