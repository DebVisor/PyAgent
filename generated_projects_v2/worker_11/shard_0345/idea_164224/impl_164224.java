...
@Data
public class Idea164224Config {
    private String name = "idea_164224";
 ...
 */
@Slf4j
public class Idea164224Service {
    private static final int IDEA_ID = 164224;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea164224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea164224Service() {
        this(new Idea164224Config());
    }

    public Idea164224Service(Idea164224Config config) {
        this.config = config != null ? config : new Idea164224Config();
