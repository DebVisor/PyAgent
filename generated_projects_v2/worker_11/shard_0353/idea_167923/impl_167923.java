...
@Data
public class Idea167923Config {
    private String name = "idea_167923";
 ...
 */
@Slf4j
public class Idea167923Service {
    private static final int IDEA_ID = 167923;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167923Service() {
        this(new Idea167923Config());
    }

    public Idea167923Service(Idea167923Config config) {
        this.config = config != null ? config : new Idea167923Config();
