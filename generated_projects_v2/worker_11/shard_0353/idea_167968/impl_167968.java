...
@Data
public class Idea167968Config {
    private String name = "idea_167968";
 ...
 */
@Slf4j
public class Idea167968Service {
    private static final int IDEA_ID = 167968;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167968Service() {
        this(new Idea167968Config());
    }

    public Idea167968Service(Idea167968Config config) {
        this.config = config != null ? config : new Idea167968Config();
