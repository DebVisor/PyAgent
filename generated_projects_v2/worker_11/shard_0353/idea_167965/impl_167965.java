...
@Data
public class Idea167965Config {
    private String name = "idea_167965";
 ...
 */
@Slf4j
public class Idea167965Service {
    private static final int IDEA_ID = 167965;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167965Service() {
        this(new Idea167965Config());
    }

    public Idea167965Service(Idea167965Config config) {
        this.config = config != null ? config : new Idea167965Config();
