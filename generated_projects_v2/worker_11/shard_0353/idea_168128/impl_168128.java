...
@Data
public class Idea168128Config {
    private String name = "idea_168128";
 ...
 */
@Slf4j
public class Idea168128Service {
    private static final int IDEA_ID = 168128;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea168128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea168128Service() {
        this(new Idea168128Config());
    }

    public Idea168128Service(Idea168128Config config) {
        this.config = config != null ? config : new Idea168128Config();
