...
@Data
public class Idea167997Config {
    private String name = "idea_167997";
 ...
 */
@Slf4j
public class Idea167997Service {
    private static final int IDEA_ID = 167997;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167997Service() {
        this(new Idea167997Config());
    }

    public Idea167997Service(Idea167997Config config) {
        this.config = config != null ? config : new Idea167997Config();
