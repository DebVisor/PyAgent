...
@Data
public class Idea167841Config {
    private String name = "idea_167841";
 ...
 */
@Slf4j
public class Idea167841Service {
    private static final int IDEA_ID = 167841;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167841Service() {
        this(new Idea167841Config());
    }

    public Idea167841Service(Idea167841Config config) {
        this.config = config != null ? config : new Idea167841Config();
