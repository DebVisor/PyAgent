...
@Data
public class Idea167838Config {
    private String name = "idea_167838";
 ...
 */
@Slf4j
public class Idea167838Service {
    private static final int IDEA_ID = 167838;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea167838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea167838Service() {
        this(new Idea167838Config());
    }

    public Idea167838Service(Idea167838Config config) {
        this.config = config != null ? config : new Idea167838Config();
