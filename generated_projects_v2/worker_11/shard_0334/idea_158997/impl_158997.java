...
@Data
public class Idea158997Config {
    private String name = "idea_158997";
 ...
 */
@Slf4j
public class Idea158997Service {
    private static final int IDEA_ID = 158997;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158997Service() {
        this(new Idea158997Config());
    }

    public Idea158997Service(Idea158997Config config) {
        this.config = config != null ? config : new Idea158997Config();
