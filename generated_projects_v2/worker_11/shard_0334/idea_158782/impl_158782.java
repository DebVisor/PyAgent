...
@Data
public class Idea158782Config {
    private String name = "idea_158782";
 ...
 */
@Slf4j
public class Idea158782Service {
    private static final int IDEA_ID = 158782;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea158782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea158782Service() {
        this(new Idea158782Config());
    }

    public Idea158782Service(Idea158782Config config) {
        this.config = config != null ? config : new Idea158782Config();
