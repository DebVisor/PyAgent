...
@Data
public class Idea160016Config {
    private String name = "idea_160016";
 ...
 */
@Slf4j
public class Idea160016Service {
    private static final int IDEA_ID = 160016;
    private static final String CATEGORY = "data";
    private static final String VERSION = "2.0.0";
    
    private final Idea160016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea160016Service() {
        this(new Idea160016Config());
    }

    public Idea160016Service(Idea160016Config config) {
        this.config = config != null ? config : new Idea160016Config();
