...
@Data
public class Idea195546Config {
    private String name = "idea_195546";
 ...
 */
@Slf4j
public class Idea195546Service {
    private static final int IDEA_ID = 195546;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195546Service() {
        this(new Idea195546Config());
    }

    public Idea195546Service(Idea195546Config config) {
        this.config = config != null ? config : new Idea195546Config();
