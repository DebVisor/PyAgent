...
@Data
public class Idea195581Config {
    private String name = "idea_195581";
 ...
 */
@Slf4j
public class Idea195581Service {
    private static final int IDEA_ID = 195581;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195581Service() {
        this(new Idea195581Config());
    }

    public Idea195581Service(Idea195581Config config) {
        this.config = config != null ? config : new Idea195581Config();
