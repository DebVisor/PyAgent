...
@Data
public class Idea195630Config {
    private String name = "idea_195630";
 ...
 */
@Slf4j
public class Idea195630Service {
    private static final int IDEA_ID = 195630;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195630Service() {
        this(new Idea195630Config());
    }

    public Idea195630Service(Idea195630Config config) {
        this.config = config != null ? config : new Idea195630Config();
