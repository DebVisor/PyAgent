...
@Data
public class Idea195500Config {
    private String name = "idea_195500";
 ...
 */
@Slf4j
public class Idea195500Service {
    private static final int IDEA_ID = 195500;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195500Service() {
        this(new Idea195500Config());
    }

    public Idea195500Service(Idea195500Config config) {
        this.config = config != null ? config : new Idea195500Config();
