...
@Data
public class Idea195540Config {
    private String name = "idea_195540";
 ...
 */
@Slf4j
public class Idea195540Service {
    private static final int IDEA_ID = 195540;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195540Service() {
        this(new Idea195540Config());
    }

    public Idea195540Service(Idea195540Config config) {
        this.config = config != null ? config : new Idea195540Config();
