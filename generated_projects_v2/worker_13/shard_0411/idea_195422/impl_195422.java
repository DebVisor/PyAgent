...
@Data
public class Idea195422Config {
    private String name = "idea_195422";
 ...
 */
@Slf4j
public class Idea195422Service {
    private static final int IDEA_ID = 195422;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195422Service() {
        this(new Idea195422Config());
    }

    public Idea195422Service(Idea195422Config config) {
        this.config = config != null ? config : new Idea195422Config();
