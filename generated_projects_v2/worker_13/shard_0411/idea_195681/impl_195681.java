...
@Data
public class Idea195681Config {
    private String name = "idea_195681";
 ...
 */
@Slf4j
public class Idea195681Service {
    private static final int IDEA_ID = 195681;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195681Service() {
        this(new Idea195681Config());
    }

    public Idea195681Service(Idea195681Config config) {
        this.config = config != null ? config : new Idea195681Config();
