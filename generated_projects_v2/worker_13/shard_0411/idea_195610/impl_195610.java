...
@Data
public class Idea195610Config {
    private String name = "idea_195610";
 ...
 */
@Slf4j
public class Idea195610Service {
    private static final int IDEA_ID = 195610;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195610Service() {
        this(new Idea195610Config());
    }

    public Idea195610Service(Idea195610Config config) {
        this.config = config != null ? config : new Idea195610Config();
