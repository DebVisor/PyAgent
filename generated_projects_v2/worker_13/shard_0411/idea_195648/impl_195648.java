...
@Data
public class Idea195648Config {
    private String name = "idea_195648";
 ...
 */
@Slf4j
public class Idea195648Service {
    private static final int IDEA_ID = 195648;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195648Service() {
        this(new Idea195648Config());
    }

    public Idea195648Service(Idea195648Config config) {
        this.config = config != null ? config : new Idea195648Config();
