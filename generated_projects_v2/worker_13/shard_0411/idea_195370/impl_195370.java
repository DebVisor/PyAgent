...
@Data
public class Idea195370Config {
    private String name = "idea_195370";
 ...
 */
@Slf4j
public class Idea195370Service {
    private static final int IDEA_ID = 195370;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195370Service() {
        this(new Idea195370Config());
    }

    public Idea195370Service(Idea195370Config config) {
        this.config = config != null ? config : new Idea195370Config();
