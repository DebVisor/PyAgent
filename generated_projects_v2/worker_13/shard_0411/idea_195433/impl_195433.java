...
@Data
public class Idea195433Config {
    private String name = "idea_195433";
 ...
 */
@Slf4j
public class Idea195433Service {
    private static final int IDEA_ID = 195433;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195433Service() {
        this(new Idea195433Config());
    }

    public Idea195433Service(Idea195433Config config) {
        this.config = config != null ? config : new Idea195433Config();
