...
@Data
public class Idea195424Config {
    private String name = "idea_195424";
 ...
 */
@Slf4j
public class Idea195424Service {
    private static final int IDEA_ID = 195424;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195424Service() {
        this(new Idea195424Config());
    }

    public Idea195424Service(Idea195424Config config) {
        this.config = config != null ? config : new Idea195424Config();
