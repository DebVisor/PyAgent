...
@Data
public class Idea195385Config {
    private String name = "idea_195385";
 ...
 */
@Slf4j
public class Idea195385Service {
    private static final int IDEA_ID = 195385;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195385Service() {
        this(new Idea195385Config());
    }

    public Idea195385Service(Idea195385Config config) {
        this.config = config != null ? config : new Idea195385Config();
