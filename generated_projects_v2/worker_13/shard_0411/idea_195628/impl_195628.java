...
@Data
public class Idea195628Config {
    private String name = "idea_195628";
 ...
 */
@Slf4j
public class Idea195628Service {
    private static final int IDEA_ID = 195628;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195628Service() {
        this(new Idea195628Config());
    }

    public Idea195628Service(Idea195628Config config) {
        this.config = config != null ? config : new Idea195628Config();
