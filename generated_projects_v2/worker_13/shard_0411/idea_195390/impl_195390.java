...
@Data
public class Idea195390Config {
    private String name = "idea_195390";
 ...
 */
@Slf4j
public class Idea195390Service {
    private static final int IDEA_ID = 195390;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195390Service() {
        this(new Idea195390Config());
    }

    public Idea195390Service(Idea195390Config config) {
        this.config = config != null ? config : new Idea195390Config();
