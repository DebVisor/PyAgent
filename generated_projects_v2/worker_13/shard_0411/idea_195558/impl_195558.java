...
@Data
public class Idea195558Config {
    private String name = "idea_195558";
 ...
 */
@Slf4j
public class Idea195558Service {
    private static final int IDEA_ID = 195558;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195558Service() {
        this(new Idea195558Config());
    }

    public Idea195558Service(Idea195558Config config) {
        this.config = config != null ? config : new Idea195558Config();
