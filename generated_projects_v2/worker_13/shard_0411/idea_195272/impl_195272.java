...
@Data
public class Idea195272Config {
    private String name = "idea_195272";
 ...
 */
@Slf4j
public class Idea195272Service {
    private static final int IDEA_ID = 195272;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195272Service() {
        this(new Idea195272Config());
    }

    public Idea195272Service(Idea195272Config config) {
        this.config = config != null ? config : new Idea195272Config();
