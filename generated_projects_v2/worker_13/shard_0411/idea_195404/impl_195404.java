...
@Data
public class Idea195404Config {
    private String name = "idea_195404";
 ...
 */
@Slf4j
public class Idea195404Service {
    private static final int IDEA_ID = 195404;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195404Service() {
        this(new Idea195404Config());
    }

    public Idea195404Service(Idea195404Config config) {
        this.config = config != null ? config : new Idea195404Config();
