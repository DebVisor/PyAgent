...
@Data
public class Idea195321Config {
    private String name = "idea_195321";
 ...
 */
@Slf4j
public class Idea195321Service {
    private static final int IDEA_ID = 195321;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195321Service() {
        this(new Idea195321Config());
    }

    public Idea195321Service(Idea195321Config config) {
        this.config = config != null ? config : new Idea195321Config();
