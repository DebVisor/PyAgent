...
@Data
public class Idea195692Config {
    private String name = "idea_195692";
 ...
 */
@Slf4j
public class Idea195692Service {
    private static final int IDEA_ID = 195692;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195692Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195692Service() {
        this(new Idea195692Config());
    }

    public Idea195692Service(Idea195692Config config) {
        this.config = config != null ? config : new Idea195692Config();
