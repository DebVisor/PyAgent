...
@Data
public class Idea195373Config {
    private String name = "idea_195373";
 ...
 */
@Slf4j
public class Idea195373Service {
    private static final int IDEA_ID = 195373;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195373Service() {
        this(new Idea195373Config());
    }

    public Idea195373Service(Idea195373Config config) {
        this.config = config != null ? config : new Idea195373Config();
