...
@Data
public class Idea195635Config {
    private String name = "idea_195635";
 ...
 */
@Slf4j
public class Idea195635Service {
    private static final int IDEA_ID = 195635;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195635Service() {
        this(new Idea195635Config());
    }

    public Idea195635Service(Idea195635Config config) {
        this.config = config != null ? config : new Idea195635Config();
