...
@Data
public class Idea195599Config {
    private String name = "idea_195599";
 ...
 */
@Slf4j
public class Idea195599Service {
    private static final int IDEA_ID = 195599;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195599Service() {
        this(new Idea195599Config());
    }

    public Idea195599Service(Idea195599Config config) {
        this.config = config != null ? config : new Idea195599Config();
