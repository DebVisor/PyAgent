...
@Data
public class Idea195384Config {
    private String name = "idea_195384";
 ...
 */
@Slf4j
public class Idea195384Service {
    private static final int IDEA_ID = 195384;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195384Service() {
        this(new Idea195384Config());
    }

    public Idea195384Service(Idea195384Config config) {
        this.config = config != null ? config : new Idea195384Config();
