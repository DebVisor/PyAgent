...
@Data
public class Idea195310Config {
    private String name = "idea_195310";
 ...
 */
@Slf4j
public class Idea195310Service {
    private static final int IDEA_ID = 195310;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195310Service() {
        this(new Idea195310Config());
    }

    public Idea195310Service(Idea195310Config config) {
        this.config = config != null ? config : new Idea195310Config();
