...
@Data
public class Idea195270Config {
    private String name = "idea_195270";
 ...
 */
@Slf4j
public class Idea195270Service {
    private static final int IDEA_ID = 195270;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195270Service() {
        this(new Idea195270Config());
    }

    public Idea195270Service(Idea195270Config config) {
        this.config = config != null ? config : new Idea195270Config();
