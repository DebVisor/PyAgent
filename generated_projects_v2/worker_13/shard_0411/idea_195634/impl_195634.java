...
@Data
public class Idea195634Config {
    private String name = "idea_195634";
 ...
 */
@Slf4j
public class Idea195634Service {
    private static final int IDEA_ID = 195634;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195634Service() {
        this(new Idea195634Config());
    }

    public Idea195634Service(Idea195634Config config) {
        this.config = config != null ? config : new Idea195634Config();
