...
@Data
public class Idea195414Config {
    private String name = "idea_195414";
 ...
 */
@Slf4j
public class Idea195414Service {
    private static final int IDEA_ID = 195414;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195414Service() {
        this(new Idea195414Config());
    }

    public Idea195414Service(Idea195414Config config) {
        this.config = config != null ? config : new Idea195414Config();
