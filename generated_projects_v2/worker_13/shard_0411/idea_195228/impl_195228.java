...
@Data
public class Idea195228Config {
    private String name = "idea_195228";
 ...
 */
@Slf4j
public class Idea195228Service {
    private static final int IDEA_ID = 195228;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195228Service() {
        this(new Idea195228Config());
    }

    public Idea195228Service(Idea195228Config config) {
        this.config = config != null ? config : new Idea195228Config();
