...
@Data
public class Idea195354Config {
    private String name = "idea_195354";
 ...
 */
@Slf4j
public class Idea195354Service {
    private static final int IDEA_ID = 195354;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195354Service() {
        this(new Idea195354Config());
    }

    public Idea195354Service(Idea195354Config config) {
        this.config = config != null ? config : new Idea195354Config();
