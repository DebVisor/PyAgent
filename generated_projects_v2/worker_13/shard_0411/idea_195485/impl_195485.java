...
@Data
public class Idea195485Config {
    private String name = "idea_195485";
 ...
 */
@Slf4j
public class Idea195485Service {
    private static final int IDEA_ID = 195485;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195485Service() {
        this(new Idea195485Config());
    }

    public Idea195485Service(Idea195485Config config) {
        this.config = config != null ? config : new Idea195485Config();
