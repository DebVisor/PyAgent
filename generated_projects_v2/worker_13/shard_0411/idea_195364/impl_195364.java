...
@Data
public class Idea195364Config {
    private String name = "idea_195364";
 ...
 */
@Slf4j
public class Idea195364Service {
    private static final int IDEA_ID = 195364;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195364Service() {
        this(new Idea195364Config());
    }

    public Idea195364Service(Idea195364Config config) {
        this.config = config != null ? config : new Idea195364Config();
