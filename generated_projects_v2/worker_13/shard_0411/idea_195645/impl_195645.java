...
@Data
public class Idea195645Config {
    private String name = "idea_195645";
 ...
 */
@Slf4j
public class Idea195645Service {
    private static final int IDEA_ID = 195645;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195645Service() {
        this(new Idea195645Config());
    }

    public Idea195645Service(Idea195645Config config) {
        this.config = config != null ? config : new Idea195645Config();
