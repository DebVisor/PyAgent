...
@Data
public class Idea195538Config {
    private String name = "idea_195538";
 ...
 */
@Slf4j
public class Idea195538Service {
    private static final int IDEA_ID = 195538;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195538Service() {
        this(new Idea195538Config());
    }

    public Idea195538Service(Idea195538Config config) {
        this.config = config != null ? config : new Idea195538Config();
