...
@Data
public class Idea195541Config {
    private String name = "idea_195541";
 ...
 */
@Slf4j
public class Idea195541Service {
    private static final int IDEA_ID = 195541;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195541Service() {
        this(new Idea195541Config());
    }

    public Idea195541Service(Idea195541Config config) {
        this.config = config != null ? config : new Idea195541Config();
