...
@Data
public class Idea195578Config {
    private String name = "idea_195578";
 ...
 */
@Slf4j
public class Idea195578Service {
    private static final int IDEA_ID = 195578;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195578Service() {
        this(new Idea195578Config());
    }

    public Idea195578Service(Idea195578Config config) {
        this.config = config != null ? config : new Idea195578Config();
