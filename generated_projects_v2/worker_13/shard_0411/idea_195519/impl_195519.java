...
@Data
public class Idea195519Config {
    private String name = "idea_195519";
 ...
 */
@Slf4j
public class Idea195519Service {
    private static final int IDEA_ID = 195519;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195519Service() {
        this(new Idea195519Config());
    }

    public Idea195519Service(Idea195519Config config) {
        this.config = config != null ? config : new Idea195519Config();
