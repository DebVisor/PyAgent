...
@Data
public class Idea195465Config {
    private String name = "idea_195465";
 ...
 */
@Slf4j
public class Idea195465Service {
    private static final int IDEA_ID = 195465;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195465Service() {
        this(new Idea195465Config());
    }

    public Idea195465Service(Idea195465Config config) {
        this.config = config != null ? config : new Idea195465Config();
