...
@Data
public class Idea195377Config {
    private String name = "idea_195377";
 ...
 */
@Slf4j
public class Idea195377Service {
    private static final int IDEA_ID = 195377;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195377Service() {
        this(new Idea195377Config());
    }

    public Idea195377Service(Idea195377Config config) {
        this.config = config != null ? config : new Idea195377Config();
