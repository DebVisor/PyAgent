...
@Data
public class Idea195533Config {
    private String name = "idea_195533";
 ...
 */
@Slf4j
public class Idea195533Service {
    private static final int IDEA_ID = 195533;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195533Service() {
        this(new Idea195533Config());
    }

    public Idea195533Service(Idea195533Config config) {
        this.config = config != null ? config : new Idea195533Config();
