...
@Data
public class Idea195257Config {
    private String name = "idea_195257";
 ...
 */
@Slf4j
public class Idea195257Service {
    private static final int IDEA_ID = 195257;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195257Service() {
        this(new Idea195257Config());
    }

    public Idea195257Service(Idea195257Config config) {
        this.config = config != null ? config : new Idea195257Config();
