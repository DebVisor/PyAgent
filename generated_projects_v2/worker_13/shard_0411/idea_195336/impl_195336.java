...
@Data
public class Idea195336Config {
    private String name = "idea_195336";
 ...
 */
@Slf4j
public class Idea195336Service {
    private static final int IDEA_ID = 195336;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195336Service() {
        this(new Idea195336Config());
    }

    public Idea195336Service(Idea195336Config config) {
        this.config = config != null ? config : new Idea195336Config();
