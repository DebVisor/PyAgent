...
@Data
public class Idea195496Config {
    private String name = "idea_195496";
 ...
 */
@Slf4j
public class Idea195496Service {
    private static final int IDEA_ID = 195496;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195496Service() {
        this(new Idea195496Config());
    }

    public Idea195496Service(Idea195496Config config) {
        this.config = config != null ? config : new Idea195496Config();
