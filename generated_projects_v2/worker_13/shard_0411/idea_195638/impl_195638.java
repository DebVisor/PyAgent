...
@Data
public class Idea195638Config {
    private String name = "idea_195638";
 ...
 */
@Slf4j
public class Idea195638Service {
    private static final int IDEA_ID = 195638;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195638Service() {
        this(new Idea195638Config());
    }

    public Idea195638Service(Idea195638Config config) {
        this.config = config != null ? config : new Idea195638Config();
