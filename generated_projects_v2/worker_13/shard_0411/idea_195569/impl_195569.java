...
@Data
public class Idea195569Config {
    private String name = "idea_195569";
 ...
 */
@Slf4j
public class Idea195569Service {
    private static final int IDEA_ID = 195569;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195569Service() {
        this(new Idea195569Config());
    }

    public Idea195569Service(Idea195569Config config) {
        this.config = config != null ? config : new Idea195569Config();
