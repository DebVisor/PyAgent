...
@Data
public class Idea195247Config {
    private String name = "idea_195247";
 ...
 */
@Slf4j
public class Idea195247Service {
    private static final int IDEA_ID = 195247;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195247Service() {
        this(new Idea195247Config());
    }

    public Idea195247Service(Idea195247Config config) {
        this.config = config != null ? config : new Idea195247Config();
