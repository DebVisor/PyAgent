...
@Data
public class Idea195253Config {
    private String name = "idea_195253";
 ...
 */
@Slf4j
public class Idea195253Service {
    private static final int IDEA_ID = 195253;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195253Service() {
        this(new Idea195253Config());
    }

    public Idea195253Service(Idea195253Config config) {
        this.config = config != null ? config : new Idea195253Config();
