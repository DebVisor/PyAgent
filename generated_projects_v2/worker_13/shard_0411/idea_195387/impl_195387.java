...
@Data
public class Idea195387Config {
    private String name = "idea_195387";
 ...
 */
@Slf4j
public class Idea195387Service {
    private static final int IDEA_ID = 195387;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195387Service() {
        this(new Idea195387Config());
    }

    public Idea195387Service(Idea195387Config config) {
        this.config = config != null ? config : new Idea195387Config();
