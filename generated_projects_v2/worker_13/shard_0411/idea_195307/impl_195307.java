...
@Data
public class Idea195307Config {
    private String name = "idea_195307";
 ...
 */
@Slf4j
public class Idea195307Service {
    private static final int IDEA_ID = 195307;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195307Service() {
        this(new Idea195307Config());
    }

    public Idea195307Service(Idea195307Config config) {
        this.config = config != null ? config : new Idea195307Config();
