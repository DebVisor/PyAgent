...
@Data
public class Idea195365Config {
    private String name = "idea_195365";
 ...
 */
@Slf4j
public class Idea195365Service {
    private static final int IDEA_ID = 195365;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195365Service() {
        this(new Idea195365Config());
    }

    public Idea195365Service(Idea195365Config config) {
        this.config = config != null ? config : new Idea195365Config();
