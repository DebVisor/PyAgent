...
@Data
public class Idea195646Config {
    private String name = "idea_195646";
 ...
 */
@Slf4j
public class Idea195646Service {
    private static final int IDEA_ID = 195646;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195646Service() {
        this(new Idea195646Config());
    }

    public Idea195646Service(Idea195646Config config) {
        this.config = config != null ? config : new Idea195646Config();
