...
@Data
public class Idea195571Config {
    private String name = "idea_195571";
 ...
 */
@Slf4j
public class Idea195571Service {
    private static final int IDEA_ID = 195571;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195571Service() {
        this(new Idea195571Config());
    }

    public Idea195571Service(Idea195571Config config) {
        this.config = config != null ? config : new Idea195571Config();
