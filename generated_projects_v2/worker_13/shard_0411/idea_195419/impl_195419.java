...
@Data
public class Idea195419Config {
    private String name = "idea_195419";
 ...
 */
@Slf4j
public class Idea195419Service {
    private static final int IDEA_ID = 195419;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195419Service() {
        this(new Idea195419Config());
    }

    public Idea195419Service(Idea195419Config config) {
        this.config = config != null ? config : new Idea195419Config();
