...
@Data
public class Idea195502Config {
    private String name = "idea_195502";
 ...
 */
@Slf4j
public class Idea195502Service {
    private static final int IDEA_ID = 195502;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195502Service() {
        this(new Idea195502Config());
    }

    public Idea195502Service(Idea195502Config config) {
        this.config = config != null ? config : new Idea195502Config();
