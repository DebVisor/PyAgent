...
@Data
public class Idea195660Config {
    private String name = "idea_195660";
 ...
 */
@Slf4j
public class Idea195660Service {
    private static final int IDEA_ID = 195660;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195660Service() {
        this(new Idea195660Config());
    }

    public Idea195660Service(Idea195660Config config) {
        this.config = config != null ? config : new Idea195660Config();
