...
@Data
public class Idea195454Config {
    private String name = "idea_195454";
 ...
 */
@Slf4j
public class Idea195454Service {
    private static final int IDEA_ID = 195454;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195454Service() {
        this(new Idea195454Config());
    }

    public Idea195454Service(Idea195454Config config) {
        this.config = config != null ? config : new Idea195454Config();
