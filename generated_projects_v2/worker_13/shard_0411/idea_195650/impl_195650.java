...
@Data
public class Idea195650Config {
    private String name = "idea_195650";
 ...
 */
@Slf4j
public class Idea195650Service {
    private static final int IDEA_ID = 195650;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195650Service() {
        this(new Idea195650Config());
    }

    public Idea195650Service(Idea195650Config config) {
        this.config = config != null ? config : new Idea195650Config();
