...
@Data
public class Idea195378Config {
    private String name = "idea_195378";
 ...
 */
@Slf4j
public class Idea195378Service {
    private static final int IDEA_ID = 195378;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195378Service() {
        this(new Idea195378Config());
    }

    public Idea195378Service(Idea195378Config config) {
        this.config = config != null ? config : new Idea195378Config();
