...
@Data
public class Idea195493Config {
    private String name = "idea_195493";
 ...
 */
@Slf4j
public class Idea195493Service {
    private static final int IDEA_ID = 195493;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195493Service() {
        this(new Idea195493Config());
    }

    public Idea195493Service(Idea195493Config config) {
        this.config = config != null ? config : new Idea195493Config();
