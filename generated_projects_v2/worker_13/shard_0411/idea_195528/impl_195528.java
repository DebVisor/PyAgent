...
@Data
public class Idea195528Config {
    private String name = "idea_195528";
 ...
 */
@Slf4j
public class Idea195528Service {
    private static final int IDEA_ID = 195528;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195528Service() {
        this(new Idea195528Config());
    }

    public Idea195528Service(Idea195528Config config) {
        this.config = config != null ? config : new Idea195528Config();
