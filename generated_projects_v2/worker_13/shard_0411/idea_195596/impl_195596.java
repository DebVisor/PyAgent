...
@Data
public class Idea195596Config {
    private String name = "idea_195596";
 ...
 */
@Slf4j
public class Idea195596Service {
    private static final int IDEA_ID = 195596;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195596Service() {
        this(new Idea195596Config());
    }

    public Idea195596Service(Idea195596Config config) {
        this.config = config != null ? config : new Idea195596Config();
