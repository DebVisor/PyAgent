...
@Data
public class Idea195677Config {
    private String name = "idea_195677";
 ...
 */
@Slf4j
public class Idea195677Service {
    private static final int IDEA_ID = 195677;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195677Service() {
        this(new Idea195677Config());
    }

    public Idea195677Service(Idea195677Config config) {
        this.config = config != null ? config : new Idea195677Config();
