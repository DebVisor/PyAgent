...
@Data
public class Idea195627Config {
    private String name = "idea_195627";
 ...
 */
@Slf4j
public class Idea195627Service {
    private static final int IDEA_ID = 195627;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195627Service() {
        this(new Idea195627Config());
    }

    public Idea195627Service(Idea195627Config config) {
        this.config = config != null ? config : new Idea195627Config();
