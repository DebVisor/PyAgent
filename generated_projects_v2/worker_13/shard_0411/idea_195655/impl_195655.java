...
@Data
public class Idea195655Config {
    private String name = "idea_195655";
 ...
 */
@Slf4j
public class Idea195655Service {
    private static final int IDEA_ID = 195655;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195655Service() {
        this(new Idea195655Config());
    }

    public Idea195655Service(Idea195655Config config) {
        this.config = config != null ? config : new Idea195655Config();
