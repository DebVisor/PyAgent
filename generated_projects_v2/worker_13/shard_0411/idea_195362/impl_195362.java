...
@Data
public class Idea195362Config {
    private String name = "idea_195362";
 ...
 */
@Slf4j
public class Idea195362Service {
    private static final int IDEA_ID = 195362;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195362Service() {
        this(new Idea195362Config());
    }

    public Idea195362Service(Idea195362Config config) {
        this.config = config != null ? config : new Idea195362Config();
