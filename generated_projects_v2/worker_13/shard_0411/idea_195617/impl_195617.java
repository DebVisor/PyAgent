...
@Data
public class Idea195617Config {
    private String name = "idea_195617";
 ...
 */
@Slf4j
public class Idea195617Service {
    private static final int IDEA_ID = 195617;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195617Service() {
        this(new Idea195617Config());
    }

    public Idea195617Service(Idea195617Config config) {
        this.config = config != null ? config : new Idea195617Config();
