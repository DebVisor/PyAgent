...
@Data
public class Idea195368Config {
    private String name = "idea_195368";
 ...
 */
@Slf4j
public class Idea195368Service {
    private static final int IDEA_ID = 195368;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195368Service() {
        this(new Idea195368Config());
    }

    public Idea195368Service(Idea195368Config config) {
        this.config = config != null ? config : new Idea195368Config();
