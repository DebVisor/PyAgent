...
@Data
public class Idea195574Config {
    private String name = "idea_195574";
 ...
 */
@Slf4j
public class Idea195574Service {
    private static final int IDEA_ID = 195574;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195574Service() {
        this(new Idea195574Config());
    }

    public Idea195574Service(Idea195574Config config) {
        this.config = config != null ? config : new Idea195574Config();
