...
@Data
public class Idea195484Config {
    private String name = "idea_195484";
 ...
 */
@Slf4j
public class Idea195484Service {
    private static final int IDEA_ID = 195484;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195484Service() {
        this(new Idea195484Config());
    }

    public Idea195484Service(Idea195484Config config) {
        this.config = config != null ? config : new Idea195484Config();
