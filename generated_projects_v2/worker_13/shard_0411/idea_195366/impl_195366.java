...
@Data
public class Idea195366Config {
    private String name = "idea_195366";
 ...
 */
@Slf4j
public class Idea195366Service {
    private static final int IDEA_ID = 195366;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195366Service() {
        this(new Idea195366Config());
    }

    public Idea195366Service(Idea195366Config config) {
        this.config = config != null ? config : new Idea195366Config();
