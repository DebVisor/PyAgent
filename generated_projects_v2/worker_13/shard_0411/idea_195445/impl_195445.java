...
@Data
public class Idea195445Config {
    private String name = "idea_195445";
 ...
 */
@Slf4j
public class Idea195445Service {
    private static final int IDEA_ID = 195445;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195445Service() {
        this(new Idea195445Config());
    }

    public Idea195445Service(Idea195445Config config) {
        this.config = config != null ? config : new Idea195445Config();
