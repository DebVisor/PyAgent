...
@Data
public class Idea195318Config {
    private String name = "idea_195318";
 ...
 */
@Slf4j
public class Idea195318Service {
    private static final int IDEA_ID = 195318;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195318Service() {
        this(new Idea195318Config());
    }

    public Idea195318Service(Idea195318Config config) {
        this.config = config != null ? config : new Idea195318Config();
