...
@Data
public class Idea195350Config {
    private String name = "idea_195350";
 ...
 */
@Slf4j
public class Idea195350Service {
    private static final int IDEA_ID = 195350;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195350Service() {
        this(new Idea195350Config());
    }

    public Idea195350Service(Idea195350Config config) {
        this.config = config != null ? config : new Idea195350Config();
