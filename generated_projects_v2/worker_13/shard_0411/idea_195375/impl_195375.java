...
@Data
public class Idea195375Config {
    private String name = "idea_195375";
 ...
 */
@Slf4j
public class Idea195375Service {
    private static final int IDEA_ID = 195375;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195375Service() {
        this(new Idea195375Config());
    }

    public Idea195375Service(Idea195375Config config) {
        this.config = config != null ? config : new Idea195375Config();
