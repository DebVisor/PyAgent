...
@Data
public class Idea195467Config {
    private String name = "idea_195467";
 ...
 */
@Slf4j
public class Idea195467Service {
    private static final int IDEA_ID = 195467;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195467Service() {
        this(new Idea195467Config());
    }

    public Idea195467Service(Idea195467Config config) {
        this.config = config != null ? config : new Idea195467Config();
