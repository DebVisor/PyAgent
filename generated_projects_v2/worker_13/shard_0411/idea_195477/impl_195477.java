...
@Data
public class Idea195477Config {
    private String name = "idea_195477";
 ...
 */
@Slf4j
public class Idea195477Service {
    private static final int IDEA_ID = 195477;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195477Service() {
        this(new Idea195477Config());
    }

    public Idea195477Service(Idea195477Config config) {
        this.config = config != null ? config : new Idea195477Config();
