...
@Data
public class Idea195410Config {
    private String name = "idea_195410";
 ...
 */
@Slf4j
public class Idea195410Service {
    private static final int IDEA_ID = 195410;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195410Service() {
        this(new Idea195410Config());
    }

    public Idea195410Service(Idea195410Config config) {
        this.config = config != null ? config : new Idea195410Config();
