...
@Data
public class Idea195673Config {
    private String name = "idea_195673";
 ...
 */
@Slf4j
public class Idea195673Service {
    private static final int IDEA_ID = 195673;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195673Service() {
        this(new Idea195673Config());
    }

    public Idea195673Service(Idea195673Config config) {
        this.config = config != null ? config : new Idea195673Config();
