...
@Data
public class Idea195447Config {
    private String name = "idea_195447";
 ...
 */
@Slf4j
public class Idea195447Service {
    private static final int IDEA_ID = 195447;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195447Service() {
        this(new Idea195447Config());
    }

    public Idea195447Service(Idea195447Config config) {
        this.config = config != null ? config : new Idea195447Config();
