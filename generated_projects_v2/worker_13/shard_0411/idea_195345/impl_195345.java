...
@Data
public class Idea195345Config {
    private String name = "idea_195345";
 ...
 */
@Slf4j
public class Idea195345Service {
    private static final int IDEA_ID = 195345;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195345Service() {
        this(new Idea195345Config());
    }

    public Idea195345Service(Idea195345Config config) {
        this.config = config != null ? config : new Idea195345Config();
