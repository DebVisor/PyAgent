...
@Data
public class Idea195696Config {
    private String name = "idea_195696";
 ...
 */
@Slf4j
public class Idea195696Service {
    private static final int IDEA_ID = 195696;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195696Service() {
        this(new Idea195696Config());
    }

    public Idea195696Service(Idea195696Config config) {
        this.config = config != null ? config : new Idea195696Config();
