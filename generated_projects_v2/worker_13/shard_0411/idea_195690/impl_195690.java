...
@Data
public class Idea195690Config {
    private String name = "idea_195690";
 ...
 */
@Slf4j
public class Idea195690Service {
    private static final int IDEA_ID = 195690;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195690Service() {
        this(new Idea195690Config());
    }

    public Idea195690Service(Idea195690Config config) {
        this.config = config != null ? config : new Idea195690Config();
