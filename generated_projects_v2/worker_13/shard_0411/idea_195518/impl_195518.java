...
@Data
public class Idea195518Config {
    private String name = "idea_195518";
 ...
 */
@Slf4j
public class Idea195518Service {
    private static final int IDEA_ID = 195518;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195518Service() {
        this(new Idea195518Config());
    }

    public Idea195518Service(Idea195518Config config) {
        this.config = config != null ? config : new Idea195518Config();
