...
@Data
public class Idea195605Config {
    private String name = "idea_195605";
 ...
 */
@Slf4j
public class Idea195605Service {
    private static final int IDEA_ID = 195605;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195605Service() {
        this(new Idea195605Config());
    }

    public Idea195605Service(Idea195605Config config) {
        this.config = config != null ? config : new Idea195605Config();
