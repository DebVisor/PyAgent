...
@Data
public class Idea195587Config {
    private String name = "idea_195587";
 ...
 */
@Slf4j
public class Idea195587Service {
    private static final int IDEA_ID = 195587;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195587Service() {
        this(new Idea195587Config());
    }

    public Idea195587Service(Idea195587Config config) {
        this.config = config != null ? config : new Idea195587Config();
