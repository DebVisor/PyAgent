...
@Data
public class Idea195441Config {
    private String name = "idea_195441";
 ...
 */
@Slf4j
public class Idea195441Service {
    private static final int IDEA_ID = 195441;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195441Service() {
        this(new Idea195441Config());
    }

    public Idea195441Service(Idea195441Config config) {
        this.config = config != null ? config : new Idea195441Config();
