...
@Data
public class Idea195234Config {
    private String name = "idea_195234";
 ...
 */
@Slf4j
public class Idea195234Service {
    private static final int IDEA_ID = 195234;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195234Service() {
        this(new Idea195234Config());
    }

    public Idea195234Service(Idea195234Config config) {
        this.config = config != null ? config : new Idea195234Config();
