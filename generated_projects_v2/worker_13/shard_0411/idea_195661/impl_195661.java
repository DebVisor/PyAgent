...
@Data
public class Idea195661Config {
    private String name = "idea_195661";
 ...
 */
@Slf4j
public class Idea195661Service {
    private static final int IDEA_ID = 195661;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195661Service() {
        this(new Idea195661Config());
    }

    public Idea195661Service(Idea195661Config config) {
        this.config = config != null ? config : new Idea195661Config();
