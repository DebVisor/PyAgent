...
@Data
public class Idea195626Config {
    private String name = "idea_195626";
 ...
 */
@Slf4j
public class Idea195626Service {
    private static final int IDEA_ID = 195626;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195626Service() {
        this(new Idea195626Config());
    }

    public Idea195626Service(Idea195626Config config) {
        this.config = config != null ? config : new Idea195626Config();
