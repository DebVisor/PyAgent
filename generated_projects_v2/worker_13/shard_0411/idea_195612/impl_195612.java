...
@Data
public class Idea195612Config {
    private String name = "idea_195612";
 ...
 */
@Slf4j
public class Idea195612Service {
    private static final int IDEA_ID = 195612;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195612Service() {
        this(new Idea195612Config());
    }

    public Idea195612Service(Idea195612Config config) {
        this.config = config != null ? config : new Idea195612Config();
