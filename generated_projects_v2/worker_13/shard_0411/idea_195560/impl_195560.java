...
@Data
public class Idea195560Config {
    private String name = "idea_195560";
 ...
 */
@Slf4j
public class Idea195560Service {
    private static final int IDEA_ID = 195560;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195560Service() {
        this(new Idea195560Config());
    }

    public Idea195560Service(Idea195560Config config) {
        this.config = config != null ? config : new Idea195560Config();
