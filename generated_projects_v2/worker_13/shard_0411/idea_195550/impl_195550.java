...
@Data
public class Idea195550Config {
    private String name = "idea_195550";
 ...
 */
@Slf4j
public class Idea195550Service {
    private static final int IDEA_ID = 195550;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195550Service() {
        this(new Idea195550Config());
    }

    public Idea195550Service(Idea195550Config config) {
        this.config = config != null ? config : new Idea195550Config();
