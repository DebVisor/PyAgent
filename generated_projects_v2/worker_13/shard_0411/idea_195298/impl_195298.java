...
@Data
public class Idea195298Config {
    private String name = "idea_195298";
 ...
 */
@Slf4j
public class Idea195298Service {
    private static final int IDEA_ID = 195298;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195298Service() {
        this(new Idea195298Config());
    }

    public Idea195298Service(Idea195298Config config) {
        this.config = config != null ? config : new Idea195298Config();
