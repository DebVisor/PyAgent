...
@Data
public class Idea195576Config {
    private String name = "idea_195576";
 ...
 */
@Slf4j
public class Idea195576Service {
    private static final int IDEA_ID = 195576;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195576Service() {
        this(new Idea195576Config());
    }

    public Idea195576Service(Idea195576Config config) {
        this.config = config != null ? config : new Idea195576Config();
