...
@Data
public class Idea195275Config {
    private String name = "idea_195275";
 ...
 */
@Slf4j
public class Idea195275Service {
    private static final int IDEA_ID = 195275;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195275Service() {
        this(new Idea195275Config());
    }

    public Idea195275Service(Idea195275Config config) {
        this.config = config != null ? config : new Idea195275Config();
