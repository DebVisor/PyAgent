...
@Data
public class Idea195565Config {
    private String name = "idea_195565";
 ...
 */
@Slf4j
public class Idea195565Service {
    private static final int IDEA_ID = 195565;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195565Service() {
        this(new Idea195565Config());
    }

    public Idea195565Service(Idea195565Config config) {
        this.config = config != null ? config : new Idea195565Config();
