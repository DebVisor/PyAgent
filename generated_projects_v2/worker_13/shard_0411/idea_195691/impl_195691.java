...
@Data
public class Idea195691Config {
    private String name = "idea_195691";
 ...
 */
@Slf4j
public class Idea195691Service {
    private static final int IDEA_ID = 195691;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195691Service() {
        this(new Idea195691Config());
    }

    public Idea195691Service(Idea195691Config config) {
        this.config = config != null ? config : new Idea195691Config();
