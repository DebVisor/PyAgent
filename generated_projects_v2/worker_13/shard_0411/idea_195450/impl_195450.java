...
@Data
public class Idea195450Config {
    private String name = "idea_195450";
 ...
 */
@Slf4j
public class Idea195450Service {
    private static final int IDEA_ID = 195450;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195450Service() {
        this(new Idea195450Config());
    }

    public Idea195450Service(Idea195450Config config) {
        this.config = config != null ? config : new Idea195450Config();
