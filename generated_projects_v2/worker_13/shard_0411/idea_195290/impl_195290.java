...
@Data
public class Idea195290Config {
    private String name = "idea_195290";
 ...
 */
@Slf4j
public class Idea195290Service {
    private static final int IDEA_ID = 195290;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195290Service() {
        this(new Idea195290Config());
    }

    public Idea195290Service(Idea195290Config config) {
        this.config = config != null ? config : new Idea195290Config();
