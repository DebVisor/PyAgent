...
@Data
public class Idea195288Config {
    private String name = "idea_195288";
 ...
 */
@Slf4j
public class Idea195288Service {
    private static final int IDEA_ID = 195288;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195288Service() {
        this(new Idea195288Config());
    }

    public Idea195288Service(Idea195288Config config) {
        this.config = config != null ? config : new Idea195288Config();
