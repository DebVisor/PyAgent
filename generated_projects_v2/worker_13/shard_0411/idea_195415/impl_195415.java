...
@Data
public class Idea195415Config {
    private String name = "idea_195415";
 ...
 */
@Slf4j
public class Idea195415Service {
    private static final int IDEA_ID = 195415;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195415Service() {
        this(new Idea195415Config());
    }

    public Idea195415Service(Idea195415Config config) {
        this.config = config != null ? config : new Idea195415Config();
