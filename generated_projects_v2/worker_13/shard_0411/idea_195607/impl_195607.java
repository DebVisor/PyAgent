...
@Data
public class Idea195607Config {
    private String name = "idea_195607";
 ...
 */
@Slf4j
public class Idea195607Service {
    private static final int IDEA_ID = 195607;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195607Service() {
        this(new Idea195607Config());
    }

    public Idea195607Service(Idea195607Config config) {
        this.config = config != null ? config : new Idea195607Config();
