...
@Data
public class Idea195693Config {
    private String name = "idea_195693";
 ...
 */
@Slf4j
public class Idea195693Service {
    private static final int IDEA_ID = 195693;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195693Service() {
        this(new Idea195693Config());
    }

    public Idea195693Service(Idea195693Config config) {
        this.config = config != null ? config : new Idea195693Config();
