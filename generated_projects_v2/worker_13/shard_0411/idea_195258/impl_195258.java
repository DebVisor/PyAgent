...
@Data
public class Idea195258Config {
    private String name = "idea_195258";
 ...
 */
@Slf4j
public class Idea195258Service {
    private static final int IDEA_ID = 195258;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195258Service() {
        this(new Idea195258Config());
    }

    public Idea195258Service(Idea195258Config config) {
        this.config = config != null ? config : new Idea195258Config();
