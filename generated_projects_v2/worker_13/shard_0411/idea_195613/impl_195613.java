...
@Data
public class Idea195613Config {
    private String name = "idea_195613";
 ...
 */
@Slf4j
public class Idea195613Service {
    private static final int IDEA_ID = 195613;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195613Service() {
        this(new Idea195613Config());
    }

    public Idea195613Service(Idea195613Config config) {
        this.config = config != null ? config : new Idea195613Config();
