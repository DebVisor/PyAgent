...
@Data
public class Idea195689Config {
    private String name = "idea_195689";
 ...
 */
@Slf4j
public class Idea195689Service {
    private static final int IDEA_ID = 195689;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195689Service() {
        this(new Idea195689Config());
    }

    public Idea195689Service(Idea195689Config config) {
        this.config = config != null ? config : new Idea195689Config();
