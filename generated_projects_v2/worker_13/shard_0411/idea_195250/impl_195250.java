...
@Data
public class Idea195250Config {
    private String name = "idea_195250";
 ...
 */
@Slf4j
public class Idea195250Service {
    private static final int IDEA_ID = 195250;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195250Service() {
        this(new Idea195250Config());
    }

    public Idea195250Service(Idea195250Config config) {
        this.config = config != null ? config : new Idea195250Config();
