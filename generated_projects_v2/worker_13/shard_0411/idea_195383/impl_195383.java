...
@Data
public class Idea195383Config {
    private String name = "idea_195383";
 ...
 */
@Slf4j
public class Idea195383Service {
    private static final int IDEA_ID = 195383;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195383Service() {
        this(new Idea195383Config());
    }

    public Idea195383Service(Idea195383Config config) {
        this.config = config != null ? config : new Idea195383Config();
