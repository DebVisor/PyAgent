...
@Data
public class Idea195669Config {
    private String name = "idea_195669";
 ...
 */
@Slf4j
public class Idea195669Service {
    private static final int IDEA_ID = 195669;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195669Service() {
        this(new Idea195669Config());
    }

    public Idea195669Service(Idea195669Config config) {
        this.config = config != null ? config : new Idea195669Config();
