...
@Data
public class Idea195460Config {
    private String name = "idea_195460";
 ...
 */
@Slf4j
public class Idea195460Service {
    private static final int IDEA_ID = 195460;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195460Service() {
        this(new Idea195460Config());
    }

    public Idea195460Service(Idea195460Config config) {
        this.config = config != null ? config : new Idea195460Config();
