...
@Data
public class Idea195478Config {
    private String name = "idea_195478";
 ...
 */
@Slf4j
public class Idea195478Service {
    private static final int IDEA_ID = 195478;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195478Service() {
        this(new Idea195478Config());
    }

    public Idea195478Service(Idea195478Config config) {
        this.config = config != null ? config : new Idea195478Config();
