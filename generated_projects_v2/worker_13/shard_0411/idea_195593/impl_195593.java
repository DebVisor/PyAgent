...
@Data
public class Idea195593Config {
    private String name = "idea_195593";
 ...
 */
@Slf4j
public class Idea195593Service {
    private static final int IDEA_ID = 195593;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195593Service() {
        this(new Idea195593Config());
    }

    public Idea195593Service(Idea195593Config config) {
        this.config = config != null ? config : new Idea195593Config();
