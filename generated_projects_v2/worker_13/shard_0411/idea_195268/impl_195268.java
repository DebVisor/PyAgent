...
@Data
public class Idea195268Config {
    private String name = "idea_195268";
 ...
 */
@Slf4j
public class Idea195268Service {
    private static final int IDEA_ID = 195268;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195268Service() {
        this(new Idea195268Config());
    }

    public Idea195268Service(Idea195268Config config) {
        this.config = config != null ? config : new Idea195268Config();
