...
@Data
public class Idea195589Config {
    private String name = "idea_195589";
 ...
 */
@Slf4j
public class Idea195589Service {
    private static final int IDEA_ID = 195589;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195589Service() {
        this(new Idea195589Config());
    }

    public Idea195589Service(Idea195589Config config) {
        this.config = config != null ? config : new Idea195589Config();
