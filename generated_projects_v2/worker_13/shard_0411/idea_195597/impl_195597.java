...
@Data
public class Idea195597Config {
    private String name = "idea_195597";
 ...
 */
@Slf4j
public class Idea195597Service {
    private static final int IDEA_ID = 195597;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195597Service() {
        this(new Idea195597Config());
    }

    public Idea195597Service(Idea195597Config config) {
        this.config = config != null ? config : new Idea195597Config();
