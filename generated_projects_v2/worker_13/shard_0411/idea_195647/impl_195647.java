...
@Data
public class Idea195647Config {
    private String name = "idea_195647";
 ...
 */
@Slf4j
public class Idea195647Service {
    private static final int IDEA_ID = 195647;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195647Service() {
        this(new Idea195647Config());
    }

    public Idea195647Service(Idea195647Config config) {
        this.config = config != null ? config : new Idea195647Config();
