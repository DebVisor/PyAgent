...
@Data
public class Idea195418Config {
    private String name = "idea_195418";
 ...
 */
@Slf4j
public class Idea195418Service {
    private static final int IDEA_ID = 195418;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195418Service() {
        this(new Idea195418Config());
    }

    public Idea195418Service(Idea195418Config config) {
        this.config = config != null ? config : new Idea195418Config();
