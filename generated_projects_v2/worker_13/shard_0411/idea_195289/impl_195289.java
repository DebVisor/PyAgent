...
@Data
public class Idea195289Config {
    private String name = "idea_195289";
 ...
 */
@Slf4j
public class Idea195289Service {
    private static final int IDEA_ID = 195289;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195289Service() {
        this(new Idea195289Config());
    }

    public Idea195289Service(Idea195289Config config) {
        this.config = config != null ? config : new Idea195289Config();
