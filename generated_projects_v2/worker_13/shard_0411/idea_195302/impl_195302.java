...
@Data
public class Idea195302Config {
    private String name = "idea_195302";
 ...
 */
@Slf4j
public class Idea195302Service {
    private static final int IDEA_ID = 195302;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195302Service() {
        this(new Idea195302Config());
    }

    public Idea195302Service(Idea195302Config config) {
        this.config = config != null ? config : new Idea195302Config();
