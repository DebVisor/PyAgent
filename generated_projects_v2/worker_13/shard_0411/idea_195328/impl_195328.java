...
@Data
public class Idea195328Config {
    private String name = "idea_195328";
 ...
 */
@Slf4j
public class Idea195328Service {
    private static final int IDEA_ID = 195328;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195328Service() {
        this(new Idea195328Config());
    }

    public Idea195328Service(Idea195328Config config) {
        this.config = config != null ? config : new Idea195328Config();
