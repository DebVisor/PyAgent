...
@Data
public class Idea195407Config {
    private String name = "idea_195407";
 ...
 */
@Slf4j
public class Idea195407Service {
    private static final int IDEA_ID = 195407;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195407Service() {
        this(new Idea195407Config());
    }

    public Idea195407Service(Idea195407Config config) {
        this.config = config != null ? config : new Idea195407Config();
