...
@Data
public class Idea195331Config {
    private String name = "idea_195331";
 ...
 */
@Slf4j
public class Idea195331Service {
    private static final int IDEA_ID = 195331;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195331Service() {
        this(new Idea195331Config());
    }

    public Idea195331Service(Idea195331Config config) {
        this.config = config != null ? config : new Idea195331Config();
