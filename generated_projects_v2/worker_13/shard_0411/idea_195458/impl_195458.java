...
@Data
public class Idea195458Config {
    private String name = "idea_195458";
 ...
 */
@Slf4j
public class Idea195458Service {
    private static final int IDEA_ID = 195458;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195458Service() {
        this(new Idea195458Config());
    }

    public Idea195458Service(Idea195458Config config) {
        this.config = config != null ? config : new Idea195458Config();
