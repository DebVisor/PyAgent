...
@Data
public class Idea195473Config {
    private String name = "idea_195473";
 ...
 */
@Slf4j
public class Idea195473Service {
    private static final int IDEA_ID = 195473;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195473Service() {
        this(new Idea195473Config());
    }

    public Idea195473Service(Idea195473Config config) {
        this.config = config != null ? config : new Idea195473Config();
