...
@Data
public class Idea195335Config {
    private String name = "idea_195335";
 ...
 */
@Slf4j
public class Idea195335Service {
    private static final int IDEA_ID = 195335;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195335Service() {
        this(new Idea195335Config());
    }

    public Idea195335Service(Idea195335Config config) {
        this.config = config != null ? config : new Idea195335Config();
