...
@Data
public class Idea195308Config {
    private String name = "idea_195308";
 ...
 */
@Slf4j
public class Idea195308Service {
    private static final int IDEA_ID = 195308;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195308Service() {
        this(new Idea195308Config());
    }

    public Idea195308Service(Idea195308Config config) {
        this.config = config != null ? config : new Idea195308Config();
