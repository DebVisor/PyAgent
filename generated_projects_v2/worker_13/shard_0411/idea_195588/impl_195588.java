...
@Data
public class Idea195588Config {
    private String name = "idea_195588";
 ...
 */
@Slf4j
public class Idea195588Service {
    private static final int IDEA_ID = 195588;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195588Service() {
        this(new Idea195588Config());
    }

    public Idea195588Service(Idea195588Config config) {
        this.config = config != null ? config : new Idea195588Config();
