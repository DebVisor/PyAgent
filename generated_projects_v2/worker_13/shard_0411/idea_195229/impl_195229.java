...
@Data
public class Idea195229Config {
    private String name = "idea_195229";
 ...
 */
@Slf4j
public class Idea195229Service {
    private static final int IDEA_ID = 195229;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195229Service() {
        this(new Idea195229Config());
    }

    public Idea195229Service(Idea195229Config config) {
        this.config = config != null ? config : new Idea195229Config();
