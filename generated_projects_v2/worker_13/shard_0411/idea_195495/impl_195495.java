...
@Data
public class Idea195495Config {
    private String name = "idea_195495";
 ...
 */
@Slf4j
public class Idea195495Service {
    private static final int IDEA_ID = 195495;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195495Service() {
        this(new Idea195495Config());
    }

    public Idea195495Service(Idea195495Config config) {
        this.config = config != null ? config : new Idea195495Config();
