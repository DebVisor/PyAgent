...
@Data
public class Idea195374Config {
    private String name = "idea_195374";
 ...
 */
@Slf4j
public class Idea195374Service {
    private static final int IDEA_ID = 195374;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195374Service() {
        this(new Idea195374Config());
    }

    public Idea195374Service(Idea195374Config config) {
        this.config = config != null ? config : new Idea195374Config();
