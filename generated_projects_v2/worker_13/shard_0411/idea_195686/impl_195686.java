...
@Data
public class Idea195686Config {
    private String name = "idea_195686";
 ...
 */
@Slf4j
public class Idea195686Service {
    private static final int IDEA_ID = 195686;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195686Service() {
        this(new Idea195686Config());
    }

    public Idea195686Service(Idea195686Config config) {
        this.config = config != null ? config : new Idea195686Config();
