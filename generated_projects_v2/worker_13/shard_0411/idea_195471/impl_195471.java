...
@Data
public class Idea195471Config {
    private String name = "idea_195471";
 ...
 */
@Slf4j
public class Idea195471Service {
    private static final int IDEA_ID = 195471;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195471Service() {
        this(new Idea195471Config());
    }

    public Idea195471Service(Idea195471Config config) {
        this.config = config != null ? config : new Idea195471Config();
