...
@Data
public class Idea195678Config {
    private String name = "idea_195678";
 ...
 */
@Slf4j
public class Idea195678Service {
    private static final int IDEA_ID = 195678;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195678Service() {
        this(new Idea195678Config());
    }

    public Idea195678Service(Idea195678Config config) {
        this.config = config != null ? config : new Idea195678Config();
