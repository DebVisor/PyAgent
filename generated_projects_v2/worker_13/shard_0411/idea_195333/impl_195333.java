...
@Data
public class Idea195333Config {
    private String name = "idea_195333";
 ...
 */
@Slf4j
public class Idea195333Service {
    private static final int IDEA_ID = 195333;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195333Service() {
        this(new Idea195333Config());
    }

    public Idea195333Service(Idea195333Config config) {
        this.config = config != null ? config : new Idea195333Config();
