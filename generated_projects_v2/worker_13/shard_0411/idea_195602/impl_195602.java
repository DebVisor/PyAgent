...
@Data
public class Idea195602Config {
    private String name = "idea_195602";
 ...
 */
@Slf4j
public class Idea195602Service {
    private static final int IDEA_ID = 195602;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195602Service() {
        this(new Idea195602Config());
    }

    public Idea195602Service(Idea195602Config config) {
        this.config = config != null ? config : new Idea195602Config();
