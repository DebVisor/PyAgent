...
@Data
public class Idea195464Config {
    private String name = "idea_195464";
 ...
 */
@Slf4j
public class Idea195464Service {
    private static final int IDEA_ID = 195464;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195464Service() {
        this(new Idea195464Config());
    }

    public Idea195464Service(Idea195464Config config) {
        this.config = config != null ? config : new Idea195464Config();
