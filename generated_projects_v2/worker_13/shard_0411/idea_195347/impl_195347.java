...
@Data
public class Idea195347Config {
    private String name = "idea_195347";
 ...
 */
@Slf4j
public class Idea195347Service {
    private static final int IDEA_ID = 195347;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195347Service() {
        this(new Idea195347Config());
    }

    public Idea195347Service(Idea195347Config config) {
        this.config = config != null ? config : new Idea195347Config();
