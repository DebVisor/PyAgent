...
@Data
public class Idea195572Config {
    private String name = "idea_195572";
 ...
 */
@Slf4j
public class Idea195572Service {
    private static final int IDEA_ID = 195572;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195572Service() {
        this(new Idea195572Config());
    }

    public Idea195572Service(Idea195572Config config) {
        this.config = config != null ? config : new Idea195572Config();
