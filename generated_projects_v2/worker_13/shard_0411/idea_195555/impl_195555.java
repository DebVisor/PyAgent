...
@Data
public class Idea195555Config {
    private String name = "idea_195555";
 ...
 */
@Slf4j
public class Idea195555Service {
    private static final int IDEA_ID = 195555;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195555Service() {
        this(new Idea195555Config());
    }

    public Idea195555Service(Idea195555Config config) {
        this.config = config != null ? config : new Idea195555Config();
