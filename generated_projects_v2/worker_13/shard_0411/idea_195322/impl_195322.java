...
@Data
public class Idea195322Config {
    private String name = "idea_195322";
 ...
 */
@Slf4j
public class Idea195322Service {
    private static final int IDEA_ID = 195322;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195322Service() {
        this(new Idea195322Config());
    }

    public Idea195322Service(Idea195322Config config) {
        this.config = config != null ? config : new Idea195322Config();
