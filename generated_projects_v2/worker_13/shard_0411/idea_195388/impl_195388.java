...
@Data
public class Idea195388Config {
    private String name = "idea_195388";
 ...
 */
@Slf4j
public class Idea195388Service {
    private static final int IDEA_ID = 195388;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195388Service() {
        this(new Idea195388Config());
    }

    public Idea195388Service(Idea195388Config config) {
        this.config = config != null ? config : new Idea195388Config();
