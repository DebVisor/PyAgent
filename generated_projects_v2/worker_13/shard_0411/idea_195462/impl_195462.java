...
@Data
public class Idea195462Config {
    private String name = "idea_195462";
 ...
 */
@Slf4j
public class Idea195462Service {
    private static final int IDEA_ID = 195462;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195462Service() {
        this(new Idea195462Config());
    }

    public Idea195462Service(Idea195462Config config) {
        this.config = config != null ? config : new Idea195462Config();
