...
@Data
public class Idea195615Config {
    private String name = "idea_195615";
 ...
 */
@Slf4j
public class Idea195615Service {
    private static final int IDEA_ID = 195615;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195615Service() {
        this(new Idea195615Config());
    }

    public Idea195615Service(Idea195615Config config) {
        this.config = config != null ? config : new Idea195615Config();
