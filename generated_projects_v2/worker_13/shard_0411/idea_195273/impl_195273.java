...
@Data
public class Idea195273Config {
    private String name = "idea_195273";
 ...
 */
@Slf4j
public class Idea195273Service {
    private static final int IDEA_ID = 195273;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195273Service() {
        this(new Idea195273Config());
    }

    public Idea195273Service(Idea195273Config config) {
        this.config = config != null ? config : new Idea195273Config();
