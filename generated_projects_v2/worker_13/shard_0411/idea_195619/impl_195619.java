...
@Data
public class Idea195619Config {
    private String name = "idea_195619";
 ...
 */
@Slf4j
public class Idea195619Service {
    private static final int IDEA_ID = 195619;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195619Service() {
        this(new Idea195619Config());
    }

    public Idea195619Service(Idea195619Config config) {
        this.config = config != null ? config : new Idea195619Config();
