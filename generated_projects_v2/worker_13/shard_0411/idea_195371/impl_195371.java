...
@Data
public class Idea195371Config {
    private String name = "idea_195371";
 ...
 */
@Slf4j
public class Idea195371Service {
    private static final int IDEA_ID = 195371;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195371Service() {
        this(new Idea195371Config());
    }

    public Idea195371Service(Idea195371Config config) {
        this.config = config != null ? config : new Idea195371Config();
