...
@Data
public class Idea195469Config {
    private String name = "idea_195469";
 ...
 */
@Slf4j
public class Idea195469Service {
    private static final int IDEA_ID = 195469;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195469Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195469Service() {
        this(new Idea195469Config());
    }

    public Idea195469Service(Idea195469Config config) {
        this.config = config != null ? config : new Idea195469Config();
