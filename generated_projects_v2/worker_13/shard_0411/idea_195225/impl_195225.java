...
@Data
public class Idea195225Config {
    private String name = "idea_195225";
 ...
 */
@Slf4j
public class Idea195225Service {
    private static final int IDEA_ID = 195225;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195225Service() {
        this(new Idea195225Config());
    }

    public Idea195225Service(Idea195225Config config) {
        this.config = config != null ? config : new Idea195225Config();
