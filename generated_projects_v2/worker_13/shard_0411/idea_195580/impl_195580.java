...
@Data
public class Idea195580Config {
    private String name = "idea_195580";
 ...
 */
@Slf4j
public class Idea195580Service {
    private static final int IDEA_ID = 195580;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195580Service() {
        this(new Idea195580Config());
    }

    public Idea195580Service(Idea195580Config config) {
        this.config = config != null ? config : new Idea195580Config();
