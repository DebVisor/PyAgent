...
@Data
public class Idea195598Config {
    private String name = "idea_195598";
 ...
 */
@Slf4j
public class Idea195598Service {
    private static final int IDEA_ID = 195598;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195598Service() {
        this(new Idea195598Config());
    }

    public Idea195598Service(Idea195598Config config) {
        this.config = config != null ? config : new Idea195598Config();
