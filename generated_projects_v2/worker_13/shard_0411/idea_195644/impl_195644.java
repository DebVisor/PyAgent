...
@Data
public class Idea195644Config {
    private String name = "idea_195644";
 ...
 */
@Slf4j
public class Idea195644Service {
    private static final int IDEA_ID = 195644;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195644Service() {
        this(new Idea195644Config());
    }

    public Idea195644Service(Idea195644Config config) {
        this.config = config != null ? config : new Idea195644Config();
