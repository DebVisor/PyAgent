...
@Data
public class Idea195287Config {
    private String name = "idea_195287";
 ...
 */
@Slf4j
public class Idea195287Service {
    private static final int IDEA_ID = 195287;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195287Service() {
        this(new Idea195287Config());
    }

    public Idea195287Service(Idea195287Config config) {
        this.config = config != null ? config : new Idea195287Config();
