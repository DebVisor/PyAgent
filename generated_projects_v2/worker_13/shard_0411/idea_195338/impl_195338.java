...
@Data
public class Idea195338Config {
    private String name = "idea_195338";
 ...
 */
@Slf4j
public class Idea195338Service {
    private static final int IDEA_ID = 195338;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195338Service() {
        this(new Idea195338Config());
    }

    public Idea195338Service(Idea195338Config config) {
        this.config = config != null ? config : new Idea195338Config();
