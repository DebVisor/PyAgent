...
@Data
public class Idea195400Config {
    private String name = "idea_195400";
 ...
 */
@Slf4j
public class Idea195400Service {
    private static final int IDEA_ID = 195400;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195400Service() {
        this(new Idea195400Config());
    }

    public Idea195400Service(Idea195400Config config) {
        this.config = config != null ? config : new Idea195400Config();
