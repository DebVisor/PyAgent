...
@Data
public class Idea195231Config {
    private String name = "idea_195231";
 ...
 */
@Slf4j
public class Idea195231Service {
    private static final int IDEA_ID = 195231;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195231Service() {
        this(new Idea195231Config());
    }

    public Idea195231Service(Idea195231Config config) {
        this.config = config != null ? config : new Idea195231Config();
