...
@Data
public class Idea195680Config {
    private String name = "idea_195680";
 ...
 */
@Slf4j
public class Idea195680Service {
    private static final int IDEA_ID = 195680;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195680Service() {
        this(new Idea195680Config());
    }

    public Idea195680Service(Idea195680Config config) {
        this.config = config != null ? config : new Idea195680Config();
