...
@Data
public class Idea195654Config {
    private String name = "idea_195654";
 ...
 */
@Slf4j
public class Idea195654Service {
    private static final int IDEA_ID = 195654;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195654Service() {
        this(new Idea195654Config());
    }

    public Idea195654Service(Idea195654Config config) {
        this.config = config != null ? config : new Idea195654Config();
