...
@Data
public class Idea195658Config {
    private String name = "idea_195658";
 ...
 */
@Slf4j
public class Idea195658Service {
    private static final int IDEA_ID = 195658;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195658Service() {
        this(new Idea195658Config());
    }

    public Idea195658Service(Idea195658Config config) {
        this.config = config != null ? config : new Idea195658Config();
