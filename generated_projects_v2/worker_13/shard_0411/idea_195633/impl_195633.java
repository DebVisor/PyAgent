...
@Data
public class Idea195633Config {
    private String name = "idea_195633";
 ...
 */
@Slf4j
public class Idea195633Service {
    private static final int IDEA_ID = 195633;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195633Service() {
        this(new Idea195633Config());
    }

    public Idea195633Service(Idea195633Config config) {
        this.config = config != null ? config : new Idea195633Config();
