...
@Data
public class Idea195226Config {
    private String name = "idea_195226";
 ...
 */
@Slf4j
public class Idea195226Service {
    private static final int IDEA_ID = 195226;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195226Service() {
        this(new Idea195226Config());
    }

    public Idea195226Service(Idea195226Config config) {
        this.config = config != null ? config : new Idea195226Config();
