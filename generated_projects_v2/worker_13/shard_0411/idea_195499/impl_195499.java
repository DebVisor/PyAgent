...
@Data
public class Idea195499Config {
    private String name = "idea_195499";
 ...
 */
@Slf4j
public class Idea195499Service {
    private static final int IDEA_ID = 195499;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195499Service() {
        this(new Idea195499Config());
    }

    public Idea195499Service(Idea195499Config config) {
        this.config = config != null ? config : new Idea195499Config();
