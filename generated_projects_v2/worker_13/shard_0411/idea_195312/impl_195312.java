...
@Data
public class Idea195312Config {
    private String name = "idea_195312";
 ...
 */
@Slf4j
public class Idea195312Service {
    private static final int IDEA_ID = 195312;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195312Service() {
        this(new Idea195312Config());
    }

    public Idea195312Service(Idea195312Config config) {
        this.config = config != null ? config : new Idea195312Config();
