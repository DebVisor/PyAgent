...
@Data
public class Idea195625Config {
    private String name = "idea_195625";
 ...
 */
@Slf4j
public class Idea195625Service {
    private static final int IDEA_ID = 195625;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195625Service() {
        this(new Idea195625Config());
    }

    public Idea195625Service(Idea195625Config config) {
        this.config = config != null ? config : new Idea195625Config();
