...
@Data
public class Idea195539Config {
    private String name = "idea_195539";
 ...
 */
@Slf4j
public class Idea195539Service {
    private static final int IDEA_ID = 195539;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195539Service() {
        this(new Idea195539Config());
    }

    public Idea195539Service(Idea195539Config config) {
        this.config = config != null ? config : new Idea195539Config();
