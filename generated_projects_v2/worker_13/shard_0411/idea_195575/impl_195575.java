...
@Data
public class Idea195575Config {
    private String name = "idea_195575";
 ...
 */
@Slf4j
public class Idea195575Service {
    private static final int IDEA_ID = 195575;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195575Service() {
        this(new Idea195575Config());
    }

    public Idea195575Service(Idea195575Config config) {
        this.config = config != null ? config : new Idea195575Config();
