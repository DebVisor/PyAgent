...
@Data
public class Idea195266Config {
    private String name = "idea_195266";
 ...
 */
@Slf4j
public class Idea195266Service {
    private static final int IDEA_ID = 195266;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195266Service() {
        this(new Idea195266Config());
    }

    public Idea195266Service(Idea195266Config config) {
        this.config = config != null ? config : new Idea195266Config();
