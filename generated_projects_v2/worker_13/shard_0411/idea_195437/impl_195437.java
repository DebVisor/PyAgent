...
@Data
public class Idea195437Config {
    private String name = "idea_195437";
 ...
 */
@Slf4j
public class Idea195437Service {
    private static final int IDEA_ID = 195437;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195437Service() {
        this(new Idea195437Config());
    }

    public Idea195437Service(Idea195437Config config) {
        this.config = config != null ? config : new Idea195437Config();
