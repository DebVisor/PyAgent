...
@Data
public class Idea195230Config {
    private String name = "idea_195230";
 ...
 */
@Slf4j
public class Idea195230Service {
    private static final int IDEA_ID = 195230;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195230Service() {
        this(new Idea195230Config());
    }

    public Idea195230Service(Idea195230Config config) {
        this.config = config != null ? config : new Idea195230Config();
