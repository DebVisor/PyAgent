...
@Data
public class Idea195254Config {
    private String name = "idea_195254";
 ...
 */
@Slf4j
public class Idea195254Service {
    private static final int IDEA_ID = 195254;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195254Service() {
        this(new Idea195254Config());
    }

    public Idea195254Service(Idea195254Config config) {
        this.config = config != null ? config : new Idea195254Config();
