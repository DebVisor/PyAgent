...
@Data
public class Idea195545Config {
    private String name = "idea_195545";
 ...
 */
@Slf4j
public class Idea195545Service {
    private static final int IDEA_ID = 195545;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195545Service() {
        this(new Idea195545Config());
    }

    public Idea195545Service(Idea195545Config config) {
        this.config = config != null ? config : new Idea195545Config();
