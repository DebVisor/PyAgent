...
@Data
public class Idea195435Config {
    private String name = "idea_195435";
 ...
 */
@Slf4j
public class Idea195435Service {
    private static final int IDEA_ID = 195435;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195435Service() {
        this(new Idea195435Config());
    }

    public Idea195435Service(Idea195435Config config) {
        this.config = config != null ? config : new Idea195435Config();
