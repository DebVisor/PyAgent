...
@Data
public class Idea195666Config {
    private String name = "idea_195666";
 ...
 */
@Slf4j
public class Idea195666Service {
    private static final int IDEA_ID = 195666;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195666Service() {
        this(new Idea195666Config());
    }

    public Idea195666Service(Idea195666Config config) {
        this.config = config != null ? config : new Idea195666Config();
