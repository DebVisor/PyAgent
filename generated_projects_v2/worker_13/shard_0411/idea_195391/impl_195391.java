...
@Data
public class Idea195391Config {
    private String name = "idea_195391";
 ...
 */
@Slf4j
public class Idea195391Service {
    private static final int IDEA_ID = 195391;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195391Service() {
        this(new Idea195391Config());
    }

    public Idea195391Service(Idea195391Config config) {
        this.config = config != null ? config : new Idea195391Config();
