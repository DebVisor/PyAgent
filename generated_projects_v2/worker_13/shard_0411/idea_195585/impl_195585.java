...
@Data
public class Idea195585Config {
    private String name = "idea_195585";
 ...
 */
@Slf4j
public class Idea195585Service {
    private static final int IDEA_ID = 195585;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195585Service() {
        this(new Idea195585Config());
    }

    public Idea195585Service(Idea195585Config config) {
        this.config = config != null ? config : new Idea195585Config();
