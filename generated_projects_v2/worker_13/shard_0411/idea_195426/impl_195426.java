...
@Data
public class Idea195426Config {
    private String name = "idea_195426";
 ...
 */
@Slf4j
public class Idea195426Service {
    private static final int IDEA_ID = 195426;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195426Service() {
        this(new Idea195426Config());
    }

    public Idea195426Service(Idea195426Config config) {
        this.config = config != null ? config : new Idea195426Config();
