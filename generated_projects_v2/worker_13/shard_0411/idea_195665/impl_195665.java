...
@Data
public class Idea195665Config {
    private String name = "idea_195665";
 ...
 */
@Slf4j
public class Idea195665Service {
    private static final int IDEA_ID = 195665;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195665Service() {
        this(new Idea195665Config());
    }

    public Idea195665Service(Idea195665Config config) {
        this.config = config != null ? config : new Idea195665Config();
