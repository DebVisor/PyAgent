...
@Data
public class Idea195360Config {
    private String name = "idea_195360";
 ...
 */
@Slf4j
public class Idea195360Service {
    private static final int IDEA_ID = 195360;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195360Service() {
        this(new Idea195360Config());
    }

    public Idea195360Service(Idea195360Config config) {
        this.config = config != null ? config : new Idea195360Config();
