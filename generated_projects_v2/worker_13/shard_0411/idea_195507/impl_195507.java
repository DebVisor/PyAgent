...
@Data
public class Idea195507Config {
    private String name = "idea_195507";
 ...
 */
@Slf4j
public class Idea195507Service {
    private static final int IDEA_ID = 195507;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195507Service() {
        this(new Idea195507Config());
    }

    public Idea195507Service(Idea195507Config config) {
        this.config = config != null ? config : new Idea195507Config();
