...
@Data
public class Idea195664Config {
    private String name = "idea_195664";
 ...
 */
@Slf4j
public class Idea195664Service {
    private static final int IDEA_ID = 195664;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195664Service() {
        this(new Idea195664Config());
    }

    public Idea195664Service(Idea195664Config config) {
        this.config = config != null ? config : new Idea195664Config();
