...
@Data
public class Idea195516Config {
    private String name = "idea_195516";
 ...
 */
@Slf4j
public class Idea195516Service {
    private static final int IDEA_ID = 195516;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195516Service() {
        this(new Idea195516Config());
    }

    public Idea195516Service(Idea195516Config config) {
        this.config = config != null ? config : new Idea195516Config();
