...
@Data
public class Idea195280Config {
    private String name = "idea_195280";
 ...
 */
@Slf4j
public class Idea195280Service {
    private static final int IDEA_ID = 195280;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195280Service() {
        this(new Idea195280Config());
    }

    public Idea195280Service(Idea195280Config config) {
        this.config = config != null ? config : new Idea195280Config();
