...
@Data
public class Idea195300Config {
    private String name = "idea_195300";
 ...
 */
@Slf4j
public class Idea195300Service {
    private static final int IDEA_ID = 195300;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195300Service() {
        this(new Idea195300Config());
    }

    public Idea195300Service(Idea195300Config config) {
        this.config = config != null ? config : new Idea195300Config();
