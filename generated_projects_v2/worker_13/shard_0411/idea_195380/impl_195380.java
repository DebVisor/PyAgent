...
@Data
public class Idea195380Config {
    private String name = "idea_195380";
 ...
 */
@Slf4j
public class Idea195380Service {
    private static final int IDEA_ID = 195380;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195380Service() {
        this(new Idea195380Config());
    }

    public Idea195380Service(Idea195380Config config) {
        this.config = config != null ? config : new Idea195380Config();
