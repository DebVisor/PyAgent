...
@Data
public class Idea195667Config {
    private String name = "idea_195667";
 ...
 */
@Slf4j
public class Idea195667Service {
    private static final int IDEA_ID = 195667;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195667Service() {
        this(new Idea195667Config());
    }

    public Idea195667Service(Idea195667Config config) {
        this.config = config != null ? config : new Idea195667Config();
