...
@Data
public class Idea195276Config {
    private String name = "idea_195276";
 ...
 */
@Slf4j
public class Idea195276Service {
    private static final int IDEA_ID = 195276;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195276Service() {
        this(new Idea195276Config());
    }

    public Idea195276Service(Idea195276Config config) {
        this.config = config != null ? config : new Idea195276Config();
