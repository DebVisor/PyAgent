...
@Data
public class Idea195640Config {
    private String name = "idea_195640";
 ...
 */
@Slf4j
public class Idea195640Service {
    private static final int IDEA_ID = 195640;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195640Service() {
        this(new Idea195640Config());
    }

    public Idea195640Service(Idea195640Config config) {
        this.config = config != null ? config : new Idea195640Config();
