...
@Data
public class Idea195271Config {
    private String name = "idea_195271";
 ...
 */
@Slf4j
public class Idea195271Service {
    private static final int IDEA_ID = 195271;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195271Service() {
        this(new Idea195271Config());
    }

    public Idea195271Service(Idea195271Config config) {
        this.config = config != null ? config : new Idea195271Config();
