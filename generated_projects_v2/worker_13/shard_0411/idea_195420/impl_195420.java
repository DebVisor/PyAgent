...
@Data
public class Idea195420Config {
    private String name = "idea_195420";
 ...
 */
@Slf4j
public class Idea195420Service {
    private static final int IDEA_ID = 195420;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195420Service() {
        this(new Idea195420Config());
    }

    public Idea195420Service(Idea195420Config config) {
        this.config = config != null ? config : new Idea195420Config();
