...
@Data
public class Idea195436Config {
    private String name = "idea_195436";
 ...
 */
@Slf4j
public class Idea195436Service {
    private static final int IDEA_ID = 195436;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195436Service() {
        this(new Idea195436Config());
    }

    public Idea195436Service(Idea195436Config config) {
        this.config = config != null ? config : new Idea195436Config();
