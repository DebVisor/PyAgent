...
@Data
public class Idea195236Config {
    private String name = "idea_195236";
 ...
 */
@Slf4j
public class Idea195236Service {
    private static final int IDEA_ID = 195236;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195236Service() {
        this(new Idea195236Config());
    }

    public Idea195236Service(Idea195236Config config) {
        this.config = config != null ? config : new Idea195236Config();
