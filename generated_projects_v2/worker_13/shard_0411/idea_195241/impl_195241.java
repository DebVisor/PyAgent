...
@Data
public class Idea195241Config {
    private String name = "idea_195241";
 ...
 */
@Slf4j
public class Idea195241Service {
    private static final int IDEA_ID = 195241;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195241Service() {
        this(new Idea195241Config());
    }

    public Idea195241Service(Idea195241Config config) {
        this.config = config != null ? config : new Idea195241Config();
