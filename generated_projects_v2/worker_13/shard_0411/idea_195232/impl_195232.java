...
@Data
public class Idea195232Config {
    private String name = "idea_195232";
 ...
 */
@Slf4j
public class Idea195232Service {
    private static final int IDEA_ID = 195232;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195232Service() {
        this(new Idea195232Config());
    }

    public Idea195232Service(Idea195232Config config) {
        this.config = config != null ? config : new Idea195232Config();
