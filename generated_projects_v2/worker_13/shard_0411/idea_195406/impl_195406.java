...
@Data
public class Idea195406Config {
    private String name = "idea_195406";
 ...
 */
@Slf4j
public class Idea195406Service {
    private static final int IDEA_ID = 195406;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195406Service() {
        this(new Idea195406Config());
    }

    public Idea195406Service(Idea195406Config config) {
        this.config = config != null ? config : new Idea195406Config();
