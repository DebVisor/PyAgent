...
@Data
public class Idea195670Config {
    private String name = "idea_195670";
 ...
 */
@Slf4j
public class Idea195670Service {
    private static final int IDEA_ID = 195670;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195670Service() {
        this(new Idea195670Config());
    }

    public Idea195670Service(Idea195670Config config) {
        this.config = config != null ? config : new Idea195670Config();
