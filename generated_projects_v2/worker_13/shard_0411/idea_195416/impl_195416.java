...
@Data
public class Idea195416Config {
    private String name = "idea_195416";
 ...
 */
@Slf4j
public class Idea195416Service {
    private static final int IDEA_ID = 195416;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195416Service() {
        this(new Idea195416Config());
    }

    public Idea195416Service(Idea195416Config config) {
        this.config = config != null ? config : new Idea195416Config();
