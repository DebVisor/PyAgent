...
@Data
public class Idea195694Config {
    private String name = "idea_195694";
 ...
 */
@Slf4j
public class Idea195694Service {
    private static final int IDEA_ID = 195694;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195694Service() {
        this(new Idea195694Config());
    }

    public Idea195694Service(Idea195694Config config) {
        this.config = config != null ? config : new Idea195694Config();
