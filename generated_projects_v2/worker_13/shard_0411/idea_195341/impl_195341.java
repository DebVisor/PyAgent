...
@Data
public class Idea195341Config {
    private String name = "idea_195341";
 ...
 */
@Slf4j
public class Idea195341Service {
    private static final int IDEA_ID = 195341;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195341Service() {
        this(new Idea195341Config());
    }

    public Idea195341Service(Idea195341Config config) {
        this.config = config != null ? config : new Idea195341Config();
