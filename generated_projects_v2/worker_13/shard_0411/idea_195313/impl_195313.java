...
@Data
public class Idea195313Config {
    private String name = "idea_195313";
 ...
 */
@Slf4j
public class Idea195313Service {
    private static final int IDEA_ID = 195313;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195313Service() {
        this(new Idea195313Config());
    }

    public Idea195313Service(Idea195313Config config) {
        this.config = config != null ? config : new Idea195313Config();
