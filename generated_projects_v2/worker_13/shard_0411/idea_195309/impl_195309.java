...
@Data
public class Idea195309Config {
    private String name = "idea_195309";
 ...
 */
@Slf4j
public class Idea195309Service {
    private static final int IDEA_ID = 195309;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195309Service() {
        this(new Idea195309Config());
    }

    public Idea195309Service(Idea195309Config config) {
        this.config = config != null ? config : new Idea195309Config();
