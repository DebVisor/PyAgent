...
@Data
public class Idea195570Config {
    private String name = "idea_195570";
 ...
 */
@Slf4j
public class Idea195570Service {
    private static final int IDEA_ID = 195570;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195570Service() {
        this(new Idea195570Config());
    }

    public Idea195570Service(Idea195570Config config) {
        this.config = config != null ? config : new Idea195570Config();
