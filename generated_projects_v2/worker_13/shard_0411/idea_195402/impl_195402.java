...
@Data
public class Idea195402Config {
    private String name = "idea_195402";
 ...
 */
@Slf4j
public class Idea195402Service {
    private static final int IDEA_ID = 195402;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195402Service() {
        this(new Idea195402Config());
    }

    public Idea195402Service(Idea195402Config config) {
        this.config = config != null ? config : new Idea195402Config();
