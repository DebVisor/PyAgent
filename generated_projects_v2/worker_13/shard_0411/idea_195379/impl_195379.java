...
@Data
public class Idea195379Config {
    private String name = "idea_195379";
 ...
 */
@Slf4j
public class Idea195379Service {
    private static final int IDEA_ID = 195379;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195379Service() {
        this(new Idea195379Config());
    }

    public Idea195379Service(Idea195379Config config) {
        this.config = config != null ? config : new Idea195379Config();
