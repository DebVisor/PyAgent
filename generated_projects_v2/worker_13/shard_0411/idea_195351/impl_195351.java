...
@Data
public class Idea195351Config {
    private String name = "idea_195351";
 ...
 */
@Slf4j
public class Idea195351Service {
    private static final int IDEA_ID = 195351;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195351Service() {
        this(new Idea195351Config());
    }

    public Idea195351Service(Idea195351Config config) {
        this.config = config != null ? config : new Idea195351Config();
