...
@Data
public class Idea195330Config {
    private String name = "idea_195330";
 ...
 */
@Slf4j
public class Idea195330Service {
    private static final int IDEA_ID = 195330;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195330Service() {
        this(new Idea195330Config());
    }

    public Idea195330Service(Idea195330Config config) {
        this.config = config != null ? config : new Idea195330Config();
