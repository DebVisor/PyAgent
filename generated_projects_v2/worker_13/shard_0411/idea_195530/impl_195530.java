...
@Data
public class Idea195530Config {
    private String name = "idea_195530";
 ...
 */
@Slf4j
public class Idea195530Service {
    private static final int IDEA_ID = 195530;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195530Service() {
        this(new Idea195530Config());
    }

    public Idea195530Service(Idea195530Config config) {
        this.config = config != null ? config : new Idea195530Config();
