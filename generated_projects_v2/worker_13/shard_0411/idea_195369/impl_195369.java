...
@Data
public class Idea195369Config {
    private String name = "idea_195369";
 ...
 */
@Slf4j
public class Idea195369Service {
    private static final int IDEA_ID = 195369;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195369Service() {
        this(new Idea195369Config());
    }

    public Idea195369Service(Idea195369Config config) {
        this.config = config != null ? config : new Idea195369Config();
