...
@Data
public class Idea195233Config {
    private String name = "idea_195233";
 ...
 */
@Slf4j
public class Idea195233Service {
    private static final int IDEA_ID = 195233;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195233Service() {
        this(new Idea195233Config());
    }

    public Idea195233Service(Idea195233Config config) {
        this.config = config != null ? config : new Idea195233Config();
