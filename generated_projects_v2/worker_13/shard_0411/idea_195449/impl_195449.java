...
@Data
public class Idea195449Config {
    private String name = "idea_195449";
 ...
 */
@Slf4j
public class Idea195449Service {
    private static final int IDEA_ID = 195449;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195449Service() {
        this(new Idea195449Config());
    }

    public Idea195449Service(Idea195449Config config) {
        this.config = config != null ? config : new Idea195449Config();
