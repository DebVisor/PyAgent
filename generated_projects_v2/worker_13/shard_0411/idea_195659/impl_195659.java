...
@Data
public class Idea195659Config {
    private String name = "idea_195659";
 ...
 */
@Slf4j
public class Idea195659Service {
    private static final int IDEA_ID = 195659;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195659Service() {
        this(new Idea195659Config());
    }

    public Idea195659Service(Idea195659Config config) {
        this.config = config != null ? config : new Idea195659Config();
