...
@Data
public class Idea195452Config {
    private String name = "idea_195452";
 ...
 */
@Slf4j
public class Idea195452Service {
    private static final int IDEA_ID = 195452;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195452Service() {
        this(new Idea195452Config());
    }

    public Idea195452Service(Idea195452Config config) {
        this.config = config != null ? config : new Idea195452Config();
