...
@Data
public class Idea195363Config {
    private String name = "idea_195363";
 ...
 */
@Slf4j
public class Idea195363Service {
    private static final int IDEA_ID = 195363;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195363Service() {
        this(new Idea195363Config());
    }

    public Idea195363Service(Idea195363Config config) {
        this.config = config != null ? config : new Idea195363Config();
