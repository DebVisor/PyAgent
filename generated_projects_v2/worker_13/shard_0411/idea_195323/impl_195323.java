...
@Data
public class Idea195323Config {
    private String name = "idea_195323";
 ...
 */
@Slf4j
public class Idea195323Service {
    private static final int IDEA_ID = 195323;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195323Service() {
        this(new Idea195323Config());
    }

    public Idea195323Service(Idea195323Config config) {
        this.config = config != null ? config : new Idea195323Config();
