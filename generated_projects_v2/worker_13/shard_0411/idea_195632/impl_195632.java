...
@Data
public class Idea195632Config {
    private String name = "idea_195632";
 ...
 */
@Slf4j
public class Idea195632Service {
    private static final int IDEA_ID = 195632;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195632Service() {
        this(new Idea195632Config());
    }

    public Idea195632Service(Idea195632Config config) {
        this.config = config != null ? config : new Idea195632Config();
