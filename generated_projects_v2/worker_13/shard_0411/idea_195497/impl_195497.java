...
@Data
public class Idea195497Config {
    private String name = "idea_195497";
 ...
 */
@Slf4j
public class Idea195497Service {
    private static final int IDEA_ID = 195497;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195497Service() {
        this(new Idea195497Config());
    }

    public Idea195497Service(Idea195497Config config) {
        this.config = config != null ? config : new Idea195497Config();
