...
@Data
public class Idea195440Config {
    private String name = "idea_195440";
 ...
 */
@Slf4j
public class Idea195440Service {
    private static final int IDEA_ID = 195440;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195440Service() {
        this(new Idea195440Config());
    }

    public Idea195440Service(Idea195440Config config) {
        this.config = config != null ? config : new Idea195440Config();
