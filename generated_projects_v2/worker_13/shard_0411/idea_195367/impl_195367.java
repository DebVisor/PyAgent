...
@Data
public class Idea195367Config {
    private String name = "idea_195367";
 ...
 */
@Slf4j
public class Idea195367Service {
    private static final int IDEA_ID = 195367;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195367Service() {
        this(new Idea195367Config());
    }

    public Idea195367Service(Idea195367Config config) {
        this.config = config != null ? config : new Idea195367Config();
