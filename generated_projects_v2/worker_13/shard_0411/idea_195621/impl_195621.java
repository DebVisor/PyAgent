...
@Data
public class Idea195621Config {
    private String name = "idea_195621";
 ...
 */
@Slf4j
public class Idea195621Service {
    private static final int IDEA_ID = 195621;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195621Service() {
        this(new Idea195621Config());
    }

    public Idea195621Service(Idea195621Config config) {
        this.config = config != null ? config : new Idea195621Config();
