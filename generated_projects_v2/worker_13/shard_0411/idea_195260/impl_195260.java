...
@Data
public class Idea195260Config {
    private String name = "idea_195260";
 ...
 */
@Slf4j
public class Idea195260Service {
    private static final int IDEA_ID = 195260;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195260Service() {
        this(new Idea195260Config());
    }

    public Idea195260Service(Idea195260Config config) {
        this.config = config != null ? config : new Idea195260Config();
