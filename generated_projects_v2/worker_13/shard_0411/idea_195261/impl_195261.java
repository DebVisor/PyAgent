...
@Data
public class Idea195261Config {
    private String name = "idea_195261";
 ...
 */
@Slf4j
public class Idea195261Service {
    private static final int IDEA_ID = 195261;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195261Service() {
        this(new Idea195261Config());
    }

    public Idea195261Service(Idea195261Config config) {
        this.config = config != null ? config : new Idea195261Config();
