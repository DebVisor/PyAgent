...
@Data
public class Idea195604Config {
    private String name = "idea_195604";
 ...
 */
@Slf4j
public class Idea195604Service {
    private static final int IDEA_ID = 195604;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195604Service() {
        this(new Idea195604Config());
    }

    public Idea195604Service(Idea195604Config config) {
        this.config = config != null ? config : new Idea195604Config();
