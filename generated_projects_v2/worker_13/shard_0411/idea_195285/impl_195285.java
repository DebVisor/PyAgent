...
@Data
public class Idea195285Config {
    private String name = "idea_195285";
 ...
 */
@Slf4j
public class Idea195285Service {
    private static final int IDEA_ID = 195285;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195285Service() {
        this(new Idea195285Config());
    }

    public Idea195285Service(Idea195285Config config) {
        this.config = config != null ? config : new Idea195285Config();
