...
@Data
public class Idea195609Config {
    private String name = "idea_195609";
 ...
 */
@Slf4j
public class Idea195609Service {
    private static final int IDEA_ID = 195609;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195609Service() {
        this(new Idea195609Config());
    }

    public Idea195609Service(Idea195609Config config) {
        this.config = config != null ? config : new Idea195609Config();
