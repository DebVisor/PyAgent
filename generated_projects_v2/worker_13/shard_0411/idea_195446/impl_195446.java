...
@Data
public class Idea195446Config {
    private String name = "idea_195446";
 ...
 */
@Slf4j
public class Idea195446Service {
    private static final int IDEA_ID = 195446;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195446Service() {
        this(new Idea195446Config());
    }

    public Idea195446Service(Idea195446Config config) {
        this.config = config != null ? config : new Idea195446Config();
