...
@Data
public class Idea195606Config {
    private String name = "idea_195606";
 ...
 */
@Slf4j
public class Idea195606Service {
    private static final int IDEA_ID = 195606;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195606Service() {
        this(new Idea195606Config());
    }

    public Idea195606Service(Idea195606Config config) {
        this.config = config != null ? config : new Idea195606Config();
