...
@Data
public class Idea195695Config {
    private String name = "idea_195695";
 ...
 */
@Slf4j
public class Idea195695Service {
    private static final int IDEA_ID = 195695;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195695Service() {
        this(new Idea195695Config());
    }

    public Idea195695Service(Idea195695Config config) {
        this.config = config != null ? config : new Idea195695Config();
