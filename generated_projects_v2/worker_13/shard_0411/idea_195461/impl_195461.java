...
@Data
public class Idea195461Config {
    private String name = "idea_195461";
 ...
 */
@Slf4j
public class Idea195461Service {
    private static final int IDEA_ID = 195461;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195461Service() {
        this(new Idea195461Config());
    }

    public Idea195461Service(Idea195461Config config) {
        this.config = config != null ? config : new Idea195461Config();
