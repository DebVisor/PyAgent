...
@Data
public class Idea195603Config {
    private String name = "idea_195603";
 ...
 */
@Slf4j
public class Idea195603Service {
    private static final int IDEA_ID = 195603;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195603Service() {
        this(new Idea195603Config());
    }

    public Idea195603Service(Idea195603Config config) {
        this.config = config != null ? config : new Idea195603Config();
