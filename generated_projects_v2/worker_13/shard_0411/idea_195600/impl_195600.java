...
@Data
public class Idea195600Config {
    private String name = "idea_195600";
 ...
 */
@Slf4j
public class Idea195600Service {
    private static final int IDEA_ID = 195600;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195600Service() {
        this(new Idea195600Config());
    }

    public Idea195600Service(Idea195600Config config) {
        this.config = config != null ? config : new Idea195600Config();
