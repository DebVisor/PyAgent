...
@Data
public class Idea195235Config {
    private String name = "idea_195235";
 ...
 */
@Slf4j
public class Idea195235Service {
    private static final int IDEA_ID = 195235;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195235Service() {
        this(new Idea195235Config());
    }

    public Idea195235Service(Idea195235Config config) {
        this.config = config != null ? config : new Idea195235Config();
