...
@Data
public class Idea195672Config {
    private String name = "idea_195672";
 ...
 */
@Slf4j
public class Idea195672Service {
    private static final int IDEA_ID = 195672;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195672Service() {
        this(new Idea195672Config());
    }

    public Idea195672Service(Idea195672Config config) {
        this.config = config != null ? config : new Idea195672Config();
