...
@Data
public class Idea195614Config {
    private String name = "idea_195614";
 ...
 */
@Slf4j
public class Idea195614Service {
    private static final int IDEA_ID = 195614;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195614Service() {
        this(new Idea195614Config());
    }

    public Idea195614Service(Idea195614Config config) {
        this.config = config != null ? config : new Idea195614Config();
