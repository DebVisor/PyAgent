...
@Data
public class Idea195474Config {
    private String name = "idea_195474";
 ...
 */
@Slf4j
public class Idea195474Service {
    private static final int IDEA_ID = 195474;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195474Service() {
        this(new Idea195474Config());
    }

    public Idea195474Service(Idea195474Config config) {
        this.config = config != null ? config : new Idea195474Config();
