...
@Data
public class Idea195514Config {
    private String name = "idea_195514";
 ...
 */
@Slf4j
public class Idea195514Service {
    private static final int IDEA_ID = 195514;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195514Service() {
        this(new Idea195514Config());
    }

    public Idea195514Service(Idea195514Config config) {
        this.config = config != null ? config : new Idea195514Config();
