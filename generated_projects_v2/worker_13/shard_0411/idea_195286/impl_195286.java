...
@Data
public class Idea195286Config {
    private String name = "idea_195286";
 ...
 */
@Slf4j
public class Idea195286Service {
    private static final int IDEA_ID = 195286;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195286Service() {
        this(new Idea195286Config());
    }

    public Idea195286Service(Idea195286Config config) {
        this.config = config != null ? config : new Idea195286Config();
