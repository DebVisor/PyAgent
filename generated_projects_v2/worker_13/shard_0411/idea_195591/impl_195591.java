...
@Data
public class Idea195591Config {
    private String name = "idea_195591";
 ...
 */
@Slf4j
public class Idea195591Service {
    private static final int IDEA_ID = 195591;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195591Service() {
        this(new Idea195591Config());
    }

    public Idea195591Service(Idea195591Config config) {
        this.config = config != null ? config : new Idea195591Config();
