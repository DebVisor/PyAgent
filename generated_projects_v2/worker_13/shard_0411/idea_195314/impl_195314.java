...
@Data
public class Idea195314Config {
    private String name = "idea_195314";
 ...
 */
@Slf4j
public class Idea195314Service {
    private static final int IDEA_ID = 195314;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195314Service() {
        this(new Idea195314Config());
    }

    public Idea195314Service(Idea195314Config config) {
        this.config = config != null ? config : new Idea195314Config();
