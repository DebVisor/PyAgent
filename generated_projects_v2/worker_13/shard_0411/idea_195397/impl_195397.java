...
@Data
public class Idea195397Config {
    private String name = "idea_195397";
 ...
 */
@Slf4j
public class Idea195397Service {
    private static final int IDEA_ID = 195397;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195397Service() {
        this(new Idea195397Config());
    }

    public Idea195397Service(Idea195397Config config) {
        this.config = config != null ? config : new Idea195397Config();
