...
@Data
public class Idea195346Config {
    private String name = "idea_195346";
 ...
 */
@Slf4j
public class Idea195346Service {
    private static final int IDEA_ID = 195346;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195346Service() {
        this(new Idea195346Config());
    }

    public Idea195346Service(Idea195346Config config) {
        this.config = config != null ? config : new Idea195346Config();
