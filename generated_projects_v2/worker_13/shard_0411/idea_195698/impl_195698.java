...
@Data
public class Idea195698Config {
    private String name = "idea_195698";
 ...
 */
@Slf4j
public class Idea195698Service {
    private static final int IDEA_ID = 195698;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195698Service() {
        this(new Idea195698Config());
    }

    public Idea195698Service(Idea195698Config config) {
        this.config = config != null ? config : new Idea195698Config();
