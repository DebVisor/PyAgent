...
@Data
public class Idea195357Config {
    private String name = "idea_195357";
 ...
 */
@Slf4j
public class Idea195357Service {
    private static final int IDEA_ID = 195357;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195357Service() {
        this(new Idea195357Config());
    }

    public Idea195357Service(Idea195357Config config) {
        this.config = config != null ? config : new Idea195357Config();
