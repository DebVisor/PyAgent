...
@Data
public class Idea195281Config {
    private String name = "idea_195281";
 ...
 */
@Slf4j
public class Idea195281Service {
    private static final int IDEA_ID = 195281;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195281Service() {
        this(new Idea195281Config());
    }

    public Idea195281Service(Idea195281Config config) {
        this.config = config != null ? config : new Idea195281Config();
