...
@Data
public class Idea195444Config {
    private String name = "idea_195444";
 ...
 */
@Slf4j
public class Idea195444Service {
    private static final int IDEA_ID = 195444;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195444Service() {
        this(new Idea195444Config());
    }

    public Idea195444Service(Idea195444Config config) {
        this.config = config != null ? config : new Idea195444Config();
