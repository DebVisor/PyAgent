...
@Data
public class Idea195311Config {
    private String name = "idea_195311";
 ...
 */
@Slf4j
public class Idea195311Service {
    private static final int IDEA_ID = 195311;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195311Service() {
        this(new Idea195311Config());
    }

    public Idea195311Service(Idea195311Config config) {
        this.config = config != null ? config : new Idea195311Config();
