...
@Data
public class Idea195642Config {
    private String name = "idea_195642";
 ...
 */
@Slf4j
public class Idea195642Service {
    private static final int IDEA_ID = 195642;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195642Service() {
        this(new Idea195642Config());
    }

    public Idea195642Service(Idea195642Config config) {
        this.config = config != null ? config : new Idea195642Config();
