...
@Data
public class Idea195389Config {
    private String name = "idea_195389";
 ...
 */
@Slf4j
public class Idea195389Service {
    private static final int IDEA_ID = 195389;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195389Service() {
        this(new Idea195389Config());
    }

    public Idea195389Service(Idea195389Config config) {
        this.config = config != null ? config : new Idea195389Config();
