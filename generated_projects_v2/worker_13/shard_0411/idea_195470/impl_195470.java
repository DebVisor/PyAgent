...
@Data
public class Idea195470Config {
    private String name = "idea_195470";
 ...
 */
@Slf4j
public class Idea195470Service {
    private static final int IDEA_ID = 195470;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195470Service() {
        this(new Idea195470Config());
    }

    public Idea195470Service(Idea195470Config config) {
        this.config = config != null ? config : new Idea195470Config();
