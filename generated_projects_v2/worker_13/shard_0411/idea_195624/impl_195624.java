...
@Data
public class Idea195624Config {
    private String name = "idea_195624";
 ...
 */
@Slf4j
public class Idea195624Service {
    private static final int IDEA_ID = 195624;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195624Service() {
        this(new Idea195624Config());
    }

    public Idea195624Service(Idea195624Config config) {
        this.config = config != null ? config : new Idea195624Config();
