...
@Data
public class Idea195381Config {
    private String name = "idea_195381";
 ...
 */
@Slf4j
public class Idea195381Service {
    private static final int IDEA_ID = 195381;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195381Service() {
        this(new Idea195381Config());
    }

    public Idea195381Service(Idea195381Config config) {
        this.config = config != null ? config : new Idea195381Config();
