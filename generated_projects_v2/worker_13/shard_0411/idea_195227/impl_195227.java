...
@Data
public class Idea195227Config {
    private String name = "idea_195227";
 ...
 */
@Slf4j
public class Idea195227Service {
    private static final int IDEA_ID = 195227;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195227Service() {
        this(new Idea195227Config());
    }

    public Idea195227Service(Idea195227Config config) {
        this.config = config != null ? config : new Idea195227Config();
