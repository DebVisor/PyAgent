...
@Data
public class Idea195536Config {
    private String name = "idea_195536";
 ...
 */
@Slf4j
public class Idea195536Service {
    private static final int IDEA_ID = 195536;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195536Service() {
        this(new Idea195536Config());
    }

    public Idea195536Service(Idea195536Config config) {
        this.config = config != null ? config : new Idea195536Config();
