...
@Data
public class Idea195676Config {
    private String name = "idea_195676";
 ...
 */
@Slf4j
public class Idea195676Service {
    private static final int IDEA_ID = 195676;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195676Service() {
        this(new Idea195676Config());
    }

    public Idea195676Service(Idea195676Config config) {
        this.config = config != null ? config : new Idea195676Config();
