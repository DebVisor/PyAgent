...
@Data
public class Idea195315Config {
    private String name = "idea_195315";
 ...
 */
@Slf4j
public class Idea195315Service {
    private static final int IDEA_ID = 195315;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195315Service() {
        this(new Idea195315Config());
    }

    public Idea195315Service(Idea195315Config config) {
        this.config = config != null ? config : new Idea195315Config();
