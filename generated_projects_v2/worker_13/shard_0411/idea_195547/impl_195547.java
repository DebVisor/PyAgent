...
@Data
public class Idea195547Config {
    private String name = "idea_195547";
 ...
 */
@Slf4j
public class Idea195547Service {
    private static final int IDEA_ID = 195547;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195547Service() {
        this(new Idea195547Config());
    }

    public Idea195547Service(Idea195547Config config) {
        this.config = config != null ? config : new Idea195547Config();
