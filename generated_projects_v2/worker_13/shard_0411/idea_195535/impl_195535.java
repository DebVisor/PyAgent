...
@Data
public class Idea195535Config {
    private String name = "idea_195535";
 ...
 */
@Slf4j
public class Idea195535Service {
    private static final int IDEA_ID = 195535;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195535Service() {
        this(new Idea195535Config());
    }

    public Idea195535Service(Idea195535Config config) {
        this.config = config != null ? config : new Idea195535Config();
