...
@Data
public class Idea195443Config {
    private String name = "idea_195443";
 ...
 */
@Slf4j
public class Idea195443Service {
    private static final int IDEA_ID = 195443;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195443Service() {
        this(new Idea195443Config());
    }

    public Idea195443Service(Idea195443Config config) {
        this.config = config != null ? config : new Idea195443Config();
