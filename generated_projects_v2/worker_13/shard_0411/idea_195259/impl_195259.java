...
@Data
public class Idea195259Config {
    private String name = "idea_195259";
 ...
 */
@Slf4j
public class Idea195259Service {
    private static final int IDEA_ID = 195259;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195259Service() {
        this(new Idea195259Config());
    }

    public Idea195259Service(Idea195259Config config) {
        this.config = config != null ? config : new Idea195259Config();
