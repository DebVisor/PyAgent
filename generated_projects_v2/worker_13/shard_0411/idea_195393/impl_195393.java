...
@Data
public class Idea195393Config {
    private String name = "idea_195393";
 ...
 */
@Slf4j
public class Idea195393Service {
    private static final int IDEA_ID = 195393;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195393Service() {
        this(new Idea195393Config());
    }

    public Idea195393Service(Idea195393Config config) {
        this.config = config != null ? config : new Idea195393Config();
