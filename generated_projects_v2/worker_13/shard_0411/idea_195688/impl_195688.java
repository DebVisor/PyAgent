...
@Data
public class Idea195688Config {
    private String name = "idea_195688";
 ...
 */
@Slf4j
public class Idea195688Service {
    private static final int IDEA_ID = 195688;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195688Service() {
        this(new Idea195688Config());
    }

    public Idea195688Service(Idea195688Config config) {
        this.config = config != null ? config : new Idea195688Config();
