...
@Data
public class Idea195684Config {
    private String name = "idea_195684";
 ...
 */
@Slf4j
public class Idea195684Service {
    private static final int IDEA_ID = 195684;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195684Service() {
        this(new Idea195684Config());
    }

    public Idea195684Service(Idea195684Config config) {
        this.config = config != null ? config : new Idea195684Config();
