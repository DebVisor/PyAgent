...
@Data
public class Idea195562Config {
    private String name = "idea_195562";
 ...
 */
@Slf4j
public class Idea195562Service {
    private static final int IDEA_ID = 195562;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195562Service() {
        this(new Idea195562Config());
    }

    public Idea195562Service(Idea195562Config config) {
        this.config = config != null ? config : new Idea195562Config();
