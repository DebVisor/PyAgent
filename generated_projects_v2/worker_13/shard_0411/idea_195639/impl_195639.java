...
@Data
public class Idea195639Config {
    private String name = "idea_195639";
 ...
 */
@Slf4j
public class Idea195639Service {
    private static final int IDEA_ID = 195639;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195639Service() {
        this(new Idea195639Config());
    }

    public Idea195639Service(Idea195639Config config) {
        this.config = config != null ? config : new Idea195639Config();
