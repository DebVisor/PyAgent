...
@Data
public class Idea195353Config {
    private String name = "idea_195353";
 ...
 */
@Slf4j
public class Idea195353Service {
    private static final int IDEA_ID = 195353;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195353Service() {
        this(new Idea195353Config());
    }

    public Idea195353Service(Idea195353Config config) {
        this.config = config != null ? config : new Idea195353Config();
