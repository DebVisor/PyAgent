...
@Data
public class Idea195251Config {
    private String name = "idea_195251";
 ...
 */
@Slf4j
public class Idea195251Service {
    private static final int IDEA_ID = 195251;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195251Service() {
        this(new Idea195251Config());
    }

    public Idea195251Service(Idea195251Config config) {
        this.config = config != null ? config : new Idea195251Config();
