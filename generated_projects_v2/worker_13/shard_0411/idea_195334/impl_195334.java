...
@Data
public class Idea195334Config {
    private String name = "idea_195334";
 ...
 */
@Slf4j
public class Idea195334Service {
    private static final int IDEA_ID = 195334;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195334Service() {
        this(new Idea195334Config());
    }

    public Idea195334Service(Idea195334Config config) {
        this.config = config != null ? config : new Idea195334Config();
