...
@Data
public class Idea195293Config {
    private String name = "idea_195293";
 ...
 */
@Slf4j
public class Idea195293Service {
    private static final int IDEA_ID = 195293;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195293Service() {
        this(new Idea195293Config());
    }

    public Idea195293Service(Idea195293Config config) {
        this.config = config != null ? config : new Idea195293Config();
