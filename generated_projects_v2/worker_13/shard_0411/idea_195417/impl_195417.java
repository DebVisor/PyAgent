...
@Data
public class Idea195417Config {
    private String name = "idea_195417";
 ...
 */
@Slf4j
public class Idea195417Service {
    private static final int IDEA_ID = 195417;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195417Service() {
        this(new Idea195417Config());
    }

    public Idea195417Service(Idea195417Config config) {
        this.config = config != null ? config : new Idea195417Config();
