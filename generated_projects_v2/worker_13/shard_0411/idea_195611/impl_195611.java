...
@Data
public class Idea195611Config {
    private String name = "idea_195611";
 ...
 */
@Slf4j
public class Idea195611Service {
    private static final int IDEA_ID = 195611;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195611Service() {
        this(new Idea195611Config());
    }

    public Idea195611Service(Idea195611Config config) {
        this.config = config != null ? config : new Idea195611Config();
