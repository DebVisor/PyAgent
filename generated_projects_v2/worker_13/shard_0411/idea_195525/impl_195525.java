...
@Data
public class Idea195525Config {
    private String name = "idea_195525";
 ...
 */
@Slf4j
public class Idea195525Service {
    private static final int IDEA_ID = 195525;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195525Service() {
        this(new Idea195525Config());
    }

    public Idea195525Service(Idea195525Config config) {
        this.config = config != null ? config : new Idea195525Config();
