...
@Data
public class Idea195337Config {
    private String name = "idea_195337";
 ...
 */
@Slf4j
public class Idea195337Service {
    private static final int IDEA_ID = 195337;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195337Service() {
        this(new Idea195337Config());
    }

    public Idea195337Service(Idea195337Config config) {
        this.config = config != null ? config : new Idea195337Config();
