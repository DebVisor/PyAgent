...
@Data
public class Idea195511Config {
    private String name = "idea_195511";
 ...
 */
@Slf4j
public class Idea195511Service {
    private static final int IDEA_ID = 195511;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195511Service() {
        this(new Idea195511Config());
    }

    public Idea195511Service(Idea195511Config config) {
        this.config = config != null ? config : new Idea195511Config();
