...
@Data
public class Idea195395Config {
    private String name = "idea_195395";
 ...
 */
@Slf4j
public class Idea195395Service {
    private static final int IDEA_ID = 195395;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195395Service() {
        this(new Idea195395Config());
    }

    public Idea195395Service(Idea195395Config config) {
        this.config = config != null ? config : new Idea195395Config();
