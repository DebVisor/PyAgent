...
@Data
public class Idea195517Config {
    private String name = "idea_195517";
 ...
 */
@Slf4j
public class Idea195517Service {
    private static final int IDEA_ID = 195517;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195517Service() {
        this(new Idea195517Config());
    }

    public Idea195517Service(Idea195517Config config) {
        this.config = config != null ? config : new Idea195517Config();
