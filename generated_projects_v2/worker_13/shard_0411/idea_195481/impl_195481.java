...
@Data
public class Idea195481Config {
    private String name = "idea_195481";
 ...
 */
@Slf4j
public class Idea195481Service {
    private static final int IDEA_ID = 195481;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195481Service() {
        this(new Idea195481Config());
    }

    public Idea195481Service(Idea195481Config config) {
        this.config = config != null ? config : new Idea195481Config();
