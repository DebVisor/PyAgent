...
@Data
public class Idea195566Config {
    private String name = "idea_195566";
 ...
 */
@Slf4j
public class Idea195566Service {
    private static final int IDEA_ID = 195566;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195566Service() {
        this(new Idea195566Config());
    }

    public Idea195566Service(Idea195566Config config) {
        this.config = config != null ? config : new Idea195566Config();
