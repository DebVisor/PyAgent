...
@Data
public class Idea195438Config {
    private String name = "idea_195438";
 ...
 */
@Slf4j
public class Idea195438Service {
    private static final int IDEA_ID = 195438;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195438Service() {
        this(new Idea195438Config());
    }

    public Idea195438Service(Idea195438Config config) {
        this.config = config != null ? config : new Idea195438Config();
