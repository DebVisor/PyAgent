...
@Data
public class Idea195303Config {
    private String name = "idea_195303";
 ...
 */
@Slf4j
public class Idea195303Service {
    private static final int IDEA_ID = 195303;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195303Service() {
        this(new Idea195303Config());
    }

    public Idea195303Service(Idea195303Config config) {
        this.config = config != null ? config : new Idea195303Config();
