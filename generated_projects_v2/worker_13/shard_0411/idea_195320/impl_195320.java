...
@Data
public class Idea195320Config {
    private String name = "idea_195320";
 ...
 */
@Slf4j
public class Idea195320Service {
    private static final int IDEA_ID = 195320;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195320Service() {
        this(new Idea195320Config());
    }

    public Idea195320Service(Idea195320Config config) {
        this.config = config != null ? config : new Idea195320Config();
