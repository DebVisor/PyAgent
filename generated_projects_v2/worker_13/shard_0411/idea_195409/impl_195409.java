...
@Data
public class Idea195409Config {
    private String name = "idea_195409";
 ...
 */
@Slf4j
public class Idea195409Service {
    private static final int IDEA_ID = 195409;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195409Service() {
        this(new Idea195409Config());
    }

    public Idea195409Service(Idea195409Config config) {
        this.config = config != null ? config : new Idea195409Config();
