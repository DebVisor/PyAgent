...
@Data
public class Idea195651Config {
    private String name = "idea_195651";
 ...
 */
@Slf4j
public class Idea195651Service {
    private static final int IDEA_ID = 195651;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195651Service() {
        this(new Idea195651Config());
    }

    public Idea195651Service(Idea195651Config config) {
        this.config = config != null ? config : new Idea195651Config();
