...
@Data
public class Idea195652Config {
    private String name = "idea_195652";
 ...
 */
@Slf4j
public class Idea195652Service {
    private static final int IDEA_ID = 195652;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195652Service() {
        this(new Idea195652Config());
    }

    public Idea195652Service(Idea195652Config config) {
        this.config = config != null ? config : new Idea195652Config();
