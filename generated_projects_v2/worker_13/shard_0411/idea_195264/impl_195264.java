...
@Data
public class Idea195264Config {
    private String name = "idea_195264";
 ...
 */
@Slf4j
public class Idea195264Service {
    private static final int IDEA_ID = 195264;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195264Service() {
        this(new Idea195264Config());
    }

    public Idea195264Service(Idea195264Config config) {
        this.config = config != null ? config : new Idea195264Config();
