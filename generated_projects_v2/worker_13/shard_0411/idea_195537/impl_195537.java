...
@Data
public class Idea195537Config {
    private String name = "idea_195537";
 ...
 */
@Slf4j
public class Idea195537Service {
    private static final int IDEA_ID = 195537;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195537Service() {
        this(new Idea195537Config());
    }

    public Idea195537Service(Idea195537Config config) {
        this.config = config != null ? config : new Idea195537Config();
