...
@Data
public class Idea195490Config {
    private String name = "idea_195490";
 ...
 */
@Slf4j
public class Idea195490Service {
    private static final int IDEA_ID = 195490;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195490Service() {
        this(new Idea195490Config());
    }

    public Idea195490Service(Idea195490Config config) {
        this.config = config != null ? config : new Idea195490Config();
