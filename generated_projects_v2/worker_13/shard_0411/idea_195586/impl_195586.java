...
@Data
public class Idea195586Config {
    private String name = "idea_195586";
 ...
 */
@Slf4j
public class Idea195586Service {
    private static final int IDEA_ID = 195586;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195586Service() {
        this(new Idea195586Config());
    }

    public Idea195586Service(Idea195586Config config) {
        this.config = config != null ? config : new Idea195586Config();
