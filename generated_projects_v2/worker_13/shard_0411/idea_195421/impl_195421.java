...
@Data
public class Idea195421Config {
    private String name = "idea_195421";
 ...
 */
@Slf4j
public class Idea195421Service {
    private static final int IDEA_ID = 195421;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195421Service() {
        this(new Idea195421Config());
    }

    public Idea195421Service(Idea195421Config config) {
        this.config = config != null ? config : new Idea195421Config();
