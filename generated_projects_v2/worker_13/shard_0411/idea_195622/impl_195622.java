...
@Data
public class Idea195622Config {
    private String name = "idea_195622";
 ...
 */
@Slf4j
public class Idea195622Service {
    private static final int IDEA_ID = 195622;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195622Service() {
        this(new Idea195622Config());
    }

    public Idea195622Service(Idea195622Config config) {
        this.config = config != null ? config : new Idea195622Config();
