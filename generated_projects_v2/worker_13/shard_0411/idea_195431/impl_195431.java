...
@Data
public class Idea195431Config {
    private String name = "idea_195431";
 ...
 */
@Slf4j
public class Idea195431Service {
    private static final int IDEA_ID = 195431;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195431Service() {
        this(new Idea195431Config());
    }

    public Idea195431Service(Idea195431Config config) {
        this.config = config != null ? config : new Idea195431Config();
