...
@Data
public class Idea195573Config {
    private String name = "idea_195573";
 ...
 */
@Slf4j
public class Idea195573Service {
    private static final int IDEA_ID = 195573;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195573Service() {
        this(new Idea195573Config());
    }

    public Idea195573Service(Idea195573Config config) {
        this.config = config != null ? config : new Idea195573Config();
