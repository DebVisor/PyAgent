...
@Data
public class Idea195305Config {
    private String name = "idea_195305";
 ...
 */
@Slf4j
public class Idea195305Service {
    private static final int IDEA_ID = 195305;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195305Service() {
        this(new Idea195305Config());
    }

    public Idea195305Service(Idea195305Config config) {
        this.config = config != null ? config : new Idea195305Config();
