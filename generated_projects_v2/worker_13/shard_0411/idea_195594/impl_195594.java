...
@Data
public class Idea195594Config {
    private String name = "idea_195594";
 ...
 */
@Slf4j
public class Idea195594Service {
    private static final int IDEA_ID = 195594;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195594Service() {
        this(new Idea195594Config());
    }

    public Idea195594Service(Idea195594Config config) {
        this.config = config != null ? config : new Idea195594Config();
