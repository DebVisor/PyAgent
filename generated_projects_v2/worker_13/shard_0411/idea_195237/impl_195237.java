...
@Data
public class Idea195237Config {
    private String name = "idea_195237";
 ...
 */
@Slf4j
public class Idea195237Service {
    private static final int IDEA_ID = 195237;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195237Service() {
        this(new Idea195237Config());
    }

    public Idea195237Service(Idea195237Config config) {
        this.config = config != null ? config : new Idea195237Config();
