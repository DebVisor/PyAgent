...
@Data
public class Idea195503Config {
    private String name = "idea_195503";
 ...
 */
@Slf4j
public class Idea195503Service {
    private static final int IDEA_ID = 195503;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195503Service() {
        this(new Idea195503Config());
    }

    public Idea195503Service(Idea195503Config config) {
        this.config = config != null ? config : new Idea195503Config();
