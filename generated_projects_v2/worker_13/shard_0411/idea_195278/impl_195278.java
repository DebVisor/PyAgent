...
@Data
public class Idea195278Config {
    private String name = "idea_195278";
 ...
 */
@Slf4j
public class Idea195278Service {
    private static final int IDEA_ID = 195278;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195278Service() {
        this(new Idea195278Config());
    }

    public Idea195278Service(Idea195278Config config) {
        this.config = config != null ? config : new Idea195278Config();
