...
@Data
public class Idea195577Config {
    private String name = "idea_195577";
 ...
 */
@Slf4j
public class Idea195577Service {
    private static final int IDEA_ID = 195577;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195577Service() {
        this(new Idea195577Config());
    }

    public Idea195577Service(Idea195577Config config) {
        this.config = config != null ? config : new Idea195577Config();
