...
@Data
public class Idea195601Config {
    private String name = "idea_195601";
 ...
 */
@Slf4j
public class Idea195601Service {
    private static final int IDEA_ID = 195601;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195601Service() {
        this(new Idea195601Config());
    }

    public Idea195601Service(Idea195601Config config) {
        this.config = config != null ? config : new Idea195601Config();
