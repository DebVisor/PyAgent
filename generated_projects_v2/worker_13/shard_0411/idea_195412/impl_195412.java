...
@Data
public class Idea195412Config {
    private String name = "idea_195412";
 ...
 */
@Slf4j
public class Idea195412Service {
    private static final int IDEA_ID = 195412;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195412Service() {
        this(new Idea195412Config());
    }

    public Idea195412Service(Idea195412Config config) {
        this.config = config != null ? config : new Idea195412Config();
