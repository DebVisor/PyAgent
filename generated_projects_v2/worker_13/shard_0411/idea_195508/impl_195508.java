...
@Data
public class Idea195508Config {
    private String name = "idea_195508";
 ...
 */
@Slf4j
public class Idea195508Service {
    private static final int IDEA_ID = 195508;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195508Service() {
        this(new Idea195508Config());
    }

    public Idea195508Service(Idea195508Config config) {
        this.config = config != null ? config : new Idea195508Config();
