...
@Data
public class Idea195529Config {
    private String name = "idea_195529";
 ...
 */
@Slf4j
public class Idea195529Service {
    private static final int IDEA_ID = 195529;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195529Service() {
        this(new Idea195529Config());
    }

    public Idea195529Service(Idea195529Config config) {
        this.config = config != null ? config : new Idea195529Config();
