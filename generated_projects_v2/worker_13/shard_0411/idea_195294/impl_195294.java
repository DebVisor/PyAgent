...
@Data
public class Idea195294Config {
    private String name = "idea_195294";
 ...
 */
@Slf4j
public class Idea195294Service {
    private static final int IDEA_ID = 195294;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195294Service() {
        this(new Idea195294Config());
    }

    public Idea195294Service(Idea195294Config config) {
        this.config = config != null ? config : new Idea195294Config();
