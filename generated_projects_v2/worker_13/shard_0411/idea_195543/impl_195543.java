...
@Data
public class Idea195543Config {
    private String name = "idea_195543";
 ...
 */
@Slf4j
public class Idea195543Service {
    private static final int IDEA_ID = 195543;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195543Service() {
        this(new Idea195543Config());
    }

    public Idea195543Service(Idea195543Config config) {
        this.config = config != null ? config : new Idea195543Config();
