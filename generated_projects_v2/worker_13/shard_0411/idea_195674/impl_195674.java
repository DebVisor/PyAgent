...
@Data
public class Idea195674Config {
    private String name = "idea_195674";
 ...
 */
@Slf4j
public class Idea195674Service {
    private static final int IDEA_ID = 195674;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195674Service() {
        this(new Idea195674Config());
    }

    public Idea195674Service(Idea195674Config config) {
        this.config = config != null ? config : new Idea195674Config();
