...
@Data
public class Idea195301Config {
    private String name = "idea_195301";
 ...
 */
@Slf4j
public class Idea195301Service {
    private static final int IDEA_ID = 195301;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195301Service() {
        this(new Idea195301Config());
    }

    public Idea195301Service(Idea195301Config config) {
        this.config = config != null ? config : new Idea195301Config();
