...
@Data
public class Idea195265Config {
    private String name = "idea_195265";
 ...
 */
@Slf4j
public class Idea195265Service {
    private static final int IDEA_ID = 195265;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195265Service() {
        this(new Idea195265Config());
    }

    public Idea195265Service(Idea195265Config config) {
        this.config = config != null ? config : new Idea195265Config();
