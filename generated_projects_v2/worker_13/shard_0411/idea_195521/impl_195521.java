...
@Data
public class Idea195521Config {
    private String name = "idea_195521";
 ...
 */
@Slf4j
public class Idea195521Service {
    private static final int IDEA_ID = 195521;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195521Service() {
        this(new Idea195521Config());
    }

    public Idea195521Service(Idea195521Config config) {
        this.config = config != null ? config : new Idea195521Config();
