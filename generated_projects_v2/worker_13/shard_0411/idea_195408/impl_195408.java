...
@Data
public class Idea195408Config {
    private String name = "idea_195408";
 ...
 */
@Slf4j
public class Idea195408Service {
    private static final int IDEA_ID = 195408;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195408Service() {
        this(new Idea195408Config());
    }

    public Idea195408Service(Idea195408Config config) {
        this.config = config != null ? config : new Idea195408Config();
