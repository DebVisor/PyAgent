...
@Data
public class Idea195324Config {
    private String name = "idea_195324";
 ...
 */
@Slf4j
public class Idea195324Service {
    private static final int IDEA_ID = 195324;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195324Service() {
        this(new Idea195324Config());
    }

    public Idea195324Service(Idea195324Config config) {
        this.config = config != null ? config : new Idea195324Config();
