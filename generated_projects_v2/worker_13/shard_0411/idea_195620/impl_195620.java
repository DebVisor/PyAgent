...
@Data
public class Idea195620Config {
    private String name = "idea_195620";
 ...
 */
@Slf4j
public class Idea195620Service {
    private static final int IDEA_ID = 195620;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195620Service() {
        this(new Idea195620Config());
    }

    public Idea195620Service(Idea195620Config config) {
        this.config = config != null ? config : new Idea195620Config();
