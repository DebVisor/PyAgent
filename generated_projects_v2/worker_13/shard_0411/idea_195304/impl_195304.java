...
@Data
public class Idea195304Config {
    private String name = "idea_195304";
 ...
 */
@Slf4j
public class Idea195304Service {
    private static final int IDEA_ID = 195304;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195304Service() {
        this(new Idea195304Config());
    }

    public Idea195304Service(Idea195304Config config) {
        this.config = config != null ? config : new Idea195304Config();
