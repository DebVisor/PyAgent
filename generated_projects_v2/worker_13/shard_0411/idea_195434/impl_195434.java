...
@Data
public class Idea195434Config {
    private String name = "idea_195434";
 ...
 */
@Slf4j
public class Idea195434Service {
    private static final int IDEA_ID = 195434;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195434Service() {
        this(new Idea195434Config());
    }

    public Idea195434Service(Idea195434Config config) {
        this.config = config != null ? config : new Idea195434Config();
