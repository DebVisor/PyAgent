...
@Data
public class Idea195641Config {
    private String name = "idea_195641";
 ...
 */
@Slf4j
public class Idea195641Service {
    private static final int IDEA_ID = 195641;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195641Service() {
        this(new Idea195641Config());
    }

    public Idea195641Service(Idea195641Config config) {
        this.config = config != null ? config : new Idea195641Config();
