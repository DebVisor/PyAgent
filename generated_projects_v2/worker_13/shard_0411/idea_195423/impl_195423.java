...
@Data
public class Idea195423Config {
    private String name = "idea_195423";
 ...
 */
@Slf4j
public class Idea195423Service {
    private static final int IDEA_ID = 195423;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195423Service() {
        this(new Idea195423Config());
    }

    public Idea195423Service(Idea195423Config config) {
        this.config = config != null ? config : new Idea195423Config();
