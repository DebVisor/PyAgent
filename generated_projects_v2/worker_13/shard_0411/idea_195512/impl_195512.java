...
@Data
public class Idea195512Config {
    private String name = "idea_195512";
 ...
 */
@Slf4j
public class Idea195512Service {
    private static final int IDEA_ID = 195512;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195512Service() {
        this(new Idea195512Config());
    }

    public Idea195512Service(Idea195512Config config) {
        this.config = config != null ? config : new Idea195512Config();
