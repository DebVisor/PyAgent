...
@Data
public class Idea195306Config {
    private String name = "idea_195306";
 ...
 */
@Slf4j
public class Idea195306Service {
    private static final int IDEA_ID = 195306;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195306Service() {
        this(new Idea195306Config());
    }

    public Idea195306Service(Idea195306Config config) {
        this.config = config != null ? config : new Idea195306Config();
