...
@Data
public class Idea195522Config {
    private String name = "idea_195522";
 ...
 */
@Slf4j
public class Idea195522Service {
    private static final int IDEA_ID = 195522;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195522Service() {
        this(new Idea195522Config());
    }

    public Idea195522Service(Idea195522Config config) {
        this.config = config != null ? config : new Idea195522Config();
