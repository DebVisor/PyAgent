...
@Data
public class Idea195376Config {
    private String name = "idea_195376";
 ...
 */
@Slf4j
public class Idea195376Service {
    private static final int IDEA_ID = 195376;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195376Service() {
        this(new Idea195376Config());
    }

    public Idea195376Service(Idea195376Config config) {
        this.config = config != null ? config : new Idea195376Config();
