...
@Data
public class Idea195513Config {
    private String name = "idea_195513";
 ...
 */
@Slf4j
public class Idea195513Service {
    private static final int IDEA_ID = 195513;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195513Service() {
        this(new Idea195513Config());
    }

    public Idea195513Service(Idea195513Config config) {
        this.config = config != null ? config : new Idea195513Config();
