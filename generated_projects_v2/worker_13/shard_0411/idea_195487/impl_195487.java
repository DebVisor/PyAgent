...
@Data
public class Idea195487Config {
    private String name = "idea_195487";
 ...
 */
@Slf4j
public class Idea195487Service {
    private static final int IDEA_ID = 195487;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195487Service() {
        this(new Idea195487Config());
    }

    public Idea195487Service(Idea195487Config config) {
        this.config = config != null ? config : new Idea195487Config();
