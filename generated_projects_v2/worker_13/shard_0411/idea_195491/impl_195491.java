...
@Data
public class Idea195491Config {
    private String name = "idea_195491";
 ...
 */
@Slf4j
public class Idea195491Service {
    private static final int IDEA_ID = 195491;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195491Service() {
        this(new Idea195491Config());
    }

    public Idea195491Service(Idea195491Config config) {
        this.config = config != null ? config : new Idea195491Config();
