...
@Data
public class Idea195295Config {
    private String name = "idea_195295";
 ...
 */
@Slf4j
public class Idea195295Service {
    private static final int IDEA_ID = 195295;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195295Service() {
        this(new Idea195295Config());
    }

    public Idea195295Service(Idea195295Config config) {
        this.config = config != null ? config : new Idea195295Config();
