...
@Data
public class Idea195515Config {
    private String name = "idea_195515";
 ...
 */
@Slf4j
public class Idea195515Service {
    private static final int IDEA_ID = 195515;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195515Service() {
        this(new Idea195515Config());
    }

    public Idea195515Service(Idea195515Config config) {
        this.config = config != null ? config : new Idea195515Config();
