...
@Data
public class Idea195240Config {
    private String name = "idea_195240";
 ...
 */
@Slf4j
public class Idea195240Service {
    private static final int IDEA_ID = 195240;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195240Service() {
        this(new Idea195240Config());
    }

    public Idea195240Service(Idea195240Config config) {
        this.config = config != null ? config : new Idea195240Config();
