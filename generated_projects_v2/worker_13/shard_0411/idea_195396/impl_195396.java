...
@Data
public class Idea195396Config {
    private String name = "idea_195396";
 ...
 */
@Slf4j
public class Idea195396Service {
    private static final int IDEA_ID = 195396;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195396Service() {
        this(new Idea195396Config());
    }

    public Idea195396Service(Idea195396Config config) {
        this.config = config != null ? config : new Idea195396Config();
