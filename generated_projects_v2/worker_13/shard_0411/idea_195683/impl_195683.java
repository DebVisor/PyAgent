...
@Data
public class Idea195683Config {
    private String name = "idea_195683";
 ...
 */
@Slf4j
public class Idea195683Service {
    private static final int IDEA_ID = 195683;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195683Service() {
        this(new Idea195683Config());
    }

    public Idea195683Service(Idea195683Config config) {
        this.config = config != null ? config : new Idea195683Config();
