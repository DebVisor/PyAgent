...
@Data
public class Idea195524Config {
    private String name = "idea_195524";
 ...
 */
@Slf4j
public class Idea195524Service {
    private static final int IDEA_ID = 195524;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195524Service() {
        this(new Idea195524Config());
    }

    public Idea195524Service(Idea195524Config config) {
        this.config = config != null ? config : new Idea195524Config();
