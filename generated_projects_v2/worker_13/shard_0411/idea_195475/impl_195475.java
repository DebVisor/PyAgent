...
@Data
public class Idea195475Config {
    private String name = "idea_195475";
 ...
 */
@Slf4j
public class Idea195475Service {
    private static final int IDEA_ID = 195475;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195475Service() {
        this(new Idea195475Config());
    }

    public Idea195475Service(Idea195475Config config) {
        this.config = config != null ? config : new Idea195475Config();
