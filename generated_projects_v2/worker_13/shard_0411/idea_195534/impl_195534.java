...
@Data
public class Idea195534Config {
    private String name = "idea_195534";
 ...
 */
@Slf4j
public class Idea195534Service {
    private static final int IDEA_ID = 195534;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195534Service() {
        this(new Idea195534Config());
    }

    public Idea195534Service(Idea195534Config config) {
        this.config = config != null ? config : new Idea195534Config();
