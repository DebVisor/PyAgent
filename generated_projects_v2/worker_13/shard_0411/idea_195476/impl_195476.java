...
@Data
public class Idea195476Config {
    private String name = "idea_195476";
 ...
 */
@Slf4j
public class Idea195476Service {
    private static final int IDEA_ID = 195476;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195476Service() {
        this(new Idea195476Config());
    }

    public Idea195476Service(Idea195476Config config) {
        this.config = config != null ? config : new Idea195476Config();
