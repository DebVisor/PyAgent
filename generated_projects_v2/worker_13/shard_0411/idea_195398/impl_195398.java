...
@Data
public class Idea195398Config {
    private String name = "idea_195398";
 ...
 */
@Slf4j
public class Idea195398Service {
    private static final int IDEA_ID = 195398;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195398Service() {
        this(new Idea195398Config());
    }

    public Idea195398Service(Idea195398Config config) {
        this.config = config != null ? config : new Idea195398Config();
