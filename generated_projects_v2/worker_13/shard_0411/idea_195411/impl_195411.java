...
@Data
public class Idea195411Config {
    private String name = "idea_195411";
 ...
 */
@Slf4j
public class Idea195411Service {
    private static final int IDEA_ID = 195411;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195411Service() {
        this(new Idea195411Config());
    }

    public Idea195411Service(Idea195411Config config) {
        this.config = config != null ? config : new Idea195411Config();
