...
@Data
public class Idea195662Config {
    private String name = "idea_195662";
 ...
 */
@Slf4j
public class Idea195662Service {
    private static final int IDEA_ID = 195662;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195662Service() {
        this(new Idea195662Config());
    }

    public Idea195662Service(Idea195662Config config) {
        this.config = config != null ? config : new Idea195662Config();
