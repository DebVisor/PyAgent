...
@Data
public class Idea195401Config {
    private String name = "idea_195401";
 ...
 */
@Slf4j
public class Idea195401Service {
    private static final int IDEA_ID = 195401;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195401Service() {
        this(new Idea195401Config());
    }

    public Idea195401Service(Idea195401Config config) {
        this.config = config != null ? config : new Idea195401Config();
