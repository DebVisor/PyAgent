...
@Data
public class Idea195561Config {
    private String name = "idea_195561";
 ...
 */
@Slf4j
public class Idea195561Service {
    private static final int IDEA_ID = 195561;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195561Service() {
        this(new Idea195561Config());
    }

    public Idea195561Service(Idea195561Config config) {
        this.config = config != null ? config : new Idea195561Config();
