...
@Data
public class Idea195382Config {
    private String name = "idea_195382";
 ...
 */
@Slf4j
public class Idea195382Service {
    private static final int IDEA_ID = 195382;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195382Service() {
        this(new Idea195382Config());
    }

    public Idea195382Service(Idea195382Config config) {
        this.config = config != null ? config : new Idea195382Config();
