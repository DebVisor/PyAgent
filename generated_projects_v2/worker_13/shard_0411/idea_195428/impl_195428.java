...
@Data
public class Idea195428Config {
    private String name = "idea_195428";
 ...
 */
@Slf4j
public class Idea195428Service {
    private static final int IDEA_ID = 195428;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195428Service() {
        this(new Idea195428Config());
    }

    public Idea195428Service(Idea195428Config config) {
        this.config = config != null ? config : new Idea195428Config();
