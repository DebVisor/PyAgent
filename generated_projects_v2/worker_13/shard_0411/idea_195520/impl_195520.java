...
@Data
public class Idea195520Config {
    private String name = "idea_195520";
 ...
 */
@Slf4j
public class Idea195520Service {
    private static final int IDEA_ID = 195520;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195520Service() {
        this(new Idea195520Config());
    }

    public Idea195520Service(Idea195520Config config) {
        this.config = config != null ? config : new Idea195520Config();
