...
@Data
public class Idea195480Config {
    private String name = "idea_195480";
 ...
 */
@Slf4j
public class Idea195480Service {
    private static final int IDEA_ID = 195480;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195480Service() {
        this(new Idea195480Config());
    }

    public Idea195480Service(Idea195480Config config) {
        this.config = config != null ? config : new Idea195480Config();
