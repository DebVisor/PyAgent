...
@Data
public class Idea195317Config {
    private String name = "idea_195317";
 ...
 */
@Slf4j
public class Idea195317Service {
    private static final int IDEA_ID = 195317;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195317Service() {
        this(new Idea195317Config());
    }

    public Idea195317Service(Idea195317Config config) {
        this.config = config != null ? config : new Idea195317Config();
