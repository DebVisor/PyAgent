...
@Data
public class Idea195675Config {
    private String name = "idea_195675";
 ...
 */
@Slf4j
public class Idea195675Service {
    private static final int IDEA_ID = 195675;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195675Service() {
        this(new Idea195675Config());
    }

    public Idea195675Service(Idea195675Config config) {
        this.config = config != null ? config : new Idea195675Config();
