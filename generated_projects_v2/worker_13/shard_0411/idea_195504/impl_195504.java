...
@Data
public class Idea195504Config {
    private String name = "idea_195504";
 ...
 */
@Slf4j
public class Idea195504Service {
    private static final int IDEA_ID = 195504;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195504Service() {
        this(new Idea195504Config());
    }

    public Idea195504Service(Idea195504Config config) {
        this.config = config != null ? config : new Idea195504Config();
