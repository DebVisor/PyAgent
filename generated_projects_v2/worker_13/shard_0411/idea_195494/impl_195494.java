...
@Data
public class Idea195494Config {
    private String name = "idea_195494";
 ...
 */
@Slf4j
public class Idea195494Service {
    private static final int IDEA_ID = 195494;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195494Service() {
        this(new Idea195494Config());
    }

    public Idea195494Service(Idea195494Config config) {
        this.config = config != null ? config : new Idea195494Config();
