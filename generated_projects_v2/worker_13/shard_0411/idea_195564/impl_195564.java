...
@Data
public class Idea195564Config {
    private String name = "idea_195564";
 ...
 */
@Slf4j
public class Idea195564Service {
    private static final int IDEA_ID = 195564;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195564Service() {
        this(new Idea195564Config());
    }

    public Idea195564Service(Idea195564Config config) {
        this.config = config != null ? config : new Idea195564Config();
