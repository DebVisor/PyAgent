...
@Data
public class Idea195245Config {
    private String name = "idea_195245";
 ...
 */
@Slf4j
public class Idea195245Service {
    private static final int IDEA_ID = 195245;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195245Service() {
        this(new Idea195245Config());
    }

    public Idea195245Service(Idea195245Config config) {
        this.config = config != null ? config : new Idea195245Config();
