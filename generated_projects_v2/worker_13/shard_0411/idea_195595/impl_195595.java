...
@Data
public class Idea195595Config {
    private String name = "idea_195595";
 ...
 */
@Slf4j
public class Idea195595Service {
    private static final int IDEA_ID = 195595;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195595Service() {
        this(new Idea195595Config());
    }

    public Idea195595Service(Idea195595Config config) {
        this.config = config != null ? config : new Idea195595Config();
