...
@Data
public class Idea195451Config {
    private String name = "idea_195451";
 ...
 */
@Slf4j
public class Idea195451Service {
    private static final int IDEA_ID = 195451;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195451Service() {
        this(new Idea195451Config());
    }

    public Idea195451Service(Idea195451Config config) {
        this.config = config != null ? config : new Idea195451Config();
