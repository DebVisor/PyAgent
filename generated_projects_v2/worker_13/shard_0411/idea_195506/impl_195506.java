...
@Data
public class Idea195506Config {
    private String name = "idea_195506";
 ...
 */
@Slf4j
public class Idea195506Service {
    private static final int IDEA_ID = 195506;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195506Service() {
        this(new Idea195506Config());
    }

    public Idea195506Service(Idea195506Config config) {
        this.config = config != null ? config : new Idea195506Config();
