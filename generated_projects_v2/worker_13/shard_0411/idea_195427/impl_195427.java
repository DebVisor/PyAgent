...
@Data
public class Idea195427Config {
    private String name = "idea_195427";
 ...
 */
@Slf4j
public class Idea195427Service {
    private static final int IDEA_ID = 195427;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195427Service() {
        this(new Idea195427Config());
    }

    public Idea195427Service(Idea195427Config config) {
        this.config = config != null ? config : new Idea195427Config();
