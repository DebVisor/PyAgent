...
@Data
public class Idea195551Config {
    private String name = "idea_195551";
 ...
 */
@Slf4j
public class Idea195551Service {
    private static final int IDEA_ID = 195551;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195551Service() {
        this(new Idea195551Config());
    }

    public Idea195551Service(Idea195551Config config) {
        this.config = config != null ? config : new Idea195551Config();
