...
@Data
public class Idea195267Config {
    private String name = "idea_195267";
 ...
 */
@Slf4j
public class Idea195267Service {
    private static final int IDEA_ID = 195267;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195267Service() {
        this(new Idea195267Config());
    }

    public Idea195267Service(Idea195267Config config) {
        this.config = config != null ? config : new Idea195267Config();
