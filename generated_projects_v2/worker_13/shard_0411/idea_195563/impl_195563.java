...
@Data
public class Idea195563Config {
    private String name = "idea_195563";
 ...
 */
@Slf4j
public class Idea195563Service {
    private static final int IDEA_ID = 195563;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195563Service() {
        this(new Idea195563Config());
    }

    public Idea195563Service(Idea195563Config config) {
        this.config = config != null ? config : new Idea195563Config();
