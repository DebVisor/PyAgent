...
@Data
public class Idea195505Config {
    private String name = "idea_195505";
 ...
 */
@Slf4j
public class Idea195505Service {
    private static final int IDEA_ID = 195505;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195505Service() {
        this(new Idea195505Config());
    }

    public Idea195505Service(Idea195505Config config) {
        this.config = config != null ? config : new Idea195505Config();
