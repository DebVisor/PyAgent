...
@Data
public class Idea195425Config {
    private String name = "idea_195425";
 ...
 */
@Slf4j
public class Idea195425Service {
    private static final int IDEA_ID = 195425;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195425Service() {
        this(new Idea195425Config());
    }

    public Idea195425Service(Idea195425Config config) {
        this.config = config != null ? config : new Idea195425Config();
