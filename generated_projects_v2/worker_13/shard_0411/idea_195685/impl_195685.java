...
@Data
public class Idea195685Config {
    private String name = "idea_195685";
 ...
 */
@Slf4j
public class Idea195685Service {
    private static final int IDEA_ID = 195685;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195685Service() {
        this(new Idea195685Config());
    }

    public Idea195685Service(Idea195685Config config) {
        this.config = config != null ? config : new Idea195685Config();
