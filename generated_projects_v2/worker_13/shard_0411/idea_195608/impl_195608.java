...
@Data
public class Idea195608Config {
    private String name = "idea_195608";
 ...
 */
@Slf4j
public class Idea195608Service {
    private static final int IDEA_ID = 195608;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195608Service() {
        this(new Idea195608Config());
    }

    public Idea195608Service(Idea195608Config config) {
        this.config = config != null ? config : new Idea195608Config();
