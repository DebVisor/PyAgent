...
@Data
public class Idea195358Config {
    private String name = "idea_195358";
 ...
 */
@Slf4j
public class Idea195358Service {
    private static final int IDEA_ID = 195358;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195358Service() {
        this(new Idea195358Config());
    }

    public Idea195358Service(Idea195358Config config) {
        this.config = config != null ? config : new Idea195358Config();
