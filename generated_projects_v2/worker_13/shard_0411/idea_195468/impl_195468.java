...
@Data
public class Idea195468Config {
    private String name = "idea_195468";
 ...
 */
@Slf4j
public class Idea195468Service {
    private static final int IDEA_ID = 195468;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195468Service() {
        this(new Idea195468Config());
    }

    public Idea195468Service(Idea195468Config config) {
        this.config = config != null ? config : new Idea195468Config();
