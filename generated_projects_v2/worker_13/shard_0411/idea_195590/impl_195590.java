...
@Data
public class Idea195590Config {
    private String name = "idea_195590";
 ...
 */
@Slf4j
public class Idea195590Service {
    private static final int IDEA_ID = 195590;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195590Service() {
        this(new Idea195590Config());
    }

    public Idea195590Service(Idea195590Config config) {
        this.config = config != null ? config : new Idea195590Config();
