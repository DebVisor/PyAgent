...
@Data
public class Idea195554Config {
    private String name = "idea_195554";
 ...
 */
@Slf4j
public class Idea195554Service {
    private static final int IDEA_ID = 195554;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195554Service() {
        this(new Idea195554Config());
    }

    public Idea195554Service(Idea195554Config config) {
        this.config = config != null ? config : new Idea195554Config();
