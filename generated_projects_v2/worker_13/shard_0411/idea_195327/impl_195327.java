...
@Data
public class Idea195327Config {
    private String name = "idea_195327";
 ...
 */
@Slf4j
public class Idea195327Service {
    private static final int IDEA_ID = 195327;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195327Service() {
        this(new Idea195327Config());
    }

    public Idea195327Service(Idea195327Config config) {
        this.config = config != null ? config : new Idea195327Config();
