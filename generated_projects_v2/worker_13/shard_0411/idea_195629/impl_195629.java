...
@Data
public class Idea195629Config {
    private String name = "idea_195629";
 ...
 */
@Slf4j
public class Idea195629Service {
    private static final int IDEA_ID = 195629;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195629Service() {
        this(new Idea195629Config());
    }

    public Idea195629Service(Idea195629Config config) {
        this.config = config != null ? config : new Idea195629Config();
