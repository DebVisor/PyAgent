...
@Data
public class Idea195483Config {
    private String name = "idea_195483";
 ...
 */
@Slf4j
public class Idea195483Service {
    private static final int IDEA_ID = 195483;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195483Service() {
        this(new Idea195483Config());
    }

    public Idea195483Service(Idea195483Config config) {
        this.config = config != null ? config : new Idea195483Config();
