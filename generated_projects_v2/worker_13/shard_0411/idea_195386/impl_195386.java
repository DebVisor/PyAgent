...
@Data
public class Idea195386Config {
    private String name = "idea_195386";
 ...
 */
@Slf4j
public class Idea195386Service {
    private static final int IDEA_ID = 195386;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195386Service() {
        this(new Idea195386Config());
    }

    public Idea195386Service(Idea195386Config config) {
        this.config = config != null ? config : new Idea195386Config();
