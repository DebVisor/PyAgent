...
@Data
public class Idea195326Config {
    private String name = "idea_195326";
 ...
 */
@Slf4j
public class Idea195326Service {
    private static final int IDEA_ID = 195326;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195326Service() {
        this(new Idea195326Config());
    }

    public Idea195326Service(Idea195326Config config) {
        this.config = config != null ? config : new Idea195326Config();
