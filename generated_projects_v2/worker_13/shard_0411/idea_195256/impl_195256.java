...
@Data
public class Idea195256Config {
    private String name = "idea_195256";
 ...
 */
@Slf4j
public class Idea195256Service {
    private static final int IDEA_ID = 195256;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195256Service() {
        this(new Idea195256Config());
    }

    public Idea195256Service(Idea195256Config config) {
        this.config = config != null ? config : new Idea195256Config();
