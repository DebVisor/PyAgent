...
@Data
public class Idea195274Config {
    private String name = "idea_195274";
 ...
 */
@Slf4j
public class Idea195274Service {
    private static final int IDEA_ID = 195274;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195274Service() {
        this(new Idea195274Config());
    }

    public Idea195274Service(Idea195274Config config) {
        this.config = config != null ? config : new Idea195274Config();
