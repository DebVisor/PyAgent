...
@Data
public class Idea195297Config {
    private String name = "idea_195297";
 ...
 */
@Slf4j
public class Idea195297Service {
    private static final int IDEA_ID = 195297;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195297Service() {
        this(new Idea195297Config());
    }

    public Idea195297Service(Idea195297Config config) {
        this.config = config != null ? config : new Idea195297Config();
