...
@Data
public class Idea195687Config {
    private String name = "idea_195687";
 ...
 */
@Slf4j
public class Idea195687Service {
    private static final int IDEA_ID = 195687;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195687Service() {
        this(new Idea195687Config());
    }

    public Idea195687Service(Idea195687Config config) {
        this.config = config != null ? config : new Idea195687Config();
