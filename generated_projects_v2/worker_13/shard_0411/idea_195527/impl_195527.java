...
@Data
public class Idea195527Config {
    private String name = "idea_195527";
 ...
 */
@Slf4j
public class Idea195527Service {
    private static final int IDEA_ID = 195527;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195527Service() {
        this(new Idea195527Config());
    }

    public Idea195527Service(Idea195527Config config) {
        this.config = config != null ? config : new Idea195527Config();
