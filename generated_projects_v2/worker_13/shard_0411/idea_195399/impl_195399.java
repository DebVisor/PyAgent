...
@Data
public class Idea195399Config {
    private String name = "idea_195399";
 ...
 */
@Slf4j
public class Idea195399Service {
    private static final int IDEA_ID = 195399;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195399Service() {
        this(new Idea195399Config());
    }

    public Idea195399Service(Idea195399Config config) {
        this.config = config != null ? config : new Idea195399Config();
