...
@Data
public class Idea195697Config {
    private String name = "idea_195697";
 ...
 */
@Slf4j
public class Idea195697Service {
    private static final int IDEA_ID = 195697;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195697Service() {
        this(new Idea195697Config());
    }

    public Idea195697Service(Idea195697Config config) {
        this.config = config != null ? config : new Idea195697Config();
