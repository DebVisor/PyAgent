...
@Data
public class Idea195526Config {
    private String name = "idea_195526";
 ...
 */
@Slf4j
public class Idea195526Service {
    private static final int IDEA_ID = 195526;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195526Service() {
        this(new Idea195526Config());
    }

    public Idea195526Service(Idea195526Config config) {
        this.config = config != null ? config : new Idea195526Config();
