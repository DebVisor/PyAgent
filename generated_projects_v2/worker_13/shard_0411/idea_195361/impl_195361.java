...
@Data
public class Idea195361Config {
    private String name = "idea_195361";
 ...
 */
@Slf4j
public class Idea195361Service {
    private static final int IDEA_ID = 195361;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195361Service() {
        this(new Idea195361Config());
    }

    public Idea195361Service(Idea195361Config config) {
        this.config = config != null ? config : new Idea195361Config();
