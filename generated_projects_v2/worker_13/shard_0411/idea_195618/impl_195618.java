...
@Data
public class Idea195618Config {
    private String name = "idea_195618";
 ...
 */
@Slf4j
public class Idea195618Service {
    private static final int IDEA_ID = 195618;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195618Service() {
        this(new Idea195618Config());
    }

    public Idea195618Service(Idea195618Config config) {
        this.config = config != null ? config : new Idea195618Config();
