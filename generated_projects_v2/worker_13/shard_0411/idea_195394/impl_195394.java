...
@Data
public class Idea195394Config {
    private String name = "idea_195394";
 ...
 */
@Slf4j
public class Idea195394Service {
    private static final int IDEA_ID = 195394;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195394Service() {
        this(new Idea195394Config());
    }

    public Idea195394Service(Idea195394Config config) {
        this.config = config != null ? config : new Idea195394Config();
