...
@Data
public class Idea195238Config {
    private String name = "idea_195238";
 ...
 */
@Slf4j
public class Idea195238Service {
    private static final int IDEA_ID = 195238;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195238Service() {
        this(new Idea195238Config());
    }

    public Idea195238Service(Idea195238Config config) {
        this.config = config != null ? config : new Idea195238Config();
