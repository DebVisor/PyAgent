...
@Data
public class Idea195291Config {
    private String name = "idea_195291";
 ...
 */
@Slf4j
public class Idea195291Service {
    private static final int IDEA_ID = 195291;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195291Service() {
        this(new Idea195291Config());
    }

    public Idea195291Service(Idea195291Config config) {
        this.config = config != null ? config : new Idea195291Config();
