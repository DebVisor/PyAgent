...
@Data
public class Idea195523Config {
    private String name = "idea_195523";
 ...
 */
@Slf4j
public class Idea195523Service {
    private static final int IDEA_ID = 195523;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195523Service() {
        this(new Idea195523Config());
    }

    public Idea195523Service(Idea195523Config config) {
        this.config = config != null ? config : new Idea195523Config();
