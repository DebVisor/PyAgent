...
@Data
public class Idea195405Config {
    private String name = "idea_195405";
 ...
 */
@Slf4j
public class Idea195405Service {
    private static final int IDEA_ID = 195405;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195405Service() {
        this(new Idea195405Config());
    }

    public Idea195405Service(Idea195405Config config) {
        this.config = config != null ? config : new Idea195405Config();
