...
@Data
public class Idea195413Config {
    private String name = "idea_195413";
 ...
 */
@Slf4j
public class Idea195413Service {
    private static final int IDEA_ID = 195413;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195413Service() {
        this(new Idea195413Config());
    }

    public Idea195413Service(Idea195413Config config) {
        this.config = config != null ? config : new Idea195413Config();
