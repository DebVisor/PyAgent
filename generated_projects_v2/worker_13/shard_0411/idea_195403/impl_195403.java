...
@Data
public class Idea195403Config {
    private String name = "idea_195403";
 ...
 */
@Slf4j
public class Idea195403Service {
    private static final int IDEA_ID = 195403;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195403Service() {
        this(new Idea195403Config());
    }

    public Idea195403Service(Idea195403Config config) {
        this.config = config != null ? config : new Idea195403Config();
