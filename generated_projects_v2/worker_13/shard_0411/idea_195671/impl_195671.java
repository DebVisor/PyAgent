...
@Data
public class Idea195671Config {
    private String name = "idea_195671";
 ...
 */
@Slf4j
public class Idea195671Service {
    private static final int IDEA_ID = 195671;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195671Service() {
        this(new Idea195671Config());
    }

    public Idea195671Service(Idea195671Config config) {
        this.config = config != null ? config : new Idea195671Config();
