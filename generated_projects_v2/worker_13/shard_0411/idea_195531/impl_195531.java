...
@Data
public class Idea195531Config {
    private String name = "idea_195531";
 ...
 */
@Slf4j
public class Idea195531Service {
    private static final int IDEA_ID = 195531;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195531Service() {
        this(new Idea195531Config());
    }

    public Idea195531Service(Idea195531Config config) {
        this.config = config != null ? config : new Idea195531Config();
