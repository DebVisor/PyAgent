...
@Data
public class Idea195532Config {
    private String name = "idea_195532";
 ...
 */
@Slf4j
public class Idea195532Service {
    private static final int IDEA_ID = 195532;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195532Service() {
        this(new Idea195532Config());
    }

    public Idea195532Service(Idea195532Config config) {
        this.config = config != null ? config : new Idea195532Config();
