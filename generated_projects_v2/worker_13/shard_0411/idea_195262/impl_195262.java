...
@Data
public class Idea195262Config {
    private String name = "idea_195262";
 ...
 */
@Slf4j
public class Idea195262Service {
    private static final int IDEA_ID = 195262;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195262Service() {
        this(new Idea195262Config());
    }

    public Idea195262Service(Idea195262Config config) {
        this.config = config != null ? config : new Idea195262Config();
