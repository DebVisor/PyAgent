...
@Data
public class Idea195510Config {
    private String name = "idea_195510";
 ...
 */
@Slf4j
public class Idea195510Service {
    private static final int IDEA_ID = 195510;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195510Service() {
        this(new Idea195510Config());
    }

    public Idea195510Service(Idea195510Config config) {
        this.config = config != null ? config : new Idea195510Config();
