...
@Data
public class Idea195653Config {
    private String name = "idea_195653";
 ...
 */
@Slf4j
public class Idea195653Service {
    private static final int IDEA_ID = 195653;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195653Service() {
        this(new Idea195653Config());
    }

    public Idea195653Service(Idea195653Config config) {
        this.config = config != null ? config : new Idea195653Config();
