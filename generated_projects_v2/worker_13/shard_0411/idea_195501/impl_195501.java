...
@Data
public class Idea195501Config {
    private String name = "idea_195501";
 ...
 */
@Slf4j
public class Idea195501Service {
    private static final int IDEA_ID = 195501;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195501Service() {
        this(new Idea195501Config());
    }

    public Idea195501Service(Idea195501Config config) {
        this.config = config != null ? config : new Idea195501Config();
