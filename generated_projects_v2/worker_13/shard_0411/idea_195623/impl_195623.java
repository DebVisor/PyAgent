...
@Data
public class Idea195623Config {
    private String name = "idea_195623";
 ...
 */
@Slf4j
public class Idea195623Service {
    private static final int IDEA_ID = 195623;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195623Service() {
        this(new Idea195623Config());
    }

    public Idea195623Service(Idea195623Config config) {
        this.config = config != null ? config : new Idea195623Config();
