...
@Data
public class Idea195637Config {
    private String name = "idea_195637";
 ...
 */
@Slf4j
public class Idea195637Service {
    private static final int IDEA_ID = 195637;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195637Service() {
        this(new Idea195637Config());
    }

    public Idea195637Service(Idea195637Config config) {
        this.config = config != null ? config : new Idea195637Config();
