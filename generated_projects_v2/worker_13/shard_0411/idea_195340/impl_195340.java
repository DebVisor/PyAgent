...
@Data
public class Idea195340Config {
    private String name = "idea_195340";
 ...
 */
@Slf4j
public class Idea195340Service {
    private static final int IDEA_ID = 195340;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195340Service() {
        this(new Idea195340Config());
    }

    public Idea195340Service(Idea195340Config config) {
        this.config = config != null ? config : new Idea195340Config();
