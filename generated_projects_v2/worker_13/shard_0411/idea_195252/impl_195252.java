...
@Data
public class Idea195252Config {
    private String name = "idea_195252";
 ...
 */
@Slf4j
public class Idea195252Service {
    private static final int IDEA_ID = 195252;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195252Service() {
        this(new Idea195252Config());
    }

    public Idea195252Service(Idea195252Config config) {
        this.config = config != null ? config : new Idea195252Config();
