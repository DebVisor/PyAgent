...
@Data
public class Idea195616Config {
    private String name = "idea_195616";
 ...
 */
@Slf4j
public class Idea195616Service {
    private static final int IDEA_ID = 195616;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195616Service() {
        this(new Idea195616Config());
    }

    public Idea195616Service(Idea195616Config config) {
        this.config = config != null ? config : new Idea195616Config();
