...
@Data
public class Idea195296Config {
    private String name = "idea_195296";
 ...
 */
@Slf4j
public class Idea195296Service {
    private static final int IDEA_ID = 195296;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195296Service() {
        this(new Idea195296Config());
    }

    public Idea195296Service(Idea195296Config config) {
        this.config = config != null ? config : new Idea195296Config();
