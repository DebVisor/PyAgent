...
@Data
public class Idea195631Config {
    private String name = "idea_195631";
 ...
 */
@Slf4j
public class Idea195631Service {
    private static final int IDEA_ID = 195631;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195631Service() {
        this(new Idea195631Config());
    }

    public Idea195631Service(Idea195631Config config) {
        this.config = config != null ? config : new Idea195631Config();
