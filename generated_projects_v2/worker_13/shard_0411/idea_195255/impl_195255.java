...
@Data
public class Idea195255Config {
    private String name = "idea_195255";
 ...
 */
@Slf4j
public class Idea195255Service {
    private static final int IDEA_ID = 195255;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195255Service() {
        this(new Idea195255Config());
    }

    public Idea195255Service(Idea195255Config config) {
        this.config = config != null ? config : new Idea195255Config();
