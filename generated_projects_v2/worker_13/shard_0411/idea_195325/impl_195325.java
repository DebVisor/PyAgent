...
@Data
public class Idea195325Config {
    private String name = "idea_195325";
 ...
 */
@Slf4j
public class Idea195325Service {
    private static final int IDEA_ID = 195325;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195325Service() {
        this(new Idea195325Config());
    }

    public Idea195325Service(Idea195325Config config) {
        this.config = config != null ? config : new Idea195325Config();
