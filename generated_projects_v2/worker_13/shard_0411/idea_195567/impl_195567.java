...
@Data
public class Idea195567Config {
    private String name = "idea_195567";
 ...
 */
@Slf4j
public class Idea195567Service {
    private static final int IDEA_ID = 195567;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195567Service() {
        this(new Idea195567Config());
    }

    public Idea195567Service(Idea195567Config config) {
        this.config = config != null ? config : new Idea195567Config();
