...
@Data
public class Idea195699Config {
    private String name = "idea_195699";
 ...
 */
@Slf4j
public class Idea195699Service {
    private static final int IDEA_ID = 195699;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195699Service() {
        this(new Idea195699Config());
    }

    public Idea195699Service(Idea195699Config config) {
        this.config = config != null ? config : new Idea195699Config();
