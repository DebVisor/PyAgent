...
@Data
public class Idea195636Config {
    private String name = "idea_195636";
 ...
 */
@Slf4j
public class Idea195636Service {
    private static final int IDEA_ID = 195636;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195636Service() {
        this(new Idea195636Config());
    }

    public Idea195636Service(Idea195636Config config) {
        this.config = config != null ? config : new Idea195636Config();
