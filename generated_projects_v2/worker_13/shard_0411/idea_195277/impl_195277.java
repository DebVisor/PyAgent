...
@Data
public class Idea195277Config {
    private String name = "idea_195277";
 ...
 */
@Slf4j
public class Idea195277Service {
    private static final int IDEA_ID = 195277;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195277Service() {
        this(new Idea195277Config());
    }

    public Idea195277Service(Idea195277Config config) {
        this.config = config != null ? config : new Idea195277Config();
