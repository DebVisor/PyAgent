...
@Data
public class Idea200035Config {
    private String name = "idea_200035";
 ...
 */
@Slf4j
public class Idea200035Service {
    private static final int IDEA_ID = 200035;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200035Service() {
        this(new Idea200035Config());
    }

    public Idea200035Service(Idea200035Config config) {
        this.config = config != null ? config : new Idea200035Config();
