...
@Data
public class Idea200320Config {
    private String name = "idea_200320";
 ...
 */
@Slf4j
public class Idea200320Service {
    private static final int IDEA_ID = 200320;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200320Service() {
        this(new Idea200320Config());
    }

    public Idea200320Service(Idea200320Config config) {
        this.config = config != null ? config : new Idea200320Config();
