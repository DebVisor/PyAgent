...
@Data
public class Idea199981Config {
    private String name = "idea_199981";
 ...
 */
@Slf4j
public class Idea199981Service {
    private static final int IDEA_ID = 199981;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199981Service() {
        this(new Idea199981Config());
    }

    public Idea199981Service(Idea199981Config config) {
        this.config = config != null ? config : new Idea199981Config();
