...
@Data
public class Idea200401Config {
    private String name = "idea_200401";
 ...
 */
@Slf4j
public class Idea200401Service {
    private static final int IDEA_ID = 200401;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200401Service() {
        this(new Idea200401Config());
    }

    public Idea200401Service(Idea200401Config config) {
        this.config = config != null ? config : new Idea200401Config();
