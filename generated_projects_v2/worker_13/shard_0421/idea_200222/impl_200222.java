...
@Data
public class Idea200222Config {
    private String name = "idea_200222";
 ...
 */
@Slf4j
public class Idea200222Service {
    private static final int IDEA_ID = 200222;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200222Service() {
        this(new Idea200222Config());
    }

    public Idea200222Service(Idea200222Config config) {
        this.config = config != null ? config : new Idea200222Config();
