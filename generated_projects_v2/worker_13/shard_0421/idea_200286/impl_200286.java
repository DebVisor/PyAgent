...
@Data
public class Idea200286Config {
    private String name = "idea_200286";
 ...
 */
@Slf4j
public class Idea200286Service {
    private static final int IDEA_ID = 200286;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200286Service() {
        this(new Idea200286Config());
    }

    public Idea200286Service(Idea200286Config config) {
        this.config = config != null ? config : new Idea200286Config();
