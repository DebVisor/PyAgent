...
@Data
public class Idea200086Config {
    private String name = "idea_200086";
 ...
 */
@Slf4j
public class Idea200086Service {
    private static final int IDEA_ID = 200086;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200086Service() {
        this(new Idea200086Config());
    }

    public Idea200086Service(Idea200086Config config) {
        this.config = config != null ? config : new Idea200086Config();
