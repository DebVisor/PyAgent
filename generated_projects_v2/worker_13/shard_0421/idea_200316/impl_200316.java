...
@Data
public class Idea200316Config {
    private String name = "idea_200316";
 ...
 */
@Slf4j
public class Idea200316Service {
    private static final int IDEA_ID = 200316;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200316Service() {
        this(new Idea200316Config());
    }

    public Idea200316Service(Idea200316Config config) {
        this.config = config != null ? config : new Idea200316Config();
