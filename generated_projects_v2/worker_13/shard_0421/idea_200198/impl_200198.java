...
@Data
public class Idea200198Config {
    private String name = "idea_200198";
 ...
 */
@Slf4j
public class Idea200198Service {
    private static final int IDEA_ID = 200198;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200198Service() {
        this(new Idea200198Config());
    }

    public Idea200198Service(Idea200198Config config) {
        this.config = config != null ? config : new Idea200198Config();
