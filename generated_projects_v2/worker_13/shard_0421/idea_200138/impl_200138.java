...
@Data
public class Idea200138Config {
    private String name = "idea_200138";
 ...
 */
@Slf4j
public class Idea200138Service {
    private static final int IDEA_ID = 200138;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200138Service() {
        this(new Idea200138Config());
    }

    public Idea200138Service(Idea200138Config config) {
        this.config = config != null ? config : new Idea200138Config();
