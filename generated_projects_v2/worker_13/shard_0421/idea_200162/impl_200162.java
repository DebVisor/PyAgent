...
@Data
public class Idea200162Config {
    private String name = "idea_200162";
 ...
 */
@Slf4j
public class Idea200162Service {
    private static final int IDEA_ID = 200162;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200162Service() {
        this(new Idea200162Config());
    }

    public Idea200162Service(Idea200162Config config) {
        this.config = config != null ? config : new Idea200162Config();
