...
@Data
public class Idea200441Config {
    private String name = "idea_200441";
 ...
 */
@Slf4j
public class Idea200441Service {
    private static final int IDEA_ID = 200441;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200441Service() {
        this(new Idea200441Config());
    }

    public Idea200441Service(Idea200441Config config) {
        this.config = config != null ? config : new Idea200441Config();
