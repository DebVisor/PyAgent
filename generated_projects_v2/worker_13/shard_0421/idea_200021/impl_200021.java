...
@Data
public class Idea200021Config {
    private String name = "idea_200021";
 ...
 */
@Slf4j
public class Idea200021Service {
    private static final int IDEA_ID = 200021;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200021Service() {
        this(new Idea200021Config());
    }

    public Idea200021Service(Idea200021Config config) {
        this.config = config != null ? config : new Idea200021Config();
