...
@Data
public class Idea200116Config {
    private String name = "idea_200116";
 ...
 */
@Slf4j
public class Idea200116Service {
    private static final int IDEA_ID = 200116;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200116Service() {
        this(new Idea200116Config());
    }

    public Idea200116Service(Idea200116Config config) {
        this.config = config != null ? config : new Idea200116Config();
