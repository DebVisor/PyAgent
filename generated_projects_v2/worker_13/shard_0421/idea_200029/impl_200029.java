...
@Data
public class Idea200029Config {
    private String name = "idea_200029";
 ...
 */
@Slf4j
public class Idea200029Service {
    private static final int IDEA_ID = 200029;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200029Service() {
        this(new Idea200029Config());
    }

    public Idea200029Service(Idea200029Config config) {
        this.config = config != null ? config : new Idea200029Config();
