...
@Data
public class Idea200289Config {
    private String name = "idea_200289";
 ...
 */
@Slf4j
public class Idea200289Service {
    private static final int IDEA_ID = 200289;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200289Service() {
        this(new Idea200289Config());
    }

    public Idea200289Service(Idea200289Config config) {
        this.config = config != null ? config : new Idea200289Config();
