...
@Data
public class Idea200165Config {
    private String name = "idea_200165";
 ...
 */
@Slf4j
public class Idea200165Service {
    private static final int IDEA_ID = 200165;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200165Service() {
        this(new Idea200165Config());
    }

    public Idea200165Service(Idea200165Config config) {
        this.config = config != null ? config : new Idea200165Config();
