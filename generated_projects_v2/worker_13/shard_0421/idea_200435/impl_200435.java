...
@Data
public class Idea200435Config {
    private String name = "idea_200435";
 ...
 */
@Slf4j
public class Idea200435Service {
    private static final int IDEA_ID = 200435;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200435Service() {
        this(new Idea200435Config());
    }

    public Idea200435Service(Idea200435Config config) {
        this.config = config != null ? config : new Idea200435Config();
