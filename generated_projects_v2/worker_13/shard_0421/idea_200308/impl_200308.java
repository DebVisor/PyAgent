...
@Data
public class Idea200308Config {
    private String name = "idea_200308";
 ...
 */
@Slf4j
public class Idea200308Service {
    private static final int IDEA_ID = 200308;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200308Service() {
        this(new Idea200308Config());
    }

    public Idea200308Service(Idea200308Config config) {
        this.config = config != null ? config : new Idea200308Config();
