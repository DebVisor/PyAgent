...
@Data
public class Idea200333Config {
    private String name = "idea_200333";
 ...
 */
@Slf4j
public class Idea200333Service {
    private static final int IDEA_ID = 200333;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200333Service() {
        this(new Idea200333Config());
    }

    public Idea200333Service(Idea200333Config config) {
        this.config = config != null ? config : new Idea200333Config();
