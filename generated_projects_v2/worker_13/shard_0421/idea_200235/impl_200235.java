...
@Data
public class Idea200235Config {
    private String name = "idea_200235";
 ...
 */
@Slf4j
public class Idea200235Service {
    private static final int IDEA_ID = 200235;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200235Service() {
        this(new Idea200235Config());
    }

    public Idea200235Service(Idea200235Config config) {
        this.config = config != null ? config : new Idea200235Config();
