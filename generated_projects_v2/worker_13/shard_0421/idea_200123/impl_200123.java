...
@Data
public class Idea200123Config {
    private String name = "idea_200123";
 ...
 */
@Slf4j
public class Idea200123Service {
    private static final int IDEA_ID = 200123;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200123Service() {
        this(new Idea200123Config());
    }

    public Idea200123Service(Idea200123Config config) {
        this.config = config != null ? config : new Idea200123Config();
