...
@Data
public class Idea200094Config {
    private String name = "idea_200094";
 ...
 */
@Slf4j
public class Idea200094Service {
    private static final int IDEA_ID = 200094;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200094Service() {
        this(new Idea200094Config());
    }

    public Idea200094Service(Idea200094Config config) {
        this.config = config != null ? config : new Idea200094Config();
