...
@Data
public class Idea200130Config {
    private String name = "idea_200130";
 ...
 */
@Slf4j
public class Idea200130Service {
    private static final int IDEA_ID = 200130;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200130Service() {
        this(new Idea200130Config());
    }

    public Idea200130Service(Idea200130Config config) {
        this.config = config != null ? config : new Idea200130Config();
