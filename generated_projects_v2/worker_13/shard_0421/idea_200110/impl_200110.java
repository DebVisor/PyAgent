...
@Data
public class Idea200110Config {
    private String name = "idea_200110";
 ...
 */
@Slf4j
public class Idea200110Service {
    private static final int IDEA_ID = 200110;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200110Service() {
        this(new Idea200110Config());
    }

    public Idea200110Service(Idea200110Config config) {
        this.config = config != null ? config : new Idea200110Config();
