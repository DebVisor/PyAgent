...
@Data
public class Idea200352Config {
    private String name = "idea_200352";
 ...
 */
@Slf4j
public class Idea200352Service {
    private static final int IDEA_ID = 200352;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200352Service() {
        this(new Idea200352Config());
    }

    public Idea200352Service(Idea200352Config config) {
        this.config = config != null ? config : new Idea200352Config();
