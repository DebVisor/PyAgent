...
@Data
public class Idea200275Config {
    private String name = "idea_200275";
 ...
 */
@Slf4j
public class Idea200275Service {
    private static final int IDEA_ID = 200275;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200275Service() {
        this(new Idea200275Config());
    }

    public Idea200275Service(Idea200275Config config) {
        this.config = config != null ? config : new Idea200275Config();
