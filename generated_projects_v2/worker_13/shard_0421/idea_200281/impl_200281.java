...
@Data
public class Idea200281Config {
    private String name = "idea_200281";
 ...
 */
@Slf4j
public class Idea200281Service {
    private static final int IDEA_ID = 200281;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200281Service() {
        this(new Idea200281Config());
    }

    public Idea200281Service(Idea200281Config config) {
        this.config = config != null ? config : new Idea200281Config();
