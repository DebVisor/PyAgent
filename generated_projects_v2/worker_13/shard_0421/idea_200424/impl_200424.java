...
@Data
public class Idea200424Config {
    private String name = "idea_200424";
 ...
 */
@Slf4j
public class Idea200424Service {
    private static final int IDEA_ID = 200424;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200424Service() {
        this(new Idea200424Config());
    }

    public Idea200424Service(Idea200424Config config) {
        this.config = config != null ? config : new Idea200424Config();
