...
@Data
public class Idea200153Config {
    private String name = "idea_200153";
 ...
 */
@Slf4j
public class Idea200153Service {
    private static final int IDEA_ID = 200153;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200153Service() {
        this(new Idea200153Config());
    }

    public Idea200153Service(Idea200153Config config) {
        this.config = config != null ? config : new Idea200153Config();
