...
@Data
public class Idea200032Config {
    private String name = "idea_200032";
 ...
 */
@Slf4j
public class Idea200032Service {
    private static final int IDEA_ID = 200032;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200032Service() {
        this(new Idea200032Config());
    }

    public Idea200032Service(Idea200032Config config) {
        this.config = config != null ? config : new Idea200032Config();
