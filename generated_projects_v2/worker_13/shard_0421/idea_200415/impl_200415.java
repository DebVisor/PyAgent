...
@Data
public class Idea200415Config {
    private String name = "idea_200415";
 ...
 */
@Slf4j
public class Idea200415Service {
    private static final int IDEA_ID = 200415;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200415Service() {
        this(new Idea200415Config());
    }

    public Idea200415Service(Idea200415Config config) {
        this.config = config != null ? config : new Idea200415Config();
