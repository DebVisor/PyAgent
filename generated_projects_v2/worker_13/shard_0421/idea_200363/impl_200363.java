...
@Data
public class Idea200363Config {
    private String name = "idea_200363";
 ...
 */
@Slf4j
public class Idea200363Service {
    private static final int IDEA_ID = 200363;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200363Service() {
        this(new Idea200363Config());
    }

    public Idea200363Service(Idea200363Config config) {
        this.config = config != null ? config : new Idea200363Config();
