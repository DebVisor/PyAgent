...
@Data
public class Idea200292Config {
    private String name = "idea_200292";
 ...
 */
@Slf4j
public class Idea200292Service {
    private static final int IDEA_ID = 200292;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200292Service() {
        this(new Idea200292Config());
    }

    public Idea200292Service(Idea200292Config config) {
        this.config = config != null ? config : new Idea200292Config();
