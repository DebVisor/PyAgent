...
@Data
public class Idea200258Config {
    private String name = "idea_200258";
 ...
 */
@Slf4j
public class Idea200258Service {
    private static final int IDEA_ID = 200258;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200258Service() {
        this(new Idea200258Config());
    }

    public Idea200258Service(Idea200258Config config) {
        this.config = config != null ? config : new Idea200258Config();
