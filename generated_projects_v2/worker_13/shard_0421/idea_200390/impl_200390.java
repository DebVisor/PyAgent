...
@Data
public class Idea200390Config {
    private String name = "idea_200390";
 ...
 */
@Slf4j
public class Idea200390Service {
    private static final int IDEA_ID = 200390;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200390Service() {
        this(new Idea200390Config());
    }

    public Idea200390Service(Idea200390Config config) {
        this.config = config != null ? config : new Idea200390Config();
