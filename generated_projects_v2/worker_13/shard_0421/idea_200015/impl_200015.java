...
@Data
public class Idea200015Config {
    private String name = "idea_200015";
 ...
 */
@Slf4j
public class Idea200015Service {
    private static final int IDEA_ID = 200015;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200015Service() {
        this(new Idea200015Config());
    }

    public Idea200015Service(Idea200015Config config) {
        this.config = config != null ? config : new Idea200015Config();
