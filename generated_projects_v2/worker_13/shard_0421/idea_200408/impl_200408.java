...
@Data
public class Idea200408Config {
    private String name = "idea_200408";
 ...
 */
@Slf4j
public class Idea200408Service {
    private static final int IDEA_ID = 200408;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200408Service() {
        this(new Idea200408Config());
    }

    public Idea200408Service(Idea200408Config config) {
        this.config = config != null ? config : new Idea200408Config();
