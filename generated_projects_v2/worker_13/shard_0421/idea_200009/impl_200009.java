...
@Data
public class Idea200009Config {
    private String name = "idea_200009";
 ...
 */
@Slf4j
public class Idea200009Service {
    private static final int IDEA_ID = 200009;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200009Service() {
        this(new Idea200009Config());
    }

    public Idea200009Service(Idea200009Config config) {
        this.config = config != null ? config : new Idea200009Config();
