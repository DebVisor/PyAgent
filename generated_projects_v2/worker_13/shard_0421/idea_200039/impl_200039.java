...
@Data
public class Idea200039Config {
    private String name = "idea_200039";
 ...
 */
@Slf4j
public class Idea200039Service {
    private static final int IDEA_ID = 200039;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200039Service() {
        this(new Idea200039Config());
    }

    public Idea200039Service(Idea200039Config config) {
        this.config = config != null ? config : new Idea200039Config();
