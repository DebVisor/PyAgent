...
@Data
public class Idea200022Config {
    private String name = "idea_200022";
 ...
 */
@Slf4j
public class Idea200022Service {
    private static final int IDEA_ID = 200022;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200022Service() {
        this(new Idea200022Config());
    }

    public Idea200022Service(Idea200022Config config) {
        this.config = config != null ? config : new Idea200022Config();
