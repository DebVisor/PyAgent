...
@Data
public class Idea200384Config {
    private String name = "idea_200384";
 ...
 */
@Slf4j
public class Idea200384Service {
    private static final int IDEA_ID = 200384;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200384Service() {
        this(new Idea200384Config());
    }

    public Idea200384Service(Idea200384Config config) {
        this.config = config != null ? config : new Idea200384Config();
