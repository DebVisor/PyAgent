...
@Data
public class Idea200144Config {
    private String name = "idea_200144";
 ...
 */
@Slf4j
public class Idea200144Service {
    private static final int IDEA_ID = 200144;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200144Service() {
        this(new Idea200144Config());
    }

    public Idea200144Service(Idea200144Config config) {
        this.config = config != null ? config : new Idea200144Config();
