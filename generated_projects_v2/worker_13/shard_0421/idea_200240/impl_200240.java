...
@Data
public class Idea200240Config {
    private String name = "idea_200240";
 ...
 */
@Slf4j
public class Idea200240Service {
    private static final int IDEA_ID = 200240;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200240Service() {
        this(new Idea200240Config());
    }

    public Idea200240Service(Idea200240Config config) {
        this.config = config != null ? config : new Idea200240Config();
