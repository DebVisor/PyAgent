...
@Data
public class Idea200097Config {
    private String name = "idea_200097";
 ...
 */
@Slf4j
public class Idea200097Service {
    private static final int IDEA_ID = 200097;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200097Service() {
        this(new Idea200097Config());
    }

    public Idea200097Service(Idea200097Config config) {
        this.config = config != null ? config : new Idea200097Config();
