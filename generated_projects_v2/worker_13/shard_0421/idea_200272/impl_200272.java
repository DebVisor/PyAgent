...
@Data
public class Idea200272Config {
    private String name = "idea_200272";
 ...
 */
@Slf4j
public class Idea200272Service {
    private static final int IDEA_ID = 200272;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200272Service() {
        this(new Idea200272Config());
    }

    public Idea200272Service(Idea200272Config config) {
        this.config = config != null ? config : new Idea200272Config();
