...
@Data
public class Idea200376Config {
    private String name = "idea_200376";
 ...
 */
@Slf4j
public class Idea200376Service {
    private static final int IDEA_ID = 200376;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200376Service() {
        this(new Idea200376Config());
    }

    public Idea200376Service(Idea200376Config config) {
        this.config = config != null ? config : new Idea200376Config();
