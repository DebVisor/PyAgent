...
@Data
public class Idea200109Config {
    private String name = "idea_200109";
 ...
 */
@Slf4j
public class Idea200109Service {
    private static final int IDEA_ID = 200109;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200109Service() {
        this(new Idea200109Config());
    }

    public Idea200109Service(Idea200109Config config) {
        this.config = config != null ? config : new Idea200109Config();
