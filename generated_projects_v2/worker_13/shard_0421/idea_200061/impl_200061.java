...
@Data
public class Idea200061Config {
    private String name = "idea_200061";
 ...
 */
@Slf4j
public class Idea200061Service {
    private static final int IDEA_ID = 200061;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200061Service() {
        this(new Idea200061Config());
    }

    public Idea200061Service(Idea200061Config config) {
        this.config = config != null ? config : new Idea200061Config();
