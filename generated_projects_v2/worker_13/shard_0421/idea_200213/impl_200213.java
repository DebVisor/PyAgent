...
@Data
public class Idea200213Config {
    private String name = "idea_200213";
 ...
 */
@Slf4j
public class Idea200213Service {
    private static final int IDEA_ID = 200213;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200213Service() {
        this(new Idea200213Config());
    }

    public Idea200213Service(Idea200213Config config) {
        this.config = config != null ? config : new Idea200213Config();
