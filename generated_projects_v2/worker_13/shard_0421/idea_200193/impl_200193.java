...
@Data
public class Idea200193Config {
    private String name = "idea_200193";
 ...
 */
@Slf4j
public class Idea200193Service {
    private static final int IDEA_ID = 200193;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200193Service() {
        this(new Idea200193Config());
    }

    public Idea200193Service(Idea200193Config config) {
        this.config = config != null ? config : new Idea200193Config();
