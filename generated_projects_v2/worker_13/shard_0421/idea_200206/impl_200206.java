...
@Data
public class Idea200206Config {
    private String name = "idea_200206";
 ...
 */
@Slf4j
public class Idea200206Service {
    private static final int IDEA_ID = 200206;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200206Service() {
        this(new Idea200206Config());
    }

    public Idea200206Service(Idea200206Config config) {
        this.config = config != null ? config : new Idea200206Config();
