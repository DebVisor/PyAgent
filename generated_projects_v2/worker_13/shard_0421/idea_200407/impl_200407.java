...
@Data
public class Idea200407Config {
    private String name = "idea_200407";
 ...
 */
@Slf4j
public class Idea200407Service {
    private static final int IDEA_ID = 200407;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200407Service() {
        this(new Idea200407Config());
    }

    public Idea200407Service(Idea200407Config config) {
        this.config = config != null ? config : new Idea200407Config();
