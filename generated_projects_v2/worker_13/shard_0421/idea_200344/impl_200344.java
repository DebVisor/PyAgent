...
@Data
public class Idea200344Config {
    private String name = "idea_200344";
 ...
 */
@Slf4j
public class Idea200344Service {
    private static final int IDEA_ID = 200344;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200344Service() {
        this(new Idea200344Config());
    }

    public Idea200344Service(Idea200344Config config) {
        this.config = config != null ? config : new Idea200344Config();
