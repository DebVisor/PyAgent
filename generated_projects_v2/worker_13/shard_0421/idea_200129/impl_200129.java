...
@Data
public class Idea200129Config {
    private String name = "idea_200129";
 ...
 */
@Slf4j
public class Idea200129Service {
    private static final int IDEA_ID = 200129;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200129Service() {
        this(new Idea200129Config());
    }

    public Idea200129Service(Idea200129Config config) {
        this.config = config != null ? config : new Idea200129Config();
