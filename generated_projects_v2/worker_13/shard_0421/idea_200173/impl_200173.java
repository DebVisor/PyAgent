...
@Data
public class Idea200173Config {
    private String name = "idea_200173";
 ...
 */
@Slf4j
public class Idea200173Service {
    private static final int IDEA_ID = 200173;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200173Service() {
        this(new Idea200173Config());
    }

    public Idea200173Service(Idea200173Config config) {
        this.config = config != null ? config : new Idea200173Config();
