...
@Data
public class Idea200382Config {
    private String name = "idea_200382";
 ...
 */
@Slf4j
public class Idea200382Service {
    private static final int IDEA_ID = 200382;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200382Service() {
        this(new Idea200382Config());
    }

    public Idea200382Service(Idea200382Config config) {
        this.config = config != null ? config : new Idea200382Config();
