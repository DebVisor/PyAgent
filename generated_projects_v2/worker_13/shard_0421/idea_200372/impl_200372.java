...
@Data
public class Idea200372Config {
    private String name = "idea_200372";
 ...
 */
@Slf4j
public class Idea200372Service {
    private static final int IDEA_ID = 200372;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200372Service() {
        this(new Idea200372Config());
    }

    public Idea200372Service(Idea200372Config config) {
        this.config = config != null ? config : new Idea200372Config();
