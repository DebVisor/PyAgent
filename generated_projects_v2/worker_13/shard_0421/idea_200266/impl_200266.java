...
@Data
public class Idea200266Config {
    private String name = "idea_200266";
 ...
 */
@Slf4j
public class Idea200266Service {
    private static final int IDEA_ID = 200266;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200266Service() {
        this(new Idea200266Config());
    }

    public Idea200266Service(Idea200266Config config) {
        this.config = config != null ? config : new Idea200266Config();
