...
@Data
public class Idea199978Config {
    private String name = "idea_199978";
 ...
 */
@Slf4j
public class Idea199978Service {
    private static final int IDEA_ID = 199978;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199978Service() {
        this(new Idea199978Config());
    }

    public Idea199978Service(Idea199978Config config) {
        this.config = config != null ? config : new Idea199978Config();
