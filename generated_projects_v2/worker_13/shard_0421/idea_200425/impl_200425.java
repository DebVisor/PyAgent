...
@Data
public class Idea200425Config {
    private String name = "idea_200425";
 ...
 */
@Slf4j
public class Idea200425Service {
    private static final int IDEA_ID = 200425;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200425Service() {
        this(new Idea200425Config());
    }

    public Idea200425Service(Idea200425Config config) {
        this.config = config != null ? config : new Idea200425Config();
