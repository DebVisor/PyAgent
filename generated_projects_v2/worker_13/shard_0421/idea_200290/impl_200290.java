...
@Data
public class Idea200290Config {
    private String name = "idea_200290";
 ...
 */
@Slf4j
public class Idea200290Service {
    private static final int IDEA_ID = 200290;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200290Service() {
        this(new Idea200290Config());
    }

    public Idea200290Service(Idea200290Config config) {
        this.config = config != null ? config : new Idea200290Config();
