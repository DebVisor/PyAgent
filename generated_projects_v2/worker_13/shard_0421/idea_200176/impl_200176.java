...
@Data
public class Idea200176Config {
    private String name = "idea_200176";
 ...
 */
@Slf4j
public class Idea200176Service {
    private static final int IDEA_ID = 200176;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200176Service() {
        this(new Idea200176Config());
    }

    public Idea200176Service(Idea200176Config config) {
        this.config = config != null ? config : new Idea200176Config();
