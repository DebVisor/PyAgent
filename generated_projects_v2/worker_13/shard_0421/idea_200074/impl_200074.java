...
@Data
public class Idea200074Config {
    private String name = "idea_200074";
 ...
 */
@Slf4j
public class Idea200074Service {
    private static final int IDEA_ID = 200074;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200074Service() {
        this(new Idea200074Config());
    }

    public Idea200074Service(Idea200074Config config) {
        this.config = config != null ? config : new Idea200074Config();
