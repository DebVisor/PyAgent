...
@Data
public class Idea200242Config {
    private String name = "idea_200242";
 ...
 */
@Slf4j
public class Idea200242Service {
    private static final int IDEA_ID = 200242;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200242Service() {
        this(new Idea200242Config());
    }

    public Idea200242Service(Idea200242Config config) {
        this.config = config != null ? config : new Idea200242Config();
