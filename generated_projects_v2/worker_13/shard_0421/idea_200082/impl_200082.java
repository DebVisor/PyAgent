...
@Data
public class Idea200082Config {
    private String name = "idea_200082";
 ...
 */
@Slf4j
public class Idea200082Service {
    private static final int IDEA_ID = 200082;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200082Service() {
        this(new Idea200082Config());
    }

    public Idea200082Service(Idea200082Config config) {
        this.config = config != null ? config : new Idea200082Config();
