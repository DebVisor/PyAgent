...
@Data
public class Idea200346Config {
    private String name = "idea_200346";
 ...
 */
@Slf4j
public class Idea200346Service {
    private static final int IDEA_ID = 200346;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200346Service() {
        this(new Idea200346Config());
    }

    public Idea200346Service(Idea200346Config config) {
        this.config = config != null ? config : new Idea200346Config();
