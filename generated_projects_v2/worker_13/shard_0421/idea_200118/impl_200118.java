...
@Data
public class Idea200118Config {
    private String name = "idea_200118";
 ...
 */
@Slf4j
public class Idea200118Service {
    private static final int IDEA_ID = 200118;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200118Service() {
        this(new Idea200118Config());
    }

    public Idea200118Service(Idea200118Config config) {
        this.config = config != null ? config : new Idea200118Config();
