...
@Data
public class Idea200228Config {
    private String name = "idea_200228";
 ...
 */
@Slf4j
public class Idea200228Service {
    private static final int IDEA_ID = 200228;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200228Service() {
        this(new Idea200228Config());
    }

    public Idea200228Service(Idea200228Config config) {
        this.config = config != null ? config : new Idea200228Config();
