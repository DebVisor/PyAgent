...
@Data
public class Idea200079Config {
    private String name = "idea_200079";
 ...
 */
@Slf4j
public class Idea200079Service {
    private static final int IDEA_ID = 200079;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200079Service() {
        this(new Idea200079Config());
    }

    public Idea200079Service(Idea200079Config config) {
        this.config = config != null ? config : new Idea200079Config();
