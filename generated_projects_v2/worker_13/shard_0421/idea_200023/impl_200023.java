...
@Data
public class Idea200023Config {
    private String name = "idea_200023";
 ...
 */
@Slf4j
public class Idea200023Service {
    private static final int IDEA_ID = 200023;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200023Service() {
        this(new Idea200023Config());
    }

    public Idea200023Service(Idea200023Config config) {
        this.config = config != null ? config : new Idea200023Config();
