...
@Data
public class Idea200167Config {
    private String name = "idea_200167";
 ...
 */
@Slf4j
public class Idea200167Service {
    private static final int IDEA_ID = 200167;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200167Service() {
        this(new Idea200167Config());
    }

    public Idea200167Service(Idea200167Config config) {
        this.config = config != null ? config : new Idea200167Config();
