...
@Data
public class Idea200319Config {
    private String name = "idea_200319";
 ...
 */
@Slf4j
public class Idea200319Service {
    private static final int IDEA_ID = 200319;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200319Service() {
        this(new Idea200319Config());
    }

    public Idea200319Service(Idea200319Config config) {
        this.config = config != null ? config : new Idea200319Config();
