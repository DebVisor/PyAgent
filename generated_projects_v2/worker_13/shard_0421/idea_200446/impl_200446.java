...
@Data
public class Idea200446Config {
    private String name = "idea_200446";
 ...
 */
@Slf4j
public class Idea200446Service {
    private static final int IDEA_ID = 200446;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200446Service() {
        this(new Idea200446Config());
    }

    public Idea200446Service(Idea200446Config config) {
        this.config = config != null ? config : new Idea200446Config();
