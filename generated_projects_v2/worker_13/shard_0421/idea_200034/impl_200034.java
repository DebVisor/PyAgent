...
@Data
public class Idea200034Config {
    private String name = "idea_200034";
 ...
 */
@Slf4j
public class Idea200034Service {
    private static final int IDEA_ID = 200034;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200034Service() {
        this(new Idea200034Config());
    }

    public Idea200034Service(Idea200034Config config) {
        this.config = config != null ? config : new Idea200034Config();
