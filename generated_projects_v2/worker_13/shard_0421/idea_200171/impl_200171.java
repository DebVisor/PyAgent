...
@Data
public class Idea200171Config {
    private String name = "idea_200171";
 ...
 */
@Slf4j
public class Idea200171Service {
    private static final int IDEA_ID = 200171;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200171Service() {
        this(new Idea200171Config());
    }

    public Idea200171Service(Idea200171Config config) {
        this.config = config != null ? config : new Idea200171Config();
