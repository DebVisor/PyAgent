...
@Data
public class Idea200277Config {
    private String name = "idea_200277";
 ...
 */
@Slf4j
public class Idea200277Service {
    private static final int IDEA_ID = 200277;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200277Service() {
        this(new Idea200277Config());
    }

    public Idea200277Service(Idea200277Config config) {
        this.config = config != null ? config : new Idea200277Config();
