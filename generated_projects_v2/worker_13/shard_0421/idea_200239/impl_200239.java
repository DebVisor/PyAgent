...
@Data
public class Idea200239Config {
    private String name = "idea_200239";
 ...
 */
@Slf4j
public class Idea200239Service {
    private static final int IDEA_ID = 200239;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200239Service() {
        this(new Idea200239Config());
    }

    public Idea200239Service(Idea200239Config config) {
        this.config = config != null ? config : new Idea200239Config();
