...
@Data
public class Idea200169Config {
    private String name = "idea_200169";
 ...
 */
@Slf4j
public class Idea200169Service {
    private static final int IDEA_ID = 200169;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200169Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200169Service() {
        this(new Idea200169Config());
    }

    public Idea200169Service(Idea200169Config config) {
        this.config = config != null ? config : new Idea200169Config();
