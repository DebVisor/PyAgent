...
@Data
public class Idea199996Config {
    private String name = "idea_199996";
 ...
 */
@Slf4j
public class Idea199996Service {
    private static final int IDEA_ID = 199996;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199996Service() {
        this(new Idea199996Config());
    }

    public Idea199996Service(Idea199996Config config) {
        this.config = config != null ? config : new Idea199996Config();
