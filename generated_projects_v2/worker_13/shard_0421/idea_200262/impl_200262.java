...
@Data
public class Idea200262Config {
    private String name = "idea_200262";
 ...
 */
@Slf4j
public class Idea200262Service {
    private static final int IDEA_ID = 200262;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200262Service() {
        this(new Idea200262Config());
    }

    public Idea200262Service(Idea200262Config config) {
        this.config = config != null ? config : new Idea200262Config();
