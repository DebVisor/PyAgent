...
@Data
public class Idea200417Config {
    private String name = "idea_200417";
 ...
 */
@Slf4j
public class Idea200417Service {
    private static final int IDEA_ID = 200417;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200417Service() {
        this(new Idea200417Config());
    }

    public Idea200417Service(Idea200417Config config) {
        this.config = config != null ? config : new Idea200417Config();
