...
@Data
public class Idea200071Config {
    private String name = "idea_200071";
 ...
 */
@Slf4j
public class Idea200071Service {
    private static final int IDEA_ID = 200071;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200071Service() {
        this(new Idea200071Config());
    }

    public Idea200071Service(Idea200071Config config) {
        this.config = config != null ? config : new Idea200071Config();
