...
@Data
public class Idea200357Config {
    private String name = "idea_200357";
 ...
 */
@Slf4j
public class Idea200357Service {
    private static final int IDEA_ID = 200357;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200357Service() {
        this(new Idea200357Config());
    }

    public Idea200357Service(Idea200357Config config) {
        this.config = config != null ? config : new Idea200357Config();
