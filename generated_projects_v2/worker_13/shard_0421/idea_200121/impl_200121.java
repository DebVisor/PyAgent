...
@Data
public class Idea200121Config {
    private String name = "idea_200121";
 ...
 */
@Slf4j
public class Idea200121Service {
    private static final int IDEA_ID = 200121;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200121Service() {
        this(new Idea200121Config());
    }

    public Idea200121Service(Idea200121Config config) {
        this.config = config != null ? config : new Idea200121Config();
