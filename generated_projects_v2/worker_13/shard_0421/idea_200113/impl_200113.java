...
@Data
public class Idea200113Config {
    private String name = "idea_200113";
 ...
 */
@Slf4j
public class Idea200113Service {
    private static final int IDEA_ID = 200113;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200113Service() {
        this(new Idea200113Config());
    }

    public Idea200113Service(Idea200113Config config) {
        this.config = config != null ? config : new Idea200113Config();
