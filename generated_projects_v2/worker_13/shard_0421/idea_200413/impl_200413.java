...
@Data
public class Idea200413Config {
    private String name = "idea_200413";
 ...
 */
@Slf4j
public class Idea200413Service {
    private static final int IDEA_ID = 200413;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200413Service() {
        this(new Idea200413Config());
    }

    public Idea200413Service(Idea200413Config config) {
        this.config = config != null ? config : new Idea200413Config();
