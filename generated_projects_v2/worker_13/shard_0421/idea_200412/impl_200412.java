...
@Data
public class Idea200412Config {
    private String name = "idea_200412";
 ...
 */
@Slf4j
public class Idea200412Service {
    private static final int IDEA_ID = 200412;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200412Service() {
        this(new Idea200412Config());
    }

    public Idea200412Service(Idea200412Config config) {
        this.config = config != null ? config : new Idea200412Config();
