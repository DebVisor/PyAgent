...
@Data
public class Idea200439Config {
    private String name = "idea_200439";
 ...
 */
@Slf4j
public class Idea200439Service {
    private static final int IDEA_ID = 200439;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200439Service() {
        this(new Idea200439Config());
    }

    public Idea200439Service(Idea200439Config config) {
        this.config = config != null ? config : new Idea200439Config();
