...
@Data
public class Idea200378Config {
    private String name = "idea_200378";
 ...
 */
@Slf4j
public class Idea200378Service {
    private static final int IDEA_ID = 200378;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200378Service() {
        this(new Idea200378Config());
    }

    public Idea200378Service(Idea200378Config config) {
        this.config = config != null ? config : new Idea200378Config();
