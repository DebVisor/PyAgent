...
@Data
public class Idea200158Config {
    private String name = "idea_200158";
 ...
 */
@Slf4j
public class Idea200158Service {
    private static final int IDEA_ID = 200158;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200158Service() {
        this(new Idea200158Config());
    }

    public Idea200158Service(Idea200158Config config) {
        this.config = config != null ? config : new Idea200158Config();
