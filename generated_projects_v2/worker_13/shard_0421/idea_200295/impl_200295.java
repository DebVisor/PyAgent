...
@Data
public class Idea200295Config {
    private String name = "idea_200295";
 ...
 */
@Slf4j
public class Idea200295Service {
    private static final int IDEA_ID = 200295;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200295Service() {
        this(new Idea200295Config());
    }

    public Idea200295Service(Idea200295Config config) {
        this.config = config != null ? config : new Idea200295Config();
