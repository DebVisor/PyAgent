...
@Data
public class Idea200101Config {
    private String name = "idea_200101";
 ...
 */
@Slf4j
public class Idea200101Service {
    private static final int IDEA_ID = 200101;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200101Service() {
        this(new Idea200101Config());
    }

    public Idea200101Service(Idea200101Config config) {
        this.config = config != null ? config : new Idea200101Config();
