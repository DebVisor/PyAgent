...
@Data
public class Idea200442Config {
    private String name = "idea_200442";
 ...
 */
@Slf4j
public class Idea200442Service {
    private static final int IDEA_ID = 200442;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200442Service() {
        this(new Idea200442Config());
    }

    public Idea200442Service(Idea200442Config config) {
        this.config = config != null ? config : new Idea200442Config();
