...
@Data
public class Idea200404Config {
    private String name = "idea_200404";
 ...
 */
@Slf4j
public class Idea200404Service {
    private static final int IDEA_ID = 200404;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200404Service() {
        this(new Idea200404Config());
    }

    public Idea200404Service(Idea200404Config config) {
        this.config = config != null ? config : new Idea200404Config();
