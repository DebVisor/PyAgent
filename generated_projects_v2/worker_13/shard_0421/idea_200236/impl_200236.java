...
@Data
public class Idea200236Config {
    private String name = "idea_200236";
 ...
 */
@Slf4j
public class Idea200236Service {
    private static final int IDEA_ID = 200236;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200236Service() {
        this(new Idea200236Config());
    }

    public Idea200236Service(Idea200236Config config) {
        this.config = config != null ? config : new Idea200236Config();
