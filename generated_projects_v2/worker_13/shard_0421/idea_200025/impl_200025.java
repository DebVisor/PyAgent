...
@Data
public class Idea200025Config {
    private String name = "idea_200025";
 ...
 */
@Slf4j
public class Idea200025Service {
    private static final int IDEA_ID = 200025;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200025Service() {
        this(new Idea200025Config());
    }

    public Idea200025Service(Idea200025Config config) {
        this.config = config != null ? config : new Idea200025Config();
