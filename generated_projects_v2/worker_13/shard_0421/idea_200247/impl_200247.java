...
@Data
public class Idea200247Config {
    private String name = "idea_200247";
 ...
 */
@Slf4j
public class Idea200247Service {
    private static final int IDEA_ID = 200247;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200247Service() {
        this(new Idea200247Config());
    }

    public Idea200247Service(Idea200247Config config) {
        this.config = config != null ? config : new Idea200247Config();
