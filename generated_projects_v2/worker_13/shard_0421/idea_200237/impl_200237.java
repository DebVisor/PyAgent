...
@Data
public class Idea200237Config {
    private String name = "idea_200237";
 ...
 */
@Slf4j
public class Idea200237Service {
    private static final int IDEA_ID = 200237;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200237Service() {
        this(new Idea200237Config());
    }

    public Idea200237Service(Idea200237Config config) {
        this.config = config != null ? config : new Idea200237Config();
