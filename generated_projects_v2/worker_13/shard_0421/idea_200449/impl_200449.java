...
@Data
public class Idea200449Config {
    private String name = "idea_200449";
 ...
 */
@Slf4j
public class Idea200449Service {
    private static final int IDEA_ID = 200449;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200449Service() {
        this(new Idea200449Config());
    }

    public Idea200449Service(Idea200449Config config) {
        this.config = config != null ? config : new Idea200449Config();
