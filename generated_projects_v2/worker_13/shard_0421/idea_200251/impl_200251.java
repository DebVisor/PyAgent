...
@Data
public class Idea200251Config {
    private String name = "idea_200251";
 ...
 */
@Slf4j
public class Idea200251Service {
    private static final int IDEA_ID = 200251;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200251Service() {
        this(new Idea200251Config());
    }

    public Idea200251Service(Idea200251Config config) {
        this.config = config != null ? config : new Idea200251Config();
