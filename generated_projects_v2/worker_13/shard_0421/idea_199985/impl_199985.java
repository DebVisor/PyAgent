...
@Data
public class Idea199985Config {
    private String name = "idea_199985";
 ...
 */
@Slf4j
public class Idea199985Service {
    private static final int IDEA_ID = 199985;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199985Service() {
        this(new Idea199985Config());
    }

    public Idea199985Service(Idea199985Config config) {
        this.config = config != null ? config : new Idea199985Config();
