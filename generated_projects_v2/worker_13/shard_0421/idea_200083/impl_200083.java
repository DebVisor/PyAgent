...
@Data
public class Idea200083Config {
    private String name = "idea_200083";
 ...
 */
@Slf4j
public class Idea200083Service {
    private static final int IDEA_ID = 200083;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200083Service() {
        this(new Idea200083Config());
    }

    public Idea200083Service(Idea200083Config config) {
        this.config = config != null ? config : new Idea200083Config();
