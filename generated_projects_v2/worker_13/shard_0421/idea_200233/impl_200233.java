...
@Data
public class Idea200233Config {
    private String name = "idea_200233";
 ...
 */
@Slf4j
public class Idea200233Service {
    private static final int IDEA_ID = 200233;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200233Service() {
        this(new Idea200233Config());
    }

    public Idea200233Service(Idea200233Config config) {
        this.config = config != null ? config : new Idea200233Config();
