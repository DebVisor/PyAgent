...
@Data
public class Idea200300Config {
    private String name = "idea_200300";
 ...
 */
@Slf4j
public class Idea200300Service {
    private static final int IDEA_ID = 200300;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200300Service() {
        this(new Idea200300Config());
    }

    public Idea200300Service(Idea200300Config config) {
        this.config = config != null ? config : new Idea200300Config();
