...
@Data
public class Idea200180Config {
    private String name = "idea_200180";
 ...
 */
@Slf4j
public class Idea200180Service {
    private static final int IDEA_ID = 200180;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200180Service() {
        this(new Idea200180Config());
    }

    public Idea200180Service(Idea200180Config config) {
        this.config = config != null ? config : new Idea200180Config();
