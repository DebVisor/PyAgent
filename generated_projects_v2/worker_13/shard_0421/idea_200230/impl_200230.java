...
@Data
public class Idea200230Config {
    private String name = "idea_200230";
 ...
 */
@Slf4j
public class Idea200230Service {
    private static final int IDEA_ID = 200230;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200230Service() {
        this(new Idea200230Config());
    }

    public Idea200230Service(Idea200230Config config) {
        this.config = config != null ? config : new Idea200230Config();
