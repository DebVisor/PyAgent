...
@Data
public class Idea200381Config {
    private String name = "idea_200381";
 ...
 */
@Slf4j
public class Idea200381Service {
    private static final int IDEA_ID = 200381;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200381Service() {
        this(new Idea200381Config());
    }

    public Idea200381Service(Idea200381Config config) {
        this.config = config != null ? config : new Idea200381Config();
