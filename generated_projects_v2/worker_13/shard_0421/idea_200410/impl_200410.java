...
@Data
public class Idea200410Config {
    private String name = "idea_200410";
 ...
 */
@Slf4j
public class Idea200410Service {
    private static final int IDEA_ID = 200410;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200410Service() {
        this(new Idea200410Config());
    }

    public Idea200410Service(Idea200410Config config) {
        this.config = config != null ? config : new Idea200410Config();
