...
@Data
public class Idea200196Config {
    private String name = "idea_200196";
 ...
 */
@Slf4j
public class Idea200196Service {
    private static final int IDEA_ID = 200196;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200196Service() {
        this(new Idea200196Config());
    }

    public Idea200196Service(Idea200196Config config) {
        this.config = config != null ? config : new Idea200196Config();
