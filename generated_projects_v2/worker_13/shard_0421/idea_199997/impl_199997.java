...
@Data
public class Idea199997Config {
    private String name = "idea_199997";
 ...
 */
@Slf4j
public class Idea199997Service {
    private static final int IDEA_ID = 199997;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199997Service() {
        this(new Idea199997Config());
    }

    public Idea199997Service(Idea199997Config config) {
        this.config = config != null ? config : new Idea199997Config();
