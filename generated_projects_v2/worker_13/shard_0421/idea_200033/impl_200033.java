...
@Data
public class Idea200033Config {
    private String name = "idea_200033";
 ...
 */
@Slf4j
public class Idea200033Service {
    private static final int IDEA_ID = 200033;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200033Service() {
        this(new Idea200033Config());
    }

    public Idea200033Service(Idea200033Config config) {
        this.config = config != null ? config : new Idea200033Config();
