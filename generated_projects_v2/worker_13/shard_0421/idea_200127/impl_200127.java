...
@Data
public class Idea200127Config {
    private String name = "idea_200127";
 ...
 */
@Slf4j
public class Idea200127Service {
    private static final int IDEA_ID = 200127;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200127Service() {
        this(new Idea200127Config());
    }

    public Idea200127Service(Idea200127Config config) {
        this.config = config != null ? config : new Idea200127Config();
