...
@Data
public class Idea200374Config {
    private String name = "idea_200374";
 ...
 */
@Slf4j
public class Idea200374Service {
    private static final int IDEA_ID = 200374;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200374Service() {
        this(new Idea200374Config());
    }

    public Idea200374Service(Idea200374Config config) {
        this.config = config != null ? config : new Idea200374Config();
