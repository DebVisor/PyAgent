...
@Data
public class Idea200336Config {
    private String name = "idea_200336";
 ...
 */
@Slf4j
public class Idea200336Service {
    private static final int IDEA_ID = 200336;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200336Service() {
        this(new Idea200336Config());
    }

    public Idea200336Service(Idea200336Config config) {
        this.config = config != null ? config : new Idea200336Config();
