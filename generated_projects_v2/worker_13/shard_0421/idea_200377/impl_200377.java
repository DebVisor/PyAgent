...
@Data
public class Idea200377Config {
    private String name = "idea_200377";
 ...
 */
@Slf4j
public class Idea200377Service {
    private static final int IDEA_ID = 200377;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200377Service() {
        this(new Idea200377Config());
    }

    public Idea200377Service(Idea200377Config config) {
        this.config = config != null ? config : new Idea200377Config();
