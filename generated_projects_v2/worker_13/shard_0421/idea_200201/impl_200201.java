...
@Data
public class Idea200201Config {
    private String name = "idea_200201";
 ...
 */
@Slf4j
public class Idea200201Service {
    private static final int IDEA_ID = 200201;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200201Service() {
        this(new Idea200201Config());
    }

    public Idea200201Service(Idea200201Config config) {
        this.config = config != null ? config : new Idea200201Config();
