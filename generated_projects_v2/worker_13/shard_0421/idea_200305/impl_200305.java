...
@Data
public class Idea200305Config {
    private String name = "idea_200305";
 ...
 */
@Slf4j
public class Idea200305Service {
    private static final int IDEA_ID = 200305;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200305Service() {
        this(new Idea200305Config());
    }

    public Idea200305Service(Idea200305Config config) {
        this.config = config != null ? config : new Idea200305Config();
