...
@Data
public class Idea200003Config {
    private String name = "idea_200003";
 ...
 */
@Slf4j
public class Idea200003Service {
    private static final int IDEA_ID = 200003;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200003Service() {
        this(new Idea200003Config());
    }

    public Idea200003Service(Idea200003Config config) {
        this.config = config != null ? config : new Idea200003Config();
