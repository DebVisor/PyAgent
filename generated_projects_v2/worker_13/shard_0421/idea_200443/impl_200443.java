...
@Data
public class Idea200443Config {
    private String name = "idea_200443";
 ...
 */
@Slf4j
public class Idea200443Service {
    private static final int IDEA_ID = 200443;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200443Service() {
        this(new Idea200443Config());
    }

    public Idea200443Service(Idea200443Config config) {
        this.config = config != null ? config : new Idea200443Config();
