...
@Data
public class Idea200298Config {
    private String name = "idea_200298";
 ...
 */
@Slf4j
public class Idea200298Service {
    private static final int IDEA_ID = 200298;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200298Service() {
        this(new Idea200298Config());
    }

    public Idea200298Service(Idea200298Config config) {
        this.config = config != null ? config : new Idea200298Config();
