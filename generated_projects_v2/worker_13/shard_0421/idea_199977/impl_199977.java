...
@Data
public class Idea199977Config {
    private String name = "idea_199977";
 ...
 */
@Slf4j
public class Idea199977Service {
    private static final int IDEA_ID = 199977;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199977Service() {
        this(new Idea199977Config());
    }

    public Idea199977Service(Idea199977Config config) {
        this.config = config != null ? config : new Idea199977Config();
