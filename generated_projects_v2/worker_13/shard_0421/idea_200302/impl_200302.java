...
@Data
public class Idea200302Config {
    private String name = "idea_200302";
 ...
 */
@Slf4j
public class Idea200302Service {
    private static final int IDEA_ID = 200302;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200302Service() {
        this(new Idea200302Config());
    }

    public Idea200302Service(Idea200302Config config) {
        this.config = config != null ? config : new Idea200302Config();
