...
@Data
public class Idea200431Config {
    private String name = "idea_200431";
 ...
 */
@Slf4j
public class Idea200431Service {
    private static final int IDEA_ID = 200431;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200431Service() {
        this(new Idea200431Config());
    }

    public Idea200431Service(Idea200431Config config) {
        this.config = config != null ? config : new Idea200431Config();
