...
@Data
public class Idea200276Config {
    private String name = "idea_200276";
 ...
 */
@Slf4j
public class Idea200276Service {
    private static final int IDEA_ID = 200276;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200276Service() {
        this(new Idea200276Config());
    }

    public Idea200276Service(Idea200276Config config) {
        this.config = config != null ? config : new Idea200276Config();
