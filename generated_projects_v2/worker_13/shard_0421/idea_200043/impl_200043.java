...
@Data
public class Idea200043Config {
    private String name = "idea_200043";
 ...
 */
@Slf4j
public class Idea200043Service {
    private static final int IDEA_ID = 200043;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200043Service() {
        this(new Idea200043Config());
    }

    public Idea200043Service(Idea200043Config config) {
        this.config = config != null ? config : new Idea200043Config();
