...
@Data
public class Idea200031Config {
    private String name = "idea_200031";
 ...
 */
@Slf4j
public class Idea200031Service {
    private static final int IDEA_ID = 200031;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200031Service() {
        this(new Idea200031Config());
    }

    public Idea200031Service(Idea200031Config config) {
        this.config = config != null ? config : new Idea200031Config();
