...
@Data
public class Idea200200Config {
    private String name = "idea_200200";
 ...
 */
@Slf4j
public class Idea200200Service {
    private static final int IDEA_ID = 200200;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200200Service() {
        this(new Idea200200Config());
    }

    public Idea200200Service(Idea200200Config config) {
        this.config = config != null ? config : new Idea200200Config();
