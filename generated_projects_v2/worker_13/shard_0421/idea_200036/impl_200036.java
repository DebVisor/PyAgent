...
@Data
public class Idea200036Config {
    private String name = "idea_200036";
 ...
 */
@Slf4j
public class Idea200036Service {
    private static final int IDEA_ID = 200036;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200036Service() {
        this(new Idea200036Config());
    }

    public Idea200036Service(Idea200036Config config) {
        this.config = config != null ? config : new Idea200036Config();
