...
@Data
public class Idea200375Config {
    private String name = "idea_200375";
 ...
 */
@Slf4j
public class Idea200375Service {
    private static final int IDEA_ID = 200375;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200375Service() {
        this(new Idea200375Config());
    }

    public Idea200375Service(Idea200375Config config) {
        this.config = config != null ? config : new Idea200375Config();
