...
@Data
public class Idea200414Config {
    private String name = "idea_200414";
 ...
 */
@Slf4j
public class Idea200414Service {
    private static final int IDEA_ID = 200414;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200414Service() {
        this(new Idea200414Config());
    }

    public Idea200414Service(Idea200414Config config) {
        this.config = config != null ? config : new Idea200414Config();
