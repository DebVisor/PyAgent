...
@Data
public class Idea200244Config {
    private String name = "idea_200244";
 ...
 */
@Slf4j
public class Idea200244Service {
    private static final int IDEA_ID = 200244;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200244Service() {
        this(new Idea200244Config());
    }

    public Idea200244Service(Idea200244Config config) {
        this.config = config != null ? config : new Idea200244Config();
