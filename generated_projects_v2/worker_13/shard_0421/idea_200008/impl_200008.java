...
@Data
public class Idea200008Config {
    private String name = "idea_200008";
 ...
 */
@Slf4j
public class Idea200008Service {
    private static final int IDEA_ID = 200008;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200008Service() {
        this(new Idea200008Config());
    }

    public Idea200008Service(Idea200008Config config) {
        this.config = config != null ? config : new Idea200008Config();
