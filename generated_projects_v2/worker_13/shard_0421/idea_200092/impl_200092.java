...
@Data
public class Idea200092Config {
    private String name = "idea_200092";
 ...
 */
@Slf4j
public class Idea200092Service {
    private static final int IDEA_ID = 200092;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200092Service() {
        this(new Idea200092Config());
    }

    public Idea200092Service(Idea200092Config config) {
        this.config = config != null ? config : new Idea200092Config();
