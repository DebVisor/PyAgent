...
@Data
public class Idea200159Config {
    private String name = "idea_200159";
 ...
 */
@Slf4j
public class Idea200159Service {
    private static final int IDEA_ID = 200159;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200159Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200159Service() {
        this(new Idea200159Config());
    }

    public Idea200159Service(Idea200159Config config) {
        this.config = config != null ? config : new Idea200159Config();
