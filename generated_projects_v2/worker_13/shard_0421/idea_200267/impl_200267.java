...
@Data
public class Idea200267Config {
    private String name = "idea_200267";
 ...
 */
@Slf4j
public class Idea200267Service {
    private static final int IDEA_ID = 200267;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200267Service() {
        this(new Idea200267Config());
    }

    public Idea200267Service(Idea200267Config config) {
        this.config = config != null ? config : new Idea200267Config();
