...
@Data
public class Idea200367Config {
    private String name = "idea_200367";
 ...
 */
@Slf4j
public class Idea200367Service {
    private static final int IDEA_ID = 200367;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200367Service() {
        this(new Idea200367Config());
    }

    public Idea200367Service(Idea200367Config config) {
        this.config = config != null ? config : new Idea200367Config();
