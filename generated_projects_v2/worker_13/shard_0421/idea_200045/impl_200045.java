...
@Data
public class Idea200045Config {
    private String name = "idea_200045";
 ...
 */
@Slf4j
public class Idea200045Service {
    private static final int IDEA_ID = 200045;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200045Service() {
        this(new Idea200045Config());
    }

    public Idea200045Service(Idea200045Config config) {
        this.config = config != null ? config : new Idea200045Config();
