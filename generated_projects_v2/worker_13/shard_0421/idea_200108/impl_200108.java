...
@Data
public class Idea200108Config {
    private String name = "idea_200108";
 ...
 */
@Slf4j
public class Idea200108Service {
    private static final int IDEA_ID = 200108;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200108Service() {
        this(new Idea200108Config());
    }

    public Idea200108Service(Idea200108Config config) {
        this.config = config != null ? config : new Idea200108Config();
