...
@Data
public class Idea200065Config {
    private String name = "idea_200065";
 ...
 */
@Slf4j
public class Idea200065Service {
    private static final int IDEA_ID = 200065;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200065Service() {
        this(new Idea200065Config());
    }

    public Idea200065Service(Idea200065Config config) {
        this.config = config != null ? config : new Idea200065Config();
