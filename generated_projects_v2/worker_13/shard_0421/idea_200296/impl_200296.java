...
@Data
public class Idea200296Config {
    private String name = "idea_200296";
 ...
 */
@Slf4j
public class Idea200296Service {
    private static final int IDEA_ID = 200296;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200296Service() {
        this(new Idea200296Config());
    }

    public Idea200296Service(Idea200296Config config) {
        this.config = config != null ? config : new Idea200296Config();
