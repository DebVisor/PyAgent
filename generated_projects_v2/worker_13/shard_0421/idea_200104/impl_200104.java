...
@Data
public class Idea200104Config {
    private String name = "idea_200104";
 ...
 */
@Slf4j
public class Idea200104Service {
    private static final int IDEA_ID = 200104;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200104Service() {
        this(new Idea200104Config());
    }

    public Idea200104Service(Idea200104Config config) {
        this.config = config != null ? config : new Idea200104Config();
