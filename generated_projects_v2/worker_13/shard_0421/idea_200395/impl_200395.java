...
@Data
public class Idea200395Config {
    private String name = "idea_200395";
 ...
 */
@Slf4j
public class Idea200395Service {
    private static final int IDEA_ID = 200395;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200395Service() {
        this(new Idea200395Config());
    }

    public Idea200395Service(Idea200395Config config) {
        this.config = config != null ? config : new Idea200395Config();
