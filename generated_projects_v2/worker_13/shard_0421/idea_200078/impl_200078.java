...
@Data
public class Idea200078Config {
    private String name = "idea_200078";
 ...
 */
@Slf4j
public class Idea200078Service {
    private static final int IDEA_ID = 200078;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200078Service() {
        this(new Idea200078Config());
    }

    public Idea200078Service(Idea200078Config config) {
        this.config = config != null ? config : new Idea200078Config();
