...
@Data
public class Idea200287Config {
    private String name = "idea_200287";
 ...
 */
@Slf4j
public class Idea200287Service {
    private static final int IDEA_ID = 200287;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200287Service() {
        this(new Idea200287Config());
    }

    public Idea200287Service(Idea200287Config config) {
        this.config = config != null ? config : new Idea200287Config();
