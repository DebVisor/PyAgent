...
@Data
public class Idea200260Config {
    private String name = "idea_200260";
 ...
 */
@Slf4j
public class Idea200260Service {
    private static final int IDEA_ID = 200260;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200260Service() {
        this(new Idea200260Config());
    }

    public Idea200260Service(Idea200260Config config) {
        this.config = config != null ? config : new Idea200260Config();
