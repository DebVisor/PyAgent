...
@Data
public class Idea200030Config {
    private String name = "idea_200030";
 ...
 */
@Slf4j
public class Idea200030Service {
    private static final int IDEA_ID = 200030;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200030Service() {
        this(new Idea200030Config());
    }

    public Idea200030Service(Idea200030Config config) {
        this.config = config != null ? config : new Idea200030Config();
