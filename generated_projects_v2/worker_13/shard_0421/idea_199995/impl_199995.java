...
@Data
public class Idea199995Config {
    private String name = "idea_199995";
 ...
 */
@Slf4j
public class Idea199995Service {
    private static final int IDEA_ID = 199995;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199995Service() {
        this(new Idea199995Config());
    }

    public Idea199995Service(Idea199995Config config) {
        this.config = config != null ? config : new Idea199995Config();
