...
@Data
public class Idea200400Config {
    private String name = "idea_200400";
 ...
 */
@Slf4j
public class Idea200400Service {
    private static final int IDEA_ID = 200400;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200400Service() {
        this(new Idea200400Config());
    }

    public Idea200400Service(Idea200400Config config) {
        this.config = config != null ? config : new Idea200400Config();
