...
@Data
public class Idea200263Config {
    private String name = "idea_200263";
 ...
 */
@Slf4j
public class Idea200263Service {
    private static final int IDEA_ID = 200263;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200263Service() {
        this(new Idea200263Config());
    }

    public Idea200263Service(Idea200263Config config) {
        this.config = config != null ? config : new Idea200263Config();
