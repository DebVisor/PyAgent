...
@Data
public class Idea200189Config {
    private String name = "idea_200189";
 ...
 */
@Slf4j
public class Idea200189Service {
    private static final int IDEA_ID = 200189;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200189Service() {
        this(new Idea200189Config());
    }

    public Idea200189Service(Idea200189Config config) {
        this.config = config != null ? config : new Idea200189Config();
