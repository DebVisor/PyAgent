...
@Data
public class Idea200027Config {
    private String name = "idea_200027";
 ...
 */
@Slf4j
public class Idea200027Service {
    private static final int IDEA_ID = 200027;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200027Service() {
        this(new Idea200027Config());
    }

    public Idea200027Service(Idea200027Config config) {
        this.config = config != null ? config : new Idea200027Config();
