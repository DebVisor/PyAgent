...
@Data
public class Idea200354Config {
    private String name = "idea_200354";
 ...
 */
@Slf4j
public class Idea200354Service {
    private static final int IDEA_ID = 200354;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200354Service() {
        this(new Idea200354Config());
    }

    public Idea200354Service(Idea200354Config config) {
        this.config = config != null ? config : new Idea200354Config();
