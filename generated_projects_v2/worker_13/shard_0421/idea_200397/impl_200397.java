...
@Data
public class Idea200397Config {
    private String name = "idea_200397";
 ...
 */
@Slf4j
public class Idea200397Service {
    private static final int IDEA_ID = 200397;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200397Service() {
        this(new Idea200397Config());
    }

    public Idea200397Service(Idea200397Config config) {
        this.config = config != null ? config : new Idea200397Config();
