...
@Data
public class Idea200394Config {
    private String name = "idea_200394";
 ...
 */
@Slf4j
public class Idea200394Service {
    private static final int IDEA_ID = 200394;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200394Service() {
        this(new Idea200394Config());
    }

    public Idea200394Service(Idea200394Config config) {
        this.config = config != null ? config : new Idea200394Config();
