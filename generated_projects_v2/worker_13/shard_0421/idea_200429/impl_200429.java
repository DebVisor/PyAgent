...
@Data
public class Idea200429Config {
    private String name = "idea_200429";
 ...
 */
@Slf4j
public class Idea200429Service {
    private static final int IDEA_ID = 200429;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200429Service() {
        this(new Idea200429Config());
    }

    public Idea200429Service(Idea200429Config config) {
        this.config = config != null ? config : new Idea200429Config();
