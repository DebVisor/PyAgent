...
@Data
public class Idea200430Config {
    private String name = "idea_200430";
 ...
 */
@Slf4j
public class Idea200430Service {
    private static final int IDEA_ID = 200430;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200430Service() {
        this(new Idea200430Config());
    }

    public Idea200430Service(Idea200430Config config) {
        this.config = config != null ? config : new Idea200430Config();
