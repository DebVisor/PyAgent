...
@Data
public class Idea200318Config {
    private String name = "idea_200318";
 ...
 */
@Slf4j
public class Idea200318Service {
    private static final int IDEA_ID = 200318;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200318Service() {
        this(new Idea200318Config());
    }

    public Idea200318Service(Idea200318Config config) {
        this.config = config != null ? config : new Idea200318Config();
