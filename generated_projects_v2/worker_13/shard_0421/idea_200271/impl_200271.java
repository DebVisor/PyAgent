...
@Data
public class Idea200271Config {
    private String name = "idea_200271";
 ...
 */
@Slf4j
public class Idea200271Service {
    private static final int IDEA_ID = 200271;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200271Service() {
        this(new Idea200271Config());
    }

    public Idea200271Service(Idea200271Config config) {
        this.config = config != null ? config : new Idea200271Config();
