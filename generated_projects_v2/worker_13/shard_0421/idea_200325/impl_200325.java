...
@Data
public class Idea200325Config {
    private String name = "idea_200325";
 ...
 */
@Slf4j
public class Idea200325Service {
    private static final int IDEA_ID = 200325;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200325Service() {
        this(new Idea200325Config());
    }

    public Idea200325Service(Idea200325Config config) {
        this.config = config != null ? config : new Idea200325Config();
