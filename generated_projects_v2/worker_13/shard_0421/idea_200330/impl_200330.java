...
@Data
public class Idea200330Config {
    private String name = "idea_200330";
 ...
 */
@Slf4j
public class Idea200330Service {
    private static final int IDEA_ID = 200330;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200330Service() {
        this(new Idea200330Config());
    }

    public Idea200330Service(Idea200330Config config) {
        this.config = config != null ? config : new Idea200330Config();
