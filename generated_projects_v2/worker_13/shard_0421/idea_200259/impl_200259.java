...
@Data
public class Idea200259Config {
    private String name = "idea_200259";
 ...
 */
@Slf4j
public class Idea200259Service {
    private static final int IDEA_ID = 200259;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200259Service() {
        this(new Idea200259Config());
    }

    public Idea200259Service(Idea200259Config config) {
        this.config = config != null ? config : new Idea200259Config();
