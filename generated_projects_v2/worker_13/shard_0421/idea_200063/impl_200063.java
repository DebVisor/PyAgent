...
@Data
public class Idea200063Config {
    private String name = "idea_200063";
 ...
 */
@Slf4j
public class Idea200063Service {
    private static final int IDEA_ID = 200063;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200063Service() {
        this(new Idea200063Config());
    }

    public Idea200063Service(Idea200063Config config) {
        this.config = config != null ? config : new Idea200063Config();
