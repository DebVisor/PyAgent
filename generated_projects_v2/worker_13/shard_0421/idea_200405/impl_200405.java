...
@Data
public class Idea200405Config {
    private String name = "idea_200405";
 ...
 */
@Slf4j
public class Idea200405Service {
    private static final int IDEA_ID = 200405;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200405Service() {
        this(new Idea200405Config());
    }

    public Idea200405Service(Idea200405Config config) {
        this.config = config != null ? config : new Idea200405Config();
