...
@Data
public class Idea200419Config {
    private String name = "idea_200419";
 ...
 */
@Slf4j
public class Idea200419Service {
    private static final int IDEA_ID = 200419;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200419Service() {
        this(new Idea200419Config());
    }

    public Idea200419Service(Idea200419Config config) {
        this.config = config != null ? config : new Idea200419Config();
