...
@Data
public class Idea200164Config {
    private String name = "idea_200164";
 ...
 */
@Slf4j
public class Idea200164Service {
    private static final int IDEA_ID = 200164;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200164Service() {
        this(new Idea200164Config());
    }

    public Idea200164Service(Idea200164Config config) {
        this.config = config != null ? config : new Idea200164Config();
