...
@Data
public class Idea200218Config {
    private String name = "idea_200218";
 ...
 */
@Slf4j
public class Idea200218Service {
    private static final int IDEA_ID = 200218;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200218Service() {
        this(new Idea200218Config());
    }

    public Idea200218Service(Idea200218Config config) {
        this.config = config != null ? config : new Idea200218Config();
