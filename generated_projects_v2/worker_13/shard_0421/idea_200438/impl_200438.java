...
@Data
public class Idea200438Config {
    private String name = "idea_200438";
 ...
 */
@Slf4j
public class Idea200438Service {
    private static final int IDEA_ID = 200438;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200438Service() {
        this(new Idea200438Config());
    }

    public Idea200438Service(Idea200438Config config) {
        this.config = config != null ? config : new Idea200438Config();
