...
@Data
public class Idea200426Config {
    private String name = "idea_200426";
 ...
 */
@Slf4j
public class Idea200426Service {
    private static final int IDEA_ID = 200426;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200426Service() {
        this(new Idea200426Config());
    }

    public Idea200426Service(Idea200426Config config) {
        this.config = config != null ? config : new Idea200426Config();
