...
@Data
public class Idea200337Config {
    private String name = "idea_200337";
 ...
 */
@Slf4j
public class Idea200337Service {
    private static final int IDEA_ID = 200337;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200337Service() {
        this(new Idea200337Config());
    }

    public Idea200337Service(Idea200337Config config) {
        this.config = config != null ? config : new Idea200337Config();
