...
@Data
public class Idea200111Config {
    private String name = "idea_200111";
 ...
 */
@Slf4j
public class Idea200111Service {
    private static final int IDEA_ID = 200111;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200111Service() {
        this(new Idea200111Config());
    }

    public Idea200111Service(Idea200111Config config) {
        this.config = config != null ? config : new Idea200111Config();
