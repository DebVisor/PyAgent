...
@Data
public class Idea200294Config {
    private String name = "idea_200294";
 ...
 */
@Slf4j
public class Idea200294Service {
    private static final int IDEA_ID = 200294;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200294Service() {
        this(new Idea200294Config());
    }

    public Idea200294Service(Idea200294Config config) {
        this.config = config != null ? config : new Idea200294Config();
