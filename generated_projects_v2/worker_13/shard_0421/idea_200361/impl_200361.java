...
@Data
public class Idea200361Config {
    private String name = "idea_200361";
 ...
 */
@Slf4j
public class Idea200361Service {
    private static final int IDEA_ID = 200361;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200361Service() {
        this(new Idea200361Config());
    }

    public Idea200361Service(Idea200361Config config) {
        this.config = config != null ? config : new Idea200361Config();
