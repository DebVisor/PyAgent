...
@Data
public class Idea200156Config {
    private String name = "idea_200156";
 ...
 */
@Slf4j
public class Idea200156Service {
    private static final int IDEA_ID = 200156;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200156Service() {
        this(new Idea200156Config());
    }

    public Idea200156Service(Idea200156Config config) {
        this.config = config != null ? config : new Idea200156Config();
