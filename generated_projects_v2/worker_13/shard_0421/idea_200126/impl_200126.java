...
@Data
public class Idea200126Config {
    private String name = "idea_200126";
 ...
 */
@Slf4j
public class Idea200126Service {
    private static final int IDEA_ID = 200126;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200126Service() {
        this(new Idea200126Config());
    }

    public Idea200126Service(Idea200126Config config) {
        this.config = config != null ? config : new Idea200126Config();
