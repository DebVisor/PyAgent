...
@Data
public class Idea200046Config {
    private String name = "idea_200046";
 ...
 */
@Slf4j
public class Idea200046Service {
    private static final int IDEA_ID = 200046;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200046Service() {
        this(new Idea200046Config());
    }

    public Idea200046Service(Idea200046Config config) {
        this.config = config != null ? config : new Idea200046Config();
