...
@Data
public class Idea200204Config {
    private String name = "idea_200204";
 ...
 */
@Slf4j
public class Idea200204Service {
    private static final int IDEA_ID = 200204;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200204Service() {
        this(new Idea200204Config());
    }

    public Idea200204Service(Idea200204Config config) {
        this.config = config != null ? config : new Idea200204Config();
