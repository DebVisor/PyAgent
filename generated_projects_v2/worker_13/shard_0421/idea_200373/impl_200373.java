...
@Data
public class Idea200373Config {
    private String name = "idea_200373";
 ...
 */
@Slf4j
public class Idea200373Service {
    private static final int IDEA_ID = 200373;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200373Service() {
        this(new Idea200373Config());
    }

    public Idea200373Service(Idea200373Config config) {
        this.config = config != null ? config : new Idea200373Config();
