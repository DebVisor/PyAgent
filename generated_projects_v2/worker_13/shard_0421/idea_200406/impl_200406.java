...
@Data
public class Idea200406Config {
    private String name = "idea_200406";
 ...
 */
@Slf4j
public class Idea200406Service {
    private static final int IDEA_ID = 200406;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200406Service() {
        this(new Idea200406Config());
    }

    public Idea200406Service(Idea200406Config config) {
        this.config = config != null ? config : new Idea200406Config();
