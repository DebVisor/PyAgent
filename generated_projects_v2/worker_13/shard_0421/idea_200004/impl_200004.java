...
@Data
public class Idea200004Config {
    private String name = "idea_200004";
 ...
 */
@Slf4j
public class Idea200004Service {
    private static final int IDEA_ID = 200004;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200004Service() {
        this(new Idea200004Config());
    }

    public Idea200004Service(Idea200004Config config) {
        this.config = config != null ? config : new Idea200004Config();
