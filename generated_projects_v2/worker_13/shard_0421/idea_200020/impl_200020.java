...
@Data
public class Idea200020Config {
    private String name = "idea_200020";
 ...
 */
@Slf4j
public class Idea200020Service {
    private static final int IDEA_ID = 200020;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200020Service() {
        this(new Idea200020Config());
    }

    public Idea200020Service(Idea200020Config config) {
        this.config = config != null ? config : new Idea200020Config();
