...
@Data
public class Idea200178Config {
    private String name = "idea_200178";
 ...
 */
@Slf4j
public class Idea200178Service {
    private static final int IDEA_ID = 200178;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200178Service() {
        this(new Idea200178Config());
    }

    public Idea200178Service(Idea200178Config config) {
        this.config = config != null ? config : new Idea200178Config();
