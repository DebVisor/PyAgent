...
@Data
public class Idea200038Config {
    private String name = "idea_200038";
 ...
 */
@Slf4j
public class Idea200038Service {
    private static final int IDEA_ID = 200038;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200038Service() {
        this(new Idea200038Config());
    }

    public Idea200038Service(Idea200038Config config) {
        this.config = config != null ? config : new Idea200038Config();
