...
@Data
public class Idea200389Config {
    private String name = "idea_200389";
 ...
 */
@Slf4j
public class Idea200389Service {
    private static final int IDEA_ID = 200389;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200389Service() {
        this(new Idea200389Config());
    }

    public Idea200389Service(Idea200389Config config) {
        this.config = config != null ? config : new Idea200389Config();
