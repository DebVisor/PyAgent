...
@Data
public class Idea200422Config {
    private String name = "idea_200422";
 ...
 */
@Slf4j
public class Idea200422Service {
    private static final int IDEA_ID = 200422;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200422Service() {
        this(new Idea200422Config());
    }

    public Idea200422Service(Idea200422Config config) {
        this.config = config != null ? config : new Idea200422Config();
