...
@Data
public class Idea200172Config {
    private String name = "idea_200172";
 ...
 */
@Slf4j
public class Idea200172Service {
    private static final int IDEA_ID = 200172;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200172Service() {
        this(new Idea200172Config());
    }

    public Idea200172Service(Idea200172Config config) {
        this.config = config != null ? config : new Idea200172Config();
