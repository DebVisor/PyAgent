...
@Data
public class Idea200060Config {
    private String name = "idea_200060";
 ...
 */
@Slf4j
public class Idea200060Service {
    private static final int IDEA_ID = 200060;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200060Service() {
        this(new Idea200060Config());
    }

    public Idea200060Service(Idea200060Config config) {
        this.config = config != null ? config : new Idea200060Config();
