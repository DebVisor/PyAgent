...
@Data
public class Idea200250Config {
    private String name = "idea_200250";
 ...
 */
@Slf4j
public class Idea200250Service {
    private static final int IDEA_ID = 200250;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200250Service() {
        this(new Idea200250Config());
    }

    public Idea200250Service(Idea200250Config config) {
        this.config = config != null ? config : new Idea200250Config();
