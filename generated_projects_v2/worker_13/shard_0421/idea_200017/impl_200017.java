...
@Data
public class Idea200017Config {
    private String name = "idea_200017";
 ...
 */
@Slf4j
public class Idea200017Service {
    private static final int IDEA_ID = 200017;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200017Service() {
        this(new Idea200017Config());
    }

    public Idea200017Service(Idea200017Config config) {
        this.config = config != null ? config : new Idea200017Config();
