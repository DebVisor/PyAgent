...
@Data
public class Idea200125Config {
    private String name = "idea_200125";
 ...
 */
@Slf4j
public class Idea200125Service {
    private static final int IDEA_ID = 200125;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200125Service() {
        this(new Idea200125Config());
    }

    public Idea200125Service(Idea200125Config config) {
        this.config = config != null ? config : new Idea200125Config();
