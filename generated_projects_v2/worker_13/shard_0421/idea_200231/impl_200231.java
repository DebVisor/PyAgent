...
@Data
public class Idea200231Config {
    private String name = "idea_200231";
 ...
 */
@Slf4j
public class Idea200231Service {
    private static final int IDEA_ID = 200231;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200231Service() {
        this(new Idea200231Config());
    }

    public Idea200231Service(Idea200231Config config) {
        this.config = config != null ? config : new Idea200231Config();
