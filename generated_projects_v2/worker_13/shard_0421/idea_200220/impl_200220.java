...
@Data
public class Idea200220Config {
    private String name = "idea_200220";
 ...
 */
@Slf4j
public class Idea200220Service {
    private static final int IDEA_ID = 200220;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200220Service() {
        this(new Idea200220Config());
    }

    public Idea200220Service(Idea200220Config config) {
        this.config = config != null ? config : new Idea200220Config();
