...
@Data
public class Idea200105Config {
    private String name = "idea_200105";
 ...
 */
@Slf4j
public class Idea200105Service {
    private static final int IDEA_ID = 200105;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200105Service() {
        this(new Idea200105Config());
    }

    public Idea200105Service(Idea200105Config config) {
        this.config = config != null ? config : new Idea200105Config();
