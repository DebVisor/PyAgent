...
@Data
public class Idea200181Config {
    private String name = "idea_200181";
 ...
 */
@Slf4j
public class Idea200181Service {
    private static final int IDEA_ID = 200181;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200181Service() {
        this(new Idea200181Config());
    }

    public Idea200181Service(Idea200181Config config) {
        this.config = config != null ? config : new Idea200181Config();
