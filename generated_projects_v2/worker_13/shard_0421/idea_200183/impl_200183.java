...
@Data
public class Idea200183Config {
    private String name = "idea_200183";
 ...
 */
@Slf4j
public class Idea200183Service {
    private static final int IDEA_ID = 200183;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200183Service() {
        this(new Idea200183Config());
    }

    public Idea200183Service(Idea200183Config config) {
        this.config = config != null ? config : new Idea200183Config();
