...
@Data
public class Idea200145Config {
    private String name = "idea_200145";
 ...
 */
@Slf4j
public class Idea200145Service {
    private static final int IDEA_ID = 200145;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200145Service() {
        this(new Idea200145Config());
    }

    public Idea200145Service(Idea200145Config config) {
        this.config = config != null ? config : new Idea200145Config();
