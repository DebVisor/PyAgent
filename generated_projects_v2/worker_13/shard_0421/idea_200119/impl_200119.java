...
@Data
public class Idea200119Config {
    private String name = "idea_200119";
 ...
 */
@Slf4j
public class Idea200119Service {
    private static final int IDEA_ID = 200119;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200119Service() {
        this(new Idea200119Config());
    }

    public Idea200119Service(Idea200119Config config) {
        this.config = config != null ? config : new Idea200119Config();
