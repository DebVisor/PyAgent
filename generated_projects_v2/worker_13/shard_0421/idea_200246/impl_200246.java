...
@Data
public class Idea200246Config {
    private String name = "idea_200246";
 ...
 */
@Slf4j
public class Idea200246Service {
    private static final int IDEA_ID = 200246;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200246Service() {
        this(new Idea200246Config());
    }

    public Idea200246Service(Idea200246Config config) {
        this.config = config != null ? config : new Idea200246Config();
