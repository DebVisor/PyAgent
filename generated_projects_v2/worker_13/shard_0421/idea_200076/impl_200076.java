...
@Data
public class Idea200076Config {
    private String name = "idea_200076";
 ...
 */
@Slf4j
public class Idea200076Service {
    private static final int IDEA_ID = 200076;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200076Service() {
        this(new Idea200076Config());
    }

    public Idea200076Service(Idea200076Config config) {
        this.config = config != null ? config : new Idea200076Config();
