...
@Data
public class Idea200427Config {
    private String name = "idea_200427";
 ...
 */
@Slf4j
public class Idea200427Service {
    private static final int IDEA_ID = 200427;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200427Service() {
        this(new Idea200427Config());
    }

    public Idea200427Service(Idea200427Config config) {
        this.config = config != null ? config : new Idea200427Config();
