...
@Data
public class Idea200098Config {
    private String name = "idea_200098";
 ...
 */
@Slf4j
public class Idea200098Service {
    private static final int IDEA_ID = 200098;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200098Service() {
        this(new Idea200098Config());
    }

    public Idea200098Service(Idea200098Config config) {
        this.config = config != null ? config : new Idea200098Config();
