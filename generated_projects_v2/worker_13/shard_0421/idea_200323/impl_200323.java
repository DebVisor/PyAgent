...
@Data
public class Idea200323Config {
    private String name = "idea_200323";
 ...
 */
@Slf4j
public class Idea200323Service {
    private static final int IDEA_ID = 200323;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200323Service() {
        this(new Idea200323Config());
    }

    public Idea200323Service(Idea200323Config config) {
        this.config = config != null ? config : new Idea200323Config();
