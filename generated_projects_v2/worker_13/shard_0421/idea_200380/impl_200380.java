...
@Data
public class Idea200380Config {
    private String name = "idea_200380";
 ...
 */
@Slf4j
public class Idea200380Service {
    private static final int IDEA_ID = 200380;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200380Service() {
        this(new Idea200380Config());
    }

    public Idea200380Service(Idea200380Config config) {
        this.config = config != null ? config : new Idea200380Config();
