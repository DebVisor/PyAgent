...
@Data
public class Idea200182Config {
    private String name = "idea_200182";
 ...
 */
@Slf4j
public class Idea200182Service {
    private static final int IDEA_ID = 200182;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200182Service() {
        this(new Idea200182Config());
    }

    public Idea200182Service(Idea200182Config config) {
        this.config = config != null ? config : new Idea200182Config();
