...
@Data
public class Idea200203Config {
    private String name = "idea_200203";
 ...
 */
@Slf4j
public class Idea200203Service {
    private static final int IDEA_ID = 200203;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200203Service() {
        this(new Idea200203Config());
    }

    public Idea200203Service(Idea200203Config config) {
        this.config = config != null ? config : new Idea200203Config();
