...
@Data
public class Idea200370Config {
    private String name = "idea_200370";
 ...
 */
@Slf4j
public class Idea200370Service {
    private static final int IDEA_ID = 200370;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200370Service() {
        this(new Idea200370Config());
    }

    public Idea200370Service(Idea200370Config config) {
        this.config = config != null ? config : new Idea200370Config();
