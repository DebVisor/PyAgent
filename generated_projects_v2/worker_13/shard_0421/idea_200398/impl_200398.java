...
@Data
public class Idea200398Config {
    private String name = "idea_200398";
 ...
 */
@Slf4j
public class Idea200398Service {
    private static final int IDEA_ID = 200398;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200398Service() {
        this(new Idea200398Config());
    }

    public Idea200398Service(Idea200398Config config) {
        this.config = config != null ? config : new Idea200398Config();
