...
@Data
public class Idea200073Config {
    private String name = "idea_200073";
 ...
 */
@Slf4j
public class Idea200073Service {
    private static final int IDEA_ID = 200073;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200073Service() {
        this(new Idea200073Config());
    }

    public Idea200073Service(Idea200073Config config) {
        this.config = config != null ? config : new Idea200073Config();
