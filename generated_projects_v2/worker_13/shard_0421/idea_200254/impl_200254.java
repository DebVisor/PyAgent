...
@Data
public class Idea200254Config {
    private String name = "idea_200254";
 ...
 */
@Slf4j
public class Idea200254Service {
    private static final int IDEA_ID = 200254;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200254Service() {
        this(new Idea200254Config());
    }

    public Idea200254Service(Idea200254Config config) {
        this.config = config != null ? config : new Idea200254Config();
