...
@Data
public class Idea200202Config {
    private String name = "idea_200202";
 ...
 */
@Slf4j
public class Idea200202Service {
    private static final int IDEA_ID = 200202;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200202Service() {
        this(new Idea200202Config());
    }

    public Idea200202Service(Idea200202Config config) {
        this.config = config != null ? config : new Idea200202Config();
