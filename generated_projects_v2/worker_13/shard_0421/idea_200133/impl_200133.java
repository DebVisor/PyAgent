...
@Data
public class Idea200133Config {
    private String name = "idea_200133";
 ...
 */
@Slf4j
public class Idea200133Service {
    private static final int IDEA_ID = 200133;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200133Service() {
        this(new Idea200133Config());
    }

    public Idea200133Service(Idea200133Config config) {
        this.config = config != null ? config : new Idea200133Config();
