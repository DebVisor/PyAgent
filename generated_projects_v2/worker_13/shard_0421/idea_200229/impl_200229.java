...
@Data
public class Idea200229Config {
    private String name = "idea_200229";
 ...
 */
@Slf4j
public class Idea200229Service {
    private static final int IDEA_ID = 200229;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200229Service() {
        this(new Idea200229Config());
    }

    public Idea200229Service(Idea200229Config config) {
        this.config = config != null ? config : new Idea200229Config();
