...
@Data
public class Idea200362Config {
    private String name = "idea_200362";
 ...
 */
@Slf4j
public class Idea200362Service {
    private static final int IDEA_ID = 200362;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200362Service() {
        this(new Idea200362Config());
    }

    public Idea200362Service(Idea200362Config config) {
        this.config = config != null ? config : new Idea200362Config();
