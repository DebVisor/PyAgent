...
@Data
public class Idea200342Config {
    private String name = "idea_200342";
 ...
 */
@Slf4j
public class Idea200342Service {
    private static final int IDEA_ID = 200342;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200342Service() {
        this(new Idea200342Config());
    }

    public Idea200342Service(Idea200342Config config) {
        this.config = config != null ? config : new Idea200342Config();
