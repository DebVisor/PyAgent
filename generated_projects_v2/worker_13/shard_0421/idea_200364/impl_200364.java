...
@Data
public class Idea200364Config {
    private String name = "idea_200364";
 ...
 */
@Slf4j
public class Idea200364Service {
    private static final int IDEA_ID = 200364;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200364Service() {
        this(new Idea200364Config());
    }

    public Idea200364Service(Idea200364Config config) {
        this.config = config != null ? config : new Idea200364Config();
