...
@Data
public class Idea200131Config {
    private String name = "idea_200131";
 ...
 */
@Slf4j
public class Idea200131Service {
    private static final int IDEA_ID = 200131;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200131Service() {
        this(new Idea200131Config());
    }

    public Idea200131Service(Idea200131Config config) {
        this.config = config != null ? config : new Idea200131Config();
