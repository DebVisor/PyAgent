...
@Data
public class Idea200265Config {
    private String name = "idea_200265";
 ...
 */
@Slf4j
public class Idea200265Service {
    private static final int IDEA_ID = 200265;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200265Service() {
        this(new Idea200265Config());
    }

    public Idea200265Service(Idea200265Config config) {
        this.config = config != null ? config : new Idea200265Config();
