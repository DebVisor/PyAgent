...
@Data
public class Idea200018Config {
    private String name = "idea_200018";
 ...
 */
@Slf4j
public class Idea200018Service {
    private static final int IDEA_ID = 200018;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200018Service() {
        this(new Idea200018Config());
    }

    public Idea200018Service(Idea200018Config config) {
        this.config = config != null ? config : new Idea200018Config();
