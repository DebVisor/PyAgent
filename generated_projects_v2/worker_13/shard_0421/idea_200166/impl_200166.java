...
@Data
public class Idea200166Config {
    private String name = "idea_200166";
 ...
 */
@Slf4j
public class Idea200166Service {
    private static final int IDEA_ID = 200166;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200166Service() {
        this(new Idea200166Config());
    }

    public Idea200166Service(Idea200166Config config) {
        this.config = config != null ? config : new Idea200166Config();
