...
@Data
public class Idea200428Config {
    private String name = "idea_200428";
 ...
 */
@Slf4j
public class Idea200428Service {
    private static final int IDEA_ID = 200428;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200428Service() {
        this(new Idea200428Config());
    }

    public Idea200428Service(Idea200428Config config) {
        this.config = config != null ? config : new Idea200428Config();
