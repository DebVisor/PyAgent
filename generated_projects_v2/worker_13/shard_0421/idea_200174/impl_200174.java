...
@Data
public class Idea200174Config {
    private String name = "idea_200174";
 ...
 */
@Slf4j
public class Idea200174Service {
    private static final int IDEA_ID = 200174;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200174Service() {
        this(new Idea200174Config());
    }

    public Idea200174Service(Idea200174Config config) {
        this.config = config != null ? config : new Idea200174Config();
