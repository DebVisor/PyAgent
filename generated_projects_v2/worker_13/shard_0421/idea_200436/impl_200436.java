...
@Data
public class Idea200436Config {
    private String name = "idea_200436";
 ...
 */
@Slf4j
public class Idea200436Service {
    private static final int IDEA_ID = 200436;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200436Service() {
        this(new Idea200436Config());
    }

    public Idea200436Service(Idea200436Config config) {
        this.config = config != null ? config : new Idea200436Config();
