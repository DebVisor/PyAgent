...
@Data
public class Idea200081Config {
    private String name = "idea_200081";
 ...
 */
@Slf4j
public class Idea200081Service {
    private static final int IDEA_ID = 200081;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200081Service() {
        this(new Idea200081Config());
    }

    public Idea200081Service(Idea200081Config config) {
        this.config = config != null ? config : new Idea200081Config();
