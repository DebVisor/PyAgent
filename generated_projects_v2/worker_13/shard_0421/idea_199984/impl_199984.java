...
@Data
public class Idea199984Config {
    private String name = "idea_199984";
 ...
 */
@Slf4j
public class Idea199984Service {
    private static final int IDEA_ID = 199984;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199984Service() {
        this(new Idea199984Config());
    }

    public Idea199984Service(Idea199984Config config) {
        this.config = config != null ? config : new Idea199984Config();
