...
@Data
public class Idea200347Config {
    private String name = "idea_200347";
 ...
 */
@Slf4j
public class Idea200347Service {
    private static final int IDEA_ID = 200347;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200347Service() {
        this(new Idea200347Config());
    }

    public Idea200347Service(Idea200347Config config) {
        this.config = config != null ? config : new Idea200347Config();
