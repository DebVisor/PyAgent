...
@Data
public class Idea200225Config {
    private String name = "idea_200225";
 ...
 */
@Slf4j
public class Idea200225Service {
    private static final int IDEA_ID = 200225;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200225Service() {
        this(new Idea200225Config());
    }

    public Idea200225Service(Idea200225Config config) {
        this.config = config != null ? config : new Idea200225Config();
