...
@Data
public class Idea200132Config {
    private String name = "idea_200132";
 ...
 */
@Slf4j
public class Idea200132Service {
    private static final int IDEA_ID = 200132;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200132Service() {
        this(new Idea200132Config());
    }

    public Idea200132Service(Idea200132Config config) {
        this.config = config != null ? config : new Idea200132Config();
