...
@Data
public class Idea200085Config {
    private String name = "idea_200085";
 ...
 */
@Slf4j
public class Idea200085Service {
    private static final int IDEA_ID = 200085;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200085Service() {
        this(new Idea200085Config());
    }

    public Idea200085Service(Idea200085Config config) {
        this.config = config != null ? config : new Idea200085Config();
