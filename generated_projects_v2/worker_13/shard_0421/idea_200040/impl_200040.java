...
@Data
public class Idea200040Config {
    private String name = "idea_200040";
 ...
 */
@Slf4j
public class Idea200040Service {
    private static final int IDEA_ID = 200040;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200040Service() {
        this(new Idea200040Config());
    }

    public Idea200040Service(Idea200040Config config) {
        this.config = config != null ? config : new Idea200040Config();
