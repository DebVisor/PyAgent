...
@Data
public class Idea200195Config {
    private String name = "idea_200195";
 ...
 */
@Slf4j
public class Idea200195Service {
    private static final int IDEA_ID = 200195;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200195Service() {
        this(new Idea200195Config());
    }

    public Idea200195Service(Idea200195Config config) {
        this.config = config != null ? config : new Idea200195Config();
