...
@Data
public class Idea200041Config {
    private String name = "idea_200041";
 ...
 */
@Slf4j
public class Idea200041Service {
    private static final int IDEA_ID = 200041;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200041Service() {
        this(new Idea200041Config());
    }

    public Idea200041Service(Idea200041Config config) {
        this.config = config != null ? config : new Idea200041Config();
