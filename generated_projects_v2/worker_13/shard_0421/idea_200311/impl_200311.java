...
@Data
public class Idea200311Config {
    private String name = "idea_200311";
 ...
 */
@Slf4j
public class Idea200311Service {
    private static final int IDEA_ID = 200311;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200311Service() {
        this(new Idea200311Config());
    }

    public Idea200311Service(Idea200311Config config) {
        this.config = config != null ? config : new Idea200311Config();
