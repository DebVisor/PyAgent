...
@Data
public class Idea200241Config {
    private String name = "idea_200241";
 ...
 */
@Slf4j
public class Idea200241Service {
    private static final int IDEA_ID = 200241;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200241Service() {
        this(new Idea200241Config());
    }

    public Idea200241Service(Idea200241Config config) {
        this.config = config != null ? config : new Idea200241Config();
