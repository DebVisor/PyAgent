...
@Data
public class Idea200434Config {
    private String name = "idea_200434";
 ...
 */
@Slf4j
public class Idea200434Service {
    private static final int IDEA_ID = 200434;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200434Service() {
        this(new Idea200434Config());
    }

    public Idea200434Service(Idea200434Config config) {
        this.config = config != null ? config : new Idea200434Config();
