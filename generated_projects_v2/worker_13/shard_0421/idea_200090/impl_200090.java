...
@Data
public class Idea200090Config {
    private String name = "idea_200090";
 ...
 */
@Slf4j
public class Idea200090Service {
    private static final int IDEA_ID = 200090;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200090Service() {
        this(new Idea200090Config());
    }

    public Idea200090Service(Idea200090Config config) {
        this.config = config != null ? config : new Idea200090Config();
