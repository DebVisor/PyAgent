...
@Data
public class Idea199983Config {
    private String name = "idea_199983";
 ...
 */
@Slf4j
public class Idea199983Service {
    private static final int IDEA_ID = 199983;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199983Service() {
        this(new Idea199983Config());
    }

    public Idea199983Service(Idea199983Config config) {
        this.config = config != null ? config : new Idea199983Config();
