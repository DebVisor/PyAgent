...
@Data
public class Idea200447Config {
    private String name = "idea_200447";
 ...
 */
@Slf4j
public class Idea200447Service {
    private static final int IDEA_ID = 200447;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200447Service() {
        this(new Idea200447Config());
    }

    public Idea200447Service(Idea200447Config config) {
        this.config = config != null ? config : new Idea200447Config();
