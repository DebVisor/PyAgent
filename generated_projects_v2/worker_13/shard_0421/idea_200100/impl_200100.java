...
@Data
public class Idea200100Config {
    private String name = "idea_200100";
 ...
 */
@Slf4j
public class Idea200100Service {
    private static final int IDEA_ID = 200100;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200100Service() {
        this(new Idea200100Config());
    }

    public Idea200100Service(Idea200100Config config) {
        this.config = config != null ? config : new Idea200100Config();
