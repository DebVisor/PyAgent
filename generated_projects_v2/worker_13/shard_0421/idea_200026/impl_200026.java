...
@Data
public class Idea200026Config {
    private String name = "idea_200026";
 ...
 */
@Slf4j
public class Idea200026Service {
    private static final int IDEA_ID = 200026;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200026Service() {
        this(new Idea200026Config());
    }

    public Idea200026Service(Idea200026Config config) {
        this.config = config != null ? config : new Idea200026Config();
