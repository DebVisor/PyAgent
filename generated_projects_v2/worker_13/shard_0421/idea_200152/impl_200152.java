...
@Data
public class Idea200152Config {
    private String name = "idea_200152";
 ...
 */
@Slf4j
public class Idea200152Service {
    private static final int IDEA_ID = 200152;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200152Service() {
        this(new Idea200152Config());
    }

    public Idea200152Service(Idea200152Config config) {
        this.config = config != null ? config : new Idea200152Config();
