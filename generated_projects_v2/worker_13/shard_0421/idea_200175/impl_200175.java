...
@Data
public class Idea200175Config {
    private String name = "idea_200175";
 ...
 */
@Slf4j
public class Idea200175Service {
    private static final int IDEA_ID = 200175;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200175Service() {
        this(new Idea200175Config());
    }

    public Idea200175Service(Idea200175Config config) {
        this.config = config != null ? config : new Idea200175Config();
