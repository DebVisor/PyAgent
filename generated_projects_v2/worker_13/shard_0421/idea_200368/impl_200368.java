...
@Data
public class Idea200368Config {
    private String name = "idea_200368";
 ...
 */
@Slf4j
public class Idea200368Service {
    private static final int IDEA_ID = 200368;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200368Service() {
        this(new Idea200368Config());
    }

    public Idea200368Service(Idea200368Config config) {
        this.config = config != null ? config : new Idea200368Config();
