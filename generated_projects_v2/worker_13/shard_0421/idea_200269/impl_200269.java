...
@Data
public class Idea200269Config {
    private String name = "idea_200269";
 ...
 */
@Slf4j
public class Idea200269Service {
    private static final int IDEA_ID = 200269;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200269Service() {
        this(new Idea200269Config());
    }

    public Idea200269Service(Idea200269Config config) {
        this.config = config != null ? config : new Idea200269Config();
