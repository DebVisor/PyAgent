...
@Data
public class Idea200070Config {
    private String name = "idea_200070";
 ...
 */
@Slf4j
public class Idea200070Service {
    private static final int IDEA_ID = 200070;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200070Service() {
        this(new Idea200070Config());
    }

    public Idea200070Service(Idea200070Config config) {
        this.config = config != null ? config : new Idea200070Config();
