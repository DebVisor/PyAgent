...
@Data
public class Idea200369Config {
    private String name = "idea_200369";
 ...
 */
@Slf4j
public class Idea200369Service {
    private static final int IDEA_ID = 200369;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200369Service() {
        this(new Idea200369Config());
    }

    public Idea200369Service(Idea200369Config config) {
        this.config = config != null ? config : new Idea200369Config();
