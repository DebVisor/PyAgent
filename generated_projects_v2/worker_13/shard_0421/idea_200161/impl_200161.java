...
@Data
public class Idea200161Config {
    private String name = "idea_200161";
 ...
 */
@Slf4j
public class Idea200161Service {
    private static final int IDEA_ID = 200161;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200161Service() {
        this(new Idea200161Config());
    }

    public Idea200161Service(Idea200161Config config) {
        this.config = config != null ? config : new Idea200161Config();
