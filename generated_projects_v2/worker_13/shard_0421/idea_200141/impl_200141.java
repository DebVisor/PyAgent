...
@Data
public class Idea200141Config {
    private String name = "idea_200141";
 ...
 */
@Slf4j
public class Idea200141Service {
    private static final int IDEA_ID = 200141;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200141Service() {
        this(new Idea200141Config());
    }

    public Idea200141Service(Idea200141Config config) {
        this.config = config != null ? config : new Idea200141Config();
