...
@Data
public class Idea200146Config {
    private String name = "idea_200146";
 ...
 */
@Slf4j
public class Idea200146Service {
    private static final int IDEA_ID = 200146;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200146Service() {
        this(new Idea200146Config());
    }

    public Idea200146Service(Idea200146Config config) {
        this.config = config != null ? config : new Idea200146Config();
