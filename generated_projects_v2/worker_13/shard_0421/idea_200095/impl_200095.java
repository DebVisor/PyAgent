...
@Data
public class Idea200095Config {
    private String name = "idea_200095";
 ...
 */
@Slf4j
public class Idea200095Service {
    private static final int IDEA_ID = 200095;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200095Service() {
        this(new Idea200095Config());
    }

    public Idea200095Service(Idea200095Config config) {
        this.config = config != null ? config : new Idea200095Config();
