...
@Data
public class Idea200335Config {
    private String name = "idea_200335";
 ...
 */
@Slf4j
public class Idea200335Service {
    private static final int IDEA_ID = 200335;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200335Service() {
        this(new Idea200335Config());
    }

    public Idea200335Service(Idea200335Config config) {
        this.config = config != null ? config : new Idea200335Config();
