...
@Data
public class Idea199986Config {
    private String name = "idea_199986";
 ...
 */
@Slf4j
public class Idea199986Service {
    private static final int IDEA_ID = 199986;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199986Service() {
        this(new Idea199986Config());
    }

    public Idea199986Service(Idea199986Config config) {
        this.config = config != null ? config : new Idea199986Config();
