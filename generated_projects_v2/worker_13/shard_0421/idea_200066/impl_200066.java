...
@Data
public class Idea200066Config {
    private String name = "idea_200066";
 ...
 */
@Slf4j
public class Idea200066Service {
    private static final int IDEA_ID = 200066;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200066Service() {
        this(new Idea200066Config());
    }

    public Idea200066Service(Idea200066Config config) {
        this.config = config != null ? config : new Idea200066Config();
