...
@Data
public class Idea200205Config {
    private String name = "idea_200205";
 ...
 */
@Slf4j
public class Idea200205Service {
    private static final int IDEA_ID = 200205;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200205Service() {
        this(new Idea200205Config());
    }

    public Idea200205Service(Idea200205Config config) {
        this.config = config != null ? config : new Idea200205Config();
