...
@Data
public class Idea200268Config {
    private String name = "idea_200268";
 ...
 */
@Slf4j
public class Idea200268Service {
    private static final int IDEA_ID = 200268;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200268Service() {
        this(new Idea200268Config());
    }

    public Idea200268Service(Idea200268Config config) {
        this.config = config != null ? config : new Idea200268Config();
