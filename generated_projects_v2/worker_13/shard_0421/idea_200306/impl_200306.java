...
@Data
public class Idea200306Config {
    private String name = "idea_200306";
 ...
 */
@Slf4j
public class Idea200306Service {
    private static final int IDEA_ID = 200306;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200306Service() {
        this(new Idea200306Config());
    }

    public Idea200306Service(Idea200306Config config) {
        this.config = config != null ? config : new Idea200306Config();
