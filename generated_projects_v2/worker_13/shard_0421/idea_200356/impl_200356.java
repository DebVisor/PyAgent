...
@Data
public class Idea200356Config {
    private String name = "idea_200356";
 ...
 */
@Slf4j
public class Idea200356Service {
    private static final int IDEA_ID = 200356;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200356Service() {
        this(new Idea200356Config());
    }

    public Idea200356Service(Idea200356Config config) {
        this.config = config != null ? config : new Idea200356Config();
