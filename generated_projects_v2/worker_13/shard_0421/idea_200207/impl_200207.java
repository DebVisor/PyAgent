...
@Data
public class Idea200207Config {
    private String name = "idea_200207";
 ...
 */
@Slf4j
public class Idea200207Service {
    private static final int IDEA_ID = 200207;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200207Service() {
        this(new Idea200207Config());
    }

    public Idea200207Service(Idea200207Config config) {
        this.config = config != null ? config : new Idea200207Config();
