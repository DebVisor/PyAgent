...
@Data
public class Idea200348Config {
    private String name = "idea_200348";
 ...
 */
@Slf4j
public class Idea200348Service {
    private static final int IDEA_ID = 200348;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200348Service() {
        this(new Idea200348Config());
    }

    public Idea200348Service(Idea200348Config config) {
        this.config = config != null ? config : new Idea200348Config();
