...
@Data
public class Idea200019Config {
    private String name = "idea_200019";
 ...
 */
@Slf4j
public class Idea200019Service {
    private static final int IDEA_ID = 200019;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200019Service() {
        this(new Idea200019Config());
    }

    public Idea200019Service(Idea200019Config config) {
        this.config = config != null ? config : new Idea200019Config();
