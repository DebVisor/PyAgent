...
@Data
public class Idea200421Config {
    private String name = "idea_200421";
 ...
 */
@Slf4j
public class Idea200421Service {
    private static final int IDEA_ID = 200421;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200421Service() {
        this(new Idea200421Config());
    }

    public Idea200421Service(Idea200421Config config) {
        this.config = config != null ? config : new Idea200421Config();
