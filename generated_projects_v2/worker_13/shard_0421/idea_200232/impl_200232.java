...
@Data
public class Idea200232Config {
    private String name = "idea_200232";
 ...
 */
@Slf4j
public class Idea200232Service {
    private static final int IDEA_ID = 200232;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200232Service() {
        this(new Idea200232Config());
    }

    public Idea200232Service(Idea200232Config config) {
        this.config = config != null ? config : new Idea200232Config();
