...
@Data
public class Idea200353Config {
    private String name = "idea_200353";
 ...
 */
@Slf4j
public class Idea200353Service {
    private static final int IDEA_ID = 200353;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200353Service() {
        this(new Idea200353Config());
    }

    public Idea200353Service(Idea200353Config config) {
        this.config = config != null ? config : new Idea200353Config();
