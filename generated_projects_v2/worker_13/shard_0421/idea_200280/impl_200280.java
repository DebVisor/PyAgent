...
@Data
public class Idea200280Config {
    private String name = "idea_200280";
 ...
 */
@Slf4j
public class Idea200280Service {
    private static final int IDEA_ID = 200280;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200280Service() {
        this(new Idea200280Config());
    }

    public Idea200280Service(Idea200280Config config) {
        this.config = config != null ? config : new Idea200280Config();
