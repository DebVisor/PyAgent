...
@Data
public class Idea200096Config {
    private String name = "idea_200096";
 ...
 */
@Slf4j
public class Idea200096Service {
    private static final int IDEA_ID = 200096;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200096Service() {
        this(new Idea200096Config());
    }

    public Idea200096Service(Idea200096Config config) {
        this.config = config != null ? config : new Idea200096Config();
