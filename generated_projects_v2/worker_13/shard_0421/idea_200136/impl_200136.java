...
@Data
public class Idea200136Config {
    private String name = "idea_200136";
 ...
 */
@Slf4j
public class Idea200136Service {
    private static final int IDEA_ID = 200136;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200136Service() {
        this(new Idea200136Config());
    }

    public Idea200136Service(Idea200136Config config) {
        this.config = config != null ? config : new Idea200136Config();
