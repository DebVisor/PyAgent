...
@Data
public class Idea200143Config {
    private String name = "idea_200143";
 ...
 */
@Slf4j
public class Idea200143Service {
    private static final int IDEA_ID = 200143;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200143Service() {
        this(new Idea200143Config());
    }

    public Idea200143Service(Idea200143Config config) {
        this.config = config != null ? config : new Idea200143Config();
