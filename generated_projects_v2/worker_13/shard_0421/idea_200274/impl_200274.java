...
@Data
public class Idea200274Config {
    private String name = "idea_200274";
 ...
 */
@Slf4j
public class Idea200274Service {
    private static final int IDEA_ID = 200274;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200274Service() {
        this(new Idea200274Config());
    }

    public Idea200274Service(Idea200274Config config) {
        this.config = config != null ? config : new Idea200274Config();
