...
@Data
public class Idea200307Config {
    private String name = "idea_200307";
 ...
 */
@Slf4j
public class Idea200307Service {
    private static final int IDEA_ID = 200307;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200307Service() {
        this(new Idea200307Config());
    }

    public Idea200307Service(Idea200307Config config) {
        this.config = config != null ? config : new Idea200307Config();
