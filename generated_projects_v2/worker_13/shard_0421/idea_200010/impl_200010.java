...
@Data
public class Idea200010Config {
    private String name = "idea_200010";
 ...
 */
@Slf4j
public class Idea200010Service {
    private static final int IDEA_ID = 200010;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200010Service() {
        this(new Idea200010Config());
    }

    public Idea200010Service(Idea200010Config config) {
        this.config = config != null ? config : new Idea200010Config();
