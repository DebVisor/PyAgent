...
@Data
public class Idea200340Config {
    private String name = "idea_200340";
 ...
 */
@Slf4j
public class Idea200340Service {
    private static final int IDEA_ID = 200340;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200340Service() {
        this(new Idea200340Config());
    }

    public Idea200340Service(Idea200340Config config) {
        this.config = config != null ? config : new Idea200340Config();
