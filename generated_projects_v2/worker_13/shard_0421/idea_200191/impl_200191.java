...
@Data
public class Idea200191Config {
    private String name = "idea_200191";
 ...
 */
@Slf4j
public class Idea200191Service {
    private static final int IDEA_ID = 200191;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200191Service() {
        this(new Idea200191Config());
    }

    public Idea200191Service(Idea200191Config config) {
        this.config = config != null ? config : new Idea200191Config();
