...
@Data
public class Idea200002Config {
    private String name = "idea_200002";
 ...
 */
@Slf4j
public class Idea200002Service {
    private static final int IDEA_ID = 200002;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200002Service() {
        this(new Idea200002Config());
    }

    public Idea200002Service(Idea200002Config config) {
        this.config = config != null ? config : new Idea200002Config();
