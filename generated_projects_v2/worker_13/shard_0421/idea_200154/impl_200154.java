...
@Data
public class Idea200154Config {
    private String name = "idea_200154";
 ...
 */
@Slf4j
public class Idea200154Service {
    private static final int IDEA_ID = 200154;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200154Service() {
        this(new Idea200154Config());
    }

    public Idea200154Service(Idea200154Config config) {
        this.config = config != null ? config : new Idea200154Config();
