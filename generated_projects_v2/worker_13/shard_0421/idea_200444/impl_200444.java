...
@Data
public class Idea200444Config {
    private String name = "idea_200444";
 ...
 */
@Slf4j
public class Idea200444Service {
    private static final int IDEA_ID = 200444;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200444Service() {
        this(new Idea200444Config());
    }

    public Idea200444Service(Idea200444Config config) {
        this.config = config != null ? config : new Idea200444Config();
