...
@Data
public class Idea200359Config {
    private String name = "idea_200359";
 ...
 */
@Slf4j
public class Idea200359Service {
    private static final int IDEA_ID = 200359;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200359Service() {
        this(new Idea200359Config());
    }

    public Idea200359Service(Idea200359Config config) {
        this.config = config != null ? config : new Idea200359Config();
