...
@Data
public class Idea200334Config {
    private String name = "idea_200334";
 ...
 */
@Slf4j
public class Idea200334Service {
    private static final int IDEA_ID = 200334;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200334Service() {
        this(new Idea200334Config());
    }

    public Idea200334Service(Idea200334Config config) {
        this.config = config != null ? config : new Idea200334Config();
