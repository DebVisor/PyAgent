...
@Data
public class Idea200212Config {
    private String name = "idea_200212";
 ...
 */
@Slf4j
public class Idea200212Service {
    private static final int IDEA_ID = 200212;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200212Service() {
        this(new Idea200212Config());
    }

    public Idea200212Service(Idea200212Config config) {
        this.config = config != null ? config : new Idea200212Config();
