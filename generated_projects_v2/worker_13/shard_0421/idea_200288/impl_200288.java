...
@Data
public class Idea200288Config {
    private String name = "idea_200288";
 ...
 */
@Slf4j
public class Idea200288Service {
    private static final int IDEA_ID = 200288;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200288Service() {
        this(new Idea200288Config());
    }

    public Idea200288Service(Idea200288Config config) {
        this.config = config != null ? config : new Idea200288Config();
