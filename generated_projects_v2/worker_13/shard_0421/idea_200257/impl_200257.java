...
@Data
public class Idea200257Config {
    private String name = "idea_200257";
 ...
 */
@Slf4j
public class Idea200257Service {
    private static final int IDEA_ID = 200257;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200257Service() {
        this(new Idea200257Config());
    }

    public Idea200257Service(Idea200257Config config) {
        this.config = config != null ? config : new Idea200257Config();
