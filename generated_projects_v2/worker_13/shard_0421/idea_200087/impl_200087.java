...
@Data
public class Idea200087Config {
    private String name = "idea_200087";
 ...
 */
@Slf4j
public class Idea200087Service {
    private static final int IDEA_ID = 200087;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200087Service() {
        this(new Idea200087Config());
    }

    public Idea200087Service(Idea200087Config config) {
        this.config = config != null ? config : new Idea200087Config();
