...
@Data
public class Idea199982Config {
    private String name = "idea_199982";
 ...
 */
@Slf4j
public class Idea199982Service {
    private static final int IDEA_ID = 199982;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199982Service() {
        this(new Idea199982Config());
    }

    public Idea199982Service(Idea199982Config config) {
        this.config = config != null ? config : new Idea199982Config();
