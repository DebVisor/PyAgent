...
@Data
public class Idea200177Config {
    private String name = "idea_200177";
 ...
 */
@Slf4j
public class Idea200177Service {
    private static final int IDEA_ID = 200177;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200177Service() {
        this(new Idea200177Config());
    }

    public Idea200177Service(Idea200177Config config) {
        this.config = config != null ? config : new Idea200177Config();
