...
@Data
public class Idea200103Config {
    private String name = "idea_200103";
 ...
 */
@Slf4j
public class Idea200103Service {
    private static final int IDEA_ID = 200103;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200103Service() {
        this(new Idea200103Config());
    }

    public Idea200103Service(Idea200103Config config) {
        this.config = config != null ? config : new Idea200103Config();
