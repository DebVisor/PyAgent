...
@Data
public class Idea200387Config {
    private String name = "idea_200387";
 ...
 */
@Slf4j
public class Idea200387Service {
    private static final int IDEA_ID = 200387;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200387Service() {
        this(new Idea200387Config());
    }

    public Idea200387Service(Idea200387Config config) {
        this.config = config != null ? config : new Idea200387Config();
