...
@Data
public class Idea200270Config {
    private String name = "idea_200270";
 ...
 */
@Slf4j
public class Idea200270Service {
    private static final int IDEA_ID = 200270;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200270Service() {
        this(new Idea200270Config());
    }

    public Idea200270Service(Idea200270Config config) {
        this.config = config != null ? config : new Idea200270Config();
