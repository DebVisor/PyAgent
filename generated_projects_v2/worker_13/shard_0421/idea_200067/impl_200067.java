...
@Data
public class Idea200067Config {
    private String name = "idea_200067";
 ...
 */
@Slf4j
public class Idea200067Service {
    private static final int IDEA_ID = 200067;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200067Service() {
        this(new Idea200067Config());
    }

    public Idea200067Service(Idea200067Config config) {
        this.config = config != null ? config : new Idea200067Config();
