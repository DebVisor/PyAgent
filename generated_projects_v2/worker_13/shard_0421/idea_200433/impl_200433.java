...
@Data
public class Idea200433Config {
    private String name = "idea_200433";
 ...
 */
@Slf4j
public class Idea200433Service {
    private static final int IDEA_ID = 200433;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200433Service() {
        this(new Idea200433Config());
    }

    public Idea200433Service(Idea200433Config config) {
        this.config = config != null ? config : new Idea200433Config();
