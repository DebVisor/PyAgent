...
@Data
public class Idea200137Config {
    private String name = "idea_200137";
 ...
 */
@Slf4j
public class Idea200137Service {
    private static final int IDEA_ID = 200137;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200137Service() {
        this(new Idea200137Config());
    }

    public Idea200137Service(Idea200137Config config) {
        this.config = config != null ? config : new Idea200137Config();
