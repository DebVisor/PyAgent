...
@Data
public class Idea200190Config {
    private String name = "idea_200190";
 ...
 */
@Slf4j
public class Idea200190Service {
    private static final int IDEA_ID = 200190;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200190Service() {
        this(new Idea200190Config());
    }

    public Idea200190Service(Idea200190Config config) {
        this.config = config != null ? config : new Idea200190Config();
