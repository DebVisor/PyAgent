...
@Data
public class Idea200343Config {
    private String name = "idea_200343";
 ...
 */
@Slf4j
public class Idea200343Service {
    private static final int IDEA_ID = 200343;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200343Service() {
        this(new Idea200343Config());
    }

    public Idea200343Service(Idea200343Config config) {
        this.config = config != null ? config : new Idea200343Config();
