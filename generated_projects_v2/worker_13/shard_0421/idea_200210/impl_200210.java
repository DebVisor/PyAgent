...
@Data
public class Idea200210Config {
    private String name = "idea_200210";
 ...
 */
@Slf4j
public class Idea200210Service {
    private static final int IDEA_ID = 200210;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200210Service() {
        this(new Idea200210Config());
    }

    public Idea200210Service(Idea200210Config config) {
        this.config = config != null ? config : new Idea200210Config();
