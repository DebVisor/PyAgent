...
@Data
public class Idea200151Config {
    private String name = "idea_200151";
 ...
 */
@Slf4j
public class Idea200151Service {
    private static final int IDEA_ID = 200151;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200151Service() {
        this(new Idea200151Config());
    }

    public Idea200151Service(Idea200151Config config) {
        this.config = config != null ? config : new Idea200151Config();
