...
@Data
public class Idea200007Config {
    private String name = "idea_200007";
 ...
 */
@Slf4j
public class Idea200007Service {
    private static final int IDEA_ID = 200007;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200007Service() {
        this(new Idea200007Config());
    }

    public Idea200007Service(Idea200007Config config) {
        this.config = config != null ? config : new Idea200007Config();
