...
@Data
public class Idea200168Config {
    private String name = "idea_200168";
 ...
 */
@Slf4j
public class Idea200168Service {
    private static final int IDEA_ID = 200168;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200168Service() {
        this(new Idea200168Config());
    }

    public Idea200168Service(Idea200168Config config) {
        this.config = config != null ? config : new Idea200168Config();
