...
@Data
public class Idea200135Config {
    private String name = "idea_200135";
 ...
 */
@Slf4j
public class Idea200135Service {
    private static final int IDEA_ID = 200135;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200135Service() {
        this(new Idea200135Config());
    }

    public Idea200135Service(Idea200135Config config) {
        this.config = config != null ? config : new Idea200135Config();
