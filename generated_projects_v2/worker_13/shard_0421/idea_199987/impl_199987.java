...
@Data
public class Idea199987Config {
    private String name = "idea_199987";
 ...
 */
@Slf4j
public class Idea199987Service {
    private static final int IDEA_ID = 199987;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199987Service() {
        this(new Idea199987Config());
    }

    public Idea199987Service(Idea199987Config config) {
        this.config = config != null ? config : new Idea199987Config();
