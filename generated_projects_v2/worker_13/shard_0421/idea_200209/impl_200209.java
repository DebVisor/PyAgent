...
@Data
public class Idea200209Config {
    private String name = "idea_200209";
 ...
 */
@Slf4j
public class Idea200209Service {
    private static final int IDEA_ID = 200209;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200209Service() {
        this(new Idea200209Config());
    }

    public Idea200209Service(Idea200209Config config) {
        this.config = config != null ? config : new Idea200209Config();
