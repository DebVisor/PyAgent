...
@Data
public class Idea200224Config {
    private String name = "idea_200224";
 ...
 */
@Slf4j
public class Idea200224Service {
    private static final int IDEA_ID = 200224;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200224Service() {
        this(new Idea200224Config());
    }

    public Idea200224Service(Idea200224Config config) {
        this.config = config != null ? config : new Idea200224Config();
