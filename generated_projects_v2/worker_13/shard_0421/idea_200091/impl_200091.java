...
@Data
public class Idea200091Config {
    private String name = "idea_200091";
 ...
 */
@Slf4j
public class Idea200091Service {
    private static final int IDEA_ID = 200091;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200091Service() {
        this(new Idea200091Config());
    }

    public Idea200091Service(Idea200091Config config) {
        this.config = config != null ? config : new Idea200091Config();
