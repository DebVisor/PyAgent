...
@Data
public class Idea200093Config {
    private String name = "idea_200093";
 ...
 */
@Slf4j
public class Idea200093Service {
    private static final int IDEA_ID = 200093;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200093Service() {
        this(new Idea200093Config());
    }

    public Idea200093Service(Idea200093Config config) {
        this.config = config != null ? config : new Idea200093Config();
