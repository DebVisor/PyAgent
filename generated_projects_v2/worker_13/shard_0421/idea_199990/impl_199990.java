...
@Data
public class Idea199990Config {
    private String name = "idea_199990";
 ...
 */
@Slf4j
public class Idea199990Service {
    private static final int IDEA_ID = 199990;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199990Service() {
        this(new Idea199990Config());
    }

    public Idea199990Service(Idea199990Config config) {
        this.config = config != null ? config : new Idea199990Config();
