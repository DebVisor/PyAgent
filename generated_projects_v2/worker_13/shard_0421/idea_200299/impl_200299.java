...
@Data
public class Idea200299Config {
    private String name = "idea_200299";
 ...
 */
@Slf4j
public class Idea200299Service {
    private static final int IDEA_ID = 200299;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200299Service() {
        this(new Idea200299Config());
    }

    public Idea200299Service(Idea200299Config config) {
        this.config = config != null ? config : new Idea200299Config();
