...
@Data
public class Idea199989Config {
    private String name = "idea_199989";
 ...
 */
@Slf4j
public class Idea199989Service {
    private static final int IDEA_ID = 199989;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199989Service() {
        this(new Idea199989Config());
    }

    public Idea199989Service(Idea199989Config config) {
        this.config = config != null ? config : new Idea199989Config();
