...
@Data
public class Idea200050Config {
    private String name = "idea_200050";
 ...
 */
@Slf4j
public class Idea200050Service {
    private static final int IDEA_ID = 200050;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200050Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200050Service() {
        this(new Idea200050Config());
    }

    public Idea200050Service(Idea200050Config config) {
        this.config = config != null ? config : new Idea200050Config();
