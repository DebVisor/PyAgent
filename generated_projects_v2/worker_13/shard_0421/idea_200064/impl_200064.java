...
@Data
public class Idea200064Config {
    private String name = "idea_200064";
 ...
 */
@Slf4j
public class Idea200064Service {
    private static final int IDEA_ID = 200064;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200064Service() {
        this(new Idea200064Config());
    }

    public Idea200064Service(Idea200064Config config) {
        this.config = config != null ? config : new Idea200064Config();
