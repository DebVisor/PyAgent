...
@Data
public class Idea200329Config {
    private String name = "idea_200329";
 ...
 */
@Slf4j
public class Idea200329Service {
    private static final int IDEA_ID = 200329;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200329Service() {
        this(new Idea200329Config());
    }

    public Idea200329Service(Idea200329Config config) {
        this.config = config != null ? config : new Idea200329Config();
