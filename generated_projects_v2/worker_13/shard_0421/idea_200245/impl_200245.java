...
@Data
public class Idea200245Config {
    private String name = "idea_200245";
 ...
 */
@Slf4j
public class Idea200245Service {
    private static final int IDEA_ID = 200245;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200245Service() {
        this(new Idea200245Config());
    }

    public Idea200245Service(Idea200245Config config) {
        this.config = config != null ? config : new Idea200245Config();
