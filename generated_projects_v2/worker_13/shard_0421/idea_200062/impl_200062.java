...
@Data
public class Idea200062Config {
    private String name = "idea_200062";
 ...
 */
@Slf4j
public class Idea200062Service {
    private static final int IDEA_ID = 200062;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200062Service() {
        this(new Idea200062Config());
    }

    public Idea200062Service(Idea200062Config config) {
        this.config = config != null ? config : new Idea200062Config();
