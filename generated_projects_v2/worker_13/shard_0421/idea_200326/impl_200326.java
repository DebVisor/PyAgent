...
@Data
public class Idea200326Config {
    private String name = "idea_200326";
 ...
 */
@Slf4j
public class Idea200326Service {
    private static final int IDEA_ID = 200326;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200326Service() {
        this(new Idea200326Config());
    }

    public Idea200326Service(Idea200326Config config) {
        this.config = config != null ? config : new Idea200326Config();
