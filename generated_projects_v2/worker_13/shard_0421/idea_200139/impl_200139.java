...
@Data
public class Idea200139Config {
    private String name = "idea_200139";
 ...
 */
@Slf4j
public class Idea200139Service {
    private static final int IDEA_ID = 200139;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200139Service() {
        this(new Idea200139Config());
    }

    public Idea200139Service(Idea200139Config config) {
        this.config = config != null ? config : new Idea200139Config();
