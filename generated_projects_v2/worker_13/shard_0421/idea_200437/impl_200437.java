...
@Data
public class Idea200437Config {
    private String name = "idea_200437";
 ...
 */
@Slf4j
public class Idea200437Service {
    private static final int IDEA_ID = 200437;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200437Service() {
        this(new Idea200437Config());
    }

    public Idea200437Service(Idea200437Config config) {
        this.config = config != null ? config : new Idea200437Config();
