...
@Data
public class Idea200179Config {
    private String name = "idea_200179";
 ...
 */
@Slf4j
public class Idea200179Service {
    private static final int IDEA_ID = 200179;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200179Service() {
        this(new Idea200179Config());
    }

    public Idea200179Service(Idea200179Config config) {
        this.config = config != null ? config : new Idea200179Config();
