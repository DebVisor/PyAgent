...
@Data
public class Idea200160Config {
    private String name = "idea_200160";
 ...
 */
@Slf4j
public class Idea200160Service {
    private static final int IDEA_ID = 200160;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200160Service() {
        this(new Idea200160Config());
    }

    public Idea200160Service(Idea200160Config config) {
        this.config = config != null ? config : new Idea200160Config();
