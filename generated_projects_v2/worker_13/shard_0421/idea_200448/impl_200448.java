...
@Data
public class Idea200448Config {
    private String name = "idea_200448";
 ...
 */
@Slf4j
public class Idea200448Service {
    private static final int IDEA_ID = 200448;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200448Service() {
        this(new Idea200448Config());
    }

    public Idea200448Service(Idea200448Config config) {
        this.config = config != null ? config : new Idea200448Config();
