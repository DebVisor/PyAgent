...
@Data
public class Idea200411Config {
    private String name = "idea_200411";
 ...
 */
@Slf4j
public class Idea200411Service {
    private static final int IDEA_ID = 200411;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200411Service() {
        this(new Idea200411Config());
    }

    public Idea200411Service(Idea200411Config config) {
        this.config = config != null ? config : new Idea200411Config();
