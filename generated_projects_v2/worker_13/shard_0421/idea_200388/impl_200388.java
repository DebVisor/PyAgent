...
@Data
public class Idea200388Config {
    private String name = "idea_200388";
 ...
 */
@Slf4j
public class Idea200388Service {
    private static final int IDEA_ID = 200388;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200388Service() {
        this(new Idea200388Config());
    }

    public Idea200388Service(Idea200388Config config) {
        this.config = config != null ? config : new Idea200388Config();
