...
@Data
public class Idea200253Config {
    private String name = "idea_200253";
 ...
 */
@Slf4j
public class Idea200253Service {
    private static final int IDEA_ID = 200253;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200253Service() {
        this(new Idea200253Config());
    }

    public Idea200253Service(Idea200253Config config) {
        this.config = config != null ? config : new Idea200253Config();
