...
@Data
public class Idea200345Config {
    private String name = "idea_200345";
 ...
 */
@Slf4j
public class Idea200345Service {
    private static final int IDEA_ID = 200345;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200345Service() {
        this(new Idea200345Config());
    }

    public Idea200345Service(Idea200345Config config) {
        this.config = config != null ? config : new Idea200345Config();
