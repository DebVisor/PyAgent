...
@Data
public class Idea200217Config {
    private String name = "idea_200217";
 ...
 */
@Slf4j
public class Idea200217Service {
    private static final int IDEA_ID = 200217;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200217Service() {
        this(new Idea200217Config());
    }

    public Idea200217Service(Idea200217Config config) {
        this.config = config != null ? config : new Idea200217Config();
