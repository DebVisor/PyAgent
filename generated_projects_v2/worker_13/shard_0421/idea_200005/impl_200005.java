...
@Data
public class Idea200005Config {
    private String name = "idea_200005";
 ...
 */
@Slf4j
public class Idea200005Service {
    private static final int IDEA_ID = 200005;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200005Service() {
        this(new Idea200005Config());
    }

    public Idea200005Service(Idea200005Config config) {
        this.config = config != null ? config : new Idea200005Config();
