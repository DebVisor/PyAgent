...
@Data
public class Idea200392Config {
    private String name = "idea_200392";
 ...
 */
@Slf4j
public class Idea200392Service {
    private static final int IDEA_ID = 200392;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200392Service() {
        this(new Idea200392Config());
    }

    public Idea200392Service(Idea200392Config config) {
        this.config = config != null ? config : new Idea200392Config();
