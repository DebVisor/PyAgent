...
@Data
public class Idea200303Config {
    private String name = "idea_200303";
 ...
 */
@Slf4j
public class Idea200303Service {
    private static final int IDEA_ID = 200303;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200303Service() {
        this(new Idea200303Config());
    }

    public Idea200303Service(Idea200303Config config) {
        this.config = config != null ? config : new Idea200303Config();
