...
@Data
public class Idea200058Config {
    private String name = "idea_200058";
 ...
 */
@Slf4j
public class Idea200058Service {
    private static final int IDEA_ID = 200058;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200058Service() {
        this(new Idea200058Config());
    }

    public Idea200058Service(Idea200058Config config) {
        this.config = config != null ? config : new Idea200058Config();
