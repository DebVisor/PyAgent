...
@Data
public class Idea200338Config {
    private String name = "idea_200338";
 ...
 */
@Slf4j
public class Idea200338Service {
    private static final int IDEA_ID = 200338;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200338Service() {
        this(new Idea200338Config());
    }

    public Idea200338Service(Idea200338Config config) {
        this.config = config != null ? config : new Idea200338Config();
