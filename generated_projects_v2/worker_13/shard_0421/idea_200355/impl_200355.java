...
@Data
public class Idea200355Config {
    private String name = "idea_200355";
 ...
 */
@Slf4j
public class Idea200355Service {
    private static final int IDEA_ID = 200355;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200355Service() {
        this(new Idea200355Config());
    }

    public Idea200355Service(Idea200355Config config) {
        this.config = config != null ? config : new Idea200355Config();
