...
@Data
public class Idea200238Config {
    private String name = "idea_200238";
 ...
 */
@Slf4j
public class Idea200238Service {
    private static final int IDEA_ID = 200238;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200238Service() {
        this(new Idea200238Config());
    }

    public Idea200238Service(Idea200238Config config) {
        this.config = config != null ? config : new Idea200238Config();
