...
@Data
public class Idea200013Config {
    private String name = "idea_200013";
 ...
 */
@Slf4j
public class Idea200013Service {
    private static final int IDEA_ID = 200013;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200013Service() {
        this(new Idea200013Config());
    }

    public Idea200013Service(Idea200013Config config) {
        this.config = config != null ? config : new Idea200013Config();
