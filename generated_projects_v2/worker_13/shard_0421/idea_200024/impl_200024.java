...
@Data
public class Idea200024Config {
    private String name = "idea_200024";
 ...
 */
@Slf4j
public class Idea200024Service {
    private static final int IDEA_ID = 200024;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200024Service() {
        this(new Idea200024Config());
    }

    public Idea200024Service(Idea200024Config config) {
        this.config = config != null ? config : new Idea200024Config();
