...
@Data
public class Idea200383Config {
    private String name = "idea_200383";
 ...
 */
@Slf4j
public class Idea200383Service {
    private static final int IDEA_ID = 200383;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200383Service() {
        this(new Idea200383Config());
    }

    public Idea200383Service(Idea200383Config config) {
        this.config = config != null ? config : new Idea200383Config();
