...
@Data
public class Idea200399Config {
    private String name = "idea_200399";
 ...
 */
@Slf4j
public class Idea200399Service {
    private static final int IDEA_ID = 200399;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200399Service() {
        this(new Idea200399Config());
    }

    public Idea200399Service(Idea200399Config config) {
        this.config = config != null ? config : new Idea200399Config();
