...
@Data
public class Idea200192Config {
    private String name = "idea_200192";
 ...
 */
@Slf4j
public class Idea200192Service {
    private static final int IDEA_ID = 200192;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200192Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200192Service() {
        this(new Idea200192Config());
    }

    public Idea200192Service(Idea200192Config config) {
        this.config = config != null ? config : new Idea200192Config();
