...
@Data
public class Idea200432Config {
    private String name = "idea_200432";
 ...
 */
@Slf4j
public class Idea200432Service {
    private static final int IDEA_ID = 200432;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200432Service() {
        this(new Idea200432Config());
    }

    public Idea200432Service(Idea200432Config config) {
        this.config = config != null ? config : new Idea200432Config();
