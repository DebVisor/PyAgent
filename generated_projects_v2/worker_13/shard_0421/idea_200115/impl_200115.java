...
@Data
public class Idea200115Config {
    private String name = "idea_200115";
 ...
 */
@Slf4j
public class Idea200115Service {
    private static final int IDEA_ID = 200115;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200115Service() {
        this(new Idea200115Config());
    }

    public Idea200115Service(Idea200115Config config) {
        this.config = config != null ? config : new Idea200115Config();
