...
@Data
public class Idea200313Config {
    private String name = "idea_200313";
 ...
 */
@Slf4j
public class Idea200313Service {
    private static final int IDEA_ID = 200313;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200313Service() {
        this(new Idea200313Config());
    }

    public Idea200313Service(Idea200313Config config) {
        this.config = config != null ? config : new Idea200313Config();
