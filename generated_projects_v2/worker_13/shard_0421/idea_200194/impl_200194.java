...
@Data
public class Idea200194Config {
    private String name = "idea_200194";
 ...
 */
@Slf4j
public class Idea200194Service {
    private static final int IDEA_ID = 200194;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200194Service() {
        this(new Idea200194Config());
    }

    public Idea200194Service(Idea200194Config config) {
        this.config = config != null ? config : new Idea200194Config();
