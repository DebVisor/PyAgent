...
@Data
public class Idea200256Config {
    private String name = "idea_200256";
 ...
 */
@Slf4j
public class Idea200256Service {
    private static final int IDEA_ID = 200256;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200256Service() {
        this(new Idea200256Config());
    }

    public Idea200256Service(Idea200256Config config) {
        this.config = config != null ? config : new Idea200256Config();
