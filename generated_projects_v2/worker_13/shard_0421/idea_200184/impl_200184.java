...
@Data
public class Idea200184Config {
    private String name = "idea_200184";
 ...
 */
@Slf4j
public class Idea200184Service {
    private static final int IDEA_ID = 200184;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200184Service() {
        this(new Idea200184Config());
    }

    public Idea200184Service(Idea200184Config config) {
        this.config = config != null ? config : new Idea200184Config();
