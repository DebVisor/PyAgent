...
@Data
public class Idea200107Config {
    private String name = "idea_200107";
 ...
 */
@Slf4j
public class Idea200107Service {
    private static final int IDEA_ID = 200107;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200107Service() {
        this(new Idea200107Config());
    }

    public Idea200107Service(Idea200107Config config) {
        this.config = config != null ? config : new Idea200107Config();
