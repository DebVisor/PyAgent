...
@Data
public class Idea200170Config {
    private String name = "idea_200170";
 ...
 */
@Slf4j
public class Idea200170Service {
    private static final int IDEA_ID = 200170;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200170Service() {
        this(new Idea200170Config());
    }

    public Idea200170Service(Idea200170Config config) {
        this.config = config != null ? config : new Idea200170Config();
