...
@Data
public class Idea200314Config {
    private String name = "idea_200314";
 ...
 */
@Slf4j
public class Idea200314Service {
    private static final int IDEA_ID = 200314;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200314Service() {
        this(new Idea200314Config());
    }

    public Idea200314Service(Idea200314Config config) {
        this.config = config != null ? config : new Idea200314Config();
