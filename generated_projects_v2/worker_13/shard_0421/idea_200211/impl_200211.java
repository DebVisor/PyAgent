...
@Data
public class Idea200211Config {
    private String name = "idea_200211";
 ...
 */
@Slf4j
public class Idea200211Service {
    private static final int IDEA_ID = 200211;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200211Service() {
        this(new Idea200211Config());
    }

    public Idea200211Service(Idea200211Config config) {
        this.config = config != null ? config : new Idea200211Config();
