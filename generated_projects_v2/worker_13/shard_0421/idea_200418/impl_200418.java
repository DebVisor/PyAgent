...
@Data
public class Idea200418Config {
    private String name = "idea_200418";
 ...
 */
@Slf4j
public class Idea200418Service {
    private static final int IDEA_ID = 200418;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200418Service() {
        this(new Idea200418Config());
    }

    public Idea200418Service(Idea200418Config config) {
        this.config = config != null ? config : new Idea200418Config();
