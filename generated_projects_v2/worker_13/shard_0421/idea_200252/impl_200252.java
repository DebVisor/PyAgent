...
@Data
public class Idea200252Config {
    private String name = "idea_200252";
 ...
 */
@Slf4j
public class Idea200252Service {
    private static final int IDEA_ID = 200252;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200252Service() {
        this(new Idea200252Config());
    }

    public Idea200252Service(Idea200252Config config) {
        this.config = config != null ? config : new Idea200252Config();
