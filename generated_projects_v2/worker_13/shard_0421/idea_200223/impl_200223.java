...
@Data
public class Idea200223Config {
    private String name = "idea_200223";
 ...
 */
@Slf4j
public class Idea200223Service {
    private static final int IDEA_ID = 200223;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200223Service() {
        this(new Idea200223Config());
    }

    public Idea200223Service(Idea200223Config config) {
        this.config = config != null ? config : new Idea200223Config();
