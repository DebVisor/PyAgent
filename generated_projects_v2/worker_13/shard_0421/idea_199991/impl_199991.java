...
@Data
public class Idea199991Config {
    private String name = "idea_199991";
 ...
 */
@Slf4j
public class Idea199991Service {
    private static final int IDEA_ID = 199991;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199991Service() {
        this(new Idea199991Config());
    }

    public Idea199991Service(Idea199991Config config) {
        this.config = config != null ? config : new Idea199991Config();
