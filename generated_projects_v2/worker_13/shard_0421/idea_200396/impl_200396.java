...
@Data
public class Idea200396Config {
    private String name = "idea_200396";
 ...
 */
@Slf4j
public class Idea200396Service {
    private static final int IDEA_ID = 200396;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200396Service() {
        this(new Idea200396Config());
    }

    public Idea200396Service(Idea200396Config config) {
        this.config = config != null ? config : new Idea200396Config();
