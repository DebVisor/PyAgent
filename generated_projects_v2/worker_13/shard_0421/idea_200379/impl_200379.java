...
@Data
public class Idea200379Config {
    private String name = "idea_200379";
 ...
 */
@Slf4j
public class Idea200379Service {
    private static final int IDEA_ID = 200379;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200379Service() {
        this(new Idea200379Config());
    }

    public Idea200379Service(Idea200379Config config) {
        this.config = config != null ? config : new Idea200379Config();
