...
@Data
public class Idea200197Config {
    private String name = "idea_200197";
 ...
 */
@Slf4j
public class Idea200197Service {
    private static final int IDEA_ID = 200197;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200197Service() {
        this(new Idea200197Config());
    }

    public Idea200197Service(Idea200197Config config) {
        this.config = config != null ? config : new Idea200197Config();
