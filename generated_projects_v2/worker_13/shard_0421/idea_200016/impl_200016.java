...
@Data
public class Idea200016Config {
    private String name = "idea_200016";
 ...
 */
@Slf4j
public class Idea200016Service {
    private static final int IDEA_ID = 200016;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200016Service() {
        this(new Idea200016Config());
    }

    public Idea200016Service(Idea200016Config config) {
        this.config = config != null ? config : new Idea200016Config();
