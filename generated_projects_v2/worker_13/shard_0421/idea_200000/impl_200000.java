...
@Data
public class Idea200000Config {
    private String name = "idea_200000";
 ...
 */
@Slf4j
public class Idea200000Service {
    private static final int IDEA_ID = 200000;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200000Service() {
        this(new Idea200000Config());
    }

    public Idea200000Service(Idea200000Config config) {
        this.config = config != null ? config : new Idea200000Config();
