...
@Data
public class Idea199980Config {
    private String name = "idea_199980";
 ...
 */
@Slf4j
public class Idea199980Service {
    private static final int IDEA_ID = 199980;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199980Service() {
        this(new Idea199980Config());
    }

    public Idea199980Service(Idea199980Config config) {
        this.config = config != null ? config : new Idea199980Config();
