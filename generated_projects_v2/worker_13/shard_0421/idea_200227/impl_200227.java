...
@Data
public class Idea200227Config {
    private String name = "idea_200227";
 ...
 */
@Slf4j
public class Idea200227Service {
    private static final int IDEA_ID = 200227;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200227Service() {
        this(new Idea200227Config());
    }

    public Idea200227Service(Idea200227Config config) {
        this.config = config != null ? config : new Idea200227Config();
