...
@Data
public class Idea200371Config {
    private String name = "idea_200371";
 ...
 */
@Slf4j
public class Idea200371Service {
    private static final int IDEA_ID = 200371;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200371Service() {
        this(new Idea200371Config());
    }

    public Idea200371Service(Idea200371Config config) {
        this.config = config != null ? config : new Idea200371Config();
