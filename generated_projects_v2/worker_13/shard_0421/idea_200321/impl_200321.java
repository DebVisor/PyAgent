...
@Data
public class Idea200321Config {
    private String name = "idea_200321";
 ...
 */
@Slf4j
public class Idea200321Service {
    private static final int IDEA_ID = 200321;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200321Service() {
        this(new Idea200321Config());
    }

    public Idea200321Service(Idea200321Config config) {
        this.config = config != null ? config : new Idea200321Config();
