...
@Data
public class Idea200386Config {
    private String name = "idea_200386";
 ...
 */
@Slf4j
public class Idea200386Service {
    private static final int IDEA_ID = 200386;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200386Service() {
        this(new Idea200386Config());
    }

    public Idea200386Service(Idea200386Config config) {
        this.config = config != null ? config : new Idea200386Config();
