...
@Data
public class Idea200283Config {
    private String name = "idea_200283";
 ...
 */
@Slf4j
public class Idea200283Service {
    private static final int IDEA_ID = 200283;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200283Service() {
        this(new Idea200283Config());
    }

    public Idea200283Service(Idea200283Config config) {
        this.config = config != null ? config : new Idea200283Config();
