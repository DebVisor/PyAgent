...
@Data
public class Idea200157Config {
    private String name = "idea_200157";
 ...
 */
@Slf4j
public class Idea200157Service {
    private static final int IDEA_ID = 200157;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200157Service() {
        this(new Idea200157Config());
    }

    public Idea200157Service(Idea200157Config config) {
        this.config = config != null ? config : new Idea200157Config();
