...
@Data
public class Idea199993Config {
    private String name = "idea_199993";
 ...
 */
@Slf4j
public class Idea199993Service {
    private static final int IDEA_ID = 199993;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199993Service() {
        this(new Idea199993Config());
    }

    public Idea199993Service(Idea199993Config config) {
        this.config = config != null ? config : new Idea199993Config();
