...
@Data
public class Idea200215Config {
    private String name = "idea_200215";
 ...
 */
@Slf4j
public class Idea200215Service {
    private static final int IDEA_ID = 200215;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200215Service() {
        this(new Idea200215Config());
    }

    public Idea200215Service(Idea200215Config config) {
        this.config = config != null ? config : new Idea200215Config();
