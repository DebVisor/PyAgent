...
@Data
public class Idea200186Config {
    private String name = "idea_200186";
 ...
 */
@Slf4j
public class Idea200186Service {
    private static final int IDEA_ID = 200186;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200186Service() {
        this(new Idea200186Config());
    }

    public Idea200186Service(Idea200186Config config) {
        this.config = config != null ? config : new Idea200186Config();
