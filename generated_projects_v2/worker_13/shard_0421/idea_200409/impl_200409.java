...
@Data
public class Idea200409Config {
    private String name = "idea_200409";
 ...
 */
@Slf4j
public class Idea200409Service {
    private static final int IDEA_ID = 200409;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200409Service() {
        this(new Idea200409Config());
    }

    public Idea200409Service(Idea200409Config config) {
        this.config = config != null ? config : new Idea200409Config();
