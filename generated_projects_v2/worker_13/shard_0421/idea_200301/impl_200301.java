...
@Data
public class Idea200301Config {
    private String name = "idea_200301";
 ...
 */
@Slf4j
public class Idea200301Service {
    private static final int IDEA_ID = 200301;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200301Service() {
        this(new Idea200301Config());
    }

    public Idea200301Service(Idea200301Config config) {
        this.config = config != null ? config : new Idea200301Config();
