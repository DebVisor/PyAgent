...
@Data
public class Idea200080Config {
    private String name = "idea_200080";
 ...
 */
@Slf4j
public class Idea200080Service {
    private static final int IDEA_ID = 200080;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200080Service() {
        this(new Idea200080Config());
    }

    public Idea200080Service(Idea200080Config config) {
        this.config = config != null ? config : new Idea200080Config();
