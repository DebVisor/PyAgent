...
@Data
public class Idea200339Config {
    private String name = "idea_200339";
 ...
 */
@Slf4j
public class Idea200339Service {
    private static final int IDEA_ID = 200339;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200339Service() {
        this(new Idea200339Config());
    }

    public Idea200339Service(Idea200339Config config) {
        this.config = config != null ? config : new Idea200339Config();
