...
@Data
public class Idea200099Config {
    private String name = "idea_200099";
 ...
 */
@Slf4j
public class Idea200099Service {
    private static final int IDEA_ID = 200099;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200099Service() {
        this(new Idea200099Config());
    }

    public Idea200099Service(Idea200099Config config) {
        this.config = config != null ? config : new Idea200099Config();
