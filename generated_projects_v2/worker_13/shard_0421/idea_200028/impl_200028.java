...
@Data
public class Idea200028Config {
    private String name = "idea_200028";
 ...
 */
@Slf4j
public class Idea200028Service {
    private static final int IDEA_ID = 200028;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200028Service() {
        this(new Idea200028Config());
    }

    public Idea200028Service(Idea200028Config config) {
        this.config = config != null ? config : new Idea200028Config();
