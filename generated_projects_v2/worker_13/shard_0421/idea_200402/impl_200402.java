...
@Data
public class Idea200402Config {
    private String name = "idea_200402";
 ...
 */
@Slf4j
public class Idea200402Service {
    private static final int IDEA_ID = 200402;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200402Service() {
        this(new Idea200402Config());
    }

    public Idea200402Service(Idea200402Config config) {
        this.config = config != null ? config : new Idea200402Config();
