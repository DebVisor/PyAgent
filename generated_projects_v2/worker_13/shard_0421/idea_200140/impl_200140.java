...
@Data
public class Idea200140Config {
    private String name = "idea_200140";
 ...
 */
@Slf4j
public class Idea200140Service {
    private static final int IDEA_ID = 200140;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200140Service() {
        this(new Idea200140Config());
    }

    public Idea200140Service(Idea200140Config config) {
        this.config = config != null ? config : new Idea200140Config();
