...
@Data
public class Idea199988Config {
    private String name = "idea_199988";
 ...
 */
@Slf4j
public class Idea199988Service {
    private static final int IDEA_ID = 199988;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199988Service() {
        this(new Idea199988Config());
    }

    public Idea199988Service(Idea199988Config config) {
        this.config = config != null ? config : new Idea199988Config();
