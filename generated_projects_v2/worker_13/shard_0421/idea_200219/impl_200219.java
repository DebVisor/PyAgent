...
@Data
public class Idea200219Config {
    private String name = "idea_200219";
 ...
 */
@Slf4j
public class Idea200219Service {
    private static final int IDEA_ID = 200219;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200219Service() {
        this(new Idea200219Config());
    }

    public Idea200219Service(Idea200219Config config) {
        this.config = config != null ? config : new Idea200219Config();
