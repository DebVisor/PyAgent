...
@Data
public class Idea200128Config {
    private String name = "idea_200128";
 ...
 */
@Slf4j
public class Idea200128Service {
    private static final int IDEA_ID = 200128;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200128Service() {
        this(new Idea200128Config());
    }

    public Idea200128Service(Idea200128Config config) {
        this.config = config != null ? config : new Idea200128Config();
