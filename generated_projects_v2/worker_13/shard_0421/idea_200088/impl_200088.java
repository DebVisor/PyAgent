...
@Data
public class Idea200088Config {
    private String name = "idea_200088";
 ...
 */
@Slf4j
public class Idea200088Service {
    private static final int IDEA_ID = 200088;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200088Service() {
        this(new Idea200088Config());
    }

    public Idea200088Service(Idea200088Config config) {
        this.config = config != null ? config : new Idea200088Config();
