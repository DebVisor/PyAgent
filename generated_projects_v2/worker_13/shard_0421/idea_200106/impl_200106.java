...
@Data
public class Idea200106Config {
    private String name = "idea_200106";
 ...
 */
@Slf4j
public class Idea200106Service {
    private static final int IDEA_ID = 200106;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200106Service() {
        this(new Idea200106Config());
    }

    public Idea200106Service(Idea200106Config config) {
        this.config = config != null ? config : new Idea200106Config();
