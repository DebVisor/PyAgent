...
@Data
public class Idea200147Config {
    private String name = "idea_200147";
 ...
 */
@Slf4j
public class Idea200147Service {
    private static final int IDEA_ID = 200147;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200147Service() {
        this(new Idea200147Config());
    }

    public Idea200147Service(Idea200147Config config) {
        this.config = config != null ? config : new Idea200147Config();
