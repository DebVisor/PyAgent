...
@Data
public class Idea200273Config {
    private String name = "idea_200273";
 ...
 */
@Slf4j
public class Idea200273Service {
    private static final int IDEA_ID = 200273;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200273Service() {
        this(new Idea200273Config());
    }

    public Idea200273Service(Idea200273Config config) {
        this.config = config != null ? config : new Idea200273Config();
