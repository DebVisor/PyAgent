...
@Data
public class Idea200331Config {
    private String name = "idea_200331";
 ...
 */
@Slf4j
public class Idea200331Service {
    private static final int IDEA_ID = 200331;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200331Service() {
        this(new Idea200331Config());
    }

    public Idea200331Service(Idea200331Config config) {
        this.config = config != null ? config : new Idea200331Config();
