...
@Data
public class Idea200285Config {
    private String name = "idea_200285";
 ...
 */
@Slf4j
public class Idea200285Service {
    private static final int IDEA_ID = 200285;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200285Service() {
        this(new Idea200285Config());
    }

    public Idea200285Service(Idea200285Config config) {
        this.config = config != null ? config : new Idea200285Config();
