...
@Data
public class Idea200327Config {
    private String name = "idea_200327";
 ...
 */
@Slf4j
public class Idea200327Service {
    private static final int IDEA_ID = 200327;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200327Service() {
        this(new Idea200327Config());
    }

    public Idea200327Service(Idea200327Config config) {
        this.config = config != null ? config : new Idea200327Config();
