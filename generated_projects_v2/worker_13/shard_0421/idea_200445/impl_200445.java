...
@Data
public class Idea200445Config {
    private String name = "idea_200445";
 ...
 */
@Slf4j
public class Idea200445Service {
    private static final int IDEA_ID = 200445;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200445Service() {
        this(new Idea200445Config());
    }

    public Idea200445Service(Idea200445Config config) {
        this.config = config != null ? config : new Idea200445Config();
