...
@Data
public class Idea200366Config {
    private String name = "idea_200366";
 ...
 */
@Slf4j
public class Idea200366Service {
    private static final int IDEA_ID = 200366;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200366Service() {
        this(new Idea200366Config());
    }

    public Idea200366Service(Idea200366Config config) {
        this.config = config != null ? config : new Idea200366Config();
