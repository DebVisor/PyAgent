...
@Data
public class Idea200084Config {
    private String name = "idea_200084";
 ...
 */
@Slf4j
public class Idea200084Service {
    private static final int IDEA_ID = 200084;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200084Service() {
        this(new Idea200084Config());
    }

    public Idea200084Service(Idea200084Config config) {
        this.config = config != null ? config : new Idea200084Config();
