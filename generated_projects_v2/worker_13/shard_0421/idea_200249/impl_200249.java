...
@Data
public class Idea200249Config {
    private String name = "idea_200249";
 ...
 */
@Slf4j
public class Idea200249Service {
    private static final int IDEA_ID = 200249;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200249Service() {
        this(new Idea200249Config());
    }

    public Idea200249Service(Idea200249Config config) {
        this.config = config != null ? config : new Idea200249Config();
