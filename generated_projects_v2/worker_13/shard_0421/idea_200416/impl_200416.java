...
@Data
public class Idea200416Config {
    private String name = "idea_200416";
 ...
 */
@Slf4j
public class Idea200416Service {
    private static final int IDEA_ID = 200416;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200416Service() {
        this(new Idea200416Config());
    }

    public Idea200416Service(Idea200416Config config) {
        this.config = config != null ? config : new Idea200416Config();
