...
@Data
public class Idea200149Config {
    private String name = "idea_200149";
 ...
 */
@Slf4j
public class Idea200149Service {
    private static final int IDEA_ID = 200149;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200149Service() {
        this(new Idea200149Config());
    }

    public Idea200149Service(Idea200149Config config) {
        this.config = config != null ? config : new Idea200149Config();
