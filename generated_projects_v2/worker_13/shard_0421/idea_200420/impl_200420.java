...
@Data
public class Idea200420Config {
    private String name = "idea_200420";
 ...
 */
@Slf4j
public class Idea200420Service {
    private static final int IDEA_ID = 200420;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200420Service() {
        this(new Idea200420Config());
    }

    public Idea200420Service(Idea200420Config config) {
        this.config = config != null ? config : new Idea200420Config();
