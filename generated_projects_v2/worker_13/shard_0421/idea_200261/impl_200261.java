...
@Data
public class Idea200261Config {
    private String name = "idea_200261";
 ...
 */
@Slf4j
public class Idea200261Service {
    private static final int IDEA_ID = 200261;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200261Service() {
        this(new Idea200261Config());
    }

    public Idea200261Service(Idea200261Config config) {
        this.config = config != null ? config : new Idea200261Config();
