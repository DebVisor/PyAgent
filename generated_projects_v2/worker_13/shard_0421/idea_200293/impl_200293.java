...
@Data
public class Idea200293Config {
    private String name = "idea_200293";
 ...
 */
@Slf4j
public class Idea200293Service {
    private static final int IDEA_ID = 200293;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200293Service() {
        this(new Idea200293Config());
    }

    public Idea200293Service(Idea200293Config config) {
        this.config = config != null ? config : new Idea200293Config();
