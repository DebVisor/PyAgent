...
@Data
public class Idea200163Config {
    private String name = "idea_200163";
 ...
 */
@Slf4j
public class Idea200163Service {
    private static final int IDEA_ID = 200163;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200163Service() {
        this(new Idea200163Config());
    }

    public Idea200163Service(Idea200163Config config) {
        this.config = config != null ? config : new Idea200163Config();
