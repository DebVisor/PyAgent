...
@Data
public class Idea200037Config {
    private String name = "idea_200037";
 ...
 */
@Slf4j
public class Idea200037Service {
    private static final int IDEA_ID = 200037;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200037Service() {
        this(new Idea200037Config());
    }

    public Idea200037Service(Idea200037Config config) {
        this.config = config != null ? config : new Idea200037Config();
