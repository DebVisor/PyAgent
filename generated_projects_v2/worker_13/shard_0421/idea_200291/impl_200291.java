...
@Data
public class Idea200291Config {
    private String name = "idea_200291";
 ...
 */
@Slf4j
public class Idea200291Service {
    private static final int IDEA_ID = 200291;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200291Service() {
        this(new Idea200291Config());
    }

    public Idea200291Service(Idea200291Config config) {
        this.config = config != null ? config : new Idea200291Config();
