...
@Data
public class Idea200255Config {
    private String name = "idea_200255";
 ...
 */
@Slf4j
public class Idea200255Service {
    private static final int IDEA_ID = 200255;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200255Service() {
        this(new Idea200255Config());
    }

    public Idea200255Service(Idea200255Config config) {
        this.config = config != null ? config : new Idea200255Config();
