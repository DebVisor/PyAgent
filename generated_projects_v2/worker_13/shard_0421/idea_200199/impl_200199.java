...
@Data
public class Idea200199Config {
    private String name = "idea_200199";
 ...
 */
@Slf4j
public class Idea200199Service {
    private static final int IDEA_ID = 200199;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200199Service() {
        this(new Idea200199Config());
    }

    public Idea200199Service(Idea200199Config config) {
        this.config = config != null ? config : new Idea200199Config();
