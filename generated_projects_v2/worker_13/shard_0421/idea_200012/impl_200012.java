...
@Data
public class Idea200012Config {
    private String name = "idea_200012";
 ...
 */
@Slf4j
public class Idea200012Service {
    private static final int IDEA_ID = 200012;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200012Service() {
        this(new Idea200012Config());
    }

    public Idea200012Service(Idea200012Config config) {
        this.config = config != null ? config : new Idea200012Config();
