...
@Data
public class Idea200284Config {
    private String name = "idea_200284";
 ...
 */
@Slf4j
public class Idea200284Service {
    private static final int IDEA_ID = 200284;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200284Service() {
        this(new Idea200284Config());
    }

    public Idea200284Service(Idea200284Config config) {
        this.config = config != null ? config : new Idea200284Config();
