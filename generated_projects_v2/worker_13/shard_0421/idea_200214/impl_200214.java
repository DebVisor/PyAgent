...
@Data
public class Idea200214Config {
    private String name = "idea_200214";
 ...
 */
@Slf4j
public class Idea200214Service {
    private static final int IDEA_ID = 200214;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200214Service() {
        this(new Idea200214Config());
    }

    public Idea200214Service(Idea200214Config config) {
        this.config = config != null ? config : new Idea200214Config();
