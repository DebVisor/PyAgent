...
@Data
public class Idea200185Config {
    private String name = "idea_200185";
 ...
 */
@Slf4j
public class Idea200185Service {
    private static final int IDEA_ID = 200185;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200185Service() {
        this(new Idea200185Config());
    }

    public Idea200185Service(Idea200185Config config) {
        this.config = config != null ? config : new Idea200185Config();
