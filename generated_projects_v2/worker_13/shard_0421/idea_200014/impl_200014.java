...
@Data
public class Idea200014Config {
    private String name = "idea_200014";
 ...
 */
@Slf4j
public class Idea200014Service {
    private static final int IDEA_ID = 200014;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200014Service() {
        this(new Idea200014Config());
    }

    public Idea200014Service(Idea200014Config config) {
        this.config = config != null ? config : new Idea200014Config();
