...
@Data
public class Idea200385Config {
    private String name = "idea_200385";
 ...
 */
@Slf4j
public class Idea200385Service {
    private static final int IDEA_ID = 200385;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200385Service() {
        this(new Idea200385Config());
    }

    public Idea200385Service(Idea200385Config config) {
        this.config = config != null ? config : new Idea200385Config();
