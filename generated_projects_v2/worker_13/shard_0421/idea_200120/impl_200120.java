...
@Data
public class Idea200120Config {
    private String name = "idea_200120";
 ...
 */
@Slf4j
public class Idea200120Service {
    private static final int IDEA_ID = 200120;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200120Service() {
        this(new Idea200120Config());
    }

    public Idea200120Service(Idea200120Config config) {
        this.config = config != null ? config : new Idea200120Config();
