...
@Data
public class Idea200309Config {
    private String name = "idea_200309";
 ...
 */
@Slf4j
public class Idea200309Service {
    private static final int IDEA_ID = 200309;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200309Service() {
        this(new Idea200309Config());
    }

    public Idea200309Service(Idea200309Config config) {
        this.config = config != null ? config : new Idea200309Config();
