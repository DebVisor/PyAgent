...
@Data
public class Idea200044Config {
    private String name = "idea_200044";
 ...
 */
@Slf4j
public class Idea200044Service {
    private static final int IDEA_ID = 200044;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200044Service() {
        this(new Idea200044Config());
    }

    public Idea200044Service(Idea200044Config config) {
        this.config = config != null ? config : new Idea200044Config();
