...
@Data
public class Idea200324Config {
    private String name = "idea_200324";
 ...
 */
@Slf4j
public class Idea200324Service {
    private static final int IDEA_ID = 200324;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200324Service() {
        this(new Idea200324Config());
    }

    public Idea200324Service(Idea200324Config config) {
        this.config = config != null ? config : new Idea200324Config();
