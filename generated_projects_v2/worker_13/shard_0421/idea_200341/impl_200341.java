...
@Data
public class Idea200341Config {
    private String name = "idea_200341";
 ...
 */
@Slf4j
public class Idea200341Service {
    private static final int IDEA_ID = 200341;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200341Service() {
        this(new Idea200341Config());
    }

    public Idea200341Service(Idea200341Config config) {
        this.config = config != null ? config : new Idea200341Config();
