...
@Data
public class Idea200208Config {
    private String name = "idea_200208";
 ...
 */
@Slf4j
public class Idea200208Service {
    private static final int IDEA_ID = 200208;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200208Service() {
        this(new Idea200208Config());
    }

    public Idea200208Service(Idea200208Config config) {
        this.config = config != null ? config : new Idea200208Config();
