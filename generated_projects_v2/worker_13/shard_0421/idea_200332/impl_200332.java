...
@Data
public class Idea200332Config {
    private String name = "idea_200332";
 ...
 */
@Slf4j
public class Idea200332Service {
    private static final int IDEA_ID = 200332;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200332Service() {
        this(new Idea200332Config());
    }

    public Idea200332Service(Idea200332Config config) {
        this.config = config != null ? config : new Idea200332Config();
