...
@Data
public class Idea200365Config {
    private String name = "idea_200365";
 ...
 */
@Slf4j
public class Idea200365Service {
    private static final int IDEA_ID = 200365;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200365Service() {
        this(new Idea200365Config());
    }

    public Idea200365Service(Idea200365Config config) {
        this.config = config != null ? config : new Idea200365Config();
