...
@Data
public class Idea200282Config {
    private String name = "idea_200282";
 ...
 */
@Slf4j
public class Idea200282Service {
    private static final int IDEA_ID = 200282;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200282Service() {
        this(new Idea200282Config());
    }

    public Idea200282Service(Idea200282Config config) {
        this.config = config != null ? config : new Idea200282Config();
