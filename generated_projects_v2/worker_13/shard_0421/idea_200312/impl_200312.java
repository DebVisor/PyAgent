...
@Data
public class Idea200312Config {
    private String name = "idea_200312";
 ...
 */
@Slf4j
public class Idea200312Service {
    private static final int IDEA_ID = 200312;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200312Service() {
        this(new Idea200312Config());
    }

    public Idea200312Service(Idea200312Config config) {
        this.config = config != null ? config : new Idea200312Config();
