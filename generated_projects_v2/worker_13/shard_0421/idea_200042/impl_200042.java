...
@Data
public class Idea200042Config {
    private String name = "idea_200042";
 ...
 */
@Slf4j
public class Idea200042Service {
    private static final int IDEA_ID = 200042;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200042Service() {
        this(new Idea200042Config());
    }

    public Idea200042Service(Idea200042Config config) {
        this.config = config != null ? config : new Idea200042Config();
