...
@Data
public class Idea200075Config {
    private String name = "idea_200075";
 ...
 */
@Slf4j
public class Idea200075Service {
    private static final int IDEA_ID = 200075;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200075Service() {
        this(new Idea200075Config());
    }

    public Idea200075Service(Idea200075Config config) {
        this.config = config != null ? config : new Idea200075Config();
