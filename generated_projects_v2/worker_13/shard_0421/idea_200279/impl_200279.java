...
@Data
public class Idea200279Config {
    private String name = "idea_200279";
 ...
 */
@Slf4j
public class Idea200279Service {
    private static final int IDEA_ID = 200279;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200279Service() {
        this(new Idea200279Config());
    }

    public Idea200279Service(Idea200279Config config) {
        this.config = config != null ? config : new Idea200279Config();
