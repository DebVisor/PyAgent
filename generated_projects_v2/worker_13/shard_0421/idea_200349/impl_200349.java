...
@Data
public class Idea200349Config {
    private String name = "idea_200349";
 ...
 */
@Slf4j
public class Idea200349Service {
    private static final int IDEA_ID = 200349;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200349Service() {
        this(new Idea200349Config());
    }

    public Idea200349Service(Idea200349Config config) {
        this.config = config != null ? config : new Idea200349Config();
