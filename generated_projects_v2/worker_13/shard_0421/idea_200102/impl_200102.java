...
@Data
public class Idea200102Config {
    private String name = "idea_200102";
 ...
 */
@Slf4j
public class Idea200102Service {
    private static final int IDEA_ID = 200102;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200102Service() {
        this(new Idea200102Config());
    }

    public Idea200102Service(Idea200102Config config) {
        this.config = config != null ? config : new Idea200102Config();
