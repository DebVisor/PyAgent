...
@Data
public class Idea200155Config {
    private String name = "idea_200155";
 ...
 */
@Slf4j
public class Idea200155Service {
    private static final int IDEA_ID = 200155;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200155Service() {
        this(new Idea200155Config());
    }

    public Idea200155Service(Idea200155Config config) {
        this.config = config != null ? config : new Idea200155Config();
