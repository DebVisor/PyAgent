...
@Data
public class Idea199976Config {
    private String name = "idea_199976";
 ...
 */
@Slf4j
public class Idea199976Service {
    private static final int IDEA_ID = 199976;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199976Service() {
        this(new Idea199976Config());
    }

    public Idea199976Service(Idea199976Config config) {
        this.config = config != null ? config : new Idea199976Config();
