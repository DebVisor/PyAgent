...
@Data
public class Idea200124Config {
    private String name = "idea_200124";
 ...
 */
@Slf4j
public class Idea200124Service {
    private static final int IDEA_ID = 200124;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200124Service() {
        this(new Idea200124Config());
    }

    public Idea200124Service(Idea200124Config config) {
        this.config = config != null ? config : new Idea200124Config();
