...
@Data
public class Idea200006Config {
    private String name = "idea_200006";
 ...
 */
@Slf4j
public class Idea200006Service {
    private static final int IDEA_ID = 200006;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200006Service() {
        this(new Idea200006Config());
    }

    public Idea200006Service(Idea200006Config config) {
        this.config = config != null ? config : new Idea200006Config();
