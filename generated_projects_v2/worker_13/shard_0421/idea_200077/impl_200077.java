...
@Data
public class Idea200077Config {
    private String name = "idea_200077";
 ...
 */
@Slf4j
public class Idea200077Service {
    private static final int IDEA_ID = 200077;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200077Service() {
        this(new Idea200077Config());
    }

    public Idea200077Service(Idea200077Config config) {
        this.config = config != null ? config : new Idea200077Config();
