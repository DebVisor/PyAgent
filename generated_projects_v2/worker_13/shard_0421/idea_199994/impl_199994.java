...
@Data
public class Idea199994Config {
    private String name = "idea_199994";
 ...
 */
@Slf4j
public class Idea199994Service {
    private static final int IDEA_ID = 199994;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199994Service() {
        this(new Idea199994Config());
    }

    public Idea199994Service(Idea199994Config config) {
        this.config = config != null ? config : new Idea199994Config();
