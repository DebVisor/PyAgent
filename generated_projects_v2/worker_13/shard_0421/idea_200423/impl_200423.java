...
@Data
public class Idea200423Config {
    private String name = "idea_200423";
 ...
 */
@Slf4j
public class Idea200423Service {
    private static final int IDEA_ID = 200423;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200423Service() {
        this(new Idea200423Config());
    }

    public Idea200423Service(Idea200423Config config) {
        this.config = config != null ? config : new Idea200423Config();
