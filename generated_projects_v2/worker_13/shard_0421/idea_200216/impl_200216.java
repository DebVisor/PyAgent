...
@Data
public class Idea200216Config {
    private String name = "idea_200216";
 ...
 */
@Slf4j
public class Idea200216Service {
    private static final int IDEA_ID = 200216;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200216Service() {
        this(new Idea200216Config());
    }

    public Idea200216Service(Idea200216Config config) {
        this.config = config != null ? config : new Idea200216Config();
