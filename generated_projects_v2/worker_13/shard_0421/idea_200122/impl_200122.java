...
@Data
public class Idea200122Config {
    private String name = "idea_200122";
 ...
 */
@Slf4j
public class Idea200122Service {
    private static final int IDEA_ID = 200122;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200122Service() {
        this(new Idea200122Config());
    }

    public Idea200122Service(Idea200122Config config) {
        this.config = config != null ? config : new Idea200122Config();
