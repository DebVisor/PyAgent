...
@Data
public class Idea200150Config {
    private String name = "idea_200150";
 ...
 */
@Slf4j
public class Idea200150Service {
    private static final int IDEA_ID = 200150;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200150Service() {
        this(new Idea200150Config());
    }

    public Idea200150Service(Idea200150Config config) {
        this.config = config != null ? config : new Idea200150Config();
