...
@Data
public class Idea200001Config {
    private String name = "idea_200001";
 ...
 */
@Slf4j
public class Idea200001Service {
    private static final int IDEA_ID = 200001;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200001Service() {
        this(new Idea200001Config());
    }

    public Idea200001Service(Idea200001Config config) {
        this.config = config != null ? config : new Idea200001Config();
