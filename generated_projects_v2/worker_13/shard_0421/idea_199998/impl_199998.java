...
@Data
public class Idea199998Config {
    private String name = "idea_199998";
 ...
 */
@Slf4j
public class Idea199998Service {
    private static final int IDEA_ID = 199998;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199998Service() {
        this(new Idea199998Config());
    }

    public Idea199998Service(Idea199998Config config) {
        this.config = config != null ? config : new Idea199998Config();
