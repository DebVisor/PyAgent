...
@Data
public class Idea200188Config {
    private String name = "idea_200188";
 ...
 */
@Slf4j
public class Idea200188Service {
    private static final int IDEA_ID = 200188;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200188Service() {
        this(new Idea200188Config());
    }

    public Idea200188Service(Idea200188Config config) {
        this.config = config != null ? config : new Idea200188Config();
