...
@Data
public class Idea200351Config {
    private String name = "idea_200351";
 ...
 */
@Slf4j
public class Idea200351Service {
    private static final int IDEA_ID = 200351;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200351Service() {
        this(new Idea200351Config());
    }

    public Idea200351Service(Idea200351Config config) {
        this.config = config != null ? config : new Idea200351Config();
