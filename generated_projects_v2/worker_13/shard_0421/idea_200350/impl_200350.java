...
@Data
public class Idea200350Config {
    private String name = "idea_200350";
 ...
 */
@Slf4j
public class Idea200350Service {
    private static final int IDEA_ID = 200350;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200350Service() {
        this(new Idea200350Config());
    }

    public Idea200350Service(Idea200350Config config) {
        this.config = config != null ? config : new Idea200350Config();
