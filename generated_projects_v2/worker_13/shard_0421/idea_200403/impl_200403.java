...
@Data
public class Idea200403Config {
    private String name = "idea_200403";
 ...
 */
@Slf4j
public class Idea200403Service {
    private static final int IDEA_ID = 200403;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200403Service() {
        this(new Idea200403Config());
    }

    public Idea200403Service(Idea200403Config config) {
        this.config = config != null ? config : new Idea200403Config();
