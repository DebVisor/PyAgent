...
@Data
public class Idea200358Config {
    private String name = "idea_200358";
 ...
 */
@Slf4j
public class Idea200358Service {
    private static final int IDEA_ID = 200358;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200358Service() {
        this(new Idea200358Config());
    }

    public Idea200358Service(Idea200358Config config) {
        this.config = config != null ? config : new Idea200358Config();
