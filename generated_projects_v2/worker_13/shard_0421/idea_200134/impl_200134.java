...
@Data
public class Idea200134Config {
    private String name = "idea_200134";
 ...
 */
@Slf4j
public class Idea200134Service {
    private static final int IDEA_ID = 200134;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200134Service() {
        this(new Idea200134Config());
    }

    public Idea200134Service(Idea200134Config config) {
        this.config = config != null ? config : new Idea200134Config();
