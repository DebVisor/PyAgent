...
@Data
public class Idea200187Config {
    private String name = "idea_200187";
 ...
 */
@Slf4j
public class Idea200187Service {
    private static final int IDEA_ID = 200187;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200187Service() {
        this(new Idea200187Config());
    }

    public Idea200187Service(Idea200187Config config) {
        this.config = config != null ? config : new Idea200187Config();
