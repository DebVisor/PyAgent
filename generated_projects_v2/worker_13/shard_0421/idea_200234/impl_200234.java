...
@Data
public class Idea200234Config {
    private String name = "idea_200234";
 ...
 */
@Slf4j
public class Idea200234Service {
    private static final int IDEA_ID = 200234;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200234Service() {
        this(new Idea200234Config());
    }

    public Idea200234Service(Idea200234Config config) {
        this.config = config != null ? config : new Idea200234Config();
