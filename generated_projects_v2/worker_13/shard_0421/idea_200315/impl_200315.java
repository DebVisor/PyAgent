...
@Data
public class Idea200315Config {
    private String name = "idea_200315";
 ...
 */
@Slf4j
public class Idea200315Service {
    private static final int IDEA_ID = 200315;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200315Service() {
        this(new Idea200315Config());
    }

    public Idea200315Service(Idea200315Config config) {
        this.config = config != null ? config : new Idea200315Config();
