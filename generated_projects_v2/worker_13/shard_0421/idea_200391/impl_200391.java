...
@Data
public class Idea200391Config {
    private String name = "idea_200391";
 ...
 */
@Slf4j
public class Idea200391Service {
    private static final int IDEA_ID = 200391;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200391Service() {
        this(new Idea200391Config());
    }

    public Idea200391Service(Idea200391Config config) {
        this.config = config != null ? config : new Idea200391Config();
