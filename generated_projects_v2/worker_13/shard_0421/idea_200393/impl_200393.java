...
@Data
public class Idea200393Config {
    private String name = "idea_200393";
 ...
 */
@Slf4j
public class Idea200393Service {
    private static final int IDEA_ID = 200393;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200393Service() {
        this(new Idea200393Config());
    }

    public Idea200393Service(Idea200393Config config) {
        this.config = config != null ? config : new Idea200393Config();
