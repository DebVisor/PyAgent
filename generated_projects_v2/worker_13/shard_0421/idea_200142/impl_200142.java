...
@Data
public class Idea200142Config {
    private String name = "idea_200142";
 ...
 */
@Slf4j
public class Idea200142Service {
    private static final int IDEA_ID = 200142;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200142Service() {
        this(new Idea200142Config());
    }

    public Idea200142Service(Idea200142Config config) {
        this.config = config != null ? config : new Idea200142Config();
