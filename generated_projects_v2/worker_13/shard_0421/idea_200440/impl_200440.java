...
@Data
public class Idea200440Config {
    private String name = "idea_200440";
 ...
 */
@Slf4j
public class Idea200440Service {
    private static final int IDEA_ID = 200440;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200440Service() {
        this(new Idea200440Config());
    }

    public Idea200440Service(Idea200440Config config) {
        this.config = config != null ? config : new Idea200440Config();
