...
@Data
public class Idea200011Config {
    private String name = "idea_200011";
 ...
 */
@Slf4j
public class Idea200011Service {
    private static final int IDEA_ID = 200011;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200011Service() {
        this(new Idea200011Config());
    }

    public Idea200011Service(Idea200011Config config) {
        this.config = config != null ? config : new Idea200011Config();
