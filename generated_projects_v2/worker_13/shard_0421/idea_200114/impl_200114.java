...
@Data
public class Idea200114Config {
    private String name = "idea_200114";
 ...
 */
@Slf4j
public class Idea200114Service {
    private static final int IDEA_ID = 200114;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200114Service() {
        this(new Idea200114Config());
    }

    public Idea200114Service(Idea200114Config config) {
        this.config = config != null ? config : new Idea200114Config();
