...
@Data
public class Idea200304Config {
    private String name = "idea_200304";
 ...
 */
@Slf4j
public class Idea200304Service {
    private static final int IDEA_ID = 200304;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200304Service() {
        this(new Idea200304Config());
    }

    public Idea200304Service(Idea200304Config config) {
        this.config = config != null ? config : new Idea200304Config();
