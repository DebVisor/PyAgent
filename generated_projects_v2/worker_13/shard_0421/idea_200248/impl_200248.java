...
@Data
public class Idea200248Config {
    private String name = "idea_200248";
 ...
 */
@Slf4j
public class Idea200248Service {
    private static final int IDEA_ID = 200248;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200248Service() {
        this(new Idea200248Config());
    }

    public Idea200248Service(Idea200248Config config) {
        this.config = config != null ? config : new Idea200248Config();
