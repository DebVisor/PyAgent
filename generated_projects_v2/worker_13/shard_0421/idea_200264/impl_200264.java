...
@Data
public class Idea200264Config {
    private String name = "idea_200264";
 ...
 */
@Slf4j
public class Idea200264Service {
    private static final int IDEA_ID = 200264;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200264Service() {
        this(new Idea200264Config());
    }

    public Idea200264Service(Idea200264Config config) {
        this.config = config != null ? config : new Idea200264Config();
