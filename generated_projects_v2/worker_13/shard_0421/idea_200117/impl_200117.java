...
@Data
public class Idea200117Config {
    private String name = "idea_200117";
 ...
 */
@Slf4j
public class Idea200117Service {
    private static final int IDEA_ID = 200117;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200117Service() {
        this(new Idea200117Config());
    }

    public Idea200117Service(Idea200117Config config) {
        this.config = config != null ? config : new Idea200117Config();
