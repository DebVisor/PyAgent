...
@Data
public class Idea200072Config {
    private String name = "idea_200072";
 ...
 */
@Slf4j
public class Idea200072Service {
    private static final int IDEA_ID = 200072;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200072Service() {
        this(new Idea200072Config());
    }

    public Idea200072Service(Idea200072Config config) {
        this.config = config != null ? config : new Idea200072Config();
