...
@Data
public class Idea200089Config {
    private String name = "idea_200089";
 ...
 */
@Slf4j
public class Idea200089Service {
    private static final int IDEA_ID = 200089;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200089Service() {
        this(new Idea200089Config());
    }

    public Idea200089Service(Idea200089Config config) {
        this.config = config != null ? config : new Idea200089Config();
