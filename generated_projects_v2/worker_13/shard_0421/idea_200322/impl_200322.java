...
@Data
public class Idea200322Config {
    private String name = "idea_200322";
 ...
 */
@Slf4j
public class Idea200322Service {
    private static final int IDEA_ID = 200322;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200322Service() {
        this(new Idea200322Config());
    }

    public Idea200322Service(Idea200322Config config) {
        this.config = config != null ? config : new Idea200322Config();
