...
@Data
public class Idea200226Config {
    private String name = "idea_200226";
 ...
 */
@Slf4j
public class Idea200226Service {
    private static final int IDEA_ID = 200226;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200226Service() {
        this(new Idea200226Config());
    }

    public Idea200226Service(Idea200226Config config) {
        this.config = config != null ? config : new Idea200226Config();
