...
@Data
public class Idea200112Config {
    private String name = "idea_200112";
 ...
 */
@Slf4j
public class Idea200112Service {
    private static final int IDEA_ID = 200112;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200112Service() {
        this(new Idea200112Config());
    }

    public Idea200112Service(Idea200112Config config) {
        this.config = config != null ? config : new Idea200112Config();
