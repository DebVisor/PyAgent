...
@Data
public class Idea200221Config {
    private String name = "idea_200221";
 ...
 */
@Slf4j
public class Idea200221Service {
    private static final int IDEA_ID = 200221;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200221Service() {
        this(new Idea200221Config());
    }

    public Idea200221Service(Idea200221Config config) {
        this.config = config != null ? config : new Idea200221Config();
