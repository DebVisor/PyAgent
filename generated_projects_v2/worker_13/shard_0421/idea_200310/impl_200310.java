...
@Data
public class Idea200310Config {
    private String name = "idea_200310";
 ...
 */
@Slf4j
public class Idea200310Service {
    private static final int IDEA_ID = 200310;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200310Service() {
        this(new Idea200310Config());
    }

    public Idea200310Service(Idea200310Config config) {
        this.config = config != null ? config : new Idea200310Config();
