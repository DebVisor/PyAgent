...
@Data
public class Idea200278Config {
    private String name = "idea_200278";
 ...
 */
@Slf4j
public class Idea200278Service {
    private static final int IDEA_ID = 200278;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200278Service() {
        this(new Idea200278Config());
    }

    public Idea200278Service(Idea200278Config config) {
        this.config = config != null ? config : new Idea200278Config();
