...
@Data
public class Idea200317Config {
    private String name = "idea_200317";
 ...
 */
@Slf4j
public class Idea200317Service {
    private static final int IDEA_ID = 200317;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200317Service() {
        this(new Idea200317Config());
    }

    public Idea200317Service(Idea200317Config config) {
        this.config = config != null ? config : new Idea200317Config();
