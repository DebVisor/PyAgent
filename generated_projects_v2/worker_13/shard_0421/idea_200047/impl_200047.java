...
@Data
public class Idea200047Config {
    private String name = "idea_200047";
 ...
 */
@Slf4j
public class Idea200047Service {
    private static final int IDEA_ID = 200047;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200047Service() {
        this(new Idea200047Config());
    }

    public Idea200047Service(Idea200047Config config) {
        this.config = config != null ? config : new Idea200047Config();
