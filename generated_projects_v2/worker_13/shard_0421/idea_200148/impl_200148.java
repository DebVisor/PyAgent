...
@Data
public class Idea200148Config {
    private String name = "idea_200148";
 ...
 */
@Slf4j
public class Idea200148Service {
    private static final int IDEA_ID = 200148;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200148Service() {
        this(new Idea200148Config());
    }

    public Idea200148Service(Idea200148Config config) {
        this.config = config != null ? config : new Idea200148Config();
