...
@Data
public class Idea200328Config {
    private String name = "idea_200328";
 ...
 */
@Slf4j
public class Idea200328Service {
    private static final int IDEA_ID = 200328;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200328Service() {
        this(new Idea200328Config());
    }

    public Idea200328Service(Idea200328Config config) {
        this.config = config != null ? config : new Idea200328Config();
