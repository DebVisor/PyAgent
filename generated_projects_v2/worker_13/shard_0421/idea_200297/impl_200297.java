...
@Data
public class Idea200297Config {
    private String name = "idea_200297";
 ...
 */
@Slf4j
public class Idea200297Service {
    private static final int IDEA_ID = 200297;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200297Service() {
        this(new Idea200297Config());
    }

    public Idea200297Service(Idea200297Config config) {
        this.config = config != null ? config : new Idea200297Config();
