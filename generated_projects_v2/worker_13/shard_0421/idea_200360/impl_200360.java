...
@Data
public class Idea200360Config {
    private String name = "idea_200360";
 ...
 */
@Slf4j
public class Idea200360Service {
    private static final int IDEA_ID = 200360;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea200360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea200360Service() {
        this(new Idea200360Config());
    }

    public Idea200360Service(Idea200360Config config) {
        this.config = config != null ? config : new Idea200360Config();
