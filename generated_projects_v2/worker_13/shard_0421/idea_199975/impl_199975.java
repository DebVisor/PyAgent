...
@Data
public class Idea199975Config {
    private String name = "idea_199975";
 ...
 */
@Slf4j
public class Idea199975Service {
    private static final int IDEA_ID = 199975;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199975Service() {
        this(new Idea199975Config());
    }

    public Idea199975Service(Idea199975Config config) {
        this.config = config != null ? config : new Idea199975Config();
