...
@Data
public class Idea199022Config {
    private String name = "idea_199022";
 ...
 */
@Slf4j
public class Idea199022Service {
    private static final int IDEA_ID = 199022;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199022Service() {
        this(new Idea199022Config());
    }

    public Idea199022Service(Idea199022Config config) {
        this.config = config != null ? config : new Idea199022Config();
