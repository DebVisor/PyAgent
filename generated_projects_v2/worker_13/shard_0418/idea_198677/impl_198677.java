...
@Data
public class Idea198677Config {
    private String name = "idea_198677";
 ...
 */
@Slf4j
public class Idea198677Service {
    private static final int IDEA_ID = 198677;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198677Service() {
        this(new Idea198677Config());
    }

    public Idea198677Service(Idea198677Config config) {
        this.config = config != null ? config : new Idea198677Config();
