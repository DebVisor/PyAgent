...
@Data
public class Idea198914Config {
    private String name = "idea_198914";
 ...
 */
@Slf4j
public class Idea198914Service {
    private static final int IDEA_ID = 198914;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198914Service() {
        this(new Idea198914Config());
    }

    public Idea198914Service(Idea198914Config config) {
        this.config = config != null ? config : new Idea198914Config();
