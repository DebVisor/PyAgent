...
@Data
public class Idea198786Config {
    private String name = "idea_198786";
 ...
 */
@Slf4j
public class Idea198786Service {
    private static final int IDEA_ID = 198786;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198786Service() {
        this(new Idea198786Config());
    }

    public Idea198786Service(Idea198786Config config) {
        this.config = config != null ? config : new Idea198786Config();
