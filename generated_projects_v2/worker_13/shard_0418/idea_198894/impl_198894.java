...
@Data
public class Idea198894Config {
    private String name = "idea_198894";
 ...
 */
@Slf4j
public class Idea198894Service {
    private static final int IDEA_ID = 198894;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198894Service() {
        this(new Idea198894Config());
    }

    public Idea198894Service(Idea198894Config config) {
        this.config = config != null ? config : new Idea198894Config();
