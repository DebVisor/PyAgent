...
@Data
public class Idea198754Config {
    private String name = "idea_198754";
 ...
 */
@Slf4j
public class Idea198754Service {
    private static final int IDEA_ID = 198754;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198754Service() {
        this(new Idea198754Config());
    }

    public Idea198754Service(Idea198754Config config) {
        this.config = config != null ? config : new Idea198754Config();
