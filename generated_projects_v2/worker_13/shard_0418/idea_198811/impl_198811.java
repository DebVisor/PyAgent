...
@Data
public class Idea198811Config {
    private String name = "idea_198811";
 ...
 */
@Slf4j
public class Idea198811Service {
    private static final int IDEA_ID = 198811;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198811Service() {
        this(new Idea198811Config());
    }

    public Idea198811Service(Idea198811Config config) {
        this.config = config != null ? config : new Idea198811Config();
