...
@Data
public class Idea198622Config {
    private String name = "idea_198622";
 ...
 */
@Slf4j
public class Idea198622Service {
    private static final int IDEA_ID = 198622;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198622Service() {
        this(new Idea198622Config());
    }

    public Idea198622Service(Idea198622Config config) {
        this.config = config != null ? config : new Idea198622Config();
