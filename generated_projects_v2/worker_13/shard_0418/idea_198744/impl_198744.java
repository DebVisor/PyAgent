...
@Data
public class Idea198744Config {
    private String name = "idea_198744";
 ...
 */
@Slf4j
public class Idea198744Service {
    private static final int IDEA_ID = 198744;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198744Service() {
        this(new Idea198744Config());
    }

    public Idea198744Service(Idea198744Config config) {
        this.config = config != null ? config : new Idea198744Config();
