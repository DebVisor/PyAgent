...
@Data
public class Idea198960Config {
    private String name = "idea_198960";
 ...
 */
@Slf4j
public class Idea198960Service {
    private static final int IDEA_ID = 198960;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198960Service() {
        this(new Idea198960Config());
    }

    public Idea198960Service(Idea198960Config config) {
        this.config = config != null ? config : new Idea198960Config();
