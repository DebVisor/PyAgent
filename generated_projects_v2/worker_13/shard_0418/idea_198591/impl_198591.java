...
@Data
public class Idea198591Config {
    private String name = "idea_198591";
 ...
 */
@Slf4j
public class Idea198591Service {
    private static final int IDEA_ID = 198591;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198591Service() {
        this(new Idea198591Config());
    }

    public Idea198591Service(Idea198591Config config) {
        this.config = config != null ? config : new Idea198591Config();
