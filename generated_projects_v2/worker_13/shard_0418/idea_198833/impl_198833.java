...
@Data
public class Idea198833Config {
    private String name = "idea_198833";
 ...
 */
@Slf4j
public class Idea198833Service {
    private static final int IDEA_ID = 198833;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198833Service() {
        this(new Idea198833Config());
    }

    public Idea198833Service(Idea198833Config config) {
        this.config = config != null ? config : new Idea198833Config();
