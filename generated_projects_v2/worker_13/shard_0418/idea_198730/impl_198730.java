...
@Data
public class Idea198730Config {
    private String name = "idea_198730";
 ...
 */
@Slf4j
public class Idea198730Service {
    private static final int IDEA_ID = 198730;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198730Service() {
        this(new Idea198730Config());
    }

    public Idea198730Service(Idea198730Config config) {
        this.config = config != null ? config : new Idea198730Config();
