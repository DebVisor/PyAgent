...
@Data
public class Idea198609Config {
    private String name = "idea_198609";
 ...
 */
@Slf4j
public class Idea198609Service {
    private static final int IDEA_ID = 198609;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198609Service() {
        this(new Idea198609Config());
    }

    public Idea198609Service(Idea198609Config config) {
        this.config = config != null ? config : new Idea198609Config();
