...
@Data
public class Idea198855Config {
    private String name = "idea_198855";
 ...
 */
@Slf4j
public class Idea198855Service {
    private static final int IDEA_ID = 198855;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198855Service() {
        this(new Idea198855Config());
    }

    public Idea198855Service(Idea198855Config config) {
        this.config = config != null ? config : new Idea198855Config();
