...
@Data
public class Idea198693Config {
    private String name = "idea_198693";
 ...
 */
@Slf4j
public class Idea198693Service {
    private static final int IDEA_ID = 198693;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198693Service() {
        this(new Idea198693Config());
    }

    public Idea198693Service(Idea198693Config config) {
        this.config = config != null ? config : new Idea198693Config();
