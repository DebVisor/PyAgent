...
@Data
public class Idea198953Config {
    private String name = "idea_198953";
 ...
 */
@Slf4j
public class Idea198953Service {
    private static final int IDEA_ID = 198953;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198953Service() {
        this(new Idea198953Config());
    }

    public Idea198953Service(Idea198953Config config) {
        this.config = config != null ? config : new Idea198953Config();
