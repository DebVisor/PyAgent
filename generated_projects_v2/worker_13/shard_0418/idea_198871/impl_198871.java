...
@Data
public class Idea198871Config {
    private String name = "idea_198871";
 ...
 */
@Slf4j
public class Idea198871Service {
    private static final int IDEA_ID = 198871;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198871Service() {
        this(new Idea198871Config());
    }

    public Idea198871Service(Idea198871Config config) {
        this.config = config != null ? config : new Idea198871Config();
