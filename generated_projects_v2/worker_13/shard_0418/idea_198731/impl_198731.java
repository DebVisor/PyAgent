...
@Data
public class Idea198731Config {
    private String name = "idea_198731";
 ...
 */
@Slf4j
public class Idea198731Service {
    private static final int IDEA_ID = 198731;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198731Service() {
        this(new Idea198731Config());
    }

    public Idea198731Service(Idea198731Config config) {
        this.config = config != null ? config : new Idea198731Config();
