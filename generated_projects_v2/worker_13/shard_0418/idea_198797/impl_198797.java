...
@Data
public class Idea198797Config {
    private String name = "idea_198797";
 ...
 */
@Slf4j
public class Idea198797Service {
    private static final int IDEA_ID = 198797;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198797Service() {
        this(new Idea198797Config());
    }

    public Idea198797Service(Idea198797Config config) {
        this.config = config != null ? config : new Idea198797Config();
