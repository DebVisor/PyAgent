...
@Data
public class Idea198925Config {
    private String name = "idea_198925";
 ...
 */
@Slf4j
public class Idea198925Service {
    private static final int IDEA_ID = 198925;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198925Service() {
        this(new Idea198925Config());
    }

    public Idea198925Service(Idea198925Config config) {
        this.config = config != null ? config : new Idea198925Config();
