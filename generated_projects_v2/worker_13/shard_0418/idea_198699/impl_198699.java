...
@Data
public class Idea198699Config {
    private String name = "idea_198699";
 ...
 */
@Slf4j
public class Idea198699Service {
    private static final int IDEA_ID = 198699;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198699Service() {
        this(new Idea198699Config());
    }

    public Idea198699Service(Idea198699Config config) {
        this.config = config != null ? config : new Idea198699Config();
