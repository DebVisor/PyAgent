...
@Data
public class Idea198665Config {
    private String name = "idea_198665";
 ...
 */
@Slf4j
public class Idea198665Service {
    private static final int IDEA_ID = 198665;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198665Service() {
        this(new Idea198665Config());
    }

    public Idea198665Service(Idea198665Config config) {
        this.config = config != null ? config : new Idea198665Config();
