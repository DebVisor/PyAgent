...
@Data
public class Idea198955Config {
    private String name = "idea_198955";
 ...
 */
@Slf4j
public class Idea198955Service {
    private static final int IDEA_ID = 198955;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198955Service() {
        this(new Idea198955Config());
    }

    public Idea198955Service(Idea198955Config config) {
        this.config = config != null ? config : new Idea198955Config();
