...
@Data
public class Idea198832Config {
    private String name = "idea_198832";
 ...
 */
@Slf4j
public class Idea198832Service {
    private static final int IDEA_ID = 198832;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198832Service() {
        this(new Idea198832Config());
    }

    public Idea198832Service(Idea198832Config config) {
        this.config = config != null ? config : new Idea198832Config();
