...
@Data
public class Idea198830Config {
    private String name = "idea_198830";
 ...
 */
@Slf4j
public class Idea198830Service {
    private static final int IDEA_ID = 198830;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198830Service() {
        this(new Idea198830Config());
    }

    public Idea198830Service(Idea198830Config config) {
        this.config = config != null ? config : new Idea198830Config();
