...
@Data
public class Idea198907Config {
    private String name = "idea_198907";
 ...
 */
@Slf4j
public class Idea198907Service {
    private static final int IDEA_ID = 198907;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198907Service() {
        this(new Idea198907Config());
    }

    public Idea198907Service(Idea198907Config config) {
        this.config = config != null ? config : new Idea198907Config();
