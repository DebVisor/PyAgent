...
@Data
public class Idea198934Config {
    private String name = "idea_198934";
 ...
 */
@Slf4j
public class Idea198934Service {
    private static final int IDEA_ID = 198934;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198934Service() {
        this(new Idea198934Config());
    }

    public Idea198934Service(Idea198934Config config) {
        this.config = config != null ? config : new Idea198934Config();
