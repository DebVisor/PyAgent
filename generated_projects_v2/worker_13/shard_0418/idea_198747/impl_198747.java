...
@Data
public class Idea198747Config {
    private String name = "idea_198747";
 ...
 */
@Slf4j
public class Idea198747Service {
    private static final int IDEA_ID = 198747;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198747Service() {
        this(new Idea198747Config());
    }

    public Idea198747Service(Idea198747Config config) {
        this.config = config != null ? config : new Idea198747Config();
