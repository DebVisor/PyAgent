...
@Data
public class Idea198918Config {
    private String name = "idea_198918";
 ...
 */
@Slf4j
public class Idea198918Service {
    private static final int IDEA_ID = 198918;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198918Service() {
        this(new Idea198918Config());
    }

    public Idea198918Service(Idea198918Config config) {
        this.config = config != null ? config : new Idea198918Config();
