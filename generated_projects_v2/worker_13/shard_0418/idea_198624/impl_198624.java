...
@Data
public class Idea198624Config {
    private String name = "idea_198624";
 ...
 */
@Slf4j
public class Idea198624Service {
    private static final int IDEA_ID = 198624;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198624Service() {
        this(new Idea198624Config());
    }

    public Idea198624Service(Idea198624Config config) {
        this.config = config != null ? config : new Idea198624Config();
