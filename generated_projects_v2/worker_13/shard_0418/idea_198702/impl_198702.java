...
@Data
public class Idea198702Config {
    private String name = "idea_198702";
 ...
 */
@Slf4j
public class Idea198702Service {
    private static final int IDEA_ID = 198702;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198702Service() {
        this(new Idea198702Config());
    }

    public Idea198702Service(Idea198702Config config) {
        this.config = config != null ? config : new Idea198702Config();
