...
@Data
public class Idea198787Config {
    private String name = "idea_198787";
 ...
 */
@Slf4j
public class Idea198787Service {
    private static final int IDEA_ID = 198787;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198787Service() {
        this(new Idea198787Config());
    }

    public Idea198787Service(Idea198787Config config) {
        this.config = config != null ? config : new Idea198787Config();
