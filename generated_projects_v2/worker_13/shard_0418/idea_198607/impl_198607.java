...
@Data
public class Idea198607Config {
    private String name = "idea_198607";
 ...
 */
@Slf4j
public class Idea198607Service {
    private static final int IDEA_ID = 198607;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198607Service() {
        this(new Idea198607Config());
    }

    public Idea198607Service(Idea198607Config config) {
        this.config = config != null ? config : new Idea198607Config();
