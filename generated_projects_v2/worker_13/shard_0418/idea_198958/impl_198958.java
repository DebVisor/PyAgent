...
@Data
public class Idea198958Config {
    private String name = "idea_198958";
 ...
 */
@Slf4j
public class Idea198958Service {
    private static final int IDEA_ID = 198958;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198958Service() {
        this(new Idea198958Config());
    }

    public Idea198958Service(Idea198958Config config) {
        this.config = config != null ? config : new Idea198958Config();
