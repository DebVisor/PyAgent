...
@Data
public class Idea198986Config {
    private String name = "idea_198986";
 ...
 */
@Slf4j
public class Idea198986Service {
    private static final int IDEA_ID = 198986;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198986Service() {
        this(new Idea198986Config());
    }

    public Idea198986Service(Idea198986Config config) {
        this.config = config != null ? config : new Idea198986Config();
