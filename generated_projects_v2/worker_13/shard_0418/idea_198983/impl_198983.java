...
@Data
public class Idea198983Config {
    private String name = "idea_198983";
 ...
 */
@Slf4j
public class Idea198983Service {
    private static final int IDEA_ID = 198983;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198983Service() {
        this(new Idea198983Config());
    }

    public Idea198983Service(Idea198983Config config) {
        this.config = config != null ? config : new Idea198983Config();
