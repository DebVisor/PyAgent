...
@Data
public class Idea198570Config {
    private String name = "idea_198570";
 ...
 */
@Slf4j
public class Idea198570Service {
    private static final int IDEA_ID = 198570;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198570Service() {
        this(new Idea198570Config());
    }

    public Idea198570Service(Idea198570Config config) {
        this.config = config != null ? config : new Idea198570Config();
