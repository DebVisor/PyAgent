...
@Data
public class Idea198995Config {
    private String name = "idea_198995";
 ...
 */
@Slf4j
public class Idea198995Service {
    private static final int IDEA_ID = 198995;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198995Service() {
        this(new Idea198995Config());
    }

    public Idea198995Service(Idea198995Config config) {
        this.config = config != null ? config : new Idea198995Config();
