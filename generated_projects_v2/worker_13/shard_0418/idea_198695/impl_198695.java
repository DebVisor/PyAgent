...
@Data
public class Idea198695Config {
    private String name = "idea_198695";
 ...
 */
@Slf4j
public class Idea198695Service {
    private static final int IDEA_ID = 198695;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198695Service() {
        this(new Idea198695Config());
    }

    public Idea198695Service(Idea198695Config config) {
        this.config = config != null ? config : new Idea198695Config();
