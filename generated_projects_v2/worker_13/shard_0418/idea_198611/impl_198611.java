...
@Data
public class Idea198611Config {
    private String name = "idea_198611";
 ...
 */
@Slf4j
public class Idea198611Service {
    private static final int IDEA_ID = 198611;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198611Service() {
        this(new Idea198611Config());
    }

    public Idea198611Service(Idea198611Config config) {
        this.config = config != null ? config : new Idea198611Config();
