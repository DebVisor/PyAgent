...
@Data
public class Idea198568Config {
    private String name = "idea_198568";
 ...
 */
@Slf4j
public class Idea198568Service {
    private static final int IDEA_ID = 198568;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198568Service() {
        this(new Idea198568Config());
    }

    public Idea198568Service(Idea198568Config config) {
        this.config = config != null ? config : new Idea198568Config();
