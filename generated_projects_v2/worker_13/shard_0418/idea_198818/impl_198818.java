...
@Data
public class Idea198818Config {
    private String name = "idea_198818";
 ...
 */
@Slf4j
public class Idea198818Service {
    private static final int IDEA_ID = 198818;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198818Service() {
        this(new Idea198818Config());
    }

    public Idea198818Service(Idea198818Config config) {
        this.config = config != null ? config : new Idea198818Config();
