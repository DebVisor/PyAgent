...
@Data
public class Idea198553Config {
    private String name = "idea_198553";
 ...
 */
@Slf4j
public class Idea198553Service {
    private static final int IDEA_ID = 198553;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198553Service() {
        this(new Idea198553Config());
    }

    public Idea198553Service(Idea198553Config config) {
        this.config = config != null ? config : new Idea198553Config();
