...
@Data
public class Idea198703Config {
    private String name = "idea_198703";
 ...
 */
@Slf4j
public class Idea198703Service {
    private static final int IDEA_ID = 198703;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198703Service() {
        this(new Idea198703Config());
    }

    public Idea198703Service(Idea198703Config config) {
        this.config = config != null ? config : new Idea198703Config();
