...
@Data
public class Idea198848Config {
    private String name = "idea_198848";
 ...
 */
@Slf4j
public class Idea198848Service {
    private static final int IDEA_ID = 198848;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198848Service() {
        this(new Idea198848Config());
    }

    public Idea198848Service(Idea198848Config config) {
        this.config = config != null ? config : new Idea198848Config();
