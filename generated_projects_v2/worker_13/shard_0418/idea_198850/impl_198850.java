...
@Data
public class Idea198850Config {
    private String name = "idea_198850";
 ...
 */
@Slf4j
public class Idea198850Service {
    private static final int IDEA_ID = 198850;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198850Service() {
        this(new Idea198850Config());
    }

    public Idea198850Service(Idea198850Config config) {
        this.config = config != null ? config : new Idea198850Config();
