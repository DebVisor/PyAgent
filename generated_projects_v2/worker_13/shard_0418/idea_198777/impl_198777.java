...
@Data
public class Idea198777Config {
    private String name = "idea_198777";
 ...
 */
@Slf4j
public class Idea198777Service {
    private static final int IDEA_ID = 198777;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198777Service() {
        this(new Idea198777Config());
    }

    public Idea198777Service(Idea198777Config config) {
        this.config = config != null ? config : new Idea198777Config();
