...
@Data
public class Idea198908Config {
    private String name = "idea_198908";
 ...
 */
@Slf4j
public class Idea198908Service {
    private static final int IDEA_ID = 198908;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198908Service() {
        this(new Idea198908Config());
    }

    public Idea198908Service(Idea198908Config config) {
        this.config = config != null ? config : new Idea198908Config();
