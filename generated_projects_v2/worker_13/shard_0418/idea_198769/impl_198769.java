...
@Data
public class Idea198769Config {
    private String name = "idea_198769";
 ...
 */
@Slf4j
public class Idea198769Service {
    private static final int IDEA_ID = 198769;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198769Service() {
        this(new Idea198769Config());
    }

    public Idea198769Service(Idea198769Config config) {
        this.config = config != null ? config : new Idea198769Config();
