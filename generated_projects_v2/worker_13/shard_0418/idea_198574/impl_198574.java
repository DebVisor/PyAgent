...
@Data
public class Idea198574Config {
    private String name = "idea_198574";
 ...
 */
@Slf4j
public class Idea198574Service {
    private static final int IDEA_ID = 198574;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198574Service() {
        this(new Idea198574Config());
    }

    public Idea198574Service(Idea198574Config config) {
        this.config = config != null ? config : new Idea198574Config();
