...
@Data
public class Idea198948Config {
    private String name = "idea_198948";
 ...
 */
@Slf4j
public class Idea198948Service {
    private static final int IDEA_ID = 198948;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198948Service() {
        this(new Idea198948Config());
    }

    public Idea198948Service(Idea198948Config config) {
        this.config = config != null ? config : new Idea198948Config();
