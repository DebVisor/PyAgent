...
@Data
public class Idea198924Config {
    private String name = "idea_198924";
 ...
 */
@Slf4j
public class Idea198924Service {
    private static final int IDEA_ID = 198924;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198924Service() {
        this(new Idea198924Config());
    }

    public Idea198924Service(Idea198924Config config) {
        this.config = config != null ? config : new Idea198924Config();
