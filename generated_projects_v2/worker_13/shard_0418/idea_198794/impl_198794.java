...
@Data
public class Idea198794Config {
    private String name = "idea_198794";
 ...
 */
@Slf4j
public class Idea198794Service {
    private static final int IDEA_ID = 198794;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198794Service() {
        this(new Idea198794Config());
    }

    public Idea198794Service(Idea198794Config config) {
        this.config = config != null ? config : new Idea198794Config();
