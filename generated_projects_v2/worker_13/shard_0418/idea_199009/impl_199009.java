...
@Data
public class Idea199009Config {
    private String name = "idea_199009";
 ...
 */
@Slf4j
public class Idea199009Service {
    private static final int IDEA_ID = 199009;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199009Service() {
        this(new Idea199009Config());
    }

    public Idea199009Service(Idea199009Config config) {
        this.config = config != null ? config : new Idea199009Config();
