...
@Data
public class Idea198905Config {
    private String name = "idea_198905";
 ...
 */
@Slf4j
public class Idea198905Service {
    private static final int IDEA_ID = 198905;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198905Service() {
        this(new Idea198905Config());
    }

    public Idea198905Service(Idea198905Config config) {
        this.config = config != null ? config : new Idea198905Config();
