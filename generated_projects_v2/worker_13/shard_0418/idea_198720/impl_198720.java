...
@Data
public class Idea198720Config {
    private String name = "idea_198720";
 ...
 */
@Slf4j
public class Idea198720Service {
    private static final int IDEA_ID = 198720;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198720Service() {
        this(new Idea198720Config());
    }

    public Idea198720Service(Idea198720Config config) {
        this.config = config != null ? config : new Idea198720Config();
