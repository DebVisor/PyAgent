...
@Data
public class Idea198801Config {
    private String name = "idea_198801";
 ...
 */
@Slf4j
public class Idea198801Service {
    private static final int IDEA_ID = 198801;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198801Service() {
        this(new Idea198801Config());
    }

    public Idea198801Service(Idea198801Config config) {
        this.config = config != null ? config : new Idea198801Config();
