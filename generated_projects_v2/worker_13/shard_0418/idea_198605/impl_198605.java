...
@Data
public class Idea198605Config {
    private String name = "idea_198605";
 ...
 */
@Slf4j
public class Idea198605Service {
    private static final int IDEA_ID = 198605;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198605Service() {
        this(new Idea198605Config());
    }

    public Idea198605Service(Idea198605Config config) {
        this.config = config != null ? config : new Idea198605Config();
