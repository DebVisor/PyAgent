...
@Data
public class Idea198886Config {
    private String name = "idea_198886";
 ...
 */
@Slf4j
public class Idea198886Service {
    private static final int IDEA_ID = 198886;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198886Service() {
        this(new Idea198886Config());
    }

    public Idea198886Service(Idea198886Config config) {
        this.config = config != null ? config : new Idea198886Config();
