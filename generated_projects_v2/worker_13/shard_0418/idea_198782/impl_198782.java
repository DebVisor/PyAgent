...
@Data
public class Idea198782Config {
    private String name = "idea_198782";
 ...
 */
@Slf4j
public class Idea198782Service {
    private static final int IDEA_ID = 198782;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198782Service() {
        this(new Idea198782Config());
    }

    public Idea198782Service(Idea198782Config config) {
        this.config = config != null ? config : new Idea198782Config();
