...
@Data
public class Idea198679Config {
    private String name = "idea_198679";
 ...
 */
@Slf4j
public class Idea198679Service {
    private static final int IDEA_ID = 198679;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198679Service() {
        this(new Idea198679Config());
    }

    public Idea198679Service(Idea198679Config config) {
        this.config = config != null ? config : new Idea198679Config();
