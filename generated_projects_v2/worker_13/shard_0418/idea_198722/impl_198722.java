...
@Data
public class Idea198722Config {
    private String name = "idea_198722";
 ...
 */
@Slf4j
public class Idea198722Service {
    private static final int IDEA_ID = 198722;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198722Service() {
        this(new Idea198722Config());
    }

    public Idea198722Service(Idea198722Config config) {
        this.config = config != null ? config : new Idea198722Config();
