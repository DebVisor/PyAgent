...
@Data
public class Idea198727Config {
    private String name = "idea_198727";
 ...
 */
@Slf4j
public class Idea198727Service {
    private static final int IDEA_ID = 198727;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198727Service() {
        this(new Idea198727Config());
    }

    public Idea198727Service(Idea198727Config config) {
        this.config = config != null ? config : new Idea198727Config();
