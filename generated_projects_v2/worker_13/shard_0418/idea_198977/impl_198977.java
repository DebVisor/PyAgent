...
@Data
public class Idea198977Config {
    private String name = "idea_198977";
 ...
 */
@Slf4j
public class Idea198977Service {
    private static final int IDEA_ID = 198977;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198977Service() {
        this(new Idea198977Config());
    }

    public Idea198977Service(Idea198977Config config) {
        this.config = config != null ? config : new Idea198977Config();
