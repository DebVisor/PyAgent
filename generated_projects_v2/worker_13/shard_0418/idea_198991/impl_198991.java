...
@Data
public class Idea198991Config {
    private String name = "idea_198991";
 ...
 */
@Slf4j
public class Idea198991Service {
    private static final int IDEA_ID = 198991;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198991Service() {
        this(new Idea198991Config());
    }

    public Idea198991Service(Idea198991Config config) {
        this.config = config != null ? config : new Idea198991Config();
