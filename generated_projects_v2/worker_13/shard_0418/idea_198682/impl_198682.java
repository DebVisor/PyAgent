...
@Data
public class Idea198682Config {
    private String name = "idea_198682";
 ...
 */
@Slf4j
public class Idea198682Service {
    private static final int IDEA_ID = 198682;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198682Service() {
        this(new Idea198682Config());
    }

    public Idea198682Service(Idea198682Config config) {
        this.config = config != null ? config : new Idea198682Config();
