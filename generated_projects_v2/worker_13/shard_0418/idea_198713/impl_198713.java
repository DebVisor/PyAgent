...
@Data
public class Idea198713Config {
    private String name = "idea_198713";
 ...
 */
@Slf4j
public class Idea198713Service {
    private static final int IDEA_ID = 198713;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198713Service() {
        this(new Idea198713Config());
    }

    public Idea198713Service(Idea198713Config config) {
        this.config = config != null ? config : new Idea198713Config();
