...
@Data
public class Idea198629Config {
    private String name = "idea_198629";
 ...
 */
@Slf4j
public class Idea198629Service {
    private static final int IDEA_ID = 198629;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198629Service() {
        this(new Idea198629Config());
    }

    public Idea198629Service(Idea198629Config config) {
        this.config = config != null ? config : new Idea198629Config();
