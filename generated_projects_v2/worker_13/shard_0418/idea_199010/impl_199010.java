...
@Data
public class Idea199010Config {
    private String name = "idea_199010";
 ...
 */
@Slf4j
public class Idea199010Service {
    private static final int IDEA_ID = 199010;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199010Service() {
        this(new Idea199010Config());
    }

    public Idea199010Service(Idea199010Config config) {
        this.config = config != null ? config : new Idea199010Config();
