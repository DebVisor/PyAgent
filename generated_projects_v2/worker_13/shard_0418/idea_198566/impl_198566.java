...
@Data
public class Idea198566Config {
    private String name = "idea_198566";
 ...
 */
@Slf4j
public class Idea198566Service {
    private static final int IDEA_ID = 198566;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198566Service() {
        this(new Idea198566Config());
    }

    public Idea198566Service(Idea198566Config config) {
        this.config = config != null ? config : new Idea198566Config();
