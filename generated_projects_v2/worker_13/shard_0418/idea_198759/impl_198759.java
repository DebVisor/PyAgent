...
@Data
public class Idea198759Config {
    private String name = "idea_198759";
 ...
 */
@Slf4j
public class Idea198759Service {
    private static final int IDEA_ID = 198759;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198759Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198759Service() {
        this(new Idea198759Config());
    }

    public Idea198759Service(Idea198759Config config) {
        this.config = config != null ? config : new Idea198759Config();
