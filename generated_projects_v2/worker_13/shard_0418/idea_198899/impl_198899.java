...
@Data
public class Idea198899Config {
    private String name = "idea_198899";
 ...
 */
@Slf4j
public class Idea198899Service {
    private static final int IDEA_ID = 198899;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198899Service() {
        this(new Idea198899Config());
    }

    public Idea198899Service(Idea198899Config config) {
        this.config = config != null ? config : new Idea198899Config();
