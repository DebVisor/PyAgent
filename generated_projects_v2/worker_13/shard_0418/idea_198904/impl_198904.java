...
@Data
public class Idea198904Config {
    private String name = "idea_198904";
 ...
 */
@Slf4j
public class Idea198904Service {
    private static final int IDEA_ID = 198904;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198904Service() {
        this(new Idea198904Config());
    }

    public Idea198904Service(Idea198904Config config) {
        this.config = config != null ? config : new Idea198904Config();
