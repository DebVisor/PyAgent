...
@Data
public class Idea198604Config {
    private String name = "idea_198604";
 ...
 */
@Slf4j
public class Idea198604Service {
    private static final int IDEA_ID = 198604;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198604Service() {
        this(new Idea198604Config());
    }

    public Idea198604Service(Idea198604Config config) {
        this.config = config != null ? config : new Idea198604Config();
