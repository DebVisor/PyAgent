...
@Data
public class Idea198729Config {
    private String name = "idea_198729";
 ...
 */
@Slf4j
public class Idea198729Service {
    private static final int IDEA_ID = 198729;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198729Service() {
        this(new Idea198729Config());
    }

    public Idea198729Service(Idea198729Config config) {
        this.config = config != null ? config : new Idea198729Config();
