...
@Data
public class Idea198791Config {
    private String name = "idea_198791";
 ...
 */
@Slf4j
public class Idea198791Service {
    private static final int IDEA_ID = 198791;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198791Service() {
        this(new Idea198791Config());
    }

    public Idea198791Service(Idea198791Config config) {
        this.config = config != null ? config : new Idea198791Config();
