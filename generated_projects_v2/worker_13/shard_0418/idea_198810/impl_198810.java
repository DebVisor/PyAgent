...
@Data
public class Idea198810Config {
    private String name = "idea_198810";
 ...
 */
@Slf4j
public class Idea198810Service {
    private static final int IDEA_ID = 198810;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198810Service() {
        this(new Idea198810Config());
    }

    public Idea198810Service(Idea198810Config config) {
        this.config = config != null ? config : new Idea198810Config();
