...
@Data
public class Idea199016Config {
    private String name = "idea_199016";
 ...
 */
@Slf4j
public class Idea199016Service {
    private static final int IDEA_ID = 199016;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199016Service() {
        this(new Idea199016Config());
    }

    public Idea199016Service(Idea199016Config config) {
        this.config = config != null ? config : new Idea199016Config();
