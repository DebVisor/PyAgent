...
@Data
public class Idea198872Config {
    private String name = "idea_198872";
 ...
 */
@Slf4j
public class Idea198872Service {
    private static final int IDEA_ID = 198872;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198872Service() {
        this(new Idea198872Config());
    }

    public Idea198872Service(Idea198872Config config) {
        this.config = config != null ? config : new Idea198872Config();
