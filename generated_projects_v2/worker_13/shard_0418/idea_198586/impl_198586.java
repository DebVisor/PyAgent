...
@Data
public class Idea198586Config {
    private String name = "idea_198586";
 ...
 */
@Slf4j
public class Idea198586Service {
    private static final int IDEA_ID = 198586;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198586Service() {
        this(new Idea198586Config());
    }

    public Idea198586Service(Idea198586Config config) {
        this.config = config != null ? config : new Idea198586Config();
