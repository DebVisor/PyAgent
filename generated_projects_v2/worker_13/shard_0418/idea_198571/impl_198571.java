...
@Data
public class Idea198571Config {
    private String name = "idea_198571";
 ...
 */
@Slf4j
public class Idea198571Service {
    private static final int IDEA_ID = 198571;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198571Service() {
        this(new Idea198571Config());
    }

    public Idea198571Service(Idea198571Config config) {
        this.config = config != null ? config : new Idea198571Config();
