...
@Data
public class Idea198588Config {
    private String name = "idea_198588";
 ...
 */
@Slf4j
public class Idea198588Service {
    private static final int IDEA_ID = 198588;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198588Service() {
        this(new Idea198588Config());
    }

    public Idea198588Service(Idea198588Config config) {
        this.config = config != null ? config : new Idea198588Config();
