...
@Data
public class Idea198917Config {
    private String name = "idea_198917";
 ...
 */
@Slf4j
public class Idea198917Service {
    private static final int IDEA_ID = 198917;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198917Service() {
        this(new Idea198917Config());
    }

    public Idea198917Service(Idea198917Config config) {
        this.config = config != null ? config : new Idea198917Config();
