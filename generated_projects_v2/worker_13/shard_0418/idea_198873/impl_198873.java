...
@Data
public class Idea198873Config {
    private String name = "idea_198873";
 ...
 */
@Slf4j
public class Idea198873Service {
    private static final int IDEA_ID = 198873;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198873Service() {
        this(new Idea198873Config());
    }

    public Idea198873Service(Idea198873Config config) {
        this.config = config != null ? config : new Idea198873Config();
