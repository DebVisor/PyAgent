...
@Data
public class Idea198878Config {
    private String name = "idea_198878";
 ...
 */
@Slf4j
public class Idea198878Service {
    private static final int IDEA_ID = 198878;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198878Service() {
        this(new Idea198878Config());
    }

    public Idea198878Service(Idea198878Config config) {
        this.config = config != null ? config : new Idea198878Config();
