...
@Data
public class Idea198757Config {
    private String name = "idea_198757";
 ...
 */
@Slf4j
public class Idea198757Service {
    private static final int IDEA_ID = 198757;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198757Service() {
        this(new Idea198757Config());
    }

    public Idea198757Service(Idea198757Config config) {
        this.config = config != null ? config : new Idea198757Config();
