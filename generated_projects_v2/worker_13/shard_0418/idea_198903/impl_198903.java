...
@Data
public class Idea198903Config {
    private String name = "idea_198903";
 ...
 */
@Slf4j
public class Idea198903Service {
    private static final int IDEA_ID = 198903;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198903Service() {
        this(new Idea198903Config());
    }

    public Idea198903Service(Idea198903Config config) {
        this.config = config != null ? config : new Idea198903Config();
