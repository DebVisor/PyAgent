...
@Data
public class Idea198579Config {
    private String name = "idea_198579";
 ...
 */
@Slf4j
public class Idea198579Service {
    private static final int IDEA_ID = 198579;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198579Service() {
        this(new Idea198579Config());
    }

    public Idea198579Service(Idea198579Config config) {
        this.config = config != null ? config : new Idea198579Config();
