...
@Data
public class Idea198866Config {
    private String name = "idea_198866";
 ...
 */
@Slf4j
public class Idea198866Service {
    private static final int IDEA_ID = 198866;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198866Service() {
        this(new Idea198866Config());
    }

    public Idea198866Service(Idea198866Config config) {
        this.config = config != null ? config : new Idea198866Config();
