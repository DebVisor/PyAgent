...
@Data
public class Idea198868Config {
    private String name = "idea_198868";
 ...
 */
@Slf4j
public class Idea198868Service {
    private static final int IDEA_ID = 198868;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198868Service() {
        this(new Idea198868Config());
    }

    public Idea198868Service(Idea198868Config config) {
        this.config = config != null ? config : new Idea198868Config();
