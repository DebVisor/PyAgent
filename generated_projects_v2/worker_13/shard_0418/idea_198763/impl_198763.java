...
@Data
public class Idea198763Config {
    private String name = "idea_198763";
 ...
 */
@Slf4j
public class Idea198763Service {
    private static final int IDEA_ID = 198763;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198763Service() {
        this(new Idea198763Config());
    }

    public Idea198763Service(Idea198763Config config) {
        this.config = config != null ? config : new Idea198763Config();
