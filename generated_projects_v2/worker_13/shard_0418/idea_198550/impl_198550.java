...
@Data
public class Idea198550Config {
    private String name = "idea_198550";
 ...
 */
@Slf4j
public class Idea198550Service {
    private static final int IDEA_ID = 198550;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198550Service() {
        this(new Idea198550Config());
    }

    public Idea198550Service(Idea198550Config config) {
        this.config = config != null ? config : new Idea198550Config();
