...
@Data
public class Idea198680Config {
    private String name = "idea_198680";
 ...
 */
@Slf4j
public class Idea198680Service {
    private static final int IDEA_ID = 198680;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198680Service() {
        this(new Idea198680Config());
    }

    public Idea198680Service(Idea198680Config config) {
        this.config = config != null ? config : new Idea198680Config();
