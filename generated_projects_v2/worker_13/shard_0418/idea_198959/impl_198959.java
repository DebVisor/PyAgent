...
@Data
public class Idea198959Config {
    private String name = "idea_198959";
 ...
 */
@Slf4j
public class Idea198959Service {
    private static final int IDEA_ID = 198959;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198959Service() {
        this(new Idea198959Config());
    }

    public Idea198959Service(Idea198959Config config) {
        this.config = config != null ? config : new Idea198959Config();
