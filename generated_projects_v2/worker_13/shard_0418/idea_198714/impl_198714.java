...
@Data
public class Idea198714Config {
    private String name = "idea_198714";
 ...
 */
@Slf4j
public class Idea198714Service {
    private static final int IDEA_ID = 198714;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198714Service() {
        this(new Idea198714Config());
    }

    public Idea198714Service(Idea198714Config config) {
        this.config = config != null ? config : new Idea198714Config();
