...
@Data
public class Idea198906Config {
    private String name = "idea_198906";
 ...
 */
@Slf4j
public class Idea198906Service {
    private static final int IDEA_ID = 198906;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198906Service() {
        this(new Idea198906Config());
    }

    public Idea198906Service(Idea198906Config config) {
        this.config = config != null ? config : new Idea198906Config();
