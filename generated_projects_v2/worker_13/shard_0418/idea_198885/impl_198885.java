...
@Data
public class Idea198885Config {
    private String name = "idea_198885";
 ...
 */
@Slf4j
public class Idea198885Service {
    private static final int IDEA_ID = 198885;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198885Service() {
        this(new Idea198885Config());
    }

    public Idea198885Service(Idea198885Config config) {
        this.config = config != null ? config : new Idea198885Config();
