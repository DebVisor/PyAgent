...
@Data
public class Idea198834Config {
    private String name = "idea_198834";
 ...
 */
@Slf4j
public class Idea198834Service {
    private static final int IDEA_ID = 198834;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198834Service() {
        this(new Idea198834Config());
    }

    public Idea198834Service(Idea198834Config config) {
        this.config = config != null ? config : new Idea198834Config();
