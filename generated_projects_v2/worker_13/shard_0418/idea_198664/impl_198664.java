...
@Data
public class Idea198664Config {
    private String name = "idea_198664";
 ...
 */
@Slf4j
public class Idea198664Service {
    private static final int IDEA_ID = 198664;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198664Service() {
        this(new Idea198664Config());
    }

    public Idea198664Service(Idea198664Config config) {
        this.config = config != null ? config : new Idea198664Config();
