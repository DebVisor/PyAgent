...
@Data
public class Idea198875Config {
    private String name = "idea_198875";
 ...
 */
@Slf4j
public class Idea198875Service {
    private static final int IDEA_ID = 198875;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198875Service() {
        this(new Idea198875Config());
    }

    public Idea198875Service(Idea198875Config config) {
        this.config = config != null ? config : new Idea198875Config();
