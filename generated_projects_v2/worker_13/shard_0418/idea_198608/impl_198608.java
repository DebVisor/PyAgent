...
@Data
public class Idea198608Config {
    private String name = "idea_198608";
 ...
 */
@Slf4j
public class Idea198608Service {
    private static final int IDEA_ID = 198608;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198608Service() {
        this(new Idea198608Config());
    }

    public Idea198608Service(Idea198608Config config) {
        this.config = config != null ? config : new Idea198608Config();
