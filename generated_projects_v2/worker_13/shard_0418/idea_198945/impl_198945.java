...
@Data
public class Idea198945Config {
    private String name = "idea_198945";
 ...
 */
@Slf4j
public class Idea198945Service {
    private static final int IDEA_ID = 198945;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198945Service() {
        this(new Idea198945Config());
    }

    public Idea198945Service(Idea198945Config config) {
        this.config = config != null ? config : new Idea198945Config();
