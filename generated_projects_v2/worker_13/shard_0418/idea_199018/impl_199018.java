...
@Data
public class Idea199018Config {
    private String name = "idea_199018";
 ...
 */
@Slf4j
public class Idea199018Service {
    private static final int IDEA_ID = 199018;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199018Service() {
        this(new Idea199018Config());
    }

    public Idea199018Service(Idea199018Config config) {
        this.config = config != null ? config : new Idea199018Config();
