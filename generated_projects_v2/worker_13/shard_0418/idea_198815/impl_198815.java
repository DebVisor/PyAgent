...
@Data
public class Idea198815Config {
    private String name = "idea_198815";
 ...
 */
@Slf4j
public class Idea198815Service {
    private static final int IDEA_ID = 198815;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198815Service() {
        this(new Idea198815Config());
    }

    public Idea198815Service(Idea198815Config config) {
        this.config = config != null ? config : new Idea198815Config();
