...
@Data
public class Idea198676Config {
    private String name = "idea_198676";
 ...
 */
@Slf4j
public class Idea198676Service {
    private static final int IDEA_ID = 198676;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198676Service() {
        this(new Idea198676Config());
    }

    public Idea198676Service(Idea198676Config config) {
        this.config = config != null ? config : new Idea198676Config();
