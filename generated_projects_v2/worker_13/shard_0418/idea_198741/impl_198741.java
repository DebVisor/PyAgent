...
@Data
public class Idea198741Config {
    private String name = "idea_198741";
 ...
 */
@Slf4j
public class Idea198741Service {
    private static final int IDEA_ID = 198741;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198741Service() {
        this(new Idea198741Config());
    }

    public Idea198741Service(Idea198741Config config) {
        this.config = config != null ? config : new Idea198741Config();
