...
@Data
public class Idea198935Config {
    private String name = "idea_198935";
 ...
 */
@Slf4j
public class Idea198935Service {
    private static final int IDEA_ID = 198935;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198935Service() {
        this(new Idea198935Config());
    }

    public Idea198935Service(Idea198935Config config) {
        this.config = config != null ? config : new Idea198935Config();
