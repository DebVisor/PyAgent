...
@Data
public class Idea199003Config {
    private String name = "idea_199003";
 ...
 */
@Slf4j
public class Idea199003Service {
    private static final int IDEA_ID = 199003;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199003Service() {
        this(new Idea199003Config());
    }

    public Idea199003Service(Idea199003Config config) {
        this.config = config != null ? config : new Idea199003Config();
