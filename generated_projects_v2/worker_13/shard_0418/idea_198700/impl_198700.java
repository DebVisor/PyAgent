...
@Data
public class Idea198700Config {
    private String name = "idea_198700";
 ...
 */
@Slf4j
public class Idea198700Service {
    private static final int IDEA_ID = 198700;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198700Service() {
        this(new Idea198700Config());
    }

    public Idea198700Service(Idea198700Config config) {
        this.config = config != null ? config : new Idea198700Config();
