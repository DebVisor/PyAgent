...
@Data
public class Idea198652Config {
    private String name = "idea_198652";
 ...
 */
@Slf4j
public class Idea198652Service {
    private static final int IDEA_ID = 198652;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198652Service() {
        this(new Idea198652Config());
    }

    public Idea198652Service(Idea198652Config config) {
        this.config = config != null ? config : new Idea198652Config();
