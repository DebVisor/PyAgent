...
@Data
public class Idea198631Config {
    private String name = "idea_198631";
 ...
 */
@Slf4j
public class Idea198631Service {
    private static final int IDEA_ID = 198631;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198631Service() {
        this(new Idea198631Config());
    }

    public Idea198631Service(Idea198631Config config) {
        this.config = config != null ? config : new Idea198631Config();
