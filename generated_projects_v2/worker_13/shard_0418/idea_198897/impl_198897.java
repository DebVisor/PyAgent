...
@Data
public class Idea198897Config {
    private String name = "idea_198897";
 ...
 */
@Slf4j
public class Idea198897Service {
    private static final int IDEA_ID = 198897;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198897Service() {
        this(new Idea198897Config());
    }

    public Idea198897Service(Idea198897Config config) {
        this.config = config != null ? config : new Idea198897Config();
