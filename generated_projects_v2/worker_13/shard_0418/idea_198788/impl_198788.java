...
@Data
public class Idea198788Config {
    private String name = "idea_198788";
 ...
 */
@Slf4j
public class Idea198788Service {
    private static final int IDEA_ID = 198788;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198788Service() {
        this(new Idea198788Config());
    }

    public Idea198788Service(Idea198788Config config) {
        this.config = config != null ? config : new Idea198788Config();
