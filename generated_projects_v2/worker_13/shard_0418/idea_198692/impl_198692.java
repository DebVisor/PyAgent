...
@Data
public class Idea198692Config {
    private String name = "idea_198692";
 ...
 */
@Slf4j
public class Idea198692Service {
    private static final int IDEA_ID = 198692;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198692Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198692Service() {
        this(new Idea198692Config());
    }

    public Idea198692Service(Idea198692Config config) {
        this.config = config != null ? config : new Idea198692Config();
