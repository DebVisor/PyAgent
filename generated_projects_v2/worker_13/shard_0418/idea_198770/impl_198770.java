...
@Data
public class Idea198770Config {
    private String name = "idea_198770";
 ...
 */
@Slf4j
public class Idea198770Service {
    private static final int IDEA_ID = 198770;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198770Service() {
        this(new Idea198770Config());
    }

    public Idea198770Service(Idea198770Config config) {
        this.config = config != null ? config : new Idea198770Config();
