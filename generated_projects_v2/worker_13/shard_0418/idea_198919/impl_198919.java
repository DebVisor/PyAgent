...
@Data
public class Idea198919Config {
    private String name = "idea_198919";
 ...
 */
@Slf4j
public class Idea198919Service {
    private static final int IDEA_ID = 198919;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198919Service() {
        this(new Idea198919Config());
    }

    public Idea198919Service(Idea198919Config config) {
        this.config = config != null ? config : new Idea198919Config();
