...
@Data
public class Idea198964Config {
    private String name = "idea_198964";
 ...
 */
@Slf4j
public class Idea198964Service {
    private static final int IDEA_ID = 198964;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198964Service() {
        this(new Idea198964Config());
    }

    public Idea198964Service(Idea198964Config config) {
        this.config = config != null ? config : new Idea198964Config();
