...
@Data
public class Idea198743Config {
    private String name = "idea_198743";
 ...
 */
@Slf4j
public class Idea198743Service {
    private static final int IDEA_ID = 198743;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198743Service() {
        this(new Idea198743Config());
    }

    public Idea198743Service(Idea198743Config config) {
        this.config = config != null ? config : new Idea198743Config();
