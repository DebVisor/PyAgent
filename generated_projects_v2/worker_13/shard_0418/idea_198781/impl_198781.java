...
@Data
public class Idea198781Config {
    private String name = "idea_198781";
 ...
 */
@Slf4j
public class Idea198781Service {
    private static final int IDEA_ID = 198781;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198781Service() {
        this(new Idea198781Config());
    }

    public Idea198781Service(Idea198781Config config) {
        this.config = config != null ? config : new Idea198781Config();
