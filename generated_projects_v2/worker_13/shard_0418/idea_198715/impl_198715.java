...
@Data
public class Idea198715Config {
    private String name = "idea_198715";
 ...
 */
@Slf4j
public class Idea198715Service {
    private static final int IDEA_ID = 198715;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198715Service() {
        this(new Idea198715Config());
    }

    public Idea198715Service(Idea198715Config config) {
        this.config = config != null ? config : new Idea198715Config();
