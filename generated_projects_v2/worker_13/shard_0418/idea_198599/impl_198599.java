...
@Data
public class Idea198599Config {
    private String name = "idea_198599";
 ...
 */
@Slf4j
public class Idea198599Service {
    private static final int IDEA_ID = 198599;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198599Service() {
        this(new Idea198599Config());
    }

    public Idea198599Service(Idea198599Config config) {
        this.config = config != null ? config : new Idea198599Config();
