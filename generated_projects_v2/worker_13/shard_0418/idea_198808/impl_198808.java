...
@Data
public class Idea198808Config {
    private String name = "idea_198808";
 ...
 */
@Slf4j
public class Idea198808Service {
    private static final int IDEA_ID = 198808;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198808Service() {
        this(new Idea198808Config());
    }

    public Idea198808Service(Idea198808Config config) {
        this.config = config != null ? config : new Idea198808Config();
