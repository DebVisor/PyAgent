...
@Data
public class Idea198928Config {
    private String name = "idea_198928";
 ...
 */
@Slf4j
public class Idea198928Service {
    private static final int IDEA_ID = 198928;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198928Service() {
        this(new Idea198928Config());
    }

    public Idea198928Service(Idea198928Config config) {
        this.config = config != null ? config : new Idea198928Config();
