...
@Data
public class Idea198569Config {
    private String name = "idea_198569";
 ...
 */
@Slf4j
public class Idea198569Service {
    private static final int IDEA_ID = 198569;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198569Service() {
        this(new Idea198569Config());
    }

    public Idea198569Service(Idea198569Config config) {
        this.config = config != null ? config : new Idea198569Config();
