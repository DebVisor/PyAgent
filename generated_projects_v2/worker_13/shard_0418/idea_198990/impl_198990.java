...
@Data
public class Idea198990Config {
    private String name = "idea_198990";
 ...
 */
@Slf4j
public class Idea198990Service {
    private static final int IDEA_ID = 198990;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198990Service() {
        this(new Idea198990Config());
    }

    public Idea198990Service(Idea198990Config config) {
        this.config = config != null ? config : new Idea198990Config();
