...
@Data
public class Idea198603Config {
    private String name = "idea_198603";
 ...
 */
@Slf4j
public class Idea198603Service {
    private static final int IDEA_ID = 198603;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198603Service() {
        this(new Idea198603Config());
    }

    public Idea198603Service(Idea198603Config config) {
        this.config = config != null ? config : new Idea198603Config();
