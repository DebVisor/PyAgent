...
@Data
public class Idea198774Config {
    private String name = "idea_198774";
 ...
 */
@Slf4j
public class Idea198774Service {
    private static final int IDEA_ID = 198774;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198774Service() {
        this(new Idea198774Config());
    }

    public Idea198774Service(Idea198774Config config) {
        this.config = config != null ? config : new Idea198774Config();
