...
@Data
public class Idea198606Config {
    private String name = "idea_198606";
 ...
 */
@Slf4j
public class Idea198606Service {
    private static final int IDEA_ID = 198606;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198606Service() {
        this(new Idea198606Config());
    }

    public Idea198606Service(Idea198606Config config) {
        this.config = config != null ? config : new Idea198606Config();
