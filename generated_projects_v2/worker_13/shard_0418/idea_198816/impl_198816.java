...
@Data
public class Idea198816Config {
    private String name = "idea_198816";
 ...
 */
@Slf4j
public class Idea198816Service {
    private static final int IDEA_ID = 198816;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198816Service() {
        this(new Idea198816Config());
    }

    public Idea198816Service(Idea198816Config config) {
        this.config = config != null ? config : new Idea198816Config();
