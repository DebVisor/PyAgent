...
@Data
public class Idea198822Config {
    private String name = "idea_198822";
 ...
 */
@Slf4j
public class Idea198822Service {
    private static final int IDEA_ID = 198822;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198822Service() {
        this(new Idea198822Config());
    }

    public Idea198822Service(Idea198822Config config) {
        this.config = config != null ? config : new Idea198822Config();
