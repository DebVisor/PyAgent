...
@Data
public class Idea198947Config {
    private String name = "idea_198947";
 ...
 */
@Slf4j
public class Idea198947Service {
    private static final int IDEA_ID = 198947;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198947Service() {
        this(new Idea198947Config());
    }

    public Idea198947Service(Idea198947Config config) {
        this.config = config != null ? config : new Idea198947Config();
