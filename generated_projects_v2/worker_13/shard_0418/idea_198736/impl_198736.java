...
@Data
public class Idea198736Config {
    private String name = "idea_198736";
 ...
 */
@Slf4j
public class Idea198736Service {
    private static final int IDEA_ID = 198736;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198736Service() {
        this(new Idea198736Config());
    }

    public Idea198736Service(Idea198736Config config) {
        this.config = config != null ? config : new Idea198736Config();
