...
@Data
public class Idea198984Config {
    private String name = "idea_198984";
 ...
 */
@Slf4j
public class Idea198984Service {
    private static final int IDEA_ID = 198984;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198984Service() {
        this(new Idea198984Config());
    }

    public Idea198984Service(Idea198984Config config) {
        this.config = config != null ? config : new Idea198984Config();
