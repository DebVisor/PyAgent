...
@Data
public class Idea198634Config {
    private String name = "idea_198634";
 ...
 */
@Slf4j
public class Idea198634Service {
    private static final int IDEA_ID = 198634;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198634Service() {
        this(new Idea198634Config());
    }

    public Idea198634Service(Idea198634Config config) {
        this.config = config != null ? config : new Idea198634Config();
