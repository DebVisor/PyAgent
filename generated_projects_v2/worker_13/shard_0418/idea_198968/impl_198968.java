...
@Data
public class Idea198968Config {
    private String name = "idea_198968";
 ...
 */
@Slf4j
public class Idea198968Service {
    private static final int IDEA_ID = 198968;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198968Service() {
        this(new Idea198968Config());
    }

    public Idea198968Service(Idea198968Config config) {
        this.config = config != null ? config : new Idea198968Config();
