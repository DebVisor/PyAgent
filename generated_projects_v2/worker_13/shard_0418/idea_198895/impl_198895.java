...
@Data
public class Idea198895Config {
    private String name = "idea_198895";
 ...
 */
@Slf4j
public class Idea198895Service {
    private static final int IDEA_ID = 198895;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198895Service() {
        this(new Idea198895Config());
    }

    public Idea198895Service(Idea198895Config config) {
        this.config = config != null ? config : new Idea198895Config();
