...
@Data
public class Idea198563Config {
    private String name = "idea_198563";
 ...
 */
@Slf4j
public class Idea198563Service {
    private static final int IDEA_ID = 198563;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198563Service() {
        this(new Idea198563Config());
    }

    public Idea198563Service(Idea198563Config config) {
        this.config = config != null ? config : new Idea198563Config();
