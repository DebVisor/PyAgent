...
@Data
public class Idea198755Config {
    private String name = "idea_198755";
 ...
 */
@Slf4j
public class Idea198755Service {
    private static final int IDEA_ID = 198755;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198755Service() {
        this(new Idea198755Config());
    }

    public Idea198755Service(Idea198755Config config) {
        this.config = config != null ? config : new Idea198755Config();
