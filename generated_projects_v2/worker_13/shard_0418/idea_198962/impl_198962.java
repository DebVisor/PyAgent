...
@Data
public class Idea198962Config {
    private String name = "idea_198962";
 ...
 */
@Slf4j
public class Idea198962Service {
    private static final int IDEA_ID = 198962;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198962Service() {
        this(new Idea198962Config());
    }

    public Idea198962Service(Idea198962Config config) {
        this.config = config != null ? config : new Idea198962Config();
