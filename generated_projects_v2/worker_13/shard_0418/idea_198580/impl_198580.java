...
@Data
public class Idea198580Config {
    private String name = "idea_198580";
 ...
 */
@Slf4j
public class Idea198580Service {
    private static final int IDEA_ID = 198580;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198580Service() {
        this(new Idea198580Config());
    }

    public Idea198580Service(Idea198580Config config) {
        this.config = config != null ? config : new Idea198580Config();
