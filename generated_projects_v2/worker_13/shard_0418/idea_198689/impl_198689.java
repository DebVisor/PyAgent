...
@Data
public class Idea198689Config {
    private String name = "idea_198689";
 ...
 */
@Slf4j
public class Idea198689Service {
    private static final int IDEA_ID = 198689;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198689Service() {
        this(new Idea198689Config());
    }

    public Idea198689Service(Idea198689Config config) {
        this.config = config != null ? config : new Idea198689Config();
