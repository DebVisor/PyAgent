...
@Data
public class Idea198572Config {
    private String name = "idea_198572";
 ...
 */
@Slf4j
public class Idea198572Service {
    private static final int IDEA_ID = 198572;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198572Service() {
        this(new Idea198572Config());
    }

    public Idea198572Service(Idea198572Config config) {
        this.config = config != null ? config : new Idea198572Config();
