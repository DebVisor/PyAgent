...
@Data
public class Idea198573Config {
    private String name = "idea_198573";
 ...
 */
@Slf4j
public class Idea198573Service {
    private static final int IDEA_ID = 198573;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198573Service() {
        this(new Idea198573Config());
    }

    public Idea198573Service(Idea198573Config config) {
        this.config = config != null ? config : new Idea198573Config();
