...
@Data
public class Idea198790Config {
    private String name = "idea_198790";
 ...
 */
@Slf4j
public class Idea198790Service {
    private static final int IDEA_ID = 198790;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198790Service() {
        this(new Idea198790Config());
    }

    public Idea198790Service(Idea198790Config config) {
        this.config = config != null ? config : new Idea198790Config();
