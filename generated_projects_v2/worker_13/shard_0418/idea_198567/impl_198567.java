...
@Data
public class Idea198567Config {
    private String name = "idea_198567";
 ...
 */
@Slf4j
public class Idea198567Service {
    private static final int IDEA_ID = 198567;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198567Service() {
        this(new Idea198567Config());
    }

    public Idea198567Service(Idea198567Config config) {
        this.config = config != null ? config : new Idea198567Config();
