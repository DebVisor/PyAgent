...
@Data
public class Idea198691Config {
    private String name = "idea_198691";
 ...
 */
@Slf4j
public class Idea198691Service {
    private static final int IDEA_ID = 198691;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198691Service() {
        this(new Idea198691Config());
    }

    public Idea198691Service(Idea198691Config config) {
        this.config = config != null ? config : new Idea198691Config();
