...
@Data
public class Idea198667Config {
    private String name = "idea_198667";
 ...
 */
@Slf4j
public class Idea198667Service {
    private static final int IDEA_ID = 198667;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198667Service() {
        this(new Idea198667Config());
    }

    public Idea198667Service(Idea198667Config config) {
        this.config = config != null ? config : new Idea198667Config();
