...
@Data
public class Idea198738Config {
    private String name = "idea_198738";
 ...
 */
@Slf4j
public class Idea198738Service {
    private static final int IDEA_ID = 198738;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198738Service() {
        this(new Idea198738Config());
    }

    public Idea198738Service(Idea198738Config config) {
        this.config = config != null ? config : new Idea198738Config();
