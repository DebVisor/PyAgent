...
@Data
public class Idea198988Config {
    private String name = "idea_198988";
 ...
 */
@Slf4j
public class Idea198988Service {
    private static final int IDEA_ID = 198988;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198988Service() {
        this(new Idea198988Config());
    }

    public Idea198988Service(Idea198988Config config) {
        this.config = config != null ? config : new Idea198988Config();
