...
@Data
public class Idea198671Config {
    private String name = "idea_198671";
 ...
 */
@Slf4j
public class Idea198671Service {
    private static final int IDEA_ID = 198671;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198671Service() {
        this(new Idea198671Config());
    }

    public Idea198671Service(Idea198671Config config) {
        this.config = config != null ? config : new Idea198671Config();
