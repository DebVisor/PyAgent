...
@Data
public class Idea198870Config {
    private String name = "idea_198870";
 ...
 */
@Slf4j
public class Idea198870Service {
    private static final int IDEA_ID = 198870;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198870Service() {
        this(new Idea198870Config());
    }

    public Idea198870Service(Idea198870Config config) {
        this.config = config != null ? config : new Idea198870Config();
