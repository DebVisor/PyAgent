...
@Data
public class Idea198694Config {
    private String name = "idea_198694";
 ...
 */
@Slf4j
public class Idea198694Service {
    private static final int IDEA_ID = 198694;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198694Service() {
        this(new Idea198694Config());
    }

    public Idea198694Service(Idea198694Config config) {
        this.config = config != null ? config : new Idea198694Config();
