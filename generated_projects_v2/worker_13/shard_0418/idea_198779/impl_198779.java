...
@Data
public class Idea198779Config {
    private String name = "idea_198779";
 ...
 */
@Slf4j
public class Idea198779Service {
    private static final int IDEA_ID = 198779;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198779Service() {
        this(new Idea198779Config());
    }

    public Idea198779Service(Idea198779Config config) {
        this.config = config != null ? config : new Idea198779Config();
