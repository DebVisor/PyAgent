...
@Data
public class Idea199015Config {
    private String name = "idea_199015";
 ...
 */
@Slf4j
public class Idea199015Service {
    private static final int IDEA_ID = 199015;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199015Service() {
        this(new Idea199015Config());
    }

    public Idea199015Service(Idea199015Config config) {
        this.config = config != null ? config : new Idea199015Config();
