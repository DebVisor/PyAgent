...
@Data
public class Idea198771Config {
    private String name = "idea_198771";
 ...
 */
@Slf4j
public class Idea198771Service {
    private static final int IDEA_ID = 198771;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198771Service() {
        this(new Idea198771Config());
    }

    public Idea198771Service(Idea198771Config config) {
        this.config = config != null ? config : new Idea198771Config();
