...
@Data
public class Idea198938Config {
    private String name = "idea_198938";
 ...
 */
@Slf4j
public class Idea198938Service {
    private static final int IDEA_ID = 198938;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198938Service() {
        this(new Idea198938Config());
    }

    public Idea198938Service(Idea198938Config config) {
        this.config = config != null ? config : new Idea198938Config();
