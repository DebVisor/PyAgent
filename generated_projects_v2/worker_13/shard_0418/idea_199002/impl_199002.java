...
@Data
public class Idea199002Config {
    private String name = "idea_199002";
 ...
 */
@Slf4j
public class Idea199002Service {
    private static final int IDEA_ID = 199002;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199002Service() {
        this(new Idea199002Config());
    }

    public Idea199002Service(Idea199002Config config) {
        this.config = config != null ? config : new Idea199002Config();
