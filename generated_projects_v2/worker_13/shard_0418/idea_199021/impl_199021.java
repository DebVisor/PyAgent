...
@Data
public class Idea199021Config {
    private String name = "idea_199021";
 ...
 */
@Slf4j
public class Idea199021Service {
    private static final int IDEA_ID = 199021;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199021Service() {
        this(new Idea199021Config());
    }

    public Idea199021Service(Idea199021Config config) {
        this.config = config != null ? config : new Idea199021Config();
