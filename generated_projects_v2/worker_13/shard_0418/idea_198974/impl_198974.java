...
@Data
public class Idea198974Config {
    private String name = "idea_198974";
 ...
 */
@Slf4j
public class Idea198974Service {
    private static final int IDEA_ID = 198974;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198974Service() {
        this(new Idea198974Config());
    }

    public Idea198974Service(Idea198974Config config) {
        this.config = config != null ? config : new Idea198974Config();
