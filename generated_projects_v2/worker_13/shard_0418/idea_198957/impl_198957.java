...
@Data
public class Idea198957Config {
    private String name = "idea_198957";
 ...
 */
@Slf4j
public class Idea198957Service {
    private static final int IDEA_ID = 198957;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198957Service() {
        this(new Idea198957Config());
    }

    public Idea198957Service(Idea198957Config config) {
        this.config = config != null ? config : new Idea198957Config();
