...
@Data
public class Idea198980Config {
    private String name = "idea_198980";
 ...
 */
@Slf4j
public class Idea198980Service {
    private static final int IDEA_ID = 198980;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198980Service() {
        this(new Idea198980Config());
    }

    public Idea198980Service(Idea198980Config config) {
        this.config = config != null ? config : new Idea198980Config();
