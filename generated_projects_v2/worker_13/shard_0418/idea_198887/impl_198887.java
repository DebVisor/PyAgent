...
@Data
public class Idea198887Config {
    private String name = "idea_198887";
 ...
 */
@Slf4j
public class Idea198887Service {
    private static final int IDEA_ID = 198887;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198887Service() {
        this(new Idea198887Config());
    }

    public Idea198887Service(Idea198887Config config) {
        this.config = config != null ? config : new Idea198887Config();
