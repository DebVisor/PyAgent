...
@Data
public class Idea198976Config {
    private String name = "idea_198976";
 ...
 */
@Slf4j
public class Idea198976Service {
    private static final int IDEA_ID = 198976;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198976Service() {
        this(new Idea198976Config());
    }

    public Idea198976Service(Idea198976Config config) {
        this.config = config != null ? config : new Idea198976Config();
