...
@Data
public class Idea198758Config {
    private String name = "idea_198758";
 ...
 */
@Slf4j
public class Idea198758Service {
    private static final int IDEA_ID = 198758;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198758Service() {
        this(new Idea198758Config());
    }

    public Idea198758Service(Idea198758Config config) {
        this.config = config != null ? config : new Idea198758Config();
