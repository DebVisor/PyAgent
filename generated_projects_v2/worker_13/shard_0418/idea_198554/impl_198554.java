...
@Data
public class Idea198554Config {
    private String name = "idea_198554";
 ...
 */
@Slf4j
public class Idea198554Service {
    private static final int IDEA_ID = 198554;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198554Service() {
        this(new Idea198554Config());
    }

    public Idea198554Service(Idea198554Config config) {
        this.config = config != null ? config : new Idea198554Config();
