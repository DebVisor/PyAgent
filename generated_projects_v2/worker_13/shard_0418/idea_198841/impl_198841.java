...
@Data
public class Idea198841Config {
    private String name = "idea_198841";
 ...
 */
@Slf4j
public class Idea198841Service {
    private static final int IDEA_ID = 198841;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198841Service() {
        this(new Idea198841Config());
    }

    public Idea198841Service(Idea198841Config config) {
        this.config = config != null ? config : new Idea198841Config();
