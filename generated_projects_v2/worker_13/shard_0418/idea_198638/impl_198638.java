...
@Data
public class Idea198638Config {
    private String name = "idea_198638";
 ...
 */
@Slf4j
public class Idea198638Service {
    private static final int IDEA_ID = 198638;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198638Service() {
        this(new Idea198638Config());
    }

    public Idea198638Service(Idea198638Config config) {
        this.config = config != null ? config : new Idea198638Config();
