...
@Data
public class Idea198721Config {
    private String name = "idea_198721";
 ...
 */
@Slf4j
public class Idea198721Service {
    private static final int IDEA_ID = 198721;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198721Service() {
        this(new Idea198721Config());
    }

    public Idea198721Service(Idea198721Config config) {
        this.config = config != null ? config : new Idea198721Config();
