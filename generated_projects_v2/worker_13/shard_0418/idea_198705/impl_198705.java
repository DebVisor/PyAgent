...
@Data
public class Idea198705Config {
    private String name = "idea_198705";
 ...
 */
@Slf4j
public class Idea198705Service {
    private static final int IDEA_ID = 198705;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198705Service() {
        this(new Idea198705Config());
    }

    public Idea198705Service(Idea198705Config config) {
        this.config = config != null ? config : new Idea198705Config();
