...
@Data
public class Idea198845Config {
    private String name = "idea_198845";
 ...
 */
@Slf4j
public class Idea198845Service {
    private static final int IDEA_ID = 198845;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198845Service() {
        this(new Idea198845Config());
    }

    public Idea198845Service(Idea198845Config config) {
        this.config = config != null ? config : new Idea198845Config();
