...
@Data
public class Idea198954Config {
    private String name = "idea_198954";
 ...
 */
@Slf4j
public class Idea198954Service {
    private static final int IDEA_ID = 198954;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198954Service() {
        this(new Idea198954Config());
    }

    public Idea198954Service(Idea198954Config config) {
        this.config = config != null ? config : new Idea198954Config();
