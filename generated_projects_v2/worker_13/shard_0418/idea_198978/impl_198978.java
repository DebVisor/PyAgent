...
@Data
public class Idea198978Config {
    private String name = "idea_198978";
 ...
 */
@Slf4j
public class Idea198978Service {
    private static final int IDEA_ID = 198978;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198978Service() {
        this(new Idea198978Config());
    }

    public Idea198978Service(Idea198978Config config) {
        this.config = config != null ? config : new Idea198978Config();
