...
@Data
public class Idea198577Config {
    private String name = "idea_198577";
 ...
 */
@Slf4j
public class Idea198577Service {
    private static final int IDEA_ID = 198577;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198577Service() {
        this(new Idea198577Config());
    }

    public Idea198577Service(Idea198577Config config) {
        this.config = config != null ? config : new Idea198577Config();
