...
@Data
public class Idea198565Config {
    private String name = "idea_198565";
 ...
 */
@Slf4j
public class Idea198565Service {
    private static final int IDEA_ID = 198565;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198565Service() {
        this(new Idea198565Config());
    }

    public Idea198565Service(Idea198565Config config) {
        this.config = config != null ? config : new Idea198565Config();
