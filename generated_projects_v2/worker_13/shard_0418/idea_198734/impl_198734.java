...
@Data
public class Idea198734Config {
    private String name = "idea_198734";
 ...
 */
@Slf4j
public class Idea198734Service {
    private static final int IDEA_ID = 198734;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198734Service() {
        this(new Idea198734Config());
    }

    public Idea198734Service(Idea198734Config config) {
        this.config = config != null ? config : new Idea198734Config();
