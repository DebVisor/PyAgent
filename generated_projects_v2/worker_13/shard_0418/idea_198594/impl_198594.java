...
@Data
public class Idea198594Config {
    private String name = "idea_198594";
 ...
 */
@Slf4j
public class Idea198594Service {
    private static final int IDEA_ID = 198594;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198594Service() {
        this(new Idea198594Config());
    }

    public Idea198594Service(Idea198594Config config) {
        this.config = config != null ? config : new Idea198594Config();
