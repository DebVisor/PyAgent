...
@Data
public class Idea198670Config {
    private String name = "idea_198670";
 ...
 */
@Slf4j
public class Idea198670Service {
    private static final int IDEA_ID = 198670;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198670Service() {
        this(new Idea198670Config());
    }

    public Idea198670Service(Idea198670Config config) {
        this.config = config != null ? config : new Idea198670Config();
