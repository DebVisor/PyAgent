...
@Data
public class Idea198559Config {
    private String name = "idea_198559";
 ...
 */
@Slf4j
public class Idea198559Service {
    private static final int IDEA_ID = 198559;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198559Service() {
        this(new Idea198559Config());
    }

    public Idea198559Service(Idea198559Config config) {
        this.config = config != null ? config : new Idea198559Config();
