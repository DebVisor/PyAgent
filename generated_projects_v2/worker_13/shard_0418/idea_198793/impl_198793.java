...
@Data
public class Idea198793Config {
    private String name = "idea_198793";
 ...
 */
@Slf4j
public class Idea198793Service {
    private static final int IDEA_ID = 198793;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198793Service() {
        this(new Idea198793Config());
    }

    public Idea198793Service(Idea198793Config config) {
        this.config = config != null ? config : new Idea198793Config();
