...
@Data
public class Idea198796Config {
    private String name = "idea_198796";
 ...
 */
@Slf4j
public class Idea198796Service {
    private static final int IDEA_ID = 198796;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198796Service() {
        this(new Idea198796Config());
    }

    public Idea198796Service(Idea198796Config config) {
        this.config = config != null ? config : new Idea198796Config();
