...
@Data
public class Idea198798Config {
    private String name = "idea_198798";
 ...
 */
@Slf4j
public class Idea198798Service {
    private static final int IDEA_ID = 198798;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198798Service() {
        this(new Idea198798Config());
    }

    public Idea198798Service(Idea198798Config config) {
        this.config = config != null ? config : new Idea198798Config();
