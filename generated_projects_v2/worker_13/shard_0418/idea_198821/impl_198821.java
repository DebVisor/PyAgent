...
@Data
public class Idea198821Config {
    private String name = "idea_198821";
 ...
 */
@Slf4j
public class Idea198821Service {
    private static final int IDEA_ID = 198821;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198821Service() {
        this(new Idea198821Config());
    }

    public Idea198821Service(Idea198821Config config) {
        this.config = config != null ? config : new Idea198821Config();
