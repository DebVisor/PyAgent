...
@Data
public class Idea198820Config {
    private String name = "idea_198820";
 ...
 */
@Slf4j
public class Idea198820Service {
    private static final int IDEA_ID = 198820;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198820Service() {
        this(new Idea198820Config());
    }

    public Idea198820Service(Idea198820Config config) {
        this.config = config != null ? config : new Idea198820Config();
