...
@Data
public class Idea198718Config {
    private String name = "idea_198718";
 ...
 */
@Slf4j
public class Idea198718Service {
    private static final int IDEA_ID = 198718;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198718Service() {
        this(new Idea198718Config());
    }

    public Idea198718Service(Idea198718Config config) {
        this.config = config != null ? config : new Idea198718Config();
