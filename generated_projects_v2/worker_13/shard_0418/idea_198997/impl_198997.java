...
@Data
public class Idea198997Config {
    private String name = "idea_198997";
 ...
 */
@Slf4j
public class Idea198997Service {
    private static final int IDEA_ID = 198997;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198997Service() {
        this(new Idea198997Config());
    }

    public Idea198997Service(Idea198997Config config) {
        this.config = config != null ? config : new Idea198997Config();
