...
@Data
public class Idea198626Config {
    private String name = "idea_198626";
 ...
 */
@Slf4j
public class Idea198626Service {
    private static final int IDEA_ID = 198626;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198626Service() {
        this(new Idea198626Config());
    }

    public Idea198626Service(Idea198626Config config) {
        this.config = config != null ? config : new Idea198626Config();
