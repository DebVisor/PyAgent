...
@Data
public class Idea198941Config {
    private String name = "idea_198941";
 ...
 */
@Slf4j
public class Idea198941Service {
    private static final int IDEA_ID = 198941;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198941Service() {
        this(new Idea198941Config());
    }

    public Idea198941Service(Idea198941Config config) {
        this.config = config != null ? config : new Idea198941Config();
