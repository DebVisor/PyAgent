...
@Data
public class Idea198616Config {
    private String name = "idea_198616";
 ...
 */
@Slf4j
public class Idea198616Service {
    private static final int IDEA_ID = 198616;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198616Service() {
        this(new Idea198616Config());
    }

    public Idea198616Service(Idea198616Config config) {
        this.config = config != null ? config : new Idea198616Config();
