...
@Data
public class Idea198584Config {
    private String name = "idea_198584";
 ...
 */
@Slf4j
public class Idea198584Service {
    private static final int IDEA_ID = 198584;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198584Service() {
        this(new Idea198584Config());
    }

    public Idea198584Service(Idea198584Config config) {
        this.config = config != null ? config : new Idea198584Config();
