...
@Data
public class Idea198973Config {
    private String name = "idea_198973";
 ...
 */
@Slf4j
public class Idea198973Service {
    private static final int IDEA_ID = 198973;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198973Service() {
        this(new Idea198973Config());
    }

    public Idea198973Service(Idea198973Config config) {
        this.config = config != null ? config : new Idea198973Config();
