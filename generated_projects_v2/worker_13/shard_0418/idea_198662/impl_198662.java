...
@Data
public class Idea198662Config {
    private String name = "idea_198662";
 ...
 */
@Slf4j
public class Idea198662Service {
    private static final int IDEA_ID = 198662;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198662Service() {
        this(new Idea198662Config());
    }

    public Idea198662Service(Idea198662Config config) {
        this.config = config != null ? config : new Idea198662Config();
