...
@Data
public class Idea198911Config {
    private String name = "idea_198911";
 ...
 */
@Slf4j
public class Idea198911Service {
    private static final int IDEA_ID = 198911;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198911Service() {
        this(new Idea198911Config());
    }

    public Idea198911Service(Idea198911Config config) {
        this.config = config != null ? config : new Idea198911Config();
