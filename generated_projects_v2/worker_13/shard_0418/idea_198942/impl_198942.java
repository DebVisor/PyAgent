...
@Data
public class Idea198942Config {
    private String name = "idea_198942";
 ...
 */
@Slf4j
public class Idea198942Service {
    private static final int IDEA_ID = 198942;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198942Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198942Service() {
        this(new Idea198942Config());
    }

    public Idea198942Service(Idea198942Config config) {
        this.config = config != null ? config : new Idea198942Config();
