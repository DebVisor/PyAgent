...
@Data
public class Idea199017Config {
    private String name = "idea_199017";
 ...
 */
@Slf4j
public class Idea199017Service {
    private static final int IDEA_ID = 199017;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199017Service() {
        this(new Idea199017Config());
    }

    public Idea199017Service(Idea199017Config config) {
        this.config = config != null ? config : new Idea199017Config();
