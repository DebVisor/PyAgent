...
@Data
public class Idea198851Config {
    private String name = "idea_198851";
 ...
 */
@Slf4j
public class Idea198851Service {
    private static final int IDEA_ID = 198851;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198851Service() {
        this(new Idea198851Config());
    }

    public Idea198851Service(Idea198851Config config) {
        this.config = config != null ? config : new Idea198851Config();
