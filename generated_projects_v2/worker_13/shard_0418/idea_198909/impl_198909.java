...
@Data
public class Idea198909Config {
    private String name = "idea_198909";
 ...
 */
@Slf4j
public class Idea198909Service {
    private static final int IDEA_ID = 198909;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198909Service() {
        this(new Idea198909Config());
    }

    public Idea198909Service(Idea198909Config config) {
        this.config = config != null ? config : new Idea198909Config();
