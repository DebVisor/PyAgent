...
@Data
public class Idea198883Config {
    private String name = "idea_198883";
 ...
 */
@Slf4j
public class Idea198883Service {
    private static final int IDEA_ID = 198883;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198883Service() {
        this(new Idea198883Config());
    }

    public Idea198883Service(Idea198883Config config) {
        this.config = config != null ? config : new Idea198883Config();
