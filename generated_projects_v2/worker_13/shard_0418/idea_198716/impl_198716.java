...
@Data
public class Idea198716Config {
    private String name = "idea_198716";
 ...
 */
@Slf4j
public class Idea198716Service {
    private static final int IDEA_ID = 198716;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198716Service() {
        this(new Idea198716Config());
    }

    public Idea198716Service(Idea198716Config config) {
        this.config = config != null ? config : new Idea198716Config();
