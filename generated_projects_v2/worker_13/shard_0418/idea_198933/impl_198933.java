...
@Data
public class Idea198933Config {
    private String name = "idea_198933";
 ...
 */
@Slf4j
public class Idea198933Service {
    private static final int IDEA_ID = 198933;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198933Service() {
        this(new Idea198933Config());
    }

    public Idea198933Service(Idea198933Config config) {
        this.config = config != null ? config : new Idea198933Config();
