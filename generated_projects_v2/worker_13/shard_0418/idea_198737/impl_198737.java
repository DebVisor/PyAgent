...
@Data
public class Idea198737Config {
    private String name = "idea_198737";
 ...
 */
@Slf4j
public class Idea198737Service {
    private static final int IDEA_ID = 198737;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198737Service() {
        this(new Idea198737Config());
    }

    public Idea198737Service(Idea198737Config config) {
        this.config = config != null ? config : new Idea198737Config();
