...
@Data
public class Idea198646Config {
    private String name = "idea_198646";
 ...
 */
@Slf4j
public class Idea198646Service {
    private static final int IDEA_ID = 198646;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198646Service() {
        this(new Idea198646Config());
    }

    public Idea198646Service(Idea198646Config config) {
        this.config = config != null ? config : new Idea198646Config();
