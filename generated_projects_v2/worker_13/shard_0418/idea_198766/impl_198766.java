...
@Data
public class Idea198766Config {
    private String name = "idea_198766";
 ...
 */
@Slf4j
public class Idea198766Service {
    private static final int IDEA_ID = 198766;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198766Service() {
        this(new Idea198766Config());
    }

    public Idea198766Service(Idea198766Config config) {
        this.config = config != null ? config : new Idea198766Config();
