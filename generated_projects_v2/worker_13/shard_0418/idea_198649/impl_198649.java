...
@Data
public class Idea198649Config {
    private String name = "idea_198649";
 ...
 */
@Slf4j
public class Idea198649Service {
    private static final int IDEA_ID = 198649;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198649Service() {
        this(new Idea198649Config());
    }

    public Idea198649Service(Idea198649Config config) {
        this.config = config != null ? config : new Idea198649Config();
