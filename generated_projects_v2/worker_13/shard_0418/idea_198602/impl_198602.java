...
@Data
public class Idea198602Config {
    private String name = "idea_198602";
 ...
 */
@Slf4j
public class Idea198602Service {
    private static final int IDEA_ID = 198602;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198602Service() {
        this(new Idea198602Config());
    }

    public Idea198602Service(Idea198602Config config) {
        this.config = config != null ? config : new Idea198602Config();
