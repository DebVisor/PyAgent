...
@Data
public class Idea198552Config {
    private String name = "idea_198552";
 ...
 */
@Slf4j
public class Idea198552Service {
    private static final int IDEA_ID = 198552;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198552Service() {
        this(new Idea198552Config());
    }

    public Idea198552Service(Idea198552Config config) {
        this.config = config != null ? config : new Idea198552Config();
