...
@Data
public class Idea198642Config {
    private String name = "idea_198642";
 ...
 */
@Slf4j
public class Idea198642Service {
    private static final int IDEA_ID = 198642;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198642Service() {
        this(new Idea198642Config());
    }

    public Idea198642Service(Idea198642Config config) {
        this.config = config != null ? config : new Idea198642Config();
