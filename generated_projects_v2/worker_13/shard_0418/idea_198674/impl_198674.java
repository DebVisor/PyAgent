...
@Data
public class Idea198674Config {
    private String name = "idea_198674";
 ...
 */
@Slf4j
public class Idea198674Service {
    private static final int IDEA_ID = 198674;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198674Service() {
        this(new Idea198674Config());
    }

    public Idea198674Service(Idea198674Config config) {
        this.config = config != null ? config : new Idea198674Config();
