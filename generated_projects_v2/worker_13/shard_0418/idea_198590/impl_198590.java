...
@Data
public class Idea198590Config {
    private String name = "idea_198590";
 ...
 */
@Slf4j
public class Idea198590Service {
    private static final int IDEA_ID = 198590;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198590Service() {
        this(new Idea198590Config());
    }

    public Idea198590Service(Idea198590Config config) {
        this.config = config != null ? config : new Idea198590Config();
