...
@Data
public class Idea198686Config {
    private String name = "idea_198686";
 ...
 */
@Slf4j
public class Idea198686Service {
    private static final int IDEA_ID = 198686;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198686Service() {
        this(new Idea198686Config());
    }

    public Idea198686Service(Idea198686Config config) {
        this.config = config != null ? config : new Idea198686Config();
