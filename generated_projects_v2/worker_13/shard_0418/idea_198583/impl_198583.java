...
@Data
public class Idea198583Config {
    private String name = "idea_198583";
 ...
 */
@Slf4j
public class Idea198583Service {
    private static final int IDEA_ID = 198583;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198583Service() {
        this(new Idea198583Config());
    }

    public Idea198583Service(Idea198583Config config) {
        this.config = config != null ? config : new Idea198583Config();
