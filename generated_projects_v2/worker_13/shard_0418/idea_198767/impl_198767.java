...
@Data
public class Idea198767Config {
    private String name = "idea_198767";
 ...
 */
@Slf4j
public class Idea198767Service {
    private static final int IDEA_ID = 198767;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198767Service() {
        this(new Idea198767Config());
    }

    public Idea198767Service(Idea198767Config config) {
        this.config = config != null ? config : new Idea198767Config();
