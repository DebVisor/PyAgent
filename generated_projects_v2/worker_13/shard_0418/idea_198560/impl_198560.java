...
@Data
public class Idea198560Config {
    private String name = "idea_198560";
 ...
 */
@Slf4j
public class Idea198560Service {
    private static final int IDEA_ID = 198560;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198560Service() {
        this(new Idea198560Config());
    }

    public Idea198560Service(Idea198560Config config) {
        this.config = config != null ? config : new Idea198560Config();
