...
@Data
public class Idea198856Config {
    private String name = "idea_198856";
 ...
 */
@Slf4j
public class Idea198856Service {
    private static final int IDEA_ID = 198856;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198856Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198856Service() {
        this(new Idea198856Config());
    }

    public Idea198856Service(Idea198856Config config) {
        this.config = config != null ? config : new Idea198856Config();
