...
@Data
public class Idea198750Config {
    private String name = "idea_198750";
 ...
 */
@Slf4j
public class Idea198750Service {
    private static final int IDEA_ID = 198750;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198750Service() {
        this(new Idea198750Config());
    }

    public Idea198750Service(Idea198750Config config) {
        this.config = config != null ? config : new Idea198750Config();
