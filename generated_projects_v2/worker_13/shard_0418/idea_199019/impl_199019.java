...
@Data
public class Idea199019Config {
    private String name = "idea_199019";
 ...
 */
@Slf4j
public class Idea199019Service {
    private static final int IDEA_ID = 199019;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199019Service() {
        this(new Idea199019Config());
    }

    public Idea199019Service(Idea199019Config config) {
        this.config = config != null ? config : new Idea199019Config();
