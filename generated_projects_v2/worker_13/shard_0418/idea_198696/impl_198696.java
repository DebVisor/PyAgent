...
@Data
public class Idea198696Config {
    private String name = "idea_198696";
 ...
 */
@Slf4j
public class Idea198696Service {
    private static final int IDEA_ID = 198696;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198696Service() {
        this(new Idea198696Config());
    }

    public Idea198696Service(Idea198696Config config) {
        this.config = config != null ? config : new Idea198696Config();
