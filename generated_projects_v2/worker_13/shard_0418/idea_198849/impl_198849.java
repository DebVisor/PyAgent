...
@Data
public class Idea198849Config {
    private String name = "idea_198849";
 ...
 */
@Slf4j
public class Idea198849Service {
    private static final int IDEA_ID = 198849;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198849Service() {
        this(new Idea198849Config());
    }

    public Idea198849Service(Idea198849Config config) {
        this.config = config != null ? config : new Idea198849Config();
