...
@Data
public class Idea198913Config {
    private String name = "idea_198913";
 ...
 */
@Slf4j
public class Idea198913Service {
    private static final int IDEA_ID = 198913;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198913Service() {
        this(new Idea198913Config());
    }

    public Idea198913Service(Idea198913Config config) {
        this.config = config != null ? config : new Idea198913Config();
