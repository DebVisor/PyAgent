...
@Data
public class Idea198946Config {
    private String name = "idea_198946";
 ...
 */
@Slf4j
public class Idea198946Service {
    private static final int IDEA_ID = 198946;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198946Service() {
        this(new Idea198946Config());
    }

    public Idea198946Service(Idea198946Config config) {
        this.config = config != null ? config : new Idea198946Config();
