...
@Data
public class Idea198773Config {
    private String name = "idea_198773";
 ...
 */
@Slf4j
public class Idea198773Service {
    private static final int IDEA_ID = 198773;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198773Service() {
        this(new Idea198773Config());
    }

    public Idea198773Service(Idea198773Config config) {
        this.config = config != null ? config : new Idea198773Config();
