...
@Data
public class Idea198658Config {
    private String name = "idea_198658";
 ...
 */
@Slf4j
public class Idea198658Service {
    private static final int IDEA_ID = 198658;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198658Service() {
        this(new Idea198658Config());
    }

    public Idea198658Service(Idea198658Config config) {
        this.config = config != null ? config : new Idea198658Config();
