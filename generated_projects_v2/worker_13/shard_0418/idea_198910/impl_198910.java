...
@Data
public class Idea198910Config {
    private String name = "idea_198910";
 ...
 */
@Slf4j
public class Idea198910Service {
    private static final int IDEA_ID = 198910;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198910Service() {
        this(new Idea198910Config());
    }

    public Idea198910Service(Idea198910Config config) {
        this.config = config != null ? config : new Idea198910Config();
