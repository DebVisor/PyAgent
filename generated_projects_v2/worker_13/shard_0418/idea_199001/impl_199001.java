...
@Data
public class Idea199001Config {
    private String name = "idea_199001";
 ...
 */
@Slf4j
public class Idea199001Service {
    private static final int IDEA_ID = 199001;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199001Service() {
        this(new Idea199001Config());
    }

    public Idea199001Service(Idea199001Config config) {
        this.config = config != null ? config : new Idea199001Config();
