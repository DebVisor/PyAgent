...
@Data
public class Idea198923Config {
    private String name = "idea_198923";
 ...
 */
@Slf4j
public class Idea198923Service {
    private static final int IDEA_ID = 198923;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198923Service() {
        this(new Idea198923Config());
    }

    public Idea198923Service(Idea198923Config config) {
        this.config = config != null ? config : new Idea198923Config();
