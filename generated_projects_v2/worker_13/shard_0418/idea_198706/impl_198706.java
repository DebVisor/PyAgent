...
@Data
public class Idea198706Config {
    private String name = "idea_198706";
 ...
 */
@Slf4j
public class Idea198706Service {
    private static final int IDEA_ID = 198706;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198706Service() {
        this(new Idea198706Config());
    }

    public Idea198706Service(Idea198706Config config) {
        this.config = config != null ? config : new Idea198706Config();
