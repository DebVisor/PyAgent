...
@Data
public class Idea198936Config {
    private String name = "idea_198936";
 ...
 */
@Slf4j
public class Idea198936Service {
    private static final int IDEA_ID = 198936;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198936Service() {
        this(new Idea198936Config());
    }

    public Idea198936Service(Idea198936Config config) {
        this.config = config != null ? config : new Idea198936Config();
