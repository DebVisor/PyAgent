...
@Data
public class Idea198966Config {
    private String name = "idea_198966";
 ...
 */
@Slf4j
public class Idea198966Service {
    private static final int IDEA_ID = 198966;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198966Service() {
        this(new Idea198966Config());
    }

    public Idea198966Service(Idea198966Config config) {
        this.config = config != null ? config : new Idea198966Config();
