...
@Data
public class Idea199007Config {
    private String name = "idea_199007";
 ...
 */
@Slf4j
public class Idea199007Service {
    private static final int IDEA_ID = 199007;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199007Service() {
        this(new Idea199007Config());
    }

    public Idea199007Service(Idea199007Config config) {
        this.config = config != null ? config : new Idea199007Config();
