...
@Data
public class Idea198651Config {
    private String name = "idea_198651";
 ...
 */
@Slf4j
public class Idea198651Service {
    private static final int IDEA_ID = 198651;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198651Service() {
        this(new Idea198651Config());
    }

    public Idea198651Service(Idea198651Config config) {
        this.config = config != null ? config : new Idea198651Config();
