...
@Data
public class Idea198965Config {
    private String name = "idea_198965";
 ...
 */
@Slf4j
public class Idea198965Service {
    private static final int IDEA_ID = 198965;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198965Service() {
        this(new Idea198965Config());
    }

    public Idea198965Service(Idea198965Config config) {
        this.config = config != null ? config : new Idea198965Config();
