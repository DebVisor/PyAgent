...
@Data
public class Idea198993Config {
    private String name = "idea_198993";
 ...
 */
@Slf4j
public class Idea198993Service {
    private static final int IDEA_ID = 198993;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198993Service() {
        this(new Idea198993Config());
    }

    public Idea198993Service(Idea198993Config config) {
        this.config = config != null ? config : new Idea198993Config();
