...
@Data
public class Idea198688Config {
    private String name = "idea_198688";
 ...
 */
@Slf4j
public class Idea198688Service {
    private static final int IDEA_ID = 198688;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198688Service() {
        this(new Idea198688Config());
    }

    public Idea198688Service(Idea198688Config config) {
        this.config = config != null ? config : new Idea198688Config();
