...
@Data
public class Idea198619Config {
    private String name = "idea_198619";
 ...
 */
@Slf4j
public class Idea198619Service {
    private static final int IDEA_ID = 198619;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198619Service() {
        this(new Idea198619Config());
    }

    public Idea198619Service(Idea198619Config config) {
        this.config = config != null ? config : new Idea198619Config();
