...
@Data
public class Idea199011Config {
    private String name = "idea_199011";
 ...
 */
@Slf4j
public class Idea199011Service {
    private static final int IDEA_ID = 199011;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199011Service() {
        this(new Idea199011Config());
    }

    public Idea199011Service(Idea199011Config config) {
        this.config = config != null ? config : new Idea199011Config();
