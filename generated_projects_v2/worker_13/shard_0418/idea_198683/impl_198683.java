...
@Data
public class Idea198683Config {
    private String name = "idea_198683";
 ...
 */
@Slf4j
public class Idea198683Service {
    private static final int IDEA_ID = 198683;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198683Service() {
        this(new Idea198683Config());
    }

    public Idea198683Service(Idea198683Config config) {
        this.config = config != null ? config : new Idea198683Config();
