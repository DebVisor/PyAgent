...
@Data
public class Idea198982Config {
    private String name = "idea_198982";
 ...
 */
@Slf4j
public class Idea198982Service {
    private static final int IDEA_ID = 198982;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198982Service() {
        this(new Idea198982Config());
    }

    public Idea198982Service(Idea198982Config config) {
        this.config = config != null ? config : new Idea198982Config();
