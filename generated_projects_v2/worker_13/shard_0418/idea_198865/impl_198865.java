...
@Data
public class Idea198865Config {
    private String name = "idea_198865";
 ...
 */
@Slf4j
public class Idea198865Service {
    private static final int IDEA_ID = 198865;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198865Service() {
        this(new Idea198865Config());
    }

    public Idea198865Service(Idea198865Config config) {
        this.config = config != null ? config : new Idea198865Config();
