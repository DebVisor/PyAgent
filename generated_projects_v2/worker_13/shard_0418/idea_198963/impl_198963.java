...
@Data
public class Idea198963Config {
    private String name = "idea_198963";
 ...
 */
@Slf4j
public class Idea198963Service {
    private static final int IDEA_ID = 198963;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198963Service() {
        this(new Idea198963Config());
    }

    public Idea198963Service(Idea198963Config config) {
        this.config = config != null ? config : new Idea198963Config();
