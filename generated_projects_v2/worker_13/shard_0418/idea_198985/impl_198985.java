...
@Data
public class Idea198985Config {
    private String name = "idea_198985";
 ...
 */
@Slf4j
public class Idea198985Service {
    private static final int IDEA_ID = 198985;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198985Service() {
        this(new Idea198985Config());
    }

    public Idea198985Service(Idea198985Config config) {
        this.config = config != null ? config : new Idea198985Config();
