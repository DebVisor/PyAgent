...
@Data
public class Idea198615Config {
    private String name = "idea_198615";
 ...
 */
@Slf4j
public class Idea198615Service {
    private static final int IDEA_ID = 198615;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198615Service() {
        this(new Idea198615Config());
    }

    public Idea198615Service(Idea198615Config config) {
        this.config = config != null ? config : new Idea198615Config();
