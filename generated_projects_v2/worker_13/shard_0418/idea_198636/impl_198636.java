...
@Data
public class Idea198636Config {
    private String name = "idea_198636";
 ...
 */
@Slf4j
public class Idea198636Service {
    private static final int IDEA_ID = 198636;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198636Service() {
        this(new Idea198636Config());
    }

    public Idea198636Service(Idea198636Config config) {
        this.config = config != null ? config : new Idea198636Config();
