...
@Data
public class Idea198884Config {
    private String name = "idea_198884";
 ...
 */
@Slf4j
public class Idea198884Service {
    private static final int IDEA_ID = 198884;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198884Service() {
        this(new Idea198884Config());
    }

    public Idea198884Service(Idea198884Config config) {
        this.config = config != null ? config : new Idea198884Config();
