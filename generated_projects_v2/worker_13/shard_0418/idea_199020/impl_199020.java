...
@Data
public class Idea199020Config {
    private String name = "idea_199020";
 ...
 */
@Slf4j
public class Idea199020Service {
    private static final int IDEA_ID = 199020;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199020Service() {
        this(new Idea199020Config());
    }

    public Idea199020Service(Idea199020Config config) {
        this.config = config != null ? config : new Idea199020Config();
