...
@Data
public class Idea198684Config {
    private String name = "idea_198684";
 ...
 */
@Slf4j
public class Idea198684Service {
    private static final int IDEA_ID = 198684;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198684Service() {
        this(new Idea198684Config());
    }

    public Idea198684Service(Idea198684Config config) {
        this.config = config != null ? config : new Idea198684Config();
