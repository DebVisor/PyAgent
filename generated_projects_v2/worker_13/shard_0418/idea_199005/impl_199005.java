...
@Data
public class Idea199005Config {
    private String name = "idea_199005";
 ...
 */
@Slf4j
public class Idea199005Service {
    private static final int IDEA_ID = 199005;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199005Service() {
        this(new Idea199005Config());
    }

    public Idea199005Service(Idea199005Config config) {
        this.config = config != null ? config : new Idea199005Config();
