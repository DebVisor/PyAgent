...
@Data
public class Idea198746Config {
    private String name = "idea_198746";
 ...
 */
@Slf4j
public class Idea198746Service {
    private static final int IDEA_ID = 198746;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198746Service() {
        this(new Idea198746Config());
    }

    public Idea198746Service(Idea198746Config config) {
        this.config = config != null ? config : new Idea198746Config();
