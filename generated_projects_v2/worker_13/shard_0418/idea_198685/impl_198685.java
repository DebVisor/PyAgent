...
@Data
public class Idea198685Config {
    private String name = "idea_198685";
 ...
 */
@Slf4j
public class Idea198685Service {
    private static final int IDEA_ID = 198685;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198685Service() {
        this(new Idea198685Config());
    }

    public Idea198685Service(Idea198685Config config) {
        this.config = config != null ? config : new Idea198685Config();
