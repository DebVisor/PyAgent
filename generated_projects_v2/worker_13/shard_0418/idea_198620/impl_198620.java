...
@Data
public class Idea198620Config {
    private String name = "idea_198620";
 ...
 */
@Slf4j
public class Idea198620Service {
    private static final int IDEA_ID = 198620;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198620Service() {
        this(new Idea198620Config());
    }

    public Idea198620Service(Idea198620Config config) {
        this.config = config != null ? config : new Idea198620Config();
