...
@Data
public class Idea198641Config {
    private String name = "idea_198641";
 ...
 */
@Slf4j
public class Idea198641Service {
    private static final int IDEA_ID = 198641;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198641Service() {
        this(new Idea198641Config());
    }

    public Idea198641Service(Idea198641Config config) {
        this.config = config != null ? config : new Idea198641Config();
