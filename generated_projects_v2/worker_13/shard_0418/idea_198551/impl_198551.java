...
@Data
public class Idea198551Config {
    private String name = "idea_198551";
 ...
 */
@Slf4j
public class Idea198551Service {
    private static final int IDEA_ID = 198551;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198551Service() {
        this(new Idea198551Config());
    }

    public Idea198551Service(Idea198551Config config) {
        this.config = config != null ? config : new Idea198551Config();
