...
@Data
public class Idea198951Config {
    private String name = "idea_198951";
 ...
 */
@Slf4j
public class Idea198951Service {
    private static final int IDEA_ID = 198951;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198951Service() {
        this(new Idea198951Config());
    }

    public Idea198951Service(Idea198951Config config) {
        this.config = config != null ? config : new Idea198951Config();
