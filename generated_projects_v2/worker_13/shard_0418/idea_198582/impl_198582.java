...
@Data
public class Idea198582Config {
    private String name = "idea_198582";
 ...
 */
@Slf4j
public class Idea198582Service {
    private static final int IDEA_ID = 198582;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198582Service() {
        this(new Idea198582Config());
    }

    public Idea198582Service(Idea198582Config config) {
        this.config = config != null ? config : new Idea198582Config();
