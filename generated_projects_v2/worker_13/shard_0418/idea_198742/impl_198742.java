...
@Data
public class Idea198742Config {
    private String name = "idea_198742";
 ...
 */
@Slf4j
public class Idea198742Service {
    private static final int IDEA_ID = 198742;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198742Service() {
        this(new Idea198742Config());
    }

    public Idea198742Service(Idea198742Config config) {
        this.config = config != null ? config : new Idea198742Config();
