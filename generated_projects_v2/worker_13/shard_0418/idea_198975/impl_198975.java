...
@Data
public class Idea198975Config {
    private String name = "idea_198975";
 ...
 */
@Slf4j
public class Idea198975Service {
    private static final int IDEA_ID = 198975;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198975Service() {
        this(new Idea198975Config());
    }

    public Idea198975Service(Idea198975Config config) {
        this.config = config != null ? config : new Idea198975Config();
