...
@Data
public class Idea198843Config {
    private String name = "idea_198843";
 ...
 */
@Slf4j
public class Idea198843Service {
    private static final int IDEA_ID = 198843;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198843Service() {
        this(new Idea198843Config());
    }

    public Idea198843Service(Idea198843Config config) {
        this.config = config != null ? config : new Idea198843Config();
