...
@Data
public class Idea198876Config {
    private String name = "idea_198876";
 ...
 */
@Slf4j
public class Idea198876Service {
    private static final int IDEA_ID = 198876;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198876Service() {
        this(new Idea198876Config());
    }

    public Idea198876Service(Idea198876Config config) {
        this.config = config != null ? config : new Idea198876Config();
