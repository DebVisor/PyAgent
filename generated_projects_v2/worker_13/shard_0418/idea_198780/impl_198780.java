...
@Data
public class Idea198780Config {
    private String name = "idea_198780";
 ...
 */
@Slf4j
public class Idea198780Service {
    private static final int IDEA_ID = 198780;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198780Service() {
        this(new Idea198780Config());
    }

    public Idea198780Service(Idea198780Config config) {
        this.config = config != null ? config : new Idea198780Config();
