...
@Data
public class Idea198979Config {
    private String name = "idea_198979";
 ...
 */
@Slf4j
public class Idea198979Service {
    private static final int IDEA_ID = 198979;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198979Service() {
        this(new Idea198979Config());
    }

    public Idea198979Service(Idea198979Config config) {
        this.config = config != null ? config : new Idea198979Config();
