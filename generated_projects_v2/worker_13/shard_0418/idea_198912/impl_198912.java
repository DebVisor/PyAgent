...
@Data
public class Idea198912Config {
    private String name = "idea_198912";
 ...
 */
@Slf4j
public class Idea198912Service {
    private static final int IDEA_ID = 198912;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198912Service() {
        this(new Idea198912Config());
    }

    public Idea198912Service(Idea198912Config config) {
        this.config = config != null ? config : new Idea198912Config();
