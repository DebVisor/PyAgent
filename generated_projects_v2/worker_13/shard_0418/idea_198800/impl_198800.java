...
@Data
public class Idea198800Config {
    private String name = "idea_198800";
 ...
 */
@Slf4j
public class Idea198800Service {
    private static final int IDEA_ID = 198800;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198800Service() {
        this(new Idea198800Config());
    }

    public Idea198800Service(Idea198800Config config) {
        this.config = config != null ? config : new Idea198800Config();
