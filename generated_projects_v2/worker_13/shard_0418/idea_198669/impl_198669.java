...
@Data
public class Idea198669Config {
    private String name = "idea_198669";
 ...
 */
@Slf4j
public class Idea198669Service {
    private static final int IDEA_ID = 198669;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198669Service() {
        this(new Idea198669Config());
    }

    public Idea198669Service(Idea198669Config config) {
        this.config = config != null ? config : new Idea198669Config();
