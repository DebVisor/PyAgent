...
@Data
public class Idea198708Config {
    private String name = "idea_198708";
 ...
 */
@Slf4j
public class Idea198708Service {
    private static final int IDEA_ID = 198708;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198708Service() {
        this(new Idea198708Config());
    }

    public Idea198708Service(Idea198708Config config) {
        this.config = config != null ? config : new Idea198708Config();
