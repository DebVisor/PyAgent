...
@Data
public class Idea198614Config {
    private String name = "idea_198614";
 ...
 */
@Slf4j
public class Idea198614Service {
    private static final int IDEA_ID = 198614;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198614Service() {
        this(new Idea198614Config());
    }

    public Idea198614Service(Idea198614Config config) {
        this.config = config != null ? config : new Idea198614Config();
