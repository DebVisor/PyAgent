...
@Data
public class Idea198799Config {
    private String name = "idea_198799";
 ...
 */
@Slf4j
public class Idea198799Service {
    private static final int IDEA_ID = 198799;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198799Service() {
        this(new Idea198799Config());
    }

    public Idea198799Service(Idea198799Config config) {
        this.config = config != null ? config : new Idea198799Config();
