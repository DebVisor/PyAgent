...
@Data
public class Idea198712Config {
    private String name = "idea_198712";
 ...
 */
@Slf4j
public class Idea198712Service {
    private static final int IDEA_ID = 198712;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198712Service() {
        this(new Idea198712Config());
    }

    public Idea198712Service(Idea198712Config config) {
        this.config = config != null ? config : new Idea198712Config();
