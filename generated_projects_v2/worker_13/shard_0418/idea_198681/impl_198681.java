...
@Data
public class Idea198681Config {
    private String name = "idea_198681";
 ...
 */
@Slf4j
public class Idea198681Service {
    private static final int IDEA_ID = 198681;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198681Service() {
        this(new Idea198681Config());
    }

    public Idea198681Service(Idea198681Config config) {
        this.config = config != null ? config : new Idea198681Config();
