...
@Data
public class Idea198949Config {
    private String name = "idea_198949";
 ...
 */
@Slf4j
public class Idea198949Service {
    private static final int IDEA_ID = 198949;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198949Service() {
        this(new Idea198949Config());
    }

    public Idea198949Service(Idea198949Config config) {
        this.config = config != null ? config : new Idea198949Config();
