...
@Data
public class Idea198562Config {
    private String name = "idea_198562";
 ...
 */
@Slf4j
public class Idea198562Service {
    private static final int IDEA_ID = 198562;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198562Service() {
        this(new Idea198562Config());
    }

    public Idea198562Service(Idea198562Config config) {
        this.config = config != null ? config : new Idea198562Config();
