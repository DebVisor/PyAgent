...
@Data
public class Idea198861Config {
    private String name = "idea_198861";
 ...
 */
@Slf4j
public class Idea198861Service {
    private static final int IDEA_ID = 198861;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198861Service() {
        this(new Idea198861Config());
    }

    public Idea198861Service(Idea198861Config config) {
        this.config = config != null ? config : new Idea198861Config();
