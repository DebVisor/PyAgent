...
@Data
public class Idea198628Config {
    private String name = "idea_198628";
 ...
 */
@Slf4j
public class Idea198628Service {
    private static final int IDEA_ID = 198628;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198628Service() {
        this(new Idea198628Config());
    }

    public Idea198628Service(Idea198628Config config) {
        this.config = config != null ? config : new Idea198628Config();
