...
@Data
public class Idea198939Config {
    private String name = "idea_198939";
 ...
 */
@Slf4j
public class Idea198939Service {
    private static final int IDEA_ID = 198939;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198939Service() {
        this(new Idea198939Config());
    }

    public Idea198939Service(Idea198939Config config) {
        this.config = config != null ? config : new Idea198939Config();
