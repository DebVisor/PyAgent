...
@Data
public class Idea198880Config {
    private String name = "idea_198880";
 ...
 */
@Slf4j
public class Idea198880Service {
    private static final int IDEA_ID = 198880;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198880Service() {
        this(new Idea198880Config());
    }

    public Idea198880Service(Idea198880Config config) {
        this.config = config != null ? config : new Idea198880Config();
