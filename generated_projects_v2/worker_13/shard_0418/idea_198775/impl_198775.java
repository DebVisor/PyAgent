...
@Data
public class Idea198775Config {
    private String name = "idea_198775";
 ...
 */
@Slf4j
public class Idea198775Service {
    private static final int IDEA_ID = 198775;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198775Service() {
        this(new Idea198775Config());
    }

    public Idea198775Service(Idea198775Config config) {
        this.config = config != null ? config : new Idea198775Config();
