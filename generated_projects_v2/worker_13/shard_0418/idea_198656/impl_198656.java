...
@Data
public class Idea198656Config {
    private String name = "idea_198656";
 ...
 */
@Slf4j
public class Idea198656Service {
    private static final int IDEA_ID = 198656;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198656Service() {
        this(new Idea198656Config());
    }

    public Idea198656Service(Idea198656Config config) {
        this.config = config != null ? config : new Idea198656Config();
