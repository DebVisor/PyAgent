...
@Data
public class Idea198601Config {
    private String name = "idea_198601";
 ...
 */
@Slf4j
public class Idea198601Service {
    private static final int IDEA_ID = 198601;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198601Service() {
        this(new Idea198601Config());
    }

    public Idea198601Service(Idea198601Config config) {
        this.config = config != null ? config : new Idea198601Config();
