...
@Data
public class Idea198929Config {
    private String name = "idea_198929";
 ...
 */
@Slf4j
public class Idea198929Service {
    private static final int IDEA_ID = 198929;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198929Service() {
        this(new Idea198929Config());
    }

    public Idea198929Service(Idea198929Config config) {
        this.config = config != null ? config : new Idea198929Config();
