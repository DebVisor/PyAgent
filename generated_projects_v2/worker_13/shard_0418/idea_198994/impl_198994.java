...
@Data
public class Idea198994Config {
    private String name = "idea_198994";
 ...
 */
@Slf4j
public class Idea198994Service {
    private static final int IDEA_ID = 198994;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198994Service() {
        this(new Idea198994Config());
    }

    public Idea198994Service(Idea198994Config config) {
        this.config = config != null ? config : new Idea198994Config();
