...
@Data
public class Idea198792Config {
    private String name = "idea_198792";
 ...
 */
@Slf4j
public class Idea198792Service {
    private static final int IDEA_ID = 198792;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198792Service() {
        this(new Idea198792Config());
    }

    public Idea198792Service(Idea198792Config config) {
        this.config = config != null ? config : new Idea198792Config();
