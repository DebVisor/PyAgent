...
@Data
public class Idea198857Config {
    private String name = "idea_198857";
 ...
 */
@Slf4j
public class Idea198857Service {
    private static final int IDEA_ID = 198857;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198857Service() {
        this(new Idea198857Config());
    }

    public Idea198857Service(Idea198857Config config) {
        this.config = config != null ? config : new Idea198857Config();
