...
@Data
public class Idea199023Config {
    private String name = "idea_199023";
 ...
 */
@Slf4j
public class Idea199023Service {
    private static final int IDEA_ID = 199023;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199023Service() {
        this(new Idea199023Config());
    }

    public Idea199023Service(Idea199023Config config) {
        this.config = config != null ? config : new Idea199023Config();
