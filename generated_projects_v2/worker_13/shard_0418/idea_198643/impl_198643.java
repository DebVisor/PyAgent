...
@Data
public class Idea198643Config {
    private String name = "idea_198643";
 ...
 */
@Slf4j
public class Idea198643Service {
    private static final int IDEA_ID = 198643;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198643Service() {
        this(new Idea198643Config());
    }

    public Idea198643Service(Idea198643Config config) {
        this.config = config != null ? config : new Idea198643Config();
