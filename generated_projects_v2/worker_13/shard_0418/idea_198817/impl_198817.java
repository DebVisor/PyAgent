...
@Data
public class Idea198817Config {
    private String name = "idea_198817";
 ...
 */
@Slf4j
public class Idea198817Service {
    private static final int IDEA_ID = 198817;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198817Service() {
        this(new Idea198817Config());
    }

    public Idea198817Service(Idea198817Config config) {
        this.config = config != null ? config : new Idea198817Config();
