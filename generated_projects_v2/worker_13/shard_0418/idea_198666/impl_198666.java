...
@Data
public class Idea198666Config {
    private String name = "idea_198666";
 ...
 */
@Slf4j
public class Idea198666Service {
    private static final int IDEA_ID = 198666;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198666Service() {
        this(new Idea198666Config());
    }

    public Idea198666Service(Idea198666Config config) {
        this.config = config != null ? config : new Idea198666Config();
