...
@Data
public class Idea198711Config {
    private String name = "idea_198711";
 ...
 */
@Slf4j
public class Idea198711Service {
    private static final int IDEA_ID = 198711;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198711Service() {
        this(new Idea198711Config());
    }

    public Idea198711Service(Idea198711Config config) {
        this.config = config != null ? config : new Idea198711Config();
