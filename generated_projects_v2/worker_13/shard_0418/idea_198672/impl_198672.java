...
@Data
public class Idea198672Config {
    private String name = "idea_198672";
 ...
 */
@Slf4j
public class Idea198672Service {
    private static final int IDEA_ID = 198672;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198672Service() {
        this(new Idea198672Config());
    }

    public Idea198672Service(Idea198672Config config) {
        this.config = config != null ? config : new Idea198672Config();
