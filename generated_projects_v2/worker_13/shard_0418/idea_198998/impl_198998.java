...
@Data
public class Idea198998Config {
    private String name = "idea_198998";
 ...
 */
@Slf4j
public class Idea198998Service {
    private static final int IDEA_ID = 198998;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198998Service() {
        this(new Idea198998Config());
    }

    public Idea198998Service(Idea198998Config config) {
        this.config = config != null ? config : new Idea198998Config();
