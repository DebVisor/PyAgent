...
@Data
public class Idea198915Config {
    private String name = "idea_198915";
 ...
 */
@Slf4j
public class Idea198915Service {
    private static final int IDEA_ID = 198915;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198915Service() {
        this(new Idea198915Config());
    }

    public Idea198915Service(Idea198915Config config) {
        this.config = config != null ? config : new Idea198915Config();
