...
@Data
public class Idea198807Config {
    private String name = "idea_198807";
 ...
 */
@Slf4j
public class Idea198807Service {
    private static final int IDEA_ID = 198807;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198807Service() {
        this(new Idea198807Config());
    }

    public Idea198807Service(Idea198807Config config) {
        this.config = config != null ? config : new Idea198807Config();
