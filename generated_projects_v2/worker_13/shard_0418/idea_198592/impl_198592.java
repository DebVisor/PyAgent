...
@Data
public class Idea198592Config {
    private String name = "idea_198592";
 ...
 */
@Slf4j
public class Idea198592Service {
    private static final int IDEA_ID = 198592;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198592Service() {
        this(new Idea198592Config());
    }

    public Idea198592Service(Idea198592Config config) {
        this.config = config != null ? config : new Idea198592Config();
