...
@Data
public class Idea198784Config {
    private String name = "idea_198784";
 ...
 */
@Slf4j
public class Idea198784Service {
    private static final int IDEA_ID = 198784;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198784Service() {
        this(new Idea198784Config());
    }

    public Idea198784Service(Idea198784Config config) {
        this.config = config != null ? config : new Idea198784Config();
