...
@Data
public class Idea198778Config {
    private String name = "idea_198778";
 ...
 */
@Slf4j
public class Idea198778Service {
    private static final int IDEA_ID = 198778;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198778Service() {
        this(new Idea198778Config());
    }

    public Idea198778Service(Idea198778Config config) {
        this.config = config != null ? config : new Idea198778Config();
