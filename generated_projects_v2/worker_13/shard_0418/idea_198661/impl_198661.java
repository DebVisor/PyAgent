...
@Data
public class Idea198661Config {
    private String name = "idea_198661";
 ...
 */
@Slf4j
public class Idea198661Service {
    private static final int IDEA_ID = 198661;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198661Service() {
        this(new Idea198661Config());
    }

    public Idea198661Service(Idea198661Config config) {
        this.config = config != null ? config : new Idea198661Config();
