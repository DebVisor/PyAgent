...
@Data
public class Idea198723Config {
    private String name = "idea_198723";
 ...
 */
@Slf4j
public class Idea198723Service {
    private static final int IDEA_ID = 198723;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198723Service() {
        this(new Idea198723Config());
    }

    public Idea198723Service(Idea198723Config config) {
        this.config = config != null ? config : new Idea198723Config();
