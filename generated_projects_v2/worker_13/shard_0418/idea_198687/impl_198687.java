...
@Data
public class Idea198687Config {
    private String name = "idea_198687";
 ...
 */
@Slf4j
public class Idea198687Service {
    private static final int IDEA_ID = 198687;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198687Service() {
        this(new Idea198687Config());
    }

    public Idea198687Service(Idea198687Config config) {
        this.config = config != null ? config : new Idea198687Config();
