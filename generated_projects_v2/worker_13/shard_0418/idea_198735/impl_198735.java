...
@Data
public class Idea198735Config {
    private String name = "idea_198735";
 ...
 */
@Slf4j
public class Idea198735Service {
    private static final int IDEA_ID = 198735;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198735Service() {
        this(new Idea198735Config());
    }

    public Idea198735Service(Idea198735Config config) {
        this.config = config != null ? config : new Idea198735Config();
