...
@Data
public class Idea198655Config {
    private String name = "idea_198655";
 ...
 */
@Slf4j
public class Idea198655Service {
    private static final int IDEA_ID = 198655;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198655Service() {
        this(new Idea198655Config());
    }

    public Idea198655Service(Idea198655Config config) {
        this.config = config != null ? config : new Idea198655Config();
