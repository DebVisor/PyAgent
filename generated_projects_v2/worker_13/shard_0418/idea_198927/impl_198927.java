...
@Data
public class Idea198927Config {
    private String name = "idea_198927";
 ...
 */
@Slf4j
public class Idea198927Service {
    private static final int IDEA_ID = 198927;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198927Service() {
        this(new Idea198927Config());
    }

    public Idea198927Service(Idea198927Config config) {
        this.config = config != null ? config : new Idea198927Config();
