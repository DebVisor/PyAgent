...
@Data
public class Idea198839Config {
    private String name = "idea_198839";
 ...
 */
@Slf4j
public class Idea198839Service {
    private static final int IDEA_ID = 198839;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198839Service() {
        this(new Idea198839Config());
    }

    public Idea198839Service(Idea198839Config config) {
        this.config = config != null ? config : new Idea198839Config();
