...
@Data
public class Idea198877Config {
    private String name = "idea_198877";
 ...
 */
@Slf4j
public class Idea198877Service {
    private static final int IDEA_ID = 198877;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198877Service() {
        this(new Idea198877Config());
    }

    public Idea198877Service(Idea198877Config config) {
        this.config = config != null ? config : new Idea198877Config();
