...
@Data
public class Idea198842Config {
    private String name = "idea_198842";
 ...
 */
@Slf4j
public class Idea198842Service {
    private static final int IDEA_ID = 198842;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198842Service() {
        this(new Idea198842Config());
    }

    public Idea198842Service(Idea198842Config config) {
        this.config = config != null ? config : new Idea198842Config();
