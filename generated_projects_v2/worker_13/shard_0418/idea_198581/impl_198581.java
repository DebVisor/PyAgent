...
@Data
public class Idea198581Config {
    private String name = "idea_198581";
 ...
 */
@Slf4j
public class Idea198581Service {
    private static final int IDEA_ID = 198581;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198581Service() {
        this(new Idea198581Config());
    }

    public Idea198581Service(Idea198581Config config) {
        this.config = config != null ? config : new Idea198581Config();
