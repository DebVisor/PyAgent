...
@Data
public class Idea198970Config {
    private String name = "idea_198970";
 ...
 */
@Slf4j
public class Idea198970Service {
    private static final int IDEA_ID = 198970;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198970Service() {
        this(new Idea198970Config());
    }

    public Idea198970Service(Idea198970Config config) {
        this.config = config != null ? config : new Idea198970Config();
