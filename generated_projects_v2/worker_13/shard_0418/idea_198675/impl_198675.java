...
@Data
public class Idea198675Config {
    private String name = "idea_198675";
 ...
 */
@Slf4j
public class Idea198675Service {
    private static final int IDEA_ID = 198675;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198675Service() {
        this(new Idea198675Config());
    }

    public Idea198675Service(Idea198675Config config) {
        this.config = config != null ? config : new Idea198675Config();
