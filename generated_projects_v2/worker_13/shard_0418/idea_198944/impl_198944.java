...
@Data
public class Idea198944Config {
    private String name = "idea_198944";
 ...
 */
@Slf4j
public class Idea198944Service {
    private static final int IDEA_ID = 198944;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198944Service() {
        this(new Idea198944Config());
    }

    public Idea198944Service(Idea198944Config config) {
        this.config = config != null ? config : new Idea198944Config();
