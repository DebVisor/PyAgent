...
@Data
public class Idea198618Config {
    private String name = "idea_198618";
 ...
 */
@Slf4j
public class Idea198618Service {
    private static final int IDEA_ID = 198618;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198618Service() {
        this(new Idea198618Config());
    }

    public Idea198618Service(Idea198618Config config) {
        this.config = config != null ? config : new Idea198618Config();
