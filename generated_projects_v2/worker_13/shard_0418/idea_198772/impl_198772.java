...
@Data
public class Idea198772Config {
    private String name = "idea_198772";
 ...
 */
@Slf4j
public class Idea198772Service {
    private static final int IDEA_ID = 198772;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198772Service() {
        this(new Idea198772Config());
    }

    public Idea198772Service(Idea198772Config config) {
        this.config = config != null ? config : new Idea198772Config();
