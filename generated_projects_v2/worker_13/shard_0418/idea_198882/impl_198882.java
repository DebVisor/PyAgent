...
@Data
public class Idea198882Config {
    private String name = "idea_198882";
 ...
 */
@Slf4j
public class Idea198882Service {
    private static final int IDEA_ID = 198882;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198882Service() {
        this(new Idea198882Config());
    }

    public Idea198882Service(Idea198882Config config) {
        this.config = config != null ? config : new Idea198882Config();
