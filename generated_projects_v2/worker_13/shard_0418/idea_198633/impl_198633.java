...
@Data
public class Idea198633Config {
    private String name = "idea_198633";
 ...
 */
@Slf4j
public class Idea198633Service {
    private static final int IDEA_ID = 198633;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198633Service() {
        this(new Idea198633Config());
    }

    public Idea198633Service(Idea198633Config config) {
        this.config = config != null ? config : new Idea198633Config();
