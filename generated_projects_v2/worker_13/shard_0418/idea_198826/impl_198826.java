...
@Data
public class Idea198826Config {
    private String name = "idea_198826";
 ...
 */
@Slf4j
public class Idea198826Service {
    private static final int IDEA_ID = 198826;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198826Service() {
        this(new Idea198826Config());
    }

    public Idea198826Service(Idea198826Config config) {
        this.config = config != null ? config : new Idea198826Config();
