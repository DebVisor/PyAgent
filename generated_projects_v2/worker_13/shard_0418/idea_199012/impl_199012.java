...
@Data
public class Idea199012Config {
    private String name = "idea_199012";
 ...
 */
@Slf4j
public class Idea199012Service {
    private static final int IDEA_ID = 199012;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199012Service() {
        this(new Idea199012Config());
    }

    public Idea199012Service(Idea199012Config config) {
        this.config = config != null ? config : new Idea199012Config();
