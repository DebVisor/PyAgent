...
@Data
public class Idea198647Config {
    private String name = "idea_198647";
 ...
 */
@Slf4j
public class Idea198647Service {
    private static final int IDEA_ID = 198647;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198647Service() {
        this(new Idea198647Config());
    }

    public Idea198647Service(Idea198647Config config) {
        this.config = config != null ? config : new Idea198647Config();
