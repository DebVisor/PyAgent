...
@Data
public class Idea198748Config {
    private String name = "idea_198748";
 ...
 */
@Slf4j
public class Idea198748Service {
    private static final int IDEA_ID = 198748;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198748Service() {
        this(new Idea198748Config());
    }

    public Idea198748Service(Idea198748Config config) {
        this.config = config != null ? config : new Idea198748Config();
