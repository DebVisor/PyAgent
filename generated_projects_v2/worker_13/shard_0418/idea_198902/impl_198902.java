...
@Data
public class Idea198902Config {
    private String name = "idea_198902";
 ...
 */
@Slf4j
public class Idea198902Service {
    private static final int IDEA_ID = 198902;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198902Service() {
        this(new Idea198902Config());
    }

    public Idea198902Service(Idea198902Config config) {
        this.config = config != null ? config : new Idea198902Config();
