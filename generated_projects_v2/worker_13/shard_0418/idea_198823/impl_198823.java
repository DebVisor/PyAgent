...
@Data
public class Idea198823Config {
    private String name = "idea_198823";
 ...
 */
@Slf4j
public class Idea198823Service {
    private static final int IDEA_ID = 198823;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198823Service() {
        this(new Idea198823Config());
    }

    public Idea198823Service(Idea198823Config config) {
        this.config = config != null ? config : new Idea198823Config();
