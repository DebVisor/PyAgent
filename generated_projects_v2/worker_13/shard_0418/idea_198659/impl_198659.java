...
@Data
public class Idea198659Config {
    private String name = "idea_198659";
 ...
 */
@Slf4j
public class Idea198659Service {
    private static final int IDEA_ID = 198659;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198659Service() {
        this(new Idea198659Config());
    }

    public Idea198659Service(Idea198659Config config) {
        this.config = config != null ? config : new Idea198659Config();
