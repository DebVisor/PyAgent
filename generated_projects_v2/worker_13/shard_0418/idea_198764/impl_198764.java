...
@Data
public class Idea198764Config {
    private String name = "idea_198764";
 ...
 */
@Slf4j
public class Idea198764Service {
    private static final int IDEA_ID = 198764;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198764Service() {
        this(new Idea198764Config());
    }

    public Idea198764Service(Idea198764Config config) {
        this.config = config != null ? config : new Idea198764Config();
