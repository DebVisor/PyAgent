...
@Data
public class Idea198846Config {
    private String name = "idea_198846";
 ...
 */
@Slf4j
public class Idea198846Service {
    private static final int IDEA_ID = 198846;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198846Service() {
        this(new Idea198846Config());
    }

    public Idea198846Service(Idea198846Config config) {
        this.config = config != null ? config : new Idea198846Config();
