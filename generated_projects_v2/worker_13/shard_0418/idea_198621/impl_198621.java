...
@Data
public class Idea198621Config {
    private String name = "idea_198621";
 ...
 */
@Slf4j
public class Idea198621Service {
    private static final int IDEA_ID = 198621;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198621Service() {
        this(new Idea198621Config());
    }

    public Idea198621Service(Idea198621Config config) {
        this.config = config != null ? config : new Idea198621Config();
