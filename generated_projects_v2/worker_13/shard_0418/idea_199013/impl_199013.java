...
@Data
public class Idea199013Config {
    private String name = "idea_199013";
 ...
 */
@Slf4j
public class Idea199013Service {
    private static final int IDEA_ID = 199013;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199013Service() {
        this(new Idea199013Config());
    }

    public Idea199013Service(Idea199013Config config) {
        this.config = config != null ? config : new Idea199013Config();
