...
@Data
public class Idea198896Config {
    private String name = "idea_198896";
 ...
 */
@Slf4j
public class Idea198896Service {
    private static final int IDEA_ID = 198896;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198896Service() {
        this(new Idea198896Config());
    }

    public Idea198896Service(Idea198896Config config) {
        this.config = config != null ? config : new Idea198896Config();
