...
@Data
public class Idea198625Config {
    private String name = "idea_198625";
 ...
 */
@Slf4j
public class Idea198625Service {
    private static final int IDEA_ID = 198625;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198625Service() {
        this(new Idea198625Config());
    }

    public Idea198625Service(Idea198625Config config) {
        this.config = config != null ? config : new Idea198625Config();
