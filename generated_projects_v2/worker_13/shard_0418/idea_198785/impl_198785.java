...
@Data
public class Idea198785Config {
    private String name = "idea_198785";
 ...
 */
@Slf4j
public class Idea198785Service {
    private static final int IDEA_ID = 198785;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198785Service() {
        this(new Idea198785Config());
    }

    public Idea198785Service(Idea198785Config config) {
        this.config = config != null ? config : new Idea198785Config();
