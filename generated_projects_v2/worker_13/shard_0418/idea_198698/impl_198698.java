...
@Data
public class Idea198698Config {
    private String name = "idea_198698";
 ...
 */
@Slf4j
public class Idea198698Service {
    private static final int IDEA_ID = 198698;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198698Service() {
        this(new Idea198698Config());
    }

    public Idea198698Service(Idea198698Config config) {
        this.config = config != null ? config : new Idea198698Config();
