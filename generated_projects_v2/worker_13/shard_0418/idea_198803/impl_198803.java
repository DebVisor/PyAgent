...
@Data
public class Idea198803Config {
    private String name = "idea_198803";
 ...
 */
@Slf4j
public class Idea198803Service {
    private static final int IDEA_ID = 198803;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198803Service() {
        this(new Idea198803Config());
    }

    public Idea198803Service(Idea198803Config config) {
        this.config = config != null ? config : new Idea198803Config();
