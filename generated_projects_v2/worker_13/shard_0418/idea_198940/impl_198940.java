...
@Data
public class Idea198940Config {
    private String name = "idea_198940";
 ...
 */
@Slf4j
public class Idea198940Service {
    private static final int IDEA_ID = 198940;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198940Service() {
        this(new Idea198940Config());
    }

    public Idea198940Service(Idea198940Config config) {
        this.config = config != null ? config : new Idea198940Config();
