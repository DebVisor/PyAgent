...
@Data
public class Idea198732Config {
    private String name = "idea_198732";
 ...
 */
@Slf4j
public class Idea198732Service {
    private static final int IDEA_ID = 198732;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198732Service() {
        this(new Idea198732Config());
    }

    public Idea198732Service(Idea198732Config config) {
        this.config = config != null ? config : new Idea198732Config();
