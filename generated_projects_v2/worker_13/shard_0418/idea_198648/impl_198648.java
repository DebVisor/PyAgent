...
@Data
public class Idea198648Config {
    private String name = "idea_198648";
 ...
 */
@Slf4j
public class Idea198648Service {
    private static final int IDEA_ID = 198648;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198648Service() {
        this(new Idea198648Config());
    }

    public Idea198648Service(Idea198648Config config) {
        this.config = config != null ? config : new Idea198648Config();
