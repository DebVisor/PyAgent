...
@Data
public class Idea198640Config {
    private String name = "idea_198640";
 ...
 */
@Slf4j
public class Idea198640Service {
    private static final int IDEA_ID = 198640;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198640Service() {
        this(new Idea198640Config());
    }

    public Idea198640Service(Idea198640Config config) {
        this.config = config != null ? config : new Idea198640Config();
