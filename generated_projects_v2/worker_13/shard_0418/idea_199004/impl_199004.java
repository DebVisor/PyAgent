...
@Data
public class Idea199004Config {
    private String name = "idea_199004";
 ...
 */
@Slf4j
public class Idea199004Service {
    private static final int IDEA_ID = 199004;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199004Service() {
        this(new Idea199004Config());
    }

    public Idea199004Service(Idea199004Config config) {
        this.config = config != null ? config : new Idea199004Config();
