...
@Data
public class Idea198776Config {
    private String name = "idea_198776";
 ...
 */
@Slf4j
public class Idea198776Service {
    private static final int IDEA_ID = 198776;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198776Service() {
        this(new Idea198776Config());
    }

    public Idea198776Service(Idea198776Config config) {
        this.config = config != null ? config : new Idea198776Config();
