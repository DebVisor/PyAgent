...
@Data
public class Idea198644Config {
    private String name = "idea_198644";
 ...
 */
@Slf4j
public class Idea198644Service {
    private static final int IDEA_ID = 198644;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198644Service() {
        this(new Idea198644Config());
    }

    public Idea198644Service(Idea198644Config config) {
        this.config = config != null ? config : new Idea198644Config();
