...
@Data
public class Idea198852Config {
    private String name = "idea_198852";
 ...
 */
@Slf4j
public class Idea198852Service {
    private static final int IDEA_ID = 198852;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198852Service() {
        this(new Idea198852Config());
    }

    public Idea198852Service(Idea198852Config config) {
        this.config = config != null ? config : new Idea198852Config();
