...
@Data
public class Idea198881Config {
    private String name = "idea_198881";
 ...
 */
@Slf4j
public class Idea198881Service {
    private static final int IDEA_ID = 198881;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198881Service() {
        this(new Idea198881Config());
    }

    public Idea198881Service(Idea198881Config config) {
        this.config = config != null ? config : new Idea198881Config();
