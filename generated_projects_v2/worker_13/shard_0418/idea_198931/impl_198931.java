...
@Data
public class Idea198931Config {
    private String name = "idea_198931";
 ...
 */
@Slf4j
public class Idea198931Service {
    private static final int IDEA_ID = 198931;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198931Service() {
        this(new Idea198931Config());
    }

    public Idea198931Service(Idea198931Config config) {
        this.config = config != null ? config : new Idea198931Config();
