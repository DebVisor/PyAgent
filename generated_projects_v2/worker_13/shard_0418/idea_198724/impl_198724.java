...
@Data
public class Idea198724Config {
    private String name = "idea_198724";
 ...
 */
@Slf4j
public class Idea198724Service {
    private static final int IDEA_ID = 198724;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198724Service() {
        this(new Idea198724Config());
    }

    public Idea198724Service(Idea198724Config config) {
        this.config = config != null ? config : new Idea198724Config();
