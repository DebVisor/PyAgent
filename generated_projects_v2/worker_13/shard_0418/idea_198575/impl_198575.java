...
@Data
public class Idea198575Config {
    private String name = "idea_198575";
 ...
 */
@Slf4j
public class Idea198575Service {
    private static final int IDEA_ID = 198575;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198575Service() {
        this(new Idea198575Config());
    }

    public Idea198575Service(Idea198575Config config) {
        this.config = config != null ? config : new Idea198575Config();
