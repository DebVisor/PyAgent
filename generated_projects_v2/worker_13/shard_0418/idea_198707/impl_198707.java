...
@Data
public class Idea198707Config {
    private String name = "idea_198707";
 ...
 */
@Slf4j
public class Idea198707Service {
    private static final int IDEA_ID = 198707;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198707Service() {
        this(new Idea198707Config());
    }

    public Idea198707Service(Idea198707Config config) {
        this.config = config != null ? config : new Idea198707Config();
