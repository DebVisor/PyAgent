...
@Data
public class Idea198888Config {
    private String name = "idea_198888";
 ...
 */
@Slf4j
public class Idea198888Service {
    private static final int IDEA_ID = 198888;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198888Service() {
        this(new Idea198888Config());
    }

    public Idea198888Service(Idea198888Config config) {
        this.config = config != null ? config : new Idea198888Config();
