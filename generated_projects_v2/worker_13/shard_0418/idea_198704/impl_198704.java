...
@Data
public class Idea198704Config {
    private String name = "idea_198704";
 ...
 */
@Slf4j
public class Idea198704Service {
    private static final int IDEA_ID = 198704;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198704Service() {
        this(new Idea198704Config());
    }

    public Idea198704Service(Idea198704Config config) {
        this.config = config != null ? config : new Idea198704Config();
