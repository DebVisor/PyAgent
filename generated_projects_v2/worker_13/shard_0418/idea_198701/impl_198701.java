...
@Data
public class Idea198701Config {
    private String name = "idea_198701";
 ...
 */
@Slf4j
public class Idea198701Service {
    private static final int IDEA_ID = 198701;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198701Service() {
        this(new Idea198701Config());
    }

    public Idea198701Service(Idea198701Config config) {
        this.config = config != null ? config : new Idea198701Config();
