...
@Data
public class Idea198972Config {
    private String name = "idea_198972";
 ...
 */
@Slf4j
public class Idea198972Service {
    private static final int IDEA_ID = 198972;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198972Service() {
        this(new Idea198972Config());
    }

    public Idea198972Service(Idea198972Config config) {
        this.config = config != null ? config : new Idea198972Config();
