...
@Data
public class Idea198613Config {
    private String name = "idea_198613";
 ...
 */
@Slf4j
public class Idea198613Service {
    private static final int IDEA_ID = 198613;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198613Service() {
        this(new Idea198613Config());
    }

    public Idea198613Service(Idea198613Config config) {
        this.config = config != null ? config : new Idea198613Config();
