...
@Data
public class Idea198864Config {
    private String name = "idea_198864";
 ...
 */
@Slf4j
public class Idea198864Service {
    private static final int IDEA_ID = 198864;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198864Service() {
        this(new Idea198864Config());
    }

    public Idea198864Service(Idea198864Config config) {
        this.config = config != null ? config : new Idea198864Config();
