...
@Data
public class Idea198725Config {
    private String name = "idea_198725";
 ...
 */
@Slf4j
public class Idea198725Service {
    private static final int IDEA_ID = 198725;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198725Service() {
        this(new Idea198725Config());
    }

    public Idea198725Service(Idea198725Config config) {
        this.config = config != null ? config : new Idea198725Config();
