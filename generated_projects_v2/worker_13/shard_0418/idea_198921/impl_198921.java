...
@Data
public class Idea198921Config {
    private String name = "idea_198921";
 ...
 */
@Slf4j
public class Idea198921Service {
    private static final int IDEA_ID = 198921;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198921Service() {
        this(new Idea198921Config());
    }

    public Idea198921Service(Idea198921Config config) {
        this.config = config != null ? config : new Idea198921Config();
