...
@Data
public class Idea198835Config {
    private String name = "idea_198835";
 ...
 */
@Slf4j
public class Idea198835Service {
    private static final int IDEA_ID = 198835;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198835Service() {
        this(new Idea198835Config());
    }

    public Idea198835Service(Idea198835Config config) {
        this.config = config != null ? config : new Idea198835Config();
