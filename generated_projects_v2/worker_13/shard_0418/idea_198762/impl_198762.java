...
@Data
public class Idea198762Config {
    private String name = "idea_198762";
 ...
 */
@Slf4j
public class Idea198762Service {
    private static final int IDEA_ID = 198762;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198762Service() {
        this(new Idea198762Config());
    }

    public Idea198762Service(Idea198762Config config) {
        this.config = config != null ? config : new Idea198762Config();
