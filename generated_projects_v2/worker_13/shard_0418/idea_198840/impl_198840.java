...
@Data
public class Idea198840Config {
    private String name = "idea_198840";
 ...
 */
@Slf4j
public class Idea198840Service {
    private static final int IDEA_ID = 198840;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198840Service() {
        this(new Idea198840Config());
    }

    public Idea198840Service(Idea198840Config config) {
        this.config = config != null ? config : new Idea198840Config();
