...
@Data
public class Idea198926Config {
    private String name = "idea_198926";
 ...
 */
@Slf4j
public class Idea198926Service {
    private static final int IDEA_ID = 198926;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198926Service() {
        this(new Idea198926Config());
    }

    public Idea198926Service(Idea198926Config config) {
        this.config = config != null ? config : new Idea198926Config();
