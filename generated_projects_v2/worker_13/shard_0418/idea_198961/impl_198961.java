...
@Data
public class Idea198961Config {
    private String name = "idea_198961";
 ...
 */
@Slf4j
public class Idea198961Service {
    private static final int IDEA_ID = 198961;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198961Service() {
        this(new Idea198961Config());
    }

    public Idea198961Service(Idea198961Config config) {
        this.config = config != null ? config : new Idea198961Config();
