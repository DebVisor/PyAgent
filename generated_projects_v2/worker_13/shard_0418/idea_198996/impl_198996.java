...
@Data
public class Idea198996Config {
    private String name = "idea_198996";
 ...
 */
@Slf4j
public class Idea198996Service {
    private static final int IDEA_ID = 198996;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198996Service() {
        this(new Idea198996Config());
    }

    public Idea198996Service(Idea198996Config config) {
        this.config = config != null ? config : new Idea198996Config();
