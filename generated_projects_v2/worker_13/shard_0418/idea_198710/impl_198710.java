...
@Data
public class Idea198710Config {
    private String name = "idea_198710";
 ...
 */
@Slf4j
public class Idea198710Service {
    private static final int IDEA_ID = 198710;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198710Service() {
        this(new Idea198710Config());
    }

    public Idea198710Service(Idea198710Config config) {
        this.config = config != null ? config : new Idea198710Config();
