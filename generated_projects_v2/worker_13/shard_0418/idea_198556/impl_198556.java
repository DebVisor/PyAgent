...
@Data
public class Idea198556Config {
    private String name = "idea_198556";
 ...
 */
@Slf4j
public class Idea198556Service {
    private static final int IDEA_ID = 198556;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198556Service() {
        this(new Idea198556Config());
    }

    public Idea198556Service(Idea198556Config config) {
        this.config = config != null ? config : new Idea198556Config();
