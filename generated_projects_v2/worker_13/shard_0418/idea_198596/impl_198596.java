...
@Data
public class Idea198596Config {
    private String name = "idea_198596";
 ...
 */
@Slf4j
public class Idea198596Service {
    private static final int IDEA_ID = 198596;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198596Service() {
        this(new Idea198596Config());
    }

    public Idea198596Service(Idea198596Config config) {
        this.config = config != null ? config : new Idea198596Config();
