...
@Data
public class Idea198719Config {
    private String name = "idea_198719";
 ...
 */
@Slf4j
public class Idea198719Service {
    private static final int IDEA_ID = 198719;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198719Service() {
        this(new Idea198719Config());
    }

    public Idea198719Service(Idea198719Config config) {
        this.config = config != null ? config : new Idea198719Config();
