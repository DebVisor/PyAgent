...
@Data
public class Idea198969Config {
    private String name = "idea_198969";
 ...
 */
@Slf4j
public class Idea198969Service {
    private static final int IDEA_ID = 198969;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198969Service() {
        this(new Idea198969Config());
    }

    public Idea198969Service(Idea198969Config config) {
        this.config = config != null ? config : new Idea198969Config();
