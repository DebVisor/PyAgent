...
@Data
public class Idea198653Config {
    private String name = "idea_198653";
 ...
 */
@Slf4j
public class Idea198653Service {
    private static final int IDEA_ID = 198653;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198653Service() {
        this(new Idea198653Config());
    }

    public Idea198653Service(Idea198653Config config) {
        this.config = config != null ? config : new Idea198653Config();
