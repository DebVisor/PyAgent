...
@Data
public class Idea198593Config {
    private String name = "idea_198593";
 ...
 */
@Slf4j
public class Idea198593Service {
    private static final int IDEA_ID = 198593;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198593Service() {
        this(new Idea198593Config());
    }

    public Idea198593Service(Idea198593Config config) {
        this.config = config != null ? config : new Idea198593Config();
