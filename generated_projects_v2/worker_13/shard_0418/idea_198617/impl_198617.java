...
@Data
public class Idea198617Config {
    private String name = "idea_198617";
 ...
 */
@Slf4j
public class Idea198617Service {
    private static final int IDEA_ID = 198617;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198617Service() {
        this(new Idea198617Config());
    }

    public Idea198617Service(Idea198617Config config) {
        this.config = config != null ? config : new Idea198617Config();
