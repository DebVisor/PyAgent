...
@Data
public class Idea198745Config {
    private String name = "idea_198745";
 ...
 */
@Slf4j
public class Idea198745Service {
    private static final int IDEA_ID = 198745;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198745Service() {
        this(new Idea198745Config());
    }

    public Idea198745Service(Idea198745Config config) {
        this.config = config != null ? config : new Idea198745Config();
