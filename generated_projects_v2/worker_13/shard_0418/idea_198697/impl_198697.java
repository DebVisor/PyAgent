...
@Data
public class Idea198697Config {
    private String name = "idea_198697";
 ...
 */
@Slf4j
public class Idea198697Service {
    private static final int IDEA_ID = 198697;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198697Service() {
        this(new Idea198697Config());
    }

    public Idea198697Service(Idea198697Config config) {
        this.config = config != null ? config : new Idea198697Config();
