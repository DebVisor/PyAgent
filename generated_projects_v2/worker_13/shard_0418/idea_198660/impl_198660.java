...
@Data
public class Idea198660Config {
    private String name = "idea_198660";
 ...
 */
@Slf4j
public class Idea198660Service {
    private static final int IDEA_ID = 198660;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198660Service() {
        this(new Idea198660Config());
    }

    public Idea198660Service(Idea198660Config config) {
        this.config = config != null ? config : new Idea198660Config();
