...
@Data
public class Idea199024Config {
    private String name = "idea_199024";
 ...
 */
@Slf4j
public class Idea199024Service {
    private static final int IDEA_ID = 199024;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199024Service() {
        this(new Idea199024Config());
    }

    public Idea199024Service(Idea199024Config config) {
        this.config = config != null ? config : new Idea199024Config();
