...
@Data
public class Idea198739Config {
    private String name = "idea_198739";
 ...
 */
@Slf4j
public class Idea198739Service {
    private static final int IDEA_ID = 198739;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198739Service() {
        this(new Idea198739Config());
    }

    public Idea198739Service(Idea198739Config config) {
        this.config = config != null ? config : new Idea198739Config();
