...
@Data
public class Idea198717Config {
    private String name = "idea_198717";
 ...
 */
@Slf4j
public class Idea198717Service {
    private static final int IDEA_ID = 198717;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198717Service() {
        this(new Idea198717Config());
    }

    public Idea198717Service(Idea198717Config config) {
        this.config = config != null ? config : new Idea198717Config();
