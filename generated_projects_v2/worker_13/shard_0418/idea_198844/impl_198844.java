...
@Data
public class Idea198844Config {
    private String name = "idea_198844";
 ...
 */
@Slf4j
public class Idea198844Service {
    private static final int IDEA_ID = 198844;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198844Service() {
        this(new Idea198844Config());
    }

    public Idea198844Service(Idea198844Config config) {
        this.config = config != null ? config : new Idea198844Config();
