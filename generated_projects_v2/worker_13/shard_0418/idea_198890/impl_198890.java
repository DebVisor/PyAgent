...
@Data
public class Idea198890Config {
    private String name = "idea_198890";
 ...
 */
@Slf4j
public class Idea198890Service {
    private static final int IDEA_ID = 198890;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198890Service() {
        this(new Idea198890Config());
    }

    public Idea198890Service(Idea198890Config config) {
        this.config = config != null ? config : new Idea198890Config();
