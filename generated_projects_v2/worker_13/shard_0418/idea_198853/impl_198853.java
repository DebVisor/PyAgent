...
@Data
public class Idea198853Config {
    private String name = "idea_198853";
 ...
 */
@Slf4j
public class Idea198853Service {
    private static final int IDEA_ID = 198853;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198853Service() {
        this(new Idea198853Config());
    }

    public Idea198853Service(Idea198853Config config) {
        this.config = config != null ? config : new Idea198853Config();
