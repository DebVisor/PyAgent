...
@Data
public class Idea198678Config {
    private String name = "idea_198678";
 ...
 */
@Slf4j
public class Idea198678Service {
    private static final int IDEA_ID = 198678;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198678Service() {
        this(new Idea198678Config());
    }

    public Idea198678Service(Idea198678Config config) {
        this.config = config != null ? config : new Idea198678Config();
