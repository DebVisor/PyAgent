...
@Data
public class Idea198867Config {
    private String name = "idea_198867";
 ...
 */
@Slf4j
public class Idea198867Service {
    private static final int IDEA_ID = 198867;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198867Service() {
        this(new Idea198867Config());
    }

    public Idea198867Service(Idea198867Config config) {
        this.config = config != null ? config : new Idea198867Config();
