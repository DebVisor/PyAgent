...
@Data
public class Idea198557Config {
    private String name = "idea_198557";
 ...
 */
@Slf4j
public class Idea198557Service {
    private static final int IDEA_ID = 198557;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198557Service() {
        this(new Idea198557Config());
    }

    public Idea198557Service(Idea198557Config config) {
        this.config = config != null ? config : new Idea198557Config();
