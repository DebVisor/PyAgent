...
@Data
public class Idea198587Config {
    private String name = "idea_198587";
 ...
 */
@Slf4j
public class Idea198587Service {
    private static final int IDEA_ID = 198587;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198587Service() {
        this(new Idea198587Config());
    }

    public Idea198587Service(Idea198587Config config) {
        this.config = config != null ? config : new Idea198587Config();
