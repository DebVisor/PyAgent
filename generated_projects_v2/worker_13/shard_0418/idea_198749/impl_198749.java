...
@Data
public class Idea198749Config {
    private String name = "idea_198749";
 ...
 */
@Slf4j
public class Idea198749Service {
    private static final int IDEA_ID = 198749;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198749Service() {
        this(new Idea198749Config());
    }

    public Idea198749Service(Idea198749Config config) {
        this.config = config != null ? config : new Idea198749Config();
