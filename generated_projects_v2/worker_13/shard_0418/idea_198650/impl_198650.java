...
@Data
public class Idea198650Config {
    private String name = "idea_198650";
 ...
 */
@Slf4j
public class Idea198650Service {
    private static final int IDEA_ID = 198650;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198650Service() {
        this(new Idea198650Config());
    }

    public Idea198650Service(Idea198650Config config) {
        this.config = config != null ? config : new Idea198650Config();
