...
@Data
public class Idea198828Config {
    private String name = "idea_198828";
 ...
 */
@Slf4j
public class Idea198828Service {
    private static final int IDEA_ID = 198828;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198828Service() {
        this(new Idea198828Config());
    }

    public Idea198828Service(Idea198828Config config) {
        this.config = config != null ? config : new Idea198828Config();
