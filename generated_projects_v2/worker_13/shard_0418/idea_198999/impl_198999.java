...
@Data
public class Idea198999Config {
    private String name = "idea_198999";
 ...
 */
@Slf4j
public class Idea198999Service {
    private static final int IDEA_ID = 198999;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198999Service() {
        this(new Idea198999Config());
    }

    public Idea198999Service(Idea198999Config config) {
        this.config = config != null ? config : new Idea198999Config();
