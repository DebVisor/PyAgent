...
@Data
public class Idea198600Config {
    private String name = "idea_198600";
 ...
 */
@Slf4j
public class Idea198600Service {
    private static final int IDEA_ID = 198600;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198600Service() {
        this(new Idea198600Config());
    }

    public Idea198600Service(Idea198600Config config) {
        this.config = config != null ? config : new Idea198600Config();
