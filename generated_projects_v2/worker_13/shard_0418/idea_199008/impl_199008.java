...
@Data
public class Idea199008Config {
    private String name = "idea_199008";
 ...
 */
@Slf4j
public class Idea199008Service {
    private static final int IDEA_ID = 199008;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199008Service() {
        this(new Idea199008Config());
    }

    public Idea199008Service(Idea199008Config config) {
        this.config = config != null ? config : new Idea199008Config();
