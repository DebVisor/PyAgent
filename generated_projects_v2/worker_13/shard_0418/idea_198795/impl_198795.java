...
@Data
public class Idea198795Config {
    private String name = "idea_198795";
 ...
 */
@Slf4j
public class Idea198795Service {
    private static final int IDEA_ID = 198795;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198795Service() {
        this(new Idea198795Config());
    }

    public Idea198795Service(Idea198795Config config) {
        this.config = config != null ? config : new Idea198795Config();
