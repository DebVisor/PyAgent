...
@Data
public class Idea198920Config {
    private String name = "idea_198920";
 ...
 */
@Slf4j
public class Idea198920Service {
    private static final int IDEA_ID = 198920;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198920Service() {
        this(new Idea198920Config());
    }

    public Idea198920Service(Idea198920Config config) {
        this.config = config != null ? config : new Idea198920Config();
