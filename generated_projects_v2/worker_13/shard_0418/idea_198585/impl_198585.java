...
@Data
public class Idea198585Config {
    private String name = "idea_198585";
 ...
 */
@Slf4j
public class Idea198585Service {
    private static final int IDEA_ID = 198585;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198585Service() {
        this(new Idea198585Config());
    }

    public Idea198585Service(Idea198585Config config) {
        this.config = config != null ? config : new Idea198585Config();
