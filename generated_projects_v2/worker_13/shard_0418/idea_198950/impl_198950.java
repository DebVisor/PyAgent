...
@Data
public class Idea198950Config {
    private String name = "idea_198950";
 ...
 */
@Slf4j
public class Idea198950Service {
    private static final int IDEA_ID = 198950;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198950Service() {
        this(new Idea198950Config());
    }

    public Idea198950Service(Idea198950Config config) {
        this.config = config != null ? config : new Idea198950Config();
