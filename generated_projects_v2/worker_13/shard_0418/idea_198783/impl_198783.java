...
@Data
public class Idea198783Config {
    private String name = "idea_198783";
 ...
 */
@Slf4j
public class Idea198783Service {
    private static final int IDEA_ID = 198783;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198783Service() {
        this(new Idea198783Config());
    }

    public Idea198783Service(Idea198783Config config) {
        this.config = config != null ? config : new Idea198783Config();
