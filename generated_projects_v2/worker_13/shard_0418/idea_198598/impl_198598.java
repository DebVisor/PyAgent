...
@Data
public class Idea198598Config {
    private String name = "idea_198598";
 ...
 */
@Slf4j
public class Idea198598Service {
    private static final int IDEA_ID = 198598;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198598Service() {
        this(new Idea198598Config());
    }

    public Idea198598Service(Idea198598Config config) {
        this.config = config != null ? config : new Idea198598Config();
