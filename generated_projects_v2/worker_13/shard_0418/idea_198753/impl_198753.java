...
@Data
public class Idea198753Config {
    private String name = "idea_198753";
 ...
 */
@Slf4j
public class Idea198753Service {
    private static final int IDEA_ID = 198753;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198753Service() {
        this(new Idea198753Config());
    }

    public Idea198753Service(Idea198753Config config) {
        this.config = config != null ? config : new Idea198753Config();
