...
@Data
public class Idea198612Config {
    private String name = "idea_198612";
 ...
 */
@Slf4j
public class Idea198612Service {
    private static final int IDEA_ID = 198612;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198612Service() {
        this(new Idea198612Config());
    }

    public Idea198612Service(Idea198612Config config) {
        this.config = config != null ? config : new Idea198612Config();
