...
@Data
public class Idea198751Config {
    private String name = "idea_198751";
 ...
 */
@Slf4j
public class Idea198751Service {
    private static final int IDEA_ID = 198751;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198751Service() {
        this(new Idea198751Config());
    }

    public Idea198751Service(Idea198751Config config) {
        this.config = config != null ? config : new Idea198751Config();
