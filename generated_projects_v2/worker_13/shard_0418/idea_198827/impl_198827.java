...
@Data
public class Idea198827Config {
    private String name = "idea_198827";
 ...
 */
@Slf4j
public class Idea198827Service {
    private static final int IDEA_ID = 198827;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198827Service() {
        this(new Idea198827Config());
    }

    public Idea198827Service(Idea198827Config config) {
        this.config = config != null ? config : new Idea198827Config();
