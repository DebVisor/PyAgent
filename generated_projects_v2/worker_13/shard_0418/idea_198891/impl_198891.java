...
@Data
public class Idea198891Config {
    private String name = "idea_198891";
 ...
 */
@Slf4j
public class Idea198891Service {
    private static final int IDEA_ID = 198891;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198891Service() {
        this(new Idea198891Config());
    }

    public Idea198891Service(Idea198891Config config) {
        this.config = config != null ? config : new Idea198891Config();
