...
@Data
public class Idea198595Config {
    private String name = "idea_198595";
 ...
 */
@Slf4j
public class Idea198595Service {
    private static final int IDEA_ID = 198595;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198595Service() {
        this(new Idea198595Config());
    }

    public Idea198595Service(Idea198595Config config) {
        this.config = config != null ? config : new Idea198595Config();
