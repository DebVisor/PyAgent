...
@Data
public class Idea198561Config {
    private String name = "idea_198561";
 ...
 */
@Slf4j
public class Idea198561Service {
    private static final int IDEA_ID = 198561;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198561Service() {
        this(new Idea198561Config());
    }

    public Idea198561Service(Idea198561Config config) {
        this.config = config != null ? config : new Idea198561Config();
