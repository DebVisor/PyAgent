...
@Data
public class Idea198752Config {
    private String name = "idea_198752";
 ...
 */
@Slf4j
public class Idea198752Service {
    private static final int IDEA_ID = 198752;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198752Service() {
        this(new Idea198752Config());
    }

    public Idea198752Service(Idea198752Config config) {
        this.config = config != null ? config : new Idea198752Config();
