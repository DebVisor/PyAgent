...
@Data
public class Idea198558Config {
    private String name = "idea_198558";
 ...
 */
@Slf4j
public class Idea198558Service {
    private static final int IDEA_ID = 198558;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198558Service() {
        this(new Idea198558Config());
    }

    public Idea198558Service(Idea198558Config config) {
        this.config = config != null ? config : new Idea198558Config();
