...
@Data
public class Idea198805Config {
    private String name = "idea_198805";
 ...
 */
@Slf4j
public class Idea198805Service {
    private static final int IDEA_ID = 198805;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198805Service() {
        this(new Idea198805Config());
    }

    public Idea198805Service(Idea198805Config config) {
        this.config = config != null ? config : new Idea198805Config();
