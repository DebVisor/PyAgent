...
@Data
public class Idea198893Config {
    private String name = "idea_198893";
 ...
 */
@Slf4j
public class Idea198893Service {
    private static final int IDEA_ID = 198893;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198893Service() {
        this(new Idea198893Config());
    }

    public Idea198893Service(Idea198893Config config) {
        this.config = config != null ? config : new Idea198893Config();
