...
@Data
public class Idea198967Config {
    private String name = "idea_198967";
 ...
 */
@Slf4j
public class Idea198967Service {
    private static final int IDEA_ID = 198967;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198967Service() {
        this(new Idea198967Config());
    }

    public Idea198967Service(Idea198967Config config) {
        this.config = config != null ? config : new Idea198967Config();
