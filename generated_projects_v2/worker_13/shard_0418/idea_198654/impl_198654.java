...
@Data
public class Idea198654Config {
    private String name = "idea_198654";
 ...
 */
@Slf4j
public class Idea198654Service {
    private static final int IDEA_ID = 198654;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198654Service() {
        this(new Idea198654Config());
    }

    public Idea198654Service(Idea198654Config config) {
        this.config = config != null ? config : new Idea198654Config();
