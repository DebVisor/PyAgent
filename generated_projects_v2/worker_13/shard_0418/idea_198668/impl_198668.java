...
@Data
public class Idea198668Config {
    private String name = "idea_198668";
 ...
 */
@Slf4j
public class Idea198668Service {
    private static final int IDEA_ID = 198668;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198668Service() {
        this(new Idea198668Config());
    }

    public Idea198668Service(Idea198668Config config) {
        this.config = config != null ? config : new Idea198668Config();
