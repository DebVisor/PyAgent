...
@Data
public class Idea198709Config {
    private String name = "idea_198709";
 ...
 */
@Slf4j
public class Idea198709Service {
    private static final int IDEA_ID = 198709;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198709Service() {
        this(new Idea198709Config());
    }

    public Idea198709Service(Idea198709Config config) {
        this.config = config != null ? config : new Idea198709Config();
