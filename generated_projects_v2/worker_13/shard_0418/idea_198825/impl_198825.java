...
@Data
public class Idea198825Config {
    private String name = "idea_198825";
 ...
 */
@Slf4j
public class Idea198825Service {
    private static final int IDEA_ID = 198825;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198825Service() {
        this(new Idea198825Config());
    }

    public Idea198825Service(Idea198825Config config) {
        this.config = config != null ? config : new Idea198825Config();
