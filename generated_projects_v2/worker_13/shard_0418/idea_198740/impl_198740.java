...
@Data
public class Idea198740Config {
    private String name = "idea_198740";
 ...
 */
@Slf4j
public class Idea198740Service {
    private static final int IDEA_ID = 198740;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198740Service() {
        this(new Idea198740Config());
    }

    public Idea198740Service(Idea198740Config config) {
        this.config = config != null ? config : new Idea198740Config();
