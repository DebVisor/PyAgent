...
@Data
public class Idea198760Config {
    private String name = "idea_198760";
 ...
 */
@Slf4j
public class Idea198760Service {
    private static final int IDEA_ID = 198760;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198760Service() {
        this(new Idea198760Config());
    }

    public Idea198760Service(Idea198760Config config) {
        this.config = config != null ? config : new Idea198760Config();
