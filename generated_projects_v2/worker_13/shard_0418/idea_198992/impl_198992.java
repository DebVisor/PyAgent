...
@Data
public class Idea198992Config {
    private String name = "idea_198992";
 ...
 */
@Slf4j
public class Idea198992Service {
    private static final int IDEA_ID = 198992;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198992Service() {
        this(new Idea198992Config());
    }

    public Idea198992Service(Idea198992Config config) {
        this.config = config != null ? config : new Idea198992Config();
