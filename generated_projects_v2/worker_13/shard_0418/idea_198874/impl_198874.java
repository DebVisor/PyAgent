...
@Data
public class Idea198874Config {
    private String name = "idea_198874";
 ...
 */
@Slf4j
public class Idea198874Service {
    private static final int IDEA_ID = 198874;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198874Service() {
        this(new Idea198874Config());
    }

    public Idea198874Service(Idea198874Config config) {
        this.config = config != null ? config : new Idea198874Config();
