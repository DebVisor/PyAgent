...
@Data
public class Idea198819Config {
    private String name = "idea_198819";
 ...
 */
@Slf4j
public class Idea198819Service {
    private static final int IDEA_ID = 198819;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198819Service() {
        this(new Idea198819Config());
    }

    public Idea198819Service(Idea198819Config config) {
        this.config = config != null ? config : new Idea198819Config();
