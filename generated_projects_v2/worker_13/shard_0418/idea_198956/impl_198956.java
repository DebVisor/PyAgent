...
@Data
public class Idea198956Config {
    private String name = "idea_198956";
 ...
 */
@Slf4j
public class Idea198956Service {
    private static final int IDEA_ID = 198956;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198956Service() {
        this(new Idea198956Config());
    }

    public Idea198956Service(Idea198956Config config) {
        this.config = config != null ? config : new Idea198956Config();
