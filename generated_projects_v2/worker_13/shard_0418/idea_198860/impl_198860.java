...
@Data
public class Idea198860Config {
    private String name = "idea_198860";
 ...
 */
@Slf4j
public class Idea198860Service {
    private static final int IDEA_ID = 198860;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198860Service() {
        this(new Idea198860Config());
    }

    public Idea198860Service(Idea198860Config config) {
        this.config = config != null ? config : new Idea198860Config();
