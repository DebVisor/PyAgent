...
@Data
public class Idea198761Config {
    private String name = "idea_198761";
 ...
 */
@Slf4j
public class Idea198761Service {
    private static final int IDEA_ID = 198761;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198761Service() {
        this(new Idea198761Config());
    }

    public Idea198761Service(Idea198761Config config) {
        this.config = config != null ? config : new Idea198761Config();
