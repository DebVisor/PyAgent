...
@Data
public class Idea198635Config {
    private String name = "idea_198635";
 ...
 */
@Slf4j
public class Idea198635Service {
    private static final int IDEA_ID = 198635;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198635Service() {
        this(new Idea198635Config());
    }

    public Idea198635Service(Idea198635Config config) {
        this.config = config != null ? config : new Idea198635Config();
