...
@Data
public class Idea198901Config {
    private String name = "idea_198901";
 ...
 */
@Slf4j
public class Idea198901Service {
    private static final int IDEA_ID = 198901;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198901Service() {
        this(new Idea198901Config());
    }

    public Idea198901Service(Idea198901Config config) {
        this.config = config != null ? config : new Idea198901Config();
