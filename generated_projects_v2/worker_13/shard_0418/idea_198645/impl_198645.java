...
@Data
public class Idea198645Config {
    private String name = "idea_198645";
 ...
 */
@Slf4j
public class Idea198645Service {
    private static final int IDEA_ID = 198645;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198645Service() {
        this(new Idea198645Config());
    }

    public Idea198645Service(Idea198645Config config) {
        this.config = config != null ? config : new Idea198645Config();
