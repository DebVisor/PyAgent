...
@Data
public class Idea198916Config {
    private String name = "idea_198916";
 ...
 */
@Slf4j
public class Idea198916Service {
    private static final int IDEA_ID = 198916;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198916Service() {
        this(new Idea198916Config());
    }

    public Idea198916Service(Idea198916Config config) {
        this.config = config != null ? config : new Idea198916Config();
