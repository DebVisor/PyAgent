...
@Data
public class Idea198813Config {
    private String name = "idea_198813";
 ...
 */
@Slf4j
public class Idea198813Service {
    private static final int IDEA_ID = 198813;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198813Service() {
        this(new Idea198813Config());
    }

    public Idea198813Service(Idea198813Config config) {
        this.config = config != null ? config : new Idea198813Config();
