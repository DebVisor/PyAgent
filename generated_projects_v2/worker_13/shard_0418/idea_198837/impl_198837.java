...
@Data
public class Idea198837Config {
    private String name = "idea_198837";
 ...
 */
@Slf4j
public class Idea198837Service {
    private static final int IDEA_ID = 198837;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198837Service() {
        this(new Idea198837Config());
    }

    public Idea198837Service(Idea198837Config config) {
        this.config = config != null ? config : new Idea198837Config();
