...
@Data
public class Idea198989Config {
    private String name = "idea_198989";
 ...
 */
@Slf4j
public class Idea198989Service {
    private static final int IDEA_ID = 198989;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198989Service() {
        this(new Idea198989Config());
    }

    public Idea198989Service(Idea198989Config config) {
        this.config = config != null ? config : new Idea198989Config();
