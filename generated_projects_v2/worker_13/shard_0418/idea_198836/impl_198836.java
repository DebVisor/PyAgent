...
@Data
public class Idea198836Config {
    private String name = "idea_198836";
 ...
 */
@Slf4j
public class Idea198836Service {
    private static final int IDEA_ID = 198836;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198836Service() {
        this(new Idea198836Config());
    }

    public Idea198836Service(Idea198836Config config) {
        this.config = config != null ? config : new Idea198836Config();
