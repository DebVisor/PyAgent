...
@Data
public class Idea199014Config {
    private String name = "idea_199014";
 ...
 */
@Slf4j
public class Idea199014Service {
    private static final int IDEA_ID = 199014;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199014Service() {
        this(new Idea199014Config());
    }

    public Idea199014Service(Idea199014Config config) {
        this.config = config != null ? config : new Idea199014Config();
