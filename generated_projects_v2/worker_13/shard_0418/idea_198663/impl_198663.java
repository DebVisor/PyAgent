...
@Data
public class Idea198663Config {
    private String name = "idea_198663";
 ...
 */
@Slf4j
public class Idea198663Service {
    private static final int IDEA_ID = 198663;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198663Service() {
        this(new Idea198663Config());
    }

    public Idea198663Service(Idea198663Config config) {
        this.config = config != null ? config : new Idea198663Config();
