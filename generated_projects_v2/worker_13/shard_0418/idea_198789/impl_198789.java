...
@Data
public class Idea198789Config {
    private String name = "idea_198789";
 ...
 */
@Slf4j
public class Idea198789Service {
    private static final int IDEA_ID = 198789;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198789Service() {
        this(new Idea198789Config());
    }

    public Idea198789Service(Idea198789Config config) {
        this.config = config != null ? config : new Idea198789Config();
