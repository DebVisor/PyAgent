...
@Data
public class Idea198630Config {
    private String name = "idea_198630";
 ...
 */
@Slf4j
public class Idea198630Service {
    private static final int IDEA_ID = 198630;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198630Service() {
        this(new Idea198630Config());
    }

    public Idea198630Service(Idea198630Config config) {
        this.config = config != null ? config : new Idea198630Config();
