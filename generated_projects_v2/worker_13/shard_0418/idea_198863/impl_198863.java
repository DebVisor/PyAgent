...
@Data
public class Idea198863Config {
    private String name = "idea_198863";
 ...
 */
@Slf4j
public class Idea198863Service {
    private static final int IDEA_ID = 198863;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198863Service() {
        this(new Idea198863Config());
    }

    public Idea198863Service(Idea198863Config config) {
        this.config = config != null ? config : new Idea198863Config();
