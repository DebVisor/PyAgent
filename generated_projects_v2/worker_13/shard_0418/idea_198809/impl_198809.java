...
@Data
public class Idea198809Config {
    private String name = "idea_198809";
 ...
 */
@Slf4j
public class Idea198809Service {
    private static final int IDEA_ID = 198809;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198809Service() {
        this(new Idea198809Config());
    }

    public Idea198809Service(Idea198809Config config) {
        this.config = config != null ? config : new Idea198809Config();
