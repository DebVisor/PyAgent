...
@Data
public class Idea198862Config {
    private String name = "idea_198862";
 ...
 */
@Slf4j
public class Idea198862Service {
    private static final int IDEA_ID = 198862;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198862Service() {
        this(new Idea198862Config());
    }

    public Idea198862Service(Idea198862Config config) {
        this.config = config != null ? config : new Idea198862Config();
