...
@Data
public class Idea198555Config {
    private String name = "idea_198555";
 ...
 */
@Slf4j
public class Idea198555Service {
    private static final int IDEA_ID = 198555;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198555Service() {
        this(new Idea198555Config());
    }

    public Idea198555Service(Idea198555Config config) {
        this.config = config != null ? config : new Idea198555Config();
