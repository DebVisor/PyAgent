...
@Data
public class Idea198589Config {
    private String name = "idea_198589";
 ...
 */
@Slf4j
public class Idea198589Service {
    private static final int IDEA_ID = 198589;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198589Service() {
        this(new Idea198589Config());
    }

    public Idea198589Service(Idea198589Config config) {
        this.config = config != null ? config : new Idea198589Config();
