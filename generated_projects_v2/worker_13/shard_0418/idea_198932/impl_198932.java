...
@Data
public class Idea198932Config {
    private String name = "idea_198932";
 ...
 */
@Slf4j
public class Idea198932Service {
    private static final int IDEA_ID = 198932;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198932Service() {
        this(new Idea198932Config());
    }

    public Idea198932Service(Idea198932Config config) {
        this.config = config != null ? config : new Idea198932Config();
