...
@Data
public class Idea198838Config {
    private String name = "idea_198838";
 ...
 */
@Slf4j
public class Idea198838Service {
    private static final int IDEA_ID = 198838;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198838Service() {
        this(new Idea198838Config());
    }

    public Idea198838Service(Idea198838Config config) {
        this.config = config != null ? config : new Idea198838Config();
