...
@Data
public class Idea198922Config {
    private String name = "idea_198922";
 ...
 */
@Slf4j
public class Idea198922Service {
    private static final int IDEA_ID = 198922;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198922Service() {
        this(new Idea198922Config());
    }

    public Idea198922Service(Idea198922Config config) {
        this.config = config != null ? config : new Idea198922Config();
