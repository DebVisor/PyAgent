...
@Data
public class Idea198930Config {
    private String name = "idea_198930";
 ...
 */
@Slf4j
public class Idea198930Service {
    private static final int IDEA_ID = 198930;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198930Service() {
        this(new Idea198930Config());
    }

    public Idea198930Service(Idea198930Config config) {
        this.config = config != null ? config : new Idea198930Config();
