...
@Data
public class Idea198728Config {
    private String name = "idea_198728";
 ...
 */
@Slf4j
public class Idea198728Service {
    private static final int IDEA_ID = 198728;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198728Service() {
        this(new Idea198728Config());
    }

    public Idea198728Service(Idea198728Config config) {
        this.config = config != null ? config : new Idea198728Config();
