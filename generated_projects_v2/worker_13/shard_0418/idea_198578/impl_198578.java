...
@Data
public class Idea198578Config {
    private String name = "idea_198578";
 ...
 */
@Slf4j
public class Idea198578Service {
    private static final int IDEA_ID = 198578;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198578Service() {
        this(new Idea198578Config());
    }

    public Idea198578Service(Idea198578Config config) {
        this.config = config != null ? config : new Idea198578Config();
