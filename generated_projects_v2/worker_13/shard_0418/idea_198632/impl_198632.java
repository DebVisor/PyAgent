...
@Data
public class Idea198632Config {
    private String name = "idea_198632";
 ...
 */
@Slf4j
public class Idea198632Service {
    private static final int IDEA_ID = 198632;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198632Service() {
        this(new Idea198632Config());
    }

    public Idea198632Service(Idea198632Config config) {
        this.config = config != null ? config : new Idea198632Config();
