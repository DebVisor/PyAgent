...
@Data
public class Idea198756Config {
    private String name = "idea_198756";
 ...
 */
@Slf4j
public class Idea198756Service {
    private static final int IDEA_ID = 198756;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198756Service() {
        this(new Idea198756Config());
    }

    public Idea198756Service(Idea198756Config config) {
        this.config = config != null ? config : new Idea198756Config();
