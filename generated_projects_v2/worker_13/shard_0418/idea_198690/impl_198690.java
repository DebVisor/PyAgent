...
@Data
public class Idea198690Config {
    private String name = "idea_198690";
 ...
 */
@Slf4j
public class Idea198690Service {
    private static final int IDEA_ID = 198690;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198690Service() {
        this(new Idea198690Config());
    }

    public Idea198690Service(Idea198690Config config) {
        this.config = config != null ? config : new Idea198690Config();
