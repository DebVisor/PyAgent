...
@Data
public class Idea198869Config {
    private String name = "idea_198869";
 ...
 */
@Slf4j
public class Idea198869Service {
    private static final int IDEA_ID = 198869;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198869Service() {
        this(new Idea198869Config());
    }

    public Idea198869Service(Idea198869Config config) {
        this.config = config != null ? config : new Idea198869Config();
