...
@Data
public class Idea198726Config {
    private String name = "idea_198726";
 ...
 */
@Slf4j
public class Idea198726Service {
    private static final int IDEA_ID = 198726;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198726Service() {
        this(new Idea198726Config());
    }

    public Idea198726Service(Idea198726Config config) {
        this.config = config != null ? config : new Idea198726Config();
