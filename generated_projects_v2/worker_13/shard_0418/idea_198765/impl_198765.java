...
@Data
public class Idea198765Config {
    private String name = "idea_198765";
 ...
 */
@Slf4j
public class Idea198765Service {
    private static final int IDEA_ID = 198765;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198765Service() {
        this(new Idea198765Config());
    }

    public Idea198765Service(Idea198765Config config) {
        this.config = config != null ? config : new Idea198765Config();
