...
@Data
public class Idea198971Config {
    private String name = "idea_198971";
 ...
 */
@Slf4j
public class Idea198971Service {
    private static final int IDEA_ID = 198971;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198971Service() {
        this(new Idea198971Config());
    }

    public Idea198971Service(Idea198971Config config) {
        this.config = config != null ? config : new Idea198971Config();
