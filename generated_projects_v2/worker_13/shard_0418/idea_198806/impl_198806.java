...
@Data
public class Idea198806Config {
    private String name = "idea_198806";
 ...
 */
@Slf4j
public class Idea198806Service {
    private static final int IDEA_ID = 198806;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198806Service() {
        this(new Idea198806Config());
    }

    public Idea198806Service(Idea198806Config config) {
        this.config = config != null ? config : new Idea198806Config();
