...
@Data
public class Idea198597Config {
    private String name = "idea_198597";
 ...
 */
@Slf4j
public class Idea198597Service {
    private static final int IDEA_ID = 198597;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198597Service() {
        this(new Idea198597Config());
    }

    public Idea198597Service(Idea198597Config config) {
        this.config = config != null ? config : new Idea198597Config();
