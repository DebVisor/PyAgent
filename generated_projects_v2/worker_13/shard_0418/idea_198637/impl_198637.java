...
@Data
public class Idea198637Config {
    private String name = "idea_198637";
 ...
 */
@Slf4j
public class Idea198637Service {
    private static final int IDEA_ID = 198637;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198637Service() {
        this(new Idea198637Config());
    }

    public Idea198637Service(Idea198637Config config) {
        this.config = config != null ? config : new Idea198637Config();
