...
@Data
public class Idea198981Config {
    private String name = "idea_198981";
 ...
 */
@Slf4j
public class Idea198981Service {
    private static final int IDEA_ID = 198981;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198981Service() {
        this(new Idea198981Config());
    }

    public Idea198981Service(Idea198981Config config) {
        this.config = config != null ? config : new Idea198981Config();
