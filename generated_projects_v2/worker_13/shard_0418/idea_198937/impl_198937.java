...
@Data
public class Idea198937Config {
    private String name = "idea_198937";
 ...
 */
@Slf4j
public class Idea198937Service {
    private static final int IDEA_ID = 198937;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198937Service() {
        this(new Idea198937Config());
    }

    public Idea198937Service(Idea198937Config config) {
        this.config = config != null ? config : new Idea198937Config();
