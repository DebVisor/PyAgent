...
@Data
public class Idea198627Config {
    private String name = "idea_198627";
 ...
 */
@Slf4j
public class Idea198627Service {
    private static final int IDEA_ID = 198627;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198627Service() {
        this(new Idea198627Config());
    }

    public Idea198627Service(Idea198627Config config) {
        this.config = config != null ? config : new Idea198627Config();
