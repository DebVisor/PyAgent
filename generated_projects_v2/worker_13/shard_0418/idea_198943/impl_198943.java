...
@Data
public class Idea198943Config {
    private String name = "idea_198943";
 ...
 */
@Slf4j
public class Idea198943Service {
    private static final int IDEA_ID = 198943;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198943Service() {
        this(new Idea198943Config());
    }

    public Idea198943Service(Idea198943Config config) {
        this.config = config != null ? config : new Idea198943Config();
