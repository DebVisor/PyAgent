...
@Data
public class Idea198623Config {
    private String name = "idea_198623";
 ...
 */
@Slf4j
public class Idea198623Service {
    private static final int IDEA_ID = 198623;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198623Service() {
        this(new Idea198623Config());
    }

    public Idea198623Service(Idea198623Config config) {
        this.config = config != null ? config : new Idea198623Config();
