...
@Data
public class Idea198814Config {
    private String name = "idea_198814";
 ...
 */
@Slf4j
public class Idea198814Service {
    private static final int IDEA_ID = 198814;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198814Service() {
        this(new Idea198814Config());
    }

    public Idea198814Service(Idea198814Config config) {
        this.config = config != null ? config : new Idea198814Config();
