...
@Data
public class Idea198639Config {
    private String name = "idea_198639";
 ...
 */
@Slf4j
public class Idea198639Service {
    private static final int IDEA_ID = 198639;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198639Service() {
        this(new Idea198639Config());
    }

    public Idea198639Service(Idea198639Config config) {
        this.config = config != null ? config : new Idea198639Config();
