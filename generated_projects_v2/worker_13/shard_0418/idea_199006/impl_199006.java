...
@Data
public class Idea199006Config {
    private String name = "idea_199006";
 ...
 */
@Slf4j
public class Idea199006Service {
    private static final int IDEA_ID = 199006;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199006Service() {
        this(new Idea199006Config());
    }

    public Idea199006Service(Idea199006Config config) {
        this.config = config != null ? config : new Idea199006Config();
