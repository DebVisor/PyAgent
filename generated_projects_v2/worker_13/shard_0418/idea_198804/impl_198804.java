...
@Data
public class Idea198804Config {
    private String name = "idea_198804";
 ...
 */
@Slf4j
public class Idea198804Service {
    private static final int IDEA_ID = 198804;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198804Service() {
        this(new Idea198804Config());
    }

    public Idea198804Service(Idea198804Config config) {
        this.config = config != null ? config : new Idea198804Config();
