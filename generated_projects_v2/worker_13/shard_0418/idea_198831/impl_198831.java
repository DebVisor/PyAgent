...
@Data
public class Idea198831Config {
    private String name = "idea_198831";
 ...
 */
@Slf4j
public class Idea198831Service {
    private static final int IDEA_ID = 198831;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198831Service() {
        this(new Idea198831Config());
    }

    public Idea198831Service(Idea198831Config config) {
        this.config = config != null ? config : new Idea198831Config();
