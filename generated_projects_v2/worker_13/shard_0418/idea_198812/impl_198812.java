...
@Data
public class Idea198812Config {
    private String name = "idea_198812";
 ...
 */
@Slf4j
public class Idea198812Service {
    private static final int IDEA_ID = 198812;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198812Service() {
        this(new Idea198812Config());
    }

    public Idea198812Service(Idea198812Config config) {
        this.config = config != null ? config : new Idea198812Config();
