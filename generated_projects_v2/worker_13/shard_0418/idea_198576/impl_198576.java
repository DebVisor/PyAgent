...
@Data
public class Idea198576Config {
    private String name = "idea_198576";
 ...
 */
@Slf4j
public class Idea198576Service {
    private static final int IDEA_ID = 198576;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198576Service() {
        this(new Idea198576Config());
    }

    public Idea198576Service(Idea198576Config config) {
        this.config = config != null ? config : new Idea198576Config();
