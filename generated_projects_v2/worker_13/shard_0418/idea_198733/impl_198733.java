...
@Data
public class Idea198733Config {
    private String name = "idea_198733";
 ...
 */
@Slf4j
public class Idea198733Service {
    private static final int IDEA_ID = 198733;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198733Service() {
        this(new Idea198733Config());
    }

    public Idea198733Service(Idea198733Config config) {
        this.config = config != null ? config : new Idea198733Config();
