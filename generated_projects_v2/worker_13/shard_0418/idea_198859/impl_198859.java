...
@Data
public class Idea198859Config {
    private String name = "idea_198859";
 ...
 */
@Slf4j
public class Idea198859Service {
    private static final int IDEA_ID = 198859;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198859Service() {
        this(new Idea198859Config());
    }

    public Idea198859Service(Idea198859Config config) {
        this.config = config != null ? config : new Idea198859Config();
