...
@Data
public class Idea198802Config {
    private String name = "idea_198802";
 ...
 */
@Slf4j
public class Idea198802Service {
    private static final int IDEA_ID = 198802;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198802Service() {
        this(new Idea198802Config());
    }

    public Idea198802Service(Idea198802Config config) {
        this.config = config != null ? config : new Idea198802Config();
