...
@Data
public class Idea198673Config {
    private String name = "idea_198673";
 ...
 */
@Slf4j
public class Idea198673Service {
    private static final int IDEA_ID = 198673;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198673Service() {
        this(new Idea198673Config());
    }

    public Idea198673Service(Idea198673Config config) {
        this.config = config != null ? config : new Idea198673Config();
