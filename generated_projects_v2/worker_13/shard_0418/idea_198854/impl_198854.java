...
@Data
public class Idea198854Config {
    private String name = "idea_198854";
 ...
 */
@Slf4j
public class Idea198854Service {
    private static final int IDEA_ID = 198854;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198854Service() {
        this(new Idea198854Config());
    }

    public Idea198854Service(Idea198854Config config) {
        this.config = config != null ? config : new Idea198854Config();
