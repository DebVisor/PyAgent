...
@Data
public class Idea198858Config {
    private String name = "idea_198858";
 ...
 */
@Slf4j
public class Idea198858Service {
    private static final int IDEA_ID = 198858;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198858Service() {
        this(new Idea198858Config());
    }

    public Idea198858Service(Idea198858Config config) {
        this.config = config != null ? config : new Idea198858Config();
