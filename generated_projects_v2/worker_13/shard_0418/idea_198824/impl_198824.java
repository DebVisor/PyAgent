...
@Data
public class Idea198824Config {
    private String name = "idea_198824";
 ...
 */
@Slf4j
public class Idea198824Service {
    private static final int IDEA_ID = 198824;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198824Service() {
        this(new Idea198824Config());
    }

    public Idea198824Service(Idea198824Config config) {
        this.config = config != null ? config : new Idea198824Config();
