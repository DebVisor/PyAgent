...
@Data
public class Idea198892Config {
    private String name = "idea_198892";
 ...
 */
@Slf4j
public class Idea198892Service {
    private static final int IDEA_ID = 198892;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198892Service() {
        this(new Idea198892Config());
    }

    public Idea198892Service(Idea198892Config config) {
        this.config = config != null ? config : new Idea198892Config();
