...
@Data
public class Idea198898Config {
    private String name = "idea_198898";
 ...
 */
@Slf4j
public class Idea198898Service {
    private static final int IDEA_ID = 198898;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198898Service() {
        this(new Idea198898Config());
    }

    public Idea198898Service(Idea198898Config config) {
        this.config = config != null ? config : new Idea198898Config();
