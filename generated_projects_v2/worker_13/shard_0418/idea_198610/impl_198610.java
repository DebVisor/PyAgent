...
@Data
public class Idea198610Config {
    private String name = "idea_198610";
 ...
 */
@Slf4j
public class Idea198610Service {
    private static final int IDEA_ID = 198610;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198610Service() {
        this(new Idea198610Config());
    }

    public Idea198610Service(Idea198610Config config) {
        this.config = config != null ? config : new Idea198610Config();
