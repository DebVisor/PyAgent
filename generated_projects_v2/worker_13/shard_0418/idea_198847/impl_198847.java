...
@Data
public class Idea198847Config {
    private String name = "idea_198847";
 ...
 */
@Slf4j
public class Idea198847Service {
    private static final int IDEA_ID = 198847;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198847Service() {
        this(new Idea198847Config());
    }

    public Idea198847Service(Idea198847Config config) {
        this.config = config != null ? config : new Idea198847Config();
