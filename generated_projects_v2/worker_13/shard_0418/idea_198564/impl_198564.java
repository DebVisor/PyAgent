...
@Data
public class Idea198564Config {
    private String name = "idea_198564";
 ...
 */
@Slf4j
public class Idea198564Service {
    private static final int IDEA_ID = 198564;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198564Service() {
        this(new Idea198564Config());
    }

    public Idea198564Service(Idea198564Config config) {
        this.config = config != null ? config : new Idea198564Config();
