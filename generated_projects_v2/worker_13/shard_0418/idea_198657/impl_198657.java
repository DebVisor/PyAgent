...
@Data
public class Idea198657Config {
    private String name = "idea_198657";
 ...
 */
@Slf4j
public class Idea198657Service {
    private static final int IDEA_ID = 198657;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198657Service() {
        this(new Idea198657Config());
    }

    public Idea198657Service(Idea198657Config config) {
        this.config = config != null ? config : new Idea198657Config();
