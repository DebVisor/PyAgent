...
@Data
public class Idea198900Config {
    private String name = "idea_198900";
 ...
 */
@Slf4j
public class Idea198900Service {
    private static final int IDEA_ID = 198900;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198900Service() {
        this(new Idea198900Config());
    }

    public Idea198900Service(Idea198900Config config) {
        this.config = config != null ? config : new Idea198900Config();
