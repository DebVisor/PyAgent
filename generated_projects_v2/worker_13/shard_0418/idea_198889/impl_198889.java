...
@Data
public class Idea198889Config {
    private String name = "idea_198889";
 ...
 */
@Slf4j
public class Idea198889Service {
    private static final int IDEA_ID = 198889;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198889Service() {
        this(new Idea198889Config());
    }

    public Idea198889Service(Idea198889Config config) {
        this.config = config != null ? config : new Idea198889Config();
