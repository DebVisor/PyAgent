...
@Data
public class Idea198768Config {
    private String name = "idea_198768";
 ...
 */
@Slf4j
public class Idea198768Service {
    private static final int IDEA_ID = 198768;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198768Service() {
        this(new Idea198768Config());
    }

    public Idea198768Service(Idea198768Config config) {
        this.config = config != null ? config : new Idea198768Config();
