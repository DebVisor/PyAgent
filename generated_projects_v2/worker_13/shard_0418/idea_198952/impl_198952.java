...
@Data
public class Idea198952Config {
    private String name = "idea_198952";
 ...
 */
@Slf4j
public class Idea198952Service {
    private static final int IDEA_ID = 198952;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198952Service() {
        this(new Idea198952Config());
    }

    public Idea198952Service(Idea198952Config config) {
        this.config = config != null ? config : new Idea198952Config();
