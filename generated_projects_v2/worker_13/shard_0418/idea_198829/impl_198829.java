...
@Data
public class Idea198829Config {
    private String name = "idea_198829";
 ...
 */
@Slf4j
public class Idea198829Service {
    private static final int IDEA_ID = 198829;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198829Service() {
        this(new Idea198829Config());
    }

    public Idea198829Service(Idea198829Config config) {
        this.config = config != null ? config : new Idea198829Config();
