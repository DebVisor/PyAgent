...
@Data
public class Idea199000Config {
    private String name = "idea_199000";
 ...
 */
@Slf4j
public class Idea199000Service {
    private static final int IDEA_ID = 199000;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199000Service() {
        this(new Idea199000Config());
    }

    public Idea199000Service(Idea199000Config config) {
        this.config = config != null ? config : new Idea199000Config();
