...
@Data
public class Idea198987Config {
    private String name = "idea_198987";
 ...
 */
@Slf4j
public class Idea198987Service {
    private static final int IDEA_ID = 198987;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198987Service() {
        this(new Idea198987Config());
    }

    public Idea198987Service(Idea198987Config config) {
        this.config = config != null ? config : new Idea198987Config();
