...
@Data
public class Idea195140Config {
    private String name = "idea_195140";
 ...
 */
@Slf4j
public class Idea195140Service {
    private static final int IDEA_ID = 195140;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195140Service() {
        this(new Idea195140Config());
    }

    public Idea195140Service(Idea195140Config config) {
        this.config = config != null ? config : new Idea195140Config();
