...
@Data
public class Idea195038Config {
    private String name = "idea_195038";
 ...
 */
@Slf4j
public class Idea195038Service {
    private static final int IDEA_ID = 195038;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195038Service() {
        this(new Idea195038Config());
    }

    public Idea195038Service(Idea195038Config config) {
        this.config = config != null ? config : new Idea195038Config();
