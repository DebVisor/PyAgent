...
@Data
public class Idea195061Config {
    private String name = "idea_195061";
 ...
 */
@Slf4j
public class Idea195061Service {
    private static final int IDEA_ID = 195061;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195061Service() {
        this(new Idea195061Config());
    }

    public Idea195061Service(Idea195061Config config) {
        this.config = config != null ? config : new Idea195061Config();
