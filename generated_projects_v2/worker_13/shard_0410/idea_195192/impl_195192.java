...
@Data
public class Idea195192Config {
    private String name = "idea_195192";
 ...
 */
@Slf4j
public class Idea195192Service {
    private static final int IDEA_ID = 195192;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195192Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195192Service() {
        this(new Idea195192Config());
    }

    public Idea195192Service(Idea195192Config config) {
        this.config = config != null ? config : new Idea195192Config();
