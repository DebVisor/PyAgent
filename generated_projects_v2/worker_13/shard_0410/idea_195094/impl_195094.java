...
@Data
public class Idea195094Config {
    private String name = "idea_195094";
 ...
 */
@Slf4j
public class Idea195094Service {
    private static final int IDEA_ID = 195094;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195094Service() {
        this(new Idea195094Config());
    }

    public Idea195094Service(Idea195094Config config) {
        this.config = config != null ? config : new Idea195094Config();
