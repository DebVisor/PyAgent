...
@Data
public class Idea195180Config {
    private String name = "idea_195180";
 ...
 */
@Slf4j
public class Idea195180Service {
    private static final int IDEA_ID = 195180;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195180Service() {
        this(new Idea195180Config());
    }

    public Idea195180Service(Idea195180Config config) {
        this.config = config != null ? config : new Idea195180Config();
