...
@Data
public class Idea195072Config {
    private String name = "idea_195072";
 ...
 */
@Slf4j
public class Idea195072Service {
    private static final int IDEA_ID = 195072;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195072Service() {
        this(new Idea195072Config());
    }

    public Idea195072Service(Idea195072Config config) {
        this.config = config != null ? config : new Idea195072Config();
