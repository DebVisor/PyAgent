...
@Data
public class Idea195022Config {
    private String name = "idea_195022";
 ...
 */
@Slf4j
public class Idea195022Service {
    private static final int IDEA_ID = 195022;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195022Service() {
        this(new Idea195022Config());
    }

    public Idea195022Service(Idea195022Config config) {
        this.config = config != null ? config : new Idea195022Config();
