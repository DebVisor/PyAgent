...
@Data
public class Idea195066Config {
    private String name = "idea_195066";
 ...
 */
@Slf4j
public class Idea195066Service {
    private static final int IDEA_ID = 195066;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195066Service() {
        this(new Idea195066Config());
    }

    public Idea195066Service(Idea195066Config config) {
        this.config = config != null ? config : new Idea195066Config();
