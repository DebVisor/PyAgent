...
@Data
public class Idea195172Config {
    private String name = "idea_195172";
 ...
 */
@Slf4j
public class Idea195172Service {
    private static final int IDEA_ID = 195172;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195172Service() {
        this(new Idea195172Config());
    }

    public Idea195172Service(Idea195172Config config) {
        this.config = config != null ? config : new Idea195172Config();
