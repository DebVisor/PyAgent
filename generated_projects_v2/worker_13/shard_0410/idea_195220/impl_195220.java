...
@Data
public class Idea195220Config {
    private String name = "idea_195220";
 ...
 */
@Slf4j
public class Idea195220Service {
    private static final int IDEA_ID = 195220;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195220Service() {
        this(new Idea195220Config());
    }

    public Idea195220Service(Idea195220Config config) {
        this.config = config != null ? config : new Idea195220Config();
