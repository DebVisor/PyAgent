...
@Data
public class Idea195036Config {
    private String name = "idea_195036";
 ...
 */
@Slf4j
public class Idea195036Service {
    private static final int IDEA_ID = 195036;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195036Service() {
        this(new Idea195036Config());
    }

    public Idea195036Service(Idea195036Config config) {
        this.config = config != null ? config : new Idea195036Config();
