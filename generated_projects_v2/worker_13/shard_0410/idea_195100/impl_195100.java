...
@Data
public class Idea195100Config {
    private String name = "idea_195100";
 ...
 */
@Slf4j
public class Idea195100Service {
    private static final int IDEA_ID = 195100;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195100Service() {
        this(new Idea195100Config());
    }

    public Idea195100Service(Idea195100Config config) {
        this.config = config != null ? config : new Idea195100Config();
