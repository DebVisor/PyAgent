...
@Data
public class Idea195167Config {
    private String name = "idea_195167";
 ...
 */
@Slf4j
public class Idea195167Service {
    private static final int IDEA_ID = 195167;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195167Service() {
        this(new Idea195167Config());
    }

    public Idea195167Service(Idea195167Config config) {
        this.config = config != null ? config : new Idea195167Config();
