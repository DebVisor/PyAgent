...
@Data
public class Idea195146Config {
    private String name = "idea_195146";
 ...
 */
@Slf4j
public class Idea195146Service {
    private static final int IDEA_ID = 195146;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195146Service() {
        this(new Idea195146Config());
    }

    public Idea195146Service(Idea195146Config config) {
        this.config = config != null ? config : new Idea195146Config();
