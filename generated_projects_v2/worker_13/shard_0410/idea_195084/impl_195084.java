...
@Data
public class Idea195084Config {
    private String name = "idea_195084";
 ...
 */
@Slf4j
public class Idea195084Service {
    private static final int IDEA_ID = 195084;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195084Service() {
        this(new Idea195084Config());
    }

    public Idea195084Service(Idea195084Config config) {
        this.config = config != null ? config : new Idea195084Config();
