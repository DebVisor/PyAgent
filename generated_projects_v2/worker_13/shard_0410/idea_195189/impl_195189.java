...
@Data
public class Idea195189Config {
    private String name = "idea_195189";
 ...
 */
@Slf4j
public class Idea195189Service {
    private static final int IDEA_ID = 195189;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195189Service() {
        this(new Idea195189Config());
    }

    public Idea195189Service(Idea195189Config config) {
        this.config = config != null ? config : new Idea195189Config();
