...
@Data
public class Idea195101Config {
    private String name = "idea_195101";
 ...
 */
@Slf4j
public class Idea195101Service {
    private static final int IDEA_ID = 195101;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195101Service() {
        this(new Idea195101Config());
    }

    public Idea195101Service(Idea195101Config config) {
        this.config = config != null ? config : new Idea195101Config();
