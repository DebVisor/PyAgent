...
@Data
public class Idea195062Config {
    private String name = "idea_195062";
 ...
 */
@Slf4j
public class Idea195062Service {
    private static final int IDEA_ID = 195062;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195062Service() {
        this(new Idea195062Config());
    }

    public Idea195062Service(Idea195062Config config) {
        this.config = config != null ? config : new Idea195062Config();
