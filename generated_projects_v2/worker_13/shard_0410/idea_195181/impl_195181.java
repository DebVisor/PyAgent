...
@Data
public class Idea195181Config {
    private String name = "idea_195181";
 ...
 */
@Slf4j
public class Idea195181Service {
    private static final int IDEA_ID = 195181;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195181Service() {
        this(new Idea195181Config());
    }

    public Idea195181Service(Idea195181Config config) {
        this.config = config != null ? config : new Idea195181Config();
