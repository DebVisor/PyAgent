...
@Data
public class Idea195006Config {
    private String name = "idea_195006";
 ...
 */
@Slf4j
public class Idea195006Service {
    private static final int IDEA_ID = 195006;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195006Service() {
        this(new Idea195006Config());
    }

    public Idea195006Service(Idea195006Config config) {
        this.config = config != null ? config : new Idea195006Config();
