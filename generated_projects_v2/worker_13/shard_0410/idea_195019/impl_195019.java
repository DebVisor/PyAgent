...
@Data
public class Idea195019Config {
    private String name = "idea_195019";
 ...
 */
@Slf4j
public class Idea195019Service {
    private static final int IDEA_ID = 195019;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195019Service() {
        this(new Idea195019Config());
    }

    public Idea195019Service(Idea195019Config config) {
        this.config = config != null ? config : new Idea195019Config();
