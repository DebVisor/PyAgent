...
@Data
public class Idea195014Config {
    private String name = "idea_195014";
 ...
 */
@Slf4j
public class Idea195014Service {
    private static final int IDEA_ID = 195014;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195014Service() {
        this(new Idea195014Config());
    }

    public Idea195014Service(Idea195014Config config) {
        this.config = config != null ? config : new Idea195014Config();
