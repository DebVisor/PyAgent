...
@Data
public class Idea195204Config {
    private String name = "idea_195204";
 ...
 */
@Slf4j
public class Idea195204Service {
    private static final int IDEA_ID = 195204;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195204Service() {
        this(new Idea195204Config());
    }

    public Idea195204Service(Idea195204Config config) {
        this.config = config != null ? config : new Idea195204Config();
