...
@Data
public class Idea195120Config {
    private String name = "idea_195120";
 ...
 */
@Slf4j
public class Idea195120Service {
    private static final int IDEA_ID = 195120;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195120Service() {
        this(new Idea195120Config());
    }

    public Idea195120Service(Idea195120Config config) {
        this.config = config != null ? config : new Idea195120Config();
