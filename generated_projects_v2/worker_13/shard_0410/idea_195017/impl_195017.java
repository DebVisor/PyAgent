...
@Data
public class Idea195017Config {
    private String name = "idea_195017";
 ...
 */
@Slf4j
public class Idea195017Service {
    private static final int IDEA_ID = 195017;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195017Service() {
        this(new Idea195017Config());
    }

    public Idea195017Service(Idea195017Config config) {
        this.config = config != null ? config : new Idea195017Config();
