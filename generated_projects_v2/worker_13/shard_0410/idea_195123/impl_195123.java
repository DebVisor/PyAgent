...
@Data
public class Idea195123Config {
    private String name = "idea_195123";
 ...
 */
@Slf4j
public class Idea195123Service {
    private static final int IDEA_ID = 195123;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195123Service() {
        this(new Idea195123Config());
    }

    public Idea195123Service(Idea195123Config config) {
        this.config = config != null ? config : new Idea195123Config();
