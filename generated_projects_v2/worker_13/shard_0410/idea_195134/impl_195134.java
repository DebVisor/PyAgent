...
@Data
public class Idea195134Config {
    private String name = "idea_195134";
 ...
 */
@Slf4j
public class Idea195134Service {
    private static final int IDEA_ID = 195134;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195134Service() {
        this(new Idea195134Config());
    }

    public Idea195134Service(Idea195134Config config) {
        this.config = config != null ? config : new Idea195134Config();
