...
@Data
public class Idea195158Config {
    private String name = "idea_195158";
 ...
 */
@Slf4j
public class Idea195158Service {
    private static final int IDEA_ID = 195158;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195158Service() {
        this(new Idea195158Config());
    }

    public Idea195158Service(Idea195158Config config) {
        this.config = config != null ? config : new Idea195158Config();
