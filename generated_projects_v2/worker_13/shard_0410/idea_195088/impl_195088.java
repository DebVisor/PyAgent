...
@Data
public class Idea195088Config {
    private String name = "idea_195088";
 ...
 */
@Slf4j
public class Idea195088Service {
    private static final int IDEA_ID = 195088;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195088Service() {
        this(new Idea195088Config());
    }

    public Idea195088Service(Idea195088Config config) {
        this.config = config != null ? config : new Idea195088Config();
