...
@Data
public class Idea195171Config {
    private String name = "idea_195171";
 ...
 */
@Slf4j
public class Idea195171Service {
    private static final int IDEA_ID = 195171;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195171Service() {
        this(new Idea195171Config());
    }

    public Idea195171Service(Idea195171Config config) {
        this.config = config != null ? config : new Idea195171Config();
