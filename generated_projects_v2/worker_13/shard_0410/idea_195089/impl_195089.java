...
@Data
public class Idea195089Config {
    private String name = "idea_195089";
 ...
 */
@Slf4j
public class Idea195089Service {
    private static final int IDEA_ID = 195089;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195089Service() {
        this(new Idea195089Config());
    }

    public Idea195089Service(Idea195089Config config) {
        this.config = config != null ? config : new Idea195089Config();
