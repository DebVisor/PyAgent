...
@Data
public class Idea195149Config {
    private String name = "idea_195149";
 ...
 */
@Slf4j
public class Idea195149Service {
    private static final int IDEA_ID = 195149;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195149Service() {
        this(new Idea195149Config());
    }

    public Idea195149Service(Idea195149Config config) {
        this.config = config != null ? config : new Idea195149Config();
