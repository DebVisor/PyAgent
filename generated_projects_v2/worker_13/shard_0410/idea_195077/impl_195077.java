...
@Data
public class Idea195077Config {
    private String name = "idea_195077";
 ...
 */
@Slf4j
public class Idea195077Service {
    private static final int IDEA_ID = 195077;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195077Service() {
        this(new Idea195077Config());
    }

    public Idea195077Service(Idea195077Config config) {
        this.config = config != null ? config : new Idea195077Config();
