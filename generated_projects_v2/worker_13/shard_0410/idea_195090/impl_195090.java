...
@Data
public class Idea195090Config {
    private String name = "idea_195090";
 ...
 */
@Slf4j
public class Idea195090Service {
    private static final int IDEA_ID = 195090;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195090Service() {
        this(new Idea195090Config());
    }

    public Idea195090Service(Idea195090Config config) {
        this.config = config != null ? config : new Idea195090Config();
