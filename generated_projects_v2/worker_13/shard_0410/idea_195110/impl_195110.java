...
@Data
public class Idea195110Config {
    private String name = "idea_195110";
 ...
 */
@Slf4j
public class Idea195110Service {
    private static final int IDEA_ID = 195110;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195110Service() {
        this(new Idea195110Config());
    }

    public Idea195110Service(Idea195110Config config) {
        this.config = config != null ? config : new Idea195110Config();
