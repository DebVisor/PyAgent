...
@Data
public class Idea195142Config {
    private String name = "idea_195142";
 ...
 */
@Slf4j
public class Idea195142Service {
    private static final int IDEA_ID = 195142;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195142Service() {
        this(new Idea195142Config());
    }

    public Idea195142Service(Idea195142Config config) {
        this.config = config != null ? config : new Idea195142Config();
