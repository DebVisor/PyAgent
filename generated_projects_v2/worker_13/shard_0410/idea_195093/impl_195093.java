...
@Data
public class Idea195093Config {
    private String name = "idea_195093";
 ...
 */
@Slf4j
public class Idea195093Service {
    private static final int IDEA_ID = 195093;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195093Service() {
        this(new Idea195093Config());
    }

    public Idea195093Service(Idea195093Config config) {
        this.config = config != null ? config : new Idea195093Config();
