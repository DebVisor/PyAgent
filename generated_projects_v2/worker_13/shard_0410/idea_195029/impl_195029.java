...
@Data
public class Idea195029Config {
    private String name = "idea_195029";
 ...
 */
@Slf4j
public class Idea195029Service {
    private static final int IDEA_ID = 195029;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195029Service() {
        this(new Idea195029Config());
    }

    public Idea195029Service(Idea195029Config config) {
        this.config = config != null ? config : new Idea195029Config();
