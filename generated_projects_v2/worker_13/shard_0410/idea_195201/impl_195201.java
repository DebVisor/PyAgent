...
@Data
public class Idea195201Config {
    private String name = "idea_195201";
 ...
 */
@Slf4j
public class Idea195201Service {
    private static final int IDEA_ID = 195201;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195201Service() {
        this(new Idea195201Config());
    }

    public Idea195201Service(Idea195201Config config) {
        this.config = config != null ? config : new Idea195201Config();
