...
@Data
public class Idea195155Config {
    private String name = "idea_195155";
 ...
 */
@Slf4j
public class Idea195155Service {
    private static final int IDEA_ID = 195155;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195155Service() {
        this(new Idea195155Config());
    }

    public Idea195155Service(Idea195155Config config) {
        this.config = config != null ? config : new Idea195155Config();
