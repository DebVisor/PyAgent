...
@Data
public class Idea195188Config {
    private String name = "idea_195188";
 ...
 */
@Slf4j
public class Idea195188Service {
    private static final int IDEA_ID = 195188;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195188Service() {
        this(new Idea195188Config());
    }

    public Idea195188Service(Idea195188Config config) {
        this.config = config != null ? config : new Idea195188Config();
