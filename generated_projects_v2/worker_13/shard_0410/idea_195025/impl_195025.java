...
@Data
public class Idea195025Config {
    private String name = "idea_195025";
 ...
 */
@Slf4j
public class Idea195025Service {
    private static final int IDEA_ID = 195025;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195025Service() {
        this(new Idea195025Config());
    }

    public Idea195025Service(Idea195025Config config) {
        this.config = config != null ? config : new Idea195025Config();
