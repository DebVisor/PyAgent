...
@Data
public class Idea195195Config {
    private String name = "idea_195195";
 ...
 */
@Slf4j
public class Idea195195Service {
    private static final int IDEA_ID = 195195;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195195Service() {
        this(new Idea195195Config());
    }

    public Idea195195Service(Idea195195Config config) {
        this.config = config != null ? config : new Idea195195Config();
