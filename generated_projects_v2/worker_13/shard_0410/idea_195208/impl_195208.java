...
@Data
public class Idea195208Config {
    private String name = "idea_195208";
 ...
 */
@Slf4j
public class Idea195208Service {
    private static final int IDEA_ID = 195208;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195208Service() {
        this(new Idea195208Config());
    }

    public Idea195208Service(Idea195208Config config) {
        this.config = config != null ? config : new Idea195208Config();
