...
@Data
public class Idea195012Config {
    private String name = "idea_195012";
 ...
 */
@Slf4j
public class Idea195012Service {
    private static final int IDEA_ID = 195012;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195012Service() {
        this(new Idea195012Config());
    }

    public Idea195012Service(Idea195012Config config) {
        this.config = config != null ? config : new Idea195012Config();
