...
@Data
public class Idea195206Config {
    private String name = "idea_195206";
 ...
 */
@Slf4j
public class Idea195206Service {
    private static final int IDEA_ID = 195206;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195206Service() {
        this(new Idea195206Config());
    }

    public Idea195206Service(Idea195206Config config) {
        this.config = config != null ? config : new Idea195206Config();
