...
@Data
public class Idea195112Config {
    private String name = "idea_195112";
 ...
 */
@Slf4j
public class Idea195112Service {
    private static final int IDEA_ID = 195112;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195112Service() {
        this(new Idea195112Config());
    }

    public Idea195112Service(Idea195112Config config) {
        this.config = config != null ? config : new Idea195112Config();
