...
@Data
public class Idea195021Config {
    private String name = "idea_195021";
 ...
 */
@Slf4j
public class Idea195021Service {
    private static final int IDEA_ID = 195021;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195021Service() {
        this(new Idea195021Config());
    }

    public Idea195021Service(Idea195021Config config) {
        this.config = config != null ? config : new Idea195021Config();
