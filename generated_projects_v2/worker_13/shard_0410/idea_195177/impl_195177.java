...
@Data
public class Idea195177Config {
    private String name = "idea_195177";
 ...
 */
@Slf4j
public class Idea195177Service {
    private static final int IDEA_ID = 195177;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195177Service() {
        this(new Idea195177Config());
    }

    public Idea195177Service(Idea195177Config config) {
        this.config = config != null ? config : new Idea195177Config();
