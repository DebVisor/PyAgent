...
@Data
public class Idea195060Config {
    private String name = "idea_195060";
 ...
 */
@Slf4j
public class Idea195060Service {
    private static final int IDEA_ID = 195060;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195060Service() {
        this(new Idea195060Config());
    }

    public Idea195060Service(Idea195060Config config) {
        this.config = config != null ? config : new Idea195060Config();
