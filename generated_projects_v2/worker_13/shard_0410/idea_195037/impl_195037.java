...
@Data
public class Idea195037Config {
    private String name = "idea_195037";
 ...
 */
@Slf4j
public class Idea195037Service {
    private static final int IDEA_ID = 195037;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195037Service() {
        this(new Idea195037Config());
    }

    public Idea195037Service(Idea195037Config config) {
        this.config = config != null ? config : new Idea195037Config();
