...
@Data
public class Idea195143Config {
    private String name = "idea_195143";
 ...
 */
@Slf4j
public class Idea195143Service {
    private static final int IDEA_ID = 195143;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195143Service() {
        this(new Idea195143Config());
    }

    public Idea195143Service(Idea195143Config config) {
        this.config = config != null ? config : new Idea195143Config();
