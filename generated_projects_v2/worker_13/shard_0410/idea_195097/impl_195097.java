...
@Data
public class Idea195097Config {
    private String name = "idea_195097";
 ...
 */
@Slf4j
public class Idea195097Service {
    private static final int IDEA_ID = 195097;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195097Service() {
        this(new Idea195097Config());
    }

    public Idea195097Service(Idea195097Config config) {
        this.config = config != null ? config : new Idea195097Config();
