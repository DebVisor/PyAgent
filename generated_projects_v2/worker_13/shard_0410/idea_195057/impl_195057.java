...
@Data
public class Idea195057Config {
    private String name = "idea_195057";
 ...
 */
@Slf4j
public class Idea195057Service {
    private static final int IDEA_ID = 195057;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195057Service() {
        this(new Idea195057Config());
    }

    public Idea195057Service(Idea195057Config config) {
        this.config = config != null ? config : new Idea195057Config();
