...
@Data
public class Idea195040Config {
    private String name = "idea_195040";
 ...
 */
@Slf4j
public class Idea195040Service {
    private static final int IDEA_ID = 195040;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195040Service() {
        this(new Idea195040Config());
    }

    public Idea195040Service(Idea195040Config config) {
        this.config = config != null ? config : new Idea195040Config();
