...
@Data
public class Idea195210Config {
    private String name = "idea_195210";
 ...
 */
@Slf4j
public class Idea195210Service {
    private static final int IDEA_ID = 195210;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195210Service() {
        this(new Idea195210Config());
    }

    public Idea195210Service(Idea195210Config config) {
        this.config = config != null ? config : new Idea195210Config();
