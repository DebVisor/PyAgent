...
@Data
public class Idea195004Config {
    private String name = "idea_195004";
 ...
 */
@Slf4j
public class Idea195004Service {
    private static final int IDEA_ID = 195004;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195004Service() {
        this(new Idea195004Config());
    }

    public Idea195004Service(Idea195004Config config) {
        this.config = config != null ? config : new Idea195004Config();
