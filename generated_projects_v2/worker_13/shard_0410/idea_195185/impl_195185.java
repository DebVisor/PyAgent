...
@Data
public class Idea195185Config {
    private String name = "idea_195185";
 ...
 */
@Slf4j
public class Idea195185Service {
    private static final int IDEA_ID = 195185;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195185Service() {
        this(new Idea195185Config());
    }

    public Idea195185Service(Idea195185Config config) {
        this.config = config != null ? config : new Idea195185Config();
