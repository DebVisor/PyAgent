...
@Data
public class Idea195013Config {
    private String name = "idea_195013";
 ...
 */
@Slf4j
public class Idea195013Service {
    private static final int IDEA_ID = 195013;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195013Service() {
        this(new Idea195013Config());
    }

    public Idea195013Service(Idea195013Config config) {
        this.config = config != null ? config : new Idea195013Config();
