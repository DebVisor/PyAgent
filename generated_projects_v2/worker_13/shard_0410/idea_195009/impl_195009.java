...
@Data
public class Idea195009Config {
    private String name = "idea_195009";
 ...
 */
@Slf4j
public class Idea195009Service {
    private static final int IDEA_ID = 195009;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195009Service() {
        this(new Idea195009Config());
    }

    public Idea195009Service(Idea195009Config config) {
        this.config = config != null ? config : new Idea195009Config();
