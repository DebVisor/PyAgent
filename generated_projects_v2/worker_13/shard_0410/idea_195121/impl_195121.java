...
@Data
public class Idea195121Config {
    private String name = "idea_195121";
 ...
 */
@Slf4j
public class Idea195121Service {
    private static final int IDEA_ID = 195121;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195121Service() {
        this(new Idea195121Config());
    }

    public Idea195121Service(Idea195121Config config) {
        this.config = config != null ? config : new Idea195121Config();
