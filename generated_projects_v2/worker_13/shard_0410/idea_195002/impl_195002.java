...
@Data
public class Idea195002Config {
    private String name = "idea_195002";
 ...
 */
@Slf4j
public class Idea195002Service {
    private static final int IDEA_ID = 195002;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195002Service() {
        this(new Idea195002Config());
    }

    public Idea195002Service(Idea195002Config config) {
        this.config = config != null ? config : new Idea195002Config();
