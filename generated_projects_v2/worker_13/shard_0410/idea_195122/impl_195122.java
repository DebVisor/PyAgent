...
@Data
public class Idea195122Config {
    private String name = "idea_195122";
 ...
 */
@Slf4j
public class Idea195122Service {
    private static final int IDEA_ID = 195122;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195122Service() {
        this(new Idea195122Config());
    }

    public Idea195122Service(Idea195122Config config) {
        this.config = config != null ? config : new Idea195122Config();
