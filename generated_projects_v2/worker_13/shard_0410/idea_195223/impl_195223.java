...
@Data
public class Idea195223Config {
    private String name = "idea_195223";
 ...
 */
@Slf4j
public class Idea195223Service {
    private static final int IDEA_ID = 195223;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195223Service() {
        this(new Idea195223Config());
    }

    public Idea195223Service(Idea195223Config config) {
        this.config = config != null ? config : new Idea195223Config();
