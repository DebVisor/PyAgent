...
@Data
public class Idea195063Config {
    private String name = "idea_195063";
 ...
 */
@Slf4j
public class Idea195063Service {
    private static final int IDEA_ID = 195063;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195063Service() {
        this(new Idea195063Config());
    }

    public Idea195063Service(Idea195063Config config) {
        this.config = config != null ? config : new Idea195063Config();
