...
@Data
public class Idea195213Config {
    private String name = "idea_195213";
 ...
 */
@Slf4j
public class Idea195213Service {
    private static final int IDEA_ID = 195213;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195213Service() {
        this(new Idea195213Config());
    }

    public Idea195213Service(Idea195213Config config) {
        this.config = config != null ? config : new Idea195213Config();
