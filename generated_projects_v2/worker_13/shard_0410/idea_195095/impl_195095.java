...
@Data
public class Idea195095Config {
    private String name = "idea_195095";
 ...
 */
@Slf4j
public class Idea195095Service {
    private static final int IDEA_ID = 195095;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195095Service() {
        this(new Idea195095Config());
    }

    public Idea195095Service(Idea195095Config config) {
        this.config = config != null ? config : new Idea195095Config();
