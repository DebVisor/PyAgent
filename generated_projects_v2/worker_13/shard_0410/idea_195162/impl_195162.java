...
@Data
public class Idea195162Config {
    private String name = "idea_195162";
 ...
 */
@Slf4j
public class Idea195162Service {
    private static final int IDEA_ID = 195162;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195162Service() {
        this(new Idea195162Config());
    }

    public Idea195162Service(Idea195162Config config) {
        this.config = config != null ? config : new Idea195162Config();
