...
@Data
public class Idea195118Config {
    private String name = "idea_195118";
 ...
 */
@Slf4j
public class Idea195118Service {
    private static final int IDEA_ID = 195118;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195118Service() {
        this(new Idea195118Config());
    }

    public Idea195118Service(Idea195118Config config) {
        this.config = config != null ? config : new Idea195118Config();
