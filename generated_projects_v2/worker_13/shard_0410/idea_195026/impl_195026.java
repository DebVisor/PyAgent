...
@Data
public class Idea195026Config {
    private String name = "idea_195026";
 ...
 */
@Slf4j
public class Idea195026Service {
    private static final int IDEA_ID = 195026;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195026Service() {
        this(new Idea195026Config());
    }

    public Idea195026Service(Idea195026Config config) {
        this.config = config != null ? config : new Idea195026Config();
