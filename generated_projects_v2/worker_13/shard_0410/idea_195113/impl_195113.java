...
@Data
public class Idea195113Config {
    private String name = "idea_195113";
 ...
 */
@Slf4j
public class Idea195113Service {
    private static final int IDEA_ID = 195113;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195113Service() {
        this(new Idea195113Config());
    }

    public Idea195113Service(Idea195113Config config) {
        this.config = config != null ? config : new Idea195113Config();
