...
@Data
public class Idea195198Config {
    private String name = "idea_195198";
 ...
 */
@Slf4j
public class Idea195198Service {
    private static final int IDEA_ID = 195198;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195198Service() {
        this(new Idea195198Config());
    }

    public Idea195198Service(Idea195198Config config) {
        this.config = config != null ? config : new Idea195198Config();
