...
@Data
public class Idea195168Config {
    private String name = "idea_195168";
 ...
 */
@Slf4j
public class Idea195168Service {
    private static final int IDEA_ID = 195168;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195168Service() {
        this(new Idea195168Config());
    }

    public Idea195168Service(Idea195168Config config) {
        this.config = config != null ? config : new Idea195168Config();
