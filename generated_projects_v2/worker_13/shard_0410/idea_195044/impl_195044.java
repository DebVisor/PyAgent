...
@Data
public class Idea195044Config {
    private String name = "idea_195044";
 ...
 */
@Slf4j
public class Idea195044Service {
    private static final int IDEA_ID = 195044;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195044Service() {
        this(new Idea195044Config());
    }

    public Idea195044Service(Idea195044Config config) {
        this.config = config != null ? config : new Idea195044Config();
