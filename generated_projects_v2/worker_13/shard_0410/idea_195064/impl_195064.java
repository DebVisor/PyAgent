...
@Data
public class Idea195064Config {
    private String name = "idea_195064";
 ...
 */
@Slf4j
public class Idea195064Service {
    private static final int IDEA_ID = 195064;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195064Service() {
        this(new Idea195064Config());
    }

    public Idea195064Service(Idea195064Config config) {
        this.config = config != null ? config : new Idea195064Config();
