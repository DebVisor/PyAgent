...
@Data
public class Idea195190Config {
    private String name = "idea_195190";
 ...
 */
@Slf4j
public class Idea195190Service {
    private static final int IDEA_ID = 195190;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195190Service() {
        this(new Idea195190Config());
    }

    public Idea195190Service(Idea195190Config config) {
        this.config = config != null ? config : new Idea195190Config();
