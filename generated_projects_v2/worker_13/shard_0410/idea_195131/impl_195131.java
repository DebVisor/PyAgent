...
@Data
public class Idea195131Config {
    private String name = "idea_195131";
 ...
 */
@Slf4j
public class Idea195131Service {
    private static final int IDEA_ID = 195131;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195131Service() {
        this(new Idea195131Config());
    }

    public Idea195131Service(Idea195131Config config) {
        this.config = config != null ? config : new Idea195131Config();
