...
@Data
public class Idea195007Config {
    private String name = "idea_195007";
 ...
 */
@Slf4j
public class Idea195007Service {
    private static final int IDEA_ID = 195007;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195007Service() {
        this(new Idea195007Config());
    }

    public Idea195007Service(Idea195007Config config) {
        this.config = config != null ? config : new Idea195007Config();
