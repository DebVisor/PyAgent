...
@Data
public class Idea195076Config {
    private String name = "idea_195076";
 ...
 */
@Slf4j
public class Idea195076Service {
    private static final int IDEA_ID = 195076;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195076Service() {
        this(new Idea195076Config());
    }

    public Idea195076Service(Idea195076Config config) {
        this.config = config != null ? config : new Idea195076Config();
