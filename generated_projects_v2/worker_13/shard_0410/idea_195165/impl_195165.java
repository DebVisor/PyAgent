...
@Data
public class Idea195165Config {
    private String name = "idea_195165";
 ...
 */
@Slf4j
public class Idea195165Service {
    private static final int IDEA_ID = 195165;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195165Service() {
        this(new Idea195165Config());
    }

    public Idea195165Service(Idea195165Config config) {
        this.config = config != null ? config : new Idea195165Config();
