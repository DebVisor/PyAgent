...
@Data
public class Idea195107Config {
    private String name = "idea_195107";
 ...
 */
@Slf4j
public class Idea195107Service {
    private static final int IDEA_ID = 195107;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195107Service() {
        this(new Idea195107Config());
    }

    public Idea195107Service(Idea195107Config config) {
        this.config = config != null ? config : new Idea195107Config();
