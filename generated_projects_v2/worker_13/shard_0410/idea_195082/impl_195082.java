...
@Data
public class Idea195082Config {
    private String name = "idea_195082";
 ...
 */
@Slf4j
public class Idea195082Service {
    private static final int IDEA_ID = 195082;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195082Service() {
        this(new Idea195082Config());
    }

    public Idea195082Service(Idea195082Config config) {
        this.config = config != null ? config : new Idea195082Config();
