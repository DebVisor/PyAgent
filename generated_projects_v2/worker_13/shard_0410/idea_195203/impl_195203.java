...
@Data
public class Idea195203Config {
    private String name = "idea_195203";
 ...
 */
@Slf4j
public class Idea195203Service {
    private static final int IDEA_ID = 195203;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195203Service() {
        this(new Idea195203Config());
    }

    public Idea195203Service(Idea195203Config config) {
        this.config = config != null ? config : new Idea195203Config();
