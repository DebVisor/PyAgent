...
@Data
public class Idea195030Config {
    private String name = "idea_195030";
 ...
 */
@Slf4j
public class Idea195030Service {
    private static final int IDEA_ID = 195030;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195030Service() {
        this(new Idea195030Config());
    }

    public Idea195030Service(Idea195030Config config) {
        this.config = config != null ? config : new Idea195030Config();
