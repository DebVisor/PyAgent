...
@Data
public class Idea195221Config {
    private String name = "idea_195221";
 ...
 */
@Slf4j
public class Idea195221Service {
    private static final int IDEA_ID = 195221;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195221Service() {
        this(new Idea195221Config());
    }

    public Idea195221Service(Idea195221Config config) {
        this.config = config != null ? config : new Idea195221Config();
