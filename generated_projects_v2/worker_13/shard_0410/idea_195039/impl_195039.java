...
@Data
public class Idea195039Config {
    private String name = "idea_195039";
 ...
 */
@Slf4j
public class Idea195039Service {
    private static final int IDEA_ID = 195039;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195039Service() {
        this(new Idea195039Config());
    }

    public Idea195039Service(Idea195039Config config) {
        this.config = config != null ? config : new Idea195039Config();
