...
@Data
public class Idea195114Config {
    private String name = "idea_195114";
 ...
 */
@Slf4j
public class Idea195114Service {
    private static final int IDEA_ID = 195114;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195114Service() {
        this(new Idea195114Config());
    }

    public Idea195114Service(Idea195114Config config) {
        this.config = config != null ? config : new Idea195114Config();
