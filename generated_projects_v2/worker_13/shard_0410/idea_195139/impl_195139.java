...
@Data
public class Idea195139Config {
    private String name = "idea_195139";
 ...
 */
@Slf4j
public class Idea195139Service {
    private static final int IDEA_ID = 195139;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195139Service() {
        this(new Idea195139Config());
    }

    public Idea195139Service(Idea195139Config config) {
        this.config = config != null ? config : new Idea195139Config();
