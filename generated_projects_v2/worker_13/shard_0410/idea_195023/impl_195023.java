...
@Data
public class Idea195023Config {
    private String name = "idea_195023";
 ...
 */
@Slf4j
public class Idea195023Service {
    private static final int IDEA_ID = 195023;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195023Service() {
        this(new Idea195023Config());
    }

    public Idea195023Service(Idea195023Config config) {
        this.config = config != null ? config : new Idea195023Config();
