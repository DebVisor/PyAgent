...
@Data
public class Idea195125Config {
    private String name = "idea_195125";
 ...
 */
@Slf4j
public class Idea195125Service {
    private static final int IDEA_ID = 195125;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195125Service() {
        this(new Idea195125Config());
    }

    public Idea195125Service(Idea195125Config config) {
        this.config = config != null ? config : new Idea195125Config();
