...
@Data
public class Idea195124Config {
    private String name = "idea_195124";
 ...
 */
@Slf4j
public class Idea195124Service {
    private static final int IDEA_ID = 195124;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195124Service() {
        this(new Idea195124Config());
    }

    public Idea195124Service(Idea195124Config config) {
        this.config = config != null ? config : new Idea195124Config();
