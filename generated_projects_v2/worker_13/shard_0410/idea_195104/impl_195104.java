...
@Data
public class Idea195104Config {
    private String name = "idea_195104";
 ...
 */
@Slf4j
public class Idea195104Service {
    private static final int IDEA_ID = 195104;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195104Service() {
        this(new Idea195104Config());
    }

    public Idea195104Service(Idea195104Config config) {
        this.config = config != null ? config : new Idea195104Config();
