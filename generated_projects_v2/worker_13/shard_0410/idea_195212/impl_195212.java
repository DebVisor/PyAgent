...
@Data
public class Idea195212Config {
    private String name = "idea_195212";
 ...
 */
@Slf4j
public class Idea195212Service {
    private static final int IDEA_ID = 195212;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195212Service() {
        this(new Idea195212Config());
    }

    public Idea195212Service(Idea195212Config config) {
        this.config = config != null ? config : new Idea195212Config();
