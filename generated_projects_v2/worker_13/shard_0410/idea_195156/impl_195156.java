...
@Data
public class Idea195156Config {
    private String name = "idea_195156";
 ...
 */
@Slf4j
public class Idea195156Service {
    private static final int IDEA_ID = 195156;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195156Service() {
        this(new Idea195156Config());
    }

    public Idea195156Service(Idea195156Config config) {
        this.config = config != null ? config : new Idea195156Config();
