...
@Data
public class Idea195016Config {
    private String name = "idea_195016";
 ...
 */
@Slf4j
public class Idea195016Service {
    private static final int IDEA_ID = 195016;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195016Service() {
        this(new Idea195016Config());
    }

    public Idea195016Service(Idea195016Config config) {
        this.config = config != null ? config : new Idea195016Config();
