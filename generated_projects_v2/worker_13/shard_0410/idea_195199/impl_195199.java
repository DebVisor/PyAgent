...
@Data
public class Idea195199Config {
    private String name = "idea_195199";
 ...
 */
@Slf4j
public class Idea195199Service {
    private static final int IDEA_ID = 195199;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195199Service() {
        this(new Idea195199Config());
    }

    public Idea195199Service(Idea195199Config config) {
        this.config = config != null ? config : new Idea195199Config();
