...
@Data
public class Idea195074Config {
    private String name = "idea_195074";
 ...
 */
@Slf4j
public class Idea195074Service {
    private static final int IDEA_ID = 195074;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195074Service() {
        this(new Idea195074Config());
    }

    public Idea195074Service(Idea195074Config config) {
        this.config = config != null ? config : new Idea195074Config();
