...
@Data
public class Idea195075Config {
    private String name = "idea_195075";
 ...
 */
@Slf4j
public class Idea195075Service {
    private static final int IDEA_ID = 195075;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195075Service() {
        this(new Idea195075Config());
    }

    public Idea195075Service(Idea195075Config config) {
        this.config = config != null ? config : new Idea195075Config();
