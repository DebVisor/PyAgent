...
@Data
public class Idea195041Config {
    private String name = "idea_195041";
 ...
 */
@Slf4j
public class Idea195041Service {
    private static final int IDEA_ID = 195041;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195041Service() {
        this(new Idea195041Config());
    }

    public Idea195041Service(Idea195041Config config) {
        this.config = config != null ? config : new Idea195041Config();
