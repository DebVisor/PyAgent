...
@Data
public class Idea195145Config {
    private String name = "idea_195145";
 ...
 */
@Slf4j
public class Idea195145Service {
    private static final int IDEA_ID = 195145;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195145Service() {
        this(new Idea195145Config());
    }

    public Idea195145Service(Idea195145Config config) {
        this.config = config != null ? config : new Idea195145Config();
