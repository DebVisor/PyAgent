...
@Data
public class Idea195091Config {
    private String name = "idea_195091";
 ...
 */
@Slf4j
public class Idea195091Service {
    private static final int IDEA_ID = 195091;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195091Service() {
        this(new Idea195091Config());
    }

    public Idea195091Service(Idea195091Config config) {
        this.config = config != null ? config : new Idea195091Config();
