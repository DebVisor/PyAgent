...
@Data
public class Idea195132Config {
    private String name = "idea_195132";
 ...
 */
@Slf4j
public class Idea195132Service {
    private static final int IDEA_ID = 195132;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195132Service() {
        this(new Idea195132Config());
    }

    public Idea195132Service(Idea195132Config config) {
        this.config = config != null ? config : new Idea195132Config();
