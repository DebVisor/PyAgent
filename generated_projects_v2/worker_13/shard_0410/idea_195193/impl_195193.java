...
@Data
public class Idea195193Config {
    private String name = "idea_195193";
 ...
 */
@Slf4j
public class Idea195193Service {
    private static final int IDEA_ID = 195193;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195193Service() {
        this(new Idea195193Config());
    }

    public Idea195193Service(Idea195193Config config) {
        this.config = config != null ? config : new Idea195193Config();
