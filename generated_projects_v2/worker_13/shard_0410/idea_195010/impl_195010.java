...
@Data
public class Idea195010Config {
    private String name = "idea_195010";
 ...
 */
@Slf4j
public class Idea195010Service {
    private static final int IDEA_ID = 195010;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195010Service() {
        this(new Idea195010Config());
    }

    public Idea195010Service(Idea195010Config config) {
        this.config = config != null ? config : new Idea195010Config();
