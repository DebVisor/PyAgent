...
@Data
public class Idea195015Config {
    private String name = "idea_195015";
 ...
 */
@Slf4j
public class Idea195015Service {
    private static final int IDEA_ID = 195015;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195015Service() {
        this(new Idea195015Config());
    }

    public Idea195015Service(Idea195015Config config) {
        this.config = config != null ? config : new Idea195015Config();
