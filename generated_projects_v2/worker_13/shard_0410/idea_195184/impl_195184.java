...
@Data
public class Idea195184Config {
    private String name = "idea_195184";
 ...
 */
@Slf4j
public class Idea195184Service {
    private static final int IDEA_ID = 195184;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195184Service() {
        this(new Idea195184Config());
    }

    public Idea195184Service(Idea195184Config config) {
        this.config = config != null ? config : new Idea195184Config();
