...
@Data
public class Idea195070Config {
    private String name = "idea_195070";
 ...
 */
@Slf4j
public class Idea195070Service {
    private static final int IDEA_ID = 195070;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195070Service() {
        this(new Idea195070Config());
    }

    public Idea195070Service(Idea195070Config config) {
        this.config = config != null ? config : new Idea195070Config();
