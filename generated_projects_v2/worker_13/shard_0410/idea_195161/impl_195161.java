...
@Data
public class Idea195161Config {
    private String name = "idea_195161";
 ...
 */
@Slf4j
public class Idea195161Service {
    private static final int IDEA_ID = 195161;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195161Service() {
        this(new Idea195161Config());
    }

    public Idea195161Service(Idea195161Config config) {
        this.config = config != null ? config : new Idea195161Config();
