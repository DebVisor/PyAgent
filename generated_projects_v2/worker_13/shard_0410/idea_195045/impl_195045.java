...
@Data
public class Idea195045Config {
    private String name = "idea_195045";
 ...
 */
@Slf4j
public class Idea195045Service {
    private static final int IDEA_ID = 195045;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195045Service() {
        this(new Idea195045Config());
    }

    public Idea195045Service(Idea195045Config config) {
        this.config = config != null ? config : new Idea195045Config();
