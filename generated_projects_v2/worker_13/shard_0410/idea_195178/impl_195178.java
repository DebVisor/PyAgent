...
@Data
public class Idea195178Config {
    private String name = "idea_195178";
 ...
 */
@Slf4j
public class Idea195178Service {
    private static final int IDEA_ID = 195178;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195178Service() {
        this(new Idea195178Config());
    }

    public Idea195178Service(Idea195178Config config) {
        this.config = config != null ? config : new Idea195178Config();
