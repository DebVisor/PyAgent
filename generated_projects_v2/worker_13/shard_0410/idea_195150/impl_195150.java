...
@Data
public class Idea195150Config {
    private String name = "idea_195150";
 ...
 */
@Slf4j
public class Idea195150Service {
    private static final int IDEA_ID = 195150;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195150Service() {
        this(new Idea195150Config());
    }

    public Idea195150Service(Idea195150Config config) {
        this.config = config != null ? config : new Idea195150Config();
