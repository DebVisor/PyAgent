...
@Data
public class Idea195000Config {
    private String name = "idea_195000";
 ...
 */
@Slf4j
public class Idea195000Service {
    private static final int IDEA_ID = 195000;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195000Service() {
        this(new Idea195000Config());
    }

    public Idea195000Service(Idea195000Config config) {
        this.config = config != null ? config : new Idea195000Config();
