...
@Data
public class Idea195200Config {
    private String name = "idea_195200";
 ...
 */
@Slf4j
public class Idea195200Service {
    private static final int IDEA_ID = 195200;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195200Service() {
        this(new Idea195200Config());
    }

    public Idea195200Service(Idea195200Config config) {
        this.config = config != null ? config : new Idea195200Config();
