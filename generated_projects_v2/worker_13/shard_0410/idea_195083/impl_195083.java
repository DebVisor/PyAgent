...
@Data
public class Idea195083Config {
    private String name = "idea_195083";
 ...
 */
@Slf4j
public class Idea195083Service {
    private static final int IDEA_ID = 195083;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195083Service() {
        this(new Idea195083Config());
    }

    public Idea195083Service(Idea195083Config config) {
        this.config = config != null ? config : new Idea195083Config();
