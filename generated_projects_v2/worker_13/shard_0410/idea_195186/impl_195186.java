...
@Data
public class Idea195186Config {
    private String name = "idea_195186";
 ...
 */
@Slf4j
public class Idea195186Service {
    private static final int IDEA_ID = 195186;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195186Service() {
        this(new Idea195186Config());
    }

    public Idea195186Service(Idea195186Config config) {
        this.config = config != null ? config : new Idea195186Config();
