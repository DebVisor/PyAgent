...
@Data
public class Idea195103Config {
    private String name = "idea_195103";
 ...
 */
@Slf4j
public class Idea195103Service {
    private static final int IDEA_ID = 195103;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195103Service() {
        this(new Idea195103Config());
    }

    public Idea195103Service(Idea195103Config config) {
        this.config = config != null ? config : new Idea195103Config();
