...
@Data
public class Idea195152Config {
    private String name = "idea_195152";
 ...
 */
@Slf4j
public class Idea195152Service {
    private static final int IDEA_ID = 195152;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195152Service() {
        this(new Idea195152Config());
    }

    public Idea195152Service(Idea195152Config config) {
        this.config = config != null ? config : new Idea195152Config();
