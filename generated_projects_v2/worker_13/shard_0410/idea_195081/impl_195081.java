...
@Data
public class Idea195081Config {
    private String name = "idea_195081";
 ...
 */
@Slf4j
public class Idea195081Service {
    private static final int IDEA_ID = 195081;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195081Service() {
        this(new Idea195081Config());
    }

    public Idea195081Service(Idea195081Config config) {
        this.config = config != null ? config : new Idea195081Config();
