...
@Data
public class Idea195051Config {
    private String name = "idea_195051";
 ...
 */
@Slf4j
public class Idea195051Service {
    private static final int IDEA_ID = 195051;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195051Service() {
        this(new Idea195051Config());
    }

    public Idea195051Service(Idea195051Config config) {
        this.config = config != null ? config : new Idea195051Config();
