...
@Data
public class Idea195141Config {
    private String name = "idea_195141";
 ...
 */
@Slf4j
public class Idea195141Service {
    private static final int IDEA_ID = 195141;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195141Service() {
        this(new Idea195141Config());
    }

    public Idea195141Service(Idea195141Config config) {
        this.config = config != null ? config : new Idea195141Config();
