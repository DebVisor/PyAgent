...
@Data
public class Idea195173Config {
    private String name = "idea_195173";
 ...
 */
@Slf4j
public class Idea195173Service {
    private static final int IDEA_ID = 195173;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195173Service() {
        this(new Idea195173Config());
    }

    public Idea195173Service(Idea195173Config config) {
        this.config = config != null ? config : new Idea195173Config();
