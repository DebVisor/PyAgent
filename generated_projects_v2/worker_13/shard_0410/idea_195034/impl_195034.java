...
@Data
public class Idea195034Config {
    private String name = "idea_195034";
 ...
 */
@Slf4j
public class Idea195034Service {
    private static final int IDEA_ID = 195034;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195034Service() {
        this(new Idea195034Config());
    }

    public Idea195034Service(Idea195034Config config) {
        this.config = config != null ? config : new Idea195034Config();
