...
@Data
public class Idea195078Config {
    private String name = "idea_195078";
 ...
 */
@Slf4j
public class Idea195078Service {
    private static final int IDEA_ID = 195078;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195078Service() {
        this(new Idea195078Config());
    }

    public Idea195078Service(Idea195078Config config) {
        this.config = config != null ? config : new Idea195078Config();
