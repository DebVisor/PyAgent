...
@Data
public class Idea195174Config {
    private String name = "idea_195174";
 ...
 */
@Slf4j
public class Idea195174Service {
    private static final int IDEA_ID = 195174;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195174Service() {
        this(new Idea195174Config());
    }

    public Idea195174Service(Idea195174Config config) {
        this.config = config != null ? config : new Idea195174Config();
