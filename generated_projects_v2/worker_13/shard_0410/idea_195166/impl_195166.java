...
@Data
public class Idea195166Config {
    private String name = "idea_195166";
 ...
 */
@Slf4j
public class Idea195166Service {
    private static final int IDEA_ID = 195166;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195166Service() {
        this(new Idea195166Config());
    }

    public Idea195166Service(Idea195166Config config) {
        this.config = config != null ? config : new Idea195166Config();
