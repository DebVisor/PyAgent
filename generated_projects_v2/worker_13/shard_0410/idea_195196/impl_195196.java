...
@Data
public class Idea195196Config {
    private String name = "idea_195196";
 ...
 */
@Slf4j
public class Idea195196Service {
    private static final int IDEA_ID = 195196;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195196Service() {
        this(new Idea195196Config());
    }

    public Idea195196Service(Idea195196Config config) {
        this.config = config != null ? config : new Idea195196Config();
