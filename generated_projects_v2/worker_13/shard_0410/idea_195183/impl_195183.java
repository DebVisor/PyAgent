...
@Data
public class Idea195183Config {
    private String name = "idea_195183";
 ...
 */
@Slf4j
public class Idea195183Service {
    private static final int IDEA_ID = 195183;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195183Service() {
        this(new Idea195183Config());
    }

    public Idea195183Service(Idea195183Config config) {
        this.config = config != null ? config : new Idea195183Config();
