...
@Data
public class Idea195080Config {
    private String name = "idea_195080";
 ...
 */
@Slf4j
public class Idea195080Service {
    private static final int IDEA_ID = 195080;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195080Service() {
        this(new Idea195080Config());
    }

    public Idea195080Service(Idea195080Config config) {
        this.config = config != null ? config : new Idea195080Config();
