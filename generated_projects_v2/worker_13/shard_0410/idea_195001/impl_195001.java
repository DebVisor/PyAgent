...
@Data
public class Idea195001Config {
    private String name = "idea_195001";
 ...
 */
@Slf4j
public class Idea195001Service {
    private static final int IDEA_ID = 195001;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195001Service() {
        this(new Idea195001Config());
    }

    public Idea195001Service(Idea195001Config config) {
        this.config = config != null ? config : new Idea195001Config();
