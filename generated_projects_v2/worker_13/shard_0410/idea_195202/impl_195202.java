...
@Data
public class Idea195202Config {
    private String name = "idea_195202";
 ...
 */
@Slf4j
public class Idea195202Service {
    private static final int IDEA_ID = 195202;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195202Service() {
        this(new Idea195202Config());
    }

    public Idea195202Service(Idea195202Config config) {
        this.config = config != null ? config : new Idea195202Config();
