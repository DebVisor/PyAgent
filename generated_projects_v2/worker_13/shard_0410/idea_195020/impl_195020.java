...
@Data
public class Idea195020Config {
    private String name = "idea_195020";
 ...
 */
@Slf4j
public class Idea195020Service {
    private static final int IDEA_ID = 195020;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195020Service() {
        this(new Idea195020Config());
    }

    public Idea195020Service(Idea195020Config config) {
        this.config = config != null ? config : new Idea195020Config();
