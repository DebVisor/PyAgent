...
@Data
public class Idea195164Config {
    private String name = "idea_195164";
 ...
 */
@Slf4j
public class Idea195164Service {
    private static final int IDEA_ID = 195164;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195164Service() {
        this(new Idea195164Config());
    }

    public Idea195164Service(Idea195164Config config) {
        this.config = config != null ? config : new Idea195164Config();
