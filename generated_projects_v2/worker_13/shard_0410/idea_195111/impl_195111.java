...
@Data
public class Idea195111Config {
    private String name = "idea_195111";
 ...
 */
@Slf4j
public class Idea195111Service {
    private static final int IDEA_ID = 195111;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195111Service() {
        this(new Idea195111Config());
    }

    public Idea195111Service(Idea195111Config config) {
        this.config = config != null ? config : new Idea195111Config();
