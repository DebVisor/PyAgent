...
@Data
public class Idea195024Config {
    private String name = "idea_195024";
 ...
 */
@Slf4j
public class Idea195024Service {
    private static final int IDEA_ID = 195024;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195024Service() {
        this(new Idea195024Config());
    }

    public Idea195024Service(Idea195024Config config) {
        this.config = config != null ? config : new Idea195024Config();
