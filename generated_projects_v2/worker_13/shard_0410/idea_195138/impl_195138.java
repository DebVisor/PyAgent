...
@Data
public class Idea195138Config {
    private String name = "idea_195138";
 ...
 */
@Slf4j
public class Idea195138Service {
    private static final int IDEA_ID = 195138;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195138Service() {
        this(new Idea195138Config());
    }

    public Idea195138Service(Idea195138Config config) {
        this.config = config != null ? config : new Idea195138Config();
