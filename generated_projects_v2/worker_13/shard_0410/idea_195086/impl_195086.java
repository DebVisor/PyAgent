...
@Data
public class Idea195086Config {
    private String name = "idea_195086";
 ...
 */
@Slf4j
public class Idea195086Service {
    private static final int IDEA_ID = 195086;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195086Service() {
        this(new Idea195086Config());
    }

    public Idea195086Service(Idea195086Config config) {
        this.config = config != null ? config : new Idea195086Config();
