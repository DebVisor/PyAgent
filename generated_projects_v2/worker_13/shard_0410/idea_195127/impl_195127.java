...
@Data
public class Idea195127Config {
    private String name = "idea_195127";
 ...
 */
@Slf4j
public class Idea195127Service {
    private static final int IDEA_ID = 195127;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195127Service() {
        this(new Idea195127Config());
    }

    public Idea195127Service(Idea195127Config config) {
        this.config = config != null ? config : new Idea195127Config();
