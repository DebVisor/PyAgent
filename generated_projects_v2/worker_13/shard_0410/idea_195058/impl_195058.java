...
@Data
public class Idea195058Config {
    private String name = "idea_195058";
 ...
 */
@Slf4j
public class Idea195058Service {
    private static final int IDEA_ID = 195058;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195058Service() {
        this(new Idea195058Config());
    }

    public Idea195058Service(Idea195058Config config) {
        this.config = config != null ? config : new Idea195058Config();
