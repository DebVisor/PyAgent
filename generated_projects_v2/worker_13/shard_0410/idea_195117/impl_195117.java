...
@Data
public class Idea195117Config {
    private String name = "idea_195117";
 ...
 */
@Slf4j
public class Idea195117Service {
    private static final int IDEA_ID = 195117;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195117Service() {
        this(new Idea195117Config());
    }

    public Idea195117Service(Idea195117Config config) {
        this.config = config != null ? config : new Idea195117Config();
