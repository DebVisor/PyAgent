...
@Data
public class Idea195154Config {
    private String name = "idea_195154";
 ...
 */
@Slf4j
public class Idea195154Service {
    private static final int IDEA_ID = 195154;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195154Service() {
        this(new Idea195154Config());
    }

    public Idea195154Service(Idea195154Config config) {
        this.config = config != null ? config : new Idea195154Config();
