...
@Data
public class Idea195099Config {
    private String name = "idea_195099";
 ...
 */
@Slf4j
public class Idea195099Service {
    private static final int IDEA_ID = 195099;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195099Service() {
        this(new Idea195099Config());
    }

    public Idea195099Service(Idea195099Config config) {
        this.config = config != null ? config : new Idea195099Config();
