...
@Data
public class Idea195170Config {
    private String name = "idea_195170";
 ...
 */
@Slf4j
public class Idea195170Service {
    private static final int IDEA_ID = 195170;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195170Service() {
        this(new Idea195170Config());
    }

    public Idea195170Service(Idea195170Config config) {
        this.config = config != null ? config : new Idea195170Config();
