...
@Data
public class Idea195194Config {
    private String name = "idea_195194";
 ...
 */
@Slf4j
public class Idea195194Service {
    private static final int IDEA_ID = 195194;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195194Service() {
        this(new Idea195194Config());
    }

    public Idea195194Service(Idea195194Config config) {
        this.config = config != null ? config : new Idea195194Config();
