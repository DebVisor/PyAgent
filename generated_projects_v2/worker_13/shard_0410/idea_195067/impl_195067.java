...
@Data
public class Idea195067Config {
    private String name = "idea_195067";
 ...
 */
@Slf4j
public class Idea195067Service {
    private static final int IDEA_ID = 195067;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195067Service() {
        this(new Idea195067Config());
    }

    public Idea195067Service(Idea195067Config config) {
        this.config = config != null ? config : new Idea195067Config();
