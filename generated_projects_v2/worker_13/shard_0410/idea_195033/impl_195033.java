...
@Data
public class Idea195033Config {
    private String name = "idea_195033";
 ...
 */
@Slf4j
public class Idea195033Service {
    private static final int IDEA_ID = 195033;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195033Service() {
        this(new Idea195033Config());
    }

    public Idea195033Service(Idea195033Config config) {
        this.config = config != null ? config : new Idea195033Config();
