...
@Data
public class Idea195187Config {
    private String name = "idea_195187";
 ...
 */
@Slf4j
public class Idea195187Service {
    private static final int IDEA_ID = 195187;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195187Service() {
        this(new Idea195187Config());
    }

    public Idea195187Service(Idea195187Config config) {
        this.config = config != null ? config : new Idea195187Config();
