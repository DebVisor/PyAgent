...
@Data
public class Idea195105Config {
    private String name = "idea_195105";
 ...
 */
@Slf4j
public class Idea195105Service {
    private static final int IDEA_ID = 195105;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195105Service() {
        this(new Idea195105Config());
    }

    public Idea195105Service(Idea195105Config config) {
        this.config = config != null ? config : new Idea195105Config();
