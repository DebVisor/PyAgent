...
@Data
public class Idea195011Config {
    private String name = "idea_195011";
 ...
 */
@Slf4j
public class Idea195011Service {
    private static final int IDEA_ID = 195011;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195011Service() {
        this(new Idea195011Config());
    }

    public Idea195011Service(Idea195011Config config) {
        this.config = config != null ? config : new Idea195011Config();
