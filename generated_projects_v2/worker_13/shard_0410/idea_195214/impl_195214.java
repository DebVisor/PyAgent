...
@Data
public class Idea195214Config {
    private String name = "idea_195214";
 ...
 */
@Slf4j
public class Idea195214Service {
    private static final int IDEA_ID = 195214;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195214Service() {
        this(new Idea195214Config());
    }

    public Idea195214Service(Idea195214Config config) {
        this.config = config != null ? config : new Idea195214Config();
