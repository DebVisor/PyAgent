...
@Data
public class Idea195027Config {
    private String name = "idea_195027";
 ...
 */
@Slf4j
public class Idea195027Service {
    private static final int IDEA_ID = 195027;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195027Service() {
        this(new Idea195027Config());
    }

    public Idea195027Service(Idea195027Config config) {
        this.config = config != null ? config : new Idea195027Config();
