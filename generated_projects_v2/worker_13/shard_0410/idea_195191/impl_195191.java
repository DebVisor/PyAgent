...
@Data
public class Idea195191Config {
    private String name = "idea_195191";
 ...
 */
@Slf4j
public class Idea195191Service {
    private static final int IDEA_ID = 195191;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195191Service() {
        this(new Idea195191Config());
    }

    public Idea195191Service(Idea195191Config config) {
        this.config = config != null ? config : new Idea195191Config();
