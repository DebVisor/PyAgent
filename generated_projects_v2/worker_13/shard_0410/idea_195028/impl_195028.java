...
@Data
public class Idea195028Config {
    private String name = "idea_195028";
 ...
 */
@Slf4j
public class Idea195028Service {
    private static final int IDEA_ID = 195028;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195028Service() {
        this(new Idea195028Config());
    }

    public Idea195028Service(Idea195028Config config) {
        this.config = config != null ? config : new Idea195028Config();
