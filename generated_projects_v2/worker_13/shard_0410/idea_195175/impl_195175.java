...
@Data
public class Idea195175Config {
    private String name = "idea_195175";
 ...
 */
@Slf4j
public class Idea195175Service {
    private static final int IDEA_ID = 195175;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195175Service() {
        this(new Idea195175Config());
    }

    public Idea195175Service(Idea195175Config config) {
        this.config = config != null ? config : new Idea195175Config();
