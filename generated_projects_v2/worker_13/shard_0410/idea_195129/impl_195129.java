...
@Data
public class Idea195129Config {
    private String name = "idea_195129";
 ...
 */
@Slf4j
public class Idea195129Service {
    private static final int IDEA_ID = 195129;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195129Service() {
        this(new Idea195129Config());
    }

    public Idea195129Service(Idea195129Config config) {
        this.config = config != null ? config : new Idea195129Config();
