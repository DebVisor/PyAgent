...
@Data
public class Idea195130Config {
    private String name = "idea_195130";
 ...
 */
@Slf4j
public class Idea195130Service {
    private static final int IDEA_ID = 195130;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195130Service() {
        this(new Idea195130Config());
    }

    public Idea195130Service(Idea195130Config config) {
        this.config = config != null ? config : new Idea195130Config();
