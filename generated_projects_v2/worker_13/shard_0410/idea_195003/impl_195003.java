...
@Data
public class Idea195003Config {
    private String name = "idea_195003";
 ...
 */
@Slf4j
public class Idea195003Service {
    private static final int IDEA_ID = 195003;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195003Service() {
        this(new Idea195003Config());
    }

    public Idea195003Service(Idea195003Config config) {
        this.config = config != null ? config : new Idea195003Config();
