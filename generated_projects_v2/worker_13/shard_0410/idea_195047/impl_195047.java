...
@Data
public class Idea195047Config {
    private String name = "idea_195047";
 ...
 */
@Slf4j
public class Idea195047Service {
    private static final int IDEA_ID = 195047;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195047Service() {
        this(new Idea195047Config());
    }

    public Idea195047Service(Idea195047Config config) {
        this.config = config != null ? config : new Idea195047Config();
