...
@Data
public class Idea195035Config {
    private String name = "idea_195035";
 ...
 */
@Slf4j
public class Idea195035Service {
    private static final int IDEA_ID = 195035;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195035Service() {
        this(new Idea195035Config());
    }

    public Idea195035Service(Idea195035Config config) {
        this.config = config != null ? config : new Idea195035Config();
