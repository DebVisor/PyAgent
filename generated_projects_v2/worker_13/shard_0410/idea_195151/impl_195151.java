...
@Data
public class Idea195151Config {
    private String name = "idea_195151";
 ...
 */
@Slf4j
public class Idea195151Service {
    private static final int IDEA_ID = 195151;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195151Service() {
        this(new Idea195151Config());
    }

    public Idea195151Service(Idea195151Config config) {
        this.config = config != null ? config : new Idea195151Config();
