...
@Data
public class Idea195144Config {
    private String name = "idea_195144";
 ...
 */
@Slf4j
public class Idea195144Service {
    private static final int IDEA_ID = 195144;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195144Service() {
        this(new Idea195144Config());
    }

    public Idea195144Service(Idea195144Config config) {
        this.config = config != null ? config : new Idea195144Config();
