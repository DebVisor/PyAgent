...
@Data
public class Idea195217Config {
    private String name = "idea_195217";
 ...
 */
@Slf4j
public class Idea195217Service {
    private static final int IDEA_ID = 195217;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195217Service() {
        this(new Idea195217Config());
    }

    public Idea195217Service(Idea195217Config config) {
        this.config = config != null ? config : new Idea195217Config();
