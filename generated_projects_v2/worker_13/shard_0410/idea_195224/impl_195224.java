...
@Data
public class Idea195224Config {
    private String name = "idea_195224";
 ...
 */
@Slf4j
public class Idea195224Service {
    private static final int IDEA_ID = 195224;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195224Service() {
        this(new Idea195224Config());
    }

    public Idea195224Service(Idea195224Config config) {
        this.config = config != null ? config : new Idea195224Config();
