...
@Data
public class Idea195128Config {
    private String name = "idea_195128";
 ...
 */
@Slf4j
public class Idea195128Service {
    private static final int IDEA_ID = 195128;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195128Service() {
        this(new Idea195128Config());
    }

    public Idea195128Service(Idea195128Config config) {
        this.config = config != null ? config : new Idea195128Config();
