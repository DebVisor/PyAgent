...
@Data
public class Idea195071Config {
    private String name = "idea_195071";
 ...
 */
@Slf4j
public class Idea195071Service {
    private static final int IDEA_ID = 195071;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195071Service() {
        this(new Idea195071Config());
    }

    public Idea195071Service(Idea195071Config config) {
        this.config = config != null ? config : new Idea195071Config();
