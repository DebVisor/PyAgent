...
@Data
public class Idea195205Config {
    private String name = "idea_195205";
 ...
 */
@Slf4j
public class Idea195205Service {
    private static final int IDEA_ID = 195205;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195205Service() {
        this(new Idea195205Config());
    }

    public Idea195205Service(Idea195205Config config) {
        this.config = config != null ? config : new Idea195205Config();
