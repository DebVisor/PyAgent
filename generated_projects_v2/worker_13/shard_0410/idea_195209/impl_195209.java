...
@Data
public class Idea195209Config {
    private String name = "idea_195209";
 ...
 */
@Slf4j
public class Idea195209Service {
    private static final int IDEA_ID = 195209;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195209Service() {
        this(new Idea195209Config());
    }

    public Idea195209Service(Idea195209Config config) {
        this.config = config != null ? config : new Idea195209Config();
