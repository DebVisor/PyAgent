...
@Data
public class Idea195147Config {
    private String name = "idea_195147";
 ...
 */
@Slf4j
public class Idea195147Service {
    private static final int IDEA_ID = 195147;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195147Service() {
        this(new Idea195147Config());
    }

    public Idea195147Service(Idea195147Config config) {
        this.config = config != null ? config : new Idea195147Config();
