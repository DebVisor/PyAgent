...
@Data
public class Idea195008Config {
    private String name = "idea_195008";
 ...
 */
@Slf4j
public class Idea195008Service {
    private static final int IDEA_ID = 195008;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195008Service() {
        this(new Idea195008Config());
    }

    public Idea195008Service(Idea195008Config config) {
        this.config = config != null ? config : new Idea195008Config();
