...
@Data
public class Idea195136Config {
    private String name = "idea_195136";
 ...
 */
@Slf4j
public class Idea195136Service {
    private static final int IDEA_ID = 195136;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195136Service() {
        this(new Idea195136Config());
    }

    public Idea195136Service(Idea195136Config config) {
        this.config = config != null ? config : new Idea195136Config();
