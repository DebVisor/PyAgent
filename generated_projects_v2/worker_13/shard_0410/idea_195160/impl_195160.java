...
@Data
public class Idea195160Config {
    private String name = "idea_195160";
 ...
 */
@Slf4j
public class Idea195160Service {
    private static final int IDEA_ID = 195160;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195160Service() {
        this(new Idea195160Config());
    }

    public Idea195160Service(Idea195160Config config) {
        this.config = config != null ? config : new Idea195160Config();
