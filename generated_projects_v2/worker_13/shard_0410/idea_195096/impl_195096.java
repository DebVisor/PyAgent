...
@Data
public class Idea195096Config {
    private String name = "idea_195096";
 ...
 */
@Slf4j
public class Idea195096Service {
    private static final int IDEA_ID = 195096;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195096Service() {
        this(new Idea195096Config());
    }

    public Idea195096Service(Idea195096Config config) {
        this.config = config != null ? config : new Idea195096Config();
