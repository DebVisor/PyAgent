...
@Data
public class Idea195018Config {
    private String name = "idea_195018";
 ...
 */
@Slf4j
public class Idea195018Service {
    private static final int IDEA_ID = 195018;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195018Service() {
        this(new Idea195018Config());
    }

    public Idea195018Service(Idea195018Config config) {
        this.config = config != null ? config : new Idea195018Config();
