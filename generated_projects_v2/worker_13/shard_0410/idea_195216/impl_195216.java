...
@Data
public class Idea195216Config {
    private String name = "idea_195216";
 ...
 */
@Slf4j
public class Idea195216Service {
    private static final int IDEA_ID = 195216;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195216Service() {
        this(new Idea195216Config());
    }

    public Idea195216Service(Idea195216Config config) {
        this.config = config != null ? config : new Idea195216Config();
