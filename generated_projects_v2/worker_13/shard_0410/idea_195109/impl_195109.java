...
@Data
public class Idea195109Config {
    private String name = "idea_195109";
 ...
 */
@Slf4j
public class Idea195109Service {
    private static final int IDEA_ID = 195109;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195109Service() {
        this(new Idea195109Config());
    }

    public Idea195109Service(Idea195109Config config) {
        this.config = config != null ? config : new Idea195109Config();
