...
@Data
public class Idea195102Config {
    private String name = "idea_195102";
 ...
 */
@Slf4j
public class Idea195102Service {
    private static final int IDEA_ID = 195102;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195102Service() {
        this(new Idea195102Config());
    }

    public Idea195102Service(Idea195102Config config) {
        this.config = config != null ? config : new Idea195102Config();
