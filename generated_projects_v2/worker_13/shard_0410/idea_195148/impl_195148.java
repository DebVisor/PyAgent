...
@Data
public class Idea195148Config {
    private String name = "idea_195148";
 ...
 */
@Slf4j
public class Idea195148Service {
    private static final int IDEA_ID = 195148;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195148Service() {
        this(new Idea195148Config());
    }

    public Idea195148Service(Idea195148Config config) {
        this.config = config != null ? config : new Idea195148Config();
