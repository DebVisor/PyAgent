...
@Data
public class Idea195106Config {
    private String name = "idea_195106";
 ...
 */
@Slf4j
public class Idea195106Service {
    private static final int IDEA_ID = 195106;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195106Service() {
        this(new Idea195106Config());
    }

    public Idea195106Service(Idea195106Config config) {
        this.config = config != null ? config : new Idea195106Config();
