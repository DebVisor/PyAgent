...
@Data
public class Idea195135Config {
    private String name = "idea_195135";
 ...
 */
@Slf4j
public class Idea195135Service {
    private static final int IDEA_ID = 195135;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195135Service() {
        this(new Idea195135Config());
    }

    public Idea195135Service(Idea195135Config config) {
        this.config = config != null ? config : new Idea195135Config();
