...
@Data
public class Idea195065Config {
    private String name = "idea_195065";
 ...
 */
@Slf4j
public class Idea195065Service {
    private static final int IDEA_ID = 195065;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195065Service() {
        this(new Idea195065Config());
    }

    public Idea195065Service(Idea195065Config config) {
        this.config = config != null ? config : new Idea195065Config();
