...
@Data
public class Idea195085Config {
    private String name = "idea_195085";
 ...
 */
@Slf4j
public class Idea195085Service {
    private static final int IDEA_ID = 195085;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195085Service() {
        this(new Idea195085Config());
    }

    public Idea195085Service(Idea195085Config config) {
        this.config = config != null ? config : new Idea195085Config();
