...
@Data
public class Idea195153Config {
    private String name = "idea_195153";
 ...
 */
@Slf4j
public class Idea195153Service {
    private static final int IDEA_ID = 195153;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195153Service() {
        this(new Idea195153Config());
    }

    public Idea195153Service(Idea195153Config config) {
        this.config = config != null ? config : new Idea195153Config();
