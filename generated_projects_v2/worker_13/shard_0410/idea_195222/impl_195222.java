...
@Data
public class Idea195222Config {
    private String name = "idea_195222";
 ...
 */
@Slf4j
public class Idea195222Service {
    private static final int IDEA_ID = 195222;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195222Service() {
        this(new Idea195222Config());
    }

    public Idea195222Service(Idea195222Config config) {
        this.config = config != null ? config : new Idea195222Config();
