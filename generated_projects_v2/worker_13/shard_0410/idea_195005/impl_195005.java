...
@Data
public class Idea195005Config {
    private String name = "idea_195005";
 ...
 */
@Slf4j
public class Idea195005Service {
    private static final int IDEA_ID = 195005;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195005Service() {
        this(new Idea195005Config());
    }

    public Idea195005Service(Idea195005Config config) {
        this.config = config != null ? config : new Idea195005Config();
