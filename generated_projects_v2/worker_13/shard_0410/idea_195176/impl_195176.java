...
@Data
public class Idea195176Config {
    private String name = "idea_195176";
 ...
 */
@Slf4j
public class Idea195176Service {
    private static final int IDEA_ID = 195176;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195176Service() {
        this(new Idea195176Config());
    }

    public Idea195176Service(Idea195176Config config) {
        this.config = config != null ? config : new Idea195176Config();
