...
@Data
public class Idea195087Config {
    private String name = "idea_195087";
 ...
 */
@Slf4j
public class Idea195087Service {
    private static final int IDEA_ID = 195087;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195087Service() {
        this(new Idea195087Config());
    }

    public Idea195087Service(Idea195087Config config) {
        this.config = config != null ? config : new Idea195087Config();
