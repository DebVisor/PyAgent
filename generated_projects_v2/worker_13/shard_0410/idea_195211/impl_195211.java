...
@Data
public class Idea195211Config {
    private String name = "idea_195211";
 ...
 */
@Slf4j
public class Idea195211Service {
    private static final int IDEA_ID = 195211;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195211Service() {
        this(new Idea195211Config());
    }

    public Idea195211Service(Idea195211Config config) {
        this.config = config != null ? config : new Idea195211Config();
