...
@Data
public class Idea195197Config {
    private String name = "idea_195197";
 ...
 */
@Slf4j
public class Idea195197Service {
    private static final int IDEA_ID = 195197;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195197Service() {
        this(new Idea195197Config());
    }

    public Idea195197Service(Idea195197Config config) {
        this.config = config != null ? config : new Idea195197Config();
