...
@Data
public class Idea195115Config {
    private String name = "idea_195115";
 ...
 */
@Slf4j
public class Idea195115Service {
    private static final int IDEA_ID = 195115;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195115Service() {
        this(new Idea195115Config());
    }

    public Idea195115Service(Idea195115Config config) {
        this.config = config != null ? config : new Idea195115Config();
