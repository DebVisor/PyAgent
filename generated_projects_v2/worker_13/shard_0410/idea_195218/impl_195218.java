...
@Data
public class Idea195218Config {
    private String name = "idea_195218";
 ...
 */
@Slf4j
public class Idea195218Service {
    private static final int IDEA_ID = 195218;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195218Service() {
        this(new Idea195218Config());
    }

    public Idea195218Service(Idea195218Config config) {
        this.config = config != null ? config : new Idea195218Config();
