...
@Data
public class Idea195098Config {
    private String name = "idea_195098";
 ...
 */
@Slf4j
public class Idea195098Service {
    private static final int IDEA_ID = 195098;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195098Service() {
        this(new Idea195098Config());
    }

    public Idea195098Service(Idea195098Config config) {
        this.config = config != null ? config : new Idea195098Config();
