...
@Data
public class Idea195108Config {
    private String name = "idea_195108";
 ...
 */
@Slf4j
public class Idea195108Service {
    private static final int IDEA_ID = 195108;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195108Service() {
        this(new Idea195108Config());
    }

    public Idea195108Service(Idea195108Config config) {
        this.config = config != null ? config : new Idea195108Config();
