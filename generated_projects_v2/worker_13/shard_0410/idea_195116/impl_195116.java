...
@Data
public class Idea195116Config {
    private String name = "idea_195116";
 ...
 */
@Slf4j
public class Idea195116Service {
    private static final int IDEA_ID = 195116;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195116Service() {
        this(new Idea195116Config());
    }

    public Idea195116Service(Idea195116Config config) {
        this.config = config != null ? config : new Idea195116Config();
