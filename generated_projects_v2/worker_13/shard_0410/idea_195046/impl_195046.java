...
@Data
public class Idea195046Config {
    private String name = "idea_195046";
 ...
 */
@Slf4j
public class Idea195046Service {
    private static final int IDEA_ID = 195046;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195046Service() {
        this(new Idea195046Config());
    }

    public Idea195046Service(Idea195046Config config) {
        this.config = config != null ? config : new Idea195046Config();
