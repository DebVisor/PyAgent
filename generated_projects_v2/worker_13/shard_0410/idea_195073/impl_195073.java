...
@Data
public class Idea195073Config {
    private String name = "idea_195073";
 ...
 */
@Slf4j
public class Idea195073Service {
    private static final int IDEA_ID = 195073;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195073Service() {
        this(new Idea195073Config());
    }

    public Idea195073Service(Idea195073Config config) {
        this.config = config != null ? config : new Idea195073Config();
