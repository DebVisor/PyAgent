...
@Data
public class Idea195207Config {
    private String name = "idea_195207";
 ...
 */
@Slf4j
public class Idea195207Service {
    private static final int IDEA_ID = 195207;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195207Service() {
        this(new Idea195207Config());
    }

    public Idea195207Service(Idea195207Config config) {
        this.config = config != null ? config : new Idea195207Config();
