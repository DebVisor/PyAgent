...
@Data
public class Idea195215Config {
    private String name = "idea_195215";
 ...
 */
@Slf4j
public class Idea195215Service {
    private static final int IDEA_ID = 195215;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195215Service() {
        this(new Idea195215Config());
    }

    public Idea195215Service(Idea195215Config config) {
        this.config = config != null ? config : new Idea195215Config();
