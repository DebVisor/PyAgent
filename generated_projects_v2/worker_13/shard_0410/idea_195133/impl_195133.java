...
@Data
public class Idea195133Config {
    private String name = "idea_195133";
 ...
 */
@Slf4j
public class Idea195133Service {
    private static final int IDEA_ID = 195133;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195133Service() {
        this(new Idea195133Config());
    }

    public Idea195133Service(Idea195133Config config) {
        this.config = config != null ? config : new Idea195133Config();
