...
@Data
public class Idea195119Config {
    private String name = "idea_195119";
 ...
 */
@Slf4j
public class Idea195119Service {
    private static final int IDEA_ID = 195119;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195119Service() {
        this(new Idea195119Config());
    }

    public Idea195119Service(Idea195119Config config) {
        this.config = config != null ? config : new Idea195119Config();
