...
@Data
public class Idea195137Config {
    private String name = "idea_195137";
 ...
 */
@Slf4j
public class Idea195137Service {
    private static final int IDEA_ID = 195137;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195137Service() {
        this(new Idea195137Config());
    }

    public Idea195137Service(Idea195137Config config) {
        this.config = config != null ? config : new Idea195137Config();
