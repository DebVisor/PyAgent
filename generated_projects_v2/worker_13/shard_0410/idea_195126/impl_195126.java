...
@Data
public class Idea195126Config {
    private String name = "idea_195126";
 ...
 */
@Slf4j
public class Idea195126Service {
    private static final int IDEA_ID = 195126;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195126Service() {
        this(new Idea195126Config());
    }

    public Idea195126Service(Idea195126Config config) {
        this.config = config != null ? config : new Idea195126Config();
