...
@Data
public class Idea196759Config {
    private String name = "idea_196759";
 ...
 */
@Slf4j
public class Idea196759Service {
    private static final int IDEA_ID = 196759;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196759Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196759Service() {
        this(new Idea196759Config());
    }

    public Idea196759Service(Idea196759Config config) {
        this.config = config != null ? config : new Idea196759Config();
