...
@Data
public class Idea197119Config {
    private String name = "idea_197119";
 ...
 */
@Slf4j
public class Idea197119Service {
    private static final int IDEA_ID = 197119;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197119Service() {
        this(new Idea197119Config());
    }

    public Idea197119Service(Idea197119Config config) {
        this.config = config != null ? config : new Idea197119Config();
