...
@Data
public class Idea196656Config {
    private String name = "idea_196656";
 ...
 */
@Slf4j
public class Idea196656Service {
    private static final int IDEA_ID = 196656;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196656Service() {
        this(new Idea196656Config());
    }

    public Idea196656Service(Idea196656Config config) {
        this.config = config != null ? config : new Idea196656Config();
