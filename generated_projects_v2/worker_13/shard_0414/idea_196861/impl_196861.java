...
@Data
public class Idea196861Config {
    private String name = "idea_196861";
 ...
 */
@Slf4j
public class Idea196861Service {
    private static final int IDEA_ID = 196861;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196861Service() {
        this(new Idea196861Config());
    }

    public Idea196861Service(Idea196861Config config) {
        this.config = config != null ? config : new Idea196861Config();
