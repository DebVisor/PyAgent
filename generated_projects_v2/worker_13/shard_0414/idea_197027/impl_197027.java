...
@Data
public class Idea197027Config {
    private String name = "idea_197027";
 ...
 */
@Slf4j
public class Idea197027Service {
    private static final int IDEA_ID = 197027;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197027Service() {
        this(new Idea197027Config());
    }

    public Idea197027Service(Idea197027Config config) {
        this.config = config != null ? config : new Idea197027Config();
