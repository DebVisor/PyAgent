...
@Data
public class Idea196710Config {
    private String name = "idea_196710";
 ...
 */
@Slf4j
public class Idea196710Service {
    private static final int IDEA_ID = 196710;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196710Service() {
        this(new Idea196710Config());
    }

    public Idea196710Service(Idea196710Config config) {
        this.config = config != null ? config : new Idea196710Config();
