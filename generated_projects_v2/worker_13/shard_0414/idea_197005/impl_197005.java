...
@Data
public class Idea197005Config {
    private String name = "idea_197005";
 ...
 */
@Slf4j
public class Idea197005Service {
    private static final int IDEA_ID = 197005;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197005Service() {
        this(new Idea197005Config());
    }

    public Idea197005Service(Idea197005Config config) {
        this.config = config != null ? config : new Idea197005Config();
