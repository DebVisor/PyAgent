...
@Data
public class Idea196881Config {
    private String name = "idea_196881";
 ...
 */
@Slf4j
public class Idea196881Service {
    private static final int IDEA_ID = 196881;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196881Service() {
        this(new Idea196881Config());
    }

    public Idea196881Service(Idea196881Config config) {
        this.config = config != null ? config : new Idea196881Config();
