...
@Data
public class Idea196882Config {
    private String name = "idea_196882";
 ...
 */
@Slf4j
public class Idea196882Service {
    private static final int IDEA_ID = 196882;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196882Service() {
        this(new Idea196882Config());
    }

    public Idea196882Service(Idea196882Config config) {
        this.config = config != null ? config : new Idea196882Config();
