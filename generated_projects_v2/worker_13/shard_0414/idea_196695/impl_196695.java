...
@Data
public class Idea196695Config {
    private String name = "idea_196695";
 ...
 */
@Slf4j
public class Idea196695Service {
    private static final int IDEA_ID = 196695;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196695Service() {
        this(new Idea196695Config());
    }

    public Idea196695Service(Idea196695Config config) {
        this.config = config != null ? config : new Idea196695Config();
