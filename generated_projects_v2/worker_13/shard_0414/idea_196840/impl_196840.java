...
@Data
public class Idea196840Config {
    private String name = "idea_196840";
 ...
 */
@Slf4j
public class Idea196840Service {
    private static final int IDEA_ID = 196840;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196840Service() {
        this(new Idea196840Config());
    }

    public Idea196840Service(Idea196840Config config) {
        this.config = config != null ? config : new Idea196840Config();
