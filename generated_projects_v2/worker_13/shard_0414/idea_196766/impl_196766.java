...
@Data
public class Idea196766Config {
    private String name = "idea_196766";
 ...
 */
@Slf4j
public class Idea196766Service {
    private static final int IDEA_ID = 196766;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196766Service() {
        this(new Idea196766Config());
    }

    public Idea196766Service(Idea196766Config config) {
        this.config = config != null ? config : new Idea196766Config();
