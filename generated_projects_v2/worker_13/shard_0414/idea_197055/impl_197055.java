...
@Data
public class Idea197055Config {
    private String name = "idea_197055";
 ...
 */
@Slf4j
public class Idea197055Service {
    private static final int IDEA_ID = 197055;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197055Service() {
        this(new Idea197055Config());
    }

    public Idea197055Service(Idea197055Config config) {
        this.config = config != null ? config : new Idea197055Config();
