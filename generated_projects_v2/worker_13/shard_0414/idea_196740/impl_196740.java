...
@Data
public class Idea196740Config {
    private String name = "idea_196740";
 ...
 */
@Slf4j
public class Idea196740Service {
    private static final int IDEA_ID = 196740;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196740Service() {
        this(new Idea196740Config());
    }

    public Idea196740Service(Idea196740Config config) {
        this.config = config != null ? config : new Idea196740Config();
