...
@Data
public class Idea196867Config {
    private String name = "idea_196867";
 ...
 */
@Slf4j
public class Idea196867Service {
    private static final int IDEA_ID = 196867;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196867Service() {
        this(new Idea196867Config());
    }

    public Idea196867Service(Idea196867Config config) {
        this.config = config != null ? config : new Idea196867Config();
