...
@Data
public class Idea196964Config {
    private String name = "idea_196964";
 ...
 */
@Slf4j
public class Idea196964Service {
    private static final int IDEA_ID = 196964;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196964Service() {
        this(new Idea196964Config());
    }

    public Idea196964Service(Idea196964Config config) {
        this.config = config != null ? config : new Idea196964Config();
