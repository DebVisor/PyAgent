...
@Data
public class Idea196702Config {
    private String name = "idea_196702";
 ...
 */
@Slf4j
public class Idea196702Service {
    private static final int IDEA_ID = 196702;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196702Service() {
        this(new Idea196702Config());
    }

    public Idea196702Service(Idea196702Config config) {
        this.config = config != null ? config : new Idea196702Config();
