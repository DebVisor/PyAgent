...
@Data
public class Idea196679Config {
    private String name = "idea_196679";
 ...
 */
@Slf4j
public class Idea196679Service {
    private static final int IDEA_ID = 196679;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196679Service() {
        this(new Idea196679Config());
    }

    public Idea196679Service(Idea196679Config config) {
        this.config = config != null ? config : new Idea196679Config();
