...
@Data
public class Idea196731Config {
    private String name = "idea_196731";
 ...
 */
@Slf4j
public class Idea196731Service {
    private static final int IDEA_ID = 196731;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196731Service() {
        this(new Idea196731Config());
    }

    public Idea196731Service(Idea196731Config config) {
        this.config = config != null ? config : new Idea196731Config();
