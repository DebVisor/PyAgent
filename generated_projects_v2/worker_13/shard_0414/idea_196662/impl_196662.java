...
@Data
public class Idea196662Config {
    private String name = "idea_196662";
 ...
 */
@Slf4j
public class Idea196662Service {
    private static final int IDEA_ID = 196662;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196662Service() {
        this(new Idea196662Config());
    }

    public Idea196662Service(Idea196662Config config) {
        this.config = config != null ? config : new Idea196662Config();
