...
@Data
public class Idea196738Config {
    private String name = "idea_196738";
 ...
 */
@Slf4j
public class Idea196738Service {
    private static final int IDEA_ID = 196738;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196738Service() {
        this(new Idea196738Config());
    }

    public Idea196738Service(Idea196738Config config) {
        this.config = config != null ? config : new Idea196738Config();
