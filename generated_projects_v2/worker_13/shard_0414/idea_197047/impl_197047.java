...
@Data
public class Idea197047Config {
    private String name = "idea_197047";
 ...
 */
@Slf4j
public class Idea197047Service {
    private static final int IDEA_ID = 197047;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197047Service() {
        this(new Idea197047Config());
    }

    public Idea197047Service(Idea197047Config config) {
        this.config = config != null ? config : new Idea197047Config();
