...
@Data
public class Idea196653Config {
    private String name = "idea_196653";
 ...
 */
@Slf4j
public class Idea196653Service {
    private static final int IDEA_ID = 196653;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196653Service() {
        this(new Idea196653Config());
    }

    public Idea196653Service(Idea196653Config config) {
        this.config = config != null ? config : new Idea196653Config();
