...
@Data
public class Idea196716Config {
    private String name = "idea_196716";
 ...
 */
@Slf4j
public class Idea196716Service {
    private static final int IDEA_ID = 196716;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196716Service() {
        this(new Idea196716Config());
    }

    public Idea196716Service(Idea196716Config config) {
        this.config = config != null ? config : new Idea196716Config();
