...
@Data
public class Idea196911Config {
    private String name = "idea_196911";
 ...
 */
@Slf4j
public class Idea196911Service {
    private static final int IDEA_ID = 196911;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196911Service() {
        this(new Idea196911Config());
    }

    public Idea196911Service(Idea196911Config config) {
        this.config = config != null ? config : new Idea196911Config();
