...
@Data
public class Idea197058Config {
    private String name = "idea_197058";
 ...
 */
@Slf4j
public class Idea197058Service {
    private static final int IDEA_ID = 197058;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197058Service() {
        this(new Idea197058Config());
    }

    public Idea197058Service(Idea197058Config config) {
        this.config = config != null ? config : new Idea197058Config();
