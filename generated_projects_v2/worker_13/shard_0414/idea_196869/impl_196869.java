...
@Data
public class Idea196869Config {
    private String name = "idea_196869";
 ...
 */
@Slf4j
public class Idea196869Service {
    private static final int IDEA_ID = 196869;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196869Service() {
        this(new Idea196869Config());
    }

    public Idea196869Service(Idea196869Config config) {
        this.config = config != null ? config : new Idea196869Config();
