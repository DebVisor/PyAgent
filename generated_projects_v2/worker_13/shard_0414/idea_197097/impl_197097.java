...
@Data
public class Idea197097Config {
    private String name = "idea_197097";
 ...
 */
@Slf4j
public class Idea197097Service {
    private static final int IDEA_ID = 197097;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197097Service() {
        this(new Idea197097Config());
    }

    public Idea197097Service(Idea197097Config config) {
        this.config = config != null ? config : new Idea197097Config();
