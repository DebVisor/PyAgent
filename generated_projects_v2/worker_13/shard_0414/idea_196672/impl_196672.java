...
@Data
public class Idea196672Config {
    private String name = "idea_196672";
 ...
 */
@Slf4j
public class Idea196672Service {
    private static final int IDEA_ID = 196672;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196672Service() {
        this(new Idea196672Config());
    }

    public Idea196672Service(Idea196672Config config) {
        this.config = config != null ? config : new Idea196672Config();
