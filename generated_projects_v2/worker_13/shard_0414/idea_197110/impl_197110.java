...
@Data
public class Idea197110Config {
    private String name = "idea_197110";
 ...
 */
@Slf4j
public class Idea197110Service {
    private static final int IDEA_ID = 197110;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197110Service() {
        this(new Idea197110Config());
    }

    public Idea197110Service(Idea197110Config config) {
        this.config = config != null ? config : new Idea197110Config();
