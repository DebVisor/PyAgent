...
@Data
public class Idea196991Config {
    private String name = "idea_196991";
 ...
 */
@Slf4j
public class Idea196991Service {
    private static final int IDEA_ID = 196991;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196991Service() {
        this(new Idea196991Config());
    }

    public Idea196991Service(Idea196991Config config) {
        this.config = config != null ? config : new Idea196991Config();
