...
@Data
public class Idea196961Config {
    private String name = "idea_196961";
 ...
 */
@Slf4j
public class Idea196961Service {
    private static final int IDEA_ID = 196961;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196961Service() {
        this(new Idea196961Config());
    }

    public Idea196961Service(Idea196961Config config) {
        this.config = config != null ? config : new Idea196961Config();
