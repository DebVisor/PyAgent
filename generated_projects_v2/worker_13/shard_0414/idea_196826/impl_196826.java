...
@Data
public class Idea196826Config {
    private String name = "idea_196826";
 ...
 */
@Slf4j
public class Idea196826Service {
    private static final int IDEA_ID = 196826;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196826Service() {
        this(new Idea196826Config());
    }

    public Idea196826Service(Idea196826Config config) {
        this.config = config != null ? config : new Idea196826Config();
