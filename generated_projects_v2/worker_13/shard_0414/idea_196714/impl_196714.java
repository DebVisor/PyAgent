...
@Data
public class Idea196714Config {
    private String name = "idea_196714";
 ...
 */
@Slf4j
public class Idea196714Service {
    private static final int IDEA_ID = 196714;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196714Service() {
        this(new Idea196714Config());
    }

    public Idea196714Service(Idea196714Config config) {
        this.config = config != null ? config : new Idea196714Config();
