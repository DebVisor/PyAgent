...
@Data
public class Idea196905Config {
    private String name = "idea_196905";
 ...
 */
@Slf4j
public class Idea196905Service {
    private static final int IDEA_ID = 196905;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196905Service() {
        this(new Idea196905Config());
    }

    public Idea196905Service(Idea196905Config config) {
        this.config = config != null ? config : new Idea196905Config();
