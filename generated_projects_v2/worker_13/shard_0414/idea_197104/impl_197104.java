...
@Data
public class Idea197104Config {
    private String name = "idea_197104";
 ...
 */
@Slf4j
public class Idea197104Service {
    private static final int IDEA_ID = 197104;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197104Service() {
        this(new Idea197104Config());
    }

    public Idea197104Service(Idea197104Config config) {
        this.config = config != null ? config : new Idea197104Config();
