...
@Data
public class Idea196875Config {
    private String name = "idea_196875";
 ...
 */
@Slf4j
public class Idea196875Service {
    private static final int IDEA_ID = 196875;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196875Service() {
        this(new Idea196875Config());
    }

    public Idea196875Service(Idea196875Config config) {
        this.config = config != null ? config : new Idea196875Config();
