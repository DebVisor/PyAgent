...
@Data
public class Idea196809Config {
    private String name = "idea_196809";
 ...
 */
@Slf4j
public class Idea196809Service {
    private static final int IDEA_ID = 196809;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196809Service() {
        this(new Idea196809Config());
    }

    public Idea196809Service(Idea196809Config config) {
        this.config = config != null ? config : new Idea196809Config();
