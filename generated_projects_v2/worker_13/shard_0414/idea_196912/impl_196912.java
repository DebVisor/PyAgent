...
@Data
public class Idea196912Config {
    private String name = "idea_196912";
 ...
 */
@Slf4j
public class Idea196912Service {
    private static final int IDEA_ID = 196912;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196912Service() {
        this(new Idea196912Config());
    }

    public Idea196912Service(Idea196912Config config) {
        this.config = config != null ? config : new Idea196912Config();
