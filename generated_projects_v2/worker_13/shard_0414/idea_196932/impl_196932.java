...
@Data
public class Idea196932Config {
    private String name = "idea_196932";
 ...
 */
@Slf4j
public class Idea196932Service {
    private static final int IDEA_ID = 196932;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196932Service() {
        this(new Idea196932Config());
    }

    public Idea196932Service(Idea196932Config config) {
        this.config = config != null ? config : new Idea196932Config();
