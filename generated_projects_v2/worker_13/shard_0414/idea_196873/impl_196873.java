...
@Data
public class Idea196873Config {
    private String name = "idea_196873";
 ...
 */
@Slf4j
public class Idea196873Service {
    private static final int IDEA_ID = 196873;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196873Service() {
        this(new Idea196873Config());
    }

    public Idea196873Service(Idea196873Config config) {
        this.config = config != null ? config : new Idea196873Config();
