...
@Data
public class Idea196966Config {
    private String name = "idea_196966";
 ...
 */
@Slf4j
public class Idea196966Service {
    private static final int IDEA_ID = 196966;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196966Service() {
        this(new Idea196966Config());
    }

    public Idea196966Service(Idea196966Config config) {
        this.config = config != null ? config : new Idea196966Config();
