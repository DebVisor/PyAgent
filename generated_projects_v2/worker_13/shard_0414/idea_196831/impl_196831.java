...
@Data
public class Idea196831Config {
    private String name = "idea_196831";
 ...
 */
@Slf4j
public class Idea196831Service {
    private static final int IDEA_ID = 196831;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196831Service() {
        this(new Idea196831Config());
    }

    public Idea196831Service(Idea196831Config config) {
        this.config = config != null ? config : new Idea196831Config();
