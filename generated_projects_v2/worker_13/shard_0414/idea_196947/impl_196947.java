...
@Data
public class Idea196947Config {
    private String name = "idea_196947";
 ...
 */
@Slf4j
public class Idea196947Service {
    private static final int IDEA_ID = 196947;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196947Service() {
        this(new Idea196947Config());
    }

    public Idea196947Service(Idea196947Config config) {
        this.config = config != null ? config : new Idea196947Config();
