...
@Data
public class Idea196807Config {
    private String name = "idea_196807";
 ...
 */
@Slf4j
public class Idea196807Service {
    private static final int IDEA_ID = 196807;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196807Service() {
        this(new Idea196807Config());
    }

    public Idea196807Service(Idea196807Config config) {
        this.config = config != null ? config : new Idea196807Config();
