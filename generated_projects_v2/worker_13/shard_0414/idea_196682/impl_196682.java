...
@Data
public class Idea196682Config {
    private String name = "idea_196682";
 ...
 */
@Slf4j
public class Idea196682Service {
    private static final int IDEA_ID = 196682;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196682Service() {
        this(new Idea196682Config());
    }

    public Idea196682Service(Idea196682Config config) {
        this.config = config != null ? config : new Idea196682Config();
