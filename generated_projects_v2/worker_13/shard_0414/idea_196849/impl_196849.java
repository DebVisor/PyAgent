...
@Data
public class Idea196849Config {
    private String name = "idea_196849";
 ...
 */
@Slf4j
public class Idea196849Service {
    private static final int IDEA_ID = 196849;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196849Service() {
        this(new Idea196849Config());
    }

    public Idea196849Service(Idea196849Config config) {
        this.config = config != null ? config : new Idea196849Config();
