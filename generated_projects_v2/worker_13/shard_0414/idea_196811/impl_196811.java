...
@Data
public class Idea196811Config {
    private String name = "idea_196811";
 ...
 */
@Slf4j
public class Idea196811Service {
    private static final int IDEA_ID = 196811;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196811Service() {
        this(new Idea196811Config());
    }

    public Idea196811Service(Idea196811Config config) {
        this.config = config != null ? config : new Idea196811Config();
