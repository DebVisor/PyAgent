...
@Data
public class Idea196818Config {
    private String name = "idea_196818";
 ...
 */
@Slf4j
public class Idea196818Service {
    private static final int IDEA_ID = 196818;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196818Service() {
        this(new Idea196818Config());
    }

    public Idea196818Service(Idea196818Config config) {
        this.config = config != null ? config : new Idea196818Config();
