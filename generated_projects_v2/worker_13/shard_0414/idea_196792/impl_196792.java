...
@Data
public class Idea196792Config {
    private String name = "idea_196792";
 ...
 */
@Slf4j
public class Idea196792Service {
    private static final int IDEA_ID = 196792;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196792Service() {
        this(new Idea196792Config());
    }

    public Idea196792Service(Idea196792Config config) {
        this.config = config != null ? config : new Idea196792Config();
