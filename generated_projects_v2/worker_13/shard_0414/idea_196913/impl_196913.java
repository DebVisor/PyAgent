...
@Data
public class Idea196913Config {
    private String name = "idea_196913";
 ...
 */
@Slf4j
public class Idea196913Service {
    private static final int IDEA_ID = 196913;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196913Service() {
        this(new Idea196913Config());
    }

    public Idea196913Service(Idea196913Config config) {
        this.config = config != null ? config : new Idea196913Config();
