...
@Data
public class Idea196993Config {
    private String name = "idea_196993";
 ...
 */
@Slf4j
public class Idea196993Service {
    private static final int IDEA_ID = 196993;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196993Service() {
        this(new Idea196993Config());
    }

    public Idea196993Service(Idea196993Config config) {
        this.config = config != null ? config : new Idea196993Config();
