...
@Data
public class Idea196925Config {
    private String name = "idea_196925";
 ...
 */
@Slf4j
public class Idea196925Service {
    private static final int IDEA_ID = 196925;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196925Service() {
        this(new Idea196925Config());
    }

    public Idea196925Service(Idea196925Config config) {
        this.config = config != null ? config : new Idea196925Config();
