...
@Data
public class Idea196894Config {
    private String name = "idea_196894";
 ...
 */
@Slf4j
public class Idea196894Service {
    private static final int IDEA_ID = 196894;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196894Service() {
        this(new Idea196894Config());
    }

    public Idea196894Service(Idea196894Config config) {
        this.config = config != null ? config : new Idea196894Config();
