...
@Data
public class Idea196708Config {
    private String name = "idea_196708";
 ...
 */
@Slf4j
public class Idea196708Service {
    private static final int IDEA_ID = 196708;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196708Service() {
        this(new Idea196708Config());
    }

    public Idea196708Service(Idea196708Config config) {
        this.config = config != null ? config : new Idea196708Config();
