...
@Data
public class Idea196829Config {
    private String name = "idea_196829";
 ...
 */
@Slf4j
public class Idea196829Service {
    private static final int IDEA_ID = 196829;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196829Service() {
        this(new Idea196829Config());
    }

    public Idea196829Service(Idea196829Config config) {
        this.config = config != null ? config : new Idea196829Config();
