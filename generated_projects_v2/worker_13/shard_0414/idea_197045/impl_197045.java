...
@Data
public class Idea197045Config {
    private String name = "idea_197045";
 ...
 */
@Slf4j
public class Idea197045Service {
    private static final int IDEA_ID = 197045;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197045Service() {
        this(new Idea197045Config());
    }

    public Idea197045Service(Idea197045Config config) {
        this.config = config != null ? config : new Idea197045Config();
