...
@Data
public class Idea196958Config {
    private String name = "idea_196958";
 ...
 */
@Slf4j
public class Idea196958Service {
    private static final int IDEA_ID = 196958;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196958Service() {
        this(new Idea196958Config());
    }

    public Idea196958Service(Idea196958Config config) {
        this.config = config != null ? config : new Idea196958Config();
