...
@Data
public class Idea196724Config {
    private String name = "idea_196724";
 ...
 */
@Slf4j
public class Idea196724Service {
    private static final int IDEA_ID = 196724;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196724Service() {
        this(new Idea196724Config());
    }

    public Idea196724Service(Idea196724Config config) {
        this.config = config != null ? config : new Idea196724Config();
