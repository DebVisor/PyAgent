...
@Data
public class Idea196994Config {
    private String name = "idea_196994";
 ...
 */
@Slf4j
public class Idea196994Service {
    private static final int IDEA_ID = 196994;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196994Service() {
        this(new Idea196994Config());
    }

    public Idea196994Service(Idea196994Config config) {
        this.config = config != null ? config : new Idea196994Config();
