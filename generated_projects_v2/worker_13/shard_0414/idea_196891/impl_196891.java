...
@Data
public class Idea196891Config {
    private String name = "idea_196891";
 ...
 */
@Slf4j
public class Idea196891Service {
    private static final int IDEA_ID = 196891;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196891Service() {
        this(new Idea196891Config());
    }

    public Idea196891Service(Idea196891Config config) {
        this.config = config != null ? config : new Idea196891Config();
