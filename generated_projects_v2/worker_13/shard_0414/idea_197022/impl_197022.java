...
@Data
public class Idea197022Config {
    private String name = "idea_197022";
 ...
 */
@Slf4j
public class Idea197022Service {
    private static final int IDEA_ID = 197022;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197022Service() {
        this(new Idea197022Config());
    }

    public Idea197022Service(Idea197022Config config) {
        this.config = config != null ? config : new Idea197022Config();
