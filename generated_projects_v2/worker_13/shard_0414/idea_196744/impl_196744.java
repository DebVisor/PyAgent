...
@Data
public class Idea196744Config {
    private String name = "idea_196744";
 ...
 */
@Slf4j
public class Idea196744Service {
    private static final int IDEA_ID = 196744;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196744Service() {
        this(new Idea196744Config());
    }

    public Idea196744Service(Idea196744Config config) {
        this.config = config != null ? config : new Idea196744Config();
