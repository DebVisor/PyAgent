...
@Data
public class Idea196953Config {
    private String name = "idea_196953";
 ...
 */
@Slf4j
public class Idea196953Service {
    private static final int IDEA_ID = 196953;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196953Service() {
        this(new Idea196953Config());
    }

    public Idea196953Service(Idea196953Config config) {
        this.config = config != null ? config : new Idea196953Config();
