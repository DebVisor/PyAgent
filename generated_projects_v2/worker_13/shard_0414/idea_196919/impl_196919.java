...
@Data
public class Idea196919Config {
    private String name = "idea_196919";
 ...
 */
@Slf4j
public class Idea196919Service {
    private static final int IDEA_ID = 196919;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196919Service() {
        this(new Idea196919Config());
    }

    public Idea196919Service(Idea196919Config config) {
        this.config = config != null ? config : new Idea196919Config();
