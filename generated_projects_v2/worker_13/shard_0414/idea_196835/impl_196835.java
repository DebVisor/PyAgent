...
@Data
public class Idea196835Config {
    private String name = "idea_196835";
 ...
 */
@Slf4j
public class Idea196835Service {
    private static final int IDEA_ID = 196835;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196835Service() {
        this(new Idea196835Config());
    }

    public Idea196835Service(Idea196835Config config) {
        this.config = config != null ? config : new Idea196835Config();
