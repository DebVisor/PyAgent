...
@Data
public class Idea197081Config {
    private String name = "idea_197081";
 ...
 */
@Slf4j
public class Idea197081Service {
    private static final int IDEA_ID = 197081;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197081Service() {
        this(new Idea197081Config());
    }

    public Idea197081Service(Idea197081Config config) {
        this.config = config != null ? config : new Idea197081Config();
