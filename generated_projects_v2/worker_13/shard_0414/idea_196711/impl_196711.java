...
@Data
public class Idea196711Config {
    private String name = "idea_196711";
 ...
 */
@Slf4j
public class Idea196711Service {
    private static final int IDEA_ID = 196711;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196711Service() {
        this(new Idea196711Config());
    }

    public Idea196711Service(Idea196711Config config) {
        this.config = config != null ? config : new Idea196711Config();
