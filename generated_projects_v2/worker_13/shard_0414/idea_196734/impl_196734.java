...
@Data
public class Idea196734Config {
    private String name = "idea_196734";
 ...
 */
@Slf4j
public class Idea196734Service {
    private static final int IDEA_ID = 196734;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196734Service() {
        this(new Idea196734Config());
    }

    public Idea196734Service(Idea196734Config config) {
        this.config = config != null ? config : new Idea196734Config();
