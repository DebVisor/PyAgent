...
@Data
public class Idea196939Config {
    private String name = "idea_196939";
 ...
 */
@Slf4j
public class Idea196939Service {
    private static final int IDEA_ID = 196939;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196939Service() {
        this(new Idea196939Config());
    }

    public Idea196939Service(Idea196939Config config) {
        this.config = config != null ? config : new Idea196939Config();
