...
@Data
public class Idea196779Config {
    private String name = "idea_196779";
 ...
 */
@Slf4j
public class Idea196779Service {
    private static final int IDEA_ID = 196779;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196779Service() {
        this(new Idea196779Config());
    }

    public Idea196779Service(Idea196779Config config) {
        this.config = config != null ? config : new Idea196779Config();
