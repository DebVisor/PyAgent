...
@Data
public class Idea196661Config {
    private String name = "idea_196661";
 ...
 */
@Slf4j
public class Idea196661Service {
    private static final int IDEA_ID = 196661;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196661Service() {
        this(new Idea196661Config());
    }

    public Idea196661Service(Idea196661Config config) {
        this.config = config != null ? config : new Idea196661Config();
