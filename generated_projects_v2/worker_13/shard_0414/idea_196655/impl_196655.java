...
@Data
public class Idea196655Config {
    private String name = "idea_196655";
 ...
 */
@Slf4j
public class Idea196655Service {
    private static final int IDEA_ID = 196655;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196655Service() {
        this(new Idea196655Config());
    }

    public Idea196655Service(Idea196655Config config) {
        this.config = config != null ? config : new Idea196655Config();
