...
@Data
public class Idea196878Config {
    private String name = "idea_196878";
 ...
 */
@Slf4j
public class Idea196878Service {
    private static final int IDEA_ID = 196878;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196878Service() {
        this(new Idea196878Config());
    }

    public Idea196878Service(Idea196878Config config) {
        this.config = config != null ? config : new Idea196878Config();
