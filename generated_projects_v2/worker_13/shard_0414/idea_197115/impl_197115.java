...
@Data
public class Idea197115Config {
    private String name = "idea_197115";
 ...
 */
@Slf4j
public class Idea197115Service {
    private static final int IDEA_ID = 197115;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197115Service() {
        this(new Idea197115Config());
    }

    public Idea197115Service(Idea197115Config config) {
        this.config = config != null ? config : new Idea197115Config();
