...
@Data
public class Idea196778Config {
    private String name = "idea_196778";
 ...
 */
@Slf4j
public class Idea196778Service {
    private static final int IDEA_ID = 196778;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196778Service() {
        this(new Idea196778Config());
    }

    public Idea196778Service(Idea196778Config config) {
        this.config = config != null ? config : new Idea196778Config();
