...
@Data
public class Idea196921Config {
    private String name = "idea_196921";
 ...
 */
@Slf4j
public class Idea196921Service {
    private static final int IDEA_ID = 196921;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196921Service() {
        this(new Idea196921Config());
    }

    public Idea196921Service(Idea196921Config config) {
        this.config = config != null ? config : new Idea196921Config();
