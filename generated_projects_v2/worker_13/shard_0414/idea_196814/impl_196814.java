...
@Data
public class Idea196814Config {
    private String name = "idea_196814";
 ...
 */
@Slf4j
public class Idea196814Service {
    private static final int IDEA_ID = 196814;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196814Service() {
        this(new Idea196814Config());
    }

    public Idea196814Service(Idea196814Config config) {
        this.config = config != null ? config : new Idea196814Config();
