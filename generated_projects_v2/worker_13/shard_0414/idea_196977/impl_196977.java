...
@Data
public class Idea196977Config {
    private String name = "idea_196977";
 ...
 */
@Slf4j
public class Idea196977Service {
    private static final int IDEA_ID = 196977;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196977Service() {
        this(new Idea196977Config());
    }

    public Idea196977Service(Idea196977Config config) {
        this.config = config != null ? config : new Idea196977Config();
