...
@Data
public class Idea196654Config {
    private String name = "idea_196654";
 ...
 */
@Slf4j
public class Idea196654Service {
    private static final int IDEA_ID = 196654;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196654Service() {
        this(new Idea196654Config());
    }

    public Idea196654Service(Idea196654Config config) {
        this.config = config != null ? config : new Idea196654Config();
