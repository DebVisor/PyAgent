...
@Data
public class Idea196922Config {
    private String name = "idea_196922";
 ...
 */
@Slf4j
public class Idea196922Service {
    private static final int IDEA_ID = 196922;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196922Service() {
        this(new Idea196922Config());
    }

    public Idea196922Service(Idea196922Config config) {
        this.config = config != null ? config : new Idea196922Config();
