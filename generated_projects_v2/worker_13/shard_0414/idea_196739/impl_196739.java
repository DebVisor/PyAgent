...
@Data
public class Idea196739Config {
    private String name = "idea_196739";
 ...
 */
@Slf4j
public class Idea196739Service {
    private static final int IDEA_ID = 196739;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196739Service() {
        this(new Idea196739Config());
    }

    public Idea196739Service(Idea196739Config config) {
        this.config = config != null ? config : new Idea196739Config();
