...
@Data
public class Idea197087Config {
    private String name = "idea_197087";
 ...
 */
@Slf4j
public class Idea197087Service {
    private static final int IDEA_ID = 197087;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197087Service() {
        this(new Idea197087Config());
    }

    public Idea197087Service(Idea197087Config config) {
        this.config = config != null ? config : new Idea197087Config();
