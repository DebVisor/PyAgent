...
@Data
public class Idea196950Config {
    private String name = "idea_196950";
 ...
 */
@Slf4j
public class Idea196950Service {
    private static final int IDEA_ID = 196950;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196950Service() {
        this(new Idea196950Config());
    }

    public Idea196950Service(Idea196950Config config) {
        this.config = config != null ? config : new Idea196950Config();
