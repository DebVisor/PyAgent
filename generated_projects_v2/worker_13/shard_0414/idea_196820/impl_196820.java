...
@Data
public class Idea196820Config {
    private String name = "idea_196820";
 ...
 */
@Slf4j
public class Idea196820Service {
    private static final int IDEA_ID = 196820;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196820Service() {
        this(new Idea196820Config());
    }

    public Idea196820Service(Idea196820Config config) {
        this.config = config != null ? config : new Idea196820Config();
