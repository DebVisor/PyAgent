...
@Data
public class Idea197092Config {
    private String name = "idea_197092";
 ...
 */
@Slf4j
public class Idea197092Service {
    private static final int IDEA_ID = 197092;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197092Service() {
        this(new Idea197092Config());
    }

    public Idea197092Service(Idea197092Config config) {
        this.config = config != null ? config : new Idea197092Config();
