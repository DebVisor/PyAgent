...
@Data
public class Idea196726Config {
    private String name = "idea_196726";
 ...
 */
@Slf4j
public class Idea196726Service {
    private static final int IDEA_ID = 196726;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196726Service() {
        this(new Idea196726Config());
    }

    public Idea196726Service(Idea196726Config config) {
        this.config = config != null ? config : new Idea196726Config();
