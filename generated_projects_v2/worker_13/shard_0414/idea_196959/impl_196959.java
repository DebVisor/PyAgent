...
@Data
public class Idea196959Config {
    private String name = "idea_196959";
 ...
 */
@Slf4j
public class Idea196959Service {
    private static final int IDEA_ID = 196959;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196959Service() {
        this(new Idea196959Config());
    }

    public Idea196959Service(Idea196959Config config) {
        this.config = config != null ? config : new Idea196959Config();
