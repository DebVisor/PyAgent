...
@Data
public class Idea197014Config {
    private String name = "idea_197014";
 ...
 */
@Slf4j
public class Idea197014Service {
    private static final int IDEA_ID = 197014;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197014Service() {
        this(new Idea197014Config());
    }

    public Idea197014Service(Idea197014Config config) {
        this.config = config != null ? config : new Idea197014Config();
