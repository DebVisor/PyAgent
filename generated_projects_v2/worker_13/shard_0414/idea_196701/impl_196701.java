...
@Data
public class Idea196701Config {
    private String name = "idea_196701";
 ...
 */
@Slf4j
public class Idea196701Service {
    private static final int IDEA_ID = 196701;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196701Service() {
        this(new Idea196701Config());
    }

    public Idea196701Service(Idea196701Config config) {
        this.config = config != null ? config : new Idea196701Config();
