...
@Data
public class Idea196888Config {
    private String name = "idea_196888";
 ...
 */
@Slf4j
public class Idea196888Service {
    private static final int IDEA_ID = 196888;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196888Service() {
        this(new Idea196888Config());
    }

    public Idea196888Service(Idea196888Config config) {
        this.config = config != null ? config : new Idea196888Config();
