...
@Data
public class Idea197044Config {
    private String name = "idea_197044";
 ...
 */
@Slf4j
public class Idea197044Service {
    private static final int IDEA_ID = 197044;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197044Service() {
        this(new Idea197044Config());
    }

    public Idea197044Service(Idea197044Config config) {
        this.config = config != null ? config : new Idea197044Config();
