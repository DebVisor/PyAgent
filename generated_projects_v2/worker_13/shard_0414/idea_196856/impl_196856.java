...
@Data
public class Idea196856Config {
    private String name = "idea_196856";
 ...
 */
@Slf4j
public class Idea196856Service {
    private static final int IDEA_ID = 196856;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196856Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196856Service() {
        this(new Idea196856Config());
    }

    public Idea196856Service(Idea196856Config config) {
        this.config = config != null ? config : new Idea196856Config();
