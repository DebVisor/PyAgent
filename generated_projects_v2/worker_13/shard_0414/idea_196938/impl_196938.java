...
@Data
public class Idea196938Config {
    private String name = "idea_196938";
 ...
 */
@Slf4j
public class Idea196938Service {
    private static final int IDEA_ID = 196938;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196938Service() {
        this(new Idea196938Config());
    }

    public Idea196938Service(Idea196938Config config) {
        this.config = config != null ? config : new Idea196938Config();
