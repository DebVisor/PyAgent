...
@Data
public class Idea197114Config {
    private String name = "idea_197114";
 ...
 */
@Slf4j
public class Idea197114Service {
    private static final int IDEA_ID = 197114;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197114Service() {
        this(new Idea197114Config());
    }

    public Idea197114Service(Idea197114Config config) {
        this.config = config != null ? config : new Idea197114Config();
