...
@Data
public class Idea197107Config {
    private String name = "idea_197107";
 ...
 */
@Slf4j
public class Idea197107Service {
    private static final int IDEA_ID = 197107;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197107Service() {
        this(new Idea197107Config());
    }

    public Idea197107Service(Idea197107Config config) {
        this.config = config != null ? config : new Idea197107Config();
