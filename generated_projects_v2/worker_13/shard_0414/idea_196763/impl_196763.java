...
@Data
public class Idea196763Config {
    private String name = "idea_196763";
 ...
 */
@Slf4j
public class Idea196763Service {
    private static final int IDEA_ID = 196763;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196763Service() {
        this(new Idea196763Config());
    }

    public Idea196763Service(Idea196763Config config) {
        this.config = config != null ? config : new Idea196763Config();
