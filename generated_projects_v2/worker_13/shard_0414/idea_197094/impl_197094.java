...
@Data
public class Idea197094Config {
    private String name = "idea_197094";
 ...
 */
@Slf4j
public class Idea197094Service {
    private static final int IDEA_ID = 197094;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197094Service() {
        this(new Idea197094Config());
    }

    public Idea197094Service(Idea197094Config config) {
        this.config = config != null ? config : new Idea197094Config();
