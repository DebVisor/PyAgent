...
@Data
public class Idea197025Config {
    private String name = "idea_197025";
 ...
 */
@Slf4j
public class Idea197025Service {
    private static final int IDEA_ID = 197025;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197025Service() {
        this(new Idea197025Config());
    }

    public Idea197025Service(Idea197025Config config) {
        this.config = config != null ? config : new Idea197025Config();
