...
@Data
public class Idea196671Config {
    private String name = "idea_196671";
 ...
 */
@Slf4j
public class Idea196671Service {
    private static final int IDEA_ID = 196671;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196671Service() {
        this(new Idea196671Config());
    }

    public Idea196671Service(Idea196671Config config) {
        this.config = config != null ? config : new Idea196671Config();
