...
@Data
public class Idea196916Config {
    private String name = "idea_196916";
 ...
 */
@Slf4j
public class Idea196916Service {
    private static final int IDEA_ID = 196916;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196916Service() {
        this(new Idea196916Config());
    }

    public Idea196916Service(Idea196916Config config) {
        this.config = config != null ? config : new Idea196916Config();
