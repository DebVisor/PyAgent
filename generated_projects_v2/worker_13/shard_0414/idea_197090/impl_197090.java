...
@Data
public class Idea197090Config {
    private String name = "idea_197090";
 ...
 */
@Slf4j
public class Idea197090Service {
    private static final int IDEA_ID = 197090;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197090Service() {
        this(new Idea197090Config());
    }

    public Idea197090Service(Idea197090Config config) {
        this.config = config != null ? config : new Idea197090Config();
