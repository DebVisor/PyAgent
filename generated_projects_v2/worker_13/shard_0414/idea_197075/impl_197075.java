...
@Data
public class Idea197075Config {
    private String name = "idea_197075";
 ...
 */
@Slf4j
public class Idea197075Service {
    private static final int IDEA_ID = 197075;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197075Service() {
        this(new Idea197075Config());
    }

    public Idea197075Service(Idea197075Config config) {
        this.config = config != null ? config : new Idea197075Config();
