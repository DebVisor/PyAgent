...
@Data
public class Idea196936Config {
    private String name = "idea_196936";
 ...
 */
@Slf4j
public class Idea196936Service {
    private static final int IDEA_ID = 196936;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196936Service() {
        this(new Idea196936Config());
    }

    public Idea196936Service(Idea196936Config config) {
        this.config = config != null ? config : new Idea196936Config();
