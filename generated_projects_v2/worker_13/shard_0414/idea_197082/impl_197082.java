...
@Data
public class Idea197082Config {
    private String name = "idea_197082";
 ...
 */
@Slf4j
public class Idea197082Service {
    private static final int IDEA_ID = 197082;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197082Service() {
        this(new Idea197082Config());
    }

    public Idea197082Service(Idea197082Config config) {
        this.config = config != null ? config : new Idea197082Config();
