...
@Data
public class Idea196774Config {
    private String name = "idea_196774";
 ...
 */
@Slf4j
public class Idea196774Service {
    private static final int IDEA_ID = 196774;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196774Service() {
        this(new Idea196774Config());
    }

    public Idea196774Service(Idea196774Config config) {
        this.config = config != null ? config : new Idea196774Config();
