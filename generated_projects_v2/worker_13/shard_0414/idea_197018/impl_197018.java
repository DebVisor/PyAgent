...
@Data
public class Idea197018Config {
    private String name = "idea_197018";
 ...
 */
@Slf4j
public class Idea197018Service {
    private static final int IDEA_ID = 197018;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197018Service() {
        this(new Idea197018Config());
    }

    public Idea197018Service(Idea197018Config config) {
        this.config = config != null ? config : new Idea197018Config();
