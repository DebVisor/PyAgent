...
@Data
public class Idea196960Config {
    private String name = "idea_196960";
 ...
 */
@Slf4j
public class Idea196960Service {
    private static final int IDEA_ID = 196960;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196960Service() {
        this(new Idea196960Config());
    }

    public Idea196960Service(Idea196960Config config) {
        this.config = config != null ? config : new Idea196960Config();
