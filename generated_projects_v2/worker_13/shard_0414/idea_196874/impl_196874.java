...
@Data
public class Idea196874Config {
    private String name = "idea_196874";
 ...
 */
@Slf4j
public class Idea196874Service {
    private static final int IDEA_ID = 196874;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196874Service() {
        this(new Idea196874Config());
    }

    public Idea196874Service(Idea196874Config config) {
        this.config = config != null ? config : new Idea196874Config();
