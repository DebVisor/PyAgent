...
@Data
public class Idea197015Config {
    private String name = "idea_197015";
 ...
 */
@Slf4j
public class Idea197015Service {
    private static final int IDEA_ID = 197015;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197015Service() {
        this(new Idea197015Config());
    }

    public Idea197015Service(Idea197015Config config) {
        this.config = config != null ? config : new Idea197015Config();
