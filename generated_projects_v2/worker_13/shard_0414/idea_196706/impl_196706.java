...
@Data
public class Idea196706Config {
    private String name = "idea_196706";
 ...
 */
@Slf4j
public class Idea196706Service {
    private static final int IDEA_ID = 196706;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196706Service() {
        this(new Idea196706Config());
    }

    public Idea196706Service(Idea196706Config config) {
        this.config = config != null ? config : new Idea196706Config();
