...
@Data
public class Idea197024Config {
    private String name = "idea_197024";
 ...
 */
@Slf4j
public class Idea197024Service {
    private static final int IDEA_ID = 197024;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197024Service() {
        this(new Idea197024Config());
    }

    public Idea197024Service(Idea197024Config config) {
        this.config = config != null ? config : new Idea197024Config();
