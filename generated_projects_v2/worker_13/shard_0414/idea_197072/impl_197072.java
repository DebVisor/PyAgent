...
@Data
public class Idea197072Config {
    private String name = "idea_197072";
 ...
 */
@Slf4j
public class Idea197072Service {
    private static final int IDEA_ID = 197072;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197072Service() {
        this(new Idea197072Config());
    }

    public Idea197072Service(Idea197072Config config) {
        this.config = config != null ? config : new Idea197072Config();
