...
@Data
public class Idea196998Config {
    private String name = "idea_196998";
 ...
 */
@Slf4j
public class Idea196998Service {
    private static final int IDEA_ID = 196998;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196998Service() {
        this(new Idea196998Config());
    }

    public Idea196998Service(Idea196998Config config) {
        this.config = config != null ? config : new Idea196998Config();
