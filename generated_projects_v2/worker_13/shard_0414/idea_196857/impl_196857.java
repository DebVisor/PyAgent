...
@Data
public class Idea196857Config {
    private String name = "idea_196857";
 ...
 */
@Slf4j
public class Idea196857Service {
    private static final int IDEA_ID = 196857;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196857Service() {
        this(new Idea196857Config());
    }

    public Idea196857Service(Idea196857Config config) {
        this.config = config != null ? config : new Idea196857Config();
