...
@Data
public class Idea196680Config {
    private String name = "idea_196680";
 ...
 */
@Slf4j
public class Idea196680Service {
    private static final int IDEA_ID = 196680;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196680Service() {
        this(new Idea196680Config());
    }

    public Idea196680Service(Idea196680Config config) {
        this.config = config != null ? config : new Idea196680Config();
