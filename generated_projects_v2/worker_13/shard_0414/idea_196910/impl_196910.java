...
@Data
public class Idea196910Config {
    private String name = "idea_196910";
 ...
 */
@Slf4j
public class Idea196910Service {
    private static final int IDEA_ID = 196910;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196910Service() {
        this(new Idea196910Config());
    }

    public Idea196910Service(Idea196910Config config) {
        this.config = config != null ? config : new Idea196910Config();
