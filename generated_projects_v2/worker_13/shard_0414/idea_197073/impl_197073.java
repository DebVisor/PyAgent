...
@Data
public class Idea197073Config {
    private String name = "idea_197073";
 ...
 */
@Slf4j
public class Idea197073Service {
    private static final int IDEA_ID = 197073;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197073Service() {
        this(new Idea197073Config());
    }

    public Idea197073Service(Idea197073Config config) {
        this.config = config != null ? config : new Idea197073Config();
