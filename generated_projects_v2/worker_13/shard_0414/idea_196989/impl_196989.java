...
@Data
public class Idea196989Config {
    private String name = "idea_196989";
 ...
 */
@Slf4j
public class Idea196989Service {
    private static final int IDEA_ID = 196989;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196989Service() {
        this(new Idea196989Config());
    }

    public Idea196989Service(Idea196989Config config) {
        this.config = config != null ? config : new Idea196989Config();
