...
@Data
public class Idea196995Config {
    private String name = "idea_196995";
 ...
 */
@Slf4j
public class Idea196995Service {
    private static final int IDEA_ID = 196995;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196995Service() {
        this(new Idea196995Config());
    }

    public Idea196995Service(Idea196995Config config) {
        this.config = config != null ? config : new Idea196995Config();
