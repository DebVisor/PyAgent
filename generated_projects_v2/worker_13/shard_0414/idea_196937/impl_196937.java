...
@Data
public class Idea196937Config {
    private String name = "idea_196937";
 ...
 */
@Slf4j
public class Idea196937Service {
    private static final int IDEA_ID = 196937;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196937Service() {
        this(new Idea196937Config());
    }

    public Idea196937Service(Idea196937Config config) {
        this.config = config != null ? config : new Idea196937Config();
