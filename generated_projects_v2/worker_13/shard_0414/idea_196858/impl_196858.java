...
@Data
public class Idea196858Config {
    private String name = "idea_196858";
 ...
 */
@Slf4j
public class Idea196858Service {
    private static final int IDEA_ID = 196858;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196858Service() {
        this(new Idea196858Config());
    }

    public Idea196858Service(Idea196858Config config) {
        this.config = config != null ? config : new Idea196858Config();
