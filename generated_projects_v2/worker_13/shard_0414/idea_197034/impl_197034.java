...
@Data
public class Idea197034Config {
    private String name = "idea_197034";
 ...
 */
@Slf4j
public class Idea197034Service {
    private static final int IDEA_ID = 197034;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197034Service() {
        this(new Idea197034Config());
    }

    public Idea197034Service(Idea197034Config config) {
        this.config = config != null ? config : new Idea197034Config();
