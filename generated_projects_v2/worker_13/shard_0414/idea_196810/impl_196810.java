...
@Data
public class Idea196810Config {
    private String name = "idea_196810";
 ...
 */
@Slf4j
public class Idea196810Service {
    private static final int IDEA_ID = 196810;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196810Service() {
        this(new Idea196810Config());
    }

    public Idea196810Service(Idea196810Config config) {
        this.config = config != null ? config : new Idea196810Config();
