...
@Data
public class Idea196675Config {
    private String name = "idea_196675";
 ...
 */
@Slf4j
public class Idea196675Service {
    private static final int IDEA_ID = 196675;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196675Service() {
        this(new Idea196675Config());
    }

    public Idea196675Service(Idea196675Config config) {
        this.config = config != null ? config : new Idea196675Config();
