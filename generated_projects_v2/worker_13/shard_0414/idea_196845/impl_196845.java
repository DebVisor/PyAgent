...
@Data
public class Idea196845Config {
    private String name = "idea_196845";
 ...
 */
@Slf4j
public class Idea196845Service {
    private static final int IDEA_ID = 196845;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196845Service() {
        this(new Idea196845Config());
    }

    public Idea196845Service(Idea196845Config config) {
        this.config = config != null ? config : new Idea196845Config();
