...
@Data
public class Idea196852Config {
    private String name = "idea_196852";
 ...
 */
@Slf4j
public class Idea196852Service {
    private static final int IDEA_ID = 196852;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196852Service() {
        this(new Idea196852Config());
    }

    public Idea196852Service(Idea196852Config config) {
        this.config = config != null ? config : new Idea196852Config();
