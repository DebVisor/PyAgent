...
@Data
public class Idea196730Config {
    private String name = "idea_196730";
 ...
 */
@Slf4j
public class Idea196730Service {
    private static final int IDEA_ID = 196730;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196730Service() {
        this(new Idea196730Config());
    }

    public Idea196730Service(Idea196730Config config) {
        this.config = config != null ? config : new Idea196730Config();
