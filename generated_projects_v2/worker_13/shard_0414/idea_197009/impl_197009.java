...
@Data
public class Idea197009Config {
    private String name = "idea_197009";
 ...
 */
@Slf4j
public class Idea197009Service {
    private static final int IDEA_ID = 197009;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197009Service() {
        this(new Idea197009Config());
    }

    public Idea197009Service(Idea197009Config config) {
        this.config = config != null ? config : new Idea197009Config();
