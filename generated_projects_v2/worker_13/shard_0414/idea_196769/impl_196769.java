...
@Data
public class Idea196769Config {
    private String name = "idea_196769";
 ...
 */
@Slf4j
public class Idea196769Service {
    private static final int IDEA_ID = 196769;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196769Service() {
        this(new Idea196769Config());
    }

    public Idea196769Service(Idea196769Config config) {
        this.config = config != null ? config : new Idea196769Config();
