...
@Data
public class Idea196747Config {
    private String name = "idea_196747";
 ...
 */
@Slf4j
public class Idea196747Service {
    private static final int IDEA_ID = 196747;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196747Service() {
        this(new Idea196747Config());
    }

    public Idea196747Service(Idea196747Config config) {
        this.config = config != null ? config : new Idea196747Config();
