...
@Data
public class Idea196853Config {
    private String name = "idea_196853";
 ...
 */
@Slf4j
public class Idea196853Service {
    private static final int IDEA_ID = 196853;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196853Service() {
        this(new Idea196853Config());
    }

    public Idea196853Service(Idea196853Config config) {
        this.config = config != null ? config : new Idea196853Config();
