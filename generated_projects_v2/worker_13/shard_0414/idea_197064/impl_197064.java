...
@Data
public class Idea197064Config {
    private String name = "idea_197064";
 ...
 */
@Slf4j
public class Idea197064Service {
    private static final int IDEA_ID = 197064;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197064Service() {
        this(new Idea197064Config());
    }

    public Idea197064Service(Idea197064Config config) {
        this.config = config != null ? config : new Idea197064Config();
