...
@Data
public class Idea196788Config {
    private String name = "idea_196788";
 ...
 */
@Slf4j
public class Idea196788Service {
    private static final int IDEA_ID = 196788;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196788Service() {
        this(new Idea196788Config());
    }

    public Idea196788Service(Idea196788Config config) {
        this.config = config != null ? config : new Idea196788Config();
