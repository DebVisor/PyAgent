...
@Data
public class Idea196914Config {
    private String name = "idea_196914";
 ...
 */
@Slf4j
public class Idea196914Service {
    private static final int IDEA_ID = 196914;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196914Service() {
        this(new Idea196914Config());
    }

    public Idea196914Service(Idea196914Config config) {
        this.config = config != null ? config : new Idea196914Config();
