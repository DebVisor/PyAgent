...
@Data
public class Idea196791Config {
    private String name = "idea_196791";
 ...
 */
@Slf4j
public class Idea196791Service {
    private static final int IDEA_ID = 196791;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196791Service() {
        this(new Idea196791Config());
    }

    public Idea196791Service(Idea196791Config config) {
        this.config = config != null ? config : new Idea196791Config();
