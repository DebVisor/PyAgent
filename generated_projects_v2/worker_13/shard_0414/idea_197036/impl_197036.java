...
@Data
public class Idea197036Config {
    private String name = "idea_197036";
 ...
 */
@Slf4j
public class Idea197036Service {
    private static final int IDEA_ID = 197036;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197036Service() {
        this(new Idea197036Config());
    }

    public Idea197036Service(Idea197036Config config) {
        this.config = config != null ? config : new Idea197036Config();
