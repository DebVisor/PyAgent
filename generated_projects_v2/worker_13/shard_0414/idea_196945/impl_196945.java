...
@Data
public class Idea196945Config {
    private String name = "idea_196945";
 ...
 */
@Slf4j
public class Idea196945Service {
    private static final int IDEA_ID = 196945;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196945Service() {
        this(new Idea196945Config());
    }

    public Idea196945Service(Idea196945Config config) {
        this.config = config != null ? config : new Idea196945Config();
