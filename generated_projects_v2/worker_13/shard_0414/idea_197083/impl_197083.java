...
@Data
public class Idea197083Config {
    private String name = "idea_197083";
 ...
 */
@Slf4j
public class Idea197083Service {
    private static final int IDEA_ID = 197083;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197083Service() {
        this(new Idea197083Config());
    }

    public Idea197083Service(Idea197083Config config) {
        this.config = config != null ? config : new Idea197083Config();
