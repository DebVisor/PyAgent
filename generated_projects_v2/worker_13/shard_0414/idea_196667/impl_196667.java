...
@Data
public class Idea196667Config {
    private String name = "idea_196667";
 ...
 */
@Slf4j
public class Idea196667Service {
    private static final int IDEA_ID = 196667;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196667Service() {
        this(new Idea196667Config());
    }

    public Idea196667Service(Idea196667Config config) {
        this.config = config != null ? config : new Idea196667Config();
