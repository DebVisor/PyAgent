...
@Data
public class Idea196844Config {
    private String name = "idea_196844";
 ...
 */
@Slf4j
public class Idea196844Service {
    private static final int IDEA_ID = 196844;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196844Service() {
        this(new Idea196844Config());
    }

    public Idea196844Service(Idea196844Config config) {
        this.config = config != null ? config : new Idea196844Config();
