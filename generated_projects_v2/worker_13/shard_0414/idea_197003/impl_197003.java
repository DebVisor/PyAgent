...
@Data
public class Idea197003Config {
    private String name = "idea_197003";
 ...
 */
@Slf4j
public class Idea197003Service {
    private static final int IDEA_ID = 197003;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197003Service() {
        this(new Idea197003Config());
    }

    public Idea197003Service(Idea197003Config config) {
        this.config = config != null ? config : new Idea197003Config();
