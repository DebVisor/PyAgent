...
@Data
public class Idea196650Config {
    private String name = "idea_196650";
 ...
 */
@Slf4j
public class Idea196650Service {
    private static final int IDEA_ID = 196650;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196650Service() {
        this(new Idea196650Config());
    }

    public Idea196650Service(Idea196650Config config) {
        this.config = config != null ? config : new Idea196650Config();
