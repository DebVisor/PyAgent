...
@Data
public class Idea196793Config {
    private String name = "idea_196793";
 ...
 */
@Slf4j
public class Idea196793Service {
    private static final int IDEA_ID = 196793;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196793Service() {
        this(new Idea196793Config());
    }

    public Idea196793Service(Idea196793Config config) {
        this.config = config != null ? config : new Idea196793Config();
