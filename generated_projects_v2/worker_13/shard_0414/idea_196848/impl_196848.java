...
@Data
public class Idea196848Config {
    private String name = "idea_196848";
 ...
 */
@Slf4j
public class Idea196848Service {
    private static final int IDEA_ID = 196848;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196848Service() {
        this(new Idea196848Config());
    }

    public Idea196848Service(Idea196848Config config) {
        this.config = config != null ? config : new Idea196848Config();
