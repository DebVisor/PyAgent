...
@Data
public class Idea196970Config {
    private String name = "idea_196970";
 ...
 */
@Slf4j
public class Idea196970Service {
    private static final int IDEA_ID = 196970;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196970Service() {
        this(new Idea196970Config());
    }

    public Idea196970Service(Idea196970Config config) {
        this.config = config != null ? config : new Idea196970Config();
