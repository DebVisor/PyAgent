...
@Data
public class Idea196846Config {
    private String name = "idea_196846";
 ...
 */
@Slf4j
public class Idea196846Service {
    private static final int IDEA_ID = 196846;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196846Service() {
        this(new Idea196846Config());
    }

    public Idea196846Service(Idea196846Config config) {
        this.config = config != null ? config : new Idea196846Config();
