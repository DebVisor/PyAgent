...
@Data
public class Idea196694Config {
    private String name = "idea_196694";
 ...
 */
@Slf4j
public class Idea196694Service {
    private static final int IDEA_ID = 196694;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196694Service() {
        this(new Idea196694Config());
    }

    public Idea196694Service(Idea196694Config config) {
        this.config = config != null ? config : new Idea196694Config();
