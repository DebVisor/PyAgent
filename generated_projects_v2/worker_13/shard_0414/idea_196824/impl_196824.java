...
@Data
public class Idea196824Config {
    private String name = "idea_196824";
 ...
 */
@Slf4j
public class Idea196824Service {
    private static final int IDEA_ID = 196824;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196824Service() {
        this(new Idea196824Config());
    }

    public Idea196824Service(Idea196824Config config) {
        this.config = config != null ? config : new Idea196824Config();
