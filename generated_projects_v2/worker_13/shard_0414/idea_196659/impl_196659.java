...
@Data
public class Idea196659Config {
    private String name = "idea_196659";
 ...
 */
@Slf4j
public class Idea196659Service {
    private static final int IDEA_ID = 196659;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196659Service() {
        this(new Idea196659Config());
    }

    public Idea196659Service(Idea196659Config config) {
        this.config = config != null ? config : new Idea196659Config();
