...
@Data
public class Idea197028Config {
    private String name = "idea_197028";
 ...
 */
@Slf4j
public class Idea197028Service {
    private static final int IDEA_ID = 197028;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197028Service() {
        this(new Idea197028Config());
    }

    public Idea197028Service(Idea197028Config config) {
        this.config = config != null ? config : new Idea197028Config();
