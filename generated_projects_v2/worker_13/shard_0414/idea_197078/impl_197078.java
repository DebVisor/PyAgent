...
@Data
public class Idea197078Config {
    private String name = "idea_197078";
 ...
 */
@Slf4j
public class Idea197078Service {
    private static final int IDEA_ID = 197078;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197078Service() {
        this(new Idea197078Config());
    }

    public Idea197078Service(Idea197078Config config) {
        this.config = config != null ? config : new Idea197078Config();
