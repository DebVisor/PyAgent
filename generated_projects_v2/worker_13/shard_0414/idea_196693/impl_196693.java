...
@Data
public class Idea196693Config {
    private String name = "idea_196693";
 ...
 */
@Slf4j
public class Idea196693Service {
    private static final int IDEA_ID = 196693;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196693Service() {
        this(new Idea196693Config());
    }

    public Idea196693Service(Idea196693Config config) {
        this.config = config != null ? config : new Idea196693Config();
