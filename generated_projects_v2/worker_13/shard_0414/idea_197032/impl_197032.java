...
@Data
public class Idea197032Config {
    private String name = "idea_197032";
 ...
 */
@Slf4j
public class Idea197032Service {
    private static final int IDEA_ID = 197032;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197032Service() {
        this(new Idea197032Config());
    }

    public Idea197032Service(Idea197032Config config) {
        this.config = config != null ? config : new Idea197032Config();
