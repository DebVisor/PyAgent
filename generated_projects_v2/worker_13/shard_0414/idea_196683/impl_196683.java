...
@Data
public class Idea196683Config {
    private String name = "idea_196683";
 ...
 */
@Slf4j
public class Idea196683Service {
    private static final int IDEA_ID = 196683;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196683Service() {
        this(new Idea196683Config());
    }

    public Idea196683Service(Idea196683Config config) {
        this.config = config != null ? config : new Idea196683Config();
