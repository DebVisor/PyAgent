...
@Data
public class Idea196864Config {
    private String name = "idea_196864";
 ...
 */
@Slf4j
public class Idea196864Service {
    private static final int IDEA_ID = 196864;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196864Service() {
        this(new Idea196864Config());
    }

    public Idea196864Service(Idea196864Config config) {
        this.config = config != null ? config : new Idea196864Config();
