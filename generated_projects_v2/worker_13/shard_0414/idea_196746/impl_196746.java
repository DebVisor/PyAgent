...
@Data
public class Idea196746Config {
    private String name = "idea_196746";
 ...
 */
@Slf4j
public class Idea196746Service {
    private static final int IDEA_ID = 196746;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196746Service() {
        this(new Idea196746Config());
    }

    public Idea196746Service(Idea196746Config config) {
        this.config = config != null ? config : new Idea196746Config();
