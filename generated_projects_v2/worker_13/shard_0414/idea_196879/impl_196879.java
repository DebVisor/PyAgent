...
@Data
public class Idea196879Config {
    private String name = "idea_196879";
 ...
 */
@Slf4j
public class Idea196879Service {
    private static final int IDEA_ID = 196879;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196879Service() {
        this(new Idea196879Config());
    }

    public Idea196879Service(Idea196879Config config) {
        this.config = config != null ? config : new Idea196879Config();
