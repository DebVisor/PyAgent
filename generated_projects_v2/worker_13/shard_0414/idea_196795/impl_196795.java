...
@Data
public class Idea196795Config {
    private String name = "idea_196795";
 ...
 */
@Slf4j
public class Idea196795Service {
    private static final int IDEA_ID = 196795;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196795Service() {
        this(new Idea196795Config());
    }

    public Idea196795Service(Idea196795Config config) {
        this.config = config != null ? config : new Idea196795Config();
