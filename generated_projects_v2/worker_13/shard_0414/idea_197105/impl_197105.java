...
@Data
public class Idea197105Config {
    private String name = "idea_197105";
 ...
 */
@Slf4j
public class Idea197105Service {
    private static final int IDEA_ID = 197105;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197105Service() {
        this(new Idea197105Config());
    }

    public Idea197105Service(Idea197105Config config) {
        this.config = config != null ? config : new Idea197105Config();
