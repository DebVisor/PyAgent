...
@Data
public class Idea196967Config {
    private String name = "idea_196967";
 ...
 */
@Slf4j
public class Idea196967Service {
    private static final int IDEA_ID = 196967;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196967Service() {
        this(new Idea196967Config());
    }

    public Idea196967Service(Idea196967Config config) {
        this.config = config != null ? config : new Idea196967Config();
