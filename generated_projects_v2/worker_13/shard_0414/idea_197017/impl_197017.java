...
@Data
public class Idea197017Config {
    private String name = "idea_197017";
 ...
 */
@Slf4j
public class Idea197017Service {
    private static final int IDEA_ID = 197017;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197017Service() {
        this(new Idea197017Config());
    }

    public Idea197017Service(Idea197017Config config) {
        this.config = config != null ? config : new Idea197017Config();
