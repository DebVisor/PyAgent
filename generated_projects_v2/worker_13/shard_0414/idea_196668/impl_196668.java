...
@Data
public class Idea196668Config {
    private String name = "idea_196668";
 ...
 */
@Slf4j
public class Idea196668Service {
    private static final int IDEA_ID = 196668;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196668Service() {
        this(new Idea196668Config());
    }

    public Idea196668Service(Idea196668Config config) {
        this.config = config != null ? config : new Idea196668Config();
