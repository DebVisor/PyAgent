...
@Data
public class Idea196799Config {
    private String name = "idea_196799";
 ...
 */
@Slf4j
public class Idea196799Service {
    private static final int IDEA_ID = 196799;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196799Service() {
        this(new Idea196799Config());
    }

    public Idea196799Service(Idea196799Config config) {
        this.config = config != null ? config : new Idea196799Config();
