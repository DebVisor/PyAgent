...
@Data
public class Idea197079Config {
    private String name = "idea_197079";
 ...
 */
@Slf4j
public class Idea197079Service {
    private static final int IDEA_ID = 197079;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197079Service() {
        this(new Idea197079Config());
    }

    public Idea197079Service(Idea197079Config config) {
        this.config = config != null ? config : new Idea197079Config();
