...
@Data
public class Idea196943Config {
    private String name = "idea_196943";
 ...
 */
@Slf4j
public class Idea196943Service {
    private static final int IDEA_ID = 196943;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196943Service() {
        this(new Idea196943Config());
    }

    public Idea196943Service(Idea196943Config config) {
        this.config = config != null ? config : new Idea196943Config();
