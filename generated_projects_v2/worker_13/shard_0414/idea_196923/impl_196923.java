...
@Data
public class Idea196923Config {
    private String name = "idea_196923";
 ...
 */
@Slf4j
public class Idea196923Service {
    private static final int IDEA_ID = 196923;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196923Service() {
        this(new Idea196923Config());
    }

    public Idea196923Service(Idea196923Config config) {
        this.config = config != null ? config : new Idea196923Config();
