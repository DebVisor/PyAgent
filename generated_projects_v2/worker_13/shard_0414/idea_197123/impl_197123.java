...
@Data
public class Idea197123Config {
    private String name = "idea_197123";
 ...
 */
@Slf4j
public class Idea197123Service {
    private static final int IDEA_ID = 197123;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197123Service() {
        this(new Idea197123Config());
    }

    public Idea197123Service(Idea197123Config config) {
        this.config = config != null ? config : new Idea197123Config();
