...
@Data
public class Idea197020Config {
    private String name = "idea_197020";
 ...
 */
@Slf4j
public class Idea197020Service {
    private static final int IDEA_ID = 197020;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197020Service() {
        this(new Idea197020Config());
    }

    public Idea197020Service(Idea197020Config config) {
        this.config = config != null ? config : new Idea197020Config();
