...
@Data
public class Idea196909Config {
    private String name = "idea_196909";
 ...
 */
@Slf4j
public class Idea196909Service {
    private static final int IDEA_ID = 196909;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196909Service() {
        this(new Idea196909Config());
    }

    public Idea196909Service(Idea196909Config config) {
        this.config = config != null ? config : new Idea196909Config();
