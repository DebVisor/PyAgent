...
@Data
public class Idea197112Config {
    private String name = "idea_197112";
 ...
 */
@Slf4j
public class Idea197112Service {
    private static final int IDEA_ID = 197112;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197112Service() {
        this(new Idea197112Config());
    }

    public Idea197112Service(Idea197112Config config) {
        this.config = config != null ? config : new Idea197112Config();
