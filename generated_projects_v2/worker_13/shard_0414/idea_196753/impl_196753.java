...
@Data
public class Idea196753Config {
    private String name = "idea_196753";
 ...
 */
@Slf4j
public class Idea196753Service {
    private static final int IDEA_ID = 196753;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196753Service() {
        this(new Idea196753Config());
    }

    public Idea196753Service(Idea196753Config config) {
        this.config = config != null ? config : new Idea196753Config();
