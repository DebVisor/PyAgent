...
@Data
public class Idea196707Config {
    private String name = "idea_196707";
 ...
 */
@Slf4j
public class Idea196707Service {
    private static final int IDEA_ID = 196707;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196707Service() {
        this(new Idea196707Config());
    }

    public Idea196707Service(Idea196707Config config) {
        this.config = config != null ? config : new Idea196707Config();
