...
@Data
public class Idea196657Config {
    private String name = "idea_196657";
 ...
 */
@Slf4j
public class Idea196657Service {
    private static final int IDEA_ID = 196657;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196657Service() {
        this(new Idea196657Config());
    }

    public Idea196657Service(Idea196657Config config) {
        this.config = config != null ? config : new Idea196657Config();
