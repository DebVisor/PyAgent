...
@Data
public class Idea196974Config {
    private String name = "idea_196974";
 ...
 */
@Slf4j
public class Idea196974Service {
    private static final int IDEA_ID = 196974;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196974Service() {
        this(new Idea196974Config());
    }

    public Idea196974Service(Idea196974Config config) {
        this.config = config != null ? config : new Idea196974Config();
