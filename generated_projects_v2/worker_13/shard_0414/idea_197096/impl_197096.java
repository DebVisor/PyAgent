...
@Data
public class Idea197096Config {
    private String name = "idea_197096";
 ...
 */
@Slf4j
public class Idea197096Service {
    private static final int IDEA_ID = 197096;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197096Service() {
        this(new Idea197096Config());
    }

    public Idea197096Service(Idea197096Config config) {
        this.config = config != null ? config : new Idea197096Config();
