...
@Data
public class Idea196933Config {
    private String name = "idea_196933";
 ...
 */
@Slf4j
public class Idea196933Service {
    private static final int IDEA_ID = 196933;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196933Service() {
        this(new Idea196933Config());
    }

    public Idea196933Service(Idea196933Config config) {
        this.config = config != null ? config : new Idea196933Config();
