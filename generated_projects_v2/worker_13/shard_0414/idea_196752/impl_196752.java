...
@Data
public class Idea196752Config {
    private String name = "idea_196752";
 ...
 */
@Slf4j
public class Idea196752Service {
    private static final int IDEA_ID = 196752;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196752Service() {
        this(new Idea196752Config());
    }

    public Idea196752Service(Idea196752Config config) {
        this.config = config != null ? config : new Idea196752Config();
