...
@Data
public class Idea196870Config {
    private String name = "idea_196870";
 ...
 */
@Slf4j
public class Idea196870Service {
    private static final int IDEA_ID = 196870;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196870Service() {
        this(new Idea196870Config());
    }

    public Idea196870Service(Idea196870Config config) {
        this.config = config != null ? config : new Idea196870Config();
