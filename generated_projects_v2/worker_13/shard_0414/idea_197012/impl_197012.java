...
@Data
public class Idea197012Config {
    private String name = "idea_197012";
 ...
 */
@Slf4j
public class Idea197012Service {
    private static final int IDEA_ID = 197012;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197012Service() {
        this(new Idea197012Config());
    }

    public Idea197012Service(Idea197012Config config) {
        this.config = config != null ? config : new Idea197012Config();
