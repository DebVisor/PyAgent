...
@Data
public class Idea196816Config {
    private String name = "idea_196816";
 ...
 */
@Slf4j
public class Idea196816Service {
    private static final int IDEA_ID = 196816;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196816Service() {
        this(new Idea196816Config());
    }

    public Idea196816Service(Idea196816Config config) {
        this.config = config != null ? config : new Idea196816Config();
