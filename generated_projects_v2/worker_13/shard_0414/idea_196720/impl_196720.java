...
@Data
public class Idea196720Config {
    private String name = "idea_196720";
 ...
 */
@Slf4j
public class Idea196720Service {
    private static final int IDEA_ID = 196720;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196720Service() {
        this(new Idea196720Config());
    }

    public Idea196720Service(Idea196720Config config) {
        this.config = config != null ? config : new Idea196720Config();
