...
@Data
public class Idea196673Config {
    private String name = "idea_196673";
 ...
 */
@Slf4j
public class Idea196673Service {
    private static final int IDEA_ID = 196673;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196673Service() {
        this(new Idea196673Config());
    }

    public Idea196673Service(Idea196673Config config) {
        this.config = config != null ? config : new Idea196673Config();
