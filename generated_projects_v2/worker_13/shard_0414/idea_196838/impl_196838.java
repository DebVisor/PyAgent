...
@Data
public class Idea196838Config {
    private String name = "idea_196838";
 ...
 */
@Slf4j
public class Idea196838Service {
    private static final int IDEA_ID = 196838;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196838Service() {
        this(new Idea196838Config());
    }

    public Idea196838Service(Idea196838Config config) {
        this.config = config != null ? config : new Idea196838Config();
