...
@Data
public class Idea196749Config {
    private String name = "idea_196749";
 ...
 */
@Slf4j
public class Idea196749Service {
    private static final int IDEA_ID = 196749;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196749Service() {
        this(new Idea196749Config());
    }

    public Idea196749Service(Idea196749Config config) {
        this.config = config != null ? config : new Idea196749Config();
