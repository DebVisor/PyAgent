...
@Data
public class Idea196839Config {
    private String name = "idea_196839";
 ...
 */
@Slf4j
public class Idea196839Service {
    private static final int IDEA_ID = 196839;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196839Service() {
        this(new Idea196839Config());
    }

    public Idea196839Service(Idea196839Config config) {
        this.config = config != null ? config : new Idea196839Config();
