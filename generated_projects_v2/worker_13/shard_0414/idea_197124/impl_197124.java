...
@Data
public class Idea197124Config {
    private String name = "idea_197124";
 ...
 */
@Slf4j
public class Idea197124Service {
    private static final int IDEA_ID = 197124;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197124Service() {
        this(new Idea197124Config());
    }

    public Idea197124Service(Idea197124Config config) {
        this.config = config != null ? config : new Idea197124Config();
