...
@Data
public class Idea197102Config {
    private String name = "idea_197102";
 ...
 */
@Slf4j
public class Idea197102Service {
    private static final int IDEA_ID = 197102;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197102Service() {
        this(new Idea197102Config());
    }

    public Idea197102Service(Idea197102Config config) {
        this.config = config != null ? config : new Idea197102Config();
