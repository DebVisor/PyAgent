...
@Data
public class Idea197035Config {
    private String name = "idea_197035";
 ...
 */
@Slf4j
public class Idea197035Service {
    private static final int IDEA_ID = 197035;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197035Service() {
        this(new Idea197035Config());
    }

    public Idea197035Service(Idea197035Config config) {
        this.config = config != null ? config : new Idea197035Config();
