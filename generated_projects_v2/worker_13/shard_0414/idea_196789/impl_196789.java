...
@Data
public class Idea196789Config {
    private String name = "idea_196789";
 ...
 */
@Slf4j
public class Idea196789Service {
    private static final int IDEA_ID = 196789;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196789Service() {
        this(new Idea196789Config());
    }

    public Idea196789Service(Idea196789Config config) {
        this.config = config != null ? config : new Idea196789Config();
