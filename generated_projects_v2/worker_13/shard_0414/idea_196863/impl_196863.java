...
@Data
public class Idea196863Config {
    private String name = "idea_196863";
 ...
 */
@Slf4j
public class Idea196863Service {
    private static final int IDEA_ID = 196863;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196863Service() {
        this(new Idea196863Config());
    }

    public Idea196863Service(Idea196863Config config) {
        this.config = config != null ? config : new Idea196863Config();
