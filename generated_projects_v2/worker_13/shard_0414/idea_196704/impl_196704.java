...
@Data
public class Idea196704Config {
    private String name = "idea_196704";
 ...
 */
@Slf4j
public class Idea196704Service {
    private static final int IDEA_ID = 196704;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196704Service() {
        this(new Idea196704Config());
    }

    public Idea196704Service(Idea196704Config config) {
        this.config = config != null ? config : new Idea196704Config();
