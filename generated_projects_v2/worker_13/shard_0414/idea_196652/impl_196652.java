...
@Data
public class Idea196652Config {
    private String name = "idea_196652";
 ...
 */
@Slf4j
public class Idea196652Service {
    private static final int IDEA_ID = 196652;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196652Service() {
        this(new Idea196652Config());
    }

    public Idea196652Service(Idea196652Config config) {
        this.config = config != null ? config : new Idea196652Config();
