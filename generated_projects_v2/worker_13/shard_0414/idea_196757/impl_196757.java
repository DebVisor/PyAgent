...
@Data
public class Idea196757Config {
    private String name = "idea_196757";
 ...
 */
@Slf4j
public class Idea196757Service {
    private static final int IDEA_ID = 196757;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196757Service() {
        this(new Idea196757Config());
    }

    public Idea196757Service(Idea196757Config config) {
        this.config = config != null ? config : new Idea196757Config();
