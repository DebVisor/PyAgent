...
@Data
public class Idea196767Config {
    private String name = "idea_196767";
 ...
 */
@Slf4j
public class Idea196767Service {
    private static final int IDEA_ID = 196767;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196767Service() {
        this(new Idea196767Config());
    }

    public Idea196767Service(Idea196767Config config) {
        this.config = config != null ? config : new Idea196767Config();
