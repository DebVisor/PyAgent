...
@Data
public class Idea196895Config {
    private String name = "idea_196895";
 ...
 */
@Slf4j
public class Idea196895Service {
    private static final int IDEA_ID = 196895;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196895Service() {
        this(new Idea196895Config());
    }

    public Idea196895Service(Idea196895Config config) {
        this.config = config != null ? config : new Idea196895Config();
