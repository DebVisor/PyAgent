...
@Data
public class Idea196940Config {
    private String name = "idea_196940";
 ...
 */
@Slf4j
public class Idea196940Service {
    private static final int IDEA_ID = 196940;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196940Service() {
        this(new Idea196940Config());
    }

    public Idea196940Service(Idea196940Config config) {
        this.config = config != null ? config : new Idea196940Config();
