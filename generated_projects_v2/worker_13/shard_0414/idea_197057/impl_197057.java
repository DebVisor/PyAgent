...
@Data
public class Idea197057Config {
    private String name = "idea_197057";
 ...
 */
@Slf4j
public class Idea197057Service {
    private static final int IDEA_ID = 197057;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197057Service() {
        this(new Idea197057Config());
    }

    public Idea197057Service(Idea197057Config config) {
        this.config = config != null ? config : new Idea197057Config();
