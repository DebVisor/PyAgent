...
@Data
public class Idea196860Config {
    private String name = "idea_196860";
 ...
 */
@Slf4j
public class Idea196860Service {
    private static final int IDEA_ID = 196860;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196860Service() {
        this(new Idea196860Config());
    }

    public Idea196860Service(Idea196860Config config) {
        this.config = config != null ? config : new Idea196860Config();
