...
@Data
public class Idea196972Config {
    private String name = "idea_196972";
 ...
 */
@Slf4j
public class Idea196972Service {
    private static final int IDEA_ID = 196972;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196972Service() {
        this(new Idea196972Config());
    }

    public Idea196972Service(Idea196972Config config) {
        this.config = config != null ? config : new Idea196972Config();
