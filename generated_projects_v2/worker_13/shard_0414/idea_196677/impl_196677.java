...
@Data
public class Idea196677Config {
    private String name = "idea_196677";
 ...
 */
@Slf4j
public class Idea196677Service {
    private static final int IDEA_ID = 196677;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196677Service() {
        this(new Idea196677Config());
    }

    public Idea196677Service(Idea196677Config config) {
        this.config = config != null ? config : new Idea196677Config();
