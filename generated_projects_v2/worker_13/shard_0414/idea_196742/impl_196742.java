...
@Data
public class Idea196742Config {
    private String name = "idea_196742";
 ...
 */
@Slf4j
public class Idea196742Service {
    private static final int IDEA_ID = 196742;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196742Service() {
        this(new Idea196742Config());
    }

    public Idea196742Service(Idea196742Config config) {
        this.config = config != null ? config : new Idea196742Config();
