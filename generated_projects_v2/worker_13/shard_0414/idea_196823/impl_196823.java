...
@Data
public class Idea196823Config {
    private String name = "idea_196823";
 ...
 */
@Slf4j
public class Idea196823Service {
    private static final int IDEA_ID = 196823;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196823Service() {
        this(new Idea196823Config());
    }

    public Idea196823Service(Idea196823Config config) {
        this.config = config != null ? config : new Idea196823Config();
