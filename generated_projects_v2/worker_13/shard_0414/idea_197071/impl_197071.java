...
@Data
public class Idea197071Config {
    private String name = "idea_197071";
 ...
 */
@Slf4j
public class Idea197071Service {
    private static final int IDEA_ID = 197071;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197071Service() {
        this(new Idea197071Config());
    }

    public Idea197071Service(Idea197071Config config) {
        this.config = config != null ? config : new Idea197071Config();
