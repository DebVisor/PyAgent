...
@Data
public class Idea196833Config {
    private String name = "idea_196833";
 ...
 */
@Slf4j
public class Idea196833Service {
    private static final int IDEA_ID = 196833;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196833Service() {
        this(new Idea196833Config());
    }

    public Idea196833Service(Idea196833Config config) {
        this.config = config != null ? config : new Idea196833Config();
