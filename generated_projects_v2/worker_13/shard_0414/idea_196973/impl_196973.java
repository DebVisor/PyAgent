...
@Data
public class Idea196973Config {
    private String name = "idea_196973";
 ...
 */
@Slf4j
public class Idea196973Service {
    private static final int IDEA_ID = 196973;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196973Service() {
        this(new Idea196973Config());
    }

    public Idea196973Service(Idea196973Config config) {
        this.config = config != null ? config : new Idea196973Config();
