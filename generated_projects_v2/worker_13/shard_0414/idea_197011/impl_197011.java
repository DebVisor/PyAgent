...
@Data
public class Idea197011Config {
    private String name = "idea_197011";
 ...
 */
@Slf4j
public class Idea197011Service {
    private static final int IDEA_ID = 197011;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197011Service() {
        this(new Idea197011Config());
    }

    public Idea197011Service(Idea197011Config config) {
        this.config = config != null ? config : new Idea197011Config();
