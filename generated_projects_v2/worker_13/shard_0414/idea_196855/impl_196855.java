...
@Data
public class Idea196855Config {
    private String name = "idea_196855";
 ...
 */
@Slf4j
public class Idea196855Service {
    private static final int IDEA_ID = 196855;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196855Service() {
        this(new Idea196855Config());
    }

    public Idea196855Service(Idea196855Config config) {
        this.config = config != null ? config : new Idea196855Config();
