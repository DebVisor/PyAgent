...
@Data
public class Idea196830Config {
    private String name = "idea_196830";
 ...
 */
@Slf4j
public class Idea196830Service {
    private static final int IDEA_ID = 196830;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196830Service() {
        this(new Idea196830Config());
    }

    public Idea196830Service(Idea196830Config config) {
        this.config = config != null ? config : new Idea196830Config();
