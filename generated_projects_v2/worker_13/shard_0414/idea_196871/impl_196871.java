...
@Data
public class Idea196871Config {
    private String name = "idea_196871";
 ...
 */
@Slf4j
public class Idea196871Service {
    private static final int IDEA_ID = 196871;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196871Service() {
        this(new Idea196871Config());
    }

    public Idea196871Service(Idea196871Config config) {
        this.config = config != null ? config : new Idea196871Config();
