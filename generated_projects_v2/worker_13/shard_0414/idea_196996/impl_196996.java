...
@Data
public class Idea196996Config {
    private String name = "idea_196996";
 ...
 */
@Slf4j
public class Idea196996Service {
    private static final int IDEA_ID = 196996;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196996Service() {
        this(new Idea196996Config());
    }

    public Idea196996Service(Idea196996Config config) {
        this.config = config != null ? config : new Idea196996Config();
