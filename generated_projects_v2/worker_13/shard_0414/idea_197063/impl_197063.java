...
@Data
public class Idea197063Config {
    private String name = "idea_197063";
 ...
 */
@Slf4j
public class Idea197063Service {
    private static final int IDEA_ID = 197063;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197063Service() {
        this(new Idea197063Config());
    }

    public Idea197063Service(Idea197063Config config) {
        this.config = config != null ? config : new Idea197063Config();
