...
@Data
public class Idea196651Config {
    private String name = "idea_196651";
 ...
 */
@Slf4j
public class Idea196651Service {
    private static final int IDEA_ID = 196651;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196651Service() {
        this(new Idea196651Config());
    }

    public Idea196651Service(Idea196651Config config) {
        this.config = config != null ? config : new Idea196651Config();
