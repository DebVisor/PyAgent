...
@Data
public class Idea196904Config {
    private String name = "idea_196904";
 ...
 */
@Slf4j
public class Idea196904Service {
    private static final int IDEA_ID = 196904;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196904Service() {
        this(new Idea196904Config());
    }

    public Idea196904Service(Idea196904Config config) {
        this.config = config != null ? config : new Idea196904Config();
