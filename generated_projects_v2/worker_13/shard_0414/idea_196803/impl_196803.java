...
@Data
public class Idea196803Config {
    private String name = "idea_196803";
 ...
 */
@Slf4j
public class Idea196803Service {
    private static final int IDEA_ID = 196803;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196803Service() {
        this(new Idea196803Config());
    }

    public Idea196803Service(Idea196803Config config) {
        this.config = config != null ? config : new Idea196803Config();
