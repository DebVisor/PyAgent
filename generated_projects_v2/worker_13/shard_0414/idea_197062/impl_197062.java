...
@Data
public class Idea197062Config {
    private String name = "idea_197062";
 ...
 */
@Slf4j
public class Idea197062Service {
    private static final int IDEA_ID = 197062;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197062Service() {
        this(new Idea197062Config());
    }

    public Idea197062Service(Idea197062Config config) {
        this.config = config != null ? config : new Idea197062Config();
