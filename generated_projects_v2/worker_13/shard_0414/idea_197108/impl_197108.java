...
@Data
public class Idea197108Config {
    private String name = "idea_197108";
 ...
 */
@Slf4j
public class Idea197108Service {
    private static final int IDEA_ID = 197108;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197108Service() {
        this(new Idea197108Config());
    }

    public Idea197108Service(Idea197108Config config) {
        this.config = config != null ? config : new Idea197108Config();
