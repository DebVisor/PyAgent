...
@Data
public class Idea197120Config {
    private String name = "idea_197120";
 ...
 */
@Slf4j
public class Idea197120Service {
    private static final int IDEA_ID = 197120;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197120Service() {
        this(new Idea197120Config());
    }

    public Idea197120Service(Idea197120Config config) {
        this.config = config != null ? config : new Idea197120Config();
