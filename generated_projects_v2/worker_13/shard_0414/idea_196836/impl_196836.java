...
@Data
public class Idea196836Config {
    private String name = "idea_196836";
 ...
 */
@Slf4j
public class Idea196836Service {
    private static final int IDEA_ID = 196836;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196836Service() {
        this(new Idea196836Config());
    }

    public Idea196836Service(Idea196836Config config) {
        this.config = config != null ? config : new Idea196836Config();
