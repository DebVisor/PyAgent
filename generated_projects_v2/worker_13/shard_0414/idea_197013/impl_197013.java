...
@Data
public class Idea197013Config {
    private String name = "idea_197013";
 ...
 */
@Slf4j
public class Idea197013Service {
    private static final int IDEA_ID = 197013;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197013Service() {
        this(new Idea197013Config());
    }

    public Idea197013Service(Idea197013Config config) {
        this.config = config != null ? config : new Idea197013Config();
