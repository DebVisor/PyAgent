...
@Data
public class Idea196832Config {
    private String name = "idea_196832";
 ...
 */
@Slf4j
public class Idea196832Service {
    private static final int IDEA_ID = 196832;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196832Service() {
        this(new Idea196832Config());
    }

    public Idea196832Service(Idea196832Config config) {
        this.config = config != null ? config : new Idea196832Config();
