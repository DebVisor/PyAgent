...
@Data
public class Idea196780Config {
    private String name = "idea_196780";
 ...
 */
@Slf4j
public class Idea196780Service {
    private static final int IDEA_ID = 196780;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196780Service() {
        this(new Idea196780Config());
    }

    public Idea196780Service(Idea196780Config config) {
        this.config = config != null ? config : new Idea196780Config();
