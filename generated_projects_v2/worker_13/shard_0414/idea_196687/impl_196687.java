...
@Data
public class Idea196687Config {
    private String name = "idea_196687";
 ...
 */
@Slf4j
public class Idea196687Service {
    private static final int IDEA_ID = 196687;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196687Service() {
        this(new Idea196687Config());
    }

    public Idea196687Service(Idea196687Config config) {
        this.config = config != null ? config : new Idea196687Config();
