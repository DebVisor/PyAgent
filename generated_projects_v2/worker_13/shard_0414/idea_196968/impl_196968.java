...
@Data
public class Idea196968Config {
    private String name = "idea_196968";
 ...
 */
@Slf4j
public class Idea196968Service {
    private static final int IDEA_ID = 196968;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196968Service() {
        this(new Idea196968Config());
    }

    public Idea196968Service(Idea196968Config config) {
        this.config = config != null ? config : new Idea196968Config();
