...
@Data
public class Idea196834Config {
    private String name = "idea_196834";
 ...
 */
@Slf4j
public class Idea196834Service {
    private static final int IDEA_ID = 196834;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196834Service() {
        this(new Idea196834Config());
    }

    public Idea196834Service(Idea196834Config config) {
        this.config = config != null ? config : new Idea196834Config();
