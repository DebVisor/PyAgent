...
@Data
public class Idea196806Config {
    private String name = "idea_196806";
 ...
 */
@Slf4j
public class Idea196806Service {
    private static final int IDEA_ID = 196806;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196806Service() {
        this(new Idea196806Config());
    }

    public Idea196806Service(Idea196806Config config) {
        this.config = config != null ? config : new Idea196806Config();
