...
@Data
public class Idea197118Config {
    private String name = "idea_197118";
 ...
 */
@Slf4j
public class Idea197118Service {
    private static final int IDEA_ID = 197118;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197118Service() {
        this(new Idea197118Config());
    }

    public Idea197118Service(Idea197118Config config) {
        this.config = config != null ? config : new Idea197118Config();
