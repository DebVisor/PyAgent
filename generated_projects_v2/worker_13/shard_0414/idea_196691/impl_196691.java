...
@Data
public class Idea196691Config {
    private String name = "idea_196691";
 ...
 */
@Slf4j
public class Idea196691Service {
    private static final int IDEA_ID = 196691;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196691Service() {
        this(new Idea196691Config());
    }

    public Idea196691Service(Idea196691Config config) {
        this.config = config != null ? config : new Idea196691Config();
