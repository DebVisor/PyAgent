...
@Data
public class Idea196892Config {
    private String name = "idea_196892";
 ...
 */
@Slf4j
public class Idea196892Service {
    private static final int IDEA_ID = 196892;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196892Service() {
        this(new Idea196892Config());
    }

    public Idea196892Service(Idea196892Config config) {
        this.config = config != null ? config : new Idea196892Config();
