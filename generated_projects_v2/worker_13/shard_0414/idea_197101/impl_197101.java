...
@Data
public class Idea197101Config {
    private String name = "idea_197101";
 ...
 */
@Slf4j
public class Idea197101Service {
    private static final int IDEA_ID = 197101;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197101Service() {
        this(new Idea197101Config());
    }

    public Idea197101Service(Idea197101Config config) {
        this.config = config != null ? config : new Idea197101Config();
