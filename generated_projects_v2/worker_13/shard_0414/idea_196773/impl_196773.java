...
@Data
public class Idea196773Config {
    private String name = "idea_196773";
 ...
 */
@Slf4j
public class Idea196773Service {
    private static final int IDEA_ID = 196773;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196773Service() {
        this(new Idea196773Config());
    }

    public Idea196773Service(Idea196773Config config) {
        this.config = config != null ? config : new Idea196773Config();
