...
@Data
public class Idea196737Config {
    private String name = "idea_196737";
 ...
 */
@Slf4j
public class Idea196737Service {
    private static final int IDEA_ID = 196737;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196737Service() {
        this(new Idea196737Config());
    }

    public Idea196737Service(Idea196737Config config) {
        this.config = config != null ? config : new Idea196737Config();
