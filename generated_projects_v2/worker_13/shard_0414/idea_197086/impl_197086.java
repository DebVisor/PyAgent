...
@Data
public class Idea197086Config {
    private String name = "idea_197086";
 ...
 */
@Slf4j
public class Idea197086Service {
    private static final int IDEA_ID = 197086;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197086Service() {
        this(new Idea197086Config());
    }

    public Idea197086Service(Idea197086Config config) {
        this.config = config != null ? config : new Idea197086Config();
