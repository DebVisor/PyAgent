...
@Data
public class Idea197111Config {
    private String name = "idea_197111";
 ...
 */
@Slf4j
public class Idea197111Service {
    private static final int IDEA_ID = 197111;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197111Service() {
        this(new Idea197111Config());
    }

    public Idea197111Service(Idea197111Config config) {
        this.config = config != null ? config : new Idea197111Config();
