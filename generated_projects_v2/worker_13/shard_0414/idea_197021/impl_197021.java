...
@Data
public class Idea197021Config {
    private String name = "idea_197021";
 ...
 */
@Slf4j
public class Idea197021Service {
    private static final int IDEA_ID = 197021;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197021Service() {
        this(new Idea197021Config());
    }

    public Idea197021Service(Idea197021Config config) {
        this.config = config != null ? config : new Idea197021Config();
