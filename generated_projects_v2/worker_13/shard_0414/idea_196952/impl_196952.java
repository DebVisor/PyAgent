...
@Data
public class Idea196952Config {
    private String name = "idea_196952";
 ...
 */
@Slf4j
public class Idea196952Service {
    private static final int IDEA_ID = 196952;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196952Service() {
        this(new Idea196952Config());
    }

    public Idea196952Service(Idea196952Config config) {
        this.config = config != null ? config : new Idea196952Config();
