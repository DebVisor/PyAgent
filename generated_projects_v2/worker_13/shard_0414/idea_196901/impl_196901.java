...
@Data
public class Idea196901Config {
    private String name = "idea_196901";
 ...
 */
@Slf4j
public class Idea196901Service {
    private static final int IDEA_ID = 196901;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196901Service() {
        this(new Idea196901Config());
    }

    public Idea196901Service(Idea196901Config config) {
        this.config = config != null ? config : new Idea196901Config();
