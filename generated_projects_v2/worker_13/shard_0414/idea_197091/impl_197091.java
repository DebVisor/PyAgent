...
@Data
public class Idea197091Config {
    private String name = "idea_197091";
 ...
 */
@Slf4j
public class Idea197091Service {
    private static final int IDEA_ID = 197091;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197091Service() {
        this(new Idea197091Config());
    }

    public Idea197091Service(Idea197091Config config) {
        this.config = config != null ? config : new Idea197091Config();
