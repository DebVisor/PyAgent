...
@Data
public class Idea197050Config {
    private String name = "idea_197050";
 ...
 */
@Slf4j
public class Idea197050Service {
    private static final int IDEA_ID = 197050;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197050Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197050Service() {
        this(new Idea197050Config());
    }

    public Idea197050Service(Idea197050Config config) {
        this.config = config != null ? config : new Idea197050Config();
