...
@Data
public class Idea196941Config {
    private String name = "idea_196941";
 ...
 */
@Slf4j
public class Idea196941Service {
    private static final int IDEA_ID = 196941;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196941Service() {
        this(new Idea196941Config());
    }

    public Idea196941Service(Idea196941Config config) {
        this.config = config != null ? config : new Idea196941Config();
