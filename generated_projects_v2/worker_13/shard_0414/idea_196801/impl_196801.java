...
@Data
public class Idea196801Config {
    private String name = "idea_196801";
 ...
 */
@Slf4j
public class Idea196801Service {
    private static final int IDEA_ID = 196801;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196801Service() {
        this(new Idea196801Config());
    }

    public Idea196801Service(Idea196801Config config) {
        this.config = config != null ? config : new Idea196801Config();
