...
@Data
public class Idea196821Config {
    private String name = "idea_196821";
 ...
 */
@Slf4j
public class Idea196821Service {
    private static final int IDEA_ID = 196821;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196821Service() {
        this(new Idea196821Config());
    }

    public Idea196821Service(Idea196821Config config) {
        this.config = config != null ? config : new Idea196821Config();
