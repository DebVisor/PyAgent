...
@Data
public class Idea196946Config {
    private String name = "idea_196946";
 ...
 */
@Slf4j
public class Idea196946Service {
    private static final int IDEA_ID = 196946;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196946Service() {
        this(new Idea196946Config());
    }

    public Idea196946Service(Idea196946Config config) {
        this.config = config != null ? config : new Idea196946Config();
