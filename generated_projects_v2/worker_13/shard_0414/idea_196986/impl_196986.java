...
@Data
public class Idea196986Config {
    private String name = "idea_196986";
 ...
 */
@Slf4j
public class Idea196986Service {
    private static final int IDEA_ID = 196986;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196986Service() {
        this(new Idea196986Config());
    }

    public Idea196986Service(Idea196986Config config) {
        this.config = config != null ? config : new Idea196986Config();
