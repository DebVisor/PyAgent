...
@Data
public class Idea197051Config {
    private String name = "idea_197051";
 ...
 */
@Slf4j
public class Idea197051Service {
    private static final int IDEA_ID = 197051;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197051Service() {
        this(new Idea197051Config());
    }

    public Idea197051Service(Idea197051Config config) {
        this.config = config != null ? config : new Idea197051Config();
