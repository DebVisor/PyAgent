...
@Data
public class Idea196681Config {
    private String name = "idea_196681";
 ...
 */
@Slf4j
public class Idea196681Service {
    private static final int IDEA_ID = 196681;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196681Service() {
        this(new Idea196681Config());
    }

    public Idea196681Service(Idea196681Config config) {
        this.config = config != null ? config : new Idea196681Config();
