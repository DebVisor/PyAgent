...
@Data
public class Idea196765Config {
    private String name = "idea_196765";
 ...
 */
@Slf4j
public class Idea196765Service {
    private static final int IDEA_ID = 196765;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196765Service() {
        this(new Idea196765Config());
    }

    public Idea196765Service(Idea196765Config config) {
        this.config = config != null ? config : new Idea196765Config();
