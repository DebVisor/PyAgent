...
@Data
public class Idea196783Config {
    private String name = "idea_196783";
 ...
 */
@Slf4j
public class Idea196783Service {
    private static final int IDEA_ID = 196783;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196783Service() {
        this(new Idea196783Config());
    }

    public Idea196783Service(Idea196783Config config) {
        this.config = config != null ? config : new Idea196783Config();
