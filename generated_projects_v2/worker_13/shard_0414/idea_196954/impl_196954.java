...
@Data
public class Idea196954Config {
    private String name = "idea_196954";
 ...
 */
@Slf4j
public class Idea196954Service {
    private static final int IDEA_ID = 196954;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196954Service() {
        this(new Idea196954Config());
    }

    public Idea196954Service(Idea196954Config config) {
        this.config = config != null ? config : new Idea196954Config();
