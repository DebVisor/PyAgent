...
@Data
public class Idea196785Config {
    private String name = "idea_196785";
 ...
 */
@Slf4j
public class Idea196785Service {
    private static final int IDEA_ID = 196785;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196785Service() {
        this(new Idea196785Config());
    }

    public Idea196785Service(Idea196785Config config) {
        this.config = config != null ? config : new Idea196785Config();
