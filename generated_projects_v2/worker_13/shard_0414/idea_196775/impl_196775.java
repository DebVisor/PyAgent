...
@Data
public class Idea196775Config {
    private String name = "idea_196775";
 ...
 */
@Slf4j
public class Idea196775Service {
    private static final int IDEA_ID = 196775;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196775Service() {
        this(new Idea196775Config());
    }

    public Idea196775Service(Idea196775Config config) {
        this.config = config != null ? config : new Idea196775Config();
