...
@Data
public class Idea196828Config {
    private String name = "idea_196828";
 ...
 */
@Slf4j
public class Idea196828Service {
    private static final int IDEA_ID = 196828;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196828Service() {
        this(new Idea196828Config());
    }

    public Idea196828Service(Idea196828Config config) {
        this.config = config != null ? config : new Idea196828Config();
