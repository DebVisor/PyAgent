...
@Data
public class Idea197076Config {
    private String name = "idea_197076";
 ...
 */
@Slf4j
public class Idea197076Service {
    private static final int IDEA_ID = 197076;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197076Service() {
        this(new Idea197076Config());
    }

    public Idea197076Service(Idea197076Config config) {
        this.config = config != null ? config : new Idea197076Config();
