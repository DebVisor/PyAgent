...
@Data
public class Idea196992Config {
    private String name = "idea_196992";
 ...
 */
@Slf4j
public class Idea196992Service {
    private static final int IDEA_ID = 196992;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196992Service() {
        this(new Idea196992Config());
    }

    public Idea196992Service(Idea196992Config config) {
        this.config = config != null ? config : new Idea196992Config();
