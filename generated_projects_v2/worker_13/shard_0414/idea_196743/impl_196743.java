...
@Data
public class Idea196743Config {
    private String name = "idea_196743";
 ...
 */
@Slf4j
public class Idea196743Service {
    private static final int IDEA_ID = 196743;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196743Service() {
        this(new Idea196743Config());
    }

    public Idea196743Service(Idea196743Config config) {
        this.config = config != null ? config : new Idea196743Config();
