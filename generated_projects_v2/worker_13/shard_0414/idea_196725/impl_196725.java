...
@Data
public class Idea196725Config {
    private String name = "idea_196725";
 ...
 */
@Slf4j
public class Idea196725Service {
    private static final int IDEA_ID = 196725;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196725Service() {
        this(new Idea196725Config());
    }

    public Idea196725Service(Idea196725Config config) {
        this.config = config != null ? config : new Idea196725Config();
