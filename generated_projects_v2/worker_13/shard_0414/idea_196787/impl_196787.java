...
@Data
public class Idea196787Config {
    private String name = "idea_196787";
 ...
 */
@Slf4j
public class Idea196787Service {
    private static final int IDEA_ID = 196787;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196787Service() {
        this(new Idea196787Config());
    }

    public Idea196787Service(Idea196787Config config) {
        this.config = config != null ? config : new Idea196787Config();
