...
@Data
public class Idea196697Config {
    private String name = "idea_196697";
 ...
 */
@Slf4j
public class Idea196697Service {
    private static final int IDEA_ID = 196697;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196697Service() {
        this(new Idea196697Config());
    }

    public Idea196697Service(Idea196697Config config) {
        this.config = config != null ? config : new Idea196697Config();
