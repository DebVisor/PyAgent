...
@Data
public class Idea196907Config {
    private String name = "idea_196907";
 ...
 */
@Slf4j
public class Idea196907Service {
    private static final int IDEA_ID = 196907;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196907Service() {
        this(new Idea196907Config());
    }

    public Idea196907Service(Idea196907Config config) {
        this.config = config != null ? config : new Idea196907Config();
