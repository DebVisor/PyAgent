...
@Data
public class Idea197052Config {
    private String name = "idea_197052";
 ...
 */
@Slf4j
public class Idea197052Service {
    private static final int IDEA_ID = 197052;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197052Service() {
        this(new Idea197052Config());
    }

    public Idea197052Service(Idea197052Config config) {
        this.config = config != null ? config : new Idea197052Config();
