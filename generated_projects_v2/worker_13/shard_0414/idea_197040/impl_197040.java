...
@Data
public class Idea197040Config {
    private String name = "idea_197040";
 ...
 */
@Slf4j
public class Idea197040Service {
    private static final int IDEA_ID = 197040;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197040Service() {
        this(new Idea197040Config());
    }

    public Idea197040Service(Idea197040Config config) {
        this.config = config != null ? config : new Idea197040Config();
