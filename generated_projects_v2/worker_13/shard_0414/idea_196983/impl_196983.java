...
@Data
public class Idea196983Config {
    private String name = "idea_196983";
 ...
 */
@Slf4j
public class Idea196983Service {
    private static final int IDEA_ID = 196983;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196983Service() {
        this(new Idea196983Config());
    }

    public Idea196983Service(Idea196983Config config) {
        this.config = config != null ? config : new Idea196983Config();
