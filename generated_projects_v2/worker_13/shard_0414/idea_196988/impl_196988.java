...
@Data
public class Idea196988Config {
    private String name = "idea_196988";
 ...
 */
@Slf4j
public class Idea196988Service {
    private static final int IDEA_ID = 196988;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196988Service() {
        this(new Idea196988Config());
    }

    public Idea196988Service(Idea196988Config config) {
        this.config = config != null ? config : new Idea196988Config();
