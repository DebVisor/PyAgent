...
@Data
public class Idea197122Config {
    private String name = "idea_197122";
 ...
 */
@Slf4j
public class Idea197122Service {
    private static final int IDEA_ID = 197122;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197122Service() {
        this(new Idea197122Config());
    }

    public Idea197122Service(Idea197122Config config) {
        this.config = config != null ? config : new Idea197122Config();
