...
@Data
public class Idea196761Config {
    private String name = "idea_196761";
 ...
 */
@Slf4j
public class Idea196761Service {
    private static final int IDEA_ID = 196761;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196761Service() {
        this(new Idea196761Config());
    }

    public Idea196761Service(Idea196761Config config) {
        this.config = config != null ? config : new Idea196761Config();
