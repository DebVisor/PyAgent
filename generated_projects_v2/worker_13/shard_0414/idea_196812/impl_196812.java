...
@Data
public class Idea196812Config {
    private String name = "idea_196812";
 ...
 */
@Slf4j
public class Idea196812Service {
    private static final int IDEA_ID = 196812;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196812Service() {
        this(new Idea196812Config());
    }

    public Idea196812Service(Idea196812Config config) {
        this.config = config != null ? config : new Idea196812Config();
