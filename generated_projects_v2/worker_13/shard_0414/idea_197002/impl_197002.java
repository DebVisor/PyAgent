...
@Data
public class Idea197002Config {
    private String name = "idea_197002";
 ...
 */
@Slf4j
public class Idea197002Service {
    private static final int IDEA_ID = 197002;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197002Service() {
        this(new Idea197002Config());
    }

    public Idea197002Service(Idea197002Config config) {
        this.config = config != null ? config : new Idea197002Config();
