...
@Data
public class Idea196963Config {
    private String name = "idea_196963";
 ...
 */
@Slf4j
public class Idea196963Service {
    private static final int IDEA_ID = 196963;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196963Service() {
        this(new Idea196963Config());
    }

    public Idea196963Service(Idea196963Config config) {
        this.config = config != null ? config : new Idea196963Config();
