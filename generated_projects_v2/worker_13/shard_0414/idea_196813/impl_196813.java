...
@Data
public class Idea196813Config {
    private String name = "idea_196813";
 ...
 */
@Slf4j
public class Idea196813Service {
    private static final int IDEA_ID = 196813;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196813Service() {
        this(new Idea196813Config());
    }

    public Idea196813Service(Idea196813Config config) {
        this.config = config != null ? config : new Idea196813Config();
