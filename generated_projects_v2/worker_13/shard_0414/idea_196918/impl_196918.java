...
@Data
public class Idea196918Config {
    private String name = "idea_196918";
 ...
 */
@Slf4j
public class Idea196918Service {
    private static final int IDEA_ID = 196918;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196918Service() {
        this(new Idea196918Config());
    }

    public Idea196918Service(Idea196918Config config) {
        this.config = config != null ? config : new Idea196918Config();
