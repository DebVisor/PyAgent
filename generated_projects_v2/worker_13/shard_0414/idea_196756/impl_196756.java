...
@Data
public class Idea196756Config {
    private String name = "idea_196756";
 ...
 */
@Slf4j
public class Idea196756Service {
    private static final int IDEA_ID = 196756;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196756Service() {
        this(new Idea196756Config());
    }

    public Idea196756Service(Idea196756Config config) {
        this.config = config != null ? config : new Idea196756Config();
