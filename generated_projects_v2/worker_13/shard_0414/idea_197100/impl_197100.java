...
@Data
public class Idea197100Config {
    private String name = "idea_197100";
 ...
 */
@Slf4j
public class Idea197100Service {
    private static final int IDEA_ID = 197100;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197100Service() {
        this(new Idea197100Config());
    }

    public Idea197100Service(Idea197100Config config) {
        this.config = config != null ? config : new Idea197100Config();
