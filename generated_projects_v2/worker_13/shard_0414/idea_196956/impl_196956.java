...
@Data
public class Idea196956Config {
    private String name = "idea_196956";
 ...
 */
@Slf4j
public class Idea196956Service {
    private static final int IDEA_ID = 196956;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196956Service() {
        this(new Idea196956Config());
    }

    public Idea196956Service(Idea196956Config config) {
        this.config = config != null ? config : new Idea196956Config();
