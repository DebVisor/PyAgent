...
@Data
public class Idea196865Config {
    private String name = "idea_196865";
 ...
 */
@Slf4j
public class Idea196865Service {
    private static final int IDEA_ID = 196865;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196865Service() {
        this(new Idea196865Config());
    }

    public Idea196865Service(Idea196865Config config) {
        this.config = config != null ? config : new Idea196865Config();
