...
@Data
public class Idea196670Config {
    private String name = "idea_196670";
 ...
 */
@Slf4j
public class Idea196670Service {
    private static final int IDEA_ID = 196670;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196670Service() {
        this(new Idea196670Config());
    }

    public Idea196670Service(Idea196670Config config) {
        this.config = config != null ? config : new Idea196670Config();
