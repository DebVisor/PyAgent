...
@Data
public class Idea196927Config {
    private String name = "idea_196927";
 ...
 */
@Slf4j
public class Idea196927Service {
    private static final int IDEA_ID = 196927;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196927Service() {
        this(new Idea196927Config());
    }

    public Idea196927Service(Idea196927Config config) {
        this.config = config != null ? config : new Idea196927Config();
