...
@Data
public class Idea196898Config {
    private String name = "idea_196898";
 ...
 */
@Slf4j
public class Idea196898Service {
    private static final int IDEA_ID = 196898;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196898Service() {
        this(new Idea196898Config());
    }

    public Idea196898Service(Idea196898Config config) {
        this.config = config != null ? config : new Idea196898Config();
