...
@Data
public class Idea196684Config {
    private String name = "idea_196684";
 ...
 */
@Slf4j
public class Idea196684Service {
    private static final int IDEA_ID = 196684;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196684Service() {
        this(new Idea196684Config());
    }

    public Idea196684Service(Idea196684Config config) {
        this.config = config != null ? config : new Idea196684Config();
