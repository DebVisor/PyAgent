...
@Data
public class Idea196971Config {
    private String name = "idea_196971";
 ...
 */
@Slf4j
public class Idea196971Service {
    private static final int IDEA_ID = 196971;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196971Service() {
        this(new Idea196971Config());
    }

    public Idea196971Service(Idea196971Config config) {
        this.config = config != null ? config : new Idea196971Config();
