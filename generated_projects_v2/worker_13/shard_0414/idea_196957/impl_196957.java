...
@Data
public class Idea196957Config {
    private String name = "idea_196957";
 ...
 */
@Slf4j
public class Idea196957Service {
    private static final int IDEA_ID = 196957;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196957Service() {
        this(new Idea196957Config());
    }

    public Idea196957Service(Idea196957Config config) {
        this.config = config != null ? config : new Idea196957Config();
