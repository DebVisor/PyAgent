...
@Data
public class Idea196658Config {
    private String name = "idea_196658";
 ...
 */
@Slf4j
public class Idea196658Service {
    private static final int IDEA_ID = 196658;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196658Service() {
        this(new Idea196658Config());
    }

    public Idea196658Service(Idea196658Config config) {
        this.config = config != null ? config : new Idea196658Config();
