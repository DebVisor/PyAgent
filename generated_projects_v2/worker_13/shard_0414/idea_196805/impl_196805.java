...
@Data
public class Idea196805Config {
    private String name = "idea_196805";
 ...
 */
@Slf4j
public class Idea196805Service {
    private static final int IDEA_ID = 196805;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196805Service() {
        this(new Idea196805Config());
    }

    public Idea196805Service(Idea196805Config config) {
        this.config = config != null ? config : new Idea196805Config();
