...
@Data
public class Idea196935Config {
    private String name = "idea_196935";
 ...
 */
@Slf4j
public class Idea196935Service {
    private static final int IDEA_ID = 196935;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196935Service() {
        this(new Idea196935Config());
    }

    public Idea196935Service(Idea196935Config config) {
        this.config = config != null ? config : new Idea196935Config();
