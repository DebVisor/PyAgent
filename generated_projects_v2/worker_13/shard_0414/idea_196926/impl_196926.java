...
@Data
public class Idea196926Config {
    private String name = "idea_196926";
 ...
 */
@Slf4j
public class Idea196926Service {
    private static final int IDEA_ID = 196926;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196926Service() {
        this(new Idea196926Config());
    }

    public Idea196926Service(Idea196926Config config) {
        this.config = config != null ? config : new Idea196926Config();
