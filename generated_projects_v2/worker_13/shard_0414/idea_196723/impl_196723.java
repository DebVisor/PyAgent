...
@Data
public class Idea196723Config {
    private String name = "idea_196723";
 ...
 */
@Slf4j
public class Idea196723Service {
    private static final int IDEA_ID = 196723;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196723Service() {
        this(new Idea196723Config());
    }

    public Idea196723Service(Idea196723Config config) {
        this.config = config != null ? config : new Idea196723Config();
