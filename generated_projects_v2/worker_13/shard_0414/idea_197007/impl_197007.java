...
@Data
public class Idea197007Config {
    private String name = "idea_197007";
 ...
 */
@Slf4j
public class Idea197007Service {
    private static final int IDEA_ID = 197007;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197007Service() {
        this(new Idea197007Config());
    }

    public Idea197007Service(Idea197007Config config) {
        this.config = config != null ? config : new Idea197007Config();
