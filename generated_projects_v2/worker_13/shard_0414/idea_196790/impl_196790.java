...
@Data
public class Idea196790Config {
    private String name = "idea_196790";
 ...
 */
@Slf4j
public class Idea196790Service {
    private static final int IDEA_ID = 196790;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196790Service() {
        this(new Idea196790Config());
    }

    public Idea196790Service(Idea196790Config config) {
        this.config = config != null ? config : new Idea196790Config();
