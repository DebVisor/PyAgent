...
@Data
public class Idea197089Config {
    private String name = "idea_197089";
 ...
 */
@Slf4j
public class Idea197089Service {
    private static final int IDEA_ID = 197089;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197089Service() {
        this(new Idea197089Config());
    }

    public Idea197089Service(Idea197089Config config) {
        this.config = config != null ? config : new Idea197089Config();
