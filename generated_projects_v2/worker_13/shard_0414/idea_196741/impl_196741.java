...
@Data
public class Idea196741Config {
    private String name = "idea_196741";
 ...
 */
@Slf4j
public class Idea196741Service {
    private static final int IDEA_ID = 196741;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196741Service() {
        this(new Idea196741Config());
    }

    public Idea196741Service(Idea196741Config config) {
        this.config = config != null ? config : new Idea196741Config();
