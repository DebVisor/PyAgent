...
@Data
public class Idea196984Config {
    private String name = "idea_196984";
 ...
 */
@Slf4j
public class Idea196984Service {
    private static final int IDEA_ID = 196984;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196984Service() {
        this(new Idea196984Config());
    }

    public Idea196984Service(Idea196984Config config) {
        this.config = config != null ? config : new Idea196984Config();
