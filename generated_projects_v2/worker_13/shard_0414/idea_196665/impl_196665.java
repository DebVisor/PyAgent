...
@Data
public class Idea196665Config {
    private String name = "idea_196665";
 ...
 */
@Slf4j
public class Idea196665Service {
    private static final int IDEA_ID = 196665;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196665Service() {
        this(new Idea196665Config());
    }

    public Idea196665Service(Idea196665Config config) {
        this.config = config != null ? config : new Idea196665Config();
