...
@Data
public class Idea196690Config {
    private String name = "idea_196690";
 ...
 */
@Slf4j
public class Idea196690Service {
    private static final int IDEA_ID = 196690;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196690Service() {
        this(new Idea196690Config());
    }

    public Idea196690Service(Idea196690Config config) {
        this.config = config != null ? config : new Idea196690Config();
