...
@Data
public class Idea197026Config {
    private String name = "idea_197026";
 ...
 */
@Slf4j
public class Idea197026Service {
    private static final int IDEA_ID = 197026;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197026Service() {
        this(new Idea197026Config());
    }

    public Idea197026Service(Idea197026Config config) {
        this.config = config != null ? config : new Idea197026Config();
