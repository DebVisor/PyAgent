...
@Data
public class Idea196893Config {
    private String name = "idea_196893";
 ...
 */
@Slf4j
public class Idea196893Service {
    private static final int IDEA_ID = 196893;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196893Service() {
        this(new Idea196893Config());
    }

    public Idea196893Service(Idea196893Config config) {
        this.config = config != null ? config : new Idea196893Config();
