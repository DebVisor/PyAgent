...
@Data
public class Idea196772Config {
    private String name = "idea_196772";
 ...
 */
@Slf4j
public class Idea196772Service {
    private static final int IDEA_ID = 196772;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196772Service() {
        this(new Idea196772Config());
    }

    public Idea196772Service(Idea196772Config config) {
        this.config = config != null ? config : new Idea196772Config();
