...
@Data
public class Idea197060Config {
    private String name = "idea_197060";
 ...
 */
@Slf4j
public class Idea197060Service {
    private static final int IDEA_ID = 197060;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197060Service() {
        this(new Idea197060Config());
    }

    public Idea197060Service(Idea197060Config config) {
        this.config = config != null ? config : new Idea197060Config();
