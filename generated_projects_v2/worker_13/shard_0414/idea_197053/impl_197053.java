...
@Data
public class Idea197053Config {
    private String name = "idea_197053";
 ...
 */
@Slf4j
public class Idea197053Service {
    private static final int IDEA_ID = 197053;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197053Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197053Service() {
        this(new Idea197053Config());
    }

    public Idea197053Service(Idea197053Config config) {
        this.config = config != null ? config : new Idea197053Config();
