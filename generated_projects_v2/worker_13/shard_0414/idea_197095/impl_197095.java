...
@Data
public class Idea197095Config {
    private String name = "idea_197095";
 ...
 */
@Slf4j
public class Idea197095Service {
    private static final int IDEA_ID = 197095;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197095Service() {
        this(new Idea197095Config());
    }

    public Idea197095Service(Idea197095Config config) {
        this.config = config != null ? config : new Idea197095Config();
