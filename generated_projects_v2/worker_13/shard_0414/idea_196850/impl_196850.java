...
@Data
public class Idea196850Config {
    private String name = "idea_196850";
 ...
 */
@Slf4j
public class Idea196850Service {
    private static final int IDEA_ID = 196850;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196850Service() {
        this(new Idea196850Config());
    }

    public Idea196850Service(Idea196850Config config) {
        this.config = config != null ? config : new Idea196850Config();
