...
@Data
public class Idea197006Config {
    private String name = "idea_197006";
 ...
 */
@Slf4j
public class Idea197006Service {
    private static final int IDEA_ID = 197006;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197006Service() {
        this(new Idea197006Config());
    }

    public Idea197006Service(Idea197006Config config) {
        this.config = config != null ? config : new Idea197006Config();
