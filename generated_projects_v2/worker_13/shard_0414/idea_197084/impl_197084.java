...
@Data
public class Idea197084Config {
    private String name = "idea_197084";
 ...
 */
@Slf4j
public class Idea197084Service {
    private static final int IDEA_ID = 197084;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197084Service() {
        this(new Idea197084Config());
    }

    public Idea197084Service(Idea197084Config config) {
        this.config = config != null ? config : new Idea197084Config();
