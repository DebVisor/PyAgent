...
@Data
public class Idea197031Config {
    private String name = "idea_197031";
 ...
 */
@Slf4j
public class Idea197031Service {
    private static final int IDEA_ID = 197031;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197031Service() {
        this(new Idea197031Config());
    }

    public Idea197031Service(Idea197031Config config) {
        this.config = config != null ? config : new Idea197031Config();
