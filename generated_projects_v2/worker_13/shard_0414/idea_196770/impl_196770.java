...
@Data
public class Idea196770Config {
    private String name = "idea_196770";
 ...
 */
@Slf4j
public class Idea196770Service {
    private static final int IDEA_ID = 196770;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196770Service() {
        this(new Idea196770Config());
    }

    public Idea196770Service(Idea196770Config config) {
        this.config = config != null ? config : new Idea196770Config();
