...
@Data
public class Idea196827Config {
    private String name = "idea_196827";
 ...
 */
@Slf4j
public class Idea196827Service {
    private static final int IDEA_ID = 196827;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196827Service() {
        this(new Idea196827Config());
    }

    public Idea196827Service(Idea196827Config config) {
        this.config = config != null ? config : new Idea196827Config();
