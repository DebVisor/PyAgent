...
@Data
public class Idea196896Config {
    private String name = "idea_196896";
 ...
 */
@Slf4j
public class Idea196896Service {
    private static final int IDEA_ID = 196896;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196896Service() {
        this(new Idea196896Config());
    }

    public Idea196896Service(Idea196896Config config) {
        this.config = config != null ? config : new Idea196896Config();
