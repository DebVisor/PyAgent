...
@Data
public class Idea196999Config {
    private String name = "idea_196999";
 ...
 */
@Slf4j
public class Idea196999Service {
    private static final int IDEA_ID = 196999;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196999Service() {
        this(new Idea196999Config());
    }

    public Idea196999Service(Idea196999Config config) {
        this.config = config != null ? config : new Idea196999Config();
