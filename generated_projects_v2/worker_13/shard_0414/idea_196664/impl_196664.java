...
@Data
public class Idea196664Config {
    private String name = "idea_196664";
 ...
 */
@Slf4j
public class Idea196664Service {
    private static final int IDEA_ID = 196664;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196664Service() {
        this(new Idea196664Config());
    }

    public Idea196664Service(Idea196664Config config) {
        this.config = config != null ? config : new Idea196664Config();
