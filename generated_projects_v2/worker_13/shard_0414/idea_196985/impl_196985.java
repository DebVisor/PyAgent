...
@Data
public class Idea196985Config {
    private String name = "idea_196985";
 ...
 */
@Slf4j
public class Idea196985Service {
    private static final int IDEA_ID = 196985;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196985Service() {
        this(new Idea196985Config());
    }

    public Idea196985Service(Idea196985Config config) {
        this.config = config != null ? config : new Idea196985Config();
