...
@Data
public class Idea196843Config {
    private String name = "idea_196843";
 ...
 */
@Slf4j
public class Idea196843Service {
    private static final int IDEA_ID = 196843;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196843Service() {
        this(new Idea196843Config());
    }

    public Idea196843Service(Idea196843Config config) {
        this.config = config != null ? config : new Idea196843Config();
