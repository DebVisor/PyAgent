...
@Data
public class Idea196758Config {
    private String name = "idea_196758";
 ...
 */
@Slf4j
public class Idea196758Service {
    private static final int IDEA_ID = 196758;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196758Service() {
        this(new Idea196758Config());
    }

    public Idea196758Service(Idea196758Config config) {
        this.config = config != null ? config : new Idea196758Config();
