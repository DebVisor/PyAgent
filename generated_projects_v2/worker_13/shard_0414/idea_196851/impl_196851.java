...
@Data
public class Idea196851Config {
    private String name = "idea_196851";
 ...
 */
@Slf4j
public class Idea196851Service {
    private static final int IDEA_ID = 196851;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196851Service() {
        this(new Idea196851Config());
    }

    public Idea196851Service(Idea196851Config config) {
        this.config = config != null ? config : new Idea196851Config();
