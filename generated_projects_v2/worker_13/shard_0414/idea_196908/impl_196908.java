...
@Data
public class Idea196908Config {
    private String name = "idea_196908";
 ...
 */
@Slf4j
public class Idea196908Service {
    private static final int IDEA_ID = 196908;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196908Service() {
        this(new Idea196908Config());
    }

    public Idea196908Service(Idea196908Config config) {
        this.config = config != null ? config : new Idea196908Config();
