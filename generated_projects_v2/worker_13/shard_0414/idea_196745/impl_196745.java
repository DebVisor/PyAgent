...
@Data
public class Idea196745Config {
    private String name = "idea_196745";
 ...
 */
@Slf4j
public class Idea196745Service {
    private static final int IDEA_ID = 196745;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196745Service() {
        this(new Idea196745Config());
    }

    public Idea196745Service(Idea196745Config config) {
        this.config = config != null ? config : new Idea196745Config();
