...
@Data
public class Idea197037Config {
    private String name = "idea_197037";
 ...
 */
@Slf4j
public class Idea197037Service {
    private static final int IDEA_ID = 197037;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197037Service() {
        this(new Idea197037Config());
    }

    public Idea197037Service(Idea197037Config config) {
        this.config = config != null ? config : new Idea197037Config();
