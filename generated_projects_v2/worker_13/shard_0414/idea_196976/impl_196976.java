...
@Data
public class Idea196976Config {
    private String name = "idea_196976";
 ...
 */
@Slf4j
public class Idea196976Service {
    private static final int IDEA_ID = 196976;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196976Service() {
        this(new Idea196976Config());
    }

    public Idea196976Service(Idea196976Config config) {
        this.config = config != null ? config : new Idea196976Config();
