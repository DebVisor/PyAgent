...
@Data
public class Idea197041Config {
    private String name = "idea_197041";
 ...
 */
@Slf4j
public class Idea197041Service {
    private static final int IDEA_ID = 197041;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197041Service() {
        this(new Idea197041Config());
    }

    public Idea197041Service(Idea197041Config config) {
        this.config = config != null ? config : new Idea197041Config();
