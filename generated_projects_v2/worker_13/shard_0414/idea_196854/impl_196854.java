...
@Data
public class Idea196854Config {
    private String name = "idea_196854";
 ...
 */
@Slf4j
public class Idea196854Service {
    private static final int IDEA_ID = 196854;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196854Service() {
        this(new Idea196854Config());
    }

    public Idea196854Service(Idea196854Config config) {
        this.config = config != null ? config : new Idea196854Config();
