...
@Data
public class Idea196841Config {
    private String name = "idea_196841";
 ...
 */
@Slf4j
public class Idea196841Service {
    private static final int IDEA_ID = 196841;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196841Service() {
        this(new Idea196841Config());
    }

    public Idea196841Service(Idea196841Config config) {
        this.config = config != null ? config : new Idea196841Config();
