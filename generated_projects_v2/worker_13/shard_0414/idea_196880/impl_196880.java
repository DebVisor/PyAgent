...
@Data
public class Idea196880Config {
    private String name = "idea_196880";
 ...
 */
@Slf4j
public class Idea196880Service {
    private static final int IDEA_ID = 196880;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196880Service() {
        this(new Idea196880Config());
    }

    public Idea196880Service(Idea196880Config config) {
        this.config = config != null ? config : new Idea196880Config();
