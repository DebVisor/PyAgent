...
@Data
public class Idea196754Config {
    private String name = "idea_196754";
 ...
 */
@Slf4j
public class Idea196754Service {
    private static final int IDEA_ID = 196754;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196754Service() {
        this(new Idea196754Config());
    }

    public Idea196754Service(Idea196754Config config) {
        this.config = config != null ? config : new Idea196754Config();
