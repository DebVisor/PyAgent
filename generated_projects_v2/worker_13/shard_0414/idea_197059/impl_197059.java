...
@Data
public class Idea197059Config {
    private String name = "idea_197059";
 ...
 */
@Slf4j
public class Idea197059Service {
    private static final int IDEA_ID = 197059;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197059Service() {
        this(new Idea197059Config());
    }

    public Idea197059Service(Idea197059Config config) {
        this.config = config != null ? config : new Idea197059Config();
