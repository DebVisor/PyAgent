...
@Data
public class Idea196949Config {
    private String name = "idea_196949";
 ...
 */
@Slf4j
public class Idea196949Service {
    private static final int IDEA_ID = 196949;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196949Service() {
        this(new Idea196949Config());
    }

    public Idea196949Service(Idea196949Config config) {
        this.config = config != null ? config : new Idea196949Config();
