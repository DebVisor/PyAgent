...
@Data
public class Idea196796Config {
    private String name = "idea_196796";
 ...
 */
@Slf4j
public class Idea196796Service {
    private static final int IDEA_ID = 196796;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196796Service() {
        this(new Idea196796Config());
    }

    public Idea196796Service(Idea196796Config config) {
        this.config = config != null ? config : new Idea196796Config();
