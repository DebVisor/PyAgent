...
@Data
public class Idea196735Config {
    private String name = "idea_196735";
 ...
 */
@Slf4j
public class Idea196735Service {
    private static final int IDEA_ID = 196735;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196735Service() {
        this(new Idea196735Config());
    }

    public Idea196735Service(Idea196735Config config) {
        this.config = config != null ? config : new Idea196735Config();
