...
@Data
public class Idea196717Config {
    private String name = "idea_196717";
 ...
 */
@Slf4j
public class Idea196717Service {
    private static final int IDEA_ID = 196717;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196717Service() {
        this(new Idea196717Config());
    }

    public Idea196717Service(Idea196717Config config) {
        this.config = config != null ? config : new Idea196717Config();
