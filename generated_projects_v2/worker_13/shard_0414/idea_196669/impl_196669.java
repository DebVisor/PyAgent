...
@Data
public class Idea196669Config {
    private String name = "idea_196669";
 ...
 */
@Slf4j
public class Idea196669Service {
    private static final int IDEA_ID = 196669;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196669Service() {
        this(new Idea196669Config());
    }

    public Idea196669Service(Idea196669Config config) {
        this.config = config != null ? config : new Idea196669Config();
