...
@Data
public class Idea196990Config {
    private String name = "idea_196990";
 ...
 */
@Slf4j
public class Idea196990Service {
    private static final int IDEA_ID = 196990;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196990Service() {
        this(new Idea196990Config());
    }

    public Idea196990Service(Idea196990Config config) {
        this.config = config != null ? config : new Idea196990Config();
