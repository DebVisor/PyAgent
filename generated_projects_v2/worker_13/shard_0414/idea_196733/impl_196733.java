...
@Data
public class Idea196733Config {
    private String name = "idea_196733";
 ...
 */
@Slf4j
public class Idea196733Service {
    private static final int IDEA_ID = 196733;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196733Service() {
        this(new Idea196733Config());
    }

    public Idea196733Service(Idea196733Config config) {
        this.config = config != null ? config : new Idea196733Config();
