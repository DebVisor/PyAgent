...
@Data
public class Idea197077Config {
    private String name = "idea_197077";
 ...
 */
@Slf4j
public class Idea197077Service {
    private static final int IDEA_ID = 197077;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197077Service() {
        this(new Idea197077Config());
    }

    public Idea197077Service(Idea197077Config config) {
        this.config = config != null ? config : new Idea197077Config();
