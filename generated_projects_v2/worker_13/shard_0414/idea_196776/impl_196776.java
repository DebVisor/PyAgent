...
@Data
public class Idea196776Config {
    private String name = "idea_196776";
 ...
 */
@Slf4j
public class Idea196776Service {
    private static final int IDEA_ID = 196776;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196776Service() {
        this(new Idea196776Config());
    }

    public Idea196776Service(Idea196776Config config) {
        this.config = config != null ? config : new Idea196776Config();
