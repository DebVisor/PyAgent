...
@Data
public class Idea196862Config {
    private String name = "idea_196862";
 ...
 */
@Slf4j
public class Idea196862Service {
    private static final int IDEA_ID = 196862;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196862Service() {
        this(new Idea196862Config());
    }

    public Idea196862Service(Idea196862Config config) {
        this.config = config != null ? config : new Idea196862Config();
