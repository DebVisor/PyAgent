...
@Data
public class Idea196955Config {
    private String name = "idea_196955";
 ...
 */
@Slf4j
public class Idea196955Service {
    private static final int IDEA_ID = 196955;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196955Service() {
        this(new Idea196955Config());
    }

    public Idea196955Service(Idea196955Config config) {
        this.config = config != null ? config : new Idea196955Config();
