...
@Data
public class Idea196822Config {
    private String name = "idea_196822";
 ...
 */
@Slf4j
public class Idea196822Service {
    private static final int IDEA_ID = 196822;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196822Service() {
        this(new Idea196822Config());
    }

    public Idea196822Service(Idea196822Config config) {
        this.config = config != null ? config : new Idea196822Config();
