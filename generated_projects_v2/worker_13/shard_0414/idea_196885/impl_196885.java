...
@Data
public class Idea196885Config {
    private String name = "idea_196885";
 ...
 */
@Slf4j
public class Idea196885Service {
    private static final int IDEA_ID = 196885;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196885Service() {
        this(new Idea196885Config());
    }

    public Idea196885Service(Idea196885Config config) {
        this.config = config != null ? config : new Idea196885Config();
