...
@Data
public class Idea196692Config {
    private String name = "idea_196692";
 ...
 */
@Slf4j
public class Idea196692Service {
    private static final int IDEA_ID = 196692;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196692Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196692Service() {
        this(new Idea196692Config());
    }

    public Idea196692Service(Idea196692Config config) {
        this.config = config != null ? config : new Idea196692Config();
