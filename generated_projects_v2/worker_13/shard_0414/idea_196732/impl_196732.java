...
@Data
public class Idea196732Config {
    private String name = "idea_196732";
 ...
 */
@Slf4j
public class Idea196732Service {
    private static final int IDEA_ID = 196732;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196732Service() {
        this(new Idea196732Config());
    }

    public Idea196732Service(Idea196732Config config) {
        this.config = config != null ? config : new Idea196732Config();
