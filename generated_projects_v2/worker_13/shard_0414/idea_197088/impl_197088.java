...
@Data
public class Idea197088Config {
    private String name = "idea_197088";
 ...
 */
@Slf4j
public class Idea197088Service {
    private static final int IDEA_ID = 197088;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197088Service() {
        this(new Idea197088Config());
    }

    public Idea197088Service(Idea197088Config config) {
        this.config = config != null ? config : new Idea197088Config();
