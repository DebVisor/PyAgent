...
@Data
public class Idea196764Config {
    private String name = "idea_196764";
 ...
 */
@Slf4j
public class Idea196764Service {
    private static final int IDEA_ID = 196764;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196764Service() {
        this(new Idea196764Config());
    }

    public Idea196764Service(Idea196764Config config) {
        this.config = config != null ? config : new Idea196764Config();
