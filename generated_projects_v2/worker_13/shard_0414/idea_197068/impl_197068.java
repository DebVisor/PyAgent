...
@Data
public class Idea197068Config {
    private String name = "idea_197068";
 ...
 */
@Slf4j
public class Idea197068Service {
    private static final int IDEA_ID = 197068;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197068Service() {
        this(new Idea197068Config());
    }

    public Idea197068Service(Idea197068Config config) {
        this.config = config != null ? config : new Idea197068Config();
