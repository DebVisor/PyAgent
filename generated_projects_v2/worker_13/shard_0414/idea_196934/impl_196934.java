...
@Data
public class Idea196934Config {
    private String name = "idea_196934";
 ...
 */
@Slf4j
public class Idea196934Service {
    private static final int IDEA_ID = 196934;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196934Service() {
        this(new Idea196934Config());
    }

    public Idea196934Service(Idea196934Config config) {
        this.config = config != null ? config : new Idea196934Config();
