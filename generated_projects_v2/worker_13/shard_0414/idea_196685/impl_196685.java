...
@Data
public class Idea196685Config {
    private String name = "idea_196685";
 ...
 */
@Slf4j
public class Idea196685Service {
    private static final int IDEA_ID = 196685;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196685Service() {
        this(new Idea196685Config());
    }

    public Idea196685Service(Idea196685Config config) {
        this.config = config != null ? config : new Idea196685Config();
