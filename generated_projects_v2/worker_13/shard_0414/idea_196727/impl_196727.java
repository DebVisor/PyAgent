...
@Data
public class Idea196727Config {
    private String name = "idea_196727";
 ...
 */
@Slf4j
public class Idea196727Service {
    private static final int IDEA_ID = 196727;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196727Service() {
        this(new Idea196727Config());
    }

    public Idea196727Service(Idea196727Config config) {
        this.config = config != null ? config : new Idea196727Config();
