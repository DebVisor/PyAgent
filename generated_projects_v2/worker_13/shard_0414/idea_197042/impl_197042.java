...
@Data
public class Idea197042Config {
    private String name = "idea_197042";
 ...
 */
@Slf4j
public class Idea197042Service {
    private static final int IDEA_ID = 197042;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197042Service() {
        this(new Idea197042Config());
    }

    public Idea197042Service(Idea197042Config config) {
        this.config = config != null ? config : new Idea197042Config();
