...
@Data
public class Idea196660Config {
    private String name = "idea_196660";
 ...
 */
@Slf4j
public class Idea196660Service {
    private static final int IDEA_ID = 196660;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196660Service() {
        this(new Idea196660Config());
    }

    public Idea196660Service(Idea196660Config config) {
        this.config = config != null ? config : new Idea196660Config();
