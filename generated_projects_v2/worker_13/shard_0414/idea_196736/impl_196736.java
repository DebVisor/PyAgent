...
@Data
public class Idea196736Config {
    private String name = "idea_196736";
 ...
 */
@Slf4j
public class Idea196736Service {
    private static final int IDEA_ID = 196736;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196736Service() {
        this(new Idea196736Config());
    }

    public Idea196736Service(Idea196736Config config) {
        this.config = config != null ? config : new Idea196736Config();
