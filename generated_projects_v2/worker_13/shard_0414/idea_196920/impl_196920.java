...
@Data
public class Idea196920Config {
    private String name = "idea_196920";
 ...
 */
@Slf4j
public class Idea196920Service {
    private static final int IDEA_ID = 196920;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196920Service() {
        this(new Idea196920Config());
    }

    public Idea196920Service(Idea196920Config config) {
        this.config = config != null ? config : new Idea196920Config();
