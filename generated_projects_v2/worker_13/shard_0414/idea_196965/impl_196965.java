...
@Data
public class Idea196965Config {
    private String name = "idea_196965";
 ...
 */
@Slf4j
public class Idea196965Service {
    private static final int IDEA_ID = 196965;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196965Service() {
        this(new Idea196965Config());
    }

    public Idea196965Service(Idea196965Config config) {
        this.config = config != null ? config : new Idea196965Config();
