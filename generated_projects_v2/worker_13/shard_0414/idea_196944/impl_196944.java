...
@Data
public class Idea196944Config {
    private String name = "idea_196944";
 ...
 */
@Slf4j
public class Idea196944Service {
    private static final int IDEA_ID = 196944;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196944Service() {
        this(new Idea196944Config());
    }

    public Idea196944Service(Idea196944Config config) {
        this.config = config != null ? config : new Idea196944Config();
