...
@Data
public class Idea196902Config {
    private String name = "idea_196902";
 ...
 */
@Slf4j
public class Idea196902Service {
    private static final int IDEA_ID = 196902;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196902Service() {
        this(new Idea196902Config());
    }

    public Idea196902Service(Idea196902Config config) {
        this.config = config != null ? config : new Idea196902Config();
