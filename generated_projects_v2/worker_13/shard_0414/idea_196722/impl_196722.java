...
@Data
public class Idea196722Config {
    private String name = "idea_196722";
 ...
 */
@Slf4j
public class Idea196722Service {
    private static final int IDEA_ID = 196722;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196722Service() {
        this(new Idea196722Config());
    }

    public Idea196722Service(Idea196722Config config) {
        this.config = config != null ? config : new Idea196722Config();
