...
@Data
public class Idea197093Config {
    private String name = "idea_197093";
 ...
 */
@Slf4j
public class Idea197093Service {
    private static final int IDEA_ID = 197093;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197093Service() {
        this(new Idea197093Config());
    }

    public Idea197093Service(Idea197093Config config) {
        this.config = config != null ? config : new Idea197093Config();
