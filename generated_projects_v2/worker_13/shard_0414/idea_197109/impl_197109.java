...
@Data
public class Idea197109Config {
    private String name = "idea_197109";
 ...
 */
@Slf4j
public class Idea197109Service {
    private static final int IDEA_ID = 197109;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197109Service() {
        this(new Idea197109Config());
    }

    public Idea197109Service(Idea197109Config config) {
        this.config = config != null ? config : new Idea197109Config();
