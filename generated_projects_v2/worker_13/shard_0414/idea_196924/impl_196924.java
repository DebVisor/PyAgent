...
@Data
public class Idea196924Config {
    private String name = "idea_196924";
 ...
 */
@Slf4j
public class Idea196924Service {
    private static final int IDEA_ID = 196924;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196924Service() {
        this(new Idea196924Config());
    }

    public Idea196924Service(Idea196924Config config) {
        this.config = config != null ? config : new Idea196924Config();
