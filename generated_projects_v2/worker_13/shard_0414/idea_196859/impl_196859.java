...
@Data
public class Idea196859Config {
    private String name = "idea_196859";
 ...
 */
@Slf4j
public class Idea196859Service {
    private static final int IDEA_ID = 196859;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196859Service() {
        this(new Idea196859Config());
    }

    public Idea196859Service(Idea196859Config config) {
        this.config = config != null ? config : new Idea196859Config();
