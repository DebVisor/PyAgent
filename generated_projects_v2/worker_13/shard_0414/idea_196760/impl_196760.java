...
@Data
public class Idea196760Config {
    private String name = "idea_196760";
 ...
 */
@Slf4j
public class Idea196760Service {
    private static final int IDEA_ID = 196760;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196760Service() {
        this(new Idea196760Config());
    }

    public Idea196760Service(Idea196760Config config) {
        this.config = config != null ? config : new Idea196760Config();
