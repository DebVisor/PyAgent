...
@Data
public class Idea196817Config {
    private String name = "idea_196817";
 ...
 */
@Slf4j
public class Idea196817Service {
    private static final int IDEA_ID = 196817;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196817Service() {
        this(new Idea196817Config());
    }

    public Idea196817Service(Idea196817Config config) {
        this.config = config != null ? config : new Idea196817Config();
