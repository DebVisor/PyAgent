...
@Data
public class Idea196719Config {
    private String name = "idea_196719";
 ...
 */
@Slf4j
public class Idea196719Service {
    private static final int IDEA_ID = 196719;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196719Service() {
        this(new Idea196719Config());
    }

    public Idea196719Service(Idea196719Config config) {
        this.config = config != null ? config : new Idea196719Config();
