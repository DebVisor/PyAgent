...
@Data
public class Idea196762Config {
    private String name = "idea_196762";
 ...
 */
@Slf4j
public class Idea196762Service {
    private static final int IDEA_ID = 196762;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196762Service() {
        this(new Idea196762Config());
    }

    public Idea196762Service(Idea196762Config config) {
        this.config = config != null ? config : new Idea196762Config();
