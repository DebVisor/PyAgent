...
@Data
public class Idea196750Config {
    private String name = "idea_196750";
 ...
 */
@Slf4j
public class Idea196750Service {
    private static final int IDEA_ID = 196750;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196750Service() {
        this(new Idea196750Config());
    }

    public Idea196750Service(Idea196750Config config) {
        this.config = config != null ? config : new Idea196750Config();
