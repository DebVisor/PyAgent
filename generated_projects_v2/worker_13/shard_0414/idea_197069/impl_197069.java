...
@Data
public class Idea197069Config {
    private String name = "idea_197069";
 ...
 */
@Slf4j
public class Idea197069Service {
    private static final int IDEA_ID = 197069;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197069Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197069Service() {
        this(new Idea197069Config());
    }

    public Idea197069Service(Idea197069Config config) {
        this.config = config != null ? config : new Idea197069Config();
