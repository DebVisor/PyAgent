...
@Data
public class Idea196728Config {
    private String name = "idea_196728";
 ...
 */
@Slf4j
public class Idea196728Service {
    private static final int IDEA_ID = 196728;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196728Service() {
        this(new Idea196728Config());
    }

    public Idea196728Service(Idea196728Config config) {
        this.config = config != null ? config : new Idea196728Config();
