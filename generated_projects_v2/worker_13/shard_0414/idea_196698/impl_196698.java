...
@Data
public class Idea196698Config {
    private String name = "idea_196698";
 ...
 */
@Slf4j
public class Idea196698Service {
    private static final int IDEA_ID = 196698;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196698Service() {
        this(new Idea196698Config());
    }

    public Idea196698Service(Idea196698Config config) {
        this.config = config != null ? config : new Idea196698Config();
