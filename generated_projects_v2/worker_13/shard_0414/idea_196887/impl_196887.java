...
@Data
public class Idea196887Config {
    private String name = "idea_196887";
 ...
 */
@Slf4j
public class Idea196887Service {
    private static final int IDEA_ID = 196887;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196887Service() {
        this(new Idea196887Config());
    }

    public Idea196887Service(Idea196887Config config) {
        this.config = config != null ? config : new Idea196887Config();
