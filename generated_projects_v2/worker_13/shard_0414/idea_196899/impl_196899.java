...
@Data
public class Idea196899Config {
    private String name = "idea_196899";
 ...
 */
@Slf4j
public class Idea196899Service {
    private static final int IDEA_ID = 196899;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196899Service() {
        this(new Idea196899Config());
    }

    public Idea196899Service(Idea196899Config config) {
        this.config = config != null ? config : new Idea196899Config();
