...
@Data
public class Idea196917Config {
    private String name = "idea_196917";
 ...
 */
@Slf4j
public class Idea196917Service {
    private static final int IDEA_ID = 196917;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196917Service() {
        this(new Idea196917Config());
    }

    public Idea196917Service(Idea196917Config config) {
        this.config = config != null ? config : new Idea196917Config();
