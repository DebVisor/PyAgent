...
@Data
public class Idea196948Config {
    private String name = "idea_196948";
 ...
 */
@Slf4j
public class Idea196948Service {
    private static final int IDEA_ID = 196948;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196948Service() {
        this(new Idea196948Config());
    }

    public Idea196948Service(Idea196948Config config) {
        this.config = config != null ? config : new Idea196948Config();
