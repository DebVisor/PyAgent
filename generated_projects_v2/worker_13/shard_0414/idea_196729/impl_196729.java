...
@Data
public class Idea196729Config {
    private String name = "idea_196729";
 ...
 */
@Slf4j
public class Idea196729Service {
    private static final int IDEA_ID = 196729;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196729Service() {
        this(new Idea196729Config());
    }

    public Idea196729Service(Idea196729Config config) {
        this.config = config != null ? config : new Idea196729Config();
