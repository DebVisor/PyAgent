...
@Data
public class Idea197008Config {
    private String name = "idea_197008";
 ...
 */
@Slf4j
public class Idea197008Service {
    private static final int IDEA_ID = 197008;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197008Service() {
        this(new Idea197008Config());
    }

    public Idea197008Service(Idea197008Config config) {
        this.config = config != null ? config : new Idea197008Config();
