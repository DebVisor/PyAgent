...
@Data
public class Idea196981Config {
    private String name = "idea_196981";
 ...
 */
@Slf4j
public class Idea196981Service {
    private static final int IDEA_ID = 196981;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196981Service() {
        this(new Idea196981Config());
    }

    public Idea196981Service(Idea196981Config config) {
        this.config = config != null ? config : new Idea196981Config();
