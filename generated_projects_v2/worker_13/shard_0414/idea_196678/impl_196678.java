...
@Data
public class Idea196678Config {
    private String name = "idea_196678";
 ...
 */
@Slf4j
public class Idea196678Service {
    private static final int IDEA_ID = 196678;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196678Service() {
        this(new Idea196678Config());
    }

    public Idea196678Service(Idea196678Config config) {
        this.config = config != null ? config : new Idea196678Config();
