...
@Data
public class Idea197048Config {
    private String name = "idea_197048";
 ...
 */
@Slf4j
public class Idea197048Service {
    private static final int IDEA_ID = 197048;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197048Service() {
        this(new Idea197048Config());
    }

    public Idea197048Service(Idea197048Config config) {
        this.config = config != null ? config : new Idea197048Config();
