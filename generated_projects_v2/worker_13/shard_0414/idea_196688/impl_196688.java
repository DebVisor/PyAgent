...
@Data
public class Idea196688Config {
    private String name = "idea_196688";
 ...
 */
@Slf4j
public class Idea196688Service {
    private static final int IDEA_ID = 196688;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196688Service() {
        this(new Idea196688Config());
    }

    public Idea196688Service(Idea196688Config config) {
        this.config = config != null ? config : new Idea196688Config();
