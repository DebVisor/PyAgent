...
@Data
public class Idea197010Config {
    private String name = "idea_197010";
 ...
 */
@Slf4j
public class Idea197010Service {
    private static final int IDEA_ID = 197010;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197010Service() {
        this(new Idea197010Config());
    }

    public Idea197010Service(Idea197010Config config) {
        this.config = config != null ? config : new Idea197010Config();
