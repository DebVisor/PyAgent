...
@Data
public class Idea196929Config {
    private String name = "idea_196929";
 ...
 */
@Slf4j
public class Idea196929Service {
    private static final int IDEA_ID = 196929;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196929Service() {
        this(new Idea196929Config());
    }

    public Idea196929Service(Idea196929Config config) {
        this.config = config != null ? config : new Idea196929Config();
