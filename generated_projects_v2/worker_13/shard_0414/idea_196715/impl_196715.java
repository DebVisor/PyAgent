...
@Data
public class Idea196715Config {
    private String name = "idea_196715";
 ...
 */
@Slf4j
public class Idea196715Service {
    private static final int IDEA_ID = 196715;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196715Service() {
        this(new Idea196715Config());
    }

    public Idea196715Service(Idea196715Config config) {
        this.config = config != null ? config : new Idea196715Config();
