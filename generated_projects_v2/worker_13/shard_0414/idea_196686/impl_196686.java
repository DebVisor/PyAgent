...
@Data
public class Idea196686Config {
    private String name = "idea_196686";
 ...
 */
@Slf4j
public class Idea196686Service {
    private static final int IDEA_ID = 196686;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196686Service() {
        this(new Idea196686Config());
    }

    public Idea196686Service(Idea196686Config config) {
        this.config = config != null ? config : new Idea196686Config();
