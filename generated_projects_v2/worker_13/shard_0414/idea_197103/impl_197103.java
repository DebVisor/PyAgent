...
@Data
public class Idea197103Config {
    private String name = "idea_197103";
 ...
 */
@Slf4j
public class Idea197103Service {
    private static final int IDEA_ID = 197103;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197103Service() {
        this(new Idea197103Config());
    }

    public Idea197103Service(Idea197103Config config) {
        this.config = config != null ? config : new Idea197103Config();
