...
@Data
public class Idea196819Config {
    private String name = "idea_196819";
 ...
 */
@Slf4j
public class Idea196819Service {
    private static final int IDEA_ID = 196819;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196819Service() {
        this(new Idea196819Config());
    }

    public Idea196819Service(Idea196819Config config) {
        this.config = config != null ? config : new Idea196819Config();
