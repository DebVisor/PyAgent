...
@Data
public class Idea196784Config {
    private String name = "idea_196784";
 ...
 */
@Slf4j
public class Idea196784Service {
    private static final int IDEA_ID = 196784;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196784Service() {
        this(new Idea196784Config());
    }

    public Idea196784Service(Idea196784Config config) {
        this.config = config != null ? config : new Idea196784Config();
