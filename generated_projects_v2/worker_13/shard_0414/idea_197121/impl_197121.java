...
@Data
public class Idea197121Config {
    private String name = "idea_197121";
 ...
 */
@Slf4j
public class Idea197121Service {
    private static final int IDEA_ID = 197121;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197121Service() {
        this(new Idea197121Config());
    }

    public Idea197121Service(Idea197121Config config) {
        this.config = config != null ? config : new Idea197121Config();
