...
@Data
public class Idea196978Config {
    private String name = "idea_196978";
 ...
 */
@Slf4j
public class Idea196978Service {
    private static final int IDEA_ID = 196978;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196978Service() {
        this(new Idea196978Config());
    }

    public Idea196978Service(Idea196978Config config) {
        this.config = config != null ? config : new Idea196978Config();
