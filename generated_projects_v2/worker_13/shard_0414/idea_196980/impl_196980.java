...
@Data
public class Idea196980Config {
    private String name = "idea_196980";
 ...
 */
@Slf4j
public class Idea196980Service {
    private static final int IDEA_ID = 196980;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196980Service() {
        this(new Idea196980Config());
    }

    public Idea196980Service(Idea196980Config config) {
        this.config = config != null ? config : new Idea196980Config();
