...
@Data
public class Idea197117Config {
    private String name = "idea_197117";
 ...
 */
@Slf4j
public class Idea197117Service {
    private static final int IDEA_ID = 197117;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197117Service() {
        this(new Idea197117Config());
    }

    public Idea197117Service(Idea197117Config config) {
        this.config = config != null ? config : new Idea197117Config();
