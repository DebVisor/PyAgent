...
@Data
public class Idea196975Config {
    private String name = "idea_196975";
 ...
 */
@Slf4j
public class Idea196975Service {
    private static final int IDEA_ID = 196975;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196975Service() {
        this(new Idea196975Config());
    }

    public Idea196975Service(Idea196975Config config) {
        this.config = config != null ? config : new Idea196975Config();
