...
@Data
public class Idea197061Config {
    private String name = "idea_197061";
 ...
 */
@Slf4j
public class Idea197061Service {
    private static final int IDEA_ID = 197061;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197061Service() {
        this(new Idea197061Config());
    }

    public Idea197061Service(Idea197061Config config) {
        this.config = config != null ? config : new Idea197061Config();
