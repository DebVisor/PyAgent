...
@Data
public class Idea196689Config {
    private String name = "idea_196689";
 ...
 */
@Slf4j
public class Idea196689Service {
    private static final int IDEA_ID = 196689;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196689Service() {
        this(new Idea196689Config());
    }

    public Idea196689Service(Idea196689Config config) {
        this.config = config != null ? config : new Idea196689Config();
