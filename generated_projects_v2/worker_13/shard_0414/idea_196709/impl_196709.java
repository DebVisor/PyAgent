...
@Data
public class Idea196709Config {
    private String name = "idea_196709";
 ...
 */
@Slf4j
public class Idea196709Service {
    private static final int IDEA_ID = 196709;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196709Service() {
        this(new Idea196709Config());
    }

    public Idea196709Service(Idea196709Config config) {
        this.config = config != null ? config : new Idea196709Config();
