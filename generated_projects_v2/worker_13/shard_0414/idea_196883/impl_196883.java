...
@Data
public class Idea196883Config {
    private String name = "idea_196883";
 ...
 */
@Slf4j
public class Idea196883Service {
    private static final int IDEA_ID = 196883;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196883Service() {
        this(new Idea196883Config());
    }

    public Idea196883Service(Idea196883Config config) {
        this.config = config != null ? config : new Idea196883Config();
