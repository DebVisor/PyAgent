...
@Data
public class Idea196930Config {
    private String name = "idea_196930";
 ...
 */
@Slf4j
public class Idea196930Service {
    private static final int IDEA_ID = 196930;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196930Service() {
        this(new Idea196930Config());
    }

    public Idea196930Service(Idea196930Config config) {
        this.config = config != null ? config : new Idea196930Config();
