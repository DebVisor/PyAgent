...
@Data
public class Idea196979Config {
    private String name = "idea_196979";
 ...
 */
@Slf4j
public class Idea196979Service {
    private static final int IDEA_ID = 196979;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196979Service() {
        this(new Idea196979Config());
    }

    public Idea196979Service(Idea196979Config config) {
        this.config = config != null ? config : new Idea196979Config();
