...
@Data
public class Idea197066Config {
    private String name = "idea_197066";
 ...
 */
@Slf4j
public class Idea197066Service {
    private static final int IDEA_ID = 197066;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197066Service() {
        this(new Idea197066Config());
    }

    public Idea197066Service(Idea197066Config config) {
        this.config = config != null ? config : new Idea197066Config();
