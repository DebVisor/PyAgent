...
@Data
public class Idea196876Config {
    private String name = "idea_196876";
 ...
 */
@Slf4j
public class Idea196876Service {
    private static final int IDEA_ID = 196876;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196876Service() {
        this(new Idea196876Config());
    }

    public Idea196876Service(Idea196876Config config) {
        this.config = config != null ? config : new Idea196876Config();
