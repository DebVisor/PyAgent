...
@Data
public class Idea196886Config {
    private String name = "idea_196886";
 ...
 */
@Slf4j
public class Idea196886Service {
    private static final int IDEA_ID = 196886;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196886Service() {
        this(new Idea196886Config());
    }

    public Idea196886Service(Idea196886Config config) {
        this.config = config != null ? config : new Idea196886Config();
