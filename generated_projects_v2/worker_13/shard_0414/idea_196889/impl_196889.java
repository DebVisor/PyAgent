...
@Data
public class Idea196889Config {
    private String name = "idea_196889";
 ...
 */
@Slf4j
public class Idea196889Service {
    private static final int IDEA_ID = 196889;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196889Service() {
        this(new Idea196889Config());
    }

    public Idea196889Service(Idea196889Config config) {
        this.config = config != null ? config : new Idea196889Config();
