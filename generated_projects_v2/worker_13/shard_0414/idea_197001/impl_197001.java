...
@Data
public class Idea197001Config {
    private String name = "idea_197001";
 ...
 */
@Slf4j
public class Idea197001Service {
    private static final int IDEA_ID = 197001;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197001Service() {
        this(new Idea197001Config());
    }

    public Idea197001Service(Idea197001Config config) {
        this.config = config != null ? config : new Idea197001Config();
