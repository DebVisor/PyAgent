...
@Data
public class Idea196808Config {
    private String name = "idea_196808";
 ...
 */
@Slf4j
public class Idea196808Service {
    private static final int IDEA_ID = 196808;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196808Service() {
        this(new Idea196808Config());
    }

    public Idea196808Service(Idea196808Config config) {
        this.config = config != null ? config : new Idea196808Config();
