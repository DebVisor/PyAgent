...
@Data
public class Idea196837Config {
    private String name = "idea_196837";
 ...
 */
@Slf4j
public class Idea196837Service {
    private static final int IDEA_ID = 196837;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196837Service() {
        this(new Idea196837Config());
    }

    public Idea196837Service(Idea196837Config config) {
        this.config = config != null ? config : new Idea196837Config();
