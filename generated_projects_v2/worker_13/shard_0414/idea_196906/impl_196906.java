...
@Data
public class Idea196906Config {
    private String name = "idea_196906";
 ...
 */
@Slf4j
public class Idea196906Service {
    private static final int IDEA_ID = 196906;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196906Service() {
        this(new Idea196906Config());
    }

    public Idea196906Service(Idea196906Config config) {
        this.config = config != null ? config : new Idea196906Config();
