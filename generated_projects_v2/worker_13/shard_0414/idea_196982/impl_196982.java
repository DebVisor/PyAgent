...
@Data
public class Idea196982Config {
    private String name = "idea_196982";
 ...
 */
@Slf4j
public class Idea196982Service {
    private static final int IDEA_ID = 196982;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196982Service() {
        this(new Idea196982Config());
    }

    public Idea196982Service(Idea196982Config config) {
        this.config = config != null ? config : new Idea196982Config();
