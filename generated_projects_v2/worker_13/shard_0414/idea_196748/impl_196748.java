...
@Data
public class Idea196748Config {
    private String name = "idea_196748";
 ...
 */
@Slf4j
public class Idea196748Service {
    private static final int IDEA_ID = 196748;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196748Service() {
        this(new Idea196748Config());
    }

    public Idea196748Service(Idea196748Config config) {
        this.config = config != null ? config : new Idea196748Config();
