...
@Data
public class Idea197070Config {
    private String name = "idea_197070";
 ...
 */
@Slf4j
public class Idea197070Service {
    private static final int IDEA_ID = 197070;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197070Service() {
        this(new Idea197070Config());
    }

    public Idea197070Service(Idea197070Config config) {
        this.config = config != null ? config : new Idea197070Config();
