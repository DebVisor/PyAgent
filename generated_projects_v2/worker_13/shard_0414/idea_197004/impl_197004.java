...
@Data
public class Idea197004Config {
    private String name = "idea_197004";
 ...
 */
@Slf4j
public class Idea197004Service {
    private static final int IDEA_ID = 197004;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197004Service() {
        this(new Idea197004Config());
    }

    public Idea197004Service(Idea197004Config config) {
        this.config = config != null ? config : new Idea197004Config();
