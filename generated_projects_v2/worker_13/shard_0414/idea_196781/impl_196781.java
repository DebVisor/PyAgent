...
@Data
public class Idea196781Config {
    private String name = "idea_196781";
 ...
 */
@Slf4j
public class Idea196781Service {
    private static final int IDEA_ID = 196781;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196781Service() {
        this(new Idea196781Config());
    }

    public Idea196781Service(Idea196781Config config) {
        this.config = config != null ? config : new Idea196781Config();
