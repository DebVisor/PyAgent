...
@Data
public class Idea196802Config {
    private String name = "idea_196802";
 ...
 */
@Slf4j
public class Idea196802Service {
    private static final int IDEA_ID = 196802;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196802Service() {
        this(new Idea196802Config());
    }

    public Idea196802Service(Idea196802Config config) {
        this.config = config != null ? config : new Idea196802Config();
