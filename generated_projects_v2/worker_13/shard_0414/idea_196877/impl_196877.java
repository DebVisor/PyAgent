...
@Data
public class Idea196877Config {
    private String name = "idea_196877";
 ...
 */
@Slf4j
public class Idea196877Service {
    private static final int IDEA_ID = 196877;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196877Service() {
        this(new Idea196877Config());
    }

    public Idea196877Service(Idea196877Config config) {
        this.config = config != null ? config : new Idea196877Config();
