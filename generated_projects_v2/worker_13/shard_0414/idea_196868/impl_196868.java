...
@Data
public class Idea196868Config {
    private String name = "idea_196868";
 ...
 */
@Slf4j
public class Idea196868Service {
    private static final int IDEA_ID = 196868;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196868Service() {
        this(new Idea196868Config());
    }

    public Idea196868Service(Idea196868Config config) {
        this.config = config != null ? config : new Idea196868Config();
