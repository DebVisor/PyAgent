...
@Data
public class Idea196847Config {
    private String name = "idea_196847";
 ...
 */
@Slf4j
public class Idea196847Service {
    private static final int IDEA_ID = 196847;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196847Service() {
        this(new Idea196847Config());
    }

    public Idea196847Service(Idea196847Config config) {
        this.config = config != null ? config : new Idea196847Config();
