...
@Data
public class Idea196866Config {
    private String name = "idea_196866";
 ...
 */
@Slf4j
public class Idea196866Service {
    private static final int IDEA_ID = 196866;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196866Service() {
        this(new Idea196866Config());
    }

    public Idea196866Service(Idea196866Config config) {
        this.config = config != null ? config : new Idea196866Config();
