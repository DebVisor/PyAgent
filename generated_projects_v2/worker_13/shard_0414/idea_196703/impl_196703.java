...
@Data
public class Idea196703Config {
    private String name = "idea_196703";
 ...
 */
@Slf4j
public class Idea196703Service {
    private static final int IDEA_ID = 196703;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196703Service() {
        this(new Idea196703Config());
    }

    public Idea196703Service(Idea196703Config config) {
        this.config = config != null ? config : new Idea196703Config();
