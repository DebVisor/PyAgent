...
@Data
public class Idea196705Config {
    private String name = "idea_196705";
 ...
 */
@Slf4j
public class Idea196705Service {
    private static final int IDEA_ID = 196705;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196705Service() {
        this(new Idea196705Config());
    }

    public Idea196705Service(Idea196705Config config) {
        this.config = config != null ? config : new Idea196705Config();
