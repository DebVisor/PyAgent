...
@Data
public class Idea196872Config {
    private String name = "idea_196872";
 ...
 */
@Slf4j
public class Idea196872Service {
    private static final int IDEA_ID = 196872;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196872Service() {
        this(new Idea196872Config());
    }

    public Idea196872Service(Idea196872Config config) {
        this.config = config != null ? config : new Idea196872Config();
