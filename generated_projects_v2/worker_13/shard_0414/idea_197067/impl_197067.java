...
@Data
public class Idea197067Config {
    private String name = "idea_197067";
 ...
 */
@Slf4j
public class Idea197067Service {
    private static final int IDEA_ID = 197067;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197067Service() {
        this(new Idea197067Config());
    }

    public Idea197067Service(Idea197067Config config) {
        this.config = config != null ? config : new Idea197067Config();
