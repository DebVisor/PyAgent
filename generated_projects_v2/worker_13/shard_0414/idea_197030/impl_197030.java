...
@Data
public class Idea197030Config {
    private String name = "idea_197030";
 ...
 */
@Slf4j
public class Idea197030Service {
    private static final int IDEA_ID = 197030;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197030Service() {
        this(new Idea197030Config());
    }

    public Idea197030Service(Idea197030Config config) {
        this.config = config != null ? config : new Idea197030Config();
