...
@Data
public class Idea197049Config {
    private String name = "idea_197049";
 ...
 */
@Slf4j
public class Idea197049Service {
    private static final int IDEA_ID = 197049;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197049Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197049Service() {
        this(new Idea197049Config());
    }

    public Idea197049Service(Idea197049Config config) {
        this.config = config != null ? config : new Idea197049Config();
