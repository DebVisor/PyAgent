...
@Data
public class Idea196797Config {
    private String name = "idea_196797";
 ...
 */
@Slf4j
public class Idea196797Service {
    private static final int IDEA_ID = 196797;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196797Service() {
        this(new Idea196797Config());
    }

    public Idea196797Service(Idea196797Config config) {
        this.config = config != null ? config : new Idea196797Config();
