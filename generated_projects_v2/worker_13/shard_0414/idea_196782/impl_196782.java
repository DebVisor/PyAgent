...
@Data
public class Idea196782Config {
    private String name = "idea_196782";
 ...
 */
@Slf4j
public class Idea196782Service {
    private static final int IDEA_ID = 196782;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196782Service() {
        this(new Idea196782Config());
    }

    public Idea196782Service(Idea196782Config config) {
        this.config = config != null ? config : new Idea196782Config();
