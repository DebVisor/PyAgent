...
@Data
public class Idea197113Config {
    private String name = "idea_197113";
 ...
 */
@Slf4j
public class Idea197113Service {
    private static final int IDEA_ID = 197113;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197113Service() {
        this(new Idea197113Config());
    }

    public Idea197113Service(Idea197113Config config) {
        this.config = config != null ? config : new Idea197113Config();
