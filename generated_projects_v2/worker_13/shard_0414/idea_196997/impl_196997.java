...
@Data
public class Idea196997Config {
    private String name = "idea_196997";
 ...
 */
@Slf4j
public class Idea196997Service {
    private static final int IDEA_ID = 196997;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196997Service() {
        this(new Idea196997Config());
    }

    public Idea196997Service(Idea196997Config config) {
        this.config = config != null ? config : new Idea196997Config();
