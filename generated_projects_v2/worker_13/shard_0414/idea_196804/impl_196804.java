...
@Data
public class Idea196804Config {
    private String name = "idea_196804";
 ...
 */
@Slf4j
public class Idea196804Service {
    private static final int IDEA_ID = 196804;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196804Service() {
        this(new Idea196804Config());
    }

    public Idea196804Service(Idea196804Config config) {
        this.config = config != null ? config : new Idea196804Config();
