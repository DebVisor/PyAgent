...
@Data
public class Idea196755Config {
    private String name = "idea_196755";
 ...
 */
@Slf4j
public class Idea196755Service {
    private static final int IDEA_ID = 196755;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196755Service() {
        this(new Idea196755Config());
    }

    public Idea196755Service(Idea196755Config config) {
        this.config = config != null ? config : new Idea196755Config();
