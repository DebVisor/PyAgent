...
@Data
public class Idea196777Config {
    private String name = "idea_196777";
 ...
 */
@Slf4j
public class Idea196777Service {
    private static final int IDEA_ID = 196777;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196777Service() {
        this(new Idea196777Config());
    }

    public Idea196777Service(Idea196777Config config) {
        this.config = config != null ? config : new Idea196777Config();
