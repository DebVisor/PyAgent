...
@Data
public class Idea197016Config {
    private String name = "idea_197016";
 ...
 */
@Slf4j
public class Idea197016Service {
    private static final int IDEA_ID = 197016;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197016Service() {
        this(new Idea197016Config());
    }

    public Idea197016Service(Idea197016Config config) {
        this.config = config != null ? config : new Idea197016Config();
