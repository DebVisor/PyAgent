...
@Data
public class Idea196786Config {
    private String name = "idea_196786";
 ...
 */
@Slf4j
public class Idea196786Service {
    private static final int IDEA_ID = 196786;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196786Service() {
        this(new Idea196786Config());
    }

    public Idea196786Service(Idea196786Config config) {
        this.config = config != null ? config : new Idea196786Config();
