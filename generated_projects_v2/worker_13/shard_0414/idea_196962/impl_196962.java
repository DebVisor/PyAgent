...
@Data
public class Idea196962Config {
    private String name = "idea_196962";
 ...
 */
@Slf4j
public class Idea196962Service {
    private static final int IDEA_ID = 196962;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196962Service() {
        this(new Idea196962Config());
    }

    public Idea196962Service(Idea196962Config config) {
        this.config = config != null ? config : new Idea196962Config();
