...
@Data
public class Idea197085Config {
    private String name = "idea_197085";
 ...
 */
@Slf4j
public class Idea197085Service {
    private static final int IDEA_ID = 197085;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197085Service() {
        this(new Idea197085Config());
    }

    public Idea197085Service(Idea197085Config config) {
        this.config = config != null ? config : new Idea197085Config();
