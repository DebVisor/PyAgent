...
@Data
public class Idea197033Config {
    private String name = "idea_197033";
 ...
 */
@Slf4j
public class Idea197033Service {
    private static final int IDEA_ID = 197033;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197033Service() {
        this(new Idea197033Config());
    }

    public Idea197033Service(Idea197033Config config) {
        this.config = config != null ? config : new Idea197033Config();
