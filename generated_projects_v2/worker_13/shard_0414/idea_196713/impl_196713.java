...
@Data
public class Idea196713Config {
    private String name = "idea_196713";
 ...
 */
@Slf4j
public class Idea196713Service {
    private static final int IDEA_ID = 196713;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196713Service() {
        this(new Idea196713Config());
    }

    public Idea196713Service(Idea196713Config config) {
        this.config = config != null ? config : new Idea196713Config();
