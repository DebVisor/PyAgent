...
@Data
public class Idea196718Config {
    private String name = "idea_196718";
 ...
 */
@Slf4j
public class Idea196718Service {
    private static final int IDEA_ID = 196718;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196718Service() {
        this(new Idea196718Config());
    }

    public Idea196718Service(Idea196718Config config) {
        this.config = config != null ? config : new Idea196718Config();
