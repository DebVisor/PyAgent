...
@Data
public class Idea197029Config {
    private String name = "idea_197029";
 ...
 */
@Slf4j
public class Idea197029Service {
    private static final int IDEA_ID = 197029;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197029Service() {
        this(new Idea197029Config());
    }

    public Idea197029Service(Idea197029Config config) {
        this.config = config != null ? config : new Idea197029Config();
