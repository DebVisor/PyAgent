...
@Data
public class Idea197098Config {
    private String name = "idea_197098";
 ...
 */
@Slf4j
public class Idea197098Service {
    private static final int IDEA_ID = 197098;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197098Service() {
        this(new Idea197098Config());
    }

    public Idea197098Service(Idea197098Config config) {
        this.config = config != null ? config : new Idea197098Config();
