...
@Data
public class Idea196700Config {
    private String name = "idea_196700";
 ...
 */
@Slf4j
public class Idea196700Service {
    private static final int IDEA_ID = 196700;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196700Service() {
        this(new Idea196700Config());
    }

    public Idea196700Service(Idea196700Config config) {
        this.config = config != null ? config : new Idea196700Config();
