...
@Data
public class Idea196699Config {
    private String name = "idea_196699";
 ...
 */
@Slf4j
public class Idea196699Service {
    private static final int IDEA_ID = 196699;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196699Service() {
        this(new Idea196699Config());
    }

    public Idea196699Service(Idea196699Config config) {
        this.config = config != null ? config : new Idea196699Config();
