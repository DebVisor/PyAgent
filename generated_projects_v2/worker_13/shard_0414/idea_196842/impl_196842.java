...
@Data
public class Idea196842Config {
    private String name = "idea_196842";
 ...
 */
@Slf4j
public class Idea196842Service {
    private static final int IDEA_ID = 196842;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196842Service() {
        this(new Idea196842Config());
    }

    public Idea196842Service(Idea196842Config config) {
        this.config = config != null ? config : new Idea196842Config();
