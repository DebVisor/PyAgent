...
@Data
public class Idea196798Config {
    private String name = "idea_196798";
 ...
 */
@Slf4j
public class Idea196798Service {
    private static final int IDEA_ID = 196798;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196798Service() {
        this(new Idea196798Config());
    }

    public Idea196798Service(Idea196798Config config) {
        this.config = config != null ? config : new Idea196798Config();
