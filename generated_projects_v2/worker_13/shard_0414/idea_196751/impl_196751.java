...
@Data
public class Idea196751Config {
    private String name = "idea_196751";
 ...
 */
@Slf4j
public class Idea196751Service {
    private static final int IDEA_ID = 196751;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196751Service() {
        this(new Idea196751Config());
    }

    public Idea196751Service(Idea196751Config config) {
        this.config = config != null ? config : new Idea196751Config();
