...
@Data
public class Idea197000Config {
    private String name = "idea_197000";
 ...
 */
@Slf4j
public class Idea197000Service {
    private static final int IDEA_ID = 197000;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197000Service() {
        this(new Idea197000Config());
    }

    public Idea197000Service(Idea197000Config config) {
        this.config = config != null ? config : new Idea197000Config();
