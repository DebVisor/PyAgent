...
@Data
public class Idea196890Config {
    private String name = "idea_196890";
 ...
 */
@Slf4j
public class Idea196890Service {
    private static final int IDEA_ID = 196890;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196890Service() {
        this(new Idea196890Config());
    }

    public Idea196890Service(Idea196890Config config) {
        this.config = config != null ? config : new Idea196890Config();
