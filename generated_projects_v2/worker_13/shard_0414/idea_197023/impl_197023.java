...
@Data
public class Idea197023Config {
    private String name = "idea_197023";
 ...
 */
@Slf4j
public class Idea197023Service {
    private static final int IDEA_ID = 197023;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197023Service() {
        this(new Idea197023Config());
    }

    public Idea197023Service(Idea197023Config config) {
        this.config = config != null ? config : new Idea197023Config();
