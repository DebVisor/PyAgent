...
@Data
public class Idea197056Config {
    private String name = "idea_197056";
 ...
 */
@Slf4j
public class Idea197056Service {
    private static final int IDEA_ID = 197056;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197056Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197056Service() {
        this(new Idea197056Config());
    }

    public Idea197056Service(Idea197056Config config) {
        this.config = config != null ? config : new Idea197056Config();
