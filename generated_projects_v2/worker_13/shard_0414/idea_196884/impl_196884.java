...
@Data
public class Idea196884Config {
    private String name = "idea_196884";
 ...
 */
@Slf4j
public class Idea196884Service {
    private static final int IDEA_ID = 196884;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196884Service() {
        this(new Idea196884Config());
    }

    public Idea196884Service(Idea196884Config config) {
        this.config = config != null ? config : new Idea196884Config();
