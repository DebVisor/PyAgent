...
@Data
public class Idea196712Config {
    private String name = "idea_196712";
 ...
 */
@Slf4j
public class Idea196712Service {
    private static final int IDEA_ID = 196712;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196712Service() {
        this(new Idea196712Config());
    }

    public Idea196712Service(Idea196712Config config) {
        this.config = config != null ? config : new Idea196712Config();
