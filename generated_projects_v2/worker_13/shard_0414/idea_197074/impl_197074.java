...
@Data
public class Idea197074Config {
    private String name = "idea_197074";
 ...
 */
@Slf4j
public class Idea197074Service {
    private static final int IDEA_ID = 197074;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197074Service() {
        this(new Idea197074Config());
    }

    public Idea197074Service(Idea197074Config config) {
        this.config = config != null ? config : new Idea197074Config();
