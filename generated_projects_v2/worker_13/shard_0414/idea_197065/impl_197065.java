...
@Data
public class Idea197065Config {
    private String name = "idea_197065";
 ...
 */
@Slf4j
public class Idea197065Service {
    private static final int IDEA_ID = 197065;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197065Service() {
        this(new Idea197065Config());
    }

    public Idea197065Service(Idea197065Config config) {
        this.config = config != null ? config : new Idea197065Config();
