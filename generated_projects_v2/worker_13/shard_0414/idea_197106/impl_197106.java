...
@Data
public class Idea197106Config {
    private String name = "idea_197106";
 ...
 */
@Slf4j
public class Idea197106Service {
    private static final int IDEA_ID = 197106;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197106Service() {
        this(new Idea197106Config());
    }

    public Idea197106Service(Idea197106Config config) {
        this.config = config != null ? config : new Idea197106Config();
