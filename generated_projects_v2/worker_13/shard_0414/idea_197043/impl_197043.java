...
@Data
public class Idea197043Config {
    private String name = "idea_197043";
 ...
 */
@Slf4j
public class Idea197043Service {
    private static final int IDEA_ID = 197043;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197043Service() {
        this(new Idea197043Config());
    }

    public Idea197043Service(Idea197043Config config) {
        this.config = config != null ? config : new Idea197043Config();
