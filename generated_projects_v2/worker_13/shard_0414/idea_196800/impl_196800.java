...
@Data
public class Idea196800Config {
    private String name = "idea_196800";
 ...
 */
@Slf4j
public class Idea196800Service {
    private static final int IDEA_ID = 196800;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196800Service() {
        this(new Idea196800Config());
    }

    public Idea196800Service(Idea196800Config config) {
        this.config = config != null ? config : new Idea196800Config();
