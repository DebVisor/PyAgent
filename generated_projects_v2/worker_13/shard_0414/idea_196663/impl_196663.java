...
@Data
public class Idea196663Config {
    private String name = "idea_196663";
 ...
 */
@Slf4j
public class Idea196663Service {
    private static final int IDEA_ID = 196663;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196663Service() {
        this(new Idea196663Config());
    }

    public Idea196663Service(Idea196663Config config) {
        this.config = config != null ? config : new Idea196663Config();
