...
@Data
public class Idea196768Config {
    private String name = "idea_196768";
 ...
 */
@Slf4j
public class Idea196768Service {
    private static final int IDEA_ID = 196768;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196768Service() {
        this(new Idea196768Config());
    }

    public Idea196768Service(Idea196768Config config) {
        this.config = config != null ? config : new Idea196768Config();
