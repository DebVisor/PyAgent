...
@Data
public class Idea196676Config {
    private String name = "idea_196676";
 ...
 */
@Slf4j
public class Idea196676Service {
    private static final int IDEA_ID = 196676;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196676Service() {
        this(new Idea196676Config());
    }

    public Idea196676Service(Idea196676Config config) {
        this.config = config != null ? config : new Idea196676Config();
