...
@Data
public class Idea196900Config {
    private String name = "idea_196900";
 ...
 */
@Slf4j
public class Idea196900Service {
    private static final int IDEA_ID = 196900;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196900Service() {
        this(new Idea196900Config());
    }

    public Idea196900Service(Idea196900Config config) {
        this.config = config != null ? config : new Idea196900Config();
