...
@Data
public class Idea196825Config {
    private String name = "idea_196825";
 ...
 */
@Slf4j
public class Idea196825Service {
    private static final int IDEA_ID = 196825;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196825Service() {
        this(new Idea196825Config());
    }

    public Idea196825Service(Idea196825Config config) {
        this.config = config != null ? config : new Idea196825Config();
