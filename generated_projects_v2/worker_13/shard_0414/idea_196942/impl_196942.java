...
@Data
public class Idea196942Config {
    private String name = "idea_196942";
 ...
 */
@Slf4j
public class Idea196942Service {
    private static final int IDEA_ID = 196942;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196942Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196942Service() {
        this(new Idea196942Config());
    }

    public Idea196942Service(Idea196942Config config) {
        this.config = config != null ? config : new Idea196942Config();
