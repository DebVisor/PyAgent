...
@Data
public class Idea196815Config {
    private String name = "idea_196815";
 ...
 */
@Slf4j
public class Idea196815Service {
    private static final int IDEA_ID = 196815;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196815Service() {
        this(new Idea196815Config());
    }

    public Idea196815Service(Idea196815Config config) {
        this.config = config != null ? config : new Idea196815Config();
