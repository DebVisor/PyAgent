...
@Data
public class Idea196903Config {
    private String name = "idea_196903";
 ...
 */
@Slf4j
public class Idea196903Service {
    private static final int IDEA_ID = 196903;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196903Service() {
        this(new Idea196903Config());
    }

    public Idea196903Service(Idea196903Config config) {
        this.config = config != null ? config : new Idea196903Config();
