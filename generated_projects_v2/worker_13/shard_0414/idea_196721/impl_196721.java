...
@Data
public class Idea196721Config {
    private String name = "idea_196721";
 ...
 */
@Slf4j
public class Idea196721Service {
    private static final int IDEA_ID = 196721;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196721Service() {
        this(new Idea196721Config());
    }

    public Idea196721Service(Idea196721Config config) {
        this.config = config != null ? config : new Idea196721Config();
