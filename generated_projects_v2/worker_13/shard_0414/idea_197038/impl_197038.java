...
@Data
public class Idea197038Config {
    private String name = "idea_197038";
 ...
 */
@Slf4j
public class Idea197038Service {
    private static final int IDEA_ID = 197038;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197038Service() {
        this(new Idea197038Config());
    }

    public Idea197038Service(Idea197038Config config) {
        this.config = config != null ? config : new Idea197038Config();
