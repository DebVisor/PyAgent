...
@Data
public class Idea196928Config {
    private String name = "idea_196928";
 ...
 */
@Slf4j
public class Idea196928Service {
    private static final int IDEA_ID = 196928;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196928Service() {
        this(new Idea196928Config());
    }

    public Idea196928Service(Idea196928Config config) {
        this.config = config != null ? config : new Idea196928Config();
