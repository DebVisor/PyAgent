...
@Data
public class Idea197099Config {
    private String name = "idea_197099";
 ...
 */
@Slf4j
public class Idea197099Service {
    private static final int IDEA_ID = 197099;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197099Service() {
        this(new Idea197099Config());
    }

    public Idea197099Service(Idea197099Config config) {
        this.config = config != null ? config : new Idea197099Config();
