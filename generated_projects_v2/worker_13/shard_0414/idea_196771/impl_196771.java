...
@Data
public class Idea196771Config {
    private String name = "idea_196771";
 ...
 */
@Slf4j
public class Idea196771Service {
    private static final int IDEA_ID = 196771;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196771Service() {
        this(new Idea196771Config());
    }

    public Idea196771Service(Idea196771Config config) {
        this.config = config != null ? config : new Idea196771Config();
