...
@Data
public class Idea196987Config {
    private String name = "idea_196987";
 ...
 */
@Slf4j
public class Idea196987Service {
    private static final int IDEA_ID = 196987;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196987Service() {
        this(new Idea196987Config());
    }

    public Idea196987Service(Idea196987Config config) {
        this.config = config != null ? config : new Idea196987Config();
