...
@Data
public class Idea196951Config {
    private String name = "idea_196951";
 ...
 */
@Slf4j
public class Idea196951Service {
    private static final int IDEA_ID = 196951;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196951Service() {
        this(new Idea196951Config());
    }

    public Idea196951Service(Idea196951Config config) {
        this.config = config != null ? config : new Idea196951Config();
