...
@Data
public class Idea196674Config {
    private String name = "idea_196674";
 ...
 */
@Slf4j
public class Idea196674Service {
    private static final int IDEA_ID = 196674;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196674Service() {
        this(new Idea196674Config());
    }

    public Idea196674Service(Idea196674Config config) {
        this.config = config != null ? config : new Idea196674Config();
