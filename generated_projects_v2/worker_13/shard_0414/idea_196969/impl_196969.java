...
@Data
public class Idea196969Config {
    private String name = "idea_196969";
 ...
 */
@Slf4j
public class Idea196969Service {
    private static final int IDEA_ID = 196969;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196969Service() {
        this(new Idea196969Config());
    }

    public Idea196969Service(Idea196969Config config) {
        this.config = config != null ? config : new Idea196969Config();
