...
@Data
public class Idea197039Config {
    private String name = "idea_197039";
 ...
 */
@Slf4j
public class Idea197039Service {
    private static final int IDEA_ID = 197039;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197039Service() {
        this(new Idea197039Config());
    }

    public Idea197039Service(Idea197039Config config) {
        this.config = config != null ? config : new Idea197039Config();
