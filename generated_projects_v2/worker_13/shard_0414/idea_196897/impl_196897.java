...
@Data
public class Idea196897Config {
    private String name = "idea_196897";
 ...
 */
@Slf4j
public class Idea196897Service {
    private static final int IDEA_ID = 196897;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196897Service() {
        this(new Idea196897Config());
    }

    public Idea196897Service(Idea196897Config config) {
        this.config = config != null ? config : new Idea196897Config();
