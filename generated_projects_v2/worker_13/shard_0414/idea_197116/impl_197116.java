...
@Data
public class Idea197116Config {
    private String name = "idea_197116";
 ...
 */
@Slf4j
public class Idea197116Service {
    private static final int IDEA_ID = 197116;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197116Service() {
        this(new Idea197116Config());
    }

    public Idea197116Service(Idea197116Config config) {
        this.config = config != null ? config : new Idea197116Config();
