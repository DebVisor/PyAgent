...
@Data
public class Idea196696Config {
    private String name = "idea_196696";
 ...
 */
@Slf4j
public class Idea196696Service {
    private static final int IDEA_ID = 196696;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196696Service() {
        this(new Idea196696Config());
    }

    public Idea196696Service(Idea196696Config config) {
        this.config = config != null ? config : new Idea196696Config();
