...
@Data
public class Idea197054Config {
    private String name = "idea_197054";
 ...
 */
@Slf4j
public class Idea197054Service {
    private static final int IDEA_ID = 197054;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197054Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197054Service() {
        this(new Idea197054Config());
    }

    public Idea197054Service(Idea197054Config config) {
        this.config = config != null ? config : new Idea197054Config();
