...
@Data
public class Idea196931Config {
    private String name = "idea_196931";
 ...
 */
@Slf4j
public class Idea196931Service {
    private static final int IDEA_ID = 196931;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196931Service() {
        this(new Idea196931Config());
    }

    public Idea196931Service(Idea196931Config config) {
        this.config = config != null ? config : new Idea196931Config();
