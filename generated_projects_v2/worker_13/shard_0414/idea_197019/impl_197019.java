...
@Data
public class Idea197019Config {
    private String name = "idea_197019";
 ...
 */
@Slf4j
public class Idea197019Service {
    private static final int IDEA_ID = 197019;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197019Service() {
        this(new Idea197019Config());
    }

    public Idea197019Service(Idea197019Config config) {
        this.config = config != null ? config : new Idea197019Config();
