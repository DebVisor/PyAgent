...
@Data
public class Idea197046Config {
    private String name = "idea_197046";
 ...
 */
@Slf4j
public class Idea197046Service {
    private static final int IDEA_ID = 197046;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197046Service() {
        this(new Idea197046Config());
    }

    public Idea197046Service(Idea197046Config config) {
        this.config = config != null ? config : new Idea197046Config();
