...
@Data
public class Idea197080Config {
    private String name = "idea_197080";
 ...
 */
@Slf4j
public class Idea197080Service {
    private static final int IDEA_ID = 197080;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197080Service() {
        this(new Idea197080Config());
    }

    public Idea197080Service(Idea197080Config config) {
        this.config = config != null ? config : new Idea197080Config();
