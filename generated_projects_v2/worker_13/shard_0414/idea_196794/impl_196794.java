...
@Data
public class Idea196794Config {
    private String name = "idea_196794";
 ...
 */
@Slf4j
public class Idea196794Service {
    private static final int IDEA_ID = 196794;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196794Service() {
        this(new Idea196794Config());
    }

    public Idea196794Service(Idea196794Config config) {
        this.config = config != null ? config : new Idea196794Config();
