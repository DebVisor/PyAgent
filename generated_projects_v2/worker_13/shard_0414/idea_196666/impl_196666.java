...
@Data
public class Idea196666Config {
    private String name = "idea_196666";
 ...
 */
@Slf4j
public class Idea196666Service {
    private static final int IDEA_ID = 196666;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196666Service() {
        this(new Idea196666Config());
    }

    public Idea196666Service(Idea196666Config config) {
        this.config = config != null ? config : new Idea196666Config();
