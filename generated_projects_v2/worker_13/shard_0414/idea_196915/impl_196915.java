...
@Data
public class Idea196915Config {
    private String name = "idea_196915";
 ...
 */
@Slf4j
public class Idea196915Service {
    private static final int IDEA_ID = 196915;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196915Service() {
        this(new Idea196915Config());
    }

    public Idea196915Service(Idea196915Config config) {
        this.config = config != null ? config : new Idea196915Config();
