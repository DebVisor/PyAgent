...
@Data
public class Idea197902Config {
    private String name = "idea_197902";
 ...
 */
@Slf4j
public class Idea197902Service {
    private static final int IDEA_ID = 197902;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197902Service() {
        this(new Idea197902Config());
    }

    public Idea197902Service(Idea197902Config config) {
        this.config = config != null ? config : new Idea197902Config();
