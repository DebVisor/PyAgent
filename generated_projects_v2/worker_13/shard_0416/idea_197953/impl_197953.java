...
@Data
public class Idea197953Config {
    private String name = "idea_197953";
 ...
 */
@Slf4j
public class Idea197953Service {
    private static final int IDEA_ID = 197953;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197953Service() {
        this(new Idea197953Config());
    }

    public Idea197953Service(Idea197953Config config) {
        this.config = config != null ? config : new Idea197953Config();
