...
@Data
public class Idea197925Config {
    private String name = "idea_197925";
 ...
 */
@Slf4j
public class Idea197925Service {
    private static final int IDEA_ID = 197925;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197925Service() {
        this(new Idea197925Config());
    }

    public Idea197925Service(Idea197925Config config) {
        this.config = config != null ? config : new Idea197925Config();
