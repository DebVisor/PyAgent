...
@Data
public class Idea197806Config {
    private String name = "idea_197806";
 ...
 */
@Slf4j
public class Idea197806Service {
    private static final int IDEA_ID = 197806;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197806Service() {
        this(new Idea197806Config());
    }

    public Idea197806Service(Idea197806Config config) {
        this.config = config != null ? config : new Idea197806Config();
