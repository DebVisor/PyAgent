...
@Data
public class Idea197755Config {
    private String name = "idea_197755";
 ...
 */
@Slf4j
public class Idea197755Service {
    private static final int IDEA_ID = 197755;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197755Service() {
        this(new Idea197755Config());
    }

    public Idea197755Service(Idea197755Config config) {
        this.config = config != null ? config : new Idea197755Config();
