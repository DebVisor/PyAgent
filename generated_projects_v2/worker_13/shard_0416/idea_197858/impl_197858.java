...
@Data
public class Idea197858Config {
    private String name = "idea_197858";
 ...
 */
@Slf4j
public class Idea197858Service {
    private static final int IDEA_ID = 197858;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197858Service() {
        this(new Idea197858Config());
    }

    public Idea197858Service(Idea197858Config config) {
        this.config = config != null ? config : new Idea197858Config();
