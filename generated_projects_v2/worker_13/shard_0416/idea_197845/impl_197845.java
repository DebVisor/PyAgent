...
@Data
public class Idea197845Config {
    private String name = "idea_197845";
 ...
 */
@Slf4j
public class Idea197845Service {
    private static final int IDEA_ID = 197845;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197845Service() {
        this(new Idea197845Config());
    }

    public Idea197845Service(Idea197845Config config) {
        this.config = config != null ? config : new Idea197845Config();
