...
@Data
public class Idea197977Config {
    private String name = "idea_197977";
 ...
 */
@Slf4j
public class Idea197977Service {
    private static final int IDEA_ID = 197977;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197977Service() {
        this(new Idea197977Config());
    }

    public Idea197977Service(Idea197977Config config) {
        this.config = config != null ? config : new Idea197977Config();
