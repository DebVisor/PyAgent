...
@Data
public class Idea197650Config {
    private String name = "idea_197650";
 ...
 */
@Slf4j
public class Idea197650Service {
    private static final int IDEA_ID = 197650;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197650Service() {
        this(new Idea197650Config());
    }

    public Idea197650Service(Idea197650Config config) {
        this.config = config != null ? config : new Idea197650Config();
