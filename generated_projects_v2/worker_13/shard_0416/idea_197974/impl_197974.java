...
@Data
public class Idea197974Config {
    private String name = "idea_197974";
 ...
 */
@Slf4j
public class Idea197974Service {
    private static final int IDEA_ID = 197974;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197974Service() {
        this(new Idea197974Config());
    }

    public Idea197974Service(Idea197974Config config) {
        this.config = config != null ? config : new Idea197974Config();
