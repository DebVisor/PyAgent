...
@Data
public class Idea197807Config {
    private String name = "idea_197807";
 ...
 */
@Slf4j
public class Idea197807Service {
    private static final int IDEA_ID = 197807;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197807Service() {
        this(new Idea197807Config());
    }

    public Idea197807Service(Idea197807Config config) {
        this.config = config != null ? config : new Idea197807Config();
