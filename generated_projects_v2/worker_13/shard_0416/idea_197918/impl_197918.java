...
@Data
public class Idea197918Config {
    private String name = "idea_197918";
 ...
 */
@Slf4j
public class Idea197918Service {
    private static final int IDEA_ID = 197918;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197918Service() {
        this(new Idea197918Config());
    }

    public Idea197918Service(Idea197918Config config) {
        this.config = config != null ? config : new Idea197918Config();
