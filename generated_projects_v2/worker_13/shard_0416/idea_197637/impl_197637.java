...
@Data
public class Idea197637Config {
    private String name = "idea_197637";
 ...
 */
@Slf4j
public class Idea197637Service {
    private static final int IDEA_ID = 197637;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197637Service() {
        this(new Idea197637Config());
    }

    public Idea197637Service(Idea197637Config config) {
        this.config = config != null ? config : new Idea197637Config();
