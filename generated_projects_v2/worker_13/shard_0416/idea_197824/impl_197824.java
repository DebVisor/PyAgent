...
@Data
public class Idea197824Config {
    private String name = "idea_197824";
 ...
 */
@Slf4j
public class Idea197824Service {
    private static final int IDEA_ID = 197824;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197824Service() {
        this(new Idea197824Config());
    }

    public Idea197824Service(Idea197824Config config) {
        this.config = config != null ? config : new Idea197824Config();
