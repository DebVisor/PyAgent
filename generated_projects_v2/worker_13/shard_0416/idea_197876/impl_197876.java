...
@Data
public class Idea197876Config {
    private String name = "idea_197876";
 ...
 */
@Slf4j
public class Idea197876Service {
    private static final int IDEA_ID = 197876;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197876Service() {
        this(new Idea197876Config());
    }

    public Idea197876Service(Idea197876Config config) {
        this.config = config != null ? config : new Idea197876Config();
