...
@Data
public class Idea197789Config {
    private String name = "idea_197789";
 ...
 */
@Slf4j
public class Idea197789Service {
    private static final int IDEA_ID = 197789;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197789Service() {
        this(new Idea197789Config());
    }

    public Idea197789Service(Idea197789Config config) {
        this.config = config != null ? config : new Idea197789Config();
