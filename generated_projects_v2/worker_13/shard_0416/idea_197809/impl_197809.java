...
@Data
public class Idea197809Config {
    private String name = "idea_197809";
 ...
 */
@Slf4j
public class Idea197809Service {
    private static final int IDEA_ID = 197809;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197809Service() {
        this(new Idea197809Config());
    }

    public Idea197809Service(Idea197809Config config) {
        this.config = config != null ? config : new Idea197809Config();
