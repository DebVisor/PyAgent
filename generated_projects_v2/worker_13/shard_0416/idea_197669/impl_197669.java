...
@Data
public class Idea197669Config {
    private String name = "idea_197669";
 ...
 */
@Slf4j
public class Idea197669Service {
    private static final int IDEA_ID = 197669;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197669Service() {
        this(new Idea197669Config());
    }

    public Idea197669Service(Idea197669Config config) {
        this.config = config != null ? config : new Idea197669Config();
