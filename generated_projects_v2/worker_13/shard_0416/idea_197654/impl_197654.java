...
@Data
public class Idea197654Config {
    private String name = "idea_197654";
 ...
 */
@Slf4j
public class Idea197654Service {
    private static final int IDEA_ID = 197654;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197654Service() {
        this(new Idea197654Config());
    }

    public Idea197654Service(Idea197654Config config) {
        this.config = config != null ? config : new Idea197654Config();
