...
@Data
public class Idea197715Config {
    private String name = "idea_197715";
 ...
 */
@Slf4j
public class Idea197715Service {
    private static final int IDEA_ID = 197715;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197715Service() {
        this(new Idea197715Config());
    }

    public Idea197715Service(Idea197715Config config) {
        this.config = config != null ? config : new Idea197715Config();
