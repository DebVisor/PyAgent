...
@Data
public class Idea197898Config {
    private String name = "idea_197898";
 ...
 */
@Slf4j
public class Idea197898Service {
    private static final int IDEA_ID = 197898;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197898Service() {
        this(new Idea197898Config());
    }

    public Idea197898Service(Idea197898Config config) {
        this.config = config != null ? config : new Idea197898Config();
