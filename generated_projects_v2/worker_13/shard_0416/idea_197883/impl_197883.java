...
@Data
public class Idea197883Config {
    private String name = "idea_197883";
 ...
 */
@Slf4j
public class Idea197883Service {
    private static final int IDEA_ID = 197883;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197883Service() {
        this(new Idea197883Config());
    }

    public Idea197883Service(Idea197883Config config) {
        this.config = config != null ? config : new Idea197883Config();
