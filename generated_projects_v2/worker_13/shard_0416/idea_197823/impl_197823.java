...
@Data
public class Idea197823Config {
    private String name = "idea_197823";
 ...
 */
@Slf4j
public class Idea197823Service {
    private static final int IDEA_ID = 197823;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197823Service() {
        this(new Idea197823Config());
    }

    public Idea197823Service(Idea197823Config config) {
        this.config = config != null ? config : new Idea197823Config();
