...
@Data
public class Idea197652Config {
    private String name = "idea_197652";
 ...
 */
@Slf4j
public class Idea197652Service {
    private static final int IDEA_ID = 197652;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197652Service() {
        this(new Idea197652Config());
    }

    public Idea197652Service(Idea197652Config config) {
        this.config = config != null ? config : new Idea197652Config();
