...
@Data
public class Idea197840Config {
    private String name = "idea_197840";
 ...
 */
@Slf4j
public class Idea197840Service {
    private static final int IDEA_ID = 197840;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197840Service() {
        this(new Idea197840Config());
    }

    public Idea197840Service(Idea197840Config config) {
        this.config = config != null ? config : new Idea197840Config();
