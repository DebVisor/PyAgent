...
@Data
public class Idea197957Config {
    private String name = "idea_197957";
 ...
 */
@Slf4j
public class Idea197957Service {
    private static final int IDEA_ID = 197957;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197957Service() {
        this(new Idea197957Config());
    }

    public Idea197957Service(Idea197957Config config) {
        this.config = config != null ? config : new Idea197957Config();
