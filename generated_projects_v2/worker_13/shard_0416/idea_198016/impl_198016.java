...
@Data
public class Idea198016Config {
    private String name = "idea_198016";
 ...
 */
@Slf4j
public class Idea198016Service {
    private static final int IDEA_ID = 198016;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198016Service() {
        this(new Idea198016Config());
    }

    public Idea198016Service(Idea198016Config config) {
        this.config = config != null ? config : new Idea198016Config();
