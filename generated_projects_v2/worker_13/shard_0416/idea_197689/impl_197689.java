...
@Data
public class Idea197689Config {
    private String name = "idea_197689";
 ...
 */
@Slf4j
public class Idea197689Service {
    private static final int IDEA_ID = 197689;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197689Service() {
        this(new Idea197689Config());
    }

    public Idea197689Service(Idea197689Config config) {
        this.config = config != null ? config : new Idea197689Config();
