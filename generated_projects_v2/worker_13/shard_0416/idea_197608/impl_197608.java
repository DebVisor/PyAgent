...
@Data
public class Idea197608Config {
    private String name = "idea_197608";
 ...
 */
@Slf4j
public class Idea197608Service {
    private static final int IDEA_ID = 197608;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197608Service() {
        this(new Idea197608Config());
    }

    public Idea197608Service(Idea197608Config config) {
        this.config = config != null ? config : new Idea197608Config();
