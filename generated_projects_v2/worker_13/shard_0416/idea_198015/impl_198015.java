...
@Data
public class Idea198015Config {
    private String name = "idea_198015";
 ...
 */
@Slf4j
public class Idea198015Service {
    private static final int IDEA_ID = 198015;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198015Service() {
        this(new Idea198015Config());
    }

    public Idea198015Service(Idea198015Config config) {
        this.config = config != null ? config : new Idea198015Config();
