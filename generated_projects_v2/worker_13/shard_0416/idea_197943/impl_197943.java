...
@Data
public class Idea197943Config {
    private String name = "idea_197943";
 ...
 */
@Slf4j
public class Idea197943Service {
    private static final int IDEA_ID = 197943;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197943Service() {
        this(new Idea197943Config());
    }

    public Idea197943Service(Idea197943Config config) {
        this.config = config != null ? config : new Idea197943Config();
