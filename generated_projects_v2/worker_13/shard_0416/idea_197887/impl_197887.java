...
@Data
public class Idea197887Config {
    private String name = "idea_197887";
 ...
 */
@Slf4j
public class Idea197887Service {
    private static final int IDEA_ID = 197887;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197887Service() {
        this(new Idea197887Config());
    }

    public Idea197887Service(Idea197887Config config) {
        this.config = config != null ? config : new Idea197887Config();
