...
@Data
public class Idea197649Config {
    private String name = "idea_197649";
 ...
 */
@Slf4j
public class Idea197649Service {
    private static final int IDEA_ID = 197649;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197649Service() {
        this(new Idea197649Config());
    }

    public Idea197649Service(Idea197649Config config) {
        this.config = config != null ? config : new Idea197649Config();
