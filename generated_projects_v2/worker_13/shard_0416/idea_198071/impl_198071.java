...
@Data
public class Idea198071Config {
    private String name = "idea_198071";
 ...
 */
@Slf4j
public class Idea198071Service {
    private static final int IDEA_ID = 198071;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198071Service() {
        this(new Idea198071Config());
    }

    public Idea198071Service(Idea198071Config config) {
        this.config = config != null ? config : new Idea198071Config();
