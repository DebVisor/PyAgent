...
@Data
public class Idea197646Config {
    private String name = "idea_197646";
 ...
 */
@Slf4j
public class Idea197646Service {
    private static final int IDEA_ID = 197646;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197646Service() {
        this(new Idea197646Config());
    }

    public Idea197646Service(Idea197646Config config) {
        this.config = config != null ? config : new Idea197646Config();
