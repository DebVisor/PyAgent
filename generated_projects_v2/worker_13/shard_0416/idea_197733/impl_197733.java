...
@Data
public class Idea197733Config {
    private String name = "idea_197733";
 ...
 */
@Slf4j
public class Idea197733Service {
    private static final int IDEA_ID = 197733;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197733Service() {
        this(new Idea197733Config());
    }

    public Idea197733Service(Idea197733Config config) {
        this.config = config != null ? config : new Idea197733Config();
