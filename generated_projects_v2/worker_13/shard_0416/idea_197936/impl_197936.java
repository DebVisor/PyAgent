...
@Data
public class Idea197936Config {
    private String name = "idea_197936";
 ...
 */
@Slf4j
public class Idea197936Service {
    private static final int IDEA_ID = 197936;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197936Service() {
        this(new Idea197936Config());
    }

    public Idea197936Service(Idea197936Config config) {
        this.config = config != null ? config : new Idea197936Config();
