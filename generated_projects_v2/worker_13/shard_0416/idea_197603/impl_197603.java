...
@Data
public class Idea197603Config {
    private String name = "idea_197603";
 ...
 */
@Slf4j
public class Idea197603Service {
    private static final int IDEA_ID = 197603;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197603Service() {
        this(new Idea197603Config());
    }

    public Idea197603Service(Idea197603Config config) {
        this.config = config != null ? config : new Idea197603Config();
