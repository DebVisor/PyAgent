...
@Data
public class Idea197816Config {
    private String name = "idea_197816";
 ...
 */
@Slf4j
public class Idea197816Service {
    private static final int IDEA_ID = 197816;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197816Service() {
        this(new Idea197816Config());
    }

    public Idea197816Service(Idea197816Config config) {
        this.config = config != null ? config : new Idea197816Config();
