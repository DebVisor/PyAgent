...
@Data
public class Idea197914Config {
    private String name = "idea_197914";
 ...
 */
@Slf4j
public class Idea197914Service {
    private static final int IDEA_ID = 197914;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197914Service() {
        this(new Idea197914Config());
    }

    public Idea197914Service(Idea197914Config config) {
        this.config = config != null ? config : new Idea197914Config();
