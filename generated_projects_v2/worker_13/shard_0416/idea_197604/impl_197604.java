...
@Data
public class Idea197604Config {
    private String name = "idea_197604";
 ...
 */
@Slf4j
public class Idea197604Service {
    private static final int IDEA_ID = 197604;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197604Service() {
        this(new Idea197604Config());
    }

    public Idea197604Service(Idea197604Config config) {
        this.config = config != null ? config : new Idea197604Config();
