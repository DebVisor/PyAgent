...
@Data
public class Idea197741Config {
    private String name = "idea_197741";
 ...
 */
@Slf4j
public class Idea197741Service {
    private static final int IDEA_ID = 197741;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197741Service() {
        this(new Idea197741Config());
    }

    public Idea197741Service(Idea197741Config config) {
        this.config = config != null ? config : new Idea197741Config();
