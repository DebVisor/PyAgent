...
@Data
public class Idea197722Config {
    private String name = "idea_197722";
 ...
 */
@Slf4j
public class Idea197722Service {
    private static final int IDEA_ID = 197722;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197722Service() {
        this(new Idea197722Config());
    }

    public Idea197722Service(Idea197722Config config) {
        this.config = config != null ? config : new Idea197722Config();
