...
@Data
public class Idea197727Config {
    private String name = "idea_197727";
 ...
 */
@Slf4j
public class Idea197727Service {
    private static final int IDEA_ID = 197727;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197727Service() {
        this(new Idea197727Config());
    }

    public Idea197727Service(Idea197727Config config) {
        this.config = config != null ? config : new Idea197727Config();
