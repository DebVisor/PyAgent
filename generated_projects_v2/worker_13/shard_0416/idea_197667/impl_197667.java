...
@Data
public class Idea197667Config {
    private String name = "idea_197667";
 ...
 */
@Slf4j
public class Idea197667Service {
    private static final int IDEA_ID = 197667;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197667Service() {
        this(new Idea197667Config());
    }

    public Idea197667Service(Idea197667Config config) {
        this.config = config != null ? config : new Idea197667Config();
