...
@Data
public class Idea197684Config {
    private String name = "idea_197684";
 ...
 */
@Slf4j
public class Idea197684Service {
    private static final int IDEA_ID = 197684;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197684Service() {
        this(new Idea197684Config());
    }

    public Idea197684Service(Idea197684Config config) {
        this.config = config != null ? config : new Idea197684Config();
