...
@Data
public class Idea197679Config {
    private String name = "idea_197679";
 ...
 */
@Slf4j
public class Idea197679Service {
    private static final int IDEA_ID = 197679;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197679Service() {
        this(new Idea197679Config());
    }

    public Idea197679Service(Idea197679Config config) {
        this.config = config != null ? config : new Idea197679Config();
