...
@Data
public class Idea197783Config {
    private String name = "idea_197783";
 ...
 */
@Slf4j
public class Idea197783Service {
    private static final int IDEA_ID = 197783;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197783Service() {
        this(new Idea197783Config());
    }

    public Idea197783Service(Idea197783Config config) {
        this.config = config != null ? config : new Idea197783Config();
