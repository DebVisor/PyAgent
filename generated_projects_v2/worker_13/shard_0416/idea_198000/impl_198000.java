...
@Data
public class Idea198000Config {
    private String name = "idea_198000";
 ...
 */
@Slf4j
public class Idea198000Service {
    private static final int IDEA_ID = 198000;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198000Service() {
        this(new Idea198000Config());
    }

    public Idea198000Service(Idea198000Config config) {
        this.config = config != null ? config : new Idea198000Config();
