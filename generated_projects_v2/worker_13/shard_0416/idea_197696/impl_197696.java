...
@Data
public class Idea197696Config {
    private String name = "idea_197696";
 ...
 */
@Slf4j
public class Idea197696Service {
    private static final int IDEA_ID = 197696;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197696Service() {
        this(new Idea197696Config());
    }

    public Idea197696Service(Idea197696Config config) {
        this.config = config != null ? config : new Idea197696Config();
