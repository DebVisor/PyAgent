...
@Data
public class Idea198057Config {
    private String name = "idea_198057";
 ...
 */
@Slf4j
public class Idea198057Service {
    private static final int IDEA_ID = 198057;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198057Service() {
        this(new Idea198057Config());
    }

    public Idea198057Service(Idea198057Config config) {
        this.config = config != null ? config : new Idea198057Config();
