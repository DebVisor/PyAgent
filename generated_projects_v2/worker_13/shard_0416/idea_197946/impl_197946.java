...
@Data
public class Idea197946Config {
    private String name = "idea_197946";
 ...
 */
@Slf4j
public class Idea197946Service {
    private static final int IDEA_ID = 197946;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197946Service() {
        this(new Idea197946Config());
    }

    public Idea197946Service(Idea197946Config config) {
        this.config = config != null ? config : new Idea197946Config();
