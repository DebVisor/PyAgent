...
@Data
public class Idea197784Config {
    private String name = "idea_197784";
 ...
 */
@Slf4j
public class Idea197784Service {
    private static final int IDEA_ID = 197784;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197784Service() {
        this(new Idea197784Config());
    }

    public Idea197784Service(Idea197784Config config) {
        this.config = config != null ? config : new Idea197784Config();
