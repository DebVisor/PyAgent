...
@Data
public class Idea197901Config {
    private String name = "idea_197901";
 ...
 */
@Slf4j
public class Idea197901Service {
    private static final int IDEA_ID = 197901;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197901Service() {
        this(new Idea197901Config());
    }

    public Idea197901Service(Idea197901Config config) {
        this.config = config != null ? config : new Idea197901Config();
