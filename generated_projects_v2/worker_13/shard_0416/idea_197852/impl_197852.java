...
@Data
public class Idea197852Config {
    private String name = "idea_197852";
 ...
 */
@Slf4j
public class Idea197852Service {
    private static final int IDEA_ID = 197852;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197852Service() {
        this(new Idea197852Config());
    }

    public Idea197852Service(Idea197852Config config) {
        this.config = config != null ? config : new Idea197852Config();
