...
@Data
public class Idea197796Config {
    private String name = "idea_197796";
 ...
 */
@Slf4j
public class Idea197796Service {
    private static final int IDEA_ID = 197796;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197796Service() {
        this(new Idea197796Config());
    }

    public Idea197796Service(Idea197796Config config) {
        this.config = config != null ? config : new Idea197796Config();
