...
@Data
public class Idea197986Config {
    private String name = "idea_197986";
 ...
 */
@Slf4j
public class Idea197986Service {
    private static final int IDEA_ID = 197986;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197986Service() {
        this(new Idea197986Config());
    }

    public Idea197986Service(Idea197986Config config) {
        this.config = config != null ? config : new Idea197986Config();
