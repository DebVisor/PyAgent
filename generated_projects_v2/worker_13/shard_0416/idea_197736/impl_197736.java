...
@Data
public class Idea197736Config {
    private String name = "idea_197736";
 ...
 */
@Slf4j
public class Idea197736Service {
    private static final int IDEA_ID = 197736;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197736Service() {
        this(new Idea197736Config());
    }

    public Idea197736Service(Idea197736Config config) {
        this.config = config != null ? config : new Idea197736Config();
