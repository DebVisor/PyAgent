...
@Data
public class Idea197704Config {
    private String name = "idea_197704";
 ...
 */
@Slf4j
public class Idea197704Service {
    private static final int IDEA_ID = 197704;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197704Service() {
        this(new Idea197704Config());
    }

    public Idea197704Service(Idea197704Config config) {
        this.config = config != null ? config : new Idea197704Config();
