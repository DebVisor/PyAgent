...
@Data
public class Idea197749Config {
    private String name = "idea_197749";
 ...
 */
@Slf4j
public class Idea197749Service {
    private static final int IDEA_ID = 197749;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197749Service() {
        this(new Idea197749Config());
    }

    public Idea197749Service(Idea197749Config config) {
        this.config = config != null ? config : new Idea197749Config();
