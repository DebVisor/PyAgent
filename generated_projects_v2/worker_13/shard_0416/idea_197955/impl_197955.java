...
@Data
public class Idea197955Config {
    private String name = "idea_197955";
 ...
 */
@Slf4j
public class Idea197955Service {
    private static final int IDEA_ID = 197955;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197955Service() {
        this(new Idea197955Config());
    }

    public Idea197955Service(Idea197955Config config) {
        this.config = config != null ? config : new Idea197955Config();
