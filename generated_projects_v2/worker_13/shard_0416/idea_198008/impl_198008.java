...
@Data
public class Idea198008Config {
    private String name = "idea_198008";
 ...
 */
@Slf4j
public class Idea198008Service {
    private static final int IDEA_ID = 198008;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198008Service() {
        this(new Idea198008Config());
    }

    public Idea198008Service(Idea198008Config config) {
        this.config = config != null ? config : new Idea198008Config();
