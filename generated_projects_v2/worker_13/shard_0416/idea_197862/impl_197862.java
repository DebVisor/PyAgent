...
@Data
public class Idea197862Config {
    private String name = "idea_197862";
 ...
 */
@Slf4j
public class Idea197862Service {
    private static final int IDEA_ID = 197862;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197862Service() {
        this(new Idea197862Config());
    }

    public Idea197862Service(Idea197862Config config) {
        this.config = config != null ? config : new Idea197862Config();
