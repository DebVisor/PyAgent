...
@Data
public class Idea197899Config {
    private String name = "idea_197899";
 ...
 */
@Slf4j
public class Idea197899Service {
    private static final int IDEA_ID = 197899;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197899Service() {
        this(new Idea197899Config());
    }

    public Idea197899Service(Idea197899Config config) {
        this.config = config != null ? config : new Idea197899Config();
