...
@Data
public class Idea198023Config {
    private String name = "idea_198023";
 ...
 */
@Slf4j
public class Idea198023Service {
    private static final int IDEA_ID = 198023;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198023Service() {
        this(new Idea198023Config());
    }

    public Idea198023Service(Idea198023Config config) {
        this.config = config != null ? config : new Idea198023Config();
