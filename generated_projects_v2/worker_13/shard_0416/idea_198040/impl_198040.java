...
@Data
public class Idea198040Config {
    private String name = "idea_198040";
 ...
 */
@Slf4j
public class Idea198040Service {
    private static final int IDEA_ID = 198040;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198040Service() {
        this(new Idea198040Config());
    }

    public Idea198040Service(Idea198040Config config) {
        this.config = config != null ? config : new Idea198040Config();
