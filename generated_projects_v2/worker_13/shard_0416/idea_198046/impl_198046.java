...
@Data
public class Idea198046Config {
    private String name = "idea_198046";
 ...
 */
@Slf4j
public class Idea198046Service {
    private static final int IDEA_ID = 198046;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198046Service() {
        this(new Idea198046Config());
    }

    public Idea198046Service(Idea198046Config config) {
        this.config = config != null ? config : new Idea198046Config();
