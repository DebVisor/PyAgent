...
@Data
public class Idea197690Config {
    private String name = "idea_197690";
 ...
 */
@Slf4j
public class Idea197690Service {
    private static final int IDEA_ID = 197690;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197690Service() {
        this(new Idea197690Config());
    }

    public Idea197690Service(Idea197690Config config) {
        this.config = config != null ? config : new Idea197690Config();
