...
@Data
public class Idea197907Config {
    private String name = "idea_197907";
 ...
 */
@Slf4j
public class Idea197907Service {
    private static final int IDEA_ID = 197907;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197907Service() {
        this(new Idea197907Config());
    }

    public Idea197907Service(Idea197907Config config) {
        this.config = config != null ? config : new Idea197907Config();
