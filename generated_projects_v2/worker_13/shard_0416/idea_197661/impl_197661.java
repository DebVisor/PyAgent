...
@Data
public class Idea197661Config {
    private String name = "idea_197661";
 ...
 */
@Slf4j
public class Idea197661Service {
    private static final int IDEA_ID = 197661;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197661Service() {
        this(new Idea197661Config());
    }

    public Idea197661Service(Idea197661Config config) {
        this.config = config != null ? config : new Idea197661Config();
