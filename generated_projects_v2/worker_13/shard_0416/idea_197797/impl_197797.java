...
@Data
public class Idea197797Config {
    private String name = "idea_197797";
 ...
 */
@Slf4j
public class Idea197797Service {
    private static final int IDEA_ID = 197797;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197797Service() {
        this(new Idea197797Config());
    }

    public Idea197797Service(Idea197797Config config) {
        this.config = config != null ? config : new Idea197797Config();
