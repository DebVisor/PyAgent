...
@Data
public class Idea198047Config {
    private String name = "idea_198047";
 ...
 */
@Slf4j
public class Idea198047Service {
    private static final int IDEA_ID = 198047;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198047Service() {
        this(new Idea198047Config());
    }

    public Idea198047Service(Idea198047Config config) {
        this.config = config != null ? config : new Idea198047Config();
