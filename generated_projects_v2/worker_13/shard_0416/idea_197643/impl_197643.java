...
@Data
public class Idea197643Config {
    private String name = "idea_197643";
 ...
 */
@Slf4j
public class Idea197643Service {
    private static final int IDEA_ID = 197643;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197643Service() {
        this(new Idea197643Config());
    }

    public Idea197643Service(Idea197643Config config) {
        this.config = config != null ? config : new Idea197643Config();
