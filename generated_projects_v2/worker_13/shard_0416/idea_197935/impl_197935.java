...
@Data
public class Idea197935Config {
    private String name = "idea_197935";
 ...
 */
@Slf4j
public class Idea197935Service {
    private static final int IDEA_ID = 197935;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197935Service() {
        this(new Idea197935Config());
    }

    public Idea197935Service(Idea197935Config config) {
        this.config = config != null ? config : new Idea197935Config();
