...
@Data
public class Idea197612Config {
    private String name = "idea_197612";
 ...
 */
@Slf4j
public class Idea197612Service {
    private static final int IDEA_ID = 197612;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197612Service() {
        this(new Idea197612Config());
    }

    public Idea197612Service(Idea197612Config config) {
        this.config = config != null ? config : new Idea197612Config();
