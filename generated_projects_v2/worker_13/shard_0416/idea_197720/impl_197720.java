...
@Data
public class Idea197720Config {
    private String name = "idea_197720";
 ...
 */
@Slf4j
public class Idea197720Service {
    private static final int IDEA_ID = 197720;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197720Service() {
        this(new Idea197720Config());
    }

    public Idea197720Service(Idea197720Config config) {
        this.config = config != null ? config : new Idea197720Config();
