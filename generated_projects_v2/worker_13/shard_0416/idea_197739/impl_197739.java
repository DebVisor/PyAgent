...
@Data
public class Idea197739Config {
    private String name = "idea_197739";
 ...
 */
@Slf4j
public class Idea197739Service {
    private static final int IDEA_ID = 197739;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197739Service() {
        this(new Idea197739Config());
    }

    public Idea197739Service(Idea197739Config config) {
        this.config = config != null ? config : new Idea197739Config();
