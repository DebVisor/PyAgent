...
@Data
public class Idea197895Config {
    private String name = "idea_197895";
 ...
 */
@Slf4j
public class Idea197895Service {
    private static final int IDEA_ID = 197895;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197895Service() {
        this(new Idea197895Config());
    }

    public Idea197895Service(Idea197895Config config) {
        this.config = config != null ? config : new Idea197895Config();
