...
@Data
public class Idea197865Config {
    private String name = "idea_197865";
 ...
 */
@Slf4j
public class Idea197865Service {
    private static final int IDEA_ID = 197865;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197865Service() {
        this(new Idea197865Config());
    }

    public Idea197865Service(Idea197865Config config) {
        this.config = config != null ? config : new Idea197865Config();
