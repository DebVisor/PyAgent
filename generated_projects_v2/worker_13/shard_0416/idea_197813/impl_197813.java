...
@Data
public class Idea197813Config {
    private String name = "idea_197813";
 ...
 */
@Slf4j
public class Idea197813Service {
    private static final int IDEA_ID = 197813;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197813Service() {
        this(new Idea197813Config());
    }

    public Idea197813Service(Idea197813Config config) {
        this.config = config != null ? config : new Idea197813Config();
