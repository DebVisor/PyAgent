...
@Data
public class Idea197793Config {
    private String name = "idea_197793";
 ...
 */
@Slf4j
public class Idea197793Service {
    private static final int IDEA_ID = 197793;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197793Service() {
        this(new Idea197793Config());
    }

    public Idea197793Service(Idea197793Config config) {
        this.config = config != null ? config : new Idea197793Config();
