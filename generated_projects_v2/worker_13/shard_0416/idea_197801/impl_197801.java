...
@Data
public class Idea197801Config {
    private String name = "idea_197801";
 ...
 */
@Slf4j
public class Idea197801Service {
    private static final int IDEA_ID = 197801;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197801Service() {
        this(new Idea197801Config());
    }

    public Idea197801Service(Idea197801Config config) {
        this.config = config != null ? config : new Idea197801Config();
