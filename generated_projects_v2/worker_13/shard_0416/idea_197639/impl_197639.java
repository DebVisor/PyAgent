...
@Data
public class Idea197639Config {
    private String name = "idea_197639";
 ...
 */
@Slf4j
public class Idea197639Service {
    private static final int IDEA_ID = 197639;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197639Service() {
        this(new Idea197639Config());
    }

    public Idea197639Service(Idea197639Config config) {
        this.config = config != null ? config : new Idea197639Config();
