...
@Data
public class Idea198011Config {
    private String name = "idea_198011";
 ...
 */
@Slf4j
public class Idea198011Service {
    private static final int IDEA_ID = 198011;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198011Service() {
        this(new Idea198011Config());
    }

    public Idea198011Service(Idea198011Config config) {
        this.config = config != null ? config : new Idea198011Config();
