...
@Data
public class Idea197705Config {
    private String name = "idea_197705";
 ...
 */
@Slf4j
public class Idea197705Service {
    private static final int IDEA_ID = 197705;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197705Service() {
        this(new Idea197705Config());
    }

    public Idea197705Service(Idea197705Config config) {
        this.config = config != null ? config : new Idea197705Config();
