...
@Data
public class Idea197934Config {
    private String name = "idea_197934";
 ...
 */
@Slf4j
public class Idea197934Service {
    private static final int IDEA_ID = 197934;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197934Service() {
        this(new Idea197934Config());
    }

    public Idea197934Service(Idea197934Config config) {
        this.config = config != null ? config : new Idea197934Config();
