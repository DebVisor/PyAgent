...
@Data
public class Idea197841Config {
    private String name = "idea_197841";
 ...
 */
@Slf4j
public class Idea197841Service {
    private static final int IDEA_ID = 197841;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197841Service() {
        this(new Idea197841Config());
    }

    public Idea197841Service(Idea197841Config config) {
        this.config = config != null ? config : new Idea197841Config();
