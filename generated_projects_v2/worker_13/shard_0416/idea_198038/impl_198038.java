...
@Data
public class Idea198038Config {
    private String name = "idea_198038";
 ...
 */
@Slf4j
public class Idea198038Service {
    private static final int IDEA_ID = 198038;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198038Service() {
        this(new Idea198038Config());
    }

    public Idea198038Service(Idea198038Config config) {
        this.config = config != null ? config : new Idea198038Config();
