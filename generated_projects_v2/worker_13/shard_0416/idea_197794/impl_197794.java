...
@Data
public class Idea197794Config {
    private String name = "idea_197794";
 ...
 */
@Slf4j
public class Idea197794Service {
    private static final int IDEA_ID = 197794;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197794Service() {
        this(new Idea197794Config());
    }

    public Idea197794Service(Idea197794Config config) {
        this.config = config != null ? config : new Idea197794Config();
