...
@Data
public class Idea198064Config {
    private String name = "idea_198064";
 ...
 */
@Slf4j
public class Idea198064Service {
    private static final int IDEA_ID = 198064;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198064Service() {
        this(new Idea198064Config());
    }

    public Idea198064Service(Idea198064Config config) {
        this.config = config != null ? config : new Idea198064Config();
