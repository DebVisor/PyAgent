...
@Data
public class Idea197950Config {
    private String name = "idea_197950";
 ...
 */
@Slf4j
public class Idea197950Service {
    private static final int IDEA_ID = 197950;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197950Service() {
        this(new Idea197950Config());
    }

    public Idea197950Service(Idea197950Config config) {
        this.config = config != null ? config : new Idea197950Config();
