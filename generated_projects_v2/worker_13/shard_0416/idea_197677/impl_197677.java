...
@Data
public class Idea197677Config {
    private String name = "idea_197677";
 ...
 */
@Slf4j
public class Idea197677Service {
    private static final int IDEA_ID = 197677;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197677Service() {
        this(new Idea197677Config());
    }

    public Idea197677Service(Idea197677Config config) {
        this.config = config != null ? config : new Idea197677Config();
