...
@Data
public class Idea198072Config {
    private String name = "idea_198072";
 ...
 */
@Slf4j
public class Idea198072Service {
    private static final int IDEA_ID = 198072;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198072Service() {
        this(new Idea198072Config());
    }

    public Idea198072Service(Idea198072Config config) {
        this.config = config != null ? config : new Idea198072Config();
