...
@Data
public class Idea197906Config {
    private String name = "idea_197906";
 ...
 */
@Slf4j
public class Idea197906Service {
    private static final int IDEA_ID = 197906;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197906Service() {
        this(new Idea197906Config());
    }

    public Idea197906Service(Idea197906Config config) {
        this.config = config != null ? config : new Idea197906Config();
