...
@Data
public class Idea197768Config {
    private String name = "idea_197768";
 ...
 */
@Slf4j
public class Idea197768Service {
    private static final int IDEA_ID = 197768;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197768Service() {
        this(new Idea197768Config());
    }

    public Idea197768Service(Idea197768Config config) {
        this.config = config != null ? config : new Idea197768Config();
