...
@Data
public class Idea198022Config {
    private String name = "idea_198022";
 ...
 */
@Slf4j
public class Idea198022Service {
    private static final int IDEA_ID = 198022;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198022Service() {
        this(new Idea198022Config());
    }

    public Idea198022Service(Idea198022Config config) {
        this.config = config != null ? config : new Idea198022Config();
