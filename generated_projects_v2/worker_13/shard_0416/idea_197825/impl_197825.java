...
@Data
public class Idea197825Config {
    private String name = "idea_197825";
 ...
 */
@Slf4j
public class Idea197825Service {
    private static final int IDEA_ID = 197825;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197825Service() {
        this(new Idea197825Config());
    }

    public Idea197825Service(Idea197825Config config) {
        this.config = config != null ? config : new Idea197825Config();
