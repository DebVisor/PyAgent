...
@Data
public class Idea197747Config {
    private String name = "idea_197747";
 ...
 */
@Slf4j
public class Idea197747Service {
    private static final int IDEA_ID = 197747;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197747Service() {
        this(new Idea197747Config());
    }

    public Idea197747Service(Idea197747Config config) {
        this.config = config != null ? config : new Idea197747Config();
