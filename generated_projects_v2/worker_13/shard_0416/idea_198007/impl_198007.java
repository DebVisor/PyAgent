...
@Data
public class Idea198007Config {
    private String name = "idea_198007";
 ...
 */
@Slf4j
public class Idea198007Service {
    private static final int IDEA_ID = 198007;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198007Service() {
        this(new Idea198007Config());
    }

    public Idea198007Service(Idea198007Config config) {
        this.config = config != null ? config : new Idea198007Config();
