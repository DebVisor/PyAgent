...
@Data
public class Idea197635Config {
    private String name = "idea_197635";
 ...
 */
@Slf4j
public class Idea197635Service {
    private static final int IDEA_ID = 197635;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197635Service() {
        this(new Idea197635Config());
    }

    public Idea197635Service(Idea197635Config config) {
        this.config = config != null ? config : new Idea197635Config();
