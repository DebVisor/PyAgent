...
@Data
public class Idea197811Config {
    private String name = "idea_197811";
 ...
 */
@Slf4j
public class Idea197811Service {
    private static final int IDEA_ID = 197811;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197811Service() {
        this(new Idea197811Config());
    }

    public Idea197811Service(Idea197811Config config) {
        this.config = config != null ? config : new Idea197811Config();
