...
@Data
public class Idea198019Config {
    private String name = "idea_198019";
 ...
 */
@Slf4j
public class Idea198019Service {
    private static final int IDEA_ID = 198019;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198019Service() {
        this(new Idea198019Config());
    }

    public Idea198019Service(Idea198019Config config) {
        this.config = config != null ? config : new Idea198019Config();
