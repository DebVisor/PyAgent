...
@Data
public class Idea197979Config {
    private String name = "idea_197979";
 ...
 */
@Slf4j
public class Idea197979Service {
    private static final int IDEA_ID = 197979;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197979Service() {
        this(new Idea197979Config());
    }

    public Idea197979Service(Idea197979Config config) {
        this.config = config != null ? config : new Idea197979Config();
