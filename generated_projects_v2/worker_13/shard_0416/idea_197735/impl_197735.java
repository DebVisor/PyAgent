...
@Data
public class Idea197735Config {
    private String name = "idea_197735";
 ...
 */
@Slf4j
public class Idea197735Service {
    private static final int IDEA_ID = 197735;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197735Service() {
        this(new Idea197735Config());
    }

    public Idea197735Service(Idea197735Config config) {
        this.config = config != null ? config : new Idea197735Config();
