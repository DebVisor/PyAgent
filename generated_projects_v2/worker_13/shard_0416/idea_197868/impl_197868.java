...
@Data
public class Idea197868Config {
    private String name = "idea_197868";
 ...
 */
@Slf4j
public class Idea197868Service {
    private static final int IDEA_ID = 197868;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197868Service() {
        this(new Idea197868Config());
    }

    public Idea197868Service(Idea197868Config config) {
        this.config = config != null ? config : new Idea197868Config();
