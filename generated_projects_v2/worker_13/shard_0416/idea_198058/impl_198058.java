...
@Data
public class Idea198058Config {
    private String name = "idea_198058";
 ...
 */
@Slf4j
public class Idea198058Service {
    private static final int IDEA_ID = 198058;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198058Service() {
        this(new Idea198058Config());
    }

    public Idea198058Service(Idea198058Config config) {
        this.config = config != null ? config : new Idea198058Config();
