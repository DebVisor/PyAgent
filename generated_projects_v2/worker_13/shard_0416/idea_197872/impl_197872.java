...
@Data
public class Idea197872Config {
    private String name = "idea_197872";
 ...
 */
@Slf4j
public class Idea197872Service {
    private static final int IDEA_ID = 197872;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197872Service() {
        this(new Idea197872Config());
    }

    public Idea197872Service(Idea197872Config config) {
        this.config = config != null ? config : new Idea197872Config();
