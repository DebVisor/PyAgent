...
@Data
public class Idea197678Config {
    private String name = "idea_197678";
 ...
 */
@Slf4j
public class Idea197678Service {
    private static final int IDEA_ID = 197678;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197678Service() {
        this(new Idea197678Config());
    }

    public Idea197678Service(Idea197678Config config) {
        this.config = config != null ? config : new Idea197678Config();
