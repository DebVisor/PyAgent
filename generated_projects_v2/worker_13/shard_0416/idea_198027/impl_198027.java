...
@Data
public class Idea198027Config {
    private String name = "idea_198027";
 ...
 */
@Slf4j
public class Idea198027Service {
    private static final int IDEA_ID = 198027;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198027Service() {
        this(new Idea198027Config());
    }

    public Idea198027Service(Idea198027Config config) {
        this.config = config != null ? config : new Idea198027Config();
