...
@Data
public class Idea197994Config {
    private String name = "idea_197994";
 ...
 */
@Slf4j
public class Idea197994Service {
    private static final int IDEA_ID = 197994;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197994Service() {
        this(new Idea197994Config());
    }

    public Idea197994Service(Idea197994Config config) {
        this.config = config != null ? config : new Idea197994Config();
