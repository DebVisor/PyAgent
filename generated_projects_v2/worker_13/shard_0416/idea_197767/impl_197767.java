...
@Data
public class Idea197767Config {
    private String name = "idea_197767";
 ...
 */
@Slf4j
public class Idea197767Service {
    private static final int IDEA_ID = 197767;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197767Service() {
        this(new Idea197767Config());
    }

    public Idea197767Service(Idea197767Config config) {
        this.config = config != null ? config : new Idea197767Config();
