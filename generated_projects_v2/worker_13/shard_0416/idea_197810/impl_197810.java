...
@Data
public class Idea197810Config {
    private String name = "idea_197810";
 ...
 */
@Slf4j
public class Idea197810Service {
    private static final int IDEA_ID = 197810;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197810Service() {
        this(new Idea197810Config());
    }

    public Idea197810Service(Idea197810Config config) {
        this.config = config != null ? config : new Idea197810Config();
