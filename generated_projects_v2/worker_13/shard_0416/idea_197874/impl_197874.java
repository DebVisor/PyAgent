...
@Data
public class Idea197874Config {
    private String name = "idea_197874";
 ...
 */
@Slf4j
public class Idea197874Service {
    private static final int IDEA_ID = 197874;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197874Service() {
        this(new Idea197874Config());
    }

    public Idea197874Service(Idea197874Config config) {
        this.config = config != null ? config : new Idea197874Config();
