...
@Data
public class Idea197921Config {
    private String name = "idea_197921";
 ...
 */
@Slf4j
public class Idea197921Service {
    private static final int IDEA_ID = 197921;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197921Service() {
        this(new Idea197921Config());
    }

    public Idea197921Service(Idea197921Config config) {
        this.config = config != null ? config : new Idea197921Config();
