...
@Data
public class Idea197880Config {
    private String name = "idea_197880";
 ...
 */
@Slf4j
public class Idea197880Service {
    private static final int IDEA_ID = 197880;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197880Service() {
        this(new Idea197880Config());
    }

    public Idea197880Service(Idea197880Config config) {
        this.config = config != null ? config : new Idea197880Config();
