...
@Data
public class Idea197615Config {
    private String name = "idea_197615";
 ...
 */
@Slf4j
public class Idea197615Service {
    private static final int IDEA_ID = 197615;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197615Service() {
        this(new Idea197615Config());
    }

    public Idea197615Service(Idea197615Config config) {
        this.config = config != null ? config : new Idea197615Config();
