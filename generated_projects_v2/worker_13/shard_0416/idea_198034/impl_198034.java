...
@Data
public class Idea198034Config {
    private String name = "idea_198034";
 ...
 */
@Slf4j
public class Idea198034Service {
    private static final int IDEA_ID = 198034;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198034Service() {
        this(new Idea198034Config());
    }

    public Idea198034Service(Idea198034Config config) {
        this.config = config != null ? config : new Idea198034Config();
