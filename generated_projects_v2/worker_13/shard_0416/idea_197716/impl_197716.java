...
@Data
public class Idea197716Config {
    private String name = "idea_197716";
 ...
 */
@Slf4j
public class Idea197716Service {
    private static final int IDEA_ID = 197716;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197716Service() {
        this(new Idea197716Config());
    }

    public Idea197716Service(Idea197716Config config) {
        this.config = config != null ? config : new Idea197716Config();
