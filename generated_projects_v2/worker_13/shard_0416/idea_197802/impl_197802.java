...
@Data
public class Idea197802Config {
    private String name = "idea_197802";
 ...
 */
@Slf4j
public class Idea197802Service {
    private static final int IDEA_ID = 197802;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197802Service() {
        this(new Idea197802Config());
    }

    public Idea197802Service(Idea197802Config config) {
        this.config = config != null ? config : new Idea197802Config();
