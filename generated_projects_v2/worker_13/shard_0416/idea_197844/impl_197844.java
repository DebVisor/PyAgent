...
@Data
public class Idea197844Config {
    private String name = "idea_197844";
 ...
 */
@Slf4j
public class Idea197844Service {
    private static final int IDEA_ID = 197844;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197844Service() {
        this(new Idea197844Config());
    }

    public Idea197844Service(Idea197844Config config) {
        this.config = config != null ? config : new Idea197844Config();
