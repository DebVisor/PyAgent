...
@Data
public class Idea197989Config {
    private String name = "idea_197989";
 ...
 */
@Slf4j
public class Idea197989Service {
    private static final int IDEA_ID = 197989;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197989Service() {
        this(new Idea197989Config());
    }

    public Idea197989Service(Idea197989Config config) {
        this.config = config != null ? config : new Idea197989Config();
