...
@Data
public class Idea198041Config {
    private String name = "idea_198041";
 ...
 */
@Slf4j
public class Idea198041Service {
    private static final int IDEA_ID = 198041;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198041Service() {
        this(new Idea198041Config());
    }

    public Idea198041Service(Idea198041Config config) {
        this.config = config != null ? config : new Idea198041Config();
