...
@Data
public class Idea197847Config {
    private String name = "idea_197847";
 ...
 */
@Slf4j
public class Idea197847Service {
    private static final int IDEA_ID = 197847;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197847Service() {
        this(new Idea197847Config());
    }

    public Idea197847Service(Idea197847Config config) {
        this.config = config != null ? config : new Idea197847Config();
