...
@Data
public class Idea197854Config {
    private String name = "idea_197854";
 ...
 */
@Slf4j
public class Idea197854Service {
    private static final int IDEA_ID = 197854;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197854Service() {
        this(new Idea197854Config());
    }

    public Idea197854Service(Idea197854Config config) {
        this.config = config != null ? config : new Idea197854Config();
