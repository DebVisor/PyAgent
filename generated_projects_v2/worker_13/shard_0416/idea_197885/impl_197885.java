...
@Data
public class Idea197885Config {
    private String name = "idea_197885";
 ...
 */
@Slf4j
public class Idea197885Service {
    private static final int IDEA_ID = 197885;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197885Service() {
        this(new Idea197885Config());
    }

    public Idea197885Service(Idea197885Config config) {
        this.config = config != null ? config : new Idea197885Config();
