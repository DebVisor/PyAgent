...
@Data
public class Idea198074Config {
    private String name = "idea_198074";
 ...
 */
@Slf4j
public class Idea198074Service {
    private static final int IDEA_ID = 198074;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198074Service() {
        this(new Idea198074Config());
    }

    public Idea198074Service(Idea198074Config config) {
        this.config = config != null ? config : new Idea198074Config();
