...
@Data
public class Idea197829Config {
    private String name = "idea_197829";
 ...
 */
@Slf4j
public class Idea197829Service {
    private static final int IDEA_ID = 197829;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197829Service() {
        this(new Idea197829Config());
    }

    public Idea197829Service(Idea197829Config config) {
        this.config = config != null ? config : new Idea197829Config();
