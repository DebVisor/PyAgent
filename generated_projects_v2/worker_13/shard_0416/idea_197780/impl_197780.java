...
@Data
public class Idea197780Config {
    private String name = "idea_197780";
 ...
 */
@Slf4j
public class Idea197780Service {
    private static final int IDEA_ID = 197780;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197780Service() {
        this(new Idea197780Config());
    }

    public Idea197780Service(Idea197780Config config) {
        this.config = config != null ? config : new Idea197780Config();
