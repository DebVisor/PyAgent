...
@Data
public class Idea197675Config {
    private String name = "idea_197675";
 ...
 */
@Slf4j
public class Idea197675Service {
    private static final int IDEA_ID = 197675;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197675Service() {
        this(new Idea197675Config());
    }

    public Idea197675Service(Idea197675Config config) {
        this.config = config != null ? config : new Idea197675Config();
