...
@Data
public class Idea197864Config {
    private String name = "idea_197864";
 ...
 */
@Slf4j
public class Idea197864Service {
    private static final int IDEA_ID = 197864;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197864Service() {
        this(new Idea197864Config());
    }

    public Idea197864Service(Idea197864Config config) {
        this.config = config != null ? config : new Idea197864Config();
