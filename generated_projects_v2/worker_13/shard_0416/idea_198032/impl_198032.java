...
@Data
public class Idea198032Config {
    private String name = "idea_198032";
 ...
 */
@Slf4j
public class Idea198032Service {
    private static final int IDEA_ID = 198032;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198032Service() {
        this(new Idea198032Config());
    }

    public Idea198032Service(Idea198032Config config) {
        this.config = config != null ? config : new Idea198032Config();
