...
@Data
public class Idea198010Config {
    private String name = "idea_198010";
 ...
 */
@Slf4j
public class Idea198010Service {
    private static final int IDEA_ID = 198010;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198010Service() {
        this(new Idea198010Config());
    }

    public Idea198010Service(Idea198010Config config) {
        this.config = config != null ? config : new Idea198010Config();
