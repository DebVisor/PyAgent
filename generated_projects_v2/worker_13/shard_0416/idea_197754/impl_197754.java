...
@Data
public class Idea197754Config {
    private String name = "idea_197754";
 ...
 */
@Slf4j
public class Idea197754Service {
    private static final int IDEA_ID = 197754;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197754Service() {
        this(new Idea197754Config());
    }

    public Idea197754Service(Idea197754Config config) {
        this.config = config != null ? config : new Idea197754Config();
