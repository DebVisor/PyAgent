...
@Data
public class Idea197685Config {
    private String name = "idea_197685";
 ...
 */
@Slf4j
public class Idea197685Service {
    private static final int IDEA_ID = 197685;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197685Service() {
        this(new Idea197685Config());
    }

    public Idea197685Service(Idea197685Config config) {
        this.config = config != null ? config : new Idea197685Config();
