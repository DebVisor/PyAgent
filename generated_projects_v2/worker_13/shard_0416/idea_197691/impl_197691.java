...
@Data
public class Idea197691Config {
    private String name = "idea_197691";
 ...
 */
@Slf4j
public class Idea197691Service {
    private static final int IDEA_ID = 197691;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197691Service() {
        this(new Idea197691Config());
    }

    public Idea197691Service(Idea197691Config config) {
        this.config = config != null ? config : new Idea197691Config();
