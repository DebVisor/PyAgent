...
@Data
public class Idea197983Config {
    private String name = "idea_197983";
 ...
 */
@Slf4j
public class Idea197983Service {
    private static final int IDEA_ID = 197983;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197983Service() {
        this(new Idea197983Config());
    }

    public Idea197983Service(Idea197983Config config) {
        this.config = config != null ? config : new Idea197983Config();
