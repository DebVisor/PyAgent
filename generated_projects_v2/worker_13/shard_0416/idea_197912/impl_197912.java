...
@Data
public class Idea197912Config {
    private String name = "idea_197912";
 ...
 */
@Slf4j
public class Idea197912Service {
    private static final int IDEA_ID = 197912;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197912Service() {
        this(new Idea197912Config());
    }

    public Idea197912Service(Idea197912Config config) {
        this.config = config != null ? config : new Idea197912Config();
