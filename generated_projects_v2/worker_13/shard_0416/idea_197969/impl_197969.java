...
@Data
public class Idea197969Config {
    private String name = "idea_197969";
 ...
 */
@Slf4j
public class Idea197969Service {
    private static final int IDEA_ID = 197969;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197969Service() {
        this(new Idea197969Config());
    }

    public Idea197969Service(Idea197969Config config) {
        this.config = config != null ? config : new Idea197969Config();
