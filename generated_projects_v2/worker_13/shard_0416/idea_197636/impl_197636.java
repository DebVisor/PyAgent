...
@Data
public class Idea197636Config {
    private String name = "idea_197636";
 ...
 */
@Slf4j
public class Idea197636Service {
    private static final int IDEA_ID = 197636;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197636Service() {
        this(new Idea197636Config());
    }

    public Idea197636Service(Idea197636Config config) {
        this.config = config != null ? config : new Idea197636Config();
