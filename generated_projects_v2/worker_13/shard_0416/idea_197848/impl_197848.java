...
@Data
public class Idea197848Config {
    private String name = "idea_197848";
 ...
 */
@Slf4j
public class Idea197848Service {
    private static final int IDEA_ID = 197848;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197848Service() {
        this(new Idea197848Config());
    }

    public Idea197848Service(Idea197848Config config) {
        this.config = config != null ? config : new Idea197848Config();
