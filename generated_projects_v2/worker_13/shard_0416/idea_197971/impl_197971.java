...
@Data
public class Idea197971Config {
    private String name = "idea_197971";
 ...
 */
@Slf4j
public class Idea197971Service {
    private static final int IDEA_ID = 197971;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197971Service() {
        this(new Idea197971Config());
    }

    public Idea197971Service(Idea197971Config config) {
        this.config = config != null ? config : new Idea197971Config();
