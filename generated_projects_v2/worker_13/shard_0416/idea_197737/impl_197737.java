...
@Data
public class Idea197737Config {
    private String name = "idea_197737";
 ...
 */
@Slf4j
public class Idea197737Service {
    private static final int IDEA_ID = 197737;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197737Service() {
        this(new Idea197737Config());
    }

    public Idea197737Service(Idea197737Config config) {
        this.config = config != null ? config : new Idea197737Config();
