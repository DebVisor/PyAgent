...
@Data
public class Idea197645Config {
    private String name = "idea_197645";
 ...
 */
@Slf4j
public class Idea197645Service {
    private static final int IDEA_ID = 197645;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197645Service() {
        this(new Idea197645Config());
    }

    public Idea197645Service(Idea197645Config config) {
        this.config = config != null ? config : new Idea197645Config();
