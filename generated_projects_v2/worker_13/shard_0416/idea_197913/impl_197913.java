...
@Data
public class Idea197913Config {
    private String name = "idea_197913";
 ...
 */
@Slf4j
public class Idea197913Service {
    private static final int IDEA_ID = 197913;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197913Service() {
        this(new Idea197913Config());
    }

    public Idea197913Service(Idea197913Config config) {
        this.config = config != null ? config : new Idea197913Config();
