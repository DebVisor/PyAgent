...
@Data
public class Idea197699Config {
    private String name = "idea_197699";
 ...
 */
@Slf4j
public class Idea197699Service {
    private static final int IDEA_ID = 197699;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197699Service() {
        this(new Idea197699Config());
    }

    public Idea197699Service(Idea197699Config config) {
        this.config = config != null ? config : new Idea197699Config();
