...
@Data
public class Idea197997Config {
    private String name = "idea_197997";
 ...
 */
@Slf4j
public class Idea197997Service {
    private static final int IDEA_ID = 197997;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197997Service() {
        this(new Idea197997Config());
    }

    public Idea197997Service(Idea197997Config config) {
        this.config = config != null ? config : new Idea197997Config();
