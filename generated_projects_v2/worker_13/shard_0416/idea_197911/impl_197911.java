...
@Data
public class Idea197911Config {
    private String name = "idea_197911";
 ...
 */
@Slf4j
public class Idea197911Service {
    private static final int IDEA_ID = 197911;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197911Service() {
        this(new Idea197911Config());
    }

    public Idea197911Service(Idea197911Config config) {
        this.config = config != null ? config : new Idea197911Config();
