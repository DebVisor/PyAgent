...
@Data
public class Idea198031Config {
    private String name = "idea_198031";
 ...
 */
@Slf4j
public class Idea198031Service {
    private static final int IDEA_ID = 198031;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198031Service() {
        this(new Idea198031Config());
    }

    public Idea198031Service(Idea198031Config config) {
        this.config = config != null ? config : new Idea198031Config();
