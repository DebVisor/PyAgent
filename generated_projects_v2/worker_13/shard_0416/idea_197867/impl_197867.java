...
@Data
public class Idea197867Config {
    private String name = "idea_197867";
 ...
 */
@Slf4j
public class Idea197867Service {
    private static final int IDEA_ID = 197867;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197867Service() {
        this(new Idea197867Config());
    }

    public Idea197867Service(Idea197867Config config) {
        this.config = config != null ? config : new Idea197867Config();
