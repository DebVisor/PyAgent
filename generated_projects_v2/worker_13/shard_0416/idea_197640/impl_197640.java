...
@Data
public class Idea197640Config {
    private String name = "idea_197640";
 ...
 */
@Slf4j
public class Idea197640Service {
    private static final int IDEA_ID = 197640;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197640Service() {
        this(new Idea197640Config());
    }

    public Idea197640Service(Idea197640Config config) {
        this.config = config != null ? config : new Idea197640Config();
