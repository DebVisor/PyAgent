...
@Data
public class Idea197814Config {
    private String name = "idea_197814";
 ...
 */
@Slf4j
public class Idea197814Service {
    private static final int IDEA_ID = 197814;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197814Service() {
        this(new Idea197814Config());
    }

    public Idea197814Service(Idea197814Config config) {
        this.config = config != null ? config : new Idea197814Config();
