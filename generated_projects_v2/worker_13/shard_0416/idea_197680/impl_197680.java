...
@Data
public class Idea197680Config {
    private String name = "idea_197680";
 ...
 */
@Slf4j
public class Idea197680Service {
    private static final int IDEA_ID = 197680;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197680Service() {
        this(new Idea197680Config());
    }

    public Idea197680Service(Idea197680Config config) {
        this.config = config != null ? config : new Idea197680Config();
