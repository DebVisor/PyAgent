...
@Data
public class Idea197833Config {
    private String name = "idea_197833";
 ...
 */
@Slf4j
public class Idea197833Service {
    private static final int IDEA_ID = 197833;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197833Service() {
        this(new Idea197833Config());
    }

    public Idea197833Service(Idea197833Config config) {
        this.config = config != null ? config : new Idea197833Config();
