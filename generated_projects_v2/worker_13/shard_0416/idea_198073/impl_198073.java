...
@Data
public class Idea198073Config {
    private String name = "idea_198073";
 ...
 */
@Slf4j
public class Idea198073Service {
    private static final int IDEA_ID = 198073;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198073Service() {
        this(new Idea198073Config());
    }

    public Idea198073Service(Idea198073Config config) {
        this.config = config != null ? config : new Idea198073Config();
