...
@Data
public class Idea197822Config {
    private String name = "idea_197822";
 ...
 */
@Slf4j
public class Idea197822Service {
    private static final int IDEA_ID = 197822;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197822Service() {
        this(new Idea197822Config());
    }

    public Idea197822Service(Idea197822Config config) {
        this.config = config != null ? config : new Idea197822Config();
