...
@Data
public class Idea197633Config {
    private String name = "idea_197633";
 ...
 */
@Slf4j
public class Idea197633Service {
    private static final int IDEA_ID = 197633;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197633Service() {
        this(new Idea197633Config());
    }

    public Idea197633Service(Idea197633Config config) {
        this.config = config != null ? config : new Idea197633Config();
