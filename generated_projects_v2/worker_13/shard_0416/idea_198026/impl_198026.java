...
@Data
public class Idea198026Config {
    private String name = "idea_198026";
 ...
 */
@Slf4j
public class Idea198026Service {
    private static final int IDEA_ID = 198026;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198026Service() {
        this(new Idea198026Config());
    }

    public Idea198026Service(Idea198026Config config) {
        this.config = config != null ? config : new Idea198026Config();
