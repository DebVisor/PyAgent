...
@Data
public class Idea197790Config {
    private String name = "idea_197790";
 ...
 */
@Slf4j
public class Idea197790Service {
    private static final int IDEA_ID = 197790;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197790Service() {
        this(new Idea197790Config());
    }

    public Idea197790Service(Idea197790Config config) {
        this.config = config != null ? config : new Idea197790Config();
