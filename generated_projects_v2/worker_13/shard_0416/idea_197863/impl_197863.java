...
@Data
public class Idea197863Config {
    private String name = "idea_197863";
 ...
 */
@Slf4j
public class Idea197863Service {
    private static final int IDEA_ID = 197863;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197863Service() {
        this(new Idea197863Config());
    }

    public Idea197863Service(Idea197863Config config) {
        this.config = config != null ? config : new Idea197863Config();
