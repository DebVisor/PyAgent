...
@Data
public class Idea197980Config {
    private String name = "idea_197980";
 ...
 */
@Slf4j
public class Idea197980Service {
    private static final int IDEA_ID = 197980;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197980Service() {
        this(new Idea197980Config());
    }

    public Idea197980Service(Idea197980Config config) {
        this.config = config != null ? config : new Idea197980Config();
