...
@Data
public class Idea197873Config {
    private String name = "idea_197873";
 ...
 */
@Slf4j
public class Idea197873Service {
    private static final int IDEA_ID = 197873;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197873Service() {
        this(new Idea197873Config());
    }

    public Idea197873Service(Idea197873Config config) {
        this.config = config != null ? config : new Idea197873Config();
