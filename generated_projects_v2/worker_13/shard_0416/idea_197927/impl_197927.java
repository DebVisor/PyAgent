...
@Data
public class Idea197927Config {
    private String name = "idea_197927";
 ...
 */
@Slf4j
public class Idea197927Service {
    private static final int IDEA_ID = 197927;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197927Service() {
        this(new Idea197927Config());
    }

    public Idea197927Service(Idea197927Config config) {
        this.config = config != null ? config : new Idea197927Config();
