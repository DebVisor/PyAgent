...
@Data
public class Idea197757Config {
    private String name = "idea_197757";
 ...
 */
@Slf4j
public class Idea197757Service {
    private static final int IDEA_ID = 197757;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197757Service() {
        this(new Idea197757Config());
    }

    public Idea197757Service(Idea197757Config config) {
        this.config = config != null ? config : new Idea197757Config();
