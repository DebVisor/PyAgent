...
@Data
public class Idea197805Config {
    private String name = "idea_197805";
 ...
 */
@Slf4j
public class Idea197805Service {
    private static final int IDEA_ID = 197805;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197805Service() {
        this(new Idea197805Config());
    }

    public Idea197805Service(Idea197805Config config) {
        this.config = config != null ? config : new Idea197805Config();
