...
@Data
public class Idea197932Config {
    private String name = "idea_197932";
 ...
 */
@Slf4j
public class Idea197932Service {
    private static final int IDEA_ID = 197932;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197932Service() {
        this(new Idea197932Config());
    }

    public Idea197932Service(Idea197932Config config) {
        this.config = config != null ? config : new Idea197932Config();
