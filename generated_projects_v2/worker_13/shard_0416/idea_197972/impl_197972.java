...
@Data
public class Idea197972Config {
    private String name = "idea_197972";
 ...
 */
@Slf4j
public class Idea197972Service {
    private static final int IDEA_ID = 197972;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197972Service() {
        this(new Idea197972Config());
    }

    public Idea197972Service(Idea197972Config config) {
        this.config = config != null ? config : new Idea197972Config();
