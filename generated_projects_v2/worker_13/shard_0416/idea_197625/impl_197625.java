...
@Data
public class Idea197625Config {
    private String name = "idea_197625";
 ...
 */
@Slf4j
public class Idea197625Service {
    private static final int IDEA_ID = 197625;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197625Service() {
        this(new Idea197625Config());
    }

    public Idea197625Service(Idea197625Config config) {
        this.config = config != null ? config : new Idea197625Config();
