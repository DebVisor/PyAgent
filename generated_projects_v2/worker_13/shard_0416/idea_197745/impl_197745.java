...
@Data
public class Idea197745Config {
    private String name = "idea_197745";
 ...
 */
@Slf4j
public class Idea197745Service {
    private static final int IDEA_ID = 197745;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197745Service() {
        this(new Idea197745Config());
    }

    public Idea197745Service(Idea197745Config config) {
        this.config = config != null ? config : new Idea197745Config();
