...
@Data
public class Idea197717Config {
    private String name = "idea_197717";
 ...
 */
@Slf4j
public class Idea197717Service {
    private static final int IDEA_ID = 197717;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197717Service() {
        this(new Idea197717Config());
    }

    public Idea197717Service(Idea197717Config config) {
        this.config = config != null ? config : new Idea197717Config();
