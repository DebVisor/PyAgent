...
@Data
public class Idea197760Config {
    private String name = "idea_197760";
 ...
 */
@Slf4j
public class Idea197760Service {
    private static final int IDEA_ID = 197760;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197760Service() {
        this(new Idea197760Config());
    }

    public Idea197760Service(Idea197760Config config) {
        this.config = config != null ? config : new Idea197760Config();
