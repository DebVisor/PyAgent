...
@Data
public class Idea197706Config {
    private String name = "idea_197706";
 ...
 */
@Slf4j
public class Idea197706Service {
    private static final int IDEA_ID = 197706;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197706Service() {
        this(new Idea197706Config());
    }

    public Idea197706Service(Idea197706Config config) {
        this.config = config != null ? config : new Idea197706Config();
