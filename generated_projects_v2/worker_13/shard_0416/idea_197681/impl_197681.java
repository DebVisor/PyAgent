...
@Data
public class Idea197681Config {
    private String name = "idea_197681";
 ...
 */
@Slf4j
public class Idea197681Service {
    private static final int IDEA_ID = 197681;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197681Service() {
        this(new Idea197681Config());
    }

    public Idea197681Service(Idea197681Config config) {
        this.config = config != null ? config : new Idea197681Config();
