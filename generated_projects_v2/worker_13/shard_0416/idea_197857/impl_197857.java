...
@Data
public class Idea197857Config {
    private String name = "idea_197857";
 ...
 */
@Slf4j
public class Idea197857Service {
    private static final int IDEA_ID = 197857;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197857Service() {
        this(new Idea197857Config());
    }

    public Idea197857Service(Idea197857Config config) {
        this.config = config != null ? config : new Idea197857Config();
