...
@Data
public class Idea197671Config {
    private String name = "idea_197671";
 ...
 */
@Slf4j
public class Idea197671Service {
    private static final int IDEA_ID = 197671;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197671Service() {
        this(new Idea197671Config());
    }

    public Idea197671Service(Idea197671Config config) {
        this.config = config != null ? config : new Idea197671Config();
