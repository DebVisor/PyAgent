...
@Data
public class Idea197611Config {
    private String name = "idea_197611";
 ...
 */
@Slf4j
public class Idea197611Service {
    private static final int IDEA_ID = 197611;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197611Service() {
        this(new Idea197611Config());
    }

    public Idea197611Service(Idea197611Config config) {
        this.config = config != null ? config : new Idea197611Config();
