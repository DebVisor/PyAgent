...
@Data
public class Idea197968Config {
    private String name = "idea_197968";
 ...
 */
@Slf4j
public class Idea197968Service {
    private static final int IDEA_ID = 197968;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197968Service() {
        this(new Idea197968Config());
    }

    public Idea197968Service(Idea197968Config config) {
        this.config = config != null ? config : new Idea197968Config();
