...
@Data
public class Idea197850Config {
    private String name = "idea_197850";
 ...
 */
@Slf4j
public class Idea197850Service {
    private static final int IDEA_ID = 197850;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197850Service() {
        this(new Idea197850Config());
    }

    public Idea197850Service(Idea197850Config config) {
        this.config = config != null ? config : new Idea197850Config();
