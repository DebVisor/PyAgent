...
@Data
public class Idea197835Config {
    private String name = "idea_197835";
 ...
 */
@Slf4j
public class Idea197835Service {
    private static final int IDEA_ID = 197835;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197835Service() {
        this(new Idea197835Config());
    }

    public Idea197835Service(Idea197835Config config) {
        this.config = config != null ? config : new Idea197835Config();
