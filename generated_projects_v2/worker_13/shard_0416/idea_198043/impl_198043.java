...
@Data
public class Idea198043Config {
    private String name = "idea_198043";
 ...
 */
@Slf4j
public class Idea198043Service {
    private static final int IDEA_ID = 198043;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198043Service() {
        this(new Idea198043Config());
    }

    public Idea198043Service(Idea198043Config config) {
        this.config = config != null ? config : new Idea198043Config();
