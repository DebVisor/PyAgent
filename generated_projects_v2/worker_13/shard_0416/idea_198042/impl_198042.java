...
@Data
public class Idea198042Config {
    private String name = "idea_198042";
 ...
 */
@Slf4j
public class Idea198042Service {
    private static final int IDEA_ID = 198042;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198042Service() {
        this(new Idea198042Config());
    }

    public Idea198042Service(Idea198042Config config) {
        this.config = config != null ? config : new Idea198042Config();
