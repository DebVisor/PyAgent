...
@Data
public class Idea197770Config {
    private String name = "idea_197770";
 ...
 */
@Slf4j
public class Idea197770Service {
    private static final int IDEA_ID = 197770;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197770Service() {
        this(new Idea197770Config());
    }

    public Idea197770Service(Idea197770Config config) {
        this.config = config != null ? config : new Idea197770Config();
