...
@Data
public class Idea198059Config {
    private String name = "idea_198059";
 ...
 */
@Slf4j
public class Idea198059Service {
    private static final int IDEA_ID = 198059;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198059Service() {
        this(new Idea198059Config());
    }

    public Idea198059Service(Idea198059Config config) {
        this.config = config != null ? config : new Idea198059Config();
