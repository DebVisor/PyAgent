...
@Data
public class Idea198066Config {
    private String name = "idea_198066";
 ...
 */
@Slf4j
public class Idea198066Service {
    private static final int IDEA_ID = 198066;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198066Service() {
        this(new Idea198066Config());
    }

    public Idea198066Service(Idea198066Config config) {
        this.config = config != null ? config : new Idea198066Config();
