...
@Data
public class Idea197870Config {
    private String name = "idea_197870";
 ...
 */
@Slf4j
public class Idea197870Service {
    private static final int IDEA_ID = 197870;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197870Service() {
        this(new Idea197870Config());
    }

    public Idea197870Service(Idea197870Config config) {
        this.config = config != null ? config : new Idea197870Config();
