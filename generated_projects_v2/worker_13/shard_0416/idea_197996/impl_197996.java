...
@Data
public class Idea197996Config {
    private String name = "idea_197996";
 ...
 */
@Slf4j
public class Idea197996Service {
    private static final int IDEA_ID = 197996;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197996Service() {
        this(new Idea197996Config());
    }

    public Idea197996Service(Idea197996Config config) {
        this.config = config != null ? config : new Idea197996Config();
