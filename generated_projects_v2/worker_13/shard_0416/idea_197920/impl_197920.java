...
@Data
public class Idea197920Config {
    private String name = "idea_197920";
 ...
 */
@Slf4j
public class Idea197920Service {
    private static final int IDEA_ID = 197920;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197920Service() {
        this(new Idea197920Config());
    }

    public Idea197920Service(Idea197920Config config) {
        this.config = config != null ? config : new Idea197920Config();
