...
@Data
public class Idea197843Config {
    private String name = "idea_197843";
 ...
 */
@Slf4j
public class Idea197843Service {
    private static final int IDEA_ID = 197843;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197843Service() {
        this(new Idea197843Config());
    }

    public Idea197843Service(Idea197843Config config) {
        this.config = config != null ? config : new Idea197843Config();
