...
@Data
public class Idea197951Config {
    private String name = "idea_197951";
 ...
 */
@Slf4j
public class Idea197951Service {
    private static final int IDEA_ID = 197951;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197951Service() {
        this(new Idea197951Config());
    }

    public Idea197951Service(Idea197951Config config) {
        this.config = config != null ? config : new Idea197951Config();
