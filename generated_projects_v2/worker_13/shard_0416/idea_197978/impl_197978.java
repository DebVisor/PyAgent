...
@Data
public class Idea197978Config {
    private String name = "idea_197978";
 ...
 */
@Slf4j
public class Idea197978Service {
    private static final int IDEA_ID = 197978;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197978Service() {
        this(new Idea197978Config());
    }

    public Idea197978Service(Idea197978Config config) {
        this.config = config != null ? config : new Idea197978Config();
