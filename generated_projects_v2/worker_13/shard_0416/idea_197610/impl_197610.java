...
@Data
public class Idea197610Config {
    private String name = "idea_197610";
 ...
 */
@Slf4j
public class Idea197610Service {
    private static final int IDEA_ID = 197610;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197610Service() {
        this(new Idea197610Config());
    }

    public Idea197610Service(Idea197610Config config) {
        this.config = config != null ? config : new Idea197610Config();
