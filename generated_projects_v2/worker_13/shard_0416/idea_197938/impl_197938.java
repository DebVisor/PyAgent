...
@Data
public class Idea197938Config {
    private String name = "idea_197938";
 ...
 */
@Slf4j
public class Idea197938Service {
    private static final int IDEA_ID = 197938;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197938Service() {
        this(new Idea197938Config());
    }

    public Idea197938Service(Idea197938Config config) {
        this.config = config != null ? config : new Idea197938Config();
