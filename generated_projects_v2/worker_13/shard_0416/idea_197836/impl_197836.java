...
@Data
public class Idea197836Config {
    private String name = "idea_197836";
 ...
 */
@Slf4j
public class Idea197836Service {
    private static final int IDEA_ID = 197836;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197836Service() {
        this(new Idea197836Config());
    }

    public Idea197836Service(Idea197836Config config) {
        this.config = config != null ? config : new Idea197836Config();
