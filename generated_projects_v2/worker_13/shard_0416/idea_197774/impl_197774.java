...
@Data
public class Idea197774Config {
    private String name = "idea_197774";
 ...
 */
@Slf4j
public class Idea197774Service {
    private static final int IDEA_ID = 197774;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197774Service() {
        this(new Idea197774Config());
    }

    public Idea197774Service(Idea197774Config config) {
        this.config = config != null ? config : new Idea197774Config();
