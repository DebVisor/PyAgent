...
@Data
public class Idea198036Config {
    private String name = "idea_198036";
 ...
 */
@Slf4j
public class Idea198036Service {
    private static final int IDEA_ID = 198036;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198036Service() {
        this(new Idea198036Config());
    }

    public Idea198036Service(Idea198036Config config) {
        this.config = config != null ? config : new Idea198036Config();
