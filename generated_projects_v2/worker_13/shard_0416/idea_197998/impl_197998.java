...
@Data
public class Idea197998Config {
    private String name = "idea_197998";
 ...
 */
@Slf4j
public class Idea197998Service {
    private static final int IDEA_ID = 197998;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197998Service() {
        this(new Idea197998Config());
    }

    public Idea197998Service(Idea197998Config config) {
        this.config = config != null ? config : new Idea197998Config();
