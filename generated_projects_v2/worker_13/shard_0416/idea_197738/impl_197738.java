...
@Data
public class Idea197738Config {
    private String name = "idea_197738";
 ...
 */
@Slf4j
public class Idea197738Service {
    private static final int IDEA_ID = 197738;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197738Service() {
        this(new Idea197738Config());
    }

    public Idea197738Service(Idea197738Config config) {
        this.config = config != null ? config : new Idea197738Config();
