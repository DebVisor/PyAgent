...
@Data
public class Idea198056Config {
    private String name = "idea_198056";
 ...
 */
@Slf4j
public class Idea198056Service {
    private static final int IDEA_ID = 198056;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198056Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198056Service() {
        this(new Idea198056Config());
    }

    public Idea198056Service(Idea198056Config config) {
        this.config = config != null ? config : new Idea198056Config();
