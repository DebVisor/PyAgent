...
@Data
public class Idea197889Config {
    private String name = "idea_197889";
 ...
 */
@Slf4j
public class Idea197889Service {
    private static final int IDEA_ID = 197889;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197889Service() {
        this(new Idea197889Config());
    }

    public Idea197889Service(Idea197889Config config) {
        this.config = config != null ? config : new Idea197889Config();
