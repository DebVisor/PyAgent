...
@Data
public class Idea197658Config {
    private String name = "idea_197658";
 ...
 */
@Slf4j
public class Idea197658Service {
    private static final int IDEA_ID = 197658;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197658Service() {
        this(new Idea197658Config());
    }

    public Idea197658Service(Idea197658Config config) {
        this.config = config != null ? config : new Idea197658Config();
