...
@Data
public class Idea197947Config {
    private String name = "idea_197947";
 ...
 */
@Slf4j
public class Idea197947Service {
    private static final int IDEA_ID = 197947;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197947Service() {
        this(new Idea197947Config());
    }

    public Idea197947Service(Idea197947Config config) {
        this.config = config != null ? config : new Idea197947Config();
