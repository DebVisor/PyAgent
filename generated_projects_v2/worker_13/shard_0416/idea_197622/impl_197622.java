...
@Data
public class Idea197622Config {
    private String name = "idea_197622";
 ...
 */
@Slf4j
public class Idea197622Service {
    private static final int IDEA_ID = 197622;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197622Service() {
        this(new Idea197622Config());
    }

    public Idea197622Service(Idea197622Config config) {
        this.config = config != null ? config : new Idea197622Config();
