...
@Data
public class Idea197772Config {
    private String name = "idea_197772";
 ...
 */
@Slf4j
public class Idea197772Service {
    private static final int IDEA_ID = 197772;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197772Service() {
        this(new Idea197772Config());
    }

    public Idea197772Service(Idea197772Config config) {
        this.config = config != null ? config : new Idea197772Config();
