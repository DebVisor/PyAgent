...
@Data
public class Idea197777Config {
    private String name = "idea_197777";
 ...
 */
@Slf4j
public class Idea197777Service {
    private static final int IDEA_ID = 197777;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197777Service() {
        this(new Idea197777Config());
    }

    public Idea197777Service(Idea197777Config config) {
        this.config = config != null ? config : new Idea197777Config();
