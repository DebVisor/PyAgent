...
@Data
public class Idea197624Config {
    private String name = "idea_197624";
 ...
 */
@Slf4j
public class Idea197624Service {
    private static final int IDEA_ID = 197624;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197624Service() {
        this(new Idea197624Config());
    }

    public Idea197624Service(Idea197624Config config) {
        this.config = config != null ? config : new Idea197624Config();
