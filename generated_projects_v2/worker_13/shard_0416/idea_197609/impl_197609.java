...
@Data
public class Idea197609Config {
    private String name = "idea_197609";
 ...
 */
@Slf4j
public class Idea197609Service {
    private static final int IDEA_ID = 197609;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197609Service() {
        this(new Idea197609Config());
    }

    public Idea197609Service(Idea197609Config config) {
        this.config = config != null ? config : new Idea197609Config();
