...
@Data
public class Idea197663Config {
    private String name = "idea_197663";
 ...
 */
@Slf4j
public class Idea197663Service {
    private static final int IDEA_ID = 197663;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197663Service() {
        this(new Idea197663Config());
    }

    public Idea197663Service(Idea197663Config config) {
        this.config = config != null ? config : new Idea197663Config();
