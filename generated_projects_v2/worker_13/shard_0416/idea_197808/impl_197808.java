...
@Data
public class Idea197808Config {
    private String name = "idea_197808";
 ...
 */
@Slf4j
public class Idea197808Service {
    private static final int IDEA_ID = 197808;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197808Service() {
        this(new Idea197808Config());
    }

    public Idea197808Service(Idea197808Config config) {
        this.config = config != null ? config : new Idea197808Config();
