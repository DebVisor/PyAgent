...
@Data
public class Idea197695Config {
    private String name = "idea_197695";
 ...
 */
@Slf4j
public class Idea197695Service {
    private static final int IDEA_ID = 197695;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197695Service() {
        this(new Idea197695Config());
    }

    public Idea197695Service(Idea197695Config config) {
        this.config = config != null ? config : new Idea197695Config();
