...
@Data
public class Idea197771Config {
    private String name = "idea_197771";
 ...
 */
@Slf4j
public class Idea197771Service {
    private static final int IDEA_ID = 197771;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197771Service() {
        this(new Idea197771Config());
    }

    public Idea197771Service(Idea197771Config config) {
        this.config = config != null ? config : new Idea197771Config();
