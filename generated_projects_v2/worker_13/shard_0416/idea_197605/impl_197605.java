...
@Data
public class Idea197605Config {
    private String name = "idea_197605";
 ...
 */
@Slf4j
public class Idea197605Service {
    private static final int IDEA_ID = 197605;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197605Service() {
        this(new Idea197605Config());
    }

    public Idea197605Service(Idea197605Config config) {
        this.config = config != null ? config : new Idea197605Config();
