...
@Data
public class Idea197803Config {
    private String name = "idea_197803";
 ...
 */
@Slf4j
public class Idea197803Service {
    private static final int IDEA_ID = 197803;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197803Service() {
        this(new Idea197803Config());
    }

    public Idea197803Service(Idea197803Config config) {
        this.config = config != null ? config : new Idea197803Config();
