...
@Data
public class Idea197666Config {
    private String name = "idea_197666";
 ...
 */
@Slf4j
public class Idea197666Service {
    private static final int IDEA_ID = 197666;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197666Service() {
        this(new Idea197666Config());
    }

    public Idea197666Service(Idea197666Config config) {
        this.config = config != null ? config : new Idea197666Config();
