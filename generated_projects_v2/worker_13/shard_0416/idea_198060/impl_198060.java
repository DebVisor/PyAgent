...
@Data
public class Idea198060Config {
    private String name = "idea_198060";
 ...
 */
@Slf4j
public class Idea198060Service {
    private static final int IDEA_ID = 198060;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198060Service() {
        this(new Idea198060Config());
    }

    public Idea198060Service(Idea198060Config config) {
        this.config = config != null ? config : new Idea198060Config();
