...
@Data
public class Idea197614Config {
    private String name = "idea_197614";
 ...
 */
@Slf4j
public class Idea197614Service {
    private static final int IDEA_ID = 197614;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197614Service() {
        this(new Idea197614Config());
    }

    public Idea197614Service(Idea197614Config config) {
        this.config = config != null ? config : new Idea197614Config();
