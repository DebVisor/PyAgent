...
@Data
public class Idea197668Config {
    private String name = "idea_197668";
 ...
 */
@Slf4j
public class Idea197668Service {
    private static final int IDEA_ID = 197668;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197668Service() {
        this(new Idea197668Config());
    }

    public Idea197668Service(Idea197668Config config) {
        this.config = config != null ? config : new Idea197668Config();
