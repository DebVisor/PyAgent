...
@Data
public class Idea197606Config {
    private String name = "idea_197606";
 ...
 */
@Slf4j
public class Idea197606Service {
    private static final int IDEA_ID = 197606;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197606Service() {
        this(new Idea197606Config());
    }

    public Idea197606Service(Idea197606Config config) {
        this.config = config != null ? config : new Idea197606Config();
