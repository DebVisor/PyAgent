...
@Data
public class Idea197700Config {
    private String name = "idea_197700";
 ...
 */
@Slf4j
public class Idea197700Service {
    private static final int IDEA_ID = 197700;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197700Service() {
        this(new Idea197700Config());
    }

    public Idea197700Service(Idea197700Config config) {
        this.config = config != null ? config : new Idea197700Config();
