...
@Data
public class Idea197657Config {
    private String name = "idea_197657";
 ...
 */
@Slf4j
public class Idea197657Service {
    private static final int IDEA_ID = 197657;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197657Service() {
        this(new Idea197657Config());
    }

    public Idea197657Service(Idea197657Config config) {
        this.config = config != null ? config : new Idea197657Config();
