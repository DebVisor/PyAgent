...
@Data
public class Idea197664Config {
    private String name = "idea_197664";
 ...
 */
@Slf4j
public class Idea197664Service {
    private static final int IDEA_ID = 197664;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197664Service() {
        this(new Idea197664Config());
    }

    public Idea197664Service(Idea197664Config config) {
        this.config = config != null ? config : new Idea197664Config();
