...
@Data
public class Idea197629Config {
    private String name = "idea_197629";
 ...
 */
@Slf4j
public class Idea197629Service {
    private static final int IDEA_ID = 197629;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197629Service() {
        this(new Idea197629Config());
    }

    public Idea197629Service(Idea197629Config config) {
        this.config = config != null ? config : new Idea197629Config();
