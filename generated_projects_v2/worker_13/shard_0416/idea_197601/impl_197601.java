...
@Data
public class Idea197601Config {
    private String name = "idea_197601";
 ...
 */
@Slf4j
public class Idea197601Service {
    private static final int IDEA_ID = 197601;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197601Service() {
        this(new Idea197601Config());
    }

    public Idea197601Service(Idea197601Config config) {
        this.config = config != null ? config : new Idea197601Config();
