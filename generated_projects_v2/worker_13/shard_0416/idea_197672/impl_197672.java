...
@Data
public class Idea197672Config {
    private String name = "idea_197672";
 ...
 */
@Slf4j
public class Idea197672Service {
    private static final int IDEA_ID = 197672;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197672Service() {
        this(new Idea197672Config());
    }

    public Idea197672Service(Idea197672Config config) {
        this.config = config != null ? config : new Idea197672Config();
