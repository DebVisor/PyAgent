...
@Data
public class Idea197711Config {
    private String name = "idea_197711";
 ...
 */
@Slf4j
public class Idea197711Service {
    private static final int IDEA_ID = 197711;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197711Service() {
        this(new Idea197711Config());
    }

    public Idea197711Service(Idea197711Config config) {
        this.config = config != null ? config : new Idea197711Config();
