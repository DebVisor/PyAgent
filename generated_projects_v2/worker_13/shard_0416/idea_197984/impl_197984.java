...
@Data
public class Idea197984Config {
    private String name = "idea_197984";
 ...
 */
@Slf4j
public class Idea197984Service {
    private static final int IDEA_ID = 197984;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197984Service() {
        this(new Idea197984Config());
    }

    public Idea197984Service(Idea197984Config config) {
        this.config = config != null ? config : new Idea197984Config();
