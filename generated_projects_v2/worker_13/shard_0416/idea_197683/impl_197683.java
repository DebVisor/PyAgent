...
@Data
public class Idea197683Config {
    private String name = "idea_197683";
 ...
 */
@Slf4j
public class Idea197683Service {
    private static final int IDEA_ID = 197683;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197683Service() {
        this(new Idea197683Config());
    }

    public Idea197683Service(Idea197683Config config) {
        this.config = config != null ? config : new Idea197683Config();
