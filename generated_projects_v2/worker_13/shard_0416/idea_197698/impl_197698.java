...
@Data
public class Idea197698Config {
    private String name = "idea_197698";
 ...
 */
@Slf4j
public class Idea197698Service {
    private static final int IDEA_ID = 197698;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197698Service() {
        this(new Idea197698Config());
    }

    public Idea197698Service(Idea197698Config config) {
        this.config = config != null ? config : new Idea197698Config();
