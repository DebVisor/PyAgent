...
@Data
public class Idea198063Config {
    private String name = "idea_198063";
 ...
 */
@Slf4j
public class Idea198063Service {
    private static final int IDEA_ID = 198063;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198063Service() {
        this(new Idea198063Config());
    }

    public Idea198063Service(Idea198063Config config) {
        this.config = config != null ? config : new Idea198063Config();
