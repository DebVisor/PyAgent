...
@Data
public class Idea197958Config {
    private String name = "idea_197958";
 ...
 */
@Slf4j
public class Idea197958Service {
    private static final int IDEA_ID = 197958;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197958Service() {
        this(new Idea197958Config());
    }

    public Idea197958Service(Idea197958Config config) {
        this.config = config != null ? config : new Idea197958Config();
