...
@Data
public class Idea197818Config {
    private String name = "idea_197818";
 ...
 */
@Slf4j
public class Idea197818Service {
    private static final int IDEA_ID = 197818;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197818Service() {
        this(new Idea197818Config());
    }

    public Idea197818Service(Idea197818Config config) {
        this.config = config != null ? config : new Idea197818Config();
