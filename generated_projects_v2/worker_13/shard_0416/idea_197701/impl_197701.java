...
@Data
public class Idea197701Config {
    private String name = "idea_197701";
 ...
 */
@Slf4j
public class Idea197701Service {
    private static final int IDEA_ID = 197701;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197701Service() {
        this(new Idea197701Config());
    }

    public Idea197701Service(Idea197701Config config) {
        this.config = config != null ? config : new Idea197701Config();
