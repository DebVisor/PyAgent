...
@Data
public class Idea197888Config {
    private String name = "idea_197888";
 ...
 */
@Slf4j
public class Idea197888Service {
    private static final int IDEA_ID = 197888;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197888Service() {
        this(new Idea197888Config());
    }

    public Idea197888Service(Idea197888Config config) {
        this.config = config != null ? config : new Idea197888Config();
