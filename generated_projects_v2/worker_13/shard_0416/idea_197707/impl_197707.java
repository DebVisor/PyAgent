...
@Data
public class Idea197707Config {
    private String name = "idea_197707";
 ...
 */
@Slf4j
public class Idea197707Service {
    private static final int IDEA_ID = 197707;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197707Service() {
        this(new Idea197707Config());
    }

    public Idea197707Service(Idea197707Config config) {
        this.config = config != null ? config : new Idea197707Config();
