...
@Data
public class Idea197837Config {
    private String name = "idea_197837";
 ...
 */
@Slf4j
public class Idea197837Service {
    private static final int IDEA_ID = 197837;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197837Service() {
        this(new Idea197837Config());
    }

    public Idea197837Service(Idea197837Config config) {
        this.config = config != null ? config : new Idea197837Config();
