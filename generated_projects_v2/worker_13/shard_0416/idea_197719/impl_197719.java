...
@Data
public class Idea197719Config {
    private String name = "idea_197719";
 ...
 */
@Slf4j
public class Idea197719Service {
    private static final int IDEA_ID = 197719;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197719Service() {
        this(new Idea197719Config());
    }

    public Idea197719Service(Idea197719Config config) {
        this.config = config != null ? config : new Idea197719Config();
