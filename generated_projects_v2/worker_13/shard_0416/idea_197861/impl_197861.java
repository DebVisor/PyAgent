...
@Data
public class Idea197861Config {
    private String name = "idea_197861";
 ...
 */
@Slf4j
public class Idea197861Service {
    private static final int IDEA_ID = 197861;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197861Service() {
        this(new Idea197861Config());
    }

    public Idea197861Service(Idea197861Config config) {
        this.config = config != null ? config : new Idea197861Config();
