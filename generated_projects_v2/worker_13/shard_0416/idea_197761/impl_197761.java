...
@Data
public class Idea197761Config {
    private String name = "idea_197761";
 ...
 */
@Slf4j
public class Idea197761Service {
    private static final int IDEA_ID = 197761;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197761Service() {
        this(new Idea197761Config());
    }

    public Idea197761Service(Idea197761Config config) {
        this.config = config != null ? config : new Idea197761Config();
