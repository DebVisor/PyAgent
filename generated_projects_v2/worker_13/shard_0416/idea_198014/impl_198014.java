...
@Data
public class Idea198014Config {
    private String name = "idea_198014";
 ...
 */
@Slf4j
public class Idea198014Service {
    private static final int IDEA_ID = 198014;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198014Service() {
        this(new Idea198014Config());
    }

    public Idea198014Service(Idea198014Config config) {
        this.config = config != null ? config : new Idea198014Config();
