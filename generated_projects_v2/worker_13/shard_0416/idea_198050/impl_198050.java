...
@Data
public class Idea198050Config {
    private String name = "idea_198050";
 ...
 */
@Slf4j
public class Idea198050Service {
    private static final int IDEA_ID = 198050;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198050Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198050Service() {
        this(new Idea198050Config());
    }

    public Idea198050Service(Idea198050Config config) {
        this.config = config != null ? config : new Idea198050Config();
