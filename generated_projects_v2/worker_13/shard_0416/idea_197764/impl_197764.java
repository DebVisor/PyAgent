...
@Data
public class Idea197764Config {
    private String name = "idea_197764";
 ...
 */
@Slf4j
public class Idea197764Service {
    private static final int IDEA_ID = 197764;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197764Service() {
        this(new Idea197764Config());
    }

    public Idea197764Service(Idea197764Config config) {
        this.config = config != null ? config : new Idea197764Config();
