...
@Data
public class Idea197602Config {
    private String name = "idea_197602";
 ...
 */
@Slf4j
public class Idea197602Service {
    private static final int IDEA_ID = 197602;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197602Service() {
        this(new Idea197602Config());
    }

    public Idea197602Service(Idea197602Config config) {
        this.config = config != null ? config : new Idea197602Config();
