...
@Data
public class Idea197882Config {
    private String name = "idea_197882";
 ...
 */
@Slf4j
public class Idea197882Service {
    private static final int IDEA_ID = 197882;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197882Service() {
        this(new Idea197882Config());
    }

    public Idea197882Service(Idea197882Config config) {
        this.config = config != null ? config : new Idea197882Config();
