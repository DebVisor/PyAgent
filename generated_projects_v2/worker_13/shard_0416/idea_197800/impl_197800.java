...
@Data
public class Idea197800Config {
    private String name = "idea_197800";
 ...
 */
@Slf4j
public class Idea197800Service {
    private static final int IDEA_ID = 197800;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197800Service() {
        this(new Idea197800Config());
    }

    public Idea197800Service(Idea197800Config config) {
        this.config = config != null ? config : new Idea197800Config();
