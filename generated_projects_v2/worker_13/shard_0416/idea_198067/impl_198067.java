...
@Data
public class Idea198067Config {
    private String name = "idea_198067";
 ...
 */
@Slf4j
public class Idea198067Service {
    private static final int IDEA_ID = 198067;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198067Service() {
        this(new Idea198067Config());
    }

    public Idea198067Service(Idea198067Config config) {
        this.config = config != null ? config : new Idea198067Config();
