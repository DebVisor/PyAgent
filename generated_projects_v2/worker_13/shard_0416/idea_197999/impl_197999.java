...
@Data
public class Idea197999Config {
    private String name = "idea_197999";
 ...
 */
@Slf4j
public class Idea197999Service {
    private static final int IDEA_ID = 197999;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197999Service() {
        this(new Idea197999Config());
    }

    public Idea197999Service(Idea197999Config config) {
        this.config = config != null ? config : new Idea197999Config();
