...
@Data
public class Idea197856Config {
    private String name = "idea_197856";
 ...
 */
@Slf4j
public class Idea197856Service {
    private static final int IDEA_ID = 197856;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197856Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197856Service() {
        this(new Idea197856Config());
    }

    public Idea197856Service(Idea197856Config config) {
        this.config = config != null ? config : new Idea197856Config();
