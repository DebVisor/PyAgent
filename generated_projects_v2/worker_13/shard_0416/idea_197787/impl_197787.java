...
@Data
public class Idea197787Config {
    private String name = "idea_197787";
 ...
 */
@Slf4j
public class Idea197787Service {
    private static final int IDEA_ID = 197787;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197787Service() {
        this(new Idea197787Config());
    }

    public Idea197787Service(Idea197787Config config) {
        this.config = config != null ? config : new Idea197787Config();
