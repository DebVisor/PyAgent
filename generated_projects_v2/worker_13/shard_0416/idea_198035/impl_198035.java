...
@Data
public class Idea198035Config {
    private String name = "idea_198035";
 ...
 */
@Slf4j
public class Idea198035Service {
    private static final int IDEA_ID = 198035;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198035Service() {
        this(new Idea198035Config());
    }

    public Idea198035Service(Idea198035Config config) {
        this.config = config != null ? config : new Idea198035Config();
