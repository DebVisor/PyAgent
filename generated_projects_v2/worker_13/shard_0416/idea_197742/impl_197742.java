...
@Data
public class Idea197742Config {
    private String name = "idea_197742";
 ...
 */
@Slf4j
public class Idea197742Service {
    private static final int IDEA_ID = 197742;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197742Service() {
        this(new Idea197742Config());
    }

    public Idea197742Service(Idea197742Config config) {
        this.config = config != null ? config : new Idea197742Config();
