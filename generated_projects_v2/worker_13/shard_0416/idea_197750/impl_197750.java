...
@Data
public class Idea197750Config {
    private String name = "idea_197750";
 ...
 */
@Slf4j
public class Idea197750Service {
    private static final int IDEA_ID = 197750;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197750Service() {
        this(new Idea197750Config());
    }

    public Idea197750Service(Idea197750Config config) {
        this.config = config != null ? config : new Idea197750Config();
