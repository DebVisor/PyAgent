...
@Data
public class Idea197937Config {
    private String name = "idea_197937";
 ...
 */
@Slf4j
public class Idea197937Service {
    private static final int IDEA_ID = 197937;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197937Service() {
        this(new Idea197937Config());
    }

    public Idea197937Service(Idea197937Config config) {
        this.config = config != null ? config : new Idea197937Config();
