...
@Data
public class Idea197728Config {
    private String name = "idea_197728";
 ...
 */
@Slf4j
public class Idea197728Service {
    private static final int IDEA_ID = 197728;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197728Service() {
        this(new Idea197728Config());
    }

    public Idea197728Service(Idea197728Config config) {
        this.config = config != null ? config : new Idea197728Config();
