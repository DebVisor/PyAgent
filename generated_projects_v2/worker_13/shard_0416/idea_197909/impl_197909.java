...
@Data
public class Idea197909Config {
    private String name = "idea_197909";
 ...
 */
@Slf4j
public class Idea197909Service {
    private static final int IDEA_ID = 197909;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197909Service() {
        this(new Idea197909Config());
    }

    public Idea197909Service(Idea197909Config config) {
        this.config = config != null ? config : new Idea197909Config();
