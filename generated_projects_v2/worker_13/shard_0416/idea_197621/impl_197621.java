...
@Data
public class Idea197621Config {
    private String name = "idea_197621";
 ...
 */
@Slf4j
public class Idea197621Service {
    private static final int IDEA_ID = 197621;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197621Service() {
        this(new Idea197621Config());
    }

    public Idea197621Service(Idea197621Config config) {
        this.config = config != null ? config : new Idea197621Config();
