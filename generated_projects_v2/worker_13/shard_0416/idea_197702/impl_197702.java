...
@Data
public class Idea197702Config {
    private String name = "idea_197702";
 ...
 */
@Slf4j
public class Idea197702Service {
    private static final int IDEA_ID = 197702;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197702Service() {
        this(new Idea197702Config());
    }

    public Idea197702Service(Idea197702Config config) {
        this.config = config != null ? config : new Idea197702Config();
