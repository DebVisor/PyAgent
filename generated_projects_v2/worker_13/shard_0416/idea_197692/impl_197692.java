...
@Data
public class Idea197692Config {
    private String name = "idea_197692";
 ...
 */
@Slf4j
public class Idea197692Service {
    private static final int IDEA_ID = 197692;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197692Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197692Service() {
        this(new Idea197692Config());
    }

    public Idea197692Service(Idea197692Config config) {
        this.config = config != null ? config : new Idea197692Config();
