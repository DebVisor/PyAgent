...
@Data
public class Idea197869Config {
    private String name = "idea_197869";
 ...
 */
@Slf4j
public class Idea197869Service {
    private static final int IDEA_ID = 197869;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197869Service() {
        this(new Idea197869Config());
    }

    public Idea197869Service(Idea197869Config config) {
        this.config = config != null ? config : new Idea197869Config();
