...
@Data
public class Idea197853Config {
    private String name = "idea_197853";
 ...
 */
@Slf4j
public class Idea197853Service {
    private static final int IDEA_ID = 197853;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197853Service() {
        this(new Idea197853Config());
    }

    public Idea197853Service(Idea197853Config config) {
        this.config = config != null ? config : new Idea197853Config();
