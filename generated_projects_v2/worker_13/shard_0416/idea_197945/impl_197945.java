...
@Data
public class Idea197945Config {
    private String name = "idea_197945";
 ...
 */
@Slf4j
public class Idea197945Service {
    private static final int IDEA_ID = 197945;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197945Service() {
        this(new Idea197945Config());
    }

    public Idea197945Service(Idea197945Config config) {
        this.config = config != null ? config : new Idea197945Config();
