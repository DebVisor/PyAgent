...
@Data
public class Idea198054Config {
    private String name = "idea_198054";
 ...
 */
@Slf4j
public class Idea198054Service {
    private static final int IDEA_ID = 198054;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198054Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198054Service() {
        this(new Idea198054Config());
    }

    public Idea198054Service(Idea198054Config config) {
        this.config = config != null ? config : new Idea198054Config();
