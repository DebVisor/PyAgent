...
@Data
public class Idea197778Config {
    private String name = "idea_197778";
 ...
 */
@Slf4j
public class Idea197778Service {
    private static final int IDEA_ID = 197778;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197778Service() {
        this(new Idea197778Config());
    }

    public Idea197778Service(Idea197778Config config) {
        this.config = config != null ? config : new Idea197778Config();
