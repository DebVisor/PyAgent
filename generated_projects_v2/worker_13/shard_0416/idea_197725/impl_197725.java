...
@Data
public class Idea197725Config {
    private String name = "idea_197725";
 ...
 */
@Slf4j
public class Idea197725Service {
    private static final int IDEA_ID = 197725;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197725Service() {
        this(new Idea197725Config());
    }

    public Idea197725Service(Idea197725Config config) {
        this.config = config != null ? config : new Idea197725Config();
