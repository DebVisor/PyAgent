...
@Data
public class Idea197723Config {
    private String name = "idea_197723";
 ...
 */
@Slf4j
public class Idea197723Service {
    private static final int IDEA_ID = 197723;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197723Service() {
        this(new Idea197723Config());
    }

    public Idea197723Service(Idea197723Config config) {
        this.config = config != null ? config : new Idea197723Config();
