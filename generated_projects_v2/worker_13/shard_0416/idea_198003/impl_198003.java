...
@Data
public class Idea198003Config {
    private String name = "idea_198003";
 ...
 */
@Slf4j
public class Idea198003Service {
    private static final int IDEA_ID = 198003;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198003Service() {
        this(new Idea198003Config());
    }

    public Idea198003Service(Idea198003Config config) {
        this.config = config != null ? config : new Idea198003Config();
