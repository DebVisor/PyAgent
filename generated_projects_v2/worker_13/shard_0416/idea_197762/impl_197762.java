...
@Data
public class Idea197762Config {
    private String name = "idea_197762";
 ...
 */
@Slf4j
public class Idea197762Service {
    private static final int IDEA_ID = 197762;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197762Service() {
        this(new Idea197762Config());
    }

    public Idea197762Service(Idea197762Config config) {
        this.config = config != null ? config : new Idea197762Config();
