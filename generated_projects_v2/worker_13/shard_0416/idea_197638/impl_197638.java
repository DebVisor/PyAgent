...
@Data
public class Idea197638Config {
    private String name = "idea_197638";
 ...
 */
@Slf4j
public class Idea197638Service {
    private static final int IDEA_ID = 197638;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197638Service() {
        this(new Idea197638Config());
    }

    public Idea197638Service(Idea197638Config config) {
        this.config = config != null ? config : new Idea197638Config();
