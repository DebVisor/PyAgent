...
@Data
public class Idea198004Config {
    private String name = "idea_198004";
 ...
 */
@Slf4j
public class Idea198004Service {
    private static final int IDEA_ID = 198004;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198004Service() {
        this(new Idea198004Config());
    }

    public Idea198004Service(Idea198004Config config) {
        this.config = config != null ? config : new Idea198004Config();
