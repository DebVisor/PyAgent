...
@Data
public class Idea197732Config {
    private String name = "idea_197732";
 ...
 */
@Slf4j
public class Idea197732Service {
    private static final int IDEA_ID = 197732;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197732Service() {
        this(new Idea197732Config());
    }

    public Idea197732Service(Idea197732Config config) {
        this.config = config != null ? config : new Idea197732Config();
