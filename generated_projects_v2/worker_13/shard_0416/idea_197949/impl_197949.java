...
@Data
public class Idea197949Config {
    private String name = "idea_197949";
 ...
 */
@Slf4j
public class Idea197949Service {
    private static final int IDEA_ID = 197949;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197949Service() {
        this(new Idea197949Config());
    }

    public Idea197949Service(Idea197949Config config) {
        this.config = config != null ? config : new Idea197949Config();
