...
@Data
public class Idea198012Config {
    private String name = "idea_198012";
 ...
 */
@Slf4j
public class Idea198012Service {
    private static final int IDEA_ID = 198012;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198012Service() {
        this(new Idea198012Config());
    }

    public Idea198012Service(Idea198012Config config) {
        this.config = config != null ? config : new Idea198012Config();
