...
@Data
public class Idea197788Config {
    private String name = "idea_197788";
 ...
 */
@Slf4j
public class Idea197788Service {
    private static final int IDEA_ID = 197788;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197788Service() {
        this(new Idea197788Config());
    }

    public Idea197788Service(Idea197788Config config) {
        this.config = config != null ? config : new Idea197788Config();
