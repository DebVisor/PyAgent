...
@Data
public class Idea197795Config {
    private String name = "idea_197795";
 ...
 */
@Slf4j
public class Idea197795Service {
    private static final int IDEA_ID = 197795;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197795Service() {
        this(new Idea197795Config());
    }

    public Idea197795Service(Idea197795Config config) {
        this.config = config != null ? config : new Idea197795Config();
