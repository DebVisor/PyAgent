...
@Data
public class Idea197821Config {
    private String name = "idea_197821";
 ...
 */
@Slf4j
public class Idea197821Service {
    private static final int IDEA_ID = 197821;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197821Service() {
        this(new Idea197821Config());
    }

    public Idea197821Service(Idea197821Config config) {
        this.config = config != null ? config : new Idea197821Config();
