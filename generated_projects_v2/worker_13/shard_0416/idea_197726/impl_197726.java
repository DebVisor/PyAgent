...
@Data
public class Idea197726Config {
    private String name = "idea_197726";
 ...
 */
@Slf4j
public class Idea197726Service {
    private static final int IDEA_ID = 197726;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197726Service() {
        this(new Idea197726Config());
    }

    public Idea197726Service(Idea197726Config config) {
        this.config = config != null ? config : new Idea197726Config();
