...
@Data
public class Idea197948Config {
    private String name = "idea_197948";
 ...
 */
@Slf4j
public class Idea197948Service {
    private static final int IDEA_ID = 197948;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197948Service() {
        this(new Idea197948Config());
    }

    public Idea197948Service(Idea197948Config config) {
        this.config = config != null ? config : new Idea197948Config();
