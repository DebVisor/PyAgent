...
@Data
public class Idea197779Config {
    private String name = "idea_197779";
 ...
 */
@Slf4j
public class Idea197779Service {
    private static final int IDEA_ID = 197779;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197779Service() {
        this(new Idea197779Config());
    }

    public Idea197779Service(Idea197779Config config) {
        this.config = config != null ? config : new Idea197779Config();
