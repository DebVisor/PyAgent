...
@Data
public class Idea198069Config {
    private String name = "idea_198069";
 ...
 */
@Slf4j
public class Idea198069Service {
    private static final int IDEA_ID = 198069;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198069Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198069Service() {
        this(new Idea198069Config());
    }

    public Idea198069Service(Idea198069Config config) {
        this.config = config != null ? config : new Idea198069Config();
