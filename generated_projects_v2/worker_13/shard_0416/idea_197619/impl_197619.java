...
@Data
public class Idea197619Config {
    private String name = "idea_197619";
 ...
 */
@Slf4j
public class Idea197619Service {
    private static final int IDEA_ID = 197619;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197619Service() {
        this(new Idea197619Config());
    }

    public Idea197619Service(Idea197619Config config) {
        this.config = config != null ? config : new Idea197619Config();
