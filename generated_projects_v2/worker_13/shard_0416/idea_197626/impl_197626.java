...
@Data
public class Idea197626Config {
    private String name = "idea_197626";
 ...
 */
@Slf4j
public class Idea197626Service {
    private static final int IDEA_ID = 197626;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197626Service() {
        this(new Idea197626Config());
    }

    public Idea197626Service(Idea197626Config config) {
        this.config = config != null ? config : new Idea197626Config();
