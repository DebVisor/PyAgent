...
@Data
public class Idea197804Config {
    private String name = "idea_197804";
 ...
 */
@Slf4j
public class Idea197804Service {
    private static final int IDEA_ID = 197804;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197804Service() {
        this(new Idea197804Config());
    }

    public Idea197804Service(Idea197804Config config) {
        this.config = config != null ? config : new Idea197804Config();
