...
@Data
public class Idea197859Config {
    private String name = "idea_197859";
 ...
 */
@Slf4j
public class Idea197859Service {
    private static final int IDEA_ID = 197859;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197859Service() {
        this(new Idea197859Config());
    }

    public Idea197859Service(Idea197859Config config) {
        this.config = config != null ? config : new Idea197859Config();
