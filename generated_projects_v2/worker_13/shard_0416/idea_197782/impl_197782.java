...
@Data
public class Idea197782Config {
    private String name = "idea_197782";
 ...
 */
@Slf4j
public class Idea197782Service {
    private static final int IDEA_ID = 197782;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197782Service() {
        this(new Idea197782Config());
    }

    public Idea197782Service(Idea197782Config config) {
        this.config = config != null ? config : new Idea197782Config();
