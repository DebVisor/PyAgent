...
@Data
public class Idea197632Config {
    private String name = "idea_197632";
 ...
 */
@Slf4j
public class Idea197632Service {
    private static final int IDEA_ID = 197632;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197632Service() {
        this(new Idea197632Config());
    }

    public Idea197632Service(Idea197632Config config) {
        this.config = config != null ? config : new Idea197632Config();
