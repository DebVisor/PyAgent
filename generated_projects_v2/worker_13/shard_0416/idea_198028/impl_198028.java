...
@Data
public class Idea198028Config {
    private String name = "idea_198028";
 ...
 */
@Slf4j
public class Idea198028Service {
    private static final int IDEA_ID = 198028;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198028Service() {
        this(new Idea198028Config());
    }

    public Idea198028Service(Idea198028Config config) {
        this.config = config != null ? config : new Idea198028Config();
