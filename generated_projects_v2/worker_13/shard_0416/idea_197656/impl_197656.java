...
@Data
public class Idea197656Config {
    private String name = "idea_197656";
 ...
 */
@Slf4j
public class Idea197656Service {
    private static final int IDEA_ID = 197656;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197656Service() {
        this(new Idea197656Config());
    }

    public Idea197656Service(Idea197656Config config) {
        this.config = config != null ? config : new Idea197656Config();
