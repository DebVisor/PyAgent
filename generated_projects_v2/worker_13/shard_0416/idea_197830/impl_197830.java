...
@Data
public class Idea197830Config {
    private String name = "idea_197830";
 ...
 */
@Slf4j
public class Idea197830Service {
    private static final int IDEA_ID = 197830;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197830Service() {
        this(new Idea197830Config());
    }

    public Idea197830Service(Idea197830Config config) {
        this.config = config != null ? config : new Idea197830Config();
