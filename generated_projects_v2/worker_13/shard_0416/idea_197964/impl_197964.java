...
@Data
public class Idea197964Config {
    private String name = "idea_197964";
 ...
 */
@Slf4j
public class Idea197964Service {
    private static final int IDEA_ID = 197964;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197964Service() {
        this(new Idea197964Config());
    }

    public Idea197964Service(Idea197964Config config) {
        this.config = config != null ? config : new Idea197964Config();
