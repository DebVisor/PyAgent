...
@Data
public class Idea197826Config {
    private String name = "idea_197826";
 ...
 */
@Slf4j
public class Idea197826Service {
    private static final int IDEA_ID = 197826;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197826Service() {
        this(new Idea197826Config());
    }

    public Idea197826Service(Idea197826Config config) {
        this.config = config != null ? config : new Idea197826Config();
