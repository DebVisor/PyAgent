...
@Data
public class Idea197674Config {
    private String name = "idea_197674";
 ...
 */
@Slf4j
public class Idea197674Service {
    private static final int IDEA_ID = 197674;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197674Service() {
        this(new Idea197674Config());
    }

    public Idea197674Service(Idea197674Config config) {
        this.config = config != null ? config : new Idea197674Config();
