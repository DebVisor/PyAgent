...
@Data
public class Idea197786Config {
    private String name = "idea_197786";
 ...
 */
@Slf4j
public class Idea197786Service {
    private static final int IDEA_ID = 197786;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197786Service() {
        this(new Idea197786Config());
    }

    public Idea197786Service(Idea197786Config config) {
        this.config = config != null ? config : new Idea197786Config();
