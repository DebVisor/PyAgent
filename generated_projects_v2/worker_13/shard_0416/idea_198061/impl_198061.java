...
@Data
public class Idea198061Config {
    private String name = "idea_198061";
 ...
 */
@Slf4j
public class Idea198061Service {
    private static final int IDEA_ID = 198061;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198061Service() {
        this(new Idea198061Config());
    }

    public Idea198061Service(Idea198061Config config) {
        this.config = config != null ? config : new Idea198061Config();
