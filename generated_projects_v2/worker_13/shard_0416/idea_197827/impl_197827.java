...
@Data
public class Idea197827Config {
    private String name = "idea_197827";
 ...
 */
@Slf4j
public class Idea197827Service {
    private static final int IDEA_ID = 197827;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197827Service() {
        this(new Idea197827Config());
    }

    public Idea197827Service(Idea197827Config config) {
        this.config = config != null ? config : new Idea197827Config();
