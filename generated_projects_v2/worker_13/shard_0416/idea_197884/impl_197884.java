...
@Data
public class Idea197884Config {
    private String name = "idea_197884";
 ...
 */
@Slf4j
public class Idea197884Service {
    private static final int IDEA_ID = 197884;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197884Service() {
        this(new Idea197884Config());
    }

    public Idea197884Service(Idea197884Config config) {
        this.config = config != null ? config : new Idea197884Config();
