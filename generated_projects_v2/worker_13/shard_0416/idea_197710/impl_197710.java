...
@Data
public class Idea197710Config {
    private String name = "idea_197710";
 ...
 */
@Slf4j
public class Idea197710Service {
    private static final int IDEA_ID = 197710;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197710Service() {
        this(new Idea197710Config());
    }

    public Idea197710Service(Idea197710Config config) {
        this.config = config != null ? config : new Idea197710Config();
