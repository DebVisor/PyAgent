...
@Data
public class Idea197910Config {
    private String name = "idea_197910";
 ...
 */
@Slf4j
public class Idea197910Service {
    private static final int IDEA_ID = 197910;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197910Service() {
        this(new Idea197910Config());
    }

    public Idea197910Service(Idea197910Config config) {
        this.config = config != null ? config : new Idea197910Config();
