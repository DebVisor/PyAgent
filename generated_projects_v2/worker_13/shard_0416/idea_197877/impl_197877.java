...
@Data
public class Idea197877Config {
    private String name = "idea_197877";
 ...
 */
@Slf4j
public class Idea197877Service {
    private static final int IDEA_ID = 197877;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197877Service() {
        this(new Idea197877Config());
    }

    public Idea197877Service(Idea197877Config config) {
        this.config = config != null ? config : new Idea197877Config();
