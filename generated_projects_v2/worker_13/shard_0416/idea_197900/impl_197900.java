...
@Data
public class Idea197900Config {
    private String name = "idea_197900";
 ...
 */
@Slf4j
public class Idea197900Service {
    private static final int IDEA_ID = 197900;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197900Service() {
        this(new Idea197900Config());
    }

    public Idea197900Service(Idea197900Config config) {
        this.config = config != null ? config : new Idea197900Config();
