...
@Data
public class Idea197952Config {
    private String name = "idea_197952";
 ...
 */
@Slf4j
public class Idea197952Service {
    private static final int IDEA_ID = 197952;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197952Service() {
        this(new Idea197952Config());
    }

    public Idea197952Service(Idea197952Config config) {
        this.config = config != null ? config : new Idea197952Config();
