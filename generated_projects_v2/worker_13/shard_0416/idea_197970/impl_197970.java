...
@Data
public class Idea197970Config {
    private String name = "idea_197970";
 ...
 */
@Slf4j
public class Idea197970Service {
    private static final int IDEA_ID = 197970;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197970Service() {
        this(new Idea197970Config());
    }

    public Idea197970Service(Idea197970Config config) {
        this.config = config != null ? config : new Idea197970Config();
