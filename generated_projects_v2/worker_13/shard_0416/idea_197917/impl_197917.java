...
@Data
public class Idea197917Config {
    private String name = "idea_197917";
 ...
 */
@Slf4j
public class Idea197917Service {
    private static final int IDEA_ID = 197917;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197917Service() {
        this(new Idea197917Config());
    }

    public Idea197917Service(Idea197917Config config) {
        this.config = config != null ? config : new Idea197917Config();
