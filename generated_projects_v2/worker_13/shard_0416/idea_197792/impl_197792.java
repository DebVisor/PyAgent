...
@Data
public class Idea197792Config {
    private String name = "idea_197792";
 ...
 */
@Slf4j
public class Idea197792Service {
    private static final int IDEA_ID = 197792;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197792Service() {
        this(new Idea197792Config());
    }

    public Idea197792Service(Idea197792Config config) {
        this.config = config != null ? config : new Idea197792Config();
