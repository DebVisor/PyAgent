...
@Data
public class Idea197642Config {
    private String name = "idea_197642";
 ...
 */
@Slf4j
public class Idea197642Service {
    private static final int IDEA_ID = 197642;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197642Service() {
        this(new Idea197642Config());
    }

    public Idea197642Service(Idea197642Config config) {
        this.config = config != null ? config : new Idea197642Config();
