...
@Data
public class Idea197660Config {
    private String name = "idea_197660";
 ...
 */
@Slf4j
public class Idea197660Service {
    private static final int IDEA_ID = 197660;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197660Service() {
        this(new Idea197660Config());
    }

    public Idea197660Service(Idea197660Config config) {
        this.config = config != null ? config : new Idea197660Config();
