...
@Data
public class Idea197894Config {
    private String name = "idea_197894";
 ...
 */
@Slf4j
public class Idea197894Service {
    private static final int IDEA_ID = 197894;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197894Service() {
        this(new Idea197894Config());
    }

    public Idea197894Service(Idea197894Config config) {
        this.config = config != null ? config : new Idea197894Config();
