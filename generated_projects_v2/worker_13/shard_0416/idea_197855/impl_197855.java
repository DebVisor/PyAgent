...
@Data
public class Idea197855Config {
    private String name = "idea_197855";
 ...
 */
@Slf4j
public class Idea197855Service {
    private static final int IDEA_ID = 197855;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197855Service() {
        this(new Idea197855Config());
    }

    public Idea197855Service(Idea197855Config config) {
        this.config = config != null ? config : new Idea197855Config();
