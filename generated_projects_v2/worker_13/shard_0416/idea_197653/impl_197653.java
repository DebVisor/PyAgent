...
@Data
public class Idea197653Config {
    private String name = "idea_197653";
 ...
 */
@Slf4j
public class Idea197653Service {
    private static final int IDEA_ID = 197653;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197653Service() {
        this(new Idea197653Config());
    }

    public Idea197653Service(Idea197653Config config) {
        this.config = config != null ? config : new Idea197653Config();
