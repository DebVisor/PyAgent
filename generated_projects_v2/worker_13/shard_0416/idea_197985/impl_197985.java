...
@Data
public class Idea197985Config {
    private String name = "idea_197985";
 ...
 */
@Slf4j
public class Idea197985Service {
    private static final int IDEA_ID = 197985;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197985Service() {
        this(new Idea197985Config());
    }

    public Idea197985Service(Idea197985Config config) {
        this.config = config != null ? config : new Idea197985Config();
