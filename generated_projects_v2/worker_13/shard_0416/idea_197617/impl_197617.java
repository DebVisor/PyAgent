...
@Data
public class Idea197617Config {
    private String name = "idea_197617";
 ...
 */
@Slf4j
public class Idea197617Service {
    private static final int IDEA_ID = 197617;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197617Service() {
        this(new Idea197617Config());
    }

    public Idea197617Service(Idea197617Config config) {
        this.config = config != null ? config : new Idea197617Config();
