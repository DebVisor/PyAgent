...
@Data
public class Idea197838Config {
    private String name = "idea_197838";
 ...
 */
@Slf4j
public class Idea197838Service {
    private static final int IDEA_ID = 197838;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197838Service() {
        this(new Idea197838Config());
    }

    public Idea197838Service(Idea197838Config config) {
        this.config = config != null ? config : new Idea197838Config();
