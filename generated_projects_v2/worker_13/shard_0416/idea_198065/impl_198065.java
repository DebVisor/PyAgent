...
@Data
public class Idea198065Config {
    private String name = "idea_198065";
 ...
 */
@Slf4j
public class Idea198065Service {
    private static final int IDEA_ID = 198065;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198065Service() {
        this(new Idea198065Config());
    }

    public Idea198065Service(Idea198065Config config) {
        this.config = config != null ? config : new Idea198065Config();
