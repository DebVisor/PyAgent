...
@Data
public class Idea197923Config {
    private String name = "idea_197923";
 ...
 */
@Slf4j
public class Idea197923Service {
    private static final int IDEA_ID = 197923;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197923Service() {
        this(new Idea197923Config());
    }

    public Idea197923Service(Idea197923Config config) {
        this.config = config != null ? config : new Idea197923Config();
