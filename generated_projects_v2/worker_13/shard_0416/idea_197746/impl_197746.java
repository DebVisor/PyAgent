...
@Data
public class Idea197746Config {
    private String name = "idea_197746";
 ...
 */
@Slf4j
public class Idea197746Service {
    private static final int IDEA_ID = 197746;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197746Service() {
        this(new Idea197746Config());
    }

    public Idea197746Service(Idea197746Config config) {
        this.config = config != null ? config : new Idea197746Config();
