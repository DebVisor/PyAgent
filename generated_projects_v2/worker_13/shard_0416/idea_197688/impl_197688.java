...
@Data
public class Idea197688Config {
    private String name = "idea_197688";
 ...
 */
@Slf4j
public class Idea197688Service {
    private static final int IDEA_ID = 197688;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197688Service() {
        this(new Idea197688Config());
    }

    public Idea197688Service(Idea197688Config config) {
        this.config = config != null ? config : new Idea197688Config();
