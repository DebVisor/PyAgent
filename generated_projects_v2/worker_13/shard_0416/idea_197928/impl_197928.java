...
@Data
public class Idea197928Config {
    private String name = "idea_197928";
 ...
 */
@Slf4j
public class Idea197928Service {
    private static final int IDEA_ID = 197928;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197928Service() {
        this(new Idea197928Config());
    }

    public Idea197928Service(Idea197928Config config) {
        this.config = config != null ? config : new Idea197928Config();
