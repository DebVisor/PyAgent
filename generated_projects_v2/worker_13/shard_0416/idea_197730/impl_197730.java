...
@Data
public class Idea197730Config {
    private String name = "idea_197730";
 ...
 */
@Slf4j
public class Idea197730Service {
    private static final int IDEA_ID = 197730;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197730Service() {
        this(new Idea197730Config());
    }

    public Idea197730Service(Idea197730Config config) {
        this.config = config != null ? config : new Idea197730Config();
