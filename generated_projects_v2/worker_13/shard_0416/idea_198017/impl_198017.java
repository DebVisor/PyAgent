...
@Data
public class Idea198017Config {
    private String name = "idea_198017";
 ...
 */
@Slf4j
public class Idea198017Service {
    private static final int IDEA_ID = 198017;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198017Service() {
        this(new Idea198017Config());
    }

    public Idea198017Service(Idea198017Config config) {
        this.config = config != null ? config : new Idea198017Config();
