...
@Data
public class Idea197756Config {
    private String name = "idea_197756";
 ...
 */
@Slf4j
public class Idea197756Service {
    private static final int IDEA_ID = 197756;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197756Service() {
        this(new Idea197756Config());
    }

    public Idea197756Service(Idea197756Config config) {
        this.config = config != null ? config : new Idea197756Config();
