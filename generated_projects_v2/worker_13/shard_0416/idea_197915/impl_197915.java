...
@Data
public class Idea197915Config {
    private String name = "idea_197915";
 ...
 */
@Slf4j
public class Idea197915Service {
    private static final int IDEA_ID = 197915;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197915Service() {
        this(new Idea197915Config());
    }

    public Idea197915Service(Idea197915Config config) {
        this.config = config != null ? config : new Idea197915Config();
