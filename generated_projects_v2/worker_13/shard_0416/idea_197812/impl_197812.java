...
@Data
public class Idea197812Config {
    private String name = "idea_197812";
 ...
 */
@Slf4j
public class Idea197812Service {
    private static final int IDEA_ID = 197812;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197812Service() {
        this(new Idea197812Config());
    }

    public Idea197812Service(Idea197812Config config) {
        this.config = config != null ? config : new Idea197812Config();
