...
@Data
public class Idea197961Config {
    private String name = "idea_197961";
 ...
 */
@Slf4j
public class Idea197961Service {
    private static final int IDEA_ID = 197961;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197961Service() {
        this(new Idea197961Config());
    }

    public Idea197961Service(Idea197961Config config) {
        this.config = config != null ? config : new Idea197961Config();
