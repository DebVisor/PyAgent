...
@Data
public class Idea197620Config {
    private String name = "idea_197620";
 ...
 */
@Slf4j
public class Idea197620Service {
    private static final int IDEA_ID = 197620;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197620Service() {
        this(new Idea197620Config());
    }

    public Idea197620Service(Idea197620Config config) {
        this.config = config != null ? config : new Idea197620Config();
