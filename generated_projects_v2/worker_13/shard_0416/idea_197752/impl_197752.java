...
@Data
public class Idea197752Config {
    private String name = "idea_197752";
 ...
 */
@Slf4j
public class Idea197752Service {
    private static final int IDEA_ID = 197752;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197752Service() {
        this(new Idea197752Config());
    }

    public Idea197752Service(Idea197752Config config) {
        this.config = config != null ? config : new Idea197752Config();
