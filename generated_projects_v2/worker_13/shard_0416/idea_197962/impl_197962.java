...
@Data
public class Idea197962Config {
    private String name = "idea_197962";
 ...
 */
@Slf4j
public class Idea197962Service {
    private static final int IDEA_ID = 197962;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197962Service() {
        this(new Idea197962Config());
    }

    public Idea197962Service(Idea197962Config config) {
        this.config = config != null ? config : new Idea197962Config();
