...
@Data
public class Idea197648Config {
    private String name = "idea_197648";
 ...
 */
@Slf4j
public class Idea197648Service {
    private static final int IDEA_ID = 197648;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197648Service() {
        this(new Idea197648Config());
    }

    public Idea197648Service(Idea197648Config config) {
        this.config = config != null ? config : new Idea197648Config();
