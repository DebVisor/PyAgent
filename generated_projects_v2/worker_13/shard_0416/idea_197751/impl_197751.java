...
@Data
public class Idea197751Config {
    private String name = "idea_197751";
 ...
 */
@Slf4j
public class Idea197751Service {
    private static final int IDEA_ID = 197751;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197751Service() {
        this(new Idea197751Config());
    }

    public Idea197751Service(Idea197751Config config) {
        this.config = config != null ? config : new Idea197751Config();
