...
@Data
public class Idea197758Config {
    private String name = "idea_197758";
 ...
 */
@Slf4j
public class Idea197758Service {
    private static final int IDEA_ID = 197758;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197758Service() {
        this(new Idea197758Config());
    }

    public Idea197758Service(Idea197758Config config) {
        this.config = config != null ? config : new Idea197758Config();
