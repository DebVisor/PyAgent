...
@Data
public class Idea197891Config {
    private String name = "idea_197891";
 ...
 */
@Slf4j
public class Idea197891Service {
    private static final int IDEA_ID = 197891;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197891Service() {
        this(new Idea197891Config());
    }

    public Idea197891Service(Idea197891Config config) {
        this.config = config != null ? config : new Idea197891Config();
