...
@Data
public class Idea197908Config {
    private String name = "idea_197908";
 ...
 */
@Slf4j
public class Idea197908Service {
    private static final int IDEA_ID = 197908;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197908Service() {
        this(new Idea197908Config());
    }

    public Idea197908Service(Idea197908Config config) {
        this.config = config != null ? config : new Idea197908Config();
