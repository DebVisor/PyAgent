...
@Data
public class Idea197834Config {
    private String name = "idea_197834";
 ...
 */
@Slf4j
public class Idea197834Service {
    private static final int IDEA_ID = 197834;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197834Service() {
        this(new Idea197834Config());
    }

    public Idea197834Service(Idea197834Config config) {
        this.config = config != null ? config : new Idea197834Config();
