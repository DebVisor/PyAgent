...
@Data
public class Idea197703Config {
    private String name = "idea_197703";
 ...
 */
@Slf4j
public class Idea197703Service {
    private static final int IDEA_ID = 197703;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197703Service() {
        this(new Idea197703Config());
    }

    public Idea197703Service(Idea197703Config config) {
        this.config = config != null ? config : new Idea197703Config();
