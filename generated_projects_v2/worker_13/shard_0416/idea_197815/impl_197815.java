...
@Data
public class Idea197815Config {
    private String name = "idea_197815";
 ...
 */
@Slf4j
public class Idea197815Service {
    private static final int IDEA_ID = 197815;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197815Service() {
        this(new Idea197815Config());
    }

    public Idea197815Service(Idea197815Config config) {
        this.config = config != null ? config : new Idea197815Config();
