...
@Data
public class Idea197644Config {
    private String name = "idea_197644";
 ...
 */
@Slf4j
public class Idea197644Service {
    private static final int IDEA_ID = 197644;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197644Service() {
        this(new Idea197644Config());
    }

    public Idea197644Service(Idea197644Config config) {
        this.config = config != null ? config : new Idea197644Config();
