...
@Data
public class Idea197930Config {
    private String name = "idea_197930";
 ...
 */
@Slf4j
public class Idea197930Service {
    private static final int IDEA_ID = 197930;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197930Service() {
        this(new Idea197930Config());
    }

    public Idea197930Service(Idea197930Config config) {
        this.config = config != null ? config : new Idea197930Config();
