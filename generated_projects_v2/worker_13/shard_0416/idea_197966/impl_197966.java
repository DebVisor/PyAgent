...
@Data
public class Idea197966Config {
    private String name = "idea_197966";
 ...
 */
@Slf4j
public class Idea197966Service {
    private static final int IDEA_ID = 197966;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197966Service() {
        this(new Idea197966Config());
    }

    public Idea197966Service(Idea197966Config config) {
        this.config = config != null ? config : new Idea197966Config();
