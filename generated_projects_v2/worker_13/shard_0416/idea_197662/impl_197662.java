...
@Data
public class Idea197662Config {
    private String name = "idea_197662";
 ...
 */
@Slf4j
public class Idea197662Service {
    private static final int IDEA_ID = 197662;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197662Service() {
        this(new Idea197662Config());
    }

    public Idea197662Service(Idea197662Config config) {
        this.config = config != null ? config : new Idea197662Config();
