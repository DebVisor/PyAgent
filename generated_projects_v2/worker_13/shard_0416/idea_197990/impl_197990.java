...
@Data
public class Idea197990Config {
    private String name = "idea_197990";
 ...
 */
@Slf4j
public class Idea197990Service {
    private static final int IDEA_ID = 197990;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197990Service() {
        this(new Idea197990Config());
    }

    public Idea197990Service(Idea197990Config config) {
        this.config = config != null ? config : new Idea197990Config();
