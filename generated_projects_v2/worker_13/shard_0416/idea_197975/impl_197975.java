...
@Data
public class Idea197975Config {
    private String name = "idea_197975";
 ...
 */
@Slf4j
public class Idea197975Service {
    private static final int IDEA_ID = 197975;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197975Service() {
        this(new Idea197975Config());
    }

    public Idea197975Service(Idea197975Config config) {
        this.config = config != null ? config : new Idea197975Config();
