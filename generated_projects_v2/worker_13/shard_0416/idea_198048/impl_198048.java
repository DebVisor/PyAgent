...
@Data
public class Idea198048Config {
    private String name = "idea_198048";
 ...
 */
@Slf4j
public class Idea198048Service {
    private static final int IDEA_ID = 198048;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198048Service() {
        this(new Idea198048Config());
    }

    public Idea198048Service(Idea198048Config config) {
        this.config = config != null ? config : new Idea198048Config();
