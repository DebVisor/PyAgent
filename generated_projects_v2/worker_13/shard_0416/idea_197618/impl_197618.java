...
@Data
public class Idea197618Config {
    private String name = "idea_197618";
 ...
 */
@Slf4j
public class Idea197618Service {
    private static final int IDEA_ID = 197618;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197618Service() {
        this(new Idea197618Config());
    }

    public Idea197618Service(Idea197618Config config) {
        this.config = config != null ? config : new Idea197618Config();
