...
@Data
public class Idea197897Config {
    private String name = "idea_197897";
 ...
 */
@Slf4j
public class Idea197897Service {
    private static final int IDEA_ID = 197897;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197897Service() {
        this(new Idea197897Config());
    }

    public Idea197897Service(Idea197897Config config) {
        this.config = config != null ? config : new Idea197897Config();
