...
@Data
public class Idea198005Config {
    private String name = "idea_198005";
 ...
 */
@Slf4j
public class Idea198005Service {
    private static final int IDEA_ID = 198005;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198005Service() {
        this(new Idea198005Config());
    }

    public Idea198005Service(Idea198005Config config) {
        this.config = config != null ? config : new Idea198005Config();
