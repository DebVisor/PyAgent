...
@Data
public class Idea197973Config {
    private String name = "idea_197973";
 ...
 */
@Slf4j
public class Idea197973Service {
    private static final int IDEA_ID = 197973;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197973Service() {
        this(new Idea197973Config());
    }

    public Idea197973Service(Idea197973Config config) {
        this.config = config != null ? config : new Idea197973Config();
