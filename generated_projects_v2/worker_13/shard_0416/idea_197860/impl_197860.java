...
@Data
public class Idea197860Config {
    private String name = "idea_197860";
 ...
 */
@Slf4j
public class Idea197860Service {
    private static final int IDEA_ID = 197860;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197860Service() {
        this(new Idea197860Config());
    }

    public Idea197860Service(Idea197860Config config) {
        this.config = config != null ? config : new Idea197860Config();
