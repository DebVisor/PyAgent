...
@Data
public class Idea197724Config {
    private String name = "idea_197724";
 ...
 */
@Slf4j
public class Idea197724Service {
    private static final int IDEA_ID = 197724;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197724Service() {
        this(new Idea197724Config());
    }

    public Idea197724Service(Idea197724Config config) {
        this.config = config != null ? config : new Idea197724Config();
