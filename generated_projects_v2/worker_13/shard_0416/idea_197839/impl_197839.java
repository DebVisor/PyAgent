...
@Data
public class Idea197839Config {
    private String name = "idea_197839";
 ...
 */
@Slf4j
public class Idea197839Service {
    private static final int IDEA_ID = 197839;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197839Service() {
        this(new Idea197839Config());
    }

    public Idea197839Service(Idea197839Config config) {
        this.config = config != null ? config : new Idea197839Config();
