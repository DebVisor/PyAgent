...
@Data
public class Idea197995Config {
    private String name = "idea_197995";
 ...
 */
@Slf4j
public class Idea197995Service {
    private static final int IDEA_ID = 197995;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197995Service() {
        this(new Idea197995Config());
    }

    public Idea197995Service(Idea197995Config config) {
        this.config = config != null ? config : new Idea197995Config();
