...
@Data
public class Idea197627Config {
    private String name = "idea_197627";
 ...
 */
@Slf4j
public class Idea197627Service {
    private static final int IDEA_ID = 197627;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197627Service() {
        this(new Idea197627Config());
    }

    public Idea197627Service(Idea197627Config config) {
        this.config = config != null ? config : new Idea197627Config();
