...
@Data
public class Idea197676Config {
    private String name = "idea_197676";
 ...
 */
@Slf4j
public class Idea197676Service {
    private static final int IDEA_ID = 197676;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197676Service() {
        this(new Idea197676Config());
    }

    public Idea197676Service(Idea197676Config config) {
        this.config = config != null ? config : new Idea197676Config();
