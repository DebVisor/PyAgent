...
@Data
public class Idea197905Config {
    private String name = "idea_197905";
 ...
 */
@Slf4j
public class Idea197905Service {
    private static final int IDEA_ID = 197905;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197905Service() {
        this(new Idea197905Config());
    }

    public Idea197905Service(Idea197905Config config) {
        this.config = config != null ? config : new Idea197905Config();
