...
@Data
public class Idea197831Config {
    private String name = "idea_197831";
 ...
 */
@Slf4j
public class Idea197831Service {
    private static final int IDEA_ID = 197831;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197831Service() {
        this(new Idea197831Config());
    }

    public Idea197831Service(Idea197831Config config) {
        this.config = config != null ? config : new Idea197831Config();
