...
@Data
public class Idea198006Config {
    private String name = "idea_198006";
 ...
 */
@Slf4j
public class Idea198006Service {
    private static final int IDEA_ID = 198006;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198006Service() {
        this(new Idea198006Config());
    }

    public Idea198006Service(Idea198006Config config) {
        this.config = config != null ? config : new Idea198006Config();
