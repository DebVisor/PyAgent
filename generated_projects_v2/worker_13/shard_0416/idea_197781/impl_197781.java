...
@Data
public class Idea197781Config {
    private String name = "idea_197781";
 ...
 */
@Slf4j
public class Idea197781Service {
    private static final int IDEA_ID = 197781;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197781Service() {
        this(new Idea197781Config());
    }

    public Idea197781Service(Idea197781Config config) {
        this.config = config != null ? config : new Idea197781Config();
