...
@Data
public class Idea197721Config {
    private String name = "idea_197721";
 ...
 */
@Slf4j
public class Idea197721Service {
    private static final int IDEA_ID = 197721;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197721Service() {
        this(new Idea197721Config());
    }

    public Idea197721Service(Idea197721Config config) {
        this.config = config != null ? config : new Idea197721Config();
