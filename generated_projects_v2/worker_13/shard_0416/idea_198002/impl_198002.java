...
@Data
public class Idea198002Config {
    private String name = "idea_198002";
 ...
 */
@Slf4j
public class Idea198002Service {
    private static final int IDEA_ID = 198002;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198002Service() {
        this(new Idea198002Config());
    }

    public Idea198002Service(Idea198002Config config) {
        this.config = config != null ? config : new Idea198002Config();
