...
@Data
public class Idea197600Config {
    private String name = "idea_197600";
 ...
 */
@Slf4j
public class Idea197600Service {
    private static final int IDEA_ID = 197600;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197600Service() {
        this(new Idea197600Config());
    }

    public Idea197600Service(Idea197600Config config) {
        this.config = config != null ? config : new Idea197600Config();
