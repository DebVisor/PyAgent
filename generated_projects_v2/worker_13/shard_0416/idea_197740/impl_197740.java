...
@Data
public class Idea197740Config {
    private String name = "idea_197740";
 ...
 */
@Slf4j
public class Idea197740Service {
    private static final int IDEA_ID = 197740;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197740Service() {
        this(new Idea197740Config());
    }

    public Idea197740Service(Idea197740Config config) {
        this.config = config != null ? config : new Idea197740Config();
