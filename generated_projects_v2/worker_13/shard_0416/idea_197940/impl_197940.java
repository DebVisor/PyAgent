...
@Data
public class Idea197940Config {
    private String name = "idea_197940";
 ...
 */
@Slf4j
public class Idea197940Service {
    private static final int IDEA_ID = 197940;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197940Service() {
        this(new Idea197940Config());
    }

    public Idea197940Service(Idea197940Config config) {
        this.config = config != null ? config : new Idea197940Config();
