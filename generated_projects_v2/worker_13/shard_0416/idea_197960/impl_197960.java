...
@Data
public class Idea197960Config {
    private String name = "idea_197960";
 ...
 */
@Slf4j
public class Idea197960Service {
    private static final int IDEA_ID = 197960;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197960Service() {
        this(new Idea197960Config());
    }

    public Idea197960Service(Idea197960Config config) {
        this.config = config != null ? config : new Idea197960Config();
