...
@Data
public class Idea197976Config {
    private String name = "idea_197976";
 ...
 */
@Slf4j
public class Idea197976Service {
    private static final int IDEA_ID = 197976;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197976Service() {
        this(new Idea197976Config());
    }

    public Idea197976Service(Idea197976Config config) {
        this.config = config != null ? config : new Idea197976Config();
