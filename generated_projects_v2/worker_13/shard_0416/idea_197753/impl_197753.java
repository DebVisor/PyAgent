...
@Data
public class Idea197753Config {
    private String name = "idea_197753";
 ...
 */
@Slf4j
public class Idea197753Service {
    private static final int IDEA_ID = 197753;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197753Service() {
        this(new Idea197753Config());
    }

    public Idea197753Service(Idea197753Config config) {
        this.config = config != null ? config : new Idea197753Config();
