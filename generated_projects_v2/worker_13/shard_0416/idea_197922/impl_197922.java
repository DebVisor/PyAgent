...
@Data
public class Idea197922Config {
    private String name = "idea_197922";
 ...
 */
@Slf4j
public class Idea197922Service {
    private static final int IDEA_ID = 197922;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197922Service() {
        this(new Idea197922Config());
    }

    public Idea197922Service(Idea197922Config config) {
        this.config = config != null ? config : new Idea197922Config();
