...
@Data
public class Idea197846Config {
    private String name = "idea_197846";
 ...
 */
@Slf4j
public class Idea197846Service {
    private static final int IDEA_ID = 197846;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197846Service() {
        this(new Idea197846Config());
    }

    public Idea197846Service(Idea197846Config config) {
        this.config = config != null ? config : new Idea197846Config();
