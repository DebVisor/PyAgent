...
@Data
public class Idea197607Config {
    private String name = "idea_197607";
 ...
 */
@Slf4j
public class Idea197607Service {
    private static final int IDEA_ID = 197607;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197607Service() {
        this(new Idea197607Config());
    }

    public Idea197607Service(Idea197607Config config) {
        this.config = config != null ? config : new Idea197607Config();
