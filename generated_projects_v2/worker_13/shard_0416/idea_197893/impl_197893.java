...
@Data
public class Idea197893Config {
    private String name = "idea_197893";
 ...
 */
@Slf4j
public class Idea197893Service {
    private static final int IDEA_ID = 197893;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197893Service() {
        this(new Idea197893Config());
    }

    public Idea197893Service(Idea197893Config config) {
        this.config = config != null ? config : new Idea197893Config();
