...
@Data
public class Idea197697Config {
    private String name = "idea_197697";
 ...
 */
@Slf4j
public class Idea197697Service {
    private static final int IDEA_ID = 197697;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197697Service() {
        this(new Idea197697Config());
    }

    public Idea197697Service(Idea197697Config config) {
        this.config = config != null ? config : new Idea197697Config();
