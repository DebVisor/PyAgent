...
@Data
public class Idea197992Config {
    private String name = "idea_197992";
 ...
 */
@Slf4j
public class Idea197992Service {
    private static final int IDEA_ID = 197992;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197992Service() {
        this(new Idea197992Config());
    }

    public Idea197992Service(Idea197992Config config) {
        this.config = config != null ? config : new Idea197992Config();
