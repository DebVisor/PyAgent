...
@Data
public class Idea197903Config {
    private String name = "idea_197903";
 ...
 */
@Slf4j
public class Idea197903Service {
    private static final int IDEA_ID = 197903;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197903Service() {
        this(new Idea197903Config());
    }

    public Idea197903Service(Idea197903Config config) {
        this.config = config != null ? config : new Idea197903Config();
