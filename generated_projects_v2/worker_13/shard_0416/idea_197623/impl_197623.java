...
@Data
public class Idea197623Config {
    private String name = "idea_197623";
 ...
 */
@Slf4j
public class Idea197623Service {
    private static final int IDEA_ID = 197623;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197623Service() {
        this(new Idea197623Config());
    }

    public Idea197623Service(Idea197623Config config) {
        this.config = config != null ? config : new Idea197623Config();
