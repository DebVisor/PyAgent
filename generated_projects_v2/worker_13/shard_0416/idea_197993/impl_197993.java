...
@Data
public class Idea197993Config {
    private String name = "idea_197993";
 ...
 */
@Slf4j
public class Idea197993Service {
    private static final int IDEA_ID = 197993;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197993Service() {
        this(new Idea197993Config());
    }

    public Idea197993Service(Idea197993Config config) {
        this.config = config != null ? config : new Idea197993Config();
