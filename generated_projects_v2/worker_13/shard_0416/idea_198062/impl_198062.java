...
@Data
public class Idea198062Config {
    private String name = "idea_198062";
 ...
 */
@Slf4j
public class Idea198062Service {
    private static final int IDEA_ID = 198062;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198062Service() {
        this(new Idea198062Config());
    }

    public Idea198062Service(Idea198062Config config) {
        this.config = config != null ? config : new Idea198062Config();
