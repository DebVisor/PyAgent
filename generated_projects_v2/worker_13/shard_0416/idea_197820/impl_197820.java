...
@Data
public class Idea197820Config {
    private String name = "idea_197820";
 ...
 */
@Slf4j
public class Idea197820Service {
    private static final int IDEA_ID = 197820;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197820Service() {
        this(new Idea197820Config());
    }

    public Idea197820Service(Idea197820Config config) {
        this.config = config != null ? config : new Idea197820Config();
