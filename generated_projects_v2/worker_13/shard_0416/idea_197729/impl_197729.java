...
@Data
public class Idea197729Config {
    private String name = "idea_197729";
 ...
 */
@Slf4j
public class Idea197729Service {
    private static final int IDEA_ID = 197729;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197729Service() {
        this(new Idea197729Config());
    }

    public Idea197729Service(Idea197729Config config) {
        this.config = config != null ? config : new Idea197729Config();
