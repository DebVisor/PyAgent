...
@Data
public class Idea198018Config {
    private String name = "idea_198018";
 ...
 */
@Slf4j
public class Idea198018Service {
    private static final int IDEA_ID = 198018;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198018Service() {
        this(new Idea198018Config());
    }

    public Idea198018Service(Idea198018Config config) {
        this.config = config != null ? config : new Idea198018Config();
