...
@Data
public class Idea197613Config {
    private String name = "idea_197613";
 ...
 */
@Slf4j
public class Idea197613Service {
    private static final int IDEA_ID = 197613;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197613Service() {
        this(new Idea197613Config());
    }

    public Idea197613Service(Idea197613Config config) {
        this.config = config != null ? config : new Idea197613Config();
