...
@Data
public class Idea197765Config {
    private String name = "idea_197765";
 ...
 */
@Slf4j
public class Idea197765Service {
    private static final int IDEA_ID = 197765;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197765Service() {
        this(new Idea197765Config());
    }

    public Idea197765Service(Idea197765Config config) {
        this.config = config != null ? config : new Idea197765Config();
