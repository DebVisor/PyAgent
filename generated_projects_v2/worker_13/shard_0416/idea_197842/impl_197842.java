...
@Data
public class Idea197842Config {
    private String name = "idea_197842";
 ...
 */
@Slf4j
public class Idea197842Service {
    private static final int IDEA_ID = 197842;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197842Service() {
        this(new Idea197842Config());
    }

    public Idea197842Service(Idea197842Config config) {
        this.config = config != null ? config : new Idea197842Config();
