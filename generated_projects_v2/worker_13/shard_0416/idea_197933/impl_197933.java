...
@Data
public class Idea197933Config {
    private String name = "idea_197933";
 ...
 */
@Slf4j
public class Idea197933Service {
    private static final int IDEA_ID = 197933;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197933Service() {
        this(new Idea197933Config());
    }

    public Idea197933Service(Idea197933Config config) {
        this.config = config != null ? config : new Idea197933Config();
