...
@Data
public class Idea197713Config {
    private String name = "idea_197713";
 ...
 */
@Slf4j
public class Idea197713Service {
    private static final int IDEA_ID = 197713;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197713Service() {
        this(new Idea197713Config());
    }

    public Idea197713Service(Idea197713Config config) {
        this.config = config != null ? config : new Idea197713Config();
