...
@Data
public class Idea197954Config {
    private String name = "idea_197954";
 ...
 */
@Slf4j
public class Idea197954Service {
    private static final int IDEA_ID = 197954;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197954Service() {
        this(new Idea197954Config());
    }

    public Idea197954Service(Idea197954Config config) {
        this.config = config != null ? config : new Idea197954Config();
