...
@Data
public class Idea197673Config {
    private String name = "idea_197673";
 ...
 */
@Slf4j
public class Idea197673Service {
    private static final int IDEA_ID = 197673;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197673Service() {
        this(new Idea197673Config());
    }

    public Idea197673Service(Idea197673Config config) {
        this.config = config != null ? config : new Idea197673Config();
