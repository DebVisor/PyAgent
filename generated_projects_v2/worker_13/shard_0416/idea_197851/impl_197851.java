...
@Data
public class Idea197851Config {
    private String name = "idea_197851";
 ...
 */
@Slf4j
public class Idea197851Service {
    private static final int IDEA_ID = 197851;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197851Service() {
        this(new Idea197851Config());
    }

    public Idea197851Service(Idea197851Config config) {
        this.config = config != null ? config : new Idea197851Config();
