...
@Data
public class Idea197687Config {
    private String name = "idea_197687";
 ...
 */
@Slf4j
public class Idea197687Service {
    private static final int IDEA_ID = 197687;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197687Service() {
        this(new Idea197687Config());
    }

    public Idea197687Service(Idea197687Config config) {
        this.config = config != null ? config : new Idea197687Config();
