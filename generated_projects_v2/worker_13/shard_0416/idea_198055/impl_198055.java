...
@Data
public class Idea198055Config {
    private String name = "idea_198055";
 ...
 */
@Slf4j
public class Idea198055Service {
    private static final int IDEA_ID = 198055;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198055Service() {
        this(new Idea198055Config());
    }

    public Idea198055Service(Idea198055Config config) {
        this.config = config != null ? config : new Idea198055Config();
