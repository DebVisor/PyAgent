...
@Data
public class Idea197849Config {
    private String name = "idea_197849";
 ...
 */
@Slf4j
public class Idea197849Service {
    private static final int IDEA_ID = 197849;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197849Service() {
        this(new Idea197849Config());
    }

    public Idea197849Service(Idea197849Config config) {
        this.config = config != null ? config : new Idea197849Config();
