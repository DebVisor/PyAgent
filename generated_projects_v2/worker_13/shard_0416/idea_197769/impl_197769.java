...
@Data
public class Idea197769Config {
    private String name = "idea_197769";
 ...
 */
@Slf4j
public class Idea197769Service {
    private static final int IDEA_ID = 197769;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197769Service() {
        this(new Idea197769Config());
    }

    public Idea197769Service(Idea197769Config config) {
        this.config = config != null ? config : new Idea197769Config();
