...
@Data
public class Idea197944Config {
    private String name = "idea_197944";
 ...
 */
@Slf4j
public class Idea197944Service {
    private static final int IDEA_ID = 197944;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197944Service() {
        this(new Idea197944Config());
    }

    public Idea197944Service(Idea197944Config config) {
        this.config = config != null ? config : new Idea197944Config();
