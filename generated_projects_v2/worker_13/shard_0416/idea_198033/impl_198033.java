...
@Data
public class Idea198033Config {
    private String name = "idea_198033";
 ...
 */
@Slf4j
public class Idea198033Service {
    private static final int IDEA_ID = 198033;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198033Service() {
        this(new Idea198033Config());
    }

    public Idea198033Service(Idea198033Config config) {
        this.config = config != null ? config : new Idea198033Config();
