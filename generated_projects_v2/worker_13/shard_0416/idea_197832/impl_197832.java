...
@Data
public class Idea197832Config {
    private String name = "idea_197832";
 ...
 */
@Slf4j
public class Idea197832Service {
    private static final int IDEA_ID = 197832;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197832Service() {
        this(new Idea197832Config());
    }

    public Idea197832Service(Idea197832Config config) {
        this.config = config != null ? config : new Idea197832Config();
