...
@Data
public class Idea198053Config {
    private String name = "idea_198053";
 ...
 */
@Slf4j
public class Idea198053Service {
    private static final int IDEA_ID = 198053;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198053Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198053Service() {
        this(new Idea198053Config());
    }

    public Idea198053Service(Idea198053Config config) {
        this.config = config != null ? config : new Idea198053Config();
