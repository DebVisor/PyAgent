...
@Data
public class Idea197886Config {
    private String name = "idea_197886";
 ...
 */
@Slf4j
public class Idea197886Service {
    private static final int IDEA_ID = 197886;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197886Service() {
        this(new Idea197886Config());
    }

    public Idea197886Service(Idea197886Config config) {
        this.config = config != null ? config : new Idea197886Config();
