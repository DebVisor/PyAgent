...
@Data
public class Idea197775Config {
    private String name = "idea_197775";
 ...
 */
@Slf4j
public class Idea197775Service {
    private static final int IDEA_ID = 197775;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197775Service() {
        this(new Idea197775Config());
    }

    public Idea197775Service(Idea197775Config config) {
        this.config = config != null ? config : new Idea197775Config();
