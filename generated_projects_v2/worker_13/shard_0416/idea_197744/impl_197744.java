...
@Data
public class Idea197744Config {
    private String name = "idea_197744";
 ...
 */
@Slf4j
public class Idea197744Service {
    private static final int IDEA_ID = 197744;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197744Service() {
        this(new Idea197744Config());
    }

    public Idea197744Service(Idea197744Config config) {
        this.config = config != null ? config : new Idea197744Config();
