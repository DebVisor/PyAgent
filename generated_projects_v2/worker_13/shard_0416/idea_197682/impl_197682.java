...
@Data
public class Idea197682Config {
    private String name = "idea_197682";
 ...
 */
@Slf4j
public class Idea197682Service {
    private static final int IDEA_ID = 197682;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197682Service() {
        this(new Idea197682Config());
    }

    public Idea197682Service(Idea197682Config config) {
        this.config = config != null ? config : new Idea197682Config();
