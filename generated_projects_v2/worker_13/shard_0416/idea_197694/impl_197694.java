...
@Data
public class Idea197694Config {
    private String name = "idea_197694";
 ...
 */
@Slf4j
public class Idea197694Service {
    private static final int IDEA_ID = 197694;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197694Service() {
        this(new Idea197694Config());
    }

    public Idea197694Service(Idea197694Config config) {
        this.config = config != null ? config : new Idea197694Config();
