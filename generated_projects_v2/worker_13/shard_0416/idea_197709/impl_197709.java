...
@Data
public class Idea197709Config {
    private String name = "idea_197709";
 ...
 */
@Slf4j
public class Idea197709Service {
    private static final int IDEA_ID = 197709;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197709Service() {
        this(new Idea197709Config());
    }

    public Idea197709Service(Idea197709Config config) {
        this.config = config != null ? config : new Idea197709Config();
