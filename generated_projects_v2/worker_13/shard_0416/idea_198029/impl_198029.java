...
@Data
public class Idea198029Config {
    private String name = "idea_198029";
 ...
 */
@Slf4j
public class Idea198029Service {
    private static final int IDEA_ID = 198029;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198029Service() {
        this(new Idea198029Config());
    }

    public Idea198029Service(Idea198029Config config) {
        this.config = config != null ? config : new Idea198029Config();
