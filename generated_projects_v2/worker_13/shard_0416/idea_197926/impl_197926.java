...
@Data
public class Idea197926Config {
    private String name = "idea_197926";
 ...
 */
@Slf4j
public class Idea197926Service {
    private static final int IDEA_ID = 197926;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197926Service() {
        this(new Idea197926Config());
    }

    public Idea197926Service(Idea197926Config config) {
        this.config = config != null ? config : new Idea197926Config();
