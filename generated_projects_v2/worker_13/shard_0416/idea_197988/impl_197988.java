...
@Data
public class Idea197988Config {
    private String name = "idea_197988";
 ...
 */
@Slf4j
public class Idea197988Service {
    private static final int IDEA_ID = 197988;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197988Service() {
        this(new Idea197988Config());
    }

    public Idea197988Service(Idea197988Config config) {
        this.config = config != null ? config : new Idea197988Config();
