...
@Data
public class Idea198049Config {
    private String name = "idea_198049";
 ...
 */
@Slf4j
public class Idea198049Service {
    private static final int IDEA_ID = 198049;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198049Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198049Service() {
        this(new Idea198049Config());
    }

    public Idea198049Service(Idea198049Config config) {
        this.config = config != null ? config : new Idea198049Config();
