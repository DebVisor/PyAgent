...
@Data
public class Idea197991Config {
    private String name = "idea_197991";
 ...
 */
@Slf4j
public class Idea197991Service {
    private static final int IDEA_ID = 197991;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197991Service() {
        this(new Idea197991Config());
    }

    public Idea197991Service(Idea197991Config config) {
        this.config = config != null ? config : new Idea197991Config();
