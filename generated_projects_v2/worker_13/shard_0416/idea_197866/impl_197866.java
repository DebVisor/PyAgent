...
@Data
public class Idea197866Config {
    private String name = "idea_197866";
 ...
 */
@Slf4j
public class Idea197866Service {
    private static final int IDEA_ID = 197866;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197866Service() {
        this(new Idea197866Config());
    }

    public Idea197866Service(Idea197866Config config) {
        this.config = config != null ? config : new Idea197866Config();
