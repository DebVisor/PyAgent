...
@Data
public class Idea197693Config {
    private String name = "idea_197693";
 ...
 */
@Slf4j
public class Idea197693Service {
    private static final int IDEA_ID = 197693;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197693Service() {
        this(new Idea197693Config());
    }

    public Idea197693Service(Idea197693Config config) {
        this.config = config != null ? config : new Idea197693Config();
