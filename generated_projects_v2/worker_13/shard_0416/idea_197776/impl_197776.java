...
@Data
public class Idea197776Config {
    private String name = "idea_197776";
 ...
 */
@Slf4j
public class Idea197776Service {
    private static final int IDEA_ID = 197776;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197776Service() {
        this(new Idea197776Config());
    }

    public Idea197776Service(Idea197776Config config) {
        this.config = config != null ? config : new Idea197776Config();
