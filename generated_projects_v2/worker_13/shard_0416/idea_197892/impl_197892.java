...
@Data
public class Idea197892Config {
    private String name = "idea_197892";
 ...
 */
@Slf4j
public class Idea197892Service {
    private static final int IDEA_ID = 197892;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197892Service() {
        this(new Idea197892Config());
    }

    public Idea197892Service(Idea197892Config config) {
        this.config = config != null ? config : new Idea197892Config();
