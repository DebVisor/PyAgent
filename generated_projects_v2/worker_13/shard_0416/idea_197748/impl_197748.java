...
@Data
public class Idea197748Config {
    private String name = "idea_197748";
 ...
 */
@Slf4j
public class Idea197748Service {
    private static final int IDEA_ID = 197748;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197748Service() {
        this(new Idea197748Config());
    }

    public Idea197748Service(Idea197748Config config) {
        this.config = config != null ? config : new Idea197748Config();
