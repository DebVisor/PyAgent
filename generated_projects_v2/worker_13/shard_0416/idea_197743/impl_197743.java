...
@Data
public class Idea197743Config {
    private String name = "idea_197743";
 ...
 */
@Slf4j
public class Idea197743Service {
    private static final int IDEA_ID = 197743;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197743Service() {
        this(new Idea197743Config());
    }

    public Idea197743Service(Idea197743Config config) {
        this.config = config != null ? config : new Idea197743Config();
