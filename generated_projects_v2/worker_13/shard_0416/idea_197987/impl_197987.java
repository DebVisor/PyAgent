...
@Data
public class Idea197987Config {
    private String name = "idea_197987";
 ...
 */
@Slf4j
public class Idea197987Service {
    private static final int IDEA_ID = 197987;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197987Service() {
        this(new Idea197987Config());
    }

    public Idea197987Service(Idea197987Config config) {
        this.config = config != null ? config : new Idea197987Config();
