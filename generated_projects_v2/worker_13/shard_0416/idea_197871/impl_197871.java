...
@Data
public class Idea197871Config {
    private String name = "idea_197871";
 ...
 */
@Slf4j
public class Idea197871Service {
    private static final int IDEA_ID = 197871;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197871Service() {
        this(new Idea197871Config());
    }

    public Idea197871Service(Idea197871Config config) {
        this.config = config != null ? config : new Idea197871Config();
