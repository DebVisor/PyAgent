...
@Data
public class Idea197941Config {
    private String name = "idea_197941";
 ...
 */
@Slf4j
public class Idea197941Service {
    private static final int IDEA_ID = 197941;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197941Service() {
        this(new Idea197941Config());
    }

    public Idea197941Service(Idea197941Config config) {
        this.config = config != null ? config : new Idea197941Config();
