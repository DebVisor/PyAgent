...
@Data
public class Idea197791Config {
    private String name = "idea_197791";
 ...
 */
@Slf4j
public class Idea197791Service {
    private static final int IDEA_ID = 197791;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197791Service() {
        this(new Idea197791Config());
    }

    public Idea197791Service(Idea197791Config config) {
        this.config = config != null ? config : new Idea197791Config();
