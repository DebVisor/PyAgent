...
@Data
public class Idea197890Config {
    private String name = "idea_197890";
 ...
 */
@Slf4j
public class Idea197890Service {
    private static final int IDEA_ID = 197890;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197890Service() {
        this(new Idea197890Config());
    }

    public Idea197890Service(Idea197890Config config) {
        this.config = config != null ? config : new Idea197890Config();
