...
@Data
public class Idea198024Config {
    private String name = "idea_198024";
 ...
 */
@Slf4j
public class Idea198024Service {
    private static final int IDEA_ID = 198024;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198024Service() {
        this(new Idea198024Config());
    }

    public Idea198024Service(Idea198024Config config) {
        this.config = config != null ? config : new Idea198024Config();
