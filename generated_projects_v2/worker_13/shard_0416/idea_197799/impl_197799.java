...
@Data
public class Idea197799Config {
    private String name = "idea_197799";
 ...
 */
@Slf4j
public class Idea197799Service {
    private static final int IDEA_ID = 197799;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197799Service() {
        this(new Idea197799Config());
    }

    public Idea197799Service(Idea197799Config config) {
        this.config = config != null ? config : new Idea197799Config();
