...
@Data
public class Idea197630Config {
    private String name = "idea_197630";
 ...
 */
@Slf4j
public class Idea197630Service {
    private static final int IDEA_ID = 197630;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197630Service() {
        this(new Idea197630Config());
    }

    public Idea197630Service(Idea197630Config config) {
        this.config = config != null ? config : new Idea197630Config();
