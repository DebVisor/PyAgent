...
@Data
public class Idea198070Config {
    private String name = "idea_198070";
 ...
 */
@Slf4j
public class Idea198070Service {
    private static final int IDEA_ID = 198070;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198070Service() {
        this(new Idea198070Config());
    }

    public Idea198070Service(Idea198070Config config) {
        this.config = config != null ? config : new Idea198070Config();
