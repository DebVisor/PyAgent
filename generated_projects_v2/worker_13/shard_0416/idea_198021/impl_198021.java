...
@Data
public class Idea198021Config {
    private String name = "idea_198021";
 ...
 */
@Slf4j
public class Idea198021Service {
    private static final int IDEA_ID = 198021;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198021Service() {
        this(new Idea198021Config());
    }

    public Idea198021Service(Idea198021Config config) {
        this.config = config != null ? config : new Idea198021Config();
