...
@Data
public class Idea197924Config {
    private String name = "idea_197924";
 ...
 */
@Slf4j
public class Idea197924Service {
    private static final int IDEA_ID = 197924;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197924Service() {
        this(new Idea197924Config());
    }

    public Idea197924Service(Idea197924Config config) {
        this.config = config != null ? config : new Idea197924Config();
