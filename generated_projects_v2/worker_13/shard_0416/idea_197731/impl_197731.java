...
@Data
public class Idea197731Config {
    private String name = "idea_197731";
 ...
 */
@Slf4j
public class Idea197731Service {
    private static final int IDEA_ID = 197731;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197731Service() {
        this(new Idea197731Config());
    }

    public Idea197731Service(Idea197731Config config) {
        this.config = config != null ? config : new Idea197731Config();
