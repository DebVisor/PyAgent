...
@Data
public class Idea197686Config {
    private String name = "idea_197686";
 ...
 */
@Slf4j
public class Idea197686Service {
    private static final int IDEA_ID = 197686;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197686Service() {
        this(new Idea197686Config());
    }

    public Idea197686Service(Idea197686Config config) {
        this.config = config != null ? config : new Idea197686Config();
