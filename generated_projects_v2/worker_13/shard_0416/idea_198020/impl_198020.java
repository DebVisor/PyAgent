...
@Data
public class Idea198020Config {
    private String name = "idea_198020";
 ...
 */
@Slf4j
public class Idea198020Service {
    private static final int IDEA_ID = 198020;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198020Service() {
        this(new Idea198020Config());
    }

    public Idea198020Service(Idea198020Config config) {
        this.config = config != null ? config : new Idea198020Config();
