...
@Data
public class Idea197817Config {
    private String name = "idea_197817";
 ...
 */
@Slf4j
public class Idea197817Service {
    private static final int IDEA_ID = 197817;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197817Service() {
        this(new Idea197817Config());
    }

    public Idea197817Service(Idea197817Config config) {
        this.config = config != null ? config : new Idea197817Config();
