...
@Data
public class Idea197881Config {
    private String name = "idea_197881";
 ...
 */
@Slf4j
public class Idea197881Service {
    private static final int IDEA_ID = 197881;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197881Service() {
        this(new Idea197881Config());
    }

    public Idea197881Service(Idea197881Config config) {
        this.config = config != null ? config : new Idea197881Config();
