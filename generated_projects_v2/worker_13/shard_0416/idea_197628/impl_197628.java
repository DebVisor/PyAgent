...
@Data
public class Idea197628Config {
    private String name = "idea_197628";
 ...
 */
@Slf4j
public class Idea197628Service {
    private static final int IDEA_ID = 197628;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197628Service() {
        this(new Idea197628Config());
    }

    public Idea197628Service(Idea197628Config config) {
        this.config = config != null ? config : new Idea197628Config();
