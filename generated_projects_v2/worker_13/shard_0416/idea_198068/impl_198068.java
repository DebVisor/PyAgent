...
@Data
public class Idea198068Config {
    private String name = "idea_198068";
 ...
 */
@Slf4j
public class Idea198068Service {
    private static final int IDEA_ID = 198068;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198068Service() {
        this(new Idea198068Config());
    }

    public Idea198068Service(Idea198068Config config) {
        this.config = config != null ? config : new Idea198068Config();
