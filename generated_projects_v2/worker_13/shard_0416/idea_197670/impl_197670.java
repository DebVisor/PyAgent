...
@Data
public class Idea197670Config {
    private String name = "idea_197670";
 ...
 */
@Slf4j
public class Idea197670Service {
    private static final int IDEA_ID = 197670;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197670Service() {
        this(new Idea197670Config());
    }

    public Idea197670Service(Idea197670Config config) {
        this.config = config != null ? config : new Idea197670Config();
