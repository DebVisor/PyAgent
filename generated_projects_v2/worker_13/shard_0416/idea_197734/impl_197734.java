...
@Data
public class Idea197734Config {
    private String name = "idea_197734";
 ...
 */
@Slf4j
public class Idea197734Service {
    private static final int IDEA_ID = 197734;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197734Service() {
        this(new Idea197734Config());
    }

    public Idea197734Service(Idea197734Config config) {
        this.config = config != null ? config : new Idea197734Config();
