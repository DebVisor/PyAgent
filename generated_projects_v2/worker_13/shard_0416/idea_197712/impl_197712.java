...
@Data
public class Idea197712Config {
    private String name = "idea_197712";
 ...
 */
@Slf4j
public class Idea197712Service {
    private static final int IDEA_ID = 197712;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197712Service() {
        this(new Idea197712Config());
    }

    public Idea197712Service(Idea197712Config config) {
        this.config = config != null ? config : new Idea197712Config();
