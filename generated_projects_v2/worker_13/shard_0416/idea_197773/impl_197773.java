...
@Data
public class Idea197773Config {
    private String name = "idea_197773";
 ...
 */
@Slf4j
public class Idea197773Service {
    private static final int IDEA_ID = 197773;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197773Service() {
        this(new Idea197773Config());
    }

    public Idea197773Service(Idea197773Config config) {
        this.config = config != null ? config : new Idea197773Config();
