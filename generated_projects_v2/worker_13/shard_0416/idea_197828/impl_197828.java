...
@Data
public class Idea197828Config {
    private String name = "idea_197828";
 ...
 */
@Slf4j
public class Idea197828Service {
    private static final int IDEA_ID = 197828;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197828Service() {
        this(new Idea197828Config());
    }

    public Idea197828Service(Idea197828Config config) {
        this.config = config != null ? config : new Idea197828Config();
