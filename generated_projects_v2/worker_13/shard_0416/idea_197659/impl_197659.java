...
@Data
public class Idea197659Config {
    private String name = "idea_197659";
 ...
 */
@Slf4j
public class Idea197659Service {
    private static final int IDEA_ID = 197659;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197659Service() {
        this(new Idea197659Config());
    }

    public Idea197659Service(Idea197659Config config) {
        this.config = config != null ? config : new Idea197659Config();
