...
@Data
public class Idea198037Config {
    private String name = "idea_198037";
 ...
 */
@Slf4j
public class Idea198037Service {
    private static final int IDEA_ID = 198037;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198037Service() {
        this(new Idea198037Config());
    }

    public Idea198037Service(Idea198037Config config) {
        this.config = config != null ? config : new Idea198037Config();
