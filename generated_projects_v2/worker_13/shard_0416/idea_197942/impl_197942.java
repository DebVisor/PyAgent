...
@Data
public class Idea197942Config {
    private String name = "idea_197942";
 ...
 */
@Slf4j
public class Idea197942Service {
    private static final int IDEA_ID = 197942;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197942Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197942Service() {
        this(new Idea197942Config());
    }

    public Idea197942Service(Idea197942Config config) {
        this.config = config != null ? config : new Idea197942Config();
