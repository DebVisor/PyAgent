...
@Data
public class Idea197759Config {
    private String name = "idea_197759";
 ...
 */
@Slf4j
public class Idea197759Service {
    private static final int IDEA_ID = 197759;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197759Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197759Service() {
        this(new Idea197759Config());
    }

    public Idea197759Service(Idea197759Config config) {
        this.config = config != null ? config : new Idea197759Config();
