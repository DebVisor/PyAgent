...
@Data
public class Idea197878Config {
    private String name = "idea_197878";
 ...
 */
@Slf4j
public class Idea197878Service {
    private static final int IDEA_ID = 197878;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197878Service() {
        this(new Idea197878Config());
    }

    public Idea197878Service(Idea197878Config config) {
        this.config = config != null ? config : new Idea197878Config();
