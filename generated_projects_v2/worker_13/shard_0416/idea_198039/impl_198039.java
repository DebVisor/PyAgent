...
@Data
public class Idea198039Config {
    private String name = "idea_198039";
 ...
 */
@Slf4j
public class Idea198039Service {
    private static final int IDEA_ID = 198039;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198039Service() {
        this(new Idea198039Config());
    }

    public Idea198039Service(Idea198039Config config) {
        this.config = config != null ? config : new Idea198039Config();
