...
@Data
public class Idea197982Config {
    private String name = "idea_197982";
 ...
 */
@Slf4j
public class Idea197982Service {
    private static final int IDEA_ID = 197982;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197982Service() {
        this(new Idea197982Config());
    }

    public Idea197982Service(Idea197982Config config) {
        this.config = config != null ? config : new Idea197982Config();
