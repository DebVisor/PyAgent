...
@Data
public class Idea197665Config {
    private String name = "idea_197665";
 ...
 */
@Slf4j
public class Idea197665Service {
    private static final int IDEA_ID = 197665;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197665Service() {
        this(new Idea197665Config());
    }

    public Idea197665Service(Idea197665Config config) {
        this.config = config != null ? config : new Idea197665Config();
