...
@Data
public class Idea197929Config {
    private String name = "idea_197929";
 ...
 */
@Slf4j
public class Idea197929Service {
    private static final int IDEA_ID = 197929;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197929Service() {
        this(new Idea197929Config());
    }

    public Idea197929Service(Idea197929Config config) {
        this.config = config != null ? config : new Idea197929Config();
