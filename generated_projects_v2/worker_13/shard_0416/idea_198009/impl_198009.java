...
@Data
public class Idea198009Config {
    private String name = "idea_198009";
 ...
 */
@Slf4j
public class Idea198009Service {
    private static final int IDEA_ID = 198009;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198009Service() {
        this(new Idea198009Config());
    }

    public Idea198009Service(Idea198009Config config) {
        this.config = config != null ? config : new Idea198009Config();
