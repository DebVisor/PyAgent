...
@Data
public class Idea197718Config {
    private String name = "idea_197718";
 ...
 */
@Slf4j
public class Idea197718Service {
    private static final int IDEA_ID = 197718;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197718Service() {
        this(new Idea197718Config());
    }

    public Idea197718Service(Idea197718Config config) {
        this.config = config != null ? config : new Idea197718Config();
