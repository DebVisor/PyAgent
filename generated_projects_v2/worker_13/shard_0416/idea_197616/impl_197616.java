...
@Data
public class Idea197616Config {
    private String name = "idea_197616";
 ...
 */
@Slf4j
public class Idea197616Service {
    private static final int IDEA_ID = 197616;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197616Service() {
        this(new Idea197616Config());
    }

    public Idea197616Service(Idea197616Config config) {
        this.config = config != null ? config : new Idea197616Config();
