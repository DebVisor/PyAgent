...
@Data
public class Idea197981Config {
    private String name = "idea_197981";
 ...
 */
@Slf4j
public class Idea197981Service {
    private static final int IDEA_ID = 197981;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197981Service() {
        this(new Idea197981Config());
    }

    public Idea197981Service(Idea197981Config config) {
        this.config = config != null ? config : new Idea197981Config();
