...
@Data
public class Idea198052Config {
    private String name = "idea_198052";
 ...
 */
@Slf4j
public class Idea198052Service {
    private static final int IDEA_ID = 198052;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198052Service() {
        this(new Idea198052Config());
    }

    public Idea198052Service(Idea198052Config config) {
        this.config = config != null ? config : new Idea198052Config();
