...
@Data
public class Idea197766Config {
    private String name = "idea_197766";
 ...
 */
@Slf4j
public class Idea197766Service {
    private static final int IDEA_ID = 197766;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197766Service() {
        this(new Idea197766Config());
    }

    public Idea197766Service(Idea197766Config config) {
        this.config = config != null ? config : new Idea197766Config();
