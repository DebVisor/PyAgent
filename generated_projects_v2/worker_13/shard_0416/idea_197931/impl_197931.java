...
@Data
public class Idea197931Config {
    private String name = "idea_197931";
 ...
 */
@Slf4j
public class Idea197931Service {
    private static final int IDEA_ID = 197931;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197931Service() {
        this(new Idea197931Config());
    }

    public Idea197931Service(Idea197931Config config) {
        this.config = config != null ? config : new Idea197931Config();
