...
@Data
public class Idea197896Config {
    private String name = "idea_197896";
 ...
 */
@Slf4j
public class Idea197896Service {
    private static final int IDEA_ID = 197896;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197896Service() {
        this(new Idea197896Config());
    }

    public Idea197896Service(Idea197896Config config) {
        this.config = config != null ? config : new Idea197896Config();
