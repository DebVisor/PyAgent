...
@Data
public class Idea197763Config {
    private String name = "idea_197763";
 ...
 */
@Slf4j
public class Idea197763Service {
    private static final int IDEA_ID = 197763;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197763Service() {
        this(new Idea197763Config());
    }

    public Idea197763Service(Idea197763Config config) {
        this.config = config != null ? config : new Idea197763Config();
