...
@Data
public class Idea198001Config {
    private String name = "idea_198001";
 ...
 */
@Slf4j
public class Idea198001Service {
    private static final int IDEA_ID = 198001;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198001Service() {
        this(new Idea198001Config());
    }

    public Idea198001Service(Idea198001Config config) {
        this.config = config != null ? config : new Idea198001Config();
