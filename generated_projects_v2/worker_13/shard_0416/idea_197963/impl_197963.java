...
@Data
public class Idea197963Config {
    private String name = "idea_197963";
 ...
 */
@Slf4j
public class Idea197963Service {
    private static final int IDEA_ID = 197963;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197963Service() {
        this(new Idea197963Config());
    }

    public Idea197963Service(Idea197963Config config) {
        this.config = config != null ? config : new Idea197963Config();
