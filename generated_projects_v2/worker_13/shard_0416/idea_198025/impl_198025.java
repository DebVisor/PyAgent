...
@Data
public class Idea198025Config {
    private String name = "idea_198025";
 ...
 */
@Slf4j
public class Idea198025Service {
    private static final int IDEA_ID = 198025;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198025Service() {
        this(new Idea198025Config());
    }

    public Idea198025Service(Idea198025Config config) {
        this.config = config != null ? config : new Idea198025Config();
