...
@Data
public class Idea197647Config {
    private String name = "idea_197647";
 ...
 */
@Slf4j
public class Idea197647Service {
    private static final int IDEA_ID = 197647;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197647Service() {
        this(new Idea197647Config());
    }

    public Idea197647Service(Idea197647Config config) {
        this.config = config != null ? config : new Idea197647Config();
