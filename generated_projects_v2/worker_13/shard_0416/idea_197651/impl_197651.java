...
@Data
public class Idea197651Config {
    private String name = "idea_197651";
 ...
 */
@Slf4j
public class Idea197651Service {
    private static final int IDEA_ID = 197651;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197651Service() {
        this(new Idea197651Config());
    }

    public Idea197651Service(Idea197651Config config) {
        this.config = config != null ? config : new Idea197651Config();
