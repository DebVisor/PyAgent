...
@Data
public class Idea198045Config {
    private String name = "idea_198045";
 ...
 */
@Slf4j
public class Idea198045Service {
    private static final int IDEA_ID = 198045;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198045Service() {
        this(new Idea198045Config());
    }

    public Idea198045Service(Idea198045Config config) {
        this.config = config != null ? config : new Idea198045Config();
