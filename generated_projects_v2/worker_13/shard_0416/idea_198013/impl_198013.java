...
@Data
public class Idea198013Config {
    private String name = "idea_198013";
 ...
 */
@Slf4j
public class Idea198013Service {
    private static final int IDEA_ID = 198013;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198013Service() {
        this(new Idea198013Config());
    }

    public Idea198013Service(Idea198013Config config) {
        this.config = config != null ? config : new Idea198013Config();
