...
@Data
public class Idea197967Config {
    private String name = "idea_197967";
 ...
 */
@Slf4j
public class Idea197967Service {
    private static final int IDEA_ID = 197967;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197967Service() {
        this(new Idea197967Config());
    }

    public Idea197967Service(Idea197967Config config) {
        this.config = config != null ? config : new Idea197967Config();
