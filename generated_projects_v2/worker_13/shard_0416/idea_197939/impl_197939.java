...
@Data
public class Idea197939Config {
    private String name = "idea_197939";
 ...
 */
@Slf4j
public class Idea197939Service {
    private static final int IDEA_ID = 197939;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197939Service() {
        this(new Idea197939Config());
    }

    public Idea197939Service(Idea197939Config config) {
        this.config = config != null ? config : new Idea197939Config();
