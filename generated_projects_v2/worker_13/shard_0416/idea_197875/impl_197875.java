...
@Data
public class Idea197875Config {
    private String name = "idea_197875";
 ...
 */
@Slf4j
public class Idea197875Service {
    private static final int IDEA_ID = 197875;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197875Service() {
        this(new Idea197875Config());
    }

    public Idea197875Service(Idea197875Config config) {
        this.config = config != null ? config : new Idea197875Config();
