...
@Data
public class Idea198051Config {
    private String name = "idea_198051";
 ...
 */
@Slf4j
public class Idea198051Service {
    private static final int IDEA_ID = 198051;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198051Service() {
        this(new Idea198051Config());
    }

    public Idea198051Service(Idea198051Config config) {
        this.config = config != null ? config : new Idea198051Config();
