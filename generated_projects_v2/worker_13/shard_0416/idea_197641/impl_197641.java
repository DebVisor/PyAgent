...
@Data
public class Idea197641Config {
    private String name = "idea_197641";
 ...
 */
@Slf4j
public class Idea197641Service {
    private static final int IDEA_ID = 197641;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197641Service() {
        this(new Idea197641Config());
    }

    public Idea197641Service(Idea197641Config config) {
        this.config = config != null ? config : new Idea197641Config();
