...
@Data
public class Idea197785Config {
    private String name = "idea_197785";
 ...
 */
@Slf4j
public class Idea197785Service {
    private static final int IDEA_ID = 197785;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197785Service() {
        this(new Idea197785Config());
    }

    public Idea197785Service(Idea197785Config config) {
        this.config = config != null ? config : new Idea197785Config();
