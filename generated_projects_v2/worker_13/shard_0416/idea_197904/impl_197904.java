...
@Data
public class Idea197904Config {
    private String name = "idea_197904";
 ...
 */
@Slf4j
public class Idea197904Service {
    private static final int IDEA_ID = 197904;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197904Service() {
        this(new Idea197904Config());
    }

    public Idea197904Service(Idea197904Config config) {
        this.config = config != null ? config : new Idea197904Config();
