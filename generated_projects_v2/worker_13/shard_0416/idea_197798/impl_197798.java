...
@Data
public class Idea197798Config {
    private String name = "idea_197798";
 ...
 */
@Slf4j
public class Idea197798Service {
    private static final int IDEA_ID = 197798;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197798Service() {
        this(new Idea197798Config());
    }

    public Idea197798Service(Idea197798Config config) {
        this.config = config != null ? config : new Idea197798Config();
