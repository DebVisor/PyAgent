...
@Data
public class Idea197714Config {
    private String name = "idea_197714";
 ...
 */
@Slf4j
public class Idea197714Service {
    private static final int IDEA_ID = 197714;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197714Service() {
        this(new Idea197714Config());
    }

    public Idea197714Service(Idea197714Config config) {
        this.config = config != null ? config : new Idea197714Config();
