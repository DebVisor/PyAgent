...
@Data
public class Idea198044Config {
    private String name = "idea_198044";
 ...
 */
@Slf4j
public class Idea198044Service {
    private static final int IDEA_ID = 198044;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198044Service() {
        this(new Idea198044Config());
    }

    public Idea198044Service(Idea198044Config config) {
        this.config = config != null ? config : new Idea198044Config();
