...
@Data
public class Idea197634Config {
    private String name = "idea_197634";
 ...
 */
@Slf4j
public class Idea197634Service {
    private static final int IDEA_ID = 197634;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197634Service() {
        this(new Idea197634Config());
    }

    public Idea197634Service(Idea197634Config config) {
        this.config = config != null ? config : new Idea197634Config();
