...
@Data
public class Idea197965Config {
    private String name = "idea_197965";
 ...
 */
@Slf4j
public class Idea197965Service {
    private static final int IDEA_ID = 197965;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197965Service() {
        this(new Idea197965Config());
    }

    public Idea197965Service(Idea197965Config config) {
        this.config = config != null ? config : new Idea197965Config();
