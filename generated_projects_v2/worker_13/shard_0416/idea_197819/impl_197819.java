...
@Data
public class Idea197819Config {
    private String name = "idea_197819";
 ...
 */
@Slf4j
public class Idea197819Service {
    private static final int IDEA_ID = 197819;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197819Service() {
        this(new Idea197819Config());
    }

    public Idea197819Service(Idea197819Config config) {
        this.config = config != null ? config : new Idea197819Config();
