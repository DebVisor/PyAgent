...
@Data
public class Idea197631Config {
    private String name = "idea_197631";
 ...
 */
@Slf4j
public class Idea197631Service {
    private static final int IDEA_ID = 197631;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197631Service() {
        this(new Idea197631Config());
    }

    public Idea197631Service(Idea197631Config config) {
        this.config = config != null ? config : new Idea197631Config();
