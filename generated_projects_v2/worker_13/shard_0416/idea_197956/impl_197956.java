...
@Data
public class Idea197956Config {
    private String name = "idea_197956";
 ...
 */
@Slf4j
public class Idea197956Service {
    private static final int IDEA_ID = 197956;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197956Service() {
        this(new Idea197956Config());
    }

    public Idea197956Service(Idea197956Config config) {
        this.config = config != null ? config : new Idea197956Config();
