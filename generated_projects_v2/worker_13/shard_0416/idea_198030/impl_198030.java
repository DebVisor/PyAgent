...
@Data
public class Idea198030Config {
    private String name = "idea_198030";
 ...
 */
@Slf4j
public class Idea198030Service {
    private static final int IDEA_ID = 198030;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198030Service() {
        this(new Idea198030Config());
    }

    public Idea198030Service(Idea198030Config config) {
        this.config = config != null ? config : new Idea198030Config();
