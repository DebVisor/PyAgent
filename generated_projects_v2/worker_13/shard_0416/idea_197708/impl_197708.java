...
@Data
public class Idea197708Config {
    private String name = "idea_197708";
 ...
 */
@Slf4j
public class Idea197708Service {
    private static final int IDEA_ID = 197708;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197708Service() {
        this(new Idea197708Config());
    }

    public Idea197708Service(Idea197708Config config) {
        this.config = config != null ? config : new Idea197708Config();
