...
@Data
public class Idea197655Config {
    private String name = "idea_197655";
 ...
 */
@Slf4j
public class Idea197655Service {
    private static final int IDEA_ID = 197655;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197655Service() {
        this(new Idea197655Config());
    }

    public Idea197655Service(Idea197655Config config) {
        this.config = config != null ? config : new Idea197655Config();
