...
@Data
public class Idea199364Config {
    private String name = "idea_199364";
 ...
 */
@Slf4j
public class Idea199364Service {
    private static final int IDEA_ID = 199364;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199364Service() {
        this(new Idea199364Config());
    }

    public Idea199364Service(Idea199364Config config) {
        this.config = config != null ? config : new Idea199364Config();
