...
@Data
public class Idea199336Config {
    private String name = "idea_199336";
 ...
 */
@Slf4j
public class Idea199336Service {
    private static final int IDEA_ID = 199336;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199336Service() {
        this(new Idea199336Config());
    }

    public Idea199336Service(Idea199336Config config) {
        this.config = config != null ? config : new Idea199336Config();
