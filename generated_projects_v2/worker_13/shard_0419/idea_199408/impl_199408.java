...
@Data
public class Idea199408Config {
    private String name = "idea_199408";
 ...
 */
@Slf4j
public class Idea199408Service {
    private static final int IDEA_ID = 199408;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199408Service() {
        this(new Idea199408Config());
    }

    public Idea199408Service(Idea199408Config config) {
        this.config = config != null ? config : new Idea199408Config();
