...
@Data
public class Idea199234Config {
    private String name = "idea_199234";
 ...
 */
@Slf4j
public class Idea199234Service {
    private static final int IDEA_ID = 199234;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199234Service() {
        this(new Idea199234Config());
    }

    public Idea199234Service(Idea199234Config config) {
        this.config = config != null ? config : new Idea199234Config();
