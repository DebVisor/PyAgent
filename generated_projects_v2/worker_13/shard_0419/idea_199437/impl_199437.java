...
@Data
public class Idea199437Config {
    private String name = "idea_199437";
 ...
 */
@Slf4j
public class Idea199437Service {
    private static final int IDEA_ID = 199437;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199437Service() {
        this(new Idea199437Config());
    }

    public Idea199437Service(Idea199437Config config) {
        this.config = config != null ? config : new Idea199437Config();
