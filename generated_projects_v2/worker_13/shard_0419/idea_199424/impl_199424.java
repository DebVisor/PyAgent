...
@Data
public class Idea199424Config {
    private String name = "idea_199424";
 ...
 */
@Slf4j
public class Idea199424Service {
    private static final int IDEA_ID = 199424;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199424Service() {
        this(new Idea199424Config());
    }

    public Idea199424Service(Idea199424Config config) {
        this.config = config != null ? config : new Idea199424Config();
