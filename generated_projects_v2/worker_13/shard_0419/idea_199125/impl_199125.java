...
@Data
public class Idea199125Config {
    private String name = "idea_199125";
 ...
 */
@Slf4j
public class Idea199125Service {
    private static final int IDEA_ID = 199125;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199125Service() {
        this(new Idea199125Config());
    }

    public Idea199125Service(Idea199125Config config) {
        this.config = config != null ? config : new Idea199125Config();
