...
@Data
public class Idea199332Config {
    private String name = "idea_199332";
 ...
 */
@Slf4j
public class Idea199332Service {
    private static final int IDEA_ID = 199332;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199332Service() {
        this(new Idea199332Config());
    }

    public Idea199332Service(Idea199332Config config) {
        this.config = config != null ? config : new Idea199332Config();
