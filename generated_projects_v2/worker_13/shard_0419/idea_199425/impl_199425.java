...
@Data
public class Idea199425Config {
    private String name = "idea_199425";
 ...
 */
@Slf4j
public class Idea199425Service {
    private static final int IDEA_ID = 199425;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199425Service() {
        this(new Idea199425Config());
    }

    public Idea199425Service(Idea199425Config config) {
        this.config = config != null ? config : new Idea199425Config();
