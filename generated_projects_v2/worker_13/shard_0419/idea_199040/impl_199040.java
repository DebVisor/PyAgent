...
@Data
public class Idea199040Config {
    private String name = "idea_199040";
 ...
 */
@Slf4j
public class Idea199040Service {
    private static final int IDEA_ID = 199040;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199040Service() {
        this(new Idea199040Config());
    }

    public Idea199040Service(Idea199040Config config) {
        this.config = config != null ? config : new Idea199040Config();
