...
@Data
public class Idea199465Config {
    private String name = "idea_199465";
 ...
 */
@Slf4j
public class Idea199465Service {
    private static final int IDEA_ID = 199465;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199465Service() {
        this(new Idea199465Config());
    }

    public Idea199465Service(Idea199465Config config) {
        this.config = config != null ? config : new Idea199465Config();
