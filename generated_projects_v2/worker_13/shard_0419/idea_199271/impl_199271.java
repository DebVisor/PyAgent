...
@Data
public class Idea199271Config {
    private String name = "idea_199271";
 ...
 */
@Slf4j
public class Idea199271Service {
    private static final int IDEA_ID = 199271;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199271Service() {
        this(new Idea199271Config());
    }

    public Idea199271Service(Idea199271Config config) {
        this.config = config != null ? config : new Idea199271Config();
