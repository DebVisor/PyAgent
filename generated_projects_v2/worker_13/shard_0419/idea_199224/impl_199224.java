...
@Data
public class Idea199224Config {
    private String name = "idea_199224";
 ...
 */
@Slf4j
public class Idea199224Service {
    private static final int IDEA_ID = 199224;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199224Service() {
        this(new Idea199224Config());
    }

    public Idea199224Service(Idea199224Config config) {
        this.config = config != null ? config : new Idea199224Config();
