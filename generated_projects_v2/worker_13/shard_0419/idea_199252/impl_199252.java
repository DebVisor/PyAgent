...
@Data
public class Idea199252Config {
    private String name = "idea_199252";
 ...
 */
@Slf4j
public class Idea199252Service {
    private static final int IDEA_ID = 199252;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199252Service() {
        this(new Idea199252Config());
    }

    public Idea199252Service(Idea199252Config config) {
        this.config = config != null ? config : new Idea199252Config();
