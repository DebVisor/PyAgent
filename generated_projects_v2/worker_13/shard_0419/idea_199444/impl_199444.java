...
@Data
public class Idea199444Config {
    private String name = "idea_199444";
 ...
 */
@Slf4j
public class Idea199444Service {
    private static final int IDEA_ID = 199444;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199444Service() {
        this(new Idea199444Config());
    }

    public Idea199444Service(Idea199444Config config) {
        this.config = config != null ? config : new Idea199444Config();
