...
@Data
public class Idea199349Config {
    private String name = "idea_199349";
 ...
 */
@Slf4j
public class Idea199349Service {
    private static final int IDEA_ID = 199349;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199349Service() {
        this(new Idea199349Config());
    }

    public Idea199349Service(Idea199349Config config) {
        this.config = config != null ? config : new Idea199349Config();
