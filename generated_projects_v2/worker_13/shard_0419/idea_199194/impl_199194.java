...
@Data
public class Idea199194Config {
    private String name = "idea_199194";
 ...
 */
@Slf4j
public class Idea199194Service {
    private static final int IDEA_ID = 199194;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199194Service() {
        this(new Idea199194Config());
    }

    public Idea199194Service(Idea199194Config config) {
        this.config = config != null ? config : new Idea199194Config();
