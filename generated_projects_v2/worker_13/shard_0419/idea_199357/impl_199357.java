...
@Data
public class Idea199357Config {
    private String name = "idea_199357";
 ...
 */
@Slf4j
public class Idea199357Service {
    private static final int IDEA_ID = 199357;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199357Service() {
        this(new Idea199357Config());
    }

    public Idea199357Service(Idea199357Config config) {
        this.config = config != null ? config : new Idea199357Config();
