...
@Data
public class Idea199367Config {
    private String name = "idea_199367";
 ...
 */
@Slf4j
public class Idea199367Service {
    private static final int IDEA_ID = 199367;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199367Service() {
        this(new Idea199367Config());
    }

    public Idea199367Service(Idea199367Config config) {
        this.config = config != null ? config : new Idea199367Config();
