...
@Data
public class Idea199095Config {
    private String name = "idea_199095";
 ...
 */
@Slf4j
public class Idea199095Service {
    private static final int IDEA_ID = 199095;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199095Service() {
        this(new Idea199095Config());
    }

    public Idea199095Service(Idea199095Config config) {
        this.config = config != null ? config : new Idea199095Config();
