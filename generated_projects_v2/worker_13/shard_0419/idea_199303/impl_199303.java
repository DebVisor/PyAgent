...
@Data
public class Idea199303Config {
    private String name = "idea_199303";
 ...
 */
@Slf4j
public class Idea199303Service {
    private static final int IDEA_ID = 199303;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199303Service() {
        this(new Idea199303Config());
    }

    public Idea199303Service(Idea199303Config config) {
        this.config = config != null ? config : new Idea199303Config();
