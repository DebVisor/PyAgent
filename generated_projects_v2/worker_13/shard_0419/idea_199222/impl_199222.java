...
@Data
public class Idea199222Config {
    private String name = "idea_199222";
 ...
 */
@Slf4j
public class Idea199222Service {
    private static final int IDEA_ID = 199222;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199222Service() {
        this(new Idea199222Config());
    }

    public Idea199222Service(Idea199222Config config) {
        this.config = config != null ? config : new Idea199222Config();
