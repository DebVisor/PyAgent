...
@Data
public class Idea199225Config {
    private String name = "idea_199225";
 ...
 */
@Slf4j
public class Idea199225Service {
    private static final int IDEA_ID = 199225;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199225Service() {
        this(new Idea199225Config());
    }

    public Idea199225Service(Idea199225Config config) {
        this.config = config != null ? config : new Idea199225Config();
