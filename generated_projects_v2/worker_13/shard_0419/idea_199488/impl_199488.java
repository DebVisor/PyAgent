...
@Data
public class Idea199488Config {
    private String name = "idea_199488";
 ...
 */
@Slf4j
public class Idea199488Service {
    private static final int IDEA_ID = 199488;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199488Service() {
        this(new Idea199488Config());
    }

    public Idea199488Service(Idea199488Config config) {
        this.config = config != null ? config : new Idea199488Config();
