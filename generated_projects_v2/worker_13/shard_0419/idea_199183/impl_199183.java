...
@Data
public class Idea199183Config {
    private String name = "idea_199183";
 ...
 */
@Slf4j
public class Idea199183Service {
    private static final int IDEA_ID = 199183;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199183Service() {
        this(new Idea199183Config());
    }

    public Idea199183Service(Idea199183Config config) {
        this.config = config != null ? config : new Idea199183Config();
