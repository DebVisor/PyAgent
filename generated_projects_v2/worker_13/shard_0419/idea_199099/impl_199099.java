...
@Data
public class Idea199099Config {
    private String name = "idea_199099";
 ...
 */
@Slf4j
public class Idea199099Service {
    private static final int IDEA_ID = 199099;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199099Service() {
        this(new Idea199099Config());
    }

    public Idea199099Service(Idea199099Config config) {
        this.config = config != null ? config : new Idea199099Config();
