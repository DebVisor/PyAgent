...
@Data
public class Idea199452Config {
    private String name = "idea_199452";
 ...
 */
@Slf4j
public class Idea199452Service {
    private static final int IDEA_ID = 199452;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199452Service() {
        this(new Idea199452Config());
    }

    public Idea199452Service(Idea199452Config config) {
        this.config = config != null ? config : new Idea199452Config();
