...
@Data
public class Idea199490Config {
    private String name = "idea_199490";
 ...
 */
@Slf4j
public class Idea199490Service {
    private static final int IDEA_ID = 199490;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199490Service() {
        this(new Idea199490Config());
    }

    public Idea199490Service(Idea199490Config config) {
        this.config = config != null ? config : new Idea199490Config();
