...
@Data
public class Idea199036Config {
    private String name = "idea_199036";
 ...
 */
@Slf4j
public class Idea199036Service {
    private static final int IDEA_ID = 199036;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199036Service() {
        this(new Idea199036Config());
    }

    public Idea199036Service(Idea199036Config config) {
        this.config = config != null ? config : new Idea199036Config();
