...
@Data
public class Idea199467Config {
    private String name = "idea_199467";
 ...
 */
@Slf4j
public class Idea199467Service {
    private static final int IDEA_ID = 199467;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199467Service() {
        this(new Idea199467Config());
    }

    public Idea199467Service(Idea199467Config config) {
        this.config = config != null ? config : new Idea199467Config();
