...
@Data
public class Idea199286Config {
    private String name = "idea_199286";
 ...
 */
@Slf4j
public class Idea199286Service {
    private static final int IDEA_ID = 199286;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199286Service() {
        this(new Idea199286Config());
    }

    public Idea199286Service(Idea199286Config config) {
        this.config = config != null ? config : new Idea199286Config();
