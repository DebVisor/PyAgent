...
@Data
public class Idea199152Config {
    private String name = "idea_199152";
 ...
 */
@Slf4j
public class Idea199152Service {
    private static final int IDEA_ID = 199152;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199152Service() {
        this(new Idea199152Config());
    }

    public Idea199152Service(Idea199152Config config) {
        this.config = config != null ? config : new Idea199152Config();
