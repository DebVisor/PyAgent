...
@Data
public class Idea199058Config {
    private String name = "idea_199058";
 ...
 */
@Slf4j
public class Idea199058Service {
    private static final int IDEA_ID = 199058;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199058Service() {
        this(new Idea199058Config());
    }

    public Idea199058Service(Idea199058Config config) {
        this.config = config != null ? config : new Idea199058Config();
