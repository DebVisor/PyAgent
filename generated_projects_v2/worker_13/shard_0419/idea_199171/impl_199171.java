...
@Data
public class Idea199171Config {
    private String name = "idea_199171";
 ...
 */
@Slf4j
public class Idea199171Service {
    private static final int IDEA_ID = 199171;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199171Service() {
        this(new Idea199171Config());
    }

    public Idea199171Service(Idea199171Config config) {
        this.config = config != null ? config : new Idea199171Config();
