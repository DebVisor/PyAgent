...
@Data
public class Idea199432Config {
    private String name = "idea_199432";
 ...
 */
@Slf4j
public class Idea199432Service {
    private static final int IDEA_ID = 199432;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199432Service() {
        this(new Idea199432Config());
    }

    public Idea199432Service(Idea199432Config config) {
        this.config = config != null ? config : new Idea199432Config();
