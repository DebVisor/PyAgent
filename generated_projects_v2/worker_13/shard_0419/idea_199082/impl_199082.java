...
@Data
public class Idea199082Config {
    private String name = "idea_199082";
 ...
 */
@Slf4j
public class Idea199082Service {
    private static final int IDEA_ID = 199082;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199082Service() {
        this(new Idea199082Config());
    }

    public Idea199082Service(Idea199082Config config) {
        this.config = config != null ? config : new Idea199082Config();
