...
@Data
public class Idea199443Config {
    private String name = "idea_199443";
 ...
 */
@Slf4j
public class Idea199443Service {
    private static final int IDEA_ID = 199443;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199443Service() {
        this(new Idea199443Config());
    }

    public Idea199443Service(Idea199443Config config) {
        this.config = config != null ? config : new Idea199443Config();
