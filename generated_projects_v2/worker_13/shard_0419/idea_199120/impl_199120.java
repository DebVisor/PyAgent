...
@Data
public class Idea199120Config {
    private String name = "idea_199120";
 ...
 */
@Slf4j
public class Idea199120Service {
    private static final int IDEA_ID = 199120;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199120Service() {
        this(new Idea199120Config());
    }

    public Idea199120Service(Idea199120Config config) {
        this.config = config != null ? config : new Idea199120Config();
