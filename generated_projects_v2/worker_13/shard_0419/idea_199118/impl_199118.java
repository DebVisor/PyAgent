...
@Data
public class Idea199118Config {
    private String name = "idea_199118";
 ...
 */
@Slf4j
public class Idea199118Service {
    private static final int IDEA_ID = 199118;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199118Service() {
        this(new Idea199118Config());
    }

    public Idea199118Service(Idea199118Config config) {
        this.config = config != null ? config : new Idea199118Config();
