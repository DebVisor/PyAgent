...
@Data
public class Idea199406Config {
    private String name = "idea_199406";
 ...
 */
@Slf4j
public class Idea199406Service {
    private static final int IDEA_ID = 199406;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199406Service() {
        this(new Idea199406Config());
    }

    public Idea199406Service(Idea199406Config config) {
        this.config = config != null ? config : new Idea199406Config();
