...
@Data
public class Idea199378Config {
    private String name = "idea_199378";
 ...
 */
@Slf4j
public class Idea199378Service {
    private static final int IDEA_ID = 199378;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199378Service() {
        this(new Idea199378Config());
    }

    public Idea199378Service(Idea199378Config config) {
        this.config = config != null ? config : new Idea199378Config();
