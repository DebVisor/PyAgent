...
@Data
public class Idea199431Config {
    private String name = "idea_199431";
 ...
 */
@Slf4j
public class Idea199431Service {
    private static final int IDEA_ID = 199431;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199431Service() {
        this(new Idea199431Config());
    }

    public Idea199431Service(Idea199431Config config) {
        this.config = config != null ? config : new Idea199431Config();
