...
@Data
public class Idea199249Config {
    private String name = "idea_199249";
 ...
 */
@Slf4j
public class Idea199249Service {
    private static final int IDEA_ID = 199249;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199249Service() {
        this(new Idea199249Config());
    }

    public Idea199249Service(Idea199249Config config) {
        this.config = config != null ? config : new Idea199249Config();
