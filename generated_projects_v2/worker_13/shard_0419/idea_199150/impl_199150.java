...
@Data
public class Idea199150Config {
    private String name = "idea_199150";
 ...
 */
@Slf4j
public class Idea199150Service {
    private static final int IDEA_ID = 199150;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199150Service() {
        this(new Idea199150Config());
    }

    public Idea199150Service(Idea199150Config config) {
        this.config = config != null ? config : new Idea199150Config();
