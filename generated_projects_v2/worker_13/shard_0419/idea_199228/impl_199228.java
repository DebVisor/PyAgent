...
@Data
public class Idea199228Config {
    private String name = "idea_199228";
 ...
 */
@Slf4j
public class Idea199228Service {
    private static final int IDEA_ID = 199228;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199228Service() {
        this(new Idea199228Config());
    }

    public Idea199228Service(Idea199228Config config) {
        this.config = config != null ? config : new Idea199228Config();
