...
@Data
public class Idea199362Config {
    private String name = "idea_199362";
 ...
 */
@Slf4j
public class Idea199362Service {
    private static final int IDEA_ID = 199362;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199362Service() {
        this(new Idea199362Config());
    }

    public Idea199362Service(Idea199362Config config) {
        this.config = config != null ? config : new Idea199362Config();
