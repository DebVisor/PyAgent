...
@Data
public class Idea199281Config {
    private String name = "idea_199281";
 ...
 */
@Slf4j
public class Idea199281Service {
    private static final int IDEA_ID = 199281;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199281Service() {
        this(new Idea199281Config());
    }

    public Idea199281Service(Idea199281Config config) {
        this.config = config != null ? config : new Idea199281Config();
