...
@Data
public class Idea199464Config {
    private String name = "idea_199464";
 ...
 */
@Slf4j
public class Idea199464Service {
    private static final int IDEA_ID = 199464;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199464Service() {
        this(new Idea199464Config());
    }

    public Idea199464Service(Idea199464Config config) {
        this.config = config != null ? config : new Idea199464Config();
