...
@Data
public class Idea199403Config {
    private String name = "idea_199403";
 ...
 */
@Slf4j
public class Idea199403Service {
    private static final int IDEA_ID = 199403;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199403Service() {
        this(new Idea199403Config());
    }

    public Idea199403Service(Idea199403Config config) {
        this.config = config != null ? config : new Idea199403Config();
