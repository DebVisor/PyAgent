...
@Data
public class Idea199216Config {
    private String name = "idea_199216";
 ...
 */
@Slf4j
public class Idea199216Service {
    private static final int IDEA_ID = 199216;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199216Service() {
        this(new Idea199216Config());
    }

    public Idea199216Service(Idea199216Config config) {
        this.config = config != null ? config : new Idea199216Config();
