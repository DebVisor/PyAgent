...
@Data
public class Idea199335Config {
    private String name = "idea_199335";
 ...
 */
@Slf4j
public class Idea199335Service {
    private static final int IDEA_ID = 199335;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199335Service() {
        this(new Idea199335Config());
    }

    public Idea199335Service(Idea199335Config config) {
        this.config = config != null ? config : new Idea199335Config();
