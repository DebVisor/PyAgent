...
@Data
public class Idea199124Config {
    private String name = "idea_199124";
 ...
 */
@Slf4j
public class Idea199124Service {
    private static final int IDEA_ID = 199124;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199124Service() {
        this(new Idea199124Config());
    }

    public Idea199124Service(Idea199124Config config) {
        this.config = config != null ? config : new Idea199124Config();
