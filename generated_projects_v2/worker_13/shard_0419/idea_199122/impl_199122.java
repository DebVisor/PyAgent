...
@Data
public class Idea199122Config {
    private String name = "idea_199122";
 ...
 */
@Slf4j
public class Idea199122Service {
    private static final int IDEA_ID = 199122;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199122Service() {
        this(new Idea199122Config());
    }

    public Idea199122Service(Idea199122Config config) {
        this.config = config != null ? config : new Idea199122Config();
