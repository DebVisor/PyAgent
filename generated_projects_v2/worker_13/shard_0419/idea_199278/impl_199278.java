...
@Data
public class Idea199278Config {
    private String name = "idea_199278";
 ...
 */
@Slf4j
public class Idea199278Service {
    private static final int IDEA_ID = 199278;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199278Service() {
        this(new Idea199278Config());
    }

    public Idea199278Service(Idea199278Config config) {
        this.config = config != null ? config : new Idea199278Config();
