...
@Data
public class Idea199219Config {
    private String name = "idea_199219";
 ...
 */
@Slf4j
public class Idea199219Service {
    private static final int IDEA_ID = 199219;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199219Service() {
        this(new Idea199219Config());
    }

    public Idea199219Service(Idea199219Config config) {
        this.config = config != null ? config : new Idea199219Config();
