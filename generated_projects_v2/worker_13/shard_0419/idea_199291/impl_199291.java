...
@Data
public class Idea199291Config {
    private String name = "idea_199291";
 ...
 */
@Slf4j
public class Idea199291Service {
    private static final int IDEA_ID = 199291;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199291Service() {
        this(new Idea199291Config());
    }

    public Idea199291Service(Idea199291Config config) {
        this.config = config != null ? config : new Idea199291Config();
