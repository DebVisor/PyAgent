...
@Data
public class Idea199101Config {
    private String name = "idea_199101";
 ...
 */
@Slf4j
public class Idea199101Service {
    private static final int IDEA_ID = 199101;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199101Service() {
        this(new Idea199101Config());
    }

    public Idea199101Service(Idea199101Config config) {
        this.config = config != null ? config : new Idea199101Config();
