...
@Data
public class Idea199232Config {
    private String name = "idea_199232";
 ...
 */
@Slf4j
public class Idea199232Service {
    private static final int IDEA_ID = 199232;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199232Service() {
        this(new Idea199232Config());
    }

    public Idea199232Service(Idea199232Config config) {
        this.config = config != null ? config : new Idea199232Config();
