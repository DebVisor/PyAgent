...
@Data
public class Idea199275Config {
    private String name = "idea_199275";
 ...
 */
@Slf4j
public class Idea199275Service {
    private static final int IDEA_ID = 199275;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199275Service() {
        this(new Idea199275Config());
    }

    public Idea199275Service(Idea199275Config config) {
        this.config = config != null ? config : new Idea199275Config();
