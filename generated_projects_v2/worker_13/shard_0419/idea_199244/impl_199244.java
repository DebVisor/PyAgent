...
@Data
public class Idea199244Config {
    private String name = "idea_199244";
 ...
 */
@Slf4j
public class Idea199244Service {
    private static final int IDEA_ID = 199244;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199244Service() {
        this(new Idea199244Config());
    }

    public Idea199244Service(Idea199244Config config) {
        this.config = config != null ? config : new Idea199244Config();
