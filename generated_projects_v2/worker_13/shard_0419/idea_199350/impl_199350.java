...
@Data
public class Idea199350Config {
    private String name = "idea_199350";
 ...
 */
@Slf4j
public class Idea199350Service {
    private static final int IDEA_ID = 199350;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199350Service() {
        this(new Idea199350Config());
    }

    public Idea199350Service(Idea199350Config config) {
        this.config = config != null ? config : new Idea199350Config();
