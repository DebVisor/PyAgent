...
@Data
public class Idea199254Config {
    private String name = "idea_199254";
 ...
 */
@Slf4j
public class Idea199254Service {
    private static final int IDEA_ID = 199254;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199254Service() {
        this(new Idea199254Config());
    }

    public Idea199254Service(Idea199254Config config) {
        this.config = config != null ? config : new Idea199254Config();
