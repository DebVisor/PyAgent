...
@Data
public class Idea199492Config {
    private String name = "idea_199492";
 ...
 */
@Slf4j
public class Idea199492Service {
    private static final int IDEA_ID = 199492;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199492Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199492Service() {
        this(new Idea199492Config());
    }

    public Idea199492Service(Idea199492Config config) {
        this.config = config != null ? config : new Idea199492Config();
