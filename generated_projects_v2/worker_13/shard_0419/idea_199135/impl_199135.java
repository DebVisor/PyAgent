...
@Data
public class Idea199135Config {
    private String name = "idea_199135";
 ...
 */
@Slf4j
public class Idea199135Service {
    private static final int IDEA_ID = 199135;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199135Service() {
        this(new Idea199135Config());
    }

    public Idea199135Service(Idea199135Config config) {
        this.config = config != null ? config : new Idea199135Config();
