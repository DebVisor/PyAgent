...
@Data
public class Idea199337Config {
    private String name = "idea_199337";
 ...
 */
@Slf4j
public class Idea199337Service {
    private static final int IDEA_ID = 199337;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199337Service() {
        this(new Idea199337Config());
    }

    public Idea199337Service(Idea199337Config config) {
        this.config = config != null ? config : new Idea199337Config();
