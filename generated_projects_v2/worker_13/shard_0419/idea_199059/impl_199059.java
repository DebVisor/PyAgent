...
@Data
public class Idea199059Config {
    private String name = "idea_199059";
 ...
 */
@Slf4j
public class Idea199059Service {
    private static final int IDEA_ID = 199059;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199059Service() {
        this(new Idea199059Config());
    }

    public Idea199059Service(Idea199059Config config) {
        this.config = config != null ? config : new Idea199059Config();
