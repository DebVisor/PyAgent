...
@Data
public class Idea199155Config {
    private String name = "idea_199155";
 ...
 */
@Slf4j
public class Idea199155Service {
    private static final int IDEA_ID = 199155;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199155Service() {
        this(new Idea199155Config());
    }

    public Idea199155Service(Idea199155Config config) {
        this.config = config != null ? config : new Idea199155Config();
