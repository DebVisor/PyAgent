...
@Data
public class Idea199200Config {
    private String name = "idea_199200";
 ...
 */
@Slf4j
public class Idea199200Service {
    private static final int IDEA_ID = 199200;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199200Service() {
        this(new Idea199200Config());
    }

    public Idea199200Service(Idea199200Config config) {
        this.config = config != null ? config : new Idea199200Config();
