...
@Data
public class Idea199347Config {
    private String name = "idea_199347";
 ...
 */
@Slf4j
public class Idea199347Service {
    private static final int IDEA_ID = 199347;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199347Service() {
        this(new Idea199347Config());
    }

    public Idea199347Service(Idea199347Config config) {
        this.config = config != null ? config : new Idea199347Config();
