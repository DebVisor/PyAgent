...
@Data
public class Idea199339Config {
    private String name = "idea_199339";
 ...
 */
@Slf4j
public class Idea199339Service {
    private static final int IDEA_ID = 199339;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199339Service() {
        this(new Idea199339Config());
    }

    public Idea199339Service(Idea199339Config config) {
        this.config = config != null ? config : new Idea199339Config();
