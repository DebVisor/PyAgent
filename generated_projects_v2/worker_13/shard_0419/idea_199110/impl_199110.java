...
@Data
public class Idea199110Config {
    private String name = "idea_199110";
 ...
 */
@Slf4j
public class Idea199110Service {
    private static final int IDEA_ID = 199110;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199110Service() {
        this(new Idea199110Config());
    }

    public Idea199110Service(Idea199110Config config) {
        this.config = config != null ? config : new Idea199110Config();
