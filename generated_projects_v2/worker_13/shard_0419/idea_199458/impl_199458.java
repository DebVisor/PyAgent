...
@Data
public class Idea199458Config {
    private String name = "idea_199458";
 ...
 */
@Slf4j
public class Idea199458Service {
    private static final int IDEA_ID = 199458;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199458Service() {
        this(new Idea199458Config());
    }

    public Idea199458Service(Idea199458Config config) {
        this.config = config != null ? config : new Idea199458Config();
