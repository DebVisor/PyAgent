...
@Data
public class Idea199223Config {
    private String name = "idea_199223";
 ...
 */
@Slf4j
public class Idea199223Service {
    private static final int IDEA_ID = 199223;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199223Service() {
        this(new Idea199223Config());
    }

    public Idea199223Service(Idea199223Config config) {
        this.config = config != null ? config : new Idea199223Config();
