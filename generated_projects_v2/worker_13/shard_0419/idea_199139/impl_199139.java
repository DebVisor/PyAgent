...
@Data
public class Idea199139Config {
    private String name = "idea_199139";
 ...
 */
@Slf4j
public class Idea199139Service {
    private static final int IDEA_ID = 199139;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199139Service() {
        this(new Idea199139Config());
    }

    public Idea199139Service(Idea199139Config config) {
        this.config = config != null ? config : new Idea199139Config();
