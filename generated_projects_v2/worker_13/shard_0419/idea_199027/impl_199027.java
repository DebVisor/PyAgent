...
@Data
public class Idea199027Config {
    private String name = "idea_199027";
 ...
 */
@Slf4j
public class Idea199027Service {
    private static final int IDEA_ID = 199027;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199027Service() {
        this(new Idea199027Config());
    }

    public Idea199027Service(Idea199027Config config) {
        this.config = config != null ? config : new Idea199027Config();
