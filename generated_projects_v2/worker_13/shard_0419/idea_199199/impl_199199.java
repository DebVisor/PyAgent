...
@Data
public class Idea199199Config {
    private String name = "idea_199199";
 ...
 */
@Slf4j
public class Idea199199Service {
    private static final int IDEA_ID = 199199;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199199Service() {
        this(new Idea199199Config());
    }

    public Idea199199Service(Idea199199Config config) {
        this.config = config != null ? config : new Idea199199Config();
