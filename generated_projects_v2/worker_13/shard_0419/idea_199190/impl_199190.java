...
@Data
public class Idea199190Config {
    private String name = "idea_199190";
 ...
 */
@Slf4j
public class Idea199190Service {
    private static final int IDEA_ID = 199190;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199190Service() {
        this(new Idea199190Config());
    }

    public Idea199190Service(Idea199190Config config) {
        this.config = config != null ? config : new Idea199190Config();
