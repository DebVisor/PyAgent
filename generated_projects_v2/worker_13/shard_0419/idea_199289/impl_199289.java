...
@Data
public class Idea199289Config {
    private String name = "idea_199289";
 ...
 */
@Slf4j
public class Idea199289Service {
    private static final int IDEA_ID = 199289;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199289Service() {
        this(new Idea199289Config());
    }

    public Idea199289Service(Idea199289Config config) {
        this.config = config != null ? config : new Idea199289Config();
