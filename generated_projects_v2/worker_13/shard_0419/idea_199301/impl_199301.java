...
@Data
public class Idea199301Config {
    private String name = "idea_199301";
 ...
 */
@Slf4j
public class Idea199301Service {
    private static final int IDEA_ID = 199301;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199301Service() {
        this(new Idea199301Config());
    }

    public Idea199301Service(Idea199301Config config) {
        this.config = config != null ? config : new Idea199301Config();
