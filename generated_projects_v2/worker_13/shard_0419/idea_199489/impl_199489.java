...
@Data
public class Idea199489Config {
    private String name = "idea_199489";
 ...
 */
@Slf4j
public class Idea199489Service {
    private static final int IDEA_ID = 199489;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199489Service() {
        this(new Idea199489Config());
    }

    public Idea199489Service(Idea199489Config config) {
        this.config = config != null ? config : new Idea199489Config();
