...
@Data
public class Idea199075Config {
    private String name = "idea_199075";
 ...
 */
@Slf4j
public class Idea199075Service {
    private static final int IDEA_ID = 199075;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199075Service() {
        this(new Idea199075Config());
    }

    public Idea199075Service(Idea199075Config config) {
        this.config = config != null ? config : new Idea199075Config();
