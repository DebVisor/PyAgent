...
@Data
public class Idea199446Config {
    private String name = "idea_199446";
 ...
 */
@Slf4j
public class Idea199446Service {
    private static final int IDEA_ID = 199446;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199446Service() {
        this(new Idea199446Config());
    }

    public Idea199446Service(Idea199446Config config) {
        this.config = config != null ? config : new Idea199446Config();
