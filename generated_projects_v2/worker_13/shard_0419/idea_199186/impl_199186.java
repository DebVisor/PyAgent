...
@Data
public class Idea199186Config {
    private String name = "idea_199186";
 ...
 */
@Slf4j
public class Idea199186Service {
    private static final int IDEA_ID = 199186;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199186Service() {
        this(new Idea199186Config());
    }

    public Idea199186Service(Idea199186Config config) {
        this.config = config != null ? config : new Idea199186Config();
