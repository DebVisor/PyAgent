...
@Data
public class Idea199193Config {
    private String name = "idea_199193";
 ...
 */
@Slf4j
public class Idea199193Service {
    private static final int IDEA_ID = 199193;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199193Service() {
        this(new Idea199193Config());
    }

    public Idea199193Service(Idea199193Config config) {
        this.config = config != null ? config : new Idea199193Config();
