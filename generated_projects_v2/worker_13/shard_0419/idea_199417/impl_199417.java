...
@Data
public class Idea199417Config {
    private String name = "idea_199417";
 ...
 */
@Slf4j
public class Idea199417Service {
    private static final int IDEA_ID = 199417;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199417Service() {
        this(new Idea199417Config());
    }

    public Idea199417Service(Idea199417Config config) {
        this.config = config != null ? config : new Idea199417Config();
