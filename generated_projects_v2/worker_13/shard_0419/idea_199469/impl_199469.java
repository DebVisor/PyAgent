...
@Data
public class Idea199469Config {
    private String name = "idea_199469";
 ...
 */
@Slf4j
public class Idea199469Service {
    private static final int IDEA_ID = 199469;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199469Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199469Service() {
        this(new Idea199469Config());
    }

    public Idea199469Service(Idea199469Config config) {
        this.config = config != null ? config : new Idea199469Config();
