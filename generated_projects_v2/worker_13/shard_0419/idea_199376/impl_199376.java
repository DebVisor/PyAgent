...
@Data
public class Idea199376Config {
    private String name = "idea_199376";
 ...
 */
@Slf4j
public class Idea199376Service {
    private static final int IDEA_ID = 199376;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199376Service() {
        this(new Idea199376Config());
    }

    public Idea199376Service(Idea199376Config config) {
        this.config = config != null ? config : new Idea199376Config();
