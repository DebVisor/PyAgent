...
@Data
public class Idea199054Config {
    private String name = "idea_199054";
 ...
 */
@Slf4j
public class Idea199054Service {
    private static final int IDEA_ID = 199054;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199054Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199054Service() {
        this(new Idea199054Config());
    }

    public Idea199054Service(Idea199054Config config) {
        this.config = config != null ? config : new Idea199054Config();
