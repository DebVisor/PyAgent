...
@Data
public class Idea199468Config {
    private String name = "idea_199468";
 ...
 */
@Slf4j
public class Idea199468Service {
    private static final int IDEA_ID = 199468;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199468Service() {
        this(new Idea199468Config());
    }

    public Idea199468Service(Idea199468Config config) {
        this.config = config != null ? config : new Idea199468Config();
