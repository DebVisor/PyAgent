...
@Data
public class Idea199314Config {
    private String name = "idea_199314";
 ...
 */
@Slf4j
public class Idea199314Service {
    private static final int IDEA_ID = 199314;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199314Service() {
        this(new Idea199314Config());
    }

    public Idea199314Service(Idea199314Config config) {
        this.config = config != null ? config : new Idea199314Config();
