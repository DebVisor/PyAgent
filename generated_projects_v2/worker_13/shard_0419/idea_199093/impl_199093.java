...
@Data
public class Idea199093Config {
    private String name = "idea_199093";
 ...
 */
@Slf4j
public class Idea199093Service {
    private static final int IDEA_ID = 199093;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199093Service() {
        this(new Idea199093Config());
    }

    public Idea199093Service(Idea199093Config config) {
        this.config = config != null ? config : new Idea199093Config();
