...
@Data
public class Idea199161Config {
    private String name = "idea_199161";
 ...
 */
@Slf4j
public class Idea199161Service {
    private static final int IDEA_ID = 199161;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199161Service() {
        this(new Idea199161Config());
    }

    public Idea199161Service(Idea199161Config config) {
        this.config = config != null ? config : new Idea199161Config();
