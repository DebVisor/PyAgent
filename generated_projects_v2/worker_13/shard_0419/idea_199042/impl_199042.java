...
@Data
public class Idea199042Config {
    private String name = "idea_199042";
 ...
 */
@Slf4j
public class Idea199042Service {
    private static final int IDEA_ID = 199042;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199042Service() {
        this(new Idea199042Config());
    }

    public Idea199042Service(Idea199042Config config) {
        this.config = config != null ? config : new Idea199042Config();
