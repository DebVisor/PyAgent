...
@Data
public class Idea199067Config {
    private String name = "idea_199067";
 ...
 */
@Slf4j
public class Idea199067Service {
    private static final int IDEA_ID = 199067;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199067Service() {
        this(new Idea199067Config());
    }

    public Idea199067Service(Idea199067Config config) {
        this.config = config != null ? config : new Idea199067Config();
