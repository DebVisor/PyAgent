...
@Data
public class Idea199104Config {
    private String name = "idea_199104";
 ...
 */
@Slf4j
public class Idea199104Service {
    private static final int IDEA_ID = 199104;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199104Service() {
        this(new Idea199104Config());
    }

    public Idea199104Service(Idea199104Config config) {
        this.config = config != null ? config : new Idea199104Config();
