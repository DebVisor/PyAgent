...
@Data
public class Idea199389Config {
    private String name = "idea_199389";
 ...
 */
@Slf4j
public class Idea199389Service {
    private static final int IDEA_ID = 199389;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199389Service() {
        this(new Idea199389Config());
    }

    public Idea199389Service(Idea199389Config config) {
        this.config = config != null ? config : new Idea199389Config();
