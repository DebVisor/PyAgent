...
@Data
public class Idea199141Config {
    private String name = "idea_199141";
 ...
 */
@Slf4j
public class Idea199141Service {
    private static final int IDEA_ID = 199141;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199141Service() {
        this(new Idea199141Config());
    }

    public Idea199141Service(Idea199141Config config) {
        this.config = config != null ? config : new Idea199141Config();
