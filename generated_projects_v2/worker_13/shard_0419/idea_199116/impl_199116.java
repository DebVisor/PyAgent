...
@Data
public class Idea199116Config {
    private String name = "idea_199116";
 ...
 */
@Slf4j
public class Idea199116Service {
    private static final int IDEA_ID = 199116;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199116Service() {
        this(new Idea199116Config());
    }

    public Idea199116Service(Idea199116Config config) {
        this.config = config != null ? config : new Idea199116Config();
