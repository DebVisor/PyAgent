...
@Data
public class Idea199313Config {
    private String name = "idea_199313";
 ...
 */
@Slf4j
public class Idea199313Service {
    private static final int IDEA_ID = 199313;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199313Service() {
        this(new Idea199313Config());
    }

    public Idea199313Service(Idea199313Config config) {
        this.config = config != null ? config : new Idea199313Config();
