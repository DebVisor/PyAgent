...
@Data
public class Idea199426Config {
    private String name = "idea_199426";
 ...
 */
@Slf4j
public class Idea199426Service {
    private static final int IDEA_ID = 199426;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199426Service() {
        this(new Idea199426Config());
    }

    public Idea199426Service(Idea199426Config config) {
        this.config = config != null ? config : new Idea199426Config();
