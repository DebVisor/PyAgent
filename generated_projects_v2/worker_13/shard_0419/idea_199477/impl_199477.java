...
@Data
public class Idea199477Config {
    private String name = "idea_199477";
 ...
 */
@Slf4j
public class Idea199477Service {
    private static final int IDEA_ID = 199477;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199477Service() {
        this(new Idea199477Config());
    }

    public Idea199477Service(Idea199477Config config) {
        this.config = config != null ? config : new Idea199477Config();
