...
@Data
public class Idea199419Config {
    private String name = "idea_199419";
 ...
 */
@Slf4j
public class Idea199419Service {
    private static final int IDEA_ID = 199419;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199419Service() {
        this(new Idea199419Config());
    }

    public Idea199419Service(Idea199419Config config) {
        this.config = config != null ? config : new Idea199419Config();
