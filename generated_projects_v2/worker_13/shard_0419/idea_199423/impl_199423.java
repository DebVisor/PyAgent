...
@Data
public class Idea199423Config {
    private String name = "idea_199423";
 ...
 */
@Slf4j
public class Idea199423Service {
    private static final int IDEA_ID = 199423;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199423Service() {
        this(new Idea199423Config());
    }

    public Idea199423Service(Idea199423Config config) {
        this.config = config != null ? config : new Idea199423Config();
