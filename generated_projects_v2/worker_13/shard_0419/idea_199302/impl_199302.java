...
@Data
public class Idea199302Config {
    private String name = "idea_199302";
 ...
 */
@Slf4j
public class Idea199302Service {
    private static final int IDEA_ID = 199302;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199302Service() {
        this(new Idea199302Config());
    }

    public Idea199302Service(Idea199302Config config) {
        this.config = config != null ? config : new Idea199302Config();
