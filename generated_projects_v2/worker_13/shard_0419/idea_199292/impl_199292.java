...
@Data
public class Idea199292Config {
    private String name = "idea_199292";
 ...
 */
@Slf4j
public class Idea199292Service {
    private static final int IDEA_ID = 199292;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199292Service() {
        this(new Idea199292Config());
    }

    public Idea199292Service(Idea199292Config config) {
        this.config = config != null ? config : new Idea199292Config();
