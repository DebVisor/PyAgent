...
@Data
public class Idea199177Config {
    private String name = "idea_199177";
 ...
 */
@Slf4j
public class Idea199177Service {
    private static final int IDEA_ID = 199177;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199177Service() {
        this(new Idea199177Config());
    }

    public Idea199177Service(Idea199177Config config) {
        this.config = config != null ? config : new Idea199177Config();
