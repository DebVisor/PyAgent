...
@Data
public class Idea199491Config {
    private String name = "idea_199491";
 ...
 */
@Slf4j
public class Idea199491Service {
    private static final int IDEA_ID = 199491;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199491Service() {
        this(new Idea199491Config());
    }

    public Idea199491Service(Idea199491Config config) {
        this.config = config != null ? config : new Idea199491Config();
