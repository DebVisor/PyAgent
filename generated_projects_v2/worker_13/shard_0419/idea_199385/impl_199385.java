...
@Data
public class Idea199385Config {
    private String name = "idea_199385";
 ...
 */
@Slf4j
public class Idea199385Service {
    private static final int IDEA_ID = 199385;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199385Service() {
        this(new Idea199385Config());
    }

    public Idea199385Service(Idea199385Config config) {
        this.config = config != null ? config : new Idea199385Config();
