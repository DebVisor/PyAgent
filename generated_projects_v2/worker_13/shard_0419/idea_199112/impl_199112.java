...
@Data
public class Idea199112Config {
    private String name = "idea_199112";
 ...
 */
@Slf4j
public class Idea199112Service {
    private static final int IDEA_ID = 199112;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199112Service() {
        this(new Idea199112Config());
    }

    public Idea199112Service(Idea199112Config config) {
        this.config = config != null ? config : new Idea199112Config();
