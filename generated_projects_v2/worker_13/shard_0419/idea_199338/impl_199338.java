...
@Data
public class Idea199338Config {
    private String name = "idea_199338";
 ...
 */
@Slf4j
public class Idea199338Service {
    private static final int IDEA_ID = 199338;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199338Service() {
        this(new Idea199338Config());
    }

    public Idea199338Service(Idea199338Config config) {
        this.config = config != null ? config : new Idea199338Config();
