...
@Data
public class Idea199326Config {
    private String name = "idea_199326";
 ...
 */
@Slf4j
public class Idea199326Service {
    private static final int IDEA_ID = 199326;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199326Service() {
        this(new Idea199326Config());
    }

    public Idea199326Service(Idea199326Config config) {
        this.config = config != null ? config : new Idea199326Config();
