...
@Data
public class Idea199032Config {
    private String name = "idea_199032";
 ...
 */
@Slf4j
public class Idea199032Service {
    private static final int IDEA_ID = 199032;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199032Service() {
        this(new Idea199032Config());
    }

    public Idea199032Service(Idea199032Config config) {
        this.config = config != null ? config : new Idea199032Config();
