...
@Data
public class Idea199310Config {
    private String name = "idea_199310";
 ...
 */
@Slf4j
public class Idea199310Service {
    private static final int IDEA_ID = 199310;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199310Service() {
        this(new Idea199310Config());
    }

    public Idea199310Service(Idea199310Config config) {
        this.config = config != null ? config : new Idea199310Config();
