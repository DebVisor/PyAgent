...
@Data
public class Idea199142Config {
    private String name = "idea_199142";
 ...
 */
@Slf4j
public class Idea199142Service {
    private static final int IDEA_ID = 199142;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199142Service() {
        this(new Idea199142Config());
    }

    public Idea199142Service(Idea199142Config config) {
        this.config = config != null ? config : new Idea199142Config();
