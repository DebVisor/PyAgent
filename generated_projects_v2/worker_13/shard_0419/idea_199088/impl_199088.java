...
@Data
public class Idea199088Config {
    private String name = "idea_199088";
 ...
 */
@Slf4j
public class Idea199088Service {
    private static final int IDEA_ID = 199088;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199088Service() {
        this(new Idea199088Config());
    }

    public Idea199088Service(Idea199088Config config) {
        this.config = config != null ? config : new Idea199088Config();
