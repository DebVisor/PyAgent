...
@Data
public class Idea199360Config {
    private String name = "idea_199360";
 ...
 */
@Slf4j
public class Idea199360Service {
    private static final int IDEA_ID = 199360;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199360Service() {
        this(new Idea199360Config());
    }

    public Idea199360Service(Idea199360Config config) {
        this.config = config != null ? config : new Idea199360Config();
