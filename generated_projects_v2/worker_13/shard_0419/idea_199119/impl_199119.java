...
@Data
public class Idea199119Config {
    private String name = "idea_199119";
 ...
 */
@Slf4j
public class Idea199119Service {
    private static final int IDEA_ID = 199119;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199119Service() {
        this(new Idea199119Config());
    }

    public Idea199119Service(Idea199119Config config) {
        this.config = config != null ? config : new Idea199119Config();
