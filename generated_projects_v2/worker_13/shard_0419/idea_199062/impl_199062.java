...
@Data
public class Idea199062Config {
    private String name = "idea_199062";
 ...
 */
@Slf4j
public class Idea199062Service {
    private static final int IDEA_ID = 199062;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199062Service() {
        this(new Idea199062Config());
    }

    public Idea199062Service(Idea199062Config config) {
        this.config = config != null ? config : new Idea199062Config();
