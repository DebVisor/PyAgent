...
@Data
public class Idea199074Config {
    private String name = "idea_199074";
 ...
 */
@Slf4j
public class Idea199074Service {
    private static final int IDEA_ID = 199074;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199074Service() {
        this(new Idea199074Config());
    }

    public Idea199074Service(Idea199074Config config) {
        this.config = config != null ? config : new Idea199074Config();
