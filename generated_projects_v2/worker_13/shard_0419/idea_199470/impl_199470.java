...
@Data
public class Idea199470Config {
    private String name = "idea_199470";
 ...
 */
@Slf4j
public class Idea199470Service {
    private static final int IDEA_ID = 199470;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199470Service() {
        this(new Idea199470Config());
    }

    public Idea199470Service(Idea199470Config config) {
        this.config = config != null ? config : new Idea199470Config();
