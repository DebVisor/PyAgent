...
@Data
public class Idea199321Config {
    private String name = "idea_199321";
 ...
 */
@Slf4j
public class Idea199321Service {
    private static final int IDEA_ID = 199321;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199321Service() {
        this(new Idea199321Config());
    }

    public Idea199321Service(Idea199321Config config) {
        this.config = config != null ? config : new Idea199321Config();
