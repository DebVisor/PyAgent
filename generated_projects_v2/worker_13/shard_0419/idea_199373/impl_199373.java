...
@Data
public class Idea199373Config {
    private String name = "idea_199373";
 ...
 */
@Slf4j
public class Idea199373Service {
    private static final int IDEA_ID = 199373;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199373Service() {
        this(new Idea199373Config());
    }

    public Idea199373Service(Idea199373Config config) {
        this.config = config != null ? config : new Idea199373Config();
