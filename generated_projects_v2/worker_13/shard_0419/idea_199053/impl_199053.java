...
@Data
public class Idea199053Config {
    private String name = "idea_199053";
 ...
 */
@Slf4j
public class Idea199053Service {
    private static final int IDEA_ID = 199053;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199053Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199053Service() {
        this(new Idea199053Config());
    }

    public Idea199053Service(Idea199053Config config) {
        this.config = config != null ? config : new Idea199053Config();
