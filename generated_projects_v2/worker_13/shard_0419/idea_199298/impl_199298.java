...
@Data
public class Idea199298Config {
    private String name = "idea_199298";
 ...
 */
@Slf4j
public class Idea199298Service {
    private static final int IDEA_ID = 199298;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199298Service() {
        this(new Idea199298Config());
    }

    public Idea199298Service(Idea199298Config config) {
        this.config = config != null ? config : new Idea199298Config();
