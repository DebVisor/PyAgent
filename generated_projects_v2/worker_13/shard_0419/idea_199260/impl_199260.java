...
@Data
public class Idea199260Config {
    private String name = "idea_199260";
 ...
 */
@Slf4j
public class Idea199260Service {
    private static final int IDEA_ID = 199260;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199260Service() {
        this(new Idea199260Config());
    }

    public Idea199260Service(Idea199260Config config) {
        this.config = config != null ? config : new Idea199260Config();
