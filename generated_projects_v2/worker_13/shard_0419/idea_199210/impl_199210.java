...
@Data
public class Idea199210Config {
    private String name = "idea_199210";
 ...
 */
@Slf4j
public class Idea199210Service {
    private static final int IDEA_ID = 199210;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199210Service() {
        this(new Idea199210Config());
    }

    public Idea199210Service(Idea199210Config config) {
        this.config = config != null ? config : new Idea199210Config();
