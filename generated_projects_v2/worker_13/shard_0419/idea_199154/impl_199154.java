...
@Data
public class Idea199154Config {
    private String name = "idea_199154";
 ...
 */
@Slf4j
public class Idea199154Service {
    private static final int IDEA_ID = 199154;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199154Service() {
        this(new Idea199154Config());
    }

    public Idea199154Service(Idea199154Config config) {
        this.config = config != null ? config : new Idea199154Config();
