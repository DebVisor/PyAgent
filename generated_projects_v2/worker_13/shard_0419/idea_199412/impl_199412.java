...
@Data
public class Idea199412Config {
    private String name = "idea_199412";
 ...
 */
@Slf4j
public class Idea199412Service {
    private static final int IDEA_ID = 199412;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199412Service() {
        this(new Idea199412Config());
    }

    public Idea199412Service(Idea199412Config config) {
        this.config = config != null ? config : new Idea199412Config();
