...
@Data
public class Idea199285Config {
    private String name = "idea_199285";
 ...
 */
@Slf4j
public class Idea199285Service {
    private static final int IDEA_ID = 199285;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199285Service() {
        this(new Idea199285Config());
    }

    public Idea199285Service(Idea199285Config config) {
        this.config = config != null ? config : new Idea199285Config();
