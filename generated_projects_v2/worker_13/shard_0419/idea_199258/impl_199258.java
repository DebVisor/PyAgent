...
@Data
public class Idea199258Config {
    private String name = "idea_199258";
 ...
 */
@Slf4j
public class Idea199258Service {
    private static final int IDEA_ID = 199258;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199258Service() {
        this(new Idea199258Config());
    }

    public Idea199258Service(Idea199258Config config) {
        this.config = config != null ? config : new Idea199258Config();
