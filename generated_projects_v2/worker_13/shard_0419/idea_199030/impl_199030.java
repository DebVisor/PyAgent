...
@Data
public class Idea199030Config {
    private String name = "idea_199030";
 ...
 */
@Slf4j
public class Idea199030Service {
    private static final int IDEA_ID = 199030;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199030Service() {
        this(new Idea199030Config());
    }

    public Idea199030Service(Idea199030Config config) {
        this.config = config != null ? config : new Idea199030Config();
