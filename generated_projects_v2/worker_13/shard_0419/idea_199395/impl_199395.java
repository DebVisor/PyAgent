...
@Data
public class Idea199395Config {
    private String name = "idea_199395";
 ...
 */
@Slf4j
public class Idea199395Service {
    private static final int IDEA_ID = 199395;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199395Service() {
        this(new Idea199395Config());
    }

    public Idea199395Service(Idea199395Config config) {
        this.config = config != null ? config : new Idea199395Config();
