...
@Data
public class Idea199300Config {
    private String name = "idea_199300";
 ...
 */
@Slf4j
public class Idea199300Service {
    private static final int IDEA_ID = 199300;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199300Service() {
        this(new Idea199300Config());
    }

    public Idea199300Service(Idea199300Config config) {
        this.config = config != null ? config : new Idea199300Config();
