...
@Data
public class Idea199433Config {
    private String name = "idea_199433";
 ...
 */
@Slf4j
public class Idea199433Service {
    private static final int IDEA_ID = 199433;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199433Service() {
        this(new Idea199433Config());
    }

    public Idea199433Service(Idea199433Config config) {
        this.config = config != null ? config : new Idea199433Config();
