...
@Data
public class Idea199483Config {
    private String name = "idea_199483";
 ...
 */
@Slf4j
public class Idea199483Service {
    private static final int IDEA_ID = 199483;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199483Service() {
        this(new Idea199483Config());
    }

    public Idea199483Service(Idea199483Config config) {
        this.config = config != null ? config : new Idea199483Config();
