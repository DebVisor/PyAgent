...
@Data
public class Idea199167Config {
    private String name = "idea_199167";
 ...
 */
@Slf4j
public class Idea199167Service {
    private static final int IDEA_ID = 199167;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199167Service() {
        this(new Idea199167Config());
    }

    public Idea199167Service(Idea199167Config config) {
        this.config = config != null ? config : new Idea199167Config();
