...
@Data
public class Idea199268Config {
    private String name = "idea_199268";
 ...
 */
@Slf4j
public class Idea199268Service {
    private static final int IDEA_ID = 199268;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199268Service() {
        this(new Idea199268Config());
    }

    public Idea199268Service(Idea199268Config config) {
        this.config = config != null ? config : new Idea199268Config();
