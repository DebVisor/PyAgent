...
@Data
public class Idea199236Config {
    private String name = "idea_199236";
 ...
 */
@Slf4j
public class Idea199236Service {
    private static final int IDEA_ID = 199236;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199236Service() {
        this(new Idea199236Config());
    }

    public Idea199236Service(Idea199236Config config) {
        this.config = config != null ? config : new Idea199236Config();
