...
@Data
public class Idea199172Config {
    private String name = "idea_199172";
 ...
 */
@Slf4j
public class Idea199172Service {
    private static final int IDEA_ID = 199172;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199172Service() {
        this(new Idea199172Config());
    }

    public Idea199172Service(Idea199172Config config) {
        this.config = config != null ? config : new Idea199172Config();
