...
@Data
public class Idea199368Config {
    private String name = "idea_199368";
 ...
 */
@Slf4j
public class Idea199368Service {
    private static final int IDEA_ID = 199368;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199368Service() {
        this(new Idea199368Config());
    }

    public Idea199368Service(Idea199368Config config) {
        this.config = config != null ? config : new Idea199368Config();
