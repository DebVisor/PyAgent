...
@Data
public class Idea199196Config {
    private String name = "idea_199196";
 ...
 */
@Slf4j
public class Idea199196Service {
    private static final int IDEA_ID = 199196;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199196Service() {
        this(new Idea199196Config());
    }

    public Idea199196Service(Idea199196Config config) {
        this.config = config != null ? config : new Idea199196Config();
