...
@Data
public class Idea199211Config {
    private String name = "idea_199211";
 ...
 */
@Slf4j
public class Idea199211Service {
    private static final int IDEA_ID = 199211;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199211Service() {
        this(new Idea199211Config());
    }

    public Idea199211Service(Idea199211Config config) {
        this.config = config != null ? config : new Idea199211Config();
