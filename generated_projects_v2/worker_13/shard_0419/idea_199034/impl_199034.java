...
@Data
public class Idea199034Config {
    private String name = "idea_199034";
 ...
 */
@Slf4j
public class Idea199034Service {
    private static final int IDEA_ID = 199034;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199034Service() {
        this(new Idea199034Config());
    }

    public Idea199034Service(Idea199034Config config) {
        this.config = config != null ? config : new Idea199034Config();
