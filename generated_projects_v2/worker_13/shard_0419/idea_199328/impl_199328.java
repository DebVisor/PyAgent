...
@Data
public class Idea199328Config {
    private String name = "idea_199328";
 ...
 */
@Slf4j
public class Idea199328Service {
    private static final int IDEA_ID = 199328;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199328Service() {
        this(new Idea199328Config());
    }

    public Idea199328Service(Idea199328Config config) {
        this.config = config != null ? config : new Idea199328Config();
