...
@Data
public class Idea199044Config {
    private String name = "idea_199044";
 ...
 */
@Slf4j
public class Idea199044Service {
    private static final int IDEA_ID = 199044;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199044Service() {
        this(new Idea199044Config());
    }

    public Idea199044Service(Idea199044Config config) {
        this.config = config != null ? config : new Idea199044Config();
