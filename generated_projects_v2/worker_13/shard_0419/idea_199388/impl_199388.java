...
@Data
public class Idea199388Config {
    private String name = "idea_199388";
 ...
 */
@Slf4j
public class Idea199388Service {
    private static final int IDEA_ID = 199388;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199388Service() {
        this(new Idea199388Config());
    }

    public Idea199388Service(Idea199388Config config) {
        this.config = config != null ? config : new Idea199388Config();
