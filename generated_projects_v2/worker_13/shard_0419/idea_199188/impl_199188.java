...
@Data
public class Idea199188Config {
    private String name = "idea_199188";
 ...
 */
@Slf4j
public class Idea199188Service {
    private static final int IDEA_ID = 199188;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199188Service() {
        this(new Idea199188Config());
    }

    public Idea199188Service(Idea199188Config config) {
        this.config = config != null ? config : new Idea199188Config();
