...
@Data
public class Idea199390Config {
    private String name = "idea_199390";
 ...
 */
@Slf4j
public class Idea199390Service {
    private static final int IDEA_ID = 199390;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199390Service() {
        this(new Idea199390Config());
    }

    public Idea199390Service(Idea199390Config config) {
        this.config = config != null ? config : new Idea199390Config();
