...
@Data
public class Idea199480Config {
    private String name = "idea_199480";
 ...
 */
@Slf4j
public class Idea199480Service {
    private static final int IDEA_ID = 199480;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199480Service() {
        this(new Idea199480Config());
    }

    public Idea199480Service(Idea199480Config config) {
        this.config = config != null ? config : new Idea199480Config();
