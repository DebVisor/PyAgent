...
@Data
public class Idea199363Config {
    private String name = "idea_199363";
 ...
 */
@Slf4j
public class Idea199363Service {
    private static final int IDEA_ID = 199363;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199363Service() {
        this(new Idea199363Config());
    }

    public Idea199363Service(Idea199363Config config) {
        this.config = config != null ? config : new Idea199363Config();
