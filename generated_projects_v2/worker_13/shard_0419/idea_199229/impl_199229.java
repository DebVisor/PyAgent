...
@Data
public class Idea199229Config {
    private String name = "idea_199229";
 ...
 */
@Slf4j
public class Idea199229Service {
    private static final int IDEA_ID = 199229;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199229Service() {
        this(new Idea199229Config());
    }

    public Idea199229Service(Idea199229Config config) {
        this.config = config != null ? config : new Idea199229Config();
