...
@Data
public class Idea199238Config {
    private String name = "idea_199238";
 ...
 */
@Slf4j
public class Idea199238Service {
    private static final int IDEA_ID = 199238;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199238Service() {
        this(new Idea199238Config());
    }

    public Idea199238Service(Idea199238Config config) {
        this.config = config != null ? config : new Idea199238Config();
