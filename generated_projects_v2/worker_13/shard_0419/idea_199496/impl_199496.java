...
@Data
public class Idea199496Config {
    private String name = "idea_199496";
 ...
 */
@Slf4j
public class Idea199496Service {
    private static final int IDEA_ID = 199496;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199496Service() {
        this(new Idea199496Config());
    }

    public Idea199496Service(Idea199496Config config) {
        this.config = config != null ? config : new Idea199496Config();
