...
@Data
public class Idea199405Config {
    private String name = "idea_199405";
 ...
 */
@Slf4j
public class Idea199405Service {
    private static final int IDEA_ID = 199405;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199405Service() {
        this(new Idea199405Config());
    }

    public Idea199405Service(Idea199405Config config) {
        this.config = config != null ? config : new Idea199405Config();
