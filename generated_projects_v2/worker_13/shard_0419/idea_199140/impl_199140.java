...
@Data
public class Idea199140Config {
    private String name = "idea_199140";
 ...
 */
@Slf4j
public class Idea199140Service {
    private static final int IDEA_ID = 199140;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199140Service() {
        this(new Idea199140Config());
    }

    public Idea199140Service(Idea199140Config config) {
        this.config = config != null ? config : new Idea199140Config();
