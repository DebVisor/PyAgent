...
@Data
public class Idea199264Config {
    private String name = "idea_199264";
 ...
 */
@Slf4j
public class Idea199264Service {
    private static final int IDEA_ID = 199264;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199264Service() {
        this(new Idea199264Config());
    }

    public Idea199264Service(Idea199264Config config) {
        this.config = config != null ? config : new Idea199264Config();
