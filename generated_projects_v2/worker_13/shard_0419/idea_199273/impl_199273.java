...
@Data
public class Idea199273Config {
    private String name = "idea_199273";
 ...
 */
@Slf4j
public class Idea199273Service {
    private static final int IDEA_ID = 199273;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199273Service() {
        this(new Idea199273Config());
    }

    public Idea199273Service(Idea199273Config config) {
        this.config = config != null ? config : new Idea199273Config();
