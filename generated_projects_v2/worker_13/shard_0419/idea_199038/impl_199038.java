...
@Data
public class Idea199038Config {
    private String name = "idea_199038";
 ...
 */
@Slf4j
public class Idea199038Service {
    private static final int IDEA_ID = 199038;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199038Service() {
        this(new Idea199038Config());
    }

    public Idea199038Service(Idea199038Config config) {
        this.config = config != null ? config : new Idea199038Config();
