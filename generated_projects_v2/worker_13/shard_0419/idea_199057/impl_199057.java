...
@Data
public class Idea199057Config {
    private String name = "idea_199057";
 ...
 */
@Slf4j
public class Idea199057Service {
    private static final int IDEA_ID = 199057;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199057Service() {
        this(new Idea199057Config());
    }

    public Idea199057Service(Idea199057Config config) {
        this.config = config != null ? config : new Idea199057Config();
