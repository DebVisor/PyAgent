...
@Data
public class Idea199450Config {
    private String name = "idea_199450";
 ...
 */
@Slf4j
public class Idea199450Service {
    private static final int IDEA_ID = 199450;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199450Service() {
        this(new Idea199450Config());
    }

    public Idea199450Service(Idea199450Config config) {
        this.config = config != null ? config : new Idea199450Config();
