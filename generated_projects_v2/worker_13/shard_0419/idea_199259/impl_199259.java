...
@Data
public class Idea199259Config {
    private String name = "idea_199259";
 ...
 */
@Slf4j
public class Idea199259Service {
    private static final int IDEA_ID = 199259;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199259Service() {
        this(new Idea199259Config());
    }

    public Idea199259Service(Idea199259Config config) {
        this.config = config != null ? config : new Idea199259Config();
