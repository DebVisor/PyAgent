...
@Data
public class Idea199341Config {
    private String name = "idea_199341";
 ...
 */
@Slf4j
public class Idea199341Service {
    private static final int IDEA_ID = 199341;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199341Service() {
        this(new Idea199341Config());
    }

    public Idea199341Service(Idea199341Config config) {
        this.config = config != null ? config : new Idea199341Config();
