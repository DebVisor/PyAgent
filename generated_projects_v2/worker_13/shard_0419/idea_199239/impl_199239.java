...
@Data
public class Idea199239Config {
    private String name = "idea_199239";
 ...
 */
@Slf4j
public class Idea199239Service {
    private static final int IDEA_ID = 199239;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199239Service() {
        this(new Idea199239Config());
    }

    public Idea199239Service(Idea199239Config config) {
        this.config = config != null ? config : new Idea199239Config();
