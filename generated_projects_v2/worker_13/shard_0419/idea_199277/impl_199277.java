...
@Data
public class Idea199277Config {
    private String name = "idea_199277";
 ...
 */
@Slf4j
public class Idea199277Service {
    private static final int IDEA_ID = 199277;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199277Service() {
        this(new Idea199277Config());
    }

    public Idea199277Service(Idea199277Config config) {
        this.config = config != null ? config : new Idea199277Config();
