...
@Data
public class Idea199353Config {
    private String name = "idea_199353";
 ...
 */
@Slf4j
public class Idea199353Service {
    private static final int IDEA_ID = 199353;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199353Service() {
        this(new Idea199353Config());
    }

    public Idea199353Service(Idea199353Config config) {
        this.config = config != null ? config : new Idea199353Config();
