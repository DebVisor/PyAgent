...
@Data
public class Idea199105Config {
    private String name = "idea_199105";
 ...
 */
@Slf4j
public class Idea199105Service {
    private static final int IDEA_ID = 199105;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199105Service() {
        this(new Idea199105Config());
    }

    public Idea199105Service(Idea199105Config config) {
        this.config = config != null ? config : new Idea199105Config();
