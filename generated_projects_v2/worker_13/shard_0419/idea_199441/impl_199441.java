...
@Data
public class Idea199441Config {
    private String name = "idea_199441";
 ...
 */
@Slf4j
public class Idea199441Service {
    private static final int IDEA_ID = 199441;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199441Service() {
        this(new Idea199441Config());
    }

    public Idea199441Service(Idea199441Config config) {
        this.config = config != null ? config : new Idea199441Config();
