...
@Data
public class Idea199157Config {
    private String name = "idea_199157";
 ...
 */
@Slf4j
public class Idea199157Service {
    private static final int IDEA_ID = 199157;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199157Service() {
        this(new Idea199157Config());
    }

    public Idea199157Service(Idea199157Config config) {
        this.config = config != null ? config : new Idea199157Config();
