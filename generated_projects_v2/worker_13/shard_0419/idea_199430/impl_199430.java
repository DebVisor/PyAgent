...
@Data
public class Idea199430Config {
    private String name = "idea_199430";
 ...
 */
@Slf4j
public class Idea199430Service {
    private static final int IDEA_ID = 199430;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199430Service() {
        this(new Idea199430Config());
    }

    public Idea199430Service(Idea199430Config config) {
        this.config = config != null ? config : new Idea199430Config();
