...
@Data
public class Idea199217Config {
    private String name = "idea_199217";
 ...
 */
@Slf4j
public class Idea199217Service {
    private static final int IDEA_ID = 199217;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199217Service() {
        this(new Idea199217Config());
    }

    public Idea199217Service(Idea199217Config config) {
        this.config = config != null ? config : new Idea199217Config();
