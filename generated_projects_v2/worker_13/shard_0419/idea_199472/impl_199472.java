...
@Data
public class Idea199472Config {
    private String name = "idea_199472";
 ...
 */
@Slf4j
public class Idea199472Service {
    private static final int IDEA_ID = 199472;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199472Service() {
        this(new Idea199472Config());
    }

    public Idea199472Service(Idea199472Config config) {
        this.config = config != null ? config : new Idea199472Config();
