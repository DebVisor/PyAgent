...
@Data
public class Idea199156Config {
    private String name = "idea_199156";
 ...
 */
@Slf4j
public class Idea199156Service {
    private static final int IDEA_ID = 199156;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199156Service() {
        this(new Idea199156Config());
    }

    public Idea199156Service(Idea199156Config config) {
        this.config = config != null ? config : new Idea199156Config();
