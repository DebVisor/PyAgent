...
@Data
public class Idea199170Config {
    private String name = "idea_199170";
 ...
 */
@Slf4j
public class Idea199170Service {
    private static final int IDEA_ID = 199170;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199170Service() {
        this(new Idea199170Config());
    }

    public Idea199170Service(Idea199170Config config) {
        this.config = config != null ? config : new Idea199170Config();
