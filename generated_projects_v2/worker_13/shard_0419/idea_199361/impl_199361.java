...
@Data
public class Idea199361Config {
    private String name = "idea_199361";
 ...
 */
@Slf4j
public class Idea199361Service {
    private static final int IDEA_ID = 199361;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199361Service() {
        this(new Idea199361Config());
    }

    public Idea199361Service(Idea199361Config config) {
        this.config = config != null ? config : new Idea199361Config();
