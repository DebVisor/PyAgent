...
@Data
public class Idea199230Config {
    private String name = "idea_199230";
 ...
 */
@Slf4j
public class Idea199230Service {
    private static final int IDEA_ID = 199230;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199230Service() {
        this(new Idea199230Config());
    }

    public Idea199230Service(Idea199230Config config) {
        this.config = config != null ? config : new Idea199230Config();
