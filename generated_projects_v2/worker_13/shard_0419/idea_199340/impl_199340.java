...
@Data
public class Idea199340Config {
    private String name = "idea_199340";
 ...
 */
@Slf4j
public class Idea199340Service {
    private static final int IDEA_ID = 199340;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199340Service() {
        this(new Idea199340Config());
    }

    public Idea199340Service(Idea199340Config config) {
        this.config = config != null ? config : new Idea199340Config();
