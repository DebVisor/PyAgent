...
@Data
public class Idea199028Config {
    private String name = "idea_199028";
 ...
 */
@Slf4j
public class Idea199028Service {
    private static final int IDEA_ID = 199028;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199028Service() {
        this(new Idea199028Config());
    }

    public Idea199028Service(Idea199028Config config) {
        this.config = config != null ? config : new Idea199028Config();
