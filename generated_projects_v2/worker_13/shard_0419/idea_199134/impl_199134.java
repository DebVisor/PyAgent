...
@Data
public class Idea199134Config {
    private String name = "idea_199134";
 ...
 */
@Slf4j
public class Idea199134Service {
    private static final int IDEA_ID = 199134;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199134Service() {
        this(new Idea199134Config());
    }

    public Idea199134Service(Idea199134Config config) {
        this.config = config != null ? config : new Idea199134Config();
