...
@Data
public class Idea199073Config {
    private String name = "idea_199073";
 ...
 */
@Slf4j
public class Idea199073Service {
    private static final int IDEA_ID = 199073;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199073Service() {
        this(new Idea199073Config());
    }

    public Idea199073Service(Idea199073Config config) {
        this.config = config != null ? config : new Idea199073Config();
