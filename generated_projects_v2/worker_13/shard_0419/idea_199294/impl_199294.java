...
@Data
public class Idea199294Config {
    private String name = "idea_199294";
 ...
 */
@Slf4j
public class Idea199294Service {
    private static final int IDEA_ID = 199294;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199294Service() {
        this(new Idea199294Config());
    }

    public Idea199294Service(Idea199294Config config) {
        this.config = config != null ? config : new Idea199294Config();
