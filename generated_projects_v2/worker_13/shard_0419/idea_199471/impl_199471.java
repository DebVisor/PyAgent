...
@Data
public class Idea199471Config {
    private String name = "idea_199471";
 ...
 */
@Slf4j
public class Idea199471Service {
    private static final int IDEA_ID = 199471;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199471Service() {
        this(new Idea199471Config());
    }

    public Idea199471Service(Idea199471Config config) {
        this.config = config != null ? config : new Idea199471Config();
