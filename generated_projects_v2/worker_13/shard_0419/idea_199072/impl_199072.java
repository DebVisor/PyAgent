...
@Data
public class Idea199072Config {
    private String name = "idea_199072";
 ...
 */
@Slf4j
public class Idea199072Service {
    private static final int IDEA_ID = 199072;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199072Service() {
        this(new Idea199072Config());
    }

    public Idea199072Service(Idea199072Config config) {
        this.config = config != null ? config : new Idea199072Config();
