...
@Data
public class Idea199435Config {
    private String name = "idea_199435";
 ...
 */
@Slf4j
public class Idea199435Service {
    private static final int IDEA_ID = 199435;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199435Service() {
        this(new Idea199435Config());
    }

    public Idea199435Service(Idea199435Config config) {
        this.config = config != null ? config : new Idea199435Config();
