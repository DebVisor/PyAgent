...
@Data
public class Idea199178Config {
    private String name = "idea_199178";
 ...
 */
@Slf4j
public class Idea199178Service {
    private static final int IDEA_ID = 199178;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199178Service() {
        this(new Idea199178Config());
    }

    public Idea199178Service(Idea199178Config config) {
        this.config = config != null ? config : new Idea199178Config();
