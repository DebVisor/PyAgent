...
@Data
public class Idea199333Config {
    private String name = "idea_199333";
 ...
 */
@Slf4j
public class Idea199333Service {
    private static final int IDEA_ID = 199333;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199333Service() {
        this(new Idea199333Config());
    }

    public Idea199333Service(Idea199333Config config) {
        this.config = config != null ? config : new Idea199333Config();
