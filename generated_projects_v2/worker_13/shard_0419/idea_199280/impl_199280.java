...
@Data
public class Idea199280Config {
    private String name = "idea_199280";
 ...
 */
@Slf4j
public class Idea199280Service {
    private static final int IDEA_ID = 199280;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199280Service() {
        this(new Idea199280Config());
    }

    public Idea199280Service(Idea199280Config config) {
        this.config = config != null ? config : new Idea199280Config();
