...
@Data
public class Idea199149Config {
    private String name = "idea_199149";
 ...
 */
@Slf4j
public class Idea199149Service {
    private static final int IDEA_ID = 199149;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199149Service() {
        this(new Idea199149Config());
    }

    public Idea199149Service(Idea199149Config config) {
        this.config = config != null ? config : new Idea199149Config();
