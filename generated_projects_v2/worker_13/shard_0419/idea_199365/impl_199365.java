...
@Data
public class Idea199365Config {
    private String name = "idea_199365";
 ...
 */
@Slf4j
public class Idea199365Service {
    private static final int IDEA_ID = 199365;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199365Service() {
        this(new Idea199365Config());
    }

    public Idea199365Service(Idea199365Config config) {
        this.config = config != null ? config : new Idea199365Config();
