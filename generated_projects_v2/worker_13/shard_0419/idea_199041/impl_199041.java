...
@Data
public class Idea199041Config {
    private String name = "idea_199041";
 ...
 */
@Slf4j
public class Idea199041Service {
    private static final int IDEA_ID = 199041;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199041Service() {
        this(new Idea199041Config());
    }

    public Idea199041Service(Idea199041Config config) {
        this.config = config != null ? config : new Idea199041Config();
