...
@Data
public class Idea199422Config {
    private String name = "idea_199422";
 ...
 */
@Slf4j
public class Idea199422Service {
    private static final int IDEA_ID = 199422;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199422Service() {
        this(new Idea199422Config());
    }

    public Idea199422Service(Idea199422Config config) {
        this.config = config != null ? config : new Idea199422Config();
