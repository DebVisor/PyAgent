...
@Data
public class Idea199162Config {
    private String name = "idea_199162";
 ...
 */
@Slf4j
public class Idea199162Service {
    private static final int IDEA_ID = 199162;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199162Service() {
        this(new Idea199162Config());
    }

    public Idea199162Service(Idea199162Config config) {
        this.config = config != null ? config : new Idea199162Config();
