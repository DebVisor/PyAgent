...
@Data
public class Idea199416Config {
    private String name = "idea_199416";
 ...
 */
@Slf4j
public class Idea199416Service {
    private static final int IDEA_ID = 199416;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199416Service() {
        this(new Idea199416Config());
    }

    public Idea199416Service(Idea199416Config config) {
        this.config = config != null ? config : new Idea199416Config();
