...
@Data
public class Idea199065Config {
    private String name = "idea_199065";
 ...
 */
@Slf4j
public class Idea199065Service {
    private static final int IDEA_ID = 199065;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199065Service() {
        this(new Idea199065Config());
    }

    public Idea199065Service(Idea199065Config config) {
        this.config = config != null ? config : new Idea199065Config();
