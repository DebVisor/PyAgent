...
@Data
public class Idea199262Config {
    private String name = "idea_199262";
 ...
 */
@Slf4j
public class Idea199262Service {
    private static final int IDEA_ID = 199262;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199262Service() {
        this(new Idea199262Config());
    }

    public Idea199262Service(Idea199262Config config) {
        this.config = config != null ? config : new Idea199262Config();
