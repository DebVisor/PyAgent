...
@Data
public class Idea199233Config {
    private String name = "idea_199233";
 ...
 */
@Slf4j
public class Idea199233Service {
    private static final int IDEA_ID = 199233;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199233Service() {
        this(new Idea199233Config());
    }

    public Idea199233Service(Idea199233Config config) {
        this.config = config != null ? config : new Idea199233Config();
