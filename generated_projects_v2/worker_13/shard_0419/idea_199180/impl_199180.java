...
@Data
public class Idea199180Config {
    private String name = "idea_199180";
 ...
 */
@Slf4j
public class Idea199180Service {
    private static final int IDEA_ID = 199180;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199180Service() {
        this(new Idea199180Config());
    }

    public Idea199180Service(Idea199180Config config) {
        this.config = config != null ? config : new Idea199180Config();
