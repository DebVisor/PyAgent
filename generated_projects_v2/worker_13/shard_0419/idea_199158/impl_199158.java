...
@Data
public class Idea199158Config {
    private String name = "idea_199158";
 ...
 */
@Slf4j
public class Idea199158Service {
    private static final int IDEA_ID = 199158;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199158Service() {
        this(new Idea199158Config());
    }

    public Idea199158Service(Idea199158Config config) {
        this.config = config != null ? config : new Idea199158Config();
