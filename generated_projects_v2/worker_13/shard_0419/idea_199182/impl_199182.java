...
@Data
public class Idea199182Config {
    private String name = "idea_199182";
 ...
 */
@Slf4j
public class Idea199182Service {
    private static final int IDEA_ID = 199182;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199182Service() {
        this(new Idea199182Config());
    }

    public Idea199182Service(Idea199182Config config) {
        this.config = config != null ? config : new Idea199182Config();
