...
@Data
public class Idea199380Config {
    private String name = "idea_199380";
 ...
 */
@Slf4j
public class Idea199380Service {
    private static final int IDEA_ID = 199380;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199380Service() {
        this(new Idea199380Config());
    }

    public Idea199380Service(Idea199380Config config) {
        this.config = config != null ? config : new Idea199380Config();
