...
@Data
public class Idea199323Config {
    private String name = "idea_199323";
 ...
 */
@Slf4j
public class Idea199323Service {
    private static final int IDEA_ID = 199323;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199323Service() {
        this(new Idea199323Config());
    }

    public Idea199323Service(Idea199323Config config) {
        this.config = config != null ? config : new Idea199323Config();
