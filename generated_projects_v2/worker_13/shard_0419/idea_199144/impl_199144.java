...
@Data
public class Idea199144Config {
    private String name = "idea_199144";
 ...
 */
@Slf4j
public class Idea199144Service {
    private static final int IDEA_ID = 199144;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199144Service() {
        this(new Idea199144Config());
    }

    public Idea199144Service(Idea199144Config config) {
        this.config = config != null ? config : new Idea199144Config();
