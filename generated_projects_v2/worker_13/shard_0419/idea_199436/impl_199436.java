...
@Data
public class Idea199436Config {
    private String name = "idea_199436";
 ...
 */
@Slf4j
public class Idea199436Service {
    private static final int IDEA_ID = 199436;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199436Service() {
        this(new Idea199436Config());
    }

    public Idea199436Service(Idea199436Config config) {
        this.config = config != null ? config : new Idea199436Config();
