...
@Data
public class Idea199462Config {
    private String name = "idea_199462";
 ...
 */
@Slf4j
public class Idea199462Service {
    private static final int IDEA_ID = 199462;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199462Service() {
        this(new Idea199462Config());
    }

    public Idea199462Service(Idea199462Config config) {
        this.config = config != null ? config : new Idea199462Config();
