...
@Data
public class Idea199486Config {
    private String name = "idea_199486";
 ...
 */
@Slf4j
public class Idea199486Service {
    private static final int IDEA_ID = 199486;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199486Service() {
        this(new Idea199486Config());
    }

    public Idea199486Service(Idea199486Config config) {
        this.config = config != null ? config : new Idea199486Config();
