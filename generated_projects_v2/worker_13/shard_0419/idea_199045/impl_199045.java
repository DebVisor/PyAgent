...
@Data
public class Idea199045Config {
    private String name = "idea_199045";
 ...
 */
@Slf4j
public class Idea199045Service {
    private static final int IDEA_ID = 199045;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199045Service() {
        this(new Idea199045Config());
    }

    public Idea199045Service(Idea199045Config config) {
        this.config = config != null ? config : new Idea199045Config();
