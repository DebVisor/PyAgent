...
@Data
public class Idea199204Config {
    private String name = "idea_199204";
 ...
 */
@Slf4j
public class Idea199204Service {
    private static final int IDEA_ID = 199204;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199204Service() {
        this(new Idea199204Config());
    }

    public Idea199204Service(Idea199204Config config) {
        this.config = config != null ? config : new Idea199204Config();
