...
@Data
public class Idea199324Config {
    private String name = "idea_199324";
 ...
 */
@Slf4j
public class Idea199324Service {
    private static final int IDEA_ID = 199324;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199324Service() {
        this(new Idea199324Config());
    }

    public Idea199324Service(Idea199324Config config) {
        this.config = config != null ? config : new Idea199324Config();
