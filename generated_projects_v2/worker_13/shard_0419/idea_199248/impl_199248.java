...
@Data
public class Idea199248Config {
    private String name = "idea_199248";
 ...
 */
@Slf4j
public class Idea199248Service {
    private static final int IDEA_ID = 199248;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199248Service() {
        this(new Idea199248Config());
    }

    public Idea199248Service(Idea199248Config config) {
        this.config = config != null ? config : new Idea199248Config();
