...
@Data
public class Idea199293Config {
    private String name = "idea_199293";
 ...
 */
@Slf4j
public class Idea199293Service {
    private static final int IDEA_ID = 199293;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199293Service() {
        this(new Idea199293Config());
    }

    public Idea199293Service(Idea199293Config config) {
        this.config = config != null ? config : new Idea199293Config();
