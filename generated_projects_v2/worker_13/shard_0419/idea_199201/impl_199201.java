...
@Data
public class Idea199201Config {
    private String name = "idea_199201";
 ...
 */
@Slf4j
public class Idea199201Service {
    private static final int IDEA_ID = 199201;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199201Service() {
        this(new Idea199201Config());
    }

    public Idea199201Service(Idea199201Config config) {
        this.config = config != null ? config : new Idea199201Config();
