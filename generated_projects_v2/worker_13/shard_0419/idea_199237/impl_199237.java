...
@Data
public class Idea199237Config {
    private String name = "idea_199237";
 ...
 */
@Slf4j
public class Idea199237Service {
    private static final int IDEA_ID = 199237;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199237Service() {
        this(new Idea199237Config());
    }

    public Idea199237Service(Idea199237Config config) {
        this.config = config != null ? config : new Idea199237Config();
