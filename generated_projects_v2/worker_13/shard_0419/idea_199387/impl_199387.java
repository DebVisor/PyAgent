...
@Data
public class Idea199387Config {
    private String name = "idea_199387";
 ...
 */
@Slf4j
public class Idea199387Service {
    private static final int IDEA_ID = 199387;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199387Service() {
        this(new Idea199387Config());
    }

    public Idea199387Service(Idea199387Config config) {
        this.config = config != null ? config : new Idea199387Config();
