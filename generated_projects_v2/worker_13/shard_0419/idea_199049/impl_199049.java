...
@Data
public class Idea199049Config {
    private String name = "idea_199049";
 ...
 */
@Slf4j
public class Idea199049Service {
    private static final int IDEA_ID = 199049;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199049Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199049Service() {
        this(new Idea199049Config());
    }

    public Idea199049Service(Idea199049Config config) {
        this.config = config != null ? config : new Idea199049Config();
