...
@Data
public class Idea199382Config {
    private String name = "idea_199382";
 ...
 */
@Slf4j
public class Idea199382Service {
    private static final int IDEA_ID = 199382;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199382Service() {
        this(new Idea199382Config());
    }

    public Idea199382Service(Idea199382Config config) {
        this.config = config != null ? config : new Idea199382Config();
