...
@Data
public class Idea199185Config {
    private String name = "idea_199185";
 ...
 */
@Slf4j
public class Idea199185Service {
    private static final int IDEA_ID = 199185;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199185Service() {
        this(new Idea199185Config());
    }

    public Idea199185Service(Idea199185Config config) {
        this.config = config != null ? config : new Idea199185Config();
