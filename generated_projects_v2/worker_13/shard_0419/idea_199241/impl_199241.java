...
@Data
public class Idea199241Config {
    private String name = "idea_199241";
 ...
 */
@Slf4j
public class Idea199241Service {
    private static final int IDEA_ID = 199241;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199241Service() {
        this(new Idea199241Config());
    }

    public Idea199241Service(Idea199241Config config) {
        this.config = config != null ? config : new Idea199241Config();
