...
@Data
public class Idea199026Config {
    private String name = "idea_199026";
 ...
 */
@Slf4j
public class Idea199026Service {
    private static final int IDEA_ID = 199026;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199026Service() {
        this(new Idea199026Config());
    }

    public Idea199026Service(Idea199026Config config) {
        this.config = config != null ? config : new Idea199026Config();
