...
@Data
public class Idea199445Config {
    private String name = "idea_199445";
 ...
 */
@Slf4j
public class Idea199445Service {
    private static final int IDEA_ID = 199445;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199445Service() {
        this(new Idea199445Config());
    }

    public Idea199445Service(Idea199445Config config) {
        this.config = config != null ? config : new Idea199445Config();
