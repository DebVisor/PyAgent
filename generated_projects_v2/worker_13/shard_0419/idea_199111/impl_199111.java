...
@Data
public class Idea199111Config {
    private String name = "idea_199111";
 ...
 */
@Slf4j
public class Idea199111Service {
    private static final int IDEA_ID = 199111;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199111Service() {
        this(new Idea199111Config());
    }

    public Idea199111Service(Idea199111Config config) {
        this.config = config != null ? config : new Idea199111Config();
