...
@Data
public class Idea199304Config {
    private String name = "idea_199304";
 ...
 */
@Slf4j
public class Idea199304Service {
    private static final int IDEA_ID = 199304;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199304Service() {
        this(new Idea199304Config());
    }

    public Idea199304Service(Idea199304Config config) {
        this.config = config != null ? config : new Idea199304Config();
