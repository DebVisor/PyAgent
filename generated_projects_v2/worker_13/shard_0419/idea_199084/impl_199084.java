...
@Data
public class Idea199084Config {
    private String name = "idea_199084";
 ...
 */
@Slf4j
public class Idea199084Service {
    private static final int IDEA_ID = 199084;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199084Service() {
        this(new Idea199084Config());
    }

    public Idea199084Service(Idea199084Config config) {
        this.config = config != null ? config : new Idea199084Config();
