...
@Data
public class Idea199428Config {
    private String name = "idea_199428";
 ...
 */
@Slf4j
public class Idea199428Service {
    private static final int IDEA_ID = 199428;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199428Service() {
        this(new Idea199428Config());
    }

    public Idea199428Service(Idea199428Config config) {
        this.config = config != null ? config : new Idea199428Config();
