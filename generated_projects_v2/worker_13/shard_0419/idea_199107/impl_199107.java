...
@Data
public class Idea199107Config {
    private String name = "idea_199107";
 ...
 */
@Slf4j
public class Idea199107Service {
    private static final int IDEA_ID = 199107;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199107Service() {
        this(new Idea199107Config());
    }

    public Idea199107Service(Idea199107Config config) {
        this.config = config != null ? config : new Idea199107Config();
