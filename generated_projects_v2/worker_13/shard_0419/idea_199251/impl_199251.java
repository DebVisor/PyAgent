...
@Data
public class Idea199251Config {
    private String name = "idea_199251";
 ...
 */
@Slf4j
public class Idea199251Service {
    private static final int IDEA_ID = 199251;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199251Service() {
        this(new Idea199251Config());
    }

    public Idea199251Service(Idea199251Config config) {
        this.config = config != null ? config : new Idea199251Config();
