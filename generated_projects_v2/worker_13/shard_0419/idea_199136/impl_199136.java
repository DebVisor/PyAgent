...
@Data
public class Idea199136Config {
    private String name = "idea_199136";
 ...
 */
@Slf4j
public class Idea199136Service {
    private static final int IDEA_ID = 199136;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199136Service() {
        this(new Idea199136Config());
    }

    public Idea199136Service(Idea199136Config config) {
        this.config = config != null ? config : new Idea199136Config();
