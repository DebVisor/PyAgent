...
@Data
public class Idea199255Config {
    private String name = "idea_199255";
 ...
 */
@Slf4j
public class Idea199255Service {
    private static final int IDEA_ID = 199255;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199255Service() {
        this(new Idea199255Config());
    }

    public Idea199255Service(Idea199255Config config) {
        this.config = config != null ? config : new Idea199255Config();
