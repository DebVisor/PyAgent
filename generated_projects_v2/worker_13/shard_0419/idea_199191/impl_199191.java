...
@Data
public class Idea199191Config {
    private String name = "idea_199191";
 ...
 */
@Slf4j
public class Idea199191Service {
    private static final int IDEA_ID = 199191;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199191Service() {
        this(new Idea199191Config());
    }

    public Idea199191Service(Idea199191Config config) {
        this.config = config != null ? config : new Idea199191Config();
