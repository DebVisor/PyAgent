...
@Data
public class Idea199055Config {
    private String name = "idea_199055";
 ...
 */
@Slf4j
public class Idea199055Service {
    private static final int IDEA_ID = 199055;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199055Service() {
        this(new Idea199055Config());
    }

    public Idea199055Service(Idea199055Config config) {
        this.config = config != null ? config : new Idea199055Config();
