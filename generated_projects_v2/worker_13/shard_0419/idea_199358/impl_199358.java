...
@Data
public class Idea199358Config {
    private String name = "idea_199358";
 ...
 */
@Slf4j
public class Idea199358Service {
    private static final int IDEA_ID = 199358;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199358Service() {
        this(new Idea199358Config());
    }

    public Idea199358Service(Idea199358Config config) {
        this.config = config != null ? config : new Idea199358Config();
