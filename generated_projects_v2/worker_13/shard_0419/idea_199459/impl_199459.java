...
@Data
public class Idea199459Config {
    private String name = "idea_199459";
 ...
 */
@Slf4j
public class Idea199459Service {
    private static final int IDEA_ID = 199459;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199459Service() {
        this(new Idea199459Config());
    }

    public Idea199459Service(Idea199459Config config) {
        this.config = config != null ? config : new Idea199459Config();
