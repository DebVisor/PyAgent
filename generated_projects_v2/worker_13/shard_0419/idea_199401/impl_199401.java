...
@Data
public class Idea199401Config {
    private String name = "idea_199401";
 ...
 */
@Slf4j
public class Idea199401Service {
    private static final int IDEA_ID = 199401;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199401Service() {
        this(new Idea199401Config());
    }

    public Idea199401Service(Idea199401Config config) {
        this.config = config != null ? config : new Idea199401Config();
