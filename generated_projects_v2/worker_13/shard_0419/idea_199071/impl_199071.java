...
@Data
public class Idea199071Config {
    private String name = "idea_199071";
 ...
 */
@Slf4j
public class Idea199071Service {
    private static final int IDEA_ID = 199071;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199071Service() {
        this(new Idea199071Config());
    }

    public Idea199071Service(Idea199071Config config) {
        this.config = config != null ? config : new Idea199071Config();
