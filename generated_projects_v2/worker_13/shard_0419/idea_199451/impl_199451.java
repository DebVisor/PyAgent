...
@Data
public class Idea199451Config {
    private String name = "idea_199451";
 ...
 */
@Slf4j
public class Idea199451Service {
    private static final int IDEA_ID = 199451;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199451Service() {
        this(new Idea199451Config());
    }

    public Idea199451Service(Idea199451Config config) {
        this.config = config != null ? config : new Idea199451Config();
