...
@Data
public class Idea199115Config {
    private String name = "idea_199115";
 ...
 */
@Slf4j
public class Idea199115Service {
    private static final int IDEA_ID = 199115;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199115Service() {
        this(new Idea199115Config());
    }

    public Idea199115Service(Idea199115Config config) {
        this.config = config != null ? config : new Idea199115Config();
