...
@Data
public class Idea199143Config {
    private String name = "idea_199143";
 ...
 */
@Slf4j
public class Idea199143Service {
    private static final int IDEA_ID = 199143;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199143Service() {
        this(new Idea199143Config());
    }

    public Idea199143Service(Idea199143Config config) {
        this.config = config != null ? config : new Idea199143Config();
