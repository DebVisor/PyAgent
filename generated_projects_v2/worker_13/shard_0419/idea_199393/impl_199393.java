...
@Data
public class Idea199393Config {
    private String name = "idea_199393";
 ...
 */
@Slf4j
public class Idea199393Service {
    private static final int IDEA_ID = 199393;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199393Service() {
        this(new Idea199393Config());
    }

    public Idea199393Service(Idea199393Config config) {
        this.config = config != null ? config : new Idea199393Config();
