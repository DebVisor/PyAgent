...
@Data
public class Idea199397Config {
    private String name = "idea_199397";
 ...
 */
@Slf4j
public class Idea199397Service {
    private static final int IDEA_ID = 199397;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199397Service() {
        this(new Idea199397Config());
    }

    public Idea199397Service(Idea199397Config config) {
        this.config = config != null ? config : new Idea199397Config();
