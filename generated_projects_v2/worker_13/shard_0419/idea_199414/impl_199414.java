...
@Data
public class Idea199414Config {
    private String name = "idea_199414";
 ...
 */
@Slf4j
public class Idea199414Service {
    private static final int IDEA_ID = 199414;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199414Service() {
        this(new Idea199414Config());
    }

    public Idea199414Service(Idea199414Config config) {
        this.config = config != null ? config : new Idea199414Config();
