...
@Data
public class Idea199207Config {
    private String name = "idea_199207";
 ...
 */
@Slf4j
public class Idea199207Service {
    private static final int IDEA_ID = 199207;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199207Service() {
        this(new Idea199207Config());
    }

    public Idea199207Service(Idea199207Config config) {
        this.config = config != null ? config : new Idea199207Config();
