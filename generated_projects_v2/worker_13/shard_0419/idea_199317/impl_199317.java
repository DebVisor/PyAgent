...
@Data
public class Idea199317Config {
    private String name = "idea_199317";
 ...
 */
@Slf4j
public class Idea199317Service {
    private static final int IDEA_ID = 199317;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199317Service() {
        this(new Idea199317Config());
    }

    public Idea199317Service(Idea199317Config config) {
        this.config = config != null ? config : new Idea199317Config();
