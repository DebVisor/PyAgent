...
@Data
public class Idea199287Config {
    private String name = "idea_199287";
 ...
 */
@Slf4j
public class Idea199287Service {
    private static final int IDEA_ID = 199287;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199287Service() {
        this(new Idea199287Config());
    }

    public Idea199287Service(Idea199287Config config) {
        this.config = config != null ? config : new Idea199287Config();
