...
@Data
public class Idea199415Config {
    private String name = "idea_199415";
 ...
 */
@Slf4j
public class Idea199415Service {
    private static final int IDEA_ID = 199415;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199415Service() {
        this(new Idea199415Config());
    }

    public Idea199415Service(Idea199415Config config) {
        this.config = config != null ? config : new Idea199415Config();
