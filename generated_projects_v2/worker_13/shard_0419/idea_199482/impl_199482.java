...
@Data
public class Idea199482Config {
    private String name = "idea_199482";
 ...
 */
@Slf4j
public class Idea199482Service {
    private static final int IDEA_ID = 199482;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199482Service() {
        this(new Idea199482Config());
    }

    public Idea199482Service(Idea199482Config config) {
        this.config = config != null ? config : new Idea199482Config();
