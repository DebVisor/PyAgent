...
@Data
public class Idea199029Config {
    private String name = "idea_199029";
 ...
 */
@Slf4j
public class Idea199029Service {
    private static final int IDEA_ID = 199029;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199029Service() {
        this(new Idea199029Config());
    }

    public Idea199029Service(Idea199029Config config) {
        this.config = config != null ? config : new Idea199029Config();
