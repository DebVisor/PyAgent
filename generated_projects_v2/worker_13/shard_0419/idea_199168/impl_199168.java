...
@Data
public class Idea199168Config {
    private String name = "idea_199168";
 ...
 */
@Slf4j
public class Idea199168Service {
    private static final int IDEA_ID = 199168;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199168Service() {
        this(new Idea199168Config());
    }

    public Idea199168Service(Idea199168Config config) {
        this.config = config != null ? config : new Idea199168Config();
