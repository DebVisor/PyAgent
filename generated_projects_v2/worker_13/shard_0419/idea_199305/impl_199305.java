...
@Data
public class Idea199305Config {
    private String name = "idea_199305";
 ...
 */
@Slf4j
public class Idea199305Service {
    private static final int IDEA_ID = 199305;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199305Service() {
        this(new Idea199305Config());
    }

    public Idea199305Service(Idea199305Config config) {
        this.config = config != null ? config : new Idea199305Config();
