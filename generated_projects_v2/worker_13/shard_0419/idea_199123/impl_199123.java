...
@Data
public class Idea199123Config {
    private String name = "idea_199123";
 ...
 */
@Slf4j
public class Idea199123Service {
    private static final int IDEA_ID = 199123;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199123Service() {
        this(new Idea199123Config());
    }

    public Idea199123Service(Idea199123Config config) {
        this.config = config != null ? config : new Idea199123Config();
