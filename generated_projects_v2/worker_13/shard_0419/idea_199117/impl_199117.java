...
@Data
public class Idea199117Config {
    private String name = "idea_199117";
 ...
 */
@Slf4j
public class Idea199117Service {
    private static final int IDEA_ID = 199117;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199117Service() {
        this(new Idea199117Config());
    }

    public Idea199117Service(Idea199117Config config) {
        this.config = config != null ? config : new Idea199117Config();
