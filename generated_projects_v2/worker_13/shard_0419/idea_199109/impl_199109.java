...
@Data
public class Idea199109Config {
    private String name = "idea_199109";
 ...
 */
@Slf4j
public class Idea199109Service {
    private static final int IDEA_ID = 199109;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199109Service() {
        this(new Idea199109Config());
    }

    public Idea199109Service(Idea199109Config config) {
        this.config = config != null ? config : new Idea199109Config();
