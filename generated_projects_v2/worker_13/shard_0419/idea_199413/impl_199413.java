...
@Data
public class Idea199413Config {
    private String name = "idea_199413";
 ...
 */
@Slf4j
public class Idea199413Service {
    private static final int IDEA_ID = 199413;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199413Service() {
        this(new Idea199413Config());
    }

    public Idea199413Service(Idea199413Config config) {
        this.config = config != null ? config : new Idea199413Config();
