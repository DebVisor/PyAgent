...
@Data
public class Idea199325Config {
    private String name = "idea_199325";
 ...
 */
@Slf4j
public class Idea199325Service {
    private static final int IDEA_ID = 199325;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199325Service() {
        this(new Idea199325Config());
    }

    public Idea199325Service(Idea199325Config config) {
        this.config = config != null ? config : new Idea199325Config();
