...
@Data
public class Idea199090Config {
    private String name = "idea_199090";
 ...
 */
@Slf4j
public class Idea199090Service {
    private static final int IDEA_ID = 199090;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199090Service() {
        this(new Idea199090Config());
    }

    public Idea199090Service(Idea199090Config config) {
        this.config = config != null ? config : new Idea199090Config();
