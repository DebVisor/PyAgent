...
@Data
public class Idea199077Config {
    private String name = "idea_199077";
 ...
 */
@Slf4j
public class Idea199077Service {
    private static final int IDEA_ID = 199077;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199077Service() {
        this(new Idea199077Config());
    }

    public Idea199077Service(Idea199077Config config) {
        this.config = config != null ? config : new Idea199077Config();
