...
@Data
public class Idea199081Config {
    private String name = "idea_199081";
 ...
 */
@Slf4j
public class Idea199081Service {
    private static final int IDEA_ID = 199081;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199081Service() {
        this(new Idea199081Config());
    }

    public Idea199081Service(Idea199081Config config) {
        this.config = config != null ? config : new Idea199081Config();
