...
@Data
public class Idea199166Config {
    private String name = "idea_199166";
 ...
 */
@Slf4j
public class Idea199166Service {
    private static final int IDEA_ID = 199166;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199166Service() {
        this(new Idea199166Config());
    }

    public Idea199166Service(Idea199166Config config) {
        this.config = config != null ? config : new Idea199166Config();
