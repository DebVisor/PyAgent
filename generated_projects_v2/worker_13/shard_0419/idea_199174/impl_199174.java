...
@Data
public class Idea199174Config {
    private String name = "idea_199174";
 ...
 */
@Slf4j
public class Idea199174Service {
    private static final int IDEA_ID = 199174;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199174Service() {
        this(new Idea199174Config());
    }

    public Idea199174Service(Idea199174Config config) {
        this.config = config != null ? config : new Idea199174Config();
