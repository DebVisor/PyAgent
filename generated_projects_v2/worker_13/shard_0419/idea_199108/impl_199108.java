...
@Data
public class Idea199108Config {
    private String name = "idea_199108";
 ...
 */
@Slf4j
public class Idea199108Service {
    private static final int IDEA_ID = 199108;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199108Service() {
        this(new Idea199108Config());
    }

    public Idea199108Service(Idea199108Config config) {
        this.config = config != null ? config : new Idea199108Config();
