...
@Data
public class Idea199083Config {
    private String name = "idea_199083";
 ...
 */
@Slf4j
public class Idea199083Service {
    private static final int IDEA_ID = 199083;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199083Service() {
        this(new Idea199083Config());
    }

    public Idea199083Service(Idea199083Config config) {
        this.config = config != null ? config : new Idea199083Config();
