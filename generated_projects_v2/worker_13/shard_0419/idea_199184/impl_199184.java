...
@Data
public class Idea199184Config {
    private String name = "idea_199184";
 ...
 */
@Slf4j
public class Idea199184Service {
    private static final int IDEA_ID = 199184;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199184Service() {
        this(new Idea199184Config());
    }

    public Idea199184Service(Idea199184Config config) {
        this.config = config != null ? config : new Idea199184Config();
