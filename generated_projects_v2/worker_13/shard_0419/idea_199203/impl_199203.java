...
@Data
public class Idea199203Config {
    private String name = "idea_199203";
 ...
 */
@Slf4j
public class Idea199203Service {
    private static final int IDEA_ID = 199203;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199203Service() {
        this(new Idea199203Config());
    }

    public Idea199203Service(Idea199203Config config) {
        this.config = config != null ? config : new Idea199203Config();
