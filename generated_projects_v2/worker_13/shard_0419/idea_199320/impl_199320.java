...
@Data
public class Idea199320Config {
    private String name = "idea_199320";
 ...
 */
@Slf4j
public class Idea199320Service {
    private static final int IDEA_ID = 199320;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199320Service() {
        this(new Idea199320Config());
    }

    public Idea199320Service(Idea199320Config config) {
        this.config = config != null ? config : new Idea199320Config();
