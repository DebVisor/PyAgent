...
@Data
public class Idea199121Config {
    private String name = "idea_199121";
 ...
 */
@Slf4j
public class Idea199121Service {
    private static final int IDEA_ID = 199121;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199121Service() {
        this(new Idea199121Config());
    }

    public Idea199121Service(Idea199121Config config) {
        this.config = config != null ? config : new Idea199121Config();
