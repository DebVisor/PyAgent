...
@Data
public class Idea199206Config {
    private String name = "idea_199206";
 ...
 */
@Slf4j
public class Idea199206Service {
    private static final int IDEA_ID = 199206;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199206Service() {
        this(new Idea199206Config());
    }

    public Idea199206Service(Idea199206Config config) {
        this.config = config != null ? config : new Idea199206Config();
