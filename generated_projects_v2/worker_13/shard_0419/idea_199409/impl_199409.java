...
@Data
public class Idea199409Config {
    private String name = "idea_199409";
 ...
 */
@Slf4j
public class Idea199409Service {
    private static final int IDEA_ID = 199409;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199409Service() {
        this(new Idea199409Config());
    }

    public Idea199409Service(Idea199409Config config) {
        this.config = config != null ? config : new Idea199409Config();
