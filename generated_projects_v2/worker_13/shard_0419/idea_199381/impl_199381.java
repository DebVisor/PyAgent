...
@Data
public class Idea199381Config {
    private String name = "idea_199381";
 ...
 */
@Slf4j
public class Idea199381Service {
    private static final int IDEA_ID = 199381;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199381Service() {
        this(new Idea199381Config());
    }

    public Idea199381Service(Idea199381Config config) {
        this.config = config != null ? config : new Idea199381Config();
