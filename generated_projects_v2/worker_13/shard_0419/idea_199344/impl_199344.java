...
@Data
public class Idea199344Config {
    private String name = "idea_199344";
 ...
 */
@Slf4j
public class Idea199344Service {
    private static final int IDEA_ID = 199344;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199344Service() {
        this(new Idea199344Config());
    }

    public Idea199344Service(Idea199344Config config) {
        this.config = config != null ? config : new Idea199344Config();
