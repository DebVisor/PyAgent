...
@Data
public class Idea199113Config {
    private String name = "idea_199113";
 ...
 */
@Slf4j
public class Idea199113Service {
    private static final int IDEA_ID = 199113;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199113Service() {
        this(new Idea199113Config());
    }

    public Idea199113Service(Idea199113Config config) {
        this.config = config != null ? config : new Idea199113Config();
