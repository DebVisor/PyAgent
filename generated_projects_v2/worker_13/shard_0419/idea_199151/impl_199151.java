...
@Data
public class Idea199151Config {
    private String name = "idea_199151";
 ...
 */
@Slf4j
public class Idea199151Service {
    private static final int IDEA_ID = 199151;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199151Service() {
        this(new Idea199151Config());
    }

    public Idea199151Service(Idea199151Config config) {
        this.config = config != null ? config : new Idea199151Config();
