...
@Data
public class Idea199246Config {
    private String name = "idea_199246";
 ...
 */
@Slf4j
public class Idea199246Service {
    private static final int IDEA_ID = 199246;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199246Service() {
        this(new Idea199246Config());
    }

    public Idea199246Service(Idea199246Config config) {
        this.config = config != null ? config : new Idea199246Config();
