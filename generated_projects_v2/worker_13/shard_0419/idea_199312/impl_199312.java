...
@Data
public class Idea199312Config {
    private String name = "idea_199312";
 ...
 */
@Slf4j
public class Idea199312Service {
    private static final int IDEA_ID = 199312;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199312Service() {
        this(new Idea199312Config());
    }

    public Idea199312Service(Idea199312Config config) {
        this.config = config != null ? config : new Idea199312Config();
