...
@Data
public class Idea199478Config {
    private String name = "idea_199478";
 ...
 */
@Slf4j
public class Idea199478Service {
    private static final int IDEA_ID = 199478;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199478Service() {
        this(new Idea199478Config());
    }

    public Idea199478Service(Idea199478Config config) {
        this.config = config != null ? config : new Idea199478Config();
