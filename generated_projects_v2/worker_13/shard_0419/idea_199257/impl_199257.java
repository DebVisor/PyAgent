...
@Data
public class Idea199257Config {
    private String name = "idea_199257";
 ...
 */
@Slf4j
public class Idea199257Service {
    private static final int IDEA_ID = 199257;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199257Service() {
        this(new Idea199257Config());
    }

    public Idea199257Service(Idea199257Config config) {
        this.config = config != null ? config : new Idea199257Config();
