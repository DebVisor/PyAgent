...
@Data
public class Idea199404Config {
    private String name = "idea_199404";
 ...
 */
@Slf4j
public class Idea199404Service {
    private static final int IDEA_ID = 199404;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199404Service() {
        this(new Idea199404Config());
    }

    public Idea199404Service(Idea199404Config config) {
        this.config = config != null ? config : new Idea199404Config();
