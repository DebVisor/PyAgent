...
@Data
public class Idea199064Config {
    private String name = "idea_199064";
 ...
 */
@Slf4j
public class Idea199064Service {
    private static final int IDEA_ID = 199064;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199064Service() {
        this(new Idea199064Config());
    }

    public Idea199064Service(Idea199064Config config) {
        this.config = config != null ? config : new Idea199064Config();
