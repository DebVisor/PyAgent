...
@Data
public class Idea199334Config {
    private String name = "idea_199334";
 ...
 */
@Slf4j
public class Idea199334Service {
    private static final int IDEA_ID = 199334;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199334Service() {
        this(new Idea199334Config());
    }

    public Idea199334Service(Idea199334Config config) {
        this.config = config != null ? config : new Idea199334Config();
