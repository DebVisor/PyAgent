...
@Data
public class Idea199484Config {
    private String name = "idea_199484";
 ...
 */
@Slf4j
public class Idea199484Service {
    private static final int IDEA_ID = 199484;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199484Service() {
        this(new Idea199484Config());
    }

    public Idea199484Service(Idea199484Config config) {
        this.config = config != null ? config : new Idea199484Config();
