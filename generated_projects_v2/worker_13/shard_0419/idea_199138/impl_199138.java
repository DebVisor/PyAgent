...
@Data
public class Idea199138Config {
    private String name = "idea_199138";
 ...
 */
@Slf4j
public class Idea199138Service {
    private static final int IDEA_ID = 199138;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199138Service() {
        this(new Idea199138Config());
    }

    public Idea199138Service(Idea199138Config config) {
        this.config = config != null ? config : new Idea199138Config();
