...
@Data
public class Idea199213Config {
    private String name = "idea_199213";
 ...
 */
@Slf4j
public class Idea199213Service {
    private static final int IDEA_ID = 199213;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199213Service() {
        this(new Idea199213Config());
    }

    public Idea199213Service(Idea199213Config config) {
        this.config = config != null ? config : new Idea199213Config();
