...
@Data
public class Idea199221Config {
    private String name = "idea_199221";
 ...
 */
@Slf4j
public class Idea199221Service {
    private static final int IDEA_ID = 199221;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199221Service() {
        this(new Idea199221Config());
    }

    public Idea199221Service(Idea199221Config config) {
        this.config = config != null ? config : new Idea199221Config();
