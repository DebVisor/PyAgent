...
@Data
public class Idea199493Config {
    private String name = "idea_199493";
 ...
 */
@Slf4j
public class Idea199493Service {
    private static final int IDEA_ID = 199493;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199493Service() {
        this(new Idea199493Config());
    }

    public Idea199493Service(Idea199493Config config) {
        this.config = config != null ? config : new Idea199493Config();
