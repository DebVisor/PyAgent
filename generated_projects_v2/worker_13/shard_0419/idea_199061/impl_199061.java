...
@Data
public class Idea199061Config {
    private String name = "idea_199061";
 ...
 */
@Slf4j
public class Idea199061Service {
    private static final int IDEA_ID = 199061;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199061Service() {
        this(new Idea199061Config());
    }

    public Idea199061Service(Idea199061Config config) {
        this.config = config != null ? config : new Idea199061Config();
