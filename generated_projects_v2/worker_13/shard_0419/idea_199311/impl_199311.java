...
@Data
public class Idea199311Config {
    private String name = "idea_199311";
 ...
 */
@Slf4j
public class Idea199311Service {
    private static final int IDEA_ID = 199311;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199311Service() {
        this(new Idea199311Config());
    }

    public Idea199311Service(Idea199311Config config) {
        this.config = config != null ? config : new Idea199311Config();
