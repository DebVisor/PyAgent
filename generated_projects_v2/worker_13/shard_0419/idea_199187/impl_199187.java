...
@Data
public class Idea199187Config {
    private String name = "idea_199187";
 ...
 */
@Slf4j
public class Idea199187Service {
    private static final int IDEA_ID = 199187;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199187Service() {
        this(new Idea199187Config());
    }

    public Idea199187Service(Idea199187Config config) {
        this.config = config != null ? config : new Idea199187Config();
