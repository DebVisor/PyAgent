...
@Data
public class Idea199215Config {
    private String name = "idea_199215";
 ...
 */
@Slf4j
public class Idea199215Service {
    private static final int IDEA_ID = 199215;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199215Service() {
        this(new Idea199215Config());
    }

    public Idea199215Service(Idea199215Config config) {
        this.config = config != null ? config : new Idea199215Config();
