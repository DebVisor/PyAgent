...
@Data
public class Idea199296Config {
    private String name = "idea_199296";
 ...
 */
@Slf4j
public class Idea199296Service {
    private static final int IDEA_ID = 199296;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199296Service() {
        this(new Idea199296Config());
    }

    public Idea199296Service(Idea199296Config config) {
        this.config = config != null ? config : new Idea199296Config();
