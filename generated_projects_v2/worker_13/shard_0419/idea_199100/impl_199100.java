...
@Data
public class Idea199100Config {
    private String name = "idea_199100";
 ...
 */
@Slf4j
public class Idea199100Service {
    private static final int IDEA_ID = 199100;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199100Service() {
        this(new Idea199100Config());
    }

    public Idea199100Service(Idea199100Config config) {
        this.config = config != null ? config : new Idea199100Config();
