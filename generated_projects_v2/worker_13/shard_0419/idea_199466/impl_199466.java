...
@Data
public class Idea199466Config {
    private String name = "idea_199466";
 ...
 */
@Slf4j
public class Idea199466Service {
    private static final int IDEA_ID = 199466;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199466Service() {
        this(new Idea199466Config());
    }

    public Idea199466Service(Idea199466Config config) {
        this.config = config != null ? config : new Idea199466Config();
