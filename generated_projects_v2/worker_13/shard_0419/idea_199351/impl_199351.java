...
@Data
public class Idea199351Config {
    private String name = "idea_199351";
 ...
 */
@Slf4j
public class Idea199351Service {
    private static final int IDEA_ID = 199351;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199351Service() {
        this(new Idea199351Config());
    }

    public Idea199351Service(Idea199351Config config) {
        this.config = config != null ? config : new Idea199351Config();
