...
@Data
public class Idea199218Config {
    private String name = "idea_199218";
 ...
 */
@Slf4j
public class Idea199218Service {
    private static final int IDEA_ID = 199218;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199218Service() {
        this(new Idea199218Config());
    }

    public Idea199218Service(Idea199218Config config) {
        this.config = config != null ? config : new Idea199218Config();
