...
@Data
public class Idea199035Config {
    private String name = "idea_199035";
 ...
 */
@Slf4j
public class Idea199035Service {
    private static final int IDEA_ID = 199035;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199035Service() {
        this(new Idea199035Config());
    }

    public Idea199035Service(Idea199035Config config) {
        this.config = config != null ? config : new Idea199035Config();
