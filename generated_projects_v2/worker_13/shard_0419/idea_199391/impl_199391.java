...
@Data
public class Idea199391Config {
    private String name = "idea_199391";
 ...
 */
@Slf4j
public class Idea199391Service {
    private static final int IDEA_ID = 199391;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199391Service() {
        this(new Idea199391Config());
    }

    public Idea199391Service(Idea199391Config config) {
        this.config = config != null ? config : new Idea199391Config();
