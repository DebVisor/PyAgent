...
@Data
public class Idea199398Config {
    private String name = "idea_199398";
 ...
 */
@Slf4j
public class Idea199398Service {
    private static final int IDEA_ID = 199398;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199398Service() {
        this(new Idea199398Config());
    }

    public Idea199398Service(Idea199398Config config) {
        this.config = config != null ? config : new Idea199398Config();
