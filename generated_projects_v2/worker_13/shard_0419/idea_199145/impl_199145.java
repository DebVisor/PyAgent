...
@Data
public class Idea199145Config {
    private String name = "idea_199145";
 ...
 */
@Slf4j
public class Idea199145Service {
    private static final int IDEA_ID = 199145;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199145Service() {
        this(new Idea199145Config());
    }

    public Idea199145Service(Idea199145Config config) {
        this.config = config != null ? config : new Idea199145Config();
