...
@Data
public class Idea199250Config {
    private String name = "idea_199250";
 ...
 */
@Slf4j
public class Idea199250Service {
    private static final int IDEA_ID = 199250;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199250Service() {
        this(new Idea199250Config());
    }

    public Idea199250Service(Idea199250Config config) {
        this.config = config != null ? config : new Idea199250Config();
