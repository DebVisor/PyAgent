...
@Data
public class Idea199078Config {
    private String name = "idea_199078";
 ...
 */
@Slf4j
public class Idea199078Service {
    private static final int IDEA_ID = 199078;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199078Service() {
        this(new Idea199078Config());
    }

    public Idea199078Service(Idea199078Config config) {
        this.config = config != null ? config : new Idea199078Config();
