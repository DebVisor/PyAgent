...
@Data
public class Idea199189Config {
    private String name = "idea_199189";
 ...
 */
@Slf4j
public class Idea199189Service {
    private static final int IDEA_ID = 199189;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199189Service() {
        this(new Idea199189Config());
    }

    public Idea199189Service(Idea199189Config config) {
        this.config = config != null ? config : new Idea199189Config();
