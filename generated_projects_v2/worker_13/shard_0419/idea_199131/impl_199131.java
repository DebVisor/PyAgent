...
@Data
public class Idea199131Config {
    private String name = "idea_199131";
 ...
 */
@Slf4j
public class Idea199131Service {
    private static final int IDEA_ID = 199131;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199131Service() {
        this(new Idea199131Config());
    }

    public Idea199131Service(Idea199131Config config) {
        this.config = config != null ? config : new Idea199131Config();
