...
@Data
public class Idea199181Config {
    private String name = "idea_199181";
 ...
 */
@Slf4j
public class Idea199181Service {
    private static final int IDEA_ID = 199181;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199181Service() {
        this(new Idea199181Config());
    }

    public Idea199181Service(Idea199181Config config) {
        this.config = config != null ? config : new Idea199181Config();
