...
@Data
public class Idea199345Config {
    private String name = "idea_199345";
 ...
 */
@Slf4j
public class Idea199345Service {
    private static final int IDEA_ID = 199345;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199345Service() {
        this(new Idea199345Config());
    }

    public Idea199345Service(Idea199345Config config) {
        this.config = config != null ? config : new Idea199345Config();
