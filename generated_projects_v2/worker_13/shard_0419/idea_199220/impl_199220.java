...
@Data
public class Idea199220Config {
    private String name = "idea_199220";
 ...
 */
@Slf4j
public class Idea199220Service {
    private static final int IDEA_ID = 199220;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199220Service() {
        this(new Idea199220Config());
    }

    public Idea199220Service(Idea199220Config config) {
        this.config = config != null ? config : new Idea199220Config();
