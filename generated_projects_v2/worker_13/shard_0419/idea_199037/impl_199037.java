...
@Data
public class Idea199037Config {
    private String name = "idea_199037";
 ...
 */
@Slf4j
public class Idea199037Service {
    private static final int IDEA_ID = 199037;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199037Service() {
        this(new Idea199037Config());
    }

    public Idea199037Service(Idea199037Config config) {
        this.config = config != null ? config : new Idea199037Config();
