...
@Data
public class Idea199212Config {
    private String name = "idea_199212";
 ...
 */
@Slf4j
public class Idea199212Service {
    private static final int IDEA_ID = 199212;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199212Service() {
        this(new Idea199212Config());
    }

    public Idea199212Service(Idea199212Config config) {
        this.config = config != null ? config : new Idea199212Config();
