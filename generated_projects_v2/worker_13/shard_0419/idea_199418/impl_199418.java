...
@Data
public class Idea199418Config {
    private String name = "idea_199418";
 ...
 */
@Slf4j
public class Idea199418Service {
    private static final int IDEA_ID = 199418;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199418Service() {
        this(new Idea199418Config());
    }

    public Idea199418Service(Idea199418Config config) {
        this.config = config != null ? config : new Idea199418Config();
