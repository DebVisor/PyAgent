...
@Data
public class Idea199076Config {
    private String name = "idea_199076";
 ...
 */
@Slf4j
public class Idea199076Service {
    private static final int IDEA_ID = 199076;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199076Service() {
        this(new Idea199076Config());
    }

    public Idea199076Service(Idea199076Config config) {
        this.config = config != null ? config : new Idea199076Config();
