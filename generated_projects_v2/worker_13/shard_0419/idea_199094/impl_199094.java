...
@Data
public class Idea199094Config {
    private String name = "idea_199094";
 ...
 */
@Slf4j
public class Idea199094Service {
    private static final int IDEA_ID = 199094;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199094Service() {
        this(new Idea199094Config());
    }

    public Idea199094Service(Idea199094Config config) {
        this.config = config != null ? config : new Idea199094Config();
