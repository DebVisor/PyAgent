...
@Data
public class Idea199175Config {
    private String name = "idea_199175";
 ...
 */
@Slf4j
public class Idea199175Service {
    private static final int IDEA_ID = 199175;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199175Service() {
        this(new Idea199175Config());
    }

    public Idea199175Service(Idea199175Config config) {
        this.config = config != null ? config : new Idea199175Config();
