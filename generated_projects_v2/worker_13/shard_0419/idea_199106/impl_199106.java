...
@Data
public class Idea199106Config {
    private String name = "idea_199106";
 ...
 */
@Slf4j
public class Idea199106Service {
    private static final int IDEA_ID = 199106;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199106Service() {
        this(new Idea199106Config());
    }

    public Idea199106Service(Idea199106Config config) {
        this.config = config != null ? config : new Idea199106Config();
