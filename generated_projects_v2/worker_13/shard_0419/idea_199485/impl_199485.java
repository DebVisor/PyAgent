...
@Data
public class Idea199485Config {
    private String name = "idea_199485";
 ...
 */
@Slf4j
public class Idea199485Service {
    private static final int IDEA_ID = 199485;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199485Service() {
        this(new Idea199485Config());
    }

    public Idea199485Service(Idea199485Config config) {
        this.config = config != null ? config : new Idea199485Config();
