...
@Data
public class Idea199265Config {
    private String name = "idea_199265";
 ...
 */
@Slf4j
public class Idea199265Service {
    private static final int IDEA_ID = 199265;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199265Service() {
        this(new Idea199265Config());
    }

    public Idea199265Service(Idea199265Config config) {
        this.config = config != null ? config : new Idea199265Config();
