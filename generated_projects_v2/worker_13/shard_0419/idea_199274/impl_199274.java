...
@Data
public class Idea199274Config {
    private String name = "idea_199274";
 ...
 */
@Slf4j
public class Idea199274Service {
    private static final int IDEA_ID = 199274;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199274Service() {
        this(new Idea199274Config());
    }

    public Idea199274Service(Idea199274Config config) {
        this.config = config != null ? config : new Idea199274Config();
