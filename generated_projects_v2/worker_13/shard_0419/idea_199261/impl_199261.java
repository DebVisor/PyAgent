...
@Data
public class Idea199261Config {
    private String name = "idea_199261";
 ...
 */
@Slf4j
public class Idea199261Service {
    private static final int IDEA_ID = 199261;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199261Service() {
        this(new Idea199261Config());
    }

    public Idea199261Service(Idea199261Config config) {
        this.config = config != null ? config : new Idea199261Config();
