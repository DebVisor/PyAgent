...
@Data
public class Idea199331Config {
    private String name = "idea_199331";
 ...
 */
@Slf4j
public class Idea199331Service {
    private static final int IDEA_ID = 199331;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199331Service() {
        this(new Idea199331Config());
    }

    public Idea199331Service(Idea199331Config config) {
        this.config = config != null ? config : new Idea199331Config();
