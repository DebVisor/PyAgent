...
@Data
public class Idea199164Config {
    private String name = "idea_199164";
 ...
 */
@Slf4j
public class Idea199164Service {
    private static final int IDEA_ID = 199164;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199164Service() {
        this(new Idea199164Config());
    }

    public Idea199164Service(Idea199164Config config) {
        this.config = config != null ? config : new Idea199164Config();
