...
@Data
public class Idea199410Config {
    private String name = "idea_199410";
 ...
 */
@Slf4j
public class Idea199410Service {
    private static final int IDEA_ID = 199410;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199410Service() {
        this(new Idea199410Config());
    }

    public Idea199410Service(Idea199410Config config) {
        this.config = config != null ? config : new Idea199410Config();
