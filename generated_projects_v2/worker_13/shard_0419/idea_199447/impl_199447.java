...
@Data
public class Idea199447Config {
    private String name = "idea_199447";
 ...
 */
@Slf4j
public class Idea199447Service {
    private static final int IDEA_ID = 199447;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199447Service() {
        this(new Idea199447Config());
    }

    public Idea199447Service(Idea199447Config config) {
        this.config = config != null ? config : new Idea199447Config();
