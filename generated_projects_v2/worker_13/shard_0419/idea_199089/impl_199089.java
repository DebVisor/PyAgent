...
@Data
public class Idea199089Config {
    private String name = "idea_199089";
 ...
 */
@Slf4j
public class Idea199089Service {
    private static final int IDEA_ID = 199089;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199089Service() {
        this(new Idea199089Config());
    }

    public Idea199089Service(Idea199089Config config) {
        this.config = config != null ? config : new Idea199089Config();
