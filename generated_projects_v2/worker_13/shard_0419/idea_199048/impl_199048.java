...
@Data
public class Idea199048Config {
    private String name = "idea_199048";
 ...
 */
@Slf4j
public class Idea199048Service {
    private static final int IDEA_ID = 199048;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199048Service() {
        this(new Idea199048Config());
    }

    public Idea199048Service(Idea199048Config config) {
        this.config = config != null ? config : new Idea199048Config();
