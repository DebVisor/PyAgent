...
@Data
public class Idea199497Config {
    private String name = "idea_199497";
 ...
 */
@Slf4j
public class Idea199497Service {
    private static final int IDEA_ID = 199497;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199497Service() {
        this(new Idea199497Config());
    }

    public Idea199497Service(Idea199497Config config) {
        this.config = config != null ? config : new Idea199497Config();
