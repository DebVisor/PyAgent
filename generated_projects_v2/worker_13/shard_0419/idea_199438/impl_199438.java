...
@Data
public class Idea199438Config {
    private String name = "idea_199438";
 ...
 */
@Slf4j
public class Idea199438Service {
    private static final int IDEA_ID = 199438;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199438Service() {
        this(new Idea199438Config());
    }

    public Idea199438Service(Idea199438Config config) {
        this.config = config != null ? config : new Idea199438Config();
