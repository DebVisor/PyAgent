...
@Data
public class Idea199153Config {
    private String name = "idea_199153";
 ...
 */
@Slf4j
public class Idea199153Service {
    private static final int IDEA_ID = 199153;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199153Service() {
        this(new Idea199153Config());
    }

    public Idea199153Service(Idea199153Config config) {
        this.config = config != null ? config : new Idea199153Config();
