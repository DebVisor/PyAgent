...
@Data
public class Idea199307Config {
    private String name = "idea_199307";
 ...
 */
@Slf4j
public class Idea199307Service {
    private static final int IDEA_ID = 199307;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199307Service() {
        this(new Idea199307Config());
    }

    public Idea199307Service(Idea199307Config config) {
        this.config = config != null ? config : new Idea199307Config();
