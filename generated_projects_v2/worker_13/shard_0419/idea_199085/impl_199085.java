...
@Data
public class Idea199085Config {
    private String name = "idea_199085";
 ...
 */
@Slf4j
public class Idea199085Service {
    private static final int IDEA_ID = 199085;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199085Service() {
        this(new Idea199085Config());
    }

    public Idea199085Service(Idea199085Config config) {
        this.config = config != null ? config : new Idea199085Config();
