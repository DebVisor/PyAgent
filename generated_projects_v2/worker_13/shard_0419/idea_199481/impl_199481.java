...
@Data
public class Idea199481Config {
    private String name = "idea_199481";
 ...
 */
@Slf4j
public class Idea199481Service {
    private static final int IDEA_ID = 199481;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199481Service() {
        this(new Idea199481Config());
    }

    public Idea199481Service(Idea199481Config config) {
        this.config = config != null ? config : new Idea199481Config();
