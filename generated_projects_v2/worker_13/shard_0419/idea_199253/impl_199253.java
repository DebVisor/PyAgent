...
@Data
public class Idea199253Config {
    private String name = "idea_199253";
 ...
 */
@Slf4j
public class Idea199253Service {
    private static final int IDEA_ID = 199253;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199253Service() {
        this(new Idea199253Config());
    }

    public Idea199253Service(Idea199253Config config) {
        this.config = config != null ? config : new Idea199253Config();
