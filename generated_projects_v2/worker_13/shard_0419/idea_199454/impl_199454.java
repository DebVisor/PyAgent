...
@Data
public class Idea199454Config {
    private String name = "idea_199454";
 ...
 */
@Slf4j
public class Idea199454Service {
    private static final int IDEA_ID = 199454;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199454Service() {
        this(new Idea199454Config());
    }

    public Idea199454Service(Idea199454Config config) {
        this.config = config != null ? config : new Idea199454Config();
