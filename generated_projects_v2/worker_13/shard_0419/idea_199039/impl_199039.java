...
@Data
public class Idea199039Config {
    private String name = "idea_199039";
 ...
 */
@Slf4j
public class Idea199039Service {
    private static final int IDEA_ID = 199039;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199039Service() {
        this(new Idea199039Config());
    }

    public Idea199039Service(Idea199039Config config) {
        this.config = config != null ? config : new Idea199039Config();
