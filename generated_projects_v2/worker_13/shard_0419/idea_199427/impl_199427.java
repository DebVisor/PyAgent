...
@Data
public class Idea199427Config {
    private String name = "idea_199427";
 ...
 */
@Slf4j
public class Idea199427Service {
    private static final int IDEA_ID = 199427;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199427Service() {
        this(new Idea199427Config());
    }

    public Idea199427Service(Idea199427Config config) {
        this.config = config != null ? config : new Idea199427Config();
