...
@Data
public class Idea199205Config {
    private String name = "idea_199205";
 ...
 */
@Slf4j
public class Idea199205Service {
    private static final int IDEA_ID = 199205;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199205Service() {
        this(new Idea199205Config());
    }

    public Idea199205Service(Idea199205Config config) {
        this.config = config != null ? config : new Idea199205Config();
