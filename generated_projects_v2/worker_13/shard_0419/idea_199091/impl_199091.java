...
@Data
public class Idea199091Config {
    private String name = "idea_199091";
 ...
 */
@Slf4j
public class Idea199091Service {
    private static final int IDEA_ID = 199091;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199091Service() {
        this(new Idea199091Config());
    }

    public Idea199091Service(Idea199091Config config) {
        this.config = config != null ? config : new Idea199091Config();
