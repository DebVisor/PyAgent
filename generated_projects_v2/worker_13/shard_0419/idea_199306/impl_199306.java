...
@Data
public class Idea199306Config {
    private String name = "idea_199306";
 ...
 */
@Slf4j
public class Idea199306Service {
    private static final int IDEA_ID = 199306;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199306Service() {
        this(new Idea199306Config());
    }

    public Idea199306Service(Idea199306Config config) {
        this.config = config != null ? config : new Idea199306Config();
