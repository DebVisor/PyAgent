...
@Data
public class Idea199033Config {
    private String name = "idea_199033";
 ...
 */
@Slf4j
public class Idea199033Service {
    private static final int IDEA_ID = 199033;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199033Service() {
        this(new Idea199033Config());
    }

    public Idea199033Service(Idea199033Config config) {
        this.config = config != null ? config : new Idea199033Config();
