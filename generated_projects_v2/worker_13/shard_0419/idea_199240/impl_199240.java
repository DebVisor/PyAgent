...
@Data
public class Idea199240Config {
    private String name = "idea_199240";
 ...
 */
@Slf4j
public class Idea199240Service {
    private static final int IDEA_ID = 199240;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199240Service() {
        this(new Idea199240Config());
    }

    public Idea199240Service(Idea199240Config config) {
        this.config = config != null ? config : new Idea199240Config();
