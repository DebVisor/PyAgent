...
@Data
public class Idea199051Config {
    private String name = "idea_199051";
 ...
 */
@Slf4j
public class Idea199051Service {
    private static final int IDEA_ID = 199051;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199051Service() {
        this(new Idea199051Config());
    }

    public Idea199051Service(Idea199051Config config) {
        this.config = config != null ? config : new Idea199051Config();
