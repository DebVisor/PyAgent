...
@Data
public class Idea199421Config {
    private String name = "idea_199421";
 ...
 */
@Slf4j
public class Idea199421Service {
    private static final int IDEA_ID = 199421;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199421Service() {
        this(new Idea199421Config());
    }

    public Idea199421Service(Idea199421Config config) {
        this.config = config != null ? config : new Idea199421Config();
