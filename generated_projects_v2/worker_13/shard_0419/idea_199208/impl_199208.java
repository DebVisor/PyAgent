...
@Data
public class Idea199208Config {
    private String name = "idea_199208";
 ...
 */
@Slf4j
public class Idea199208Service {
    private static final int IDEA_ID = 199208;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199208Service() {
        this(new Idea199208Config());
    }

    public Idea199208Service(Idea199208Config config) {
        this.config = config != null ? config : new Idea199208Config();
