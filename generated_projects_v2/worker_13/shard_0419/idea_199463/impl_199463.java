...
@Data
public class Idea199463Config {
    private String name = "idea_199463";
 ...
 */
@Slf4j
public class Idea199463Service {
    private static final int IDEA_ID = 199463;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199463Service() {
        this(new Idea199463Config());
    }

    public Idea199463Service(Idea199463Config config) {
        this.config = config != null ? config : new Idea199463Config();
