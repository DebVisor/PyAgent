...
@Data
public class Idea199377Config {
    private String name = "idea_199377";
 ...
 */
@Slf4j
public class Idea199377Service {
    private static final int IDEA_ID = 199377;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199377Service() {
        this(new Idea199377Config());
    }

    public Idea199377Service(Idea199377Config config) {
        this.config = config != null ? config : new Idea199377Config();
