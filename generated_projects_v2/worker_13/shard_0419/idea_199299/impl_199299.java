...
@Data
public class Idea199299Config {
    private String name = "idea_199299";
 ...
 */
@Slf4j
public class Idea199299Service {
    private static final int IDEA_ID = 199299;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199299Service() {
        this(new Idea199299Config());
    }

    public Idea199299Service(Idea199299Config config) {
        this.config = config != null ? config : new Idea199299Config();
