...
@Data
public class Idea199366Config {
    private String name = "idea_199366";
 ...
 */
@Slf4j
public class Idea199366Service {
    private static final int IDEA_ID = 199366;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199366Service() {
        this(new Idea199366Config());
    }

    public Idea199366Service(Idea199366Config config) {
        this.config = config != null ? config : new Idea199366Config();
