...
@Data
public class Idea199202Config {
    private String name = "idea_199202";
 ...
 */
@Slf4j
public class Idea199202Service {
    private static final int IDEA_ID = 199202;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199202Service() {
        this(new Idea199202Config());
    }

    public Idea199202Service(Idea199202Config config) {
        this.config = config != null ? config : new Idea199202Config();
