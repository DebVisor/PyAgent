...
@Data
public class Idea199247Config {
    private String name = "idea_199247";
 ...
 */
@Slf4j
public class Idea199247Service {
    private static final int IDEA_ID = 199247;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199247Service() {
        this(new Idea199247Config());
    }

    public Idea199247Service(Idea199247Config config) {
        this.config = config != null ? config : new Idea199247Config();
