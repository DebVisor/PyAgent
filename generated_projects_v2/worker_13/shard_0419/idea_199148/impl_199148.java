...
@Data
public class Idea199148Config {
    private String name = "idea_199148";
 ...
 */
@Slf4j
public class Idea199148Service {
    private static final int IDEA_ID = 199148;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199148Service() {
        this(new Idea199148Config());
    }

    public Idea199148Service(Idea199148Config config) {
        this.config = config != null ? config : new Idea199148Config();
