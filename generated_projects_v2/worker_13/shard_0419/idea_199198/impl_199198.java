...
@Data
public class Idea199198Config {
    private String name = "idea_199198";
 ...
 */
@Slf4j
public class Idea199198Service {
    private static final int IDEA_ID = 199198;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199198Service() {
        this(new Idea199198Config());
    }

    public Idea199198Service(Idea199198Config config) {
        this.config = config != null ? config : new Idea199198Config();
