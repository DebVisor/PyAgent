...
@Data
public class Idea199163Config {
    private String name = "idea_199163";
 ...
 */
@Slf4j
public class Idea199163Service {
    private static final int IDEA_ID = 199163;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199163Service() {
        this(new Idea199163Config());
    }

    public Idea199163Service(Idea199163Config config) {
        this.config = config != null ? config : new Idea199163Config();
