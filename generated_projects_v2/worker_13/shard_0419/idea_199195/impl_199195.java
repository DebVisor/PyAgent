...
@Data
public class Idea199195Config {
    private String name = "idea_199195";
 ...
 */
@Slf4j
public class Idea199195Service {
    private static final int IDEA_ID = 199195;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199195Service() {
        this(new Idea199195Config());
    }

    public Idea199195Service(Idea199195Config config) {
        this.config = config != null ? config : new Idea199195Config();
