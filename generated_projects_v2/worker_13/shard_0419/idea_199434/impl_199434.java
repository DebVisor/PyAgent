...
@Data
public class Idea199434Config {
    private String name = "idea_199434";
 ...
 */
@Slf4j
public class Idea199434Service {
    private static final int IDEA_ID = 199434;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199434Service() {
        this(new Idea199434Config());
    }

    public Idea199434Service(Idea199434Config config) {
        this.config = config != null ? config : new Idea199434Config();
