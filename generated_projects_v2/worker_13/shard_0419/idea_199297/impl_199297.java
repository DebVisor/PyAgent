...
@Data
public class Idea199297Config {
    private String name = "idea_199297";
 ...
 */
@Slf4j
public class Idea199297Service {
    private static final int IDEA_ID = 199297;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199297Service() {
        this(new Idea199297Config());
    }

    public Idea199297Service(Idea199297Config config) {
        this.config = config != null ? config : new Idea199297Config();
