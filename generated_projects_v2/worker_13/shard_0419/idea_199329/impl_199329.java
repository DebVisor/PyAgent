...
@Data
public class Idea199329Config {
    private String name = "idea_199329";
 ...
 */
@Slf4j
public class Idea199329Service {
    private static final int IDEA_ID = 199329;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199329Service() {
        this(new Idea199329Config());
    }

    public Idea199329Service(Idea199329Config config) {
        this.config = config != null ? config : new Idea199329Config();
