...
@Data
public class Idea199231Config {
    private String name = "idea_199231";
 ...
 */
@Slf4j
public class Idea199231Service {
    private static final int IDEA_ID = 199231;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199231Service() {
        this(new Idea199231Config());
    }

    public Idea199231Service(Idea199231Config config) {
        this.config = config != null ? config : new Idea199231Config();
