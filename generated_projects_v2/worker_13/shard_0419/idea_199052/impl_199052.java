...
@Data
public class Idea199052Config {
    private String name = "idea_199052";
 ...
 */
@Slf4j
public class Idea199052Service {
    private static final int IDEA_ID = 199052;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199052Service() {
        this(new Idea199052Config());
    }

    public Idea199052Service(Idea199052Config config) {
        this.config = config != null ? config : new Idea199052Config();
