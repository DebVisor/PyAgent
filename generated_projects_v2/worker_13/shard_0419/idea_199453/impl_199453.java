...
@Data
public class Idea199453Config {
    private String name = "idea_199453";
 ...
 */
@Slf4j
public class Idea199453Service {
    private static final int IDEA_ID = 199453;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199453Service() {
        this(new Idea199453Config());
    }

    public Idea199453Service(Idea199453Config config) {
        this.config = config != null ? config : new Idea199453Config();
