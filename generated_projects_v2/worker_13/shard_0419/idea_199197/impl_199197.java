...
@Data
public class Idea199197Config {
    private String name = "idea_199197";
 ...
 */
@Slf4j
public class Idea199197Service {
    private static final int IDEA_ID = 199197;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199197Service() {
        this(new Idea199197Config());
    }

    public Idea199197Service(Idea199197Config config) {
        this.config = config != null ? config : new Idea199197Config();
