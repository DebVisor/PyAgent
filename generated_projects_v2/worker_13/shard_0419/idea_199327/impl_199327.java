...
@Data
public class Idea199327Config {
    private String name = "idea_199327";
 ...
 */
@Slf4j
public class Idea199327Service {
    private static final int IDEA_ID = 199327;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199327Service() {
        this(new Idea199327Config());
    }

    public Idea199327Service(Idea199327Config config) {
        this.config = config != null ? config : new Idea199327Config();
