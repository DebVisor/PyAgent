...
@Data
public class Idea199498Config {
    private String name = "idea_199498";
 ...
 */
@Slf4j
public class Idea199498Service {
    private static final int IDEA_ID = 199498;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199498Service() {
        this(new Idea199498Config());
    }

    public Idea199498Service(Idea199498Config config) {
        this.config = config != null ? config : new Idea199498Config();
