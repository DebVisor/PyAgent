...
@Data
public class Idea199290Config {
    private String name = "idea_199290";
 ...
 */
@Slf4j
public class Idea199290Service {
    private static final int IDEA_ID = 199290;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199290Service() {
        this(new Idea199290Config());
    }

    public Idea199290Service(Idea199290Config config) {
        this.config = config != null ? config : new Idea199290Config();
