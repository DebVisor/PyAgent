...
@Data
public class Idea199102Config {
    private String name = "idea_199102";
 ...
 */
@Slf4j
public class Idea199102Service {
    private static final int IDEA_ID = 199102;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199102Service() {
        this(new Idea199102Config());
    }

    public Idea199102Service(Idea199102Config config) {
        this.config = config != null ? config : new Idea199102Config();
