...
@Data
public class Idea199066Config {
    private String name = "idea_199066";
 ...
 */
@Slf4j
public class Idea199066Service {
    private static final int IDEA_ID = 199066;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199066Service() {
        this(new Idea199066Config());
    }

    public Idea199066Service(Idea199066Config config) {
        this.config = config != null ? config : new Idea199066Config();
