...
@Data
public class Idea199129Config {
    private String name = "idea_199129";
 ...
 */
@Slf4j
public class Idea199129Service {
    private static final int IDEA_ID = 199129;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199129Service() {
        this(new Idea199129Config());
    }

    public Idea199129Service(Idea199129Config config) {
        this.config = config != null ? config : new Idea199129Config();
