...
@Data
public class Idea199130Config {
    private String name = "idea_199130";
 ...
 */
@Slf4j
public class Idea199130Service {
    private static final int IDEA_ID = 199130;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199130Service() {
        this(new Idea199130Config());
    }

    public Idea199130Service(Idea199130Config config) {
        this.config = config != null ? config : new Idea199130Config();
