...
@Data
public class Idea199127Config {
    private String name = "idea_199127";
 ...
 */
@Slf4j
public class Idea199127Service {
    private static final int IDEA_ID = 199127;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199127Service() {
        this(new Idea199127Config());
    }

    public Idea199127Service(Idea199127Config config) {
        this.config = config != null ? config : new Idea199127Config();
