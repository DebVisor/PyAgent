...
@Data
public class Idea199165Config {
    private String name = "idea_199165";
 ...
 */
@Slf4j
public class Idea199165Service {
    private static final int IDEA_ID = 199165;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199165Service() {
        this(new Idea199165Config());
    }

    public Idea199165Service(Idea199165Config config) {
        this.config = config != null ? config : new Idea199165Config();
