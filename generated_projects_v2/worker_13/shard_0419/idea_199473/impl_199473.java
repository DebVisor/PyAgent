...
@Data
public class Idea199473Config {
    private String name = "idea_199473";
 ...
 */
@Slf4j
public class Idea199473Service {
    private static final int IDEA_ID = 199473;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199473Service() {
        this(new Idea199473Config());
    }

    public Idea199473Service(Idea199473Config config) {
        this.config = config != null ? config : new Idea199473Config();
