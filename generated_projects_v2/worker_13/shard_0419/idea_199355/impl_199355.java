...
@Data
public class Idea199355Config {
    private String name = "idea_199355";
 ...
 */
@Slf4j
public class Idea199355Service {
    private static final int IDEA_ID = 199355;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199355Service() {
        this(new Idea199355Config());
    }

    public Idea199355Service(Idea199355Config config) {
        this.config = config != null ? config : new Idea199355Config();
