...
@Data
public class Idea199359Config {
    private String name = "idea_199359";
 ...
 */
@Slf4j
public class Idea199359Service {
    private static final int IDEA_ID = 199359;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199359Service() {
        this(new Idea199359Config());
    }

    public Idea199359Service(Idea199359Config config) {
        this.config = config != null ? config : new Idea199359Config();
