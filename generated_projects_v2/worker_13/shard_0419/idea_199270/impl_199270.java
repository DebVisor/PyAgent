...
@Data
public class Idea199270Config {
    private String name = "idea_199270";
 ...
 */
@Slf4j
public class Idea199270Service {
    private static final int IDEA_ID = 199270;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199270Service() {
        this(new Idea199270Config());
    }

    public Idea199270Service(Idea199270Config config) {
        this.config = config != null ? config : new Idea199270Config();
