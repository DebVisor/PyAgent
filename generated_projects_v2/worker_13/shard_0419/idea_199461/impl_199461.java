...
@Data
public class Idea199461Config {
    private String name = "idea_199461";
 ...
 */
@Slf4j
public class Idea199461Service {
    private static final int IDEA_ID = 199461;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199461Service() {
        this(new Idea199461Config());
    }

    public Idea199461Service(Idea199461Config config) {
        this.config = config != null ? config : new Idea199461Config();
