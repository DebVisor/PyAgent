...
@Data
public class Idea199460Config {
    private String name = "idea_199460";
 ...
 */
@Slf4j
public class Idea199460Service {
    private static final int IDEA_ID = 199460;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199460Service() {
        this(new Idea199460Config());
    }

    public Idea199460Service(Idea199460Config config) {
        this.config = config != null ? config : new Idea199460Config();
