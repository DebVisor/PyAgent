...
@Data
public class Idea199160Config {
    private String name = "idea_199160";
 ...
 */
@Slf4j
public class Idea199160Service {
    private static final int IDEA_ID = 199160;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199160Service() {
        this(new Idea199160Config());
    }

    public Idea199160Service(Idea199160Config config) {
        this.config = config != null ? config : new Idea199160Config();
