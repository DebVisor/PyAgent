...
@Data
public class Idea199245Config {
    private String name = "idea_199245";
 ...
 */
@Slf4j
public class Idea199245Service {
    private static final int IDEA_ID = 199245;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199245Service() {
        this(new Idea199245Config());
    }

    public Idea199245Service(Idea199245Config config) {
        this.config = config != null ? config : new Idea199245Config();
