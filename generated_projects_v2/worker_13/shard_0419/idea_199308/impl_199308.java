...
@Data
public class Idea199308Config {
    private String name = "idea_199308";
 ...
 */
@Slf4j
public class Idea199308Service {
    private static final int IDEA_ID = 199308;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199308Service() {
        this(new Idea199308Config());
    }

    public Idea199308Service(Idea199308Config config) {
        this.config = config != null ? config : new Idea199308Config();
