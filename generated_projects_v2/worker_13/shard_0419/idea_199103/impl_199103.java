...
@Data
public class Idea199103Config {
    private String name = "idea_199103";
 ...
 */
@Slf4j
public class Idea199103Service {
    private static final int IDEA_ID = 199103;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199103Service() {
        this(new Idea199103Config());
    }

    public Idea199103Service(Idea199103Config config) {
        this.config = config != null ? config : new Idea199103Config();
