...
@Data
public class Idea199487Config {
    private String name = "idea_199487";
 ...
 */
@Slf4j
public class Idea199487Service {
    private static final int IDEA_ID = 199487;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199487Service() {
        this(new Idea199487Config());
    }

    public Idea199487Service(Idea199487Config config) {
        this.config = config != null ? config : new Idea199487Config();
