...
@Data
public class Idea199214Config {
    private String name = "idea_199214";
 ...
 */
@Slf4j
public class Idea199214Service {
    private static final int IDEA_ID = 199214;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199214Service() {
        this(new Idea199214Config());
    }

    public Idea199214Service(Idea199214Config config) {
        this.config = config != null ? config : new Idea199214Config();
