...
@Data
public class Idea199371Config {
    private String name = "idea_199371";
 ...
 */
@Slf4j
public class Idea199371Service {
    private static final int IDEA_ID = 199371;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199371Service() {
        this(new Idea199371Config());
    }

    public Idea199371Service(Idea199371Config config) {
        this.config = config != null ? config : new Idea199371Config();
