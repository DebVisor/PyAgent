...
@Data
public class Idea199411Config {
    private String name = "idea_199411";
 ...
 */
@Slf4j
public class Idea199411Service {
    private static final int IDEA_ID = 199411;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199411Service() {
        this(new Idea199411Config());
    }

    public Idea199411Service(Idea199411Config config) {
        this.config = config != null ? config : new Idea199411Config();
