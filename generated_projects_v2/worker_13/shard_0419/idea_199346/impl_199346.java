...
@Data
public class Idea199346Config {
    private String name = "idea_199346";
 ...
 */
@Slf4j
public class Idea199346Service {
    private static final int IDEA_ID = 199346;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199346Service() {
        this(new Idea199346Config());
    }

    public Idea199346Service(Idea199346Config config) {
        this.config = config != null ? config : new Idea199346Config();
