...
@Data
public class Idea199031Config {
    private String name = "idea_199031";
 ...
 */
@Slf4j
public class Idea199031Service {
    private static final int IDEA_ID = 199031;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199031Service() {
        this(new Idea199031Config());
    }

    public Idea199031Service(Idea199031Config config) {
        this.config = config != null ? config : new Idea199031Config();
