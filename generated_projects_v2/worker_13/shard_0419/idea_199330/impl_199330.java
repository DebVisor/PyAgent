...
@Data
public class Idea199330Config {
    private String name = "idea_199330";
 ...
 */
@Slf4j
public class Idea199330Service {
    private static final int IDEA_ID = 199330;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199330Service() {
        this(new Idea199330Config());
    }

    public Idea199330Service(Idea199330Config config) {
        this.config = config != null ? config : new Idea199330Config();
