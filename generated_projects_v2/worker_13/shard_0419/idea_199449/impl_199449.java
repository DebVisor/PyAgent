...
@Data
public class Idea199449Config {
    private String name = "idea_199449";
 ...
 */
@Slf4j
public class Idea199449Service {
    private static final int IDEA_ID = 199449;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199449Service() {
        this(new Idea199449Config());
    }

    public Idea199449Service(Idea199449Config config) {
        this.config = config != null ? config : new Idea199449Config();
