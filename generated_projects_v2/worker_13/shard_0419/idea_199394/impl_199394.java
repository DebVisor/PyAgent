...
@Data
public class Idea199394Config {
    private String name = "idea_199394";
 ...
 */
@Slf4j
public class Idea199394Service {
    private static final int IDEA_ID = 199394;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199394Service() {
        this(new Idea199394Config());
    }

    public Idea199394Service(Idea199394Config config) {
        this.config = config != null ? config : new Idea199394Config();
