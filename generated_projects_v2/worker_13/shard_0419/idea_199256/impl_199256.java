...
@Data
public class Idea199256Config {
    private String name = "idea_199256";
 ...
 */
@Slf4j
public class Idea199256Service {
    private static final int IDEA_ID = 199256;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199256Service() {
        this(new Idea199256Config());
    }

    public Idea199256Service(Idea199256Config config) {
        this.config = config != null ? config : new Idea199256Config();
