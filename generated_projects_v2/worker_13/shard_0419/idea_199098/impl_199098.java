...
@Data
public class Idea199098Config {
    private String name = "idea_199098";
 ...
 */
@Slf4j
public class Idea199098Service {
    private static final int IDEA_ID = 199098;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199098Service() {
        this(new Idea199098Config());
    }

    public Idea199098Service(Idea199098Config config) {
        this.config = config != null ? config : new Idea199098Config();
