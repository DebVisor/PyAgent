...
@Data
public class Idea199439Config {
    private String name = "idea_199439";
 ...
 */
@Slf4j
public class Idea199439Service {
    private static final int IDEA_ID = 199439;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199439Service() {
        this(new Idea199439Config());
    }

    public Idea199439Service(Idea199439Config config) {
        this.config = config != null ? config : new Idea199439Config();
