...
@Data
public class Idea199269Config {
    private String name = "idea_199269";
 ...
 */
@Slf4j
public class Idea199269Service {
    private static final int IDEA_ID = 199269;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199269Service() {
        this(new Idea199269Config());
    }

    public Idea199269Service(Idea199269Config config) {
        this.config = config != null ? config : new Idea199269Config();
