...
@Data
public class Idea199046Config {
    private String name = "idea_199046";
 ...
 */
@Slf4j
public class Idea199046Service {
    private static final int IDEA_ID = 199046;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199046Service() {
        this(new Idea199046Config());
    }

    public Idea199046Service(Idea199046Config config) {
        this.config = config != null ? config : new Idea199046Config();
