...
@Data
public class Idea199227Config {
    private String name = "idea_199227";
 ...
 */
@Slf4j
public class Idea199227Service {
    private static final int IDEA_ID = 199227;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199227Service() {
        this(new Idea199227Config());
    }

    public Idea199227Service(Idea199227Config config) {
        this.config = config != null ? config : new Idea199227Config();
