...
@Data
public class Idea199114Config {
    private String name = "idea_199114";
 ...
 */
@Slf4j
public class Idea199114Service {
    private static final int IDEA_ID = 199114;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199114Service() {
        this(new Idea199114Config());
    }

    public Idea199114Service(Idea199114Config config) {
        this.config = config != null ? config : new Idea199114Config();
