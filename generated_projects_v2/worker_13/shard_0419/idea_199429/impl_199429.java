...
@Data
public class Idea199429Config {
    private String name = "idea_199429";
 ...
 */
@Slf4j
public class Idea199429Service {
    private static final int IDEA_ID = 199429;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199429Service() {
        this(new Idea199429Config());
    }

    public Idea199429Service(Idea199429Config config) {
        this.config = config != null ? config : new Idea199429Config();
