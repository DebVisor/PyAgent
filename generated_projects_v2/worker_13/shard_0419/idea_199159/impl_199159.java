...
@Data
public class Idea199159Config {
    private String name = "idea_199159";
 ...
 */
@Slf4j
public class Idea199159Service {
    private static final int IDEA_ID = 199159;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199159Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199159Service() {
        this(new Idea199159Config());
    }

    public Idea199159Service(Idea199159Config config) {
        this.config = config != null ? config : new Idea199159Config();
