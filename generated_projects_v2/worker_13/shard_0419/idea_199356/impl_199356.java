...
@Data
public class Idea199356Config {
    private String name = "idea_199356";
 ...
 */
@Slf4j
public class Idea199356Service {
    private static final int IDEA_ID = 199356;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199356Service() {
        this(new Idea199356Config());
    }

    public Idea199356Service(Idea199356Config config) {
        this.config = config != null ? config : new Idea199356Config();
