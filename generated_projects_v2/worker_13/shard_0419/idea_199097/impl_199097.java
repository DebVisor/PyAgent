...
@Data
public class Idea199097Config {
    private String name = "idea_199097";
 ...
 */
@Slf4j
public class Idea199097Service {
    private static final int IDEA_ID = 199097;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199097Service() {
        this(new Idea199097Config());
    }

    public Idea199097Service(Idea199097Config config) {
        this.config = config != null ? config : new Idea199097Config();
