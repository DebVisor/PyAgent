...
@Data
public class Idea199420Config {
    private String name = "idea_199420";
 ...
 */
@Slf4j
public class Idea199420Service {
    private static final int IDEA_ID = 199420;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199420Service() {
        this(new Idea199420Config());
    }

    public Idea199420Service(Idea199420Config config) {
        this.config = config != null ? config : new Idea199420Config();
