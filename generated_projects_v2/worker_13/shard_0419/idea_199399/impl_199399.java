...
@Data
public class Idea199399Config {
    private String name = "idea_199399";
 ...
 */
@Slf4j
public class Idea199399Service {
    private static final int IDEA_ID = 199399;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199399Service() {
        this(new Idea199399Config());
    }

    public Idea199399Service(Idea199399Config config) {
        this.config = config != null ? config : new Idea199399Config();
