...
@Data
public class Idea199318Config {
    private String name = "idea_199318";
 ...
 */
@Slf4j
public class Idea199318Service {
    private static final int IDEA_ID = 199318;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199318Service() {
        this(new Idea199318Config());
    }

    public Idea199318Service(Idea199318Config config) {
        this.config = config != null ? config : new Idea199318Config();
