...
@Data
public class Idea199386Config {
    private String name = "idea_199386";
 ...
 */
@Slf4j
public class Idea199386Service {
    private static final int IDEA_ID = 199386;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199386Service() {
        this(new Idea199386Config());
    }

    public Idea199386Service(Idea199386Config config) {
        this.config = config != null ? config : new Idea199386Config();
