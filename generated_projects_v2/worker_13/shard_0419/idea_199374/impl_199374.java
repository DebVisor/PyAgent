...
@Data
public class Idea199374Config {
    private String name = "idea_199374";
 ...
 */
@Slf4j
public class Idea199374Service {
    private static final int IDEA_ID = 199374;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199374Service() {
        this(new Idea199374Config());
    }

    public Idea199374Service(Idea199374Config config) {
        this.config = config != null ? config : new Idea199374Config();
