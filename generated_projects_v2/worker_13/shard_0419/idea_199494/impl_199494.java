...
@Data
public class Idea199494Config {
    private String name = "idea_199494";
 ...
 */
@Slf4j
public class Idea199494Service {
    private static final int IDEA_ID = 199494;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199494Service() {
        this(new Idea199494Config());
    }

    public Idea199494Service(Idea199494Config config) {
        this.config = config != null ? config : new Idea199494Config();
