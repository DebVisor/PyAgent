...
@Data
public class Idea199384Config {
    private String name = "idea_199384";
 ...
 */
@Slf4j
public class Idea199384Service {
    private static final int IDEA_ID = 199384;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199384Service() {
        this(new Idea199384Config());
    }

    public Idea199384Service(Idea199384Config config) {
        this.config = config != null ? config : new Idea199384Config();
