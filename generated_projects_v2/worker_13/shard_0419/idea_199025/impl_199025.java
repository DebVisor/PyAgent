...
@Data
public class Idea199025Config {
    private String name = "idea_199025";
 ...
 */
@Slf4j
public class Idea199025Service {
    private static final int IDEA_ID = 199025;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199025Service() {
        this(new Idea199025Config());
    }

    public Idea199025Service(Idea199025Config config) {
        this.config = config != null ? config : new Idea199025Config();
