...
@Data
public class Idea199272Config {
    private String name = "idea_199272";
 ...
 */
@Slf4j
public class Idea199272Service {
    private static final int IDEA_ID = 199272;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199272Service() {
        this(new Idea199272Config());
    }

    public Idea199272Service(Idea199272Config config) {
        this.config = config != null ? config : new Idea199272Config();
