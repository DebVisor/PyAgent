...
@Data
public class Idea199060Config {
    private String name = "idea_199060";
 ...
 */
@Slf4j
public class Idea199060Service {
    private static final int IDEA_ID = 199060;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199060Service() {
        this(new Idea199060Config());
    }

    public Idea199060Service(Idea199060Config config) {
        this.config = config != null ? config : new Idea199060Config();
