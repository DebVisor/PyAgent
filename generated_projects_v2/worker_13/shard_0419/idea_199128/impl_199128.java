...
@Data
public class Idea199128Config {
    private String name = "idea_199128";
 ...
 */
@Slf4j
public class Idea199128Service {
    private static final int IDEA_ID = 199128;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199128Service() {
        this(new Idea199128Config());
    }

    public Idea199128Service(Idea199128Config config) {
        this.config = config != null ? config : new Idea199128Config();
