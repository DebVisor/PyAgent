...
@Data
public class Idea199475Config {
    private String name = "idea_199475";
 ...
 */
@Slf4j
public class Idea199475Service {
    private static final int IDEA_ID = 199475;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199475Service() {
        this(new Idea199475Config());
    }

    public Idea199475Service(Idea199475Config config) {
        this.config = config != null ? config : new Idea199475Config();
