...
@Data
public class Idea199309Config {
    private String name = "idea_199309";
 ...
 */
@Slf4j
public class Idea199309Service {
    private static final int IDEA_ID = 199309;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199309Service() {
        this(new Idea199309Config());
    }

    public Idea199309Service(Idea199309Config config) {
        this.config = config != null ? config : new Idea199309Config();
