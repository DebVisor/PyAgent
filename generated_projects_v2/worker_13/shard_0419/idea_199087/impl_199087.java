...
@Data
public class Idea199087Config {
    private String name = "idea_199087";
 ...
 */
@Slf4j
public class Idea199087Service {
    private static final int IDEA_ID = 199087;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199087Service() {
        this(new Idea199087Config());
    }

    public Idea199087Service(Idea199087Config config) {
        this.config = config != null ? config : new Idea199087Config();
