...
@Data
public class Idea199068Config {
    private String name = "idea_199068";
 ...
 */
@Slf4j
public class Idea199068Service {
    private static final int IDEA_ID = 199068;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199068Service() {
        this(new Idea199068Config());
    }

    public Idea199068Service(Idea199068Config config) {
        this.config = config != null ? config : new Idea199068Config();
