...
@Data
public class Idea199050Config {
    private String name = "idea_199050";
 ...
 */
@Slf4j
public class Idea199050Service {
    private static final int IDEA_ID = 199050;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199050Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199050Service() {
        this(new Idea199050Config());
    }

    public Idea199050Service(Idea199050Config config) {
        this.config = config != null ? config : new Idea199050Config();
