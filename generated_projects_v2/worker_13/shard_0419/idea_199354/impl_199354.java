...
@Data
public class Idea199354Config {
    private String name = "idea_199354";
 ...
 */
@Slf4j
public class Idea199354Service {
    private static final int IDEA_ID = 199354;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199354Service() {
        this(new Idea199354Config());
    }

    public Idea199354Service(Idea199354Config config) {
        this.config = config != null ? config : new Idea199354Config();
