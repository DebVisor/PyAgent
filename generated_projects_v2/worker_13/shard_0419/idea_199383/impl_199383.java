...
@Data
public class Idea199383Config {
    private String name = "idea_199383";
 ...
 */
@Slf4j
public class Idea199383Service {
    private static final int IDEA_ID = 199383;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199383Service() {
        this(new Idea199383Config());
    }

    public Idea199383Service(Idea199383Config config) {
        this.config = config != null ? config : new Idea199383Config();
