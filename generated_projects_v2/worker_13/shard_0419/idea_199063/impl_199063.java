...
@Data
public class Idea199063Config {
    private String name = "idea_199063";
 ...
 */
@Slf4j
public class Idea199063Service {
    private static final int IDEA_ID = 199063;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199063Service() {
        this(new Idea199063Config());
    }

    public Idea199063Service(Idea199063Config config) {
        this.config = config != null ? config : new Idea199063Config();
