...
@Data
public class Idea199147Config {
    private String name = "idea_199147";
 ...
 */
@Slf4j
public class Idea199147Service {
    private static final int IDEA_ID = 199147;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199147Service() {
        this(new Idea199147Config());
    }

    public Idea199147Service(Idea199147Config config) {
        this.config = config != null ? config : new Idea199147Config();
