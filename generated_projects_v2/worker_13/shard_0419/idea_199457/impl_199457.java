...
@Data
public class Idea199457Config {
    private String name = "idea_199457";
 ...
 */
@Slf4j
public class Idea199457Service {
    private static final int IDEA_ID = 199457;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199457Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199457Service() {
        this(new Idea199457Config());
    }

    public Idea199457Service(Idea199457Config config) {
        this.config = config != null ? config : new Idea199457Config();
