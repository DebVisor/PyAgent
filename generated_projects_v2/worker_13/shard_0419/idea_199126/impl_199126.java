...
@Data
public class Idea199126Config {
    private String name = "idea_199126";
 ...
 */
@Slf4j
public class Idea199126Service {
    private static final int IDEA_ID = 199126;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199126Service() {
        this(new Idea199126Config());
    }

    public Idea199126Service(Idea199126Config config) {
        this.config = config != null ? config : new Idea199126Config();
