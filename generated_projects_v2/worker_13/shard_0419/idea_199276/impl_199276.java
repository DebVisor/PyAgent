...
@Data
public class Idea199276Config {
    private String name = "idea_199276";
 ...
 */
@Slf4j
public class Idea199276Service {
    private static final int IDEA_ID = 199276;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199276Service() {
        this(new Idea199276Config());
    }

    public Idea199276Service(Idea199276Config config) {
        this.config = config != null ? config : new Idea199276Config();
