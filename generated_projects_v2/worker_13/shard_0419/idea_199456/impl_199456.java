...
@Data
public class Idea199456Config {
    private String name = "idea_199456";
 ...
 */
@Slf4j
public class Idea199456Service {
    private static final int IDEA_ID = 199456;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199456Service() {
        this(new Idea199456Config());
    }

    public Idea199456Service(Idea199456Config config) {
        this.config = config != null ? config : new Idea199456Config();
