...
@Data
public class Idea199266Config {
    private String name = "idea_199266";
 ...
 */
@Slf4j
public class Idea199266Service {
    private static final int IDEA_ID = 199266;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199266Service() {
        this(new Idea199266Config());
    }

    public Idea199266Service(Idea199266Config config) {
        this.config = config != null ? config : new Idea199266Config();
