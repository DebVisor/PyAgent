...
@Data
public class Idea199400Config {
    private String name = "idea_199400";
 ...
 */
@Slf4j
public class Idea199400Service {
    private static final int IDEA_ID = 199400;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199400Service() {
        this(new Idea199400Config());
    }

    public Idea199400Service(Idea199400Config config) {
        this.config = config != null ? config : new Idea199400Config();
