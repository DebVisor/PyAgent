...
@Data
public class Idea199235Config {
    private String name = "idea_199235";
 ...
 */
@Slf4j
public class Idea199235Service {
    private static final int IDEA_ID = 199235;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199235Service() {
        this(new Idea199235Config());
    }

    public Idea199235Service(Idea199235Config config) {
        this.config = config != null ? config : new Idea199235Config();
