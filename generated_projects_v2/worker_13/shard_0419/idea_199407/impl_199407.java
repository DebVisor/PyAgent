...
@Data
public class Idea199407Config {
    private String name = "idea_199407";
 ...
 */
@Slf4j
public class Idea199407Service {
    private static final int IDEA_ID = 199407;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199407Service() {
        this(new Idea199407Config());
    }

    public Idea199407Service(Idea199407Config config) {
        this.config = config != null ? config : new Idea199407Config();
