...
@Data
public class Idea199440Config {
    private String name = "idea_199440";
 ...
 */
@Slf4j
public class Idea199440Service {
    private static final int IDEA_ID = 199440;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199440Service() {
        this(new Idea199440Config());
    }

    public Idea199440Service(Idea199440Config config) {
        this.config = config != null ? config : new Idea199440Config();
