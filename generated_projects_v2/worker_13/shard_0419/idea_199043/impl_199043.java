...
@Data
public class Idea199043Config {
    private String name = "idea_199043";
 ...
 */
@Slf4j
public class Idea199043Service {
    private static final int IDEA_ID = 199043;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199043Service() {
        this(new Idea199043Config());
    }

    public Idea199043Service(Idea199043Config config) {
        this.config = config != null ? config : new Idea199043Config();
