...
@Data
public class Idea199288Config {
    private String name = "idea_199288";
 ...
 */
@Slf4j
public class Idea199288Service {
    private static final int IDEA_ID = 199288;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199288Service() {
        this(new Idea199288Config());
    }

    public Idea199288Service(Idea199288Config config) {
        this.config = config != null ? config : new Idea199288Config();
