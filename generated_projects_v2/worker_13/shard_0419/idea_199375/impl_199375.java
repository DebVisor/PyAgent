...
@Data
public class Idea199375Config {
    private String name = "idea_199375";
 ...
 */
@Slf4j
public class Idea199375Service {
    private static final int IDEA_ID = 199375;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199375Service() {
        this(new Idea199375Config());
    }

    public Idea199375Service(Idea199375Config config) {
        this.config = config != null ? config : new Idea199375Config();
