...
@Data
public class Idea199080Config {
    private String name = "idea_199080";
 ...
 */
@Slf4j
public class Idea199080Service {
    private static final int IDEA_ID = 199080;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199080Service() {
        this(new Idea199080Config());
    }

    public Idea199080Service(Idea199080Config config) {
        this.config = config != null ? config : new Idea199080Config();
