...
@Data
public class Idea199226Config {
    private String name = "idea_199226";
 ...
 */
@Slf4j
public class Idea199226Service {
    private static final int IDEA_ID = 199226;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199226Service() {
        this(new Idea199226Config());
    }

    public Idea199226Service(Idea199226Config config) {
        this.config = config != null ? config : new Idea199226Config();
