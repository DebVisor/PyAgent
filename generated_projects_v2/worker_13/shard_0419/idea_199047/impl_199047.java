...
@Data
public class Idea199047Config {
    private String name = "idea_199047";
 ...
 */
@Slf4j
public class Idea199047Service {
    private static final int IDEA_ID = 199047;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199047Service() {
        this(new Idea199047Config());
    }

    public Idea199047Service(Idea199047Config config) {
        this.config = config != null ? config : new Idea199047Config();
