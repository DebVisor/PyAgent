...
@Data
public class Idea199096Config {
    private String name = "idea_199096";
 ...
 */
@Slf4j
public class Idea199096Service {
    private static final int IDEA_ID = 199096;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199096Service() {
        this(new Idea199096Config());
    }

    public Idea199096Service(Idea199096Config config) {
        this.config = config != null ? config : new Idea199096Config();
