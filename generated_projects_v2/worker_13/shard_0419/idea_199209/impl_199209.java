...
@Data
public class Idea199209Config {
    private String name = "idea_199209";
 ...
 */
@Slf4j
public class Idea199209Service {
    private static final int IDEA_ID = 199209;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199209Service() {
        this(new Idea199209Config());
    }

    public Idea199209Service(Idea199209Config config) {
        this.config = config != null ? config : new Idea199209Config();
