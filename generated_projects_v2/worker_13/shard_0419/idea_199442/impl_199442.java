...
@Data
public class Idea199442Config {
    private String name = "idea_199442";
 ...
 */
@Slf4j
public class Idea199442Service {
    private static final int IDEA_ID = 199442;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199442Service() {
        this(new Idea199442Config());
    }

    public Idea199442Service(Idea199442Config config) {
        this.config = config != null ? config : new Idea199442Config();
