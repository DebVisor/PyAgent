...
@Data
public class Idea199146Config {
    private String name = "idea_199146";
 ...
 */
@Slf4j
public class Idea199146Service {
    private static final int IDEA_ID = 199146;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199146Service() {
        this(new Idea199146Config());
    }

    public Idea199146Service(Idea199146Config config) {
        this.config = config != null ? config : new Idea199146Config();
