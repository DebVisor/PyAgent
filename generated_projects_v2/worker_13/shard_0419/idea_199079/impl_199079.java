...
@Data
public class Idea199079Config {
    private String name = "idea_199079";
 ...
 */
@Slf4j
public class Idea199079Service {
    private static final int IDEA_ID = 199079;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199079Service() {
        this(new Idea199079Config());
    }

    public Idea199079Service(Idea199079Config config) {
        this.config = config != null ? config : new Idea199079Config();
