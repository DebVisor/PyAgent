...
@Data
public class Idea199086Config {
    private String name = "idea_199086";
 ...
 */
@Slf4j
public class Idea199086Service {
    private static final int IDEA_ID = 199086;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199086Service() {
        this(new Idea199086Config());
    }

    public Idea199086Service(Idea199086Config config) {
        this.config = config != null ? config : new Idea199086Config();
