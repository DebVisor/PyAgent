...
@Data
public class Idea199070Config {
    private String name = "idea_199070";
 ...
 */
@Slf4j
public class Idea199070Service {
    private static final int IDEA_ID = 199070;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199070Service() {
        this(new Idea199070Config());
    }

    public Idea199070Service(Idea199070Config config) {
        this.config = config != null ? config : new Idea199070Config();
