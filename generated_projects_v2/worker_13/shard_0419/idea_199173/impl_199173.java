...
@Data
public class Idea199173Config {
    private String name = "idea_199173";
 ...
 */
@Slf4j
public class Idea199173Service {
    private static final int IDEA_ID = 199173;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199173Service() {
        this(new Idea199173Config());
    }

    public Idea199173Service(Idea199173Config config) {
        this.config = config != null ? config : new Idea199173Config();
