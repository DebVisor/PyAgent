...
@Data
public class Idea199284Config {
    private String name = "idea_199284";
 ...
 */
@Slf4j
public class Idea199284Service {
    private static final int IDEA_ID = 199284;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199284Service() {
        this(new Idea199284Config());
    }

    public Idea199284Service(Idea199284Config config) {
        this.config = config != null ? config : new Idea199284Config();
