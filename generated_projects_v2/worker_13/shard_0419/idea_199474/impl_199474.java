...
@Data
public class Idea199474Config {
    private String name = "idea_199474";
 ...
 */
@Slf4j
public class Idea199474Service {
    private static final int IDEA_ID = 199474;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199474Service() {
        this(new Idea199474Config());
    }

    public Idea199474Service(Idea199474Config config) {
        this.config = config != null ? config : new Idea199474Config();
