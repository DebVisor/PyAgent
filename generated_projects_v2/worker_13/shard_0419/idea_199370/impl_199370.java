...
@Data
public class Idea199370Config {
    private String name = "idea_199370";
 ...
 */
@Slf4j
public class Idea199370Service {
    private static final int IDEA_ID = 199370;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199370Service() {
        this(new Idea199370Config());
    }

    public Idea199370Service(Idea199370Config config) {
        this.config = config != null ? config : new Idea199370Config();
