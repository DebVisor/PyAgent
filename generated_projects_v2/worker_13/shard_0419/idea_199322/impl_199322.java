...
@Data
public class Idea199322Config {
    private String name = "idea_199322";
 ...
 */
@Slf4j
public class Idea199322Service {
    private static final int IDEA_ID = 199322;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199322Service() {
        this(new Idea199322Config());
    }

    public Idea199322Service(Idea199322Config config) {
        this.config = config != null ? config : new Idea199322Config();
