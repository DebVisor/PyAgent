...
@Data
public class Idea199133Config {
    private String name = "idea_199133";
 ...
 */
@Slf4j
public class Idea199133Service {
    private static final int IDEA_ID = 199133;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199133Service() {
        this(new Idea199133Config());
    }

    public Idea199133Service(Idea199133Config config) {
        this.config = config != null ? config : new Idea199133Config();
