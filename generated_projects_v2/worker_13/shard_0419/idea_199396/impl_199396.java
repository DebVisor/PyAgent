...
@Data
public class Idea199396Config {
    private String name = "idea_199396";
 ...
 */
@Slf4j
public class Idea199396Service {
    private static final int IDEA_ID = 199396;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199396Service() {
        this(new Idea199396Config());
    }

    public Idea199396Service(Idea199396Config config) {
        this.config = config != null ? config : new Idea199396Config();
