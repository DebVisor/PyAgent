...
@Data
public class Idea199137Config {
    private String name = "idea_199137";
 ...
 */
@Slf4j
public class Idea199137Service {
    private static final int IDEA_ID = 199137;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199137Service() {
        this(new Idea199137Config());
    }

    public Idea199137Service(Idea199137Config config) {
        this.config = config != null ? config : new Idea199137Config();
