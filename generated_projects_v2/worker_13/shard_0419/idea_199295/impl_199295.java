...
@Data
public class Idea199295Config {
    private String name = "idea_199295";
 ...
 */
@Slf4j
public class Idea199295Service {
    private static final int IDEA_ID = 199295;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199295Service() {
        this(new Idea199295Config());
    }

    public Idea199295Service(Idea199295Config config) {
        this.config = config != null ? config : new Idea199295Config();
