...
@Data
public class Idea199479Config {
    private String name = "idea_199479";
 ...
 */
@Slf4j
public class Idea199479Service {
    private static final int IDEA_ID = 199479;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199479Service() {
        this(new Idea199479Config());
    }

    public Idea199479Service(Idea199479Config config) {
        this.config = config != null ? config : new Idea199479Config();
