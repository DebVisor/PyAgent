...
@Data
public class Idea199402Config {
    private String name = "idea_199402";
 ...
 */
@Slf4j
public class Idea199402Service {
    private static final int IDEA_ID = 199402;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199402Service() {
        this(new Idea199402Config());
    }

    public Idea199402Service(Idea199402Config config) {
        this.config = config != null ? config : new Idea199402Config();
