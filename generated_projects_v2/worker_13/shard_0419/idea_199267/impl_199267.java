...
@Data
public class Idea199267Config {
    private String name = "idea_199267";
 ...
 */
@Slf4j
public class Idea199267Service {
    private static final int IDEA_ID = 199267;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199267Service() {
        this(new Idea199267Config());
    }

    public Idea199267Service(Idea199267Config config) {
        this.config = config != null ? config : new Idea199267Config();
