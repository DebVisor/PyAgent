...
@Data
public class Idea198517Config {
    private String name = "idea_198517";
 ...
 */
@Slf4j
public class Idea198517Service {
    private static final int IDEA_ID = 198517;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198517Service() {
        this(new Idea198517Config());
    }

    public Idea198517Service(Idea198517Config config) {
        this.config = config != null ? config : new Idea198517Config();
