...
@Data
public class Idea198181Config {
    private String name = "idea_198181";
 ...
 */
@Slf4j
public class Idea198181Service {
    private static final int IDEA_ID = 198181;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198181Service() {
        this(new Idea198181Config());
    }

    public Idea198181Service(Idea198181Config config) {
        this.config = config != null ? config : new Idea198181Config();
