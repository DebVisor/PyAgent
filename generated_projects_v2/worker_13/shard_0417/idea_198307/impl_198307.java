...
@Data
public class Idea198307Config {
    private String name = "idea_198307";
 ...
 */
@Slf4j
public class Idea198307Service {
    private static final int IDEA_ID = 198307;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198307Service() {
        this(new Idea198307Config());
    }

    public Idea198307Service(Idea198307Config config) {
        this.config = config != null ? config : new Idea198307Config();
