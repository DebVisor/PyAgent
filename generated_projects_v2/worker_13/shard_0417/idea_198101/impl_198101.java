...
@Data
public class Idea198101Config {
    private String name = "idea_198101";
 ...
 */
@Slf4j
public class Idea198101Service {
    private static final int IDEA_ID = 198101;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198101Service() {
        this(new Idea198101Config());
    }

    public Idea198101Service(Idea198101Config config) {
        this.config = config != null ? config : new Idea198101Config();
