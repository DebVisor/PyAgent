...
@Data
public class Idea198461Config {
    private String name = "idea_198461";
 ...
 */
@Slf4j
public class Idea198461Service {
    private static final int IDEA_ID = 198461;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198461Service() {
        this(new Idea198461Config());
    }

    public Idea198461Service(Idea198461Config config) {
        this.config = config != null ? config : new Idea198461Config();
