...
@Data
public class Idea198358Config {
    private String name = "idea_198358";
 ...
 */
@Slf4j
public class Idea198358Service {
    private static final int IDEA_ID = 198358;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198358Service() {
        this(new Idea198358Config());
    }

    public Idea198358Service(Idea198358Config config) {
        this.config = config != null ? config : new Idea198358Config();
