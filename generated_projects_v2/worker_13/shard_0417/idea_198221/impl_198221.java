...
@Data
public class Idea198221Config {
    private String name = "idea_198221";
 ...
 */
@Slf4j
public class Idea198221Service {
    private static final int IDEA_ID = 198221;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198221Service() {
        this(new Idea198221Config());
    }

    public Idea198221Service(Idea198221Config config) {
        this.config = config != null ? config : new Idea198221Config();
