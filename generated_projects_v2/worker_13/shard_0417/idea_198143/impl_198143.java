...
@Data
public class Idea198143Config {
    private String name = "idea_198143";
 ...
 */
@Slf4j
public class Idea198143Service {
    private static final int IDEA_ID = 198143;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198143Service() {
        this(new Idea198143Config());
    }

    public Idea198143Service(Idea198143Config config) {
        this.config = config != null ? config : new Idea198143Config();
