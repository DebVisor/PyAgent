...
@Data
public class Idea198205Config {
    private String name = "idea_198205";
 ...
 */
@Slf4j
public class Idea198205Service {
    private static final int IDEA_ID = 198205;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198205Service() {
        this(new Idea198205Config());
    }

    public Idea198205Service(Idea198205Config config) {
        this.config = config != null ? config : new Idea198205Config();
