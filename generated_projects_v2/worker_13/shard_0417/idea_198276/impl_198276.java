...
@Data
public class Idea198276Config {
    private String name = "idea_198276";
 ...
 */
@Slf4j
public class Idea198276Service {
    private static final int IDEA_ID = 198276;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198276Service() {
        this(new Idea198276Config());
    }

    public Idea198276Service(Idea198276Config config) {
        this.config = config != null ? config : new Idea198276Config();
