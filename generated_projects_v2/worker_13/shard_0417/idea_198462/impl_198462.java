...
@Data
public class Idea198462Config {
    private String name = "idea_198462";
 ...
 */
@Slf4j
public class Idea198462Service {
    private static final int IDEA_ID = 198462;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198462Service() {
        this(new Idea198462Config());
    }

    public Idea198462Service(Idea198462Config config) {
        this.config = config != null ? config : new Idea198462Config();
