...
@Data
public class Idea198537Config {
    private String name = "idea_198537";
 ...
 */
@Slf4j
public class Idea198537Service {
    private static final int IDEA_ID = 198537;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198537Service() {
        this(new Idea198537Config());
    }

    public Idea198537Service(Idea198537Config config) {
        this.config = config != null ? config : new Idea198537Config();
