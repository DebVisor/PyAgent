...
@Data
public class Idea198539Config {
    private String name = "idea_198539";
 ...
 */
@Slf4j
public class Idea198539Service {
    private static final int IDEA_ID = 198539;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198539Service() {
        this(new Idea198539Config());
    }

    public Idea198539Service(Idea198539Config config) {
        this.config = config != null ? config : new Idea198539Config();
