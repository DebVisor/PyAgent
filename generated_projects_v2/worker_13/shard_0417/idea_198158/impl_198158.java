...
@Data
public class Idea198158Config {
    private String name = "idea_198158";
 ...
 */
@Slf4j
public class Idea198158Service {
    private static final int IDEA_ID = 198158;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198158Service() {
        this(new Idea198158Config());
    }

    public Idea198158Service(Idea198158Config config) {
        this.config = config != null ? config : new Idea198158Config();
