...
@Data
public class Idea198309Config {
    private String name = "idea_198309";
 ...
 */
@Slf4j
public class Idea198309Service {
    private static final int IDEA_ID = 198309;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198309Service() {
        this(new Idea198309Config());
    }

    public Idea198309Service(Idea198309Config config) {
        this.config = config != null ? config : new Idea198309Config();
