...
@Data
public class Idea198301Config {
    private String name = "idea_198301";
 ...
 */
@Slf4j
public class Idea198301Service {
    private static final int IDEA_ID = 198301;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198301Service() {
        this(new Idea198301Config());
    }

    public Idea198301Service(Idea198301Config config) {
        this.config = config != null ? config : new Idea198301Config();
