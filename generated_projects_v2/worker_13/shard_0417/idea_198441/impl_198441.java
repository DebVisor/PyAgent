...
@Data
public class Idea198441Config {
    private String name = "idea_198441";
 ...
 */
@Slf4j
public class Idea198441Service {
    private static final int IDEA_ID = 198441;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198441Service() {
        this(new Idea198441Config());
    }

    public Idea198441Service(Idea198441Config config) {
        this.config = config != null ? config : new Idea198441Config();
