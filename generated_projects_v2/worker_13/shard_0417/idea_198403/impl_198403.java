...
@Data
public class Idea198403Config {
    private String name = "idea_198403";
 ...
 */
@Slf4j
public class Idea198403Service {
    private static final int IDEA_ID = 198403;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198403Service() {
        this(new Idea198403Config());
    }

    public Idea198403Service(Idea198403Config config) {
        this.config = config != null ? config : new Idea198403Config();
