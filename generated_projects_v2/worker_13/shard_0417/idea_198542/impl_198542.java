...
@Data
public class Idea198542Config {
    private String name = "idea_198542";
 ...
 */
@Slf4j
public class Idea198542Service {
    private static final int IDEA_ID = 198542;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198542Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198542Service() {
        this(new Idea198542Config());
    }

    public Idea198542Service(Idea198542Config config) {
        this.config = config != null ? config : new Idea198542Config();
