...
@Data
public class Idea198466Config {
    private String name = "idea_198466";
 ...
 */
@Slf4j
public class Idea198466Service {
    private static final int IDEA_ID = 198466;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198466Service() {
        this(new Idea198466Config());
    }

    public Idea198466Service(Idea198466Config config) {
        this.config = config != null ? config : new Idea198466Config();
