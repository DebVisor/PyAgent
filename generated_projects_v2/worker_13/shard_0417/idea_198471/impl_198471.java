...
@Data
public class Idea198471Config {
    private String name = "idea_198471";
 ...
 */
@Slf4j
public class Idea198471Service {
    private static final int IDEA_ID = 198471;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198471Service() {
        this(new Idea198471Config());
    }

    public Idea198471Service(Idea198471Config config) {
        this.config = config != null ? config : new Idea198471Config();
