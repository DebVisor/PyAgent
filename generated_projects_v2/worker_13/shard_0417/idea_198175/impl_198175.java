...
@Data
public class Idea198175Config {
    private String name = "idea_198175";
 ...
 */
@Slf4j
public class Idea198175Service {
    private static final int IDEA_ID = 198175;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198175Service() {
        this(new Idea198175Config());
    }

    public Idea198175Service(Idea198175Config config) {
        this.config = config != null ? config : new Idea198175Config();
