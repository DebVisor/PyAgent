...
@Data
public class Idea198255Config {
    private String name = "idea_198255";
 ...
 */
@Slf4j
public class Idea198255Service {
    private static final int IDEA_ID = 198255;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198255Service() {
        this(new Idea198255Config());
    }

    public Idea198255Service(Idea198255Config config) {
        this.config = config != null ? config : new Idea198255Config();
