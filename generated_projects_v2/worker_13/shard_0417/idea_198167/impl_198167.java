...
@Data
public class Idea198167Config {
    private String name = "idea_198167";
 ...
 */
@Slf4j
public class Idea198167Service {
    private static final int IDEA_ID = 198167;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198167Service() {
        this(new Idea198167Config());
    }

    public Idea198167Service(Idea198167Config config) {
        this.config = config != null ? config : new Idea198167Config();
