...
@Data
public class Idea198415Config {
    private String name = "idea_198415";
 ...
 */
@Slf4j
public class Idea198415Service {
    private static final int IDEA_ID = 198415;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198415Service() {
        this(new Idea198415Config());
    }

    public Idea198415Service(Idea198415Config config) {
        this.config = config != null ? config : new Idea198415Config();
