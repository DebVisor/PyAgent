...
@Data
public class Idea198465Config {
    private String name = "idea_198465";
 ...
 */
@Slf4j
public class Idea198465Service {
    private static final int IDEA_ID = 198465;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198465Service() {
        this(new Idea198465Config());
    }

    public Idea198465Service(Idea198465Config config) {
        this.config = config != null ? config : new Idea198465Config();
