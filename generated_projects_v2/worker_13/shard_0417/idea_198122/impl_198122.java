...
@Data
public class Idea198122Config {
    private String name = "idea_198122";
 ...
 */
@Slf4j
public class Idea198122Service {
    private static final int IDEA_ID = 198122;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198122Service() {
        this(new Idea198122Config());
    }

    public Idea198122Service(Idea198122Config config) {
        this.config = config != null ? config : new Idea198122Config();
