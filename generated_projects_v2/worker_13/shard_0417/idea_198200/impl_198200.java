...
@Data
public class Idea198200Config {
    private String name = "idea_198200";
 ...
 */
@Slf4j
public class Idea198200Service {
    private static final int IDEA_ID = 198200;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198200Service() {
        this(new Idea198200Config());
    }

    public Idea198200Service(Idea198200Config config) {
        this.config = config != null ? config : new Idea198200Config();
