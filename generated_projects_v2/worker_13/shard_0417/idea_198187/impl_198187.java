...
@Data
public class Idea198187Config {
    private String name = "idea_198187";
 ...
 */
@Slf4j
public class Idea198187Service {
    private static final int IDEA_ID = 198187;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198187Service() {
        this(new Idea198187Config());
    }

    public Idea198187Service(Idea198187Config config) {
        this.config = config != null ? config : new Idea198187Config();
