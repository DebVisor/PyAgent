...
@Data
public class Idea198412Config {
    private String name = "idea_198412";
 ...
 */
@Slf4j
public class Idea198412Service {
    private static final int IDEA_ID = 198412;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198412Service() {
        this(new Idea198412Config());
    }

    public Idea198412Service(Idea198412Config config) {
        this.config = config != null ? config : new Idea198412Config();
