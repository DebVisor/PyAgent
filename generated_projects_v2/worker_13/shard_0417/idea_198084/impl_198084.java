...
@Data
public class Idea198084Config {
    private String name = "idea_198084";
 ...
 */
@Slf4j
public class Idea198084Service {
    private static final int IDEA_ID = 198084;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198084Service() {
        this(new Idea198084Config());
    }

    public Idea198084Service(Idea198084Config config) {
        this.config = config != null ? config : new Idea198084Config();
