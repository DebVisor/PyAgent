...
@Data
public class Idea198166Config {
    private String name = "idea_198166";
 ...
 */
@Slf4j
public class Idea198166Service {
    private static final int IDEA_ID = 198166;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198166Service() {
        this(new Idea198166Config());
    }

    public Idea198166Service(Idea198166Config config) {
        this.config = config != null ? config : new Idea198166Config();
