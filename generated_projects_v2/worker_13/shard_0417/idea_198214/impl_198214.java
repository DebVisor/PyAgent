...
@Data
public class Idea198214Config {
    private String name = "idea_198214";
 ...
 */
@Slf4j
public class Idea198214Service {
    private static final int IDEA_ID = 198214;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198214Service() {
        this(new Idea198214Config());
    }

    public Idea198214Service(Idea198214Config config) {
        this.config = config != null ? config : new Idea198214Config();
