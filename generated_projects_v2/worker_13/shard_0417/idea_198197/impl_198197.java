...
@Data
public class Idea198197Config {
    private String name = "idea_198197";
 ...
 */
@Slf4j
public class Idea198197Service {
    private static final int IDEA_ID = 198197;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198197Service() {
        this(new Idea198197Config());
    }

    public Idea198197Service(Idea198197Config config) {
        this.config = config != null ? config : new Idea198197Config();
