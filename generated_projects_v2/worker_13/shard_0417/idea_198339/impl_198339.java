...
@Data
public class Idea198339Config {
    private String name = "idea_198339";
 ...
 */
@Slf4j
public class Idea198339Service {
    private static final int IDEA_ID = 198339;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198339Service() {
        this(new Idea198339Config());
    }

    public Idea198339Service(Idea198339Config config) {
        this.config = config != null ? config : new Idea198339Config();
