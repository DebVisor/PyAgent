...
@Data
public class Idea198161Config {
    private String name = "idea_198161";
 ...
 */
@Slf4j
public class Idea198161Service {
    private static final int IDEA_ID = 198161;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198161Service() {
        this(new Idea198161Config());
    }

    public Idea198161Service(Idea198161Config config) {
        this.config = config != null ? config : new Idea198161Config();
