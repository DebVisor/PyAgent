...
@Data
public class Idea198211Config {
    private String name = "idea_198211";
 ...
 */
@Slf4j
public class Idea198211Service {
    private static final int IDEA_ID = 198211;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198211Service() {
        this(new Idea198211Config());
    }

    public Idea198211Service(Idea198211Config config) {
        this.config = config != null ? config : new Idea198211Config();
