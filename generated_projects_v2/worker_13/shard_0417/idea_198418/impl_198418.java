...
@Data
public class Idea198418Config {
    private String name = "idea_198418";
 ...
 */
@Slf4j
public class Idea198418Service {
    private static final int IDEA_ID = 198418;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198418Service() {
        this(new Idea198418Config());
    }

    public Idea198418Service(Idea198418Config config) {
        this.config = config != null ? config : new Idea198418Config();
