...
@Data
public class Idea198405Config {
    private String name = "idea_198405";
 ...
 */
@Slf4j
public class Idea198405Service {
    private static final int IDEA_ID = 198405;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198405Service() {
        this(new Idea198405Config());
    }

    public Idea198405Service(Idea198405Config config) {
        this.config = config != null ? config : new Idea198405Config();
