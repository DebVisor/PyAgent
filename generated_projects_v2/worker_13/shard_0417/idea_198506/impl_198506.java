...
@Data
public class Idea198506Config {
    private String name = "idea_198506";
 ...
 */
@Slf4j
public class Idea198506Service {
    private static final int IDEA_ID = 198506;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198506Service() {
        this(new Idea198506Config());
    }

    public Idea198506Service(Idea198506Config config) {
        this.config = config != null ? config : new Idea198506Config();
