...
@Data
public class Idea198147Config {
    private String name = "idea_198147";
 ...
 */
@Slf4j
public class Idea198147Service {
    private static final int IDEA_ID = 198147;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198147Service() {
        this(new Idea198147Config());
    }

    public Idea198147Service(Idea198147Config config) {
        this.config = config != null ? config : new Idea198147Config();
