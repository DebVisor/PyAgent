...
@Data
public class Idea198287Config {
    private String name = "idea_198287";
 ...
 */
@Slf4j
public class Idea198287Service {
    private static final int IDEA_ID = 198287;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198287Service() {
        this(new Idea198287Config());
    }

    public Idea198287Service(Idea198287Config config) {
        this.config = config != null ? config : new Idea198287Config();
