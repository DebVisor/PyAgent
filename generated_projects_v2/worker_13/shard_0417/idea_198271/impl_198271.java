...
@Data
public class Idea198271Config {
    private String name = "idea_198271";
 ...
 */
@Slf4j
public class Idea198271Service {
    private static final int IDEA_ID = 198271;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198271Service() {
        this(new Idea198271Config());
    }

    public Idea198271Service(Idea198271Config config) {
        this.config = config != null ? config : new Idea198271Config();
