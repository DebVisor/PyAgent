...
@Data
public class Idea198456Config {
    private String name = "idea_198456";
 ...
 */
@Slf4j
public class Idea198456Service {
    private static final int IDEA_ID = 198456;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198456Service() {
        this(new Idea198456Config());
    }

    public Idea198456Service(Idea198456Config config) {
        this.config = config != null ? config : new Idea198456Config();
