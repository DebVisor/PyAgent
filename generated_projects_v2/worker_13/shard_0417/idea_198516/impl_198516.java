...
@Data
public class Idea198516Config {
    private String name = "idea_198516";
 ...
 */
@Slf4j
public class Idea198516Service {
    private static final int IDEA_ID = 198516;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198516Service() {
        this(new Idea198516Config());
    }

    public Idea198516Service(Idea198516Config config) {
        this.config = config != null ? config : new Idea198516Config();
