...
@Data
public class Idea198293Config {
    private String name = "idea_198293";
 ...
 */
@Slf4j
public class Idea198293Service {
    private static final int IDEA_ID = 198293;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198293Service() {
        this(new Idea198293Config());
    }

    public Idea198293Service(Idea198293Config config) {
        this.config = config != null ? config : new Idea198293Config();
