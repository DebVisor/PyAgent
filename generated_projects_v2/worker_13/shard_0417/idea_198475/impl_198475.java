...
@Data
public class Idea198475Config {
    private String name = "idea_198475";
 ...
 */
@Slf4j
public class Idea198475Service {
    private static final int IDEA_ID = 198475;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198475Service() {
        this(new Idea198475Config());
    }

    public Idea198475Service(Idea198475Config config) {
        this.config = config != null ? config : new Idea198475Config();
