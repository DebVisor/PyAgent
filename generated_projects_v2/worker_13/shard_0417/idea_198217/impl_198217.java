...
@Data
public class Idea198217Config {
    private String name = "idea_198217";
 ...
 */
@Slf4j
public class Idea198217Service {
    private static final int IDEA_ID = 198217;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198217Service() {
        this(new Idea198217Config());
    }

    public Idea198217Service(Idea198217Config config) {
        this.config = config != null ? config : new Idea198217Config();
