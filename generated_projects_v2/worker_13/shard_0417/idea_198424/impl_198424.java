...
@Data
public class Idea198424Config {
    private String name = "idea_198424";
 ...
 */
@Slf4j
public class Idea198424Service {
    private static final int IDEA_ID = 198424;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198424Service() {
        this(new Idea198424Config());
    }

    public Idea198424Service(Idea198424Config config) {
        this.config = config != null ? config : new Idea198424Config();
