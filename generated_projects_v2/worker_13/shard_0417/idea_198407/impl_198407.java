...
@Data
public class Idea198407Config {
    private String name = "idea_198407";
 ...
 */
@Slf4j
public class Idea198407Service {
    private static final int IDEA_ID = 198407;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198407Service() {
        this(new Idea198407Config());
    }

    public Idea198407Service(Idea198407Config config) {
        this.config = config != null ? config : new Idea198407Config();
