...
@Data
public class Idea198420Config {
    private String name = "idea_198420";
 ...
 */
@Slf4j
public class Idea198420Service {
    private static final int IDEA_ID = 198420;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198420Service() {
        this(new Idea198420Config());
    }

    public Idea198420Service(Idea198420Config config) {
        this.config = config != null ? config : new Idea198420Config();
