...
@Data
public class Idea198499Config {
    private String name = "idea_198499";
 ...
 */
@Slf4j
public class Idea198499Service {
    private static final int IDEA_ID = 198499;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198499Service() {
        this(new Idea198499Config());
    }

    public Idea198499Service(Idea198499Config config) {
        this.config = config != null ? config : new Idea198499Config();
