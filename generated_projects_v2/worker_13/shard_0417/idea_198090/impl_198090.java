...
@Data
public class Idea198090Config {
    private String name = "idea_198090";
 ...
 */
@Slf4j
public class Idea198090Service {
    private static final int IDEA_ID = 198090;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198090Service() {
        this(new Idea198090Config());
    }

    public Idea198090Service(Idea198090Config config) {
        this.config = config != null ? config : new Idea198090Config();
