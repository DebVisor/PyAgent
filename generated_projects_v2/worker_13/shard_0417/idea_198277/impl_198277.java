...
@Data
public class Idea198277Config {
    private String name = "idea_198277";
 ...
 */
@Slf4j
public class Idea198277Service {
    private static final int IDEA_ID = 198277;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198277Service() {
        this(new Idea198277Config());
    }

    public Idea198277Service(Idea198277Config config) {
        this.config = config != null ? config : new Idea198277Config();
