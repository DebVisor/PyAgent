...
@Data
public class Idea198218Config {
    private String name = "idea_198218";
 ...
 */
@Slf4j
public class Idea198218Service {
    private static final int IDEA_ID = 198218;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198218Service() {
        this(new Idea198218Config());
    }

    public Idea198218Service(Idea198218Config config) {
        this.config = config != null ? config : new Idea198218Config();
