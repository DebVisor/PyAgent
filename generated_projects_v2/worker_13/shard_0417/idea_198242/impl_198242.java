...
@Data
public class Idea198242Config {
    private String name = "idea_198242";
 ...
 */
@Slf4j
public class Idea198242Service {
    private static final int IDEA_ID = 198242;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198242Service() {
        this(new Idea198242Config());
    }

    public Idea198242Service(Idea198242Config config) {
        this.config = config != null ? config : new Idea198242Config();
