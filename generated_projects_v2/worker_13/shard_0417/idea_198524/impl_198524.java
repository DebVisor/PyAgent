...
@Data
public class Idea198524Config {
    private String name = "idea_198524";
 ...
 */
@Slf4j
public class Idea198524Service {
    private static final int IDEA_ID = 198524;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198524Service() {
        this(new Idea198524Config());
    }

    public Idea198524Service(Idea198524Config config) {
        this.config = config != null ? config : new Idea198524Config();
