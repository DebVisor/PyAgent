...
@Data
public class Idea198282Config {
    private String name = "idea_198282";
 ...
 */
@Slf4j
public class Idea198282Service {
    private static final int IDEA_ID = 198282;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198282Service() {
        this(new Idea198282Config());
    }

    public Idea198282Service(Idea198282Config config) {
        this.config = config != null ? config : new Idea198282Config();
