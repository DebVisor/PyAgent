...
@Data
public class Idea198377Config {
    private String name = "idea_198377";
 ...
 */
@Slf4j
public class Idea198377Service {
    private static final int IDEA_ID = 198377;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198377Service() {
        this(new Idea198377Config());
    }

    public Idea198377Service(Idea198377Config config) {
        this.config = config != null ? config : new Idea198377Config();
