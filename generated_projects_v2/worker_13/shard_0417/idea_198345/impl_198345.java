...
@Data
public class Idea198345Config {
    private String name = "idea_198345";
 ...
 */
@Slf4j
public class Idea198345Service {
    private static final int IDEA_ID = 198345;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198345Service() {
        this(new Idea198345Config());
    }

    public Idea198345Service(Idea198345Config config) {
        this.config = config != null ? config : new Idea198345Config();
