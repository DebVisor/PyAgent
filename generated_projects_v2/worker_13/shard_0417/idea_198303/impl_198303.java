...
@Data
public class Idea198303Config {
    private String name = "idea_198303";
 ...
 */
@Slf4j
public class Idea198303Service {
    private static final int IDEA_ID = 198303;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198303Service() {
        this(new Idea198303Config());
    }

    public Idea198303Service(Idea198303Config config) {
        this.config = config != null ? config : new Idea198303Config();
