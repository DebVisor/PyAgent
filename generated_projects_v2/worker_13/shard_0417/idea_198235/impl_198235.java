...
@Data
public class Idea198235Config {
    private String name = "idea_198235";
 ...
 */
@Slf4j
public class Idea198235Service {
    private static final int IDEA_ID = 198235;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198235Service() {
        this(new Idea198235Config());
    }

    public Idea198235Service(Idea198235Config config) {
        this.config = config != null ? config : new Idea198235Config();
