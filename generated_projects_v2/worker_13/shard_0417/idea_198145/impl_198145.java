...
@Data
public class Idea198145Config {
    private String name = "idea_198145";
 ...
 */
@Slf4j
public class Idea198145Service {
    private static final int IDEA_ID = 198145;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198145Service() {
        this(new Idea198145Config());
    }

    public Idea198145Service(Idea198145Config config) {
        this.config = config != null ? config : new Idea198145Config();
