...
@Data
public class Idea198530Config {
    private String name = "idea_198530";
 ...
 */
@Slf4j
public class Idea198530Service {
    private static final int IDEA_ID = 198530;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198530Service() {
        this(new Idea198530Config());
    }

    public Idea198530Service(Idea198530Config config) {
        this.config = config != null ? config : new Idea198530Config();
