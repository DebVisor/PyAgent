...
@Data
public class Idea198252Config {
    private String name = "idea_198252";
 ...
 */
@Slf4j
public class Idea198252Service {
    private static final int IDEA_ID = 198252;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198252Service() {
        this(new Idea198252Config());
    }

    public Idea198252Service(Idea198252Config config) {
        this.config = config != null ? config : new Idea198252Config();
