...
@Data
public class Idea198098Config {
    private String name = "idea_198098";
 ...
 */
@Slf4j
public class Idea198098Service {
    private static final int IDEA_ID = 198098;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198098Service() {
        this(new Idea198098Config());
    }

    public Idea198098Service(Idea198098Config config) {
        this.config = config != null ? config : new Idea198098Config();
