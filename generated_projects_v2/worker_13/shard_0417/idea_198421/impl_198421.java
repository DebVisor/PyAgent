...
@Data
public class Idea198421Config {
    private String name = "idea_198421";
 ...
 */
@Slf4j
public class Idea198421Service {
    private static final int IDEA_ID = 198421;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198421Service() {
        this(new Idea198421Config());
    }

    public Idea198421Service(Idea198421Config config) {
        this.config = config != null ? config : new Idea198421Config();
