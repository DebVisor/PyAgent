...
@Data
public class Idea198334Config {
    private String name = "idea_198334";
 ...
 */
@Slf4j
public class Idea198334Service {
    private static final int IDEA_ID = 198334;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198334Service() {
        this(new Idea198334Config());
    }

    public Idea198334Service(Idea198334Config config) {
        this.config = config != null ? config : new Idea198334Config();
