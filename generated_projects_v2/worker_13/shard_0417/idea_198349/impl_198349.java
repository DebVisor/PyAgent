...
@Data
public class Idea198349Config {
    private String name = "idea_198349";
 ...
 */
@Slf4j
public class Idea198349Service {
    private static final int IDEA_ID = 198349;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198349Service() {
        this(new Idea198349Config());
    }

    public Idea198349Service(Idea198349Config config) {
        this.config = config != null ? config : new Idea198349Config();
