...
@Data
public class Idea198367Config {
    private String name = "idea_198367";
 ...
 */
@Slf4j
public class Idea198367Service {
    private static final int IDEA_ID = 198367;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198367Service() {
        this(new Idea198367Config());
    }

    public Idea198367Service(Idea198367Config config) {
        this.config = config != null ? config : new Idea198367Config();
