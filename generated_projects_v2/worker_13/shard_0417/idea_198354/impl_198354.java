...
@Data
public class Idea198354Config {
    private String name = "idea_198354";
 ...
 */
@Slf4j
public class Idea198354Service {
    private static final int IDEA_ID = 198354;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198354Service() {
        this(new Idea198354Config());
    }

    public Idea198354Service(Idea198354Config config) {
        this.config = config != null ? config : new Idea198354Config();
