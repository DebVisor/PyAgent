...
@Data
public class Idea198097Config {
    private String name = "idea_198097";
 ...
 */
@Slf4j
public class Idea198097Service {
    private static final int IDEA_ID = 198097;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198097Service() {
        this(new Idea198097Config());
    }

    public Idea198097Service(Idea198097Config config) {
        this.config = config != null ? config : new Idea198097Config();
