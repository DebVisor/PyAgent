...
@Data
public class Idea198094Config {
    private String name = "idea_198094";
 ...
 */
@Slf4j
public class Idea198094Service {
    private static final int IDEA_ID = 198094;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198094Service() {
        this(new Idea198094Config());
    }

    public Idea198094Service(Idea198094Config config) {
        this.config = config != null ? config : new Idea198094Config();
