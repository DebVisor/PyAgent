...
@Data
public class Idea198508Config {
    private String name = "idea_198508";
 ...
 */
@Slf4j
public class Idea198508Service {
    private static final int IDEA_ID = 198508;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198508Service() {
        this(new Idea198508Config());
    }

    public Idea198508Service(Idea198508Config config) {
        this.config = config != null ? config : new Idea198508Config();
