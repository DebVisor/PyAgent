...
@Data
public class Idea198138Config {
    private String name = "idea_198138";
 ...
 */
@Slf4j
public class Idea198138Service {
    private static final int IDEA_ID = 198138;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198138Service() {
        this(new Idea198138Config());
    }

    public Idea198138Service(Idea198138Config config) {
        this.config = config != null ? config : new Idea198138Config();
