...
@Data
public class Idea198457Config {
    private String name = "idea_198457";
 ...
 */
@Slf4j
public class Idea198457Service {
    private static final int IDEA_ID = 198457;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198457Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198457Service() {
        this(new Idea198457Config());
    }

    public Idea198457Service(Idea198457Config config) {
        this.config = config != null ? config : new Idea198457Config();
