...
@Data
public class Idea198467Config {
    private String name = "idea_198467";
 ...
 */
@Slf4j
public class Idea198467Service {
    private static final int IDEA_ID = 198467;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198467Service() {
        this(new Idea198467Config());
    }

    public Idea198467Service(Idea198467Config config) {
        this.config = config != null ? config : new Idea198467Config();
