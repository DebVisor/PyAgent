...
@Data
public class Idea198440Config {
    private String name = "idea_198440";
 ...
 */
@Slf4j
public class Idea198440Service {
    private static final int IDEA_ID = 198440;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198440Service() {
        this(new Idea198440Config());
    }

    public Idea198440Service(Idea198440Config config) {
        this.config = config != null ? config : new Idea198440Config();
