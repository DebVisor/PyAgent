...
@Data
public class Idea198468Config {
    private String name = "idea_198468";
 ...
 */
@Slf4j
public class Idea198468Service {
    private static final int IDEA_ID = 198468;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198468Service() {
        this(new Idea198468Config());
    }

    public Idea198468Service(Idea198468Config config) {
        this.config = config != null ? config : new Idea198468Config();
