...
@Data
public class Idea198490Config {
    private String name = "idea_198490";
 ...
 */
@Slf4j
public class Idea198490Service {
    private static final int IDEA_ID = 198490;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198490Service() {
        this(new Idea198490Config());
    }

    public Idea198490Service(Idea198490Config config) {
        this.config = config != null ? config : new Idea198490Config();
