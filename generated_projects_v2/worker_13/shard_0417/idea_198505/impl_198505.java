...
@Data
public class Idea198505Config {
    private String name = "idea_198505";
 ...
 */
@Slf4j
public class Idea198505Service {
    private static final int IDEA_ID = 198505;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198505Service() {
        this(new Idea198505Config());
    }

    public Idea198505Service(Idea198505Config config) {
        this.config = config != null ? config : new Idea198505Config();
