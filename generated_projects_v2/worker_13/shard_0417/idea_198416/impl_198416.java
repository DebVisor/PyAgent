...
@Data
public class Idea198416Config {
    private String name = "idea_198416";
 ...
 */
@Slf4j
public class Idea198416Service {
    private static final int IDEA_ID = 198416;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198416Service() {
        this(new Idea198416Config());
    }

    public Idea198416Service(Idea198416Config config) {
        this.config = config != null ? config : new Idea198416Config();
