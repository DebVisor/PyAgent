...
@Data
public class Idea198281Config {
    private String name = "idea_198281";
 ...
 */
@Slf4j
public class Idea198281Service {
    private static final int IDEA_ID = 198281;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198281Service() {
        this(new Idea198281Config());
    }

    public Idea198281Service(Idea198281Config config) {
        this.config = config != null ? config : new Idea198281Config();
