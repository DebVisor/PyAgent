...
@Data
public class Idea198087Config {
    private String name = "idea_198087";
 ...
 */
@Slf4j
public class Idea198087Service {
    private static final int IDEA_ID = 198087;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198087Service() {
        this(new Idea198087Config());
    }

    public Idea198087Service(Idea198087Config config) {
        this.config = config != null ? config : new Idea198087Config();
