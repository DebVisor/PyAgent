...
@Data
public class Idea198216Config {
    private String name = "idea_198216";
 ...
 */
@Slf4j
public class Idea198216Service {
    private static final int IDEA_ID = 198216;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198216Service() {
        this(new Idea198216Config());
    }

    public Idea198216Service(Idea198216Config config) {
        this.config = config != null ? config : new Idea198216Config();
