...
@Data
public class Idea198170Config {
    private String name = "idea_198170";
 ...
 */
@Slf4j
public class Idea198170Service {
    private static final int IDEA_ID = 198170;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198170Service() {
        this(new Idea198170Config());
    }

    public Idea198170Service(Idea198170Config config) {
        this.config = config != null ? config : new Idea198170Config();
