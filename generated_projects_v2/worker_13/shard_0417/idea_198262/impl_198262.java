...
@Data
public class Idea198262Config {
    private String name = "idea_198262";
 ...
 */
@Slf4j
public class Idea198262Service {
    private static final int IDEA_ID = 198262;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198262Service() {
        this(new Idea198262Config());
    }

    public Idea198262Service(Idea198262Config config) {
        this.config = config != null ? config : new Idea198262Config();
