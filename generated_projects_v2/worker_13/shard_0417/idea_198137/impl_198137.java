...
@Data
public class Idea198137Config {
    private String name = "idea_198137";
 ...
 */
@Slf4j
public class Idea198137Service {
    private static final int IDEA_ID = 198137;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198137Service() {
        this(new Idea198137Config());
    }

    public Idea198137Service(Idea198137Config config) {
        this.config = config != null ? config : new Idea198137Config();
