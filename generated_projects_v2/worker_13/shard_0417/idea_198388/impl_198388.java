...
@Data
public class Idea198388Config {
    private String name = "idea_198388";
 ...
 */
@Slf4j
public class Idea198388Service {
    private static final int IDEA_ID = 198388;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198388Service() {
        this(new Idea198388Config());
    }

    public Idea198388Service(Idea198388Config config) {
        this.config = config != null ? config : new Idea198388Config();
