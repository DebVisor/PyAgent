...
@Data
public class Idea198269Config {
    private String name = "idea_198269";
 ...
 */
@Slf4j
public class Idea198269Service {
    private static final int IDEA_ID = 198269;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198269Service() {
        this(new Idea198269Config());
    }

    public Idea198269Service(Idea198269Config config) {
        this.config = config != null ? config : new Idea198269Config();
