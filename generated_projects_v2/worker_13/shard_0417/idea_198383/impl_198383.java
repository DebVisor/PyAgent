...
@Data
public class Idea198383Config {
    private String name = "idea_198383";
 ...
 */
@Slf4j
public class Idea198383Service {
    private static final int IDEA_ID = 198383;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198383Service() {
        this(new Idea198383Config());
    }

    public Idea198383Service(Idea198383Config config) {
        this.config = config != null ? config : new Idea198383Config();
