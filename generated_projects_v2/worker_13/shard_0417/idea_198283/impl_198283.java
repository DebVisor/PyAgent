...
@Data
public class Idea198283Config {
    private String name = "idea_198283";
 ...
 */
@Slf4j
public class Idea198283Service {
    private static final int IDEA_ID = 198283;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198283Service() {
        this(new Idea198283Config());
    }

    public Idea198283Service(Idea198283Config config) {
        this.config = config != null ? config : new Idea198283Config();
