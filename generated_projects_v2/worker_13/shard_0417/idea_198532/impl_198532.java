...
@Data
public class Idea198532Config {
    private String name = "idea_198532";
 ...
 */
@Slf4j
public class Idea198532Service {
    private static final int IDEA_ID = 198532;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198532Service() {
        this(new Idea198532Config());
    }

    public Idea198532Service(Idea198532Config config) {
        this.config = config != null ? config : new Idea198532Config();
