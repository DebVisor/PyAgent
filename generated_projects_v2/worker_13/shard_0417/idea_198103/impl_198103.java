...
@Data
public class Idea198103Config {
    private String name = "idea_198103";
 ...
 */
@Slf4j
public class Idea198103Service {
    private static final int IDEA_ID = 198103;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198103Service() {
        this(new Idea198103Config());
    }

    public Idea198103Service(Idea198103Config config) {
        this.config = config != null ? config : new Idea198103Config();
