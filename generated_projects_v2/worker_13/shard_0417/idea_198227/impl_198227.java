...
@Data
public class Idea198227Config {
    private String name = "idea_198227";
 ...
 */
@Slf4j
public class Idea198227Service {
    private static final int IDEA_ID = 198227;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198227Service() {
        this(new Idea198227Config());
    }

    public Idea198227Service(Idea198227Config config) {
        this.config = config != null ? config : new Idea198227Config();
