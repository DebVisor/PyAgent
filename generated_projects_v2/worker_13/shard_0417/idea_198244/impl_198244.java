...
@Data
public class Idea198244Config {
    private String name = "idea_198244";
 ...
 */
@Slf4j
public class Idea198244Service {
    private static final int IDEA_ID = 198244;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198244Service() {
        this(new Idea198244Config());
    }

    public Idea198244Service(Idea198244Config config) {
        this.config = config != null ? config : new Idea198244Config();
