...
@Data
public class Idea198156Config {
    private String name = "idea_198156";
 ...
 */
@Slf4j
public class Idea198156Service {
    private static final int IDEA_ID = 198156;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198156Service() {
        this(new Idea198156Config());
    }

    public Idea198156Service(Idea198156Config config) {
        this.config = config != null ? config : new Idea198156Config();
