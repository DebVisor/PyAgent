...
@Data
public class Idea198322Config {
    private String name = "idea_198322";
 ...
 */
@Slf4j
public class Idea198322Service {
    private static final int IDEA_ID = 198322;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198322Service() {
        this(new Idea198322Config());
    }

    public Idea198322Service(Idea198322Config config) {
        this.config = config != null ? config : new Idea198322Config();
