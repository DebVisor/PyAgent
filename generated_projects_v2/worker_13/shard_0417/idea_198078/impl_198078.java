...
@Data
public class Idea198078Config {
    private String name = "idea_198078";
 ...
 */
@Slf4j
public class Idea198078Service {
    private static final int IDEA_ID = 198078;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198078Service() {
        this(new Idea198078Config());
    }

    public Idea198078Service(Idea198078Config config) {
        this.config = config != null ? config : new Idea198078Config();
