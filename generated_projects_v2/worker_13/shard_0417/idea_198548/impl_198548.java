...
@Data
public class Idea198548Config {
    private String name = "idea_198548";
 ...
 */
@Slf4j
public class Idea198548Service {
    private static final int IDEA_ID = 198548;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198548Service() {
        this(new Idea198548Config());
    }

    public Idea198548Service(Idea198548Config config) {
        this.config = config != null ? config : new Idea198548Config();
