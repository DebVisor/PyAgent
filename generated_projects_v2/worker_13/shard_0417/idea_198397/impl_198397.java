...
@Data
public class Idea198397Config {
    private String name = "idea_198397";
 ...
 */
@Slf4j
public class Idea198397Service {
    private static final int IDEA_ID = 198397;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198397Service() {
        this(new Idea198397Config());
    }

    public Idea198397Service(Idea198397Config config) {
        this.config = config != null ? config : new Idea198397Config();
