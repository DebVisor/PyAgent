...
@Data
public class Idea198373Config {
    private String name = "idea_198373";
 ...
 */
@Slf4j
public class Idea198373Service {
    private static final int IDEA_ID = 198373;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198373Service() {
        this(new Idea198373Config());
    }

    public Idea198373Service(Idea198373Config config) {
        this.config = config != null ? config : new Idea198373Config();
