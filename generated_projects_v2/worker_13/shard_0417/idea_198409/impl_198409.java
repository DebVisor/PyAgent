...
@Data
public class Idea198409Config {
    private String name = "idea_198409";
 ...
 */
@Slf4j
public class Idea198409Service {
    private static final int IDEA_ID = 198409;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198409Service() {
        this(new Idea198409Config());
    }

    public Idea198409Service(Idea198409Config config) {
        this.config = config != null ? config : new Idea198409Config();
