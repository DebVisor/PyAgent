...
@Data
public class Idea198443Config {
    private String name = "idea_198443";
 ...
 */
@Slf4j
public class Idea198443Service {
    private static final int IDEA_ID = 198443;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198443Service() {
        this(new Idea198443Config());
    }

    public Idea198443Service(Idea198443Config config) {
        this.config = config != null ? config : new Idea198443Config();
