...
@Data
public class Idea198206Config {
    private String name = "idea_198206";
 ...
 */
@Slf4j
public class Idea198206Service {
    private static final int IDEA_ID = 198206;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198206Service() {
        this(new Idea198206Config());
    }

    public Idea198206Service(Idea198206Config config) {
        this.config = config != null ? config : new Idea198206Config();
