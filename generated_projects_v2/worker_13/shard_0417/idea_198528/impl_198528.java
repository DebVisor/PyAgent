...
@Data
public class Idea198528Config {
    private String name = "idea_198528";
 ...
 */
@Slf4j
public class Idea198528Service {
    private static final int IDEA_ID = 198528;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198528Service() {
        this(new Idea198528Config());
    }

    public Idea198528Service(Idea198528Config config) {
        this.config = config != null ? config : new Idea198528Config();
