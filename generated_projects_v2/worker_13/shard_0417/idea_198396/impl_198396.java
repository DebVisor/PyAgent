...
@Data
public class Idea198396Config {
    private String name = "idea_198396";
 ...
 */
@Slf4j
public class Idea198396Service {
    private static final int IDEA_ID = 198396;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198396Service() {
        this(new Idea198396Config());
    }

    public Idea198396Service(Idea198396Config config) {
        this.config = config != null ? config : new Idea198396Config();
