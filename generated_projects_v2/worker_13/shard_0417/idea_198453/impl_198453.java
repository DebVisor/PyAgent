...
@Data
public class Idea198453Config {
    private String name = "idea_198453";
 ...
 */
@Slf4j
public class Idea198453Service {
    private static final int IDEA_ID = 198453;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198453Service() {
        this(new Idea198453Config());
    }

    public Idea198453Service(Idea198453Config config) {
        this.config = config != null ? config : new Idea198453Config();
