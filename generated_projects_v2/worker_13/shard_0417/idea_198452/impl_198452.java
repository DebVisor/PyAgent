...
@Data
public class Idea198452Config {
    private String name = "idea_198452";
 ...
 */
@Slf4j
public class Idea198452Service {
    private static final int IDEA_ID = 198452;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198452Service() {
        this(new Idea198452Config());
    }

    public Idea198452Service(Idea198452Config config) {
        this.config = config != null ? config : new Idea198452Config();
