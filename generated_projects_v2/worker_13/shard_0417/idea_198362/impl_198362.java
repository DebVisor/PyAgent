...
@Data
public class Idea198362Config {
    private String name = "idea_198362";
 ...
 */
@Slf4j
public class Idea198362Service {
    private static final int IDEA_ID = 198362;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198362Service() {
        this(new Idea198362Config());
    }

    public Idea198362Service(Idea198362Config config) {
        this.config = config != null ? config : new Idea198362Config();
