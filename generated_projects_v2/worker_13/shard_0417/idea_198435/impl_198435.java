...
@Data
public class Idea198435Config {
    private String name = "idea_198435";
 ...
 */
@Slf4j
public class Idea198435Service {
    private static final int IDEA_ID = 198435;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198435Service() {
        this(new Idea198435Config());
    }

    public Idea198435Service(Idea198435Config config) {
        this.config = config != null ? config : new Idea198435Config();
