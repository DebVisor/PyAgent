...
@Data
public class Idea198485Config {
    private String name = "idea_198485";
 ...
 */
@Slf4j
public class Idea198485Service {
    private static final int IDEA_ID = 198485;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198485Service() {
        this(new Idea198485Config());
    }

    public Idea198485Service(Idea198485Config config) {
        this.config = config != null ? config : new Idea198485Config();
