...
@Data
public class Idea198379Config {
    private String name = "idea_198379";
 ...
 */
@Slf4j
public class Idea198379Service {
    private static final int IDEA_ID = 198379;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198379Service() {
        this(new Idea198379Config());
    }

    public Idea198379Service(Idea198379Config config) {
        this.config = config != null ? config : new Idea198379Config();
