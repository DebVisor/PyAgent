...
@Data
public class Idea198134Config {
    private String name = "idea_198134";
 ...
 */
@Slf4j
public class Idea198134Service {
    private static final int IDEA_ID = 198134;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198134Service() {
        this(new Idea198134Config());
    }

    public Idea198134Service(Idea198134Config config) {
        this.config = config != null ? config : new Idea198134Config();
