...
@Data
public class Idea198413Config {
    private String name = "idea_198413";
 ...
 */
@Slf4j
public class Idea198413Service {
    private static final int IDEA_ID = 198413;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198413Service() {
        this(new Idea198413Config());
    }

    public Idea198413Service(Idea198413Config config) {
        this.config = config != null ? config : new Idea198413Config();
