...
@Data
public class Idea198408Config {
    private String name = "idea_198408";
 ...
 */
@Slf4j
public class Idea198408Service {
    private static final int IDEA_ID = 198408;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198408Service() {
        this(new Idea198408Config());
    }

    public Idea198408Service(Idea198408Config config) {
        this.config = config != null ? config : new Idea198408Config();
