...
@Data
public class Idea198525Config {
    private String name = "idea_198525";
 ...
 */
@Slf4j
public class Idea198525Service {
    private static final int IDEA_ID = 198525;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198525Service() {
        this(new Idea198525Config());
    }

    public Idea198525Service(Idea198525Config config) {
        this.config = config != null ? config : new Idea198525Config();
