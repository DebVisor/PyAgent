...
@Data
public class Idea198316Config {
    private String name = "idea_198316";
 ...
 */
@Slf4j
public class Idea198316Service {
    private static final int IDEA_ID = 198316;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198316Service() {
        this(new Idea198316Config());
    }

    public Idea198316Service(Idea198316Config config) {
        this.config = config != null ? config : new Idea198316Config();
