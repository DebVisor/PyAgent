...
@Data
public class Idea198223Config {
    private String name = "idea_198223";
 ...
 */
@Slf4j
public class Idea198223Service {
    private static final int IDEA_ID = 198223;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198223Service() {
        this(new Idea198223Config());
    }

    public Idea198223Service(Idea198223Config config) {
        this.config = config != null ? config : new Idea198223Config();
