...
@Data
public class Idea198502Config {
    private String name = "idea_198502";
 ...
 */
@Slf4j
public class Idea198502Service {
    private static final int IDEA_ID = 198502;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198502Service() {
        this(new Idea198502Config());
    }

    public Idea198502Service(Idea198502Config config) {
        this.config = config != null ? config : new Idea198502Config();
