...
@Data
public class Idea198523Config {
    private String name = "idea_198523";
 ...
 */
@Slf4j
public class Idea198523Service {
    private static final int IDEA_ID = 198523;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198523Service() {
        this(new Idea198523Config());
    }

    public Idea198523Service(Idea198523Config config) {
        this.config = config != null ? config : new Idea198523Config();
