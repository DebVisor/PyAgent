...
@Data
public class Idea198361Config {
    private String name = "idea_198361";
 ...
 */
@Slf4j
public class Idea198361Service {
    private static final int IDEA_ID = 198361;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198361Service() {
        this(new Idea198361Config());
    }

    public Idea198361Service(Idea198361Config config) {
        this.config = config != null ? config : new Idea198361Config();
