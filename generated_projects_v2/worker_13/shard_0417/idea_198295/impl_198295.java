...
@Data
public class Idea198295Config {
    private String name = "idea_198295";
 ...
 */
@Slf4j
public class Idea198295Service {
    private static final int IDEA_ID = 198295;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198295Service() {
        this(new Idea198295Config());
    }

    public Idea198295Service(Idea198295Config config) {
        this.config = config != null ? config : new Idea198295Config();
