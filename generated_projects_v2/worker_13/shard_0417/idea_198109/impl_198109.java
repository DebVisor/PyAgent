...
@Data
public class Idea198109Config {
    private String name = "idea_198109";
 ...
 */
@Slf4j
public class Idea198109Service {
    private static final int IDEA_ID = 198109;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198109Service() {
        this(new Idea198109Config());
    }

    public Idea198109Service(Idea198109Config config) {
        this.config = config != null ? config : new Idea198109Config();
