...
@Data
public class Idea198338Config {
    private String name = "idea_198338";
 ...
 */
@Slf4j
public class Idea198338Service {
    private static final int IDEA_ID = 198338;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198338Service() {
        this(new Idea198338Config());
    }

    public Idea198338Service(Idea198338Config config) {
        this.config = config != null ? config : new Idea198338Config();
