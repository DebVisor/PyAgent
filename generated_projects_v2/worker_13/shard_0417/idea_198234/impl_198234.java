...
@Data
public class Idea198234Config {
    private String name = "idea_198234";
 ...
 */
@Slf4j
public class Idea198234Service {
    private static final int IDEA_ID = 198234;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198234Service() {
        this(new Idea198234Config());
    }

    public Idea198234Service(Idea198234Config config) {
        this.config = config != null ? config : new Idea198234Config();
