...
@Data
public class Idea198540Config {
    private String name = "idea_198540";
 ...
 */
@Slf4j
public class Idea198540Service {
    private static final int IDEA_ID = 198540;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198540Service() {
        this(new Idea198540Config());
    }

    public Idea198540Service(Idea198540Config config) {
        this.config = config != null ? config : new Idea198540Config();
