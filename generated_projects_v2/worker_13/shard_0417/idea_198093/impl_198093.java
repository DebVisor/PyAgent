...
@Data
public class Idea198093Config {
    private String name = "idea_198093";
 ...
 */
@Slf4j
public class Idea198093Service {
    private static final int IDEA_ID = 198093;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198093Service() {
        this(new Idea198093Config());
    }

    public Idea198093Service(Idea198093Config config) {
        this.config = config != null ? config : new Idea198093Config();
