...
@Data
public class Idea198374Config {
    private String name = "idea_198374";
 ...
 */
@Slf4j
public class Idea198374Service {
    private static final int IDEA_ID = 198374;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198374Service() {
        this(new Idea198374Config());
    }

    public Idea198374Service(Idea198374Config config) {
        this.config = config != null ? config : new Idea198374Config();
