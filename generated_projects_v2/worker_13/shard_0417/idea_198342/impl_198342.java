...
@Data
public class Idea198342Config {
    private String name = "idea_198342";
 ...
 */
@Slf4j
public class Idea198342Service {
    private static final int IDEA_ID = 198342;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198342Service() {
        this(new Idea198342Config());
    }

    public Idea198342Service(Idea198342Config config) {
        this.config = config != null ? config : new Idea198342Config();
