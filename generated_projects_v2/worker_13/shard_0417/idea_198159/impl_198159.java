...
@Data
public class Idea198159Config {
    private String name = "idea_198159";
 ...
 */
@Slf4j
public class Idea198159Service {
    private static final int IDEA_ID = 198159;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198159Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198159Service() {
        this(new Idea198159Config());
    }

    public Idea198159Service(Idea198159Config config) {
        this.config = config != null ? config : new Idea198159Config();
