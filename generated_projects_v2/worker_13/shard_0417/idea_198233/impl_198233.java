...
@Data
public class Idea198233Config {
    private String name = "idea_198233";
 ...
 */
@Slf4j
public class Idea198233Service {
    private static final int IDEA_ID = 198233;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198233Service() {
        this(new Idea198233Config());
    }

    public Idea198233Service(Idea198233Config config) {
        this.config = config != null ? config : new Idea198233Config();
