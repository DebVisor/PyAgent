...
@Data
public class Idea198529Config {
    private String name = "idea_198529";
 ...
 */
@Slf4j
public class Idea198529Service {
    private static final int IDEA_ID = 198529;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198529Service() {
        this(new Idea198529Config());
    }

    public Idea198529Service(Idea198529Config config) {
        this.config = config != null ? config : new Idea198529Config();
