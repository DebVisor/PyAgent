...
@Data
public class Idea198341Config {
    private String name = "idea_198341";
 ...
 */
@Slf4j
public class Idea198341Service {
    private static final int IDEA_ID = 198341;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198341Service() {
        this(new Idea198341Config());
    }

    public Idea198341Service(Idea198341Config config) {
        this.config = config != null ? config : new Idea198341Config();
