...
@Data
public class Idea198083Config {
    private String name = "idea_198083";
 ...
 */
@Slf4j
public class Idea198083Service {
    private static final int IDEA_ID = 198083;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198083Service() {
        this(new Idea198083Config());
    }

    public Idea198083Service(Idea198083Config config) {
        this.config = config != null ? config : new Idea198083Config();
