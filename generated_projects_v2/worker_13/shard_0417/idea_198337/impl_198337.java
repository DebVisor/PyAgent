...
@Data
public class Idea198337Config {
    private String name = "idea_198337";
 ...
 */
@Slf4j
public class Idea198337Service {
    private static final int IDEA_ID = 198337;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198337Service() {
        this(new Idea198337Config());
    }

    public Idea198337Service(Idea198337Config config) {
        this.config = config != null ? config : new Idea198337Config();
