...
@Data
public class Idea198394Config {
    private String name = "idea_198394";
 ...
 */
@Slf4j
public class Idea198394Service {
    private static final int IDEA_ID = 198394;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198394Service() {
        this(new Idea198394Config());
    }

    public Idea198394Service(Idea198394Config config) {
        this.config = config != null ? config : new Idea198394Config();
