...
@Data
public class Idea198363Config {
    private String name = "idea_198363";
 ...
 */
@Slf4j
public class Idea198363Service {
    private static final int IDEA_ID = 198363;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198363Service() {
        this(new Idea198363Config());
    }

    public Idea198363Service(Idea198363Config config) {
        this.config = config != null ? config : new Idea198363Config();
