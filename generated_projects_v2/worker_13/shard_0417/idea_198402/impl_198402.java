...
@Data
public class Idea198402Config {
    private String name = "idea_198402";
 ...
 */
@Slf4j
public class Idea198402Service {
    private static final int IDEA_ID = 198402;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198402Service() {
        this(new Idea198402Config());
    }

    public Idea198402Service(Idea198402Config config) {
        this.config = config != null ? config : new Idea198402Config();
