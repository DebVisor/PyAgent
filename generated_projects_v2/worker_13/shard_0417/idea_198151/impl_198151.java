...
@Data
public class Idea198151Config {
    private String name = "idea_198151";
 ...
 */
@Slf4j
public class Idea198151Service {
    private static final int IDEA_ID = 198151;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198151Service() {
        this(new Idea198151Config());
    }

    public Idea198151Service(Idea198151Config config) {
        this.config = config != null ? config : new Idea198151Config();
