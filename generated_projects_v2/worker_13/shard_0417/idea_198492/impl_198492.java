...
@Data
public class Idea198492Config {
    private String name = "idea_198492";
 ...
 */
@Slf4j
public class Idea198492Service {
    private static final int IDEA_ID = 198492;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198492Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198492Service() {
        this(new Idea198492Config());
    }

    public Idea198492Service(Idea198492Config config) {
        this.config = config != null ? config : new Idea198492Config();
