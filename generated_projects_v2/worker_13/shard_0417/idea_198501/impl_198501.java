...
@Data
public class Idea198501Config {
    private String name = "idea_198501";
 ...
 */
@Slf4j
public class Idea198501Service {
    private static final int IDEA_ID = 198501;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198501Service() {
        this(new Idea198501Config());
    }

    public Idea198501Service(Idea198501Config config) {
        this.config = config != null ? config : new Idea198501Config();
