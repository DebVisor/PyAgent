...
@Data
public class Idea198275Config {
    private String name = "idea_198275";
 ...
 */
@Slf4j
public class Idea198275Service {
    private static final int IDEA_ID = 198275;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198275Service() {
        this(new Idea198275Config());
    }

    public Idea198275Service(Idea198275Config config) {
        this.config = config != null ? config : new Idea198275Config();
