...
@Data
public class Idea198389Config {
    private String name = "idea_198389";
 ...
 */
@Slf4j
public class Idea198389Service {
    private static final int IDEA_ID = 198389;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198389Service() {
        this(new Idea198389Config());
    }

    public Idea198389Service(Idea198389Config config) {
        this.config = config != null ? config : new Idea198389Config();
