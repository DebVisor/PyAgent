...
@Data
public class Idea198219Config {
    private String name = "idea_198219";
 ...
 */
@Slf4j
public class Idea198219Service {
    private static final int IDEA_ID = 198219;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198219Service() {
        this(new Idea198219Config());
    }

    public Idea198219Service(Idea198219Config config) {
        this.config = config != null ? config : new Idea198219Config();
