...
@Data
public class Idea198438Config {
    private String name = "idea_198438";
 ...
 */
@Slf4j
public class Idea198438Service {
    private static final int IDEA_ID = 198438;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198438Service() {
        this(new Idea198438Config());
    }

    public Idea198438Service(Idea198438Config config) {
        this.config = config != null ? config : new Idea198438Config();
