...
@Data
public class Idea198290Config {
    private String name = "idea_198290";
 ...
 */
@Slf4j
public class Idea198290Service {
    private static final int IDEA_ID = 198290;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198290Service() {
        this(new Idea198290Config());
    }

    public Idea198290Service(Idea198290Config config) {
        this.config = config != null ? config : new Idea198290Config();
