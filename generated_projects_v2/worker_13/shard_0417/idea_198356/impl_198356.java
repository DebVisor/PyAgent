...
@Data
public class Idea198356Config {
    private String name = "idea_198356";
 ...
 */
@Slf4j
public class Idea198356Service {
    private static final int IDEA_ID = 198356;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198356Service() {
        this(new Idea198356Config());
    }

    public Idea198356Service(Idea198356Config config) {
        this.config = config != null ? config : new Idea198356Config();
