...
@Data
public class Idea198426Config {
    private String name = "idea_198426";
 ...
 */
@Slf4j
public class Idea198426Service {
    private static final int IDEA_ID = 198426;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198426Service() {
        this(new Idea198426Config());
    }

    public Idea198426Service(Idea198426Config config) {
        this.config = config != null ? config : new Idea198426Config();
