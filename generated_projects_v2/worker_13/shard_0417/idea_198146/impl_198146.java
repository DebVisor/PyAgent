...
@Data
public class Idea198146Config {
    private String name = "idea_198146";
 ...
 */
@Slf4j
public class Idea198146Service {
    private static final int IDEA_ID = 198146;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198146Service() {
        this(new Idea198146Config());
    }

    public Idea198146Service(Idea198146Config config) {
        this.config = config != null ? config : new Idea198146Config();
