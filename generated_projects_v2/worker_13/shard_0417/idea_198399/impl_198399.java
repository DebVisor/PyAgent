...
@Data
public class Idea198399Config {
    private String name = "idea_198399";
 ...
 */
@Slf4j
public class Idea198399Service {
    private static final int IDEA_ID = 198399;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198399Service() {
        this(new Idea198399Config());
    }

    public Idea198399Service(Idea198399Config config) {
        this.config = config != null ? config : new Idea198399Config();
