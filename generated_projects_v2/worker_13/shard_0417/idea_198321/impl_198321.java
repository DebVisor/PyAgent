...
@Data
public class Idea198321Config {
    private String name = "idea_198321";
 ...
 */
@Slf4j
public class Idea198321Service {
    private static final int IDEA_ID = 198321;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198321Service() {
        this(new Idea198321Config());
    }

    public Idea198321Service(Idea198321Config config) {
        this.config = config != null ? config : new Idea198321Config();
