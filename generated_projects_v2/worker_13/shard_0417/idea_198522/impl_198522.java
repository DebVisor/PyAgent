...
@Data
public class Idea198522Config {
    private String name = "idea_198522";
 ...
 */
@Slf4j
public class Idea198522Service {
    private static final int IDEA_ID = 198522;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198522Service() {
        this(new Idea198522Config());
    }

    public Idea198522Service(Idea198522Config config) {
        this.config = config != null ? config : new Idea198522Config();
