...
@Data
public class Idea198264Config {
    private String name = "idea_198264";
 ...
 */
@Slf4j
public class Idea198264Service {
    private static final int IDEA_ID = 198264;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198264Service() {
        this(new Idea198264Config());
    }

    public Idea198264Service(Idea198264Config config) {
        this.config = config != null ? config : new Idea198264Config();
