...
@Data
public class Idea198364Config {
    private String name = "idea_198364";
 ...
 */
@Slf4j
public class Idea198364Service {
    private static final int IDEA_ID = 198364;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198364Service() {
        this(new Idea198364Config());
    }

    public Idea198364Service(Idea198364Config config) {
        this.config = config != null ? config : new Idea198364Config();
