...
@Data
public class Idea198154Config {
    private String name = "idea_198154";
 ...
 */
@Slf4j
public class Idea198154Service {
    private static final int IDEA_ID = 198154;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198154Service() {
        this(new Idea198154Config());
    }

    public Idea198154Service(Idea198154Config config) {
        this.config = config != null ? config : new Idea198154Config();
