...
@Data
public class Idea198507Config {
    private String name = "idea_198507";
 ...
 */
@Slf4j
public class Idea198507Service {
    private static final int IDEA_ID = 198507;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198507Service() {
        this(new Idea198507Config());
    }

    public Idea198507Service(Idea198507Config config) {
        this.config = config != null ? config : new Idea198507Config();
