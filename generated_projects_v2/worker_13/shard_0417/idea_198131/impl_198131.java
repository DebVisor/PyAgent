...
@Data
public class Idea198131Config {
    private String name = "idea_198131";
 ...
 */
@Slf4j
public class Idea198131Service {
    private static final int IDEA_ID = 198131;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198131Service() {
        this(new Idea198131Config());
    }

    public Idea198131Service(Idea198131Config config) {
        this.config = config != null ? config : new Idea198131Config();
