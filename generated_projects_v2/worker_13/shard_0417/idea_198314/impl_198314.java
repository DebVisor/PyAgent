...
@Data
public class Idea198314Config {
    private String name = "idea_198314";
 ...
 */
@Slf4j
public class Idea198314Service {
    private static final int IDEA_ID = 198314;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198314Service() {
        this(new Idea198314Config());
    }

    public Idea198314Service(Idea198314Config config) {
        this.config = config != null ? config : new Idea198314Config();
