...
@Data
public class Idea198272Config {
    private String name = "idea_198272";
 ...
 */
@Slf4j
public class Idea198272Service {
    private static final int IDEA_ID = 198272;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198272Service() {
        this(new Idea198272Config());
    }

    public Idea198272Service(Idea198272Config config) {
        this.config = config != null ? config : new Idea198272Config();
