...
@Data
public class Idea198199Config {
    private String name = "idea_198199";
 ...
 */
@Slf4j
public class Idea198199Service {
    private static final int IDEA_ID = 198199;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198199Service() {
        this(new Idea198199Config());
    }

    public Idea198199Service(Idea198199Config config) {
        this.config = config != null ? config : new Idea198199Config();
