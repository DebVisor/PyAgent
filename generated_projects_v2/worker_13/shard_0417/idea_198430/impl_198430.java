...
@Data
public class Idea198430Config {
    private String name = "idea_198430";
 ...
 */
@Slf4j
public class Idea198430Service {
    private static final int IDEA_ID = 198430;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198430Service() {
        this(new Idea198430Config());
    }

    public Idea198430Service(Idea198430Config config) {
        this.config = config != null ? config : new Idea198430Config();
