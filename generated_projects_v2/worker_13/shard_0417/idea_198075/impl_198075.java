...
@Data
public class Idea198075Config {
    private String name = "idea_198075";
 ...
 */
@Slf4j
public class Idea198075Service {
    private static final int IDEA_ID = 198075;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198075Service() {
        this(new Idea198075Config());
    }

    public Idea198075Service(Idea198075Config config) {
        this.config = config != null ? config : new Idea198075Config();
