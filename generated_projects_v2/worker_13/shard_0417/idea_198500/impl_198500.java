...
@Data
public class Idea198500Config {
    private String name = "idea_198500";
 ...
 */
@Slf4j
public class Idea198500Service {
    private static final int IDEA_ID = 198500;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198500Service() {
        this(new Idea198500Config());
    }

    public Idea198500Service(Idea198500Config config) {
        this.config = config != null ? config : new Idea198500Config();
