...
@Data
public class Idea198194Config {
    private String name = "idea_198194";
 ...
 */
@Slf4j
public class Idea198194Service {
    private static final int IDEA_ID = 198194;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198194Service() {
        this(new Idea198194Config());
    }

    public Idea198194Service(Idea198194Config config) {
        this.config = config != null ? config : new Idea198194Config();
