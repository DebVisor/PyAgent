...
@Data
public class Idea198392Config {
    private String name = "idea_198392";
 ...
 */
@Slf4j
public class Idea198392Service {
    private static final int IDEA_ID = 198392;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198392Service() {
        this(new Idea198392Config());
    }

    public Idea198392Service(Idea198392Config config) {
        this.config = config != null ? config : new Idea198392Config();
