...
@Data
public class Idea198212Config {
    private String name = "idea_198212";
 ...
 */
@Slf4j
public class Idea198212Service {
    private static final int IDEA_ID = 198212;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198212Service() {
        this(new Idea198212Config());
    }

    public Idea198212Service(Idea198212Config config) {
        this.config = config != null ? config : new Idea198212Config();
