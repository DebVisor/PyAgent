...
@Data
public class Idea198448Config {
    private String name = "idea_198448";
 ...
 */
@Slf4j
public class Idea198448Service {
    private static final int IDEA_ID = 198448;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198448Service() {
        this(new Idea198448Config());
    }

    public Idea198448Service(Idea198448Config config) {
        this.config = config != null ? config : new Idea198448Config();
