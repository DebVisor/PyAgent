...
@Data
public class Idea198488Config {
    private String name = "idea_198488";
 ...
 */
@Slf4j
public class Idea198488Service {
    private static final int IDEA_ID = 198488;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198488Service() {
        this(new Idea198488Config());
    }

    public Idea198488Service(Idea198488Config config) {
        this.config = config != null ? config : new Idea198488Config();
