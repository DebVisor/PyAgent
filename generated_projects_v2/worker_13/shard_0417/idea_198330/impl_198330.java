...
@Data
public class Idea198330Config {
    private String name = "idea_198330";
 ...
 */
@Slf4j
public class Idea198330Service {
    private static final int IDEA_ID = 198330;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198330Service() {
        this(new Idea198330Config());
    }

    public Idea198330Service(Idea198330Config config) {
        this.config = config != null ? config : new Idea198330Config();
