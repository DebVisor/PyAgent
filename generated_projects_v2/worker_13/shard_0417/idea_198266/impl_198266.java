...
@Data
public class Idea198266Config {
    private String name = "idea_198266";
 ...
 */
@Slf4j
public class Idea198266Service {
    private static final int IDEA_ID = 198266;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198266Service() {
        this(new Idea198266Config());
    }

    public Idea198266Service(Idea198266Config config) {
        this.config = config != null ? config : new Idea198266Config();
