...
@Data
public class Idea198285Config {
    private String name = "idea_198285";
 ...
 */
@Slf4j
public class Idea198285Service {
    private static final int IDEA_ID = 198285;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198285Service() {
        this(new Idea198285Config());
    }

    public Idea198285Service(Idea198285Config config) {
        this.config = config != null ? config : new Idea198285Config();
