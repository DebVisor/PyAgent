...
@Data
public class Idea198477Config {
    private String name = "idea_198477";
 ...
 */
@Slf4j
public class Idea198477Service {
    private static final int IDEA_ID = 198477;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198477Service() {
        this(new Idea198477Config());
    }

    public Idea198477Service(Idea198477Config config) {
        this.config = config != null ? config : new Idea198477Config();
