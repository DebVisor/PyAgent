...
@Data
public class Idea198450Config {
    private String name = "idea_198450";
 ...
 */
@Slf4j
public class Idea198450Service {
    private static final int IDEA_ID = 198450;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198450Service() {
        this(new Idea198450Config());
    }

    public Idea198450Service(Idea198450Config config) {
        this.config = config != null ? config : new Idea198450Config();
