...
@Data
public class Idea198225Config {
    private String name = "idea_198225";
 ...
 */
@Slf4j
public class Idea198225Service {
    private static final int IDEA_ID = 198225;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198225Service() {
        this(new Idea198225Config());
    }

    public Idea198225Service(Idea198225Config config) {
        this.config = config != null ? config : new Idea198225Config();
