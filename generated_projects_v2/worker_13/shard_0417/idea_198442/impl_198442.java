...
@Data
public class Idea198442Config {
    private String name = "idea_198442";
 ...
 */
@Slf4j
public class Idea198442Service {
    private static final int IDEA_ID = 198442;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198442Service() {
        this(new Idea198442Config());
    }

    public Idea198442Service(Idea198442Config config) {
        this.config = config != null ? config : new Idea198442Config();
