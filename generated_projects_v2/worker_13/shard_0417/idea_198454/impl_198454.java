...
@Data
public class Idea198454Config {
    private String name = "idea_198454";
 ...
 */
@Slf4j
public class Idea198454Service {
    private static final int IDEA_ID = 198454;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198454Service() {
        this(new Idea198454Config());
    }

    public Idea198454Service(Idea198454Config config) {
        this.config = config != null ? config : new Idea198454Config();
