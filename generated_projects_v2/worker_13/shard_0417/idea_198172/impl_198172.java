...
@Data
public class Idea198172Config {
    private String name = "idea_198172";
 ...
 */
@Slf4j
public class Idea198172Service {
    private static final int IDEA_ID = 198172;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198172Service() {
        this(new Idea198172Config());
    }

    public Idea198172Service(Idea198172Config config) {
        this.config = config != null ? config : new Idea198172Config();
