...
@Data
public class Idea198359Config {
    private String name = "idea_198359";
 ...
 */
@Slf4j
public class Idea198359Service {
    private static final int IDEA_ID = 198359;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198359Service() {
        this(new Idea198359Config());
    }

    public Idea198359Service(Idea198359Config config) {
        this.config = config != null ? config : new Idea198359Config();
