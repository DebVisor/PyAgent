...
@Data
public class Idea198384Config {
    private String name = "idea_198384";
 ...
 */
@Slf4j
public class Idea198384Service {
    private static final int IDEA_ID = 198384;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198384Service() {
        this(new Idea198384Config());
    }

    public Idea198384Service(Idea198384Config config) {
        this.config = config != null ? config : new Idea198384Config();
