...
@Data
public class Idea198136Config {
    private String name = "idea_198136";
 ...
 */
@Slf4j
public class Idea198136Service {
    private static final int IDEA_ID = 198136;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198136Service() {
        this(new Idea198136Config());
    }

    public Idea198136Service(Idea198136Config config) {
        this.config = config != null ? config : new Idea198136Config();
