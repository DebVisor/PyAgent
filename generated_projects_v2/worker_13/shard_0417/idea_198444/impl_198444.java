...
@Data
public class Idea198444Config {
    private String name = "idea_198444";
 ...
 */
@Slf4j
public class Idea198444Service {
    private static final int IDEA_ID = 198444;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198444Service() {
        this(new Idea198444Config());
    }

    public Idea198444Service(Idea198444Config config) {
        this.config = config != null ? config : new Idea198444Config();
