...
@Data
public class Idea198190Config {
    private String name = "idea_198190";
 ...
 */
@Slf4j
public class Idea198190Service {
    private static final int IDEA_ID = 198190;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198190Service() {
        this(new Idea198190Config());
    }

    public Idea198190Service(Idea198190Config config) {
        this.config = config != null ? config : new Idea198190Config();
