...
@Data
public class Idea198193Config {
    private String name = "idea_198193";
 ...
 */
@Slf4j
public class Idea198193Service {
    private static final int IDEA_ID = 198193;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198193Service() {
        this(new Idea198193Config());
    }

    public Idea198193Service(Idea198193Config config) {
        this.config = config != null ? config : new Idea198193Config();
