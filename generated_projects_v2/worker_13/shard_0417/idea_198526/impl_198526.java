...
@Data
public class Idea198526Config {
    private String name = "idea_198526";
 ...
 */
@Slf4j
public class Idea198526Service {
    private static final int IDEA_ID = 198526;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198526Service() {
        this(new Idea198526Config());
    }

    public Idea198526Service(Idea198526Config config) {
        this.config = config != null ? config : new Idea198526Config();
