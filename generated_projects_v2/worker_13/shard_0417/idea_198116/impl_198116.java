...
@Data
public class Idea198116Config {
    private String name = "idea_198116";
 ...
 */
@Slf4j
public class Idea198116Service {
    private static final int IDEA_ID = 198116;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198116Service() {
        this(new Idea198116Config());
    }

    public Idea198116Service(Idea198116Config config) {
        this.config = config != null ? config : new Idea198116Config();
