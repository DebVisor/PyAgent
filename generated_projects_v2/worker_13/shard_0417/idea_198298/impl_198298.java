...
@Data
public class Idea198298Config {
    private String name = "idea_198298";
 ...
 */
@Slf4j
public class Idea198298Service {
    private static final int IDEA_ID = 198298;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198298Service() {
        this(new Idea198298Config());
    }

    public Idea198298Service(Idea198298Config config) {
        this.config = config != null ? config : new Idea198298Config();
