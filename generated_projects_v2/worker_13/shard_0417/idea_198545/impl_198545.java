...
@Data
public class Idea198545Config {
    private String name = "idea_198545";
 ...
 */
@Slf4j
public class Idea198545Service {
    private static final int IDEA_ID = 198545;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198545Service() {
        this(new Idea198545Config());
    }

    public Idea198545Service(Idea198545Config config) {
        this.config = config != null ? config : new Idea198545Config();
