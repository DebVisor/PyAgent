...
@Data
public class Idea198215Config {
    private String name = "idea_198215";
 ...
 */
@Slf4j
public class Idea198215Service {
    private static final int IDEA_ID = 198215;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198215Service() {
        this(new Idea198215Config());
    }

    public Idea198215Service(Idea198215Config config) {
        this.config = config != null ? config : new Idea198215Config();
