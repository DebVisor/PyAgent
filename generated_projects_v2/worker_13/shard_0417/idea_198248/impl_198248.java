...
@Data
public class Idea198248Config {
    private String name = "idea_198248";
 ...
 */
@Slf4j
public class Idea198248Service {
    private static final int IDEA_ID = 198248;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198248Service() {
        this(new Idea198248Config());
    }

    public Idea198248Service(Idea198248Config config) {
        this.config = config != null ? config : new Idea198248Config();
