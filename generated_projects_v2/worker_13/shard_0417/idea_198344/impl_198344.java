...
@Data
public class Idea198344Config {
    private String name = "idea_198344";
 ...
 */
@Slf4j
public class Idea198344Service {
    private static final int IDEA_ID = 198344;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198344Service() {
        this(new Idea198344Config());
    }

    public Idea198344Service(Idea198344Config config) {
        this.config = config != null ? config : new Idea198344Config();
