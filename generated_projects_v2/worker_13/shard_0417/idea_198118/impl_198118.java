...
@Data
public class Idea198118Config {
    private String name = "idea_198118";
 ...
 */
@Slf4j
public class Idea198118Service {
    private static final int IDEA_ID = 198118;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198118Service() {
        this(new Idea198118Config());
    }

    public Idea198118Service(Idea198118Config config) {
        this.config = config != null ? config : new Idea198118Config();
