...
@Data
public class Idea198340Config {
    private String name = "idea_198340";
 ...
 */
@Slf4j
public class Idea198340Service {
    private static final int IDEA_ID = 198340;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198340Service() {
        this(new Idea198340Config());
    }

    public Idea198340Service(Idea198340Config config) {
        this.config = config != null ? config : new Idea198340Config();
