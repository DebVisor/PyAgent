...
@Data
public class Idea198208Config {
    private String name = "idea_198208";
 ...
 */
@Slf4j
public class Idea198208Service {
    private static final int IDEA_ID = 198208;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198208Service() {
        this(new Idea198208Config());
    }

    public Idea198208Service(Idea198208Config config) {
        this.config = config != null ? config : new Idea198208Config();
