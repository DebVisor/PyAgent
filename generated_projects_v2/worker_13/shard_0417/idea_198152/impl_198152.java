...
@Data
public class Idea198152Config {
    private String name = "idea_198152";
 ...
 */
@Slf4j
public class Idea198152Service {
    private static final int IDEA_ID = 198152;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198152Service() {
        this(new Idea198152Config());
    }

    public Idea198152Service(Idea198152Config config) {
        this.config = config != null ? config : new Idea198152Config();
