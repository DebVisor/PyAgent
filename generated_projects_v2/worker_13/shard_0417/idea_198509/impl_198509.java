...
@Data
public class Idea198509Config {
    private String name = "idea_198509";
 ...
 */
@Slf4j
public class Idea198509Service {
    private static final int IDEA_ID = 198509;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198509Service() {
        this(new Idea198509Config());
    }

    public Idea198509Service(Idea198509Config config) {
        this.config = config != null ? config : new Idea198509Config();
