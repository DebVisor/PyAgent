...
@Data
public class Idea198472Config {
    private String name = "idea_198472";
 ...
 */
@Slf4j
public class Idea198472Service {
    private static final int IDEA_ID = 198472;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198472Service() {
        this(new Idea198472Config());
    }

    public Idea198472Service(Idea198472Config config) {
        this.config = config != null ? config : new Idea198472Config();
