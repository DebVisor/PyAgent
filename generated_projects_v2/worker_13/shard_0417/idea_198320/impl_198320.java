...
@Data
public class Idea198320Config {
    private String name = "idea_198320";
 ...
 */
@Slf4j
public class Idea198320Service {
    private static final int IDEA_ID = 198320;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198320Service() {
        this(new Idea198320Config());
    }

    public Idea198320Service(Idea198320Config config) {
        this.config = config != null ? config : new Idea198320Config();
