...
@Data
public class Idea198370Config {
    private String name = "idea_198370";
 ...
 */
@Slf4j
public class Idea198370Service {
    private static final int IDEA_ID = 198370;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198370Service() {
        this(new Idea198370Config());
    }

    public Idea198370Service(Idea198370Config config) {
        this.config = config != null ? config : new Idea198370Config();
