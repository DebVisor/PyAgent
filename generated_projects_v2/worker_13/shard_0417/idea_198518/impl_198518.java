...
@Data
public class Idea198518Config {
    private String name = "idea_198518";
 ...
 */
@Slf4j
public class Idea198518Service {
    private static final int IDEA_ID = 198518;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198518Service() {
        this(new Idea198518Config());
    }

    public Idea198518Service(Idea198518Config config) {
        this.config = config != null ? config : new Idea198518Config();
