...
@Data
public class Idea198245Config {
    private String name = "idea_198245";
 ...
 */
@Slf4j
public class Idea198245Service {
    private static final int IDEA_ID = 198245;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198245Service() {
        this(new Idea198245Config());
    }

    public Idea198245Service(Idea198245Config config) {
        this.config = config != null ? config : new Idea198245Config();
