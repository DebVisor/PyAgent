...
@Data
public class Idea198177Config {
    private String name = "idea_198177";
 ...
 */
@Slf4j
public class Idea198177Service {
    private static final int IDEA_ID = 198177;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198177Service() {
        this(new Idea198177Config());
    }

    public Idea198177Service(Idea198177Config config) {
        this.config = config != null ? config : new Idea198177Config();
