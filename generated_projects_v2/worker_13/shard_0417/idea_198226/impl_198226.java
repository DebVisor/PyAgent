...
@Data
public class Idea198226Config {
    private String name = "idea_198226";
 ...
 */
@Slf4j
public class Idea198226Service {
    private static final int IDEA_ID = 198226;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198226Service() {
        this(new Idea198226Config());
    }

    public Idea198226Service(Idea198226Config config) {
        this.config = config != null ? config : new Idea198226Config();
