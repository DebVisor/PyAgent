...
@Data
public class Idea198431Config {
    private String name = "idea_198431";
 ...
 */
@Slf4j
public class Idea198431Service {
    private static final int IDEA_ID = 198431;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198431Service() {
        this(new Idea198431Config());
    }

    public Idea198431Service(Idea198431Config config) {
        this.config = config != null ? config : new Idea198431Config();
