...
@Data
public class Idea198541Config {
    private String name = "idea_198541";
 ...
 */
@Slf4j
public class Idea198541Service {
    private static final int IDEA_ID = 198541;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198541Service() {
        this(new Idea198541Config());
    }

    public Idea198541Service(Idea198541Config config) {
        this.config = config != null ? config : new Idea198541Config();
