...
@Data
public class Idea198081Config {
    private String name = "idea_198081";
 ...
 */
@Slf4j
public class Idea198081Service {
    private static final int IDEA_ID = 198081;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198081Service() {
        this(new Idea198081Config());
    }

    public Idea198081Service(Idea198081Config config) {
        this.config = config != null ? config : new Idea198081Config();
