...
@Data
public class Idea198192Config {
    private String name = "idea_198192";
 ...
 */
@Slf4j
public class Idea198192Service {
    private static final int IDEA_ID = 198192;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198192Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198192Service() {
        this(new Idea198192Config());
    }

    public Idea198192Service(Idea198192Config config) {
        this.config = config != null ? config : new Idea198192Config();
