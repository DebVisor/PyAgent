...
@Data
public class Idea198496Config {
    private String name = "idea_198496";
 ...
 */
@Slf4j
public class Idea198496Service {
    private static final int IDEA_ID = 198496;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198496Service() {
        this(new Idea198496Config());
    }

    public Idea198496Service(Idea198496Config config) {
        this.config = config != null ? config : new Idea198496Config();
