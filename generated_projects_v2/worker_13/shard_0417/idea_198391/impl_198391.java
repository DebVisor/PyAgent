...
@Data
public class Idea198391Config {
    private String name = "idea_198391";
 ...
 */
@Slf4j
public class Idea198391Service {
    private static final int IDEA_ID = 198391;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198391Service() {
        this(new Idea198391Config());
    }

    public Idea198391Service(Idea198391Config config) {
        this.config = config != null ? config : new Idea198391Config();
