...
@Data
public class Idea198371Config {
    private String name = "idea_198371";
 ...
 */
@Slf4j
public class Idea198371Service {
    private static final int IDEA_ID = 198371;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198371Service() {
        this(new Idea198371Config());
    }

    public Idea198371Service(Idea198371Config config) {
        this.config = config != null ? config : new Idea198371Config();
