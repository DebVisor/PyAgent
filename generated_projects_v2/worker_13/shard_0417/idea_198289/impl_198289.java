...
@Data
public class Idea198289Config {
    private String name = "idea_198289";
 ...
 */
@Slf4j
public class Idea198289Service {
    private static final int IDEA_ID = 198289;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198289Service() {
        this(new Idea198289Config());
    }

    public Idea198289Service(Idea198289Config config) {
        this.config = config != null ? config : new Idea198289Config();
