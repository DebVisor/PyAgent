...
@Data
public class Idea198414Config {
    private String name = "idea_198414";
 ...
 */
@Slf4j
public class Idea198414Service {
    private static final int IDEA_ID = 198414;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198414Service() {
        this(new Idea198414Config());
    }

    public Idea198414Service(Idea198414Config config) {
        this.config = config != null ? config : new Idea198414Config();
