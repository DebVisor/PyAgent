...
@Data
public class Idea198360Config {
    private String name = "idea_198360";
 ...
 */
@Slf4j
public class Idea198360Service {
    private static final int IDEA_ID = 198360;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198360Service() {
        this(new Idea198360Config());
    }

    public Idea198360Service(Idea198360Config config) {
        this.config = config != null ? config : new Idea198360Config();
