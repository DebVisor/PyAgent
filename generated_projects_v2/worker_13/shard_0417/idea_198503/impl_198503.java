...
@Data
public class Idea198503Config {
    private String name = "idea_198503";
 ...
 */
@Slf4j
public class Idea198503Service {
    private static final int IDEA_ID = 198503;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198503Service() {
        this(new Idea198503Config());
    }

    public Idea198503Service(Idea198503Config config) {
        this.config = config != null ? config : new Idea198503Config();
