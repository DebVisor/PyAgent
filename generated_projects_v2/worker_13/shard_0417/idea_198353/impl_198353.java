...
@Data
public class Idea198353Config {
    private String name = "idea_198353";
 ...
 */
@Slf4j
public class Idea198353Service {
    private static final int IDEA_ID = 198353;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198353Service() {
        this(new Idea198353Config());
    }

    public Idea198353Service(Idea198353Config config) {
        this.config = config != null ? config : new Idea198353Config();
