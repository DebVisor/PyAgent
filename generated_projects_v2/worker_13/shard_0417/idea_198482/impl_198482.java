...
@Data
public class Idea198482Config {
    private String name = "idea_198482";
 ...
 */
@Slf4j
public class Idea198482Service {
    private static final int IDEA_ID = 198482;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198482Service() {
        this(new Idea198482Config());
    }

    public Idea198482Service(Idea198482Config config) {
        this.config = config != null ? config : new Idea198482Config();
