...
@Data
public class Idea198239Config {
    private String name = "idea_198239";
 ...
 */
@Slf4j
public class Idea198239Service {
    private static final int IDEA_ID = 198239;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198239Service() {
        this(new Idea198239Config());
    }

    public Idea198239Service(Idea198239Config config) {
        this.config = config != null ? config : new Idea198239Config();
