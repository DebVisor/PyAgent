...
@Data
public class Idea198534Config {
    private String name = "idea_198534";
 ...
 */
@Slf4j
public class Idea198534Service {
    private static final int IDEA_ID = 198534;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198534Service() {
        this(new Idea198534Config());
    }

    public Idea198534Service(Idea198534Config config) {
        this.config = config != null ? config : new Idea198534Config();
