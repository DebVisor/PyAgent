...
@Data
public class Idea198162Config {
    private String name = "idea_198162";
 ...
 */
@Slf4j
public class Idea198162Service {
    private static final int IDEA_ID = 198162;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198162Service() {
        this(new Idea198162Config());
    }

    public Idea198162Service(Idea198162Config config) {
        this.config = config != null ? config : new Idea198162Config();
