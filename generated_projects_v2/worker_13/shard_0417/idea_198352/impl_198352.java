...
@Data
public class Idea198352Config {
    private String name = "idea_198352";
 ...
 */
@Slf4j
public class Idea198352Service {
    private static final int IDEA_ID = 198352;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198352Service() {
        this(new Idea198352Config());
    }

    public Idea198352Service(Idea198352Config config) {
        this.config = config != null ? config : new Idea198352Config();
