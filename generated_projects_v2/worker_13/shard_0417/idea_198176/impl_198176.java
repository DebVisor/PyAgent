...
@Data
public class Idea198176Config {
    private String name = "idea_198176";
 ...
 */
@Slf4j
public class Idea198176Service {
    private static final int IDEA_ID = 198176;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198176Service() {
        this(new Idea198176Config());
    }

    public Idea198176Service(Idea198176Config config) {
        this.config = config != null ? config : new Idea198176Config();
