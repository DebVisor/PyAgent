...
@Data
public class Idea198115Config {
    private String name = "idea_198115";
 ...
 */
@Slf4j
public class Idea198115Service {
    private static final int IDEA_ID = 198115;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198115Service() {
        this(new Idea198115Config());
    }

    public Idea198115Service(Idea198115Config config) {
        this.config = config != null ? config : new Idea198115Config();
