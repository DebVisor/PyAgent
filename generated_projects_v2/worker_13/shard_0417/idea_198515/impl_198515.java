...
@Data
public class Idea198515Config {
    private String name = "idea_198515";
 ...
 */
@Slf4j
public class Idea198515Service {
    private static final int IDEA_ID = 198515;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198515Service() {
        this(new Idea198515Config());
    }

    public Idea198515Service(Idea198515Config config) {
        this.config = config != null ? config : new Idea198515Config();
