...
@Data
public class Idea198387Config {
    private String name = "idea_198387";
 ...
 */
@Slf4j
public class Idea198387Service {
    private static final int IDEA_ID = 198387;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198387Service() {
        this(new Idea198387Config());
    }

    public Idea198387Service(Idea198387Config config) {
        this.config = config != null ? config : new Idea198387Config();
