...
@Data
public class Idea198142Config {
    private String name = "idea_198142";
 ...
 */
@Slf4j
public class Idea198142Service {
    private static final int IDEA_ID = 198142;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198142Service() {
        this(new Idea198142Config());
    }

    public Idea198142Service(Idea198142Config config) {
        this.config = config != null ? config : new Idea198142Config();
