...
@Data
public class Idea198203Config {
    private String name = "idea_198203";
 ...
 */
@Slf4j
public class Idea198203Service {
    private static final int IDEA_ID = 198203;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198203Service() {
        this(new Idea198203Config());
    }

    public Idea198203Service(Idea198203Config config) {
        this.config = config != null ? config : new Idea198203Config();
