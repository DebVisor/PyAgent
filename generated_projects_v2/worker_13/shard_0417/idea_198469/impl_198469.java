...
@Data
public class Idea198469Config {
    private String name = "idea_198469";
 ...
 */
@Slf4j
public class Idea198469Service {
    private static final int IDEA_ID = 198469;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198469Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198469Service() {
        this(new Idea198469Config());
    }

    public Idea198469Service(Idea198469Config config) {
        this.config = config != null ? config : new Idea198469Config();
