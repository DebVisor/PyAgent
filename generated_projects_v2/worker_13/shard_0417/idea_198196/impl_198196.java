...
@Data
public class Idea198196Config {
    private String name = "idea_198196";
 ...
 */
@Slf4j
public class Idea198196Service {
    private static final int IDEA_ID = 198196;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198196Service() {
        this(new Idea198196Config());
    }

    public Idea198196Service(Idea198196Config config) {
        this.config = config != null ? config : new Idea198196Config();
