...
@Data
public class Idea198169Config {
    private String name = "idea_198169";
 ...
 */
@Slf4j
public class Idea198169Service {
    private static final int IDEA_ID = 198169;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198169Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198169Service() {
        this(new Idea198169Config());
    }

    public Idea198169Service(Idea198169Config config) {
        this.config = config != null ? config : new Idea198169Config();
