...
@Data
public class Idea198163Config {
    private String name = "idea_198163";
 ...
 */
@Slf4j
public class Idea198163Service {
    private static final int IDEA_ID = 198163;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198163Service() {
        this(new Idea198163Config());
    }

    public Idea198163Service(Idea198163Config config) {
        this.config = config != null ? config : new Idea198163Config();
