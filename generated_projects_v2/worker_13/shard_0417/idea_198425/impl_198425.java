...
@Data
public class Idea198425Config {
    private String name = "idea_198425";
 ...
 */
@Slf4j
public class Idea198425Service {
    private static final int IDEA_ID = 198425;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198425Service() {
        this(new Idea198425Config());
    }

    public Idea198425Service(Idea198425Config config) {
        this.config = config != null ? config : new Idea198425Config();
