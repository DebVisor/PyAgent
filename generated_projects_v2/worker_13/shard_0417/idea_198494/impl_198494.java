...
@Data
public class Idea198494Config {
    private String name = "idea_198494";
 ...
 */
@Slf4j
public class Idea198494Service {
    private static final int IDEA_ID = 198494;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198494Service() {
        this(new Idea198494Config());
    }

    public Idea198494Service(Idea198494Config config) {
        this.config = config != null ? config : new Idea198494Config();
