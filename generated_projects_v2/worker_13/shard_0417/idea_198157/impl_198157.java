...
@Data
public class Idea198157Config {
    private String name = "idea_198157";
 ...
 */
@Slf4j
public class Idea198157Service {
    private static final int IDEA_ID = 198157;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198157Service() {
        this(new Idea198157Config());
    }

    public Idea198157Service(Idea198157Config config) {
        this.config = config != null ? config : new Idea198157Config();
