...
@Data
public class Idea198077Config {
    private String name = "idea_198077";
 ...
 */
@Slf4j
public class Idea198077Service {
    private static final int IDEA_ID = 198077;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198077Service() {
        this(new Idea198077Config());
    }

    public Idea198077Service(Idea198077Config config) {
        this.config = config != null ? config : new Idea198077Config();
