...
@Data
public class Idea198099Config {
    private String name = "idea_198099";
 ...
 */
@Slf4j
public class Idea198099Service {
    private static final int IDEA_ID = 198099;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198099Service() {
        this(new Idea198099Config());
    }

    public Idea198099Service(Idea198099Config config) {
        this.config = config != null ? config : new Idea198099Config();
