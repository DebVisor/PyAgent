...
@Data
public class Idea198512Config {
    private String name = "idea_198512";
 ...
 */
@Slf4j
public class Idea198512Service {
    private static final int IDEA_ID = 198512;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198512Service() {
        this(new Idea198512Config());
    }

    public Idea198512Service(Idea198512Config config) {
        this.config = config != null ? config : new Idea198512Config();
