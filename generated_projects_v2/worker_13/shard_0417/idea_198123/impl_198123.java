...
@Data
public class Idea198123Config {
    private String name = "idea_198123";
 ...
 */
@Slf4j
public class Idea198123Service {
    private static final int IDEA_ID = 198123;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198123Service() {
        this(new Idea198123Config());
    }

    public Idea198123Service(Idea198123Config config) {
        this.config = config != null ? config : new Idea198123Config();
