...
@Data
public class Idea198140Config {
    private String name = "idea_198140";
 ...
 */
@Slf4j
public class Idea198140Service {
    private static final int IDEA_ID = 198140;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198140Service() {
        this(new Idea198140Config());
    }

    public Idea198140Service(Idea198140Config config) {
        this.config = config != null ? config : new Idea198140Config();
