...
@Data
public class Idea198315Config {
    private String name = "idea_198315";
 ...
 */
@Slf4j
public class Idea198315Service {
    private static final int IDEA_ID = 198315;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198315Service() {
        this(new Idea198315Config());
    }

    public Idea198315Service(Idea198315Config config) {
        this.config = config != null ? config : new Idea198315Config();
