...
@Data
public class Idea198085Config {
    private String name = "idea_198085";
 ...
 */
@Slf4j
public class Idea198085Service {
    private static final int IDEA_ID = 198085;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198085Service() {
        this(new Idea198085Config());
    }

    public Idea198085Service(Idea198085Config config) {
        this.config = config != null ? config : new Idea198085Config();
