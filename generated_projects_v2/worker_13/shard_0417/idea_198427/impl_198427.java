...
@Data
public class Idea198427Config {
    private String name = "idea_198427";
 ...
 */
@Slf4j
public class Idea198427Service {
    private static final int IDEA_ID = 198427;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198427Service() {
        this(new Idea198427Config());
    }

    public Idea198427Service(Idea198427Config config) {
        this.config = config != null ? config : new Idea198427Config();
