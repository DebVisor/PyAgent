...
@Data
public class Idea198173Config {
    private String name = "idea_198173";
 ...
 */
@Slf4j
public class Idea198173Service {
    private static final int IDEA_ID = 198173;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198173Service() {
        this(new Idea198173Config());
    }

    public Idea198173Service(Idea198173Config config) {
        this.config = config != null ? config : new Idea198173Config();
