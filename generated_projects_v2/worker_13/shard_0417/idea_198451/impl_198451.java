...
@Data
public class Idea198451Config {
    private String name = "idea_198451";
 ...
 */
@Slf4j
public class Idea198451Service {
    private static final int IDEA_ID = 198451;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198451Service() {
        this(new Idea198451Config());
    }

    public Idea198451Service(Idea198451Config config) {
        this.config = config != null ? config : new Idea198451Config();
