...
@Data
public class Idea198547Config {
    private String name = "idea_198547";
 ...
 */
@Slf4j
public class Idea198547Service {
    private static final int IDEA_ID = 198547;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198547Service() {
        this(new Idea198547Config());
    }

    public Idea198547Service(Idea198547Config config) {
        this.config = config != null ? config : new Idea198547Config();
