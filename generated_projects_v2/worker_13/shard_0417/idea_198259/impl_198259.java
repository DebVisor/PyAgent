...
@Data
public class Idea198259Config {
    private String name = "idea_198259";
 ...
 */
@Slf4j
public class Idea198259Service {
    private static final int IDEA_ID = 198259;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198259Service() {
        this(new Idea198259Config());
    }

    public Idea198259Service(Idea198259Config config) {
        this.config = config != null ? config : new Idea198259Config();
