...
@Data
public class Idea198279Config {
    private String name = "idea_198279";
 ...
 */
@Slf4j
public class Idea198279Service {
    private static final int IDEA_ID = 198279;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198279Service() {
        this(new Idea198279Config());
    }

    public Idea198279Service(Idea198279Config config) {
        this.config = config != null ? config : new Idea198279Config();
