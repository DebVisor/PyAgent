...
@Data
public class Idea198247Config {
    private String name = "idea_198247";
 ...
 */
@Slf4j
public class Idea198247Service {
    private static final int IDEA_ID = 198247;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198247Service() {
        this(new Idea198247Config());
    }

    public Idea198247Service(Idea198247Config config) {
        this.config = config != null ? config : new Idea198247Config();
