...
@Data
public class Idea198284Config {
    private String name = "idea_198284";
 ...
 */
@Slf4j
public class Idea198284Service {
    private static final int IDEA_ID = 198284;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198284Service() {
        this(new Idea198284Config());
    }

    public Idea198284Service(Idea198284Config config) {
        this.config = config != null ? config : new Idea198284Config();
