...
@Data
public class Idea198150Config {
    private String name = "idea_198150";
 ...
 */
@Slf4j
public class Idea198150Service {
    private static final int IDEA_ID = 198150;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198150Service() {
        this(new Idea198150Config());
    }

    public Idea198150Service(Idea198150Config config) {
        this.config = config != null ? config : new Idea198150Config();
