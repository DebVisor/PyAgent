...
@Data
public class Idea198491Config {
    private String name = "idea_198491";
 ...
 */
@Slf4j
public class Idea198491Service {
    private static final int IDEA_ID = 198491;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198491Service() {
        this(new Idea198491Config());
    }

    public Idea198491Service(Idea198491Config config) {
        this.config = config != null ? config : new Idea198491Config();
