...
@Data
public class Idea198278Config {
    private String name = "idea_198278";
 ...
 */
@Slf4j
public class Idea198278Service {
    private static final int IDEA_ID = 198278;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198278Service() {
        this(new Idea198278Config());
    }

    public Idea198278Service(Idea198278Config config) {
        this.config = config != null ? config : new Idea198278Config();
