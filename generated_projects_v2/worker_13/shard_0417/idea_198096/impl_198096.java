...
@Data
public class Idea198096Config {
    private String name = "idea_198096";
 ...
 */
@Slf4j
public class Idea198096Service {
    private static final int IDEA_ID = 198096;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198096Service() {
        this(new Idea198096Config());
    }

    public Idea198096Service(Idea198096Config config) {
        this.config = config != null ? config : new Idea198096Config();
