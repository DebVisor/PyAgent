...
@Data
public class Idea198270Config {
    private String name = "idea_198270";
 ...
 */
@Slf4j
public class Idea198270Service {
    private static final int IDEA_ID = 198270;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198270Service() {
        this(new Idea198270Config());
    }

    public Idea198270Service(Idea198270Config config) {
        this.config = config != null ? config : new Idea198270Config();
