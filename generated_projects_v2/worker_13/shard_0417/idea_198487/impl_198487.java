...
@Data
public class Idea198487Config {
    private String name = "idea_198487";
 ...
 */
@Slf4j
public class Idea198487Service {
    private static final int IDEA_ID = 198487;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198487Service() {
        this(new Idea198487Config());
    }

    public Idea198487Service(Idea198487Config config) {
        this.config = config != null ? config : new Idea198487Config();
