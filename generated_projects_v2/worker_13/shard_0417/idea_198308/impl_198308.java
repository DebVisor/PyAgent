...
@Data
public class Idea198308Config {
    private String name = "idea_198308";
 ...
 */
@Slf4j
public class Idea198308Service {
    private static final int IDEA_ID = 198308;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198308Service() {
        this(new Idea198308Config());
    }

    public Idea198308Service(Idea198308Config config) {
        this.config = config != null ? config : new Idea198308Config();
