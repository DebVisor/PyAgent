...
@Data
public class Idea198127Config {
    private String name = "idea_198127";
 ...
 */
@Slf4j
public class Idea198127Service {
    private static final int IDEA_ID = 198127;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198127Service() {
        this(new Idea198127Config());
    }

    public Idea198127Service(Idea198127Config config) {
        this.config = config != null ? config : new Idea198127Config();
