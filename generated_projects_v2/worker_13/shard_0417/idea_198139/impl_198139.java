...
@Data
public class Idea198139Config {
    private String name = "idea_198139";
 ...
 */
@Slf4j
public class Idea198139Service {
    private static final int IDEA_ID = 198139;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198139Service() {
        this(new Idea198139Config());
    }

    public Idea198139Service(Idea198139Config config) {
        this.config = config != null ? config : new Idea198139Config();
