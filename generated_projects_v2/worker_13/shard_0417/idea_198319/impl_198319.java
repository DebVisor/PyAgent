...
@Data
public class Idea198319Config {
    private String name = "idea_198319";
 ...
 */
@Slf4j
public class Idea198319Service {
    private static final int IDEA_ID = 198319;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198319Service() {
        this(new Idea198319Config());
    }

    public Idea198319Service(Idea198319Config config) {
        this.config = config != null ? config : new Idea198319Config();
