...
@Data
public class Idea198210Config {
    private String name = "idea_198210";
 ...
 */
@Slf4j
public class Idea198210Service {
    private static final int IDEA_ID = 198210;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198210Service() {
        this(new Idea198210Config());
    }

    public Idea198210Service(Idea198210Config config) {
        this.config = config != null ? config : new Idea198210Config();
