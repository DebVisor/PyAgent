...
@Data
public class Idea198483Config {
    private String name = "idea_198483";
 ...
 */
@Slf4j
public class Idea198483Service {
    private static final int IDEA_ID = 198483;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198483Service() {
        this(new Idea198483Config());
    }

    public Idea198483Service(Idea198483Config config) {
        this.config = config != null ? config : new Idea198483Config();
