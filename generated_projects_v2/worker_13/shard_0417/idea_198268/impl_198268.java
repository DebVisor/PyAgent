...
@Data
public class Idea198268Config {
    private String name = "idea_198268";
 ...
 */
@Slf4j
public class Idea198268Service {
    private static final int IDEA_ID = 198268;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198268Service() {
        this(new Idea198268Config());
    }

    public Idea198268Service(Idea198268Config config) {
        this.config = config != null ? config : new Idea198268Config();
