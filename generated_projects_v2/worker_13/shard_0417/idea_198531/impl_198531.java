...
@Data
public class Idea198531Config {
    private String name = "idea_198531";
 ...
 */
@Slf4j
public class Idea198531Service {
    private static final int IDEA_ID = 198531;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198531Service() {
        this(new Idea198531Config());
    }

    public Idea198531Service(Idea198531Config config) {
        this.config = config != null ? config : new Idea198531Config();
