...
@Data
public class Idea198419Config {
    private String name = "idea_198419";
 ...
 */
@Slf4j
public class Idea198419Service {
    private static final int IDEA_ID = 198419;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198419Service() {
        this(new Idea198419Config());
    }

    public Idea198419Service(Idea198419Config config) {
        this.config = config != null ? config : new Idea198419Config();
