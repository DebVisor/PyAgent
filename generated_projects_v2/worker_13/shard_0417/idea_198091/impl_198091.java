...
@Data
public class Idea198091Config {
    private String name = "idea_198091";
 ...
 */
@Slf4j
public class Idea198091Service {
    private static final int IDEA_ID = 198091;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198091Service() {
        this(new Idea198091Config());
    }

    public Idea198091Service(Idea198091Config config) {
        this.config = config != null ? config : new Idea198091Config();
