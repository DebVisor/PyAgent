...
@Data
public class Idea198280Config {
    private String name = "idea_198280";
 ...
 */
@Slf4j
public class Idea198280Service {
    private static final int IDEA_ID = 198280;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198280Service() {
        this(new Idea198280Config());
    }

    public Idea198280Service(Idea198280Config config) {
        this.config = config != null ? config : new Idea198280Config();
