...
@Data
public class Idea198231Config {
    private String name = "idea_198231";
 ...
 */
@Slf4j
public class Idea198231Service {
    private static final int IDEA_ID = 198231;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198231Service() {
        this(new Idea198231Config());
    }

    public Idea198231Service(Idea198231Config config) {
        this.config = config != null ? config : new Idea198231Config();
