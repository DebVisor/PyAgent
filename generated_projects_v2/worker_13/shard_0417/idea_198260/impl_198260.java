...
@Data
public class Idea198260Config {
    private String name = "idea_198260";
 ...
 */
@Slf4j
public class Idea198260Service {
    private static final int IDEA_ID = 198260;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198260Service() {
        this(new Idea198260Config());
    }

    public Idea198260Service(Idea198260Config config) {
        this.config = config != null ? config : new Idea198260Config();
