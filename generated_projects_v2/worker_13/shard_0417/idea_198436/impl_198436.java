...
@Data
public class Idea198436Config {
    private String name = "idea_198436";
 ...
 */
@Slf4j
public class Idea198436Service {
    private static final int IDEA_ID = 198436;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198436Service() {
        this(new Idea198436Config());
    }

    public Idea198436Service(Idea198436Config config) {
        this.config = config != null ? config : new Idea198436Config();
