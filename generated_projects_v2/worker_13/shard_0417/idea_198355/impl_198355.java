...
@Data
public class Idea198355Config {
    private String name = "idea_198355";
 ...
 */
@Slf4j
public class Idea198355Service {
    private static final int IDEA_ID = 198355;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198355Service() {
        this(new Idea198355Config());
    }

    public Idea198355Service(Idea198355Config config) {
        this.config = config != null ? config : new Idea198355Config();
