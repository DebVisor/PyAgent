...
@Data
public class Idea198092Config {
    private String name = "idea_198092";
 ...
 */
@Slf4j
public class Idea198092Service {
    private static final int IDEA_ID = 198092;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198092Service() {
        this(new Idea198092Config());
    }

    public Idea198092Service(Idea198092Config config) {
        this.config = config != null ? config : new Idea198092Config();
