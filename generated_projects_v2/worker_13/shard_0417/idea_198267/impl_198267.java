...
@Data
public class Idea198267Config {
    private String name = "idea_198267";
 ...
 */
@Slf4j
public class Idea198267Service {
    private static final int IDEA_ID = 198267;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198267Service() {
        this(new Idea198267Config());
    }

    public Idea198267Service(Idea198267Config config) {
        this.config = config != null ? config : new Idea198267Config();
