...
@Data
public class Idea198195Config {
    private String name = "idea_198195";
 ...
 */
@Slf4j
public class Idea198195Service {
    private static final int IDEA_ID = 198195;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198195Service() {
        this(new Idea198195Config());
    }

    public Idea198195Service(Idea198195Config config) {
        this.config = config != null ? config : new Idea198195Config();
