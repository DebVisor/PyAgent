...
@Data
public class Idea198432Config {
    private String name = "idea_198432";
 ...
 */
@Slf4j
public class Idea198432Service {
    private static final int IDEA_ID = 198432;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198432Service() {
        this(new Idea198432Config());
    }

    public Idea198432Service(Idea198432Config config) {
        this.config = config != null ? config : new Idea198432Config();
