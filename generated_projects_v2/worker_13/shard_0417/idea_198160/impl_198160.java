...
@Data
public class Idea198160Config {
    private String name = "idea_198160";
 ...
 */
@Slf4j
public class Idea198160Service {
    private static final int IDEA_ID = 198160;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198160Service() {
        this(new Idea198160Config());
    }

    public Idea198160Service(Idea198160Config config) {
        this.config = config != null ? config : new Idea198160Config();
