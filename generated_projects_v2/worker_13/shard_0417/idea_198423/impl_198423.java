...
@Data
public class Idea198423Config {
    private String name = "idea_198423";
 ...
 */
@Slf4j
public class Idea198423Service {
    private static final int IDEA_ID = 198423;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198423Service() {
        this(new Idea198423Config());
    }

    public Idea198423Service(Idea198423Config config) {
        this.config = config != null ? config : new Idea198423Config();
