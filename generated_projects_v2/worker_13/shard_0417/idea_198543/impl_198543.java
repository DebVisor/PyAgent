...
@Data
public class Idea198543Config {
    private String name = "idea_198543";
 ...
 */
@Slf4j
public class Idea198543Service {
    private static final int IDEA_ID = 198543;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198543Service() {
        this(new Idea198543Config());
    }

    public Idea198543Service(Idea198543Config config) {
        this.config = config != null ? config : new Idea198543Config();
