...
@Data
public class Idea198333Config {
    private String name = "idea_198333";
 ...
 */
@Slf4j
public class Idea198333Service {
    private static final int IDEA_ID = 198333;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198333Service() {
        this(new Idea198333Config());
    }

    public Idea198333Service(Idea198333Config config) {
        this.config = config != null ? config : new Idea198333Config();
