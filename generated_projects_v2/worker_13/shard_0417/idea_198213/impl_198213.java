...
@Data
public class Idea198213Config {
    private String name = "idea_198213";
 ...
 */
@Slf4j
public class Idea198213Service {
    private static final int IDEA_ID = 198213;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198213Service() {
        this(new Idea198213Config());
    }

    public Idea198213Service(Idea198213Config config) {
        this.config = config != null ? config : new Idea198213Config();
