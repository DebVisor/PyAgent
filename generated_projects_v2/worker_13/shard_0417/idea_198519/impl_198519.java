...
@Data
public class Idea198519Config {
    private String name = "idea_198519";
 ...
 */
@Slf4j
public class Idea198519Service {
    private static final int IDEA_ID = 198519;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198519Service() {
        this(new Idea198519Config());
    }

    public Idea198519Service(Idea198519Config config) {
        this.config = config != null ? config : new Idea198519Config();
