...
@Data
public class Idea198417Config {
    private String name = "idea_198417";
 ...
 */
@Slf4j
public class Idea198417Service {
    private static final int IDEA_ID = 198417;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198417Service() {
        this(new Idea198417Config());
    }

    public Idea198417Service(Idea198417Config config) {
        this.config = config != null ? config : new Idea198417Config();
