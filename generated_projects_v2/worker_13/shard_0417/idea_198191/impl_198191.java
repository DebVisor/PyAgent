...
@Data
public class Idea198191Config {
    private String name = "idea_198191";
 ...
 */
@Slf4j
public class Idea198191Service {
    private static final int IDEA_ID = 198191;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198191Service() {
        this(new Idea198191Config());
    }

    public Idea198191Service(Idea198191Config config) {
        this.config = config != null ? config : new Idea198191Config();
