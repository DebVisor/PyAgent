...
@Data
public class Idea198400Config {
    private String name = "idea_198400";
 ...
 */
@Slf4j
public class Idea198400Service {
    private static final int IDEA_ID = 198400;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198400Service() {
        this(new Idea198400Config());
    }

    public Idea198400Service(Idea198400Config config) {
        this.config = config != null ? config : new Idea198400Config();
