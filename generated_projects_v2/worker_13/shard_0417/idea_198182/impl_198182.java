...
@Data
public class Idea198182Config {
    private String name = "idea_198182";
 ...
 */
@Slf4j
public class Idea198182Service {
    private static final int IDEA_ID = 198182;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198182Service() {
        this(new Idea198182Config());
    }

    public Idea198182Service(Idea198182Config config) {
        this.config = config != null ? config : new Idea198182Config();
