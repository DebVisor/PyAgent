...
@Data
public class Idea198299Config {
    private String name = "idea_198299";
 ...
 */
@Slf4j
public class Idea198299Service {
    private static final int IDEA_ID = 198299;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198299Service() {
        this(new Idea198299Config());
    }

    public Idea198299Service(Idea198299Config config) {
        this.config = config != null ? config : new Idea198299Config();
