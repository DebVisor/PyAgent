...
@Data
public class Idea198520Config {
    private String name = "idea_198520";
 ...
 */
@Slf4j
public class Idea198520Service {
    private static final int IDEA_ID = 198520;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198520Service() {
        this(new Idea198520Config());
    }

    public Idea198520Service(Idea198520Config config) {
        this.config = config != null ? config : new Idea198520Config();
