...
@Data
public class Idea198108Config {
    private String name = "idea_198108";
 ...
 */
@Slf4j
public class Idea198108Service {
    private static final int IDEA_ID = 198108;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198108Service() {
        this(new Idea198108Config());
    }

    public Idea198108Service(Idea198108Config config) {
        this.config = config != null ? config : new Idea198108Config();
