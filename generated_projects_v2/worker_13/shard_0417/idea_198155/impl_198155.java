...
@Data
public class Idea198155Config {
    private String name = "idea_198155";
 ...
 */
@Slf4j
public class Idea198155Service {
    private static final int IDEA_ID = 198155;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198155Service() {
        this(new Idea198155Config());
    }

    public Idea198155Service(Idea198155Config config) {
        this.config = config != null ? config : new Idea198155Config();
