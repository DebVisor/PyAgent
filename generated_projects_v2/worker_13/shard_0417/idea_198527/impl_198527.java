...
@Data
public class Idea198527Config {
    private String name = "idea_198527";
 ...
 */
@Slf4j
public class Idea198527Service {
    private static final int IDEA_ID = 198527;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198527Service() {
        this(new Idea198527Config());
    }

    public Idea198527Service(Idea198527Config config) {
        this.config = config != null ? config : new Idea198527Config();
