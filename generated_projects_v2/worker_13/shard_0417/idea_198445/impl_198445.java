...
@Data
public class Idea198445Config {
    private String name = "idea_198445";
 ...
 */
@Slf4j
public class Idea198445Service {
    private static final int IDEA_ID = 198445;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198445Service() {
        this(new Idea198445Config());
    }

    public Idea198445Service(Idea198445Config config) {
        this.config = config != null ? config : new Idea198445Config();
