...
@Data
public class Idea198168Config {
    private String name = "idea_198168";
 ...
 */
@Slf4j
public class Idea198168Service {
    private static final int IDEA_ID = 198168;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198168Service() {
        this(new Idea198168Config());
    }

    public Idea198168Service(Idea198168Config config) {
        this.config = config != null ? config : new Idea198168Config();
