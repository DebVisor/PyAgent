...
@Data
public class Idea198107Config {
    private String name = "idea_198107";
 ...
 */
@Slf4j
public class Idea198107Service {
    private static final int IDEA_ID = 198107;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198107Service() {
        this(new Idea198107Config());
    }

    public Idea198107Service(Idea198107Config config) {
        this.config = config != null ? config : new Idea198107Config();
