...
@Data
public class Idea198243Config {
    private String name = "idea_198243";
 ...
 */
@Slf4j
public class Idea198243Service {
    private static final int IDEA_ID = 198243;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198243Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198243Service() {
        this(new Idea198243Config());
    }

    public Idea198243Service(Idea198243Config config) {
        this.config = config != null ? config : new Idea198243Config();
