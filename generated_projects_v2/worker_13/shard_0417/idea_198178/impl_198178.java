...
@Data
public class Idea198178Config {
    private String name = "idea_198178";
 ...
 */
@Slf4j
public class Idea198178Service {
    private static final int IDEA_ID = 198178;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198178Service() {
        this(new Idea198178Config());
    }

    public Idea198178Service(Idea198178Config config) {
        this.config = config != null ? config : new Idea198178Config();
