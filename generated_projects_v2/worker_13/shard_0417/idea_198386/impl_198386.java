...
@Data
public class Idea198386Config {
    private String name = "idea_198386";
 ...
 */
@Slf4j
public class Idea198386Service {
    private static final int IDEA_ID = 198386;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198386Service() {
        this(new Idea198386Config());
    }

    public Idea198386Service(Idea198386Config config) {
        this.config = config != null ? config : new Idea198386Config();
