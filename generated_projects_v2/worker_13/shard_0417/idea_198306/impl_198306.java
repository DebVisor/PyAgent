...
@Data
public class Idea198306Config {
    private String name = "idea_198306";
 ...
 */
@Slf4j
public class Idea198306Service {
    private static final int IDEA_ID = 198306;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198306Service() {
        this(new Idea198306Config());
    }

    public Idea198306Service(Idea198306Config config) {
        this.config = config != null ? config : new Idea198306Config();
