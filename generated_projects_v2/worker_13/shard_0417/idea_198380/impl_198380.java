...
@Data
public class Idea198380Config {
    private String name = "idea_198380";
 ...
 */
@Slf4j
public class Idea198380Service {
    private static final int IDEA_ID = 198380;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198380Service() {
        this(new Idea198380Config());
    }

    public Idea198380Service(Idea198380Config config) {
        this.config = config != null ? config : new Idea198380Config();
