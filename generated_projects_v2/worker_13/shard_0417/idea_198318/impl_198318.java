...
@Data
public class Idea198318Config {
    private String name = "idea_198318";
 ...
 */
@Slf4j
public class Idea198318Service {
    private static final int IDEA_ID = 198318;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198318Service() {
        this(new Idea198318Config());
    }

    public Idea198318Service(Idea198318Config config) {
        this.config = config != null ? config : new Idea198318Config();
