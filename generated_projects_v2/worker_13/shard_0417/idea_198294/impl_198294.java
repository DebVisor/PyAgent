...
@Data
public class Idea198294Config {
    private String name = "idea_198294";
 ...
 */
@Slf4j
public class Idea198294Service {
    private static final int IDEA_ID = 198294;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198294Service() {
        this(new Idea198294Config());
    }

    public Idea198294Service(Idea198294Config config) {
        this.config = config != null ? config : new Idea198294Config();
