...
@Data
public class Idea198133Config {
    private String name = "idea_198133";
 ...
 */
@Slf4j
public class Idea198133Service {
    private static final int IDEA_ID = 198133;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198133Service() {
        this(new Idea198133Config());
    }

    public Idea198133Service(Idea198133Config config) {
        this.config = config != null ? config : new Idea198133Config();
