...
@Data
public class Idea198153Config {
    private String name = "idea_198153";
 ...
 */
@Slf4j
public class Idea198153Service {
    private static final int IDEA_ID = 198153;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198153Service() {
        this(new Idea198153Config());
    }

    public Idea198153Service(Idea198153Config config) {
        this.config = config != null ? config : new Idea198153Config();
