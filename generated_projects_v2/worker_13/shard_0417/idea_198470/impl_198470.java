...
@Data
public class Idea198470Config {
    private String name = "idea_198470";
 ...
 */
@Slf4j
public class Idea198470Service {
    private static final int IDEA_ID = 198470;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198470Service() {
        this(new Idea198470Config());
    }

    public Idea198470Service(Idea198470Config config) {
        this.config = config != null ? config : new Idea198470Config();
