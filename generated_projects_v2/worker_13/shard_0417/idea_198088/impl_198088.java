...
@Data
public class Idea198088Config {
    private String name = "idea_198088";
 ...
 */
@Slf4j
public class Idea198088Service {
    private static final int IDEA_ID = 198088;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198088Service() {
        this(new Idea198088Config());
    }

    public Idea198088Service(Idea198088Config config) {
        this.config = config != null ? config : new Idea198088Config();
