...
@Data
public class Idea198357Config {
    private String name = "idea_198357";
 ...
 */
@Slf4j
public class Idea198357Service {
    private static final int IDEA_ID = 198357;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198357Service() {
        this(new Idea198357Config());
    }

    public Idea198357Service(Idea198357Config config) {
        this.config = config != null ? config : new Idea198357Config();
