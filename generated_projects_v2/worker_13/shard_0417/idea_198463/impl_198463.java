...
@Data
public class Idea198463Config {
    private String name = "idea_198463";
 ...
 */
@Slf4j
public class Idea198463Service {
    private static final int IDEA_ID = 198463;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198463Service() {
        this(new Idea198463Config());
    }

    public Idea198463Service(Idea198463Config config) {
        this.config = config != null ? config : new Idea198463Config();
