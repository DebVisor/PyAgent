...
@Data
public class Idea198253Config {
    private String name = "idea_198253";
 ...
 */
@Slf4j
public class Idea198253Service {
    private static final int IDEA_ID = 198253;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198253Service() {
        this(new Idea198253Config());
    }

    public Idea198253Service(Idea198253Config config) {
        this.config = config != null ? config : new Idea198253Config();
