...
@Data
public class Idea198286Config {
    private String name = "idea_198286";
 ...
 */
@Slf4j
public class Idea198286Service {
    private static final int IDEA_ID = 198286;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198286Service() {
        this(new Idea198286Config());
    }

    public Idea198286Service(Idea198286Config config) {
        this.config = config != null ? config : new Idea198286Config();
