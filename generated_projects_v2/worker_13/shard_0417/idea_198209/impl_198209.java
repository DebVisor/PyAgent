...
@Data
public class Idea198209Config {
    private String name = "idea_198209";
 ...
 */
@Slf4j
public class Idea198209Service {
    private static final int IDEA_ID = 198209;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198209Service() {
        this(new Idea198209Config());
    }

    public Idea198209Service(Idea198209Config config) {
        this.config = config != null ? config : new Idea198209Config();
