...
@Data
public class Idea198130Config {
    private String name = "idea_198130";
 ...
 */
@Slf4j
public class Idea198130Service {
    private static final int IDEA_ID = 198130;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198130Service() {
        this(new Idea198130Config());
    }

    public Idea198130Service(Idea198130Config config) {
        this.config = config != null ? config : new Idea198130Config();
