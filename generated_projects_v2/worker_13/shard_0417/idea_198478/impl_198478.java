...
@Data
public class Idea198478Config {
    private String name = "idea_198478";
 ...
 */
@Slf4j
public class Idea198478Service {
    private static final int IDEA_ID = 198478;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198478Service() {
        this(new Idea198478Config());
    }

    public Idea198478Service(Idea198478Config config) {
        this.config = config != null ? config : new Idea198478Config();
