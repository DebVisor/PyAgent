...
@Data
public class Idea198390Config {
    private String name = "idea_198390";
 ...
 */
@Slf4j
public class Idea198390Service {
    private static final int IDEA_ID = 198390;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198390Service() {
        this(new Idea198390Config());
    }

    public Idea198390Service(Idea198390Config config) {
        this.config = config != null ? config : new Idea198390Config();
