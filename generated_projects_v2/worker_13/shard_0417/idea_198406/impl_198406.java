...
@Data
public class Idea198406Config {
    private String name = "idea_198406";
 ...
 */
@Slf4j
public class Idea198406Service {
    private static final int IDEA_ID = 198406;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198406Service() {
        this(new Idea198406Config());
    }

    public Idea198406Service(Idea198406Config config) {
        this.config = config != null ? config : new Idea198406Config();
