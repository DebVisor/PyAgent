...
@Data
public class Idea198119Config {
    private String name = "idea_198119";
 ...
 */
@Slf4j
public class Idea198119Service {
    private static final int IDEA_ID = 198119;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198119Service() {
        this(new Idea198119Config());
    }

    public Idea198119Service(Idea198119Config config) {
        this.config = config != null ? config : new Idea198119Config();
