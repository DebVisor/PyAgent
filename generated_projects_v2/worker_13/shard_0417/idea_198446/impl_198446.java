...
@Data
public class Idea198446Config {
    private String name = "idea_198446";
 ...
 */
@Slf4j
public class Idea198446Service {
    private static final int IDEA_ID = 198446;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198446Service() {
        this(new Idea198446Config());
    }

    public Idea198446Service(Idea198446Config config) {
        this.config = config != null ? config : new Idea198446Config();
