...
@Data
public class Idea198382Config {
    private String name = "idea_198382";
 ...
 */
@Slf4j
public class Idea198382Service {
    private static final int IDEA_ID = 198382;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198382Service() {
        this(new Idea198382Config());
    }

    public Idea198382Service(Idea198382Config config) {
        this.config = config != null ? config : new Idea198382Config();
