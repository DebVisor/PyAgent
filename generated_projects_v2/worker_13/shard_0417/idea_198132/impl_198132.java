...
@Data
public class Idea198132Config {
    private String name = "idea_198132";
 ...
 */
@Slf4j
public class Idea198132Service {
    private static final int IDEA_ID = 198132;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198132Service() {
        this(new Idea198132Config());
    }

    public Idea198132Service(Idea198132Config config) {
        this.config = config != null ? config : new Idea198132Config();
