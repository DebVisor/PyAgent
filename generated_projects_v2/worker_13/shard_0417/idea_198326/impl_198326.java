...
@Data
public class Idea198326Config {
    private String name = "idea_198326";
 ...
 */
@Slf4j
public class Idea198326Service {
    private static final int IDEA_ID = 198326;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198326Service() {
        this(new Idea198326Config());
    }

    public Idea198326Service(Idea198326Config config) {
        this.config = config != null ? config : new Idea198326Config();
