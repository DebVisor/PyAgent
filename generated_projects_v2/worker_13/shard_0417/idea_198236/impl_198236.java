...
@Data
public class Idea198236Config {
    private String name = "idea_198236";
 ...
 */
@Slf4j
public class Idea198236Service {
    private static final int IDEA_ID = 198236;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198236Service() {
        this(new Idea198236Config());
    }

    public Idea198236Service(Idea198236Config config) {
        this.config = config != null ? config : new Idea198236Config();
