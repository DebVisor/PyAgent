...
@Data
public class Idea198513Config {
    private String name = "idea_198513";
 ...
 */
@Slf4j
public class Idea198513Service {
    private static final int IDEA_ID = 198513;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198513Service() {
        this(new Idea198513Config());
    }

    public Idea198513Service(Idea198513Config config) {
        this.config = config != null ? config : new Idea198513Config();
