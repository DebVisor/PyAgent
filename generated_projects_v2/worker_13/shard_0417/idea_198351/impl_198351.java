...
@Data
public class Idea198351Config {
    private String name = "idea_198351";
 ...
 */
@Slf4j
public class Idea198351Service {
    private static final int IDEA_ID = 198351;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198351Service() {
        this(new Idea198351Config());
    }

    public Idea198351Service(Idea198351Config config) {
        this.config = config != null ? config : new Idea198351Config();
