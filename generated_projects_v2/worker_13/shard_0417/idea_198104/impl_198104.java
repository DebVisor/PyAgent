...
@Data
public class Idea198104Config {
    private String name = "idea_198104";
 ...
 */
@Slf4j
public class Idea198104Service {
    private static final int IDEA_ID = 198104;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198104Service() {
        this(new Idea198104Config());
    }

    public Idea198104Service(Idea198104Config config) {
        this.config = config != null ? config : new Idea198104Config();
