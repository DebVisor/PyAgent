...
@Data
public class Idea198486Config {
    private String name = "idea_198486";
 ...
 */
@Slf4j
public class Idea198486Service {
    private static final int IDEA_ID = 198486;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198486Service() {
        this(new Idea198486Config());
    }

    public Idea198486Service(Idea198486Config config) {
        this.config = config != null ? config : new Idea198486Config();
