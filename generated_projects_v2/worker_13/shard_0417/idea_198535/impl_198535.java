...
@Data
public class Idea198535Config {
    private String name = "idea_198535";
 ...
 */
@Slf4j
public class Idea198535Service {
    private static final int IDEA_ID = 198535;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198535Service() {
        this(new Idea198535Config());
    }

    public Idea198535Service(Idea198535Config config) {
        this.config = config != null ? config : new Idea198535Config();
