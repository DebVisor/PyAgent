...
@Data
public class Idea198428Config {
    private String name = "idea_198428";
 ...
 */
@Slf4j
public class Idea198428Service {
    private static final int IDEA_ID = 198428;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198428Service() {
        this(new Idea198428Config());
    }

    public Idea198428Service(Idea198428Config config) {
        this.config = config != null ? config : new Idea198428Config();
