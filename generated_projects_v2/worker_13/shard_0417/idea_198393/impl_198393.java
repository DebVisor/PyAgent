...
@Data
public class Idea198393Config {
    private String name = "idea_198393";
 ...
 */
@Slf4j
public class Idea198393Service {
    private static final int IDEA_ID = 198393;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198393Service() {
        this(new Idea198393Config());
    }

    public Idea198393Service(Idea198393Config config) {
        this.config = config != null ? config : new Idea198393Config();
