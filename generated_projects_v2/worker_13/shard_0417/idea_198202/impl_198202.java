...
@Data
public class Idea198202Config {
    private String name = "idea_198202";
 ...
 */
@Slf4j
public class Idea198202Service {
    private static final int IDEA_ID = 198202;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198202Service() {
        this(new Idea198202Config());
    }

    public Idea198202Service(Idea198202Config config) {
        this.config = config != null ? config : new Idea198202Config();
