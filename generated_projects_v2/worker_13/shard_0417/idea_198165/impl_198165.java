...
@Data
public class Idea198165Config {
    private String name = "idea_198165";
 ...
 */
@Slf4j
public class Idea198165Service {
    private static final int IDEA_ID = 198165;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198165Service() {
        this(new Idea198165Config());
    }

    public Idea198165Service(Idea198165Config config) {
        this.config = config != null ? config : new Idea198165Config();
