...
@Data
public class Idea198533Config {
    private String name = "idea_198533";
 ...
 */
@Slf4j
public class Idea198533Service {
    private static final int IDEA_ID = 198533;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198533Service() {
        this(new Idea198533Config());
    }

    public Idea198533Service(Idea198533Config config) {
        this.config = config != null ? config : new Idea198533Config();
