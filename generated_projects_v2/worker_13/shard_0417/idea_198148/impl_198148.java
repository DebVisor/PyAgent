...
@Data
public class Idea198148Config {
    private String name = "idea_198148";
 ...
 */
@Slf4j
public class Idea198148Service {
    private static final int IDEA_ID = 198148;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198148Service() {
        this(new Idea198148Config());
    }

    public Idea198148Service(Idea198148Config config) {
        this.config = config != null ? config : new Idea198148Config();
