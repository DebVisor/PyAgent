...
@Data
public class Idea198313Config {
    private String name = "idea_198313";
 ...
 */
@Slf4j
public class Idea198313Service {
    private static final int IDEA_ID = 198313;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198313Service() {
        this(new Idea198313Config());
    }

    public Idea198313Service(Idea198313Config config) {
        this.config = config != null ? config : new Idea198313Config();
