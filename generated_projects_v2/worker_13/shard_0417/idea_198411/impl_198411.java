...
@Data
public class Idea198411Config {
    private String name = "idea_198411";
 ...
 */
@Slf4j
public class Idea198411Service {
    private static final int IDEA_ID = 198411;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198411Service() {
        this(new Idea198411Config());
    }

    public Idea198411Service(Idea198411Config config) {
        this.config = config != null ? config : new Idea198411Config();
