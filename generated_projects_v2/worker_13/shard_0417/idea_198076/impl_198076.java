...
@Data
public class Idea198076Config {
    private String name = "idea_198076";
 ...
 */
@Slf4j
public class Idea198076Service {
    private static final int IDEA_ID = 198076;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198076Service() {
        this(new Idea198076Config());
    }

    public Idea198076Service(Idea198076Config config) {
        this.config = config != null ? config : new Idea198076Config();
