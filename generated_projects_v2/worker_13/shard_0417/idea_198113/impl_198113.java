...
@Data
public class Idea198113Config {
    private String name = "idea_198113";
 ...
 */
@Slf4j
public class Idea198113Service {
    private static final int IDEA_ID = 198113;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198113Service() {
        this(new Idea198113Config());
    }

    public Idea198113Service(Idea198113Config config) {
        this.config = config != null ? config : new Idea198113Config();
