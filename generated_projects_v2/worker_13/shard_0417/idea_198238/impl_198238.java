...
@Data
public class Idea198238Config {
    private String name = "idea_198238";
 ...
 */
@Slf4j
public class Idea198238Service {
    private static final int IDEA_ID = 198238;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198238Service() {
        this(new Idea198238Config());
    }

    public Idea198238Service(Idea198238Config config) {
        this.config = config != null ? config : new Idea198238Config();
