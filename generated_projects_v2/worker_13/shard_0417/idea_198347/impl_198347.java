...
@Data
public class Idea198347Config {
    private String name = "idea_198347";
 ...
 */
@Slf4j
public class Idea198347Service {
    private static final int IDEA_ID = 198347;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198347Service() {
        this(new Idea198347Config());
    }

    public Idea198347Service(Idea198347Config config) {
        this.config = config != null ? config : new Idea198347Config();
