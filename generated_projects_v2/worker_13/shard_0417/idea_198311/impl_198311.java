...
@Data
public class Idea198311Config {
    private String name = "idea_198311";
 ...
 */
@Slf4j
public class Idea198311Service {
    private static final int IDEA_ID = 198311;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198311Service() {
        this(new Idea198311Config());
    }

    public Idea198311Service(Idea198311Config config) {
        this.config = config != null ? config : new Idea198311Config();
