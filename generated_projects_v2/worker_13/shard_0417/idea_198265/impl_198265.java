...
@Data
public class Idea198265Config {
    private String name = "idea_198265";
 ...
 */
@Slf4j
public class Idea198265Service {
    private static final int IDEA_ID = 198265;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198265Service() {
        this(new Idea198265Config());
    }

    public Idea198265Service(Idea198265Config config) {
        this.config = config != null ? config : new Idea198265Config();
