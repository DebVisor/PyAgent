...
@Data
public class Idea198106Config {
    private String name = "idea_198106";
 ...
 */
@Slf4j
public class Idea198106Service {
    private static final int IDEA_ID = 198106;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198106Service() {
        this(new Idea198106Config());
    }

    public Idea198106Service(Idea198106Config config) {
        this.config = config != null ? config : new Idea198106Config();
