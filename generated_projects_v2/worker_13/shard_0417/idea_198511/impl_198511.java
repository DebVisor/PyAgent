...
@Data
public class Idea198511Config {
    private String name = "idea_198511";
 ...
 */
@Slf4j
public class Idea198511Service {
    private static final int IDEA_ID = 198511;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198511Service() {
        this(new Idea198511Config());
    }

    public Idea198511Service(Idea198511Config config) {
        this.config = config != null ? config : new Idea198511Config();
