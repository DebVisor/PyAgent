...
@Data
public class Idea198124Config {
    private String name = "idea_198124";
 ...
 */
@Slf4j
public class Idea198124Service {
    private static final int IDEA_ID = 198124;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198124Service() {
        this(new Idea198124Config());
    }

    public Idea198124Service(Idea198124Config config) {
        this.config = config != null ? config : new Idea198124Config();
