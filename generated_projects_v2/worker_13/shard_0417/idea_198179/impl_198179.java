...
@Data
public class Idea198179Config {
    private String name = "idea_198179";
 ...
 */
@Slf4j
public class Idea198179Service {
    private static final int IDEA_ID = 198179;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198179Service() {
        this(new Idea198179Config());
    }

    public Idea198179Service(Idea198179Config config) {
        this.config = config != null ? config : new Idea198179Config();
