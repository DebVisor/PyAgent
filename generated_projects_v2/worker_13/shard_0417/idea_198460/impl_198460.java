...
@Data
public class Idea198460Config {
    private String name = "idea_198460";
 ...
 */
@Slf4j
public class Idea198460Service {
    private static final int IDEA_ID = 198460;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198460Service() {
        this(new Idea198460Config());
    }

    public Idea198460Service(Idea198460Config config) {
        this.config = config != null ? config : new Idea198460Config();
