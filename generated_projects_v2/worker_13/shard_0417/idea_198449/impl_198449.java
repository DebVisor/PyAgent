...
@Data
public class Idea198449Config {
    private String name = "idea_198449";
 ...
 */
@Slf4j
public class Idea198449Service {
    private static final int IDEA_ID = 198449;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198449Service() {
        this(new Idea198449Config());
    }

    public Idea198449Service(Idea198449Config config) {
        this.config = config != null ? config : new Idea198449Config();
