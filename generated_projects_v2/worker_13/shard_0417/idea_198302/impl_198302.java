...
@Data
public class Idea198302Config {
    private String name = "idea_198302";
 ...
 */
@Slf4j
public class Idea198302Service {
    private static final int IDEA_ID = 198302;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198302Service() {
        this(new Idea198302Config());
    }

    public Idea198302Service(Idea198302Config config) {
        this.config = config != null ? config : new Idea198302Config();
