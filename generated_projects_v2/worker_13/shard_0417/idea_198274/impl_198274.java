...
@Data
public class Idea198274Config {
    private String name = "idea_198274";
 ...
 */
@Slf4j
public class Idea198274Service {
    private static final int IDEA_ID = 198274;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198274Service() {
        this(new Idea198274Config());
    }

    public Idea198274Service(Idea198274Config config) {
        this.config = config != null ? config : new Idea198274Config();
