...
@Data
public class Idea198434Config {
    private String name = "idea_198434";
 ...
 */
@Slf4j
public class Idea198434Service {
    private static final int IDEA_ID = 198434;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198434Service() {
        this(new Idea198434Config());
    }

    public Idea198434Service(Idea198434Config config) {
        this.config = config != null ? config : new Idea198434Config();
