...
@Data
public class Idea198398Config {
    private String name = "idea_198398";
 ...
 */
@Slf4j
public class Idea198398Service {
    private static final int IDEA_ID = 198398;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198398Service() {
        this(new Idea198398Config());
    }

    public Idea198398Service(Idea198398Config config) {
        this.config = config != null ? config : new Idea198398Config();
