...
@Data
public class Idea198082Config {
    private String name = "idea_198082";
 ...
 */
@Slf4j
public class Idea198082Service {
    private static final int IDEA_ID = 198082;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198082Service() {
        this(new Idea198082Config());
    }

    public Idea198082Service(Idea198082Config config) {
        this.config = config != null ? config : new Idea198082Config();
