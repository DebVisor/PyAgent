...
@Data
public class Idea198121Config {
    private String name = "idea_198121";
 ...
 */
@Slf4j
public class Idea198121Service {
    private static final int IDEA_ID = 198121;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198121Service() {
        this(new Idea198121Config());
    }

    public Idea198121Service(Idea198121Config config) {
        this.config = config != null ? config : new Idea198121Config();
