...
@Data
public class Idea198288Config {
    private String name = "idea_198288";
 ...
 */
@Slf4j
public class Idea198288Service {
    private static final int IDEA_ID = 198288;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198288Service() {
        this(new Idea198288Config());
    }

    public Idea198288Service(Idea198288Config config) {
        this.config = config != null ? config : new Idea198288Config();
