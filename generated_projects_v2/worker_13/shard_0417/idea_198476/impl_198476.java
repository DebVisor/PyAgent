...
@Data
public class Idea198476Config {
    private String name = "idea_198476";
 ...
 */
@Slf4j
public class Idea198476Service {
    private static final int IDEA_ID = 198476;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198476Service() {
        this(new Idea198476Config());
    }

    public Idea198476Service(Idea198476Config config) {
        this.config = config != null ? config : new Idea198476Config();
