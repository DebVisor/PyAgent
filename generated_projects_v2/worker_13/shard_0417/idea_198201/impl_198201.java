...
@Data
public class Idea198201Config {
    private String name = "idea_198201";
 ...
 */
@Slf4j
public class Idea198201Service {
    private static final int IDEA_ID = 198201;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198201Service() {
        this(new Idea198201Config());
    }

    public Idea198201Service(Idea198201Config config) {
        this.config = config != null ? config : new Idea198201Config();
