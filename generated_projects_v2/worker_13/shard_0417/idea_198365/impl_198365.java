...
@Data
public class Idea198365Config {
    private String name = "idea_198365";
 ...
 */
@Slf4j
public class Idea198365Service {
    private static final int IDEA_ID = 198365;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198365Service() {
        this(new Idea198365Config());
    }

    public Idea198365Service(Idea198365Config config) {
        this.config = config != null ? config : new Idea198365Config();
