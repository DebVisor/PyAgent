...
@Data
public class Idea198292Config {
    private String name = "idea_198292";
 ...
 */
@Slf4j
public class Idea198292Service {
    private static final int IDEA_ID = 198292;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198292Service() {
        this(new Idea198292Config());
    }

    public Idea198292Service(Idea198292Config config) {
        this.config = config != null ? config : new Idea198292Config();
