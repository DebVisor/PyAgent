...
@Data
public class Idea198126Config {
    private String name = "idea_198126";
 ...
 */
@Slf4j
public class Idea198126Service {
    private static final int IDEA_ID = 198126;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198126Service() {
        this(new Idea198126Config());
    }

    public Idea198126Service(Idea198126Config config) {
        this.config = config != null ? config : new Idea198126Config();
