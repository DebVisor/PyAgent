...
@Data
public class Idea198220Config {
    private String name = "idea_198220";
 ...
 */
@Slf4j
public class Idea198220Service {
    private static final int IDEA_ID = 198220;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198220Service() {
        this(new Idea198220Config());
    }

    public Idea198220Service(Idea198220Config config) {
        this.config = config != null ? config : new Idea198220Config();
