...
@Data
public class Idea198536Config {
    private String name = "idea_198536";
 ...
 */
@Slf4j
public class Idea198536Service {
    private static final int IDEA_ID = 198536;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198536Service() {
        this(new Idea198536Config());
    }

    public Idea198536Service(Idea198536Config config) {
        this.config = config != null ? config : new Idea198536Config();
