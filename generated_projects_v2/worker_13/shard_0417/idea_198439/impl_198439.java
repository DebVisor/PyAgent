...
@Data
public class Idea198439Config {
    private String name = "idea_198439";
 ...
 */
@Slf4j
public class Idea198439Service {
    private static final int IDEA_ID = 198439;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198439Service() {
        this(new Idea198439Config());
    }

    public Idea198439Service(Idea198439Config config) {
        this.config = config != null ? config : new Idea198439Config();
