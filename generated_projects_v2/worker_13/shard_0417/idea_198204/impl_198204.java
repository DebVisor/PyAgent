...
@Data
public class Idea198204Config {
    private String name = "idea_198204";
 ...
 */
@Slf4j
public class Idea198204Service {
    private static final int IDEA_ID = 198204;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198204Service() {
        this(new Idea198204Config());
    }

    public Idea198204Service(Idea198204Config config) {
        this.config = config != null ? config : new Idea198204Config();
