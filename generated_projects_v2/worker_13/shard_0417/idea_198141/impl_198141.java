...
@Data
public class Idea198141Config {
    private String name = "idea_198141";
 ...
 */
@Slf4j
public class Idea198141Service {
    private static final int IDEA_ID = 198141;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198141Service() {
        this(new Idea198141Config());
    }

    public Idea198141Service(Idea198141Config config) {
        this.config = config != null ? config : new Idea198141Config();
