...
@Data
public class Idea198117Config {
    private String name = "idea_198117";
 ...
 */
@Slf4j
public class Idea198117Service {
    private static final int IDEA_ID = 198117;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198117Service() {
        this(new Idea198117Config());
    }

    public Idea198117Service(Idea198117Config config) {
        this.config = config != null ? config : new Idea198117Config();
