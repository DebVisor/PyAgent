...
@Data
public class Idea198174Config {
    private String name = "idea_198174";
 ...
 */
@Slf4j
public class Idea198174Service {
    private static final int IDEA_ID = 198174;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198174Service() {
        this(new Idea198174Config());
    }

    public Idea198174Service(Idea198174Config config) {
        this.config = config != null ? config : new Idea198174Config();
