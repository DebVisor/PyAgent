...
@Data
public class Idea198324Config {
    private String name = "idea_198324";
 ...
 */
@Slf4j
public class Idea198324Service {
    private static final int IDEA_ID = 198324;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198324Service() {
        this(new Idea198324Config());
    }

    public Idea198324Service(Idea198324Config config) {
        this.config = config != null ? config : new Idea198324Config();
