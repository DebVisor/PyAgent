...
@Data
public class Idea198250Config {
    private String name = "idea_198250";
 ...
 */
@Slf4j
public class Idea198250Service {
    private static final int IDEA_ID = 198250;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198250Service() {
        this(new Idea198250Config());
    }

    public Idea198250Service(Idea198250Config config) {
        this.config = config != null ? config : new Idea198250Config();
