...
@Data
public class Idea198546Config {
    private String name = "idea_198546";
 ...
 */
@Slf4j
public class Idea198546Service {
    private static final int IDEA_ID = 198546;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198546Service() {
        this(new Idea198546Config());
    }

    public Idea198546Service(Idea198546Config config) {
        this.config = config != null ? config : new Idea198546Config();
