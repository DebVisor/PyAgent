...
@Data
public class Idea198102Config {
    private String name = "idea_198102";
 ...
 */
@Slf4j
public class Idea198102Service {
    private static final int IDEA_ID = 198102;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198102Service() {
        this(new Idea198102Config());
    }

    public Idea198102Service(Idea198102Config config) {
        this.config = config != null ? config : new Idea198102Config();
