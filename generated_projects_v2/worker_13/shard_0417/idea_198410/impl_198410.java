...
@Data
public class Idea198410Config {
    private String name = "idea_198410";
 ...
 */
@Slf4j
public class Idea198410Service {
    private static final int IDEA_ID = 198410;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198410Service() {
        this(new Idea198410Config());
    }

    public Idea198410Service(Idea198410Config config) {
        this.config = config != null ? config : new Idea198410Config();
