...
@Data
public class Idea198343Config {
    private String name = "idea_198343";
 ...
 */
@Slf4j
public class Idea198343Service {
    private static final int IDEA_ID = 198343;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198343Service() {
        this(new Idea198343Config());
    }

    public Idea198343Service(Idea198343Config config) {
        this.config = config != null ? config : new Idea198343Config();
