...
@Data
public class Idea198105Config {
    private String name = "idea_198105";
 ...
 */
@Slf4j
public class Idea198105Service {
    private static final int IDEA_ID = 198105;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198105Service() {
        this(new Idea198105Config());
    }

    public Idea198105Service(Idea198105Config config) {
        this.config = config != null ? config : new Idea198105Config();
