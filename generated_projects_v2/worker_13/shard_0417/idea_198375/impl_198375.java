...
@Data
public class Idea198375Config {
    private String name = "idea_198375";
 ...
 */
@Slf4j
public class Idea198375Service {
    private static final int IDEA_ID = 198375;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198375Service() {
        this(new Idea198375Config());
    }

    public Idea198375Service(Idea198375Config config) {
        this.config = config != null ? config : new Idea198375Config();
