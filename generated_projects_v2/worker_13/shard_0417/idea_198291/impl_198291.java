...
@Data
public class Idea198291Config {
    private String name = "idea_198291";
 ...
 */
@Slf4j
public class Idea198291Service {
    private static final int IDEA_ID = 198291;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198291Service() {
        this(new Idea198291Config());
    }

    public Idea198291Service(Idea198291Config config) {
        this.config = config != null ? config : new Idea198291Config();
