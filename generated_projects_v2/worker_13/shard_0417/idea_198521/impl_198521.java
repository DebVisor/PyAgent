...
@Data
public class Idea198521Config {
    private String name = "idea_198521";
 ...
 */
@Slf4j
public class Idea198521Service {
    private static final int IDEA_ID = 198521;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198521Service() {
        this(new Idea198521Config());
    }

    public Idea198521Service(Idea198521Config config) {
        this.config = config != null ? config : new Idea198521Config();
