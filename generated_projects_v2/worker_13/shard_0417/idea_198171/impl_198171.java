...
@Data
public class Idea198171Config {
    private String name = "idea_198171";
 ...
 */
@Slf4j
public class Idea198171Service {
    private static final int IDEA_ID = 198171;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198171Service() {
        this(new Idea198171Config());
    }

    public Idea198171Service(Idea198171Config config) {
        this.config = config != null ? config : new Idea198171Config();
