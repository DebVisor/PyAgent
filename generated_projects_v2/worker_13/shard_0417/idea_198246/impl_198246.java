...
@Data
public class Idea198246Config {
    private String name = "idea_198246";
 ...
 */
@Slf4j
public class Idea198246Service {
    private static final int IDEA_ID = 198246;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198246Service() {
        this(new Idea198246Config());
    }

    public Idea198246Service(Idea198246Config config) {
        this.config = config != null ? config : new Idea198246Config();
