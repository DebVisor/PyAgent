...
@Data
public class Idea198429Config {
    private String name = "idea_198429";
 ...
 */
@Slf4j
public class Idea198429Service {
    private static final int IDEA_ID = 198429;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198429Service() {
        this(new Idea198429Config());
    }

    public Idea198429Service(Idea198429Config config) {
        this.config = config != null ? config : new Idea198429Config();
