...
@Data
public class Idea198376Config {
    private String name = "idea_198376";
 ...
 */
@Slf4j
public class Idea198376Service {
    private static final int IDEA_ID = 198376;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198376Service() {
        this(new Idea198376Config());
    }

    public Idea198376Service(Idea198376Config config) {
        this.config = config != null ? config : new Idea198376Config();
