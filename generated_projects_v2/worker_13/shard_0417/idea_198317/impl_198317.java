...
@Data
public class Idea198317Config {
    private String name = "idea_198317";
 ...
 */
@Slf4j
public class Idea198317Service {
    private static final int IDEA_ID = 198317;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198317Service() {
        this(new Idea198317Config());
    }

    public Idea198317Service(Idea198317Config config) {
        this.config = config != null ? config : new Idea198317Config();
