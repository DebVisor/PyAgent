...
@Data
public class Idea198458Config {
    private String name = "idea_198458";
 ...
 */
@Slf4j
public class Idea198458Service {
    private static final int IDEA_ID = 198458;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198458Service() {
        this(new Idea198458Config());
    }

    public Idea198458Service(Idea198458Config config) {
        this.config = config != null ? config : new Idea198458Config();
