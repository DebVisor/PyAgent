...
@Data
public class Idea198510Config {
    private String name = "idea_198510";
 ...
 */
@Slf4j
public class Idea198510Service {
    private static final int IDEA_ID = 198510;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198510Service() {
        this(new Idea198510Config());
    }

    public Idea198510Service(Idea198510Config config) {
        this.config = config != null ? config : new Idea198510Config();
