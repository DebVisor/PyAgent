...
@Data
public class Idea198300Config {
    private String name = "idea_198300";
 ...
 */
@Slf4j
public class Idea198300Service {
    private static final int IDEA_ID = 198300;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198300Service() {
        this(new Idea198300Config());
    }

    public Idea198300Service(Idea198300Config config) {
        this.config = config != null ? config : new Idea198300Config();
