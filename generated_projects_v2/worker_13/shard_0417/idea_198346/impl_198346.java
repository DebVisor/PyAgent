...
@Data
public class Idea198346Config {
    private String name = "idea_198346";
 ...
 */
@Slf4j
public class Idea198346Service {
    private static final int IDEA_ID = 198346;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198346Service() {
        this(new Idea198346Config());
    }

    public Idea198346Service(Idea198346Config config) {
        this.config = config != null ? config : new Idea198346Config();
