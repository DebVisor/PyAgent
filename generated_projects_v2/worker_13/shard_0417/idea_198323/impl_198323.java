...
@Data
public class Idea198323Config {
    private String name = "idea_198323";
 ...
 */
@Slf4j
public class Idea198323Service {
    private static final int IDEA_ID = 198323;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198323Service() {
        this(new Idea198323Config());
    }

    public Idea198323Service(Idea198323Config config) {
        this.config = config != null ? config : new Idea198323Config();
