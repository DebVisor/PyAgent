...
@Data
public class Idea198372Config {
    private String name = "idea_198372";
 ...
 */
@Slf4j
public class Idea198372Service {
    private static final int IDEA_ID = 198372;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198372Service() {
        this(new Idea198372Config());
    }

    public Idea198372Service(Idea198372Config config) {
        this.config = config != null ? config : new Idea198372Config();
