...
@Data
public class Idea198135Config {
    private String name = "idea_198135";
 ...
 */
@Slf4j
public class Idea198135Service {
    private static final int IDEA_ID = 198135;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198135Service() {
        this(new Idea198135Config());
    }

    public Idea198135Service(Idea198135Config config) {
        this.config = config != null ? config : new Idea198135Config();
