...
@Data
public class Idea198332Config {
    private String name = "idea_198332";
 ...
 */
@Slf4j
public class Idea198332Service {
    private static final int IDEA_ID = 198332;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198332Service() {
        this(new Idea198332Config());
    }

    public Idea198332Service(Idea198332Config config) {
        this.config = config != null ? config : new Idea198332Config();
