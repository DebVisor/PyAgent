...
@Data
public class Idea198350Config {
    private String name = "idea_198350";
 ...
 */
@Slf4j
public class Idea198350Service {
    private static final int IDEA_ID = 198350;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198350Service() {
        this(new Idea198350Config());
    }

    public Idea198350Service(Idea198350Config config) {
        this.config = config != null ? config : new Idea198350Config();
