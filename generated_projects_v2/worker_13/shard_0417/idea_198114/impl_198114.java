...
@Data
public class Idea198114Config {
    private String name = "idea_198114";
 ...
 */
@Slf4j
public class Idea198114Service {
    private static final int IDEA_ID = 198114;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198114Service() {
        this(new Idea198114Config());
    }

    public Idea198114Service(Idea198114Config config) {
        this.config = config != null ? config : new Idea198114Config();
