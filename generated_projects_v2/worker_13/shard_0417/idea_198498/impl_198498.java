...
@Data
public class Idea198498Config {
    private String name = "idea_198498";
 ...
 */
@Slf4j
public class Idea198498Service {
    private static final int IDEA_ID = 198498;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198498Service() {
        this(new Idea198498Config());
    }

    public Idea198498Service(Idea198498Config config) {
        this.config = config != null ? config : new Idea198498Config();
