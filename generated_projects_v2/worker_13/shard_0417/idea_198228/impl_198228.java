...
@Data
public class Idea198228Config {
    private String name = "idea_198228";
 ...
 */
@Slf4j
public class Idea198228Service {
    private static final int IDEA_ID = 198228;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198228Service() {
        this(new Idea198228Config());
    }

    public Idea198228Service(Idea198228Config config) {
        this.config = config != null ? config : new Idea198228Config();
