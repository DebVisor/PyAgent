...
@Data
public class Idea198251Config {
    private String name = "idea_198251";
 ...
 */
@Slf4j
public class Idea198251Service {
    private static final int IDEA_ID = 198251;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198251Service() {
        this(new Idea198251Config());
    }

    public Idea198251Service(Idea198251Config config) {
        this.config = config != null ? config : new Idea198251Config();
