...
@Data
public class Idea198464Config {
    private String name = "idea_198464";
 ...
 */
@Slf4j
public class Idea198464Service {
    private static final int IDEA_ID = 198464;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198464Service() {
        this(new Idea198464Config());
    }

    public Idea198464Service(Idea198464Config config) {
        this.config = config != null ? config : new Idea198464Config();
