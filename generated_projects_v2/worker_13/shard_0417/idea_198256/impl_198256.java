...
@Data
public class Idea198256Config {
    private String name = "idea_198256";
 ...
 */
@Slf4j
public class Idea198256Service {
    private static final int IDEA_ID = 198256;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198256Service() {
        this(new Idea198256Config());
    }

    public Idea198256Service(Idea198256Config config) {
        this.config = config != null ? config : new Idea198256Config();
