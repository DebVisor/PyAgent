...
@Data
public class Idea198473Config {
    private String name = "idea_198473";
 ...
 */
@Slf4j
public class Idea198473Service {
    private static final int IDEA_ID = 198473;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198473Service() {
        this(new Idea198473Config());
    }

    public Idea198473Service(Idea198473Config config) {
        this.config = config != null ? config : new Idea198473Config();
