...
@Data
public class Idea198297Config {
    private String name = "idea_198297";
 ...
 */
@Slf4j
public class Idea198297Service {
    private static final int IDEA_ID = 198297;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198297Service() {
        this(new Idea198297Config());
    }

    public Idea198297Service(Idea198297Config config) {
        this.config = config != null ? config : new Idea198297Config();
