...
@Data
public class Idea198437Config {
    private String name = "idea_198437";
 ...
 */
@Slf4j
public class Idea198437Service {
    private static final int IDEA_ID = 198437;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198437Service() {
        this(new Idea198437Config());
    }

    public Idea198437Service(Idea198437Config config) {
        this.config = config != null ? config : new Idea198437Config();
