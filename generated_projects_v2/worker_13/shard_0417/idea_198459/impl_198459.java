...
@Data
public class Idea198459Config {
    private String name = "idea_198459";
 ...
 */
@Slf4j
public class Idea198459Service {
    private static final int IDEA_ID = 198459;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198459Service() {
        this(new Idea198459Config());
    }

    public Idea198459Service(Idea198459Config config) {
        this.config = config != null ? config : new Idea198459Config();
