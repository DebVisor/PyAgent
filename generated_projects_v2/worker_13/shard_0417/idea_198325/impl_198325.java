...
@Data
public class Idea198325Config {
    private String name = "idea_198325";
 ...
 */
@Slf4j
public class Idea198325Service {
    private static final int IDEA_ID = 198325;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198325Service() {
        this(new Idea198325Config());
    }

    public Idea198325Service(Idea198325Config config) {
        this.config = config != null ? config : new Idea198325Config();
