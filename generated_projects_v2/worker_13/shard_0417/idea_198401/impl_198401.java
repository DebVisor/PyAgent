...
@Data
public class Idea198401Config {
    private String name = "idea_198401";
 ...
 */
@Slf4j
public class Idea198401Service {
    private static final int IDEA_ID = 198401;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198401Service() {
        this(new Idea198401Config());
    }

    public Idea198401Service(Idea198401Config config) {
        this.config = config != null ? config : new Idea198401Config();
