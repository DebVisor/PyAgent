...
@Data
public class Idea198261Config {
    private String name = "idea_198261";
 ...
 */
@Slf4j
public class Idea198261Service {
    private static final int IDEA_ID = 198261;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198261Service() {
        this(new Idea198261Config());
    }

    public Idea198261Service(Idea198261Config config) {
        this.config = config != null ? config : new Idea198261Config();
