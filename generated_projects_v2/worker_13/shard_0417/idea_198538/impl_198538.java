...
@Data
public class Idea198538Config {
    private String name = "idea_198538";
 ...
 */
@Slf4j
public class Idea198538Service {
    private static final int IDEA_ID = 198538;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198538Service() {
        this(new Idea198538Config());
    }

    public Idea198538Service(Idea198538Config config) {
        this.config = config != null ? config : new Idea198538Config();
