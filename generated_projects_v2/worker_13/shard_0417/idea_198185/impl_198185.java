...
@Data
public class Idea198185Config {
    private String name = "idea_198185";
 ...
 */
@Slf4j
public class Idea198185Service {
    private static final int IDEA_ID = 198185;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198185Service() {
        this(new Idea198185Config());
    }

    public Idea198185Service(Idea198185Config config) {
        this.config = config != null ? config : new Idea198185Config();
