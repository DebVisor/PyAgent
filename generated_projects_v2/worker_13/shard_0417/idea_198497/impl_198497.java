...
@Data
public class Idea198497Config {
    private String name = "idea_198497";
 ...
 */
@Slf4j
public class Idea198497Service {
    private static final int IDEA_ID = 198497;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198497Service() {
        this(new Idea198497Config());
    }

    public Idea198497Service(Idea198497Config config) {
        this.config = config != null ? config : new Idea198497Config();
