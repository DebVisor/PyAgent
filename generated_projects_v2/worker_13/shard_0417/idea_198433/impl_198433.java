...
@Data
public class Idea198433Config {
    private String name = "idea_198433";
 ...
 */
@Slf4j
public class Idea198433Service {
    private static final int IDEA_ID = 198433;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198433Service() {
        this(new Idea198433Config());
    }

    public Idea198433Service(Idea198433Config config) {
        this.config = config != null ? config : new Idea198433Config();
