...
@Data
public class Idea198336Config {
    private String name = "idea_198336";
 ...
 */
@Slf4j
public class Idea198336Service {
    private static final int IDEA_ID = 198336;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198336Service() {
        this(new Idea198336Config());
    }

    public Idea198336Service(Idea198336Config config) {
        this.config = config != null ? config : new Idea198336Config();
