...
@Data
public class Idea198089Config {
    private String name = "idea_198089";
 ...
 */
@Slf4j
public class Idea198089Service {
    private static final int IDEA_ID = 198089;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198089Service() {
        this(new Idea198089Config());
    }

    public Idea198089Service(Idea198089Config config) {
        this.config = config != null ? config : new Idea198089Config();
