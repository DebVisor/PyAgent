...
@Data
public class Idea198381Config {
    private String name = "idea_198381";
 ...
 */
@Slf4j
public class Idea198381Service {
    private static final int IDEA_ID = 198381;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198381Service() {
        this(new Idea198381Config());
    }

    public Idea198381Service(Idea198381Config config) {
        this.config = config != null ? config : new Idea198381Config();
