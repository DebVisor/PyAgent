...
@Data
public class Idea198331Config {
    private String name = "idea_198331";
 ...
 */
@Slf4j
public class Idea198331Service {
    private static final int IDEA_ID = 198331;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198331Service() {
        this(new Idea198331Config());
    }

    public Idea198331Service(Idea198331Config config) {
        this.config = config != null ? config : new Idea198331Config();
