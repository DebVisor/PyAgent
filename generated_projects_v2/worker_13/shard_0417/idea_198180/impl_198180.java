...
@Data
public class Idea198180Config {
    private String name = "idea_198180";
 ...
 */
@Slf4j
public class Idea198180Service {
    private static final int IDEA_ID = 198180;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198180Service() {
        this(new Idea198180Config());
    }

    public Idea198180Service(Idea198180Config config) {
        this.config = config != null ? config : new Idea198180Config();
