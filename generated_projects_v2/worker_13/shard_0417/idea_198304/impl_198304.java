...
@Data
public class Idea198304Config {
    private String name = "idea_198304";
 ...
 */
@Slf4j
public class Idea198304Service {
    private static final int IDEA_ID = 198304;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198304Service() {
        this(new Idea198304Config());
    }

    public Idea198304Service(Idea198304Config config) {
        this.config = config != null ? config : new Idea198304Config();
