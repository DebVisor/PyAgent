...
@Data
public class Idea198514Config {
    private String name = "idea_198514";
 ...
 */
@Slf4j
public class Idea198514Service {
    private static final int IDEA_ID = 198514;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198514Service() {
        this(new Idea198514Config());
    }

    public Idea198514Service(Idea198514Config config) {
        this.config = config != null ? config : new Idea198514Config();
