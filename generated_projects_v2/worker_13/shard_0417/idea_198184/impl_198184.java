...
@Data
public class Idea198184Config {
    private String name = "idea_198184";
 ...
 */
@Slf4j
public class Idea198184Service {
    private static final int IDEA_ID = 198184;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198184Service() {
        this(new Idea198184Config());
    }

    public Idea198184Service(Idea198184Config config) {
        this.config = config != null ? config : new Idea198184Config();
