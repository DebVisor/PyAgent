...
@Data
public class Idea198254Config {
    private String name = "idea_198254";
 ...
 */
@Slf4j
public class Idea198254Service {
    private static final int IDEA_ID = 198254;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198254Service() {
        this(new Idea198254Config());
    }

    public Idea198254Service(Idea198254Config config) {
        this.config = config != null ? config : new Idea198254Config();
