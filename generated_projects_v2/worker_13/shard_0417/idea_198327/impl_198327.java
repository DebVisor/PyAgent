...
@Data
public class Idea198327Config {
    private String name = "idea_198327";
 ...
 */
@Slf4j
public class Idea198327Service {
    private static final int IDEA_ID = 198327;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198327Service() {
        this(new Idea198327Config());
    }

    public Idea198327Service(Idea198327Config config) {
        this.config = config != null ? config : new Idea198327Config();
