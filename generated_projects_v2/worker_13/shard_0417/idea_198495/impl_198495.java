...
@Data
public class Idea198495Config {
    private String name = "idea_198495";
 ...
 */
@Slf4j
public class Idea198495Service {
    private static final int IDEA_ID = 198495;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198495Service() {
        this(new Idea198495Config());
    }

    public Idea198495Service(Idea198495Config config) {
        this.config = config != null ? config : new Idea198495Config();
