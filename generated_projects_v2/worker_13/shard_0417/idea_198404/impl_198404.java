...
@Data
public class Idea198404Config {
    private String name = "idea_198404";
 ...
 */
@Slf4j
public class Idea198404Service {
    private static final int IDEA_ID = 198404;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198404Service() {
        this(new Idea198404Config());
    }

    public Idea198404Service(Idea198404Config config) {
        this.config = config != null ? config : new Idea198404Config();
