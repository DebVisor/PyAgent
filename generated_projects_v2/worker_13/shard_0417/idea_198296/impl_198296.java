...
@Data
public class Idea198296Config {
    private String name = "idea_198296";
 ...
 */
@Slf4j
public class Idea198296Service {
    private static final int IDEA_ID = 198296;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198296Service() {
        this(new Idea198296Config());
    }

    public Idea198296Service(Idea198296Config config) {
        this.config = config != null ? config : new Idea198296Config();
