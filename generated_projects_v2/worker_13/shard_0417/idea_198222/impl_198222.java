...
@Data
public class Idea198222Config {
    private String name = "idea_198222";
 ...
 */
@Slf4j
public class Idea198222Service {
    private static final int IDEA_ID = 198222;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198222Service() {
        this(new Idea198222Config());
    }

    public Idea198222Service(Idea198222Config config) {
        this.config = config != null ? config : new Idea198222Config();
