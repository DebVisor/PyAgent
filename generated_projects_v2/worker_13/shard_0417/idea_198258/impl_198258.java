...
@Data
public class Idea198258Config {
    private String name = "idea_198258";
 ...
 */
@Slf4j
public class Idea198258Service {
    private static final int IDEA_ID = 198258;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198258Service() {
        this(new Idea198258Config());
    }

    public Idea198258Service(Idea198258Config config) {
        this.config = config != null ? config : new Idea198258Config();
