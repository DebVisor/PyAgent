...
@Data
public class Idea198455Config {
    private String name = "idea_198455";
 ...
 */
@Slf4j
public class Idea198455Service {
    private static final int IDEA_ID = 198455;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198455Service() {
        this(new Idea198455Config());
    }

    public Idea198455Service(Idea198455Config config) {
        this.config = config != null ? config : new Idea198455Config();
