...
@Data
public class Idea198232Config {
    private String name = "idea_198232";
 ...
 */
@Slf4j
public class Idea198232Service {
    private static final int IDEA_ID = 198232;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198232Service() {
        this(new Idea198232Config());
    }

    public Idea198232Service(Idea198232Config config) {
        this.config = config != null ? config : new Idea198232Config();
