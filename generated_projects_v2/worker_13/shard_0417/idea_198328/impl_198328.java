...
@Data
public class Idea198328Config {
    private String name = "idea_198328";
 ...
 */
@Slf4j
public class Idea198328Service {
    private static final int IDEA_ID = 198328;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198328Service() {
        this(new Idea198328Config());
    }

    public Idea198328Service(Idea198328Config config) {
        this.config = config != null ? config : new Idea198328Config();
