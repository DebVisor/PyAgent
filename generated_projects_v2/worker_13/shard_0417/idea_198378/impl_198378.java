...
@Data
public class Idea198378Config {
    private String name = "idea_198378";
 ...
 */
@Slf4j
public class Idea198378Service {
    private static final int IDEA_ID = 198378;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198378Service() {
        this(new Idea198378Config());
    }

    public Idea198378Service(Idea198378Config config) {
        this.config = config != null ? config : new Idea198378Config();
