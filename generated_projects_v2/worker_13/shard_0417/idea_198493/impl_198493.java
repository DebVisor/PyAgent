...
@Data
public class Idea198493Config {
    private String name = "idea_198493";
 ...
 */
@Slf4j
public class Idea198493Service {
    private static final int IDEA_ID = 198493;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198493Service() {
        this(new Idea198493Config());
    }

    public Idea198493Service(Idea198493Config config) {
        this.config = config != null ? config : new Idea198493Config();
