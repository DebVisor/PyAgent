...
@Data
public class Idea198504Config {
    private String name = "idea_198504";
 ...
 */
@Slf4j
public class Idea198504Service {
    private static final int IDEA_ID = 198504;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198504Service() {
        this(new Idea198504Config());
    }

    public Idea198504Service(Idea198504Config config) {
        this.config = config != null ? config : new Idea198504Config();
