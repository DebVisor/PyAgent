...
@Data
public class Idea198128Config {
    private String name = "idea_198128";
 ...
 */
@Slf4j
public class Idea198128Service {
    private static final int IDEA_ID = 198128;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198128Service() {
        this(new Idea198128Config());
    }

    public Idea198128Service(Idea198128Config config) {
        this.config = config != null ? config : new Idea198128Config();
