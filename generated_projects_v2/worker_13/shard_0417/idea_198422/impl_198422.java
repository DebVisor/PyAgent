...
@Data
public class Idea198422Config {
    private String name = "idea_198422";
 ...
 */
@Slf4j
public class Idea198422Service {
    private static final int IDEA_ID = 198422;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198422Service() {
        this(new Idea198422Config());
    }

    public Idea198422Service(Idea198422Config config) {
        this.config = config != null ? config : new Idea198422Config();
