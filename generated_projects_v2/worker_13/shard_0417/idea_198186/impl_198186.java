...
@Data
public class Idea198186Config {
    private String name = "idea_198186";
 ...
 */
@Slf4j
public class Idea198186Service {
    private static final int IDEA_ID = 198186;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198186Service() {
        this(new Idea198186Config());
    }

    public Idea198186Service(Idea198186Config config) {
        this.config = config != null ? config : new Idea198186Config();
