...
@Data
public class Idea198129Config {
    private String name = "idea_198129";
 ...
 */
@Slf4j
public class Idea198129Service {
    private static final int IDEA_ID = 198129;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198129Service() {
        this(new Idea198129Config());
    }

    public Idea198129Service(Idea198129Config config) {
        this.config = config != null ? config : new Idea198129Config();
