...
@Data
public class Idea198549Config {
    private String name = "idea_198549";
 ...
 */
@Slf4j
public class Idea198549Service {
    private static final int IDEA_ID = 198549;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198549Service() {
        this(new Idea198549Config());
    }

    public Idea198549Service(Idea198549Config config) {
        this.config = config != null ? config : new Idea198549Config();
