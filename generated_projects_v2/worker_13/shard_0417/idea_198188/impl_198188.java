...
@Data
public class Idea198188Config {
    private String name = "idea_198188";
 ...
 */
@Slf4j
public class Idea198188Service {
    private static final int IDEA_ID = 198188;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198188Service() {
        this(new Idea198188Config());
    }

    public Idea198188Service(Idea198188Config config) {
        this.config = config != null ? config : new Idea198188Config();
