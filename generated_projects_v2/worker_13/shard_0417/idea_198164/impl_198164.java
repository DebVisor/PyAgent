...
@Data
public class Idea198164Config {
    private String name = "idea_198164";
 ...
 */
@Slf4j
public class Idea198164Service {
    private static final int IDEA_ID = 198164;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198164Service() {
        this(new Idea198164Config());
    }

    public Idea198164Service(Idea198164Config config) {
        this.config = config != null ? config : new Idea198164Config();
