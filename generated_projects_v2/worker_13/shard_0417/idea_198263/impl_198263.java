...
@Data
public class Idea198263Config {
    private String name = "idea_198263";
 ...
 */
@Slf4j
public class Idea198263Service {
    private static final int IDEA_ID = 198263;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198263Service() {
        this(new Idea198263Config());
    }

    public Idea198263Service(Idea198263Config config) {
        this.config = config != null ? config : new Idea198263Config();
