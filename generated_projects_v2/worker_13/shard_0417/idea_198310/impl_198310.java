...
@Data
public class Idea198310Config {
    private String name = "idea_198310";
 ...
 */
@Slf4j
public class Idea198310Service {
    private static final int IDEA_ID = 198310;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198310Service() {
        this(new Idea198310Config());
    }

    public Idea198310Service(Idea198310Config config) {
        this.config = config != null ? config : new Idea198310Config();
