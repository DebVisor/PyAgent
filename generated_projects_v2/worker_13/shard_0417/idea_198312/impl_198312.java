...
@Data
public class Idea198312Config {
    private String name = "idea_198312";
 ...
 */
@Slf4j
public class Idea198312Service {
    private static final int IDEA_ID = 198312;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198312Service() {
        this(new Idea198312Config());
    }

    public Idea198312Service(Idea198312Config config) {
        this.config = config != null ? config : new Idea198312Config();
