...
@Data
public class Idea198240Config {
    private String name = "idea_198240";
 ...
 */
@Slf4j
public class Idea198240Service {
    private static final int IDEA_ID = 198240;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198240Service() {
        this(new Idea198240Config());
    }

    public Idea198240Service(Idea198240Config config) {
        this.config = config != null ? config : new Idea198240Config();
