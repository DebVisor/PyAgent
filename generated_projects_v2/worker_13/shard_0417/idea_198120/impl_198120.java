...
@Data
public class Idea198120Config {
    private String name = "idea_198120";
 ...
 */
@Slf4j
public class Idea198120Service {
    private static final int IDEA_ID = 198120;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198120Service() {
        this(new Idea198120Config());
    }

    public Idea198120Service(Idea198120Config config) {
        this.config = config != null ? config : new Idea198120Config();
