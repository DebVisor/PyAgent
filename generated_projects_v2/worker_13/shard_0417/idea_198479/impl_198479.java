...
@Data
public class Idea198479Config {
    private String name = "idea_198479";
 ...
 */
@Slf4j
public class Idea198479Service {
    private static final int IDEA_ID = 198479;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198479Service() {
        this(new Idea198479Config());
    }

    public Idea198479Service(Idea198479Config config) {
        this.config = config != null ? config : new Idea198479Config();
