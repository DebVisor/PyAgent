...
@Data
public class Idea198149Config {
    private String name = "idea_198149";
 ...
 */
@Slf4j
public class Idea198149Service {
    private static final int IDEA_ID = 198149;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198149Service() {
        this(new Idea198149Config());
    }

    public Idea198149Service(Idea198149Config config) {
        this.config = config != null ? config : new Idea198149Config();
