...
@Data
public class Idea198368Config {
    private String name = "idea_198368";
 ...
 */
@Slf4j
public class Idea198368Service {
    private static final int IDEA_ID = 198368;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198368Service() {
        this(new Idea198368Config());
    }

    public Idea198368Service(Idea198368Config config) {
        this.config = config != null ? config : new Idea198368Config();
