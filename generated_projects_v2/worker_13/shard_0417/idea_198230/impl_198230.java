...
@Data
public class Idea198230Config {
    private String name = "idea_198230";
 ...
 */
@Slf4j
public class Idea198230Service {
    private static final int IDEA_ID = 198230;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198230Service() {
        this(new Idea198230Config());
    }

    public Idea198230Service(Idea198230Config config) {
        this.config = config != null ? config : new Idea198230Config();
