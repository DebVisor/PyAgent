...
@Data
public class Idea198079Config {
    private String name = "idea_198079";
 ...
 */
@Slf4j
public class Idea198079Service {
    private static final int IDEA_ID = 198079;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198079Service() {
        this(new Idea198079Config());
    }

    public Idea198079Service(Idea198079Config config) {
        this.config = config != null ? config : new Idea198079Config();
