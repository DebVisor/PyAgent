...
@Data
public class Idea198369Config {
    private String name = "idea_198369";
 ...
 */
@Slf4j
public class Idea198369Service {
    private static final int IDEA_ID = 198369;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198369Service() {
        this(new Idea198369Config());
    }

    public Idea198369Service(Idea198369Config config) {
        this.config = config != null ? config : new Idea198369Config();
