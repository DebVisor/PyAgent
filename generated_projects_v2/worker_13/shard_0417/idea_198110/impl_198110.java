...
@Data
public class Idea198110Config {
    private String name = "idea_198110";
 ...
 */
@Slf4j
public class Idea198110Service {
    private static final int IDEA_ID = 198110;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198110Service() {
        this(new Idea198110Config());
    }

    public Idea198110Service(Idea198110Config config) {
        this.config = config != null ? config : new Idea198110Config();
