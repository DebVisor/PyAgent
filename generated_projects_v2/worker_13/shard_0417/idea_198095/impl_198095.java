...
@Data
public class Idea198095Config {
    private String name = "idea_198095";
 ...
 */
@Slf4j
public class Idea198095Service {
    private static final int IDEA_ID = 198095;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198095Service() {
        this(new Idea198095Config());
    }

    public Idea198095Service(Idea198095Config config) {
        this.config = config != null ? config : new Idea198095Config();
