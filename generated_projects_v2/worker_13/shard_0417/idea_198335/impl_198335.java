...
@Data
public class Idea198335Config {
    private String name = "idea_198335";
 ...
 */
@Slf4j
public class Idea198335Service {
    private static final int IDEA_ID = 198335;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198335Service() {
        this(new Idea198335Config());
    }

    public Idea198335Service(Idea198335Config config) {
        this.config = config != null ? config : new Idea198335Config();
