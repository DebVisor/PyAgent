...
@Data
public class Idea198183Config {
    private String name = "idea_198183";
 ...
 */
@Slf4j
public class Idea198183Service {
    private static final int IDEA_ID = 198183;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198183Service() {
        this(new Idea198183Config());
    }

    public Idea198183Service(Idea198183Config config) {
        this.config = config != null ? config : new Idea198183Config();
