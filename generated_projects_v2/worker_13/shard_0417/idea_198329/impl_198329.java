...
@Data
public class Idea198329Config {
    private String name = "idea_198329";
 ...
 */
@Slf4j
public class Idea198329Service {
    private static final int IDEA_ID = 198329;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198329Service() {
        this(new Idea198329Config());
    }

    public Idea198329Service(Idea198329Config config) {
        this.config = config != null ? config : new Idea198329Config();
