...
@Data
public class Idea198544Config {
    private String name = "idea_198544";
 ...
 */
@Slf4j
public class Idea198544Service {
    private static final int IDEA_ID = 198544;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198544Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198544Service() {
        this(new Idea198544Config());
    }

    public Idea198544Service(Idea198544Config config) {
        this.config = config != null ? config : new Idea198544Config();
