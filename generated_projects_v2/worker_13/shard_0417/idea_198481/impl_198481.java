...
@Data
public class Idea198481Config {
    private String name = "idea_198481";
 ...
 */
@Slf4j
public class Idea198481Service {
    private static final int IDEA_ID = 198481;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198481Service() {
        this(new Idea198481Config());
    }

    public Idea198481Service(Idea198481Config config) {
        this.config = config != null ? config : new Idea198481Config();
