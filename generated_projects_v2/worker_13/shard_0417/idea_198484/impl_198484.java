...
@Data
public class Idea198484Config {
    private String name = "idea_198484";
 ...
 */
@Slf4j
public class Idea198484Service {
    private static final int IDEA_ID = 198484;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198484Service() {
        this(new Idea198484Config());
    }

    public Idea198484Service(Idea198484Config config) {
        this.config = config != null ? config : new Idea198484Config();
