...
@Data
public class Idea198385Config {
    private String name = "idea_198385";
 ...
 */
@Slf4j
public class Idea198385Service {
    private static final int IDEA_ID = 198385;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198385Service() {
        this(new Idea198385Config());
    }

    public Idea198385Service(Idea198385Config config) {
        this.config = config != null ? config : new Idea198385Config();
