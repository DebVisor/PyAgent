...
@Data
public class Idea198080Config {
    private String name = "idea_198080";
 ...
 */
@Slf4j
public class Idea198080Service {
    private static final int IDEA_ID = 198080;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198080Service() {
        this(new Idea198080Config());
    }

    public Idea198080Service(Idea198080Config config) {
        this.config = config != null ? config : new Idea198080Config();
