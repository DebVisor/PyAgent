...
@Data
public class Idea198348Config {
    private String name = "idea_198348";
 ...
 */
@Slf4j
public class Idea198348Service {
    private static final int IDEA_ID = 198348;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198348Service() {
        this(new Idea198348Config());
    }

    public Idea198348Service(Idea198348Config config) {
        this.config = config != null ? config : new Idea198348Config();
