...
@Data
public class Idea198111Config {
    private String name = "idea_198111";
 ...
 */
@Slf4j
public class Idea198111Service {
    private static final int IDEA_ID = 198111;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198111Service() {
        this(new Idea198111Config());
    }

    public Idea198111Service(Idea198111Config config) {
        this.config = config != null ? config : new Idea198111Config();
