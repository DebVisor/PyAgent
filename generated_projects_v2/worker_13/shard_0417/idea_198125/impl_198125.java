...
@Data
public class Idea198125Config {
    private String name = "idea_198125";
 ...
 */
@Slf4j
public class Idea198125Service {
    private static final int IDEA_ID = 198125;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198125Service() {
        this(new Idea198125Config());
    }

    public Idea198125Service(Idea198125Config config) {
        this.config = config != null ? config : new Idea198125Config();
