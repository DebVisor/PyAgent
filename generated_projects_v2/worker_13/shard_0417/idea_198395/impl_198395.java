...
@Data
public class Idea198395Config {
    private String name = "idea_198395";
 ...
 */
@Slf4j
public class Idea198395Service {
    private static final int IDEA_ID = 198395;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198395Service() {
        this(new Idea198395Config());
    }

    public Idea198395Service(Idea198395Config config) {
        this.config = config != null ? config : new Idea198395Config();
