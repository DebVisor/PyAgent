...
@Data
public class Idea198447Config {
    private String name = "idea_198447";
 ...
 */
@Slf4j
public class Idea198447Service {
    private static final int IDEA_ID = 198447;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198447Service() {
        this(new Idea198447Config());
    }

    public Idea198447Service(Idea198447Config config) {
        this.config = config != null ? config : new Idea198447Config();
