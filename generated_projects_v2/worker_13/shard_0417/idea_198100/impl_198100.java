...
@Data
public class Idea198100Config {
    private String name = "idea_198100";
 ...
 */
@Slf4j
public class Idea198100Service {
    private static final int IDEA_ID = 198100;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198100Service() {
        this(new Idea198100Config());
    }

    public Idea198100Service(Idea198100Config config) {
        this.config = config != null ? config : new Idea198100Config();
