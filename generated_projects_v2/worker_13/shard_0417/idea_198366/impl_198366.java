...
@Data
public class Idea198366Config {
    private String name = "idea_198366";
 ...
 */
@Slf4j
public class Idea198366Service {
    private static final int IDEA_ID = 198366;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198366Service() {
        this(new Idea198366Config());
    }

    public Idea198366Service(Idea198366Config config) {
        this.config = config != null ? config : new Idea198366Config();
