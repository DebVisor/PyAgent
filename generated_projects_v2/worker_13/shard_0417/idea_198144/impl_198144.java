...
@Data
public class Idea198144Config {
    private String name = "idea_198144";
 ...
 */
@Slf4j
public class Idea198144Service {
    private static final int IDEA_ID = 198144;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198144Service() {
        this(new Idea198144Config());
    }

    public Idea198144Service(Idea198144Config config) {
        this.config = config != null ? config : new Idea198144Config();
