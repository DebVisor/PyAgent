...
@Data
public class Idea198474Config {
    private String name = "idea_198474";
 ...
 */
@Slf4j
public class Idea198474Service {
    private static final int IDEA_ID = 198474;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198474Service() {
        this(new Idea198474Config());
    }

    public Idea198474Service(Idea198474Config config) {
        this.config = config != null ? config : new Idea198474Config();
