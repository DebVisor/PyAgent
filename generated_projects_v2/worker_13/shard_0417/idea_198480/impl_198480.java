...
@Data
public class Idea198480Config {
    private String name = "idea_198480";
 ...
 */
@Slf4j
public class Idea198480Service {
    private static final int IDEA_ID = 198480;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198480Service() {
        this(new Idea198480Config());
    }

    public Idea198480Service(Idea198480Config config) {
        this.config = config != null ? config : new Idea198480Config();
