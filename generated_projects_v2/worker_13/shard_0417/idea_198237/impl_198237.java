...
@Data
public class Idea198237Config {
    private String name = "idea_198237";
 ...
 */
@Slf4j
public class Idea198237Service {
    private static final int IDEA_ID = 198237;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198237Service() {
        this(new Idea198237Config());
    }

    public Idea198237Service(Idea198237Config config) {
        this.config = config != null ? config : new Idea198237Config();
