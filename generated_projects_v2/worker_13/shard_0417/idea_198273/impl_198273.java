...
@Data
public class Idea198273Config {
    private String name = "idea_198273";
 ...
 */
@Slf4j
public class Idea198273Service {
    private static final int IDEA_ID = 198273;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198273Service() {
        this(new Idea198273Config());
    }

    public Idea198273Service(Idea198273Config config) {
        this.config = config != null ? config : new Idea198273Config();
