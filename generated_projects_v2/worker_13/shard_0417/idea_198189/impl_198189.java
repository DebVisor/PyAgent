...
@Data
public class Idea198189Config {
    private String name = "idea_198189";
 ...
 */
@Slf4j
public class Idea198189Service {
    private static final int IDEA_ID = 198189;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198189Service() {
        this(new Idea198189Config());
    }

    public Idea198189Service(Idea198189Config config) {
        this.config = config != null ? config : new Idea198189Config();
