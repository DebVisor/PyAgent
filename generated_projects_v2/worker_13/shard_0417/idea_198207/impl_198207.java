...
@Data
public class Idea198207Config {
    private String name = "idea_198207";
 ...
 */
@Slf4j
public class Idea198207Service {
    private static final int IDEA_ID = 198207;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198207Service() {
        this(new Idea198207Config());
    }

    public Idea198207Service(Idea198207Config config) {
        this.config = config != null ? config : new Idea198207Config();
