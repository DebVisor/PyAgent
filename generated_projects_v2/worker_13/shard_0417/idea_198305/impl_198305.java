...
@Data
public class Idea198305Config {
    private String name = "idea_198305";
 ...
 */
@Slf4j
public class Idea198305Service {
    private static final int IDEA_ID = 198305;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198305Service() {
        this(new Idea198305Config());
    }

    public Idea198305Service(Idea198305Config config) {
        this.config = config != null ? config : new Idea198305Config();
