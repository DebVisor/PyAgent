...
@Data
public class Idea198224Config {
    private String name = "idea_198224";
 ...
 */
@Slf4j
public class Idea198224Service {
    private static final int IDEA_ID = 198224;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198224Service() {
        this(new Idea198224Config());
    }

    public Idea198224Service(Idea198224Config config) {
        this.config = config != null ? config : new Idea198224Config();
