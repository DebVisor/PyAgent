...
@Data
public class Idea198112Config {
    private String name = "idea_198112";
 ...
 */
@Slf4j
public class Idea198112Service {
    private static final int IDEA_ID = 198112;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198112Service() {
        this(new Idea198112Config());
    }

    public Idea198112Service(Idea198112Config config) {
        this.config = config != null ? config : new Idea198112Config();
