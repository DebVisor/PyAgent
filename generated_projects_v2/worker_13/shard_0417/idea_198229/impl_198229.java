...
@Data
public class Idea198229Config {
    private String name = "idea_198229";
 ...
 */
@Slf4j
public class Idea198229Service {
    private static final int IDEA_ID = 198229;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198229Service() {
        this(new Idea198229Config());
    }

    public Idea198229Service(Idea198229Config config) {
        this.config = config != null ? config : new Idea198229Config();
