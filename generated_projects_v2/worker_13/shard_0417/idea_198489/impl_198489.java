...
@Data
public class Idea198489Config {
    private String name = "idea_198489";
 ...
 */
@Slf4j
public class Idea198489Service {
    private static final int IDEA_ID = 198489;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198489Service() {
        this(new Idea198489Config());
    }

    public Idea198489Service(Idea198489Config config) {
        this.config = config != null ? config : new Idea198489Config();
