...
@Data
public class Idea198198Config {
    private String name = "idea_198198";
 ...
 */
@Slf4j
public class Idea198198Service {
    private static final int IDEA_ID = 198198;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198198Service() {
        this(new Idea198198Config());
    }

    public Idea198198Service(Idea198198Config config) {
        this.config = config != null ? config : new Idea198198Config();
