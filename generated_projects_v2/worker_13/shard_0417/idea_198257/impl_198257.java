...
@Data
public class Idea198257Config {
    private String name = "idea_198257";
 ...
 */
@Slf4j
public class Idea198257Service {
    private static final int IDEA_ID = 198257;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198257Service() {
        this(new Idea198257Config());
    }

    public Idea198257Service(Idea198257Config config) {
        this.config = config != null ? config : new Idea198257Config();
