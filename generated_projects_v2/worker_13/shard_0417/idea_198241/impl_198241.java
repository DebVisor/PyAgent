...
@Data
public class Idea198241Config {
    private String name = "idea_198241";
 ...
 */
@Slf4j
public class Idea198241Service {
    private static final int IDEA_ID = 198241;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198241Service() {
        this(new Idea198241Config());
    }

    public Idea198241Service(Idea198241Config config) {
        this.config = config != null ? config : new Idea198241Config();
