...
@Data
public class Idea198086Config {
    private String name = "idea_198086";
 ...
 */
@Slf4j
public class Idea198086Service {
    private static final int IDEA_ID = 198086;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea198086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea198086Service() {
        this(new Idea198086Config());
    }

    public Idea198086Service(Idea198086Config config) {
        this.config = config != null ? config : new Idea198086Config();
