...
@Data
public class Idea196512Config {
    private String name = "idea_196512";
 ...
 */
@Slf4j
public class Idea196512Service {
    private static final int IDEA_ID = 196512;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196512Service() {
        this(new Idea196512Config());
    }

    public Idea196512Service(Idea196512Config config) {
        this.config = config != null ? config : new Idea196512Config();
