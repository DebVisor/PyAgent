...
@Data
public class Idea196314Config {
    private String name = "idea_196314";
 ...
 */
@Slf4j
public class Idea196314Service {
    private static final int IDEA_ID = 196314;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196314Service() {
        this(new Idea196314Config());
    }

    public Idea196314Service(Idea196314Config config) {
        this.config = config != null ? config : new Idea196314Config();
