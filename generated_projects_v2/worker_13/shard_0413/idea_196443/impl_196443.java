...
@Data
public class Idea196443Config {
    private String name = "idea_196443";
 ...
 */
@Slf4j
public class Idea196443Service {
    private static final int IDEA_ID = 196443;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196443Service() {
        this(new Idea196443Config());
    }

    public Idea196443Service(Idea196443Config config) {
        this.config = config != null ? config : new Idea196443Config();
