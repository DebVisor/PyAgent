...
@Data
public class Idea196403Config {
    private String name = "idea_196403";
 ...
 */
@Slf4j
public class Idea196403Service {
    private static final int IDEA_ID = 196403;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196403Service() {
        this(new Idea196403Config());
    }

    public Idea196403Service(Idea196403Config config) {
        this.config = config != null ? config : new Idea196403Config();
