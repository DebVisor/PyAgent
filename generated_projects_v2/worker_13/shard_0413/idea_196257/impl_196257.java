...
@Data
public class Idea196257Config {
    private String name = "idea_196257";
 ...
 */
@Slf4j
public class Idea196257Service {
    private static final int IDEA_ID = 196257;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196257Service() {
        this(new Idea196257Config());
    }

    public Idea196257Service(Idea196257Config config) {
        this.config = config != null ? config : new Idea196257Config();
