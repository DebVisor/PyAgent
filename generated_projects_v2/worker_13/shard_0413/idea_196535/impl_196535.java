...
@Data
public class Idea196535Config {
    private String name = "idea_196535";
 ...
 */
@Slf4j
public class Idea196535Service {
    private static final int IDEA_ID = 196535;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196535Service() {
        this(new Idea196535Config());
    }

    public Idea196535Service(Idea196535Config config) {
        this.config = config != null ? config : new Idea196535Config();
