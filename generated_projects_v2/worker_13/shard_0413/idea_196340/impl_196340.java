...
@Data
public class Idea196340Config {
    private String name = "idea_196340";
 ...
 */
@Slf4j
public class Idea196340Service {
    private static final int IDEA_ID = 196340;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196340Service() {
        this(new Idea196340Config());
    }

    public Idea196340Service(Idea196340Config config) {
        this.config = config != null ? config : new Idea196340Config();
