...
@Data
public class Idea196511Config {
    private String name = "idea_196511";
 ...
 */
@Slf4j
public class Idea196511Service {
    private static final int IDEA_ID = 196511;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196511Service() {
        this(new Idea196511Config());
    }

    public Idea196511Service(Idea196511Config config) {
        this.config = config != null ? config : new Idea196511Config();
