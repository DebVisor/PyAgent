...
@Data
public class Idea196453Config {
    private String name = "idea_196453";
 ...
 */
@Slf4j
public class Idea196453Service {
    private static final int IDEA_ID = 196453;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196453Service() {
        this(new Idea196453Config());
    }

    public Idea196453Service(Idea196453Config config) {
        this.config = config != null ? config : new Idea196453Config();
