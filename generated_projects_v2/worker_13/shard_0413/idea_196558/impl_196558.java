...
@Data
public class Idea196558Config {
    private String name = "idea_196558";
 ...
 */
@Slf4j
public class Idea196558Service {
    private static final int IDEA_ID = 196558;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196558Service() {
        this(new Idea196558Config());
    }

    public Idea196558Service(Idea196558Config config) {
        this.config = config != null ? config : new Idea196558Config();
