...
@Data
public class Idea196249Config {
    private String name = "idea_196249";
 ...
 */
@Slf4j
public class Idea196249Service {
    private static final int IDEA_ID = 196249;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196249Service() {
        this(new Idea196249Config());
    }

    public Idea196249Service(Idea196249Config config) {
        this.config = config != null ? config : new Idea196249Config();
