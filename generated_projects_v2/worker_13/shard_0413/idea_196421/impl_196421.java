...
@Data
public class Idea196421Config {
    private String name = "idea_196421";
 ...
 */
@Slf4j
public class Idea196421Service {
    private static final int IDEA_ID = 196421;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196421Service() {
        this(new Idea196421Config());
    }

    public Idea196421Service(Idea196421Config config) {
        this.config = config != null ? config : new Idea196421Config();
