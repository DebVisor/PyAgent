...
@Data
public class Idea196380Config {
    private String name = "idea_196380";
 ...
 */
@Slf4j
public class Idea196380Service {
    private static final int IDEA_ID = 196380;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196380Service() {
        this(new Idea196380Config());
    }

    public Idea196380Service(Idea196380Config config) {
        this.config = config != null ? config : new Idea196380Config();
