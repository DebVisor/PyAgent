...
@Data
public class Idea196333Config {
    private String name = "idea_196333";
 ...
 */
@Slf4j
public class Idea196333Service {
    private static final int IDEA_ID = 196333;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196333Service() {
        this(new Idea196333Config());
    }

    public Idea196333Service(Idea196333Config config) {
        this.config = config != null ? config : new Idea196333Config();
