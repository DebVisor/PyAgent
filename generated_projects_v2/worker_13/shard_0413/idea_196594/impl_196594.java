...
@Data
public class Idea196594Config {
    private String name = "idea_196594";
 ...
 */
@Slf4j
public class Idea196594Service {
    private static final int IDEA_ID = 196594;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196594Service() {
        this(new Idea196594Config());
    }

    public Idea196594Service(Idea196594Config config) {
        this.config = config != null ? config : new Idea196594Config();
