...
@Data
public class Idea196525Config {
    private String name = "idea_196525";
 ...
 */
@Slf4j
public class Idea196525Service {
    private static final int IDEA_ID = 196525;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196525Service() {
        this(new Idea196525Config());
    }

    public Idea196525Service(Idea196525Config config) {
        this.config = config != null ? config : new Idea196525Config();
