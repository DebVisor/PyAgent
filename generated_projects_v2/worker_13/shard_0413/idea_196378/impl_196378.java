...
@Data
public class Idea196378Config {
    private String name = "idea_196378";
 ...
 */
@Slf4j
public class Idea196378Service {
    private static final int IDEA_ID = 196378;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196378Service() {
        this(new Idea196378Config());
    }

    public Idea196378Service(Idea196378Config config) {
        this.config = config != null ? config : new Idea196378Config();
