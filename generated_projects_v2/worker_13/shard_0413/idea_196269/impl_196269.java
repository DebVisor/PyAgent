...
@Data
public class Idea196269Config {
    private String name = "idea_196269";
 ...
 */
@Slf4j
public class Idea196269Service {
    private static final int IDEA_ID = 196269;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196269Service() {
        this(new Idea196269Config());
    }

    public Idea196269Service(Idea196269Config config) {
        this.config = config != null ? config : new Idea196269Config();
