...
@Data
public class Idea196351Config {
    private String name = "idea_196351";
 ...
 */
@Slf4j
public class Idea196351Service {
    private static final int IDEA_ID = 196351;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196351Service() {
        this(new Idea196351Config());
    }

    public Idea196351Service(Idea196351Config config) {
        this.config = config != null ? config : new Idea196351Config();
