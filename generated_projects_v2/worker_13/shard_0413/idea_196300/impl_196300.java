...
@Data
public class Idea196300Config {
    private String name = "idea_196300";
 ...
 */
@Slf4j
public class Idea196300Service {
    private static final int IDEA_ID = 196300;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196300Service() {
        this(new Idea196300Config());
    }

    public Idea196300Service(Idea196300Config config) {
        this.config = config != null ? config : new Idea196300Config();
