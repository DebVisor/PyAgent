...
@Data
public class Idea196317Config {
    private String name = "idea_196317";
 ...
 */
@Slf4j
public class Idea196317Service {
    private static final int IDEA_ID = 196317;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196317Service() {
        this(new Idea196317Config());
    }

    public Idea196317Service(Idea196317Config config) {
        this.config = config != null ? config : new Idea196317Config();
