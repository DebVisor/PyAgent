...
@Data
public class Idea196325Config {
    private String name = "idea_196325";
 ...
 */
@Slf4j
public class Idea196325Service {
    private static final int IDEA_ID = 196325;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196325Service() {
        this(new Idea196325Config());
    }

    public Idea196325Service(Idea196325Config config) {
        this.config = config != null ? config : new Idea196325Config();
