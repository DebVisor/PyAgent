...
@Data
public class Idea196489Config {
    private String name = "idea_196489";
 ...
 */
@Slf4j
public class Idea196489Service {
    private static final int IDEA_ID = 196489;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196489Service() {
        this(new Idea196489Config());
    }

    public Idea196489Service(Idea196489Config config) {
        this.config = config != null ? config : new Idea196489Config();
