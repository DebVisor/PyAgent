...
@Data
public class Idea196364Config {
    private String name = "idea_196364";
 ...
 */
@Slf4j
public class Idea196364Service {
    private static final int IDEA_ID = 196364;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196364Service() {
        this(new Idea196364Config());
    }

    public Idea196364Service(Idea196364Config config) {
        this.config = config != null ? config : new Idea196364Config();
