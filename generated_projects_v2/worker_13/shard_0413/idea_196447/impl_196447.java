...
@Data
public class Idea196447Config {
    private String name = "idea_196447";
 ...
 */
@Slf4j
public class Idea196447Service {
    private static final int IDEA_ID = 196447;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196447Service() {
        this(new Idea196447Config());
    }

    public Idea196447Service(Idea196447Config config) {
        this.config = config != null ? config : new Idea196447Config();
