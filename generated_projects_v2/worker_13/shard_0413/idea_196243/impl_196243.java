...
@Data
public class Idea196243Config {
    private String name = "idea_196243";
 ...
 */
@Slf4j
public class Idea196243Service {
    private static final int IDEA_ID = 196243;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196243Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196243Service() {
        this(new Idea196243Config());
    }

    public Idea196243Service(Idea196243Config config) {
        this.config = config != null ? config : new Idea196243Config();
