...
@Data
public class Idea196369Config {
    private String name = "idea_196369";
 ...
 */
@Slf4j
public class Idea196369Service {
    private static final int IDEA_ID = 196369;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196369Service() {
        this(new Idea196369Config());
    }

    public Idea196369Service(Idea196369Config config) {
        this.config = config != null ? config : new Idea196369Config();
