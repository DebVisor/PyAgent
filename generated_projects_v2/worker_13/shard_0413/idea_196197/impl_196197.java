...
@Data
public class Idea196197Config {
    private String name = "idea_196197";
 ...
 */
@Slf4j
public class Idea196197Service {
    private static final int IDEA_ID = 196197;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196197Service() {
        this(new Idea196197Config());
    }

    public Idea196197Service(Idea196197Config config) {
        this.config = config != null ? config : new Idea196197Config();
