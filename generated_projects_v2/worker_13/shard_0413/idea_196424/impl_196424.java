...
@Data
public class Idea196424Config {
    private String name = "idea_196424";
 ...
 */
@Slf4j
public class Idea196424Service {
    private static final int IDEA_ID = 196424;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196424Service() {
        this(new Idea196424Config());
    }

    public Idea196424Service(Idea196424Config config) {
        this.config = config != null ? config : new Idea196424Config();
