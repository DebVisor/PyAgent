...
@Data
public class Idea196417Config {
    private String name = "idea_196417";
 ...
 */
@Slf4j
public class Idea196417Service {
    private static final int IDEA_ID = 196417;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196417Service() {
        this(new Idea196417Config());
    }

    public Idea196417Service(Idea196417Config config) {
        this.config = config != null ? config : new Idea196417Config();
