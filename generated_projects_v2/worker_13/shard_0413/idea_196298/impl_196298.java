...
@Data
public class Idea196298Config {
    private String name = "idea_196298";
 ...
 */
@Slf4j
public class Idea196298Service {
    private static final int IDEA_ID = 196298;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196298Service() {
        this(new Idea196298Config());
    }

    public Idea196298Service(Idea196298Config config) {
        this.config = config != null ? config : new Idea196298Config();
