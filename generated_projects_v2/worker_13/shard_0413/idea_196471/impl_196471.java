...
@Data
public class Idea196471Config {
    private String name = "idea_196471";
 ...
 */
@Slf4j
public class Idea196471Service {
    private static final int IDEA_ID = 196471;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196471Service() {
        this(new Idea196471Config());
    }

    public Idea196471Service(Idea196471Config config) {
        this.config = config != null ? config : new Idea196471Config();
