...
@Data
public class Idea196372Config {
    private String name = "idea_196372";
 ...
 */
@Slf4j
public class Idea196372Service {
    private static final int IDEA_ID = 196372;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196372Service() {
        this(new Idea196372Config());
    }

    public Idea196372Service(Idea196372Config config) {
        this.config = config != null ? config : new Idea196372Config();
