...
@Data
public class Idea196513Config {
    private String name = "idea_196513";
 ...
 */
@Slf4j
public class Idea196513Service {
    private static final int IDEA_ID = 196513;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196513Service() {
        this(new Idea196513Config());
    }

    public Idea196513Service(Idea196513Config config) {
        this.config = config != null ? config : new Idea196513Config();
