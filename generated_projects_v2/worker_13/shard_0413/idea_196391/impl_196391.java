...
@Data
public class Idea196391Config {
    private String name = "idea_196391";
 ...
 */
@Slf4j
public class Idea196391Service {
    private static final int IDEA_ID = 196391;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196391Service() {
        this(new Idea196391Config());
    }

    public Idea196391Service(Idea196391Config config) {
        this.config = config != null ? config : new Idea196391Config();
