...
@Data
public class Idea196359Config {
    private String name = "idea_196359";
 ...
 */
@Slf4j
public class Idea196359Service {
    private static final int IDEA_ID = 196359;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196359Service() {
        this(new Idea196359Config());
    }

    public Idea196359Service(Idea196359Config config) {
        this.config = config != null ? config : new Idea196359Config();
