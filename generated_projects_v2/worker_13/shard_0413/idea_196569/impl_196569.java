...
@Data
public class Idea196569Config {
    private String name = "idea_196569";
 ...
 */
@Slf4j
public class Idea196569Service {
    private static final int IDEA_ID = 196569;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196569Service() {
        this(new Idea196569Config());
    }

    public Idea196569Service(Idea196569Config config) {
        this.config = config != null ? config : new Idea196569Config();
