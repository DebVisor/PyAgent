...
@Data
public class Idea196302Config {
    private String name = "idea_196302";
 ...
 */
@Slf4j
public class Idea196302Service {
    private static final int IDEA_ID = 196302;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196302Service() {
        this(new Idea196302Config());
    }

    public Idea196302Service(Idea196302Config config) {
        this.config = config != null ? config : new Idea196302Config();
