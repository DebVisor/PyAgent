...
@Data
public class Idea196590Config {
    private String name = "idea_196590";
 ...
 */
@Slf4j
public class Idea196590Service {
    private static final int IDEA_ID = 196590;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196590Service() {
        this(new Idea196590Config());
    }

    public Idea196590Service(Idea196590Config config) {
        this.config = config != null ? config : new Idea196590Config();
