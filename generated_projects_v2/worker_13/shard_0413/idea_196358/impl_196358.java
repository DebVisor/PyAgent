...
@Data
public class Idea196358Config {
    private String name = "idea_196358";
 ...
 */
@Slf4j
public class Idea196358Service {
    private static final int IDEA_ID = 196358;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196358Service() {
        this(new Idea196358Config());
    }

    public Idea196358Service(Idea196358Config config) {
        this.config = config != null ? config : new Idea196358Config();
