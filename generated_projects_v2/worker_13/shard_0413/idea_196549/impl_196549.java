...
@Data
public class Idea196549Config {
    private String name = "idea_196549";
 ...
 */
@Slf4j
public class Idea196549Service {
    private static final int IDEA_ID = 196549;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196549Service() {
        this(new Idea196549Config());
    }

    public Idea196549Service(Idea196549Config config) {
        this.config = config != null ? config : new Idea196549Config();
