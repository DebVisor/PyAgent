...
@Data
public class Idea196234Config {
    private String name = "idea_196234";
 ...
 */
@Slf4j
public class Idea196234Service {
    private static final int IDEA_ID = 196234;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196234Service() {
        this(new Idea196234Config());
    }

    public Idea196234Service(Idea196234Config config) {
        this.config = config != null ? config : new Idea196234Config();
