...
@Data
public class Idea196503Config {
    private String name = "idea_196503";
 ...
 */
@Slf4j
public class Idea196503Service {
    private static final int IDEA_ID = 196503;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196503Service() {
        this(new Idea196503Config());
    }

    public Idea196503Service(Idea196503Config config) {
        this.config = config != null ? config : new Idea196503Config();
