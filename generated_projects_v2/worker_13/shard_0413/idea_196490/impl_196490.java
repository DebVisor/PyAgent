...
@Data
public class Idea196490Config {
    private String name = "idea_196490";
 ...
 */
@Slf4j
public class Idea196490Service {
    private static final int IDEA_ID = 196490;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196490Service() {
        this(new Idea196490Config());
    }

    public Idea196490Service(Idea196490Config config) {
        this.config = config != null ? config : new Idea196490Config();
