...
@Data
public class Idea196446Config {
    private String name = "idea_196446";
 ...
 */
@Slf4j
public class Idea196446Service {
    private static final int IDEA_ID = 196446;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196446Service() {
        this(new Idea196446Config());
    }

    public Idea196446Service(Idea196446Config config) {
        this.config = config != null ? config : new Idea196446Config();
