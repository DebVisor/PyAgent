...
@Data
public class Idea196346Config {
    private String name = "idea_196346";
 ...
 */
@Slf4j
public class Idea196346Service {
    private static final int IDEA_ID = 196346;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196346Service() {
        this(new Idea196346Config());
    }

    public Idea196346Service(Idea196346Config config) {
        this.config = config != null ? config : new Idea196346Config();
