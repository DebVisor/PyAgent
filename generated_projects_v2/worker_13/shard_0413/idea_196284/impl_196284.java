...
@Data
public class Idea196284Config {
    private String name = "idea_196284";
 ...
 */
@Slf4j
public class Idea196284Service {
    private static final int IDEA_ID = 196284;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196284Service() {
        this(new Idea196284Config());
    }

    public Idea196284Service(Idea196284Config config) {
        this.config = config != null ? config : new Idea196284Config();
