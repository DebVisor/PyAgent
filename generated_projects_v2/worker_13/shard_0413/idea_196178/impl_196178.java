...
@Data
public class Idea196178Config {
    private String name = "idea_196178";
 ...
 */
@Slf4j
public class Idea196178Service {
    private static final int IDEA_ID = 196178;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196178Service() {
        this(new Idea196178Config());
    }

    public Idea196178Service(Idea196178Config config) {
        this.config = config != null ? config : new Idea196178Config();
