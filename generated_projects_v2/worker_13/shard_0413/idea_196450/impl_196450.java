...
@Data
public class Idea196450Config {
    private String name = "idea_196450";
 ...
 */
@Slf4j
public class Idea196450Service {
    private static final int IDEA_ID = 196450;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196450Service() {
        this(new Idea196450Config());
    }

    public Idea196450Service(Idea196450Config config) {
        this.config = config != null ? config : new Idea196450Config();
