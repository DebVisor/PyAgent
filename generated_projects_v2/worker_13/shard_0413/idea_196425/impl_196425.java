...
@Data
public class Idea196425Config {
    private String name = "idea_196425";
 ...
 */
@Slf4j
public class Idea196425Service {
    private static final int IDEA_ID = 196425;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196425Service() {
        this(new Idea196425Config());
    }

    public Idea196425Service(Idea196425Config config) {
        this.config = config != null ? config : new Idea196425Config();
