...
@Data
public class Idea196339Config {
    private String name = "idea_196339";
 ...
 */
@Slf4j
public class Idea196339Service {
    private static final int IDEA_ID = 196339;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196339Service() {
        this(new Idea196339Config());
    }

    public Idea196339Service(Idea196339Config config) {
        this.config = config != null ? config : new Idea196339Config();
