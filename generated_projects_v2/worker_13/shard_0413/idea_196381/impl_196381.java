...
@Data
public class Idea196381Config {
    private String name = "idea_196381";
 ...
 */
@Slf4j
public class Idea196381Service {
    private static final int IDEA_ID = 196381;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196381Service() {
        this(new Idea196381Config());
    }

    public Idea196381Service(Idea196381Config config) {
        this.config = config != null ? config : new Idea196381Config();
