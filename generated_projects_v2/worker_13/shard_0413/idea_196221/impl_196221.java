...
@Data
public class Idea196221Config {
    private String name = "idea_196221";
 ...
 */
@Slf4j
public class Idea196221Service {
    private static final int IDEA_ID = 196221;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196221Service() {
        this(new Idea196221Config());
    }

    public Idea196221Service(Idea196221Config config) {
        this.config = config != null ? config : new Idea196221Config();
