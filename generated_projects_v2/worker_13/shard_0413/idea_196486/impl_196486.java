...
@Data
public class Idea196486Config {
    private String name = "idea_196486";
 ...
 */
@Slf4j
public class Idea196486Service {
    private static final int IDEA_ID = 196486;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196486Service() {
        this(new Idea196486Config());
    }

    public Idea196486Service(Idea196486Config config) {
        this.config = config != null ? config : new Idea196486Config();
