...
@Data
public class Idea196642Config {
    private String name = "idea_196642";
 ...
 */
@Slf4j
public class Idea196642Service {
    private static final int IDEA_ID = 196642;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196642Service() {
        this(new Idea196642Config());
    }

    public Idea196642Service(Idea196642Config config) {
        this.config = config != null ? config : new Idea196642Config();
