...
@Data
public class Idea196282Config {
    private String name = "idea_196282";
 ...
 */
@Slf4j
public class Idea196282Service {
    private static final int IDEA_ID = 196282;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196282Service() {
        this(new Idea196282Config());
    }

    public Idea196282Service(Idea196282Config config) {
        this.config = config != null ? config : new Idea196282Config();
