...
@Data
public class Idea196576Config {
    private String name = "idea_196576";
 ...
 */
@Slf4j
public class Idea196576Service {
    private static final int IDEA_ID = 196576;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196576Service() {
        this(new Idea196576Config());
    }

    public Idea196576Service(Idea196576Config config) {
        this.config = config != null ? config : new Idea196576Config();
