...
@Data
public class Idea196400Config {
    private String name = "idea_196400";
 ...
 */
@Slf4j
public class Idea196400Service {
    private static final int IDEA_ID = 196400;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196400Service() {
        this(new Idea196400Config());
    }

    public Idea196400Service(Idea196400Config config) {
        this.config = config != null ? config : new Idea196400Config();
