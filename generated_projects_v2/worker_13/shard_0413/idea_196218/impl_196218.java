...
@Data
public class Idea196218Config {
    private String name = "idea_196218";
 ...
 */
@Slf4j
public class Idea196218Service {
    private static final int IDEA_ID = 196218;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196218Service() {
        this(new Idea196218Config());
    }

    public Idea196218Service(Idea196218Config config) {
        this.config = config != null ? config : new Idea196218Config();
