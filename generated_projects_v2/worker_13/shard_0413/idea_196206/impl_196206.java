...
@Data
public class Idea196206Config {
    private String name = "idea_196206";
 ...
 */
@Slf4j
public class Idea196206Service {
    private static final int IDEA_ID = 196206;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196206Service() {
        this(new Idea196206Config());
    }

    public Idea196206Service(Idea196206Config config) {
        this.config = config != null ? config : new Idea196206Config();
