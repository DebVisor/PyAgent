...
@Data
public class Idea196644Config {
    private String name = "idea_196644";
 ...
 */
@Slf4j
public class Idea196644Service {
    private static final int IDEA_ID = 196644;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196644Service() {
        this(new Idea196644Config());
    }

    public Idea196644Service(Idea196644Config config) {
        this.config = config != null ? config : new Idea196644Config();
