...
@Data
public class Idea196542Config {
    private String name = "idea_196542";
 ...
 */
@Slf4j
public class Idea196542Service {
    private static final int IDEA_ID = 196542;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196542Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196542Service() {
        this(new Idea196542Config());
    }

    public Idea196542Service(Idea196542Config config) {
        this.config = config != null ? config : new Idea196542Config();
