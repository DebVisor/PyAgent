...
@Data
public class Idea196323Config {
    private String name = "idea_196323";
 ...
 */
@Slf4j
public class Idea196323Service {
    private static final int IDEA_ID = 196323;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196323Service() {
        this(new Idea196323Config());
    }

    public Idea196323Service(Idea196323Config config) {
        this.config = config != null ? config : new Idea196323Config();
