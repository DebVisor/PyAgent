...
@Data
public class Idea196304Config {
    private String name = "idea_196304";
 ...
 */
@Slf4j
public class Idea196304Service {
    private static final int IDEA_ID = 196304;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196304Service() {
        this(new Idea196304Config());
    }

    public Idea196304Service(Idea196304Config config) {
        this.config = config != null ? config : new Idea196304Config();
