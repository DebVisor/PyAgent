...
@Data
public class Idea196413Config {
    private String name = "idea_196413";
 ...
 */
@Slf4j
public class Idea196413Service {
    private static final int IDEA_ID = 196413;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196413Service() {
        this(new Idea196413Config());
    }

    public Idea196413Service(Idea196413Config config) {
        this.config = config != null ? config : new Idea196413Config();
