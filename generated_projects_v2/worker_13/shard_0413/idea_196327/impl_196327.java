...
@Data
public class Idea196327Config {
    private String name = "idea_196327";
 ...
 */
@Slf4j
public class Idea196327Service {
    private static final int IDEA_ID = 196327;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196327Service() {
        this(new Idea196327Config());
    }

    public Idea196327Service(Idea196327Config config) {
        this.config = config != null ? config : new Idea196327Config();
