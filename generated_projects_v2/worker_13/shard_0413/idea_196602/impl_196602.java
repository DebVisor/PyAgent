...
@Data
public class Idea196602Config {
    private String name = "idea_196602";
 ...
 */
@Slf4j
public class Idea196602Service {
    private static final int IDEA_ID = 196602;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196602Service() {
        this(new Idea196602Config());
    }

    public Idea196602Service(Idea196602Config config) {
        this.config = config != null ? config : new Idea196602Config();
