...
@Data
public class Idea196532Config {
    private String name = "idea_196532";
 ...
 */
@Slf4j
public class Idea196532Service {
    private static final int IDEA_ID = 196532;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196532Service() {
        this(new Idea196532Config());
    }

    public Idea196532Service(Idea196532Config config) {
        this.config = config != null ? config : new Idea196532Config();
