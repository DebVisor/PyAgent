...
@Data
public class Idea196277Config {
    private String name = "idea_196277";
 ...
 */
@Slf4j
public class Idea196277Service {
    private static final int IDEA_ID = 196277;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196277Service() {
        this(new Idea196277Config());
    }

    public Idea196277Service(Idea196277Config config) {
        this.config = config != null ? config : new Idea196277Config();
