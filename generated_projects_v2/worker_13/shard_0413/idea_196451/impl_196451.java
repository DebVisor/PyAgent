...
@Data
public class Idea196451Config {
    private String name = "idea_196451";
 ...
 */
@Slf4j
public class Idea196451Service {
    private static final int IDEA_ID = 196451;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196451Service() {
        this(new Idea196451Config());
    }

    public Idea196451Service(Idea196451Config config) {
        this.config = config != null ? config : new Idea196451Config();
