...
@Data
public class Idea196337Config {
    private String name = "idea_196337";
 ...
 */
@Slf4j
public class Idea196337Service {
    private static final int IDEA_ID = 196337;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196337Service() {
        this(new Idea196337Config());
    }

    public Idea196337Service(Idea196337Config config) {
        this.config = config != null ? config : new Idea196337Config();
