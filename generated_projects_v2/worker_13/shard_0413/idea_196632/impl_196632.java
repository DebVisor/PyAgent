...
@Data
public class Idea196632Config {
    private String name = "idea_196632";
 ...
 */
@Slf4j
public class Idea196632Service {
    private static final int IDEA_ID = 196632;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196632Service() {
        this(new Idea196632Config());
    }

    public Idea196632Service(Idea196632Config config) {
        this.config = config != null ? config : new Idea196632Config();
