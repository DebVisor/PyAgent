...
@Data
public class Idea196355Config {
    private String name = "idea_196355";
 ...
 */
@Slf4j
public class Idea196355Service {
    private static final int IDEA_ID = 196355;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196355Service() {
        this(new Idea196355Config());
    }

    public Idea196355Service(Idea196355Config config) {
        this.config = config != null ? config : new Idea196355Config();
