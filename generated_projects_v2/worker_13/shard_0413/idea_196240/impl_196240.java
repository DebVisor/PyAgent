...
@Data
public class Idea196240Config {
    private String name = "idea_196240";
 ...
 */
@Slf4j
public class Idea196240Service {
    private static final int IDEA_ID = 196240;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196240Service() {
        this(new Idea196240Config());
    }

    public Idea196240Service(Idea196240Config config) {
        this.config = config != null ? config : new Idea196240Config();
