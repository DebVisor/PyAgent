...
@Data
public class Idea196353Config {
    private String name = "idea_196353";
 ...
 */
@Slf4j
public class Idea196353Service {
    private static final int IDEA_ID = 196353;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196353Service() {
        this(new Idea196353Config());
    }

    public Idea196353Service(Idea196353Config config) {
        this.config = config != null ? config : new Idea196353Config();
