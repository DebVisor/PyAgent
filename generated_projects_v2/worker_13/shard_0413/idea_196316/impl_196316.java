...
@Data
public class Idea196316Config {
    private String name = "idea_196316";
 ...
 */
@Slf4j
public class Idea196316Service {
    private static final int IDEA_ID = 196316;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196316Service() {
        this(new Idea196316Config());
    }

    public Idea196316Service(Idea196316Config config) {
        this.config = config != null ? config : new Idea196316Config();
