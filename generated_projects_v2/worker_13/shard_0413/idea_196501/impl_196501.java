...
@Data
public class Idea196501Config {
    private String name = "idea_196501";
 ...
 */
@Slf4j
public class Idea196501Service {
    private static final int IDEA_ID = 196501;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196501Service() {
        this(new Idea196501Config());
    }

    public Idea196501Service(Idea196501Config config) {
        this.config = config != null ? config : new Idea196501Config();
