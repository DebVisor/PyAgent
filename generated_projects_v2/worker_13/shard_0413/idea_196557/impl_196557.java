...
@Data
public class Idea196557Config {
    private String name = "idea_196557";
 ...
 */
@Slf4j
public class Idea196557Service {
    private static final int IDEA_ID = 196557;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196557Service() {
        this(new Idea196557Config());
    }

    public Idea196557Service(Idea196557Config config) {
        this.config = config != null ? config : new Idea196557Config();
