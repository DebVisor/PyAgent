...
@Data
public class Idea196244Config {
    private String name = "idea_196244";
 ...
 */
@Slf4j
public class Idea196244Service {
    private static final int IDEA_ID = 196244;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196244Service() {
        this(new Idea196244Config());
    }

    public Idea196244Service(Idea196244Config config) {
        this.config = config != null ? config : new Idea196244Config();
