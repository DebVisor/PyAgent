...
@Data
public class Idea196181Config {
    private String name = "idea_196181";
 ...
 */
@Slf4j
public class Idea196181Service {
    private static final int IDEA_ID = 196181;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196181Service() {
        this(new Idea196181Config());
    }

    public Idea196181Service(Idea196181Config config) {
        this.config = config != null ? config : new Idea196181Config();
