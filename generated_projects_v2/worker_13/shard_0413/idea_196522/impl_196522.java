...
@Data
public class Idea196522Config {
    private String name = "idea_196522";
 ...
 */
@Slf4j
public class Idea196522Service {
    private static final int IDEA_ID = 196522;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196522Service() {
        this(new Idea196522Config());
    }

    public Idea196522Service(Idea196522Config config) {
        this.config = config != null ? config : new Idea196522Config();
