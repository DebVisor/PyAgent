...
@Data
public class Idea196457Config {
    private String name = "idea_196457";
 ...
 */
@Slf4j
public class Idea196457Service {
    private static final int IDEA_ID = 196457;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196457Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196457Service() {
        this(new Idea196457Config());
    }

    public Idea196457Service(Idea196457Config config) {
        this.config = config != null ? config : new Idea196457Config();
