...
@Data
public class Idea196408Config {
    private String name = "idea_196408";
 ...
 */
@Slf4j
public class Idea196408Service {
    private static final int IDEA_ID = 196408;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196408Service() {
        this(new Idea196408Config());
    }

    public Idea196408Service(Idea196408Config config) {
        this.config = config != null ? config : new Idea196408Config();
