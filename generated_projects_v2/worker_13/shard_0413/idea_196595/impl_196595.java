...
@Data
public class Idea196595Config {
    private String name = "idea_196595";
 ...
 */
@Slf4j
public class Idea196595Service {
    private static final int IDEA_ID = 196595;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196595Service() {
        this(new Idea196595Config());
    }

    public Idea196595Service(Idea196595Config config) {
        this.config = config != null ? config : new Idea196595Config();
