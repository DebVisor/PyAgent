...
@Data
public class Idea196523Config {
    private String name = "idea_196523";
 ...
 */
@Slf4j
public class Idea196523Service {
    private static final int IDEA_ID = 196523;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196523Service() {
        this(new Idea196523Config());
    }

    public Idea196523Service(Idea196523Config config) {
        this.config = config != null ? config : new Idea196523Config();
