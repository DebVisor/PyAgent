...
@Data
public class Idea196596Config {
    private String name = "idea_196596";
 ...
 */
@Slf4j
public class Idea196596Service {
    private static final int IDEA_ID = 196596;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196596Service() {
        this(new Idea196596Config());
    }

    public Idea196596Service(Idea196596Config config) {
        this.config = config != null ? config : new Idea196596Config();
