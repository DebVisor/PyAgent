...
@Data
public class Idea196375Config {
    private String name = "idea_196375";
 ...
 */
@Slf4j
public class Idea196375Service {
    private static final int IDEA_ID = 196375;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196375Service() {
        this(new Idea196375Config());
    }

    public Idea196375Service(Idea196375Config config) {
        this.config = config != null ? config : new Idea196375Config();
