...
@Data
public class Idea196423Config {
    private String name = "idea_196423";
 ...
 */
@Slf4j
public class Idea196423Service {
    private static final int IDEA_ID = 196423;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196423Service() {
        this(new Idea196423Config());
    }

    public Idea196423Service(Idea196423Config config) {
        this.config = config != null ? config : new Idea196423Config();
