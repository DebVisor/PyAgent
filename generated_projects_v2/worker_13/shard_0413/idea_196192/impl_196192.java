...
@Data
public class Idea196192Config {
    private String name = "idea_196192";
 ...
 */
@Slf4j
public class Idea196192Service {
    private static final int IDEA_ID = 196192;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196192Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196192Service() {
        this(new Idea196192Config());
    }

    public Idea196192Service(Idea196192Config config) {
        this.config = config != null ? config : new Idea196192Config();
