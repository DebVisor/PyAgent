...
@Data
public class Idea196554Config {
    private String name = "idea_196554";
 ...
 */
@Slf4j
public class Idea196554Service {
    private static final int IDEA_ID = 196554;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196554Service() {
        this(new Idea196554Config());
    }

    public Idea196554Service(Idea196554Config config) {
        this.config = config != null ? config : new Idea196554Config();
