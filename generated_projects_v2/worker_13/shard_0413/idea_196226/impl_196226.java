...
@Data
public class Idea196226Config {
    private String name = "idea_196226";
 ...
 */
@Slf4j
public class Idea196226Service {
    private static final int IDEA_ID = 196226;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196226Service() {
        this(new Idea196226Config());
    }

    public Idea196226Service(Idea196226Config config) {
        this.config = config != null ? config : new Idea196226Config();
