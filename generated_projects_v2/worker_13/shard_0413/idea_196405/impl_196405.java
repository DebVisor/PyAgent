...
@Data
public class Idea196405Config {
    private String name = "idea_196405";
 ...
 */
@Slf4j
public class Idea196405Service {
    private static final int IDEA_ID = 196405;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196405Service() {
        this(new Idea196405Config());
    }

    public Idea196405Service(Idea196405Config config) {
        this.config = config != null ? config : new Idea196405Config();
