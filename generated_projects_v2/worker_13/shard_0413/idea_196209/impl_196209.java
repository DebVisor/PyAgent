...
@Data
public class Idea196209Config {
    private String name = "idea_196209";
 ...
 */
@Slf4j
public class Idea196209Service {
    private static final int IDEA_ID = 196209;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196209Service() {
        this(new Idea196209Config());
    }

    public Idea196209Service(Idea196209Config config) {
        this.config = config != null ? config : new Idea196209Config();
