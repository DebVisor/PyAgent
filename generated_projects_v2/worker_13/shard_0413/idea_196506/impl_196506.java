...
@Data
public class Idea196506Config {
    private String name = "idea_196506";
 ...
 */
@Slf4j
public class Idea196506Service {
    private static final int IDEA_ID = 196506;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196506Service() {
        this(new Idea196506Config());
    }

    public Idea196506Service(Idea196506Config config) {
        this.config = config != null ? config : new Idea196506Config();
