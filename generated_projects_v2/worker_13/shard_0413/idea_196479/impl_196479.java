...
@Data
public class Idea196479Config {
    private String name = "idea_196479";
 ...
 */
@Slf4j
public class Idea196479Service {
    private static final int IDEA_ID = 196479;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196479Service() {
        this(new Idea196479Config());
    }

    public Idea196479Service(Idea196479Config config) {
        this.config = config != null ? config : new Idea196479Config();
