...
@Data
public class Idea196614Config {
    private String name = "idea_196614";
 ...
 */
@Slf4j
public class Idea196614Service {
    private static final int IDEA_ID = 196614;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196614Service() {
        this(new Idea196614Config());
    }

    public Idea196614Service(Idea196614Config config) {
        this.config = config != null ? config : new Idea196614Config();
