...
@Data
public class Idea196541Config {
    private String name = "idea_196541";
 ...
 */
@Slf4j
public class Idea196541Service {
    private static final int IDEA_ID = 196541;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196541Service() {
        this(new Idea196541Config());
    }

    public Idea196541Service(Idea196541Config config) {
        this.config = config != null ? config : new Idea196541Config();
