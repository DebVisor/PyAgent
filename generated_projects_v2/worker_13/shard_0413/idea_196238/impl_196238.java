...
@Data
public class Idea196238Config {
    private String name = "idea_196238";
 ...
 */
@Slf4j
public class Idea196238Service {
    private static final int IDEA_ID = 196238;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196238Service() {
        this(new Idea196238Config());
    }

    public Idea196238Service(Idea196238Config config) {
        this.config = config != null ? config : new Idea196238Config();
