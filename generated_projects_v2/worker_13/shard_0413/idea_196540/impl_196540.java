...
@Data
public class Idea196540Config {
    private String name = "idea_196540";
 ...
 */
@Slf4j
public class Idea196540Service {
    private static final int IDEA_ID = 196540;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196540Service() {
        this(new Idea196540Config());
    }

    public Idea196540Service(Idea196540Config config) {
        this.config = config != null ? config : new Idea196540Config();
