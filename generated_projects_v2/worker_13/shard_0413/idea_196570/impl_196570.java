...
@Data
public class Idea196570Config {
    private String name = "idea_196570";
 ...
 */
@Slf4j
public class Idea196570Service {
    private static final int IDEA_ID = 196570;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196570Service() {
        this(new Idea196570Config());
    }

    public Idea196570Service(Idea196570Config config) {
        this.config = config != null ? config : new Idea196570Config();
