...
@Data
public class Idea196232Config {
    private String name = "idea_196232";
 ...
 */
@Slf4j
public class Idea196232Service {
    private static final int IDEA_ID = 196232;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196232Service() {
        this(new Idea196232Config());
    }

    public Idea196232Service(Idea196232Config config) {
        this.config = config != null ? config : new Idea196232Config();
