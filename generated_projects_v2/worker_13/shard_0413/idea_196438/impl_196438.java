...
@Data
public class Idea196438Config {
    private String name = "idea_196438";
 ...
 */
@Slf4j
public class Idea196438Service {
    private static final int IDEA_ID = 196438;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196438Service() {
        this(new Idea196438Config());
    }

    public Idea196438Service(Idea196438Config config) {
        this.config = config != null ? config : new Idea196438Config();
