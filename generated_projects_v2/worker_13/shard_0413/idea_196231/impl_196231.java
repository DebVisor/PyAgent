...
@Data
public class Idea196231Config {
    private String name = "idea_196231";
 ...
 */
@Slf4j
public class Idea196231Service {
    private static final int IDEA_ID = 196231;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196231Service() {
        this(new Idea196231Config());
    }

    public Idea196231Service(Idea196231Config config) {
        this.config = config != null ? config : new Idea196231Config();
