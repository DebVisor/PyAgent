...
@Data
public class Idea196581Config {
    private String name = "idea_196581";
 ...
 */
@Slf4j
public class Idea196581Service {
    private static final int IDEA_ID = 196581;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196581Service() {
        this(new Idea196581Config());
    }

    public Idea196581Service(Idea196581Config config) {
        this.config = config != null ? config : new Idea196581Config();
