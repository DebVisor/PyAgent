...
@Data
public class Idea196182Config {
    private String name = "idea_196182";
 ...
 */
@Slf4j
public class Idea196182Service {
    private static final int IDEA_ID = 196182;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196182Service() {
        this(new Idea196182Config());
    }

    public Idea196182Service(Idea196182Config config) {
        this.config = config != null ? config : new Idea196182Config();
