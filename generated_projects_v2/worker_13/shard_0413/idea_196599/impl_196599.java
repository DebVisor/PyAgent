...
@Data
public class Idea196599Config {
    private String name = "idea_196599";
 ...
 */
@Slf4j
public class Idea196599Service {
    private static final int IDEA_ID = 196599;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196599Service() {
        this(new Idea196599Config());
    }

    public Idea196599Service(Idea196599Config config) {
        this.config = config != null ? config : new Idea196599Config();
