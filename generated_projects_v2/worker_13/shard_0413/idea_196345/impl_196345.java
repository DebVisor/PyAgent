...
@Data
public class Idea196345Config {
    private String name = "idea_196345";
 ...
 */
@Slf4j
public class Idea196345Service {
    private static final int IDEA_ID = 196345;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196345Service() {
        this(new Idea196345Config());
    }

    public Idea196345Service(Idea196345Config config) {
        this.config = config != null ? config : new Idea196345Config();
