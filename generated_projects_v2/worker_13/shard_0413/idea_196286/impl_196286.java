...
@Data
public class Idea196286Config {
    private String name = "idea_196286";
 ...
 */
@Slf4j
public class Idea196286Service {
    private static final int IDEA_ID = 196286;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196286Service() {
        this(new Idea196286Config());
    }

    public Idea196286Service(Idea196286Config config) {
        this.config = config != null ? config : new Idea196286Config();
