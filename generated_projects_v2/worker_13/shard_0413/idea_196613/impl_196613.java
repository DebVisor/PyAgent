...
@Data
public class Idea196613Config {
    private String name = "idea_196613";
 ...
 */
@Slf4j
public class Idea196613Service {
    private static final int IDEA_ID = 196613;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196613Service() {
        this(new Idea196613Config());
    }

    public Idea196613Service(Idea196613Config config) {
        this.config = config != null ? config : new Idea196613Config();
