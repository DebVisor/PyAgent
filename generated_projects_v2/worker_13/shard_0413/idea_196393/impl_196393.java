...
@Data
public class Idea196393Config {
    private String name = "idea_196393";
 ...
 */
@Slf4j
public class Idea196393Service {
    private static final int IDEA_ID = 196393;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196393Service() {
        this(new Idea196393Config());
    }

    public Idea196393Service(Idea196393Config config) {
        this.config = config != null ? config : new Idea196393Config();
