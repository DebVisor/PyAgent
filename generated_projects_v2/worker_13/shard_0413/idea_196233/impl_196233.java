...
@Data
public class Idea196233Config {
    private String name = "idea_196233";
 ...
 */
@Slf4j
public class Idea196233Service {
    private static final int IDEA_ID = 196233;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196233Service() {
        this(new Idea196233Config());
    }

    public Idea196233Service(Idea196233Config config) {
        this.config = config != null ? config : new Idea196233Config();
