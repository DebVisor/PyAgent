...
@Data
public class Idea196537Config {
    private String name = "idea_196537";
 ...
 */
@Slf4j
public class Idea196537Service {
    private static final int IDEA_ID = 196537;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196537Service() {
        this(new Idea196537Config());
    }

    public Idea196537Service(Idea196537Config config) {
        this.config = config != null ? config : new Idea196537Config();
