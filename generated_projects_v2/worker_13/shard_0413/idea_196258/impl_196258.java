...
@Data
public class Idea196258Config {
    private String name = "idea_196258";
 ...
 */
@Slf4j
public class Idea196258Service {
    private static final int IDEA_ID = 196258;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196258Service() {
        this(new Idea196258Config());
    }

    public Idea196258Service(Idea196258Config config) {
        this.config = config != null ? config : new Idea196258Config();
