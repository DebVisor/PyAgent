...
@Data
public class Idea196488Config {
    private String name = "idea_196488";
 ...
 */
@Slf4j
public class Idea196488Service {
    private static final int IDEA_ID = 196488;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196488Service() {
        this(new Idea196488Config());
    }

    public Idea196488Service(Idea196488Config config) {
        this.config = config != null ? config : new Idea196488Config();
