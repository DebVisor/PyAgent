...
@Data
public class Idea196352Config {
    private String name = "idea_196352";
 ...
 */
@Slf4j
public class Idea196352Service {
    private static final int IDEA_ID = 196352;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196352Service() {
        this(new Idea196352Config());
    }

    public Idea196352Service(Idea196352Config config) {
        this.config = config != null ? config : new Idea196352Config();
