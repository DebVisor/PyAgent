...
@Data
public class Idea196521Config {
    private String name = "idea_196521";
 ...
 */
@Slf4j
public class Idea196521Service {
    private static final int IDEA_ID = 196521;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196521Service() {
        this(new Idea196521Config());
    }

    public Idea196521Service(Idea196521Config config) {
        this.config = config != null ? config : new Idea196521Config();
