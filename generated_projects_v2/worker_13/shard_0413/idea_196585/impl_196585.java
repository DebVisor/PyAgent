...
@Data
public class Idea196585Config {
    private String name = "idea_196585";
 ...
 */
@Slf4j
public class Idea196585Service {
    private static final int IDEA_ID = 196585;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196585Service() {
        this(new Idea196585Config());
    }

    public Idea196585Service(Idea196585Config config) {
        this.config = config != null ? config : new Idea196585Config();
