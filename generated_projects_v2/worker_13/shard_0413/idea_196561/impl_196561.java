...
@Data
public class Idea196561Config {
    private String name = "idea_196561";
 ...
 */
@Slf4j
public class Idea196561Service {
    private static final int IDEA_ID = 196561;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196561Service() {
        this(new Idea196561Config());
    }

    public Idea196561Service(Idea196561Config config) {
        this.config = config != null ? config : new Idea196561Config();
