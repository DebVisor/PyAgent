...
@Data
public class Idea196224Config {
    private String name = "idea_196224";
 ...
 */
@Slf4j
public class Idea196224Service {
    private static final int IDEA_ID = 196224;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196224Service() {
        this(new Idea196224Config());
    }

    public Idea196224Service(Idea196224Config config) {
        this.config = config != null ? config : new Idea196224Config();
