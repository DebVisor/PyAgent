...
@Data
public class Idea196433Config {
    private String name = "idea_196433";
 ...
 */
@Slf4j
public class Idea196433Service {
    private static final int IDEA_ID = 196433;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196433Service() {
        this(new Idea196433Config());
    }

    public Idea196433Service(Idea196433Config config) {
        this.config = config != null ? config : new Idea196433Config();
