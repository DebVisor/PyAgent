...
@Data
public class Idea196297Config {
    private String name = "idea_196297";
 ...
 */
@Slf4j
public class Idea196297Service {
    private static final int IDEA_ID = 196297;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196297Service() {
        this(new Idea196297Config());
    }

    public Idea196297Service(Idea196297Config config) {
        this.config = config != null ? config : new Idea196297Config();
