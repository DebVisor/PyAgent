...
@Data
public class Idea196179Config {
    private String name = "idea_196179";
 ...
 */
@Slf4j
public class Idea196179Service {
    private static final int IDEA_ID = 196179;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196179Service() {
        this(new Idea196179Config());
    }

    public Idea196179Service(Idea196179Config config) {
        this.config = config != null ? config : new Idea196179Config();
