...
@Data
public class Idea196190Config {
    private String name = "idea_196190";
 ...
 */
@Slf4j
public class Idea196190Service {
    private static final int IDEA_ID = 196190;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196190Service() {
        this(new Idea196190Config());
    }

    public Idea196190Service(Idea196190Config config) {
        this.config = config != null ? config : new Idea196190Config();
