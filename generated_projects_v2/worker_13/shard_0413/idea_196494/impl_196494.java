...
@Data
public class Idea196494Config {
    private String name = "idea_196494";
 ...
 */
@Slf4j
public class Idea196494Service {
    private static final int IDEA_ID = 196494;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196494Service() {
        this(new Idea196494Config());
    }

    public Idea196494Service(Idea196494Config config) {
        this.config = config != null ? config : new Idea196494Config();
