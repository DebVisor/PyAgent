...
@Data
public class Idea196347Config {
    private String name = "idea_196347";
 ...
 */
@Slf4j
public class Idea196347Service {
    private static final int IDEA_ID = 196347;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196347Service() {
        this(new Idea196347Config());
    }

    public Idea196347Service(Idea196347Config config) {
        this.config = config != null ? config : new Idea196347Config();
