...
@Data
public class Idea196188Config {
    private String name = "idea_196188";
 ...
 */
@Slf4j
public class Idea196188Service {
    private static final int IDEA_ID = 196188;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196188Service() {
        this(new Idea196188Config());
    }

    public Idea196188Service(Idea196188Config config) {
        this.config = config != null ? config : new Idea196188Config();
