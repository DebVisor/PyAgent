...
@Data
public class Idea196320Config {
    private String name = "idea_196320";
 ...
 */
@Slf4j
public class Idea196320Service {
    private static final int IDEA_ID = 196320;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196320Service() {
        this(new Idea196320Config());
    }

    public Idea196320Service(Idea196320Config config) {
        this.config = config != null ? config : new Idea196320Config();
