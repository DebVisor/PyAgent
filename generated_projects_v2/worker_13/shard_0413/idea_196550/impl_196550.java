...
@Data
public class Idea196550Config {
    private String name = "idea_196550";
 ...
 */
@Slf4j
public class Idea196550Service {
    private static final int IDEA_ID = 196550;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196550Service() {
        this(new Idea196550Config());
    }

    public Idea196550Service(Idea196550Config config) {
        this.config = config != null ? config : new Idea196550Config();
