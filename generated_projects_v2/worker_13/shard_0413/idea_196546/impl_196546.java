...
@Data
public class Idea196546Config {
    private String name = "idea_196546";
 ...
 */
@Slf4j
public class Idea196546Service {
    private static final int IDEA_ID = 196546;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196546Service() {
        this(new Idea196546Config());
    }

    public Idea196546Service(Idea196546Config config) {
        this.config = config != null ? config : new Idea196546Config();
