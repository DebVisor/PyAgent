...
@Data
public class Idea196319Config {
    private String name = "idea_196319";
 ...
 */
@Slf4j
public class Idea196319Service {
    private static final int IDEA_ID = 196319;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196319Service() {
        this(new Idea196319Config());
    }

    public Idea196319Service(Idea196319Config config) {
        this.config = config != null ? config : new Idea196319Config();
