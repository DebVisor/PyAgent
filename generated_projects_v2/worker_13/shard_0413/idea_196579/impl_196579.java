...
@Data
public class Idea196579Config {
    private String name = "idea_196579";
 ...
 */
@Slf4j
public class Idea196579Service {
    private static final int IDEA_ID = 196579;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196579Service() {
        this(new Idea196579Config());
    }

    public Idea196579Service(Idea196579Config config) {
        this.config = config != null ? config : new Idea196579Config();
