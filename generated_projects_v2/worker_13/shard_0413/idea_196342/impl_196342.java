...
@Data
public class Idea196342Config {
    private String name = "idea_196342";
 ...
 */
@Slf4j
public class Idea196342Service {
    private static final int IDEA_ID = 196342;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196342Service() {
        this(new Idea196342Config());
    }

    public Idea196342Service(Idea196342Config config) {
        this.config = config != null ? config : new Idea196342Config();
