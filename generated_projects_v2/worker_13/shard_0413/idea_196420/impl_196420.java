...
@Data
public class Idea196420Config {
    private String name = "idea_196420";
 ...
 */
@Slf4j
public class Idea196420Service {
    private static final int IDEA_ID = 196420;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196420Service() {
        this(new Idea196420Config());
    }

    public Idea196420Service(Idea196420Config config) {
        this.config = config != null ? config : new Idea196420Config();
