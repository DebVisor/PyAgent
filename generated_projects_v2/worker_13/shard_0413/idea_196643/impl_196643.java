...
@Data
public class Idea196643Config {
    private String name = "idea_196643";
 ...
 */
@Slf4j
public class Idea196643Service {
    private static final int IDEA_ID = 196643;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196643Service() {
        this(new Idea196643Config());
    }

    public Idea196643Service(Idea196643Config config) {
        this.config = config != null ? config : new Idea196643Config();
