...
@Data
public class Idea196647Config {
    private String name = "idea_196647";
 ...
 */
@Slf4j
public class Idea196647Service {
    private static final int IDEA_ID = 196647;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196647Service() {
        this(new Idea196647Config());
    }

    public Idea196647Service(Idea196647Config config) {
        this.config = config != null ? config : new Idea196647Config();
