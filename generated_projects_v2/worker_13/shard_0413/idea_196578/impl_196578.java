...
@Data
public class Idea196578Config {
    private String name = "idea_196578";
 ...
 */
@Slf4j
public class Idea196578Service {
    private static final int IDEA_ID = 196578;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196578Service() {
        this(new Idea196578Config());
    }

    public Idea196578Service(Idea196578Config config) {
        this.config = config != null ? config : new Idea196578Config();
