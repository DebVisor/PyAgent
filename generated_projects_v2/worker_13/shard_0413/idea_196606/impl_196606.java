...
@Data
public class Idea196606Config {
    private String name = "idea_196606";
 ...
 */
@Slf4j
public class Idea196606Service {
    private static final int IDEA_ID = 196606;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196606Service() {
        this(new Idea196606Config());
    }

    public Idea196606Service(Idea196606Config config) {
        this.config = config != null ? config : new Idea196606Config();
