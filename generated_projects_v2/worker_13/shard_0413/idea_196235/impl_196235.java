...
@Data
public class Idea196235Config {
    private String name = "idea_196235";
 ...
 */
@Slf4j
public class Idea196235Service {
    private static final int IDEA_ID = 196235;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196235Service() {
        this(new Idea196235Config());
    }

    public Idea196235Service(Idea196235Config config) {
        this.config = config != null ? config : new Idea196235Config();
