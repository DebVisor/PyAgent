...
@Data
public class Idea196487Config {
    private String name = "idea_196487";
 ...
 */
@Slf4j
public class Idea196487Service {
    private static final int IDEA_ID = 196487;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196487Service() {
        this(new Idea196487Config());
    }

    public Idea196487Service(Idea196487Config config) {
        this.config = config != null ? config : new Idea196487Config();
