...
@Data
public class Idea196363Config {
    private String name = "idea_196363";
 ...
 */
@Slf4j
public class Idea196363Service {
    private static final int IDEA_ID = 196363;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196363Service() {
        this(new Idea196363Config());
    }

    public Idea196363Service(Idea196363Config config) {
        this.config = config != null ? config : new Idea196363Config();
