...
@Data
public class Idea196604Config {
    private String name = "idea_196604";
 ...
 */
@Slf4j
public class Idea196604Service {
    private static final int IDEA_ID = 196604;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196604Service() {
        this(new Idea196604Config());
    }

    public Idea196604Service(Idea196604Config config) {
        this.config = config != null ? config : new Idea196604Config();
