...
@Data
public class Idea196634Config {
    private String name = "idea_196634";
 ...
 */
@Slf4j
public class Idea196634Service {
    private static final int IDEA_ID = 196634;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196634Service() {
        this(new Idea196634Config());
    }

    public Idea196634Service(Idea196634Config config) {
        this.config = config != null ? config : new Idea196634Config();
