...
@Data
public class Idea196392Config {
    private String name = "idea_196392";
 ...
 */
@Slf4j
public class Idea196392Service {
    private static final int IDEA_ID = 196392;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196392Service() {
        this(new Idea196392Config());
    }

    public Idea196392Service(Idea196392Config config) {
        this.config = config != null ? config : new Idea196392Config();
