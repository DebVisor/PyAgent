...
@Data
public class Idea196638Config {
    private String name = "idea_196638";
 ...
 */
@Slf4j
public class Idea196638Service {
    private static final int IDEA_ID = 196638;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196638Service() {
        this(new Idea196638Config());
    }

    public Idea196638Service(Idea196638Config config) {
        this.config = config != null ? config : new Idea196638Config();
