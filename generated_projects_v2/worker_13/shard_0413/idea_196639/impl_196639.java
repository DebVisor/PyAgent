...
@Data
public class Idea196639Config {
    private String name = "idea_196639";
 ...
 */
@Slf4j
public class Idea196639Service {
    private static final int IDEA_ID = 196639;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196639Service() {
        this(new Idea196639Config());
    }

    public Idea196639Service(Idea196639Config config) {
        this.config = config != null ? config : new Idea196639Config();
