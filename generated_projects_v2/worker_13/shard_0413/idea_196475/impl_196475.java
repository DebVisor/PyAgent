...
@Data
public class Idea196475Config {
    private String name = "idea_196475";
 ...
 */
@Slf4j
public class Idea196475Service {
    private static final int IDEA_ID = 196475;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196475Service() {
        this(new Idea196475Config());
    }

    public Idea196475Service(Idea196475Config config) {
        this.config = config != null ? config : new Idea196475Config();
