...
@Data
public class Idea196187Config {
    private String name = "idea_196187";
 ...
 */
@Slf4j
public class Idea196187Service {
    private static final int IDEA_ID = 196187;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196187Service() {
        this(new Idea196187Config());
    }

    public Idea196187Service(Idea196187Config config) {
        this.config = config != null ? config : new Idea196187Config();
