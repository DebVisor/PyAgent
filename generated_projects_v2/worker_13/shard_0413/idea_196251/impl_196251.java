...
@Data
public class Idea196251Config {
    private String name = "idea_196251";
 ...
 */
@Slf4j
public class Idea196251Service {
    private static final int IDEA_ID = 196251;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196251Service() {
        this(new Idea196251Config());
    }

    public Idea196251Service(Idea196251Config config) {
        this.config = config != null ? config : new Idea196251Config();
