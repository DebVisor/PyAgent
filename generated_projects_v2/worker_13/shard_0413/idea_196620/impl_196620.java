...
@Data
public class Idea196620Config {
    private String name = "idea_196620";
 ...
 */
@Slf4j
public class Idea196620Service {
    private static final int IDEA_ID = 196620;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196620Service() {
        this(new Idea196620Config());
    }

    public Idea196620Service(Idea196620Config config) {
        this.config = config != null ? config : new Idea196620Config();
