...
@Data
public class Idea196461Config {
    private String name = "idea_196461";
 ...
 */
@Slf4j
public class Idea196461Service {
    private static final int IDEA_ID = 196461;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196461Service() {
        this(new Idea196461Config());
    }

    public Idea196461Service(Idea196461Config config) {
        this.config = config != null ? config : new Idea196461Config();
