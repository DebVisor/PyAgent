...
@Data
public class Idea196434Config {
    private String name = "idea_196434";
 ...
 */
@Slf4j
public class Idea196434Service {
    private static final int IDEA_ID = 196434;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196434Service() {
        this(new Idea196434Config());
    }

    public Idea196434Service(Idea196434Config config) {
        this.config = config != null ? config : new Idea196434Config();
