...
@Data
public class Idea196176Config {
    private String name = "idea_196176";
 ...
 */
@Slf4j
public class Idea196176Service {
    private static final int IDEA_ID = 196176;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196176Service() {
        this(new Idea196176Config());
    }

    public Idea196176Service(Idea196176Config config) {
        this.config = config != null ? config : new Idea196176Config();
