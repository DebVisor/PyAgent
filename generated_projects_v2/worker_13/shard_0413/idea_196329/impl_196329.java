...
@Data
public class Idea196329Config {
    private String name = "idea_196329";
 ...
 */
@Slf4j
public class Idea196329Service {
    private static final int IDEA_ID = 196329;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196329Service() {
        this(new Idea196329Config());
    }

    public Idea196329Service(Idea196329Config config) {
        this.config = config != null ? config : new Idea196329Config();
