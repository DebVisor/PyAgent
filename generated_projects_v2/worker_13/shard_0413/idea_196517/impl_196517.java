...
@Data
public class Idea196517Config {
    private String name = "idea_196517";
 ...
 */
@Slf4j
public class Idea196517Service {
    private static final int IDEA_ID = 196517;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196517Service() {
        this(new Idea196517Config());
    }

    public Idea196517Service(Idea196517Config config) {
        this.config = config != null ? config : new Idea196517Config();
