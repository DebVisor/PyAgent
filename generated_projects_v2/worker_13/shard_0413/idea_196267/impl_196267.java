...
@Data
public class Idea196267Config {
    private String name = "idea_196267";
 ...
 */
@Slf4j
public class Idea196267Service {
    private static final int IDEA_ID = 196267;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196267Service() {
        this(new Idea196267Config());
    }

    public Idea196267Service(Idea196267Config config) {
        this.config = config != null ? config : new Idea196267Config();
