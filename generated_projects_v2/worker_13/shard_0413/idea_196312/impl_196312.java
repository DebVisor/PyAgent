...
@Data
public class Idea196312Config {
    private String name = "idea_196312";
 ...
 */
@Slf4j
public class Idea196312Service {
    private static final int IDEA_ID = 196312;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196312Service() {
        this(new Idea196312Config());
    }

    public Idea196312Service(Idea196312Config config) {
        this.config = config != null ? config : new Idea196312Config();
