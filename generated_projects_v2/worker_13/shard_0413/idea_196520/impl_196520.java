...
@Data
public class Idea196520Config {
    private String name = "idea_196520";
 ...
 */
@Slf4j
public class Idea196520Service {
    private static final int IDEA_ID = 196520;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196520Service() {
        this(new Idea196520Config());
    }

    public Idea196520Service(Idea196520Config config) {
        this.config = config != null ? config : new Idea196520Config();
