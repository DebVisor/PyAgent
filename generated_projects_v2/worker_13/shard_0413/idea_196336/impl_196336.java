...
@Data
public class Idea196336Config {
    private String name = "idea_196336";
 ...
 */
@Slf4j
public class Idea196336Service {
    private static final int IDEA_ID = 196336;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196336Service() {
        this(new Idea196336Config());
    }

    public Idea196336Service(Idea196336Config config) {
        this.config = config != null ? config : new Idea196336Config();
