...
@Data
public class Idea196444Config {
    private String name = "idea_196444";
 ...
 */
@Slf4j
public class Idea196444Service {
    private static final int IDEA_ID = 196444;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196444Service() {
        this(new Idea196444Config());
    }

    public Idea196444Service(Idea196444Config config) {
        this.config = config != null ? config : new Idea196444Config();
