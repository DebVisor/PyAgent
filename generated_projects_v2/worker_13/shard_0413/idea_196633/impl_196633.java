...
@Data
public class Idea196633Config {
    private String name = "idea_196633";
 ...
 */
@Slf4j
public class Idea196633Service {
    private static final int IDEA_ID = 196633;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196633Service() {
        this(new Idea196633Config());
    }

    public Idea196633Service(Idea196633Config config) {
        this.config = config != null ? config : new Idea196633Config();
