...
@Data
public class Idea196629Config {
    private String name = "idea_196629";
 ...
 */
@Slf4j
public class Idea196629Service {
    private static final int IDEA_ID = 196629;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196629Service() {
        this(new Idea196629Config());
    }

    public Idea196629Service(Idea196629Config config) {
        this.config = config != null ? config : new Idea196629Config();
