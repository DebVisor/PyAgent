...
@Data
public class Idea196458Config {
    private String name = "idea_196458";
 ...
 */
@Slf4j
public class Idea196458Service {
    private static final int IDEA_ID = 196458;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196458Service() {
        this(new Idea196458Config());
    }

    public Idea196458Service(Idea196458Config config) {
        this.config = config != null ? config : new Idea196458Config();
