...
@Data
public class Idea196418Config {
    private String name = "idea_196418";
 ...
 */
@Slf4j
public class Idea196418Service {
    private static final int IDEA_ID = 196418;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196418Service() {
        this(new Idea196418Config());
    }

    public Idea196418Service(Idea196418Config config) {
        this.config = config != null ? config : new Idea196418Config();
