...
@Data
public class Idea196472Config {
    private String name = "idea_196472";
 ...
 */
@Slf4j
public class Idea196472Service {
    private static final int IDEA_ID = 196472;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196472Service() {
        this(new Idea196472Config());
    }

    public Idea196472Service(Idea196472Config config) {
        this.config = config != null ? config : new Idea196472Config();
