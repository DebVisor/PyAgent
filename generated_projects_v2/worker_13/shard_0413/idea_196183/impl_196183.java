...
@Data
public class Idea196183Config {
    private String name = "idea_196183";
 ...
 */
@Slf4j
public class Idea196183Service {
    private static final int IDEA_ID = 196183;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196183Service() {
        this(new Idea196183Config());
    }

    public Idea196183Service(Idea196183Config config) {
        this.config = config != null ? config : new Idea196183Config();
