...
@Data
public class Idea196431Config {
    private String name = "idea_196431";
 ...
 */
@Slf4j
public class Idea196431Service {
    private static final int IDEA_ID = 196431;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196431Service() {
        this(new Idea196431Config());
    }

    public Idea196431Service(Idea196431Config config) {
        this.config = config != null ? config : new Idea196431Config();
