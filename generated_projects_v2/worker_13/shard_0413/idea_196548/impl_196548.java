...
@Data
public class Idea196548Config {
    private String name = "idea_196548";
 ...
 */
@Slf4j
public class Idea196548Service {
    private static final int IDEA_ID = 196548;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196548Service() {
        this(new Idea196548Config());
    }

    public Idea196548Service(Idea196548Config config) {
        this.config = config != null ? config : new Idea196548Config();
