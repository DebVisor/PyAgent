...
@Data
public class Idea196321Config {
    private String name = "idea_196321";
 ...
 */
@Slf4j
public class Idea196321Service {
    private static final int IDEA_ID = 196321;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196321Service() {
        this(new Idea196321Config());
    }

    public Idea196321Service(Idea196321Config config) {
        this.config = config != null ? config : new Idea196321Config();
