...
@Data
public class Idea196289Config {
    private String name = "idea_196289";
 ...
 */
@Slf4j
public class Idea196289Service {
    private static final int IDEA_ID = 196289;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196289Service() {
        this(new Idea196289Config());
    }

    public Idea196289Service(Idea196289Config config) {
        this.config = config != null ? config : new Idea196289Config();
