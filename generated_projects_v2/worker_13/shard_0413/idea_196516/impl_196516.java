...
@Data
public class Idea196516Config {
    private String name = "idea_196516";
 ...
 */
@Slf4j
public class Idea196516Service {
    private static final int IDEA_ID = 196516;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196516Service() {
        this(new Idea196516Config());
    }

    public Idea196516Service(Idea196516Config config) {
        this.config = config != null ? config : new Idea196516Config();
