...
@Data
public class Idea196203Config {
    private String name = "idea_196203";
 ...
 */
@Slf4j
public class Idea196203Service {
    private static final int IDEA_ID = 196203;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196203Service() {
        this(new Idea196203Config());
    }

    public Idea196203Service(Idea196203Config config) {
        this.config = config != null ? config : new Idea196203Config();
