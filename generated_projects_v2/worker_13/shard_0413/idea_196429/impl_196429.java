...
@Data
public class Idea196429Config {
    private String name = "idea_196429";
 ...
 */
@Slf4j
public class Idea196429Service {
    private static final int IDEA_ID = 196429;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196429Service() {
        this(new Idea196429Config());
    }

    public Idea196429Service(Idea196429Config config) {
        this.config = config != null ? config : new Idea196429Config();
