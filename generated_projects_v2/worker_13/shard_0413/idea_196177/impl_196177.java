...
@Data
public class Idea196177Config {
    private String name = "idea_196177";
 ...
 */
@Slf4j
public class Idea196177Service {
    private static final int IDEA_ID = 196177;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196177Service() {
        this(new Idea196177Config());
    }

    public Idea196177Service(Idea196177Config config) {
        this.config = config != null ? config : new Idea196177Config();
