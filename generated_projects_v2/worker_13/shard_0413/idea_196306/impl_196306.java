...
@Data
public class Idea196306Config {
    private String name = "idea_196306";
 ...
 */
@Slf4j
public class Idea196306Service {
    private static final int IDEA_ID = 196306;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196306Service() {
        this(new Idea196306Config());
    }

    public Idea196306Service(Idea196306Config config) {
        this.config = config != null ? config : new Idea196306Config();
