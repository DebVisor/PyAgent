...
@Data
public class Idea196648Config {
    private String name = "idea_196648";
 ...
 */
@Slf4j
public class Idea196648Service {
    private static final int IDEA_ID = 196648;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196648Service() {
        this(new Idea196648Config());
    }

    public Idea196648Service(Idea196648Config config) {
        this.config = config != null ? config : new Idea196648Config();
