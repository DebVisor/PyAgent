...
@Data
public class Idea196223Config {
    private String name = "idea_196223";
 ...
 */
@Slf4j
public class Idea196223Service {
    private static final int IDEA_ID = 196223;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196223Service() {
        this(new Idea196223Config());
    }

    public Idea196223Service(Idea196223Config config) {
        this.config = config != null ? config : new Idea196223Config();
