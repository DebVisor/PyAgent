...
@Data
public class Idea196568Config {
    private String name = "idea_196568";
 ...
 */
@Slf4j
public class Idea196568Service {
    private static final int IDEA_ID = 196568;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196568Service() {
        this(new Idea196568Config());
    }

    public Idea196568Service(Idea196568Config config) {
        this.config = config != null ? config : new Idea196568Config();
