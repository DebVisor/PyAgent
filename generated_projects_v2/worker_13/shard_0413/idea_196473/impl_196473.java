...
@Data
public class Idea196473Config {
    private String name = "idea_196473";
 ...
 */
@Slf4j
public class Idea196473Service {
    private static final int IDEA_ID = 196473;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196473Service() {
        this(new Idea196473Config());
    }

    public Idea196473Service(Idea196473Config config) {
        this.config = config != null ? config : new Idea196473Config();
