...
@Data
public class Idea196262Config {
    private String name = "idea_196262";
 ...
 */
@Slf4j
public class Idea196262Service {
    private static final int IDEA_ID = 196262;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196262Service() {
        this(new Idea196262Config());
    }

    public Idea196262Service(Idea196262Config config) {
        this.config = config != null ? config : new Idea196262Config();
