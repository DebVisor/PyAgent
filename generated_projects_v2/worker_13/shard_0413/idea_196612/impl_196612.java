...
@Data
public class Idea196612Config {
    private String name = "idea_196612";
 ...
 */
@Slf4j
public class Idea196612Service {
    private static final int IDEA_ID = 196612;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196612Service() {
        this(new Idea196612Config());
    }

    public Idea196612Service(Idea196612Config config) {
        this.config = config != null ? config : new Idea196612Config();
