...
@Data
public class Idea196186Config {
    private String name = "idea_196186";
 ...
 */
@Slf4j
public class Idea196186Service {
    private static final int IDEA_ID = 196186;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196186Service() {
        this(new Idea196186Config());
    }

    public Idea196186Service(Idea196186Config config) {
        this.config = config != null ? config : new Idea196186Config();
