...
@Data
public class Idea196194Config {
    private String name = "idea_196194";
 ...
 */
@Slf4j
public class Idea196194Service {
    private static final int IDEA_ID = 196194;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196194Service() {
        this(new Idea196194Config());
    }

    public Idea196194Service(Idea196194Config config) {
        this.config = config != null ? config : new Idea196194Config();
