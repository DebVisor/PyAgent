...
@Data
public class Idea196435Config {
    private String name = "idea_196435";
 ...
 */
@Slf4j
public class Idea196435Service {
    private static final int IDEA_ID = 196435;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196435Service() {
        this(new Idea196435Config());
    }

    public Idea196435Service(Idea196435Config config) {
        this.config = config != null ? config : new Idea196435Config();
