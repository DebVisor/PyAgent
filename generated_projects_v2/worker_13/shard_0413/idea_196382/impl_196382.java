...
@Data
public class Idea196382Config {
    private String name = "idea_196382";
 ...
 */
@Slf4j
public class Idea196382Service {
    private static final int IDEA_ID = 196382;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196382Service() {
        this(new Idea196382Config());
    }

    public Idea196382Service(Idea196382Config config) {
        this.config = config != null ? config : new Idea196382Config();
