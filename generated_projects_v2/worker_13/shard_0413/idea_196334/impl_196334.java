...
@Data
public class Idea196334Config {
    private String name = "idea_196334";
 ...
 */
@Slf4j
public class Idea196334Service {
    private static final int IDEA_ID = 196334;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196334Service() {
        this(new Idea196334Config());
    }

    public Idea196334Service(Idea196334Config config) {
        this.config = config != null ? config : new Idea196334Config();
