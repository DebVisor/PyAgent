...
@Data
public class Idea196605Config {
    private String name = "idea_196605";
 ...
 */
@Slf4j
public class Idea196605Service {
    private static final int IDEA_ID = 196605;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196605Service() {
        this(new Idea196605Config());
    }

    public Idea196605Service(Idea196605Config config) {
        this.config = config != null ? config : new Idea196605Config();
