...
@Data
public class Idea196200Config {
    private String name = "idea_196200";
 ...
 */
@Slf4j
public class Idea196200Service {
    private static final int IDEA_ID = 196200;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196200Service() {
        this(new Idea196200Config());
    }

    public Idea196200Service(Idea196200Config config) {
        this.config = config != null ? config : new Idea196200Config();
