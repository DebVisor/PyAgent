...
@Data
public class Idea196388Config {
    private String name = "idea_196388";
 ...
 */
@Slf4j
public class Idea196388Service {
    private static final int IDEA_ID = 196388;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196388Service() {
        this(new Idea196388Config());
    }

    public Idea196388Service(Idea196388Config config) {
        this.config = config != null ? config : new Idea196388Config();
