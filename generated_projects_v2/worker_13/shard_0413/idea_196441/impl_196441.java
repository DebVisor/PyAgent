...
@Data
public class Idea196441Config {
    private String name = "idea_196441";
 ...
 */
@Slf4j
public class Idea196441Service {
    private static final int IDEA_ID = 196441;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196441Service() {
        this(new Idea196441Config());
    }

    public Idea196441Service(Idea196441Config config) {
        this.config = config != null ? config : new Idea196441Config();
