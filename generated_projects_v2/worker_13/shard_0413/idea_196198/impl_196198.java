...
@Data
public class Idea196198Config {
    private String name = "idea_196198";
 ...
 */
@Slf4j
public class Idea196198Service {
    private static final int IDEA_ID = 196198;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196198Service() {
        this(new Idea196198Config());
    }

    public Idea196198Service(Idea196198Config config) {
        this.config = config != null ? config : new Idea196198Config();
