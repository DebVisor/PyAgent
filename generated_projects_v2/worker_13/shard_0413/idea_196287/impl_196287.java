...
@Data
public class Idea196287Config {
    private String name = "idea_196287";
 ...
 */
@Slf4j
public class Idea196287Service {
    private static final int IDEA_ID = 196287;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196287Service() {
        this(new Idea196287Config());
    }

    public Idea196287Service(Idea196287Config config) {
        this.config = config != null ? config : new Idea196287Config();
