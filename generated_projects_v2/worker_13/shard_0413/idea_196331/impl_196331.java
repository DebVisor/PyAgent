...
@Data
public class Idea196331Config {
    private String name = "idea_196331";
 ...
 */
@Slf4j
public class Idea196331Service {
    private static final int IDEA_ID = 196331;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196331Service() {
        this(new Idea196331Config());
    }

    public Idea196331Service(Idea196331Config config) {
        this.config = config != null ? config : new Idea196331Config();
