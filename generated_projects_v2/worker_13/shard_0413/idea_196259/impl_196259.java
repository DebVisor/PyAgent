...
@Data
public class Idea196259Config {
    private String name = "idea_196259";
 ...
 */
@Slf4j
public class Idea196259Service {
    private static final int IDEA_ID = 196259;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196259Service() {
        this(new Idea196259Config());
    }

    public Idea196259Service(Idea196259Config config) {
        this.config = config != null ? config : new Idea196259Config();
