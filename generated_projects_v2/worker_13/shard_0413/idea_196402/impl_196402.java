...
@Data
public class Idea196402Config {
    private String name = "idea_196402";
 ...
 */
@Slf4j
public class Idea196402Service {
    private static final int IDEA_ID = 196402;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196402Service() {
        this(new Idea196402Config());
    }

    public Idea196402Service(Idea196402Config config) {
        this.config = config != null ? config : new Idea196402Config();
