...
@Data
public class Idea196448Config {
    private String name = "idea_196448";
 ...
 */
@Slf4j
public class Idea196448Service {
    private static final int IDEA_ID = 196448;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196448Service() {
        this(new Idea196448Config());
    }

    public Idea196448Service(Idea196448Config config) {
        this.config = config != null ? config : new Idea196448Config();
