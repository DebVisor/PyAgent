...
@Data
public class Idea196255Config {
    private String name = "idea_196255";
 ...
 */
@Slf4j
public class Idea196255Service {
    private static final int IDEA_ID = 196255;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196255Service() {
        this(new Idea196255Config());
    }

    public Idea196255Service(Idea196255Config config) {
        this.config = config != null ? config : new Idea196255Config();
