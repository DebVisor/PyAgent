...
@Data
public class Idea196237Config {
    private String name = "idea_196237";
 ...
 */
@Slf4j
public class Idea196237Service {
    private static final int IDEA_ID = 196237;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196237Service() {
        this(new Idea196237Config());
    }

    public Idea196237Service(Idea196237Config config) {
        this.config = config != null ? config : new Idea196237Config();
