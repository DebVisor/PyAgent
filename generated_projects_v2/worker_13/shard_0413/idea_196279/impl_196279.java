...
@Data
public class Idea196279Config {
    private String name = "idea_196279";
 ...
 */
@Slf4j
public class Idea196279Service {
    private static final int IDEA_ID = 196279;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196279Service() {
        this(new Idea196279Config());
    }

    public Idea196279Service(Idea196279Config config) {
        this.config = config != null ? config : new Idea196279Config();
