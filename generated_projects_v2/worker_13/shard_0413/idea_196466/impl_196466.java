...
@Data
public class Idea196466Config {
    private String name = "idea_196466";
 ...
 */
@Slf4j
public class Idea196466Service {
    private static final int IDEA_ID = 196466;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196466Service() {
        this(new Idea196466Config());
    }

    public Idea196466Service(Idea196466Config config) {
        this.config = config != null ? config : new Idea196466Config();
