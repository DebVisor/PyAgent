...
@Data
public class Idea196356Config {
    private String name = "idea_196356";
 ...
 */
@Slf4j
public class Idea196356Service {
    private static final int IDEA_ID = 196356;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196356Service() {
        this(new Idea196356Config());
    }

    public Idea196356Service(Idea196356Config config) {
        this.config = config != null ? config : new Idea196356Config();
