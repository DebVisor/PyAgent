...
@Data
public class Idea196256Config {
    private String name = "idea_196256";
 ...
 */
@Slf4j
public class Idea196256Service {
    private static final int IDEA_ID = 196256;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196256Service() {
        this(new Idea196256Config());
    }

    public Idea196256Service(Idea196256Config config) {
        this.config = config != null ? config : new Idea196256Config();
