...
@Data
public class Idea196397Config {
    private String name = "idea_196397";
 ...
 */
@Slf4j
public class Idea196397Service {
    private static final int IDEA_ID = 196397;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196397Service() {
        this(new Idea196397Config());
    }

    public Idea196397Service(Idea196397Config config) {
        this.config = config != null ? config : new Idea196397Config();
