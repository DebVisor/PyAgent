...
@Data
public class Idea196628Config {
    private String name = "idea_196628";
 ...
 */
@Slf4j
public class Idea196628Service {
    private static final int IDEA_ID = 196628;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196628Service() {
        this(new Idea196628Config());
    }

    public Idea196628Service(Idea196628Config config) {
        this.config = config != null ? config : new Idea196628Config();
