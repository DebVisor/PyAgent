...
@Data
public class Idea196315Config {
    private String name = "idea_196315";
 ...
 */
@Slf4j
public class Idea196315Service {
    private static final int IDEA_ID = 196315;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196315Service() {
        this(new Idea196315Config());
    }

    public Idea196315Service(Idea196315Config config) {
        this.config = config != null ? config : new Idea196315Config();
