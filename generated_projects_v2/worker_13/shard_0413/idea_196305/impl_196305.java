...
@Data
public class Idea196305Config {
    private String name = "idea_196305";
 ...
 */
@Slf4j
public class Idea196305Service {
    private static final int IDEA_ID = 196305;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196305Service() {
        this(new Idea196305Config());
    }

    public Idea196305Service(Idea196305Config config) {
        this.config = config != null ? config : new Idea196305Config();
