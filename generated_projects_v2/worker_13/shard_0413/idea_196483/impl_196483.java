...
@Data
public class Idea196483Config {
    private String name = "idea_196483";
 ...
 */
@Slf4j
public class Idea196483Service {
    private static final int IDEA_ID = 196483;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196483Service() {
        this(new Idea196483Config());
    }

    public Idea196483Service(Idea196483Config config) {
        this.config = config != null ? config : new Idea196483Config();
