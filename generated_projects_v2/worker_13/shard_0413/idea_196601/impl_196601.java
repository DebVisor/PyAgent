...
@Data
public class Idea196601Config {
    private String name = "idea_196601";
 ...
 */
@Slf4j
public class Idea196601Service {
    private static final int IDEA_ID = 196601;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196601Service() {
        this(new Idea196601Config());
    }

    public Idea196601Service(Idea196601Config config) {
        this.config = config != null ? config : new Idea196601Config();
