...
@Data
public class Idea196454Config {
    private String name = "idea_196454";
 ...
 */
@Slf4j
public class Idea196454Service {
    private static final int IDEA_ID = 196454;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196454Service() {
        this(new Idea196454Config());
    }

    public Idea196454Service(Idea196454Config config) {
        this.config = config != null ? config : new Idea196454Config();
