...
@Data
public class Idea196432Config {
    private String name = "idea_196432";
 ...
 */
@Slf4j
public class Idea196432Service {
    private static final int IDEA_ID = 196432;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196432Service() {
        this(new Idea196432Config());
    }

    public Idea196432Service(Idea196432Config config) {
        this.config = config != null ? config : new Idea196432Config();
