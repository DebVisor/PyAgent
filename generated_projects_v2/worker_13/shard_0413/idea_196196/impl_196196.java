...
@Data
public class Idea196196Config {
    private String name = "idea_196196";
 ...
 */
@Slf4j
public class Idea196196Service {
    private static final int IDEA_ID = 196196;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196196Service() {
        this(new Idea196196Config());
    }

    public Idea196196Service(Idea196196Config config) {
        this.config = config != null ? config : new Idea196196Config();
