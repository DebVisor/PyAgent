...
@Data
public class Idea196175Config {
    private String name = "idea_196175";
 ...
 */
@Slf4j
public class Idea196175Service {
    private static final int IDEA_ID = 196175;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196175Service() {
        this(new Idea196175Config());
    }

    public Idea196175Service(Idea196175Config config) {
        this.config = config != null ? config : new Idea196175Config();
