...
@Data
public class Idea196631Config {
    private String name = "idea_196631";
 ...
 */
@Slf4j
public class Idea196631Service {
    private static final int IDEA_ID = 196631;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196631Service() {
        this(new Idea196631Config());
    }

    public Idea196631Service(Idea196631Config config) {
        this.config = config != null ? config : new Idea196631Config();
