...
@Data
public class Idea196252Config {
    private String name = "idea_196252";
 ...
 */
@Slf4j
public class Idea196252Service {
    private static final int IDEA_ID = 196252;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196252Service() {
        this(new Idea196252Config());
    }

    public Idea196252Service(Idea196252Config config) {
        this.config = config != null ? config : new Idea196252Config();
