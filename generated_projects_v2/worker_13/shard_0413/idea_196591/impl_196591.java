...
@Data
public class Idea196591Config {
    private String name = "idea_196591";
 ...
 */
@Slf4j
public class Idea196591Service {
    private static final int IDEA_ID = 196591;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196591Service() {
        this(new Idea196591Config());
    }

    public Idea196591Service(Idea196591Config config) {
        this.config = config != null ? config : new Idea196591Config();
