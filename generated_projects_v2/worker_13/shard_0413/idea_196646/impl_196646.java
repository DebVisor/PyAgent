...
@Data
public class Idea196646Config {
    private String name = "idea_196646";
 ...
 */
@Slf4j
public class Idea196646Service {
    private static final int IDEA_ID = 196646;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196646Service() {
        this(new Idea196646Config());
    }

    public Idea196646Service(Idea196646Config config) {
        this.config = config != null ? config : new Idea196646Config();
