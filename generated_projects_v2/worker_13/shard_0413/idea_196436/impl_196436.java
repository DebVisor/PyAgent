...
@Data
public class Idea196436Config {
    private String name = "idea_196436";
 ...
 */
@Slf4j
public class Idea196436Service {
    private static final int IDEA_ID = 196436;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196436Service() {
        this(new Idea196436Config());
    }

    public Idea196436Service(Idea196436Config config) {
        this.config = config != null ? config : new Idea196436Config();
