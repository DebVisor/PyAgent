...
@Data
public class Idea196263Config {
    private String name = "idea_196263";
 ...
 */
@Slf4j
public class Idea196263Service {
    private static final int IDEA_ID = 196263;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196263Service() {
        this(new Idea196263Config());
    }

    public Idea196263Service(Idea196263Config config) {
        this.config = config != null ? config : new Idea196263Config();
