...
@Data
public class Idea196480Config {
    private String name = "idea_196480";
 ...
 */
@Slf4j
public class Idea196480Service {
    private static final int IDEA_ID = 196480;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196480Service() {
        this(new Idea196480Config());
    }

    public Idea196480Service(Idea196480Config config) {
        this.config = config != null ? config : new Idea196480Config();
