...
@Data
public class Idea196440Config {
    private String name = "idea_196440";
 ...
 */
@Slf4j
public class Idea196440Service {
    private static final int IDEA_ID = 196440;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196440Service() {
        this(new Idea196440Config());
    }

    public Idea196440Service(Idea196440Config config) {
        this.config = config != null ? config : new Idea196440Config();
