...
@Data
public class Idea196204Config {
    private String name = "idea_196204";
 ...
 */
@Slf4j
public class Idea196204Service {
    private static final int IDEA_ID = 196204;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196204Service() {
        this(new Idea196204Config());
    }

    public Idea196204Service(Idea196204Config config) {
        this.config = config != null ? config : new Idea196204Config();
