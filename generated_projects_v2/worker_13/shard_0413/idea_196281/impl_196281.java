...
@Data
public class Idea196281Config {
    private String name = "idea_196281";
 ...
 */
@Slf4j
public class Idea196281Service {
    private static final int IDEA_ID = 196281;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196281Service() {
        this(new Idea196281Config());
    }

    public Idea196281Service(Idea196281Config config) {
        this.config = config != null ? config : new Idea196281Config();
