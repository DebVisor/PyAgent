...
@Data
public class Idea196465Config {
    private String name = "idea_196465";
 ...
 */
@Slf4j
public class Idea196465Service {
    private static final int IDEA_ID = 196465;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196465Service() {
        this(new Idea196465Config());
    }

    public Idea196465Service(Idea196465Config config) {
        this.config = config != null ? config : new Idea196465Config();
