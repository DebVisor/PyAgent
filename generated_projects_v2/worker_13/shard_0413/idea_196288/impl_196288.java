...
@Data
public class Idea196288Config {
    private String name = "idea_196288";
 ...
 */
@Slf4j
public class Idea196288Service {
    private static final int IDEA_ID = 196288;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196288Service() {
        this(new Idea196288Config());
    }

    public Idea196288Service(Idea196288Config config) {
        this.config = config != null ? config : new Idea196288Config();
