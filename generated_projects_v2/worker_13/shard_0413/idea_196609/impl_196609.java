...
@Data
public class Idea196609Config {
    private String name = "idea_196609";
 ...
 */
@Slf4j
public class Idea196609Service {
    private static final int IDEA_ID = 196609;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196609Service() {
        this(new Idea196609Config());
    }

    public Idea196609Service(Idea196609Config config) {
        this.config = config != null ? config : new Idea196609Config();
