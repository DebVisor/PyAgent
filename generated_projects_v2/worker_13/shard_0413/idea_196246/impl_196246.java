...
@Data
public class Idea196246Config {
    private String name = "idea_196246";
 ...
 */
@Slf4j
public class Idea196246Service {
    private static final int IDEA_ID = 196246;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196246Service() {
        this(new Idea196246Config());
    }

    public Idea196246Service(Idea196246Config config) {
        this.config = config != null ? config : new Idea196246Config();
