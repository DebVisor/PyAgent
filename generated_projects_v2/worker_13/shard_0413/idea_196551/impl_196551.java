...
@Data
public class Idea196551Config {
    private String name = "idea_196551";
 ...
 */
@Slf4j
public class Idea196551Service {
    private static final int IDEA_ID = 196551;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196551Service() {
        this(new Idea196551Config());
    }

    public Idea196551Service(Idea196551Config config) {
        this.config = config != null ? config : new Idea196551Config();
