...
@Data
public class Idea196427Config {
    private String name = "idea_196427";
 ...
 */
@Slf4j
public class Idea196427Service {
    private static final int IDEA_ID = 196427;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196427Service() {
        this(new Idea196427Config());
    }

    public Idea196427Service(Idea196427Config config) {
        this.config = config != null ? config : new Idea196427Config();
