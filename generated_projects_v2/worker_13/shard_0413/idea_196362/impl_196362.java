...
@Data
public class Idea196362Config {
    private String name = "idea_196362";
 ...
 */
@Slf4j
public class Idea196362Service {
    private static final int IDEA_ID = 196362;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196362Service() {
        this(new Idea196362Config());
    }

    public Idea196362Service(Idea196362Config config) {
        this.config = config != null ? config : new Idea196362Config();
