...
@Data
public class Idea196462Config {
    private String name = "idea_196462";
 ...
 */
@Slf4j
public class Idea196462Service {
    private static final int IDEA_ID = 196462;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196462Service() {
        this(new Idea196462Config());
    }

    public Idea196462Service(Idea196462Config config) {
        this.config = config != null ? config : new Idea196462Config();
