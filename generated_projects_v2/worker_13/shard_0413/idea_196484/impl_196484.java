...
@Data
public class Idea196484Config {
    private String name = "idea_196484";
 ...
 */
@Slf4j
public class Idea196484Service {
    private static final int IDEA_ID = 196484;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196484Service() {
        this(new Idea196484Config());
    }

    public Idea196484Service(Idea196484Config config) {
        this.config = config != null ? config : new Idea196484Config();
