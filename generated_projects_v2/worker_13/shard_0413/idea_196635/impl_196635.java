...
@Data
public class Idea196635Config {
    private String name = "idea_196635";
 ...
 */
@Slf4j
public class Idea196635Service {
    private static final int IDEA_ID = 196635;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196635Service() {
        this(new Idea196635Config());
    }

    public Idea196635Service(Idea196635Config config) {
        this.config = config != null ? config : new Idea196635Config();
