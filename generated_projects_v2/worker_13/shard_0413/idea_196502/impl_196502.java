...
@Data
public class Idea196502Config {
    private String name = "idea_196502";
 ...
 */
@Slf4j
public class Idea196502Service {
    private static final int IDEA_ID = 196502;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196502Service() {
        this(new Idea196502Config());
    }

    public Idea196502Service(Idea196502Config config) {
        this.config = config != null ? config : new Idea196502Config();
