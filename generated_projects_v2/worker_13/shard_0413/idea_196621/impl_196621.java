...
@Data
public class Idea196621Config {
    private String name = "idea_196621";
 ...
 */
@Slf4j
public class Idea196621Service {
    private static final int IDEA_ID = 196621;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196621Service() {
        this(new Idea196621Config());
    }

    public Idea196621Service(Idea196621Config config) {
        this.config = config != null ? config : new Idea196621Config();
