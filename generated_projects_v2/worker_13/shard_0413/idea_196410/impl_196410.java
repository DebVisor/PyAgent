...
@Data
public class Idea196410Config {
    private String name = "idea_196410";
 ...
 */
@Slf4j
public class Idea196410Service {
    private static final int IDEA_ID = 196410;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196410Service() {
        this(new Idea196410Config());
    }

    public Idea196410Service(Idea196410Config config) {
        this.config = config != null ? config : new Idea196410Config();
