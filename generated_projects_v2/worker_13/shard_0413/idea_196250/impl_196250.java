...
@Data
public class Idea196250Config {
    private String name = "idea_196250";
 ...
 */
@Slf4j
public class Idea196250Service {
    private static final int IDEA_ID = 196250;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196250Service() {
        this(new Idea196250Config());
    }

    public Idea196250Service(Idea196250Config config) {
        this.config = config != null ? config : new Idea196250Config();
