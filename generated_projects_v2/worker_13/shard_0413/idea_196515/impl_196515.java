...
@Data
public class Idea196515Config {
    private String name = "idea_196515";
 ...
 */
@Slf4j
public class Idea196515Service {
    private static final int IDEA_ID = 196515;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196515Service() {
        this(new Idea196515Config());
    }

    public Idea196515Service(Idea196515Config config) {
        this.config = config != null ? config : new Idea196515Config();
