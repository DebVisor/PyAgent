...
@Data
public class Idea196519Config {
    private String name = "idea_196519";
 ...
 */
@Slf4j
public class Idea196519Service {
    private static final int IDEA_ID = 196519;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196519Service() {
        this(new Idea196519Config());
    }

    public Idea196519Service(Idea196519Config config) {
        this.config = config != null ? config : new Idea196519Config();
