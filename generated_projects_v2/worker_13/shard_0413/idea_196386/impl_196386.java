...
@Data
public class Idea196386Config {
    private String name = "idea_196386";
 ...
 */
@Slf4j
public class Idea196386Service {
    private static final int IDEA_ID = 196386;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196386Service() {
        this(new Idea196386Config());
    }

    public Idea196386Service(Idea196386Config config) {
        this.config = config != null ? config : new Idea196386Config();
