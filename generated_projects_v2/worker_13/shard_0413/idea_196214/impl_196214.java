...
@Data
public class Idea196214Config {
    private String name = "idea_196214";
 ...
 */
@Slf4j
public class Idea196214Service {
    private static final int IDEA_ID = 196214;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196214Service() {
        this(new Idea196214Config());
    }

    public Idea196214Service(Idea196214Config config) {
        this.config = config != null ? config : new Idea196214Config();
