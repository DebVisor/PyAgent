...
@Data
public class Idea196253Config {
    private String name = "idea_196253";
 ...
 */
@Slf4j
public class Idea196253Service {
    private static final int IDEA_ID = 196253;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196253Service() {
        this(new Idea196253Config());
    }

    public Idea196253Service(Idea196253Config config) {
        this.config = config != null ? config : new Idea196253Config();
