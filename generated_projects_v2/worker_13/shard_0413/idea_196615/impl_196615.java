...
@Data
public class Idea196615Config {
    private String name = "idea_196615";
 ...
 */
@Slf4j
public class Idea196615Service {
    private static final int IDEA_ID = 196615;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196615Service() {
        this(new Idea196615Config());
    }

    public Idea196615Service(Idea196615Config config) {
        this.config = config != null ? config : new Idea196615Config();
