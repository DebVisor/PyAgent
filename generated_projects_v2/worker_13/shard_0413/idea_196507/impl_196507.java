...
@Data
public class Idea196507Config {
    private String name = "idea_196507";
 ...
 */
@Slf4j
public class Idea196507Service {
    private static final int IDEA_ID = 196507;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196507Service() {
        this(new Idea196507Config());
    }

    public Idea196507Service(Idea196507Config config) {
        this.config = config != null ? config : new Idea196507Config();
