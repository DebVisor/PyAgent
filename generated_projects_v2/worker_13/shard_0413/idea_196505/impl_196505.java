...
@Data
public class Idea196505Config {
    private String name = "idea_196505";
 ...
 */
@Slf4j
public class Idea196505Service {
    private static final int IDEA_ID = 196505;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196505Service() {
        this(new Idea196505Config());
    }

    public Idea196505Service(Idea196505Config config) {
        this.config = config != null ? config : new Idea196505Config();
