...
@Data
public class Idea196623Config {
    private String name = "idea_196623";
 ...
 */
@Slf4j
public class Idea196623Service {
    private static final int IDEA_ID = 196623;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196623Service() {
        this(new Idea196623Config());
    }

    public Idea196623Service(Idea196623Config config) {
        this.config = config != null ? config : new Idea196623Config();
