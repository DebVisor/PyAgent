...
@Data
public class Idea196449Config {
    private String name = "idea_196449";
 ...
 */
@Slf4j
public class Idea196449Service {
    private static final int IDEA_ID = 196449;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196449Service() {
        this(new Idea196449Config());
    }

    public Idea196449Service(Idea196449Config config) {
        this.config = config != null ? config : new Idea196449Config();
