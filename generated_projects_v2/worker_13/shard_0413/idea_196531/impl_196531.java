...
@Data
public class Idea196531Config {
    private String name = "idea_196531";
 ...
 */
@Slf4j
public class Idea196531Service {
    private static final int IDEA_ID = 196531;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196531Service() {
        this(new Idea196531Config());
    }

    public Idea196531Service(Idea196531Config config) {
        this.config = config != null ? config : new Idea196531Config();
