...
@Data
public class Idea196245Config {
    private String name = "idea_196245";
 ...
 */
@Slf4j
public class Idea196245Service {
    private static final int IDEA_ID = 196245;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196245Service() {
        this(new Idea196245Config());
    }

    public Idea196245Service(Idea196245Config config) {
        this.config = config != null ? config : new Idea196245Config();
