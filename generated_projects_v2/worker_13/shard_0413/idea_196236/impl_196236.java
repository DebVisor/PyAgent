...
@Data
public class Idea196236Config {
    private String name = "idea_196236";
 ...
 */
@Slf4j
public class Idea196236Service {
    private static final int IDEA_ID = 196236;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196236Service() {
        this(new Idea196236Config());
    }

    public Idea196236Service(Idea196236Config config) {
        this.config = config != null ? config : new Idea196236Config();
