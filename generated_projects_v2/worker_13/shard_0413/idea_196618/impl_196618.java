...
@Data
public class Idea196618Config {
    private String name = "idea_196618";
 ...
 */
@Slf4j
public class Idea196618Service {
    private static final int IDEA_ID = 196618;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196618Service() {
        this(new Idea196618Config());
    }

    public Idea196618Service(Idea196618Config config) {
        this.config = config != null ? config : new Idea196618Config();
