...
@Data
public class Idea196361Config {
    private String name = "idea_196361";
 ...
 */
@Slf4j
public class Idea196361Service {
    private static final int IDEA_ID = 196361;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196361Service() {
        this(new Idea196361Config());
    }

    public Idea196361Service(Idea196361Config config) {
        this.config = config != null ? config : new Idea196361Config();
