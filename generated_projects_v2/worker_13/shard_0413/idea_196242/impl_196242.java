...
@Data
public class Idea196242Config {
    private String name = "idea_196242";
 ...
 */
@Slf4j
public class Idea196242Service {
    private static final int IDEA_ID = 196242;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196242Service() {
        this(new Idea196242Config());
    }

    public Idea196242Service(Idea196242Config config) {
        this.config = config != null ? config : new Idea196242Config();
