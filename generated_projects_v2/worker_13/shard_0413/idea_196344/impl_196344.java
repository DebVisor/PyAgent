...
@Data
public class Idea196344Config {
    private String name = "idea_196344";
 ...
 */
@Slf4j
public class Idea196344Service {
    private static final int IDEA_ID = 196344;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196344Service() {
        this(new Idea196344Config());
    }

    public Idea196344Service(Idea196344Config config) {
        this.config = config != null ? config : new Idea196344Config();
