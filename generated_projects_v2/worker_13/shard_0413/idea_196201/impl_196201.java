...
@Data
public class Idea196201Config {
    private String name = "idea_196201";
 ...
 */
@Slf4j
public class Idea196201Service {
    private static final int IDEA_ID = 196201;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196201Service() {
        this(new Idea196201Config());
    }

    public Idea196201Service(Idea196201Config config) {
        this.config = config != null ? config : new Idea196201Config();
