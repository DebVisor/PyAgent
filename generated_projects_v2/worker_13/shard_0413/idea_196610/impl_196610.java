...
@Data
public class Idea196610Config {
    private String name = "idea_196610";
 ...
 */
@Slf4j
public class Idea196610Service {
    private static final int IDEA_ID = 196610;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196610Service() {
        this(new Idea196610Config());
    }

    public Idea196610Service(Idea196610Config config) {
        this.config = config != null ? config : new Idea196610Config();
