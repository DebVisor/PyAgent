...
@Data
public class Idea196367Config {
    private String name = "idea_196367";
 ...
 */
@Slf4j
public class Idea196367Service {
    private static final int IDEA_ID = 196367;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196367Service() {
        this(new Idea196367Config());
    }

    public Idea196367Service(Idea196367Config config) {
        this.config = config != null ? config : new Idea196367Config();
