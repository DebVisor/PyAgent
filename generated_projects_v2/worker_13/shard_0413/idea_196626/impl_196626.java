...
@Data
public class Idea196626Config {
    private String name = "idea_196626";
 ...
 */
@Slf4j
public class Idea196626Service {
    private static final int IDEA_ID = 196626;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196626Service() {
        this(new Idea196626Config());
    }

    public Idea196626Service(Idea196626Config config) {
        this.config = config != null ? config : new Idea196626Config();
