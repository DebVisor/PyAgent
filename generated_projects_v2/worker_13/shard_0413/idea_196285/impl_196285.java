...
@Data
public class Idea196285Config {
    private String name = "idea_196285";
 ...
 */
@Slf4j
public class Idea196285Service {
    private static final int IDEA_ID = 196285;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196285Service() {
        this(new Idea196285Config());
    }

    public Idea196285Service(Idea196285Config config) {
        this.config = config != null ? config : new Idea196285Config();
