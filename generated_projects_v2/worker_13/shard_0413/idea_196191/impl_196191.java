...
@Data
public class Idea196191Config {
    private String name = "idea_196191";
 ...
 */
@Slf4j
public class Idea196191Service {
    private static final int IDEA_ID = 196191;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196191Service() {
        this(new Idea196191Config());
    }

    public Idea196191Service(Idea196191Config config) {
        this.config = config != null ? config : new Idea196191Config();
