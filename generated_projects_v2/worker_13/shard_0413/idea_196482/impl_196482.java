...
@Data
public class Idea196482Config {
    private String name = "idea_196482";
 ...
 */
@Slf4j
public class Idea196482Service {
    private static final int IDEA_ID = 196482;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196482Service() {
        this(new Idea196482Config());
    }

    public Idea196482Service(Idea196482Config config) {
        this.config = config != null ? config : new Idea196482Config();
