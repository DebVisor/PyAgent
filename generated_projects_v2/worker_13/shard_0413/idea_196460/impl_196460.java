...
@Data
public class Idea196460Config {
    private String name = "idea_196460";
 ...
 */
@Slf4j
public class Idea196460Service {
    private static final int IDEA_ID = 196460;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196460Service() {
        this(new Idea196460Config());
    }

    public Idea196460Service(Idea196460Config config) {
        this.config = config != null ? config : new Idea196460Config();
