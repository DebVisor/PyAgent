...
@Data
public class Idea196559Config {
    private String name = "idea_196559";
 ...
 */
@Slf4j
public class Idea196559Service {
    private static final int IDEA_ID = 196559;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196559Service() {
        this(new Idea196559Config());
    }

    public Idea196559Service(Idea196559Config config) {
        this.config = config != null ? config : new Idea196559Config();
