...
@Data
public class Idea196474Config {
    private String name = "idea_196474";
 ...
 */
@Slf4j
public class Idea196474Service {
    private static final int IDEA_ID = 196474;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196474Service() {
        this(new Idea196474Config());
    }

    public Idea196474Service(Idea196474Config config) {
        this.config = config != null ? config : new Idea196474Config();
