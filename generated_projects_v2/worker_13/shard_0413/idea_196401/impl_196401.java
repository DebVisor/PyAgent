...
@Data
public class Idea196401Config {
    private String name = "idea_196401";
 ...
 */
@Slf4j
public class Idea196401Service {
    private static final int IDEA_ID = 196401;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196401Service() {
        this(new Idea196401Config());
    }

    public Idea196401Service(Idea196401Config config) {
        this.config = config != null ? config : new Idea196401Config();
