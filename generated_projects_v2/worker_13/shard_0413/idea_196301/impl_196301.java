...
@Data
public class Idea196301Config {
    private String name = "idea_196301";
 ...
 */
@Slf4j
public class Idea196301Service {
    private static final int IDEA_ID = 196301;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196301Service() {
        this(new Idea196301Config());
    }

    public Idea196301Service(Idea196301Config config) {
        this.config = config != null ? config : new Idea196301Config();
