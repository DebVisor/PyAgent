...
@Data
public class Idea196247Config {
    private String name = "idea_196247";
 ...
 */
@Slf4j
public class Idea196247Service {
    private static final int IDEA_ID = 196247;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196247Service() {
        this(new Idea196247Config());
    }

    public Idea196247Service(Idea196247Config config) {
        this.config = config != null ? config : new Idea196247Config();
