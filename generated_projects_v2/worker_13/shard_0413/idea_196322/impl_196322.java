...
@Data
public class Idea196322Config {
    private String name = "idea_196322";
 ...
 */
@Slf4j
public class Idea196322Service {
    private static final int IDEA_ID = 196322;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196322Service() {
        this(new Idea196322Config());
    }

    public Idea196322Service(Idea196322Config config) {
        this.config = config != null ? config : new Idea196322Config();
