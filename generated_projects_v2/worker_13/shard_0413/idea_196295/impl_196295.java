...
@Data
public class Idea196295Config {
    private String name = "idea_196295";
 ...
 */
@Slf4j
public class Idea196295Service {
    private static final int IDEA_ID = 196295;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196295Service() {
        this(new Idea196295Config());
    }

    public Idea196295Service(Idea196295Config config) {
        this.config = config != null ? config : new Idea196295Config();
