...
@Data
public class Idea196294Config {
    private String name = "idea_196294";
 ...
 */
@Slf4j
public class Idea196294Service {
    private static final int IDEA_ID = 196294;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196294Service() {
        this(new Idea196294Config());
    }

    public Idea196294Service(Idea196294Config config) {
        this.config = config != null ? config : new Idea196294Config();
