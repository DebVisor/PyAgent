...
@Data
public class Idea196603Config {
    private String name = "idea_196603";
 ...
 */
@Slf4j
public class Idea196603Service {
    private static final int IDEA_ID = 196603;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196603Service() {
        this(new Idea196603Config());
    }

    public Idea196603Service(Idea196603Config config) {
        this.config = config != null ? config : new Idea196603Config();
