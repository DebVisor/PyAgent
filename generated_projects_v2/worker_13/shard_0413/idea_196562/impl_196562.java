...
@Data
public class Idea196562Config {
    private String name = "idea_196562";
 ...
 */
@Slf4j
public class Idea196562Service {
    private static final int IDEA_ID = 196562;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196562Service() {
        this(new Idea196562Config());
    }

    public Idea196562Service(Idea196562Config config) {
        this.config = config != null ? config : new Idea196562Config();
