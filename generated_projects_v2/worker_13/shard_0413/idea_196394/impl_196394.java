...
@Data
public class Idea196394Config {
    private String name = "idea_196394";
 ...
 */
@Slf4j
public class Idea196394Service {
    private static final int IDEA_ID = 196394;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196394Service() {
        this(new Idea196394Config());
    }

    public Idea196394Service(Idea196394Config config) {
        this.config = config != null ? config : new Idea196394Config();
