...
@Data
public class Idea196593Config {
    private String name = "idea_196593";
 ...
 */
@Slf4j
public class Idea196593Service {
    private static final int IDEA_ID = 196593;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196593Service() {
        this(new Idea196593Config());
    }

    public Idea196593Service(Idea196593Config config) {
        this.config = config != null ? config : new Idea196593Config();
