...
@Data
public class Idea196338Config {
    private String name = "idea_196338";
 ...
 */
@Slf4j
public class Idea196338Service {
    private static final int IDEA_ID = 196338;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196338Service() {
        this(new Idea196338Config());
    }

    public Idea196338Service(Idea196338Config config) {
        this.config = config != null ? config : new Idea196338Config();
