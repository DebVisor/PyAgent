...
@Data
public class Idea196278Config {
    private String name = "idea_196278";
 ...
 */
@Slf4j
public class Idea196278Service {
    private static final int IDEA_ID = 196278;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196278Service() {
        this(new Idea196278Config());
    }

    public Idea196278Service(Idea196278Config config) {
        this.config = config != null ? config : new Idea196278Config();
