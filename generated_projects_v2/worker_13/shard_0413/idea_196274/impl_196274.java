...
@Data
public class Idea196274Config {
    private String name = "idea_196274";
 ...
 */
@Slf4j
public class Idea196274Service {
    private static final int IDEA_ID = 196274;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196274Service() {
        this(new Idea196274Config());
    }

    public Idea196274Service(Idea196274Config config) {
        this.config = config != null ? config : new Idea196274Config();
