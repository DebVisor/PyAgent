...
@Data
public class Idea196412Config {
    private String name = "idea_196412";
 ...
 */
@Slf4j
public class Idea196412Service {
    private static final int IDEA_ID = 196412;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196412Service() {
        this(new Idea196412Config());
    }

    public Idea196412Service(Idea196412Config config) {
        this.config = config != null ? config : new Idea196412Config();
