...
@Data
public class Idea196416Config {
    private String name = "idea_196416";
 ...
 */
@Slf4j
public class Idea196416Service {
    private static final int IDEA_ID = 196416;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196416Service() {
        this(new Idea196416Config());
    }

    public Idea196416Service(Idea196416Config config) {
        this.config = config != null ? config : new Idea196416Config();
