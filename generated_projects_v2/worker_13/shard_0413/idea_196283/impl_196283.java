...
@Data
public class Idea196283Config {
    private String name = "idea_196283";
 ...
 */
@Slf4j
public class Idea196283Service {
    private static final int IDEA_ID = 196283;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196283Service() {
        this(new Idea196283Config());
    }

    public Idea196283Service(Idea196283Config config) {
        this.config = config != null ? config : new Idea196283Config();
