...
@Data
public class Idea196536Config {
    private String name = "idea_196536";
 ...
 */
@Slf4j
public class Idea196536Service {
    private static final int IDEA_ID = 196536;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196536Service() {
        this(new Idea196536Config());
    }

    public Idea196536Service(Idea196536Config config) {
        this.config = config != null ? config : new Idea196536Config();
