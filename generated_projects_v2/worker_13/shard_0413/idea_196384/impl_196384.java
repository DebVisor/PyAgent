...
@Data
public class Idea196384Config {
    private String name = "idea_196384";
 ...
 */
@Slf4j
public class Idea196384Service {
    private static final int IDEA_ID = 196384;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196384Service() {
        this(new Idea196384Config());
    }

    public Idea196384Service(Idea196384Config config) {
        this.config = config != null ? config : new Idea196384Config();
