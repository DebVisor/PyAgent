...
@Data
public class Idea196208Config {
    private String name = "idea_196208";
 ...
 */
@Slf4j
public class Idea196208Service {
    private static final int IDEA_ID = 196208;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196208Service() {
        this(new Idea196208Config());
    }

    public Idea196208Service(Idea196208Config config) {
        this.config = config != null ? config : new Idea196208Config();
