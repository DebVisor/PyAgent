...
@Data
public class Idea196547Config {
    private String name = "idea_196547";
 ...
 */
@Slf4j
public class Idea196547Service {
    private static final int IDEA_ID = 196547;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196547Service() {
        this(new Idea196547Config());
    }

    public Idea196547Service(Idea196547Config config) {
        this.config = config != null ? config : new Idea196547Config();
