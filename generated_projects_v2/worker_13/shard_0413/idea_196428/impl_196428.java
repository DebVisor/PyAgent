...
@Data
public class Idea196428Config {
    private String name = "idea_196428";
 ...
 */
@Slf4j
public class Idea196428Service {
    private static final int IDEA_ID = 196428;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196428Service() {
        this(new Idea196428Config());
    }

    public Idea196428Service(Idea196428Config config) {
        this.config = config != null ? config : new Idea196428Config();
