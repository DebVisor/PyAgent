...
@Data
public class Idea196478Config {
    private String name = "idea_196478";
 ...
 */
@Slf4j
public class Idea196478Service {
    private static final int IDEA_ID = 196478;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196478Service() {
        this(new Idea196478Config());
    }

    public Idea196478Service(Idea196478Config config) {
        this.config = config != null ? config : new Idea196478Config();
