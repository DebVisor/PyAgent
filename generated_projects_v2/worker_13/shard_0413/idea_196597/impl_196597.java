...
@Data
public class Idea196597Config {
    private String name = "idea_196597";
 ...
 */
@Slf4j
public class Idea196597Service {
    private static final int IDEA_ID = 196597;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196597Service() {
        this(new Idea196597Config());
    }

    public Idea196597Service(Idea196597Config config) {
        this.config = config != null ? config : new Idea196597Config();
