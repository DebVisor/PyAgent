...
@Data
public class Idea196213Config {
    private String name = "idea_196213";
 ...
 */
@Slf4j
public class Idea196213Service {
    private static final int IDEA_ID = 196213;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196213Service() {
        this(new Idea196213Config());
    }

    public Idea196213Service(Idea196213Config config) {
        this.config = config != null ? config : new Idea196213Config();
