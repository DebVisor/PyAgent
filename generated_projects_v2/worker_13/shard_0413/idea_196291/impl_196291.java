...
@Data
public class Idea196291Config {
    private String name = "idea_196291";
 ...
 */
@Slf4j
public class Idea196291Service {
    private static final int IDEA_ID = 196291;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196291Service() {
        this(new Idea196291Config());
    }

    public Idea196291Service(Idea196291Config config) {
        this.config = config != null ? config : new Idea196291Config();
