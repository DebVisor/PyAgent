...
@Data
public class Idea196533Config {
    private String name = "idea_196533";
 ...
 */
@Slf4j
public class Idea196533Service {
    private static final int IDEA_ID = 196533;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196533Service() {
        this(new Idea196533Config());
    }

    public Idea196533Service(Idea196533Config config) {
        this.config = config != null ? config : new Idea196533Config();
