...
@Data
public class Idea196583Config {
    private String name = "idea_196583";
 ...
 */
@Slf4j
public class Idea196583Service {
    private static final int IDEA_ID = 196583;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196583Service() {
        this(new Idea196583Config());
    }

    public Idea196583Service(Idea196583Config config) {
        this.config = config != null ? config : new Idea196583Config();
