...
@Data
public class Idea196456Config {
    private String name = "idea_196456";
 ...
 */
@Slf4j
public class Idea196456Service {
    private static final int IDEA_ID = 196456;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196456Service() {
        this(new Idea196456Config());
    }

    public Idea196456Service(Idea196456Config config) {
        this.config = config != null ? config : new Idea196456Config();
