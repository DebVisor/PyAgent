...
@Data
public class Idea196225Config {
    private String name = "idea_196225";
 ...
 */
@Slf4j
public class Idea196225Service {
    private static final int IDEA_ID = 196225;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196225Service() {
        this(new Idea196225Config());
    }

    public Idea196225Service(Idea196225Config config) {
        this.config = config != null ? config : new Idea196225Config();
