...
@Data
public class Idea196624Config {
    private String name = "idea_196624";
 ...
 */
@Slf4j
public class Idea196624Service {
    private static final int IDEA_ID = 196624;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196624Service() {
        this(new Idea196624Config());
    }

    public Idea196624Service(Idea196624Config config) {
        this.config = config != null ? config : new Idea196624Config();
