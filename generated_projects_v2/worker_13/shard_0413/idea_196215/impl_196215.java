...
@Data
public class Idea196215Config {
    private String name = "idea_196215";
 ...
 */
@Slf4j
public class Idea196215Service {
    private static final int IDEA_ID = 196215;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196215Service() {
        this(new Idea196215Config());
    }

    public Idea196215Service(Idea196215Config config) {
        this.config = config != null ? config : new Idea196215Config();
