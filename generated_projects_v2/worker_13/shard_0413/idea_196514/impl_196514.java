...
@Data
public class Idea196514Config {
    private String name = "idea_196514";
 ...
 */
@Slf4j
public class Idea196514Service {
    private static final int IDEA_ID = 196514;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196514Service() {
        this(new Idea196514Config());
    }

    public Idea196514Service(Idea196514Config config) {
        this.config = config != null ? config : new Idea196514Config();
