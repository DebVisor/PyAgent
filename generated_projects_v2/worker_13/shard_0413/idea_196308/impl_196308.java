...
@Data
public class Idea196308Config {
    private String name = "idea_196308";
 ...
 */
@Slf4j
public class Idea196308Service {
    private static final int IDEA_ID = 196308;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196308Service() {
        this(new Idea196308Config());
    }

    public Idea196308Service(Idea196308Config config) {
        this.config = config != null ? config : new Idea196308Config();
