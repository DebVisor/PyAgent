...
@Data
public class Idea196518Config {
    private String name = "idea_196518";
 ...
 */
@Slf4j
public class Idea196518Service {
    private static final int IDEA_ID = 196518;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196518Service() {
        this(new Idea196518Config());
    }

    public Idea196518Service(Idea196518Config config) {
        this.config = config != null ? config : new Idea196518Config();
