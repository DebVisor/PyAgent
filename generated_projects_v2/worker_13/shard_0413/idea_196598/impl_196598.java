...
@Data
public class Idea196598Config {
    private String name = "idea_196598";
 ...
 */
@Slf4j
public class Idea196598Service {
    private static final int IDEA_ID = 196598;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196598Service() {
        this(new Idea196598Config());
    }

    public Idea196598Service(Idea196598Config config) {
        this.config = config != null ? config : new Idea196598Config();
