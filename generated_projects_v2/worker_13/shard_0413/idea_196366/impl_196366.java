...
@Data
public class Idea196366Config {
    private String name = "idea_196366";
 ...
 */
@Slf4j
public class Idea196366Service {
    private static final int IDEA_ID = 196366;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196366Service() {
        this(new Idea196366Config());
    }

    public Idea196366Service(Idea196366Config config) {
        this.config = config != null ? config : new Idea196366Config();
