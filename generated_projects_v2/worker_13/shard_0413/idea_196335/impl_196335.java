...
@Data
public class Idea196335Config {
    private String name = "idea_196335";
 ...
 */
@Slf4j
public class Idea196335Service {
    private static final int IDEA_ID = 196335;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196335Service() {
        this(new Idea196335Config());
    }

    public Idea196335Service(Idea196335Config config) {
        this.config = config != null ? config : new Idea196335Config();
