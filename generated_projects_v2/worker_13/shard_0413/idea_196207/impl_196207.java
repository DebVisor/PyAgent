...
@Data
public class Idea196207Config {
    private String name = "idea_196207";
 ...
 */
@Slf4j
public class Idea196207Service {
    private static final int IDEA_ID = 196207;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196207Service() {
        this(new Idea196207Config());
    }

    public Idea196207Service(Idea196207Config config) {
        this.config = config != null ? config : new Idea196207Config();
