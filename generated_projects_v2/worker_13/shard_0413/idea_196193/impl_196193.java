...
@Data
public class Idea196193Config {
    private String name = "idea_196193";
 ...
 */
@Slf4j
public class Idea196193Service {
    private static final int IDEA_ID = 196193;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196193Service() {
        this(new Idea196193Config());
    }

    public Idea196193Service(Idea196193Config config) {
        this.config = config != null ? config : new Idea196193Config();
