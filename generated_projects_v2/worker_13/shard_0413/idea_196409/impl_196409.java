...
@Data
public class Idea196409Config {
    private String name = "idea_196409";
 ...
 */
@Slf4j
public class Idea196409Service {
    private static final int IDEA_ID = 196409;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196409Service() {
        this(new Idea196409Config());
    }

    public Idea196409Service(Idea196409Config config) {
        this.config = config != null ? config : new Idea196409Config();
