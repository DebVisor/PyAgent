...
@Data
public class Idea196307Config {
    private String name = "idea_196307";
 ...
 */
@Slf4j
public class Idea196307Service {
    private static final int IDEA_ID = 196307;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196307Service() {
        this(new Idea196307Config());
    }

    public Idea196307Service(Idea196307Config config) {
        this.config = config != null ? config : new Idea196307Config();
