...
@Data
public class Idea196216Config {
    private String name = "idea_196216";
 ...
 */
@Slf4j
public class Idea196216Service {
    private static final int IDEA_ID = 196216;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196216Service() {
        this(new Idea196216Config());
    }

    public Idea196216Service(Idea196216Config config) {
        this.config = config != null ? config : new Idea196216Config();
