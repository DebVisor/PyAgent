...
@Data
public class Idea196485Config {
    private String name = "idea_196485";
 ...
 */
@Slf4j
public class Idea196485Service {
    private static final int IDEA_ID = 196485;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196485Service() {
        this(new Idea196485Config());
    }

    public Idea196485Service(Idea196485Config config) {
        this.config = config != null ? config : new Idea196485Config();
