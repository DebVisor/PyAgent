...
@Data
public class Idea196261Config {
    private String name = "idea_196261";
 ...
 */
@Slf4j
public class Idea196261Service {
    private static final int IDEA_ID = 196261;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196261Service() {
        this(new Idea196261Config());
    }

    public Idea196261Service(Idea196261Config config) {
        this.config = config != null ? config : new Idea196261Config();
