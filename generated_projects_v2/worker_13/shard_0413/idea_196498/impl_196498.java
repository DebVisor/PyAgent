...
@Data
public class Idea196498Config {
    private String name = "idea_196498";
 ...
 */
@Slf4j
public class Idea196498Service {
    private static final int IDEA_ID = 196498;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196498Service() {
        this(new Idea196498Config());
    }

    public Idea196498Service(Idea196498Config config) {
        this.config = config != null ? config : new Idea196498Config();
