...
@Data
public class Idea196379Config {
    private String name = "idea_196379";
 ...
 */
@Slf4j
public class Idea196379Service {
    private static final int IDEA_ID = 196379;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196379Service() {
        this(new Idea196379Config());
    }

    public Idea196379Service(Idea196379Config config) {
        this.config = config != null ? config : new Idea196379Config();
