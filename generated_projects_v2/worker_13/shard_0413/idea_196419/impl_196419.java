...
@Data
public class Idea196419Config {
    private String name = "idea_196419";
 ...
 */
@Slf4j
public class Idea196419Service {
    private static final int IDEA_ID = 196419;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196419Service() {
        this(new Idea196419Config());
    }

    public Idea196419Service(Idea196419Config config) {
        this.config = config != null ? config : new Idea196419Config();
