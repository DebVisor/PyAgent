...
@Data
public class Idea196567Config {
    private String name = "idea_196567";
 ...
 */
@Slf4j
public class Idea196567Service {
    private static final int IDEA_ID = 196567;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196567Service() {
        this(new Idea196567Config());
    }

    public Idea196567Service(Idea196567Config config) {
        this.config = config != null ? config : new Idea196567Config();
