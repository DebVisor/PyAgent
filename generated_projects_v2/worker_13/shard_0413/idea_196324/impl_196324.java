...
@Data
public class Idea196324Config {
    private String name = "idea_196324";
 ...
 */
@Slf4j
public class Idea196324Service {
    private static final int IDEA_ID = 196324;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196324Service() {
        this(new Idea196324Config());
    }

    public Idea196324Service(Idea196324Config config) {
        this.config = config != null ? config : new Idea196324Config();
