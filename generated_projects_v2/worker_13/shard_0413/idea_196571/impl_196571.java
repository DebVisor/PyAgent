...
@Data
public class Idea196571Config {
    private String name = "idea_196571";
 ...
 */
@Slf4j
public class Idea196571Service {
    private static final int IDEA_ID = 196571;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196571Service() {
        this(new Idea196571Config());
    }

    public Idea196571Service(Idea196571Config config) {
        this.config = config != null ? config : new Idea196571Config();
