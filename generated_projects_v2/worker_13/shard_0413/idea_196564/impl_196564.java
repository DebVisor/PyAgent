...
@Data
public class Idea196564Config {
    private String name = "idea_196564";
 ...
 */
@Slf4j
public class Idea196564Service {
    private static final int IDEA_ID = 196564;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196564Service() {
        this(new Idea196564Config());
    }

    public Idea196564Service(Idea196564Config config) {
        this.config = config != null ? config : new Idea196564Config();
