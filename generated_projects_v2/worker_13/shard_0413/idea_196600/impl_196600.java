...
@Data
public class Idea196600Config {
    private String name = "idea_196600";
 ...
 */
@Slf4j
public class Idea196600Service {
    private static final int IDEA_ID = 196600;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196600Service() {
        this(new Idea196600Config());
    }

    public Idea196600Service(Idea196600Config config) {
        this.config = config != null ? config : new Idea196600Config();
