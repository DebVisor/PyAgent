...
@Data
public class Idea196383Config {
    private String name = "idea_196383";
 ...
 */
@Slf4j
public class Idea196383Service {
    private static final int IDEA_ID = 196383;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196383Service() {
        this(new Idea196383Config());
    }

    public Idea196383Service(Idea196383Config config) {
        this.config = config != null ? config : new Idea196383Config();
