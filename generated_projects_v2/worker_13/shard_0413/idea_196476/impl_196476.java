...
@Data
public class Idea196476Config {
    private String name = "idea_196476";
 ...
 */
@Slf4j
public class Idea196476Service {
    private static final int IDEA_ID = 196476;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196476Service() {
        this(new Idea196476Config());
    }

    public Idea196476Service(Idea196476Config config) {
        this.config = config != null ? config : new Idea196476Config();
