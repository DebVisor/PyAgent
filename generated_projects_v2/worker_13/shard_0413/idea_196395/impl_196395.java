...
@Data
public class Idea196395Config {
    private String name = "idea_196395";
 ...
 */
@Slf4j
public class Idea196395Service {
    private static final int IDEA_ID = 196395;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196395Service() {
        this(new Idea196395Config());
    }

    public Idea196395Service(Idea196395Config config) {
        this.config = config != null ? config : new Idea196395Config();
