...
@Data
public class Idea196374Config {
    private String name = "idea_196374";
 ...
 */
@Slf4j
public class Idea196374Service {
    private static final int IDEA_ID = 196374;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196374Service() {
        this(new Idea196374Config());
    }

    public Idea196374Service(Idea196374Config config) {
        this.config = config != null ? config : new Idea196374Config();
