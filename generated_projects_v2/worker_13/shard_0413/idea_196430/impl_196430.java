...
@Data
public class Idea196430Config {
    private String name = "idea_196430";
 ...
 */
@Slf4j
public class Idea196430Service {
    private static final int IDEA_ID = 196430;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196430Service() {
        this(new Idea196430Config());
    }

    public Idea196430Service(Idea196430Config config) {
        this.config = config != null ? config : new Idea196430Config();
