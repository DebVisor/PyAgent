...
@Data
public class Idea196415Config {
    private String name = "idea_196415";
 ...
 */
@Slf4j
public class Idea196415Service {
    private static final int IDEA_ID = 196415;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196415Service() {
        this(new Idea196415Config());
    }

    public Idea196415Service(Idea196415Config config) {
        this.config = config != null ? config : new Idea196415Config();
