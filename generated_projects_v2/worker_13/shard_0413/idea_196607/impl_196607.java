...
@Data
public class Idea196607Config {
    private String name = "idea_196607";
 ...
 */
@Slf4j
public class Idea196607Service {
    private static final int IDEA_ID = 196607;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196607Service() {
        this(new Idea196607Config());
    }

    public Idea196607Service(Idea196607Config config) {
        this.config = config != null ? config : new Idea196607Config();
