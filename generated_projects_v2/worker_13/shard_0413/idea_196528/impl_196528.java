...
@Data
public class Idea196528Config {
    private String name = "idea_196528";
 ...
 */
@Slf4j
public class Idea196528Service {
    private static final int IDEA_ID = 196528;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196528Service() {
        this(new Idea196528Config());
    }

    public Idea196528Service(Idea196528Config config) {
        this.config = config != null ? config : new Idea196528Config();
