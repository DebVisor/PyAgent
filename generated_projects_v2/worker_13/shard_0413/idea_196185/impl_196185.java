...
@Data
public class Idea196185Config {
    private String name = "idea_196185";
 ...
 */
@Slf4j
public class Idea196185Service {
    private static final int IDEA_ID = 196185;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196185Service() {
        this(new Idea196185Config());
    }

    public Idea196185Service(Idea196185Config config) {
        this.config = config != null ? config : new Idea196185Config();
