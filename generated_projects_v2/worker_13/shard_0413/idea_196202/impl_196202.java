...
@Data
public class Idea196202Config {
    private String name = "idea_196202";
 ...
 */
@Slf4j
public class Idea196202Service {
    private static final int IDEA_ID = 196202;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196202Service() {
        this(new Idea196202Config());
    }

    public Idea196202Service(Idea196202Config config) {
        this.config = config != null ? config : new Idea196202Config();
