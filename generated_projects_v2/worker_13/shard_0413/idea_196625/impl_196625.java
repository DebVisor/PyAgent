...
@Data
public class Idea196625Config {
    private String name = "idea_196625";
 ...
 */
@Slf4j
public class Idea196625Service {
    private static final int IDEA_ID = 196625;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196625Service() {
        this(new Idea196625Config());
    }

    public Idea196625Service(Idea196625Config config) {
        this.config = config != null ? config : new Idea196625Config();
