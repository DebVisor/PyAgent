...
@Data
public class Idea196348Config {
    private String name = "idea_196348";
 ...
 */
@Slf4j
public class Idea196348Service {
    private static final int IDEA_ID = 196348;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196348Service() {
        this(new Idea196348Config());
    }

    public Idea196348Service(Idea196348Config config) {
        this.config = config != null ? config : new Idea196348Config();
