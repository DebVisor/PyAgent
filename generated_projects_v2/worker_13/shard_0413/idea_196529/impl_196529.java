...
@Data
public class Idea196529Config {
    private String name = "idea_196529";
 ...
 */
@Slf4j
public class Idea196529Service {
    private static final int IDEA_ID = 196529;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196529Service() {
        this(new Idea196529Config());
    }

    public Idea196529Service(Idea196529Config config) {
        this.config = config != null ? config : new Idea196529Config();
