...
@Data
public class Idea196299Config {
    private String name = "idea_196299";
 ...
 */
@Slf4j
public class Idea196299Service {
    private static final int IDEA_ID = 196299;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196299Service() {
        this(new Idea196299Config());
    }

    public Idea196299Service(Idea196299Config config) {
        this.config = config != null ? config : new Idea196299Config();
