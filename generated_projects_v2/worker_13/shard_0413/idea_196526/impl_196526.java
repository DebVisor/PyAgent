...
@Data
public class Idea196526Config {
    private String name = "idea_196526";
 ...
 */
@Slf4j
public class Idea196526Service {
    private static final int IDEA_ID = 196526;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196526Service() {
        this(new Idea196526Config());
    }

    public Idea196526Service(Idea196526Config config) {
        this.config = config != null ? config : new Idea196526Config();
