...
@Data
public class Idea196477Config {
    private String name = "idea_196477";
 ...
 */
@Slf4j
public class Idea196477Service {
    private static final int IDEA_ID = 196477;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196477Service() {
        this(new Idea196477Config());
    }

    public Idea196477Service(Idea196477Config config) {
        this.config = config != null ? config : new Idea196477Config();
