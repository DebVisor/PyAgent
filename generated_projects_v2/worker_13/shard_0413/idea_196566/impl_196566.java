...
@Data
public class Idea196566Config {
    private String name = "idea_196566";
 ...
 */
@Slf4j
public class Idea196566Service {
    private static final int IDEA_ID = 196566;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196566Service() {
        this(new Idea196566Config());
    }

    public Idea196566Service(Idea196566Config config) {
        this.config = config != null ? config : new Idea196566Config();
