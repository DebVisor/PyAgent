...
@Data
public class Idea196357Config {
    private String name = "idea_196357";
 ...
 */
@Slf4j
public class Idea196357Service {
    private static final int IDEA_ID = 196357;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196357Service() {
        this(new Idea196357Config());
    }

    public Idea196357Service(Idea196357Config config) {
        this.config = config != null ? config : new Idea196357Config();
