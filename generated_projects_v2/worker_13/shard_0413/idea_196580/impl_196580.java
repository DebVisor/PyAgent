...
@Data
public class Idea196580Config {
    private String name = "idea_196580";
 ...
 */
@Slf4j
public class Idea196580Service {
    private static final int IDEA_ID = 196580;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196580Service() {
        this(new Idea196580Config());
    }

    public Idea196580Service(Idea196580Config config) {
        this.config = config != null ? config : new Idea196580Config();
