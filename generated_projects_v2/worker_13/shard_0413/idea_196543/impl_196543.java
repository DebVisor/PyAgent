...
@Data
public class Idea196543Config {
    private String name = "idea_196543";
 ...
 */
@Slf4j
public class Idea196543Service {
    private static final int IDEA_ID = 196543;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196543Service() {
        this(new Idea196543Config());
    }

    public Idea196543Service(Idea196543Config config) {
        this.config = config != null ? config : new Idea196543Config();
