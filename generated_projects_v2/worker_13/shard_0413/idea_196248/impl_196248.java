...
@Data
public class Idea196248Config {
    private String name = "idea_196248";
 ...
 */
@Slf4j
public class Idea196248Service {
    private static final int IDEA_ID = 196248;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196248Service() {
        this(new Idea196248Config());
    }

    public Idea196248Service(Idea196248Config config) {
        this.config = config != null ? config : new Idea196248Config();
