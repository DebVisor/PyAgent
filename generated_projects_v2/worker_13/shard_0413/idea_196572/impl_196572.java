...
@Data
public class Idea196572Config {
    private String name = "idea_196572";
 ...
 */
@Slf4j
public class Idea196572Service {
    private static final int IDEA_ID = 196572;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196572Service() {
        this(new Idea196572Config());
    }

    public Idea196572Service(Idea196572Config config) {
        this.config = config != null ? config : new Idea196572Config();
