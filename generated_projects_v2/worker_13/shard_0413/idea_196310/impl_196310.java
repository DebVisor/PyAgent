...
@Data
public class Idea196310Config {
    private String name = "idea_196310";
 ...
 */
@Slf4j
public class Idea196310Service {
    private static final int IDEA_ID = 196310;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196310Service() {
        this(new Idea196310Config());
    }

    public Idea196310Service(Idea196310Config config) {
        this.config = config != null ? config : new Idea196310Config();
