...
@Data
public class Idea196411Config {
    private String name = "idea_196411";
 ...
 */
@Slf4j
public class Idea196411Service {
    private static final int IDEA_ID = 196411;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196411Service() {
        this(new Idea196411Config());
    }

    public Idea196411Service(Idea196411Config config) {
        this.config = config != null ? config : new Idea196411Config();
