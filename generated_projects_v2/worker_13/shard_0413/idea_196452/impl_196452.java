...
@Data
public class Idea196452Config {
    private String name = "idea_196452";
 ...
 */
@Slf4j
public class Idea196452Service {
    private static final int IDEA_ID = 196452;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196452Service() {
        this(new Idea196452Config());
    }

    public Idea196452Service(Idea196452Config config) {
        this.config = config != null ? config : new Idea196452Config();
