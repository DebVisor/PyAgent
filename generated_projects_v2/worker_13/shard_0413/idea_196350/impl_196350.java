...
@Data
public class Idea196350Config {
    private String name = "idea_196350";
 ...
 */
@Slf4j
public class Idea196350Service {
    private static final int IDEA_ID = 196350;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196350Service() {
        this(new Idea196350Config());
    }

    public Idea196350Service(Idea196350Config config) {
        this.config = config != null ? config : new Idea196350Config();
