...
@Data
public class Idea196556Config {
    private String name = "idea_196556";
 ...
 */
@Slf4j
public class Idea196556Service {
    private static final int IDEA_ID = 196556;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196556Service() {
        this(new Idea196556Config());
    }

    public Idea196556Service(Idea196556Config config) {
        this.config = config != null ? config : new Idea196556Config();
