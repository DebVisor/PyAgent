...
@Data
public class Idea196303Config {
    private String name = "idea_196303";
 ...
 */
@Slf4j
public class Idea196303Service {
    private static final int IDEA_ID = 196303;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196303Service() {
        this(new Idea196303Config());
    }

    public Idea196303Service(Idea196303Config config) {
        this.config = config != null ? config : new Idea196303Config();
