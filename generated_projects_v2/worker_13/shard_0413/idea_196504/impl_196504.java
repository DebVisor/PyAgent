...
@Data
public class Idea196504Config {
    private String name = "idea_196504";
 ...
 */
@Slf4j
public class Idea196504Service {
    private static final int IDEA_ID = 196504;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196504Service() {
        this(new Idea196504Config());
    }

    public Idea196504Service(Idea196504Config config) {
        this.config = config != null ? config : new Idea196504Config();
