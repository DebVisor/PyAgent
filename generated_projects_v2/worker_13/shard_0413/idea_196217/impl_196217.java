...
@Data
public class Idea196217Config {
    private String name = "idea_196217";
 ...
 */
@Slf4j
public class Idea196217Service {
    private static final int IDEA_ID = 196217;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196217Service() {
        this(new Idea196217Config());
    }

    public Idea196217Service(Idea196217Config config) {
        this.config = config != null ? config : new Idea196217Config();
