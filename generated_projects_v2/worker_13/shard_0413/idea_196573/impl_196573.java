...
@Data
public class Idea196573Config {
    private String name = "idea_196573";
 ...
 */
@Slf4j
public class Idea196573Service {
    private static final int IDEA_ID = 196573;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196573Service() {
        this(new Idea196573Config());
    }

    public Idea196573Service(Idea196573Config config) {
        this.config = config != null ? config : new Idea196573Config();
