...
@Data
public class Idea196365Config {
    private String name = "idea_196365";
 ...
 */
@Slf4j
public class Idea196365Service {
    private static final int IDEA_ID = 196365;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196365Service() {
        this(new Idea196365Config());
    }

    public Idea196365Service(Idea196365Config config) {
        this.config = config != null ? config : new Idea196365Config();
