...
@Data
public class Idea196509Config {
    private String name = "idea_196509";
 ...
 */
@Slf4j
public class Idea196509Service {
    private static final int IDEA_ID = 196509;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196509Service() {
        this(new Idea196509Config());
    }

    public Idea196509Service(Idea196509Config config) {
        this.config = config != null ? config : new Idea196509Config();
