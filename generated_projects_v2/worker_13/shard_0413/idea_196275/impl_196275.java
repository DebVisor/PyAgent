...
@Data
public class Idea196275Config {
    private String name = "idea_196275";
 ...
 */
@Slf4j
public class Idea196275Service {
    private static final int IDEA_ID = 196275;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196275Service() {
        this(new Idea196275Config());
    }

    public Idea196275Service(Idea196275Config config) {
        this.config = config != null ? config : new Idea196275Config();
