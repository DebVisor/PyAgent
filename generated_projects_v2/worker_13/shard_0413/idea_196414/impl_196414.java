...
@Data
public class Idea196414Config {
    private String name = "idea_196414";
 ...
 */
@Slf4j
public class Idea196414Service {
    private static final int IDEA_ID = 196414;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196414Service() {
        this(new Idea196414Config());
    }

    public Idea196414Service(Idea196414Config config) {
        this.config = config != null ? config : new Idea196414Config();
