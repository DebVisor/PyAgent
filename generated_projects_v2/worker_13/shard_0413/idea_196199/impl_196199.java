...
@Data
public class Idea196199Config {
    private String name = "idea_196199";
 ...
 */
@Slf4j
public class Idea196199Service {
    private static final int IDEA_ID = 196199;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196199Service() {
        this(new Idea196199Config());
    }

    public Idea196199Service(Idea196199Config config) {
        this.config = config != null ? config : new Idea196199Config();
