...
@Data
public class Idea196330Config {
    private String name = "idea_196330";
 ...
 */
@Slf4j
public class Idea196330Service {
    private static final int IDEA_ID = 196330;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196330Service() {
        this(new Idea196330Config());
    }

    public Idea196330Service(Idea196330Config config) {
        this.config = config != null ? config : new Idea196330Config();
