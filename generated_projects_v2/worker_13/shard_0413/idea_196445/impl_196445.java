...
@Data
public class Idea196445Config {
    private String name = "idea_196445";
 ...
 */
@Slf4j
public class Idea196445Service {
    private static final int IDEA_ID = 196445;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196445Service() {
        this(new Idea196445Config());
    }

    public Idea196445Service(Idea196445Config config) {
        this.config = config != null ? config : new Idea196445Config();
