...
@Data
public class Idea196459Config {
    private String name = "idea_196459";
 ...
 */
@Slf4j
public class Idea196459Service {
    private static final int IDEA_ID = 196459;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196459Service() {
        this(new Idea196459Config());
    }

    public Idea196459Service(Idea196459Config config) {
        this.config = config != null ? config : new Idea196459Config();
