...
@Data
public class Idea196219Config {
    private String name = "idea_196219";
 ...
 */
@Slf4j
public class Idea196219Service {
    private static final int IDEA_ID = 196219;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196219Service() {
        this(new Idea196219Config());
    }

    public Idea196219Service(Idea196219Config config) {
        this.config = config != null ? config : new Idea196219Config();
