...
@Data
public class Idea196399Config {
    private String name = "idea_196399";
 ...
 */
@Slf4j
public class Idea196399Service {
    private static final int IDEA_ID = 196399;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196399Service() {
        this(new Idea196399Config());
    }

    public Idea196399Service(Idea196399Config config) {
        this.config = config != null ? config : new Idea196399Config();
