...
@Data
public class Idea196313Config {
    private String name = "idea_196313";
 ...
 */
@Slf4j
public class Idea196313Service {
    private static final int IDEA_ID = 196313;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196313Service() {
        this(new Idea196313Config());
    }

    public Idea196313Service(Idea196313Config config) {
        this.config = config != null ? config : new Idea196313Config();
