...
@Data
public class Idea196265Config {
    private String name = "idea_196265";
 ...
 */
@Slf4j
public class Idea196265Service {
    private static final int IDEA_ID = 196265;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196265Service() {
        this(new Idea196265Config());
    }

    public Idea196265Service(Idea196265Config config) {
        this.config = config != null ? config : new Idea196265Config();
