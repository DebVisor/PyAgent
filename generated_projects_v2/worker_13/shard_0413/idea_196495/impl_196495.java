...
@Data
public class Idea196495Config {
    private String name = "idea_196495";
 ...
 */
@Slf4j
public class Idea196495Service {
    private static final int IDEA_ID = 196495;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196495Service() {
        this(new Idea196495Config());
    }

    public Idea196495Service(Idea196495Config config) {
        this.config = config != null ? config : new Idea196495Config();
