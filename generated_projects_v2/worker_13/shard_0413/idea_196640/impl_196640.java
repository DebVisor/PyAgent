...
@Data
public class Idea196640Config {
    private String name = "idea_196640";
 ...
 */
@Slf4j
public class Idea196640Service {
    private static final int IDEA_ID = 196640;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196640Service() {
        this(new Idea196640Config());
    }

    public Idea196640Service(Idea196640Config config) {
        this.config = config != null ? config : new Idea196640Config();
