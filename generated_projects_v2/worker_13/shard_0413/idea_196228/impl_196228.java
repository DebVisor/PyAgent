...
@Data
public class Idea196228Config {
    private String name = "idea_196228";
 ...
 */
@Slf4j
public class Idea196228Service {
    private static final int IDEA_ID = 196228;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196228Service() {
        this(new Idea196228Config());
    }

    public Idea196228Service(Idea196228Config config) {
        this.config = config != null ? config : new Idea196228Config();
