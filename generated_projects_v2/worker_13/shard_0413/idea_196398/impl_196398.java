...
@Data
public class Idea196398Config {
    private String name = "idea_196398";
 ...
 */
@Slf4j
public class Idea196398Service {
    private static final int IDEA_ID = 196398;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196398Service() {
        this(new Idea196398Config());
    }

    public Idea196398Service(Idea196398Config config) {
        this.config = config != null ? config : new Idea196398Config();
