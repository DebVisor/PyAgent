...
@Data
public class Idea196271Config {
    private String name = "idea_196271";
 ...
 */
@Slf4j
public class Idea196271Service {
    private static final int IDEA_ID = 196271;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196271Service() {
        this(new Idea196271Config());
    }

    public Idea196271Service(Idea196271Config config) {
        this.config = config != null ? config : new Idea196271Config();
