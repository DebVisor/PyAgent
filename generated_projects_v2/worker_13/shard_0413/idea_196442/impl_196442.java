...
@Data
public class Idea196442Config {
    private String name = "idea_196442";
 ...
 */
@Slf4j
public class Idea196442Service {
    private static final int IDEA_ID = 196442;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196442Service() {
        this(new Idea196442Config());
    }

    public Idea196442Service(Idea196442Config config) {
        this.config = config != null ? config : new Idea196442Config();
