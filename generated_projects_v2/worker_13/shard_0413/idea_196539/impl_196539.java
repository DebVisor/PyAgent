...
@Data
public class Idea196539Config {
    private String name = "idea_196539";
 ...
 */
@Slf4j
public class Idea196539Service {
    private static final int IDEA_ID = 196539;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196539Service() {
        this(new Idea196539Config());
    }

    public Idea196539Service(Idea196539Config config) {
        this.config = config != null ? config : new Idea196539Config();
