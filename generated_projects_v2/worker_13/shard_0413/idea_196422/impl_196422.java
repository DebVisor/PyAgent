...
@Data
public class Idea196422Config {
    private String name = "idea_196422";
 ...
 */
@Slf4j
public class Idea196422Service {
    private static final int IDEA_ID = 196422;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196422Service() {
        this(new Idea196422Config());
    }

    public Idea196422Service(Idea196422Config config) {
        this.config = config != null ? config : new Idea196422Config();
