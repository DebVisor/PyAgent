...
@Data
public class Idea196332Config {
    private String name = "idea_196332";
 ...
 */
@Slf4j
public class Idea196332Service {
    private static final int IDEA_ID = 196332;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196332Service() {
        this(new Idea196332Config());
    }

    public Idea196332Service(Idea196332Config config) {
        this.config = config != null ? config : new Idea196332Config();
