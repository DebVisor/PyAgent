...
@Data
public class Idea196326Config {
    private String name = "idea_196326";
 ...
 */
@Slf4j
public class Idea196326Service {
    private static final int IDEA_ID = 196326;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196326Service() {
        this(new Idea196326Config());
    }

    public Idea196326Service(Idea196326Config config) {
        this.config = config != null ? config : new Idea196326Config();
