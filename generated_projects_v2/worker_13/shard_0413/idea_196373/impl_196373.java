...
@Data
public class Idea196373Config {
    private String name = "idea_196373";
 ...
 */
@Slf4j
public class Idea196373Service {
    private static final int IDEA_ID = 196373;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196373Service() {
        this(new Idea196373Config());
    }

    public Idea196373Service(Idea196373Config config) {
        this.config = config != null ? config : new Idea196373Config();
