...
@Data
public class Idea196389Config {
    private String name = "idea_196389";
 ...
 */
@Slf4j
public class Idea196389Service {
    private static final int IDEA_ID = 196389;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196389Service() {
        this(new Idea196389Config());
    }

    public Idea196389Service(Idea196389Config config) {
        this.config = config != null ? config : new Idea196389Config();
