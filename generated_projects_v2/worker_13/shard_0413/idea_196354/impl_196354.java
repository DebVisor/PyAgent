...
@Data
public class Idea196354Config {
    private String name = "idea_196354";
 ...
 */
@Slf4j
public class Idea196354Service {
    private static final int IDEA_ID = 196354;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196354Service() {
        this(new Idea196354Config());
    }

    public Idea196354Service(Idea196354Config config) {
        this.config = config != null ? config : new Idea196354Config();
