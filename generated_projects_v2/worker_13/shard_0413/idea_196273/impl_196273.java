...
@Data
public class Idea196273Config {
    private String name = "idea_196273";
 ...
 */
@Slf4j
public class Idea196273Service {
    private static final int IDEA_ID = 196273;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196273Service() {
        this(new Idea196273Config());
    }

    public Idea196273Service(Idea196273Config config) {
        this.config = config != null ? config : new Idea196273Config();
