...
@Data
public class Idea196563Config {
    private String name = "idea_196563";
 ...
 */
@Slf4j
public class Idea196563Service {
    private static final int IDEA_ID = 196563;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196563Service() {
        this(new Idea196563Config());
    }

    public Idea196563Service(Idea196563Config config) {
        this.config = config != null ? config : new Idea196563Config();
