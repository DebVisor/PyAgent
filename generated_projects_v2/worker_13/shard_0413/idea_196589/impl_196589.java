...
@Data
public class Idea196589Config {
    private String name = "idea_196589";
 ...
 */
@Slf4j
public class Idea196589Service {
    private static final int IDEA_ID = 196589;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196589Service() {
        this(new Idea196589Config());
    }

    public Idea196589Service(Idea196589Config config) {
        this.config = config != null ? config : new Idea196589Config();
