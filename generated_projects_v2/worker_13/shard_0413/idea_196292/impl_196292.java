...
@Data
public class Idea196292Config {
    private String name = "idea_196292";
 ...
 */
@Slf4j
public class Idea196292Service {
    private static final int IDEA_ID = 196292;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196292Service() {
        this(new Idea196292Config());
    }

    public Idea196292Service(Idea196292Config config) {
        this.config = config != null ? config : new Idea196292Config();
