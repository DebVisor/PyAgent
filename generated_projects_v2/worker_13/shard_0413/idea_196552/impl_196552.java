...
@Data
public class Idea196552Config {
    private String name = "idea_196552";
 ...
 */
@Slf4j
public class Idea196552Service {
    private static final int IDEA_ID = 196552;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196552Service() {
        this(new Idea196552Config());
    }

    public Idea196552Service(Idea196552Config config) {
        this.config = config != null ? config : new Idea196552Config();
