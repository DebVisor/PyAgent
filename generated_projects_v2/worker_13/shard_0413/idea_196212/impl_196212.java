...
@Data
public class Idea196212Config {
    private String name = "idea_196212";
 ...
 */
@Slf4j
public class Idea196212Service {
    private static final int IDEA_ID = 196212;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196212Service() {
        this(new Idea196212Config());
    }

    public Idea196212Service(Idea196212Config config) {
        this.config = config != null ? config : new Idea196212Config();
