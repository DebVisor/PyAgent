...
@Data
public class Idea196227Config {
    private String name = "idea_196227";
 ...
 */
@Slf4j
public class Idea196227Service {
    private static final int IDEA_ID = 196227;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196227Service() {
        this(new Idea196227Config());
    }

    public Idea196227Service(Idea196227Config config) {
        this.config = config != null ? config : new Idea196227Config();
