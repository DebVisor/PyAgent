...
@Data
public class Idea196377Config {
    private String name = "idea_196377";
 ...
 */
@Slf4j
public class Idea196377Service {
    private static final int IDEA_ID = 196377;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196377Service() {
        this(new Idea196377Config());
    }

    public Idea196377Service(Idea196377Config config) {
        this.config = config != null ? config : new Idea196377Config();
