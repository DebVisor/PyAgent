...
@Data
public class Idea196565Config {
    private String name = "idea_196565";
 ...
 */
@Slf4j
public class Idea196565Service {
    private static final int IDEA_ID = 196565;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196565Service() {
        this(new Idea196565Config());
    }

    public Idea196565Service(Idea196565Config config) {
        this.config = config != null ? config : new Idea196565Config();
