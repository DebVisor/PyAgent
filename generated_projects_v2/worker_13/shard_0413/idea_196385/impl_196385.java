...
@Data
public class Idea196385Config {
    private String name = "idea_196385";
 ...
 */
@Slf4j
public class Idea196385Service {
    private static final int IDEA_ID = 196385;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196385Service() {
        this(new Idea196385Config());
    }

    public Idea196385Service(Idea196385Config config) {
        this.config = config != null ? config : new Idea196385Config();
