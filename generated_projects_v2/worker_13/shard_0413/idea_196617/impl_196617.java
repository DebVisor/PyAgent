...
@Data
public class Idea196617Config {
    private String name = "idea_196617";
 ...
 */
@Slf4j
public class Idea196617Service {
    private static final int IDEA_ID = 196617;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196617Service() {
        this(new Idea196617Config());
    }

    public Idea196617Service(Idea196617Config config) {
        this.config = config != null ? config : new Idea196617Config();
