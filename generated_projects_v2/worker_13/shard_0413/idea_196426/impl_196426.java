...
@Data
public class Idea196426Config {
    private String name = "idea_196426";
 ...
 */
@Slf4j
public class Idea196426Service {
    private static final int IDEA_ID = 196426;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196426Service() {
        this(new Idea196426Config());
    }

    public Idea196426Service(Idea196426Config config) {
        this.config = config != null ? config : new Idea196426Config();
