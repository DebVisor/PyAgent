...
@Data
public class Idea196496Config {
    private String name = "idea_196496";
 ...
 */
@Slf4j
public class Idea196496Service {
    private static final int IDEA_ID = 196496;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196496Service() {
        this(new Idea196496Config());
    }

    public Idea196496Service(Idea196496Config config) {
        this.config = config != null ? config : new Idea196496Config();
