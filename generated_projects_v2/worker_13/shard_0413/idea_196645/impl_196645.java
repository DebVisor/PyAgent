...
@Data
public class Idea196645Config {
    private String name = "idea_196645";
 ...
 */
@Slf4j
public class Idea196645Service {
    private static final int IDEA_ID = 196645;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196645Service() {
        this(new Idea196645Config());
    }

    public Idea196645Service(Idea196645Config config) {
        this.config = config != null ? config : new Idea196645Config();
