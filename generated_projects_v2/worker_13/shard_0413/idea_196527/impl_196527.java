...
@Data
public class Idea196527Config {
    private String name = "idea_196527";
 ...
 */
@Slf4j
public class Idea196527Service {
    private static final int IDEA_ID = 196527;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196527Service() {
        this(new Idea196527Config());
    }

    public Idea196527Service(Idea196527Config config) {
        this.config = config != null ? config : new Idea196527Config();
