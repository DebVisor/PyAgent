...
@Data
public class Idea196470Config {
    private String name = "idea_196470";
 ...
 */
@Slf4j
public class Idea196470Service {
    private static final int IDEA_ID = 196470;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196470Service() {
        this(new Idea196470Config());
    }

    public Idea196470Service(Idea196470Config config) {
        this.config = config != null ? config : new Idea196470Config();
