...
@Data
public class Idea196468Config {
    private String name = "idea_196468";
 ...
 */
@Slf4j
public class Idea196468Service {
    private static final int IDEA_ID = 196468;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196468Service() {
        this(new Idea196468Config());
    }

    public Idea196468Service(Idea196468Config config) {
        this.config = config != null ? config : new Idea196468Config();
