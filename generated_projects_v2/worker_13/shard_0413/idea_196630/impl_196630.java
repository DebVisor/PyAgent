...
@Data
public class Idea196630Config {
    private String name = "idea_196630";
 ...
 */
@Slf4j
public class Idea196630Service {
    private static final int IDEA_ID = 196630;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196630Service() {
        this(new Idea196630Config());
    }

    public Idea196630Service(Idea196630Config config) {
        this.config = config != null ? config : new Idea196630Config();
