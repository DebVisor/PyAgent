...
@Data
public class Idea196455Config {
    private String name = "idea_196455";
 ...
 */
@Slf4j
public class Idea196455Service {
    private static final int IDEA_ID = 196455;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196455Service() {
        this(new Idea196455Config());
    }

    public Idea196455Service(Idea196455Config config) {
        this.config = config != null ? config : new Idea196455Config();
