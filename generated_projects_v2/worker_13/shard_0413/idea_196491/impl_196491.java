...
@Data
public class Idea196491Config {
    private String name = "idea_196491";
 ...
 */
@Slf4j
public class Idea196491Service {
    private static final int IDEA_ID = 196491;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196491Service() {
        this(new Idea196491Config());
    }

    public Idea196491Service(Idea196491Config config) {
        this.config = config != null ? config : new Idea196491Config();
