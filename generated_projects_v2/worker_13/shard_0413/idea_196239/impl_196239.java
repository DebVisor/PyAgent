...
@Data
public class Idea196239Config {
    private String name = "idea_196239";
 ...
 */
@Slf4j
public class Idea196239Service {
    private static final int IDEA_ID = 196239;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196239Service() {
        this(new Idea196239Config());
    }

    public Idea196239Service(Idea196239Config config) {
        this.config = config != null ? config : new Idea196239Config();
