...
@Data
public class Idea196500Config {
    private String name = "idea_196500";
 ...
 */
@Slf4j
public class Idea196500Service {
    private static final int IDEA_ID = 196500;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196500Service() {
        this(new Idea196500Config());
    }

    public Idea196500Service(Idea196500Config config) {
        this.config = config != null ? config : new Idea196500Config();
