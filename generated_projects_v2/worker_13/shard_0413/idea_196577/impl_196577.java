...
@Data
public class Idea196577Config {
    private String name = "idea_196577";
 ...
 */
@Slf4j
public class Idea196577Service {
    private static final int IDEA_ID = 196577;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196577Service() {
        this(new Idea196577Config());
    }

    public Idea196577Service(Idea196577Config config) {
        this.config = config != null ? config : new Idea196577Config();
