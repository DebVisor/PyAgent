...
@Data
public class Idea196582Config {
    private String name = "idea_196582";
 ...
 */
@Slf4j
public class Idea196582Service {
    private static final int IDEA_ID = 196582;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196582Service() {
        this(new Idea196582Config());
    }

    public Idea196582Service(Idea196582Config config) {
        this.config = config != null ? config : new Idea196582Config();
