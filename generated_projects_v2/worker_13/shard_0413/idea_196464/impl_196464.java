...
@Data
public class Idea196464Config {
    private String name = "idea_196464";
 ...
 */
@Slf4j
public class Idea196464Service {
    private static final int IDEA_ID = 196464;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196464Service() {
        this(new Idea196464Config());
    }

    public Idea196464Service(Idea196464Config config) {
        this.config = config != null ? config : new Idea196464Config();
