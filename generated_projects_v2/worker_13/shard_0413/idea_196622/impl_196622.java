...
@Data
public class Idea196622Config {
    private String name = "idea_196622";
 ...
 */
@Slf4j
public class Idea196622Service {
    private static final int IDEA_ID = 196622;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196622Service() {
        this(new Idea196622Config());
    }

    public Idea196622Service(Idea196622Config config) {
        this.config = config != null ? config : new Idea196622Config();
