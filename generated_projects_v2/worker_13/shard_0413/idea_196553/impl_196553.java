...
@Data
public class Idea196553Config {
    private String name = "idea_196553";
 ...
 */
@Slf4j
public class Idea196553Service {
    private static final int IDEA_ID = 196553;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196553Service() {
        this(new Idea196553Config());
    }

    public Idea196553Service(Idea196553Config config) {
        this.config = config != null ? config : new Idea196553Config();
