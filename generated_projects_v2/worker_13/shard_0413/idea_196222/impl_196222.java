...
@Data
public class Idea196222Config {
    private String name = "idea_196222";
 ...
 */
@Slf4j
public class Idea196222Service {
    private static final int IDEA_ID = 196222;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196222Service() {
        this(new Idea196222Config());
    }

    public Idea196222Service(Idea196222Config config) {
        this.config = config != null ? config : new Idea196222Config();
