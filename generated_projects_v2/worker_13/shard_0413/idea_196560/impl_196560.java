...
@Data
public class Idea196560Config {
    private String name = "idea_196560";
 ...
 */
@Slf4j
public class Idea196560Service {
    private static final int IDEA_ID = 196560;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196560Service() {
        this(new Idea196560Config());
    }

    public Idea196560Service(Idea196560Config config) {
        this.config = config != null ? config : new Idea196560Config();
