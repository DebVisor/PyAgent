...
@Data
public class Idea196220Config {
    private String name = "idea_196220";
 ...
 */
@Slf4j
public class Idea196220Service {
    private static final int IDEA_ID = 196220;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196220Service() {
        this(new Idea196220Config());
    }

    public Idea196220Service(Idea196220Config config) {
        this.config = config != null ? config : new Idea196220Config();
