...
@Data
public class Idea196368Config {
    private String name = "idea_196368";
 ...
 */
@Slf4j
public class Idea196368Service {
    private static final int IDEA_ID = 196368;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196368Service() {
        this(new Idea196368Config());
    }

    public Idea196368Service(Idea196368Config config) {
        this.config = config != null ? config : new Idea196368Config();
