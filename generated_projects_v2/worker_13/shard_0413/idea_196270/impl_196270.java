...
@Data
public class Idea196270Config {
    private String name = "idea_196270";
 ...
 */
@Slf4j
public class Idea196270Service {
    private static final int IDEA_ID = 196270;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196270Service() {
        this(new Idea196270Config());
    }

    public Idea196270Service(Idea196270Config config) {
        this.config = config != null ? config : new Idea196270Config();
