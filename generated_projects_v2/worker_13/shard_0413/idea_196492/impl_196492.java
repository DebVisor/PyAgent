...
@Data
public class Idea196492Config {
    private String name = "idea_196492";
 ...
 */
@Slf4j
public class Idea196492Service {
    private static final int IDEA_ID = 196492;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196492Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196492Service() {
        this(new Idea196492Config());
    }

    public Idea196492Service(Idea196492Config config) {
        this.config = config != null ? config : new Idea196492Config();
