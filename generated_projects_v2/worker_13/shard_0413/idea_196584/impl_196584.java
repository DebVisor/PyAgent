...
@Data
public class Idea196584Config {
    private String name = "idea_196584";
 ...
 */
@Slf4j
public class Idea196584Service {
    private static final int IDEA_ID = 196584;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196584Service() {
        this(new Idea196584Config());
    }

    public Idea196584Service(Idea196584Config config) {
        this.config = config != null ? config : new Idea196584Config();
