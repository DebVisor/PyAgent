...
@Data
public class Idea196627Config {
    private String name = "idea_196627";
 ...
 */
@Slf4j
public class Idea196627Service {
    private static final int IDEA_ID = 196627;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196627Service() {
        this(new Idea196627Config());
    }

    public Idea196627Service(Idea196627Config config) {
        this.config = config != null ? config : new Idea196627Config();
