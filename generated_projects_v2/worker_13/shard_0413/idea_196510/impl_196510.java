...
@Data
public class Idea196510Config {
    private String name = "idea_196510";
 ...
 */
@Slf4j
public class Idea196510Service {
    private static final int IDEA_ID = 196510;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196510Service() {
        this(new Idea196510Config());
    }

    public Idea196510Service(Idea196510Config config) {
        this.config = config != null ? config : new Idea196510Config();
