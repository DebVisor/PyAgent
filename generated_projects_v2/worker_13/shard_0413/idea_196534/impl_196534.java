...
@Data
public class Idea196534Config {
    private String name = "idea_196534";
 ...
 */
@Slf4j
public class Idea196534Service {
    private static final int IDEA_ID = 196534;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196534Service() {
        this(new Idea196534Config());
    }

    public Idea196534Service(Idea196534Config config) {
        this.config = config != null ? config : new Idea196534Config();
