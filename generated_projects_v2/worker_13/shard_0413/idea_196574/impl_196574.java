...
@Data
public class Idea196574Config {
    private String name = "idea_196574";
 ...
 */
@Slf4j
public class Idea196574Service {
    private static final int IDEA_ID = 196574;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196574Service() {
        this(new Idea196574Config());
    }

    public Idea196574Service(Idea196574Config config) {
        this.config = config != null ? config : new Idea196574Config();
