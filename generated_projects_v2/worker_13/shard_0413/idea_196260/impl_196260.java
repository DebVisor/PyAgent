...
@Data
public class Idea196260Config {
    private String name = "idea_196260";
 ...
 */
@Slf4j
public class Idea196260Service {
    private static final int IDEA_ID = 196260;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196260Service() {
        this(new Idea196260Config());
    }

    public Idea196260Service(Idea196260Config config) {
        this.config = config != null ? config : new Idea196260Config();
