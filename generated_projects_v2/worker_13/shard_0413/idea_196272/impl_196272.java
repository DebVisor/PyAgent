...
@Data
public class Idea196272Config {
    private String name = "idea_196272";
 ...
 */
@Slf4j
public class Idea196272Service {
    private static final int IDEA_ID = 196272;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196272Service() {
        this(new Idea196272Config());
    }

    public Idea196272Service(Idea196272Config config) {
        this.config = config != null ? config : new Idea196272Config();
