...
@Data
public class Idea196649Config {
    private String name = "idea_196649";
 ...
 */
@Slf4j
public class Idea196649Service {
    private static final int IDEA_ID = 196649;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196649Service() {
        this(new Idea196649Config());
    }

    public Idea196649Service(Idea196649Config config) {
        this.config = config != null ? config : new Idea196649Config();
