...
@Data
public class Idea196636Config {
    private String name = "idea_196636";
 ...
 */
@Slf4j
public class Idea196636Service {
    private static final int IDEA_ID = 196636;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196636Service() {
        this(new Idea196636Config());
    }

    public Idea196636Service(Idea196636Config config) {
        this.config = config != null ? config : new Idea196636Config();
