...
@Data
public class Idea196469Config {
    private String name = "idea_196469";
 ...
 */
@Slf4j
public class Idea196469Service {
    private static final int IDEA_ID = 196469;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196469Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196469Service() {
        this(new Idea196469Config());
    }

    public Idea196469Service(Idea196469Config config) {
        this.config = config != null ? config : new Idea196469Config();
