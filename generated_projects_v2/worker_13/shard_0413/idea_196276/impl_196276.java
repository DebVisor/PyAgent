...
@Data
public class Idea196276Config {
    private String name = "idea_196276";
 ...
 */
@Slf4j
public class Idea196276Service {
    private static final int IDEA_ID = 196276;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196276Service() {
        this(new Idea196276Config());
    }

    public Idea196276Service(Idea196276Config config) {
        this.config = config != null ? config : new Idea196276Config();
