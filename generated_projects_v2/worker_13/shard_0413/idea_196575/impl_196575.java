...
@Data
public class Idea196575Config {
    private String name = "idea_196575";
 ...
 */
@Slf4j
public class Idea196575Service {
    private static final int IDEA_ID = 196575;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196575Service() {
        this(new Idea196575Config());
    }

    public Idea196575Service(Idea196575Config config) {
        this.config = config != null ? config : new Idea196575Config();
