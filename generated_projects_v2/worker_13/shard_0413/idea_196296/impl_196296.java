...
@Data
public class Idea196296Config {
    private String name = "idea_196296";
 ...
 */
@Slf4j
public class Idea196296Service {
    private static final int IDEA_ID = 196296;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196296Service() {
        this(new Idea196296Config());
    }

    public Idea196296Service(Idea196296Config config) {
        this.config = config != null ? config : new Idea196296Config();
