...
@Data
public class Idea196463Config {
    private String name = "idea_196463";
 ...
 */
@Slf4j
public class Idea196463Service {
    private static final int IDEA_ID = 196463;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196463Service() {
        this(new Idea196463Config());
    }

    public Idea196463Service(Idea196463Config config) {
        this.config = config != null ? config : new Idea196463Config();
