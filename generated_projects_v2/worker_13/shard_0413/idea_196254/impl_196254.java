...
@Data
public class Idea196254Config {
    private String name = "idea_196254";
 ...
 */
@Slf4j
public class Idea196254Service {
    private static final int IDEA_ID = 196254;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196254Service() {
        this(new Idea196254Config());
    }

    public Idea196254Service(Idea196254Config config) {
        this.config = config != null ? config : new Idea196254Config();
