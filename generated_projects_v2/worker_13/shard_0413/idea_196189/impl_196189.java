...
@Data
public class Idea196189Config {
    private String name = "idea_196189";
 ...
 */
@Slf4j
public class Idea196189Service {
    private static final int IDEA_ID = 196189;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196189Service() {
        this(new Idea196189Config());
    }

    public Idea196189Service(Idea196189Config config) {
        this.config = config != null ? config : new Idea196189Config();
