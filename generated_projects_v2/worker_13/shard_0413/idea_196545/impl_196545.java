...
@Data
public class Idea196545Config {
    private String name = "idea_196545";
 ...
 */
@Slf4j
public class Idea196545Service {
    private static final int IDEA_ID = 196545;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196545Service() {
        this(new Idea196545Config());
    }

    public Idea196545Service(Idea196545Config config) {
        this.config = config != null ? config : new Idea196545Config();
