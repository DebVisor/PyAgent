...
@Data
public class Idea196611Config {
    private String name = "idea_196611";
 ...
 */
@Slf4j
public class Idea196611Service {
    private static final int IDEA_ID = 196611;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196611Service() {
        this(new Idea196611Config());
    }

    public Idea196611Service(Idea196611Config config) {
        this.config = config != null ? config : new Idea196611Config();
