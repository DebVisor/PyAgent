...
@Data
public class Idea196370Config {
    private String name = "idea_196370";
 ...
 */
@Slf4j
public class Idea196370Service {
    private static final int IDEA_ID = 196370;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196370Service() {
        this(new Idea196370Config());
    }

    public Idea196370Service(Idea196370Config config) {
        this.config = config != null ? config : new Idea196370Config();
