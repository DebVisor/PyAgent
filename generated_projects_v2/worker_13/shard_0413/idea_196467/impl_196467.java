...
@Data
public class Idea196467Config {
    private String name = "idea_196467";
 ...
 */
@Slf4j
public class Idea196467Service {
    private static final int IDEA_ID = 196467;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196467Service() {
        this(new Idea196467Config());
    }

    public Idea196467Service(Idea196467Config config) {
        this.config = config != null ? config : new Idea196467Config();
