...
@Data
public class Idea196341Config {
    private String name = "idea_196341";
 ...
 */
@Slf4j
public class Idea196341Service {
    private static final int IDEA_ID = 196341;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196341Service() {
        this(new Idea196341Config());
    }

    public Idea196341Service(Idea196341Config config) {
        this.config = config != null ? config : new Idea196341Config();
