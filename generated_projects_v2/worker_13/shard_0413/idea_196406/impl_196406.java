...
@Data
public class Idea196406Config {
    private String name = "idea_196406";
 ...
 */
@Slf4j
public class Idea196406Service {
    private static final int IDEA_ID = 196406;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196406Service() {
        this(new Idea196406Config());
    }

    public Idea196406Service(Idea196406Config config) {
        this.config = config != null ? config : new Idea196406Config();
