...
@Data
public class Idea196616Config {
    private String name = "idea_196616";
 ...
 */
@Slf4j
public class Idea196616Service {
    private static final int IDEA_ID = 196616;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196616Service() {
        this(new Idea196616Config());
    }

    public Idea196616Service(Idea196616Config config) {
        this.config = config != null ? config : new Idea196616Config();
