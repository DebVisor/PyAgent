...
@Data
public class Idea196211Config {
    private String name = "idea_196211";
 ...
 */
@Slf4j
public class Idea196211Service {
    private static final int IDEA_ID = 196211;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196211Service() {
        this(new Idea196211Config());
    }

    public Idea196211Service(Idea196211Config config) {
        this.config = config != null ? config : new Idea196211Config();
