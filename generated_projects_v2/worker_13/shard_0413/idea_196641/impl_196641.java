...
@Data
public class Idea196641Config {
    private String name = "idea_196641";
 ...
 */
@Slf4j
public class Idea196641Service {
    private static final int IDEA_ID = 196641;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196641Service() {
        this(new Idea196641Config());
    }

    public Idea196641Service(Idea196641Config config) {
        this.config = config != null ? config : new Idea196641Config();
