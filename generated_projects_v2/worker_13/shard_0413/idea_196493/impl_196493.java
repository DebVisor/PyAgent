...
@Data
public class Idea196493Config {
    private String name = "idea_196493";
 ...
 */
@Slf4j
public class Idea196493Service {
    private static final int IDEA_ID = 196493;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196493Service() {
        this(new Idea196493Config());
    }

    public Idea196493Service(Idea196493Config config) {
        this.config = config != null ? config : new Idea196493Config();
