...
@Data
public class Idea196229Config {
    private String name = "idea_196229";
 ...
 */
@Slf4j
public class Idea196229Service {
    private static final int IDEA_ID = 196229;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196229Service() {
        this(new Idea196229Config());
    }

    public Idea196229Service(Idea196229Config config) {
        this.config = config != null ? config : new Idea196229Config();
