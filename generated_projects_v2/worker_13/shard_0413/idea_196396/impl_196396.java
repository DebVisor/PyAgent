...
@Data
public class Idea196396Config {
    private String name = "idea_196396";
 ...
 */
@Slf4j
public class Idea196396Service {
    private static final int IDEA_ID = 196396;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196396Service() {
        this(new Idea196396Config());
    }

    public Idea196396Service(Idea196396Config config) {
        this.config = config != null ? config : new Idea196396Config();
