...
@Data
public class Idea196280Config {
    private String name = "idea_196280";
 ...
 */
@Slf4j
public class Idea196280Service {
    private static final int IDEA_ID = 196280;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196280Service() {
        this(new Idea196280Config());
    }

    public Idea196280Service(Idea196280Config config) {
        this.config = config != null ? config : new Idea196280Config();
