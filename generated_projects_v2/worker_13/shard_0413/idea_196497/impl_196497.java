...
@Data
public class Idea196497Config {
    private String name = "idea_196497";
 ...
 */
@Slf4j
public class Idea196497Service {
    private static final int IDEA_ID = 196497;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196497Service() {
        this(new Idea196497Config());
    }

    public Idea196497Service(Idea196497Config config) {
        this.config = config != null ? config : new Idea196497Config();
