...
@Data
public class Idea196586Config {
    private String name = "idea_196586";
 ...
 */
@Slf4j
public class Idea196586Service {
    private static final int IDEA_ID = 196586;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196586Service() {
        this(new Idea196586Config());
    }

    public Idea196586Service(Idea196586Config config) {
        this.config = config != null ? config : new Idea196586Config();
