...
@Data
public class Idea196530Config {
    private String name = "idea_196530";
 ...
 */
@Slf4j
public class Idea196530Service {
    private static final int IDEA_ID = 196530;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196530Service() {
        this(new Idea196530Config());
    }

    public Idea196530Service(Idea196530Config config) {
        this.config = config != null ? config : new Idea196530Config();
