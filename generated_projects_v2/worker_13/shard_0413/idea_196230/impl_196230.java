...
@Data
public class Idea196230Config {
    private String name = "idea_196230";
 ...
 */
@Slf4j
public class Idea196230Service {
    private static final int IDEA_ID = 196230;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196230Service() {
        this(new Idea196230Config());
    }

    public Idea196230Service(Idea196230Config config) {
        this.config = config != null ? config : new Idea196230Config();
