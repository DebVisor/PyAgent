...
@Data
public class Idea196387Config {
    private String name = "idea_196387";
 ...
 */
@Slf4j
public class Idea196387Service {
    private static final int IDEA_ID = 196387;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196387Service() {
        this(new Idea196387Config());
    }

    public Idea196387Service(Idea196387Config config) {
        this.config = config != null ? config : new Idea196387Config();
