...
@Data
public class Idea196318Config {
    private String name = "idea_196318";
 ...
 */
@Slf4j
public class Idea196318Service {
    private static final int IDEA_ID = 196318;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196318Service() {
        this(new Idea196318Config());
    }

    public Idea196318Service(Idea196318Config config) {
        this.config = config != null ? config : new Idea196318Config();
