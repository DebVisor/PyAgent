...
@Data
public class Idea196349Config {
    private String name = "idea_196349";
 ...
 */
@Slf4j
public class Idea196349Service {
    private static final int IDEA_ID = 196349;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196349Service() {
        this(new Idea196349Config());
    }

    public Idea196349Service(Idea196349Config config) {
        this.config = config != null ? config : new Idea196349Config();
