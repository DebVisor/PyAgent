...
@Data
public class Idea196360Config {
    private String name = "idea_196360";
 ...
 */
@Slf4j
public class Idea196360Service {
    private static final int IDEA_ID = 196360;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196360Service() {
        this(new Idea196360Config());
    }

    public Idea196360Service(Idea196360Config config) {
        this.config = config != null ? config : new Idea196360Config();
