...
@Data
public class Idea196180Config {
    private String name = "idea_196180";
 ...
 */
@Slf4j
public class Idea196180Service {
    private static final int IDEA_ID = 196180;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196180Service() {
        this(new Idea196180Config());
    }

    public Idea196180Service(Idea196180Config config) {
        this.config = config != null ? config : new Idea196180Config();
