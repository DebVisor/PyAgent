...
@Data
public class Idea196481Config {
    private String name = "idea_196481";
 ...
 */
@Slf4j
public class Idea196481Service {
    private static final int IDEA_ID = 196481;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196481Service() {
        this(new Idea196481Config());
    }

    public Idea196481Service(Idea196481Config config) {
        this.config = config != null ? config : new Idea196481Config();
