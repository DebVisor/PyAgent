...
@Data
public class Idea196437Config {
    private String name = "idea_196437";
 ...
 */
@Slf4j
public class Idea196437Service {
    private static final int IDEA_ID = 196437;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196437Service() {
        this(new Idea196437Config());
    }

    public Idea196437Service(Idea196437Config config) {
        this.config = config != null ? config : new Idea196437Config();
