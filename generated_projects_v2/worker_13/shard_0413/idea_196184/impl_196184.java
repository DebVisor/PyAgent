...
@Data
public class Idea196184Config {
    private String name = "idea_196184";
 ...
 */
@Slf4j
public class Idea196184Service {
    private static final int IDEA_ID = 196184;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196184Service() {
        this(new Idea196184Config());
    }

    public Idea196184Service(Idea196184Config config) {
        this.config = config != null ? config : new Idea196184Config();
