...
@Data
public class Idea196619Config {
    private String name = "idea_196619";
 ...
 */
@Slf4j
public class Idea196619Service {
    private static final int IDEA_ID = 196619;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196619Service() {
        this(new Idea196619Config());
    }

    public Idea196619Service(Idea196619Config config) {
        this.config = config != null ? config : new Idea196619Config();
