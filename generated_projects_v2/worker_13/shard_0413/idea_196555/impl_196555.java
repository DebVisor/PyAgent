...
@Data
public class Idea196555Config {
    private String name = "idea_196555";
 ...
 */
@Slf4j
public class Idea196555Service {
    private static final int IDEA_ID = 196555;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196555Service() {
        this(new Idea196555Config());
    }

    public Idea196555Service(Idea196555Config config) {
        this.config = config != null ? config : new Idea196555Config();
