...
@Data
public class Idea196371Config {
    private String name = "idea_196371";
 ...
 */
@Slf4j
public class Idea196371Service {
    private static final int IDEA_ID = 196371;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196371Service() {
        this(new Idea196371Config());
    }

    public Idea196371Service(Idea196371Config config) {
        this.config = config != null ? config : new Idea196371Config();
