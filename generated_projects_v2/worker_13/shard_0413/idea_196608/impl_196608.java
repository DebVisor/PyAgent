...
@Data
public class Idea196608Config {
    private String name = "idea_196608";
 ...
 */
@Slf4j
public class Idea196608Service {
    private static final int IDEA_ID = 196608;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196608Service() {
        this(new Idea196608Config());
    }

    public Idea196608Service(Idea196608Config config) {
        this.config = config != null ? config : new Idea196608Config();
