...
@Data
public class Idea196343Config {
    private String name = "idea_196343";
 ...
 */
@Slf4j
public class Idea196343Service {
    private static final int IDEA_ID = 196343;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196343Service() {
        this(new Idea196343Config());
    }

    public Idea196343Service(Idea196343Config config) {
        this.config = config != null ? config : new Idea196343Config();
