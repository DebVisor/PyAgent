...
@Data
public class Idea196293Config {
    private String name = "idea_196293";
 ...
 */
@Slf4j
public class Idea196293Service {
    private static final int IDEA_ID = 196293;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196293Service() {
        this(new Idea196293Config());
    }

    public Idea196293Service(Idea196293Config config) {
        this.config = config != null ? config : new Idea196293Config();
