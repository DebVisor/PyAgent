...
@Data
public class Idea196290Config {
    private String name = "idea_196290";
 ...
 */
@Slf4j
public class Idea196290Service {
    private static final int IDEA_ID = 196290;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196290Service() {
        this(new Idea196290Config());
    }

    public Idea196290Service(Idea196290Config config) {
        this.config = config != null ? config : new Idea196290Config();
