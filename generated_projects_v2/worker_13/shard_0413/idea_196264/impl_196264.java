...
@Data
public class Idea196264Config {
    private String name = "idea_196264";
 ...
 */
@Slf4j
public class Idea196264Service {
    private static final int IDEA_ID = 196264;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196264Service() {
        this(new Idea196264Config());
    }

    public Idea196264Service(Idea196264Config config) {
        this.config = config != null ? config : new Idea196264Config();
