...
@Data
public class Idea196266Config {
    private String name = "idea_196266";
 ...
 */
@Slf4j
public class Idea196266Service {
    private static final int IDEA_ID = 196266;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196266Service() {
        this(new Idea196266Config());
    }

    public Idea196266Service(Idea196266Config config) {
        this.config = config != null ? config : new Idea196266Config();
