...
@Data
public class Idea196210Config {
    private String name = "idea_196210";
 ...
 */
@Slf4j
public class Idea196210Service {
    private static final int IDEA_ID = 196210;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196210Service() {
        this(new Idea196210Config());
    }

    public Idea196210Service(Idea196210Config config) {
        this.config = config != null ? config : new Idea196210Config();
