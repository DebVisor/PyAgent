...
@Data
public class Idea196587Config {
    private String name = "idea_196587";
 ...
 */
@Slf4j
public class Idea196587Service {
    private static final int IDEA_ID = 196587;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196587Service() {
        this(new Idea196587Config());
    }

    public Idea196587Service(Idea196587Config config) {
        this.config = config != null ? config : new Idea196587Config();
