...
@Data
public class Idea196311Config {
    private String name = "idea_196311";
 ...
 */
@Slf4j
public class Idea196311Service {
    private static final int IDEA_ID = 196311;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196311Service() {
        this(new Idea196311Config());
    }

    public Idea196311Service(Idea196311Config config) {
        this.config = config != null ? config : new Idea196311Config();
