...
@Data
public class Idea196439Config {
    private String name = "idea_196439";
 ...
 */
@Slf4j
public class Idea196439Service {
    private static final int IDEA_ID = 196439;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196439Service() {
        this(new Idea196439Config());
    }

    public Idea196439Service(Idea196439Config config) {
        this.config = config != null ? config : new Idea196439Config();
