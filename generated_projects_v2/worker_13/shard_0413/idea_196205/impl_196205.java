...
@Data
public class Idea196205Config {
    private String name = "idea_196205";
 ...
 */
@Slf4j
public class Idea196205Service {
    private static final int IDEA_ID = 196205;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196205Service() {
        this(new Idea196205Config());
    }

    public Idea196205Service(Idea196205Config config) {
        this.config = config != null ? config : new Idea196205Config();
