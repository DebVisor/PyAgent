...
@Data
public class Idea196241Config {
    private String name = "idea_196241";
 ...
 */
@Slf4j
public class Idea196241Service {
    private static final int IDEA_ID = 196241;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196241Service() {
        this(new Idea196241Config());
    }

    public Idea196241Service(Idea196241Config config) {
        this.config = config != null ? config : new Idea196241Config();
