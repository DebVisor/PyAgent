...
@Data
public class Idea196499Config {
    private String name = "idea_196499";
 ...
 */
@Slf4j
public class Idea196499Service {
    private static final int IDEA_ID = 196499;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196499Service() {
        this(new Idea196499Config());
    }

    public Idea196499Service(Idea196499Config config) {
        this.config = config != null ? config : new Idea196499Config();
