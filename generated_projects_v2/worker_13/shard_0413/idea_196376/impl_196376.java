...
@Data
public class Idea196376Config {
    private String name = "idea_196376";
 ...
 */
@Slf4j
public class Idea196376Service {
    private static final int IDEA_ID = 196376;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196376Service() {
        this(new Idea196376Config());
    }

    public Idea196376Service(Idea196376Config config) {
        this.config = config != null ? config : new Idea196376Config();
