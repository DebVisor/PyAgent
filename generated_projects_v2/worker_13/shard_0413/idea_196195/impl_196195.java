...
@Data
public class Idea196195Config {
    private String name = "idea_196195";
 ...
 */
@Slf4j
public class Idea196195Service {
    private static final int IDEA_ID = 196195;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196195Service() {
        this(new Idea196195Config());
    }

    public Idea196195Service(Idea196195Config config) {
        this.config = config != null ? config : new Idea196195Config();
