...
@Data
public class Idea196592Config {
    private String name = "idea_196592";
 ...
 */
@Slf4j
public class Idea196592Service {
    private static final int IDEA_ID = 196592;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196592Service() {
        this(new Idea196592Config());
    }

    public Idea196592Service(Idea196592Config config) {
        this.config = config != null ? config : new Idea196592Config();
