...
@Data
public class Idea196588Config {
    private String name = "idea_196588";
 ...
 */
@Slf4j
public class Idea196588Service {
    private static final int IDEA_ID = 196588;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196588Service() {
        this(new Idea196588Config());
    }

    public Idea196588Service(Idea196588Config config) {
        this.config = config != null ? config : new Idea196588Config();
