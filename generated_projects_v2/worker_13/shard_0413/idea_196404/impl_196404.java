...
@Data
public class Idea196404Config {
    private String name = "idea_196404";
 ...
 */
@Slf4j
public class Idea196404Service {
    private static final int IDEA_ID = 196404;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196404Service() {
        this(new Idea196404Config());
    }

    public Idea196404Service(Idea196404Config config) {
        this.config = config != null ? config : new Idea196404Config();
