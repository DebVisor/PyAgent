...
@Data
public class Idea196508Config {
    private String name = "idea_196508";
 ...
 */
@Slf4j
public class Idea196508Service {
    private static final int IDEA_ID = 196508;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196508Service() {
        this(new Idea196508Config());
    }

    public Idea196508Service(Idea196508Config config) {
        this.config = config != null ? config : new Idea196508Config();
