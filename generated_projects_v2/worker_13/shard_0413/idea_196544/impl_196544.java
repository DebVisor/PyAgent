...
@Data
public class Idea196544Config {
    private String name = "idea_196544";
 ...
 */
@Slf4j
public class Idea196544Service {
    private static final int IDEA_ID = 196544;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196544Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196544Service() {
        this(new Idea196544Config());
    }

    public Idea196544Service(Idea196544Config config) {
        this.config = config != null ? config : new Idea196544Config();
