...
@Data
public class Idea196328Config {
    private String name = "idea_196328";
 ...
 */
@Slf4j
public class Idea196328Service {
    private static final int IDEA_ID = 196328;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196328Service() {
        this(new Idea196328Config());
    }

    public Idea196328Service(Idea196328Config config) {
        this.config = config != null ? config : new Idea196328Config();
