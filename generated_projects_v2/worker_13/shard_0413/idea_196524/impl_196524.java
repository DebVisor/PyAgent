...
@Data
public class Idea196524Config {
    private String name = "idea_196524";
 ...
 */
@Slf4j
public class Idea196524Service {
    private static final int IDEA_ID = 196524;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196524Service() {
        this(new Idea196524Config());
    }

    public Idea196524Service(Idea196524Config config) {
        this.config = config != null ? config : new Idea196524Config();
