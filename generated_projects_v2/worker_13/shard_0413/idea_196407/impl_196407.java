...
@Data
public class Idea196407Config {
    private String name = "idea_196407";
 ...
 */
@Slf4j
public class Idea196407Service {
    private static final int IDEA_ID = 196407;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196407Service() {
        this(new Idea196407Config());
    }

    public Idea196407Service(Idea196407Config config) {
        this.config = config != null ? config : new Idea196407Config();
