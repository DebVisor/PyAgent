...
@Data
public class Idea196390Config {
    private String name = "idea_196390";
 ...
 */
@Slf4j
public class Idea196390Service {
    private static final int IDEA_ID = 196390;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196390Service() {
        this(new Idea196390Config());
    }

    public Idea196390Service(Idea196390Config config) {
        this.config = config != null ? config : new Idea196390Config();
