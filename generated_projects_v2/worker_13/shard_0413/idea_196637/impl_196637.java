...
@Data
public class Idea196637Config {
    private String name = "idea_196637";
 ...
 */
@Slf4j
public class Idea196637Service {
    private static final int IDEA_ID = 196637;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196637Service() {
        this(new Idea196637Config());
    }

    public Idea196637Service(Idea196637Config config) {
        this.config = config != null ? config : new Idea196637Config();
