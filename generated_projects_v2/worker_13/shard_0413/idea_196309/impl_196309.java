...
@Data
public class Idea196309Config {
    private String name = "idea_196309";
 ...
 */
@Slf4j
public class Idea196309Service {
    private static final int IDEA_ID = 196309;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196309Service() {
        this(new Idea196309Config());
    }

    public Idea196309Service(Idea196309Config config) {
        this.config = config != null ? config : new Idea196309Config();
