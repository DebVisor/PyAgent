...
@Data
public class Idea196268Config {
    private String name = "idea_196268";
 ...
 */
@Slf4j
public class Idea196268Service {
    private static final int IDEA_ID = 196268;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196268Service() {
        this(new Idea196268Config());
    }

    public Idea196268Service(Idea196268Config config) {
        this.config = config != null ? config : new Idea196268Config();
