...
@Data
public class Idea195824Config {
    private String name = "idea_195824";
 ...
 */
@Slf4j
public class Idea195824Service {
    private static final int IDEA_ID = 195824;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195824Service() {
        this(new Idea195824Config());
    }

    public Idea195824Service(Idea195824Config config) {
        this.config = config != null ? config : new Idea195824Config();
