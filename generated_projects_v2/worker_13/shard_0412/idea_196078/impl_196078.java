...
@Data
public class Idea196078Config {
    private String name = "idea_196078";
 ...
 */
@Slf4j
public class Idea196078Service {
    private static final int IDEA_ID = 196078;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196078Service() {
        this(new Idea196078Config());
    }

    public Idea196078Service(Idea196078Config config) {
        this.config = config != null ? config : new Idea196078Config();
