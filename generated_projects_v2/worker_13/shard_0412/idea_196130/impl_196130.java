...
@Data
public class Idea196130Config {
    private String name = "idea_196130";
 ...
 */
@Slf4j
public class Idea196130Service {
    private static final int IDEA_ID = 196130;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196130Service() {
        this(new Idea196130Config());
    }

    public Idea196130Service(Idea196130Config config) {
        this.config = config != null ? config : new Idea196130Config();
