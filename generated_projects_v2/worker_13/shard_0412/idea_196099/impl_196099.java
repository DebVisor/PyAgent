...
@Data
public class Idea196099Config {
    private String name = "idea_196099";
 ...
 */
@Slf4j
public class Idea196099Service {
    private static final int IDEA_ID = 196099;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196099Service() {
        this(new Idea196099Config());
    }

    public Idea196099Service(Idea196099Config config) {
        this.config = config != null ? config : new Idea196099Config();
