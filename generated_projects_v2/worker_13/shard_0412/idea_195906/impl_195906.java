...
@Data
public class Idea195906Config {
    private String name = "idea_195906";
 ...
 */
@Slf4j
public class Idea195906Service {
    private static final int IDEA_ID = 195906;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195906Service() {
        this(new Idea195906Config());
    }

    public Idea195906Service(Idea195906Config config) {
        this.config = config != null ? config : new Idea195906Config();
