...
@Data
public class Idea195968Config {
    private String name = "idea_195968";
 ...
 */
@Slf4j
public class Idea195968Service {
    private static final int IDEA_ID = 195968;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195968Service() {
        this(new Idea195968Config());
    }

    public Idea195968Service(Idea195968Config config) {
        this.config = config != null ? config : new Idea195968Config();
