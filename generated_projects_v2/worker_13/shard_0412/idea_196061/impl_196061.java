...
@Data
public class Idea196061Config {
    private String name = "idea_196061";
 ...
 */
@Slf4j
public class Idea196061Service {
    private static final int IDEA_ID = 196061;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196061Service() {
        this(new Idea196061Config());
    }

    public Idea196061Service(Idea196061Config config) {
        this.config = config != null ? config : new Idea196061Config();
