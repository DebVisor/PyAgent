...
@Data
public class Idea195920Config {
    private String name = "idea_195920";
 ...
 */
@Slf4j
public class Idea195920Service {
    private static final int IDEA_ID = 195920;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195920Service() {
        this(new Idea195920Config());
    }

    public Idea195920Service(Idea195920Config config) {
        this.config = config != null ? config : new Idea195920Config();
