...
@Data
public class Idea195984Config {
    private String name = "idea_195984";
 ...
 */
@Slf4j
public class Idea195984Service {
    private static final int IDEA_ID = 195984;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195984Service() {
        this(new Idea195984Config());
    }

    public Idea195984Service(Idea195984Config config) {
        this.config = config != null ? config : new Idea195984Config();
