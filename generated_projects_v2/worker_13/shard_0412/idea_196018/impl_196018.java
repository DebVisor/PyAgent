...
@Data
public class Idea196018Config {
    private String name = "idea_196018";
 ...
 */
@Slf4j
public class Idea196018Service {
    private static final int IDEA_ID = 196018;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196018Service() {
        this(new Idea196018Config());
    }

    public Idea196018Service(Idea196018Config config) {
        this.config = config != null ? config : new Idea196018Config();
