...
@Data
public class Idea195939Config {
    private String name = "idea_195939";
 ...
 */
@Slf4j
public class Idea195939Service {
    private static final int IDEA_ID = 195939;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195939Service() {
        this(new Idea195939Config());
    }

    public Idea195939Service(Idea195939Config config) {
        this.config = config != null ? config : new Idea195939Config();
