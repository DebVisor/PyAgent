...
@Data
public class Idea196090Config {
    private String name = "idea_196090";
 ...
 */
@Slf4j
public class Idea196090Service {
    private static final int IDEA_ID = 196090;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196090Service() {
        this(new Idea196090Config());
    }

    public Idea196090Service(Idea196090Config config) {
        this.config = config != null ? config : new Idea196090Config();
