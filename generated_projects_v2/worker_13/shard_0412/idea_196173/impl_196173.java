...
@Data
public class Idea196173Config {
    private String name = "idea_196173";
 ...
 */
@Slf4j
public class Idea196173Service {
    private static final int IDEA_ID = 196173;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196173Service() {
        this(new Idea196173Config());
    }

    public Idea196173Service(Idea196173Config config) {
        this.config = config != null ? config : new Idea196173Config();
