...
@Data
public class Idea195720Config {
    private String name = "idea_195720";
 ...
 */
@Slf4j
public class Idea195720Service {
    private static final int IDEA_ID = 195720;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195720Service() {
        this(new Idea195720Config());
    }

    public Idea195720Service(Idea195720Config config) {
        this.config = config != null ? config : new Idea195720Config();
