...
@Data
public class Idea195756Config {
    private String name = "idea_195756";
 ...
 */
@Slf4j
public class Idea195756Service {
    private static final int IDEA_ID = 195756;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195756Service() {
        this(new Idea195756Config());
    }

    public Idea195756Service(Idea195756Config config) {
        this.config = config != null ? config : new Idea195756Config();
