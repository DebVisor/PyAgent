...
@Data
public class Idea195827Config {
    private String name = "idea_195827";
 ...
 */
@Slf4j
public class Idea195827Service {
    private static final int IDEA_ID = 195827;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195827Service() {
        this(new Idea195827Config());
    }

    public Idea195827Service(Idea195827Config config) {
        this.config = config != null ? config : new Idea195827Config();
