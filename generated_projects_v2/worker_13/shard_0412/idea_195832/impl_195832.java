...
@Data
public class Idea195832Config {
    private String name = "idea_195832";
 ...
 */
@Slf4j
public class Idea195832Service {
    private static final int IDEA_ID = 195832;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195832Service() {
        this(new Idea195832Config());
    }

    public Idea195832Service(Idea195832Config config) {
        this.config = config != null ? config : new Idea195832Config();
