...
@Data
public class Idea196002Config {
    private String name = "idea_196002";
 ...
 */
@Slf4j
public class Idea196002Service {
    private static final int IDEA_ID = 196002;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196002Service() {
        this(new Idea196002Config());
    }

    public Idea196002Service(Idea196002Config config) {
        this.config = config != null ? config : new Idea196002Config();
