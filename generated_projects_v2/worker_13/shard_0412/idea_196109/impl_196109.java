...
@Data
public class Idea196109Config {
    private String name = "idea_196109";
 ...
 */
@Slf4j
public class Idea196109Service {
    private static final int IDEA_ID = 196109;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196109Service() {
        this(new Idea196109Config());
    }

    public Idea196109Service(Idea196109Config config) {
        this.config = config != null ? config : new Idea196109Config();
