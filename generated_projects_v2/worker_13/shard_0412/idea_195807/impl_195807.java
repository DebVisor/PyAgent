...
@Data
public class Idea195807Config {
    private String name = "idea_195807";
 ...
 */
@Slf4j
public class Idea195807Service {
    private static final int IDEA_ID = 195807;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195807Service() {
        this(new Idea195807Config());
    }

    public Idea195807Service(Idea195807Config config) {
        this.config = config != null ? config : new Idea195807Config();
