...
@Data
public class Idea195896Config {
    private String name = "idea_195896";
 ...
 */
@Slf4j
public class Idea195896Service {
    private static final int IDEA_ID = 195896;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195896Service() {
        this(new Idea195896Config());
    }

    public Idea195896Service(Idea195896Config config) {
        this.config = config != null ? config : new Idea195896Config();
