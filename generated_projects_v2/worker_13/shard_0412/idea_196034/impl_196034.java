...
@Data
public class Idea196034Config {
    private String name = "idea_196034";
 ...
 */
@Slf4j
public class Idea196034Service {
    private static final int IDEA_ID = 196034;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196034Service() {
        this(new Idea196034Config());
    }

    public Idea196034Service(Idea196034Config config) {
        this.config = config != null ? config : new Idea196034Config();
