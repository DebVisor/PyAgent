...
@Data
public class Idea196064Config {
    private String name = "idea_196064";
 ...
 */
@Slf4j
public class Idea196064Service {
    private static final int IDEA_ID = 196064;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196064Service() {
        this(new Idea196064Config());
    }

    public Idea196064Service(Idea196064Config config) {
        this.config = config != null ? config : new Idea196064Config();
