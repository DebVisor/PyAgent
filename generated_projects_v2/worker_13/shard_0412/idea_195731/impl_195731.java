...
@Data
public class Idea195731Config {
    private String name = "idea_195731";
 ...
 */
@Slf4j
public class Idea195731Service {
    private static final int IDEA_ID = 195731;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195731Service() {
        this(new Idea195731Config());
    }

    public Idea195731Service(Idea195731Config config) {
        this.config = config != null ? config : new Idea195731Config();
