...
@Data
public class Idea195840Config {
    private String name = "idea_195840";
 ...
 */
@Slf4j
public class Idea195840Service {
    private static final int IDEA_ID = 195840;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195840Service() {
        this(new Idea195840Config());
    }

    public Idea195840Service(Idea195840Config config) {
        this.config = config != null ? config : new Idea195840Config();
