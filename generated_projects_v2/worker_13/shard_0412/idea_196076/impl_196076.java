...
@Data
public class Idea196076Config {
    private String name = "idea_196076";
 ...
 */
@Slf4j
public class Idea196076Service {
    private static final int IDEA_ID = 196076;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196076Service() {
        this(new Idea196076Config());
    }

    public Idea196076Service(Idea196076Config config) {
        this.config = config != null ? config : new Idea196076Config();
