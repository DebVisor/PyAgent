...
@Data
public class Idea195883Config {
    private String name = "idea_195883";
 ...
 */
@Slf4j
public class Idea195883Service {
    private static final int IDEA_ID = 195883;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195883Service() {
        this(new Idea195883Config());
    }

    public Idea195883Service(Idea195883Config config) {
        this.config = config != null ? config : new Idea195883Config();
