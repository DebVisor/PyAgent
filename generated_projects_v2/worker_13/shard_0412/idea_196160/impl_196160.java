...
@Data
public class Idea196160Config {
    private String name = "idea_196160";
 ...
 */
@Slf4j
public class Idea196160Service {
    private static final int IDEA_ID = 196160;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196160Service() {
        this(new Idea196160Config());
    }

    public Idea196160Service(Idea196160Config config) {
        this.config = config != null ? config : new Idea196160Config();
