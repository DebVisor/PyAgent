...
@Data
public class Idea195846Config {
    private String name = "idea_195846";
 ...
 */
@Slf4j
public class Idea195846Service {
    private static final int IDEA_ID = 195846;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195846Service() {
        this(new Idea195846Config());
    }

    public Idea195846Service(Idea195846Config config) {
        this.config = config != null ? config : new Idea195846Config();
