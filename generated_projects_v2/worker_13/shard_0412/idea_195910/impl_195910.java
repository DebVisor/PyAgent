...
@Data
public class Idea195910Config {
    private String name = "idea_195910";
 ...
 */
@Slf4j
public class Idea195910Service {
    private static final int IDEA_ID = 195910;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195910Service() {
        this(new Idea195910Config());
    }

    public Idea195910Service(Idea195910Config config) {
        this.config = config != null ? config : new Idea195910Config();
