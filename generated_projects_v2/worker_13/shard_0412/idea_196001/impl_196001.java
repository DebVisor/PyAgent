...
@Data
public class Idea196001Config {
    private String name = "idea_196001";
 ...
 */
@Slf4j
public class Idea196001Service {
    private static final int IDEA_ID = 196001;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196001Service() {
        this(new Idea196001Config());
    }

    public Idea196001Service(Idea196001Config config) {
        this.config = config != null ? config : new Idea196001Config();
