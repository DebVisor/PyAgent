...
@Data
public class Idea196149Config {
    private String name = "idea_196149";
 ...
 */
@Slf4j
public class Idea196149Service {
    private static final int IDEA_ID = 196149;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196149Service() {
        this(new Idea196149Config());
    }

    public Idea196149Service(Idea196149Config config) {
        this.config = config != null ? config : new Idea196149Config();
