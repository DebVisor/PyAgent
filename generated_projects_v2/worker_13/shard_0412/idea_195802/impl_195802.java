...
@Data
public class Idea195802Config {
    private String name = "idea_195802";
 ...
 */
@Slf4j
public class Idea195802Service {
    private static final int IDEA_ID = 195802;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195802Service() {
        this(new Idea195802Config());
    }

    public Idea195802Service(Idea195802Config config) {
        this.config = config != null ? config : new Idea195802Config();
