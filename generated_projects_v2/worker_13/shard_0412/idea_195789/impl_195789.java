...
@Data
public class Idea195789Config {
    private String name = "idea_195789";
 ...
 */
@Slf4j
public class Idea195789Service {
    private static final int IDEA_ID = 195789;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195789Service() {
        this(new Idea195789Config());
    }

    public Idea195789Service(Idea195789Config config) {
        this.config = config != null ? config : new Idea195789Config();
