...
@Data
public class Idea195858Config {
    private String name = "idea_195858";
 ...
 */
@Slf4j
public class Idea195858Service {
    private static final int IDEA_ID = 195858;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195858Service() {
        this(new Idea195858Config());
    }

    public Idea195858Service(Idea195858Config config) {
        this.config = config != null ? config : new Idea195858Config();
