...
@Data
public class Idea195875Config {
    private String name = "idea_195875";
 ...
 */
@Slf4j
public class Idea195875Service {
    private static final int IDEA_ID = 195875;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195875Service() {
        this(new Idea195875Config());
    }

    public Idea195875Service(Idea195875Config config) {
        this.config = config != null ? config : new Idea195875Config();
