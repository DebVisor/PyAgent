...
@Data
public class Idea196105Config {
    private String name = "idea_196105";
 ...
 */
@Slf4j
public class Idea196105Service {
    private static final int IDEA_ID = 196105;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196105Service() {
        this(new Idea196105Config());
    }

    public Idea196105Service(Idea196105Config config) {
        this.config = config != null ? config : new Idea196105Config();
