...
@Data
public class Idea195703Config {
    private String name = "idea_195703";
 ...
 */
@Slf4j
public class Idea195703Service {
    private static final int IDEA_ID = 195703;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195703Service() {
        this(new Idea195703Config());
    }

    public Idea195703Service(Idea195703Config config) {
        this.config = config != null ? config : new Idea195703Config();
