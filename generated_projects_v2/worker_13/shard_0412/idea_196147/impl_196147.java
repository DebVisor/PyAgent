...
@Data
public class Idea196147Config {
    private String name = "idea_196147";
 ...
 */
@Slf4j
public class Idea196147Service {
    private static final int IDEA_ID = 196147;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196147Service() {
        this(new Idea196147Config());
    }

    public Idea196147Service(Idea196147Config config) {
        this.config = config != null ? config : new Idea196147Config();
