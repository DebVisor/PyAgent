...
@Data
public class Idea196060Config {
    private String name = "idea_196060";
 ...
 */
@Slf4j
public class Idea196060Service {
    private static final int IDEA_ID = 196060;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196060Service() {
        this(new Idea196060Config());
    }

    public Idea196060Service(Idea196060Config config) {
        this.config = config != null ? config : new Idea196060Config();
