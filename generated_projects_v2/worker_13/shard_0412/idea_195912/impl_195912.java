...
@Data
public class Idea195912Config {
    private String name = "idea_195912";
 ...
 */
@Slf4j
public class Idea195912Service {
    private static final int IDEA_ID = 195912;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195912Service() {
        this(new Idea195912Config());
    }

    public Idea195912Service(Idea195912Config config) {
        this.config = config != null ? config : new Idea195912Config();
