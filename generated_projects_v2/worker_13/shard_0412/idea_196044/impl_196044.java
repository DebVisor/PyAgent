...
@Data
public class Idea196044Config {
    private String name = "idea_196044";
 ...
 */
@Slf4j
public class Idea196044Service {
    private static final int IDEA_ID = 196044;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196044Service() {
        this(new Idea196044Config());
    }

    public Idea196044Service(Idea196044Config config) {
        this.config = config != null ? config : new Idea196044Config();
