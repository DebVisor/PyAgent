...
@Data
public class Idea195714Config {
    private String name = "idea_195714";
 ...
 */
@Slf4j
public class Idea195714Service {
    private static final int IDEA_ID = 195714;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195714Service() {
        this(new Idea195714Config());
    }

    public Idea195714Service(Idea195714Config config) {
        this.config = config != null ? config : new Idea195714Config();
