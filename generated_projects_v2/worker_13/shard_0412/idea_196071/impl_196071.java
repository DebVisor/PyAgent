...
@Data
public class Idea196071Config {
    private String name = "idea_196071";
 ...
 */
@Slf4j
public class Idea196071Service {
    private static final int IDEA_ID = 196071;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196071Service() {
        this(new Idea196071Config());
    }

    public Idea196071Service(Idea196071Config config) {
        this.config = config != null ? config : new Idea196071Config();
