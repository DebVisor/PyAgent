...
@Data
public class Idea195764Config {
    private String name = "idea_195764";
 ...
 */
@Slf4j
public class Idea195764Service {
    private static final int IDEA_ID = 195764;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195764Service() {
        this(new Idea195764Config());
    }

    public Idea195764Service(Idea195764Config config) {
        this.config = config != null ? config : new Idea195764Config();
