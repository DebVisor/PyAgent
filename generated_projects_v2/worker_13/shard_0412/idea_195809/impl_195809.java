...
@Data
public class Idea195809Config {
    private String name = "idea_195809";
 ...
 */
@Slf4j
public class Idea195809Service {
    private static final int IDEA_ID = 195809;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195809Service() {
        this(new Idea195809Config());
    }

    public Idea195809Service(Idea195809Config config) {
        this.config = config != null ? config : new Idea195809Config();
