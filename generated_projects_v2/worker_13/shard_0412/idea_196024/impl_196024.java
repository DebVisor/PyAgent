...
@Data
public class Idea196024Config {
    private String name = "idea_196024";
 ...
 */
@Slf4j
public class Idea196024Service {
    private static final int IDEA_ID = 196024;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196024Service() {
        this(new Idea196024Config());
    }

    public Idea196024Service(Idea196024Config config) {
        this.config = config != null ? config : new Idea196024Config();
