...
@Data
public class Idea196081Config {
    private String name = "idea_196081";
 ...
 */
@Slf4j
public class Idea196081Service {
    private static final int IDEA_ID = 196081;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196081Service() {
        this(new Idea196081Config());
    }

    public Idea196081Service(Idea196081Config config) {
        this.config = config != null ? config : new Idea196081Config();
