...
@Data
public class Idea195928Config {
    private String name = "idea_195928";
 ...
 */
@Slf4j
public class Idea195928Service {
    private static final int IDEA_ID = 195928;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195928Service() {
        this(new Idea195928Config());
    }

    public Idea195928Service(Idea195928Config config) {
        this.config = config != null ? config : new Idea195928Config();
