...
@Data
public class Idea196058Config {
    private String name = "idea_196058";
 ...
 */
@Slf4j
public class Idea196058Service {
    private static final int IDEA_ID = 196058;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196058Service() {
        this(new Idea196058Config());
    }

    public Idea196058Service(Idea196058Config config) {
        this.config = config != null ? config : new Idea196058Config();
