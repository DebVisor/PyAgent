...
@Data
public class Idea196102Config {
    private String name = "idea_196102";
 ...
 */
@Slf4j
public class Idea196102Service {
    private static final int IDEA_ID = 196102;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196102Service() {
        this(new Idea196102Config());
    }

    public Idea196102Service(Idea196102Config config) {
        this.config = config != null ? config : new Idea196102Config();
