...
@Data
public class Idea196123Config {
    private String name = "idea_196123";
 ...
 */
@Slf4j
public class Idea196123Service {
    private static final int IDEA_ID = 196123;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196123Service() {
        this(new Idea196123Config());
    }

    public Idea196123Service(Idea196123Config config) {
        this.config = config != null ? config : new Idea196123Config();
