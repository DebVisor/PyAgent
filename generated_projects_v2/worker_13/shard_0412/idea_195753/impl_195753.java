...
@Data
public class Idea195753Config {
    private String name = "idea_195753";
 ...
 */
@Slf4j
public class Idea195753Service {
    private static final int IDEA_ID = 195753;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195753Service() {
        this(new Idea195753Config());
    }

    public Idea195753Service(Idea195753Config config) {
        this.config = config != null ? config : new Idea195753Config();
