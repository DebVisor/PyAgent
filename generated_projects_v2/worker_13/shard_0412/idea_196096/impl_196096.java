...
@Data
public class Idea196096Config {
    private String name = "idea_196096";
 ...
 */
@Slf4j
public class Idea196096Service {
    private static final int IDEA_ID = 196096;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196096Service() {
        this(new Idea196096Config());
    }

    public Idea196096Service(Idea196096Config config) {
        this.config = config != null ? config : new Idea196096Config();
