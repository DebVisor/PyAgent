...
@Data
public class Idea196053Config {
    private String name = "idea_196053";
 ...
 */
@Slf4j
public class Idea196053Service {
    private static final int IDEA_ID = 196053;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196053Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196053Service() {
        this(new Idea196053Config());
    }

    public Idea196053Service(Idea196053Config config) {
        this.config = config != null ? config : new Idea196053Config();
