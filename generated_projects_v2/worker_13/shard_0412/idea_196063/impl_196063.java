...
@Data
public class Idea196063Config {
    private String name = "idea_196063";
 ...
 */
@Slf4j
public class Idea196063Service {
    private static final int IDEA_ID = 196063;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196063Service() {
        this(new Idea196063Config());
    }

    public Idea196063Service(Idea196063Config config) {
        this.config = config != null ? config : new Idea196063Config();
