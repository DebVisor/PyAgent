...
@Data
public class Idea195907Config {
    private String name = "idea_195907";
 ...
 */
@Slf4j
public class Idea195907Service {
    private static final int IDEA_ID = 195907;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195907Service() {
        this(new Idea195907Config());
    }

    public Idea195907Service(Idea195907Config config) {
        this.config = config != null ? config : new Idea195907Config();
