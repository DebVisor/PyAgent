...
@Data
public class Idea196169Config {
    private String name = "idea_196169";
 ...
 */
@Slf4j
public class Idea196169Service {
    private static final int IDEA_ID = 196169;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196169Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196169Service() {
        this(new Idea196169Config());
    }

    public Idea196169Service(Idea196169Config config) {
        this.config = config != null ? config : new Idea196169Config();
