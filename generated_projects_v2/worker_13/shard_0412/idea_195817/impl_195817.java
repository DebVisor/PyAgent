...
@Data
public class Idea195817Config {
    private String name = "idea_195817";
 ...
 */
@Slf4j
public class Idea195817Service {
    private static final int IDEA_ID = 195817;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195817Service() {
        this(new Idea195817Config());
    }

    public Idea195817Service(Idea195817Config config) {
        this.config = config != null ? config : new Idea195817Config();
