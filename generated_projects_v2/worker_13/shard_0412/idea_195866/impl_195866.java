...
@Data
public class Idea195866Config {
    private String name = "idea_195866";
 ...
 */
@Slf4j
public class Idea195866Service {
    private static final int IDEA_ID = 195866;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195866Service() {
        this(new Idea195866Config());
    }

    public Idea195866Service(Idea195866Config config) {
        this.config = config != null ? config : new Idea195866Config();
