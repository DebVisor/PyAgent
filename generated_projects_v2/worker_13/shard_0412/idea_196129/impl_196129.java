...
@Data
public class Idea196129Config {
    private String name = "idea_196129";
 ...
 */
@Slf4j
public class Idea196129Service {
    private static final int IDEA_ID = 196129;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196129Service() {
        this(new Idea196129Config());
    }

    public Idea196129Service(Idea196129Config config) {
        this.config = config != null ? config : new Idea196129Config();
