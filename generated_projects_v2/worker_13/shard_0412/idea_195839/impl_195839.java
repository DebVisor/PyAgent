...
@Data
public class Idea195839Config {
    private String name = "idea_195839";
 ...
 */
@Slf4j
public class Idea195839Service {
    private static final int IDEA_ID = 195839;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195839Service() {
        this(new Idea195839Config());
    }

    public Idea195839Service(Idea195839Config config) {
        this.config = config != null ? config : new Idea195839Config();
