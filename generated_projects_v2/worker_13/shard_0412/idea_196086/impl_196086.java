...
@Data
public class Idea196086Config {
    private String name = "idea_196086";
 ...
 */
@Slf4j
public class Idea196086Service {
    private static final int IDEA_ID = 196086;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196086Service() {
        this(new Idea196086Config());
    }

    public Idea196086Service(Idea196086Config config) {
        this.config = config != null ? config : new Idea196086Config();
