...
@Data
public class Idea196037Config {
    private String name = "idea_196037";
 ...
 */
@Slf4j
public class Idea196037Service {
    private static final int IDEA_ID = 196037;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196037Service() {
        this(new Idea196037Config());
    }

    public Idea196037Service(Idea196037Config config) {
        this.config = config != null ? config : new Idea196037Config();
