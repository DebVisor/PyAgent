...
@Data
public class Idea195886Config {
    private String name = "idea_195886";
 ...
 */
@Slf4j
public class Idea195886Service {
    private static final int IDEA_ID = 195886;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195886Service() {
        this(new Idea195886Config());
    }

    public Idea195886Service(Idea195886Config config) {
        this.config = config != null ? config : new Idea195886Config();
