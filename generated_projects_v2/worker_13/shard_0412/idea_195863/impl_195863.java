...
@Data
public class Idea195863Config {
    private String name = "idea_195863";
 ...
 */
@Slf4j
public class Idea195863Service {
    private static final int IDEA_ID = 195863;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195863Service() {
        this(new Idea195863Config());
    }

    public Idea195863Service(Idea195863Config config) {
        this.config = config != null ? config : new Idea195863Config();
