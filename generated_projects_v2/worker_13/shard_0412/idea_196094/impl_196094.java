...
@Data
public class Idea196094Config {
    private String name = "idea_196094";
 ...
 */
@Slf4j
public class Idea196094Service {
    private static final int IDEA_ID = 196094;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196094Service() {
        this(new Idea196094Config());
    }

    public Idea196094Service(Idea196094Config config) {
        this.config = config != null ? config : new Idea196094Config();
