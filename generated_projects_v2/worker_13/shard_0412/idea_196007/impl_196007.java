...
@Data
public class Idea196007Config {
    private String name = "idea_196007";
 ...
 */
@Slf4j
public class Idea196007Service {
    private static final int IDEA_ID = 196007;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196007Service() {
        this(new Idea196007Config());
    }

    public Idea196007Service(Idea196007Config config) {
        this.config = config != null ? config : new Idea196007Config();
