...
@Data
public class Idea196148Config {
    private String name = "idea_196148";
 ...
 */
@Slf4j
public class Idea196148Service {
    private static final int IDEA_ID = 196148;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196148Service() {
        this(new Idea196148Config());
    }

    public Idea196148Service(Idea196148Config config) {
        this.config = config != null ? config : new Idea196148Config();
