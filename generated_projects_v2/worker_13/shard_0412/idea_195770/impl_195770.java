...
@Data
public class Idea195770Config {
    private String name = "idea_195770";
 ...
 */
@Slf4j
public class Idea195770Service {
    private static final int IDEA_ID = 195770;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195770Service() {
        this(new Idea195770Config());
    }

    public Idea195770Service(Idea195770Config config) {
        this.config = config != null ? config : new Idea195770Config();
