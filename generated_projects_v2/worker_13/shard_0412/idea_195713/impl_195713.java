...
@Data
public class Idea195713Config {
    private String name = "idea_195713";
 ...
 */
@Slf4j
public class Idea195713Service {
    private static final int IDEA_ID = 195713;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195713Service() {
        this(new Idea195713Config());
    }

    public Idea195713Service(Idea195713Config config) {
        this.config = config != null ? config : new Idea195713Config();
