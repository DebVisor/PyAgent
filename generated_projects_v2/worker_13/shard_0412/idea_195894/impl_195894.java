...
@Data
public class Idea195894Config {
    private String name = "idea_195894";
 ...
 */
@Slf4j
public class Idea195894Service {
    private static final int IDEA_ID = 195894;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195894Service() {
        this(new Idea195894Config());
    }

    public Idea195894Service(Idea195894Config config) {
        this.config = config != null ? config : new Idea195894Config();
