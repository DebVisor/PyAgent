...
@Data
public class Idea195890Config {
    private String name = "idea_195890";
 ...
 */
@Slf4j
public class Idea195890Service {
    private static final int IDEA_ID = 195890;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195890Service() {
        this(new Idea195890Config());
    }

    public Idea195890Service(Idea195890Config config) {
        this.config = config != null ? config : new Idea195890Config();
