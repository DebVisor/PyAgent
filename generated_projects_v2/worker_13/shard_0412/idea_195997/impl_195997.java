...
@Data
public class Idea195997Config {
    private String name = "idea_195997";
 ...
 */
@Slf4j
public class Idea195997Service {
    private static final int IDEA_ID = 195997;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195997Service() {
        this(new Idea195997Config());
    }

    public Idea195997Service(Idea195997Config config) {
        this.config = config != null ? config : new Idea195997Config();
