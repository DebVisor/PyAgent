...
@Data
public class Idea196142Config {
    private String name = "idea_196142";
 ...
 */
@Slf4j
public class Idea196142Service {
    private static final int IDEA_ID = 196142;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196142Service() {
        this(new Idea196142Config());
    }

    public Idea196142Service(Idea196142Config config) {
        this.config = config != null ? config : new Idea196142Config();
