...
@Data
public class Idea196075Config {
    private String name = "idea_196075";
 ...
 */
@Slf4j
public class Idea196075Service {
    private static final int IDEA_ID = 196075;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196075Service() {
        this(new Idea196075Config());
    }

    public Idea196075Service(Idea196075Config config) {
        this.config = config != null ? config : new Idea196075Config();
