...
@Data
public class Idea195794Config {
    private String name = "idea_195794";
 ...
 */
@Slf4j
public class Idea195794Service {
    private static final int IDEA_ID = 195794;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195794Service() {
        this(new Idea195794Config());
    }

    public Idea195794Service(Idea195794Config config) {
        this.config = config != null ? config : new Idea195794Config();
