...
@Data
public class Idea196140Config {
    private String name = "idea_196140";
 ...
 */
@Slf4j
public class Idea196140Service {
    private static final int IDEA_ID = 196140;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196140Service() {
        this(new Idea196140Config());
    }

    public Idea196140Service(Idea196140Config config) {
        this.config = config != null ? config : new Idea196140Config();
