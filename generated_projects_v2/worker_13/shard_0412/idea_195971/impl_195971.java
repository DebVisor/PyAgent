...
@Data
public class Idea195971Config {
    private String name = "idea_195971";
 ...
 */
@Slf4j
public class Idea195971Service {
    private static final int IDEA_ID = 195971;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195971Service() {
        this(new Idea195971Config());
    }

    public Idea195971Service(Idea195971Config config) {
        this.config = config != null ? config : new Idea195971Config();
