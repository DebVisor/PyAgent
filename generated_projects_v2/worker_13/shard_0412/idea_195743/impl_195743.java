...
@Data
public class Idea195743Config {
    private String name = "idea_195743";
 ...
 */
@Slf4j
public class Idea195743Service {
    private static final int IDEA_ID = 195743;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195743Service() {
        this(new Idea195743Config());
    }

    public Idea195743Service(Idea195743Config config) {
        this.config = config != null ? config : new Idea195743Config();
