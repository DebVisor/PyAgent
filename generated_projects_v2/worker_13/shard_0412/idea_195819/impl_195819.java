...
@Data
public class Idea195819Config {
    private String name = "idea_195819";
 ...
 */
@Slf4j
public class Idea195819Service {
    private static final int IDEA_ID = 195819;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195819Service() {
        this(new Idea195819Config());
    }

    public Idea195819Service(Idea195819Config config) {
        this.config = config != null ? config : new Idea195819Config();
