...
@Data
public class Idea195949Config {
    private String name = "idea_195949";
 ...
 */
@Slf4j
public class Idea195949Service {
    private static final int IDEA_ID = 195949;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195949Service() {
        this(new Idea195949Config());
    }

    public Idea195949Service(Idea195949Config config) {
        this.config = config != null ? config : new Idea195949Config();
