...
@Data
public class Idea196161Config {
    private String name = "idea_196161";
 ...
 */
@Slf4j
public class Idea196161Service {
    private static final int IDEA_ID = 196161;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196161Service() {
        this(new Idea196161Config());
    }

    public Idea196161Service(Idea196161Config config) {
        this.config = config != null ? config : new Idea196161Config();
