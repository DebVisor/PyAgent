...
@Data
public class Idea195855Config {
    private String name = "idea_195855";
 ...
 */
@Slf4j
public class Idea195855Service {
    private static final int IDEA_ID = 195855;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195855Service() {
        this(new Idea195855Config());
    }

    public Idea195855Service(Idea195855Config config) {
        this.config = config != null ? config : new Idea195855Config();
