...
@Data
public class Idea196136Config {
    private String name = "idea_196136";
 ...
 */
@Slf4j
public class Idea196136Service {
    private static final int IDEA_ID = 196136;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196136Service() {
        this(new Idea196136Config());
    }

    public Idea196136Service(Idea196136Config config) {
        this.config = config != null ? config : new Idea196136Config();
