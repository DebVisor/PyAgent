...
@Data
public class Idea196115Config {
    private String name = "idea_196115";
 ...
 */
@Slf4j
public class Idea196115Service {
    private static final int IDEA_ID = 196115;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196115Service() {
        this(new Idea196115Config());
    }

    public Idea196115Service(Idea196115Config config) {
        this.config = config != null ? config : new Idea196115Config();
