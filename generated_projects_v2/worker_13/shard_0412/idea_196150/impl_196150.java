...
@Data
public class Idea196150Config {
    private String name = "idea_196150";
 ...
 */
@Slf4j
public class Idea196150Service {
    private static final int IDEA_ID = 196150;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196150Service() {
        this(new Idea196150Config());
    }

    public Idea196150Service(Idea196150Config config) {
        this.config = config != null ? config : new Idea196150Config();
