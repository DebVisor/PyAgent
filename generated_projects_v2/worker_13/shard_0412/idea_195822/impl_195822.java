...
@Data
public class Idea195822Config {
    private String name = "idea_195822";
 ...
 */
@Slf4j
public class Idea195822Service {
    private static final int IDEA_ID = 195822;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195822Service() {
        this(new Idea195822Config());
    }

    public Idea195822Service(Idea195822Config config) {
        this.config = config != null ? config : new Idea195822Config();
