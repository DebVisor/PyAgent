...
@Data
public class Idea196133Config {
    private String name = "idea_196133";
 ...
 */
@Slf4j
public class Idea196133Service {
    private static final int IDEA_ID = 196133;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196133Service() {
        this(new Idea196133Config());
    }

    public Idea196133Service(Idea196133Config config) {
        this.config = config != null ? config : new Idea196133Config();
