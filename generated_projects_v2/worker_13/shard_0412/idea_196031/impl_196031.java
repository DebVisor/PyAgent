...
@Data
public class Idea196031Config {
    private String name = "idea_196031";
 ...
 */
@Slf4j
public class Idea196031Service {
    private static final int IDEA_ID = 196031;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196031Service() {
        this(new Idea196031Config());
    }

    public Idea196031Service(Idea196031Config config) {
        this.config = config != null ? config : new Idea196031Config();
