...
@Data
public class Idea196022Config {
    private String name = "idea_196022";
 ...
 */
@Slf4j
public class Idea196022Service {
    private static final int IDEA_ID = 196022;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196022Service() {
        this(new Idea196022Config());
    }

    public Idea196022Service(Idea196022Config config) {
        this.config = config != null ? config : new Idea196022Config();
