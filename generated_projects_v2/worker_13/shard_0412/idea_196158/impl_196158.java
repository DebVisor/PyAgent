...
@Data
public class Idea196158Config {
    private String name = "idea_196158";
 ...
 */
@Slf4j
public class Idea196158Service {
    private static final int IDEA_ID = 196158;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196158Service() {
        this(new Idea196158Config());
    }

    public Idea196158Service(Idea196158Config config) {
        this.config = config != null ? config : new Idea196158Config();
