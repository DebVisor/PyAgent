...
@Data
public class Idea196004Config {
    private String name = "idea_196004";
 ...
 */
@Slf4j
public class Idea196004Service {
    private static final int IDEA_ID = 196004;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196004Service() {
        this(new Idea196004Config());
    }

    public Idea196004Service(Idea196004Config config) {
        this.config = config != null ? config : new Idea196004Config();
