...
@Data
public class Idea196013Config {
    private String name = "idea_196013";
 ...
 */
@Slf4j
public class Idea196013Service {
    private static final int IDEA_ID = 196013;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196013Service() {
        this(new Idea196013Config());
    }

    public Idea196013Service(Idea196013Config config) {
        this.config = config != null ? config : new Idea196013Config();
