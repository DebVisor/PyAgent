...
@Data
public class Idea195891Config {
    private String name = "idea_195891";
 ...
 */
@Slf4j
public class Idea195891Service {
    private static final int IDEA_ID = 195891;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195891Service() {
        this(new Idea195891Config());
    }

    public Idea195891Service(Idea195891Config config) {
        this.config = config != null ? config : new Idea195891Config();
