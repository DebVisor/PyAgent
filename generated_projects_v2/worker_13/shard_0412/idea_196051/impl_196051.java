...
@Data
public class Idea196051Config {
    private String name = "idea_196051";
 ...
 */
@Slf4j
public class Idea196051Service {
    private static final int IDEA_ID = 196051;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196051Service() {
        this(new Idea196051Config());
    }

    public Idea196051Service(Idea196051Config config) {
        this.config = config != null ? config : new Idea196051Config();
