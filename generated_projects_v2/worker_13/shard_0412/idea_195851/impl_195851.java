...
@Data
public class Idea195851Config {
    private String name = "idea_195851";
 ...
 */
@Slf4j
public class Idea195851Service {
    private static final int IDEA_ID = 195851;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195851Service() {
        this(new Idea195851Config());
    }

    public Idea195851Service(Idea195851Config config) {
        this.config = config != null ? config : new Idea195851Config();
