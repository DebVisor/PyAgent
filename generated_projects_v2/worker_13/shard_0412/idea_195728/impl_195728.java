...
@Data
public class Idea195728Config {
    private String name = "idea_195728";
 ...
 */
@Slf4j
public class Idea195728Service {
    private static final int IDEA_ID = 195728;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195728Service() {
        this(new Idea195728Config());
    }

    public Idea195728Service(Idea195728Config config) {
        this.config = config != null ? config : new Idea195728Config();
