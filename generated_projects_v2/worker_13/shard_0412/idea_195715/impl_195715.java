...
@Data
public class Idea195715Config {
    private String name = "idea_195715";
 ...
 */
@Slf4j
public class Idea195715Service {
    private static final int IDEA_ID = 195715;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195715Service() {
        this(new Idea195715Config());
    }

    public Idea195715Service(Idea195715Config config) {
        this.config = config != null ? config : new Idea195715Config();
