...
@Data
public class Idea195730Config {
    private String name = "idea_195730";
 ...
 */
@Slf4j
public class Idea195730Service {
    private static final int IDEA_ID = 195730;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195730Service() {
        this(new Idea195730Config());
    }

    public Idea195730Service(Idea195730Config config) {
        this.config = config != null ? config : new Idea195730Config();
