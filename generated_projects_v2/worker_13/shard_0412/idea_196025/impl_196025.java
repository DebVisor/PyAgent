...
@Data
public class Idea196025Config {
    private String name = "idea_196025";
 ...
 */
@Slf4j
public class Idea196025Service {
    private static final int IDEA_ID = 196025;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196025Service() {
        this(new Idea196025Config());
    }

    public Idea196025Service(Idea196025Config config) {
        this.config = config != null ? config : new Idea196025Config();
