...
@Data
public class Idea196128Config {
    private String name = "idea_196128";
 ...
 */
@Slf4j
public class Idea196128Service {
    private static final int IDEA_ID = 196128;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196128Service() {
        this(new Idea196128Config());
    }

    public Idea196128Service(Idea196128Config config) {
        this.config = config != null ? config : new Idea196128Config();
