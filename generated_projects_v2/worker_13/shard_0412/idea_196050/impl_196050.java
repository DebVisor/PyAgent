...
@Data
public class Idea196050Config {
    private String name = "idea_196050";
 ...
 */
@Slf4j
public class Idea196050Service {
    private static final int IDEA_ID = 196050;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196050Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196050Service() {
        this(new Idea196050Config());
    }

    public Idea196050Service(Idea196050Config config) {
        this.config = config != null ? config : new Idea196050Config();
