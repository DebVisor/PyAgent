...
@Data
public class Idea195833Config {
    private String name = "idea_195833";
 ...
 */
@Slf4j
public class Idea195833Service {
    private static final int IDEA_ID = 195833;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195833Service() {
        this(new Idea195833Config());
    }

    public Idea195833Service(Idea195833Config config) {
        this.config = config != null ? config : new Idea195833Config();
