...
@Data
public class Idea195895Config {
    private String name = "idea_195895";
 ...
 */
@Slf4j
public class Idea195895Service {
    private static final int IDEA_ID = 195895;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195895Service() {
        this(new Idea195895Config());
    }

    public Idea195895Service(Idea195895Config config) {
        this.config = config != null ? config : new Idea195895Config();
