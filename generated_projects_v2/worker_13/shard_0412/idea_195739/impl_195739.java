...
@Data
public class Idea195739Config {
    private String name = "idea_195739";
 ...
 */
@Slf4j
public class Idea195739Service {
    private static final int IDEA_ID = 195739;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195739Service() {
        this(new Idea195739Config());
    }

    public Idea195739Service(Idea195739Config config) {
        this.config = config != null ? config : new Idea195739Config();
