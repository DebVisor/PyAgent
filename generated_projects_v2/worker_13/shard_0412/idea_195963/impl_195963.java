...
@Data
public class Idea195963Config {
    private String name = "idea_195963";
 ...
 */
@Slf4j
public class Idea195963Service {
    private static final int IDEA_ID = 195963;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195963Service() {
        this(new Idea195963Config());
    }

    public Idea195963Service(Idea195963Config config) {
        this.config = config != null ? config : new Idea195963Config();
