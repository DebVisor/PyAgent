...
@Data
public class Idea196107Config {
    private String name = "idea_196107";
 ...
 */
@Slf4j
public class Idea196107Service {
    private static final int IDEA_ID = 196107;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196107Service() {
        this(new Idea196107Config());
    }

    public Idea196107Service(Idea196107Config config) {
        this.config = config != null ? config : new Idea196107Config();
