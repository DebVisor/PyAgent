...
@Data
public class Idea196020Config {
    private String name = "idea_196020";
 ...
 */
@Slf4j
public class Idea196020Service {
    private static final int IDEA_ID = 196020;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196020Service() {
        this(new Idea196020Config());
    }

    public Idea196020Service(Idea196020Config config) {
        this.config = config != null ? config : new Idea196020Config();
