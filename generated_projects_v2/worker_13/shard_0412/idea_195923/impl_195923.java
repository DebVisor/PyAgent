...
@Data
public class Idea195923Config {
    private String name = "idea_195923";
 ...
 */
@Slf4j
public class Idea195923Service {
    private static final int IDEA_ID = 195923;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195923Service() {
        this(new Idea195923Config());
    }

    public Idea195923Service(Idea195923Config config) {
        this.config = config != null ? config : new Idea195923Config();
