...
@Data
public class Idea195815Config {
    private String name = "idea_195815";
 ...
 */
@Slf4j
public class Idea195815Service {
    private static final int IDEA_ID = 195815;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195815Service() {
        this(new Idea195815Config());
    }

    public Idea195815Service(Idea195815Config config) {
        this.config = config != null ? config : new Idea195815Config();
