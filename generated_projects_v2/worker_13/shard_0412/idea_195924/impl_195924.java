...
@Data
public class Idea195924Config {
    private String name = "idea_195924";
 ...
 */
@Slf4j
public class Idea195924Service {
    private static final int IDEA_ID = 195924;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195924Service() {
        this(new Idea195924Config());
    }

    public Idea195924Service(Idea195924Config config) {
        this.config = config != null ? config : new Idea195924Config();
