...
@Data
public class Idea196070Config {
    private String name = "idea_196070";
 ...
 */
@Slf4j
public class Idea196070Service {
    private static final int IDEA_ID = 196070;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196070Service() {
        this(new Idea196070Config());
    }

    public Idea196070Service(Idea196070Config config) {
        this.config = config != null ? config : new Idea196070Config();
