...
@Data
public class Idea195965Config {
    private String name = "idea_195965";
 ...
 */
@Slf4j
public class Idea195965Service {
    private static final int IDEA_ID = 195965;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195965Service() {
        this(new Idea195965Config());
    }

    public Idea195965Service(Idea195965Config config) {
        this.config = config != null ? config : new Idea195965Config();
