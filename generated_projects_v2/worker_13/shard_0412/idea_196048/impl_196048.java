...
@Data
public class Idea196048Config {
    private String name = "idea_196048";
 ...
 */
@Slf4j
public class Idea196048Service {
    private static final int IDEA_ID = 196048;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196048Service() {
        this(new Idea196048Config());
    }

    public Idea196048Service(Idea196048Config config) {
        this.config = config != null ? config : new Idea196048Config();
