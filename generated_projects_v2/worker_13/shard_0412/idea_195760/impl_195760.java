...
@Data
public class Idea195760Config {
    private String name = "idea_195760";
 ...
 */
@Slf4j
public class Idea195760Service {
    private static final int IDEA_ID = 195760;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195760Service() {
        this(new Idea195760Config());
    }

    public Idea195760Service(Idea195760Config config) {
        this.config = config != null ? config : new Idea195760Config();
