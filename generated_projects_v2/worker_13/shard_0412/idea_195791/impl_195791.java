...
@Data
public class Idea195791Config {
    private String name = "idea_195791";
 ...
 */
@Slf4j
public class Idea195791Service {
    private static final int IDEA_ID = 195791;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195791Service() {
        this(new Idea195791Config());
    }

    public Idea195791Service(Idea195791Config config) {
        this.config = config != null ? config : new Idea195791Config();
