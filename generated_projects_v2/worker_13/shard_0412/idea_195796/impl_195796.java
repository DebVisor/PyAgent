...
@Data
public class Idea195796Config {
    private String name = "idea_195796";
 ...
 */
@Slf4j
public class Idea195796Service {
    private static final int IDEA_ID = 195796;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195796Service() {
        this(new Idea195796Config());
    }

    public Idea195796Service(Idea195796Config config) {
        this.config = config != null ? config : new Idea195796Config();
