...
@Data
public class Idea195994Config {
    private String name = "idea_195994";
 ...
 */
@Slf4j
public class Idea195994Service {
    private static final int IDEA_ID = 195994;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195994Service() {
        this(new Idea195994Config());
    }

    public Idea195994Service(Idea195994Config config) {
        this.config = config != null ? config : new Idea195994Config();
