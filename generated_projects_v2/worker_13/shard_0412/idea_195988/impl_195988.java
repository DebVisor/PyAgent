...
@Data
public class Idea195988Config {
    private String name = "idea_195988";
 ...
 */
@Slf4j
public class Idea195988Service {
    private static final int IDEA_ID = 195988;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195988Service() {
        this(new Idea195988Config());
    }

    public Idea195988Service(Idea195988Config config) {
        this.config = config != null ? config : new Idea195988Config();
