...
@Data
public class Idea195861Config {
    private String name = "idea_195861";
 ...
 */
@Slf4j
public class Idea195861Service {
    private static final int IDEA_ID = 195861;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195861Service() {
        this(new Idea195861Config());
    }

    public Idea195861Service(Idea195861Config config) {
        this.config = config != null ? config : new Idea195861Config();
