...
@Data
public class Idea195914Config {
    private String name = "idea_195914";
 ...
 */
@Slf4j
public class Idea195914Service {
    private static final int IDEA_ID = 195914;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195914Service() {
        this(new Idea195914Config());
    }

    public Idea195914Service(Idea195914Config config) {
        this.config = config != null ? config : new Idea195914Config();
