...
@Data
public class Idea195748Config {
    private String name = "idea_195748";
 ...
 */
@Slf4j
public class Idea195748Service {
    private static final int IDEA_ID = 195748;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195748Service() {
        this(new Idea195748Config());
    }

    public Idea195748Service(Idea195748Config config) {
        this.config = config != null ? config : new Idea195748Config();
