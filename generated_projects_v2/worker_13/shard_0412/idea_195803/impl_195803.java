...
@Data
public class Idea195803Config {
    private String name = "idea_195803";
 ...
 */
@Slf4j
public class Idea195803Service {
    private static final int IDEA_ID = 195803;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195803Service() {
        this(new Idea195803Config());
    }

    public Idea195803Service(Idea195803Config config) {
        this.config = config != null ? config : new Idea195803Config();
