...
@Data
public class Idea196104Config {
    private String name = "idea_196104";
 ...
 */
@Slf4j
public class Idea196104Service {
    private static final int IDEA_ID = 196104;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196104Service() {
        this(new Idea196104Config());
    }

    public Idea196104Service(Idea196104Config config) {
        this.config = config != null ? config : new Idea196104Config();
