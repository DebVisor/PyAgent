...
@Data
public class Idea195986Config {
    private String name = "idea_195986";
 ...
 */
@Slf4j
public class Idea195986Service {
    private static final int IDEA_ID = 195986;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195986Service() {
        this(new Idea195986Config());
    }

    public Idea195986Service(Idea195986Config config) {
        this.config = config != null ? config : new Idea195986Config();
