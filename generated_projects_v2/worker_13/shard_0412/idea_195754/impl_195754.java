...
@Data
public class Idea195754Config {
    private String name = "idea_195754";
 ...
 */
@Slf4j
public class Idea195754Service {
    private static final int IDEA_ID = 195754;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195754Service() {
        this(new Idea195754Config());
    }

    public Idea195754Service(Idea195754Config config) {
        this.config = config != null ? config : new Idea195754Config();
