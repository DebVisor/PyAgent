...
@Data
public class Idea196122Config {
    private String name = "idea_196122";
 ...
 */
@Slf4j
public class Idea196122Service {
    private static final int IDEA_ID = 196122;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196122Service() {
        this(new Idea196122Config());
    }

    public Idea196122Service(Idea196122Config config) {
        this.config = config != null ? config : new Idea196122Config();
