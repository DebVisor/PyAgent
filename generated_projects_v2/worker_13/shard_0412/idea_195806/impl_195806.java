...
@Data
public class Idea195806Config {
    private String name = "idea_195806";
 ...
 */
@Slf4j
public class Idea195806Service {
    private static final int IDEA_ID = 195806;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195806Service() {
        this(new Idea195806Config());
    }

    public Idea195806Service(Idea195806Config config) {
        this.config = config != null ? config : new Idea195806Config();
