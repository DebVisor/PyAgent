...
@Data
public class Idea196021Config {
    private String name = "idea_196021";
 ...
 */
@Slf4j
public class Idea196021Service {
    private static final int IDEA_ID = 196021;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196021Service() {
        this(new Idea196021Config());
    }

    public Idea196021Service(Idea196021Config config) {
        this.config = config != null ? config : new Idea196021Config();
