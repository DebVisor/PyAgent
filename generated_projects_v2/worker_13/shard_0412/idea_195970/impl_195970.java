...
@Data
public class Idea195970Config {
    private String name = "idea_195970";
 ...
 */
@Slf4j
public class Idea195970Service {
    private static final int IDEA_ID = 195970;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195970Service() {
        this(new Idea195970Config());
    }

    public Idea195970Service(Idea195970Config config) {
        this.config = config != null ? config : new Idea195970Config();
