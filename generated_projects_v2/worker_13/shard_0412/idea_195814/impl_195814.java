...
@Data
public class Idea195814Config {
    private String name = "idea_195814";
 ...
 */
@Slf4j
public class Idea195814Service {
    private static final int IDEA_ID = 195814;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195814Service() {
        this(new Idea195814Config());
    }

    public Idea195814Service(Idea195814Config config) {
        this.config = config != null ? config : new Idea195814Config();
