...
@Data
public class Idea195834Config {
    private String name = "idea_195834";
 ...
 */
@Slf4j
public class Idea195834Service {
    private static final int IDEA_ID = 195834;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195834Service() {
        this(new Idea195834Config());
    }

    public Idea195834Service(Idea195834Config config) {
        this.config = config != null ? config : new Idea195834Config();
