...
@Data
public class Idea196080Config {
    private String name = "idea_196080";
 ...
 */
@Slf4j
public class Idea196080Service {
    private static final int IDEA_ID = 196080;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196080Service() {
        this(new Idea196080Config());
    }

    public Idea196080Service(Idea196080Config config) {
        this.config = config != null ? config : new Idea196080Config();
