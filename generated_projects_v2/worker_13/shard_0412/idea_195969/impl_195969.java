...
@Data
public class Idea195969Config {
    private String name = "idea_195969";
 ...
 */
@Slf4j
public class Idea195969Service {
    private static final int IDEA_ID = 195969;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195969Service() {
        this(new Idea195969Config());
    }

    public Idea195969Service(Idea195969Config config) {
        this.config = config != null ? config : new Idea195969Config();
