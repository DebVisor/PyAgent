...
@Data
public class Idea195745Config {
    private String name = "idea_195745";
 ...
 */
@Slf4j
public class Idea195745Service {
    private static final int IDEA_ID = 195745;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195745Service() {
        this(new Idea195745Config());
    }

    public Idea195745Service(Idea195745Config config) {
        this.config = config != null ? config : new Idea195745Config();
