...
@Data
public class Idea195909Config {
    private String name = "idea_195909";
 ...
 */
@Slf4j
public class Idea195909Service {
    private static final int IDEA_ID = 195909;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195909Service() {
        this(new Idea195909Config());
    }

    public Idea195909Service(Idea195909Config config) {
        this.config = config != null ? config : new Idea195909Config();
