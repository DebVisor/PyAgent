...
@Data
public class Idea195708Config {
    private String name = "idea_195708";
 ...
 */
@Slf4j
public class Idea195708Service {
    private static final int IDEA_ID = 195708;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195708Service() {
        this(new Idea195708Config());
    }

    public Idea195708Service(Idea195708Config config) {
        this.config = config != null ? config : new Idea195708Config();
