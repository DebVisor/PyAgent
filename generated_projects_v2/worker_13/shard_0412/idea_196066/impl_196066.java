...
@Data
public class Idea196066Config {
    private String name = "idea_196066";
 ...
 */
@Slf4j
public class Idea196066Service {
    private static final int IDEA_ID = 196066;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196066Service() {
        this(new Idea196066Config());
    }

    public Idea196066Service(Idea196066Config config) {
        this.config = config != null ? config : new Idea196066Config();
