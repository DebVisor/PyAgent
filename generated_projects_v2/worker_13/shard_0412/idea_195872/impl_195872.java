...
@Data
public class Idea195872Config {
    private String name = "idea_195872";
 ...
 */
@Slf4j
public class Idea195872Service {
    private static final int IDEA_ID = 195872;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195872Service() {
        this(new Idea195872Config());
    }

    public Idea195872Service(Idea195872Config config) {
        this.config = config != null ? config : new Idea195872Config();
