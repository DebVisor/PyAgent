...
@Data
public class Idea195992Config {
    private String name = "idea_195992";
 ...
 */
@Slf4j
public class Idea195992Service {
    private static final int IDEA_ID = 195992;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195992Service() {
        this(new Idea195992Config());
    }

    public Idea195992Service(Idea195992Config config) {
        this.config = config != null ? config : new Idea195992Config();
