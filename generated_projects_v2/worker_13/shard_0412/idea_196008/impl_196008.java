...
@Data
public class Idea196008Config {
    private String name = "idea_196008";
 ...
 */
@Slf4j
public class Idea196008Service {
    private static final int IDEA_ID = 196008;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196008Service() {
        this(new Idea196008Config());
    }

    public Idea196008Service(Idea196008Config config) {
        this.config = config != null ? config : new Idea196008Config();
