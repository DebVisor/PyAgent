...
@Data
public class Idea196131Config {
    private String name = "idea_196131";
 ...
 */
@Slf4j
public class Idea196131Service {
    private static final int IDEA_ID = 196131;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196131Service() {
        this(new Idea196131Config());
    }

    public Idea196131Service(Idea196131Config config) {
        this.config = config != null ? config : new Idea196131Config();
