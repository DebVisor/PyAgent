...
@Data
public class Idea195800Config {
    private String name = "idea_195800";
 ...
 */
@Slf4j
public class Idea195800Service {
    private static final int IDEA_ID = 195800;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195800Service() {
        this(new Idea195800Config());
    }

    public Idea195800Service(Idea195800Config config) {
        this.config = config != null ? config : new Idea195800Config();
