...
@Data
public class Idea195887Config {
    private String name = "idea_195887";
 ...
 */
@Slf4j
public class Idea195887Service {
    private static final int IDEA_ID = 195887;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195887Service() {
        this(new Idea195887Config());
    }

    public Idea195887Service(Idea195887Config config) {
        this.config = config != null ? config : new Idea195887Config();
