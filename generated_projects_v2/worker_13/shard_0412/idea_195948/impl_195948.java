...
@Data
public class Idea195948Config {
    private String name = "idea_195948";
 ...
 */
@Slf4j
public class Idea195948Service {
    private static final int IDEA_ID = 195948;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195948Service() {
        this(new Idea195948Config());
    }

    public Idea195948Service(Idea195948Config config) {
        this.config = config != null ? config : new Idea195948Config();
