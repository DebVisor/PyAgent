...
@Data
public class Idea195784Config {
    private String name = "idea_195784";
 ...
 */
@Slf4j
public class Idea195784Service {
    private static final int IDEA_ID = 195784;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195784Service() {
        this(new Idea195784Config());
    }

    public Idea195784Service(Idea195784Config config) {
        this.config = config != null ? config : new Idea195784Config();
