...
@Data
public class Idea195993Config {
    private String name = "idea_195993";
 ...
 */
@Slf4j
public class Idea195993Service {
    private static final int IDEA_ID = 195993;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195993Service() {
        this(new Idea195993Config());
    }

    public Idea195993Service(Idea195993Config config) {
        this.config = config != null ? config : new Idea195993Config();
