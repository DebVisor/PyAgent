...
@Data
public class Idea196141Config {
    private String name = "idea_196141";
 ...
 */
@Slf4j
public class Idea196141Service {
    private static final int IDEA_ID = 196141;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196141Service() {
        this(new Idea196141Config());
    }

    public Idea196141Service(Idea196141Config config) {
        this.config = config != null ? config : new Idea196141Config();
