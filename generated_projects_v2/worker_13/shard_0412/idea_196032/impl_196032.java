...
@Data
public class Idea196032Config {
    private String name = "idea_196032";
 ...
 */
@Slf4j
public class Idea196032Service {
    private static final int IDEA_ID = 196032;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196032Service() {
        this(new Idea196032Config());
    }

    public Idea196032Service(Idea196032Config config) {
        this.config = config != null ? config : new Idea196032Config();
