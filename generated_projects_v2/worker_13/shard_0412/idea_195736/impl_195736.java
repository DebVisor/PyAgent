...
@Data
public class Idea195736Config {
    private String name = "idea_195736";
 ...
 */
@Slf4j
public class Idea195736Service {
    private static final int IDEA_ID = 195736;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195736Service() {
        this(new Idea195736Config());
    }

    public Idea195736Service(Idea195736Config config) {
        this.config = config != null ? config : new Idea195736Config();
