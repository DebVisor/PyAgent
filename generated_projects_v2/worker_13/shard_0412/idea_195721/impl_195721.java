...
@Data
public class Idea195721Config {
    private String name = "idea_195721";
 ...
 */
@Slf4j
public class Idea195721Service {
    private static final int IDEA_ID = 195721;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195721Service() {
        this(new Idea195721Config());
    }

    public Idea195721Service(Idea195721Config config) {
        this.config = config != null ? config : new Idea195721Config();
