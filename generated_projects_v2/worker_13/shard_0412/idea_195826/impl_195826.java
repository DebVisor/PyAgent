...
@Data
public class Idea195826Config {
    private String name = "idea_195826";
 ...
 */
@Slf4j
public class Idea195826Service {
    private static final int IDEA_ID = 195826;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195826Service() {
        this(new Idea195826Config());
    }

    public Idea195826Service(Idea195826Config config) {
        this.config = config != null ? config : new Idea195826Config();
