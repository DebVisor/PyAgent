...
@Data
public class Idea196043Config {
    private String name = "idea_196043";
 ...
 */
@Slf4j
public class Idea196043Service {
    private static final int IDEA_ID = 196043;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196043Service() {
        this(new Idea196043Config());
    }

    public Idea196043Service(Idea196043Config config) {
        this.config = config != null ? config : new Idea196043Config();
