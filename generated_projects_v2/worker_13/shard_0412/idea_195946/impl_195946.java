...
@Data
public class Idea195946Config {
    private String name = "idea_195946";
 ...
 */
@Slf4j
public class Idea195946Service {
    private static final int IDEA_ID = 195946;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195946Service() {
        this(new Idea195946Config());
    }

    public Idea195946Service(Idea195946Config config) {
        this.config = config != null ? config : new Idea195946Config();
