...
@Data
public class Idea195864Config {
    private String name = "idea_195864";
 ...
 */
@Slf4j
public class Idea195864Service {
    private static final int IDEA_ID = 195864;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195864Service() {
        this(new Idea195864Config());
    }

    public Idea195864Service(Idea195864Config config) {
        this.config = config != null ? config : new Idea195864Config();
