...
@Data
public class Idea195805Config {
    private String name = "idea_195805";
 ...
 */
@Slf4j
public class Idea195805Service {
    private static final int IDEA_ID = 195805;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195805Service() {
        this(new Idea195805Config());
    }

    public Idea195805Service(Idea195805Config config) {
        this.config = config != null ? config : new Idea195805Config();
