...
@Data
public class Idea195925Config {
    private String name = "idea_195925";
 ...
 */
@Slf4j
public class Idea195925Service {
    private static final int IDEA_ID = 195925;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195925Service() {
        this(new Idea195925Config());
    }

    public Idea195925Service(Idea195925Config config) {
        this.config = config != null ? config : new Idea195925Config();
