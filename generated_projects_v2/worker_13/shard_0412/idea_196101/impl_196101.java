...
@Data
public class Idea196101Config {
    private String name = "idea_196101";
 ...
 */
@Slf4j
public class Idea196101Service {
    private static final int IDEA_ID = 196101;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196101Service() {
        this(new Idea196101Config());
    }

    public Idea196101Service(Idea196101Config config) {
        this.config = config != null ? config : new Idea196101Config();
