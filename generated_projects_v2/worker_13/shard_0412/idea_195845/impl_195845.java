...
@Data
public class Idea195845Config {
    private String name = "idea_195845";
 ...
 */
@Slf4j
public class Idea195845Service {
    private static final int IDEA_ID = 195845;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195845Service() {
        this(new Idea195845Config());
    }

    public Idea195845Service(Idea195845Config config) {
        this.config = config != null ? config : new Idea195845Config();
