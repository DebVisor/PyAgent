...
@Data
public class Idea195823Config {
    private String name = "idea_195823";
 ...
 */
@Slf4j
public class Idea195823Service {
    private static final int IDEA_ID = 195823;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195823Service() {
        this(new Idea195823Config());
    }

    public Idea195823Service(Idea195823Config config) {
        this.config = config != null ? config : new Idea195823Config();
