...
@Data
public class Idea195931Config {
    private String name = "idea_195931";
 ...
 */
@Slf4j
public class Idea195931Service {
    private static final int IDEA_ID = 195931;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195931Service() {
        this(new Idea195931Config());
    }

    public Idea195931Service(Idea195931Config config) {
        this.config = config != null ? config : new Idea195931Config();
