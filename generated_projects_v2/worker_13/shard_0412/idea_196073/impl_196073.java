...
@Data
public class Idea196073Config {
    private String name = "idea_196073";
 ...
 */
@Slf4j
public class Idea196073Service {
    private static final int IDEA_ID = 196073;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196073Service() {
        this(new Idea196073Config());
    }

    public Idea196073Service(Idea196073Config config) {
        this.config = config != null ? config : new Idea196073Config();
