...
@Data
public class Idea196068Config {
    private String name = "idea_196068";
 ...
 */
@Slf4j
public class Idea196068Service {
    private static final int IDEA_ID = 196068;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196068Service() {
        this(new Idea196068Config());
    }

    public Idea196068Service(Idea196068Config config) {
        this.config = config != null ? config : new Idea196068Config();
