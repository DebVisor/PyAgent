...
@Data
public class Idea195862Config {
    private String name = "idea_195862";
 ...
 */
@Slf4j
public class Idea195862Service {
    private static final int IDEA_ID = 195862;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195862Service() {
        this(new Idea195862Config());
    }

    public Idea195862Service(Idea195862Config config) {
        this.config = config != null ? config : new Idea195862Config();
