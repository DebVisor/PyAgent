...
@Data
public class Idea195742Config {
    private String name = "idea_195742";
 ...
 */
@Slf4j
public class Idea195742Service {
    private static final int IDEA_ID = 195742;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195742Service() {
        this(new Idea195742Config());
    }

    public Idea195742Service(Idea195742Config config) {
        this.config = config != null ? config : new Idea195742Config();
