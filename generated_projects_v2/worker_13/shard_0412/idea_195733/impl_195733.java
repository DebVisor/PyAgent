...
@Data
public class Idea195733Config {
    private String name = "idea_195733";
 ...
 */
@Slf4j
public class Idea195733Service {
    private static final int IDEA_ID = 195733;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195733Service() {
        this(new Idea195733Config());
    }

    public Idea195733Service(Idea195733Config config) {
        this.config = config != null ? config : new Idea195733Config();
