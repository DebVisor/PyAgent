...
@Data
public class Idea195990Config {
    private String name = "idea_195990";
 ...
 */
@Slf4j
public class Idea195990Service {
    private static final int IDEA_ID = 195990;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195990Service() {
        this(new Idea195990Config());
    }

    public Idea195990Service(Idea195990Config config) {
        this.config = config != null ? config : new Idea195990Config();
