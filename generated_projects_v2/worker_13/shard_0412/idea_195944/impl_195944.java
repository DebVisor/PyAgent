...
@Data
public class Idea195944Config {
    private String name = "idea_195944";
 ...
 */
@Slf4j
public class Idea195944Service {
    private static final int IDEA_ID = 195944;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195944Service() {
        this(new Idea195944Config());
    }

    public Idea195944Service(Idea195944Config config) {
        this.config = config != null ? config : new Idea195944Config();
