...
@Data
public class Idea195884Config {
    private String name = "idea_195884";
 ...
 */
@Slf4j
public class Idea195884Service {
    private static final int IDEA_ID = 195884;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195884Service() {
        this(new Idea195884Config());
    }

    public Idea195884Service(Idea195884Config config) {
        this.config = config != null ? config : new Idea195884Config();
