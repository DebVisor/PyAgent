...
@Data
public class Idea195885Config {
    private String name = "idea_195885";
 ...
 */
@Slf4j
public class Idea195885Service {
    private static final int IDEA_ID = 195885;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195885Service() {
        this(new Idea195885Config());
    }

    public Idea195885Service(Idea195885Config config) {
        this.config = config != null ? config : new Idea195885Config();
