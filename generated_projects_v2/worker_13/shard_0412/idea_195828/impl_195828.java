...
@Data
public class Idea195828Config {
    private String name = "idea_195828";
 ...
 */
@Slf4j
public class Idea195828Service {
    private static final int IDEA_ID = 195828;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195828Service() {
        this(new Idea195828Config());
    }

    public Idea195828Service(Idea195828Config config) {
        this.config = config != null ? config : new Idea195828Config();
