...
@Data
public class Idea195766Config {
    private String name = "idea_195766";
 ...
 */
@Slf4j
public class Idea195766Service {
    private static final int IDEA_ID = 195766;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195766Service() {
        this(new Idea195766Config());
    }

    public Idea195766Service(Idea195766Config config) {
        this.config = config != null ? config : new Idea195766Config();
