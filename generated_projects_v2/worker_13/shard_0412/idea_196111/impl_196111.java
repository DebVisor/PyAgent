...
@Data
public class Idea196111Config {
    private String name = "idea_196111";
 ...
 */
@Slf4j
public class Idea196111Service {
    private static final int IDEA_ID = 196111;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196111Service() {
        this(new Idea196111Config());
    }

    public Idea196111Service(Idea196111Config config) {
        this.config = config != null ? config : new Idea196111Config();
