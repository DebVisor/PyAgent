...
@Data
public class Idea195781Config {
    private String name = "idea_195781";
 ...
 */
@Slf4j
public class Idea195781Service {
    private static final int IDEA_ID = 195781;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195781Service() {
        this(new Idea195781Config());
    }

    public Idea195781Service(Idea195781Config config) {
        this.config = config != null ? config : new Idea195781Config();
