...
@Data
public class Idea196092Config {
    private String name = "idea_196092";
 ...
 */
@Slf4j
public class Idea196092Service {
    private static final int IDEA_ID = 196092;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196092Service() {
        this(new Idea196092Config());
    }

    public Idea196092Service(Idea196092Config config) {
        this.config = config != null ? config : new Idea196092Config();
