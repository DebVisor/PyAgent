...
@Data
public class Idea196045Config {
    private String name = "idea_196045";
 ...
 */
@Slf4j
public class Idea196045Service {
    private static final int IDEA_ID = 196045;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196045Service() {
        this(new Idea196045Config());
    }

    public Idea196045Service(Idea196045Config config) {
        this.config = config != null ? config : new Idea196045Config();
