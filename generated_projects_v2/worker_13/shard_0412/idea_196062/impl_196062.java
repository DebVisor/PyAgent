...
@Data
public class Idea196062Config {
    private String name = "idea_196062";
 ...
 */
@Slf4j
public class Idea196062Service {
    private static final int IDEA_ID = 196062;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196062Service() {
        this(new Idea196062Config());
    }

    public Idea196062Service(Idea196062Config config) {
        this.config = config != null ? config : new Idea196062Config();
