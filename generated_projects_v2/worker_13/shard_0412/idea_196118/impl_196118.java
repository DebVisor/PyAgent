...
@Data
public class Idea196118Config {
    private String name = "idea_196118";
 ...
 */
@Slf4j
public class Idea196118Service {
    private static final int IDEA_ID = 196118;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196118Service() {
        this(new Idea196118Config());
    }

    public Idea196118Service(Idea196118Config config) {
        this.config = config != null ? config : new Idea196118Config();
