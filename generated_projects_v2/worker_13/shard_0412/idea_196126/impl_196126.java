...
@Data
public class Idea196126Config {
    private String name = "idea_196126";
 ...
 */
@Slf4j
public class Idea196126Service {
    private static final int IDEA_ID = 196126;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196126Service() {
        this(new Idea196126Config());
    }

    public Idea196126Service(Idea196126Config config) {
        this.config = config != null ? config : new Idea196126Config();
