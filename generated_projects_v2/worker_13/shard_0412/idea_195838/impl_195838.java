...
@Data
public class Idea195838Config {
    private String name = "idea_195838";
 ...
 */
@Slf4j
public class Idea195838Service {
    private static final int IDEA_ID = 195838;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195838Service() {
        this(new Idea195838Config());
    }

    public Idea195838Service(Idea195838Config config) {
        this.config = config != null ? config : new Idea195838Config();
