...
@Data
public class Idea195956Config {
    private String name = "idea_195956";
 ...
 */
@Slf4j
public class Idea195956Service {
    private static final int IDEA_ID = 195956;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195956Service() {
        this(new Idea195956Config());
    }

    public Idea195956Service(Idea195956Config config) {
        this.config = config != null ? config : new Idea195956Config();
