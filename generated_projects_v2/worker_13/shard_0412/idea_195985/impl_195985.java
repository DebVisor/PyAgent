...
@Data
public class Idea195985Config {
    private String name = "idea_195985";
 ...
 */
@Slf4j
public class Idea195985Service {
    private static final int IDEA_ID = 195985;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195985Service() {
        this(new Idea195985Config());
    }

    public Idea195985Service(Idea195985Config config) {
        this.config = config != null ? config : new Idea195985Config();
