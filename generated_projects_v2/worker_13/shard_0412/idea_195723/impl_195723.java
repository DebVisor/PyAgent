...
@Data
public class Idea195723Config {
    private String name = "idea_195723";
 ...
 */
@Slf4j
public class Idea195723Service {
    private static final int IDEA_ID = 195723;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195723Service() {
        this(new Idea195723Config());
    }

    public Idea195723Service(Idea195723Config config) {
        this.config = config != null ? config : new Idea195723Config();
