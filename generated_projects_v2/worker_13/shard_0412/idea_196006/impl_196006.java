...
@Data
public class Idea196006Config {
    private String name = "idea_196006";
 ...
 */
@Slf4j
public class Idea196006Service {
    private static final int IDEA_ID = 196006;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196006Service() {
        this(new Idea196006Config());
    }

    public Idea196006Service(Idea196006Config config) {
        this.config = config != null ? config : new Idea196006Config();
