...
@Data
public class Idea195722Config {
    private String name = "idea_195722";
 ...
 */
@Slf4j
public class Idea195722Service {
    private static final int IDEA_ID = 195722;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195722Service() {
        this(new Idea195722Config());
    }

    public Idea195722Service(Idea195722Config config) {
        this.config = config != null ? config : new Idea195722Config();
