...
@Data
public class Idea195811Config {
    private String name = "idea_195811";
 ...
 */
@Slf4j
public class Idea195811Service {
    private static final int IDEA_ID = 195811;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195811Service() {
        this(new Idea195811Config());
    }

    public Idea195811Service(Idea195811Config config) {
        this.config = config != null ? config : new Idea195811Config();
