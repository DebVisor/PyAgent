...
@Data
public class Idea195761Config {
    private String name = "idea_195761";
 ...
 */
@Slf4j
public class Idea195761Service {
    private static final int IDEA_ID = 195761;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195761Service() {
        this(new Idea195761Config());
    }

    public Idea195761Service(Idea195761Config config) {
        this.config = config != null ? config : new Idea195761Config();
