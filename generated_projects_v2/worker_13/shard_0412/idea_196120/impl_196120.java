...
@Data
public class Idea196120Config {
    private String name = "idea_196120";
 ...
 */
@Slf4j
public class Idea196120Service {
    private static final int IDEA_ID = 196120;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196120Service() {
        this(new Idea196120Config());
    }

    public Idea196120Service(Idea196120Config config) {
        this.config = config != null ? config : new Idea196120Config();
