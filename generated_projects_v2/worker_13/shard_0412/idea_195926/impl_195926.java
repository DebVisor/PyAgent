...
@Data
public class Idea195926Config {
    private String name = "idea_195926";
 ...
 */
@Slf4j
public class Idea195926Service {
    private static final int IDEA_ID = 195926;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195926Service() {
        this(new Idea195926Config());
    }

    public Idea195926Service(Idea195926Config config) {
        this.config = config != null ? config : new Idea195926Config();
