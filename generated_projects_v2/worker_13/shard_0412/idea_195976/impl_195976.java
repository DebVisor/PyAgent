...
@Data
public class Idea195976Config {
    private String name = "idea_195976";
 ...
 */
@Slf4j
public class Idea195976Service {
    private static final int IDEA_ID = 195976;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195976Service() {
        this(new Idea195976Config());
    }

    public Idea195976Service(Idea195976Config config) {
        this.config = config != null ? config : new Idea195976Config();
