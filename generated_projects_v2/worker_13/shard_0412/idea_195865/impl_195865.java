...
@Data
public class Idea195865Config {
    private String name = "idea_195865";
 ...
 */
@Slf4j
public class Idea195865Service {
    private static final int IDEA_ID = 195865;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195865Service() {
        this(new Idea195865Config());
    }

    public Idea195865Service(Idea195865Config config) {
        this.config = config != null ? config : new Idea195865Config();
