...
@Data
public class Idea196009Config {
    private String name = "idea_196009";
 ...
 */
@Slf4j
public class Idea196009Service {
    private static final int IDEA_ID = 196009;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196009Service() {
        this(new Idea196009Config());
    }

    public Idea196009Service(Idea196009Config config) {
        this.config = config != null ? config : new Idea196009Config();
