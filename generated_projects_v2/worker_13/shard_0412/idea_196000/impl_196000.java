...
@Data
public class Idea196000Config {
    private String name = "idea_196000";
 ...
 */
@Slf4j
public class Idea196000Service {
    private static final int IDEA_ID = 196000;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196000Service() {
        this(new Idea196000Config());
    }

    public Idea196000Service(Idea196000Config config) {
        this.config = config != null ? config : new Idea196000Config();
