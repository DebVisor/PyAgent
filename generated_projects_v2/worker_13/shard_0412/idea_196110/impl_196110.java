...
@Data
public class Idea196110Config {
    private String name = "idea_196110";
 ...
 */
@Slf4j
public class Idea196110Service {
    private static final int IDEA_ID = 196110;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196110Service() {
        this(new Idea196110Config());
    }

    public Idea196110Service(Idea196110Config config) {
        this.config = config != null ? config : new Idea196110Config();
