...
@Data
public class Idea195871Config {
    private String name = "idea_195871";
 ...
 */
@Slf4j
public class Idea195871Service {
    private static final int IDEA_ID = 195871;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195871Service() {
        this(new Idea195871Config());
    }

    public Idea195871Service(Idea195871Config config) {
        this.config = config != null ? config : new Idea195871Config();
