...
@Data
public class Idea195874Config {
    private String name = "idea_195874";
 ...
 */
@Slf4j
public class Idea195874Service {
    private static final int IDEA_ID = 195874;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195874Service() {
        this(new Idea195874Config());
    }

    public Idea195874Service(Idea195874Config config) {
        this.config = config != null ? config : new Idea195874Config();
