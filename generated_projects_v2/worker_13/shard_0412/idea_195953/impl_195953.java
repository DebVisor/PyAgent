...
@Data
public class Idea195953Config {
    private String name = "idea_195953";
 ...
 */
@Slf4j
public class Idea195953Service {
    private static final int IDEA_ID = 195953;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195953Service() {
        this(new Idea195953Config());
    }

    public Idea195953Service(Idea195953Config config) {
        this.config = config != null ? config : new Idea195953Config();
