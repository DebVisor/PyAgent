...
@Data
public class Idea196047Config {
    private String name = "idea_196047";
 ...
 */
@Slf4j
public class Idea196047Service {
    private static final int IDEA_ID = 196047;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196047Service() {
        this(new Idea196047Config());
    }

    public Idea196047Service(Idea196047Config config) {
        this.config = config != null ? config : new Idea196047Config();
