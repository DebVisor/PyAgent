...
@Data
public class Idea195735Config {
    private String name = "idea_195735";
 ...
 */
@Slf4j
public class Idea195735Service {
    private static final int IDEA_ID = 195735;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195735Service() {
        this(new Idea195735Config());
    }

    public Idea195735Service(Idea195735Config config) {
        this.config = config != null ? config : new Idea195735Config();
