...
@Data
public class Idea196159Config {
    private String name = "idea_196159";
 ...
 */
@Slf4j
public class Idea196159Service {
    private static final int IDEA_ID = 196159;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196159Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196159Service() {
        this(new Idea196159Config());
    }

    public Idea196159Service(Idea196159Config config) {
        this.config = config != null ? config : new Idea196159Config();
