...
@Data
public class Idea195718Config {
    private String name = "idea_195718";
 ...
 */
@Slf4j
public class Idea195718Service {
    private static final int IDEA_ID = 195718;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195718Service() {
        this(new Idea195718Config());
    }

    public Idea195718Service(Idea195718Config config) {
        this.config = config != null ? config : new Idea195718Config();
