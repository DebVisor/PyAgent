...
@Data
public class Idea196174Config {
    private String name = "idea_196174";
 ...
 */
@Slf4j
public class Idea196174Service {
    private static final int IDEA_ID = 196174;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196174Service() {
        this(new Idea196174Config());
    }

    public Idea196174Service(Idea196174Config config) {
        this.config = config != null ? config : new Idea196174Config();
