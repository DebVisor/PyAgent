...
@Data
public class Idea196056Config {
    private String name = "idea_196056";
 ...
 */
@Slf4j
public class Idea196056Service {
    private static final int IDEA_ID = 196056;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196056Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196056Service() {
        this(new Idea196056Config());
    }

    public Idea196056Service(Idea196056Config config) {
        this.config = config != null ? config : new Idea196056Config();
