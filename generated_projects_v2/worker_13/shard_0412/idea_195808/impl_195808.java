...
@Data
public class Idea195808Config {
    private String name = "idea_195808";
 ...
 */
@Slf4j
public class Idea195808Service {
    private static final int IDEA_ID = 195808;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195808Service() {
        this(new Idea195808Config());
    }

    public Idea195808Service(Idea195808Config config) {
        this.config = config != null ? config : new Idea195808Config();
