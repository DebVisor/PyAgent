...
@Data
public class Idea196030Config {
    private String name = "idea_196030";
 ...
 */
@Slf4j
public class Idea196030Service {
    private static final int IDEA_ID = 196030;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196030Service() {
        this(new Idea196030Config());
    }

    public Idea196030Service(Idea196030Config config) {
        this.config = config != null ? config : new Idea196030Config();
