...
@Data
public class Idea195752Config {
    private String name = "idea_195752";
 ...
 */
@Slf4j
public class Idea195752Service {
    private static final int IDEA_ID = 195752;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195752Service() {
        this(new Idea195752Config());
    }

    public Idea195752Service(Idea195752Config config) {
        this.config = config != null ? config : new Idea195752Config();
