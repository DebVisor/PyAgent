...
@Data
public class Idea196117Config {
    private String name = "idea_196117";
 ...
 */
@Slf4j
public class Idea196117Service {
    private static final int IDEA_ID = 196117;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196117Service() {
        this(new Idea196117Config());
    }

    public Idea196117Service(Idea196117Config config) {
        this.config = config != null ? config : new Idea196117Config();
