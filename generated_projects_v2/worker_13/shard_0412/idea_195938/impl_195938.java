...
@Data
public class Idea195938Config {
    private String name = "idea_195938";
 ...
 */
@Slf4j
public class Idea195938Service {
    private static final int IDEA_ID = 195938;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195938Service() {
        this(new Idea195938Config());
    }

    public Idea195938Service(Idea195938Config config) {
        this.config = config != null ? config : new Idea195938Config();
