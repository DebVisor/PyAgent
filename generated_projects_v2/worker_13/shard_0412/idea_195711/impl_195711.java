...
@Data
public class Idea195711Config {
    private String name = "idea_195711";
 ...
 */
@Slf4j
public class Idea195711Service {
    private static final int IDEA_ID = 195711;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195711Service() {
        this(new Idea195711Config());
    }

    public Idea195711Service(Idea195711Config config) {
        this.config = config != null ? config : new Idea195711Config();
