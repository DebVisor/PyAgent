...
@Data
public class Idea195911Config {
    private String name = "idea_195911";
 ...
 */
@Slf4j
public class Idea195911Service {
    private static final int IDEA_ID = 195911;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195911Service() {
        this(new Idea195911Config());
    }

    public Idea195911Service(Idea195911Config config) {
        this.config = config != null ? config : new Idea195911Config();
