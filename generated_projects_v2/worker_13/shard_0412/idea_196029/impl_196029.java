...
@Data
public class Idea196029Config {
    private String name = "idea_196029";
 ...
 */
@Slf4j
public class Idea196029Service {
    private static final int IDEA_ID = 196029;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196029Service() {
        this(new Idea196029Config());
    }

    public Idea196029Service(Idea196029Config config) {
        this.config = config != null ? config : new Idea196029Config();
