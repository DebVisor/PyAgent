...
@Data
public class Idea195889Config {
    private String name = "idea_195889";
 ...
 */
@Slf4j
public class Idea195889Service {
    private static final int IDEA_ID = 195889;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195889Service() {
        this(new Idea195889Config());
    }

    public Idea195889Service(Idea195889Config config) {
        this.config = config != null ? config : new Idea195889Config();
