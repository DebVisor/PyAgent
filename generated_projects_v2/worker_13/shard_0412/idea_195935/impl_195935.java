...
@Data
public class Idea195935Config {
    private String name = "idea_195935";
 ...
 */
@Slf4j
public class Idea195935Service {
    private static final int IDEA_ID = 195935;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195935Service() {
        this(new Idea195935Config());
    }

    public Idea195935Service(Idea195935Config config) {
        this.config = config != null ? config : new Idea195935Config();
