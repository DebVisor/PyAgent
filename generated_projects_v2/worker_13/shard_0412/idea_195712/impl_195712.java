...
@Data
public class Idea195712Config {
    private String name = "idea_195712";
 ...
 */
@Slf4j
public class Idea195712Service {
    private static final int IDEA_ID = 195712;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195712Service() {
        this(new Idea195712Config());
    }

    public Idea195712Service(Idea195712Config config) {
        this.config = config != null ? config : new Idea195712Config();
