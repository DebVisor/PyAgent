...
@Data
public class Idea195727Config {
    private String name = "idea_195727";
 ...
 */
@Slf4j
public class Idea195727Service {
    private static final int IDEA_ID = 195727;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195727Service() {
        this(new Idea195727Config());
    }

    public Idea195727Service(Idea195727Config config) {
        this.config = config != null ? config : new Idea195727Config();
