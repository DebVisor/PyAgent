...
@Data
public class Idea195954Config {
    private String name = "idea_195954";
 ...
 */
@Slf4j
public class Idea195954Service {
    private static final int IDEA_ID = 195954;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195954Service() {
        this(new Idea195954Config());
    }

    public Idea195954Service(Idea195954Config config) {
        this.config = config != null ? config : new Idea195954Config();
