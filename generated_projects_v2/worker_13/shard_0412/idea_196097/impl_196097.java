...
@Data
public class Idea196097Config {
    private String name = "idea_196097";
 ...
 */
@Slf4j
public class Idea196097Service {
    private static final int IDEA_ID = 196097;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196097Service() {
        this(new Idea196097Config());
    }

    public Idea196097Service(Idea196097Config config) {
        this.config = config != null ? config : new Idea196097Config();
