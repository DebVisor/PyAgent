...
@Data
public class Idea195844Config {
    private String name = "idea_195844";
 ...
 */
@Slf4j
public class Idea195844Service {
    private static final int IDEA_ID = 195844;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195844Service() {
        this(new Idea195844Config());
    }

    public Idea195844Service(Idea195844Config config) {
        this.config = config != null ? config : new Idea195844Config();
