...
@Data
public class Idea195757Config {
    private String name = "idea_195757";
 ...
 */
@Slf4j
public class Idea195757Service {
    private static final int IDEA_ID = 195757;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195757Service() {
        this(new Idea195757Config());
    }

    public Idea195757Service(Idea195757Config config) {
        this.config = config != null ? config : new Idea195757Config();
