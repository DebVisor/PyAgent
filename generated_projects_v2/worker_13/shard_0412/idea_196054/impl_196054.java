...
@Data
public class Idea196054Config {
    private String name = "idea_196054";
 ...
 */
@Slf4j
public class Idea196054Service {
    private static final int IDEA_ID = 196054;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196054Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196054Service() {
        this(new Idea196054Config());
    }

    public Idea196054Service(Idea196054Config config) {
        this.config = config != null ? config : new Idea196054Config();
