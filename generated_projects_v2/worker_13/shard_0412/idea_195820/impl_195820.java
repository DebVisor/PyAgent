...
@Data
public class Idea195820Config {
    private String name = "idea_195820";
 ...
 */
@Slf4j
public class Idea195820Service {
    private static final int IDEA_ID = 195820;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195820Service() {
        this(new Idea195820Config());
    }

    public Idea195820Service(Idea195820Config config) {
        this.config = config != null ? config : new Idea195820Config();
