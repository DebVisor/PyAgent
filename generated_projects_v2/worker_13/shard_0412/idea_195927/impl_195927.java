...
@Data
public class Idea195927Config {
    private String name = "idea_195927";
 ...
 */
@Slf4j
public class Idea195927Service {
    private static final int IDEA_ID = 195927;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195927Service() {
        this(new Idea195927Config());
    }

    public Idea195927Service(Idea195927Config config) {
        this.config = config != null ? config : new Idea195927Config();
