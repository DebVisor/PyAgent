...
@Data
public class Idea195967Config {
    private String name = "idea_195967";
 ...
 */
@Slf4j
public class Idea195967Service {
    private static final int IDEA_ID = 195967;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195967Service() {
        this(new Idea195967Config());
    }

    public Idea195967Service(Idea195967Config config) {
        this.config = config != null ? config : new Idea195967Config();
