...
@Data
public class Idea196079Config {
    private String name = "idea_196079";
 ...
 */
@Slf4j
public class Idea196079Service {
    private static final int IDEA_ID = 196079;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196079Service() {
        this(new Idea196079Config());
    }

    public Idea196079Service(Idea196079Config config) {
        this.config = config != null ? config : new Idea196079Config();
