...
@Data
public class Idea195786Config {
    private String name = "idea_195786";
 ...
 */
@Slf4j
public class Idea195786Service {
    private static final int IDEA_ID = 195786;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195786Service() {
        this(new Idea195786Config());
    }

    public Idea195786Service(Idea195786Config config) {
        this.config = config != null ? config : new Idea195786Config();
