...
@Data
public class Idea195738Config {
    private String name = "idea_195738";
 ...
 */
@Slf4j
public class Idea195738Service {
    private static final int IDEA_ID = 195738;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195738Service() {
        this(new Idea195738Config());
    }

    public Idea195738Service(Idea195738Config config) {
        this.config = config != null ? config : new Idea195738Config();
