...
@Data
public class Idea195917Config {
    private String name = "idea_195917";
 ...
 */
@Slf4j
public class Idea195917Service {
    private static final int IDEA_ID = 195917;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195917Service() {
        this(new Idea195917Config());
    }

    public Idea195917Service(Idea195917Config config) {
        this.config = config != null ? config : new Idea195917Config();
