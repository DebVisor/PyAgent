...
@Data
public class Idea195934Config {
    private String name = "idea_195934";
 ...
 */
@Slf4j
public class Idea195934Service {
    private static final int IDEA_ID = 195934;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195934Service() {
        this(new Idea195934Config());
    }

    public Idea195934Service(Idea195934Config config) {
        this.config = config != null ? config : new Idea195934Config();
