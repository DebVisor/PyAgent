...
@Data
public class Idea196040Config {
    private String name = "idea_196040";
 ...
 */
@Slf4j
public class Idea196040Service {
    private static final int IDEA_ID = 196040;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196040Service() {
        this(new Idea196040Config());
    }

    public Idea196040Service(Idea196040Config config) {
        this.config = config != null ? config : new Idea196040Config();
