...
@Data
public class Idea195980Config {
    private String name = "idea_195980";
 ...
 */
@Slf4j
public class Idea195980Service {
    private static final int IDEA_ID = 195980;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195980Service() {
        this(new Idea195980Config());
    }

    public Idea195980Service(Idea195980Config config) {
        this.config = config != null ? config : new Idea195980Config();
