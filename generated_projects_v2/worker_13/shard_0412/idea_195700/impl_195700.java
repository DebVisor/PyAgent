...
@Data
public class Idea195700Config {
    private String name = "idea_195700";
 ...
 */
@Slf4j
public class Idea195700Service {
    private static final int IDEA_ID = 195700;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195700Service() {
        this(new Idea195700Config());
    }

    public Idea195700Service(Idea195700Config config) {
        this.config = config != null ? config : new Idea195700Config();
