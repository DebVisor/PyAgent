...
@Data
public class Idea196132Config {
    private String name = "idea_196132";
 ...
 */
@Slf4j
public class Idea196132Service {
    private static final int IDEA_ID = 196132;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196132Service() {
        this(new Idea196132Config());
    }

    public Idea196132Service(Idea196132Config config) {
        this.config = config != null ? config : new Idea196132Config();
