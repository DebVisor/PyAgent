...
@Data
public class Idea195857Config {
    private String name = "idea_195857";
 ...
 */
@Slf4j
public class Idea195857Service {
    private static final int IDEA_ID = 195857;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195857Service() {
        this(new Idea195857Config());
    }

    public Idea195857Service(Idea195857Config config) {
        this.config = config != null ? config : new Idea195857Config();
