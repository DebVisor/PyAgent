...
@Data
public class Idea195913Config {
    private String name = "idea_195913";
 ...
 */
@Slf4j
public class Idea195913Service {
    private static final int IDEA_ID = 195913;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195913Service() {
        this(new Idea195913Config());
    }

    public Idea195913Service(Idea195913Config config) {
        this.config = config != null ? config : new Idea195913Config();
