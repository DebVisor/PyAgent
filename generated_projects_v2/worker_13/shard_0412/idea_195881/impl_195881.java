...
@Data
public class Idea195881Config {
    private String name = "idea_195881";
 ...
 */
@Slf4j
public class Idea195881Service {
    private static final int IDEA_ID = 195881;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195881Service() {
        this(new Idea195881Config());
    }

    public Idea195881Service(Idea195881Config config) {
        this.config = config != null ? config : new Idea195881Config();
