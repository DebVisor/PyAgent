...
@Data
public class Idea195991Config {
    private String name = "idea_195991";
 ...
 */
@Slf4j
public class Idea195991Service {
    private static final int IDEA_ID = 195991;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195991Service() {
        this(new Idea195991Config());
    }

    public Idea195991Service(Idea195991Config config) {
        this.config = config != null ? config : new Idea195991Config();
