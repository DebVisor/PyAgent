...
@Data
public class Idea196171Config {
    private String name = "idea_196171";
 ...
 */
@Slf4j
public class Idea196171Service {
    private static final int IDEA_ID = 196171;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196171Service() {
        this(new Idea196171Config());
    }

    public Idea196171Service(Idea196171Config config) {
        this.config = config != null ? config : new Idea196171Config();
