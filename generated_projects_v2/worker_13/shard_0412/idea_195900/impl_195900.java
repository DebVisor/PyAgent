...
@Data
public class Idea195900Config {
    private String name = "idea_195900";
 ...
 */
@Slf4j
public class Idea195900Service {
    private static final int IDEA_ID = 195900;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195900Service() {
        this(new Idea195900Config());
    }

    public Idea195900Service(Idea195900Config config) {
        this.config = config != null ? config : new Idea195900Config();
