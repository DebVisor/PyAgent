...
@Data
public class Idea195903Config {
    private String name = "idea_195903";
 ...
 */
@Slf4j
public class Idea195903Service {
    private static final int IDEA_ID = 195903;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195903Service() {
        this(new Idea195903Config());
    }

    public Idea195903Service(Idea195903Config config) {
        this.config = config != null ? config : new Idea195903Config();
