...
@Data
public class Idea195995Config {
    private String name = "idea_195995";
 ...
 */
@Slf4j
public class Idea195995Service {
    private static final int IDEA_ID = 195995;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195995Service() {
        this(new Idea195995Config());
    }

    public Idea195995Service(Idea195995Config config) {
        this.config = config != null ? config : new Idea195995Config();
