...
@Data
public class Idea195799Config {
    private String name = "idea_195799";
 ...
 */
@Slf4j
public class Idea195799Service {
    private static final int IDEA_ID = 195799;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195799Service() {
        this(new Idea195799Config());
    }

    public Idea195799Service(Idea195799Config config) {
        this.config = config != null ? config : new Idea195799Config();
