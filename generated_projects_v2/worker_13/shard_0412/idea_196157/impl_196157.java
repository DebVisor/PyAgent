...
@Data
public class Idea196157Config {
    private String name = "idea_196157";
 ...
 */
@Slf4j
public class Idea196157Service {
    private static final int IDEA_ID = 196157;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196157Service() {
        this(new Idea196157Config());
    }

    public Idea196157Service(Idea196157Config config) {
        this.config = config != null ? config : new Idea196157Config();
