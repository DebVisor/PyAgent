...
@Data
public class Idea196152Config {
    private String name = "idea_196152";
 ...
 */
@Slf4j
public class Idea196152Service {
    private static final int IDEA_ID = 196152;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196152Service() {
        this(new Idea196152Config());
    }

    public Idea196152Service(Idea196152Config config) {
        this.config = config != null ? config : new Idea196152Config();
