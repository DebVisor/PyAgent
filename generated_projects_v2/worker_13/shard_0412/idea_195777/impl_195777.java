...
@Data
public class Idea195777Config {
    private String name = "idea_195777";
 ...
 */
@Slf4j
public class Idea195777Service {
    private static final int IDEA_ID = 195777;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195777Service() {
        this(new Idea195777Config());
    }

    public Idea195777Service(Idea195777Config config) {
        this.config = config != null ? config : new Idea195777Config();
