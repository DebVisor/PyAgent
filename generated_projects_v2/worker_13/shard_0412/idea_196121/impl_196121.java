...
@Data
public class Idea196121Config {
    private String name = "idea_196121";
 ...
 */
@Slf4j
public class Idea196121Service {
    private static final int IDEA_ID = 196121;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196121Service() {
        this(new Idea196121Config());
    }

    public Idea196121Service(Idea196121Config config) {
        this.config = config != null ? config : new Idea196121Config();
