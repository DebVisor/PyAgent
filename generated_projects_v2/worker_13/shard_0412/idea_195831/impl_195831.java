...
@Data
public class Idea195831Config {
    private String name = "idea_195831";
 ...
 */
@Slf4j
public class Idea195831Service {
    private static final int IDEA_ID = 195831;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195831Service() {
        this(new Idea195831Config());
    }

    public Idea195831Service(Idea195831Config config) {
        this.config = config != null ? config : new Idea195831Config();
