...
@Data
public class Idea196137Config {
    private String name = "idea_196137";
 ...
 */
@Slf4j
public class Idea196137Service {
    private static final int IDEA_ID = 196137;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196137Service() {
        this(new Idea196137Config());
    }

    public Idea196137Service(Idea196137Config config) {
        this.config = config != null ? config : new Idea196137Config();
