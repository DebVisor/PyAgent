...
@Data
public class Idea196127Config {
    private String name = "idea_196127";
 ...
 */
@Slf4j
public class Idea196127Service {
    private static final int IDEA_ID = 196127;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196127Service() {
        this(new Idea196127Config());
    }

    public Idea196127Service(Idea196127Config config) {
        this.config = config != null ? config : new Idea196127Config();
