...
@Data
public class Idea195958Config {
    private String name = "idea_195958";
 ...
 */
@Slf4j
public class Idea195958Service {
    private static final int IDEA_ID = 195958;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195958Service() {
        this(new Idea195958Config());
    }

    public Idea195958Service(Idea195958Config config) {
        this.config = config != null ? config : new Idea195958Config();
