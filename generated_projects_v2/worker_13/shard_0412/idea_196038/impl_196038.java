...
@Data
public class Idea196038Config {
    private String name = "idea_196038";
 ...
 */
@Slf4j
public class Idea196038Service {
    private static final int IDEA_ID = 196038;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196038Service() {
        this(new Idea196038Config());
    }

    public Idea196038Service(Idea196038Config config) {
        this.config = config != null ? config : new Idea196038Config();
