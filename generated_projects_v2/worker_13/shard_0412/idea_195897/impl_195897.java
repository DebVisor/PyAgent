...
@Data
public class Idea195897Config {
    private String name = "idea_195897";
 ...
 */
@Slf4j
public class Idea195897Service {
    private static final int IDEA_ID = 195897;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195897Service() {
        this(new Idea195897Config());
    }

    public Idea195897Service(Idea195897Config config) {
        this.config = config != null ? config : new Idea195897Config();
