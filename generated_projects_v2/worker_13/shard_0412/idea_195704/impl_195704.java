...
@Data
public class Idea195704Config {
    private String name = "idea_195704";
 ...
 */
@Slf4j
public class Idea195704Service {
    private static final int IDEA_ID = 195704;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195704Service() {
        this(new Idea195704Config());
    }

    public Idea195704Service(Idea195704Config config) {
        this.config = config != null ? config : new Idea195704Config();
