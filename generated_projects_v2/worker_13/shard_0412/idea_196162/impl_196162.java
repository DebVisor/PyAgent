...
@Data
public class Idea196162Config {
    private String name = "idea_196162";
 ...
 */
@Slf4j
public class Idea196162Service {
    private static final int IDEA_ID = 196162;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196162Service() {
        this(new Idea196162Config());
    }

    public Idea196162Service(Idea196162Config config) {
        this.config = config != null ? config : new Idea196162Config();
