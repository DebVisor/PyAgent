...
@Data
public class Idea196134Config {
    private String name = "idea_196134";
 ...
 */
@Slf4j
public class Idea196134Service {
    private static final int IDEA_ID = 196134;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196134Service() {
        this(new Idea196134Config());
    }

    public Idea196134Service(Idea196134Config config) {
        this.config = config != null ? config : new Idea196134Config();
