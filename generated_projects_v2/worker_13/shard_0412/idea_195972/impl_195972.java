...
@Data
public class Idea195972Config {
    private String name = "idea_195972";
 ...
 */
@Slf4j
public class Idea195972Service {
    private static final int IDEA_ID = 195972;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195972Service() {
        this(new Idea195972Config());
    }

    public Idea195972Service(Idea195972Config config) {
        this.config = config != null ? config : new Idea195972Config();
