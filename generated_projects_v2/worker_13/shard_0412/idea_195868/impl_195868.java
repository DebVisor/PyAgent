...
@Data
public class Idea195868Config {
    private String name = "idea_195868";
 ...
 */
@Slf4j
public class Idea195868Service {
    private static final int IDEA_ID = 195868;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195868Service() {
        this(new Idea195868Config());
    }

    public Idea195868Service(Idea195868Config config) {
        this.config = config != null ? config : new Idea195868Config();
