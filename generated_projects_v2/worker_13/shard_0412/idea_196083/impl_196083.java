...
@Data
public class Idea196083Config {
    private String name = "idea_196083";
 ...
 */
@Slf4j
public class Idea196083Service {
    private static final int IDEA_ID = 196083;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196083Service() {
        this(new Idea196083Config());
    }

    public Idea196083Service(Idea196083Config config) {
        this.config = config != null ? config : new Idea196083Config();
