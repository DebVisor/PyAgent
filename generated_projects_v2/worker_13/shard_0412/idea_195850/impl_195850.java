...
@Data
public class Idea195850Config {
    private String name = "idea_195850";
 ...
 */
@Slf4j
public class Idea195850Service {
    private static final int IDEA_ID = 195850;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195850Service() {
        this(new Idea195850Config());
    }

    public Idea195850Service(Idea195850Config config) {
        this.config = config != null ? config : new Idea195850Config();
