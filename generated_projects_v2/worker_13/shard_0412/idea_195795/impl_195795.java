...
@Data
public class Idea195795Config {
    private String name = "idea_195795";
 ...
 */
@Slf4j
public class Idea195795Service {
    private static final int IDEA_ID = 195795;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195795Service() {
        this(new Idea195795Config());
    }

    public Idea195795Service(Idea195795Config config) {
        this.config = config != null ? config : new Idea195795Config();
