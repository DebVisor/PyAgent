...
@Data
public class Idea195987Config {
    private String name = "idea_195987";
 ...
 */
@Slf4j
public class Idea195987Service {
    private static final int IDEA_ID = 195987;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195987Service() {
        this(new Idea195987Config());
    }

    public Idea195987Service(Idea195987Config config) {
        this.config = config != null ? config : new Idea195987Config();
