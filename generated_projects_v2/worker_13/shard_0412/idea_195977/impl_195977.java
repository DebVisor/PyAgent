...
@Data
public class Idea195977Config {
    private String name = "idea_195977";
 ...
 */
@Slf4j
public class Idea195977Service {
    private static final int IDEA_ID = 195977;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195977Service() {
        this(new Idea195977Config());
    }

    public Idea195977Service(Idea195977Config config) {
        this.config = config != null ? config : new Idea195977Config();
