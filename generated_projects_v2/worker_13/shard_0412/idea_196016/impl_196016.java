...
@Data
public class Idea196016Config {
    private String name = "idea_196016";
 ...
 */
@Slf4j
public class Idea196016Service {
    private static final int IDEA_ID = 196016;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196016Service() {
        this(new Idea196016Config());
    }

    public Idea196016Service(Idea196016Config config) {
        this.config = config != null ? config : new Idea196016Config();
