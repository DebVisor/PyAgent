...
@Data
public class Idea195981Config {
    private String name = "idea_195981";
 ...
 */
@Slf4j
public class Idea195981Service {
    private static final int IDEA_ID = 195981;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195981Service() {
        this(new Idea195981Config());
    }

    public Idea195981Service(Idea195981Config config) {
        this.config = config != null ? config : new Idea195981Config();
