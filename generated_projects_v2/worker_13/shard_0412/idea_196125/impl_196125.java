...
@Data
public class Idea196125Config {
    private String name = "idea_196125";
 ...
 */
@Slf4j
public class Idea196125Service {
    private static final int IDEA_ID = 196125;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196125Service() {
        this(new Idea196125Config());
    }

    public Idea196125Service(Idea196125Config config) {
        this.config = config != null ? config : new Idea196125Config();
