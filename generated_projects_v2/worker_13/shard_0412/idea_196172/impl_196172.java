...
@Data
public class Idea196172Config {
    private String name = "idea_196172";
 ...
 */
@Slf4j
public class Idea196172Service {
    private static final int IDEA_ID = 196172;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196172Service() {
        this(new Idea196172Config());
    }

    public Idea196172Service(Idea196172Config config) {
        this.config = config != null ? config : new Idea196172Config();
