...
@Data
public class Idea196026Config {
    private String name = "idea_196026";
 ...
 */
@Slf4j
public class Idea196026Service {
    private static final int IDEA_ID = 196026;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196026Service() {
        this(new Idea196026Config());
    }

    public Idea196026Service(Idea196026Config config) {
        this.config = config != null ? config : new Idea196026Config();
