...
@Data
public class Idea196138Config {
    private String name = "idea_196138";
 ...
 */
@Slf4j
public class Idea196138Service {
    private static final int IDEA_ID = 196138;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196138Service() {
        this(new Idea196138Config());
    }

    public Idea196138Service(Idea196138Config config) {
        this.config = config != null ? config : new Idea196138Config();
