...
@Data
public class Idea196106Config {
    private String name = "idea_196106";
 ...
 */
@Slf4j
public class Idea196106Service {
    private static final int IDEA_ID = 196106;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196106Service() {
        this(new Idea196106Config());
    }

    public Idea196106Service(Idea196106Config config) {
        this.config = config != null ? config : new Idea196106Config();
