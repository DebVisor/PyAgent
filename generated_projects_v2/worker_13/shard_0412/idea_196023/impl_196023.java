...
@Data
public class Idea196023Config {
    private String name = "idea_196023";
 ...
 */
@Slf4j
public class Idea196023Service {
    private static final int IDEA_ID = 196023;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196023Service() {
        this(new Idea196023Config());
    }

    public Idea196023Service(Idea196023Config config) {
        this.config = config != null ? config : new Idea196023Config();
