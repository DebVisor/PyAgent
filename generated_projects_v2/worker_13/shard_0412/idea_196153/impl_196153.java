...
@Data
public class Idea196153Config {
    private String name = "idea_196153";
 ...
 */
@Slf4j
public class Idea196153Service {
    private static final int IDEA_ID = 196153;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196153Service() {
        this(new Idea196153Config());
    }

    public Idea196153Service(Idea196153Config config) {
        this.config = config != null ? config : new Idea196153Config();
