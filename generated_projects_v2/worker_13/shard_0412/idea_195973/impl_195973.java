...
@Data
public class Idea195973Config {
    private String name = "idea_195973";
 ...
 */
@Slf4j
public class Idea195973Service {
    private static final int IDEA_ID = 195973;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195973Service() {
        this(new Idea195973Config());
    }

    public Idea195973Service(Idea195973Config config) {
        this.config = config != null ? config : new Idea195973Config();
