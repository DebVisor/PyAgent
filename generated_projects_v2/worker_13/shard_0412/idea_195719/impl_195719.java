...
@Data
public class Idea195719Config {
    private String name = "idea_195719";
 ...
 */
@Slf4j
public class Idea195719Service {
    private static final int IDEA_ID = 195719;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195719Service() {
        this(new Idea195719Config());
    }

    public Idea195719Service(Idea195719Config config) {
        this.config = config != null ? config : new Idea195719Config();
