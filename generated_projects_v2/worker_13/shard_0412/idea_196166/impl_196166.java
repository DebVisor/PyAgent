...
@Data
public class Idea196166Config {
    private String name = "idea_196166";
 ...
 */
@Slf4j
public class Idea196166Service {
    private static final int IDEA_ID = 196166;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196166Service() {
        this(new Idea196166Config());
    }

    public Idea196166Service(Idea196166Config config) {
        this.config = config != null ? config : new Idea196166Config();
