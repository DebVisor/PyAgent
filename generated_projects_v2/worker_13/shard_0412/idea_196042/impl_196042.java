...
@Data
public class Idea196042Config {
    private String name = "idea_196042";
 ...
 */
@Slf4j
public class Idea196042Service {
    private static final int IDEA_ID = 196042;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196042Service() {
        this(new Idea196042Config());
    }

    public Idea196042Service(Idea196042Config config) {
        this.config = config != null ? config : new Idea196042Config();
