...
@Data
public class Idea195769Config {
    private String name = "idea_195769";
 ...
 */
@Slf4j
public class Idea195769Service {
    private static final int IDEA_ID = 195769;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195769Service() {
        this(new Idea195769Config());
    }

    public Idea195769Service(Idea195769Config config) {
        this.config = config != null ? config : new Idea195769Config();
