...
@Data
public class Idea195747Config {
    private String name = "idea_195747";
 ...
 */
@Slf4j
public class Idea195747Service {
    private static final int IDEA_ID = 195747;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195747Service() {
        this(new Idea195747Config());
    }

    public Idea195747Service(Idea195747Config config) {
        this.config = config != null ? config : new Idea195747Config();
