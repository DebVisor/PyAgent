...
@Data
public class Idea195804Config {
    private String name = "idea_195804";
 ...
 */
@Slf4j
public class Idea195804Service {
    private static final int IDEA_ID = 195804;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195804Service() {
        this(new Idea195804Config());
    }

    public Idea195804Service(Idea195804Config config) {
        this.config = config != null ? config : new Idea195804Config();
