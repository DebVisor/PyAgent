...
@Data
public class Idea195707Config {
    private String name = "idea_195707";
 ...
 */
@Slf4j
public class Idea195707Service {
    private static final int IDEA_ID = 195707;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195707Service() {
        this(new Idea195707Config());
    }

    public Idea195707Service(Idea195707Config config) {
        this.config = config != null ? config : new Idea195707Config();
