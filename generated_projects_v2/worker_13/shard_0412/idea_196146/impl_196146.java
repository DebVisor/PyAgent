...
@Data
public class Idea196146Config {
    private String name = "idea_196146";
 ...
 */
@Slf4j
public class Idea196146Service {
    private static final int IDEA_ID = 196146;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196146Service() {
        this(new Idea196146Config());
    }

    public Idea196146Service(Idea196146Config config) {
        this.config = config != null ? config : new Idea196146Config();
