...
@Data
public class Idea195759Config {
    private String name = "idea_195759";
 ...
 */
@Slf4j
public class Idea195759Service {
    private static final int IDEA_ID = 195759;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195759Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195759Service() {
        this(new Idea195759Config());
    }

    public Idea195759Service(Idea195759Config config) {
        this.config = config != null ? config : new Idea195759Config();
