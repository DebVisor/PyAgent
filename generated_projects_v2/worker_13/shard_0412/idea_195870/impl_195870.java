...
@Data
public class Idea195870Config {
    private String name = "idea_195870";
 ...
 */
@Slf4j
public class Idea195870Service {
    private static final int IDEA_ID = 195870;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195870Service() {
        this(new Idea195870Config());
    }

    public Idea195870Service(Idea195870Config config) {
        this.config = config != null ? config : new Idea195870Config();
