...
@Data
public class Idea195798Config {
    private String name = "idea_195798";
 ...
 */
@Slf4j
public class Idea195798Service {
    private static final int IDEA_ID = 195798;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195798Service() {
        this(new Idea195798Config());
    }

    public Idea195798Service(Idea195798Config config) {
        this.config = config != null ? config : new Idea195798Config();
