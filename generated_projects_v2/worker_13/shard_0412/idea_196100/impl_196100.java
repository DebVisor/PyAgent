...
@Data
public class Idea196100Config {
    private String name = "idea_196100";
 ...
 */
@Slf4j
public class Idea196100Service {
    private static final int IDEA_ID = 196100;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196100Service() {
        this(new Idea196100Config());
    }

    public Idea196100Service(Idea196100Config config) {
        this.config = config != null ? config : new Idea196100Config();
