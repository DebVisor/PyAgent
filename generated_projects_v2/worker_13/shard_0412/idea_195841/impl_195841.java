...
@Data
public class Idea195841Config {
    private String name = "idea_195841";
 ...
 */
@Slf4j
public class Idea195841Service {
    private static final int IDEA_ID = 195841;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195841Service() {
        this(new Idea195841Config());
    }

    public Idea195841Service(Idea195841Config config) {
        this.config = config != null ? config : new Idea195841Config();
