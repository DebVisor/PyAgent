...
@Data
public class Idea195778Config {
    private String name = "idea_195778";
 ...
 */
@Slf4j
public class Idea195778Service {
    private static final int IDEA_ID = 195778;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195778Service() {
        this(new Idea195778Config());
    }

    public Idea195778Service(Idea195778Config config) {
        this.config = config != null ? config : new Idea195778Config();
