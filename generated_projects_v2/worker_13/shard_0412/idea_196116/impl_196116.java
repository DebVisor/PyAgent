...
@Data
public class Idea196116Config {
    private String name = "idea_196116";
 ...
 */
@Slf4j
public class Idea196116Service {
    private static final int IDEA_ID = 196116;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196116Service() {
        this(new Idea196116Config());
    }

    public Idea196116Service(Idea196116Config config) {
        this.config = config != null ? config : new Idea196116Config();
