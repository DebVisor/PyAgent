...
@Data
public class Idea195767Config {
    private String name = "idea_195767";
 ...
 */
@Slf4j
public class Idea195767Service {
    private static final int IDEA_ID = 195767;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195767Service() {
        this(new Idea195767Config());
    }

    public Idea195767Service(Idea195767Config config) {
        this.config = config != null ? config : new Idea195767Config();
