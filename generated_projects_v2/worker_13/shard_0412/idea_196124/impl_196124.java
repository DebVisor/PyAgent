...
@Data
public class Idea196124Config {
    private String name = "idea_196124";
 ...
 */
@Slf4j
public class Idea196124Service {
    private static final int IDEA_ID = 196124;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196124Service() {
        this(new Idea196124Config());
    }

    public Idea196124Service(Idea196124Config config) {
        this.config = config != null ? config : new Idea196124Config();
