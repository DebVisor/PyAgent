...
@Data
public class Idea195744Config {
    private String name = "idea_195744";
 ...
 */
@Slf4j
public class Idea195744Service {
    private static final int IDEA_ID = 195744;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195744Service() {
        this(new Idea195744Config());
    }

    public Idea195744Service(Idea195744Config config) {
        this.config = config != null ? config : new Idea195744Config();
