...
@Data
public class Idea196003Config {
    private String name = "idea_196003";
 ...
 */
@Slf4j
public class Idea196003Service {
    private static final int IDEA_ID = 196003;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196003Service() {
        this(new Idea196003Config());
    }

    public Idea196003Service(Idea196003Config config) {
        this.config = config != null ? config : new Idea196003Config();
