...
@Data
public class Idea196057Config {
    private String name = "idea_196057";
 ...
 */
@Slf4j
public class Idea196057Service {
    private static final int IDEA_ID = 196057;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196057Service() {
        this(new Idea196057Config());
    }

    public Idea196057Service(Idea196057Config config) {
        this.config = config != null ? config : new Idea196057Config();
