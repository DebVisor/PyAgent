...
@Data
public class Idea195952Config {
    private String name = "idea_195952";
 ...
 */
@Slf4j
public class Idea195952Service {
    private static final int IDEA_ID = 195952;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195952Service() {
        this(new Idea195952Config());
    }

    public Idea195952Service(Idea195952Config config) {
        this.config = config != null ? config : new Idea195952Config();
