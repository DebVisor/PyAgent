...
@Data
public class Idea195772Config {
    private String name = "idea_195772";
 ...
 */
@Slf4j
public class Idea195772Service {
    private static final int IDEA_ID = 195772;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195772Service() {
        this(new Idea195772Config());
    }

    public Idea195772Service(Idea195772Config config) {
        this.config = config != null ? config : new Idea195772Config();
