...
@Data
public class Idea195779Config {
    private String name = "idea_195779";
 ...
 */
@Slf4j
public class Idea195779Service {
    private static final int IDEA_ID = 195779;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195779Service() {
        this(new Idea195779Config());
    }

    public Idea195779Service(Idea195779Config config) {
        this.config = config != null ? config : new Idea195779Config();
