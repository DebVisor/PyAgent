...
@Data
public class Idea195933Config {
    private String name = "idea_195933";
 ...
 */
@Slf4j
public class Idea195933Service {
    private static final int IDEA_ID = 195933;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195933Service() {
        this(new Idea195933Config());
    }

    public Idea195933Service(Idea195933Config config) {
        this.config = config != null ? config : new Idea195933Config();
