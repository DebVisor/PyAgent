...
@Data
public class Idea196035Config {
    private String name = "idea_196035";
 ...
 */
@Slf4j
public class Idea196035Service {
    private static final int IDEA_ID = 196035;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196035Service() {
        this(new Idea196035Config());
    }

    public Idea196035Service(Idea196035Config config) {
        this.config = config != null ? config : new Idea196035Config();
