...
@Data
public class Idea195869Config {
    private String name = "idea_195869";
 ...
 */
@Slf4j
public class Idea195869Service {
    private static final int IDEA_ID = 195869;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195869Service() {
        this(new Idea195869Config());
    }

    public Idea195869Service(Idea195869Config config) {
        this.config = config != null ? config : new Idea195869Config();
