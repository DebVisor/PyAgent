...
@Data
public class Idea195893Config {
    private String name = "idea_195893";
 ...
 */
@Slf4j
public class Idea195893Service {
    private static final int IDEA_ID = 195893;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195893Service() {
        this(new Idea195893Config());
    }

    public Idea195893Service(Idea195893Config config) {
        this.config = config != null ? config : new Idea195893Config();
