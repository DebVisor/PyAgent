...
@Data
public class Idea196113Config {
    private String name = "idea_196113";
 ...
 */
@Slf4j
public class Idea196113Service {
    private static final int IDEA_ID = 196113;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196113Service() {
        this(new Idea196113Config());
    }

    public Idea196113Service(Idea196113Config config) {
        this.config = config != null ? config : new Idea196113Config();
