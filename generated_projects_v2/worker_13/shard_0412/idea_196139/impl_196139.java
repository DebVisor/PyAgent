...
@Data
public class Idea196139Config {
    private String name = "idea_196139";
 ...
 */
@Slf4j
public class Idea196139Service {
    private static final int IDEA_ID = 196139;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196139Service() {
        this(new Idea196139Config());
    }

    public Idea196139Service(Idea196139Config config) {
        this.config = config != null ? config : new Idea196139Config();
