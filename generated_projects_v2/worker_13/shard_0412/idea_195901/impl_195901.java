...
@Data
public class Idea195901Config {
    private String name = "idea_195901";
 ...
 */
@Slf4j
public class Idea195901Service {
    private static final int IDEA_ID = 195901;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195901Service() {
        this(new Idea195901Config());
    }

    public Idea195901Service(Idea195901Config config) {
        this.config = config != null ? config : new Idea195901Config();
