...
@Data
public class Idea196015Config {
    private String name = "idea_196015";
 ...
 */
@Slf4j
public class Idea196015Service {
    private static final int IDEA_ID = 196015;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196015Service() {
        this(new Idea196015Config());
    }

    public Idea196015Service(Idea196015Config config) {
        this.config = config != null ? config : new Idea196015Config();
