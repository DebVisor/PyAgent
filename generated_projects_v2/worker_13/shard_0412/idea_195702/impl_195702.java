...
@Data
public class Idea195702Config {
    private String name = "idea_195702";
 ...
 */
@Slf4j
public class Idea195702Service {
    private static final int IDEA_ID = 195702;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195702Service() {
        this(new Idea195702Config());
    }

    public Idea195702Service(Idea195702Config config) {
        this.config = config != null ? config : new Idea195702Config();
