...
@Data
public class Idea196154Config {
    private String name = "idea_196154";
 ...
 */
@Slf4j
public class Idea196154Service {
    private static final int IDEA_ID = 196154;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196154Service() {
        this(new Idea196154Config());
    }

    public Idea196154Service(Idea196154Config config) {
        this.config = config != null ? config : new Idea196154Config();
