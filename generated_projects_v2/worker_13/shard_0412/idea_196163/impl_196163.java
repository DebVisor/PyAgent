...
@Data
public class Idea196163Config {
    private String name = "idea_196163";
 ...
 */
@Slf4j
public class Idea196163Service {
    private static final int IDEA_ID = 196163;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196163Service() {
        this(new Idea196163Config());
    }

    public Idea196163Service(Idea196163Config config) {
        this.config = config != null ? config : new Idea196163Config();
