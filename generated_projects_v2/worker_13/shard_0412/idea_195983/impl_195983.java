...
@Data
public class Idea195983Config {
    private String name = "idea_195983";
 ...
 */
@Slf4j
public class Idea195983Service {
    private static final int IDEA_ID = 195983;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195983Service() {
        this(new Idea195983Config());
    }

    public Idea195983Service(Idea195983Config config) {
        this.config = config != null ? config : new Idea195983Config();
