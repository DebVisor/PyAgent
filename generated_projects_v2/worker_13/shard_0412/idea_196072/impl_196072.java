...
@Data
public class Idea196072Config {
    private String name = "idea_196072";
 ...
 */
@Slf4j
public class Idea196072Service {
    private static final int IDEA_ID = 196072;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196072Service() {
        this(new Idea196072Config());
    }

    public Idea196072Service(Idea196072Config config) {
        this.config = config != null ? config : new Idea196072Config();
