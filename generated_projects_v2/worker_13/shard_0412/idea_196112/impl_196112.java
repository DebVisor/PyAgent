...
@Data
public class Idea196112Config {
    private String name = "idea_196112";
 ...
 */
@Slf4j
public class Idea196112Service {
    private static final int IDEA_ID = 196112;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196112Service() {
        this(new Idea196112Config());
    }

    public Idea196112Service(Idea196112Config config) {
        this.config = config != null ? config : new Idea196112Config();
