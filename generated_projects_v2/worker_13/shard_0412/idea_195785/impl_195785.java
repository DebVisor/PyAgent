...
@Data
public class Idea195785Config {
    private String name = "idea_195785";
 ...
 */
@Slf4j
public class Idea195785Service {
    private static final int IDEA_ID = 195785;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195785Service() {
        this(new Idea195785Config());
    }

    public Idea195785Service(Idea195785Config config) {
        this.config = config != null ? config : new Idea195785Config();
