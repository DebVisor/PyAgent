...
@Data
public class Idea195898Config {
    private String name = "idea_195898";
 ...
 */
@Slf4j
public class Idea195898Service {
    private static final int IDEA_ID = 195898;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195898Service() {
        this(new Idea195898Config());
    }

    public Idea195898Service(Idea195898Config config) {
        this.config = config != null ? config : new Idea195898Config();
