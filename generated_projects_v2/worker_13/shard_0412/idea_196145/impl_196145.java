...
@Data
public class Idea196145Config {
    private String name = "idea_196145";
 ...
 */
@Slf4j
public class Idea196145Service {
    private static final int IDEA_ID = 196145;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196145Service() {
        this(new Idea196145Config());
    }

    public Idea196145Service(Idea196145Config config) {
        this.config = config != null ? config : new Idea196145Config();
