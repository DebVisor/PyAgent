...
@Data
public class Idea196017Config {
    private String name = "idea_196017";
 ...
 */
@Slf4j
public class Idea196017Service {
    private static final int IDEA_ID = 196017;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196017Service() {
        this(new Idea196017Config());
    }

    public Idea196017Service(Idea196017Config config) {
        this.config = config != null ? config : new Idea196017Config();
