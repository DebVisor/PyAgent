...
@Data
public class Idea195813Config {
    private String name = "idea_195813";
 ...
 */
@Slf4j
public class Idea195813Service {
    private static final int IDEA_ID = 195813;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195813Service() {
        this(new Idea195813Config());
    }

    public Idea195813Service(Idea195813Config config) {
        this.config = config != null ? config : new Idea195813Config();
