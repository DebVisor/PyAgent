...
@Data
public class Idea196065Config {
    private String name = "idea_196065";
 ...
 */
@Slf4j
public class Idea196065Service {
    private static final int IDEA_ID = 196065;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196065Service() {
        this(new Idea196065Config());
    }

    public Idea196065Service(Idea196065Config config) {
        this.config = config != null ? config : new Idea196065Config();
