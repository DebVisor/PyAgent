...
@Data
public class Idea196144Config {
    private String name = "idea_196144";
 ...
 */
@Slf4j
public class Idea196144Service {
    private static final int IDEA_ID = 196144;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196144Service() {
        this(new Idea196144Config());
    }

    public Idea196144Service(Idea196144Config config) {
        this.config = config != null ? config : new Idea196144Config();
