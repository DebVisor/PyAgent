...
@Data
public class Idea195941Config {
    private String name = "idea_195941";
 ...
 */
@Slf4j
public class Idea195941Service {
    private static final int IDEA_ID = 195941;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195941Service() {
        this(new Idea195941Config());
    }

    public Idea195941Service(Idea195941Config config) {
        this.config = config != null ? config : new Idea195941Config();
