...
@Data
public class Idea196114Config {
    private String name = "idea_196114";
 ...
 */
@Slf4j
public class Idea196114Service {
    private static final int IDEA_ID = 196114;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196114Service() {
        this(new Idea196114Config());
    }

    public Idea196114Service(Idea196114Config config) {
        this.config = config != null ? config : new Idea196114Config();
