...
@Data
public class Idea196093Config {
    private String name = "idea_196093";
 ...
 */
@Slf4j
public class Idea196093Service {
    private static final int IDEA_ID = 196093;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196093Service() {
        this(new Idea196093Config());
    }

    public Idea196093Service(Idea196093Config config) {
        this.config = config != null ? config : new Idea196093Config();
