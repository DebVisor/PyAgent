...
@Data
public class Idea195860Config {
    private String name = "idea_195860";
 ...
 */
@Slf4j
public class Idea195860Service {
    private static final int IDEA_ID = 195860;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195860Service() {
        this(new Idea195860Config());
    }

    public Idea195860Service(Idea195860Config config) {
        this.config = config != null ? config : new Idea195860Config();
