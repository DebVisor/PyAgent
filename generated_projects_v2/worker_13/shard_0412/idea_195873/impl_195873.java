...
@Data
public class Idea195873Config {
    private String name = "idea_195873";
 ...
 */
@Slf4j
public class Idea195873Service {
    private static final int IDEA_ID = 195873;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195873Service() {
        this(new Idea195873Config());
    }

    public Idea195873Service(Idea195873Config config) {
        this.config = config != null ? config : new Idea195873Config();
