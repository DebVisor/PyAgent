...
@Data
public class Idea195825Config {
    private String name = "idea_195825";
 ...
 */
@Slf4j
public class Idea195825Service {
    private static final int IDEA_ID = 195825;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195825Service() {
        this(new Idea195825Config());
    }

    public Idea195825Service(Idea195825Config config) {
        this.config = config != null ? config : new Idea195825Config();
