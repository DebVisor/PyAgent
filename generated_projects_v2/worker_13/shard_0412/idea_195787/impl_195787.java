...
@Data
public class Idea195787Config {
    private String name = "idea_195787";
 ...
 */
@Slf4j
public class Idea195787Service {
    private static final int IDEA_ID = 195787;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195787Service() {
        this(new Idea195787Config());
    }

    public Idea195787Service(Idea195787Config config) {
        this.config = config != null ? config : new Idea195787Config();
