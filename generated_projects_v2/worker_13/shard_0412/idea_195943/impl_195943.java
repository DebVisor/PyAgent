...
@Data
public class Idea195943Config {
    private String name = "idea_195943";
 ...
 */
@Slf4j
public class Idea195943Service {
    private static final int IDEA_ID = 195943;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195943Service() {
        this(new Idea195943Config());
    }

    public Idea195943Service(Idea195943Config config) {
        this.config = config != null ? config : new Idea195943Config();
