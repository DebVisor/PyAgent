...
@Data
public class Idea195974Config {
    private String name = "idea_195974";
 ...
 */
@Slf4j
public class Idea195974Service {
    private static final int IDEA_ID = 195974;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195974Service() {
        this(new Idea195974Config());
    }

    public Idea195974Service(Idea195974Config config) {
        this.config = config != null ? config : new Idea195974Config();
