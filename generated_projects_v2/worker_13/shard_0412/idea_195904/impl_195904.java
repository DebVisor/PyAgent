...
@Data
public class Idea195904Config {
    private String name = "idea_195904";
 ...
 */
@Slf4j
public class Idea195904Service {
    private static final int IDEA_ID = 195904;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195904Service() {
        this(new Idea195904Config());
    }

    public Idea195904Service(Idea195904Config config) {
        this.config = config != null ? config : new Idea195904Config();
