...
@Data
public class Idea196027Config {
    private String name = "idea_196027";
 ...
 */
@Slf4j
public class Idea196027Service {
    private static final int IDEA_ID = 196027;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196027Service() {
        this(new Idea196027Config());
    }

    public Idea196027Service(Idea196027Config config) {
        this.config = config != null ? config : new Idea196027Config();
