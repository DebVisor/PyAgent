...
@Data
public class Idea195998Config {
    private String name = "idea_195998";
 ...
 */
@Slf4j
public class Idea195998Service {
    private static final int IDEA_ID = 195998;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195998Service() {
        this(new Idea195998Config());
    }

    public Idea195998Service(Idea195998Config config) {
        this.config = config != null ? config : new Idea195998Config();
