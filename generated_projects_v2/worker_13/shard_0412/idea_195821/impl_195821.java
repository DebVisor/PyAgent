...
@Data
public class Idea195821Config {
    private String name = "idea_195821";
 ...
 */
@Slf4j
public class Idea195821Service {
    private static final int IDEA_ID = 195821;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195821Service() {
        this(new Idea195821Config());
    }

    public Idea195821Service(Idea195821Config config) {
        this.config = config != null ? config : new Idea195821Config();
