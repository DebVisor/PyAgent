...
@Data
public class Idea196077Config {
    private String name = "idea_196077";
 ...
 */
@Slf4j
public class Idea196077Service {
    private static final int IDEA_ID = 196077;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196077Service() {
        this(new Idea196077Config());
    }

    public Idea196077Service(Idea196077Config config) {
        this.config = config != null ? config : new Idea196077Config();
