...
@Data
public class Idea195962Config {
    private String name = "idea_195962";
 ...
 */
@Slf4j
public class Idea195962Service {
    private static final int IDEA_ID = 195962;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195962Service() {
        this(new Idea195962Config());
    }

    public Idea195962Service(Idea195962Config config) {
        this.config = config != null ? config : new Idea195962Config();
