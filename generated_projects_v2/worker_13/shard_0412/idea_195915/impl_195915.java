...
@Data
public class Idea195915Config {
    private String name = "idea_195915";
 ...
 */
@Slf4j
public class Idea195915Service {
    private static final int IDEA_ID = 195915;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195915Service() {
        this(new Idea195915Config());
    }

    public Idea195915Service(Idea195915Config config) {
        this.config = config != null ? config : new Idea195915Config();
