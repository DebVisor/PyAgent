...
@Data
public class Idea196069Config {
    private String name = "idea_196069";
 ...
 */
@Slf4j
public class Idea196069Service {
    private static final int IDEA_ID = 196069;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196069Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196069Service() {
        this(new Idea196069Config());
    }

    public Idea196069Service(Idea196069Config config) {
        this.config = config != null ? config : new Idea196069Config();
