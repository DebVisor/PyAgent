...
@Data
public class Idea195726Config {
    private String name = "idea_195726";
 ...
 */
@Slf4j
public class Idea195726Service {
    private static final int IDEA_ID = 195726;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195726Service() {
        this(new Idea195726Config());
    }

    public Idea195726Service(Idea195726Config config) {
        this.config = config != null ? config : new Idea195726Config();
