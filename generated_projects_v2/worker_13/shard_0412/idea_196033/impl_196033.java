...
@Data
public class Idea196033Config {
    private String name = "idea_196033";
 ...
 */
@Slf4j
public class Idea196033Service {
    private static final int IDEA_ID = 196033;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196033Service() {
        this(new Idea196033Config());
    }

    public Idea196033Service(Idea196033Config config) {
        this.config = config != null ? config : new Idea196033Config();
