...
@Data
public class Idea195750Config {
    private String name = "idea_195750";
 ...
 */
@Slf4j
public class Idea195750Service {
    private static final int IDEA_ID = 195750;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195750Service() {
        this(new Idea195750Config());
    }

    public Idea195750Service(Idea195750Config config) {
        this.config = config != null ? config : new Idea195750Config();
