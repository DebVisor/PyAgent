...
@Data
public class Idea195816Config {
    private String name = "idea_195816";
 ...
 */
@Slf4j
public class Idea195816Service {
    private static final int IDEA_ID = 195816;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195816Service() {
        this(new Idea195816Config());
    }

    public Idea195816Service(Idea195816Config config) {
        this.config = config != null ? config : new Idea195816Config();
