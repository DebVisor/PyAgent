...
@Data
public class Idea195774Config {
    private String name = "idea_195774";
 ...
 */
@Slf4j
public class Idea195774Service {
    private static final int IDEA_ID = 195774;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195774Service() {
        this(new Idea195774Config());
    }

    public Idea195774Service(Idea195774Config config) {
        this.config = config != null ? config : new Idea195774Config();
