...
@Data
public class Idea195706Config {
    private String name = "idea_195706";
 ...
 */
@Slf4j
public class Idea195706Service {
    private static final int IDEA_ID = 195706;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195706Service() {
        this(new Idea195706Config());
    }

    public Idea195706Service(Idea195706Config config) {
        this.config = config != null ? config : new Idea195706Config();
