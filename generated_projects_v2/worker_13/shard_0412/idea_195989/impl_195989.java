...
@Data
public class Idea195989Config {
    private String name = "idea_195989";
 ...
 */
@Slf4j
public class Idea195989Service {
    private static final int IDEA_ID = 195989;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195989Service() {
        this(new Idea195989Config());
    }

    public Idea195989Service(Idea195989Config config) {
        this.config = config != null ? config : new Idea195989Config();
