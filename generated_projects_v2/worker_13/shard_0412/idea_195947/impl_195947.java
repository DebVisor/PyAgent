...
@Data
public class Idea195947Config {
    private String name = "idea_195947";
 ...
 */
@Slf4j
public class Idea195947Service {
    private static final int IDEA_ID = 195947;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195947Service() {
        this(new Idea195947Config());
    }

    public Idea195947Service(Idea195947Config config) {
        this.config = config != null ? config : new Idea195947Config();
