...
@Data
public class Idea196170Config {
    private String name = "idea_196170";
 ...
 */
@Slf4j
public class Idea196170Service {
    private static final int IDEA_ID = 196170;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196170Service() {
        this(new Idea196170Config());
    }

    public Idea196170Service(Idea196170Config config) {
        this.config = config != null ? config : new Idea196170Config();
