...
@Data
public class Idea195812Config {
    private String name = "idea_195812";
 ...
 */
@Slf4j
public class Idea195812Service {
    private static final int IDEA_ID = 195812;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195812Service() {
        this(new Idea195812Config());
    }

    public Idea195812Service(Idea195812Config config) {
        this.config = config != null ? config : new Idea195812Config();
