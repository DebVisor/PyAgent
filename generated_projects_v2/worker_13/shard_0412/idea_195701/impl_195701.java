...
@Data
public class Idea195701Config {
    private String name = "idea_195701";
 ...
 */
@Slf4j
public class Idea195701Service {
    private static final int IDEA_ID = 195701;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195701Service() {
        this(new Idea195701Config());
    }

    public Idea195701Service(Idea195701Config config) {
        this.config = config != null ? config : new Idea195701Config();
