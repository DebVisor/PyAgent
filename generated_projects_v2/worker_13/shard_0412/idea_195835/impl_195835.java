...
@Data
public class Idea195835Config {
    private String name = "idea_195835";
 ...
 */
@Slf4j
public class Idea195835Service {
    private static final int IDEA_ID = 195835;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195835Service() {
        this(new Idea195835Config());
    }

    public Idea195835Service(Idea195835Config config) {
        this.config = config != null ? config : new Idea195835Config();
