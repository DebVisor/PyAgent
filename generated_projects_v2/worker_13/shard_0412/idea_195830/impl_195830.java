...
@Data
public class Idea195830Config {
    private String name = "idea_195830";
 ...
 */
@Slf4j
public class Idea195830Service {
    private static final int IDEA_ID = 195830;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195830Service() {
        this(new Idea195830Config());
    }

    public Idea195830Service(Idea195830Config config) {
        this.config = config != null ? config : new Idea195830Config();
