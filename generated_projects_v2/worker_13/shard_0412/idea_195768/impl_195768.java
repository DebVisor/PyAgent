...
@Data
public class Idea195768Config {
    private String name = "idea_195768";
 ...
 */
@Slf4j
public class Idea195768Service {
    private static final int IDEA_ID = 195768;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195768Service() {
        this(new Idea195768Config());
    }

    public Idea195768Service(Idea195768Config config) {
        this.config = config != null ? config : new Idea195768Config();
