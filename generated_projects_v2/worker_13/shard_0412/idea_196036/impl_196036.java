...
@Data
public class Idea196036Config {
    private String name = "idea_196036";
 ...
 */
@Slf4j
public class Idea196036Service {
    private static final int IDEA_ID = 196036;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196036Service() {
        this(new Idea196036Config());
    }

    public Idea196036Service(Idea196036Config config) {
        this.config = config != null ? config : new Idea196036Config();
