...
@Data
public class Idea196135Config {
    private String name = "idea_196135";
 ...
 */
@Slf4j
public class Idea196135Service {
    private static final int IDEA_ID = 196135;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196135Service() {
        this(new Idea196135Config());
    }

    public Idea196135Service(Idea196135Config config) {
        this.config = config != null ? config : new Idea196135Config();
