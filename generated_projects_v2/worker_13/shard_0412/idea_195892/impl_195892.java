...
@Data
public class Idea195892Config {
    private String name = "idea_195892";
 ...
 */
@Slf4j
public class Idea195892Service {
    private static final int IDEA_ID = 195892;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195892Service() {
        this(new Idea195892Config());
    }

    public Idea195892Service(Idea195892Config config) {
        this.config = config != null ? config : new Idea195892Config();
