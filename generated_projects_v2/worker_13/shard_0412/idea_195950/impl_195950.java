...
@Data
public class Idea195950Config {
    private String name = "idea_195950";
 ...
 */
@Slf4j
public class Idea195950Service {
    private static final int IDEA_ID = 195950;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195950Service() {
        this(new Idea195950Config());
    }

    public Idea195950Service(Idea195950Config config) {
        this.config = config != null ? config : new Idea195950Config();
