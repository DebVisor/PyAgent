...
@Data
public class Idea195979Config {
    private String name = "idea_195979";
 ...
 */
@Slf4j
public class Idea195979Service {
    private static final int IDEA_ID = 195979;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195979Service() {
        this(new Idea195979Config());
    }

    public Idea195979Service(Idea195979Config config) {
        this.config = config != null ? config : new Idea195979Config();
