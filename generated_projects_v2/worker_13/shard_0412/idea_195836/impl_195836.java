...
@Data
public class Idea195836Config {
    private String name = "idea_195836";
 ...
 */
@Slf4j
public class Idea195836Service {
    private static final int IDEA_ID = 195836;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195836Service() {
        this(new Idea195836Config());
    }

    public Idea195836Service(Idea195836Config config) {
        this.config = config != null ? config : new Idea195836Config();
