...
@Data
public class Idea196164Config {
    private String name = "idea_196164";
 ...
 */
@Slf4j
public class Idea196164Service {
    private static final int IDEA_ID = 196164;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196164Service() {
        this(new Idea196164Config());
    }

    public Idea196164Service(Idea196164Config config) {
        this.config = config != null ? config : new Idea196164Config();
