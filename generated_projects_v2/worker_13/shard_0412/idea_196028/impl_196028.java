...
@Data
public class Idea196028Config {
    private String name = "idea_196028";
 ...
 */
@Slf4j
public class Idea196028Service {
    private static final int IDEA_ID = 196028;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196028Service() {
        this(new Idea196028Config());
    }

    public Idea196028Service(Idea196028Config config) {
        this.config = config != null ? config : new Idea196028Config();
