...
@Data
public class Idea195936Config {
    private String name = "idea_195936";
 ...
 */
@Slf4j
public class Idea195936Service {
    private static final int IDEA_ID = 195936;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195936Service() {
        this(new Idea195936Config());
    }

    public Idea195936Service(Idea195936Config config) {
        this.config = config != null ? config : new Idea195936Config();
