...
@Data
public class Idea195888Config {
    private String name = "idea_195888";
 ...
 */
@Slf4j
public class Idea195888Service {
    private static final int IDEA_ID = 195888;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195888Service() {
        this(new Idea195888Config());
    }

    public Idea195888Service(Idea195888Config config) {
        this.config = config != null ? config : new Idea195888Config();
