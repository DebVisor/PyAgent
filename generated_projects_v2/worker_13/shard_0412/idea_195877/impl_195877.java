...
@Data
public class Idea195877Config {
    private String name = "idea_195877";
 ...
 */
@Slf4j
public class Idea195877Service {
    private static final int IDEA_ID = 195877;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195877Service() {
        this(new Idea195877Config());
    }

    public Idea195877Service(Idea195877Config config) {
        this.config = config != null ? config : new Idea195877Config();
