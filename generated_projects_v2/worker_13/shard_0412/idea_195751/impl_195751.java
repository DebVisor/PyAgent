...
@Data
public class Idea195751Config {
    private String name = "idea_195751";
 ...
 */
@Slf4j
public class Idea195751Service {
    private static final int IDEA_ID = 195751;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195751Service() {
        this(new Idea195751Config());
    }

    public Idea195751Service(Idea195751Config config) {
        this.config = config != null ? config : new Idea195751Config();
