...
@Data
public class Idea196084Config {
    private String name = "idea_196084";
 ...
 */
@Slf4j
public class Idea196084Service {
    private static final int IDEA_ID = 196084;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196084Service() {
        this(new Idea196084Config());
    }

    public Idea196084Service(Idea196084Config config) {
        this.config = config != null ? config : new Idea196084Config();
