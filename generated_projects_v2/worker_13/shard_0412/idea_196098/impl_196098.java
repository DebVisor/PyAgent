...
@Data
public class Idea196098Config {
    private String name = "idea_196098";
 ...
 */
@Slf4j
public class Idea196098Service {
    private static final int IDEA_ID = 196098;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196098Service() {
        this(new Idea196098Config());
    }

    public Idea196098Service(Idea196098Config config) {
        this.config = config != null ? config : new Idea196098Config();
