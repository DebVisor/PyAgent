...
@Data
public class Idea195740Config {
    private String name = "idea_195740";
 ...
 */
@Slf4j
public class Idea195740Service {
    private static final int IDEA_ID = 195740;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195740Service() {
        this(new Idea195740Config());
    }

    public Idea195740Service(Idea195740Config config) {
        this.config = config != null ? config : new Idea195740Config();
