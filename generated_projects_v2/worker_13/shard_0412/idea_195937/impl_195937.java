...
@Data
public class Idea195937Config {
    private String name = "idea_195937";
 ...
 */
@Slf4j
public class Idea195937Service {
    private static final int IDEA_ID = 195937;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195937Service() {
        this(new Idea195937Config());
    }

    public Idea195937Service(Idea195937Config config) {
        this.config = config != null ? config : new Idea195937Config();
