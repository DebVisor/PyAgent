...
@Data
public class Idea195790Config {
    private String name = "idea_195790";
 ...
 */
@Slf4j
public class Idea195790Service {
    private static final int IDEA_ID = 195790;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195790Service() {
        this(new Idea195790Config());
    }

    public Idea195790Service(Idea195790Config config) {
        this.config = config != null ? config : new Idea195790Config();
