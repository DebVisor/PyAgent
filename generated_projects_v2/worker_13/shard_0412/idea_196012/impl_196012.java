...
@Data
public class Idea196012Config {
    private String name = "idea_196012";
 ...
 */
@Slf4j
public class Idea196012Service {
    private static final int IDEA_ID = 196012;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196012Service() {
        this(new Idea196012Config());
    }

    public Idea196012Service(Idea196012Config config) {
        this.config = config != null ? config : new Idea196012Config();
