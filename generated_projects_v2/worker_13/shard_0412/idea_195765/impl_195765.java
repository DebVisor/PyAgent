...
@Data
public class Idea195765Config {
    private String name = "idea_195765";
 ...
 */
@Slf4j
public class Idea195765Service {
    private static final int IDEA_ID = 195765;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195765Service() {
        this(new Idea195765Config());
    }

    public Idea195765Service(Idea195765Config config) {
        this.config = config != null ? config : new Idea195765Config();
