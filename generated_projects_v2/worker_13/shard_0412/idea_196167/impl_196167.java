...
@Data
public class Idea196167Config {
    private String name = "idea_196167";
 ...
 */
@Slf4j
public class Idea196167Service {
    private static final int IDEA_ID = 196167;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196167Service() {
        this(new Idea196167Config());
    }

    public Idea196167Service(Idea196167Config config) {
        this.config = config != null ? config : new Idea196167Config();
