...
@Data
public class Idea195775Config {
    private String name = "idea_195775";
 ...
 */
@Slf4j
public class Idea195775Service {
    private static final int IDEA_ID = 195775;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195775Service() {
        this(new Idea195775Config());
    }

    public Idea195775Service(Idea195775Config config) {
        this.config = config != null ? config : new Idea195775Config();
