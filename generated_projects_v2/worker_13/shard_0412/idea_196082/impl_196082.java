...
@Data
public class Idea196082Config {
    private String name = "idea_196082";
 ...
 */
@Slf4j
public class Idea196082Service {
    private static final int IDEA_ID = 196082;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196082Service() {
        this(new Idea196082Config());
    }

    public Idea196082Service(Idea196082Config config) {
        this.config = config != null ? config : new Idea196082Config();
