...
@Data
public class Idea195780Config {
    private String name = "idea_195780";
 ...
 */
@Slf4j
public class Idea195780Service {
    private static final int IDEA_ID = 195780;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195780Service() {
        this(new Idea195780Config());
    }

    public Idea195780Service(Idea195780Config config) {
        this.config = config != null ? config : new Idea195780Config();
