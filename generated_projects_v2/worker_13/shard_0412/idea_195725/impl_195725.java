...
@Data
public class Idea195725Config {
    private String name = "idea_195725";
 ...
 */
@Slf4j
public class Idea195725Service {
    private static final int IDEA_ID = 195725;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195725Service() {
        this(new Idea195725Config());
    }

    public Idea195725Service(Idea195725Config config) {
        this.config = config != null ? config : new Idea195725Config();
