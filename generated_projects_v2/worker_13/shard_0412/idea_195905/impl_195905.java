...
@Data
public class Idea195905Config {
    private String name = "idea_195905";
 ...
 */
@Slf4j
public class Idea195905Service {
    private static final int IDEA_ID = 195905;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195905Service() {
        this(new Idea195905Config());
    }

    public Idea195905Service(Idea195905Config config) {
        this.config = config != null ? config : new Idea195905Config();
