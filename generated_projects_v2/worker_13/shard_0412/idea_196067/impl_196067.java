...
@Data
public class Idea196067Config {
    private String name = "idea_196067";
 ...
 */
@Slf4j
public class Idea196067Service {
    private static final int IDEA_ID = 196067;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196067Service() {
        this(new Idea196067Config());
    }

    public Idea196067Service(Idea196067Config config) {
        this.config = config != null ? config : new Idea196067Config();
