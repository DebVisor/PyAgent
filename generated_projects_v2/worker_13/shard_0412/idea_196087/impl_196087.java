...
@Data
public class Idea196087Config {
    private String name = "idea_196087";
 ...
 */
@Slf4j
public class Idea196087Service {
    private static final int IDEA_ID = 196087;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196087Service() {
        this(new Idea196087Config());
    }

    public Idea196087Service(Idea196087Config config) {
        this.config = config != null ? config : new Idea196087Config();
