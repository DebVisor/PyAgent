...
@Data
public class Idea195902Config {
    private String name = "idea_195902";
 ...
 */
@Slf4j
public class Idea195902Service {
    private static final int IDEA_ID = 195902;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195902Service() {
        this(new Idea195902Config());
    }

    public Idea195902Service(Idea195902Config config) {
        this.config = config != null ? config : new Idea195902Config();
