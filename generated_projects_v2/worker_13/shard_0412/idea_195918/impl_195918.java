...
@Data
public class Idea195918Config {
    private String name = "idea_195918";
 ...
 */
@Slf4j
public class Idea195918Service {
    private static final int IDEA_ID = 195918;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195918Service() {
        this(new Idea195918Config());
    }

    public Idea195918Service(Idea195918Config config) {
        this.config = config != null ? config : new Idea195918Config();
