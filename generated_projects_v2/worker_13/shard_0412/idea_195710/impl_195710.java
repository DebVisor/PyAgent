...
@Data
public class Idea195710Config {
    private String name = "idea_195710";
 ...
 */
@Slf4j
public class Idea195710Service {
    private static final int IDEA_ID = 195710;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195710Service() {
        this(new Idea195710Config());
    }

    public Idea195710Service(Idea195710Config config) {
        this.config = config != null ? config : new Idea195710Config();
