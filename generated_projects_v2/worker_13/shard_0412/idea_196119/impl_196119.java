...
@Data
public class Idea196119Config {
    private String name = "idea_196119";
 ...
 */
@Slf4j
public class Idea196119Service {
    private static final int IDEA_ID = 196119;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196119Service() {
        this(new Idea196119Config());
    }

    public Idea196119Service(Idea196119Config config) {
        this.config = config != null ? config : new Idea196119Config();
