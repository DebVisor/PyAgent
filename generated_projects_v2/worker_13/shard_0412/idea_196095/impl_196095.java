...
@Data
public class Idea196095Config {
    private String name = "idea_196095";
 ...
 */
@Slf4j
public class Idea196095Service {
    private static final int IDEA_ID = 196095;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196095Service() {
        this(new Idea196095Config());
    }

    public Idea196095Service(Idea196095Config config) {
        this.config = config != null ? config : new Idea196095Config();
