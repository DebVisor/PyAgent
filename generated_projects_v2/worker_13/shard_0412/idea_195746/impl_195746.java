...
@Data
public class Idea195746Config {
    private String name = "idea_195746";
 ...
 */
@Slf4j
public class Idea195746Service {
    private static final int IDEA_ID = 195746;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195746Service() {
        this(new Idea195746Config());
    }

    public Idea195746Service(Idea195746Config config) {
        this.config = config != null ? config : new Idea195746Config();
