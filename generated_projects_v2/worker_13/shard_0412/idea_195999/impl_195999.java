...
@Data
public class Idea195999Config {
    private String name = "idea_195999";
 ...
 */
@Slf4j
public class Idea195999Service {
    private static final int IDEA_ID = 195999;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195999Service() {
        this(new Idea195999Config());
    }

    public Idea195999Service(Idea195999Config config) {
        this.config = config != null ? config : new Idea195999Config();
