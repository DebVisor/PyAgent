...
@Data
public class Idea195818Config {
    private String name = "idea_195818";
 ...
 */
@Slf4j
public class Idea195818Service {
    private static final int IDEA_ID = 195818;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195818Service() {
        this(new Idea195818Config());
    }

    public Idea195818Service(Idea195818Config config) {
        this.config = config != null ? config : new Idea195818Config();
