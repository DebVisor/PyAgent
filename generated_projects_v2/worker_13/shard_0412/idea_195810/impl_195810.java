...
@Data
public class Idea195810Config {
    private String name = "idea_195810";
 ...
 */
@Slf4j
public class Idea195810Service {
    private static final int IDEA_ID = 195810;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195810Service() {
        this(new Idea195810Config());
    }

    public Idea195810Service(Idea195810Config config) {
        this.config = config != null ? config : new Idea195810Config();
