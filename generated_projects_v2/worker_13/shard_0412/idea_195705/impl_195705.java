...
@Data
public class Idea195705Config {
    private String name = "idea_195705";
 ...
 */
@Slf4j
public class Idea195705Service {
    private static final int IDEA_ID = 195705;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195705Service() {
        this(new Idea195705Config());
    }

    public Idea195705Service(Idea195705Config config) {
        this.config = config != null ? config : new Idea195705Config();
