...
@Data
public class Idea195975Config {
    private String name = "idea_195975";
 ...
 */
@Slf4j
public class Idea195975Service {
    private static final int IDEA_ID = 195975;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195975Service() {
        this(new Idea195975Config());
    }

    public Idea195975Service(Idea195975Config config) {
        this.config = config != null ? config : new Idea195975Config();
