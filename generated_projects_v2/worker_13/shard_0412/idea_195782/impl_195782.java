...
@Data
public class Idea195782Config {
    private String name = "idea_195782";
 ...
 */
@Slf4j
public class Idea195782Service {
    private static final int IDEA_ID = 195782;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195782Service() {
        this(new Idea195782Config());
    }

    public Idea195782Service(Idea195782Config config) {
        this.config = config != null ? config : new Idea195782Config();
