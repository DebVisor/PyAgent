...
@Data
public class Idea195853Config {
    private String name = "idea_195853";
 ...
 */
@Slf4j
public class Idea195853Service {
    private static final int IDEA_ID = 195853;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195853Service() {
        this(new Idea195853Config());
    }

    public Idea195853Service(Idea195853Config config) {
        this.config = config != null ? config : new Idea195853Config();
