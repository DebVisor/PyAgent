...
@Data
public class Idea195847Config {
    private String name = "idea_195847";
 ...
 */
@Slf4j
public class Idea195847Service {
    private static final int IDEA_ID = 195847;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195847Service() {
        this(new Idea195847Config());
    }

    public Idea195847Service(Idea195847Config config) {
        this.config = config != null ? config : new Idea195847Config();
