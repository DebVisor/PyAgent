...
@Data
public class Idea195758Config {
    private String name = "idea_195758";
 ...
 */
@Slf4j
public class Idea195758Service {
    private static final int IDEA_ID = 195758;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195758Service() {
        this(new Idea195758Config());
    }

    public Idea195758Service(Idea195758Config config) {
        this.config = config != null ? config : new Idea195758Config();
