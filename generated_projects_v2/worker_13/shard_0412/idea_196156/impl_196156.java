...
@Data
public class Idea196156Config {
    private String name = "idea_196156";
 ...
 */
@Slf4j
public class Idea196156Service {
    private static final int IDEA_ID = 196156;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196156Service() {
        this(new Idea196156Config());
    }

    public Idea196156Service(Idea196156Config config) {
        this.config = config != null ? config : new Idea196156Config();
