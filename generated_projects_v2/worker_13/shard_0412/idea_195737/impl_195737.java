...
@Data
public class Idea195737Config {
    private String name = "idea_195737";
 ...
 */
@Slf4j
public class Idea195737Service {
    private static final int IDEA_ID = 195737;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195737Service() {
        this(new Idea195737Config());
    }

    public Idea195737Service(Idea195737Config config) {
        this.config = config != null ? config : new Idea195737Config();
