...
@Data
public class Idea196165Config {
    private String name = "idea_196165";
 ...
 */
@Slf4j
public class Idea196165Service {
    private static final int IDEA_ID = 196165;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196165Service() {
        this(new Idea196165Config());
    }

    public Idea196165Service(Idea196165Config config) {
        this.config = config != null ? config : new Idea196165Config();
