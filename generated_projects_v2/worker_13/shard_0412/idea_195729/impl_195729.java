...
@Data
public class Idea195729Config {
    private String name = "idea_195729";
 ...
 */
@Slf4j
public class Idea195729Service {
    private static final int IDEA_ID = 195729;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195729Service() {
        this(new Idea195729Config());
    }

    public Idea195729Service(Idea195729Config config) {
        this.config = config != null ? config : new Idea195729Config();
