...
@Data
public class Idea195960Config {
    private String name = "idea_195960";
 ...
 */
@Slf4j
public class Idea195960Service {
    private static final int IDEA_ID = 195960;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195960Service() {
        this(new Idea195960Config());
    }

    public Idea195960Service(Idea195960Config config) {
        this.config = config != null ? config : new Idea195960Config();
