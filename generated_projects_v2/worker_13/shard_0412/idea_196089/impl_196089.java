...
@Data
public class Idea196089Config {
    private String name = "idea_196089";
 ...
 */
@Slf4j
public class Idea196089Service {
    private static final int IDEA_ID = 196089;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196089Service() {
        this(new Idea196089Config());
    }

    public Idea196089Service(Idea196089Config config) {
        this.config = config != null ? config : new Idea196089Config();
