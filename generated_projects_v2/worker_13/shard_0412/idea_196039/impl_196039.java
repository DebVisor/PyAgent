...
@Data
public class Idea196039Config {
    private String name = "idea_196039";
 ...
 */
@Slf4j
public class Idea196039Service {
    private static final int IDEA_ID = 196039;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196039Service() {
        this(new Idea196039Config());
    }

    public Idea196039Service(Idea196039Config config) {
        this.config = config != null ? config : new Idea196039Config();
