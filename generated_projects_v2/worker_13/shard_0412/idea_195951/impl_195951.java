...
@Data
public class Idea195951Config {
    private String name = "idea_195951";
 ...
 */
@Slf4j
public class Idea195951Service {
    private static final int IDEA_ID = 195951;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195951Service() {
        this(new Idea195951Config());
    }

    public Idea195951Service(Idea195951Config config) {
        this.config = config != null ? config : new Idea195951Config();
