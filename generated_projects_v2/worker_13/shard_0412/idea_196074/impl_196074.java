...
@Data
public class Idea196074Config {
    private String name = "idea_196074";
 ...
 */
@Slf4j
public class Idea196074Service {
    private static final int IDEA_ID = 196074;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196074Service() {
        this(new Idea196074Config());
    }

    public Idea196074Service(Idea196074Config config) {
        this.config = config != null ? config : new Idea196074Config();
