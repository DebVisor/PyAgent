...
@Data
public class Idea196103Config {
    private String name = "idea_196103";
 ...
 */
@Slf4j
public class Idea196103Service {
    private static final int IDEA_ID = 196103;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196103Service() {
        this(new Idea196103Config());
    }

    public Idea196103Service(Idea196103Config config) {
        this.config = config != null ? config : new Idea196103Config();
