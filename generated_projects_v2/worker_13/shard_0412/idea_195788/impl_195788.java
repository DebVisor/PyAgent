...
@Data
public class Idea195788Config {
    private String name = "idea_195788";
 ...
 */
@Slf4j
public class Idea195788Service {
    private static final int IDEA_ID = 195788;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195788Service() {
        this(new Idea195788Config());
    }

    public Idea195788Service(Idea195788Config config) {
        this.config = config != null ? config : new Idea195788Config();
