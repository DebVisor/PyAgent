...
@Data
public class Idea195771Config {
    private String name = "idea_195771";
 ...
 */
@Slf4j
public class Idea195771Service {
    private static final int IDEA_ID = 195771;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195771Service() {
        this(new Idea195771Config());
    }

    public Idea195771Service(Idea195771Config config) {
        this.config = config != null ? config : new Idea195771Config();
