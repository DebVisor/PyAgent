...
@Data
public class Idea195801Config {
    private String name = "idea_195801";
 ...
 */
@Slf4j
public class Idea195801Service {
    private static final int IDEA_ID = 195801;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195801Service() {
        this(new Idea195801Config());
    }

    public Idea195801Service(Idea195801Config config) {
        this.config = config != null ? config : new Idea195801Config();
