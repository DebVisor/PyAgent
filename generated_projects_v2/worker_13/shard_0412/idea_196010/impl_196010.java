...
@Data
public class Idea196010Config {
    private String name = "idea_196010";
 ...
 */
@Slf4j
public class Idea196010Service {
    private static final int IDEA_ID = 196010;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196010Service() {
        this(new Idea196010Config());
    }

    public Idea196010Service(Idea196010Config config) {
        this.config = config != null ? config : new Idea196010Config();
