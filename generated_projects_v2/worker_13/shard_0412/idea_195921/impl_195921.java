...
@Data
public class Idea195921Config {
    private String name = "idea_195921";
 ...
 */
@Slf4j
public class Idea195921Service {
    private static final int IDEA_ID = 195921;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195921Service() {
        this(new Idea195921Config());
    }

    public Idea195921Service(Idea195921Config config) {
        this.config = config != null ? config : new Idea195921Config();
