...
@Data
public class Idea195773Config {
    private String name = "idea_195773";
 ...
 */
@Slf4j
public class Idea195773Service {
    private static final int IDEA_ID = 195773;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195773Service() {
        this(new Idea195773Config());
    }

    public Idea195773Service(Idea195773Config config) {
        this.config = config != null ? config : new Idea195773Config();
