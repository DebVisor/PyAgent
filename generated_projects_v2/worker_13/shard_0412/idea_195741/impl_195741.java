...
@Data
public class Idea195741Config {
    private String name = "idea_195741";
 ...
 */
@Slf4j
public class Idea195741Service {
    private static final int IDEA_ID = 195741;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195741Service() {
        this(new Idea195741Config());
    }

    public Idea195741Service(Idea195741Config config) {
        this.config = config != null ? config : new Idea195741Config();
