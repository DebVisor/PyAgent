...
@Data
public class Idea195709Config {
    private String name = "idea_195709";
 ...
 */
@Slf4j
public class Idea195709Service {
    private static final int IDEA_ID = 195709;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195709Service() {
        this(new Idea195709Config());
    }

    public Idea195709Service(Idea195709Config config) {
        this.config = config != null ? config : new Idea195709Config();
