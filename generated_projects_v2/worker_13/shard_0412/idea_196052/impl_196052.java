...
@Data
public class Idea196052Config {
    private String name = "idea_196052";
 ...
 */
@Slf4j
public class Idea196052Service {
    private static final int IDEA_ID = 196052;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196052Service() {
        this(new Idea196052Config());
    }

    public Idea196052Service(Idea196052Config config) {
        this.config = config != null ? config : new Idea196052Config();
