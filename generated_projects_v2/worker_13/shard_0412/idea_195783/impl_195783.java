...
@Data
public class Idea195783Config {
    private String name = "idea_195783";
 ...
 */
@Slf4j
public class Idea195783Service {
    private static final int IDEA_ID = 195783;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195783Service() {
        this(new Idea195783Config());
    }

    public Idea195783Service(Idea195783Config config) {
        this.config = config != null ? config : new Idea195783Config();
