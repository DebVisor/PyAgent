...
@Data
public class Idea196085Config {
    private String name = "idea_196085";
 ...
 */
@Slf4j
public class Idea196085Service {
    private static final int IDEA_ID = 196085;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196085Service() {
        this(new Idea196085Config());
    }

    public Idea196085Service(Idea196085Config config) {
        this.config = config != null ? config : new Idea196085Config();
