...
@Data
public class Idea196005Config {
    private String name = "idea_196005";
 ...
 */
@Slf4j
public class Idea196005Service {
    private static final int IDEA_ID = 196005;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196005Service() {
        this(new Idea196005Config());
    }

    public Idea196005Service(Idea196005Config config) {
        this.config = config != null ? config : new Idea196005Config();
