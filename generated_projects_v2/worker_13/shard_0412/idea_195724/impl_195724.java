...
@Data
public class Idea195724Config {
    private String name = "idea_195724";
 ...
 */
@Slf4j
public class Idea195724Service {
    private static final int IDEA_ID = 195724;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195724Service() {
        this(new Idea195724Config());
    }

    public Idea195724Service(Idea195724Config config) {
        this.config = config != null ? config : new Idea195724Config();
