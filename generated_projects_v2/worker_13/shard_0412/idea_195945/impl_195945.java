...
@Data
public class Idea195945Config {
    private String name = "idea_195945";
 ...
 */
@Slf4j
public class Idea195945Service {
    private static final int IDEA_ID = 195945;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195945Service() {
        this(new Idea195945Config());
    }

    public Idea195945Service(Idea195945Config config) {
        this.config = config != null ? config : new Idea195945Config();
