...
@Data
public class Idea195961Config {
    private String name = "idea_195961";
 ...
 */
@Slf4j
public class Idea195961Service {
    private static final int IDEA_ID = 195961;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195961Service() {
        this(new Idea195961Config());
    }

    public Idea195961Service(Idea195961Config config) {
        this.config = config != null ? config : new Idea195961Config();
