...
@Data
public class Idea195829Config {
    private String name = "idea_195829";
 ...
 */
@Slf4j
public class Idea195829Service {
    private static final int IDEA_ID = 195829;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195829Service() {
        this(new Idea195829Config());
    }

    public Idea195829Service(Idea195829Config config) {
        this.config = config != null ? config : new Idea195829Config();
