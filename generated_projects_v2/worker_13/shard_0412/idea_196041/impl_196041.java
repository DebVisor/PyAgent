...
@Data
public class Idea196041Config {
    private String name = "idea_196041";
 ...
 */
@Slf4j
public class Idea196041Service {
    private static final int IDEA_ID = 196041;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196041Service() {
        this(new Idea196041Config());
    }

    public Idea196041Service(Idea196041Config config) {
        this.config = config != null ? config : new Idea196041Config();
