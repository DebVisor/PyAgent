...
@Data
public class Idea195978Config {
    private String name = "idea_195978";
 ...
 */
@Slf4j
public class Idea195978Service {
    private static final int IDEA_ID = 195978;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195978Service() {
        this(new Idea195978Config());
    }

    public Idea195978Service(Idea195978Config config) {
        this.config = config != null ? config : new Idea195978Config();
