...
@Data
public class Idea196168Config {
    private String name = "idea_196168";
 ...
 */
@Slf4j
public class Idea196168Service {
    private static final int IDEA_ID = 196168;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196168Service() {
        this(new Idea196168Config());
    }

    public Idea196168Service(Idea196168Config config) {
        this.config = config != null ? config : new Idea196168Config();
