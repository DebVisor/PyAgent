...
@Data
public class Idea196049Config {
    private String name = "idea_196049";
 ...
 */
@Slf4j
public class Idea196049Service {
    private static final int IDEA_ID = 196049;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196049Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196049Service() {
        this(new Idea196049Config());
    }

    public Idea196049Service(Idea196049Config config) {
        this.config = config != null ? config : new Idea196049Config();
