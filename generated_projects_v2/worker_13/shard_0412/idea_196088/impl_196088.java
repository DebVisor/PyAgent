...
@Data
public class Idea196088Config {
    private String name = "idea_196088";
 ...
 */
@Slf4j
public class Idea196088Service {
    private static final int IDEA_ID = 196088;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196088Service() {
        this(new Idea196088Config());
    }

    public Idea196088Service(Idea196088Config config) {
        this.config = config != null ? config : new Idea196088Config();
