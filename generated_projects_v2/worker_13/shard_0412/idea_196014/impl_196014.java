...
@Data
public class Idea196014Config {
    private String name = "idea_196014";
 ...
 */
@Slf4j
public class Idea196014Service {
    private static final int IDEA_ID = 196014;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196014Service() {
        this(new Idea196014Config());
    }

    public Idea196014Service(Idea196014Config config) {
        this.config = config != null ? config : new Idea196014Config();
