...
@Data
public class Idea196055Config {
    private String name = "idea_196055";
 ...
 */
@Slf4j
public class Idea196055Service {
    private static final int IDEA_ID = 196055;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196055Service() {
        this(new Idea196055Config());
    }

    public Idea196055Service(Idea196055Config config) {
        this.config = config != null ? config : new Idea196055Config();
