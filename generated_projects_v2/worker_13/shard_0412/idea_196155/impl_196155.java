...
@Data
public class Idea196155Config {
    private String name = "idea_196155";
 ...
 */
@Slf4j
public class Idea196155Service {
    private static final int IDEA_ID = 196155;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196155Service() {
        this(new Idea196155Config());
    }

    public Idea196155Service(Idea196155Config config) {
        this.config = config != null ? config : new Idea196155Config();
