...
@Data
public class Idea195955Config {
    private String name = "idea_195955";
 ...
 */
@Slf4j
public class Idea195955Service {
    private static final int IDEA_ID = 195955;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195955Service() {
        this(new Idea195955Config());
    }

    public Idea195955Service(Idea195955Config config) {
        this.config = config != null ? config : new Idea195955Config();
