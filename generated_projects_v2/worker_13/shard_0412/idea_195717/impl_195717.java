...
@Data
public class Idea195717Config {
    private String name = "idea_195717";
 ...
 */
@Slf4j
public class Idea195717Service {
    private static final int IDEA_ID = 195717;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195717Service() {
        this(new Idea195717Config());
    }

    public Idea195717Service(Idea195717Config config) {
        this.config = config != null ? config : new Idea195717Config();
