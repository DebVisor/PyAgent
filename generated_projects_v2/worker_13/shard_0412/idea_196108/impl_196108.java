...
@Data
public class Idea196108Config {
    private String name = "idea_196108";
 ...
 */
@Slf4j
public class Idea196108Service {
    private static final int IDEA_ID = 196108;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196108Service() {
        this(new Idea196108Config());
    }

    public Idea196108Service(Idea196108Config config) {
        this.config = config != null ? config : new Idea196108Config();
