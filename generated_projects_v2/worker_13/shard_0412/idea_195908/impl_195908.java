...
@Data
public class Idea195908Config {
    private String name = "idea_195908";
 ...
 */
@Slf4j
public class Idea195908Service {
    private static final int IDEA_ID = 195908;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195908Service() {
        this(new Idea195908Config());
    }

    public Idea195908Service(Idea195908Config config) {
        this.config = config != null ? config : new Idea195908Config();
