...
@Data
public class Idea195793Config {
    private String name = "idea_195793";
 ...
 */
@Slf4j
public class Idea195793Service {
    private static final int IDEA_ID = 195793;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195793Service() {
        this(new Idea195793Config());
    }

    public Idea195793Service(Idea195793Config config) {
        this.config = config != null ? config : new Idea195793Config();
