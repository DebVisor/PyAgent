...
@Data
public class Idea195797Config {
    private String name = "idea_195797";
 ...
 */
@Slf4j
public class Idea195797Service {
    private static final int IDEA_ID = 195797;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195797Service() {
        this(new Idea195797Config());
    }

    public Idea195797Service(Idea195797Config config) {
        this.config = config != null ? config : new Idea195797Config();
