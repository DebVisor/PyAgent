...
@Data
public class Idea195964Config {
    private String name = "idea_195964";
 ...
 */
@Slf4j
public class Idea195964Service {
    private static final int IDEA_ID = 195964;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195964Service() {
        this(new Idea195964Config());
    }

    public Idea195964Service(Idea195964Config config) {
        this.config = config != null ? config : new Idea195964Config();
