...
@Data
public class Idea196143Config {
    private String name = "idea_196143";
 ...
 */
@Slf4j
public class Idea196143Service {
    private static final int IDEA_ID = 196143;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196143Service() {
        this(new Idea196143Config());
    }

    public Idea196143Service(Idea196143Config config) {
        this.config = config != null ? config : new Idea196143Config();
