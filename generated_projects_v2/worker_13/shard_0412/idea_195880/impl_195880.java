...
@Data
public class Idea195880Config {
    private String name = "idea_195880";
 ...
 */
@Slf4j
public class Idea195880Service {
    private static final int IDEA_ID = 195880;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195880Service() {
        this(new Idea195880Config());
    }

    public Idea195880Service(Idea195880Config config) {
        this.config = config != null ? config : new Idea195880Config();
