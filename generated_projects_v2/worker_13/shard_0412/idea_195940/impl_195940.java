...
@Data
public class Idea195940Config {
    private String name = "idea_195940";
 ...
 */
@Slf4j
public class Idea195940Service {
    private static final int IDEA_ID = 195940;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195940Service() {
        this(new Idea195940Config());
    }

    public Idea195940Service(Idea195940Config config) {
        this.config = config != null ? config : new Idea195940Config();
