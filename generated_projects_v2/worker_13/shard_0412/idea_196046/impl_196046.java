...
@Data
public class Idea196046Config {
    private String name = "idea_196046";
 ...
 */
@Slf4j
public class Idea196046Service {
    private static final int IDEA_ID = 196046;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196046Service() {
        this(new Idea196046Config());
    }

    public Idea196046Service(Idea196046Config config) {
        this.config = config != null ? config : new Idea196046Config();
