...
@Data
public class Idea196151Config {
    private String name = "idea_196151";
 ...
 */
@Slf4j
public class Idea196151Service {
    private static final int IDEA_ID = 196151;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196151Service() {
        this(new Idea196151Config());
    }

    public Idea196151Service(Idea196151Config config) {
        this.config = config != null ? config : new Idea196151Config();
