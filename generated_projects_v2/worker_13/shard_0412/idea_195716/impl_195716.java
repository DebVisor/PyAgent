...
@Data
public class Idea195716Config {
    private String name = "idea_195716";
 ...
 */
@Slf4j
public class Idea195716Service {
    private static final int IDEA_ID = 195716;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195716Service() {
        this(new Idea195716Config());
    }

    public Idea195716Service(Idea195716Config config) {
        this.config = config != null ? config : new Idea195716Config();
