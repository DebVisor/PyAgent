...
@Data
public class Idea196091Config {
    private String name = "idea_196091";
 ...
 */
@Slf4j
public class Idea196091Service {
    private static final int IDEA_ID = 196091;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196091Service() {
        this(new Idea196091Config());
    }

    public Idea196091Service(Idea196091Config config) {
        this.config = config != null ? config : new Idea196091Config();
