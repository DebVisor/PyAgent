...
@Data
public class Idea195878Config {
    private String name = "idea_195878";
 ...
 */
@Slf4j
public class Idea195878Service {
    private static final int IDEA_ID = 195878;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195878Service() {
        this(new Idea195878Config());
    }

    public Idea195878Service(Idea195878Config config) {
        this.config = config != null ? config : new Idea195878Config();
