...
@Data
public class Idea195996Config {
    private String name = "idea_195996";
 ...
 */
@Slf4j
public class Idea195996Service {
    private static final int IDEA_ID = 195996;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195996Service() {
        this(new Idea195996Config());
    }

    public Idea195996Service(Idea195996Config config) {
        this.config = config != null ? config : new Idea195996Config();
