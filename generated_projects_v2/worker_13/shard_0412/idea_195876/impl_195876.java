...
@Data
public class Idea195876Config {
    private String name = "idea_195876";
 ...
 */
@Slf4j
public class Idea195876Service {
    private static final int IDEA_ID = 195876;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195876Service() {
        this(new Idea195876Config());
    }

    public Idea195876Service(Idea195876Config config) {
        this.config = config != null ? config : new Idea195876Config();
