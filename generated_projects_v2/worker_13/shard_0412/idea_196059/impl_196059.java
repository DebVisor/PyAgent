...
@Data
public class Idea196059Config {
    private String name = "idea_196059";
 ...
 */
@Slf4j
public class Idea196059Service {
    private static final int IDEA_ID = 196059;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196059Service() {
        this(new Idea196059Config());
    }

    public Idea196059Service(Idea196059Config config) {
        this.config = config != null ? config : new Idea196059Config();
