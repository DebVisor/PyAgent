...
@Data
public class Idea195734Config {
    private String name = "idea_195734";
 ...
 */
@Slf4j
public class Idea195734Service {
    private static final int IDEA_ID = 195734;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195734Service() {
        this(new Idea195734Config());
    }

    public Idea195734Service(Idea195734Config config) {
        this.config = config != null ? config : new Idea195734Config();
