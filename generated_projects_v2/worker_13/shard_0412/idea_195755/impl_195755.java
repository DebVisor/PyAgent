...
@Data
public class Idea195755Config {
    private String name = "idea_195755";
 ...
 */
@Slf4j
public class Idea195755Service {
    private static final int IDEA_ID = 195755;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195755Service() {
        this(new Idea195755Config());
    }

    public Idea195755Service(Idea195755Config config) {
        this.config = config != null ? config : new Idea195755Config();
