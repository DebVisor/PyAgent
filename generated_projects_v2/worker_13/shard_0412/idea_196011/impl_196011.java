...
@Data
public class Idea196011Config {
    private String name = "idea_196011";
 ...
 */
@Slf4j
public class Idea196011Service {
    private static final int IDEA_ID = 196011;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196011Service() {
        this(new Idea196011Config());
    }

    public Idea196011Service(Idea196011Config config) {
        this.config = config != null ? config : new Idea196011Config();
