...
@Data
public class Idea195837Config {
    private String name = "idea_195837";
 ...
 */
@Slf4j
public class Idea195837Service {
    private static final int IDEA_ID = 195837;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195837Service() {
        this(new Idea195837Config());
    }

    public Idea195837Service(Idea195837Config config) {
        this.config = config != null ? config : new Idea195837Config();
