...
@Data
public class Idea196019Config {
    private String name = "idea_196019";
 ...
 */
@Slf4j
public class Idea196019Service {
    private static final int IDEA_ID = 196019;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea196019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea196019Service() {
        this(new Idea196019Config());
    }

    public Idea196019Service(Idea196019Config config) {
        this.config = config != null ? config : new Idea196019Config();
