...
@Data
public class Idea195966Config {
    private String name = "idea_195966";
 ...
 */
@Slf4j
public class Idea195966Service {
    private static final int IDEA_ID = 195966;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195966Service() {
        this(new Idea195966Config());
    }

    public Idea195966Service(Idea195966Config config) {
        this.config = config != null ? config : new Idea195966Config();
