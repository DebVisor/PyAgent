...
@Data
public class Idea195930Config {
    private String name = "idea_195930";
 ...
 */
@Slf4j
public class Idea195930Service {
    private static final int IDEA_ID = 195930;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea195930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea195930Service() {
        this(new Idea195930Config());
    }

    public Idea195930Service(Idea195930Config config) {
        this.config = config != null ? config : new Idea195930Config();
