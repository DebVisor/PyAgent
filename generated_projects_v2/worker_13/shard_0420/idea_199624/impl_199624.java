...
@Data
public class Idea199624Config {
    private String name = "idea_199624";
 ...
 */
@Slf4j
public class Idea199624Service {
    private static final int IDEA_ID = 199624;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199624Service() {
        this(new Idea199624Config());
    }

    public Idea199624Service(Idea199624Config config) {
        this.config = config != null ? config : new Idea199624Config();
