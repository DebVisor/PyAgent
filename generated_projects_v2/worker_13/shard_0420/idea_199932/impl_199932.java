...
@Data
public class Idea199932Config {
    private String name = "idea_199932";
 ...
 */
@Slf4j
public class Idea199932Service {
    private static final int IDEA_ID = 199932;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199932Service() {
        this(new Idea199932Config());
    }

    public Idea199932Service(Idea199932Config config) {
        this.config = config != null ? config : new Idea199932Config();
