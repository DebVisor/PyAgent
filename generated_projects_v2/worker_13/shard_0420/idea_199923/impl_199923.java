...
@Data
public class Idea199923Config {
    private String name = "idea_199923";
 ...
 */
@Slf4j
public class Idea199923Service {
    private static final int IDEA_ID = 199923;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199923Service() {
        this(new Idea199923Config());
    }

    public Idea199923Service(Idea199923Config config) {
        this.config = config != null ? config : new Idea199923Config();
