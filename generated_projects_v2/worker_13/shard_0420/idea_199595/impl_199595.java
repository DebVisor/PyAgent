...
@Data
public class Idea199595Config {
    private String name = "idea_199595";
 ...
 */
@Slf4j
public class Idea199595Service {
    private static final int IDEA_ID = 199595;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199595Service() {
        this(new Idea199595Config());
    }

    public Idea199595Service(Idea199595Config config) {
        this.config = config != null ? config : new Idea199595Config();
