...
@Data
public class Idea199871Config {
    private String name = "idea_199871";
 ...
 */
@Slf4j
public class Idea199871Service {
    private static final int IDEA_ID = 199871;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199871Service() {
        this(new Idea199871Config());
    }

    public Idea199871Service(Idea199871Config config) {
        this.config = config != null ? config : new Idea199871Config();
