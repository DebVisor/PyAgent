...
@Data
public class Idea199780Config {
    private String name = "idea_199780";
 ...
 */
@Slf4j
public class Idea199780Service {
    private static final int IDEA_ID = 199780;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199780Service() {
        this(new Idea199780Config());
    }

    public Idea199780Service(Idea199780Config config) {
        this.config = config != null ? config : new Idea199780Config();
