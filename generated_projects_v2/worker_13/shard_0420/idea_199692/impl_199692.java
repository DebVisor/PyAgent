...
@Data
public class Idea199692Config {
    private String name = "idea_199692";
 ...
 */
@Slf4j
public class Idea199692Service {
    private static final int IDEA_ID = 199692;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199692Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199692Service() {
        this(new Idea199692Config());
    }

    public Idea199692Service(Idea199692Config config) {
        this.config = config != null ? config : new Idea199692Config();
