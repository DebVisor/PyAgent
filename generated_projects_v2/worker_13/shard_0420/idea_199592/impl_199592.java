...
@Data
public class Idea199592Config {
    private String name = "idea_199592";
 ...
 */
@Slf4j
public class Idea199592Service {
    private static final int IDEA_ID = 199592;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199592Service() {
        this(new Idea199592Config());
    }

    public Idea199592Service(Idea199592Config config) {
        this.config = config != null ? config : new Idea199592Config();
