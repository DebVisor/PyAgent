...
@Data
public class Idea199973Config {
    private String name = "idea_199973";
 ...
 */
@Slf4j
public class Idea199973Service {
    private static final int IDEA_ID = 199973;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199973Service() {
        this(new Idea199973Config());
    }

    public Idea199973Service(Idea199973Config config) {
        this.config = config != null ? config : new Idea199973Config();
