...
@Data
public class Idea199672Config {
    private String name = "idea_199672";
 ...
 */
@Slf4j
public class Idea199672Service {
    private static final int IDEA_ID = 199672;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199672Service() {
        this(new Idea199672Config());
    }

    public Idea199672Service(Idea199672Config config) {
        this.config = config != null ? config : new Idea199672Config();
