...
@Data
public class Idea199627Config {
    private String name = "idea_199627";
 ...
 */
@Slf4j
public class Idea199627Service {
    private static final int IDEA_ID = 199627;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199627Service() {
        this(new Idea199627Config());
    }

    public Idea199627Service(Idea199627Config config) {
        this.config = config != null ? config : new Idea199627Config();
