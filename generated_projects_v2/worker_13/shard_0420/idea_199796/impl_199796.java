...
@Data
public class Idea199796Config {
    private String name = "idea_199796";
 ...
 */
@Slf4j
public class Idea199796Service {
    private static final int IDEA_ID = 199796;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199796Service() {
        this(new Idea199796Config());
    }

    public Idea199796Service(Idea199796Config config) {
        this.config = config != null ? config : new Idea199796Config();
