...
@Data
public class Idea199557Config {
    private String name = "idea_199557";
 ...
 */
@Slf4j
public class Idea199557Service {
    private static final int IDEA_ID = 199557;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199557Service() {
        this(new Idea199557Config());
    }

    public Idea199557Service(Idea199557Config config) {
        this.config = config != null ? config : new Idea199557Config();
