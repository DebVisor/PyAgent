...
@Data
public class Idea199551Config {
    private String name = "idea_199551";
 ...
 */
@Slf4j
public class Idea199551Service {
    private static final int IDEA_ID = 199551;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199551Service() {
        this(new Idea199551Config());
    }

    public Idea199551Service(Idea199551Config config) {
        this.config = config != null ? config : new Idea199551Config();
