...
@Data
public class Idea199758Config {
    private String name = "idea_199758";
 ...
 */
@Slf4j
public class Idea199758Service {
    private static final int IDEA_ID = 199758;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199758Service() {
        this(new Idea199758Config());
    }

    public Idea199758Service(Idea199758Config config) {
        this.config = config != null ? config : new Idea199758Config();
