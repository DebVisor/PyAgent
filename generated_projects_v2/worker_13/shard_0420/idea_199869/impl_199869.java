...
@Data
public class Idea199869Config {
    private String name = "idea_199869";
 ...
 */
@Slf4j
public class Idea199869Service {
    private static final int IDEA_ID = 199869;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199869Service() {
        this(new Idea199869Config());
    }

    public Idea199869Service(Idea199869Config config) {
        this.config = config != null ? config : new Idea199869Config();
