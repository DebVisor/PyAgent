...
@Data
public class Idea199783Config {
    private String name = "idea_199783";
 ...
 */
@Slf4j
public class Idea199783Service {
    private static final int IDEA_ID = 199783;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199783Service() {
        this(new Idea199783Config());
    }

    public Idea199783Service(Idea199783Config config) {
        this.config = config != null ? config : new Idea199783Config();
