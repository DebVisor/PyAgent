...
@Data
public class Idea199943Config {
    private String name = "idea_199943";
 ...
 */
@Slf4j
public class Idea199943Service {
    private static final int IDEA_ID = 199943;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199943Service() {
        this(new Idea199943Config());
    }

    public Idea199943Service(Idea199943Config config) {
        this.config = config != null ? config : new Idea199943Config();
