...
@Data
public class Idea199528Config {
    private String name = "idea_199528";
 ...
 */
@Slf4j
public class Idea199528Service {
    private static final int IDEA_ID = 199528;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199528Service() {
        this(new Idea199528Config());
    }

    public Idea199528Service(Idea199528Config config) {
        this.config = config != null ? config : new Idea199528Config();
