...
@Data
public class Idea199944Config {
    private String name = "idea_199944";
 ...
 */
@Slf4j
public class Idea199944Service {
    private static final int IDEA_ID = 199944;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199944Service() {
        this(new Idea199944Config());
    }

    public Idea199944Service(Idea199944Config config) {
        this.config = config != null ? config : new Idea199944Config();
