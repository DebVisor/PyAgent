...
@Data
public class Idea199837Config {
    private String name = "idea_199837";
 ...
 */
@Slf4j
public class Idea199837Service {
    private static final int IDEA_ID = 199837;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199837Service() {
        this(new Idea199837Config());
    }

    public Idea199837Service(Idea199837Config config) {
        this.config = config != null ? config : new Idea199837Config();
