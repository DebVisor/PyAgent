...
@Data
public class Idea199541Config {
    private String name = "idea_199541";
 ...
 */
@Slf4j
public class Idea199541Service {
    private static final int IDEA_ID = 199541;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199541Service() {
        this(new Idea199541Config());
    }

    public Idea199541Service(Idea199541Config config) {
        this.config = config != null ? config : new Idea199541Config();
