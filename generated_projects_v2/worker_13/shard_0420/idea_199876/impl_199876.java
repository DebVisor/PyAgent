...
@Data
public class Idea199876Config {
    private String name = "idea_199876";
 ...
 */
@Slf4j
public class Idea199876Service {
    private static final int IDEA_ID = 199876;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199876Service() {
        this(new Idea199876Config());
    }

    public Idea199876Service(Idea199876Config config) {
        this.config = config != null ? config : new Idea199876Config();
