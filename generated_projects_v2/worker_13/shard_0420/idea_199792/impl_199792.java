...
@Data
public class Idea199792Config {
    private String name = "idea_199792";
 ...
 */
@Slf4j
public class Idea199792Service {
    private static final int IDEA_ID = 199792;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199792Service() {
        this(new Idea199792Config());
    }

    public Idea199792Service(Idea199792Config config) {
        this.config = config != null ? config : new Idea199792Config();
