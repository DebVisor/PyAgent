...
@Data
public class Idea199653Config {
    private String name = "idea_199653";
 ...
 */
@Slf4j
public class Idea199653Service {
    private static final int IDEA_ID = 199653;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199653Service() {
        this(new Idea199653Config());
    }

    public Idea199653Service(Idea199653Config config) {
        this.config = config != null ? config : new Idea199653Config();
