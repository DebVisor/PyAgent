...
@Data
public class Idea199707Config {
    private String name = "idea_199707";
 ...
 */
@Slf4j
public class Idea199707Service {
    private static final int IDEA_ID = 199707;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199707Service() {
        this(new Idea199707Config());
    }

    public Idea199707Service(Idea199707Config config) {
        this.config = config != null ? config : new Idea199707Config();
