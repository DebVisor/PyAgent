...
@Data
public class Idea199555Config {
    private String name = "idea_199555";
 ...
 */
@Slf4j
public class Idea199555Service {
    private static final int IDEA_ID = 199555;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199555Service() {
        this(new Idea199555Config());
    }

    public Idea199555Service(Idea199555Config config) {
        this.config = config != null ? config : new Idea199555Config();
