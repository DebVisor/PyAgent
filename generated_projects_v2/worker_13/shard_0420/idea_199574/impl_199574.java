...
@Data
public class Idea199574Config {
    private String name = "idea_199574";
 ...
 */
@Slf4j
public class Idea199574Service {
    private static final int IDEA_ID = 199574;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199574Service() {
        this(new Idea199574Config());
    }

    public Idea199574Service(Idea199574Config config) {
        this.config = config != null ? config : new Idea199574Config();
