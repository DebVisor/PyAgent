...
@Data
public class Idea199913Config {
    private String name = "idea_199913";
 ...
 */
@Slf4j
public class Idea199913Service {
    private static final int IDEA_ID = 199913;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199913Service() {
        this(new Idea199913Config());
    }

    public Idea199913Service(Idea199913Config config) {
        this.config = config != null ? config : new Idea199913Config();
