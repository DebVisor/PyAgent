...
@Data
public class Idea199723Config {
    private String name = "idea_199723";
 ...
 */
@Slf4j
public class Idea199723Service {
    private static final int IDEA_ID = 199723;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199723Service() {
        this(new Idea199723Config());
    }

    public Idea199723Service(Idea199723Config config) {
        this.config = config != null ? config : new Idea199723Config();
