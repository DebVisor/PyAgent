...
@Data
public class Idea199968Config {
    private String name = "idea_199968";
 ...
 */
@Slf4j
public class Idea199968Service {
    private static final int IDEA_ID = 199968;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199968Service() {
        this(new Idea199968Config());
    }

    public Idea199968Service(Idea199968Config config) {
        this.config = config != null ? config : new Idea199968Config();
