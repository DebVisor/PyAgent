...
@Data
public class Idea199825Config {
    private String name = "idea_199825";
 ...
 */
@Slf4j
public class Idea199825Service {
    private static final int IDEA_ID = 199825;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199825Service() {
        this(new Idea199825Config());
    }

    public Idea199825Service(Idea199825Config config) {
        this.config = config != null ? config : new Idea199825Config();
