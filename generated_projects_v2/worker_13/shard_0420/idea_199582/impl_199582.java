...
@Data
public class Idea199582Config {
    private String name = "idea_199582";
 ...
 */
@Slf4j
public class Idea199582Service {
    private static final int IDEA_ID = 199582;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199582Service() {
        this(new Idea199582Config());
    }

    public Idea199582Service(Idea199582Config config) {
        this.config = config != null ? config : new Idea199582Config();
