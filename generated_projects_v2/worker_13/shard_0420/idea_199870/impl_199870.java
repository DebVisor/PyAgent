...
@Data
public class Idea199870Config {
    private String name = "idea_199870";
 ...
 */
@Slf4j
public class Idea199870Service {
    private static final int IDEA_ID = 199870;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199870Service() {
        this(new Idea199870Config());
    }

    public Idea199870Service(Idea199870Config config) {
        this.config = config != null ? config : new Idea199870Config();
