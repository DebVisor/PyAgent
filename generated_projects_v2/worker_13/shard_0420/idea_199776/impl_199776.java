...
@Data
public class Idea199776Config {
    private String name = "idea_199776";
 ...
 */
@Slf4j
public class Idea199776Service {
    private static final int IDEA_ID = 199776;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199776Service() {
        this(new Idea199776Config());
    }

    public Idea199776Service(Idea199776Config config) {
        this.config = config != null ? config : new Idea199776Config();
