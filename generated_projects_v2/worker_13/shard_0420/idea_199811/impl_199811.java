...
@Data
public class Idea199811Config {
    private String name = "idea_199811";
 ...
 */
@Slf4j
public class Idea199811Service {
    private static final int IDEA_ID = 199811;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199811Service() {
        this(new Idea199811Config());
    }

    public Idea199811Service(Idea199811Config config) {
        this.config = config != null ? config : new Idea199811Config();
