...
@Data
public class Idea199924Config {
    private String name = "idea_199924";
 ...
 */
@Slf4j
public class Idea199924Service {
    private static final int IDEA_ID = 199924;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199924Service() {
        this(new Idea199924Config());
    }

    public Idea199924Service(Idea199924Config config) {
        this.config = config != null ? config : new Idea199924Config();
