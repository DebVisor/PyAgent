...
@Data
public class Idea199749Config {
    private String name = "idea_199749";
 ...
 */
@Slf4j
public class Idea199749Service {
    private static final int IDEA_ID = 199749;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199749Service() {
        this(new Idea199749Config());
    }

    public Idea199749Service(Idea199749Config config) {
        this.config = config != null ? config : new Idea199749Config();
