...
@Data
public class Idea199685Config {
    private String name = "idea_199685";
 ...
 */
@Slf4j
public class Idea199685Service {
    private static final int IDEA_ID = 199685;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199685Service() {
        this(new Idea199685Config());
    }

    public Idea199685Service(Idea199685Config config) {
        this.config = config != null ? config : new Idea199685Config();
