...
@Data
public class Idea199797Config {
    private String name = "idea_199797";
 ...
 */
@Slf4j
public class Idea199797Service {
    private static final int IDEA_ID = 199797;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199797Service() {
        this(new Idea199797Config());
    }

    public Idea199797Service(Idea199797Config config) {
        this.config = config != null ? config : new Idea199797Config();
