...
@Data
public class Idea199728Config {
    private String name = "idea_199728";
 ...
 */
@Slf4j
public class Idea199728Service {
    private static final int IDEA_ID = 199728;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199728Service() {
        this(new Idea199728Config());
    }

    public Idea199728Service(Idea199728Config config) {
        this.config = config != null ? config : new Idea199728Config();
