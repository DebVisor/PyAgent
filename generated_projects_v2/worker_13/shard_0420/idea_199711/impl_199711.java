...
@Data
public class Idea199711Config {
    private String name = "idea_199711";
 ...
 */
@Slf4j
public class Idea199711Service {
    private static final int IDEA_ID = 199711;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199711Service() {
        this(new Idea199711Config());
    }

    public Idea199711Service(Idea199711Config config) {
        this.config = config != null ? config : new Idea199711Config();
