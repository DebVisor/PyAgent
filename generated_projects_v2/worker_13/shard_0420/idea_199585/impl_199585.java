...
@Data
public class Idea199585Config {
    private String name = "idea_199585";
 ...
 */
@Slf4j
public class Idea199585Service {
    private static final int IDEA_ID = 199585;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199585Service() {
        this(new Idea199585Config());
    }

    public Idea199585Service(Idea199585Config config) {
        this.config = config != null ? config : new Idea199585Config();
