...
@Data
public class Idea199853Config {
    private String name = "idea_199853";
 ...
 */
@Slf4j
public class Idea199853Service {
    private static final int IDEA_ID = 199853;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199853Service() {
        this(new Idea199853Config());
    }

    public Idea199853Service(Idea199853Config config) {
        this.config = config != null ? config : new Idea199853Config();
