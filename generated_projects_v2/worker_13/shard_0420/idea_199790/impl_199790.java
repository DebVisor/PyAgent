...
@Data
public class Idea199790Config {
    private String name = "idea_199790";
 ...
 */
@Slf4j
public class Idea199790Service {
    private static final int IDEA_ID = 199790;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199790Service() {
        this(new Idea199790Config());
    }

    public Idea199790Service(Idea199790Config config) {
        this.config = config != null ? config : new Idea199790Config();
