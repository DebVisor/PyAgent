...
@Data
public class Idea199640Config {
    private String name = "idea_199640";
 ...
 */
@Slf4j
public class Idea199640Service {
    private static final int IDEA_ID = 199640;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199640Service() {
        this(new Idea199640Config());
    }

    public Idea199640Service(Idea199640Config config) {
        this.config = config != null ? config : new Idea199640Config();
