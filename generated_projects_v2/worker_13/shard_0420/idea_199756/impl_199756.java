...
@Data
public class Idea199756Config {
    private String name = "idea_199756";
 ...
 */
@Slf4j
public class Idea199756Service {
    private static final int IDEA_ID = 199756;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199756Service() {
        this(new Idea199756Config());
    }

    public Idea199756Service(Idea199756Config config) {
        this.config = config != null ? config : new Idea199756Config();
