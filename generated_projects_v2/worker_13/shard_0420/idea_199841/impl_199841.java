...
@Data
public class Idea199841Config {
    private String name = "idea_199841";
 ...
 */
@Slf4j
public class Idea199841Service {
    private static final int IDEA_ID = 199841;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199841Service() {
        this(new Idea199841Config());
    }

    public Idea199841Service(Idea199841Config config) {
        this.config = config != null ? config : new Idea199841Config();
