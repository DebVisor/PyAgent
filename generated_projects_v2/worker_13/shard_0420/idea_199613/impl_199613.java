...
@Data
public class Idea199613Config {
    private String name = "idea_199613";
 ...
 */
@Slf4j
public class Idea199613Service {
    private static final int IDEA_ID = 199613;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199613Service() {
        this(new Idea199613Config());
    }

    public Idea199613Service(Idea199613Config config) {
        this.config = config != null ? config : new Idea199613Config();
