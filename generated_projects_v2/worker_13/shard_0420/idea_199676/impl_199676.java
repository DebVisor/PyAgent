...
@Data
public class Idea199676Config {
    private String name = "idea_199676";
 ...
 */
@Slf4j
public class Idea199676Service {
    private static final int IDEA_ID = 199676;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199676Service() {
        this(new Idea199676Config());
    }

    public Idea199676Service(Idea199676Config config) {
        this.config = config != null ? config : new Idea199676Config();
