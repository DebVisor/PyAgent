...
@Data
public class Idea199568Config {
    private String name = "idea_199568";
 ...
 */
@Slf4j
public class Idea199568Service {
    private static final int IDEA_ID = 199568;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199568Service() {
        this(new Idea199568Config());
    }

    public Idea199568Service(Idea199568Config config) {
        this.config = config != null ? config : new Idea199568Config();
