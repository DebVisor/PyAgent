...
@Data
public class Idea199617Config {
    private String name = "idea_199617";
 ...
 */
@Slf4j
public class Idea199617Service {
    private static final int IDEA_ID = 199617;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199617Service() {
        this(new Idea199617Config());
    }

    public Idea199617Service(Idea199617Config config) {
        this.config = config != null ? config : new Idea199617Config();
