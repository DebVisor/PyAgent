...
@Data
public class Idea199530Config {
    private String name = "idea_199530";
 ...
 */
@Slf4j
public class Idea199530Service {
    private static final int IDEA_ID = 199530;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199530Service() {
        this(new Idea199530Config());
    }

    public Idea199530Service(Idea199530Config config) {
        this.config = config != null ? config : new Idea199530Config();
