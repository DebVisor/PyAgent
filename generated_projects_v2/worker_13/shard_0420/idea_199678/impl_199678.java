...
@Data
public class Idea199678Config {
    private String name = "idea_199678";
 ...
 */
@Slf4j
public class Idea199678Service {
    private static final int IDEA_ID = 199678;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199678Service() {
        this(new Idea199678Config());
    }

    public Idea199678Service(Idea199678Config config) {
        this.config = config != null ? config : new Idea199678Config();
