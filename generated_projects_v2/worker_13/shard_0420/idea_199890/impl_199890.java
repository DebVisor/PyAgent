...
@Data
public class Idea199890Config {
    private String name = "idea_199890";
 ...
 */
@Slf4j
public class Idea199890Service {
    private static final int IDEA_ID = 199890;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199890Service() {
        this(new Idea199890Config());
    }

    public Idea199890Service(Idea199890Config config) {
        this.config = config != null ? config : new Idea199890Config();
