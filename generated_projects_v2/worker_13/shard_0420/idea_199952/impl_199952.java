...
@Data
public class Idea199952Config {
    private String name = "idea_199952";
 ...
 */
@Slf4j
public class Idea199952Service {
    private static final int IDEA_ID = 199952;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199952Service() {
        this(new Idea199952Config());
    }

    public Idea199952Service(Idea199952Config config) {
        this.config = config != null ? config : new Idea199952Config();
