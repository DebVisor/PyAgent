...
@Data
public class Idea199929Config {
    private String name = "idea_199929";
 ...
 */
@Slf4j
public class Idea199929Service {
    private static final int IDEA_ID = 199929;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199929Service() {
        this(new Idea199929Config());
    }

    public Idea199929Service(Idea199929Config config) {
        this.config = config != null ? config : new Idea199929Config();
