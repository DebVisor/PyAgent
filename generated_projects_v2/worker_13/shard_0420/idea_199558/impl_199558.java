...
@Data
public class Idea199558Config {
    private String name = "idea_199558";
 ...
 */
@Slf4j
public class Idea199558Service {
    private static final int IDEA_ID = 199558;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199558Service() {
        this(new Idea199558Config());
    }

    public Idea199558Service(Idea199558Config config) {
        this.config = config != null ? config : new Idea199558Config();
