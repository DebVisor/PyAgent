...
@Data
public class Idea199823Config {
    private String name = "idea_199823";
 ...
 */
@Slf4j
public class Idea199823Service {
    private static final int IDEA_ID = 199823;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199823Service() {
        this(new Idea199823Config());
    }

    public Idea199823Service(Idea199823Config config) {
        this.config = config != null ? config : new Idea199823Config();
