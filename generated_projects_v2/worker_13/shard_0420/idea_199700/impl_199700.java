...
@Data
public class Idea199700Config {
    private String name = "idea_199700";
 ...
 */
@Slf4j
public class Idea199700Service {
    private static final int IDEA_ID = 199700;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199700Service() {
        this(new Idea199700Config());
    }

    public Idea199700Service(Idea199700Config config) {
        this.config = config != null ? config : new Idea199700Config();
