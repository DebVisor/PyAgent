...
@Data
public class Idea199878Config {
    private String name = "idea_199878";
 ...
 */
@Slf4j
public class Idea199878Service {
    private static final int IDEA_ID = 199878;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199878Service() {
        this(new Idea199878Config());
    }

    public Idea199878Service(Idea199878Config config) {
        this.config = config != null ? config : new Idea199878Config();
