...
@Data
public class Idea199662Config {
    private String name = "idea_199662";
 ...
 */
@Slf4j
public class Idea199662Service {
    private static final int IDEA_ID = 199662;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199662Service() {
        this(new Idea199662Config());
    }

    public Idea199662Service(Idea199662Config config) {
        this.config = config != null ? config : new Idea199662Config();
