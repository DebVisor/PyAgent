...
@Data
public class Idea199765Config {
    private String name = "idea_199765";
 ...
 */
@Slf4j
public class Idea199765Service {
    private static final int IDEA_ID = 199765;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199765Service() {
        this(new Idea199765Config());
    }

    public Idea199765Service(Idea199765Config config) {
        this.config = config != null ? config : new Idea199765Config();
