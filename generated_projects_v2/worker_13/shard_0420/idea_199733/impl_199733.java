...
@Data
public class Idea199733Config {
    private String name = "idea_199733";
 ...
 */
@Slf4j
public class Idea199733Service {
    private static final int IDEA_ID = 199733;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199733Service() {
        this(new Idea199733Config());
    }

    public Idea199733Service(Idea199733Config config) {
        this.config = config != null ? config : new Idea199733Config();
