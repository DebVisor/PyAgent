...
@Data
public class Idea199908Config {
    private String name = "idea_199908";
 ...
 */
@Slf4j
public class Idea199908Service {
    private static final int IDEA_ID = 199908;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199908Service() {
        this(new Idea199908Config());
    }

    public Idea199908Service(Idea199908Config config) {
        this.config = config != null ? config : new Idea199908Config();
