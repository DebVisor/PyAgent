...
@Data
public class Idea199587Config {
    private String name = "idea_199587";
 ...
 */
@Slf4j
public class Idea199587Service {
    private static final int IDEA_ID = 199587;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199587Service() {
        this(new Idea199587Config());
    }

    public Idea199587Service(Idea199587Config config) {
        this.config = config != null ? config : new Idea199587Config();
