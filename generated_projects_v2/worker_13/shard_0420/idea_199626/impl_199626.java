...
@Data
public class Idea199626Config {
    private String name = "idea_199626";
 ...
 */
@Slf4j
public class Idea199626Service {
    private static final int IDEA_ID = 199626;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199626Service() {
        this(new Idea199626Config());
    }

    public Idea199626Service(Idea199626Config config) {
        this.config = config != null ? config : new Idea199626Config();
