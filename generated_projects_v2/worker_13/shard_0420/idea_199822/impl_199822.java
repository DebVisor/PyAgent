...
@Data
public class Idea199822Config {
    private String name = "idea_199822";
 ...
 */
@Slf4j
public class Idea199822Service {
    private static final int IDEA_ID = 199822;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199822Service() {
        this(new Idea199822Config());
    }

    public Idea199822Service(Idea199822Config config) {
        this.config = config != null ? config : new Idea199822Config();
