...
@Data
public class Idea199513Config {
    private String name = "idea_199513";
 ...
 */
@Slf4j
public class Idea199513Service {
    private static final int IDEA_ID = 199513;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199513Service() {
        this(new Idea199513Config());
    }

    public Idea199513Service(Idea199513Config config) {
        this.config = config != null ? config : new Idea199513Config();
