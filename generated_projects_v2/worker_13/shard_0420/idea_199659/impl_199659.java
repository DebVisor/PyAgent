...
@Data
public class Idea199659Config {
    private String name = "idea_199659";
 ...
 */
@Slf4j
public class Idea199659Service {
    private static final int IDEA_ID = 199659;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199659Service() {
        this(new Idea199659Config());
    }

    public Idea199659Service(Idea199659Config config) {
        this.config = config != null ? config : new Idea199659Config();
