...
@Data
public class Idea199537Config {
    private String name = "idea_199537";
 ...
 */
@Slf4j
public class Idea199537Service {
    private static final int IDEA_ID = 199537;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199537Service() {
        this(new Idea199537Config());
    }

    public Idea199537Service(Idea199537Config config) {
        this.config = config != null ? config : new Idea199537Config();
