...
@Data
public class Idea199533Config {
    private String name = "idea_199533";
 ...
 */
@Slf4j
public class Idea199533Service {
    private static final int IDEA_ID = 199533;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199533Service() {
        this(new Idea199533Config());
    }

    public Idea199533Service(Idea199533Config config) {
        this.config = config != null ? config : new Idea199533Config();
