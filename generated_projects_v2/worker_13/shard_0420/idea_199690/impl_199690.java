...
@Data
public class Idea199690Config {
    private String name = "idea_199690";
 ...
 */
@Slf4j
public class Idea199690Service {
    private static final int IDEA_ID = 199690;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199690Service() {
        this(new Idea199690Config());
    }

    public Idea199690Service(Idea199690Config config) {
        this.config = config != null ? config : new Idea199690Config();
