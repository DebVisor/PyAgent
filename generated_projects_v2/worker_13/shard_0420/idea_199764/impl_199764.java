...
@Data
public class Idea199764Config {
    private String name = "idea_199764";
 ...
 */
@Slf4j
public class Idea199764Service {
    private static final int IDEA_ID = 199764;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199764Service() {
        this(new Idea199764Config());
    }

    public Idea199764Service(Idea199764Config config) {
        this.config = config != null ? config : new Idea199764Config();
