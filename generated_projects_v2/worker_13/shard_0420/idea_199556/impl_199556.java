...
@Data
public class Idea199556Config {
    private String name = "idea_199556";
 ...
 */
@Slf4j
public class Idea199556Service {
    private static final int IDEA_ID = 199556;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199556Service() {
        this(new Idea199556Config());
    }

    public Idea199556Service(Idea199556Config config) {
        this.config = config != null ? config : new Idea199556Config();
