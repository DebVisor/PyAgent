...
@Data
public class Idea199680Config {
    private String name = "idea_199680";
 ...
 */
@Slf4j
public class Idea199680Service {
    private static final int IDEA_ID = 199680;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199680Service() {
        this(new Idea199680Config());
    }

    public Idea199680Service(Idea199680Config config) {
        this.config = config != null ? config : new Idea199680Config();
