...
@Data
public class Idea199641Config {
    private String name = "idea_199641";
 ...
 */
@Slf4j
public class Idea199641Service {
    private static final int IDEA_ID = 199641;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199641Service() {
        this(new Idea199641Config());
    }

    public Idea199641Service(Idea199641Config config) {
        this.config = config != null ? config : new Idea199641Config();
