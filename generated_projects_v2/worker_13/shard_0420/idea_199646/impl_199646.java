...
@Data
public class Idea199646Config {
    private String name = "idea_199646";
 ...
 */
@Slf4j
public class Idea199646Service {
    private static final int IDEA_ID = 199646;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199646Service() {
        this(new Idea199646Config());
    }

    public Idea199646Service(Idea199646Config config) {
        this.config = config != null ? config : new Idea199646Config();
