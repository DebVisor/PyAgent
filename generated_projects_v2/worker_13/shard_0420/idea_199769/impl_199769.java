...
@Data
public class Idea199769Config {
    private String name = "idea_199769";
 ...
 */
@Slf4j
public class Idea199769Service {
    private static final int IDEA_ID = 199769;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199769Service() {
        this(new Idea199769Config());
    }

    public Idea199769Service(Idea199769Config config) {
        this.config = config != null ? config : new Idea199769Config();
