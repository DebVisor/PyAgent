...
@Data
public class Idea199633Config {
    private String name = "idea_199633";
 ...
 */
@Slf4j
public class Idea199633Service {
    private static final int IDEA_ID = 199633;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199633Service() {
        this(new Idea199633Config());
    }

    public Idea199633Service(Idea199633Config config) {
        this.config = config != null ? config : new Idea199633Config();
