...
@Data
public class Idea199605Config {
    private String name = "idea_199605";
 ...
 */
@Slf4j
public class Idea199605Service {
    private static final int IDEA_ID = 199605;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199605Service() {
        this(new Idea199605Config());
    }

    public Idea199605Service(Idea199605Config config) {
        this.config = config != null ? config : new Idea199605Config();
