...
@Data
public class Idea199607Config {
    private String name = "idea_199607";
 ...
 */
@Slf4j
public class Idea199607Service {
    private static final int IDEA_ID = 199607;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199607Service() {
        this(new Idea199607Config());
    }

    public Idea199607Service(Idea199607Config config) {
        this.config = config != null ? config : new Idea199607Config();
