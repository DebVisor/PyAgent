...
@Data
public class Idea199888Config {
    private String name = "idea_199888";
 ...
 */
@Slf4j
public class Idea199888Service {
    private static final int IDEA_ID = 199888;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199888Service() {
        this(new Idea199888Config());
    }

    public Idea199888Service(Idea199888Config config) {
        this.config = config != null ? config : new Idea199888Config();
