...
@Data
public class Idea199693Config {
    private String name = "idea_199693";
 ...
 */
@Slf4j
public class Idea199693Service {
    private static final int IDEA_ID = 199693;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199693Service() {
        this(new Idea199693Config());
    }

    public Idea199693Service(Idea199693Config config) {
        this.config = config != null ? config : new Idea199693Config();
