...
@Data
public class Idea199961Config {
    private String name = "idea_199961";
 ...
 */
@Slf4j
public class Idea199961Service {
    private static final int IDEA_ID = 199961;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199961Service() {
        this(new Idea199961Config());
    }

    public Idea199961Service(Idea199961Config config) {
        this.config = config != null ? config : new Idea199961Config();
