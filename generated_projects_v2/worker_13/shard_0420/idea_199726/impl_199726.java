...
@Data
public class Idea199726Config {
    private String name = "idea_199726";
 ...
 */
@Slf4j
public class Idea199726Service {
    private static final int IDEA_ID = 199726;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199726Service() {
        this(new Idea199726Config());
    }

    public Idea199726Service(Idea199726Config config) {
        this.config = config != null ? config : new Idea199726Config();
