...
@Data
public class Idea199702Config {
    private String name = "idea_199702";
 ...
 */
@Slf4j
public class Idea199702Service {
    private static final int IDEA_ID = 199702;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199702Service() {
        this(new Idea199702Config());
    }

    public Idea199702Service(Idea199702Config config) {
        this.config = config != null ? config : new Idea199702Config();
