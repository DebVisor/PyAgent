...
@Data
public class Idea199632Config {
    private String name = "idea_199632";
 ...
 */
@Slf4j
public class Idea199632Service {
    private static final int IDEA_ID = 199632;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199632Service() {
        this(new Idea199632Config());
    }

    public Idea199632Service(Idea199632Config config) {
        this.config = config != null ? config : new Idea199632Config();
