...
@Data
public class Idea199666Config {
    private String name = "idea_199666";
 ...
 */
@Slf4j
public class Idea199666Service {
    private static final int IDEA_ID = 199666;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199666Service() {
        this(new Idea199666Config());
    }

    public Idea199666Service(Idea199666Config config) {
        this.config = config != null ? config : new Idea199666Config();
