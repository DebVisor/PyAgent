...
@Data
public class Idea199877Config {
    private String name = "idea_199877";
 ...
 */
@Slf4j
public class Idea199877Service {
    private static final int IDEA_ID = 199877;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199877Service() {
        this(new Idea199877Config());
    }

    public Idea199877Service(Idea199877Config config) {
        this.config = config != null ? config : new Idea199877Config();
