...
@Data
public class Idea199868Config {
    private String name = "idea_199868";
 ...
 */
@Slf4j
public class Idea199868Service {
    private static final int IDEA_ID = 199868;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199868Service() {
        this(new Idea199868Config());
    }

    public Idea199868Service(Idea199868Config config) {
        this.config = config != null ? config : new Idea199868Config();
