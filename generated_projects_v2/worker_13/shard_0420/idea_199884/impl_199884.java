...
@Data
public class Idea199884Config {
    private String name = "idea_199884";
 ...
 */
@Slf4j
public class Idea199884Service {
    private static final int IDEA_ID = 199884;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199884Service() {
        this(new Idea199884Config());
    }

    public Idea199884Service(Idea199884Config config) {
        this.config = config != null ? config : new Idea199884Config();
