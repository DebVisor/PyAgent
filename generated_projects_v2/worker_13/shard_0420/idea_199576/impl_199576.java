...
@Data
public class Idea199576Config {
    private String name = "idea_199576";
 ...
 */
@Slf4j
public class Idea199576Service {
    private static final int IDEA_ID = 199576;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199576Service() {
        this(new Idea199576Config());
    }

    public Idea199576Service(Idea199576Config config) {
        this.config = config != null ? config : new Idea199576Config();
