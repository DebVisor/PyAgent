...
@Data
public class Idea199911Config {
    private String name = "idea_199911";
 ...
 */
@Slf4j
public class Idea199911Service {
    private static final int IDEA_ID = 199911;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199911Service() {
        this(new Idea199911Config());
    }

    public Idea199911Service(Idea199911Config config) {
        this.config = config != null ? config : new Idea199911Config();
