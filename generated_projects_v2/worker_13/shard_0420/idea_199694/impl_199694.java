...
@Data
public class Idea199694Config {
    private String name = "idea_199694";
 ...
 */
@Slf4j
public class Idea199694Service {
    private static final int IDEA_ID = 199694;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199694Service() {
        this(new Idea199694Config());
    }

    public Idea199694Service(Idea199694Config config) {
        this.config = config != null ? config : new Idea199694Config();
