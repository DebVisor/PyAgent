...
@Data
public class Idea199784Config {
    private String name = "idea_199784";
 ...
 */
@Slf4j
public class Idea199784Service {
    private static final int IDEA_ID = 199784;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199784Service() {
        this(new Idea199784Config());
    }

    public Idea199784Service(Idea199784Config config) {
        this.config = config != null ? config : new Idea199784Config();
