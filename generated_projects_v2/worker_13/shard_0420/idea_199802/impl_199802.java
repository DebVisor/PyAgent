...
@Data
public class Idea199802Config {
    private String name = "idea_199802";
 ...
 */
@Slf4j
public class Idea199802Service {
    private static final int IDEA_ID = 199802;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199802Service() {
        this(new Idea199802Config());
    }

    public Idea199802Service(Idea199802Config config) {
        this.config = config != null ? config : new Idea199802Config();
