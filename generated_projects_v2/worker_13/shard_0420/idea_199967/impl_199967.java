...
@Data
public class Idea199967Config {
    private String name = "idea_199967";
 ...
 */
@Slf4j
public class Idea199967Service {
    private static final int IDEA_ID = 199967;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199967Service() {
        this(new Idea199967Config());
    }

    public Idea199967Service(Idea199967Config config) {
        this.config = config != null ? config : new Idea199967Config();
