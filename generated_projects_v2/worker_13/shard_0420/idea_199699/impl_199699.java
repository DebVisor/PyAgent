...
@Data
public class Idea199699Config {
    private String name = "idea_199699";
 ...
 */
@Slf4j
public class Idea199699Service {
    private static final int IDEA_ID = 199699;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199699Service() {
        this(new Idea199699Config());
    }

    public Idea199699Service(Idea199699Config config) {
        this.config = config != null ? config : new Idea199699Config();
