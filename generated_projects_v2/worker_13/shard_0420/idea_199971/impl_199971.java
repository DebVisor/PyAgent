...
@Data
public class Idea199971Config {
    private String name = "idea_199971";
 ...
 */
@Slf4j
public class Idea199971Service {
    private static final int IDEA_ID = 199971;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199971Service() {
        this(new Idea199971Config());
    }

    public Idea199971Service(Idea199971Config config) {
        this.config = config != null ? config : new Idea199971Config();
