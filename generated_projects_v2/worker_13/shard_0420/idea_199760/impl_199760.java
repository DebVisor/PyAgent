...
@Data
public class Idea199760Config {
    private String name = "idea_199760";
 ...
 */
@Slf4j
public class Idea199760Service {
    private static final int IDEA_ID = 199760;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199760Service() {
        this(new Idea199760Config());
    }

    public Idea199760Service(Idea199760Config config) {
        this.config = config != null ? config : new Idea199760Config();
