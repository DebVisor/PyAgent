...
@Data
public class Idea199761Config {
    private String name = "idea_199761";
 ...
 */
@Slf4j
public class Idea199761Service {
    private static final int IDEA_ID = 199761;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199761Service() {
        this(new Idea199761Config());
    }

    public Idea199761Service(Idea199761Config config) {
        this.config = config != null ? config : new Idea199761Config();
