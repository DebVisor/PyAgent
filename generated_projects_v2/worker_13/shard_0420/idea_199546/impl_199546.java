...
@Data
public class Idea199546Config {
    private String name = "idea_199546";
 ...
 */
@Slf4j
public class Idea199546Service {
    private static final int IDEA_ID = 199546;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199546Service() {
        this(new Idea199546Config());
    }

    public Idea199546Service(Idea199546Config config) {
        this.config = config != null ? config : new Idea199546Config();
