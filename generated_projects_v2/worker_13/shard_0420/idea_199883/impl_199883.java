...
@Data
public class Idea199883Config {
    private String name = "idea_199883";
 ...
 */
@Slf4j
public class Idea199883Service {
    private static final int IDEA_ID = 199883;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199883Service() {
        this(new Idea199883Config());
    }

    public Idea199883Service(Idea199883Config config) {
        this.config = config != null ? config : new Idea199883Config();
