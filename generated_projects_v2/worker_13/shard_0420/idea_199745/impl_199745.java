...
@Data
public class Idea199745Config {
    private String name = "idea_199745";
 ...
 */
@Slf4j
public class Idea199745Service {
    private static final int IDEA_ID = 199745;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199745Service() {
        this(new Idea199745Config());
    }

    public Idea199745Service(Idea199745Config config) {
        this.config = config != null ? config : new Idea199745Config();
