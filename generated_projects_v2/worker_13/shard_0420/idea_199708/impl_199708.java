...
@Data
public class Idea199708Config {
    private String name = "idea_199708";
 ...
 */
@Slf4j
public class Idea199708Service {
    private static final int IDEA_ID = 199708;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199708Service() {
        this(new Idea199708Config());
    }

    public Idea199708Service(Idea199708Config config) {
        this.config = config != null ? config : new Idea199708Config();
