...
@Data
public class Idea199810Config {
    private String name = "idea_199810";
 ...
 */
@Slf4j
public class Idea199810Service {
    private static final int IDEA_ID = 199810;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199810Service() {
        this(new Idea199810Config());
    }

    public Idea199810Service(Idea199810Config config) {
        this.config = config != null ? config : new Idea199810Config();
