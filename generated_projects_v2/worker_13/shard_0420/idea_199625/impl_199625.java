...
@Data
public class Idea199625Config {
    private String name = "idea_199625";
 ...
 */
@Slf4j
public class Idea199625Service {
    private static final int IDEA_ID = 199625;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199625Service() {
        this(new Idea199625Config());
    }

    public Idea199625Service(Idea199625Config config) {
        this.config = config != null ? config : new Idea199625Config();
