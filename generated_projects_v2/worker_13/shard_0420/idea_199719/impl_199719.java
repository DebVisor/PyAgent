...
@Data
public class Idea199719Config {
    private String name = "idea_199719";
 ...
 */
@Slf4j
public class Idea199719Service {
    private static final int IDEA_ID = 199719;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199719Service() {
        this(new Idea199719Config());
    }

    public Idea199719Service(Idea199719Config config) {
        this.config = config != null ? config : new Idea199719Config();
