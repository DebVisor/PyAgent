...
@Data
public class Idea199898Config {
    private String name = "idea_199898";
 ...
 */
@Slf4j
public class Idea199898Service {
    private static final int IDEA_ID = 199898;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199898Service() {
        this(new Idea199898Config());
    }

    public Idea199898Service(Idea199898Config config) {
        this.config = config != null ? config : new Idea199898Config();
