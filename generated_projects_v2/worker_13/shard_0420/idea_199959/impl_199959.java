...
@Data
public class Idea199959Config {
    private String name = "idea_199959";
 ...
 */
@Slf4j
public class Idea199959Service {
    private static final int IDEA_ID = 199959;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199959Service() {
        this(new Idea199959Config());
    }

    public Idea199959Service(Idea199959Config config) {
        this.config = config != null ? config : new Idea199959Config();
