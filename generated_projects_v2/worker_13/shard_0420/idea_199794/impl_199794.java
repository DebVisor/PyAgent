...
@Data
public class Idea199794Config {
    private String name = "idea_199794";
 ...
 */
@Slf4j
public class Idea199794Service {
    private static final int IDEA_ID = 199794;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199794Service() {
        this(new Idea199794Config());
    }

    public Idea199794Service(Idea199794Config config) {
        this.config = config != null ? config : new Idea199794Config();
