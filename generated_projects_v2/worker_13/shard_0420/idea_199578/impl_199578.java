...
@Data
public class Idea199578Config {
    private String name = "idea_199578";
 ...
 */
@Slf4j
public class Idea199578Service {
    private static final int IDEA_ID = 199578;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199578Service() {
        this(new Idea199578Config());
    }

    public Idea199578Service(Idea199578Config config) {
        this.config = config != null ? config : new Idea199578Config();
