...
@Data
public class Idea199777Config {
    private String name = "idea_199777";
 ...
 */
@Slf4j
public class Idea199777Service {
    private static final int IDEA_ID = 199777;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199777Service() {
        this(new Idea199777Config());
    }

    public Idea199777Service(Idea199777Config config) {
        this.config = config != null ? config : new Idea199777Config();
