...
@Data
public class Idea199947Config {
    private String name = "idea_199947";
 ...
 */
@Slf4j
public class Idea199947Service {
    private static final int IDEA_ID = 199947;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199947Service() {
        this(new Idea199947Config());
    }

    public Idea199947Service(Idea199947Config config) {
        this.config = config != null ? config : new Idea199947Config();
