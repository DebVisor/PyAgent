...
@Data
public class Idea199872Config {
    private String name = "idea_199872";
 ...
 */
@Slf4j
public class Idea199872Service {
    private static final int IDEA_ID = 199872;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199872Service() {
        this(new Idea199872Config());
    }

    public Idea199872Service(Idea199872Config config) {
        this.config = config != null ? config : new Idea199872Config();
