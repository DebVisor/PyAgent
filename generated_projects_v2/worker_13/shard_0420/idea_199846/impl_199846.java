...
@Data
public class Idea199846Config {
    private String name = "idea_199846";
 ...
 */
@Slf4j
public class Idea199846Service {
    private static final int IDEA_ID = 199846;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199846Service() {
        this(new Idea199846Config());
    }

    public Idea199846Service(Idea199846Config config) {
        this.config = config != null ? config : new Idea199846Config();
