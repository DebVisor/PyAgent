...
@Data
public class Idea199663Config {
    private String name = "idea_199663";
 ...
 */
@Slf4j
public class Idea199663Service {
    private static final int IDEA_ID = 199663;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199663Service() {
        this(new Idea199663Config());
    }

    public Idea199663Service(Idea199663Config config) {
        this.config = config != null ? config : new Idea199663Config();
