...
@Data
public class Idea199886Config {
    private String name = "idea_199886";
 ...
 */
@Slf4j
public class Idea199886Service {
    private static final int IDEA_ID = 199886;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199886Service() {
        this(new Idea199886Config());
    }

    public Idea199886Service(Idea199886Config config) {
        this.config = config != null ? config : new Idea199886Config();
