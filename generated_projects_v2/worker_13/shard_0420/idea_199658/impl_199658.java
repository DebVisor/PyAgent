...
@Data
public class Idea199658Config {
    private String name = "idea_199658";
 ...
 */
@Slf4j
public class Idea199658Service {
    private static final int IDEA_ID = 199658;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199658Service() {
        this(new Idea199658Config());
    }

    public Idea199658Service(Idea199658Config config) {
        this.config = config != null ? config : new Idea199658Config();
