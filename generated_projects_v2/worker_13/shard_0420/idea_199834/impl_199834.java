...
@Data
public class Idea199834Config {
    private String name = "idea_199834";
 ...
 */
@Slf4j
public class Idea199834Service {
    private static final int IDEA_ID = 199834;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199834Service() {
        this(new Idea199834Config());
    }

    public Idea199834Service(Idea199834Config config) {
        this.config = config != null ? config : new Idea199834Config();
