...
@Data
public class Idea199549Config {
    private String name = "idea_199549";
 ...
 */
@Slf4j
public class Idea199549Service {
    private static final int IDEA_ID = 199549;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199549Service() {
        this(new Idea199549Config());
    }

    public Idea199549Service(Idea199549Config config) {
        this.config = config != null ? config : new Idea199549Config();
