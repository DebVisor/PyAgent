...
@Data
public class Idea199668Config {
    private String name = "idea_199668";
 ...
 */
@Slf4j
public class Idea199668Service {
    private static final int IDEA_ID = 199668;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199668Service() {
        this(new Idea199668Config());
    }

    public Idea199668Service(Idea199668Config config) {
        this.config = config != null ? config : new Idea199668Config();
