...
@Data
public class Idea199847Config {
    private String name = "idea_199847";
 ...
 */
@Slf4j
public class Idea199847Service {
    private static final int IDEA_ID = 199847;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199847Service() {
        this(new Idea199847Config());
    }

    public Idea199847Service(Idea199847Config config) {
        this.config = config != null ? config : new Idea199847Config();
