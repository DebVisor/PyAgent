...
@Data
public class Idea199798Config {
    private String name = "idea_199798";
 ...
 */
@Slf4j
public class Idea199798Service {
    private static final int IDEA_ID = 199798;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199798Service() {
        this(new Idea199798Config());
    }

    public Idea199798Service(Idea199798Config config) {
        this.config = config != null ? config : new Idea199798Config();
