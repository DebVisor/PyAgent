...
@Data
public class Idea199689Config {
    private String name = "idea_199689";
 ...
 */
@Slf4j
public class Idea199689Service {
    private static final int IDEA_ID = 199689;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199689Service() {
        this(new Idea199689Config());
    }

    public Idea199689Service(Idea199689Config config) {
        this.config = config != null ? config : new Idea199689Config();
