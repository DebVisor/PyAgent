...
@Data
public class Idea199554Config {
    private String name = "idea_199554";
 ...
 */
@Slf4j
public class Idea199554Service {
    private static final int IDEA_ID = 199554;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199554Service() {
        this(new Idea199554Config());
    }

    public Idea199554Service(Idea199554Config config) {
        this.config = config != null ? config : new Idea199554Config();
