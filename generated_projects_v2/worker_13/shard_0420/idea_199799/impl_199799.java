...
@Data
public class Idea199799Config {
    private String name = "idea_199799";
 ...
 */
@Slf4j
public class Idea199799Service {
    private static final int IDEA_ID = 199799;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199799Service() {
        this(new Idea199799Config());
    }

    public Idea199799Service(Idea199799Config config) {
        this.config = config != null ? config : new Idea199799Config();
