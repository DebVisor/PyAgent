...
@Data
public class Idea199628Config {
    private String name = "idea_199628";
 ...
 */
@Slf4j
public class Idea199628Service {
    private static final int IDEA_ID = 199628;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199628Service() {
        this(new Idea199628Config());
    }

    public Idea199628Service(Idea199628Config config) {
        this.config = config != null ? config : new Idea199628Config();
