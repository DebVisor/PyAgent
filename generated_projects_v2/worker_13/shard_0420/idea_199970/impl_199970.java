...
@Data
public class Idea199970Config {
    private String name = "idea_199970";
 ...
 */
@Slf4j
public class Idea199970Service {
    private static final int IDEA_ID = 199970;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199970Service() {
        this(new Idea199970Config());
    }

    public Idea199970Service(Idea199970Config config) {
        this.config = config != null ? config : new Idea199970Config();
