...
@Data
public class Idea199712Config {
    private String name = "idea_199712";
 ...
 */
@Slf4j
public class Idea199712Service {
    private static final int IDEA_ID = 199712;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199712Service() {
        this(new Idea199712Config());
    }

    public Idea199712Service(Idea199712Config config) {
        this.config = config != null ? config : new Idea199712Config();
