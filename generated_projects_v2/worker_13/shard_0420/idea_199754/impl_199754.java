...
@Data
public class Idea199754Config {
    private String name = "idea_199754";
 ...
 */
@Slf4j
public class Idea199754Service {
    private static final int IDEA_ID = 199754;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199754Service() {
        this(new Idea199754Config());
    }

    public Idea199754Service(Idea199754Config config) {
        this.config = config != null ? config : new Idea199754Config();
