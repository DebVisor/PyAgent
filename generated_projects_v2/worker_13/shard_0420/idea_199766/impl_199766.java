...
@Data
public class Idea199766Config {
    private String name = "idea_199766";
 ...
 */
@Slf4j
public class Idea199766Service {
    private static final int IDEA_ID = 199766;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199766Service() {
        this(new Idea199766Config());
    }

    public Idea199766Service(Idea199766Config config) {
        this.config = config != null ? config : new Idea199766Config();
