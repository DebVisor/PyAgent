...
@Data
public class Idea199889Config {
    private String name = "idea_199889";
 ...
 */
@Slf4j
public class Idea199889Service {
    private static final int IDEA_ID = 199889;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199889Service() {
        this(new Idea199889Config());
    }

    public Idea199889Service(Idea199889Config config) {
        this.config = config != null ? config : new Idea199889Config();
