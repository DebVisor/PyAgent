...
@Data
public class Idea199520Config {
    private String name = "idea_199520";
 ...
 */
@Slf4j
public class Idea199520Service {
    private static final int IDEA_ID = 199520;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199520Service() {
        this(new Idea199520Config());
    }

    public Idea199520Service(Idea199520Config config) {
        this.config = config != null ? config : new Idea199520Config();
