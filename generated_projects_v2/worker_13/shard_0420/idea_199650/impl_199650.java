...
@Data
public class Idea199650Config {
    private String name = "idea_199650";
 ...
 */
@Slf4j
public class Idea199650Service {
    private static final int IDEA_ID = 199650;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199650Service() {
        this(new Idea199650Config());
    }

    public Idea199650Service(Idea199650Config config) {
        this.config = config != null ? config : new Idea199650Config();
