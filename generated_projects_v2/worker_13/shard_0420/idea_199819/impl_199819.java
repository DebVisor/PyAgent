...
@Data
public class Idea199819Config {
    private String name = "idea_199819";
 ...
 */
@Slf4j
public class Idea199819Service {
    private static final int IDEA_ID = 199819;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199819Service() {
        this(new Idea199819Config());
    }

    public Idea199819Service(Idea199819Config config) {
        this.config = config != null ? config : new Idea199819Config();
