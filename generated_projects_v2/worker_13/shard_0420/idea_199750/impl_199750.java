...
@Data
public class Idea199750Config {
    private String name = "idea_199750";
 ...
 */
@Slf4j
public class Idea199750Service {
    private static final int IDEA_ID = 199750;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199750Service() {
        this(new Idea199750Config());
    }

    public Idea199750Service(Idea199750Config config) {
        this.config = config != null ? config : new Idea199750Config();
