...
@Data
public class Idea199914Config {
    private String name = "idea_199914";
 ...
 */
@Slf4j
public class Idea199914Service {
    private static final int IDEA_ID = 199914;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199914Service() {
        this(new Idea199914Config());
    }

    public Idea199914Service(Idea199914Config config) {
        this.config = config != null ? config : new Idea199914Config();
