...
@Data
public class Idea199681Config {
    private String name = "idea_199681";
 ...
 */
@Slf4j
public class Idea199681Service {
    private static final int IDEA_ID = 199681;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199681Service() {
        this(new Idea199681Config());
    }

    public Idea199681Service(Idea199681Config config) {
        this.config = config != null ? config : new Idea199681Config();
