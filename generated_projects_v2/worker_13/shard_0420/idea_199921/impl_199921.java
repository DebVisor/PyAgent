...
@Data
public class Idea199921Config {
    private String name = "idea_199921";
 ...
 */
@Slf4j
public class Idea199921Service {
    private static final int IDEA_ID = 199921;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199921Service() {
        this(new Idea199921Config());
    }

    public Idea199921Service(Idea199921Config config) {
        this.config = config != null ? config : new Idea199921Config();
