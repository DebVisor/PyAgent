...
@Data
public class Idea199560Config {
    private String name = "idea_199560";
 ...
 */
@Slf4j
public class Idea199560Service {
    private static final int IDEA_ID = 199560;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199560Service() {
        this(new Idea199560Config());
    }

    public Idea199560Service(Idea199560Config config) {
        this.config = config != null ? config : new Idea199560Config();
