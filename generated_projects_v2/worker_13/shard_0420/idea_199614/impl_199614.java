...
@Data
public class Idea199614Config {
    private String name = "idea_199614";
 ...
 */
@Slf4j
public class Idea199614Service {
    private static final int IDEA_ID = 199614;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199614Service() {
        this(new Idea199614Config());
    }

    public Idea199614Service(Idea199614Config config) {
        this.config = config != null ? config : new Idea199614Config();
