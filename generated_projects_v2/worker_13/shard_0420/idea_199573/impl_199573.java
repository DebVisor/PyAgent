...
@Data
public class Idea199573Config {
    private String name = "idea_199573";
 ...
 */
@Slf4j
public class Idea199573Service {
    private static final int IDEA_ID = 199573;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199573Service() {
        this(new Idea199573Config());
    }

    public Idea199573Service(Idea199573Config config) {
        this.config = config != null ? config : new Idea199573Config();
