...
@Data
public class Idea199636Config {
    private String name = "idea_199636";
 ...
 */
@Slf4j
public class Idea199636Service {
    private static final int IDEA_ID = 199636;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199636Service() {
        this(new Idea199636Config());
    }

    public Idea199636Service(Idea199636Config config) {
        this.config = config != null ? config : new Idea199636Config();
