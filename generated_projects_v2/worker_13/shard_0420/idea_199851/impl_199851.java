...
@Data
public class Idea199851Config {
    private String name = "idea_199851";
 ...
 */
@Slf4j
public class Idea199851Service {
    private static final int IDEA_ID = 199851;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199851Service() {
        this(new Idea199851Config());
    }

    public Idea199851Service(Idea199851Config config) {
        this.config = config != null ? config : new Idea199851Config();
