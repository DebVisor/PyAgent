...
@Data
public class Idea199900Config {
    private String name = "idea_199900";
 ...
 */
@Slf4j
public class Idea199900Service {
    private static final int IDEA_ID = 199900;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199900Service() {
        this(new Idea199900Config());
    }

    public Idea199900Service(Idea199900Config config) {
        this.config = config != null ? config : new Idea199900Config();
