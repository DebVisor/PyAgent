...
@Data
public class Idea199940Config {
    private String name = "idea_199940";
 ...
 */
@Slf4j
public class Idea199940Service {
    private static final int IDEA_ID = 199940;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199940Service() {
        this(new Idea199940Config());
    }

    public Idea199940Service(Idea199940Config config) {
        this.config = config != null ? config : new Idea199940Config();
