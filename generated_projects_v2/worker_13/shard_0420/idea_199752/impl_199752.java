...
@Data
public class Idea199752Config {
    private String name = "idea_199752";
 ...
 */
@Slf4j
public class Idea199752Service {
    private static final int IDEA_ID = 199752;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199752Service() {
        this(new Idea199752Config());
    }

    public Idea199752Service(Idea199752Config config) {
        this.config = config != null ? config : new Idea199752Config();
