...
@Data
public class Idea199586Config {
    private String name = "idea_199586";
 ...
 */
@Slf4j
public class Idea199586Service {
    private static final int IDEA_ID = 199586;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199586Service() {
        this(new Idea199586Config());
    }

    public Idea199586Service(Idea199586Config config) {
        this.config = config != null ? config : new Idea199586Config();
