...
@Data
public class Idea199826Config {
    private String name = "idea_199826";
 ...
 */
@Slf4j
public class Idea199826Service {
    private static final int IDEA_ID = 199826;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199826Service() {
        this(new Idea199826Config());
    }

    public Idea199826Service(Idea199826Config config) {
        this.config = config != null ? config : new Idea199826Config();
