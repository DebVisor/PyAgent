...
@Data
public class Idea199755Config {
    private String name = "idea_199755";
 ...
 */
@Slf4j
public class Idea199755Service {
    private static final int IDEA_ID = 199755;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199755Service() {
        this(new Idea199755Config());
    }

    public Idea199755Service(Idea199755Config config) {
        this.config = config != null ? config : new Idea199755Config();
