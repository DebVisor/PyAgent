...
@Data
public class Idea199937Config {
    private String name = "idea_199937";
 ...
 */
@Slf4j
public class Idea199937Service {
    private static final int IDEA_ID = 199937;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199937Service() {
        this(new Idea199937Config());
    }

    public Idea199937Service(Idea199937Config config) {
        this.config = config != null ? config : new Idea199937Config();
