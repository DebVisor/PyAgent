...
@Data
public class Idea199649Config {
    private String name = "idea_199649";
 ...
 */
@Slf4j
public class Idea199649Service {
    private static final int IDEA_ID = 199649;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199649Service() {
        this(new Idea199649Config());
    }

    public Idea199649Service(Idea199649Config config) {
        this.config = config != null ? config : new Idea199649Config();
