...
@Data
public class Idea199710Config {
    private String name = "idea_199710";
 ...
 */
@Slf4j
public class Idea199710Service {
    private static final int IDEA_ID = 199710;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199710Service() {
        this(new Idea199710Config());
    }

    public Idea199710Service(Idea199710Config config) {
        this.config = config != null ? config : new Idea199710Config();
