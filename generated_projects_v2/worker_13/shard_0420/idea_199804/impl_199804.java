...
@Data
public class Idea199804Config {
    private String name = "idea_199804";
 ...
 */
@Slf4j
public class Idea199804Service {
    private static final int IDEA_ID = 199804;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199804Service() {
        this(new Idea199804Config());
    }

    public Idea199804Service(Idea199804Config config) {
        this.config = config != null ? config : new Idea199804Config();
