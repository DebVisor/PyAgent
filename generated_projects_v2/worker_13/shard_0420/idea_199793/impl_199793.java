...
@Data
public class Idea199793Config {
    private String name = "idea_199793";
 ...
 */
@Slf4j
public class Idea199793Service {
    private static final int IDEA_ID = 199793;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199793Service() {
        this(new Idea199793Config());
    }

    public Idea199793Service(Idea199793Config config) {
        this.config = config != null ? config : new Idea199793Config();
