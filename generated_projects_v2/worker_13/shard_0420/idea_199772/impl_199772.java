...
@Data
public class Idea199772Config {
    private String name = "idea_199772";
 ...
 */
@Slf4j
public class Idea199772Service {
    private static final int IDEA_ID = 199772;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199772Service() {
        this(new Idea199772Config());
    }

    public Idea199772Service(Idea199772Config config) {
        this.config = config != null ? config : new Idea199772Config();
