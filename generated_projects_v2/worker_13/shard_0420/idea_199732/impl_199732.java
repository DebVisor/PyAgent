...
@Data
public class Idea199732Config {
    private String name = "idea_199732";
 ...
 */
@Slf4j
public class Idea199732Service {
    private static final int IDEA_ID = 199732;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199732Service() {
        this(new Idea199732Config());
    }

    public Idea199732Service(Idea199732Config config) {
        this.config = config != null ? config : new Idea199732Config();
