...
@Data
public class Idea199901Config {
    private String name = "idea_199901";
 ...
 */
@Slf4j
public class Idea199901Service {
    private static final int IDEA_ID = 199901;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199901Service() {
        this(new Idea199901Config());
    }

    public Idea199901Service(Idea199901Config config) {
        this.config = config != null ? config : new Idea199901Config();
