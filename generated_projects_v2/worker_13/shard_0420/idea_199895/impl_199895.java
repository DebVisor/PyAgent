...
@Data
public class Idea199895Config {
    private String name = "idea_199895";
 ...
 */
@Slf4j
public class Idea199895Service {
    private static final int IDEA_ID = 199895;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199895Service() {
        this(new Idea199895Config());
    }

    public Idea199895Service(Idea199895Config config) {
        this.config = config != null ? config : new Idea199895Config();
