...
@Data
public class Idea199894Config {
    private String name = "idea_199894";
 ...
 */
@Slf4j
public class Idea199894Service {
    private static final int IDEA_ID = 199894;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199894Service() {
        this(new Idea199894Config());
    }

    public Idea199894Service(Idea199894Config config) {
        this.config = config != null ? config : new Idea199894Config();
