...
@Data
public class Idea199675Config {
    private String name = "idea_199675";
 ...
 */
@Slf4j
public class Idea199675Service {
    private static final int IDEA_ID = 199675;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199675Service() {
        this(new Idea199675Config());
    }

    public Idea199675Service(Idea199675Config config) {
        this.config = config != null ? config : new Idea199675Config();
