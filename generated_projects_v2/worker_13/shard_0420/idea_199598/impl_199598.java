...
@Data
public class Idea199598Config {
    private String name = "idea_199598";
 ...
 */
@Slf4j
public class Idea199598Service {
    private static final int IDEA_ID = 199598;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199598Service() {
        this(new Idea199598Config());
    }

    public Idea199598Service(Idea199598Config config) {
        this.config = config != null ? config : new Idea199598Config();
