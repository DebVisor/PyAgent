...
@Data
public class Idea199620Config {
    private String name = "idea_199620";
 ...
 */
@Slf4j
public class Idea199620Service {
    private static final int IDEA_ID = 199620;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199620Service() {
        this(new Idea199620Config());
    }

    public Idea199620Service(Idea199620Config config) {
        this.config = config != null ? config : new Idea199620Config();
