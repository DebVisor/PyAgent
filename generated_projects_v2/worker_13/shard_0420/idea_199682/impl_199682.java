...
@Data
public class Idea199682Config {
    private String name = "idea_199682";
 ...
 */
@Slf4j
public class Idea199682Service {
    private static final int IDEA_ID = 199682;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199682Service() {
        this(new Idea199682Config());
    }

    public Idea199682Service(Idea199682Config config) {
        this.config = config != null ? config : new Idea199682Config();
