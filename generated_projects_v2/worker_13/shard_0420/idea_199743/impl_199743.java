...
@Data
public class Idea199743Config {
    private String name = "idea_199743";
 ...
 */
@Slf4j
public class Idea199743Service {
    private static final int IDEA_ID = 199743;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199743Service() {
        this(new Idea199743Config());
    }

    public Idea199743Service(Idea199743Config config) {
        this.config = config != null ? config : new Idea199743Config();
