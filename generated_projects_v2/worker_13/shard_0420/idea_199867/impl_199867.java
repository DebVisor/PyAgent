...
@Data
public class Idea199867Config {
    private String name = "idea_199867";
 ...
 */
@Slf4j
public class Idea199867Service {
    private static final int IDEA_ID = 199867;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199867Service() {
        this(new Idea199867Config());
    }

    public Idea199867Service(Idea199867Config config) {
        this.config = config != null ? config : new Idea199867Config();
