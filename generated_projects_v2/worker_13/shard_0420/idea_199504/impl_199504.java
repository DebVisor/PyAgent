...
@Data
public class Idea199504Config {
    private String name = "idea_199504";
 ...
 */
@Slf4j
public class Idea199504Service {
    private static final int IDEA_ID = 199504;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199504Service() {
        this(new Idea199504Config());
    }

    public Idea199504Service(Idea199504Config config) {
        this.config = config != null ? config : new Idea199504Config();
