...
@Data
public class Idea199655Config {
    private String name = "idea_199655";
 ...
 */
@Slf4j
public class Idea199655Service {
    private static final int IDEA_ID = 199655;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199655Service() {
        this(new Idea199655Config());
    }

    public Idea199655Service(Idea199655Config config) {
        this.config = config != null ? config : new Idea199655Config();
