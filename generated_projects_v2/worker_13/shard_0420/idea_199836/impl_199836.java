...
@Data
public class Idea199836Config {
    private String name = "idea_199836";
 ...
 */
@Slf4j
public class Idea199836Service {
    private static final int IDEA_ID = 199836;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199836Service() {
        this(new Idea199836Config());
    }

    public Idea199836Service(Idea199836Config config) {
        this.config = config != null ? config : new Idea199836Config();
