...
@Data
public class Idea199701Config {
    private String name = "idea_199701";
 ...
 */
@Slf4j
public class Idea199701Service {
    private static final int IDEA_ID = 199701;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199701Service() {
        this(new Idea199701Config());
    }

    public Idea199701Service(Idea199701Config config) {
        this.config = config != null ? config : new Idea199701Config();
