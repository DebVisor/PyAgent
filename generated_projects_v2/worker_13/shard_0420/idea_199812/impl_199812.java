...
@Data
public class Idea199812Config {
    private String name = "idea_199812";
 ...
 */
@Slf4j
public class Idea199812Service {
    private static final int IDEA_ID = 199812;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199812Service() {
        this(new Idea199812Config());
    }

    public Idea199812Service(Idea199812Config config) {
        this.config = config != null ? config : new Idea199812Config();
