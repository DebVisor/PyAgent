...
@Data
public class Idea199683Config {
    private String name = "idea_199683";
 ...
 */
@Slf4j
public class Idea199683Service {
    private static final int IDEA_ID = 199683;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199683Service() {
        this(new Idea199683Config());
    }

    public Idea199683Service(Idea199683Config config) {
        this.config = config != null ? config : new Idea199683Config();
