...
@Data
public class Idea199629Config {
    private String name = "idea_199629";
 ...
 */
@Slf4j
public class Idea199629Service {
    private static final int IDEA_ID = 199629;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199629Service() {
        this(new Idea199629Config());
    }

    public Idea199629Service(Idea199629Config config) {
        this.config = config != null ? config : new Idea199629Config();
