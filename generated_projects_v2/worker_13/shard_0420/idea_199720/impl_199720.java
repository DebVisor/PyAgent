...
@Data
public class Idea199720Config {
    private String name = "idea_199720";
 ...
 */
@Slf4j
public class Idea199720Service {
    private static final int IDEA_ID = 199720;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199720Service() {
        this(new Idea199720Config());
    }

    public Idea199720Service(Idea199720Config config) {
        this.config = config != null ? config : new Idea199720Config();
