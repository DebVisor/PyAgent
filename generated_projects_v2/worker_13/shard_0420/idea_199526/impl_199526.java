...
@Data
public class Idea199526Config {
    private String name = "idea_199526";
 ...
 */
@Slf4j
public class Idea199526Service {
    private static final int IDEA_ID = 199526;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199526Service() {
        this(new Idea199526Config());
    }

    public Idea199526Service(Idea199526Config config) {
        this.config = config != null ? config : new Idea199526Config();
