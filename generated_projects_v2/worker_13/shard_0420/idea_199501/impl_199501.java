...
@Data
public class Idea199501Config {
    private String name = "idea_199501";
 ...
 */
@Slf4j
public class Idea199501Service {
    private static final int IDEA_ID = 199501;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199501Service() {
        this(new Idea199501Config());
    }

    public Idea199501Service(Idea199501Config config) {
        this.config = config != null ? config : new Idea199501Config();
