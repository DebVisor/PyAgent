...
@Data
public class Idea199844Config {
    private String name = "idea_199844";
 ...
 */
@Slf4j
public class Idea199844Service {
    private static final int IDEA_ID = 199844;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199844Service() {
        this(new Idea199844Config());
    }

    public Idea199844Service(Idea199844Config config) {
        this.config = config != null ? config : new Idea199844Config();
