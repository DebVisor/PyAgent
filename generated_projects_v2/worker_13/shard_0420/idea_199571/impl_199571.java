...
@Data
public class Idea199571Config {
    private String name = "idea_199571";
 ...
 */
@Slf4j
public class Idea199571Service {
    private static final int IDEA_ID = 199571;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199571Service() {
        this(new Idea199571Config());
    }

    public Idea199571Service(Idea199571Config config) {
        this.config = config != null ? config : new Idea199571Config();
