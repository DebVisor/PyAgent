...
@Data
public class Idea199721Config {
    private String name = "idea_199721";
 ...
 */
@Slf4j
public class Idea199721Service {
    private static final int IDEA_ID = 199721;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199721Service() {
        this(new Idea199721Config());
    }

    public Idea199721Service(Idea199721Config config) {
        this.config = config != null ? config : new Idea199721Config();
