...
@Data
public class Idea199589Config {
    private String name = "idea_199589";
 ...
 */
@Slf4j
public class Idea199589Service {
    private static final int IDEA_ID = 199589;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199589Service() {
        this(new Idea199589Config());
    }

    public Idea199589Service(Idea199589Config config) {
        this.config = config != null ? config : new Idea199589Config();
