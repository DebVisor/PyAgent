...
@Data
public class Idea199594Config {
    private String name = "idea_199594";
 ...
 */
@Slf4j
public class Idea199594Service {
    private static final int IDEA_ID = 199594;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199594Service() {
        this(new Idea199594Config());
    }

    public Idea199594Service(Idea199594Config config) {
        this.config = config != null ? config : new Idea199594Config();
