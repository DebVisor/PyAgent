...
@Data
public class Idea199570Config {
    private String name = "idea_199570";
 ...
 */
@Slf4j
public class Idea199570Service {
    private static final int IDEA_ID = 199570;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199570Service() {
        this(new Idea199570Config());
    }

    public Idea199570Service(Idea199570Config config) {
        this.config = config != null ? config : new Idea199570Config();
