...
@Data
public class Idea199705Config {
    private String name = "idea_199705";
 ...
 */
@Slf4j
public class Idea199705Service {
    private static final int IDEA_ID = 199705;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199705Service() {
        this(new Idea199705Config());
    }

    public Idea199705Service(Idea199705Config config) {
        this.config = config != null ? config : new Idea199705Config();
