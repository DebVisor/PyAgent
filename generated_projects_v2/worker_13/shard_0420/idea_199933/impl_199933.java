...
@Data
public class Idea199933Config {
    private String name = "idea_199933";
 ...
 */
@Slf4j
public class Idea199933Service {
    private static final int IDEA_ID = 199933;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199933Service() {
        this(new Idea199933Config());
    }

    public Idea199933Service(Idea199933Config config) {
        this.config = config != null ? config : new Idea199933Config();
