...
@Data
public class Idea199563Config {
    private String name = "idea_199563";
 ...
 */
@Slf4j
public class Idea199563Service {
    private static final int IDEA_ID = 199563;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199563Service() {
        this(new Idea199563Config());
    }

    public Idea199563Service(Idea199563Config config) {
        this.config = config != null ? config : new Idea199563Config();
