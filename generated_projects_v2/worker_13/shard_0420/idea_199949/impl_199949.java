...
@Data
public class Idea199949Config {
    private String name = "idea_199949";
 ...
 */
@Slf4j
public class Idea199949Service {
    private static final int IDEA_ID = 199949;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199949Service() {
        this(new Idea199949Config());
    }

    public Idea199949Service(Idea199949Config config) {
        this.config = config != null ? config : new Idea199949Config();
