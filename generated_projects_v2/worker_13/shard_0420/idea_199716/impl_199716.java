...
@Data
public class Idea199716Config {
    private String name = "idea_199716";
 ...
 */
@Slf4j
public class Idea199716Service {
    private static final int IDEA_ID = 199716;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199716Service() {
        this(new Idea199716Config());
    }

    public Idea199716Service(Idea199716Config config) {
        this.config = config != null ? config : new Idea199716Config();
