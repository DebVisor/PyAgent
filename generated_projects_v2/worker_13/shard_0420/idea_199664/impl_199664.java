...
@Data
public class Idea199664Config {
    private String name = "idea_199664";
 ...
 */
@Slf4j
public class Idea199664Service {
    private static final int IDEA_ID = 199664;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199664Service() {
        this(new Idea199664Config());
    }

    public Idea199664Service(Idea199664Config config) {
        this.config = config != null ? config : new Idea199664Config();
