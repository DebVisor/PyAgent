...
@Data
public class Idea199610Config {
    private String name = "idea_199610";
 ...
 */
@Slf4j
public class Idea199610Service {
    private static final int IDEA_ID = 199610;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199610Service() {
        this(new Idea199610Config());
    }

    public Idea199610Service(Idea199610Config config) {
        this.config = config != null ? config : new Idea199610Config();
