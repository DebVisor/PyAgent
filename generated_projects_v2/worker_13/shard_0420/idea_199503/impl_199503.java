...
@Data
public class Idea199503Config {
    private String name = "idea_199503";
 ...
 */
@Slf4j
public class Idea199503Service {
    private static final int IDEA_ID = 199503;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199503Service() {
        this(new Idea199503Config());
    }

    public Idea199503Service(Idea199503Config config) {
        this.config = config != null ? config : new Idea199503Config();
