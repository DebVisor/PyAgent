...
@Data
public class Idea199966Config {
    private String name = "idea_199966";
 ...
 */
@Slf4j
public class Idea199966Service {
    private static final int IDEA_ID = 199966;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199966Service() {
        this(new Idea199966Config());
    }

    public Idea199966Service(Idea199966Config config) {
        this.config = config != null ? config : new Idea199966Config();
