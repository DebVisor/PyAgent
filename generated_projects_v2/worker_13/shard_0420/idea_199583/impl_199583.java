...
@Data
public class Idea199583Config {
    private String name = "idea_199583";
 ...
 */
@Slf4j
public class Idea199583Service {
    private static final int IDEA_ID = 199583;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199583Service() {
        this(new Idea199583Config());
    }

    public Idea199583Service(Idea199583Config config) {
        this.config = config != null ? config : new Idea199583Config();
