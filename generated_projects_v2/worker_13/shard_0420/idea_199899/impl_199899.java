...
@Data
public class Idea199899Config {
    private String name = "idea_199899";
 ...
 */
@Slf4j
public class Idea199899Service {
    private static final int IDEA_ID = 199899;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199899Service() {
        this(new Idea199899Config());
    }

    public Idea199899Service(Idea199899Config config) {
        this.config = config != null ? config : new Idea199899Config();
