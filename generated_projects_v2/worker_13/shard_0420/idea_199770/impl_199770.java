...
@Data
public class Idea199770Config {
    private String name = "idea_199770";
 ...
 */
@Slf4j
public class Idea199770Service {
    private static final int IDEA_ID = 199770;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199770Service() {
        this(new Idea199770Config());
    }

    public Idea199770Service(Idea199770Config config) {
        this.config = config != null ? config : new Idea199770Config();
