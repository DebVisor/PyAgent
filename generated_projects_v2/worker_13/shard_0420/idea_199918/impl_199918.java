...
@Data
public class Idea199918Config {
    private String name = "idea_199918";
 ...
 */
@Slf4j
public class Idea199918Service {
    private static final int IDEA_ID = 199918;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199918Service() {
        this(new Idea199918Config());
    }

    public Idea199918Service(Idea199918Config config) {
        this.config = config != null ? config : new Idea199918Config();
