...
@Data
public class Idea199535Config {
    private String name = "idea_199535";
 ...
 */
@Slf4j
public class Idea199535Service {
    private static final int IDEA_ID = 199535;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199535Service() {
        this(new Idea199535Config());
    }

    public Idea199535Service(Idea199535Config config) {
        this.config = config != null ? config : new Idea199535Config();
