...
@Data
public class Idea199524Config {
    private String name = "idea_199524";
 ...
 */
@Slf4j
public class Idea199524Service {
    private static final int IDEA_ID = 199524;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199524Service() {
        this(new Idea199524Config());
    }

    public Idea199524Service(Idea199524Config config) {
        this.config = config != null ? config : new Idea199524Config();
