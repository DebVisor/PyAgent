...
@Data
public class Idea199550Config {
    private String name = "idea_199550";
 ...
 */
@Slf4j
public class Idea199550Service {
    private static final int IDEA_ID = 199550;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199550Service() {
        this(new Idea199550Config());
    }

    public Idea199550Service(Idea199550Config config) {
        this.config = config != null ? config : new Idea199550Config();
