...
@Data
public class Idea199926Config {
    private String name = "idea_199926";
 ...
 */
@Slf4j
public class Idea199926Service {
    private static final int IDEA_ID = 199926;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199926Service() {
        this(new Idea199926Config());
    }

    public Idea199926Service(Idea199926Config config) {
        this.config = config != null ? config : new Idea199926Config();
