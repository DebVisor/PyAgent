...
@Data
public class Idea199738Config {
    private String name = "idea_199738";
 ...
 */
@Slf4j
public class Idea199738Service {
    private static final int IDEA_ID = 199738;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199738Service() {
        this(new Idea199738Config());
    }

    public Idea199738Service(Idea199738Config config) {
        this.config = config != null ? config : new Idea199738Config();
