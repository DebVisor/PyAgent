...
@Data
public class Idea199652Config {
    private String name = "idea_199652";
 ...
 */
@Slf4j
public class Idea199652Service {
    private static final int IDEA_ID = 199652;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199652Service() {
        this(new Idea199652Config());
    }

    public Idea199652Service(Idea199652Config config) {
        this.config = config != null ? config : new Idea199652Config();
