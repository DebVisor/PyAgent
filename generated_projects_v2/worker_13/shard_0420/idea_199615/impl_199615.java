...
@Data
public class Idea199615Config {
    private String name = "idea_199615";
 ...
 */
@Slf4j
public class Idea199615Service {
    private static final int IDEA_ID = 199615;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199615Service() {
        this(new Idea199615Config());
    }

    public Idea199615Service(Idea199615Config config) {
        this.config = config != null ? config : new Idea199615Config();
