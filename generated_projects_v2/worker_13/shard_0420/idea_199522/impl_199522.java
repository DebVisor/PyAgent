...
@Data
public class Idea199522Config {
    private String name = "idea_199522";
 ...
 */
@Slf4j
public class Idea199522Service {
    private static final int IDEA_ID = 199522;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199522Service() {
        this(new Idea199522Config());
    }

    public Idea199522Service(Idea199522Config config) {
        this.config = config != null ? config : new Idea199522Config();
