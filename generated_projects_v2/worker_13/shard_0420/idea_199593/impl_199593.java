...
@Data
public class Idea199593Config {
    private String name = "idea_199593";
 ...
 */
@Slf4j
public class Idea199593Service {
    private static final int IDEA_ID = 199593;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199593Service() {
        this(new Idea199593Config());
    }

    public Idea199593Service(Idea199593Config config) {
        this.config = config != null ? config : new Idea199593Config();
