...
@Data
public class Idea199539Config {
    private String name = "idea_199539";
 ...
 */
@Slf4j
public class Idea199539Service {
    private static final int IDEA_ID = 199539;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199539Service() {
        this(new Idea199539Config());
    }

    public Idea199539Service(Idea199539Config config) {
        this.config = config != null ? config : new Idea199539Config();
