...
@Data
public class Idea199800Config {
    private String name = "idea_199800";
 ...
 */
@Slf4j
public class Idea199800Service {
    private static final int IDEA_ID = 199800;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199800Service() {
        this(new Idea199800Config());
    }

    public Idea199800Service(Idea199800Config config) {
        this.config = config != null ? config : new Idea199800Config();
