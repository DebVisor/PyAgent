...
@Data
public class Idea199912Config {
    private String name = "idea_199912";
 ...
 */
@Slf4j
public class Idea199912Service {
    private static final int IDEA_ID = 199912;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199912Service() {
        this(new Idea199912Config());
    }

    public Idea199912Service(Idea199912Config config) {
        this.config = config != null ? config : new Idea199912Config();
