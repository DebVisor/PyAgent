...
@Data
public class Idea199580Config {
    private String name = "idea_199580";
 ...
 */
@Slf4j
public class Idea199580Service {
    private static final int IDEA_ID = 199580;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199580Service() {
        this(new Idea199580Config());
    }

    public Idea199580Service(Idea199580Config config) {
        this.config = config != null ? config : new Idea199580Config();
