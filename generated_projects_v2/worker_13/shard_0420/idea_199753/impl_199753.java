...
@Data
public class Idea199753Config {
    private String name = "idea_199753";
 ...
 */
@Slf4j
public class Idea199753Service {
    private static final int IDEA_ID = 199753;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199753Service() {
        this(new Idea199753Config());
    }

    public Idea199753Service(Idea199753Config config) {
        this.config = config != null ? config : new Idea199753Config();
