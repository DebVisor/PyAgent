...
@Data
public class Idea199677Config {
    private String name = "idea_199677";
 ...
 */
@Slf4j
public class Idea199677Service {
    private static final int IDEA_ID = 199677;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199677Service() {
        this(new Idea199677Config());
    }

    public Idea199677Service(Idea199677Config config) {
        this.config = config != null ? config : new Idea199677Config();
