...
@Data
public class Idea199893Config {
    private String name = "idea_199893";
 ...
 */
@Slf4j
public class Idea199893Service {
    private static final int IDEA_ID = 199893;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199893Service() {
        this(new Idea199893Config());
    }

    public Idea199893Service(Idea199893Config config) {
        this.config = config != null ? config : new Idea199893Config();
