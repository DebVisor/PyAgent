...
@Data
public class Idea199824Config {
    private String name = "idea_199824";
 ...
 */
@Slf4j
public class Idea199824Service {
    private static final int IDEA_ID = 199824;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199824Service() {
        this(new Idea199824Config());
    }

    public Idea199824Service(Idea199824Config config) {
        this.config = config != null ? config : new Idea199824Config();
