...
@Data
public class Idea199927Config {
    private String name = "idea_199927";
 ...
 */
@Slf4j
public class Idea199927Service {
    private static final int IDEA_ID = 199927;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199927Service() {
        this(new Idea199927Config());
    }

    public Idea199927Service(Idea199927Config config) {
        this.config = config != null ? config : new Idea199927Config();
