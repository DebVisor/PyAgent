...
@Data
public class Idea199779Config {
    private String name = "idea_199779";
 ...
 */
@Slf4j
public class Idea199779Service {
    private static final int IDEA_ID = 199779;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199779Service() {
        this(new Idea199779Config());
    }

    public Idea199779Service(Idea199779Config config) {
        this.config = config != null ? config : new Idea199779Config();
