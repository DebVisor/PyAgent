...
@Data
public class Idea199803Config {
    private String name = "idea_199803";
 ...
 */
@Slf4j
public class Idea199803Service {
    private static final int IDEA_ID = 199803;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199803Service() {
        this(new Idea199803Config());
    }

    public Idea199803Service(Idea199803Config config) {
        this.config = config != null ? config : new Idea199803Config();
