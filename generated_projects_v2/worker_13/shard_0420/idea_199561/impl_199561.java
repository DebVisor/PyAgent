...
@Data
public class Idea199561Config {
    private String name = "idea_199561";
 ...
 */
@Slf4j
public class Idea199561Service {
    private static final int IDEA_ID = 199561;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199561Service() {
        this(new Idea199561Config());
    }

    public Idea199561Service(Idea199561Config config) {
        this.config = config != null ? config : new Idea199561Config();
