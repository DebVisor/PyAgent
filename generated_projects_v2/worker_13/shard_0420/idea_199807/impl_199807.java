...
@Data
public class Idea199807Config {
    private String name = "idea_199807";
 ...
 */
@Slf4j
public class Idea199807Service {
    private static final int IDEA_ID = 199807;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199807Service() {
        this(new Idea199807Config());
    }

    public Idea199807Service(Idea199807Config config) {
        this.config = config != null ? config : new Idea199807Config();
