...
@Data
public class Idea199801Config {
    private String name = "idea_199801";
 ...
 */
@Slf4j
public class Idea199801Service {
    private static final int IDEA_ID = 199801;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199801Service() {
        this(new Idea199801Config());
    }

    public Idea199801Service(Idea199801Config config) {
        this.config = config != null ? config : new Idea199801Config();
