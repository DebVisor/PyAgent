...
@Data
public class Idea199954Config {
    private String name = "idea_199954";
 ...
 */
@Slf4j
public class Idea199954Service {
    private static final int IDEA_ID = 199954;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199954Service() {
        this(new Idea199954Config());
    }

    public Idea199954Service(Idea199954Config config) {
        this.config = config != null ? config : new Idea199954Config();
