...
@Data
public class Idea199510Config {
    private String name = "idea_199510";
 ...
 */
@Slf4j
public class Idea199510Service {
    private static final int IDEA_ID = 199510;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199510Service() {
        this(new Idea199510Config());
    }

    public Idea199510Service(Idea199510Config config) {
        this.config = config != null ? config : new Idea199510Config();
