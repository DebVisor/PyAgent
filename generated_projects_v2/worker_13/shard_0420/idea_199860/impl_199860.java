...
@Data
public class Idea199860Config {
    private String name = "idea_199860";
 ...
 */
@Slf4j
public class Idea199860Service {
    private static final int IDEA_ID = 199860;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199860Service() {
        this(new Idea199860Config());
    }

    public Idea199860Service(Idea199860Config config) {
        this.config = config != null ? config : new Idea199860Config();
