...
@Data
public class Idea199832Config {
    private String name = "idea_199832";
 ...
 */
@Slf4j
public class Idea199832Service {
    private static final int IDEA_ID = 199832;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199832Service() {
        this(new Idea199832Config());
    }

    public Idea199832Service(Idea199832Config config) {
        this.config = config != null ? config : new Idea199832Config();
