...
@Data
public class Idea199514Config {
    private String name = "idea_199514";
 ...
 */
@Slf4j
public class Idea199514Service {
    private static final int IDEA_ID = 199514;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199514Service() {
        this(new Idea199514Config());
    }

    public Idea199514Service(Idea199514Config config) {
        this.config = config != null ? config : new Idea199514Config();
