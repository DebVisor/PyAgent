...
@Data
public class Idea199747Config {
    private String name = "idea_199747";
 ...
 */
@Slf4j
public class Idea199747Service {
    private static final int IDEA_ID = 199747;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199747Service() {
        this(new Idea199747Config());
    }

    public Idea199747Service(Idea199747Config config) {
        this.config = config != null ? config : new Idea199747Config();
