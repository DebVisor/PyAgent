...
@Data
public class Idea199808Config {
    private String name = "idea_199808";
 ...
 */
@Slf4j
public class Idea199808Service {
    private static final int IDEA_ID = 199808;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199808Service() {
        this(new Idea199808Config());
    }

    public Idea199808Service(Idea199808Config config) {
        this.config = config != null ? config : new Idea199808Config();
