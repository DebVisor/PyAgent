...
@Data
public class Idea199577Config {
    private String name = "idea_199577";
 ...
 */
@Slf4j
public class Idea199577Service {
    private static final int IDEA_ID = 199577;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199577Service() {
        this(new Idea199577Config());
    }

    public Idea199577Service(Idea199577Config config) {
        this.config = config != null ? config : new Idea199577Config();
