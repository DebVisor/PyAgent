...
@Data
public class Idea199880Config {
    private String name = "idea_199880";
 ...
 */
@Slf4j
public class Idea199880Service {
    private static final int IDEA_ID = 199880;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199880Service() {
        this(new Idea199880Config());
    }

    public Idea199880Service(Idea199880Config config) {
        this.config = config != null ? config : new Idea199880Config();
