...
@Data
public class Idea199852Config {
    private String name = "idea_199852";
 ...
 */
@Slf4j
public class Idea199852Service {
    private static final int IDEA_ID = 199852;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199852Service() {
        this(new Idea199852Config());
    }

    public Idea199852Service(Idea199852Config config) {
        this.config = config != null ? config : new Idea199852Config();
