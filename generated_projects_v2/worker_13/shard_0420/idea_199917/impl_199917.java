...
@Data
public class Idea199917Config {
    private String name = "idea_199917";
 ...
 */
@Slf4j
public class Idea199917Service {
    private static final int IDEA_ID = 199917;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199917Service() {
        this(new Idea199917Config());
    }

    public Idea199917Service(Idea199917Config config) {
        this.config = config != null ? config : new Idea199917Config();
