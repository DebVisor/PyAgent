...
@Data
public class Idea199845Config {
    private String name = "idea_199845";
 ...
 */
@Slf4j
public class Idea199845Service {
    private static final int IDEA_ID = 199845;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199845Service() {
        this(new Idea199845Config());
    }

    public Idea199845Service(Idea199845Config config) {
        this.config = config != null ? config : new Idea199845Config();
