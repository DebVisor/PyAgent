...
@Data
public class Idea199611Config {
    private String name = "idea_199611";
 ...
 */
@Slf4j
public class Idea199611Service {
    private static final int IDEA_ID = 199611;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199611Service() {
        this(new Idea199611Config());
    }

    public Idea199611Service(Idea199611Config config) {
        this.config = config != null ? config : new Idea199611Config();
