...
@Data
public class Idea199863Config {
    private String name = "idea_199863";
 ...
 */
@Slf4j
public class Idea199863Service {
    private static final int IDEA_ID = 199863;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199863Service() {
        this(new Idea199863Config());
    }

    public Idea199863Service(Idea199863Config config) {
        this.config = config != null ? config : new Idea199863Config();
