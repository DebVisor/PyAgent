...
@Data
public class Idea199945Config {
    private String name = "idea_199945";
 ...
 */
@Slf4j
public class Idea199945Service {
    private static final int IDEA_ID = 199945;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199945Service() {
        this(new Idea199945Config());
    }

    public Idea199945Service(Idea199945Config config) {
        this.config = config != null ? config : new Idea199945Config();
