...
@Data
public class Idea199859Config {
    private String name = "idea_199859";
 ...
 */
@Slf4j
public class Idea199859Service {
    private static final int IDEA_ID = 199859;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199859Service() {
        this(new Idea199859Config());
    }

    public Idea199859Service(Idea199859Config config) {
        this.config = config != null ? config : new Idea199859Config();
