...
@Data
public class Idea199698Config {
    private String name = "idea_199698";
 ...
 */
@Slf4j
public class Idea199698Service {
    private static final int IDEA_ID = 199698;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199698Service() {
        this(new Idea199698Config());
    }

    public Idea199698Service(Idea199698Config config) {
        this.config = config != null ? config : new Idea199698Config();
