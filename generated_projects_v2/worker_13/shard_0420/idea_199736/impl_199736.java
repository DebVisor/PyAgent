...
@Data
public class Idea199736Config {
    private String name = "idea_199736";
 ...
 */
@Slf4j
public class Idea199736Service {
    private static final int IDEA_ID = 199736;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199736Service() {
        this(new Idea199736Config());
    }

    public Idea199736Service(Idea199736Config config) {
        this.config = config != null ? config : new Idea199736Config();
