...
@Data
public class Idea199786Config {
    private String name = "idea_199786";
 ...
 */
@Slf4j
public class Idea199786Service {
    private static final int IDEA_ID = 199786;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199786Service() {
        this(new Idea199786Config());
    }

    public Idea199786Service(Idea199786Config config) {
        this.config = config != null ? config : new Idea199786Config();
