...
@Data
public class Idea199566Config {
    private String name = "idea_199566";
 ...
 */
@Slf4j
public class Idea199566Service {
    private static final int IDEA_ID = 199566;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199566Service() {
        this(new Idea199566Config());
    }

    public Idea199566Service(Idea199566Config config) {
        this.config = config != null ? config : new Idea199566Config();
