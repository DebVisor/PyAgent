...
@Data
public class Idea199706Config {
    private String name = "idea_199706";
 ...
 */
@Slf4j
public class Idea199706Service {
    private static final int IDEA_ID = 199706;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199706Service() {
        this(new Idea199706Config());
    }

    public Idea199706Service(Idea199706Config config) {
        this.config = config != null ? config : new Idea199706Config();
