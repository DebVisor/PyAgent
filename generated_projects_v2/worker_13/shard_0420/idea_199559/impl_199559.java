...
@Data
public class Idea199559Config {
    private String name = "idea_199559";
 ...
 */
@Slf4j
public class Idea199559Service {
    private static final int IDEA_ID = 199559;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199559Service() {
        this(new Idea199559Config());
    }

    public Idea199559Service(Idea199559Config config) {
        this.config = config != null ? config : new Idea199559Config();
