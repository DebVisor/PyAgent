...
@Data
public class Idea199941Config {
    private String name = "idea_199941";
 ...
 */
@Slf4j
public class Idea199941Service {
    private static final int IDEA_ID = 199941;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199941Service() {
        this(new Idea199941Config());
    }

    public Idea199941Service(Idea199941Config config) {
        this.config = config != null ? config : new Idea199941Config();
