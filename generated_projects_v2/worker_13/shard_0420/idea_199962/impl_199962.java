...
@Data
public class Idea199962Config {
    private String name = "idea_199962";
 ...
 */
@Slf4j
public class Idea199962Service {
    private static final int IDEA_ID = 199962;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199962Service() {
        this(new Idea199962Config());
    }

    public Idea199962Service(Idea199962Config config) {
        this.config = config != null ? config : new Idea199962Config();
