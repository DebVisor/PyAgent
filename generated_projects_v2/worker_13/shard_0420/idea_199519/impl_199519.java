...
@Data
public class Idea199519Config {
    private String name = "idea_199519";
 ...
 */
@Slf4j
public class Idea199519Service {
    private static final int IDEA_ID = 199519;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199519Service() {
        this(new Idea199519Config());
    }

    public Idea199519Service(Idea199519Config config) {
        this.config = config != null ? config : new Idea199519Config();
