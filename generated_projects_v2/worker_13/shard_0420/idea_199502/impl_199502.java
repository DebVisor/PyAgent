...
@Data
public class Idea199502Config {
    private String name = "idea_199502";
 ...
 */
@Slf4j
public class Idea199502Service {
    private static final int IDEA_ID = 199502;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199502Service() {
        this(new Idea199502Config());
    }

    public Idea199502Service(Idea199502Config config) {
        this.config = config != null ? config : new Idea199502Config();
