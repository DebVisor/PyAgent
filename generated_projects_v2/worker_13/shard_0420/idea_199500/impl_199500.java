...
@Data
public class Idea199500Config {
    private String name = "idea_199500";
 ...
 */
@Slf4j
public class Idea199500Service {
    private static final int IDEA_ID = 199500;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199500Service() {
        this(new Idea199500Config());
    }

    public Idea199500Service(Idea199500Config config) {
        this.config = config != null ? config : new Idea199500Config();
