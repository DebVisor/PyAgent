...
@Data
public class Idea199840Config {
    private String name = "idea_199840";
 ...
 */
@Slf4j
public class Idea199840Service {
    private static final int IDEA_ID = 199840;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199840Service() {
        this(new Idea199840Config());
    }

    public Idea199840Service(Idea199840Config config) {
        this.config = config != null ? config : new Idea199840Config();
