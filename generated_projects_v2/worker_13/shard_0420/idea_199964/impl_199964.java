...
@Data
public class Idea199964Config {
    private String name = "idea_199964";
 ...
 */
@Slf4j
public class Idea199964Service {
    private static final int IDEA_ID = 199964;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199964Service() {
        this(new Idea199964Config());
    }

    public Idea199964Service(Idea199964Config config) {
        this.config = config != null ? config : new Idea199964Config();
