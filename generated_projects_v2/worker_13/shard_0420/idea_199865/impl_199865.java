...
@Data
public class Idea199865Config {
    private String name = "idea_199865";
 ...
 */
@Slf4j
public class Idea199865Service {
    private static final int IDEA_ID = 199865;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199865Service() {
        this(new Idea199865Config());
    }

    public Idea199865Service(Idea199865Config config) {
        this.config = config != null ? config : new Idea199865Config();
