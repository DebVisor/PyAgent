...
@Data
public class Idea199603Config {
    private String name = "idea_199603";
 ...
 */
@Slf4j
public class Idea199603Service {
    private static final int IDEA_ID = 199603;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199603Service() {
        this(new Idea199603Config());
    }

    public Idea199603Service(Idea199603Config config) {
        this.config = config != null ? config : new Idea199603Config();
