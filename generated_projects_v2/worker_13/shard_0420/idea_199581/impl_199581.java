...
@Data
public class Idea199581Config {
    private String name = "idea_199581";
 ...
 */
@Slf4j
public class Idea199581Service {
    private static final int IDEA_ID = 199581;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199581Service() {
        this(new Idea199581Config());
    }

    public Idea199581Service(Idea199581Config config) {
        this.config = config != null ? config : new Idea199581Config();
