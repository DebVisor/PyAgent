...
@Data
public class Idea199809Config {
    private String name = "idea_199809";
 ...
 */
@Slf4j
public class Idea199809Service {
    private static final int IDEA_ID = 199809;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199809Service() {
        this(new Idea199809Config());
    }

    public Idea199809Service(Idea199809Config config) {
        this.config = config != null ? config : new Idea199809Config();
