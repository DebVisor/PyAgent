...
@Data
public class Idea199543Config {
    private String name = "idea_199543";
 ...
 */
@Slf4j
public class Idea199543Service {
    private static final int IDEA_ID = 199543;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199543Service() {
        this(new Idea199543Config());
    }

    public Idea199543Service(Idea199543Config config) {
        this.config = config != null ? config : new Idea199543Config();
