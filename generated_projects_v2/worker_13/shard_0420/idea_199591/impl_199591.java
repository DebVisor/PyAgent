...
@Data
public class Idea199591Config {
    private String name = "idea_199591";
 ...
 */
@Slf4j
public class Idea199591Service {
    private static final int IDEA_ID = 199591;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199591Service() {
        this(new Idea199591Config());
    }

    public Idea199591Service(Idea199591Config config) {
        this.config = config != null ? config : new Idea199591Config();
