...
@Data
public class Idea199525Config {
    private String name = "idea_199525";
 ...
 */
@Slf4j
public class Idea199525Service {
    private static final int IDEA_ID = 199525;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199525Service() {
        this(new Idea199525Config());
    }

    public Idea199525Service(Idea199525Config config) {
        this.config = config != null ? config : new Idea199525Config();
