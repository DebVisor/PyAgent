...
@Data
public class Idea199660Config {
    private String name = "idea_199660";
 ...
 */
@Slf4j
public class Idea199660Service {
    private static final int IDEA_ID = 199660;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199660Service() {
        this(new Idea199660Config());
    }

    public Idea199660Service(Idea199660Config config) {
        this.config = config != null ? config : new Idea199660Config();
