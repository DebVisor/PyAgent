...
@Data
public class Idea199915Config {
    private String name = "idea_199915";
 ...
 */
@Slf4j
public class Idea199915Service {
    private static final int IDEA_ID = 199915;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199915Service() {
        this(new Idea199915Config());
    }

    public Idea199915Service(Idea199915Config config) {
        this.config = config != null ? config : new Idea199915Config();
