...
@Data
public class Idea199634Config {
    private String name = "idea_199634";
 ...
 */
@Slf4j
public class Idea199634Service {
    private static final int IDEA_ID = 199634;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199634Service() {
        this(new Idea199634Config());
    }

    public Idea199634Service(Idea199634Config config) {
        this.config = config != null ? config : new Idea199634Config();
