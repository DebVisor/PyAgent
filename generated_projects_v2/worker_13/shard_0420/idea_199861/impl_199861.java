...
@Data
public class Idea199861Config {
    private String name = "idea_199861";
 ...
 */
@Slf4j
public class Idea199861Service {
    private static final int IDEA_ID = 199861;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199861Service() {
        this(new Idea199861Config());
    }

    public Idea199861Service(Idea199861Config config) {
        this.config = config != null ? config : new Idea199861Config();
