...
@Data
public class Idea199906Config {
    private String name = "idea_199906";
 ...
 */
@Slf4j
public class Idea199906Service {
    private static final int IDEA_ID = 199906;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199906Service() {
        this(new Idea199906Config());
    }

    public Idea199906Service(Idea199906Config config) {
        this.config = config != null ? config : new Idea199906Config();
