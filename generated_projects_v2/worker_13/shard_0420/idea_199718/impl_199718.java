...
@Data
public class Idea199718Config {
    private String name = "idea_199718";
 ...
 */
@Slf4j
public class Idea199718Service {
    private static final int IDEA_ID = 199718;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199718Service() {
        this(new Idea199718Config());
    }

    public Idea199718Service(Idea199718Config config) {
        this.config = config != null ? config : new Idea199718Config();
