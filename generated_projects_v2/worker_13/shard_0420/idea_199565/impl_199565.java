...
@Data
public class Idea199565Config {
    private String name = "idea_199565";
 ...
 */
@Slf4j
public class Idea199565Service {
    private static final int IDEA_ID = 199565;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199565Service() {
        this(new Idea199565Config());
    }

    public Idea199565Service(Idea199565Config config) {
        this.config = config != null ? config : new Idea199565Config();
