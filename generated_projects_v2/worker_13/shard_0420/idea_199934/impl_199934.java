...
@Data
public class Idea199934Config {
    private String name = "idea_199934";
 ...
 */
@Slf4j
public class Idea199934Service {
    private static final int IDEA_ID = 199934;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199934Service() {
        this(new Idea199934Config());
    }

    public Idea199934Service(Idea199934Config config) {
        this.config = config != null ? config : new Idea199934Config();
