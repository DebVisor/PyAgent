...
@Data
public class Idea199897Config {
    private String name = "idea_199897";
 ...
 */
@Slf4j
public class Idea199897Service {
    private static final int IDEA_ID = 199897;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199897Service() {
        this(new Idea199897Config());
    }

    public Idea199897Service(Idea199897Config config) {
        this.config = config != null ? config : new Idea199897Config();
