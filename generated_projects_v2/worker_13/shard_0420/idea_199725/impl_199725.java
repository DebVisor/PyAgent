...
@Data
public class Idea199725Config {
    private String name = "idea_199725";
 ...
 */
@Slf4j
public class Idea199725Service {
    private static final int IDEA_ID = 199725;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199725Service() {
        this(new Idea199725Config());
    }

    public Idea199725Service(Idea199725Config config) {
        this.config = config != null ? config : new Idea199725Config();
