...
@Data
public class Idea199972Config {
    private String name = "idea_199972";
 ...
 */
@Slf4j
public class Idea199972Service {
    private static final int IDEA_ID = 199972;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199972Service() {
        this(new Idea199972Config());
    }

    public Idea199972Service(Idea199972Config config) {
        this.config = config != null ? config : new Idea199972Config();
