...
@Data
public class Idea199815Config {
    private String name = "idea_199815";
 ...
 */
@Slf4j
public class Idea199815Service {
    private static final int IDEA_ID = 199815;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199815Service() {
        this(new Idea199815Config());
    }

    public Idea199815Service(Idea199815Config config) {
        this.config = config != null ? config : new Idea199815Config();
