...
@Data
public class Idea199931Config {
    private String name = "idea_199931";
 ...
 */
@Slf4j
public class Idea199931Service {
    private static final int IDEA_ID = 199931;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199931Service() {
        this(new Idea199931Config());
    }

    public Idea199931Service(Idea199931Config config) {
        this.config = config != null ? config : new Idea199931Config();
