...
@Data
public class Idea199735Config {
    private String name = "idea_199735";
 ...
 */
@Slf4j
public class Idea199735Service {
    private static final int IDEA_ID = 199735;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199735Service() {
        this(new Idea199735Config());
    }

    public Idea199735Service(Idea199735Config config) {
        this.config = config != null ? config : new Idea199735Config();
