...
@Data
public class Idea199920Config {
    private String name = "idea_199920";
 ...
 */
@Slf4j
public class Idea199920Service {
    private static final int IDEA_ID = 199920;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199920Service() {
        this(new Idea199920Config());
    }

    public Idea199920Service(Idea199920Config config) {
        this.config = config != null ? config : new Idea199920Config();
