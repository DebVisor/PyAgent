...
@Data
public class Idea199795Config {
    private String name = "idea_199795";
 ...
 */
@Slf4j
public class Idea199795Service {
    private static final int IDEA_ID = 199795;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199795Service() {
        this(new Idea199795Config());
    }

    public Idea199795Service(Idea199795Config config) {
        this.config = config != null ? config : new Idea199795Config();
