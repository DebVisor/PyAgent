...
@Data
public class Idea199827Config {
    private String name = "idea_199827";
 ...
 */
@Slf4j
public class Idea199827Service {
    private static final int IDEA_ID = 199827;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199827Service() {
        this(new Idea199827Config());
    }

    public Idea199827Service(Idea199827Config config) {
        this.config = config != null ? config : new Idea199827Config();
