...
@Data
public class Idea199714Config {
    private String name = "idea_199714";
 ...
 */
@Slf4j
public class Idea199714Service {
    private static final int IDEA_ID = 199714;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199714Service() {
        this(new Idea199714Config());
    }

    public Idea199714Service(Idea199714Config config) {
        this.config = config != null ? config : new Idea199714Config();
