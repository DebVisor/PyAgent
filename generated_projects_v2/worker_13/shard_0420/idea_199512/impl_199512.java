...
@Data
public class Idea199512Config {
    private String name = "idea_199512";
 ...
 */
@Slf4j
public class Idea199512Service {
    private static final int IDEA_ID = 199512;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199512Service() {
        this(new Idea199512Config());
    }

    public Idea199512Service(Idea199512Config config) {
        this.config = config != null ? config : new Idea199512Config();
