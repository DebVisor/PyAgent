...
@Data
public class Idea199850Config {
    private String name = "idea_199850";
 ...
 */
@Slf4j
public class Idea199850Service {
    private static final int IDEA_ID = 199850;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199850Service() {
        this(new Idea199850Config());
    }

    public Idea199850Service(Idea199850Config config) {
        this.config = config != null ? config : new Idea199850Config();
