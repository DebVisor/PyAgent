...
@Data
public class Idea199575Config {
    private String name = "idea_199575";
 ...
 */
@Slf4j
public class Idea199575Service {
    private static final int IDEA_ID = 199575;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199575Service() {
        this(new Idea199575Config());
    }

    public Idea199575Service(Idea199575Config config) {
        this.config = config != null ? config : new Idea199575Config();
