...
@Data
public class Idea199762Config {
    private String name = "idea_199762";
 ...
 */
@Slf4j
public class Idea199762Service {
    private static final int IDEA_ID = 199762;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199762Service() {
        this(new Idea199762Config());
    }

    public Idea199762Service(Idea199762Config config) {
        this.config = config != null ? config : new Idea199762Config();
