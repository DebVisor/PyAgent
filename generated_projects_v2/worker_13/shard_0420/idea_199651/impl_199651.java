...
@Data
public class Idea199651Config {
    private String name = "idea_199651";
 ...
 */
@Slf4j
public class Idea199651Service {
    private static final int IDEA_ID = 199651;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199651Service() {
        this(new Idea199651Config());
    }

    public Idea199651Service(Idea199651Config config) {
        this.config = config != null ? config : new Idea199651Config();
