...
@Data
public class Idea199509Config {
    private String name = "idea_199509";
 ...
 */
@Slf4j
public class Idea199509Service {
    private static final int IDEA_ID = 199509;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199509Service() {
        this(new Idea199509Config());
    }

    public Idea199509Service(Idea199509Config config) {
        this.config = config != null ? config : new Idea199509Config();
