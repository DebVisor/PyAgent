...
@Data
public class Idea199597Config {
    private String name = "idea_199597";
 ...
 */
@Slf4j
public class Idea199597Service {
    private static final int IDEA_ID = 199597;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199597Service() {
        this(new Idea199597Config());
    }

    public Idea199597Service(Idea199597Config config) {
        this.config = config != null ? config : new Idea199597Config();
