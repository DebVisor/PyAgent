...
@Data
public class Idea199531Config {
    private String name = "idea_199531";
 ...
 */
@Slf4j
public class Idea199531Service {
    private static final int IDEA_ID = 199531;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199531Service() {
        this(new Idea199531Config());
    }

    public Idea199531Service(Idea199531Config config) {
        this.config = config != null ? config : new Idea199531Config();
