...
@Data
public class Idea199515Config {
    private String name = "idea_199515";
 ...
 */
@Slf4j
public class Idea199515Service {
    private static final int IDEA_ID = 199515;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199515Service() {
        this(new Idea199515Config());
    }

    public Idea199515Service(Idea199515Config config) {
        this.config = config != null ? config : new Idea199515Config();
