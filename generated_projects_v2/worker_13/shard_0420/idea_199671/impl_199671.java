...
@Data
public class Idea199671Config {
    private String name = "idea_199671";
 ...
 */
@Slf4j
public class Idea199671Service {
    private static final int IDEA_ID = 199671;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199671Service() {
        this(new Idea199671Config());
    }

    public Idea199671Service(Idea199671Config config) {
        this.config = config != null ? config : new Idea199671Config();
