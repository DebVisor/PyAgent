...
@Data
public class Idea199686Config {
    private String name = "idea_199686";
 ...
 */
@Slf4j
public class Idea199686Service {
    private static final int IDEA_ID = 199686;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199686Service() {
        this(new Idea199686Config());
    }

    public Idea199686Service(Idea199686Config config) {
        this.config = config != null ? config : new Idea199686Config();
