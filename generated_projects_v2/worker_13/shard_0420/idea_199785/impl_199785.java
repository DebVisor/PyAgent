...
@Data
public class Idea199785Config {
    private String name = "idea_199785";
 ...
 */
@Slf4j
public class Idea199785Service {
    private static final int IDEA_ID = 199785;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199785Service() {
        this(new Idea199785Config());
    }

    public Idea199785Service(Idea199785Config config) {
        this.config = config != null ? config : new Idea199785Config();
