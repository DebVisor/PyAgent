...
@Data
public class Idea199696Config {
    private String name = "idea_199696";
 ...
 */
@Slf4j
public class Idea199696Service {
    private static final int IDEA_ID = 199696;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199696Service() {
        this(new Idea199696Config());
    }

    public Idea199696Service(Idea199696Config config) {
        this.config = config != null ? config : new Idea199696Config();
