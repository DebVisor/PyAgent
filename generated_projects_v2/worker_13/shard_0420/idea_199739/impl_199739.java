...
@Data
public class Idea199739Config {
    private String name = "idea_199739";
 ...
 */
@Slf4j
public class Idea199739Service {
    private static final int IDEA_ID = 199739;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199739Service() {
        this(new Idea199739Config());
    }

    public Idea199739Service(Idea199739Config config) {
        this.config = config != null ? config : new Idea199739Config();
