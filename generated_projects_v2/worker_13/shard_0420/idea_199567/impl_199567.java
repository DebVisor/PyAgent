...
@Data
public class Idea199567Config {
    private String name = "idea_199567";
 ...
 */
@Slf4j
public class Idea199567Service {
    private static final int IDEA_ID = 199567;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199567Service() {
        this(new Idea199567Config());
    }

    public Idea199567Service(Idea199567Config config) {
        this.config = config != null ? config : new Idea199567Config();
