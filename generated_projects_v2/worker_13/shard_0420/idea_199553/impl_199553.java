...
@Data
public class Idea199553Config {
    private String name = "idea_199553";
 ...
 */
@Slf4j
public class Idea199553Service {
    private static final int IDEA_ID = 199553;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199553Service() {
        this(new Idea199553Config());
    }

    public Idea199553Service(Idea199553Config config) {
        this.config = config != null ? config : new Idea199553Config();
