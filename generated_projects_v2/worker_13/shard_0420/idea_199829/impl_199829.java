...
@Data
public class Idea199829Config {
    private String name = "idea_199829";
 ...
 */
@Slf4j
public class Idea199829Service {
    private static final int IDEA_ID = 199829;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199829Service() {
        this(new Idea199829Config());
    }

    public Idea199829Service(Idea199829Config config) {
        this.config = config != null ? config : new Idea199829Config();
