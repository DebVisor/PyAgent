...
@Data
public class Idea199521Config {
    private String name = "idea_199521";
 ...
 */
@Slf4j
public class Idea199521Service {
    private static final int IDEA_ID = 199521;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199521Service() {
        this(new Idea199521Config());
    }

    public Idea199521Service(Idea199521Config config) {
        this.config = config != null ? config : new Idea199521Config();
