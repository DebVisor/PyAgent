...
@Data
public class Idea199965Config {
    private String name = "idea_199965";
 ...
 */
@Slf4j
public class Idea199965Service {
    private static final int IDEA_ID = 199965;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199965Service() {
        this(new Idea199965Config());
    }

    public Idea199965Service(Idea199965Config config) {
        this.config = config != null ? config : new Idea199965Config();
