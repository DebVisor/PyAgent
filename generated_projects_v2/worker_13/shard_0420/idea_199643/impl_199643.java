...
@Data
public class Idea199643Config {
    private String name = "idea_199643";
 ...
 */
@Slf4j
public class Idea199643Service {
    private static final int IDEA_ID = 199643;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199643Service() {
        this(new Idea199643Config());
    }

    public Idea199643Service(Idea199643Config config) {
        this.config = config != null ? config : new Idea199643Config();
