...
@Data
public class Idea199609Config {
    private String name = "idea_199609";
 ...
 */
@Slf4j
public class Idea199609Service {
    private static final int IDEA_ID = 199609;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199609Service() {
        this(new Idea199609Config());
    }

    public Idea199609Service(Idea199609Config config) {
        this.config = config != null ? config : new Idea199609Config();
