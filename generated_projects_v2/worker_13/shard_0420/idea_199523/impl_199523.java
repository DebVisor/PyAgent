...
@Data
public class Idea199523Config {
    private String name = "idea_199523";
 ...
 */
@Slf4j
public class Idea199523Service {
    private static final int IDEA_ID = 199523;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199523Service() {
        this(new Idea199523Config());
    }

    public Idea199523Service(Idea199523Config config) {
        this.config = config != null ? config : new Idea199523Config();
