...
@Data
public class Idea199572Config {
    private String name = "idea_199572";
 ...
 */
@Slf4j
public class Idea199572Service {
    private static final int IDEA_ID = 199572;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199572Service() {
        this(new Idea199572Config());
    }

    public Idea199572Service(Idea199572Config config) {
        this.config = config != null ? config : new Idea199572Config();
