...
@Data
public class Idea199618Config {
    private String name = "idea_199618";
 ...
 */
@Slf4j
public class Idea199618Service {
    private static final int IDEA_ID = 199618;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199618Service() {
        this(new Idea199618Config());
    }

    public Idea199618Service(Idea199618Config config) {
        this.config = config != null ? config : new Idea199618Config();
