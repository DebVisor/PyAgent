...
@Data
public class Idea199622Config {
    private String name = "idea_199622";
 ...
 */
@Slf4j
public class Idea199622Service {
    private static final int IDEA_ID = 199622;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199622Service() {
        this(new Idea199622Config());
    }

    public Idea199622Service(Idea199622Config config) {
        this.config = config != null ? config : new Idea199622Config();
