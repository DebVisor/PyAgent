...
@Data
public class Idea199538Config {
    private String name = "idea_199538";
 ...
 */
@Slf4j
public class Idea199538Service {
    private static final int IDEA_ID = 199538;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199538Service() {
        this(new Idea199538Config());
    }

    public Idea199538Service(Idea199538Config config) {
        this.config = config != null ? config : new Idea199538Config();
