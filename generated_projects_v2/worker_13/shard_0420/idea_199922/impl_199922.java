...
@Data
public class Idea199922Config {
    private String name = "idea_199922";
 ...
 */
@Slf4j
public class Idea199922Service {
    private static final int IDEA_ID = 199922;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199922Service() {
        this(new Idea199922Config());
    }

    public Idea199922Service(Idea199922Config config) {
        this.config = config != null ? config : new Idea199922Config();
