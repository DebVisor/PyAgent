...
@Data
public class Idea199600Config {
    private String name = "idea_199600";
 ...
 */
@Slf4j
public class Idea199600Service {
    private static final int IDEA_ID = 199600;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199600Service() {
        this(new Idea199600Config());
    }

    public Idea199600Service(Idea199600Config config) {
        this.config = config != null ? config : new Idea199600Config();
