...
@Data
public class Idea199674Config {
    private String name = "idea_199674";
 ...
 */
@Slf4j
public class Idea199674Service {
    private static final int IDEA_ID = 199674;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199674Service() {
        this(new Idea199674Config());
    }

    public Idea199674Service(Idea199674Config config) {
        this.config = config != null ? config : new Idea199674Config();
