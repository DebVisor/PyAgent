...
@Data
public class Idea199669Config {
    private String name = "idea_199669";
 ...
 */
@Slf4j
public class Idea199669Service {
    private static final int IDEA_ID = 199669;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199669Service() {
        this(new Idea199669Config());
    }

    public Idea199669Service(Idea199669Config config) {
        this.config = config != null ? config : new Idea199669Config();
