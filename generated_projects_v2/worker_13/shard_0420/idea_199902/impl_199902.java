...
@Data
public class Idea199902Config {
    private String name = "idea_199902";
 ...
 */
@Slf4j
public class Idea199902Service {
    private static final int IDEA_ID = 199902;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199902Service() {
        this(new Idea199902Config());
    }

    public Idea199902Service(Idea199902Config config) {
        this.config = config != null ? config : new Idea199902Config();
