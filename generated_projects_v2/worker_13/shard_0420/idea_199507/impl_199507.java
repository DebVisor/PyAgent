...
@Data
public class Idea199507Config {
    private String name = "idea_199507";
 ...
 */
@Slf4j
public class Idea199507Service {
    private static final int IDEA_ID = 199507;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199507Service() {
        this(new Idea199507Config());
    }

    public Idea199507Service(Idea199507Config config) {
        this.config = config != null ? config : new Idea199507Config();
