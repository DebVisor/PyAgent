...
@Data
public class Idea199606Config {
    private String name = "idea_199606";
 ...
 */
@Slf4j
public class Idea199606Service {
    private static final int IDEA_ID = 199606;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199606Service() {
        this(new Idea199606Config());
    }

    public Idea199606Service(Idea199606Config config) {
        this.config = config != null ? config : new Idea199606Config();
