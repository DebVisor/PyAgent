...
@Data
public class Idea199731Config {
    private String name = "idea_199731";
 ...
 */
@Slf4j
public class Idea199731Service {
    private static final int IDEA_ID = 199731;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199731Service() {
        this(new Idea199731Config());
    }

    public Idea199731Service(Idea199731Config config) {
        this.config = config != null ? config : new Idea199731Config();
