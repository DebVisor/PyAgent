...
@Data
public class Idea199767Config {
    private String name = "idea_199767";
 ...
 */
@Slf4j
public class Idea199767Service {
    private static final int IDEA_ID = 199767;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199767Service() {
        this(new Idea199767Config());
    }

    public Idea199767Service(Idea199767Config config) {
        this.config = config != null ? config : new Idea199767Config();
