...
@Data
public class Idea199548Config {
    private String name = "idea_199548";
 ...
 */
@Slf4j
public class Idea199548Service {
    private static final int IDEA_ID = 199548;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199548Service() {
        this(new Idea199548Config());
    }

    public Idea199548Service(Idea199548Config config) {
        this.config = config != null ? config : new Idea199548Config();
