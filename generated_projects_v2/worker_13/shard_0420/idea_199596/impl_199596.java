...
@Data
public class Idea199596Config {
    private String name = "idea_199596";
 ...
 */
@Slf4j
public class Idea199596Service {
    private static final int IDEA_ID = 199596;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199596Service() {
        this(new Idea199596Config());
    }

    public Idea199596Service(Idea199596Config config) {
        this.config = config != null ? config : new Idea199596Config();
