...
@Data
public class Idea199821Config {
    private String name = "idea_199821";
 ...
 */
@Slf4j
public class Idea199821Service {
    private static final int IDEA_ID = 199821;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199821Service() {
        this(new Idea199821Config());
    }

    public Idea199821Service(Idea199821Config config) {
        this.config = config != null ? config : new Idea199821Config();
