...
@Data
public class Idea199540Config {
    private String name = "idea_199540";
 ...
 */
@Slf4j
public class Idea199540Service {
    private static final int IDEA_ID = 199540;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199540Service() {
        this(new Idea199540Config());
    }

    public Idea199540Service(Idea199540Config config) {
        this.config = config != null ? config : new Idea199540Config();
