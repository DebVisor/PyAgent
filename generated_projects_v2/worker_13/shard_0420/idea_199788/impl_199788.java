...
@Data
public class Idea199788Config {
    private String name = "idea_199788";
 ...
 */
@Slf4j
public class Idea199788Service {
    private static final int IDEA_ID = 199788;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199788Service() {
        this(new Idea199788Config());
    }

    public Idea199788Service(Idea199788Config config) {
        this.config = config != null ? config : new Idea199788Config();
