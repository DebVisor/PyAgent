...
@Data
public class Idea199938Config {
    private String name = "idea_199938";
 ...
 */
@Slf4j
public class Idea199938Service {
    private static final int IDEA_ID = 199938;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199938Service() {
        this(new Idea199938Config());
    }

    public Idea199938Service(Idea199938Config config) {
        this.config = config != null ? config : new Idea199938Config();
