...
@Data
public class Idea199948Config {
    private String name = "idea_199948";
 ...
 */
@Slf4j
public class Idea199948Service {
    private static final int IDEA_ID = 199948;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199948Service() {
        this(new Idea199948Config());
    }

    public Idea199948Service(Idea199948Config config) {
        this.config = config != null ? config : new Idea199948Config();
