...
@Data
public class Idea199882Config {
    private String name = "idea_199882";
 ...
 */
@Slf4j
public class Idea199882Service {
    private static final int IDEA_ID = 199882;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199882Service() {
        this(new Idea199882Config());
    }

    public Idea199882Service(Idea199882Config config) {
        this.config = config != null ? config : new Idea199882Config();
