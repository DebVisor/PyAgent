...
@Data
public class Idea199866Config {
    private String name = "idea_199866";
 ...
 */
@Slf4j
public class Idea199866Service {
    private static final int IDEA_ID = 199866;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199866Service() {
        this(new Idea199866Config());
    }

    public Idea199866Service(Idea199866Config config) {
        this.config = config != null ? config : new Idea199866Config();
