...
@Data
public class Idea199907Config {
    private String name = "idea_199907";
 ...
 */
@Slf4j
public class Idea199907Service {
    private static final int IDEA_ID = 199907;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199907Service() {
        this(new Idea199907Config());
    }

    public Idea199907Service(Idea199907Config config) {
        this.config = config != null ? config : new Idea199907Config();
