...
@Data
public class Idea199604Config {
    private String name = "idea_199604";
 ...
 */
@Slf4j
public class Idea199604Service {
    private static final int IDEA_ID = 199604;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199604Service() {
        this(new Idea199604Config());
    }

    public Idea199604Service(Idea199604Config config) {
        this.config = config != null ? config : new Idea199604Config();
