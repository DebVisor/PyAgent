...
@Data
public class Idea199601Config {
    private String name = "idea_199601";
 ...
 */
@Slf4j
public class Idea199601Service {
    private static final int IDEA_ID = 199601;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199601Service() {
        this(new Idea199601Config());
    }

    public Idea199601Service(Idea199601Config config) {
        this.config = config != null ? config : new Idea199601Config();
