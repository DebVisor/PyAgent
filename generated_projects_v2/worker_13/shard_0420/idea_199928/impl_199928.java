...
@Data
public class Idea199928Config {
    private String name = "idea_199928";
 ...
 */
@Slf4j
public class Idea199928Service {
    private static final int IDEA_ID = 199928;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199928Service() {
        this(new Idea199928Config());
    }

    public Idea199928Service(Idea199928Config config) {
        this.config = config != null ? config : new Idea199928Config();
