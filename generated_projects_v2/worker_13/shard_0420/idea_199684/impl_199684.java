...
@Data
public class Idea199684Config {
    private String name = "idea_199684";
 ...
 */
@Slf4j
public class Idea199684Service {
    private static final int IDEA_ID = 199684;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199684Service() {
        this(new Idea199684Config());
    }

    public Idea199684Service(Idea199684Config config) {
        this.config = config != null ? config : new Idea199684Config();
