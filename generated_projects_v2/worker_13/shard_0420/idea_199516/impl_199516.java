...
@Data
public class Idea199516Config {
    private String name = "idea_199516";
 ...
 */
@Slf4j
public class Idea199516Service {
    private static final int IDEA_ID = 199516;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199516Service() {
        this(new Idea199516Config());
    }

    public Idea199516Service(Idea199516Config config) {
        this.config = config != null ? config : new Idea199516Config();
