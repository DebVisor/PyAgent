...
@Data
public class Idea199647Config {
    private String name = "idea_199647";
 ...
 */
@Slf4j
public class Idea199647Service {
    private static final int IDEA_ID = 199647;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199647Service() {
        this(new Idea199647Config());
    }

    public Idea199647Service(Idea199647Config config) {
        this.config = config != null ? config : new Idea199647Config();
