...
@Data
public class Idea199771Config {
    private String name = "idea_199771";
 ...
 */
@Slf4j
public class Idea199771Service {
    private static final int IDEA_ID = 199771;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199771Service() {
        this(new Idea199771Config());
    }

    public Idea199771Service(Idea199771Config config) {
        this.config = config != null ? config : new Idea199771Config();
