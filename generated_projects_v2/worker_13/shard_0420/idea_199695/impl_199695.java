...
@Data
public class Idea199695Config {
    private String name = "idea_199695";
 ...
 */
@Slf4j
public class Idea199695Service {
    private static final int IDEA_ID = 199695;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199695Service() {
        this(new Idea199695Config());
    }

    public Idea199695Service(Idea199695Config config) {
        this.config = config != null ? config : new Idea199695Config();
