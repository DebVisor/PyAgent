...
@Data
public class Idea199703Config {
    private String name = "idea_199703";
 ...
 */
@Slf4j
public class Idea199703Service {
    private static final int IDEA_ID = 199703;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199703Service() {
        this(new Idea199703Config());
    }

    public Idea199703Service(Idea199703Config config) {
        this.config = config != null ? config : new Idea199703Config();
