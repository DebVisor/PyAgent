...
@Data
public class Idea199506Config {
    private String name = "idea_199506";
 ...
 */
@Slf4j
public class Idea199506Service {
    private static final int IDEA_ID = 199506;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199506Service() {
        this(new Idea199506Config());
    }

    public Idea199506Service(Idea199506Config config) {
        this.config = config != null ? config : new Idea199506Config();
