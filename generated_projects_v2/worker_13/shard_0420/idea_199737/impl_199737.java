...
@Data
public class Idea199737Config {
    private String name = "idea_199737";
 ...
 */
@Slf4j
public class Idea199737Service {
    private static final int IDEA_ID = 199737;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199737Service() {
        this(new Idea199737Config());
    }

    public Idea199737Service(Idea199737Config config) {
        this.config = config != null ? config : new Idea199737Config();
