...
@Data
public class Idea199616Config {
    private String name = "idea_199616";
 ...
 */
@Slf4j
public class Idea199616Service {
    private static final int IDEA_ID = 199616;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199616Service() {
        this(new Idea199616Config());
    }

    public Idea199616Service(Idea199616Config config) {
        this.config = config != null ? config : new Idea199616Config();
