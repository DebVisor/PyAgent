...
@Data
public class Idea199925Config {
    private String name = "idea_199925";
 ...
 */
@Slf4j
public class Idea199925Service {
    private static final int IDEA_ID = 199925;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199925Service() {
        this(new Idea199925Config());
    }

    public Idea199925Service(Idea199925Config config) {
        this.config = config != null ? config : new Idea199925Config();
