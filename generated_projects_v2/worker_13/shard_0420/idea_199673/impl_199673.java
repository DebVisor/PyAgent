...
@Data
public class Idea199673Config {
    private String name = "idea_199673";
 ...
 */
@Slf4j
public class Idea199673Service {
    private static final int IDEA_ID = 199673;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199673Service() {
        this(new Idea199673Config());
    }

    public Idea199673Service(Idea199673Config config) {
        this.config = config != null ? config : new Idea199673Config();
