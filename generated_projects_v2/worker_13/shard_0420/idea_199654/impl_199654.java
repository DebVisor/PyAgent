...
@Data
public class Idea199654Config {
    private String name = "idea_199654";
 ...
 */
@Slf4j
public class Idea199654Service {
    private static final int IDEA_ID = 199654;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199654Service() {
        this(new Idea199654Config());
    }

    public Idea199654Service(Idea199654Config config) {
        this.config = config != null ? config : new Idea199654Config();
