...
@Data
public class Idea199873Config {
    private String name = "idea_199873";
 ...
 */
@Slf4j
public class Idea199873Service {
    private static final int IDEA_ID = 199873;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199873Service() {
        this(new Idea199873Config());
    }

    public Idea199873Service(Idea199873Config config) {
        this.config = config != null ? config : new Idea199873Config();
