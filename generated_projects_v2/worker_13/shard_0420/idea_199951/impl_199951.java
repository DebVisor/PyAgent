...
@Data
public class Idea199951Config {
    private String name = "idea_199951";
 ...
 */
@Slf4j
public class Idea199951Service {
    private static final int IDEA_ID = 199951;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199951Service() {
        this(new Idea199951Config());
    }

    public Idea199951Service(Idea199951Config config) {
        this.config = config != null ? config : new Idea199951Config();
