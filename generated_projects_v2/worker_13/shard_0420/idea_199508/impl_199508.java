...
@Data
public class Idea199508Config {
    private String name = "idea_199508";
 ...
 */
@Slf4j
public class Idea199508Service {
    private static final int IDEA_ID = 199508;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199508Service() {
        this(new Idea199508Config());
    }

    public Idea199508Service(Idea199508Config config) {
        this.config = config != null ? config : new Idea199508Config();
