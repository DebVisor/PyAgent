...
@Data
public class Idea199903Config {
    private String name = "idea_199903";
 ...
 */
@Slf4j
public class Idea199903Service {
    private static final int IDEA_ID = 199903;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199903Service() {
        this(new Idea199903Config());
    }

    public Idea199903Service(Idea199903Config config) {
        this.config = config != null ? config : new Idea199903Config();
