...
@Data
public class Idea199729Config {
    private String name = "idea_199729";
 ...
 */
@Slf4j
public class Idea199729Service {
    private static final int IDEA_ID = 199729;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199729Service() {
        this(new Idea199729Config());
    }

    public Idea199729Service(Idea199729Config config) {
        this.config = config != null ? config : new Idea199729Config();
