...
@Data
public class Idea199670Config {
    private String name = "idea_199670";
 ...
 */
@Slf4j
public class Idea199670Service {
    private static final int IDEA_ID = 199670;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199670Service() {
        this(new Idea199670Config());
    }

    public Idea199670Service(Idea199670Config config) {
        this.config = config != null ? config : new Idea199670Config();
