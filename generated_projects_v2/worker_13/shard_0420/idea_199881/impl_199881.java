...
@Data
public class Idea199881Config {
    private String name = "idea_199881";
 ...
 */
@Slf4j
public class Idea199881Service {
    private static final int IDEA_ID = 199881;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199881Service() {
        this(new Idea199881Config());
    }

    public Idea199881Service(Idea199881Config config) {
        this.config = config != null ? config : new Idea199881Config();
