...
@Data
public class Idea199623Config {
    private String name = "idea_199623";
 ...
 */
@Slf4j
public class Idea199623Service {
    private static final int IDEA_ID = 199623;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199623Service() {
        this(new Idea199623Config());
    }

    public Idea199623Service(Idea199623Config config) {
        this.config = config != null ? config : new Idea199623Config();
