...
@Data
public class Idea199748Config {
    private String name = "idea_199748";
 ...
 */
@Slf4j
public class Idea199748Service {
    private static final int IDEA_ID = 199748;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199748Service() {
        this(new Idea199748Config());
    }

    public Idea199748Service(Idea199748Config config) {
        this.config = config != null ? config : new Idea199748Config();
