...
@Data
public class Idea199637Config {
    private String name = "idea_199637";
 ...
 */
@Slf4j
public class Idea199637Service {
    private static final int IDEA_ID = 199637;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199637Service() {
        this(new Idea199637Config());
    }

    public Idea199637Service(Idea199637Config config) {
        this.config = config != null ? config : new Idea199637Config();
