...
@Data
public class Idea199621Config {
    private String name = "idea_199621";
 ...
 */
@Slf4j
public class Idea199621Service {
    private static final int IDEA_ID = 199621;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199621Service() {
        this(new Idea199621Config());
    }

    public Idea199621Service(Idea199621Config config) {
        this.config = config != null ? config : new Idea199621Config();
