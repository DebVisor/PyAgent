...
@Data
public class Idea199778Config {
    private String name = "idea_199778";
 ...
 */
@Slf4j
public class Idea199778Service {
    private static final int IDEA_ID = 199778;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199778Service() {
        this(new Idea199778Config());
    }

    public Idea199778Service(Idea199778Config config) {
        this.config = config != null ? config : new Idea199778Config();
