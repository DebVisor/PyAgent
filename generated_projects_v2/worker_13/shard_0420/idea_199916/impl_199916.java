...
@Data
public class Idea199916Config {
    private String name = "idea_199916";
 ...
 */
@Slf4j
public class Idea199916Service {
    private static final int IDEA_ID = 199916;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199916Service() {
        this(new Idea199916Config());
    }

    public Idea199916Service(Idea199916Config config) {
        this.config = config != null ? config : new Idea199916Config();
