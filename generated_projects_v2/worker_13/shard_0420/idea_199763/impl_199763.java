...
@Data
public class Idea199763Config {
    private String name = "idea_199763";
 ...
 */
@Slf4j
public class Idea199763Service {
    private static final int IDEA_ID = 199763;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199763Service() {
        this(new Idea199763Config());
    }

    public Idea199763Service(Idea199763Config config) {
        this.config = config != null ? config : new Idea199763Config();
