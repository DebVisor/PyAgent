...
@Data
public class Idea199730Config {
    private String name = "idea_199730";
 ...
 */
@Slf4j
public class Idea199730Service {
    private static final int IDEA_ID = 199730;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199730Service() {
        this(new Idea199730Config());
    }

    public Idea199730Service(Idea199730Config config) {
        this.config = config != null ? config : new Idea199730Config();
