...
@Data
public class Idea199958Config {
    private String name = "idea_199958";
 ...
 */
@Slf4j
public class Idea199958Service {
    private static final int IDEA_ID = 199958;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199958Service() {
        this(new Idea199958Config());
    }

    public Idea199958Service(Idea199958Config config) {
        this.config = config != null ? config : new Idea199958Config();
