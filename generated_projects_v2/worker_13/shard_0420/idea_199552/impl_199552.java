...
@Data
public class Idea199552Config {
    private String name = "idea_199552";
 ...
 */
@Slf4j
public class Idea199552Service {
    private static final int IDEA_ID = 199552;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199552Service() {
        this(new Idea199552Config());
    }

    public Idea199552Service(Idea199552Config config) {
        this.config = config != null ? config : new Idea199552Config();
