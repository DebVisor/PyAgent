...
@Data
public class Idea199562Config {
    private String name = "idea_199562";
 ...
 */
@Slf4j
public class Idea199562Service {
    private static final int IDEA_ID = 199562;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199562Service() {
        this(new Idea199562Config());
    }

    public Idea199562Service(Idea199562Config config) {
        this.config = config != null ? config : new Idea199562Config();
