...
@Data
public class Idea199529Config {
    private String name = "idea_199529";
 ...
 */
@Slf4j
public class Idea199529Service {
    private static final int IDEA_ID = 199529;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199529Service() {
        this(new Idea199529Config());
    }

    public Idea199529Service(Idea199529Config config) {
        this.config = config != null ? config : new Idea199529Config();
