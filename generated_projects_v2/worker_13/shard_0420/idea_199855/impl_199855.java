...
@Data
public class Idea199855Config {
    private String name = "idea_199855";
 ...
 */
@Slf4j
public class Idea199855Service {
    private static final int IDEA_ID = 199855;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199855Service() {
        this(new Idea199855Config());
    }

    public Idea199855Service(Idea199855Config config) {
        this.config = config != null ? config : new Idea199855Config();
