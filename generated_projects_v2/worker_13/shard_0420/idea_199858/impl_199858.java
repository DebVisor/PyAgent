...
@Data
public class Idea199858Config {
    private String name = "idea_199858";
 ...
 */
@Slf4j
public class Idea199858Service {
    private static final int IDEA_ID = 199858;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199858Service() {
        this(new Idea199858Config());
    }

    public Idea199858Service(Idea199858Config config) {
        this.config = config != null ? config : new Idea199858Config();
