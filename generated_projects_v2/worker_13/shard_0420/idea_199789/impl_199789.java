...
@Data
public class Idea199789Config {
    private String name = "idea_199789";
 ...
 */
@Slf4j
public class Idea199789Service {
    private static final int IDEA_ID = 199789;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199789Service() {
        this(new Idea199789Config());
    }

    public Idea199789Service(Idea199789Config config) {
        this.config = config != null ? config : new Idea199789Config();
