...
@Data
public class Idea199667Config {
    private String name = "idea_199667";
 ...
 */
@Slf4j
public class Idea199667Service {
    private static final int IDEA_ID = 199667;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199667Service() {
        this(new Idea199667Config());
    }

    public Idea199667Service(Idea199667Config config) {
        this.config = config != null ? config : new Idea199667Config();
