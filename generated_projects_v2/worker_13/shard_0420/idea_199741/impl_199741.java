...
@Data
public class Idea199741Config {
    private String name = "idea_199741";
 ...
 */
@Slf4j
public class Idea199741Service {
    private static final int IDEA_ID = 199741;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199741Service() {
        this(new Idea199741Config());
    }

    public Idea199741Service(Idea199741Config config) {
        this.config = config != null ? config : new Idea199741Config();
