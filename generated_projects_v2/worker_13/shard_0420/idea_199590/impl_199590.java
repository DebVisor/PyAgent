...
@Data
public class Idea199590Config {
    private String name = "idea_199590";
 ...
 */
@Slf4j
public class Idea199590Service {
    private static final int IDEA_ID = 199590;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199590Service() {
        this(new Idea199590Config());
    }

    public Idea199590Service(Idea199590Config config) {
        this.config = config != null ? config : new Idea199590Config();
