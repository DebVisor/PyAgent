...
@Data
public class Idea199818Config {
    private String name = "idea_199818";
 ...
 */
@Slf4j
public class Idea199818Service {
    private static final int IDEA_ID = 199818;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199818Service() {
        this(new Idea199818Config());
    }

    public Idea199818Service(Idea199818Config config) {
        this.config = config != null ? config : new Idea199818Config();
