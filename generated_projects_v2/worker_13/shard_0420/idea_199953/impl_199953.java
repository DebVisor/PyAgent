...
@Data
public class Idea199953Config {
    private String name = "idea_199953";
 ...
 */
@Slf4j
public class Idea199953Service {
    private static final int IDEA_ID = 199953;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199953Service() {
        this(new Idea199953Config());
    }

    public Idea199953Service(Idea199953Config config) {
        this.config = config != null ? config : new Idea199953Config();
