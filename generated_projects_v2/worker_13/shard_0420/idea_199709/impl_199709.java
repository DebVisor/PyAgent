...
@Data
public class Idea199709Config {
    private String name = "idea_199709";
 ...
 */
@Slf4j
public class Idea199709Service {
    private static final int IDEA_ID = 199709;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199709Service() {
        this(new Idea199709Config());
    }

    public Idea199709Service(Idea199709Config config) {
        this.config = config != null ? config : new Idea199709Config();
