...
@Data
public class Idea199891Config {
    private String name = "idea_199891";
 ...
 */
@Slf4j
public class Idea199891Service {
    private static final int IDEA_ID = 199891;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199891Service() {
        this(new Idea199891Config());
    }

    public Idea199891Service(Idea199891Config config) {
        this.config = config != null ? config : new Idea199891Config();
