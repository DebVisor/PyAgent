...
@Data
public class Idea199816Config {
    private String name = "idea_199816";
 ...
 */
@Slf4j
public class Idea199816Service {
    private static final int IDEA_ID = 199816;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199816Service() {
        this(new Idea199816Config());
    }

    public Idea199816Service(Idea199816Config config) {
        this.config = config != null ? config : new Idea199816Config();
