...
@Data
public class Idea199930Config {
    private String name = "idea_199930";
 ...
 */
@Slf4j
public class Idea199930Service {
    private static final int IDEA_ID = 199930;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199930Service() {
        this(new Idea199930Config());
    }

    public Idea199930Service(Idea199930Config config) {
        this.config = config != null ? config : new Idea199930Config();
