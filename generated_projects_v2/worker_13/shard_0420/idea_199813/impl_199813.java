...
@Data
public class Idea199813Config {
    private String name = "idea_199813";
 ...
 */
@Slf4j
public class Idea199813Service {
    private static final int IDEA_ID = 199813;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199813Service() {
        this(new Idea199813Config());
    }

    public Idea199813Service(Idea199813Config config) {
        this.config = config != null ? config : new Idea199813Config();
