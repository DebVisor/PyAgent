...
@Data
public class Idea199734Config {
    private String name = "idea_199734";
 ...
 */
@Slf4j
public class Idea199734Service {
    private static final int IDEA_ID = 199734;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199734Service() {
        this(new Idea199734Config());
    }

    public Idea199734Service(Idea199734Config config) {
        this.config = config != null ? config : new Idea199734Config();
