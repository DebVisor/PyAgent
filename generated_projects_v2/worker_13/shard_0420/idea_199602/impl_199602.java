...
@Data
public class Idea199602Config {
    private String name = "idea_199602";
 ...
 */
@Slf4j
public class Idea199602Service {
    private static final int IDEA_ID = 199602;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199602Service() {
        this(new Idea199602Config());
    }

    public Idea199602Service(Idea199602Config config) {
        this.config = config != null ? config : new Idea199602Config();
