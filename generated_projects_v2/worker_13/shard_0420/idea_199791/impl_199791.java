...
@Data
public class Idea199791Config {
    private String name = "idea_199791";
 ...
 */
@Slf4j
public class Idea199791Service {
    private static final int IDEA_ID = 199791;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199791Service() {
        this(new Idea199791Config());
    }

    public Idea199791Service(Idea199791Config config) {
        this.config = config != null ? config : new Idea199791Config();
