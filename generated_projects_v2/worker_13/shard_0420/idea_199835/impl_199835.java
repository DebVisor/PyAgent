...
@Data
public class Idea199835Config {
    private String name = "idea_199835";
 ...
 */
@Slf4j
public class Idea199835Service {
    private static final int IDEA_ID = 199835;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199835Service() {
        this(new Idea199835Config());
    }

    public Idea199835Service(Idea199835Config config) {
        this.config = config != null ? config : new Idea199835Config();
