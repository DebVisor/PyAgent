...
@Data
public class Idea199955Config {
    private String name = "idea_199955";
 ...
 */
@Slf4j
public class Idea199955Service {
    private static final int IDEA_ID = 199955;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199955Service() {
        this(new Idea199955Config());
    }

    public Idea199955Service(Idea199955Config config) {
        this.config = config != null ? config : new Idea199955Config();
