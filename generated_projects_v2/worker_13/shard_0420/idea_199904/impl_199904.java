...
@Data
public class Idea199904Config {
    private String name = "idea_199904";
 ...
 */
@Slf4j
public class Idea199904Service {
    private static final int IDEA_ID = 199904;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199904Service() {
        this(new Idea199904Config());
    }

    public Idea199904Service(Idea199904Config config) {
        this.config = config != null ? config : new Idea199904Config();
