...
@Data
public class Idea199724Config {
    private String name = "idea_199724";
 ...
 */
@Slf4j
public class Idea199724Service {
    private static final int IDEA_ID = 199724;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199724Service() {
        this(new Idea199724Config());
    }

    public Idea199724Service(Idea199724Config config) {
        this.config = config != null ? config : new Idea199724Config();
