...
@Data
public class Idea199831Config {
    private String name = "idea_199831";
 ...
 */
@Slf4j
public class Idea199831Service {
    private static final int IDEA_ID = 199831;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199831Service() {
        this(new Idea199831Config());
    }

    public Idea199831Service(Idea199831Config config) {
        this.config = config != null ? config : new Idea199831Config();
