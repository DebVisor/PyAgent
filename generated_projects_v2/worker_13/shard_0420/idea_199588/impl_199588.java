...
@Data
public class Idea199588Config {
    private String name = "idea_199588";
 ...
 */
@Slf4j
public class Idea199588Service {
    private static final int IDEA_ID = 199588;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199588Service() {
        this(new Idea199588Config());
    }

    public Idea199588Service(Idea199588Config config) {
        this.config = config != null ? config : new Idea199588Config();
