...
@Data
public class Idea199950Config {
    private String name = "idea_199950";
 ...
 */
@Slf4j
public class Idea199950Service {
    private static final int IDEA_ID = 199950;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199950Service() {
        this(new Idea199950Config());
    }

    public Idea199950Service(Idea199950Config config) {
        this.config = config != null ? config : new Idea199950Config();
