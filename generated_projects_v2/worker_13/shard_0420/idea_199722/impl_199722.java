...
@Data
public class Idea199722Config {
    private String name = "idea_199722";
 ...
 */
@Slf4j
public class Idea199722Service {
    private static final int IDEA_ID = 199722;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199722Service() {
        this(new Idea199722Config());
    }

    public Idea199722Service(Idea199722Config config) {
        this.config = config != null ? config : new Idea199722Config();
