...
@Data
public class Idea199773Config {
    private String name = "idea_199773";
 ...
 */
@Slf4j
public class Idea199773Service {
    private static final int IDEA_ID = 199773;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199773Service() {
        this(new Idea199773Config());
    }

    public Idea199773Service(Idea199773Config config) {
        this.config = config != null ? config : new Idea199773Config();
