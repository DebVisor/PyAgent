...
@Data
public class Idea199856Config {
    private String name = "idea_199856";
 ...
 */
@Slf4j
public class Idea199856Service {
    private static final int IDEA_ID = 199856;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199856Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199856Service() {
        this(new Idea199856Config());
    }

    public Idea199856Service(Idea199856Config config) {
        this.config = config != null ? config : new Idea199856Config();
