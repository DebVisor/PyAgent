...
@Data
public class Idea199639Config {
    private String name = "idea_199639";
 ...
 */
@Slf4j
public class Idea199639Service {
    private static final int IDEA_ID = 199639;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199639Service() {
        this(new Idea199639Config());
    }

    public Idea199639Service(Idea199639Config config) {
        this.config = config != null ? config : new Idea199639Config();
