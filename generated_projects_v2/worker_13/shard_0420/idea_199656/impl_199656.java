...
@Data
public class Idea199656Config {
    private String name = "idea_199656";
 ...
 */
@Slf4j
public class Idea199656Service {
    private static final int IDEA_ID = 199656;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199656Service() {
        this(new Idea199656Config());
    }

    public Idea199656Service(Idea199656Config config) {
        this.config = config != null ? config : new Idea199656Config();
