...
@Data
public class Idea199833Config {
    private String name = "idea_199833";
 ...
 */
@Slf4j
public class Idea199833Service {
    private static final int IDEA_ID = 199833;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199833Service() {
        this(new Idea199833Config());
    }

    public Idea199833Service(Idea199833Config config) {
        this.config = config != null ? config : new Idea199833Config();
