...
@Data
public class Idea199775Config {
    private String name = "idea_199775";
 ...
 */
@Slf4j
public class Idea199775Service {
    private static final int IDEA_ID = 199775;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199775Service() {
        this(new Idea199775Config());
    }

    public Idea199775Service(Idea199775Config config) {
        this.config = config != null ? config : new Idea199775Config();
