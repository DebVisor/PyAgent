...
@Data
public class Idea199936Config {
    private String name = "idea_199936";
 ...
 */
@Slf4j
public class Idea199936Service {
    private static final int IDEA_ID = 199936;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199936Service() {
        this(new Idea199936Config());
    }

    public Idea199936Service(Idea199936Config config) {
        this.config = config != null ? config : new Idea199936Config();
