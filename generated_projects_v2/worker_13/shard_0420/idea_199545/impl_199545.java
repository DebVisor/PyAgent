...
@Data
public class Idea199545Config {
    private String name = "idea_199545";
 ...
 */
@Slf4j
public class Idea199545Service {
    private static final int IDEA_ID = 199545;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199545Service() {
        this(new Idea199545Config());
    }

    public Idea199545Service(Idea199545Config config) {
        this.config = config != null ? config : new Idea199545Config();
