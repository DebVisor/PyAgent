...
@Data
public class Idea199887Config {
    private String name = "idea_199887";
 ...
 */
@Slf4j
public class Idea199887Service {
    private static final int IDEA_ID = 199887;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199887Service() {
        this(new Idea199887Config());
    }

    public Idea199887Service(Idea199887Config config) {
        this.config = config != null ? config : new Idea199887Config();
