...
@Data
public class Idea199814Config {
    private String name = "idea_199814";
 ...
 */
@Slf4j
public class Idea199814Service {
    private static final int IDEA_ID = 199814;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199814Service() {
        this(new Idea199814Config());
    }

    public Idea199814Service(Idea199814Config config) {
        this.config = config != null ? config : new Idea199814Config();
