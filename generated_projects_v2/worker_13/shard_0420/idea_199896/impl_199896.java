...
@Data
public class Idea199896Config {
    private String name = "idea_199896";
 ...
 */
@Slf4j
public class Idea199896Service {
    private static final int IDEA_ID = 199896;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199896Service() {
        this(new Idea199896Config());
    }

    public Idea199896Service(Idea199896Config config) {
        this.config = config != null ? config : new Idea199896Config();
