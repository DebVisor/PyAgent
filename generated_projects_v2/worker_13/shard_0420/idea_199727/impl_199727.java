...
@Data
public class Idea199727Config {
    private String name = "idea_199727";
 ...
 */
@Slf4j
public class Idea199727Service {
    private static final int IDEA_ID = 199727;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199727Service() {
        this(new Idea199727Config());
    }

    public Idea199727Service(Idea199727Config config) {
        this.config = config != null ? config : new Idea199727Config();
