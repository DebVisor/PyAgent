...
@Data
public class Idea199830Config {
    private String name = "idea_199830";
 ...
 */
@Slf4j
public class Idea199830Service {
    private static final int IDEA_ID = 199830;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199830Service() {
        this(new Idea199830Config());
    }

    public Idea199830Service(Idea199830Config config) {
        this.config = config != null ? config : new Idea199830Config();
