...
@Data
public class Idea199569Config {
    private String name = "idea_199569";
 ...
 */
@Slf4j
public class Idea199569Service {
    private static final int IDEA_ID = 199569;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199569Service() {
        this(new Idea199569Config());
    }

    public Idea199569Service(Idea199569Config config) {
        this.config = config != null ? config : new Idea199569Config();
