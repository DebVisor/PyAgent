...
@Data
public class Idea199939Config {
    private String name = "idea_199939";
 ...
 */
@Slf4j
public class Idea199939Service {
    private static final int IDEA_ID = 199939;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199939Service() {
        this(new Idea199939Config());
    }

    public Idea199939Service(Idea199939Config config) {
        this.config = config != null ? config : new Idea199939Config();
