...
@Data
public class Idea199638Config {
    private String name = "idea_199638";
 ...
 */
@Slf4j
public class Idea199638Service {
    private static final int IDEA_ID = 199638;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199638Service() {
        this(new Idea199638Config());
    }

    public Idea199638Service(Idea199638Config config) {
        this.config = config != null ? config : new Idea199638Config();
