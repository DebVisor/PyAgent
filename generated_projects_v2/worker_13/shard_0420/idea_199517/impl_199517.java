...
@Data
public class Idea199517Config {
    private String name = "idea_199517";
 ...
 */
@Slf4j
public class Idea199517Service {
    private static final int IDEA_ID = 199517;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199517Service() {
        this(new Idea199517Config());
    }

    public Idea199517Service(Idea199517Config config) {
        this.config = config != null ? config : new Idea199517Config();
