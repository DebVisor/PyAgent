...
@Data
public class Idea199817Config {
    private String name = "idea_199817";
 ...
 */
@Slf4j
public class Idea199817Service {
    private static final int IDEA_ID = 199817;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199817Service() {
        this(new Idea199817Config());
    }

    public Idea199817Service(Idea199817Config config) {
        this.config = config != null ? config : new Idea199817Config();
