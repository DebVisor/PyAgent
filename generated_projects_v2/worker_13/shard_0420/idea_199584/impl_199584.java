...
@Data
public class Idea199584Config {
    private String name = "idea_199584";
 ...
 */
@Slf4j
public class Idea199584Service {
    private static final int IDEA_ID = 199584;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199584Service() {
        this(new Idea199584Config());
    }

    public Idea199584Service(Idea199584Config config) {
        this.config = config != null ? config : new Idea199584Config();
