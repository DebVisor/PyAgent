...
@Data
public class Idea199740Config {
    private String name = "idea_199740";
 ...
 */
@Slf4j
public class Idea199740Service {
    private static final int IDEA_ID = 199740;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199740Service() {
        this(new Idea199740Config());
    }

    public Idea199740Service(Idea199740Config config) {
        this.config = config != null ? config : new Idea199740Config();
