...
@Data
public class Idea199781Config {
    private String name = "idea_199781";
 ...
 */
@Slf4j
public class Idea199781Service {
    private static final int IDEA_ID = 199781;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199781Service() {
        this(new Idea199781Config());
    }

    public Idea199781Service(Idea199781Config config) {
        this.config = config != null ? config : new Idea199781Config();
