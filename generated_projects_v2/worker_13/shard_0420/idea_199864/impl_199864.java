...
@Data
public class Idea199864Config {
    private String name = "idea_199864";
 ...
 */
@Slf4j
public class Idea199864Service {
    private static final int IDEA_ID = 199864;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199864Service() {
        this(new Idea199864Config());
    }

    public Idea199864Service(Idea199864Config config) {
        this.config = config != null ? config : new Idea199864Config();
