...
@Data
public class Idea199974Config {
    private String name = "idea_199974";
 ...
 */
@Slf4j
public class Idea199974Service {
    private static final int IDEA_ID = 199974;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199974Service() {
        this(new Idea199974Config());
    }

    public Idea199974Service(Idea199974Config config) {
        this.config = config != null ? config : new Idea199974Config();
