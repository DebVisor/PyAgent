...
@Data
public class Idea199608Config {
    private String name = "idea_199608";
 ...
 */
@Slf4j
public class Idea199608Service {
    private static final int IDEA_ID = 199608;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199608Service() {
        this(new Idea199608Config());
    }

    public Idea199608Service(Idea199608Config config) {
        this.config = config != null ? config : new Idea199608Config();
