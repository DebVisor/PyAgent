...
@Data
public class Idea199935Config {
    private String name = "idea_199935";
 ...
 */
@Slf4j
public class Idea199935Service {
    private static final int IDEA_ID = 199935;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199935Service() {
        this(new Idea199935Config());
    }

    public Idea199935Service(Idea199935Config config) {
        this.config = config != null ? config : new Idea199935Config();
