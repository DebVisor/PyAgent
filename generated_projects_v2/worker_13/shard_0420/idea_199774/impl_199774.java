...
@Data
public class Idea199774Config {
    private String name = "idea_199774";
 ...
 */
@Slf4j
public class Idea199774Service {
    private static final int IDEA_ID = 199774;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199774Service() {
        this(new Idea199774Config());
    }

    public Idea199774Service(Idea199774Config config) {
        this.config = config != null ? config : new Idea199774Config();
