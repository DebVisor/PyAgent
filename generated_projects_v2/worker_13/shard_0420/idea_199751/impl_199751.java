...
@Data
public class Idea199751Config {
    private String name = "idea_199751";
 ...
 */
@Slf4j
public class Idea199751Service {
    private static final int IDEA_ID = 199751;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199751Service() {
        this(new Idea199751Config());
    }

    public Idea199751Service(Idea199751Config config) {
        this.config = config != null ? config : new Idea199751Config();
