...
@Data
public class Idea199635Config {
    private String name = "idea_199635";
 ...
 */
@Slf4j
public class Idea199635Service {
    private static final int IDEA_ID = 199635;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199635Service() {
        this(new Idea199635Config());
    }

    public Idea199635Service(Idea199635Config config) {
        this.config = config != null ? config : new Idea199635Config();
