...
@Data
public class Idea199715Config {
    private String name = "idea_199715";
 ...
 */
@Slf4j
public class Idea199715Service {
    private static final int IDEA_ID = 199715;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199715Service() {
        this(new Idea199715Config());
    }

    public Idea199715Service(Idea199715Config config) {
        this.config = config != null ? config : new Idea199715Config();
