...
@Data
public class Idea199645Config {
    private String name = "idea_199645";
 ...
 */
@Slf4j
public class Idea199645Service {
    private static final int IDEA_ID = 199645;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199645Service() {
        this(new Idea199645Config());
    }

    public Idea199645Service(Idea199645Config config) {
        this.config = config != null ? config : new Idea199645Config();
