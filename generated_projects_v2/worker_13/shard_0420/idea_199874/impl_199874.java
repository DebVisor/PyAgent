...
@Data
public class Idea199874Config {
    private String name = "idea_199874";
 ...
 */
@Slf4j
public class Idea199874Service {
    private static final int IDEA_ID = 199874;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199874Service() {
        this(new Idea199874Config());
    }

    public Idea199874Service(Idea199874Config config) {
        this.config = config != null ? config : new Idea199874Config();
