...
@Data
public class Idea199848Config {
    private String name = "idea_199848";
 ...
 */
@Slf4j
public class Idea199848Service {
    private static final int IDEA_ID = 199848;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199848Service() {
        this(new Idea199848Config());
    }

    public Idea199848Service(Idea199848Config config) {
        this.config = config != null ? config : new Idea199848Config();
