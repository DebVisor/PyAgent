...
@Data
public class Idea199805Config {
    private String name = "idea_199805";
 ...
 */
@Slf4j
public class Idea199805Service {
    private static final int IDEA_ID = 199805;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199805Service() {
        this(new Idea199805Config());
    }

    public Idea199805Service(Idea199805Config config) {
        this.config = config != null ? config : new Idea199805Config();
