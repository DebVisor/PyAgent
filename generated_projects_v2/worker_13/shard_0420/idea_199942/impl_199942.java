...
@Data
public class Idea199942Config {
    private String name = "idea_199942";
 ...
 */
@Slf4j
public class Idea199942Service {
    private static final int IDEA_ID = 199942;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199942Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199942Service() {
        this(new Idea199942Config());
    }

    public Idea199942Service(Idea199942Config config) {
        this.config = config != null ? config : new Idea199942Config();
