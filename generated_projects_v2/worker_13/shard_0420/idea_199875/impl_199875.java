...
@Data
public class Idea199875Config {
    private String name = "idea_199875";
 ...
 */
@Slf4j
public class Idea199875Service {
    private static final int IDEA_ID = 199875;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199875Service() {
        this(new Idea199875Config());
    }

    public Idea199875Service(Idea199875Config config) {
        this.config = config != null ? config : new Idea199875Config();
