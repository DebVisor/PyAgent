...
@Data
public class Idea199661Config {
    private String name = "idea_199661";
 ...
 */
@Slf4j
public class Idea199661Service {
    private static final int IDEA_ID = 199661;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199661Service() {
        this(new Idea199661Config());
    }

    public Idea199661Service(Idea199661Config config) {
        this.config = config != null ? config : new Idea199661Config();
