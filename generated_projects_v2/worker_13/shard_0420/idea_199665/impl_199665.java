...
@Data
public class Idea199665Config {
    private String name = "idea_199665";
 ...
 */
@Slf4j
public class Idea199665Service {
    private static final int IDEA_ID = 199665;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199665Service() {
        this(new Idea199665Config());
    }

    public Idea199665Service(Idea199665Config config) {
        this.config = config != null ? config : new Idea199665Config();
