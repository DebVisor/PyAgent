...
@Data
public class Idea199838Config {
    private String name = "idea_199838";
 ...
 */
@Slf4j
public class Idea199838Service {
    private static final int IDEA_ID = 199838;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199838Service() {
        this(new Idea199838Config());
    }

    public Idea199838Service(Idea199838Config config) {
        this.config = config != null ? config : new Idea199838Config();
