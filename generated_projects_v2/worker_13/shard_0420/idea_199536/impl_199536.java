...
@Data
public class Idea199536Config {
    private String name = "idea_199536";
 ...
 */
@Slf4j
public class Idea199536Service {
    private static final int IDEA_ID = 199536;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199536Service() {
        this(new Idea199536Config());
    }

    public Idea199536Service(Idea199536Config config) {
        this.config = config != null ? config : new Idea199536Config();
