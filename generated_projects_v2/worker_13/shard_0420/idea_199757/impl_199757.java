...
@Data
public class Idea199757Config {
    private String name = "idea_199757";
 ...
 */
@Slf4j
public class Idea199757Service {
    private static final int IDEA_ID = 199757;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199757Service() {
        this(new Idea199757Config());
    }

    public Idea199757Service(Idea199757Config config) {
        this.config = config != null ? config : new Idea199757Config();
