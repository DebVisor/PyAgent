...
@Data
public class Idea199820Config {
    private String name = "idea_199820";
 ...
 */
@Slf4j
public class Idea199820Service {
    private static final int IDEA_ID = 199820;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199820Service() {
        this(new Idea199820Config());
    }

    public Idea199820Service(Idea199820Config config) {
        this.config = config != null ? config : new Idea199820Config();
