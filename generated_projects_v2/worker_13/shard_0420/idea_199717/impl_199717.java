...
@Data
public class Idea199717Config {
    private String name = "idea_199717";
 ...
 */
@Slf4j
public class Idea199717Service {
    private static final int IDEA_ID = 199717;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199717Service() {
        this(new Idea199717Config());
    }

    public Idea199717Service(Idea199717Config config) {
        this.config = config != null ? config : new Idea199717Config();
