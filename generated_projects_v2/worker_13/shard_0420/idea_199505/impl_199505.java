...
@Data
public class Idea199505Config {
    private String name = "idea_199505";
 ...
 */
@Slf4j
public class Idea199505Service {
    private static final int IDEA_ID = 199505;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199505Service() {
        this(new Idea199505Config());
    }

    public Idea199505Service(Idea199505Config config) {
        this.config = config != null ? config : new Idea199505Config();
