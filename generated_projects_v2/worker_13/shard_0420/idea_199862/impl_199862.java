...
@Data
public class Idea199862Config {
    private String name = "idea_199862";
 ...
 */
@Slf4j
public class Idea199862Service {
    private static final int IDEA_ID = 199862;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199862Service() {
        this(new Idea199862Config());
    }

    public Idea199862Service(Idea199862Config config) {
        this.config = config != null ? config : new Idea199862Config();
