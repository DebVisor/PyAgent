...
@Data
public class Idea199631Config {
    private String name = "idea_199631";
 ...
 */
@Slf4j
public class Idea199631Service {
    private static final int IDEA_ID = 199631;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199631Service() {
        this(new Idea199631Config());
    }

    public Idea199631Service(Idea199631Config config) {
        this.config = config != null ? config : new Idea199631Config();
