...
@Data
public class Idea199630Config {
    private String name = "idea_199630";
 ...
 */
@Slf4j
public class Idea199630Service {
    private static final int IDEA_ID = 199630;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199630Service() {
        this(new Idea199630Config());
    }

    public Idea199630Service(Idea199630Config config) {
        this.config = config != null ? config : new Idea199630Config();
