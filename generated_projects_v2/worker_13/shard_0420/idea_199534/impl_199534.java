...
@Data
public class Idea199534Config {
    private String name = "idea_199534";
 ...
 */
@Slf4j
public class Idea199534Service {
    private static final int IDEA_ID = 199534;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199534Service() {
        this(new Idea199534Config());
    }

    public Idea199534Service(Idea199534Config config) {
        this.config = config != null ? config : new Idea199534Config();
