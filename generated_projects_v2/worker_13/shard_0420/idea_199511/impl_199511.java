...
@Data
public class Idea199511Config {
    private String name = "idea_199511";
 ...
 */
@Slf4j
public class Idea199511Service {
    private static final int IDEA_ID = 199511;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199511Service() {
        this(new Idea199511Config());
    }

    public Idea199511Service(Idea199511Config config) {
        this.config = config != null ? config : new Idea199511Config();
