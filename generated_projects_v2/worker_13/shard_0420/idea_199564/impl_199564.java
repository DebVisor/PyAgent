...
@Data
public class Idea199564Config {
    private String name = "idea_199564";
 ...
 */
@Slf4j
public class Idea199564Service {
    private static final int IDEA_ID = 199564;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199564Service() {
        this(new Idea199564Config());
    }

    public Idea199564Service(Idea199564Config config) {
        this.config = config != null ? config : new Idea199564Config();
