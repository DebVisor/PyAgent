...
@Data
public class Idea199687Config {
    private String name = "idea_199687";
 ...
 */
@Slf4j
public class Idea199687Service {
    private static final int IDEA_ID = 199687;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199687Service() {
        this(new Idea199687Config());
    }

    public Idea199687Service(Idea199687Config config) {
        this.config = config != null ? config : new Idea199687Config();
