...
@Data
public class Idea199744Config {
    private String name = "idea_199744";
 ...
 */
@Slf4j
public class Idea199744Service {
    private static final int IDEA_ID = 199744;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199744Service() {
        this(new Idea199744Config());
    }

    public Idea199744Service(Idea199744Config config) {
        this.config = config != null ? config : new Idea199744Config();
