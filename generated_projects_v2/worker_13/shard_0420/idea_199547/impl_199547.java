...
@Data
public class Idea199547Config {
    private String name = "idea_199547";
 ...
 */
@Slf4j
public class Idea199547Service {
    private static final int IDEA_ID = 199547;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199547Service() {
        this(new Idea199547Config());
    }

    public Idea199547Service(Idea199547Config config) {
        this.config = config != null ? config : new Idea199547Config();
