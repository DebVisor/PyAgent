...
@Data
public class Idea199527Config {
    private String name = "idea_199527";
 ...
 */
@Slf4j
public class Idea199527Service {
    private static final int IDEA_ID = 199527;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199527Service() {
        this(new Idea199527Config());
    }

    public Idea199527Service(Idea199527Config config) {
        this.config = config != null ? config : new Idea199527Config();
