...
@Data
public class Idea199713Config {
    private String name = "idea_199713";
 ...
 */
@Slf4j
public class Idea199713Service {
    private static final int IDEA_ID = 199713;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199713Service() {
        this(new Idea199713Config());
    }

    public Idea199713Service(Idea199713Config config) {
        this.config = config != null ? config : new Idea199713Config();
