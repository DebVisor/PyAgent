...
@Data
public class Idea199657Config {
    private String name = "idea_199657";
 ...
 */
@Slf4j
public class Idea199657Service {
    private static final int IDEA_ID = 199657;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199657Service() {
        this(new Idea199657Config());
    }

    public Idea199657Service(Idea199657Config config) {
        this.config = config != null ? config : new Idea199657Config();
