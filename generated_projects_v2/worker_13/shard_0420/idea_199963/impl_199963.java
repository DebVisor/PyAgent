...
@Data
public class Idea199963Config {
    private String name = "idea_199963";
 ...
 */
@Slf4j
public class Idea199963Service {
    private static final int IDEA_ID = 199963;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199963Service() {
        this(new Idea199963Config());
    }

    public Idea199963Service(Idea199963Config config) {
        this.config = config != null ? config : new Idea199963Config();
