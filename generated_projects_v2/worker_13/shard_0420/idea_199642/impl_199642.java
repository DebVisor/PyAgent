...
@Data
public class Idea199642Config {
    private String name = "idea_199642";
 ...
 */
@Slf4j
public class Idea199642Service {
    private static final int IDEA_ID = 199642;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199642Service() {
        this(new Idea199642Config());
    }

    public Idea199642Service(Idea199642Config config) {
        this.config = config != null ? config : new Idea199642Config();
