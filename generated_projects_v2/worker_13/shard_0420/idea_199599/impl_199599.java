...
@Data
public class Idea199599Config {
    private String name = "idea_199599";
 ...
 */
@Slf4j
public class Idea199599Service {
    private static final int IDEA_ID = 199599;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199599Service() {
        this(new Idea199599Config());
    }

    public Idea199599Service(Idea199599Config config) {
        this.config = config != null ? config : new Idea199599Config();
