...
@Data
public class Idea199885Config {
    private String name = "idea_199885";
 ...
 */
@Slf4j
public class Idea199885Service {
    private static final int IDEA_ID = 199885;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199885Service() {
        this(new Idea199885Config());
    }

    public Idea199885Service(Idea199885Config config) {
        this.config = config != null ? config : new Idea199885Config();
