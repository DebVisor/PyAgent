...
@Data
public class Idea199768Config {
    private String name = "idea_199768";
 ...
 */
@Slf4j
public class Idea199768Service {
    private static final int IDEA_ID = 199768;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199768Service() {
        this(new Idea199768Config());
    }

    public Idea199768Service(Idea199768Config config) {
        this.config = config != null ? config : new Idea199768Config();
