...
@Data
public class Idea199806Config {
    private String name = "idea_199806";
 ...
 */
@Slf4j
public class Idea199806Service {
    private static final int IDEA_ID = 199806;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199806Service() {
        this(new Idea199806Config());
    }

    public Idea199806Service(Idea199806Config config) {
        this.config = config != null ? config : new Idea199806Config();
