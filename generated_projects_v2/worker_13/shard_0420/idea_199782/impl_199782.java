...
@Data
public class Idea199782Config {
    private String name = "idea_199782";
 ...
 */
@Slf4j
public class Idea199782Service {
    private static final int IDEA_ID = 199782;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199782Service() {
        this(new Idea199782Config());
    }

    public Idea199782Service(Idea199782Config config) {
        this.config = config != null ? config : new Idea199782Config();
