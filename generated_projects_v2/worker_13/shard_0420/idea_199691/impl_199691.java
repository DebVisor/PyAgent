...
@Data
public class Idea199691Config {
    private String name = "idea_199691";
 ...
 */
@Slf4j
public class Idea199691Service {
    private static final int IDEA_ID = 199691;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199691Service() {
        this(new Idea199691Config());
    }

    public Idea199691Service(Idea199691Config config) {
        this.config = config != null ? config : new Idea199691Config();
