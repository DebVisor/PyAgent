...
@Data
public class Idea199746Config {
    private String name = "idea_199746";
 ...
 */
@Slf4j
public class Idea199746Service {
    private static final int IDEA_ID = 199746;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199746Service() {
        this(new Idea199746Config());
    }

    public Idea199746Service(Idea199746Config config) {
        this.config = config != null ? config : new Idea199746Config();
