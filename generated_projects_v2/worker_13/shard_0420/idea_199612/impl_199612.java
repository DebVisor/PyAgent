...
@Data
public class Idea199612Config {
    private String name = "idea_199612";
 ...
 */
@Slf4j
public class Idea199612Service {
    private static final int IDEA_ID = 199612;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199612Service() {
        this(new Idea199612Config());
    }

    public Idea199612Service(Idea199612Config config) {
        this.config = config != null ? config : new Idea199612Config();
