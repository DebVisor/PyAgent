...
@Data
public class Idea199828Config {
    private String name = "idea_199828";
 ...
 */
@Slf4j
public class Idea199828Service {
    private static final int IDEA_ID = 199828;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199828Service() {
        this(new Idea199828Config());
    }

    public Idea199828Service(Idea199828Config config) {
        this.config = config != null ? config : new Idea199828Config();
