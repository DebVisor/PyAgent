...
@Data
public class Idea199787Config {
    private String name = "idea_199787";
 ...
 */
@Slf4j
public class Idea199787Service {
    private static final int IDEA_ID = 199787;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199787Service() {
        this(new Idea199787Config());
    }

    public Idea199787Service(Idea199787Config config) {
        this.config = config != null ? config : new Idea199787Config();
