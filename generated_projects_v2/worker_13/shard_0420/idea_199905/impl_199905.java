...
@Data
public class Idea199905Config {
    private String name = "idea_199905";
 ...
 */
@Slf4j
public class Idea199905Service {
    private static final int IDEA_ID = 199905;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199905Service() {
        this(new Idea199905Config());
    }

    public Idea199905Service(Idea199905Config config) {
        this.config = config != null ? config : new Idea199905Config();
