...
@Data
public class Idea199960Config {
    private String name = "idea_199960";
 ...
 */
@Slf4j
public class Idea199960Service {
    private static final int IDEA_ID = 199960;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199960Service() {
        this(new Idea199960Config());
    }

    public Idea199960Service(Idea199960Config config) {
        this.config = config != null ? config : new Idea199960Config();
