...
@Data
public class Idea199648Config {
    private String name = "idea_199648";
 ...
 */
@Slf4j
public class Idea199648Service {
    private static final int IDEA_ID = 199648;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199648Service() {
        this(new Idea199648Config());
    }

    public Idea199648Service(Idea199648Config config) {
        this.config = config != null ? config : new Idea199648Config();
