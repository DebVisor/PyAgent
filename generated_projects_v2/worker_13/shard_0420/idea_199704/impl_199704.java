...
@Data
public class Idea199704Config {
    private String name = "idea_199704";
 ...
 */
@Slf4j
public class Idea199704Service {
    private static final int IDEA_ID = 199704;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199704Service() {
        this(new Idea199704Config());
    }

    public Idea199704Service(Idea199704Config config) {
        this.config = config != null ? config : new Idea199704Config();
