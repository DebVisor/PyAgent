...
@Data
public class Idea199688Config {
    private String name = "idea_199688";
 ...
 */
@Slf4j
public class Idea199688Service {
    private static final int IDEA_ID = 199688;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199688Service() {
        this(new Idea199688Config());
    }

    public Idea199688Service(Idea199688Config config) {
        this.config = config != null ? config : new Idea199688Config();
