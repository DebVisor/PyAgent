...
@Data
public class Idea199857Config {
    private String name = "idea_199857";
 ...
 */
@Slf4j
public class Idea199857Service {
    private static final int IDEA_ID = 199857;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199857Service() {
        this(new Idea199857Config());
    }

    public Idea199857Service(Idea199857Config config) {
        this.config = config != null ? config : new Idea199857Config();
