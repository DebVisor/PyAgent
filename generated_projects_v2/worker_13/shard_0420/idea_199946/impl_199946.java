...
@Data
public class Idea199946Config {
    private String name = "idea_199946";
 ...
 */
@Slf4j
public class Idea199946Service {
    private static final int IDEA_ID = 199946;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199946Service() {
        this(new Idea199946Config());
    }

    public Idea199946Service(Idea199946Config config) {
        this.config = config != null ? config : new Idea199946Config();
