...
@Data
public class Idea199697Config {
    private String name = "idea_199697";
 ...
 */
@Slf4j
public class Idea199697Service {
    private static final int IDEA_ID = 199697;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea199697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea199697Service() {
        this(new Idea199697Config());
    }

    public Idea199697Service(Idea199697Config config) {
        this.config = config != null ? config : new Idea199697Config();
