...
@Data
public class Idea197273Config {
    private String name = "idea_197273";
 ...
 */
@Slf4j
public class Idea197273Service {
    private static final int IDEA_ID = 197273;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197273Service() {
        this(new Idea197273Config());
    }

    public Idea197273Service(Idea197273Config config) {
        this.config = config != null ? config : new Idea197273Config();
