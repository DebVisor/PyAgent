...
@Data
public class Idea197191Config {
    private String name = "idea_197191";
 ...
 */
@Slf4j
public class Idea197191Service {
    private static final int IDEA_ID = 197191;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197191Service() {
        this(new Idea197191Config());
    }

    public Idea197191Service(Idea197191Config config) {
        this.config = config != null ? config : new Idea197191Config();
