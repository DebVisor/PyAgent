...
@Data
public class Idea197228Config {
    private String name = "idea_197228";
 ...
 */
@Slf4j
public class Idea197228Service {
    private static final int IDEA_ID = 197228;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197228Service() {
        this(new Idea197228Config());
    }

    public Idea197228Service(Idea197228Config config) {
        this.config = config != null ? config : new Idea197228Config();
