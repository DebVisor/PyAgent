...
@Data
public class Idea197294Config {
    private String name = "idea_197294";
 ...
 */
@Slf4j
public class Idea197294Service {
    private static final int IDEA_ID = 197294;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197294Service() {
        this(new Idea197294Config());
    }

    public Idea197294Service(Idea197294Config config) {
        this.config = config != null ? config : new Idea197294Config();
