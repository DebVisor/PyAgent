...
@Data
public class Idea197467Config {
    private String name = "idea_197467";
 ...
 */
@Slf4j
public class Idea197467Service {
    private static final int IDEA_ID = 197467;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197467Service() {
        this(new Idea197467Config());
    }

    public Idea197467Service(Idea197467Config config) {
        this.config = config != null ? config : new Idea197467Config();
