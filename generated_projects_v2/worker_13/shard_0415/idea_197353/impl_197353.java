...
@Data
public class Idea197353Config {
    private String name = "idea_197353";
 ...
 */
@Slf4j
public class Idea197353Service {
    private static final int IDEA_ID = 197353;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197353Service() {
        this(new Idea197353Config());
    }

    public Idea197353Service(Idea197353Config config) {
        this.config = config != null ? config : new Idea197353Config();
