...
@Data
public class Idea197320Config {
    private String name = "idea_197320";
 ...
 */
@Slf4j
public class Idea197320Service {
    private static final int IDEA_ID = 197320;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197320Service() {
        this(new Idea197320Config());
    }

    public Idea197320Service(Idea197320Config config) {
        this.config = config != null ? config : new Idea197320Config();
