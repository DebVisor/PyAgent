...
@Data
public class Idea197137Config {
    private String name = "idea_197137";
 ...
 */
@Slf4j
public class Idea197137Service {
    private static final int IDEA_ID = 197137;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197137Service() {
        this(new Idea197137Config());
    }

    public Idea197137Service(Idea197137Config config) {
        this.config = config != null ? config : new Idea197137Config();
