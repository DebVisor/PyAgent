...
@Data
public class Idea197408Config {
    private String name = "idea_197408";
 ...
 */
@Slf4j
public class Idea197408Service {
    private static final int IDEA_ID = 197408;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197408Service() {
        this(new Idea197408Config());
    }

    public Idea197408Service(Idea197408Config config) {
        this.config = config != null ? config : new Idea197408Config();
