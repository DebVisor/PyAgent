...
@Data
public class Idea197399Config {
    private String name = "idea_197399";
 ...
 */
@Slf4j
public class Idea197399Service {
    private static final int IDEA_ID = 197399;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197399Service() {
        this(new Idea197399Config());
    }

    public Idea197399Service(Idea197399Config config) {
        this.config = config != null ? config : new Idea197399Config();
