...
@Data
public class Idea197195Config {
    private String name = "idea_197195";
 ...
 */
@Slf4j
public class Idea197195Service {
    private static final int IDEA_ID = 197195;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197195Service() {
        this(new Idea197195Config());
    }

    public Idea197195Service(Idea197195Config config) {
        this.config = config != null ? config : new Idea197195Config();
