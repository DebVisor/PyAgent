...
@Data
public class Idea197297Config {
    private String name = "idea_197297";
 ...
 */
@Slf4j
public class Idea197297Service {
    private static final int IDEA_ID = 197297;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197297Service() {
        this(new Idea197297Config());
    }

    public Idea197297Service(Idea197297Config config) {
        this.config = config != null ? config : new Idea197297Config();
