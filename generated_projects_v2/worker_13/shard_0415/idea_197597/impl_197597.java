...
@Data
public class Idea197597Config {
    private String name = "idea_197597";
 ...
 */
@Slf4j
public class Idea197597Service {
    private static final int IDEA_ID = 197597;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197597Service() {
        this(new Idea197597Config());
    }

    public Idea197597Service(Idea197597Config config) {
        this.config = config != null ? config : new Idea197597Config();
