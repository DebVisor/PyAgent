...
@Data
public class Idea197450Config {
    private String name = "idea_197450";
 ...
 */
@Slf4j
public class Idea197450Service {
    private static final int IDEA_ID = 197450;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197450Service() {
        this(new Idea197450Config());
    }

    public Idea197450Service(Idea197450Config config) {
        this.config = config != null ? config : new Idea197450Config();
