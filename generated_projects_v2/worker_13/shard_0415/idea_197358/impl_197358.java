...
@Data
public class Idea197358Config {
    private String name = "idea_197358";
 ...
 */
@Slf4j
public class Idea197358Service {
    private static final int IDEA_ID = 197358;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197358Service() {
        this(new Idea197358Config());
    }

    public Idea197358Service(Idea197358Config config) {
        this.config = config != null ? config : new Idea197358Config();
