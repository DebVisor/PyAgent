...
@Data
public class Idea197555Config {
    private String name = "idea_197555";
 ...
 */
@Slf4j
public class Idea197555Service {
    private static final int IDEA_ID = 197555;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197555Service() {
        this(new Idea197555Config());
    }

    public Idea197555Service(Idea197555Config config) {
        this.config = config != null ? config : new Idea197555Config();
