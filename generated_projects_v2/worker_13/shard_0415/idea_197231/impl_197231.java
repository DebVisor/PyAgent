...
@Data
public class Idea197231Config {
    private String name = "idea_197231";
 ...
 */
@Slf4j
public class Idea197231Service {
    private static final int IDEA_ID = 197231;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197231Service() {
        this(new Idea197231Config());
    }

    public Idea197231Service(Idea197231Config config) {
        this.config = config != null ? config : new Idea197231Config();
