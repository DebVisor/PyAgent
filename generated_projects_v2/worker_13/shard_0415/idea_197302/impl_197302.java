...
@Data
public class Idea197302Config {
    private String name = "idea_197302";
 ...
 */
@Slf4j
public class Idea197302Service {
    private static final int IDEA_ID = 197302;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197302Service() {
        this(new Idea197302Config());
    }

    public Idea197302Service(Idea197302Config config) {
        this.config = config != null ? config : new Idea197302Config();
