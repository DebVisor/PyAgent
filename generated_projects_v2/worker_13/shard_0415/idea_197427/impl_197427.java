...
@Data
public class Idea197427Config {
    private String name = "idea_197427";
 ...
 */
@Slf4j
public class Idea197427Service {
    private static final int IDEA_ID = 197427;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197427Service() {
        this(new Idea197427Config());
    }

    public Idea197427Service(Idea197427Config config) {
        this.config = config != null ? config : new Idea197427Config();
