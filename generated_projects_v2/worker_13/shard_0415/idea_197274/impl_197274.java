...
@Data
public class Idea197274Config {
    private String name = "idea_197274";
 ...
 */
@Slf4j
public class Idea197274Service {
    private static final int IDEA_ID = 197274;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197274Service() {
        this(new Idea197274Config());
    }

    public Idea197274Service(Idea197274Config config) {
        this.config = config != null ? config : new Idea197274Config();
