...
@Data
public class Idea197207Config {
    private String name = "idea_197207";
 ...
 */
@Slf4j
public class Idea197207Service {
    private static final int IDEA_ID = 197207;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197207Service() {
        this(new Idea197207Config());
    }

    public Idea197207Service(Idea197207Config config) {
        this.config = config != null ? config : new Idea197207Config();
