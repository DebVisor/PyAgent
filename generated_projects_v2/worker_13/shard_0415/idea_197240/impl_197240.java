...
@Data
public class Idea197240Config {
    private String name = "idea_197240";
 ...
 */
@Slf4j
public class Idea197240Service {
    private static final int IDEA_ID = 197240;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197240Service() {
        this(new Idea197240Config());
    }

    public Idea197240Service(Idea197240Config config) {
        this.config = config != null ? config : new Idea197240Config();
