...
@Data
public class Idea197131Config {
    private String name = "idea_197131";
 ...
 */
@Slf4j
public class Idea197131Service {
    private static final int IDEA_ID = 197131;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197131Service() {
        this(new Idea197131Config());
    }

    public Idea197131Service(Idea197131Config config) {
        this.config = config != null ? config : new Idea197131Config();
