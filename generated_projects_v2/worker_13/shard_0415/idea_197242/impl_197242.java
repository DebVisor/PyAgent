...
@Data
public class Idea197242Config {
    private String name = "idea_197242";
 ...
 */
@Slf4j
public class Idea197242Service {
    private static final int IDEA_ID = 197242;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197242Service() {
        this(new Idea197242Config());
    }

    public Idea197242Service(Idea197242Config config) {
        this.config = config != null ? config : new Idea197242Config();
