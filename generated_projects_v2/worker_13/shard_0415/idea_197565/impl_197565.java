...
@Data
public class Idea197565Config {
    private String name = "idea_197565";
 ...
 */
@Slf4j
public class Idea197565Service {
    private static final int IDEA_ID = 197565;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197565Service() {
        this(new Idea197565Config());
    }

    public Idea197565Service(Idea197565Config config) {
        this.config = config != null ? config : new Idea197565Config();
