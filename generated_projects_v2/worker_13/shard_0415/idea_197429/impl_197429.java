...
@Data
public class Idea197429Config {
    private String name = "idea_197429";
 ...
 */
@Slf4j
public class Idea197429Service {
    private static final int IDEA_ID = 197429;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197429Service() {
        this(new Idea197429Config());
    }

    public Idea197429Service(Idea197429Config config) {
        this.config = config != null ? config : new Idea197429Config();
