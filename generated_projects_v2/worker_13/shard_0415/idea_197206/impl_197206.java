...
@Data
public class Idea197206Config {
    private String name = "idea_197206";
 ...
 */
@Slf4j
public class Idea197206Service {
    private static final int IDEA_ID = 197206;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197206Service() {
        this(new Idea197206Config());
    }

    public Idea197206Service(Idea197206Config config) {
        this.config = config != null ? config : new Idea197206Config();
