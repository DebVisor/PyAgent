...
@Data
public class Idea197369Config {
    private String name = "idea_197369";
 ...
 */
@Slf4j
public class Idea197369Service {
    private static final int IDEA_ID = 197369;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197369Service() {
        this(new Idea197369Config());
    }

    public Idea197369Service(Idea197369Config config) {
        this.config = config != null ? config : new Idea197369Config();
