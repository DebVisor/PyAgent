...
@Data
public class Idea197504Config {
    private String name = "idea_197504";
 ...
 */
@Slf4j
public class Idea197504Service {
    private static final int IDEA_ID = 197504;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197504Service() {
        this(new Idea197504Config());
    }

    public Idea197504Service(Idea197504Config config) {
        this.config = config != null ? config : new Idea197504Config();
