...
@Data
public class Idea197316Config {
    private String name = "idea_197316";
 ...
 */
@Slf4j
public class Idea197316Service {
    private static final int IDEA_ID = 197316;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197316Service() {
        this(new Idea197316Config());
    }

    public Idea197316Service(Idea197316Config config) {
        this.config = config != null ? config : new Idea197316Config();
