...
@Data
public class Idea197333Config {
    private String name = "idea_197333";
 ...
 */
@Slf4j
public class Idea197333Service {
    private static final int IDEA_ID = 197333;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197333Service() {
        this(new Idea197333Config());
    }

    public Idea197333Service(Idea197333Config config) {
        this.config = config != null ? config : new Idea197333Config();
