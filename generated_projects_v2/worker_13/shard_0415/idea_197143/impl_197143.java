...
@Data
public class Idea197143Config {
    private String name = "idea_197143";
 ...
 */
@Slf4j
public class Idea197143Service {
    private static final int IDEA_ID = 197143;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197143Service() {
        this(new Idea197143Config());
    }

    public Idea197143Service(Idea197143Config config) {
        this.config = config != null ? config : new Idea197143Config();
