...
@Data
public class Idea197441Config {
    private String name = "idea_197441";
 ...
 */
@Slf4j
public class Idea197441Service {
    private static final int IDEA_ID = 197441;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197441Service() {
        this(new Idea197441Config());
    }

    public Idea197441Service(Idea197441Config config) {
        this.config = config != null ? config : new Idea197441Config();
