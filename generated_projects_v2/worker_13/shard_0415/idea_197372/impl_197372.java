...
@Data
public class Idea197372Config {
    private String name = "idea_197372";
 ...
 */
@Slf4j
public class Idea197372Service {
    private static final int IDEA_ID = 197372;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197372Service() {
        this(new Idea197372Config());
    }

    public Idea197372Service(Idea197372Config config) {
        this.config = config != null ? config : new Idea197372Config();
