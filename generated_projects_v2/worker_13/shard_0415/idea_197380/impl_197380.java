...
@Data
public class Idea197380Config {
    private String name = "idea_197380";
 ...
 */
@Slf4j
public class Idea197380Service {
    private static final int IDEA_ID = 197380;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197380Service() {
        this(new Idea197380Config());
    }

    public Idea197380Service(Idea197380Config config) {
        this.config = config != null ? config : new Idea197380Config();
