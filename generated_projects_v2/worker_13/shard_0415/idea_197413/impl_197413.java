...
@Data
public class Idea197413Config {
    private String name = "idea_197413";
 ...
 */
@Slf4j
public class Idea197413Service {
    private static final int IDEA_ID = 197413;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197413Service() {
        this(new Idea197413Config());
    }

    public Idea197413Service(Idea197413Config config) {
        this.config = config != null ? config : new Idea197413Config();
