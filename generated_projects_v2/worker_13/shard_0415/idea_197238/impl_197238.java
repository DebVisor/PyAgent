...
@Data
public class Idea197238Config {
    private String name = "idea_197238";
 ...
 */
@Slf4j
public class Idea197238Service {
    private static final int IDEA_ID = 197238;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197238Service() {
        this(new Idea197238Config());
    }

    public Idea197238Service(Idea197238Config config) {
        this.config = config != null ? config : new Idea197238Config();
