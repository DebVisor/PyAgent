...
@Data
public class Idea197420Config {
    private String name = "idea_197420";
 ...
 */
@Slf4j
public class Idea197420Service {
    private static final int IDEA_ID = 197420;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197420Service() {
        this(new Idea197420Config());
    }

    public Idea197420Service(Idea197420Config config) {
        this.config = config != null ? config : new Idea197420Config();
