...
@Data
public class Idea197298Config {
    private String name = "idea_197298";
 ...
 */
@Slf4j
public class Idea197298Service {
    private static final int IDEA_ID = 197298;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197298Service() {
        this(new Idea197298Config());
    }

    public Idea197298Service(Idea197298Config config) {
        this.config = config != null ? config : new Idea197298Config();
