...
@Data
public class Idea197415Config {
    private String name = "idea_197415";
 ...
 */
@Slf4j
public class Idea197415Service {
    private static final int IDEA_ID = 197415;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197415Service() {
        this(new Idea197415Config());
    }

    public Idea197415Service(Idea197415Config config) {
        this.config = config != null ? config : new Idea197415Config();
