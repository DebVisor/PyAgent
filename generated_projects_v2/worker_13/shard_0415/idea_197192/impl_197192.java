...
@Data
public class Idea197192Config {
    private String name = "idea_197192";
 ...
 */
@Slf4j
public class Idea197192Service {
    private static final int IDEA_ID = 197192;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197192Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197192Service() {
        this(new Idea197192Config());
    }

    public Idea197192Service(Idea197192Config config) {
        this.config = config != null ? config : new Idea197192Config();
