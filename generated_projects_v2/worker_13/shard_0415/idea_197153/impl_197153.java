...
@Data
public class Idea197153Config {
    private String name = "idea_197153";
 ...
 */
@Slf4j
public class Idea197153Service {
    private static final int IDEA_ID = 197153;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197153Service() {
        this(new Idea197153Config());
    }

    public Idea197153Service(Idea197153Config config) {
        this.config = config != null ? config : new Idea197153Config();
