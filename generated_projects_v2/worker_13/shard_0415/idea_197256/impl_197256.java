...
@Data
public class Idea197256Config {
    private String name = "idea_197256";
 ...
 */
@Slf4j
public class Idea197256Service {
    private static final int IDEA_ID = 197256;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197256Service() {
        this(new Idea197256Config());
    }

    public Idea197256Service(Idea197256Config config) {
        this.config = config != null ? config : new Idea197256Config();
