...
@Data
public class Idea197175Config {
    private String name = "idea_197175";
 ...
 */
@Slf4j
public class Idea197175Service {
    private static final int IDEA_ID = 197175;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197175Service() {
        this(new Idea197175Config());
    }

    public Idea197175Service(Idea197175Config config) {
        this.config = config != null ? config : new Idea197175Config();
