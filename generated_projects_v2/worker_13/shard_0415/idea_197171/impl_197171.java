...
@Data
public class Idea197171Config {
    private String name = "idea_197171";
 ...
 */
@Slf4j
public class Idea197171Service {
    private static final int IDEA_ID = 197171;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197171Service() {
        this(new Idea197171Config());
    }

    public Idea197171Service(Idea197171Config config) {
        this.config = config != null ? config : new Idea197171Config();
