...
@Data
public class Idea197454Config {
    private String name = "idea_197454";
 ...
 */
@Slf4j
public class Idea197454Service {
    private static final int IDEA_ID = 197454;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197454Service() {
        this(new Idea197454Config());
    }

    public Idea197454Service(Idea197454Config config) {
        this.config = config != null ? config : new Idea197454Config();
