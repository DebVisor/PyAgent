...
@Data
public class Idea197139Config {
    private String name = "idea_197139";
 ...
 */
@Slf4j
public class Idea197139Service {
    private static final int IDEA_ID = 197139;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197139Service() {
        this(new Idea197139Config());
    }

    public Idea197139Service(Idea197139Config config) {
        this.config = config != null ? config : new Idea197139Config();
