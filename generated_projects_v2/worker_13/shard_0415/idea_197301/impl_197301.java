...
@Data
public class Idea197301Config {
    private String name = "idea_197301";
 ...
 */
@Slf4j
public class Idea197301Service {
    private static final int IDEA_ID = 197301;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197301Service() {
        this(new Idea197301Config());
    }

    public Idea197301Service(Idea197301Config config) {
        this.config = config != null ? config : new Idea197301Config();
