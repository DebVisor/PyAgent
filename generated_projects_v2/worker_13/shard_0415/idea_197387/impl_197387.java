...
@Data
public class Idea197387Config {
    private String name = "idea_197387";
 ...
 */
@Slf4j
public class Idea197387Service {
    private static final int IDEA_ID = 197387;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197387Service() {
        this(new Idea197387Config());
    }

    public Idea197387Service(Idea197387Config config) {
        this.config = config != null ? config : new Idea197387Config();
