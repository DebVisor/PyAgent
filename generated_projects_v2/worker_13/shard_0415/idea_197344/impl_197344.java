...
@Data
public class Idea197344Config {
    private String name = "idea_197344";
 ...
 */
@Slf4j
public class Idea197344Service {
    private static final int IDEA_ID = 197344;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197344Service() {
        this(new Idea197344Config());
    }

    public Idea197344Service(Idea197344Config config) {
        this.config = config != null ? config : new Idea197344Config();
