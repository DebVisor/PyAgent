...
@Data
public class Idea197328Config {
    private String name = "idea_197328";
 ...
 */
@Slf4j
public class Idea197328Service {
    private static final int IDEA_ID = 197328;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197328Service() {
        this(new Idea197328Config());
    }

    public Idea197328Service(Idea197328Config config) {
        this.config = config != null ? config : new Idea197328Config();
