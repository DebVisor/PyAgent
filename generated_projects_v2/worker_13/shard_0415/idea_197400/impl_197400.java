...
@Data
public class Idea197400Config {
    private String name = "idea_197400";
 ...
 */
@Slf4j
public class Idea197400Service {
    private static final int IDEA_ID = 197400;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197400Service() {
        this(new Idea197400Config());
    }

    public Idea197400Service(Idea197400Config config) {
        this.config = config != null ? config : new Idea197400Config();
