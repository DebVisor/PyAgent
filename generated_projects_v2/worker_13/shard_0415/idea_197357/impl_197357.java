...
@Data
public class Idea197357Config {
    private String name = "idea_197357";
 ...
 */
@Slf4j
public class Idea197357Service {
    private static final int IDEA_ID = 197357;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197357Service() {
        this(new Idea197357Config());
    }

    public Idea197357Service(Idea197357Config config) {
        this.config = config != null ? config : new Idea197357Config();
