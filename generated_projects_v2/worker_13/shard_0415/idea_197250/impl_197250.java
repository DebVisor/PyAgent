...
@Data
public class Idea197250Config {
    private String name = "idea_197250";
 ...
 */
@Slf4j
public class Idea197250Service {
    private static final int IDEA_ID = 197250;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197250Service() {
        this(new Idea197250Config());
    }

    public Idea197250Service(Idea197250Config config) {
        this.config = config != null ? config : new Idea197250Config();
