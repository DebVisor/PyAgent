...
@Data
public class Idea197584Config {
    private String name = "idea_197584";
 ...
 */
@Slf4j
public class Idea197584Service {
    private static final int IDEA_ID = 197584;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197584Service() {
        this(new Idea197584Config());
    }

    public Idea197584Service(Idea197584Config config) {
        this.config = config != null ? config : new Idea197584Config();
