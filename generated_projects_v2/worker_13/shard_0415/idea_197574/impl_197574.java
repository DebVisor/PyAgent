...
@Data
public class Idea197574Config {
    private String name = "idea_197574";
 ...
 */
@Slf4j
public class Idea197574Service {
    private static final int IDEA_ID = 197574;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197574Service() {
        this(new Idea197574Config());
    }

    public Idea197574Service(Idea197574Config config) {
        this.config = config != null ? config : new Idea197574Config();
