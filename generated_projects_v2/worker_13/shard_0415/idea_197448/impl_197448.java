...
@Data
public class Idea197448Config {
    private String name = "idea_197448";
 ...
 */
@Slf4j
public class Idea197448Service {
    private static final int IDEA_ID = 197448;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197448Service() {
        this(new Idea197448Config());
    }

    public Idea197448Service(Idea197448Config config) {
        this.config = config != null ? config : new Idea197448Config();
