...
@Data
public class Idea197414Config {
    private String name = "idea_197414";
 ...
 */
@Slf4j
public class Idea197414Service {
    private static final int IDEA_ID = 197414;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197414Service() {
        this(new Idea197414Config());
    }

    public Idea197414Service(Idea197414Config config) {
        this.config = config != null ? config : new Idea197414Config();
