...
@Data
public class Idea197590Config {
    private String name = "idea_197590";
 ...
 */
@Slf4j
public class Idea197590Service {
    private static final int IDEA_ID = 197590;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197590Service() {
        this(new Idea197590Config());
    }

    public Idea197590Service(Idea197590Config config) {
        this.config = config != null ? config : new Idea197590Config();
