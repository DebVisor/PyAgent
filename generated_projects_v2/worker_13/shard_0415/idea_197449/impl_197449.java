...
@Data
public class Idea197449Config {
    private String name = "idea_197449";
 ...
 */
@Slf4j
public class Idea197449Service {
    private static final int IDEA_ID = 197449;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197449Service() {
        this(new Idea197449Config());
    }

    public Idea197449Service(Idea197449Config config) {
        this.config = config != null ? config : new Idea197449Config();
