...
@Data
public class Idea197221Config {
    private String name = "idea_197221";
 ...
 */
@Slf4j
public class Idea197221Service {
    private static final int IDEA_ID = 197221;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197221Service() {
        this(new Idea197221Config());
    }

    public Idea197221Service(Idea197221Config config) {
        this.config = config != null ? config : new Idea197221Config();
