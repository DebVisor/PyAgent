...
@Data
public class Idea197490Config {
    private String name = "idea_197490";
 ...
 */
@Slf4j
public class Idea197490Service {
    private static final int IDEA_ID = 197490;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197490Service() {
        this(new Idea197490Config());
    }

    public Idea197490Service(Idea197490Config config) {
        this.config = config != null ? config : new Idea197490Config();
