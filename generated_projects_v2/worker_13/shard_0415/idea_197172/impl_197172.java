...
@Data
public class Idea197172Config {
    private String name = "idea_197172";
 ...
 */
@Slf4j
public class Idea197172Service {
    private static final int IDEA_ID = 197172;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197172Service() {
        this(new Idea197172Config());
    }

    public Idea197172Service(Idea197172Config config) {
        this.config = config != null ? config : new Idea197172Config();
