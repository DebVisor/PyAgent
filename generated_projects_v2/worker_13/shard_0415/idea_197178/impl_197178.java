...
@Data
public class Idea197178Config {
    private String name = "idea_197178";
 ...
 */
@Slf4j
public class Idea197178Service {
    private static final int IDEA_ID = 197178;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197178Service() {
        this(new Idea197178Config());
    }

    public Idea197178Service(Idea197178Config config) {
        this.config = config != null ? config : new Idea197178Config();
