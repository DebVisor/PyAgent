...
@Data
public class Idea197287Config {
    private String name = "idea_197287";
 ...
 */
@Slf4j
public class Idea197287Service {
    private static final int IDEA_ID = 197287;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197287Service() {
        this(new Idea197287Config());
    }

    public Idea197287Service(Idea197287Config config) {
        this.config = config != null ? config : new Idea197287Config();
