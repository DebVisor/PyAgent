...
@Data
public class Idea197488Config {
    private String name = "idea_197488";
 ...
 */
@Slf4j
public class Idea197488Service {
    private static final int IDEA_ID = 197488;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197488Service() {
        this(new Idea197488Config());
    }

    public Idea197488Service(Idea197488Config config) {
        this.config = config != null ? config : new Idea197488Config();
