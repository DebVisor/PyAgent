...
@Data
public class Idea197200Config {
    private String name = "idea_197200";
 ...
 */
@Slf4j
public class Idea197200Service {
    private static final int IDEA_ID = 197200;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197200Service() {
        this(new Idea197200Config());
    }

    public Idea197200Service(Idea197200Config config) {
        this.config = config != null ? config : new Idea197200Config();
