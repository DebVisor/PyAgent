...
@Data
public class Idea197434Config {
    private String name = "idea_197434";
 ...
 */
@Slf4j
public class Idea197434Service {
    private static final int IDEA_ID = 197434;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197434Service() {
        this(new Idea197434Config());
    }

    public Idea197434Service(Idea197434Config config) {
        this.config = config != null ? config : new Idea197434Config();
