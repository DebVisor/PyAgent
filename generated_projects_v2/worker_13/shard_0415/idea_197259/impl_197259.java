...
@Data
public class Idea197259Config {
    private String name = "idea_197259";
 ...
 */
@Slf4j
public class Idea197259Service {
    private static final int IDEA_ID = 197259;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197259Service() {
        this(new Idea197259Config());
    }

    public Idea197259Service(Idea197259Config config) {
        this.config = config != null ? config : new Idea197259Config();
