...
@Data
public class Idea197236Config {
    private String name = "idea_197236";
 ...
 */
@Slf4j
public class Idea197236Service {
    private static final int IDEA_ID = 197236;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197236Service() {
        this(new Idea197236Config());
    }

    public Idea197236Service(Idea197236Config config) {
        this.config = config != null ? config : new Idea197236Config();
