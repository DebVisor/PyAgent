...
@Data
public class Idea197561Config {
    private String name = "idea_197561";
 ...
 */
@Slf4j
public class Idea197561Service {
    private static final int IDEA_ID = 197561;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197561Service() {
        this(new Idea197561Config());
    }

    public Idea197561Service(Idea197561Config config) {
        this.config = config != null ? config : new Idea197561Config();
