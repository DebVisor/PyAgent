...
@Data
public class Idea197491Config {
    private String name = "idea_197491";
 ...
 */
@Slf4j
public class Idea197491Service {
    private static final int IDEA_ID = 197491;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197491Service() {
        this(new Idea197491Config());
    }

    public Idea197491Service(Idea197491Config config) {
        this.config = config != null ? config : new Idea197491Config();
