...
@Data
public class Idea197295Config {
    private String name = "idea_197295";
 ...
 */
@Slf4j
public class Idea197295Service {
    private static final int IDEA_ID = 197295;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197295Service() {
        this(new Idea197295Config());
    }

    public Idea197295Service(Idea197295Config config) {
        this.config = config != null ? config : new Idea197295Config();
