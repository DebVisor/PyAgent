...
@Data
public class Idea197142Config {
    private String name = "idea_197142";
 ...
 */
@Slf4j
public class Idea197142Service {
    private static final int IDEA_ID = 197142;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197142Service() {
        this(new Idea197142Config());
    }

    public Idea197142Service(Idea197142Config config) {
        this.config = config != null ? config : new Idea197142Config();
