...
@Data
public class Idea197265Config {
    private String name = "idea_197265";
 ...
 */
@Slf4j
public class Idea197265Service {
    private static final int IDEA_ID = 197265;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197265Service() {
        this(new Idea197265Config());
    }

    public Idea197265Service(Idea197265Config config) {
        this.config = config != null ? config : new Idea197265Config();
