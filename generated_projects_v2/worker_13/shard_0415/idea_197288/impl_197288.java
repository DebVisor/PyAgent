...
@Data
public class Idea197288Config {
    private String name = "idea_197288";
 ...
 */
@Slf4j
public class Idea197288Service {
    private static final int IDEA_ID = 197288;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197288Service() {
        this(new Idea197288Config());
    }

    public Idea197288Service(Idea197288Config config) {
        this.config = config != null ? config : new Idea197288Config();
