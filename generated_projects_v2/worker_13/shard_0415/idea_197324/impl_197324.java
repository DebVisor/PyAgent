...
@Data
public class Idea197324Config {
    private String name = "idea_197324";
 ...
 */
@Slf4j
public class Idea197324Service {
    private static final int IDEA_ID = 197324;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197324Service() {
        this(new Idea197324Config());
    }

    public Idea197324Service(Idea197324Config config) {
        this.config = config != null ? config : new Idea197324Config();
