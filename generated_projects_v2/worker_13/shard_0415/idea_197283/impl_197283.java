...
@Data
public class Idea197283Config {
    private String name = "idea_197283";
 ...
 */
@Slf4j
public class Idea197283Service {
    private static final int IDEA_ID = 197283;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197283Service() {
        this(new Idea197283Config());
    }

    public Idea197283Service(Idea197283Config config) {
        this.config = config != null ? config : new Idea197283Config();
