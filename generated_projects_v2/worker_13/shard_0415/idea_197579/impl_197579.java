...
@Data
public class Idea197579Config {
    private String name = "idea_197579";
 ...
 */
@Slf4j
public class Idea197579Service {
    private static final int IDEA_ID = 197579;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197579Service() {
        this(new Idea197579Config());
    }

    public Idea197579Service(Idea197579Config config) {
        this.config = config != null ? config : new Idea197579Config();
