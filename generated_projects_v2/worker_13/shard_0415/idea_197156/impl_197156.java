...
@Data
public class Idea197156Config {
    private String name = "idea_197156";
 ...
 */
@Slf4j
public class Idea197156Service {
    private static final int IDEA_ID = 197156;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197156Service() {
        this(new Idea197156Config());
    }

    public Idea197156Service(Idea197156Config config) {
        this.config = config != null ? config : new Idea197156Config();
