...
@Data
public class Idea197391Config {
    private String name = "idea_197391";
 ...
 */
@Slf4j
public class Idea197391Service {
    private static final int IDEA_ID = 197391;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197391Service() {
        this(new Idea197391Config());
    }

    public Idea197391Service(Idea197391Config config) {
        this.config = config != null ? config : new Idea197391Config();
