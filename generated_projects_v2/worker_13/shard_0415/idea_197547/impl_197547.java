...
@Data
public class Idea197547Config {
    private String name = "idea_197547";
 ...
 */
@Slf4j
public class Idea197547Service {
    private static final int IDEA_ID = 197547;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197547Service() {
        this(new Idea197547Config());
    }

    public Idea197547Service(Idea197547Config config) {
        this.config = config != null ? config : new Idea197547Config();
