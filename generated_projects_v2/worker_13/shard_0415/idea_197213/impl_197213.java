...
@Data
public class Idea197213Config {
    private String name = "idea_197213";
 ...
 */
@Slf4j
public class Idea197213Service {
    private static final int IDEA_ID = 197213;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197213Service() {
        this(new Idea197213Config());
    }

    public Idea197213Service(Idea197213Config config) {
        this.config = config != null ? config : new Idea197213Config();
