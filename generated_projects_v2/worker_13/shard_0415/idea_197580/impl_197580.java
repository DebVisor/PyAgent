...
@Data
public class Idea197580Config {
    private String name = "idea_197580";
 ...
 */
@Slf4j
public class Idea197580Service {
    private static final int IDEA_ID = 197580;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197580Service() {
        this(new Idea197580Config());
    }

    public Idea197580Service(Idea197580Config config) {
        this.config = config != null ? config : new Idea197580Config();
