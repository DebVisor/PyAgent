...
@Data
public class Idea197254Config {
    private String name = "idea_197254";
 ...
 */
@Slf4j
public class Idea197254Service {
    private static final int IDEA_ID = 197254;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197254Service() {
        this(new Idea197254Config());
    }

    public Idea197254Service(Idea197254Config config) {
        this.config = config != null ? config : new Idea197254Config();
