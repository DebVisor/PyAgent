...
@Data
public class Idea197524Config {
    private String name = "idea_197524";
 ...
 */
@Slf4j
public class Idea197524Service {
    private static final int IDEA_ID = 197524;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197524Service() {
        this(new Idea197524Config());
    }

    public Idea197524Service(Idea197524Config config) {
        this.config = config != null ? config : new Idea197524Config();
