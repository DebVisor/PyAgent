...
@Data
public class Idea197548Config {
    private String name = "idea_197548";
 ...
 */
@Slf4j
public class Idea197548Service {
    private static final int IDEA_ID = 197548;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197548Service() {
        this(new Idea197548Config());
    }

    public Idea197548Service(Idea197548Config config) {
        this.config = config != null ? config : new Idea197548Config();
