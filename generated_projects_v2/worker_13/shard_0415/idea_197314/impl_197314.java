...
@Data
public class Idea197314Config {
    private String name = "idea_197314";
 ...
 */
@Slf4j
public class Idea197314Service {
    private static final int IDEA_ID = 197314;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197314Service() {
        this(new Idea197314Config());
    }

    public Idea197314Service(Idea197314Config config) {
        this.config = config != null ? config : new Idea197314Config();
