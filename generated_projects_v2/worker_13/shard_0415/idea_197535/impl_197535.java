...
@Data
public class Idea197535Config {
    private String name = "idea_197535";
 ...
 */
@Slf4j
public class Idea197535Service {
    private static final int IDEA_ID = 197535;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197535Service() {
        this(new Idea197535Config());
    }

    public Idea197535Service(Idea197535Config config) {
        this.config = config != null ? config : new Idea197535Config();
