...
@Data
public class Idea197530Config {
    private String name = "idea_197530";
 ...
 */
@Slf4j
public class Idea197530Service {
    private static final int IDEA_ID = 197530;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197530Service() {
        this(new Idea197530Config());
    }

    public Idea197530Service(Idea197530Config config) {
        this.config = config != null ? config : new Idea197530Config();
