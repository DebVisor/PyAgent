...
@Data
public class Idea197505Config {
    private String name = "idea_197505";
 ...
 */
@Slf4j
public class Idea197505Service {
    private static final int IDEA_ID = 197505;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197505Service() {
        this(new Idea197505Config());
    }

    public Idea197505Service(Idea197505Config config) {
        this.config = config != null ? config : new Idea197505Config();
