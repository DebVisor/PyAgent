...
@Data
public class Idea197305Config {
    private String name = "idea_197305";
 ...
 */
@Slf4j
public class Idea197305Service {
    private static final int IDEA_ID = 197305;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197305Service() {
        this(new Idea197305Config());
    }

    public Idea197305Service(Idea197305Config config) {
        this.config = config != null ? config : new Idea197305Config();
