...
@Data
public class Idea197332Config {
    private String name = "idea_197332";
 ...
 */
@Slf4j
public class Idea197332Service {
    private static final int IDEA_ID = 197332;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197332Service() {
        this(new Idea197332Config());
    }

    public Idea197332Service(Idea197332Config config) {
        this.config = config != null ? config : new Idea197332Config();
