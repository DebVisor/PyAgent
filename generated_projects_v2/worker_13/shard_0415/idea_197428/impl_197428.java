...
@Data
public class Idea197428Config {
    private String name = "idea_197428";
 ...
 */
@Slf4j
public class Idea197428Service {
    private static final int IDEA_ID = 197428;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197428Service() {
        this(new Idea197428Config());
    }

    public Idea197428Service(Idea197428Config config) {
        this.config = config != null ? config : new Idea197428Config();
