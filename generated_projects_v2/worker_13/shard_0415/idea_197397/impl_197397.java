...
@Data
public class Idea197397Config {
    private String name = "idea_197397";
 ...
 */
@Slf4j
public class Idea197397Service {
    private static final int IDEA_ID = 197397;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197397Service() {
        this(new Idea197397Config());
    }

    public Idea197397Service(Idea197397Config config) {
        this.config = config != null ? config : new Idea197397Config();
