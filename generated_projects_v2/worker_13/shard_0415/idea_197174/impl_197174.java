...
@Data
public class Idea197174Config {
    private String name = "idea_197174";
 ...
 */
@Slf4j
public class Idea197174Service {
    private static final int IDEA_ID = 197174;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197174Service() {
        this(new Idea197174Config());
    }

    public Idea197174Service(Idea197174Config config) {
        this.config = config != null ? config : new Idea197174Config();
