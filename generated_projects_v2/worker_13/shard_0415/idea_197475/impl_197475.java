...
@Data
public class Idea197475Config {
    private String name = "idea_197475";
 ...
 */
@Slf4j
public class Idea197475Service {
    private static final int IDEA_ID = 197475;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197475Service() {
        this(new Idea197475Config());
    }

    public Idea197475Service(Idea197475Config config) {
        this.config = config != null ? config : new Idea197475Config();
