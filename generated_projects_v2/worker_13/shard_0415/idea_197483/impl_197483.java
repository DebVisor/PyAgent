...
@Data
public class Idea197483Config {
    private String name = "idea_197483";
 ...
 */
@Slf4j
public class Idea197483Service {
    private static final int IDEA_ID = 197483;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197483Service() {
        this(new Idea197483Config());
    }

    public Idea197483Service(Idea197483Config config) {
        this.config = config != null ? config : new Idea197483Config();
