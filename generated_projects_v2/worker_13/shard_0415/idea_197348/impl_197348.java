...
@Data
public class Idea197348Config {
    private String name = "idea_197348";
 ...
 */
@Slf4j
public class Idea197348Service {
    private static final int IDEA_ID = 197348;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197348Service() {
        this(new Idea197348Config());
    }

    public Idea197348Service(Idea197348Config config) {
        this.config = config != null ? config : new Idea197348Config();
