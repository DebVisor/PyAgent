...
@Data
public class Idea197571Config {
    private String name = "idea_197571";
 ...
 */
@Slf4j
public class Idea197571Service {
    private static final int IDEA_ID = 197571;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197571Service() {
        this(new Idea197571Config());
    }

    public Idea197571Service(Idea197571Config config) {
        this.config = config != null ? config : new Idea197571Config();
