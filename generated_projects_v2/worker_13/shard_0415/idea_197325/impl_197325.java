...
@Data
public class Idea197325Config {
    private String name = "idea_197325";
 ...
 */
@Slf4j
public class Idea197325Service {
    private static final int IDEA_ID = 197325;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197325Service() {
        this(new Idea197325Config());
    }

    public Idea197325Service(Idea197325Config config) {
        this.config = config != null ? config : new Idea197325Config();
