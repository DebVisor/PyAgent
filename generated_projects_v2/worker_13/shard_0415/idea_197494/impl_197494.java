...
@Data
public class Idea197494Config {
    private String name = "idea_197494";
 ...
 */
@Slf4j
public class Idea197494Service {
    private static final int IDEA_ID = 197494;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197494Service() {
        this(new Idea197494Config());
    }

    public Idea197494Service(Idea197494Config config) {
        this.config = config != null ? config : new Idea197494Config();
