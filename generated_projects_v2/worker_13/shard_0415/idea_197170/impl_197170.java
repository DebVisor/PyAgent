...
@Data
public class Idea197170Config {
    private String name = "idea_197170";
 ...
 */
@Slf4j
public class Idea197170Service {
    private static final int IDEA_ID = 197170;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197170Service() {
        this(new Idea197170Config());
    }

    public Idea197170Service(Idea197170Config config) {
        this.config = config != null ? config : new Idea197170Config();
