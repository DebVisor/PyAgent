...
@Data
public class Idea197164Config {
    private String name = "idea_197164";
 ...
 */
@Slf4j
public class Idea197164Service {
    private static final int IDEA_ID = 197164;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197164Service() {
        this(new Idea197164Config());
    }

    public Idea197164Service(Idea197164Config config) {
        this.config = config != null ? config : new Idea197164Config();
