...
@Data
public class Idea197128Config {
    private String name = "idea_197128";
 ...
 */
@Slf4j
public class Idea197128Service {
    private static final int IDEA_ID = 197128;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197128Service() {
        this(new Idea197128Config());
    }

    public Idea197128Service(Idea197128Config config) {
        this.config = config != null ? config : new Idea197128Config();
