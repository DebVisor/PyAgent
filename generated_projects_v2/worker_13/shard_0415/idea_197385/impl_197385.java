...
@Data
public class Idea197385Config {
    private String name = "idea_197385";
 ...
 */
@Slf4j
public class Idea197385Service {
    private static final int IDEA_ID = 197385;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197385Service() {
        this(new Idea197385Config());
    }

    public Idea197385Service(Idea197385Config config) {
        this.config = config != null ? config : new Idea197385Config();
