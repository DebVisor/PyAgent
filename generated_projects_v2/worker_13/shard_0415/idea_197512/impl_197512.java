...
@Data
public class Idea197512Config {
    private String name = "idea_197512";
 ...
 */
@Slf4j
public class Idea197512Service {
    private static final int IDEA_ID = 197512;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197512Service() {
        this(new Idea197512Config());
    }

    public Idea197512Service(Idea197512Config config) {
        this.config = config != null ? config : new Idea197512Config();
