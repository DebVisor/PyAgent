...
@Data
public class Idea197510Config {
    private String name = "idea_197510";
 ...
 */
@Slf4j
public class Idea197510Service {
    private static final int IDEA_ID = 197510;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197510Service() {
        this(new Idea197510Config());
    }

    public Idea197510Service(Idea197510Config config) {
        this.config = config != null ? config : new Idea197510Config();
