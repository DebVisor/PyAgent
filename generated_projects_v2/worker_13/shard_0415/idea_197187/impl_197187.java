...
@Data
public class Idea197187Config {
    private String name = "idea_197187";
 ...
 */
@Slf4j
public class Idea197187Service {
    private static final int IDEA_ID = 197187;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197187Service() {
        this(new Idea197187Config());
    }

    public Idea197187Service(Idea197187Config config) {
        this.config = config != null ? config : new Idea197187Config();
