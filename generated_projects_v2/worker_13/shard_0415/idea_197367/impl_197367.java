...
@Data
public class Idea197367Config {
    private String name = "idea_197367";
 ...
 */
@Slf4j
public class Idea197367Service {
    private static final int IDEA_ID = 197367;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197367Service() {
        this(new Idea197367Config());
    }

    public Idea197367Service(Idea197367Config config) {
        this.config = config != null ? config : new Idea197367Config();
