...
@Data
public class Idea197452Config {
    private String name = "idea_197452";
 ...
 */
@Slf4j
public class Idea197452Service {
    private static final int IDEA_ID = 197452;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197452Service() {
        this(new Idea197452Config());
    }

    public Idea197452Service(Idea197452Config config) {
        this.config = config != null ? config : new Idea197452Config();
