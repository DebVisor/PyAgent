...
@Data
public class Idea197503Config {
    private String name = "idea_197503";
 ...
 */
@Slf4j
public class Idea197503Service {
    private static final int IDEA_ID = 197503;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197503Service() {
        this(new Idea197503Config());
    }

    public Idea197503Service(Idea197503Config config) {
        this.config = config != null ? config : new Idea197503Config();
