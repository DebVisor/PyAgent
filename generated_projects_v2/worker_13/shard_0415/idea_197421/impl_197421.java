...
@Data
public class Idea197421Config {
    private String name = "idea_197421";
 ...
 */
@Slf4j
public class Idea197421Service {
    private static final int IDEA_ID = 197421;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197421Service() {
        this(new Idea197421Config());
    }

    public Idea197421Service(Idea197421Config config) {
        this.config = config != null ? config : new Idea197421Config();
