...
@Data
public class Idea197341Config {
    private String name = "idea_197341";
 ...
 */
@Slf4j
public class Idea197341Service {
    private static final int IDEA_ID = 197341;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197341Service() {
        this(new Idea197341Config());
    }

    public Idea197341Service(Idea197341Config config) {
        this.config = config != null ? config : new Idea197341Config();
