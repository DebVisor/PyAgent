...
@Data
public class Idea197162Config {
    private String name = "idea_197162";
 ...
 */
@Slf4j
public class Idea197162Service {
    private static final int IDEA_ID = 197162;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197162Service() {
        this(new Idea197162Config());
    }

    public Idea197162Service(Idea197162Config config) {
        this.config = config != null ? config : new Idea197162Config();
