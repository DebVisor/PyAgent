...
@Data
public class Idea197227Config {
    private String name = "idea_197227";
 ...
 */
@Slf4j
public class Idea197227Service {
    private static final int IDEA_ID = 197227;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197227Service() {
        this(new Idea197227Config());
    }

    public Idea197227Service(Idea197227Config config) {
        this.config = config != null ? config : new Idea197227Config();
