...
@Data
public class Idea197331Config {
    private String name = "idea_197331";
 ...
 */
@Slf4j
public class Idea197331Service {
    private static final int IDEA_ID = 197331;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197331Service() {
        this(new Idea197331Config());
    }

    public Idea197331Service(Idea197331Config config) {
        this.config = config != null ? config : new Idea197331Config();
