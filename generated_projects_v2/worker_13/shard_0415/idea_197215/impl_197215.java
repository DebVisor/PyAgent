...
@Data
public class Idea197215Config {
    private String name = "idea_197215";
 ...
 */
@Slf4j
public class Idea197215Service {
    private static final int IDEA_ID = 197215;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197215Service() {
        this(new Idea197215Config());
    }

    public Idea197215Service(Idea197215Config config) {
        this.config = config != null ? config : new Idea197215Config();
