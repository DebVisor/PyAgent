...
@Data
public class Idea197458Config {
    private String name = "idea_197458";
 ...
 */
@Slf4j
public class Idea197458Service {
    private static final int IDEA_ID = 197458;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197458Service() {
        this(new Idea197458Config());
    }

    public Idea197458Service(Idea197458Config config) {
        this.config = config != null ? config : new Idea197458Config();
