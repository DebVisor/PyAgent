...
@Data
public class Idea197384Config {
    private String name = "idea_197384";
 ...
 */
@Slf4j
public class Idea197384Service {
    private static final int IDEA_ID = 197384;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197384Service() {
        this(new Idea197384Config());
    }

    public Idea197384Service(Idea197384Config config) {
        this.config = config != null ? config : new Idea197384Config();
