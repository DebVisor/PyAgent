...
@Data
public class Idea197562Config {
    private String name = "idea_197562";
 ...
 */
@Slf4j
public class Idea197562Service {
    private static final int IDEA_ID = 197562;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197562Service() {
        this(new Idea197562Config());
    }

    public Idea197562Service(Idea197562Config config) {
        this.config = config != null ? config : new Idea197562Config();
