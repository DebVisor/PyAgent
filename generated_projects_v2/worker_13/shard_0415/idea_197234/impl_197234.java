...
@Data
public class Idea197234Config {
    private String name = "idea_197234";
 ...
 */
@Slf4j
public class Idea197234Service {
    private static final int IDEA_ID = 197234;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197234Service() {
        this(new Idea197234Config());
    }

    public Idea197234Service(Idea197234Config config) {
        this.config = config != null ? config : new Idea197234Config();
