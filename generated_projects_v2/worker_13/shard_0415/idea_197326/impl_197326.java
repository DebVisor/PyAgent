...
@Data
public class Idea197326Config {
    private String name = "idea_197326";
 ...
 */
@Slf4j
public class Idea197326Service {
    private static final int IDEA_ID = 197326;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197326Service() {
        this(new Idea197326Config());
    }

    public Idea197326Service(Idea197326Config config) {
        this.config = config != null ? config : new Idea197326Config();
