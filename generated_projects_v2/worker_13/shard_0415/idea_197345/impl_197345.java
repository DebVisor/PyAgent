...
@Data
public class Idea197345Config {
    private String name = "idea_197345";
 ...
 */
@Slf4j
public class Idea197345Service {
    private static final int IDEA_ID = 197345;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197345Service() {
        this(new Idea197345Config());
    }

    public Idea197345Service(Idea197345Config config) {
        this.config = config != null ? config : new Idea197345Config();
