...
@Data
public class Idea197392Config {
    private String name = "idea_197392";
 ...
 */
@Slf4j
public class Idea197392Service {
    private static final int IDEA_ID = 197392;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197392Service() {
        this(new Idea197392Config());
    }

    public Idea197392Service(Idea197392Config config) {
        this.config = config != null ? config : new Idea197392Config();
