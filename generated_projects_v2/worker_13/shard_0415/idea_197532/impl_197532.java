...
@Data
public class Idea197532Config {
    private String name = "idea_197532";
 ...
 */
@Slf4j
public class Idea197532Service {
    private static final int IDEA_ID = 197532;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197532Service() {
        this(new Idea197532Config());
    }

    public Idea197532Service(Idea197532Config config) {
        this.config = config != null ? config : new Idea197532Config();
