...
@Data
public class Idea197495Config {
    private String name = "idea_197495";
 ...
 */
@Slf4j
public class Idea197495Service {
    private static final int IDEA_ID = 197495;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197495Service() {
        this(new Idea197495Config());
    }

    public Idea197495Service(Idea197495Config config) {
        this.config = config != null ? config : new Idea197495Config();
