...
@Data
public class Idea197439Config {
    private String name = "idea_197439";
 ...
 */
@Slf4j
public class Idea197439Service {
    private static final int IDEA_ID = 197439;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197439Service() {
        this(new Idea197439Config());
    }

    public Idea197439Service(Idea197439Config config) {
        this.config = config != null ? config : new Idea197439Config();
