...
@Data
public class Idea197545Config {
    private String name = "idea_197545";
 ...
 */
@Slf4j
public class Idea197545Service {
    private static final int IDEA_ID = 197545;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197545Service() {
        this(new Idea197545Config());
    }

    public Idea197545Service(Idea197545Config config) {
        this.config = config != null ? config : new Idea197545Config();
