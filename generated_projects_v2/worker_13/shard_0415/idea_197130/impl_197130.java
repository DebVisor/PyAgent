...
@Data
public class Idea197130Config {
    private String name = "idea_197130";
 ...
 */
@Slf4j
public class Idea197130Service {
    private static final int IDEA_ID = 197130;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197130Service() {
        this(new Idea197130Config());
    }

    public Idea197130Service(Idea197130Config config) {
        this.config = config != null ? config : new Idea197130Config();
