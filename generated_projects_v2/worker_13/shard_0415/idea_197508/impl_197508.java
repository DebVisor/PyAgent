...
@Data
public class Idea197508Config {
    private String name = "idea_197508";
 ...
 */
@Slf4j
public class Idea197508Service {
    private static final int IDEA_ID = 197508;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197508Service() {
        this(new Idea197508Config());
    }

    public Idea197508Service(Idea197508Config config) {
        this.config = config != null ? config : new Idea197508Config();
