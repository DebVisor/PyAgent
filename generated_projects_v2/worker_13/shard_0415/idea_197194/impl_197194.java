...
@Data
public class Idea197194Config {
    private String name = "idea_197194";
 ...
 */
@Slf4j
public class Idea197194Service {
    private static final int IDEA_ID = 197194;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197194Service() {
        this(new Idea197194Config());
    }

    public Idea197194Service(Idea197194Config config) {
        this.config = config != null ? config : new Idea197194Config();
