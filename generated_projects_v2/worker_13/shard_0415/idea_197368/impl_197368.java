...
@Data
public class Idea197368Config {
    private String name = "idea_197368";
 ...
 */
@Slf4j
public class Idea197368Service {
    private static final int IDEA_ID = 197368;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197368Service() {
        this(new Idea197368Config());
    }

    public Idea197368Service(Idea197368Config config) {
        this.config = config != null ? config : new Idea197368Config();
