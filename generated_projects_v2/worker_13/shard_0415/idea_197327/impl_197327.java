...
@Data
public class Idea197327Config {
    private String name = "idea_197327";
 ...
 */
@Slf4j
public class Idea197327Service {
    private static final int IDEA_ID = 197327;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197327Service() {
        this(new Idea197327Config());
    }

    public Idea197327Service(Idea197327Config config) {
        this.config = config != null ? config : new Idea197327Config();
