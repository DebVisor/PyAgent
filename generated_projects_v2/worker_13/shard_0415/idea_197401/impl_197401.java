...
@Data
public class Idea197401Config {
    private String name = "idea_197401";
 ...
 */
@Slf4j
public class Idea197401Service {
    private static final int IDEA_ID = 197401;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197401Service() {
        this(new Idea197401Config());
    }

    public Idea197401Service(Idea197401Config config) {
        this.config = config != null ? config : new Idea197401Config();
