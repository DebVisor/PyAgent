...
@Data
public class Idea197151Config {
    private String name = "idea_197151";
 ...
 */
@Slf4j
public class Idea197151Service {
    private static final int IDEA_ID = 197151;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197151Service() {
        this(new Idea197151Config());
    }

    public Idea197151Service(Idea197151Config config) {
        this.config = config != null ? config : new Idea197151Config();
