...
@Data
public class Idea197418Config {
    private String name = "idea_197418";
 ...
 */
@Slf4j
public class Idea197418Service {
    private static final int IDEA_ID = 197418;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197418Service() {
        this(new Idea197418Config());
    }

    public Idea197418Service(Idea197418Config config) {
        this.config = config != null ? config : new Idea197418Config();
