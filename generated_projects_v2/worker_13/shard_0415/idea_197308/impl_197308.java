...
@Data
public class Idea197308Config {
    private String name = "idea_197308";
 ...
 */
@Slf4j
public class Idea197308Service {
    private static final int IDEA_ID = 197308;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197308Service() {
        this(new Idea197308Config());
    }

    public Idea197308Service(Idea197308Config config) {
        this.config = config != null ? config : new Idea197308Config();
