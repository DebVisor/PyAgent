...
@Data
public class Idea197212Config {
    private String name = "idea_197212";
 ...
 */
@Slf4j
public class Idea197212Service {
    private static final int IDEA_ID = 197212;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197212Service() {
        this(new Idea197212Config());
    }

    public Idea197212Service(Idea197212Config config) {
        this.config = config != null ? config : new Idea197212Config();
