...
@Data
public class Idea197248Config {
    private String name = "idea_197248";
 ...
 */
@Slf4j
public class Idea197248Service {
    private static final int IDEA_ID = 197248;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197248Service() {
        this(new Idea197248Config());
    }

    public Idea197248Service(Idea197248Config config) {
        this.config = config != null ? config : new Idea197248Config();
