...
@Data
public class Idea197539Config {
    private String name = "idea_197539";
 ...
 */
@Slf4j
public class Idea197539Service {
    private static final int IDEA_ID = 197539;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197539Service() {
        this(new Idea197539Config());
    }

    public Idea197539Service(Idea197539Config config) {
        this.config = config != null ? config : new Idea197539Config();
