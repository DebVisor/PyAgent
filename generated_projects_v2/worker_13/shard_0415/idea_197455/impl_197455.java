...
@Data
public class Idea197455Config {
    private String name = "idea_197455";
 ...
 */
@Slf4j
public class Idea197455Service {
    private static final int IDEA_ID = 197455;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197455Service() {
        this(new Idea197455Config());
    }

    public Idea197455Service(Idea197455Config config) {
        this.config = config != null ? config : new Idea197455Config();
