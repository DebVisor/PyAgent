...
@Data
public class Idea197244Config {
    private String name = "idea_197244";
 ...
 */
@Slf4j
public class Idea197244Service {
    private static final int IDEA_ID = 197244;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197244Service() {
        this(new Idea197244Config());
    }

    public Idea197244Service(Idea197244Config config) {
        this.config = config != null ? config : new Idea197244Config();
