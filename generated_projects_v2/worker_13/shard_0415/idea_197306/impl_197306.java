...
@Data
public class Idea197306Config {
    private String name = "idea_197306";
 ...
 */
@Slf4j
public class Idea197306Service {
    private static final int IDEA_ID = 197306;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197306Service() {
        this(new Idea197306Config());
    }

    public Idea197306Service(Idea197306Config config) {
        this.config = config != null ? config : new Idea197306Config();
