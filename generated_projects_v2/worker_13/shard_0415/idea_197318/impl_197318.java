...
@Data
public class Idea197318Config {
    private String name = "idea_197318";
 ...
 */
@Slf4j
public class Idea197318Service {
    private static final int IDEA_ID = 197318;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197318Service() {
        this(new Idea197318Config());
    }

    public Idea197318Service(Idea197318Config config) {
        this.config = config != null ? config : new Idea197318Config();
