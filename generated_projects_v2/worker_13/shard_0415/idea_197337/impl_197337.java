...
@Data
public class Idea197337Config {
    private String name = "idea_197337";
 ...
 */
@Slf4j
public class Idea197337Service {
    private static final int IDEA_ID = 197337;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197337Service() {
        this(new Idea197337Config());
    }

    public Idea197337Service(Idea197337Config config) {
        this.config = config != null ? config : new Idea197337Config();
