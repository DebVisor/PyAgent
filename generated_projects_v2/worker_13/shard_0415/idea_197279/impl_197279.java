...
@Data
public class Idea197279Config {
    private String name = "idea_197279";
 ...
 */
@Slf4j
public class Idea197279Service {
    private static final int IDEA_ID = 197279;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197279Service() {
        this(new Idea197279Config());
    }

    public Idea197279Service(Idea197279Config config) {
        this.config = config != null ? config : new Idea197279Config();
