...
@Data
public class Idea197322Config {
    private String name = "idea_197322";
 ...
 */
@Slf4j
public class Idea197322Service {
    private static final int IDEA_ID = 197322;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197322Service() {
        this(new Idea197322Config());
    }

    public Idea197322Service(Idea197322Config config) {
        this.config = config != null ? config : new Idea197322Config();
