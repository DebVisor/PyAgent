...
@Data
public class Idea197229Config {
    private String name = "idea_197229";
 ...
 */
@Slf4j
public class Idea197229Service {
    private static final int IDEA_ID = 197229;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197229Service() {
        this(new Idea197229Config());
    }

    public Idea197229Service(Idea197229Config config) {
        this.config = config != null ? config : new Idea197229Config();
