...
@Data
public class Idea197144Config {
    private String name = "idea_197144";
 ...
 */
@Slf4j
public class Idea197144Service {
    private static final int IDEA_ID = 197144;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197144Service() {
        this(new Idea197144Config());
    }

    public Idea197144Service(Idea197144Config config) {
        this.config = config != null ? config : new Idea197144Config();
