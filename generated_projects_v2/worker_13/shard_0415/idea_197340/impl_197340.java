...
@Data
public class Idea197340Config {
    private String name = "idea_197340";
 ...
 */
@Slf4j
public class Idea197340Service {
    private static final int IDEA_ID = 197340;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197340Service() {
        this(new Idea197340Config());
    }

    public Idea197340Service(Idea197340Config config) {
        this.config = config != null ? config : new Idea197340Config();
