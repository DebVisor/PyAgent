...
@Data
public class Idea197245Config {
    private String name = "idea_197245";
 ...
 */
@Slf4j
public class Idea197245Service {
    private static final int IDEA_ID = 197245;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197245Service() {
        this(new Idea197245Config());
    }

    public Idea197245Service(Idea197245Config config) {
        this.config = config != null ? config : new Idea197245Config();
