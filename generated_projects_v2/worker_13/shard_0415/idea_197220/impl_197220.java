...
@Data
public class Idea197220Config {
    private String name = "idea_197220";
 ...
 */
@Slf4j
public class Idea197220Service {
    private static final int IDEA_ID = 197220;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197220Service() {
        this(new Idea197220Config());
    }

    public Idea197220Service(Idea197220Config config) {
        this.config = config != null ? config : new Idea197220Config();
