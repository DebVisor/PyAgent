...
@Data
public class Idea197364Config {
    private String name = "idea_197364";
 ...
 */
@Slf4j
public class Idea197364Service {
    private static final int IDEA_ID = 197364;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197364Service() {
        this(new Idea197364Config());
    }

    public Idea197364Service(Idea197364Config config) {
        this.config = config != null ? config : new Idea197364Config();
