...
@Data
public class Idea197587Config {
    private String name = "idea_197587";
 ...
 */
@Slf4j
public class Idea197587Service {
    private static final int IDEA_ID = 197587;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197587Service() {
        this(new Idea197587Config());
    }

    public Idea197587Service(Idea197587Config config) {
        this.config = config != null ? config : new Idea197587Config();
