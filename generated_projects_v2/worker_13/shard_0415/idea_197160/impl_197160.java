...
@Data
public class Idea197160Config {
    private String name = "idea_197160";
 ...
 */
@Slf4j
public class Idea197160Service {
    private static final int IDEA_ID = 197160;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197160Service() {
        this(new Idea197160Config());
    }

    public Idea197160Service(Idea197160Config config) {
        this.config = config != null ? config : new Idea197160Config();
