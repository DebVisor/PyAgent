...
@Data
public class Idea197457Config {
    private String name = "idea_197457";
 ...
 */
@Slf4j
public class Idea197457Service {
    private static final int IDEA_ID = 197457;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197457Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197457Service() {
        this(new Idea197457Config());
    }

    public Idea197457Service(Idea197457Config config) {
        this.config = config != null ? config : new Idea197457Config();
