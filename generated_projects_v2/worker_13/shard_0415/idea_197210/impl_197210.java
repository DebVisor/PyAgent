...
@Data
public class Idea197210Config {
    private String name = "idea_197210";
 ...
 */
@Slf4j
public class Idea197210Service {
    private static final int IDEA_ID = 197210;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197210Service() {
        this(new Idea197210Config());
    }

    public Idea197210Service(Idea197210Config config) {
        this.config = config != null ? config : new Idea197210Config();
