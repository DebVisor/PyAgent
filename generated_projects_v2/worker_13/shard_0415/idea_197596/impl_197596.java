...
@Data
public class Idea197596Config {
    private String name = "idea_197596";
 ...
 */
@Slf4j
public class Idea197596Service {
    private static final int IDEA_ID = 197596;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197596Service() {
        this(new Idea197596Config());
    }

    public Idea197596Service(Idea197596Config config) {
        this.config = config != null ? config : new Idea197596Config();
