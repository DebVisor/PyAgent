...
@Data
public class Idea197304Config {
    private String name = "idea_197304";
 ...
 */
@Slf4j
public class Idea197304Service {
    private static final int IDEA_ID = 197304;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197304Service() {
        this(new Idea197304Config());
    }

    public Idea197304Service(Idea197304Config config) {
        this.config = config != null ? config : new Idea197304Config();
