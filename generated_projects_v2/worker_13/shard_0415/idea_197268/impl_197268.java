...
@Data
public class Idea197268Config {
    private String name = "idea_197268";
 ...
 */
@Slf4j
public class Idea197268Service {
    private static final int IDEA_ID = 197268;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197268Service() {
        this(new Idea197268Config());
    }

    public Idea197268Service(Idea197268Config config) {
        this.config = config != null ? config : new Idea197268Config();
