...
@Data
public class Idea197339Config {
    private String name = "idea_197339";
 ...
 */
@Slf4j
public class Idea197339Service {
    private static final int IDEA_ID = 197339;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197339Service() {
        this(new Idea197339Config());
    }

    public Idea197339Service(Idea197339Config config) {
        this.config = config != null ? config : new Idea197339Config();
