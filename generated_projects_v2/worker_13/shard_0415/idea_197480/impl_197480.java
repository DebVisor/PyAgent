...
@Data
public class Idea197480Config {
    private String name = "idea_197480";
 ...
 */
@Slf4j
public class Idea197480Service {
    private static final int IDEA_ID = 197480;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197480Service() {
        this(new Idea197480Config());
    }

    public Idea197480Service(Idea197480Config config) {
        this.config = config != null ? config : new Idea197480Config();
