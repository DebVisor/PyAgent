...
@Data
public class Idea197146Config {
    private String name = "idea_197146";
 ...
 */
@Slf4j
public class Idea197146Service {
    private static final int IDEA_ID = 197146;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197146Service() {
        this(new Idea197146Config());
    }

    public Idea197146Service(Idea197146Config config) {
        this.config = config != null ? config : new Idea197146Config();
