...
@Data
public class Idea197125Config {
    private String name = "idea_197125";
 ...
 */
@Slf4j
public class Idea197125Service {
    private static final int IDEA_ID = 197125;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197125Service() {
        this(new Idea197125Config());
    }

    public Idea197125Service(Idea197125Config config) {
        this.config = config != null ? config : new Idea197125Config();
