...
@Data
public class Idea197224Config {
    private String name = "idea_197224";
 ...
 */
@Slf4j
public class Idea197224Service {
    private static final int IDEA_ID = 197224;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197224Service() {
        this(new Idea197224Config());
    }

    public Idea197224Service(Idea197224Config config) {
        this.config = config != null ? config : new Idea197224Config();
