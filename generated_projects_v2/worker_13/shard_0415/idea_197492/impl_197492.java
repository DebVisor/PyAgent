...
@Data
public class Idea197492Config {
    private String name = "idea_197492";
 ...
 */
@Slf4j
public class Idea197492Service {
    private static final int IDEA_ID = 197492;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197492Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197492Service() {
        this(new Idea197492Config());
    }

    public Idea197492Service(Idea197492Config config) {
        this.config = config != null ? config : new Idea197492Config();
