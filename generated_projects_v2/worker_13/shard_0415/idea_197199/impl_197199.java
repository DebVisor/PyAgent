...
@Data
public class Idea197199Config {
    private String name = "idea_197199";
 ...
 */
@Slf4j
public class Idea197199Service {
    private static final int IDEA_ID = 197199;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197199Service() {
        this(new Idea197199Config());
    }

    public Idea197199Service(Idea197199Config config) {
        this.config = config != null ? config : new Idea197199Config();
