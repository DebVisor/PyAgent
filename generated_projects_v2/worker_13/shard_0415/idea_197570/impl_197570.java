...
@Data
public class Idea197570Config {
    private String name = "idea_197570";
 ...
 */
@Slf4j
public class Idea197570Service {
    private static final int IDEA_ID = 197570;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197570Service() {
        this(new Idea197570Config());
    }

    public Idea197570Service(Idea197570Config config) {
        this.config = config != null ? config : new Idea197570Config();
