...
@Data
public class Idea197423Config {
    private String name = "idea_197423";
 ...
 */
@Slf4j
public class Idea197423Service {
    private static final int IDEA_ID = 197423;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197423Service() {
        this(new Idea197423Config());
    }

    public Idea197423Service(Idea197423Config config) {
        this.config = config != null ? config : new Idea197423Config();
