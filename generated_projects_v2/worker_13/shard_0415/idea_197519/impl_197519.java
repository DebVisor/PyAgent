...
@Data
public class Idea197519Config {
    private String name = "idea_197519";
 ...
 */
@Slf4j
public class Idea197519Service {
    private static final int IDEA_ID = 197519;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197519Service() {
        this(new Idea197519Config());
    }

    public Idea197519Service(Idea197519Config config) {
        this.config = config != null ? config : new Idea197519Config();
