...
@Data
public class Idea197253Config {
    private String name = "idea_197253";
 ...
 */
@Slf4j
public class Idea197253Service {
    private static final int IDEA_ID = 197253;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197253Service() {
        this(new Idea197253Config());
    }

    public Idea197253Service(Idea197253Config config) {
        this.config = config != null ? config : new Idea197253Config();
