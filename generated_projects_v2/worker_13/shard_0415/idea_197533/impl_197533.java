...
@Data
public class Idea197533Config {
    private String name = "idea_197533";
 ...
 */
@Slf4j
public class Idea197533Service {
    private static final int IDEA_ID = 197533;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197533Service() {
        this(new Idea197533Config());
    }

    public Idea197533Service(Idea197533Config config) {
        this.config = config != null ? config : new Idea197533Config();
