...
@Data
public class Idea197598Config {
    private String name = "idea_197598";
 ...
 */
@Slf4j
public class Idea197598Service {
    private static final int IDEA_ID = 197598;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197598Service() {
        this(new Idea197598Config());
    }

    public Idea197598Service(Idea197598Config config) {
        this.config = config != null ? config : new Idea197598Config();
