...
@Data
public class Idea197502Config {
    private String name = "idea_197502";
 ...
 */
@Slf4j
public class Idea197502Service {
    private static final int IDEA_ID = 197502;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197502Service() {
        this(new Idea197502Config());
    }

    public Idea197502Service(Idea197502Config config) {
        this.config = config != null ? config : new Idea197502Config();
