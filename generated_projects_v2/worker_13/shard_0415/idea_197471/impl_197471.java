...
@Data
public class Idea197471Config {
    private String name = "idea_197471";
 ...
 */
@Slf4j
public class Idea197471Service {
    private static final int IDEA_ID = 197471;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197471Service() {
        this(new Idea197471Config());
    }

    public Idea197471Service(Idea197471Config config) {
        this.config = config != null ? config : new Idea197471Config();
