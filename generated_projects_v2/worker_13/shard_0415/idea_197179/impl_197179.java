...
@Data
public class Idea197179Config {
    private String name = "idea_197179";
 ...
 */
@Slf4j
public class Idea197179Service {
    private static final int IDEA_ID = 197179;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197179Service() {
        this(new Idea197179Config());
    }

    public Idea197179Service(Idea197179Config config) {
        this.config = config != null ? config : new Idea197179Config();
