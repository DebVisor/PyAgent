...
@Data
public class Idea197335Config {
    private String name = "idea_197335";
 ...
 */
@Slf4j
public class Idea197335Service {
    private static final int IDEA_ID = 197335;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197335Service() {
        this(new Idea197335Config());
    }

    public Idea197335Service(Idea197335Config config) {
        this.config = config != null ? config : new Idea197335Config();
