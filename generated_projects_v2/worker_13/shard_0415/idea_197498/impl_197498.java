...
@Data
public class Idea197498Config {
    private String name = "idea_197498";
 ...
 */
@Slf4j
public class Idea197498Service {
    private static final int IDEA_ID = 197498;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197498Service() {
        this(new Idea197498Config());
    }

    public Idea197498Service(Idea197498Config config) {
        this.config = config != null ? config : new Idea197498Config();
