...
@Data
public class Idea197257Config {
    private String name = "idea_197257";
 ...
 */
@Slf4j
public class Idea197257Service {
    private static final int IDEA_ID = 197257;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197257Service() {
        this(new Idea197257Config());
    }

    public Idea197257Service(Idea197257Config config) {
        this.config = config != null ? config : new Idea197257Config();
