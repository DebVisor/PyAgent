...
@Data
public class Idea197451Config {
    private String name = "idea_197451";
 ...
 */
@Slf4j
public class Idea197451Service {
    private static final int IDEA_ID = 197451;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197451Service() {
        this(new Idea197451Config());
    }

    public Idea197451Service(Idea197451Config config) {
        this.config = config != null ? config : new Idea197451Config();
