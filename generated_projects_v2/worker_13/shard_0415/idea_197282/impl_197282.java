...
@Data
public class Idea197282Config {
    private String name = "idea_197282";
 ...
 */
@Slf4j
public class Idea197282Service {
    private static final int IDEA_ID = 197282;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197282Service() {
        this(new Idea197282Config());
    }

    public Idea197282Service(Idea197282Config config) {
        this.config = config != null ? config : new Idea197282Config();
