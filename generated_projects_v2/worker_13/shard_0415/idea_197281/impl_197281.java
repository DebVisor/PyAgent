...
@Data
public class Idea197281Config {
    private String name = "idea_197281";
 ...
 */
@Slf4j
public class Idea197281Service {
    private static final int IDEA_ID = 197281;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197281Service() {
        this(new Idea197281Config());
    }

    public Idea197281Service(Idea197281Config config) {
        this.config = config != null ? config : new Idea197281Config();
