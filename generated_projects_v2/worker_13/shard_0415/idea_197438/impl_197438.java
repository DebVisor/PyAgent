...
@Data
public class Idea197438Config {
    private String name = "idea_197438";
 ...
 */
@Slf4j
public class Idea197438Service {
    private static final int IDEA_ID = 197438;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197438Service() {
        this(new Idea197438Config());
    }

    public Idea197438Service(Idea197438Config config) {
        this.config = config != null ? config : new Idea197438Config();
