...
@Data
public class Idea197453Config {
    private String name = "idea_197453";
 ...
 */
@Slf4j
public class Idea197453Service {
    private static final int IDEA_ID = 197453;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197453Service() {
        this(new Idea197453Config());
    }

    public Idea197453Service(Idea197453Config config) {
        this.config = config != null ? config : new Idea197453Config();
