...
@Data
public class Idea197456Config {
    private String name = "idea_197456";
 ...
 */
@Slf4j
public class Idea197456Service {
    private static final int IDEA_ID = 197456;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197456Service() {
        this(new Idea197456Config());
    }

    public Idea197456Service(Idea197456Config config) {
        this.config = config != null ? config : new Idea197456Config();
