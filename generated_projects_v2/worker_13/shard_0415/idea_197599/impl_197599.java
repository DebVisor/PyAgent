...
@Data
public class Idea197599Config {
    private String name = "idea_197599";
 ...
 */
@Slf4j
public class Idea197599Service {
    private static final int IDEA_ID = 197599;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197599Service() {
        this(new Idea197599Config());
    }

    public Idea197599Service(Idea197599Config config) {
        this.config = config != null ? config : new Idea197599Config();
