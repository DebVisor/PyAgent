...
@Data
public class Idea197126Config {
    private String name = "idea_197126";
 ...
 */
@Slf4j
public class Idea197126Service {
    private static final int IDEA_ID = 197126;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197126Service() {
        this(new Idea197126Config());
    }

    public Idea197126Service(Idea197126Config config) {
        this.config = config != null ? config : new Idea197126Config();
