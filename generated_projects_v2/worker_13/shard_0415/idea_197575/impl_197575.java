...
@Data
public class Idea197575Config {
    private String name = "idea_197575";
 ...
 */
@Slf4j
public class Idea197575Service {
    private static final int IDEA_ID = 197575;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197575Service() {
        this(new Idea197575Config());
    }

    public Idea197575Service(Idea197575Config config) {
        this.config = config != null ? config : new Idea197575Config();
