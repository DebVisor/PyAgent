...
@Data
public class Idea197589Config {
    private String name = "idea_197589";
 ...
 */
@Slf4j
public class Idea197589Service {
    private static final int IDEA_ID = 197589;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197589Service() {
        this(new Idea197589Config());
    }

    public Idea197589Service(Idea197589Config config) {
        this.config = config != null ? config : new Idea197589Config();
