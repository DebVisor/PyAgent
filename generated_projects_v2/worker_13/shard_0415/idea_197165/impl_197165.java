...
@Data
public class Idea197165Config {
    private String name = "idea_197165";
 ...
 */
@Slf4j
public class Idea197165Service {
    private static final int IDEA_ID = 197165;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197165Service() {
        this(new Idea197165Config());
    }

    public Idea197165Service(Idea197165Config config) {
        this.config = config != null ? config : new Idea197165Config();
