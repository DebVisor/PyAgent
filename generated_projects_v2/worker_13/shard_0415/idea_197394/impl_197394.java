...
@Data
public class Idea197394Config {
    private String name = "idea_197394";
 ...
 */
@Slf4j
public class Idea197394Service {
    private static final int IDEA_ID = 197394;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197394Service() {
        this(new Idea197394Config());
    }

    public Idea197394Service(Idea197394Config config) {
        this.config = config != null ? config : new Idea197394Config();
