...
@Data
public class Idea197129Config {
    private String name = "idea_197129";
 ...
 */
@Slf4j
public class Idea197129Service {
    private static final int IDEA_ID = 197129;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197129Service() {
        this(new Idea197129Config());
    }

    public Idea197129Service(Idea197129Config config) {
        this.config = config != null ? config : new Idea197129Config();
