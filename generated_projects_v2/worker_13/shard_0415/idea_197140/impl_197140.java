...
@Data
public class Idea197140Config {
    private String name = "idea_197140";
 ...
 */
@Slf4j
public class Idea197140Service {
    private static final int IDEA_ID = 197140;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197140Service() {
        this(new Idea197140Config());
    }

    public Idea197140Service(Idea197140Config config) {
        this.config = config != null ? config : new Idea197140Config();
