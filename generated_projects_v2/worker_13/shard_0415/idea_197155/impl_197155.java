...
@Data
public class Idea197155Config {
    private String name = "idea_197155";
 ...
 */
@Slf4j
public class Idea197155Service {
    private static final int IDEA_ID = 197155;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197155Service() {
        this(new Idea197155Config());
    }

    public Idea197155Service(Idea197155Config config) {
        this.config = config != null ? config : new Idea197155Config();
