...
@Data
public class Idea197303Config {
    private String name = "idea_197303";
 ...
 */
@Slf4j
public class Idea197303Service {
    private static final int IDEA_ID = 197303;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197303Service() {
        this(new Idea197303Config());
    }

    public Idea197303Service(Idea197303Config config) {
        this.config = config != null ? config : new Idea197303Config();
