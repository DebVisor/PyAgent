...
@Data
public class Idea197182Config {
    private String name = "idea_197182";
 ...
 */
@Slf4j
public class Idea197182Service {
    private static final int IDEA_ID = 197182;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197182Service() {
        this(new Idea197182Config());
    }

    public Idea197182Service(Idea197182Config config) {
        this.config = config != null ? config : new Idea197182Config();
