...
@Data
public class Idea197188Config {
    private String name = "idea_197188";
 ...
 */
@Slf4j
public class Idea197188Service {
    private static final int IDEA_ID = 197188;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197188Service() {
        this(new Idea197188Config());
    }

    public Idea197188Service(Idea197188Config config) {
        this.config = config != null ? config : new Idea197188Config();
