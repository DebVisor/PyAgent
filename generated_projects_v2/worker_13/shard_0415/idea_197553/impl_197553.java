...
@Data
public class Idea197553Config {
    private String name = "idea_197553";
 ...
 */
@Slf4j
public class Idea197553Service {
    private static final int IDEA_ID = 197553;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197553Service() {
        this(new Idea197553Config());
    }

    public Idea197553Service(Idea197553Config config) {
        this.config = config != null ? config : new Idea197553Config();
