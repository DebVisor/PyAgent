...
@Data
public class Idea197482Config {
    private String name = "idea_197482";
 ...
 */
@Slf4j
public class Idea197482Service {
    private static final int IDEA_ID = 197482;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197482Service() {
        this(new Idea197482Config());
    }

    public Idea197482Service(Idea197482Config config) {
        this.config = config != null ? config : new Idea197482Config();
