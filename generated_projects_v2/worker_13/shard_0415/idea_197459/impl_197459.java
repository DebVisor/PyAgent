...
@Data
public class Idea197459Config {
    private String name = "idea_197459";
 ...
 */
@Slf4j
public class Idea197459Service {
    private static final int IDEA_ID = 197459;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197459Service() {
        this(new Idea197459Config());
    }

    public Idea197459Service(Idea197459Config config) {
        this.config = config != null ? config : new Idea197459Config();
