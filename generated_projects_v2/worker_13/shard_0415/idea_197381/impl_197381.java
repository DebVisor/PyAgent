...
@Data
public class Idea197381Config {
    private String name = "idea_197381";
 ...
 */
@Slf4j
public class Idea197381Service {
    private static final int IDEA_ID = 197381;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197381Service() {
        this(new Idea197381Config());
    }

    public Idea197381Service(Idea197381Config config) {
        this.config = config != null ? config : new Idea197381Config();
