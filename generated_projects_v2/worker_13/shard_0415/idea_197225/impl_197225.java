...
@Data
public class Idea197225Config {
    private String name = "idea_197225";
 ...
 */
@Slf4j
public class Idea197225Service {
    private static final int IDEA_ID = 197225;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197225Service() {
        this(new Idea197225Config());
    }

    public Idea197225Service(Idea197225Config config) {
        this.config = config != null ? config : new Idea197225Config();
