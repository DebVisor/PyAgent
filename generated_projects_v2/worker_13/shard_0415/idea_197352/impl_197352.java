...
@Data
public class Idea197352Config {
    private String name = "idea_197352";
 ...
 */
@Slf4j
public class Idea197352Service {
    private static final int IDEA_ID = 197352;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197352Service() {
        this(new Idea197352Config());
    }

    public Idea197352Service(Idea197352Config config) {
        this.config = config != null ? config : new Idea197352Config();
