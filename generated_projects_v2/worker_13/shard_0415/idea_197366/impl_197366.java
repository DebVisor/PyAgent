...
@Data
public class Idea197366Config {
    private String name = "idea_197366";
 ...
 */
@Slf4j
public class Idea197366Service {
    private static final int IDEA_ID = 197366;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197366Service() {
        this(new Idea197366Config());
    }

    public Idea197366Service(Idea197366Config config) {
        this.config = config != null ? config : new Idea197366Config();
