...
@Data
public class Idea197572Config {
    private String name = "idea_197572";
 ...
 */
@Slf4j
public class Idea197572Service {
    private static final int IDEA_ID = 197572;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197572Service() {
        this(new Idea197572Config());
    }

    public Idea197572Service(Idea197572Config config) {
        this.config = config != null ? config : new Idea197572Config();
