...
@Data
public class Idea197557Config {
    private String name = "idea_197557";
 ...
 */
@Slf4j
public class Idea197557Service {
    private static final int IDEA_ID = 197557;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197557Service() {
        this(new Idea197557Config());
    }

    public Idea197557Service(Idea197557Config config) {
        this.config = config != null ? config : new Idea197557Config();
