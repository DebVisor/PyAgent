...
@Data
public class Idea197284Config {
    private String name = "idea_197284";
 ...
 */
@Slf4j
public class Idea197284Service {
    private static final int IDEA_ID = 197284;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197284Service() {
        this(new Idea197284Config());
    }

    public Idea197284Service(Idea197284Config config) {
        this.config = config != null ? config : new Idea197284Config();
