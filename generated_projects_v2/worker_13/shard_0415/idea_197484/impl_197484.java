...
@Data
public class Idea197484Config {
    private String name = "idea_197484";
 ...
 */
@Slf4j
public class Idea197484Service {
    private static final int IDEA_ID = 197484;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197484Service() {
        this(new Idea197484Config());
    }

    public Idea197484Service(Idea197484Config config) {
        this.config = config != null ? config : new Idea197484Config();
