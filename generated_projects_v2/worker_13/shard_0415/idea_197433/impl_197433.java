...
@Data
public class Idea197433Config {
    private String name = "idea_197433";
 ...
 */
@Slf4j
public class Idea197433Service {
    private static final int IDEA_ID = 197433;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197433Service() {
        this(new Idea197433Config());
    }

    public Idea197433Service(Idea197433Config config) {
        this.config = config != null ? config : new Idea197433Config();
