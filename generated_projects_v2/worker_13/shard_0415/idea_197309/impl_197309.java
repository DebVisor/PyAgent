...
@Data
public class Idea197309Config {
    private String name = "idea_197309";
 ...
 */
@Slf4j
public class Idea197309Service {
    private static final int IDEA_ID = 197309;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197309Service() {
        this(new Idea197309Config());
    }

    public Idea197309Service(Idea197309Config config) {
        this.config = config != null ? config : new Idea197309Config();
