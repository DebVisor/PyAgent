...
@Data
public class Idea197323Config {
    private String name = "idea_197323";
 ...
 */
@Slf4j
public class Idea197323Service {
    private static final int IDEA_ID = 197323;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197323Service() {
        this(new Idea197323Config());
    }

    public Idea197323Service(Idea197323Config config) {
        this.config = config != null ? config : new Idea197323Config();
