...
@Data
public class Idea197246Config {
    private String name = "idea_197246";
 ...
 */
@Slf4j
public class Idea197246Service {
    private static final int IDEA_ID = 197246;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197246Service() {
        this(new Idea197246Config());
    }

    public Idea197246Service(Idea197246Config config) {
        this.config = config != null ? config : new Idea197246Config();
