...
@Data
public class Idea197540Config {
    private String name = "idea_197540";
 ...
 */
@Slf4j
public class Idea197540Service {
    private static final int IDEA_ID = 197540;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197540Service() {
        this(new Idea197540Config());
    }

    public Idea197540Service(Idea197540Config config) {
        this.config = config != null ? config : new Idea197540Config();
