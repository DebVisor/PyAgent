...
@Data
public class Idea197568Config {
    private String name = "idea_197568";
 ...
 */
@Slf4j
public class Idea197568Service {
    private static final int IDEA_ID = 197568;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197568Service() {
        this(new Idea197568Config());
    }

    public Idea197568Service(Idea197568Config config) {
        this.config = config != null ? config : new Idea197568Config();
