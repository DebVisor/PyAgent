...
@Data
public class Idea197362Config {
    private String name = "idea_197362";
 ...
 */
@Slf4j
public class Idea197362Service {
    private static final int IDEA_ID = 197362;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197362Service() {
        this(new Idea197362Config());
    }

    public Idea197362Service(Idea197362Config config) {
        this.config = config != null ? config : new Idea197362Config();
