...
@Data
public class Idea197205Config {
    private String name = "idea_197205";
 ...
 */
@Slf4j
public class Idea197205Service {
    private static final int IDEA_ID = 197205;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197205Service() {
        this(new Idea197205Config());
    }

    public Idea197205Service(Idea197205Config config) {
        this.config = config != null ? config : new Idea197205Config();
