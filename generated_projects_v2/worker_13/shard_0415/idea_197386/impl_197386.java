...
@Data
public class Idea197386Config {
    private String name = "idea_197386";
 ...
 */
@Slf4j
public class Idea197386Service {
    private static final int IDEA_ID = 197386;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197386Service() {
        this(new Idea197386Config());
    }

    public Idea197386Service(Idea197386Config config) {
        this.config = config != null ? config : new Idea197386Config();
