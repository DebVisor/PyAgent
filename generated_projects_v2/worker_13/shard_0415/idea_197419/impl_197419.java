...
@Data
public class Idea197419Config {
    private String name = "idea_197419";
 ...
 */
@Slf4j
public class Idea197419Service {
    private static final int IDEA_ID = 197419;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197419Service() {
        this(new Idea197419Config());
    }

    public Idea197419Service(Idea197419Config config) {
        this.config = config != null ? config : new Idea197419Config();
