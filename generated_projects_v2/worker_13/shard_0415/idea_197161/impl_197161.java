...
@Data
public class Idea197161Config {
    private String name = "idea_197161";
 ...
 */
@Slf4j
public class Idea197161Service {
    private static final int IDEA_ID = 197161;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197161Service() {
        this(new Idea197161Config());
    }

    public Idea197161Service(Idea197161Config config) {
        this.config = config != null ? config : new Idea197161Config();
