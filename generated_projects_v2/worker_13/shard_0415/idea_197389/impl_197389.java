...
@Data
public class Idea197389Config {
    private String name = "idea_197389";
 ...
 */
@Slf4j
public class Idea197389Service {
    private static final int IDEA_ID = 197389;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197389Service() {
        this(new Idea197389Config());
    }

    public Idea197389Service(Idea197389Config config) {
        this.config = config != null ? config : new Idea197389Config();
