...
@Data
public class Idea197444Config {
    private String name = "idea_197444";
 ...
 */
@Slf4j
public class Idea197444Service {
    private static final int IDEA_ID = 197444;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197444Service() {
        this(new Idea197444Config());
    }

    public Idea197444Service(Idea197444Config config) {
        this.config = config != null ? config : new Idea197444Config();
