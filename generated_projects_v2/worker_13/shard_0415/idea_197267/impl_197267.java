...
@Data
public class Idea197267Config {
    private String name = "idea_197267";
 ...
 */
@Slf4j
public class Idea197267Service {
    private static final int IDEA_ID = 197267;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197267Service() {
        this(new Idea197267Config());
    }

    public Idea197267Service(Idea197267Config config) {
        this.config = config != null ? config : new Idea197267Config();
