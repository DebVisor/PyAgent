...
@Data
public class Idea197351Config {
    private String name = "idea_197351";
 ...
 */
@Slf4j
public class Idea197351Service {
    private static final int IDEA_ID = 197351;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197351Service() {
        this(new Idea197351Config());
    }

    public Idea197351Service(Idea197351Config config) {
        this.config = config != null ? config : new Idea197351Config();
