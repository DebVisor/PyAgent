...
@Data
public class Idea197136Config {
    private String name = "idea_197136";
 ...
 */
@Slf4j
public class Idea197136Service {
    private static final int IDEA_ID = 197136;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197136Service() {
        this(new Idea197136Config());
    }

    public Idea197136Service(Idea197136Config config) {
        this.config = config != null ? config : new Idea197136Config();
