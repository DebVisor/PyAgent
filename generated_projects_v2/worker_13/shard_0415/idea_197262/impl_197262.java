...
@Data
public class Idea197262Config {
    private String name = "idea_197262";
 ...
 */
@Slf4j
public class Idea197262Service {
    private static final int IDEA_ID = 197262;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197262Service() {
        this(new Idea197262Config());
    }

    public Idea197262Service(Idea197262Config config) {
        this.config = config != null ? config : new Idea197262Config();
