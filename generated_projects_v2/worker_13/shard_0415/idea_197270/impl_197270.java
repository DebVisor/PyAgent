...
@Data
public class Idea197270Config {
    private String name = "idea_197270";
 ...
 */
@Slf4j
public class Idea197270Service {
    private static final int IDEA_ID = 197270;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197270Service() {
        this(new Idea197270Config());
    }

    public Idea197270Service(Idea197270Config config) {
        this.config = config != null ? config : new Idea197270Config();
