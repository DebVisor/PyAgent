...
@Data
public class Idea197468Config {
    private String name = "idea_197468";
 ...
 */
@Slf4j
public class Idea197468Service {
    private static final int IDEA_ID = 197468;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197468Service() {
        this(new Idea197468Config());
    }

    public Idea197468Service(Idea197468Config config) {
        this.config = config != null ? config : new Idea197468Config();
