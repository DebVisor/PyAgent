...
@Data
public class Idea197180Config {
    private String name = "idea_197180";
 ...
 */
@Slf4j
public class Idea197180Service {
    private static final int IDEA_ID = 197180;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197180Service() {
        this(new Idea197180Config());
    }

    public Idea197180Service(Idea197180Config config) {
        this.config = config != null ? config : new Idea197180Config();
