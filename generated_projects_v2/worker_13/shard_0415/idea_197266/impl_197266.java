...
@Data
public class Idea197266Config {
    private String name = "idea_197266";
 ...
 */
@Slf4j
public class Idea197266Service {
    private static final int IDEA_ID = 197266;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197266Service() {
        this(new Idea197266Config());
    }

    public Idea197266Service(Idea197266Config config) {
        this.config = config != null ? config : new Idea197266Config();
