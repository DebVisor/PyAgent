...
@Data
public class Idea197534Config {
    private String name = "idea_197534";
 ...
 */
@Slf4j
public class Idea197534Service {
    private static final int IDEA_ID = 197534;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197534Service() {
        this(new Idea197534Config());
    }

    public Idea197534Service(Idea197534Config config) {
        this.config = config != null ? config : new Idea197534Config();
