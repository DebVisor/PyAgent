...
@Data
public class Idea197132Config {
    private String name = "idea_197132";
 ...
 */
@Slf4j
public class Idea197132Service {
    private static final int IDEA_ID = 197132;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197132Service() {
        this(new Idea197132Config());
    }

    public Idea197132Service(Idea197132Config config) {
        this.config = config != null ? config : new Idea197132Config();
