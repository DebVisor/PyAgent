...
@Data
public class Idea197330Config {
    private String name = "idea_197330";
 ...
 */
@Slf4j
public class Idea197330Service {
    private static final int IDEA_ID = 197330;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197330Service() {
        this(new Idea197330Config());
    }

    public Idea197330Service(Idea197330Config config) {
        this.config = config != null ? config : new Idea197330Config();
