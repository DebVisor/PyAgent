...
@Data
public class Idea197559Config {
    private String name = "idea_197559";
 ...
 */
@Slf4j
public class Idea197559Service {
    private static final int IDEA_ID = 197559;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197559Service() {
        this(new Idea197559Config());
    }

    public Idea197559Service(Idea197559Config config) {
        this.config = config != null ? config : new Idea197559Config();
