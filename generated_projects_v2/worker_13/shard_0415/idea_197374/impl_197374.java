...
@Data
public class Idea197374Config {
    private String name = "idea_197374";
 ...
 */
@Slf4j
public class Idea197374Service {
    private static final int IDEA_ID = 197374;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197374Service() {
        this(new Idea197374Config());
    }

    public Idea197374Service(Idea197374Config config) {
        this.config = config != null ? config : new Idea197374Config();
