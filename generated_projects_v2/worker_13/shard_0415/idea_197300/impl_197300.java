...
@Data
public class Idea197300Config {
    private String name = "idea_197300";
 ...
 */
@Slf4j
public class Idea197300Service {
    private static final int IDEA_ID = 197300;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197300Service() {
        this(new Idea197300Config());
    }

    public Idea197300Service(Idea197300Config config) {
        this.config = config != null ? config : new Idea197300Config();
