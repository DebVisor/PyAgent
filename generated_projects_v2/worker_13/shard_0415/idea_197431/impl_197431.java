...
@Data
public class Idea197431Config {
    private String name = "idea_197431";
 ...
 */
@Slf4j
public class Idea197431Service {
    private static final int IDEA_ID = 197431;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197431Service() {
        this(new Idea197431Config());
    }

    public Idea197431Service(Idea197431Config config) {
        this.config = config != null ? config : new Idea197431Config();
