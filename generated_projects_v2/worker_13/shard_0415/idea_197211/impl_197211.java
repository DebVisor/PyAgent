...
@Data
public class Idea197211Config {
    private String name = "idea_197211";
 ...
 */
@Slf4j
public class Idea197211Service {
    private static final int IDEA_ID = 197211;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197211Service() {
        this(new Idea197211Config());
    }

    public Idea197211Service(Idea197211Config config) {
        this.config = config != null ? config : new Idea197211Config();
