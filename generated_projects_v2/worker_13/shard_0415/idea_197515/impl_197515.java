...
@Data
public class Idea197515Config {
    private String name = "idea_197515";
 ...
 */
@Slf4j
public class Idea197515Service {
    private static final int IDEA_ID = 197515;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197515Service() {
        this(new Idea197515Config());
    }

    public Idea197515Service(Idea197515Config config) {
        this.config = config != null ? config : new Idea197515Config();
