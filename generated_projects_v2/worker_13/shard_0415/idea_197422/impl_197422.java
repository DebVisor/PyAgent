...
@Data
public class Idea197422Config {
    private String name = "idea_197422";
 ...
 */
@Slf4j
public class Idea197422Service {
    private static final int IDEA_ID = 197422;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197422Service() {
        this(new Idea197422Config());
    }

    public Idea197422Service(Idea197422Config config) {
        this.config = config != null ? config : new Idea197422Config();
