...
@Data
public class Idea197398Config {
    private String name = "idea_197398";
 ...
 */
@Slf4j
public class Idea197398Service {
    private static final int IDEA_ID = 197398;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197398Service() {
        this(new Idea197398Config());
    }

    public Idea197398Service(Idea197398Config config) {
        this.config = config != null ? config : new Idea197398Config();
