...
@Data
public class Idea197396Config {
    private String name = "idea_197396";
 ...
 */
@Slf4j
public class Idea197396Service {
    private static final int IDEA_ID = 197396;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197396Service() {
        this(new Idea197396Config());
    }

    public Idea197396Service(Idea197396Config config) {
        this.config = config != null ? config : new Idea197396Config();
