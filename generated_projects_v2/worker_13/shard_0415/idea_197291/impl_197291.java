...
@Data
public class Idea197291Config {
    private String name = "idea_197291";
 ...
 */
@Slf4j
public class Idea197291Service {
    private static final int IDEA_ID = 197291;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197291Service() {
        this(new Idea197291Config());
    }

    public Idea197291Service(Idea197291Config config) {
        this.config = config != null ? config : new Idea197291Config();
