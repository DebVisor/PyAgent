...
@Data
public class Idea197513Config {
    private String name = "idea_197513";
 ...
 */
@Slf4j
public class Idea197513Service {
    private static final int IDEA_ID = 197513;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197513Service() {
        this(new Idea197513Config());
    }

    public Idea197513Service(Idea197513Config config) {
        this.config = config != null ? config : new Idea197513Config();
