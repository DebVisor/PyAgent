...
@Data
public class Idea197407Config {
    private String name = "idea_197407";
 ...
 */
@Slf4j
public class Idea197407Service {
    private static final int IDEA_ID = 197407;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197407Service() {
        this(new Idea197407Config());
    }

    public Idea197407Service(Idea197407Config config) {
        this.config = config != null ? config : new Idea197407Config();
