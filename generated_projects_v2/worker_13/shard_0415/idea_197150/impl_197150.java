...
@Data
public class Idea197150Config {
    private String name = "idea_197150";
 ...
 */
@Slf4j
public class Idea197150Service {
    private static final int IDEA_ID = 197150;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197150Service() {
        this(new Idea197150Config());
    }

    public Idea197150Service(Idea197150Config config) {
        this.config = config != null ? config : new Idea197150Config();
