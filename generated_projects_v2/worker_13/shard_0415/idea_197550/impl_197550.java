...
@Data
public class Idea197550Config {
    private String name = "idea_197550";
 ...
 */
@Slf4j
public class Idea197550Service {
    private static final int IDEA_ID = 197550;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197550Service() {
        this(new Idea197550Config());
    }

    public Idea197550Service(Idea197550Config config) {
        this.config = config != null ? config : new Idea197550Config();
