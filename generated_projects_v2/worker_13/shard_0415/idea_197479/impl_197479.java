...
@Data
public class Idea197479Config {
    private String name = "idea_197479";
 ...
 */
@Slf4j
public class Idea197479Service {
    private static final int IDEA_ID = 197479;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197479Service() {
        this(new Idea197479Config());
    }

    public Idea197479Service(Idea197479Config config) {
        this.config = config != null ? config : new Idea197479Config();
