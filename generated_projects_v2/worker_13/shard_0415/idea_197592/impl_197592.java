...
@Data
public class Idea197592Config {
    private String name = "idea_197592";
 ...
 */
@Slf4j
public class Idea197592Service {
    private static final int IDEA_ID = 197592;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197592Service() {
        this(new Idea197592Config());
    }

    public Idea197592Service(Idea197592Config config) {
        this.config = config != null ? config : new Idea197592Config();
