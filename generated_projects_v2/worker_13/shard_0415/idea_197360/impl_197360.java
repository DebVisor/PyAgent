...
@Data
public class Idea197360Config {
    private String name = "idea_197360";
 ...
 */
@Slf4j
public class Idea197360Service {
    private static final int IDEA_ID = 197360;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197360Service() {
        this(new Idea197360Config());
    }

    public Idea197360Service(Idea197360Config config) {
        this.config = config != null ? config : new Idea197360Config();
