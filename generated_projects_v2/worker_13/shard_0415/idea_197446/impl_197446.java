...
@Data
public class Idea197446Config {
    private String name = "idea_197446";
 ...
 */
@Slf4j
public class Idea197446Service {
    private static final int IDEA_ID = 197446;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197446Service() {
        this(new Idea197446Config());
    }

    public Idea197446Service(Idea197446Config config) {
        this.config = config != null ? config : new Idea197446Config();
