...
@Data
public class Idea197311Config {
    private String name = "idea_197311";
 ...
 */
@Slf4j
public class Idea197311Service {
    private static final int IDEA_ID = 197311;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197311Service() {
        this(new Idea197311Config());
    }

    public Idea197311Service(Idea197311Config config) {
        this.config = config != null ? config : new Idea197311Config();
