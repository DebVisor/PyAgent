...
@Data
public class Idea197216Config {
    private String name = "idea_197216";
 ...
 */
@Slf4j
public class Idea197216Service {
    private static final int IDEA_ID = 197216;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197216Service() {
        this(new Idea197216Config());
    }

    public Idea197216Service(Idea197216Config config) {
        this.config = config != null ? config : new Idea197216Config();
