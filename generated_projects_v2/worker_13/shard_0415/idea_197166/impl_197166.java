...
@Data
public class Idea197166Config {
    private String name = "idea_197166";
 ...
 */
@Slf4j
public class Idea197166Service {
    private static final int IDEA_ID = 197166;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197166Service() {
        this(new Idea197166Config());
    }

    public Idea197166Service(Idea197166Config config) {
        this.config = config != null ? config : new Idea197166Config();
