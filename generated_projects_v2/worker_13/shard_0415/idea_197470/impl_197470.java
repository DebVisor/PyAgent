...
@Data
public class Idea197470Config {
    private String name = "idea_197470";
 ...
 */
@Slf4j
public class Idea197470Service {
    private static final int IDEA_ID = 197470;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197470Service() {
        this(new Idea197470Config());
    }

    public Idea197470Service(Idea197470Config config) {
        this.config = config != null ? config : new Idea197470Config();
