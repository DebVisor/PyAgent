...
@Data
public class Idea197518Config {
    private String name = "idea_197518";
 ...
 */
@Slf4j
public class Idea197518Service {
    private static final int IDEA_ID = 197518;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197518Service() {
        this(new Idea197518Config());
    }

    public Idea197518Service(Idea197518Config config) {
        this.config = config != null ? config : new Idea197518Config();
