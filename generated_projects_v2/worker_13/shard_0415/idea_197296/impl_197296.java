...
@Data
public class Idea197296Config {
    private String name = "idea_197296";
 ...
 */
@Slf4j
public class Idea197296Service {
    private static final int IDEA_ID = 197296;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197296Service() {
        this(new Idea197296Config());
    }

    public Idea197296Service(Idea197296Config config) {
        this.config = config != null ? config : new Idea197296Config();
