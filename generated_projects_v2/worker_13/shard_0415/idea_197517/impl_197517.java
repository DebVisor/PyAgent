...
@Data
public class Idea197517Config {
    private String name = "idea_197517";
 ...
 */
@Slf4j
public class Idea197517Service {
    private static final int IDEA_ID = 197517;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197517Service() {
        this(new Idea197517Config());
    }

    public Idea197517Service(Idea197517Config config) {
        this.config = config != null ? config : new Idea197517Config();
