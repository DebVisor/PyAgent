...
@Data
public class Idea197363Config {
    private String name = "idea_197363";
 ...
 */
@Slf4j
public class Idea197363Service {
    private static final int IDEA_ID = 197363;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197363Service() {
        this(new Idea197363Config());
    }

    public Idea197363Service(Idea197363Config config) {
        this.config = config != null ? config : new Idea197363Config();
