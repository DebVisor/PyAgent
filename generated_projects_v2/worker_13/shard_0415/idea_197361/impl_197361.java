...
@Data
public class Idea197361Config {
    private String name = "idea_197361";
 ...
 */
@Slf4j
public class Idea197361Service {
    private static final int IDEA_ID = 197361;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197361Service() {
        this(new Idea197361Config());
    }

    public Idea197361Service(Idea197361Config config) {
        this.config = config != null ? config : new Idea197361Config();
