...
@Data
public class Idea197440Config {
    private String name = "idea_197440";
 ...
 */
@Slf4j
public class Idea197440Service {
    private static final int IDEA_ID = 197440;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197440Service() {
        this(new Idea197440Config());
    }

    public Idea197440Service(Idea197440Config config) {
        this.config = config != null ? config : new Idea197440Config();
