...
@Data
public class Idea197430Config {
    private String name = "idea_197430";
 ...
 */
@Slf4j
public class Idea197430Service {
    private static final int IDEA_ID = 197430;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197430Service() {
        this(new Idea197430Config());
    }

    public Idea197430Service(Idea197430Config config) {
        this.config = config != null ? config : new Idea197430Config();
