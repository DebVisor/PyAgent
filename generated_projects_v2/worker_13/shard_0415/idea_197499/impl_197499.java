...
@Data
public class Idea197499Config {
    private String name = "idea_197499";
 ...
 */
@Slf4j
public class Idea197499Service {
    private static final int IDEA_ID = 197499;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197499Service() {
        this(new Idea197499Config());
    }

    public Idea197499Service(Idea197499Config config) {
        this.config = config != null ? config : new Idea197499Config();
