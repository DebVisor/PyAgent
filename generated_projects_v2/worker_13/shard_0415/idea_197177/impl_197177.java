...
@Data
public class Idea197177Config {
    private String name = "idea_197177";
 ...
 */
@Slf4j
public class Idea197177Service {
    private static final int IDEA_ID = 197177;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197177Service() {
        this(new Idea197177Config());
    }

    public Idea197177Service(Idea197177Config config) {
        this.config = config != null ? config : new Idea197177Config();
