...
@Data
public class Idea197417Config {
    private String name = "idea_197417";
 ...
 */
@Slf4j
public class Idea197417Service {
    private static final int IDEA_ID = 197417;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197417Service() {
        this(new Idea197417Config());
    }

    public Idea197417Service(Idea197417Config config) {
        this.config = config != null ? config : new Idea197417Config();
