...
@Data
public class Idea197230Config {
    private String name = "idea_197230";
 ...
 */
@Slf4j
public class Idea197230Service {
    private static final int IDEA_ID = 197230;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197230Service() {
        this(new Idea197230Config());
    }

    public Idea197230Service(Idea197230Config config) {
        this.config = config != null ? config : new Idea197230Config();
