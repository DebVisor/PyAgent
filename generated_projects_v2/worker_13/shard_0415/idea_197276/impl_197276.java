...
@Data
public class Idea197276Config {
    private String name = "idea_197276";
 ...
 */
@Slf4j
public class Idea197276Service {
    private static final int IDEA_ID = 197276;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197276Service() {
        this(new Idea197276Config());
    }

    public Idea197276Service(Idea197276Config config) {
        this.config = config != null ? config : new Idea197276Config();
