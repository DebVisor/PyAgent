...
@Data
public class Idea197293Config {
    private String name = "idea_197293";
 ...
 */
@Slf4j
public class Idea197293Service {
    private static final int IDEA_ID = 197293;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197293Service() {
        this(new Idea197293Config());
    }

    public Idea197293Service(Idea197293Config config) {
        this.config = config != null ? config : new Idea197293Config();
