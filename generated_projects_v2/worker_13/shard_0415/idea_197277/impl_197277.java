...
@Data
public class Idea197277Config {
    private String name = "idea_197277";
 ...
 */
@Slf4j
public class Idea197277Service {
    private static final int IDEA_ID = 197277;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197277Service() {
        this(new Idea197277Config());
    }

    public Idea197277Service(Idea197277Config config) {
        this.config = config != null ? config : new Idea197277Config();
