...
@Data
public class Idea197334Config {
    private String name = "idea_197334";
 ...
 */
@Slf4j
public class Idea197334Service {
    private static final int IDEA_ID = 197334;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197334Service() {
        this(new Idea197334Config());
    }

    public Idea197334Service(Idea197334Config config) {
        this.config = config != null ? config : new Idea197334Config();
