...
@Data
public class Idea197489Config {
    private String name = "idea_197489";
 ...
 */
@Slf4j
public class Idea197489Service {
    private static final int IDEA_ID = 197489;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197489Service() {
        this(new Idea197489Config());
    }

    public Idea197489Service(Idea197489Config config) {
        this.config = config != null ? config : new Idea197489Config();
