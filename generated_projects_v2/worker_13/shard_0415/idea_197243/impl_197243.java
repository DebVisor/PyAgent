...
@Data
public class Idea197243Config {
    private String name = "idea_197243";
 ...
 */
@Slf4j
public class Idea197243Service {
    private static final int IDEA_ID = 197243;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197243Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197243Service() {
        this(new Idea197243Config());
    }

    public Idea197243Service(Idea197243Config config) {
        this.config = config != null ? config : new Idea197243Config();
