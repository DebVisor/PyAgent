...
@Data
public class Idea197378Config {
    private String name = "idea_197378";
 ...
 */
@Slf4j
public class Idea197378Service {
    private static final int IDEA_ID = 197378;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197378Service() {
        this(new Idea197378Config());
    }

    public Idea197378Service(Idea197378Config config) {
        this.config = config != null ? config : new Idea197378Config();
