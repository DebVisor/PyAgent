...
@Data
public class Idea197383Config {
    private String name = "idea_197383";
 ...
 */
@Slf4j
public class Idea197383Service {
    private static final int IDEA_ID = 197383;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197383Service() {
        this(new Idea197383Config());
    }

    public Idea197383Service(Idea197383Config config) {
        this.config = config != null ? config : new Idea197383Config();
