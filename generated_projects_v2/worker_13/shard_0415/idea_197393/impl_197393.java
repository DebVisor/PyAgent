...
@Data
public class Idea197393Config {
    private String name = "idea_197393";
 ...
 */
@Slf4j
public class Idea197393Service {
    private static final int IDEA_ID = 197393;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197393Service() {
        this(new Idea197393Config());
    }

    public Idea197393Service(Idea197393Config config) {
        this.config = config != null ? config : new Idea197393Config();
