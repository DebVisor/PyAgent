...
@Data
public class Idea197546Config {
    private String name = "idea_197546";
 ...
 */
@Slf4j
public class Idea197546Service {
    private static final int IDEA_ID = 197546;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197546Service() {
        this(new Idea197546Config());
    }

    public Idea197546Service(Idea197546Config config) {
        this.config = config != null ? config : new Idea197546Config();
