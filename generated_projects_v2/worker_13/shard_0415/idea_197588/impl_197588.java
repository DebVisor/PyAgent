...
@Data
public class Idea197588Config {
    private String name = "idea_197588";
 ...
 */
@Slf4j
public class Idea197588Service {
    private static final int IDEA_ID = 197588;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197588Service() {
        this(new Idea197588Config());
    }

    public Idea197588Service(Idea197588Config config) {
        this.config = config != null ? config : new Idea197588Config();
