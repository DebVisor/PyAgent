...
@Data
public class Idea197241Config {
    private String name = "idea_197241";
 ...
 */
@Slf4j
public class Idea197241Service {
    private static final int IDEA_ID = 197241;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197241Service() {
        this(new Idea197241Config());
    }

    public Idea197241Service(Idea197241Config config) {
        this.config = config != null ? config : new Idea197241Config();
