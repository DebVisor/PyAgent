...
@Data
public class Idea197538Config {
    private String name = "idea_197538";
 ...
 */
@Slf4j
public class Idea197538Service {
    private static final int IDEA_ID = 197538;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197538Service() {
        this(new Idea197538Config());
    }

    public Idea197538Service(Idea197538Config config) {
        this.config = config != null ? config : new Idea197538Config();
