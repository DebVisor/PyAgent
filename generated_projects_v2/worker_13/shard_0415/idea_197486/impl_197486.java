...
@Data
public class Idea197486Config {
    private String name = "idea_197486";
 ...
 */
@Slf4j
public class Idea197486Service {
    private static final int IDEA_ID = 197486;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197486Service() {
        this(new Idea197486Config());
    }

    public Idea197486Service(Idea197486Config config) {
        this.config = config != null ? config : new Idea197486Config();
