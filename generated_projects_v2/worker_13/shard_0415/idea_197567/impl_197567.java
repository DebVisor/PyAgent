...
@Data
public class Idea197567Config {
    private String name = "idea_197567";
 ...
 */
@Slf4j
public class Idea197567Service {
    private static final int IDEA_ID = 197567;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197567Service() {
        this(new Idea197567Config());
    }

    public Idea197567Service(Idea197567Config config) {
        this.config = config != null ? config : new Idea197567Config();
