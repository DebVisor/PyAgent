...
@Data
public class Idea197544Config {
    private String name = "idea_197544";
 ...
 */
@Slf4j
public class Idea197544Service {
    private static final int IDEA_ID = 197544;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197544Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197544Service() {
        this(new Idea197544Config());
    }

    public Idea197544Service(Idea197544Config config) {
        this.config = config != null ? config : new Idea197544Config();
