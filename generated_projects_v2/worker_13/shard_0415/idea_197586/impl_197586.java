...
@Data
public class Idea197586Config {
    private String name = "idea_197586";
 ...
 */
@Slf4j
public class Idea197586Service {
    private static final int IDEA_ID = 197586;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197586Service() {
        this(new Idea197586Config());
    }

    public Idea197586Service(Idea197586Config config) {
        this.config = config != null ? config : new Idea197586Config();
