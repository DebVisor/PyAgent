...
@Data
public class Idea197402Config {
    private String name = "idea_197402";
 ...
 */
@Slf4j
public class Idea197402Service {
    private static final int IDEA_ID = 197402;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197402Service() {
        this(new Idea197402Config());
    }

    public Idea197402Service(Idea197402Config config) {
        this.config = config != null ? config : new Idea197402Config();
