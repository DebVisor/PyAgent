...
@Data
public class Idea197239Config {
    private String name = "idea_197239";
 ...
 */
@Slf4j
public class Idea197239Service {
    private static final int IDEA_ID = 197239;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197239Service() {
        this(new Idea197239Config());
    }

    public Idea197239Service(Idea197239Config config) {
        this.config = config != null ? config : new Idea197239Config();
