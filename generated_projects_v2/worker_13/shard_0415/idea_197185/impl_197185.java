...
@Data
public class Idea197185Config {
    private String name = "idea_197185";
 ...
 */
@Slf4j
public class Idea197185Service {
    private static final int IDEA_ID = 197185;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197185Service() {
        this(new Idea197185Config());
    }

    public Idea197185Service(Idea197185Config config) {
        this.config = config != null ? config : new Idea197185Config();
