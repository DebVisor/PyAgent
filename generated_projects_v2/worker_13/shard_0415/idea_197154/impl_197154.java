...
@Data
public class Idea197154Config {
    private String name = "idea_197154";
 ...
 */
@Slf4j
public class Idea197154Service {
    private static final int IDEA_ID = 197154;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197154Service() {
        this(new Idea197154Config());
    }

    public Idea197154Service(Idea197154Config config) {
        this.config = config != null ? config : new Idea197154Config();
