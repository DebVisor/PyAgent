...
@Data
public class Idea197222Config {
    private String name = "idea_197222";
 ...
 */
@Slf4j
public class Idea197222Service {
    private static final int IDEA_ID = 197222;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197222Service() {
        this(new Idea197222Config());
    }

    public Idea197222Service(Idea197222Config config) {
        this.config = config != null ? config : new Idea197222Config();
