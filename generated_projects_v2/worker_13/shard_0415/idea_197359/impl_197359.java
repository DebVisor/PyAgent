...
@Data
public class Idea197359Config {
    private String name = "idea_197359";
 ...
 */
@Slf4j
public class Idea197359Service {
    private static final int IDEA_ID = 197359;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197359Service() {
        this(new Idea197359Config());
    }

    public Idea197359Service(Idea197359Config config) {
        this.config = config != null ? config : new Idea197359Config();
