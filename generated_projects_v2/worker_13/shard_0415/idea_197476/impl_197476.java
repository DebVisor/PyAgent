...
@Data
public class Idea197476Config {
    private String name = "idea_197476";
 ...
 */
@Slf4j
public class Idea197476Service {
    private static final int IDEA_ID = 197476;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197476Service() {
        this(new Idea197476Config());
    }

    public Idea197476Service(Idea197476Config config) {
        this.config = config != null ? config : new Idea197476Config();
