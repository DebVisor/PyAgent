...
@Data
public class Idea197141Config {
    private String name = "idea_197141";
 ...
 */
@Slf4j
public class Idea197141Service {
    private static final int IDEA_ID = 197141;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197141Service() {
        this(new Idea197141Config());
    }

    public Idea197141Service(Idea197141Config config) {
        this.config = config != null ? config : new Idea197141Config();
