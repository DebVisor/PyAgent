...
@Data
public class Idea197208Config {
    private String name = "idea_197208";
 ...
 */
@Slf4j
public class Idea197208Service {
    private static final int IDEA_ID = 197208;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197208Service() {
        this(new Idea197208Config());
    }

    public Idea197208Service(Idea197208Config config) {
        this.config = config != null ? config : new Idea197208Config();
