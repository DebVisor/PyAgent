...
@Data
public class Idea197526Config {
    private String name = "idea_197526";
 ...
 */
@Slf4j
public class Idea197526Service {
    private static final int IDEA_ID = 197526;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197526Service() {
        this(new Idea197526Config());
    }

    public Idea197526Service(Idea197526Config config) {
        this.config = config != null ? config : new Idea197526Config();
