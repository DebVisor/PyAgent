...
@Data
public class Idea197349Config {
    private String name = "idea_197349";
 ...
 */
@Slf4j
public class Idea197349Service {
    private static final int IDEA_ID = 197349;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197349Service() {
        this(new Idea197349Config());
    }

    public Idea197349Service(Idea197349Config config) {
        this.config = config != null ? config : new Idea197349Config();
