...
@Data
public class Idea197576Config {
    private String name = "idea_197576";
 ...
 */
@Slf4j
public class Idea197576Service {
    private static final int IDEA_ID = 197576;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197576Service() {
        this(new Idea197576Config());
    }

    public Idea197576Service(Idea197576Config config) {
        this.config = config != null ? config : new Idea197576Config();
