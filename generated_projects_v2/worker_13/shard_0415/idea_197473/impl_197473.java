...
@Data
public class Idea197473Config {
    private String name = "idea_197473";
 ...
 */
@Slf4j
public class Idea197473Service {
    private static final int IDEA_ID = 197473;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197473Service() {
        this(new Idea197473Config());
    }

    public Idea197473Service(Idea197473Config config) {
        this.config = config != null ? config : new Idea197473Config();
