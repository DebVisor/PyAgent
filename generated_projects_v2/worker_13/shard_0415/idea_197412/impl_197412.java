...
@Data
public class Idea197412Config {
    private String name = "idea_197412";
 ...
 */
@Slf4j
public class Idea197412Service {
    private static final int IDEA_ID = 197412;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197412Service() {
        this(new Idea197412Config());
    }

    public Idea197412Service(Idea197412Config config) {
        this.config = config != null ? config : new Idea197412Config();
