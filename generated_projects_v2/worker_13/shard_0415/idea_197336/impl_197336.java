...
@Data
public class Idea197336Config {
    private String name = "idea_197336";
 ...
 */
@Slf4j
public class Idea197336Service {
    private static final int IDEA_ID = 197336;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197336Service() {
        this(new Idea197336Config());
    }

    public Idea197336Service(Idea197336Config config) {
        this.config = config != null ? config : new Idea197336Config();
