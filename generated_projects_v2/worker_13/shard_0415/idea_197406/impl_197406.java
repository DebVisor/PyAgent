...
@Data
public class Idea197406Config {
    private String name = "idea_197406";
 ...
 */
@Slf4j
public class Idea197406Service {
    private static final int IDEA_ID = 197406;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197406Service() {
        this(new Idea197406Config());
    }

    public Idea197406Service(Idea197406Config config) {
        this.config = config != null ? config : new Idea197406Config();
