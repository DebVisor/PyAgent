...
@Data
public class Idea197313Config {
    private String name = "idea_197313";
 ...
 */
@Slf4j
public class Idea197313Service {
    private static final int IDEA_ID = 197313;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197313Service() {
        this(new Idea197313Config());
    }

    public Idea197313Service(Idea197313Config config) {
        this.config = config != null ? config : new Idea197313Config();
