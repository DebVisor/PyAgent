...
@Data
public class Idea197514Config {
    private String name = "idea_197514";
 ...
 */
@Slf4j
public class Idea197514Service {
    private static final int IDEA_ID = 197514;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197514Service() {
        this(new Idea197514Config());
    }

    public Idea197514Service(Idea197514Config config) {
        this.config = config != null ? config : new Idea197514Config();
