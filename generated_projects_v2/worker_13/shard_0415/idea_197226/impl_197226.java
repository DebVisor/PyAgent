...
@Data
public class Idea197226Config {
    private String name = "idea_197226";
 ...
 */
@Slf4j
public class Idea197226Service {
    private static final int IDEA_ID = 197226;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197226Service() {
        this(new Idea197226Config());
    }

    public Idea197226Service(Idea197226Config config) {
        this.config = config != null ? config : new Idea197226Config();
