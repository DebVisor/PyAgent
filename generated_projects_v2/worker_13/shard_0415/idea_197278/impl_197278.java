...
@Data
public class Idea197278Config {
    private String name = "idea_197278";
 ...
 */
@Slf4j
public class Idea197278Service {
    private static final int IDEA_ID = 197278;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197278Service() {
        this(new Idea197278Config());
    }

    public Idea197278Service(Idea197278Config config) {
        this.config = config != null ? config : new Idea197278Config();
