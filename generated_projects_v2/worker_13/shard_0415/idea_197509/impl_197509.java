...
@Data
public class Idea197509Config {
    private String name = "idea_197509";
 ...
 */
@Slf4j
public class Idea197509Service {
    private static final int IDEA_ID = 197509;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197509Service() {
        this(new Idea197509Config());
    }

    public Idea197509Service(Idea197509Config config) {
        this.config = config != null ? config : new Idea197509Config();
