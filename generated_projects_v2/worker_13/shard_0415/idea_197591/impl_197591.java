...
@Data
public class Idea197591Config {
    private String name = "idea_197591";
 ...
 */
@Slf4j
public class Idea197591Service {
    private static final int IDEA_ID = 197591;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197591Service() {
        this(new Idea197591Config());
    }

    public Idea197591Service(Idea197591Config config) {
        this.config = config != null ? config : new Idea197591Config();
