...
@Data
public class Idea197134Config {
    private String name = "idea_197134";
 ...
 */
@Slf4j
public class Idea197134Service {
    private static final int IDEA_ID = 197134;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197134Service() {
        this(new Idea197134Config());
    }

    public Idea197134Service(Idea197134Config config) {
        this.config = config != null ? config : new Idea197134Config();
