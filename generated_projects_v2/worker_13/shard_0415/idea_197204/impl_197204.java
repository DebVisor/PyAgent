...
@Data
public class Idea197204Config {
    private String name = "idea_197204";
 ...
 */
@Slf4j
public class Idea197204Service {
    private static final int IDEA_ID = 197204;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197204Service() {
        this(new Idea197204Config());
    }

    public Idea197204Service(Idea197204Config config) {
        this.config = config != null ? config : new Idea197204Config();
