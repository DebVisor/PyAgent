...
@Data
public class Idea197198Config {
    private String name = "idea_197198";
 ...
 */
@Slf4j
public class Idea197198Service {
    private static final int IDEA_ID = 197198;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197198Service() {
        this(new Idea197198Config());
    }

    public Idea197198Service(Idea197198Config config) {
        this.config = config != null ? config : new Idea197198Config();
