...
@Data
public class Idea197445Config {
    private String name = "idea_197445";
 ...
 */
@Slf4j
public class Idea197445Service {
    private static final int IDEA_ID = 197445;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197445Service() {
        this(new Idea197445Config());
    }

    public Idea197445Service(Idea197445Config config) {
        this.config = config != null ? config : new Idea197445Config();
