...
@Data
public class Idea197342Config {
    private String name = "idea_197342";
 ...
 */
@Slf4j
public class Idea197342Service {
    private static final int IDEA_ID = 197342;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197342Service() {
        this(new Idea197342Config());
    }

    public Idea197342Service(Idea197342Config config) {
        this.config = config != null ? config : new Idea197342Config();
