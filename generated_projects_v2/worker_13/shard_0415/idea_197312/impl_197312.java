...
@Data
public class Idea197312Config {
    private String name = "idea_197312";
 ...
 */
@Slf4j
public class Idea197312Service {
    private static final int IDEA_ID = 197312;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197312Service() {
        this(new Idea197312Config());
    }

    public Idea197312Service(Idea197312Config config) {
        this.config = config != null ? config : new Idea197312Config();
