...
@Data
public class Idea197338Config {
    private String name = "idea_197338";
 ...
 */
@Slf4j
public class Idea197338Service {
    private static final int IDEA_ID = 197338;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197338Service() {
        this(new Idea197338Config());
    }

    public Idea197338Service(Idea197338Config config) {
        this.config = config != null ? config : new Idea197338Config();
