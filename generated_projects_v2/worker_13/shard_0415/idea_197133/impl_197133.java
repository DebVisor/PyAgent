...
@Data
public class Idea197133Config {
    private String name = "idea_197133";
 ...
 */
@Slf4j
public class Idea197133Service {
    private static final int IDEA_ID = 197133;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197133Service() {
        this(new Idea197133Config());
    }

    public Idea197133Service(Idea197133Config config) {
        this.config = config != null ? config : new Idea197133Config();
