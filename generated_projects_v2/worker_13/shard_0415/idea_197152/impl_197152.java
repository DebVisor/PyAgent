...
@Data
public class Idea197152Config {
    private String name = "idea_197152";
 ...
 */
@Slf4j
public class Idea197152Service {
    private static final int IDEA_ID = 197152;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197152Service() {
        this(new Idea197152Config());
    }

    public Idea197152Service(Idea197152Config config) {
        this.config = config != null ? config : new Idea197152Config();
