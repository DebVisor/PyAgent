...
@Data
public class Idea197595Config {
    private String name = "idea_197595";
 ...
 */
@Slf4j
public class Idea197595Service {
    private static final int IDEA_ID = 197595;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197595Service() {
        this(new Idea197595Config());
    }

    public Idea197595Service(Idea197595Config config) {
        this.config = config != null ? config : new Idea197595Config();
