...
@Data
public class Idea197500Config {
    private String name = "idea_197500";
 ...
 */
@Slf4j
public class Idea197500Service {
    private static final int IDEA_ID = 197500;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197500Service() {
        this(new Idea197500Config());
    }

    public Idea197500Service(Idea197500Config config) {
        this.config = config != null ? config : new Idea197500Config();
