...
@Data
public class Idea197356Config {
    private String name = "idea_197356";
 ...
 */
@Slf4j
public class Idea197356Service {
    private static final int IDEA_ID = 197356;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197356Service() {
        this(new Idea197356Config());
    }

    public Idea197356Service(Idea197356Config config) {
        this.config = config != null ? config : new Idea197356Config();
