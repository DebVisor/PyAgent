...
@Data
public class Idea197275Config {
    private String name = "idea_197275";
 ...
 */
@Slf4j
public class Idea197275Service {
    private static final int IDEA_ID = 197275;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197275Service() {
        this(new Idea197275Config());
    }

    public Idea197275Service(Idea197275Config config) {
        this.config = config != null ? config : new Idea197275Config();
