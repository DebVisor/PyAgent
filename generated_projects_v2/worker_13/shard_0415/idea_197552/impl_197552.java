...
@Data
public class Idea197552Config {
    private String name = "idea_197552";
 ...
 */
@Slf4j
public class Idea197552Service {
    private static final int IDEA_ID = 197552;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197552Service() {
        this(new Idea197552Config());
    }

    public Idea197552Service(Idea197552Config config) {
        this.config = config != null ? config : new Idea197552Config();
