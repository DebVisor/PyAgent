...
@Data
public class Idea197186Config {
    private String name = "idea_197186";
 ...
 */
@Slf4j
public class Idea197186Service {
    private static final int IDEA_ID = 197186;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197186Service() {
        this(new Idea197186Config());
    }

    public Idea197186Service(Idea197186Config config) {
        this.config = config != null ? config : new Idea197186Config();
