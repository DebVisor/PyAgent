...
@Data
public class Idea197350Config {
    private String name = "idea_197350";
 ...
 */
@Slf4j
public class Idea197350Service {
    private static final int IDEA_ID = 197350;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197350Service() {
        this(new Idea197350Config());
    }

    public Idea197350Service(Idea197350Config config) {
        this.config = config != null ? config : new Idea197350Config();
