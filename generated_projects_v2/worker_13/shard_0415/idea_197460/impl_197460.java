...
@Data
public class Idea197460Config {
    private String name = "idea_197460";
 ...
 */
@Slf4j
public class Idea197460Service {
    private static final int IDEA_ID = 197460;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197460Service() {
        this(new Idea197460Config());
    }

    public Idea197460Service(Idea197460Config config) {
        this.config = config != null ? config : new Idea197460Config();
