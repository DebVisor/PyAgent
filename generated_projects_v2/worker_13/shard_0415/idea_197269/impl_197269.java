...
@Data
public class Idea197269Config {
    private String name = "idea_197269";
 ...
 */
@Slf4j
public class Idea197269Service {
    private static final int IDEA_ID = 197269;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197269Service() {
        this(new Idea197269Config());
    }

    public Idea197269Service(Idea197269Config config) {
        this.config = config != null ? config : new Idea197269Config();
