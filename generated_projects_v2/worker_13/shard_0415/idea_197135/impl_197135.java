...
@Data
public class Idea197135Config {
    private String name = "idea_197135";
 ...
 */
@Slf4j
public class Idea197135Service {
    private static final int IDEA_ID = 197135;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197135Service() {
        this(new Idea197135Config());
    }

    public Idea197135Service(Idea197135Config config) {
        this.config = config != null ? config : new Idea197135Config();
