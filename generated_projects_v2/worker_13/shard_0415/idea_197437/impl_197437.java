...
@Data
public class Idea197437Config {
    private String name = "idea_197437";
 ...
 */
@Slf4j
public class Idea197437Service {
    private static final int IDEA_ID = 197437;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197437Service() {
        this(new Idea197437Config());
    }

    public Idea197437Service(Idea197437Config config) {
        this.config = config != null ? config : new Idea197437Config();
