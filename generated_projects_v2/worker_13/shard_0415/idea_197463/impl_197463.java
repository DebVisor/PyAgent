...
@Data
public class Idea197463Config {
    private String name = "idea_197463";
 ...
 */
@Slf4j
public class Idea197463Service {
    private static final int IDEA_ID = 197463;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197463Service() {
        this(new Idea197463Config());
    }

    public Idea197463Service(Idea197463Config config) {
        this.config = config != null ? config : new Idea197463Config();
