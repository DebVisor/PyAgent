...
@Data
public class Idea197251Config {
    private String name = "idea_197251";
 ...
 */
@Slf4j
public class Idea197251Service {
    private static final int IDEA_ID = 197251;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197251Service() {
        this(new Idea197251Config());
    }

    public Idea197251Service(Idea197251Config config) {
        this.config = config != null ? config : new Idea197251Config();
