...
@Data
public class Idea197147Config {
    private String name = "idea_197147";
 ...
 */
@Slf4j
public class Idea197147Service {
    private static final int IDEA_ID = 197147;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197147Service() {
        this(new Idea197147Config());
    }

    public Idea197147Service(Idea197147Config config) {
        this.config = config != null ? config : new Idea197147Config();
