...
@Data
public class Idea197432Config {
    private String name = "idea_197432";
 ...
 */
@Slf4j
public class Idea197432Service {
    private static final int IDEA_ID = 197432;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197432Service() {
        this(new Idea197432Config());
    }

    public Idea197432Service(Idea197432Config config) {
        this.config = config != null ? config : new Idea197432Config();
