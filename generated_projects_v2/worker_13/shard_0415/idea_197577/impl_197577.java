...
@Data
public class Idea197577Config {
    private String name = "idea_197577";
 ...
 */
@Slf4j
public class Idea197577Service {
    private static final int IDEA_ID = 197577;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197577Service() {
        this(new Idea197577Config());
    }

    public Idea197577Service(Idea197577Config config) {
        this.config = config != null ? config : new Idea197577Config();
