...
@Data
public class Idea197148Config {
    private String name = "idea_197148";
 ...
 */
@Slf4j
public class Idea197148Service {
    private static final int IDEA_ID = 197148;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197148Service() {
        this(new Idea197148Config());
    }

    public Idea197148Service(Idea197148Config config) {
        this.config = config != null ? config : new Idea197148Config();
