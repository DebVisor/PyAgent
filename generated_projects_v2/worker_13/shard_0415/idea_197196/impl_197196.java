...
@Data
public class Idea197196Config {
    private String name = "idea_197196";
 ...
 */
@Slf4j
public class Idea197196Service {
    private static final int IDEA_ID = 197196;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197196Service() {
        this(new Idea197196Config());
    }

    public Idea197196Service(Idea197196Config config) {
        this.config = config != null ? config : new Idea197196Config();
