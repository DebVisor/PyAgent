...
@Data
public class Idea197390Config {
    private String name = "idea_197390";
 ...
 */
@Slf4j
public class Idea197390Service {
    private static final int IDEA_ID = 197390;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197390Service() {
        this(new Idea197390Config());
    }

    public Idea197390Service(Idea197390Config config) {
        this.config = config != null ? config : new Idea197390Config();
