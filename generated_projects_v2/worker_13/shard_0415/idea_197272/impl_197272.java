...
@Data
public class Idea197272Config {
    private String name = "idea_197272";
 ...
 */
@Slf4j
public class Idea197272Service {
    private static final int IDEA_ID = 197272;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197272Service() {
        this(new Idea197272Config());
    }

    public Idea197272Service(Idea197272Config config) {
        this.config = config != null ? config : new Idea197272Config();
