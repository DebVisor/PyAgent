...
@Data
public class Idea197569Config {
    private String name = "idea_197569";
 ...
 */
@Slf4j
public class Idea197569Service {
    private static final int IDEA_ID = 197569;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197569Service() {
        this(new Idea197569Config());
    }

    public Idea197569Service(Idea197569Config config) {
        this.config = config != null ? config : new Idea197569Config();
