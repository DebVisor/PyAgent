...
@Data
public class Idea197511Config {
    private String name = "idea_197511";
 ...
 */
@Slf4j
public class Idea197511Service {
    private static final int IDEA_ID = 197511;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197511Service() {
        this(new Idea197511Config());
    }

    public Idea197511Service(Idea197511Config config) {
        this.config = config != null ? config : new Idea197511Config();
