...
@Data
public class Idea197501Config {
    private String name = "idea_197501";
 ...
 */
@Slf4j
public class Idea197501Service {
    private static final int IDEA_ID = 197501;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197501Service() {
        this(new Idea197501Config());
    }

    public Idea197501Service(Idea197501Config config) {
        this.config = config != null ? config : new Idea197501Config();
