...
@Data
public class Idea197193Config {
    private String name = "idea_197193";
 ...
 */
@Slf4j
public class Idea197193Service {
    private static final int IDEA_ID = 197193;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197193Service() {
        this(new Idea197193Config());
    }

    public Idea197193Service(Idea197193Config config) {
        this.config = config != null ? config : new Idea197193Config();
