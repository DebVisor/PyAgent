...
@Data
public class Idea197365Config {
    private String name = "idea_197365";
 ...
 */
@Slf4j
public class Idea197365Service {
    private static final int IDEA_ID = 197365;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197365Service() {
        this(new Idea197365Config());
    }

    public Idea197365Service(Idea197365Config config) {
        this.config = config != null ? config : new Idea197365Config();
