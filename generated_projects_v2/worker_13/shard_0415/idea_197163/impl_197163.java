...
@Data
public class Idea197163Config {
    private String name = "idea_197163";
 ...
 */
@Slf4j
public class Idea197163Service {
    private static final int IDEA_ID = 197163;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197163Service() {
        this(new Idea197163Config());
    }

    public Idea197163Service(Idea197163Config config) {
        this.config = config != null ? config : new Idea197163Config();
