...
@Data
public class Idea197477Config {
    private String name = "idea_197477";
 ...
 */
@Slf4j
public class Idea197477Service {
    private static final int IDEA_ID = 197477;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197477Service() {
        this(new Idea197477Config());
    }

    public Idea197477Service(Idea197477Config config) {
        this.config = config != null ? config : new Idea197477Config();
