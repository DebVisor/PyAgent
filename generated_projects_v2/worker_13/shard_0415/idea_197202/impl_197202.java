...
@Data
public class Idea197202Config {
    private String name = "idea_197202";
 ...
 */
@Slf4j
public class Idea197202Service {
    private static final int IDEA_ID = 197202;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197202Service() {
        this(new Idea197202Config());
    }

    public Idea197202Service(Idea197202Config config) {
        this.config = config != null ? config : new Idea197202Config();
