...
@Data
public class Idea197235Config {
    private String name = "idea_197235";
 ...
 */
@Slf4j
public class Idea197235Service {
    private static final int IDEA_ID = 197235;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197235Service() {
        this(new Idea197235Config());
    }

    public Idea197235Service(Idea197235Config config) {
        this.config = config != null ? config : new Idea197235Config();
