...
@Data
public class Idea197425Config {
    private String name = "idea_197425";
 ...
 */
@Slf4j
public class Idea197425Service {
    private static final int IDEA_ID = 197425;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197425Service() {
        this(new Idea197425Config());
    }

    public Idea197425Service(Idea197425Config config) {
        this.config = config != null ? config : new Idea197425Config();
