...
@Data
public class Idea197564Config {
    private String name = "idea_197564";
 ...
 */
@Slf4j
public class Idea197564Service {
    private static final int IDEA_ID = 197564;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197564Service() {
        this(new Idea197564Config());
    }

    public Idea197564Service(Idea197564Config config) {
        this.config = config != null ? config : new Idea197564Config();
