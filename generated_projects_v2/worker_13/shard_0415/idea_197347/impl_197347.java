...
@Data
public class Idea197347Config {
    private String name = "idea_197347";
 ...
 */
@Slf4j
public class Idea197347Service {
    private static final int IDEA_ID = 197347;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197347Service() {
        this(new Idea197347Config());
    }

    public Idea197347Service(Idea197347Config config) {
        this.config = config != null ? config : new Idea197347Config();
