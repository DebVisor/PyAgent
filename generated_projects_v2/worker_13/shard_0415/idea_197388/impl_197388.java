...
@Data
public class Idea197388Config {
    private String name = "idea_197388";
 ...
 */
@Slf4j
public class Idea197388Service {
    private static final int IDEA_ID = 197388;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197388Service() {
        this(new Idea197388Config());
    }

    public Idea197388Service(Idea197388Config config) {
        this.config = config != null ? config : new Idea197388Config();
