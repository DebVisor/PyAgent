...
@Data
public class Idea197376Config {
    private String name = "idea_197376";
 ...
 */
@Slf4j
public class Idea197376Service {
    private static final int IDEA_ID = 197376;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197376Service() {
        this(new Idea197376Config());
    }

    public Idea197376Service(Idea197376Config config) {
        this.config = config != null ? config : new Idea197376Config();
