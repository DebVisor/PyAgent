...
@Data
public class Idea197255Config {
    private String name = "idea_197255";
 ...
 */
@Slf4j
public class Idea197255Service {
    private static final int IDEA_ID = 197255;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197255Service() {
        this(new Idea197255Config());
    }

    public Idea197255Service(Idea197255Config config) {
        this.config = config != null ? config : new Idea197255Config();
