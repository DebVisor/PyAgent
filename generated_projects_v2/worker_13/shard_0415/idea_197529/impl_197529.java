...
@Data
public class Idea197529Config {
    private String name = "idea_197529";
 ...
 */
@Slf4j
public class Idea197529Service {
    private static final int IDEA_ID = 197529;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197529Service() {
        this(new Idea197529Config());
    }

    public Idea197529Service(Idea197529Config config) {
        this.config = config != null ? config : new Idea197529Config();
