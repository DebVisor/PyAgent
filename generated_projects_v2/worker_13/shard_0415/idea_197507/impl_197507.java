...
@Data
public class Idea197507Config {
    private String name = "idea_197507";
 ...
 */
@Slf4j
public class Idea197507Service {
    private static final int IDEA_ID = 197507;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197507Service() {
        this(new Idea197507Config());
    }

    public Idea197507Service(Idea197507Config config) {
        this.config = config != null ? config : new Idea197507Config();
