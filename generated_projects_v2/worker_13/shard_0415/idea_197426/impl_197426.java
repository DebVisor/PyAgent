...
@Data
public class Idea197426Config {
    private String name = "idea_197426";
 ...
 */
@Slf4j
public class Idea197426Service {
    private static final int IDEA_ID = 197426;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197426Service() {
        this(new Idea197426Config());
    }

    public Idea197426Service(Idea197426Config config) {
        this.config = config != null ? config : new Idea197426Config();
