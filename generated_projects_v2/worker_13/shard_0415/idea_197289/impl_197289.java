...
@Data
public class Idea197289Config {
    private String name = "idea_197289";
 ...
 */
@Slf4j
public class Idea197289Service {
    private static final int IDEA_ID = 197289;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197289Service() {
        this(new Idea197289Config());
    }

    public Idea197289Service(Idea197289Config config) {
        this.config = config != null ? config : new Idea197289Config();
