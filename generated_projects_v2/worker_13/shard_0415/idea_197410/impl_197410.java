...
@Data
public class Idea197410Config {
    private String name = "idea_197410";
 ...
 */
@Slf4j
public class Idea197410Service {
    private static final int IDEA_ID = 197410;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197410Service() {
        this(new Idea197410Config());
    }

    public Idea197410Service(Idea197410Config config) {
        this.config = config != null ? config : new Idea197410Config();
