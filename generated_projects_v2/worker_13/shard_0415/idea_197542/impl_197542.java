...
@Data
public class Idea197542Config {
    private String name = "idea_197542";
 ...
 */
@Slf4j
public class Idea197542Service {
    private static final int IDEA_ID = 197542;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197542Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197542Service() {
        this(new Idea197542Config());
    }

    public Idea197542Service(Idea197542Config config) {
        this.config = config != null ? config : new Idea197542Config();
