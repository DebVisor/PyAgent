...
@Data
public class Idea197578Config {
    private String name = "idea_197578";
 ...
 */
@Slf4j
public class Idea197578Service {
    private static final int IDEA_ID = 197578;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197578Service() {
        this(new Idea197578Config());
    }

    public Idea197578Service(Idea197578Config config) {
        this.config = config != null ? config : new Idea197578Config();
