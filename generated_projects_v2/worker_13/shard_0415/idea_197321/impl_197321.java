...
@Data
public class Idea197321Config {
    private String name = "idea_197321";
 ...
 */
@Slf4j
public class Idea197321Service {
    private static final int IDEA_ID = 197321;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197321Service() {
        this(new Idea197321Config());
    }

    public Idea197321Service(Idea197321Config config) {
        this.config = config != null ? config : new Idea197321Config();
