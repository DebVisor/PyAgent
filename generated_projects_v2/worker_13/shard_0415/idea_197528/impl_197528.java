...
@Data
public class Idea197528Config {
    private String name = "idea_197528";
 ...
 */
@Slf4j
public class Idea197528Service {
    private static final int IDEA_ID = 197528;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197528Service() {
        this(new Idea197528Config());
    }

    public Idea197528Service(Idea197528Config config) {
        this.config = config != null ? config : new Idea197528Config();
