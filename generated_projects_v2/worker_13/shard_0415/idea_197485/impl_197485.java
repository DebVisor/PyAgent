...
@Data
public class Idea197485Config {
    private String name = "idea_197485";
 ...
 */
@Slf4j
public class Idea197485Service {
    private static final int IDEA_ID = 197485;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197485Service() {
        this(new Idea197485Config());
    }

    public Idea197485Service(Idea197485Config config) {
        this.config = config != null ? config : new Idea197485Config();
