...
@Data
public class Idea197465Config {
    private String name = "idea_197465";
 ...
 */
@Slf4j
public class Idea197465Service {
    private static final int IDEA_ID = 197465;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197465Service() {
        this(new Idea197465Config());
    }

    public Idea197465Service(Idea197465Config config) {
        this.config = config != null ? config : new Idea197465Config();
