...
@Data
public class Idea197521Config {
    private String name = "idea_197521";
 ...
 */
@Slf4j
public class Idea197521Service {
    private static final int IDEA_ID = 197521;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197521Service() {
        this(new Idea197521Config());
    }

    public Idea197521Service(Idea197521Config config) {
        this.config = config != null ? config : new Idea197521Config();
