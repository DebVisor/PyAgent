...
@Data
public class Idea197355Config {
    private String name = "idea_197355";
 ...
 */
@Slf4j
public class Idea197355Service {
    private static final int IDEA_ID = 197355;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197355Service() {
        this(new Idea197355Config());
    }

    public Idea197355Service(Idea197355Config config) {
        this.config = config != null ? config : new Idea197355Config();
