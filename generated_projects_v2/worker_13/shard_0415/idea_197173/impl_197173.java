...
@Data
public class Idea197173Config {
    private String name = "idea_197173";
 ...
 */
@Slf4j
public class Idea197173Service {
    private static final int IDEA_ID = 197173;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197173Service() {
        this(new Idea197173Config());
    }

    public Idea197173Service(Idea197173Config config) {
        this.config = config != null ? config : new Idea197173Config();
