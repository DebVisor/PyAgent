...
@Data
public class Idea197506Config {
    private String name = "idea_197506";
 ...
 */
@Slf4j
public class Idea197506Service {
    private static final int IDEA_ID = 197506;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197506Service() {
        this(new Idea197506Config());
    }

    public Idea197506Service(Idea197506Config config) {
        this.config = config != null ? config : new Idea197506Config();
