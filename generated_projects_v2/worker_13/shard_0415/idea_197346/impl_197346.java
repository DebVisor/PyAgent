...
@Data
public class Idea197346Config {
    private String name = "idea_197346";
 ...
 */
@Slf4j
public class Idea197346Service {
    private static final int IDEA_ID = 197346;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197346Service() {
        this(new Idea197346Config());
    }

    public Idea197346Service(Idea197346Config config) {
        this.config = config != null ? config : new Idea197346Config();
