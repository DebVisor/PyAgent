...
@Data
public class Idea197474Config {
    private String name = "idea_197474";
 ...
 */
@Slf4j
public class Idea197474Service {
    private static final int IDEA_ID = 197474;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197474Service() {
        this(new Idea197474Config());
    }

    public Idea197474Service(Idea197474Config config) {
        this.config = config != null ? config : new Idea197474Config();
