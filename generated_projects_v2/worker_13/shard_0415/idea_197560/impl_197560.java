...
@Data
public class Idea197560Config {
    private String name = "idea_197560";
 ...
 */
@Slf4j
public class Idea197560Service {
    private static final int IDEA_ID = 197560;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197560Service() {
        this(new Idea197560Config());
    }

    public Idea197560Service(Idea197560Config config) {
        this.config = config != null ? config : new Idea197560Config();
