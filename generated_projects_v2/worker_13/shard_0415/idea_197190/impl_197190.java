...
@Data
public class Idea197190Config {
    private String name = "idea_197190";
 ...
 */
@Slf4j
public class Idea197190Service {
    private static final int IDEA_ID = 197190;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197190Service() {
        this(new Idea197190Config());
    }

    public Idea197190Service(Idea197190Config config) {
        this.config = config != null ? config : new Idea197190Config();
