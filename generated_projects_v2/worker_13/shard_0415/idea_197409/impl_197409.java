...
@Data
public class Idea197409Config {
    private String name = "idea_197409";
 ...
 */
@Slf4j
public class Idea197409Service {
    private static final int IDEA_ID = 197409;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197409Service() {
        this(new Idea197409Config());
    }

    public Idea197409Service(Idea197409Config config) {
        this.config = config != null ? config : new Idea197409Config();
