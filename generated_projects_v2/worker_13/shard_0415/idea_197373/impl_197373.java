...
@Data
public class Idea197373Config {
    private String name = "idea_197373";
 ...
 */
@Slf4j
public class Idea197373Service {
    private static final int IDEA_ID = 197373;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197373Service() {
        this(new Idea197373Config());
    }

    public Idea197373Service(Idea197373Config config) {
        this.config = config != null ? config : new Idea197373Config();
