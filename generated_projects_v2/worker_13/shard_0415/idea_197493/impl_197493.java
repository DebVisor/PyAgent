...
@Data
public class Idea197493Config {
    private String name = "idea_197493";
 ...
 */
@Slf4j
public class Idea197493Service {
    private static final int IDEA_ID = 197493;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197493Service() {
        this(new Idea197493Config());
    }

    public Idea197493Service(Idea197493Config config) {
        this.config = config != null ? config : new Idea197493Config();
