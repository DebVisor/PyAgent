...
@Data
public class Idea197201Config {
    private String name = "idea_197201";
 ...
 */
@Slf4j
public class Idea197201Service {
    private static final int IDEA_ID = 197201;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197201Service() {
        this(new Idea197201Config());
    }

    public Idea197201Service(Idea197201Config config) {
        this.config = config != null ? config : new Idea197201Config();
