...
@Data
public class Idea197487Config {
    private String name = "idea_197487";
 ...
 */
@Slf4j
public class Idea197487Service {
    private static final int IDEA_ID = 197487;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197487Service() {
        this(new Idea197487Config());
    }

    public Idea197487Service(Idea197487Config config) {
        this.config = config != null ? config : new Idea197487Config();
