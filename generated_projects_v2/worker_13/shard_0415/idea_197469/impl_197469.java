...
@Data
public class Idea197469Config {
    private String name = "idea_197469";
 ...
 */
@Slf4j
public class Idea197469Service {
    private static final int IDEA_ID = 197469;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197469Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197469Service() {
        this(new Idea197469Config());
    }

    public Idea197469Service(Idea197469Config config) {
        this.config = config != null ? config : new Idea197469Config();
