...
@Data
public class Idea197189Config {
    private String name = "idea_197189";
 ...
 */
@Slf4j
public class Idea197189Service {
    private static final int IDEA_ID = 197189;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197189Service() {
        this(new Idea197189Config());
    }

    public Idea197189Service(Idea197189Config config) {
        this.config = config != null ? config : new Idea197189Config();
