...
@Data
public class Idea197411Config {
    private String name = "idea_197411";
 ...
 */
@Slf4j
public class Idea197411Service {
    private static final int IDEA_ID = 197411;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197411Service() {
        this(new Idea197411Config());
    }

    public Idea197411Service(Idea197411Config config) {
        this.config = config != null ? config : new Idea197411Config();
