...
@Data
public class Idea197536Config {
    private String name = "idea_197536";
 ...
 */
@Slf4j
public class Idea197536Service {
    private static final int IDEA_ID = 197536;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197536Service() {
        this(new Idea197536Config());
    }

    public Idea197536Service(Idea197536Config config) {
        this.config = config != null ? config : new Idea197536Config();
