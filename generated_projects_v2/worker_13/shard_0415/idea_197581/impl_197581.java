...
@Data
public class Idea197581Config {
    private String name = "idea_197581";
 ...
 */
@Slf4j
public class Idea197581Service {
    private static final int IDEA_ID = 197581;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197581Service() {
        this(new Idea197581Config());
    }

    public Idea197581Service(Idea197581Config config) {
        this.config = config != null ? config : new Idea197581Config();
