...
@Data
public class Idea197541Config {
    private String name = "idea_197541";
 ...
 */
@Slf4j
public class Idea197541Service {
    private static final int IDEA_ID = 197541;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197541Service() {
        this(new Idea197541Config());
    }

    public Idea197541Service(Idea197541Config config) {
        this.config = config != null ? config : new Idea197541Config();
