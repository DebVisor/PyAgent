...
@Data
public class Idea197566Config {
    private String name = "idea_197566";
 ...
 */
@Slf4j
public class Idea197566Service {
    private static final int IDEA_ID = 197566;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197566Service() {
        this(new Idea197566Config());
    }

    public Idea197566Service(Idea197566Config config) {
        this.config = config != null ? config : new Idea197566Config();
