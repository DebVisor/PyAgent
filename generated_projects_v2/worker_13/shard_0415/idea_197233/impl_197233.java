...
@Data
public class Idea197233Config {
    private String name = "idea_197233";
 ...
 */
@Slf4j
public class Idea197233Service {
    private static final int IDEA_ID = 197233;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197233Service() {
        this(new Idea197233Config());
    }

    public Idea197233Service(Idea197233Config config) {
        this.config = config != null ? config : new Idea197233Config();
