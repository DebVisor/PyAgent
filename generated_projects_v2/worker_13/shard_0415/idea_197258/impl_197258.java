...
@Data
public class Idea197258Config {
    private String name = "idea_197258";
 ...
 */
@Slf4j
public class Idea197258Service {
    private static final int IDEA_ID = 197258;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197258Service() {
        this(new Idea197258Config());
    }

    public Idea197258Service(Idea197258Config config) {
        this.config = config != null ? config : new Idea197258Config();
