...
@Data
public class Idea197442Config {
    private String name = "idea_197442";
 ...
 */
@Slf4j
public class Idea197442Service {
    private static final int IDEA_ID = 197442;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197442Service() {
        this(new Idea197442Config());
    }

    public Idea197442Service(Idea197442Config config) {
        this.config = config != null ? config : new Idea197442Config();
