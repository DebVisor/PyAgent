...
@Data
public class Idea197379Config {
    private String name = "idea_197379";
 ...
 */
@Slf4j
public class Idea197379Service {
    private static final int IDEA_ID = 197379;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197379Service() {
        this(new Idea197379Config());
    }

    public Idea197379Service(Idea197379Config config) {
        this.config = config != null ? config : new Idea197379Config();
