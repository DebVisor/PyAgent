...
@Data
public class Idea197522Config {
    private String name = "idea_197522";
 ...
 */
@Slf4j
public class Idea197522Service {
    private static final int IDEA_ID = 197522;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197522Service() {
        this(new Idea197522Config());
    }

    public Idea197522Service(Idea197522Config config) {
        this.config = config != null ? config : new Idea197522Config();
