...
@Data
public class Idea197525Config {
    private String name = "idea_197525";
 ...
 */
@Slf4j
public class Idea197525Service {
    private static final int IDEA_ID = 197525;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197525Service() {
        this(new Idea197525Config());
    }

    public Idea197525Service(Idea197525Config config) {
        this.config = config != null ? config : new Idea197525Config();
