...
@Data
public class Idea197214Config {
    private String name = "idea_197214";
 ...
 */
@Slf4j
public class Idea197214Service {
    private static final int IDEA_ID = 197214;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197214Service() {
        this(new Idea197214Config());
    }

    public Idea197214Service(Idea197214Config config) {
        this.config = config != null ? config : new Idea197214Config();
