...
@Data
public class Idea197563Config {
    private String name = "idea_197563";
 ...
 */
@Slf4j
public class Idea197563Service {
    private static final int IDEA_ID = 197563;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197563Service() {
        this(new Idea197563Config());
    }

    public Idea197563Service(Idea197563Config config) {
        this.config = config != null ? config : new Idea197563Config();
