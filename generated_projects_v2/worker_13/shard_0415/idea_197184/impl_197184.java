...
@Data
public class Idea197184Config {
    private String name = "idea_197184";
 ...
 */
@Slf4j
public class Idea197184Service {
    private static final int IDEA_ID = 197184;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197184Service() {
        this(new Idea197184Config());
    }

    public Idea197184Service(Idea197184Config config) {
        this.config = config != null ? config : new Idea197184Config();
