...
@Data
public class Idea197403Config {
    private String name = "idea_197403";
 ...
 */
@Slf4j
public class Idea197403Service {
    private static final int IDEA_ID = 197403;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197403Service() {
        this(new Idea197403Config());
    }

    public Idea197403Service(Idea197403Config config) {
        this.config = config != null ? config : new Idea197403Config();
