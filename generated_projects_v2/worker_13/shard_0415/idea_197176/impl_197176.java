...
@Data
public class Idea197176Config {
    private String name = "idea_197176";
 ...
 */
@Slf4j
public class Idea197176Service {
    private static final int IDEA_ID = 197176;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197176Service() {
        this(new Idea197176Config());
    }

    public Idea197176Service(Idea197176Config config) {
        this.config = config != null ? config : new Idea197176Config();
