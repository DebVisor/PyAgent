...
@Data
public class Idea197260Config {
    private String name = "idea_197260";
 ...
 */
@Slf4j
public class Idea197260Service {
    private static final int IDEA_ID = 197260;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197260Service() {
        this(new Idea197260Config());
    }

    public Idea197260Service(Idea197260Config config) {
        this.config = config != null ? config : new Idea197260Config();
