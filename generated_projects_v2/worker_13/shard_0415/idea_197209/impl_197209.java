...
@Data
public class Idea197209Config {
    private String name = "idea_197209";
 ...
 */
@Slf4j
public class Idea197209Service {
    private static final int IDEA_ID = 197209;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197209Service() {
        this(new Idea197209Config());
    }

    public Idea197209Service(Idea197209Config config) {
        this.config = config != null ? config : new Idea197209Config();
