...
@Data
public class Idea197317Config {
    private String name = "idea_197317";
 ...
 */
@Slf4j
public class Idea197317Service {
    private static final int IDEA_ID = 197317;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197317Service() {
        this(new Idea197317Config());
    }

    public Idea197317Service(Idea197317Config config) {
        this.config = config != null ? config : new Idea197317Config();
