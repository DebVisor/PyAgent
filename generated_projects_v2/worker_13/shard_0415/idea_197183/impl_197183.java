...
@Data
public class Idea197183Config {
    private String name = "idea_197183";
 ...
 */
@Slf4j
public class Idea197183Service {
    private static final int IDEA_ID = 197183;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197183Service() {
        this(new Idea197183Config());
    }

    public Idea197183Service(Idea197183Config config) {
        this.config = config != null ? config : new Idea197183Config();
