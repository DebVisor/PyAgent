...
@Data
public class Idea197343Config {
    private String name = "idea_197343";
 ...
 */
@Slf4j
public class Idea197343Service {
    private static final int IDEA_ID = 197343;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197343Service() {
        this(new Idea197343Config());
    }

    public Idea197343Service(Idea197343Config config) {
        this.config = config != null ? config : new Idea197343Config();
