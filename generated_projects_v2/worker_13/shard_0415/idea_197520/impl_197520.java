...
@Data
public class Idea197520Config {
    private String name = "idea_197520";
 ...
 */
@Slf4j
public class Idea197520Service {
    private static final int IDEA_ID = 197520;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197520Service() {
        this(new Idea197520Config());
    }

    public Idea197520Service(Idea197520Config config) {
        this.config = config != null ? config : new Idea197520Config();
