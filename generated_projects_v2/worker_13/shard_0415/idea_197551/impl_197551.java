...
@Data
public class Idea197551Config {
    private String name = "idea_197551";
 ...
 */
@Slf4j
public class Idea197551Service {
    private static final int IDEA_ID = 197551;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197551Service() {
        this(new Idea197551Config());
    }

    public Idea197551Service(Idea197551Config config) {
        this.config = config != null ? config : new Idea197551Config();
