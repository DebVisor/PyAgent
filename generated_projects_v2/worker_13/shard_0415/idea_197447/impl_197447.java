...
@Data
public class Idea197447Config {
    private String name = "idea_197447";
 ...
 */
@Slf4j
public class Idea197447Service {
    private static final int IDEA_ID = 197447;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197447Service() {
        this(new Idea197447Config());
    }

    public Idea197447Service(Idea197447Config config) {
        this.config = config != null ? config : new Idea197447Config();
