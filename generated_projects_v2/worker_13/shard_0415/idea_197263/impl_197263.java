...
@Data
public class Idea197263Config {
    private String name = "idea_197263";
 ...
 */
@Slf4j
public class Idea197263Service {
    private static final int IDEA_ID = 197263;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197263Service() {
        this(new Idea197263Config());
    }

    public Idea197263Service(Idea197263Config config) {
        this.config = config != null ? config : new Idea197263Config();
