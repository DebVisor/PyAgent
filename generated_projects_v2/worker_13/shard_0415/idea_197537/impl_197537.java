...
@Data
public class Idea197537Config {
    private String name = "idea_197537";
 ...
 */
@Slf4j
public class Idea197537Service {
    private static final int IDEA_ID = 197537;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197537Service() {
        this(new Idea197537Config());
    }

    public Idea197537Service(Idea197537Config config) {
        this.config = config != null ? config : new Idea197537Config();
