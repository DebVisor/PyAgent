...
@Data
public class Idea197424Config {
    private String name = "idea_197424";
 ...
 */
@Slf4j
public class Idea197424Service {
    private static final int IDEA_ID = 197424;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197424Service() {
        this(new Idea197424Config());
    }

    public Idea197424Service(Idea197424Config config) {
        this.config = config != null ? config : new Idea197424Config();
