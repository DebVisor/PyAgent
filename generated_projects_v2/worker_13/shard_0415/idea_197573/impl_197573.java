...
@Data
public class Idea197573Config {
    private String name = "idea_197573";
 ...
 */
@Slf4j
public class Idea197573Service {
    private static final int IDEA_ID = 197573;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197573Service() {
        this(new Idea197573Config());
    }

    public Idea197573Service(Idea197573Config config) {
        this.config = config != null ? config : new Idea197573Config();
