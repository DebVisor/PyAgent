...
@Data
public class Idea197138Config {
    private String name = "idea_197138";
 ...
 */
@Slf4j
public class Idea197138Service {
    private static final int IDEA_ID = 197138;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197138Service() {
        this(new Idea197138Config());
    }

    public Idea197138Service(Idea197138Config config) {
        this.config = config != null ? config : new Idea197138Config();
