...
@Data
public class Idea197310Config {
    private String name = "idea_197310";
 ...
 */
@Slf4j
public class Idea197310Service {
    private static final int IDEA_ID = 197310;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197310Service() {
        this(new Idea197310Config());
    }

    public Idea197310Service(Idea197310Config config) {
        this.config = config != null ? config : new Idea197310Config();
