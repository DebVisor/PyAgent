...
@Data
public class Idea197516Config {
    private String name = "idea_197516";
 ...
 */
@Slf4j
public class Idea197516Service {
    private static final int IDEA_ID = 197516;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197516Service() {
        this(new Idea197516Config());
    }

    public Idea197516Service(Idea197516Config config) {
        this.config = config != null ? config : new Idea197516Config();
