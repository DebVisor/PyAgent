...
@Data
public class Idea197370Config {
    private String name = "idea_197370";
 ...
 */
@Slf4j
public class Idea197370Service {
    private static final int IDEA_ID = 197370;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197370Service() {
        this(new Idea197370Config());
    }

    public Idea197370Service(Idea197370Config config) {
        this.config = config != null ? config : new Idea197370Config();
