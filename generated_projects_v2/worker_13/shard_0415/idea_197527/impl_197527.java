...
@Data
public class Idea197527Config {
    private String name = "idea_197527";
 ...
 */
@Slf4j
public class Idea197527Service {
    private static final int IDEA_ID = 197527;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197527Service() {
        this(new Idea197527Config());
    }

    public Idea197527Service(Idea197527Config config) {
        this.config = config != null ? config : new Idea197527Config();
