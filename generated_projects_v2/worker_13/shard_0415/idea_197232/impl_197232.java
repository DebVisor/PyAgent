...
@Data
public class Idea197232Config {
    private String name = "idea_197232";
 ...
 */
@Slf4j
public class Idea197232Service {
    private static final int IDEA_ID = 197232;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197232Service() {
        this(new Idea197232Config());
    }

    public Idea197232Service(Idea197232Config config) {
        this.config = config != null ? config : new Idea197232Config();
