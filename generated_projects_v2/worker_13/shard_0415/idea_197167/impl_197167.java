...
@Data
public class Idea197167Config {
    private String name = "idea_197167";
 ...
 */
@Slf4j
public class Idea197167Service {
    private static final int IDEA_ID = 197167;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197167Service() {
        this(new Idea197167Config());
    }

    public Idea197167Service(Idea197167Config config) {
        this.config = config != null ? config : new Idea197167Config();
