...
@Data
public class Idea197582Config {
    private String name = "idea_197582";
 ...
 */
@Slf4j
public class Idea197582Service {
    private static final int IDEA_ID = 197582;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197582Service() {
        this(new Idea197582Config());
    }

    public Idea197582Service(Idea197582Config config) {
        this.config = config != null ? config : new Idea197582Config();
