...
@Data
public class Idea197217Config {
    private String name = "idea_197217";
 ...
 */
@Slf4j
public class Idea197217Service {
    private static final int IDEA_ID = 197217;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197217Service() {
        this(new Idea197217Config());
    }

    public Idea197217Service(Idea197217Config config) {
        this.config = config != null ? config : new Idea197217Config();
