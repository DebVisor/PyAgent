...
@Data
public class Idea197223Config {
    private String name = "idea_197223";
 ...
 */
@Slf4j
public class Idea197223Service {
    private static final int IDEA_ID = 197223;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197223Service() {
        this(new Idea197223Config());
    }

    public Idea197223Service(Idea197223Config config) {
        this.config = config != null ? config : new Idea197223Config();
