...
@Data
public class Idea197558Config {
    private String name = "idea_197558";
 ...
 */
@Slf4j
public class Idea197558Service {
    private static final int IDEA_ID = 197558;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197558Service() {
        this(new Idea197558Config());
    }

    public Idea197558Service(Idea197558Config config) {
        this.config = config != null ? config : new Idea197558Config();
