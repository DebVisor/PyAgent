...
@Data
public class Idea197583Config {
    private String name = "idea_197583";
 ...
 */
@Slf4j
public class Idea197583Service {
    private static final int IDEA_ID = 197583;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197583Service() {
        this(new Idea197583Config());
    }

    public Idea197583Service(Idea197583Config config) {
        this.config = config != null ? config : new Idea197583Config();
