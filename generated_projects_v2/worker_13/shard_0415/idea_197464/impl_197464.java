...
@Data
public class Idea197464Config {
    private String name = "idea_197464";
 ...
 */
@Slf4j
public class Idea197464Service {
    private static final int IDEA_ID = 197464;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197464Service() {
        this(new Idea197464Config());
    }

    public Idea197464Service(Idea197464Config config) {
        this.config = config != null ? config : new Idea197464Config();
