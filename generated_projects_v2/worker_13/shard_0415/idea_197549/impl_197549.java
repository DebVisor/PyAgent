...
@Data
public class Idea197549Config {
    private String name = "idea_197549";
 ...
 */
@Slf4j
public class Idea197549Service {
    private static final int IDEA_ID = 197549;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197549Service() {
        this(new Idea197549Config());
    }

    public Idea197549Service(Idea197549Config config) {
        this.config = config != null ? config : new Idea197549Config();
