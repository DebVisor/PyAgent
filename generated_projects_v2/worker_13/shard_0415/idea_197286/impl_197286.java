...
@Data
public class Idea197286Config {
    private String name = "idea_197286";
 ...
 */
@Slf4j
public class Idea197286Service {
    private static final int IDEA_ID = 197286;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197286Service() {
        this(new Idea197286Config());
    }

    public Idea197286Service(Idea197286Config config) {
        this.config = config != null ? config : new Idea197286Config();
