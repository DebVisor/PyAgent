...
@Data
public class Idea197461Config {
    private String name = "idea_197461";
 ...
 */
@Slf4j
public class Idea197461Service {
    private static final int IDEA_ID = 197461;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197461Service() {
        this(new Idea197461Config());
    }

    public Idea197461Service(Idea197461Config config) {
        this.config = config != null ? config : new Idea197461Config();
