...
@Data
public class Idea197354Config {
    private String name = "idea_197354";
 ...
 */
@Slf4j
public class Idea197354Service {
    private static final int IDEA_ID = 197354;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197354Service() {
        this(new Idea197354Config());
    }

    public Idea197354Service(Idea197354Config config) {
        this.config = config != null ? config : new Idea197354Config();
