...
@Data
public class Idea197280Config {
    private String name = "idea_197280";
 ...
 */
@Slf4j
public class Idea197280Service {
    private static final int IDEA_ID = 197280;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197280Service() {
        this(new Idea197280Config());
    }

    public Idea197280Service(Idea197280Config config) {
        this.config = config != null ? config : new Idea197280Config();
