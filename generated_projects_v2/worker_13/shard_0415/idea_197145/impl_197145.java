...
@Data
public class Idea197145Config {
    private String name = "idea_197145";
 ...
 */
@Slf4j
public class Idea197145Service {
    private static final int IDEA_ID = 197145;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197145Service() {
        this(new Idea197145Config());
    }

    public Idea197145Service(Idea197145Config config) {
        this.config = config != null ? config : new Idea197145Config();
