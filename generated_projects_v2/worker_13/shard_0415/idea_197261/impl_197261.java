...
@Data
public class Idea197261Config {
    private String name = "idea_197261";
 ...
 */
@Slf4j
public class Idea197261Service {
    private static final int IDEA_ID = 197261;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197261Service() {
        this(new Idea197261Config());
    }

    public Idea197261Service(Idea197261Config config) {
        this.config = config != null ? config : new Idea197261Config();
