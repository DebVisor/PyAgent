...
@Data
public class Idea197299Config {
    private String name = "idea_197299";
 ...
 */
@Slf4j
public class Idea197299Service {
    private static final int IDEA_ID = 197299;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197299Service() {
        this(new Idea197299Config());
    }

    public Idea197299Service(Idea197299Config config) {
        this.config = config != null ? config : new Idea197299Config();
