...
@Data
public class Idea197181Config {
    private String name = "idea_197181";
 ...
 */
@Slf4j
public class Idea197181Service {
    private static final int IDEA_ID = 197181;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197181Service() {
        this(new Idea197181Config());
    }

    public Idea197181Service(Idea197181Config config) {
        this.config = config != null ? config : new Idea197181Config();
