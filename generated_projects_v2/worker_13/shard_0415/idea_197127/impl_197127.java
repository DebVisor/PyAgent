...
@Data
public class Idea197127Config {
    private String name = "idea_197127";
 ...
 */
@Slf4j
public class Idea197127Service {
    private static final int IDEA_ID = 197127;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197127Service() {
        this(new Idea197127Config());
    }

    public Idea197127Service(Idea197127Config config) {
        this.config = config != null ? config : new Idea197127Config();
