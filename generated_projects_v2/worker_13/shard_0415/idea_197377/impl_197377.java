...
@Data
public class Idea197377Config {
    private String name = "idea_197377";
 ...
 */
@Slf4j
public class Idea197377Service {
    private static final int IDEA_ID = 197377;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197377Service() {
        this(new Idea197377Config());
    }

    public Idea197377Service(Idea197377Config config) {
        this.config = config != null ? config : new Idea197377Config();
