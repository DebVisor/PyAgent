...
@Data
public class Idea197382Config {
    private String name = "idea_197382";
 ...
 */
@Slf4j
public class Idea197382Service {
    private static final int IDEA_ID = 197382;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197382Service() {
        this(new Idea197382Config());
    }

    public Idea197382Service(Idea197382Config config) {
        this.config = config != null ? config : new Idea197382Config();
