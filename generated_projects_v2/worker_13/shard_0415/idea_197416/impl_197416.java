...
@Data
public class Idea197416Config {
    private String name = "idea_197416";
 ...
 */
@Slf4j
public class Idea197416Service {
    private static final int IDEA_ID = 197416;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197416Service() {
        this(new Idea197416Config());
    }

    public Idea197416Service(Idea197416Config config) {
        this.config = config != null ? config : new Idea197416Config();
