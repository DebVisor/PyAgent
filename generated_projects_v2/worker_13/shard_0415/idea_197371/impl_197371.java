...
@Data
public class Idea197371Config {
    private String name = "idea_197371";
 ...
 */
@Slf4j
public class Idea197371Service {
    private static final int IDEA_ID = 197371;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197371Service() {
        this(new Idea197371Config());
    }

    public Idea197371Service(Idea197371Config config) {
        this.config = config != null ? config : new Idea197371Config();
