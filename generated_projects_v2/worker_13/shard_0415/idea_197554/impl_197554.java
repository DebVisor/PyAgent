...
@Data
public class Idea197554Config {
    private String name = "idea_197554";
 ...
 */
@Slf4j
public class Idea197554Service {
    private static final int IDEA_ID = 197554;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197554Service() {
        this(new Idea197554Config());
    }

    public Idea197554Service(Idea197554Config config) {
        this.config = config != null ? config : new Idea197554Config();
