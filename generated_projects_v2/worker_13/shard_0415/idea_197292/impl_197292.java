...
@Data
public class Idea197292Config {
    private String name = "idea_197292";
 ...
 */
@Slf4j
public class Idea197292Service {
    private static final int IDEA_ID = 197292;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197292Service() {
        this(new Idea197292Config());
    }

    public Idea197292Service(Idea197292Config config) {
        this.config = config != null ? config : new Idea197292Config();
