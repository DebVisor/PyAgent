...
@Data
public class Idea197585Config {
    private String name = "idea_197585";
 ...
 */
@Slf4j
public class Idea197585Service {
    private static final int IDEA_ID = 197585;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197585Service() {
        this(new Idea197585Config());
    }

    public Idea197585Service(Idea197585Config config) {
        this.config = config != null ? config : new Idea197585Config();
