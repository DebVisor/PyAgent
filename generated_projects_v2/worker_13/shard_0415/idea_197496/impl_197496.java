...
@Data
public class Idea197496Config {
    private String name = "idea_197496";
 ...
 */
@Slf4j
public class Idea197496Service {
    private static final int IDEA_ID = 197496;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197496Service() {
        this(new Idea197496Config());
    }

    public Idea197496Service(Idea197496Config config) {
        this.config = config != null ? config : new Idea197496Config();
