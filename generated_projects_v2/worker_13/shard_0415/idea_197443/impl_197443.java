...
@Data
public class Idea197443Config {
    private String name = "idea_197443";
 ...
 */
@Slf4j
public class Idea197443Service {
    private static final int IDEA_ID = 197443;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197443Service() {
        this(new Idea197443Config());
    }

    public Idea197443Service(Idea197443Config config) {
        this.config = config != null ? config : new Idea197443Config();
