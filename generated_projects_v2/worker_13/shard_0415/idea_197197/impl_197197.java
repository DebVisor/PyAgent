...
@Data
public class Idea197197Config {
    private String name = "idea_197197";
 ...
 */
@Slf4j
public class Idea197197Service {
    private static final int IDEA_ID = 197197;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197197Service() {
        this(new Idea197197Config());
    }

    public Idea197197Service(Idea197197Config config) {
        this.config = config != null ? config : new Idea197197Config();
