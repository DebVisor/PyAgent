...
@Data
public class Idea197218Config {
    private String name = "idea_197218";
 ...
 */
@Slf4j
public class Idea197218Service {
    private static final int IDEA_ID = 197218;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197218Service() {
        this(new Idea197218Config());
    }

    public Idea197218Service(Idea197218Config config) {
        this.config = config != null ? config : new Idea197218Config();
