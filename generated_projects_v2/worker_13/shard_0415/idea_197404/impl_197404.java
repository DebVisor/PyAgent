...
@Data
public class Idea197404Config {
    private String name = "idea_197404";
 ...
 */
@Slf4j
public class Idea197404Service {
    private static final int IDEA_ID = 197404;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197404Service() {
        this(new Idea197404Config());
    }

    public Idea197404Service(Idea197404Config config) {
        this.config = config != null ? config : new Idea197404Config();
