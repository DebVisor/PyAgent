...
@Data
public class Idea197149Config {
    private String name = "idea_197149";
 ...
 */
@Slf4j
public class Idea197149Service {
    private static final int IDEA_ID = 197149;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197149Service() {
        this(new Idea197149Config());
    }

    public Idea197149Service(Idea197149Config config) {
        this.config = config != null ? config : new Idea197149Config();
