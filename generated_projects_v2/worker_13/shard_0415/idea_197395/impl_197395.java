...
@Data
public class Idea197395Config {
    private String name = "idea_197395";
 ...
 */
@Slf4j
public class Idea197395Service {
    private static final int IDEA_ID = 197395;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197395Service() {
        this(new Idea197395Config());
    }

    public Idea197395Service(Idea197395Config config) {
        this.config = config != null ? config : new Idea197395Config();
