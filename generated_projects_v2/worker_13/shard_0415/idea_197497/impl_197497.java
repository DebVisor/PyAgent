...
@Data
public class Idea197497Config {
    private String name = "idea_197497";
 ...
 */
@Slf4j
public class Idea197497Service {
    private static final int IDEA_ID = 197497;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197497Service() {
        this(new Idea197497Config());
    }

    public Idea197497Service(Idea197497Config config) {
        this.config = config != null ? config : new Idea197497Config();
