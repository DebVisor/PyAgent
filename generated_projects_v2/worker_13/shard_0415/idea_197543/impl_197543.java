...
@Data
public class Idea197543Config {
    private String name = "idea_197543";
 ...
 */
@Slf4j
public class Idea197543Service {
    private static final int IDEA_ID = 197543;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197543Service() {
        this(new Idea197543Config());
    }

    public Idea197543Service(Idea197543Config config) {
        this.config = config != null ? config : new Idea197543Config();
