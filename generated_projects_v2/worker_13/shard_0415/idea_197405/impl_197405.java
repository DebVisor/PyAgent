...
@Data
public class Idea197405Config {
    private String name = "idea_197405";
 ...
 */
@Slf4j
public class Idea197405Service {
    private static final int IDEA_ID = 197405;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197405Service() {
        this(new Idea197405Config());
    }

    public Idea197405Service(Idea197405Config config) {
        this.config = config != null ? config : new Idea197405Config();
