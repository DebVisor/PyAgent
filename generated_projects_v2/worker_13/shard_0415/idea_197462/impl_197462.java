...
@Data
public class Idea197462Config {
    private String name = "idea_197462";
 ...
 */
@Slf4j
public class Idea197462Service {
    private static final int IDEA_ID = 197462;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197462Service() {
        this(new Idea197462Config());
    }

    public Idea197462Service(Idea197462Config config) {
        this.config = config != null ? config : new Idea197462Config();
