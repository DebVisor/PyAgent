...
@Data
public class Idea197271Config {
    private String name = "idea_197271";
 ...
 */
@Slf4j
public class Idea197271Service {
    private static final int IDEA_ID = 197271;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197271Service() {
        this(new Idea197271Config());
    }

    public Idea197271Service(Idea197271Config config) {
        this.config = config != null ? config : new Idea197271Config();
