...
@Data
public class Idea197285Config {
    private String name = "idea_197285";
 ...
 */
@Slf4j
public class Idea197285Service {
    private static final int IDEA_ID = 197285;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197285Service() {
        this(new Idea197285Config());
    }

    public Idea197285Service(Idea197285Config config) {
        this.config = config != null ? config : new Idea197285Config();
