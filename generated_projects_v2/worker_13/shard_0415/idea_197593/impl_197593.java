...
@Data
public class Idea197593Config {
    private String name = "idea_197593";
 ...
 */
@Slf4j
public class Idea197593Service {
    private static final int IDEA_ID = 197593;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197593Service() {
        this(new Idea197593Config());
    }

    public Idea197593Service(Idea197593Config config) {
        this.config = config != null ? config : new Idea197593Config();
