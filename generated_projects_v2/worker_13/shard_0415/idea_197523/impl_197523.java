...
@Data
public class Idea197523Config {
    private String name = "idea_197523";
 ...
 */
@Slf4j
public class Idea197523Service {
    private static final int IDEA_ID = 197523;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197523Service() {
        this(new Idea197523Config());
    }

    public Idea197523Service(Idea197523Config config) {
        this.config = config != null ? config : new Idea197523Config();
