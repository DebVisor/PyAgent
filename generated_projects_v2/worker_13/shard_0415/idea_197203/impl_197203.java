...
@Data
public class Idea197203Config {
    private String name = "idea_197203";
 ...
 */
@Slf4j
public class Idea197203Service {
    private static final int IDEA_ID = 197203;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197203Service() {
        this(new Idea197203Config());
    }

    public Idea197203Service(Idea197203Config config) {
        this.config = config != null ? config : new Idea197203Config();
