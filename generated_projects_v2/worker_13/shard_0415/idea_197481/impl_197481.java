...
@Data
public class Idea197481Config {
    private String name = "idea_197481";
 ...
 */
@Slf4j
public class Idea197481Service {
    private static final int IDEA_ID = 197481;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197481Service() {
        this(new Idea197481Config());
    }

    public Idea197481Service(Idea197481Config config) {
        this.config = config != null ? config : new Idea197481Config();
