...
@Data
public class Idea197531Config {
    private String name = "idea_197531";
 ...
 */
@Slf4j
public class Idea197531Service {
    private static final int IDEA_ID = 197531;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197531Service() {
        this(new Idea197531Config());
    }

    public Idea197531Service(Idea197531Config config) {
        this.config = config != null ? config : new Idea197531Config();
