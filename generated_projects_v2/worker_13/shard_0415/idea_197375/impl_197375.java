...
@Data
public class Idea197375Config {
    private String name = "idea_197375";
 ...
 */
@Slf4j
public class Idea197375Service {
    private static final int IDEA_ID = 197375;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197375Service() {
        this(new Idea197375Config());
    }

    public Idea197375Service(Idea197375Config config) {
        this.config = config != null ? config : new Idea197375Config();
