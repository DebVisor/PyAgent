...
@Data
public class Idea197290Config {
    private String name = "idea_197290";
 ...
 */
@Slf4j
public class Idea197290Service {
    private static final int IDEA_ID = 197290;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197290Service() {
        this(new Idea197290Config());
    }

    public Idea197290Service(Idea197290Config config) {
        this.config = config != null ? config : new Idea197290Config();
