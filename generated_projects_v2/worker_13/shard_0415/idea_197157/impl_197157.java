...
@Data
public class Idea197157Config {
    private String name = "idea_197157";
 ...
 */
@Slf4j
public class Idea197157Service {
    private static final int IDEA_ID = 197157;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197157Service() {
        this(new Idea197157Config());
    }

    public Idea197157Service(Idea197157Config config) {
        this.config = config != null ? config : new Idea197157Config();
