...
@Data
public class Idea197307Config {
    private String name = "idea_197307";
 ...
 */
@Slf4j
public class Idea197307Service {
    private static final int IDEA_ID = 197307;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197307Service() {
        this(new Idea197307Config());
    }

    public Idea197307Service(Idea197307Config config) {
        this.config = config != null ? config : new Idea197307Config();
