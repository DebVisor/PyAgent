...
@Data
public class Idea197478Config {
    private String name = "idea_197478";
 ...
 */
@Slf4j
public class Idea197478Service {
    private static final int IDEA_ID = 197478;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197478Service() {
        this(new Idea197478Config());
    }

    public Idea197478Service(Idea197478Config config) {
        this.config = config != null ? config : new Idea197478Config();
