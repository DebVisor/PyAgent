...
@Data
public class Idea197169Config {
    private String name = "idea_197169";
 ...
 */
@Slf4j
public class Idea197169Service {
    private static final int IDEA_ID = 197169;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197169Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197169Service() {
        this(new Idea197169Config());
    }

    public Idea197169Service(Idea197169Config config) {
        this.config = config != null ? config : new Idea197169Config();
