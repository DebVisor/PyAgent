...
@Data
public class Idea197252Config {
    private String name = "idea_197252";
 ...
 */
@Slf4j
public class Idea197252Service {
    private static final int IDEA_ID = 197252;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197252Service() {
        this(new Idea197252Config());
    }

    public Idea197252Service(Idea197252Config config) {
        this.config = config != null ? config : new Idea197252Config();
