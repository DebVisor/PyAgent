...
@Data
public class Idea197237Config {
    private String name = "idea_197237";
 ...
 */
@Slf4j
public class Idea197237Service {
    private static final int IDEA_ID = 197237;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197237Service() {
        this(new Idea197237Config());
    }

    public Idea197237Service(Idea197237Config config) {
        this.config = config != null ? config : new Idea197237Config();
