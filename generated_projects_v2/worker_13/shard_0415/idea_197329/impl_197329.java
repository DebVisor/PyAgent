...
@Data
public class Idea197329Config {
    private String name = "idea_197329";
 ...
 */
@Slf4j
public class Idea197329Service {
    private static final int IDEA_ID = 197329;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197329Service() {
        this(new Idea197329Config());
    }

    public Idea197329Service(Idea197329Config config) {
        this.config = config != null ? config : new Idea197329Config();
