...
@Data
public class Idea197436Config {
    private String name = "idea_197436";
 ...
 */
@Slf4j
public class Idea197436Service {
    private static final int IDEA_ID = 197436;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197436Service() {
        this(new Idea197436Config());
    }

    public Idea197436Service(Idea197436Config config) {
        this.config = config != null ? config : new Idea197436Config();
