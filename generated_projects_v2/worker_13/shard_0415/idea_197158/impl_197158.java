...
@Data
public class Idea197158Config {
    private String name = "idea_197158";
 ...
 */
@Slf4j
public class Idea197158Service {
    private static final int IDEA_ID = 197158;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197158Service() {
        this(new Idea197158Config());
    }

    public Idea197158Service(Idea197158Config config) {
        this.config = config != null ? config : new Idea197158Config();
