...
@Data
public class Idea197315Config {
    private String name = "idea_197315";
 ...
 */
@Slf4j
public class Idea197315Service {
    private static final int IDEA_ID = 197315;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197315Service() {
        this(new Idea197315Config());
    }

    public Idea197315Service(Idea197315Config config) {
        this.config = config != null ? config : new Idea197315Config();
