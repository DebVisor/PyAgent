...
@Data
public class Idea197168Config {
    private String name = "idea_197168";
 ...
 */
@Slf4j
public class Idea197168Service {
    private static final int IDEA_ID = 197168;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197168Service() {
        this(new Idea197168Config());
    }

    public Idea197168Service(Idea197168Config config) {
        this.config = config != null ? config : new Idea197168Config();
