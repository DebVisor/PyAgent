...
@Data
public class Idea197594Config {
    private String name = "idea_197594";
 ...
 */
@Slf4j
public class Idea197594Service {
    private static final int IDEA_ID = 197594;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197594Service() {
        this(new Idea197594Config());
    }

    public Idea197594Service(Idea197594Config config) {
        this.config = config != null ? config : new Idea197594Config();
