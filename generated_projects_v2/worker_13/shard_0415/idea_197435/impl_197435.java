...
@Data
public class Idea197435Config {
    private String name = "idea_197435";
 ...
 */
@Slf4j
public class Idea197435Service {
    private static final int IDEA_ID = 197435;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197435Service() {
        this(new Idea197435Config());
    }

    public Idea197435Service(Idea197435Config config) {
        this.config = config != null ? config : new Idea197435Config();
