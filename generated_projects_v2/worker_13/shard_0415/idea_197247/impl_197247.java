...
@Data
public class Idea197247Config {
    private String name = "idea_197247";
 ...
 */
@Slf4j
public class Idea197247Service {
    private static final int IDEA_ID = 197247;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197247Service() {
        this(new Idea197247Config());
    }

    public Idea197247Service(Idea197247Config config) {
        this.config = config != null ? config : new Idea197247Config();
