...
@Data
public class Idea197466Config {
    private String name = "idea_197466";
 ...
 */
@Slf4j
public class Idea197466Service {
    private static final int IDEA_ID = 197466;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197466Service() {
        this(new Idea197466Config());
    }

    public Idea197466Service(Idea197466Config config) {
        this.config = config != null ? config : new Idea197466Config();
