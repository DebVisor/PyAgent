...
@Data
public class Idea197264Config {
    private String name = "idea_197264";
 ...
 */
@Slf4j
public class Idea197264Service {
    private static final int IDEA_ID = 197264;
    private static final String CATEGORY = "security";
    private static final String VERSION = "2.0.0";
    
    private final Idea197264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea197264Service() {
        this(new Idea197264Config());
    }

    public Idea197264Service(Idea197264Config config) {
        this.config = config != null ? config : new Idea197264Config();
