...
## Problem statement
`performance/metrics_bench.py` benchmarks Rust through Python. No Rust-side `criterion` benchmarks exist, making it impossible to detect performance regressions at the Rust layer.
