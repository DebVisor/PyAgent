...
## Problem statement
The CRDT sub-crate (`rust_core/crdt/`) builds a standalone binary but exposes no PyO3 bindings. `src/core/crdt_bridge.py` implies FFI was planned but not completed.
