...
new_project = {
    ...
    "lane": "Released",
    "summary": (
        "Generate, propose merges, and promote legacy ideas from "
        "PyAgent.3.7.0 codebase. Add shared parallel agent register "
        "and CLI for atomic work coordination."
    ),
    "branch": "merged",
    "pr": "#268",
    "priority": "P2",
...
print("✓ Added prj0000113 to projects.json and kanban.json")
